...
| **input_iterator_tag output_iterator_tagforward_iterator_tagbidirectional_iterator_tagrandom_access_iterator_tagcontiguous_iterator_tag**(C++20)  
---  
...
## Contents
  ...
  * [1 Iterator category](iterator_tags.html#Iterator_category)
  * [2 Iterator concept](iterator_tags.html#Iterator_concept)
  * [3 Notes](iterator_tags.html#Notes)
  * [4 Example](iterator_tags.html#Example)
  * [5 See also](iterator_tags.html#See_also)
...
For every [LegacyIterator](../named_req/Iterator.html "cpp/named req/Iterator") type `It`, a `typedef` [std::iterator_traits](iterator_traits.html)<It>::iterator_category must be defined to be an alias to one of these tag types, to indicate the most specific category that `It` is in. 
  ...
  1. `input_iterator_tag` corresponds to [LegacyInputIterator](../named_req/InputIterator.html "cpp/named req/InputIterator"). 
  2. `output_iterator_tag` corresponds to [LegacyOutputIterator](../named_req/OutputIterator.html "cpp/named req/OutputIterator"). 
  3. `forward_iterator_tag` corresponds to [LegacyForwardIterator](../named_req/ForwardIterator.html "cpp/named req/ForwardIterator"). 
  4. `bidirectional_iterator_tag` corresponds to [LegacyBidirectionalIterator](../named_req/BidirectionalIterator.html "cpp/named req/BidirectionalIterator"). 
  5. `random_access_iterator_tag` corresponds to [LegacyRandomAccessIterator](../named_req/RandomAccessIterator.html "cpp/named req/RandomAccessIterator"). 
...
For every [`input_iterator`](input_iterator.html "cpp/iterator/input iterator") type `It`, either It::iterator_concept (if [std::iterator_traits](iterator_traits.html)<It> is generated from primary template) or [std::iterator_traits](iterator_traits.html)<It>::iterator_concept (if [std::iterator_traits](iterator_traits.html)<It> is specialized) may be declared as an alias to one of these tags, to indicate the strongest iterator concept that `It` intends to model. 

  1. `input_iterator_tag` corresponds to [`input_iterator`](input_iterator.html "cpp/iterator/input iterator"). 
  2. `forward_iterator_tag` corresponds to [`forward_iterator`](forward_iterator.html "cpp/iterator/forward iterator"). 
  3. `bidirectional_iterator_tag` corresponds to [`bidirectional_iterator`](bidirectional_iterator.html "cpp/iterator/bidirectional iterator"). 
  4. `random_access_iterator_tag` corresponds to [`random_access_iterator`](random_access_iterator.html "cpp/iterator/random access iterator"). 
  5. `contiguous_iterator_tag` corresponds to [`contiguous_iterator`](contiguous_iterator.html "cpp/iterator/contiguous iterator"). 
...
Run this code
    ...
     
    template<[std::bidirectional_iterator](bidirectional_iterator.html) BDIter>
    void alg(BDIter, BDIter)
    {
        [std::cout](../io/cout.html) << "1. alg() \t called for bidirectional iterator\n";
    }
     
    template<[std::random_access_iterator](random_access_iterator.html) RAIter>
    void alg(RAIter, RAIter)
    {
        [std::cout](../io/cout.html) << "2. alg() \t called for random-access iterator\n";
    }
     
    ...
    namespace legacy
    {
        ...
        namespace implementation_details
        {
            ...
            {
                [std::cout](../io/cout.html) << "3. legacy::alg() called for bidirectional iterator\n";
            }
     
            template<class RAIter>
            void alg(RAIter, RAIter, std::random_access_iterator_tag)
            {
                [std::cout](../io/cout.html) << "4. legacy::alg() called for random-access iterator\n";
            }
        } // namespace implementation_details
     
        template<class Iter>
        void alg(Iter first, Iter last)
        {
            implementation_details::alg(first, last,
                typename [std::iterator_traits](iterator_traits.html)<Iter>::iterator_category());
        }
    } // namespace legacy
     
    int main()
    {
        [std::list](../container/list.html)<int> l;
        alg(l.begin(), l.end()); // 1.
