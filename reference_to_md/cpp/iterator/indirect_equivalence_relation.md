...
[std::equivalence_relation](../concepts/equivalence_relation.html)  
...
[P2997R1](https://wg21.link/P2997R1) | C++20  | `indirect_equivalence_relation` required F& to satisfy [`equivalence_relation`](../concepts/equivalence_relation.html "cpp/concepts/equivalence relation") with  
