...
[std::forward_iterator](forward_iterator.html)<I> &&  
[std::derived_from](../concepts/derived_from.html)</*ITER_CONCEPT*/<I>, [std::bidirectional_iterator_tag](iterator_tags.html)> &&  
requires(I i) {  
...
The concept `bidirectional_iterator` refines [`forward_iterator`](forward_iterator.html "cpp/iterator/forward iterator") by adding the ability to move an iterator backward. 

## Contents

  * [1 Iterator concept determination](bidirectional_iterator.html#Iterator_concept_determination)
  * [2 Semantic requirements](bidirectional_iterator.html#Semantic_requirements)
  * [3 Equality preservation](bidirectional_iterator.html#Equality_preservation)
  * [4 Notes](bidirectional_iterator.html#Notes)
  * [5 Example](bidirectional_iterator.html#Example)
  * [6 See also](bidirectional_iterator.html#See_also)
...
(That is, [std::derived_from](../concepts/derived_from.html)</*ITER_CONCEPT*/<I>, [std::bidirectional_iterator_tag](iterator_tags.html)> is assumed to be true.) 
