...
## Contents
  ...
  * [2 Member types](iterator.html#Member_types)
  * [3 Example](iterator.html#Example)
  * [4 See also](iterator.html#See_also)
...
Run this code
    ...
    public:
        ...
        class iterator : public std::iterator<
                                    [std::input_iterator_tag](iterator_tags.html), // iterator_category
                                    long,                    // value_type
    ...
    int main()
    {
        ...
        auto itr = [std::find](../algorithm/find.html)(range.begin(), range.end(), 18);
        [std::cout](../io/cout.html) << *itr << '\n'; // 18
     
        // Range::iterator also satisfies range-based for requirements
        for (long l : Range<3, 5>())
            [std::cout](../io/cout.html) << l << ' '; // 3 4 5
