...
Member functions  
---  
[front_insert_iterator::front_insert_iterator](front_insert_iterator/front_insert_iterator.html "cpp/iterator/front insert iterator/front insert iterator")  
[front_insert_iterator::operator=](front_insert_iterator/operator=.html "cpp/iterator/front insert iterator/operator=")  
[front_insert_iterator::operator*](front_insert_iterator/operator*.html "cpp/iterator/front insert iterator/operator*")  
[front_insert_iterator::operator++front_insert_iterator::operator++(int)](front_insert_iterator/operator++.html "cpp/iterator/front insert iterator/operator++")  
...
template< class Container >  
class front_insert_iterator; |  |  (since C++17)  
| |   
  
`std::front_insert_iterator` is a [LegacyOutputIterator](../named_req/OutputIterator.html "cpp/named req/OutputIterator") that prepends elements to a container for which it was constructed. The container's `push_front()` member function is called whenever the iterator (whether dereferenced or not) is assigned to. Incrementing the `std::front_insert_iterator` is a no-op. 

## Contents

  * [1 Member types](front_insert_iterator.html#Member_types)
  * [2 Member functions](front_insert_iterator.html#Member_functions)
  * [3 Member objects](front_insert_iterator.html#Member_objects)
  * [4 Example](front_insert_iterator.html#Example)
  * [5 See also](front_insert_iterator.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_insert_iterator&action=edit&section=1 "Edit section: Member functions")] Member functions

[ (constructor)](front_insert_iterator/front_insert_iterator.html "cpp/iterator/front insert iterator/front insert iterator") |  constructs a new `front_insert_iterator`   
...
---|---  
[ operator=](front_insert_iterator/operator=.html "cpp/iterator/front insert iterator/operator=") |  inserts an object into the associated container   
...
[ operator*](front_insert_iterator/operator*.html "cpp/iterator/front insert iterator/operator*") |  no-op   
...
[ operator++operator++(int)](front_insert_iterator/operator++.html "cpp/iterator/front insert iterator/operator++") |  no-op   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_insert_iterator&action=edit&section=2 "Edit section: Member objects")] Member objects

Member name  |  Definition   
---|---  
`container` (protected) |  a pointer of type Container*  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_insert_iterator&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    namespace stb
    {
        ...
        {
            std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(d, [std::ostream_iterator](ostream_iterator.html)<int>([std::cout](../io/cout.html), " "));
    ...
    int main()
    {
        ...
        [std::deque](../container/deque.html)<int> d;
     
        [std::copy](../algorithm/copy.html)(v.begin(), v.end(),
                  std::front_insert_iterator<[std::deque](../container/deque.html)<int>>(d));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_insert_iterator&action=edit&section=4 "Edit section: See also")] See also

[ front_inserter](front_inserter.html "cpp/iterator/front inserter") |  creates a **std::front_insert_iterator** of type inferred from the argument   
