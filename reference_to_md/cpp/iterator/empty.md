...
template< class C >  
constexpr auto empty( const C& c ) -> decltype(c.empty()); |  (1) | (since C++17)  
template< class T, [std::size_t](../types/size_t.html) N >  
constexpr bool empty( const T (&array)[N] ) noexcept; |  (2) | (since C++17)  
template< class E >  
constexpr bool empty( [std::initializer_list](../utility/initializer_list.html)<E> il ) noexcept; |  (3) | (since C++17)  
| |   
...
## Contents
  ...
  * [4 Notes](empty.html#Notes)
  * [5 Possible implementation](empty.html#Possible_implementation)
  * [6 Example](empty.html#Example)
  * [7 See also](empty.html#See_also)
...
[Second version](empty.html#Version_2)  
...
[Third version](empty.html#Version_3)  
      
    
    template<class E>
    [[nodiscard]] constexpr bool empty([std::initializer_list](../utility/initializer_list.html)<E> il) noexcept
    {
        return il.size() == 0;
    }  
...
Run this code
    ...
    void print(const T& container)
    {
        if (std::empty(container))
            [std::cout](../io/cout.html) << "Empty\n";
        else
        {
            [std::cout](../io/cout.html) << "Elements:";
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> c = {1, 2, 3};
        print(c);
        c.clear();
        print(c);
     
