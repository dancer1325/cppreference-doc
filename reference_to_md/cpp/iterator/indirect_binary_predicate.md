...
[std::indirectly_readable](indirectly_readable.html)<I1> &&  
[std::indirectly_readable](indirectly_readable.html)<I2> &&  
[std::copy_constructible](../concepts/copy_constructible.html)<F> &&  
[std::predicate](../concepts/predicate.html)<F&, /*indirect-value-t*/<I1>, /*indirect-value-t*/<I2>> &&  
[std::predicate](../concepts/predicate.html)<F&, /*indirect-value-t*/<I1>, [std::iter_reference_t](iter_t.html)<I2>> &&  
[std::predicate](../concepts/predicate.html)<F&, [std::iter_reference_t](iter_t.html)<I1>, /*indirect-value-t*/<I2>> &&  
[std::predicate](../concepts/predicate.html)<F&, [std::iter_reference_t](iter_t.html)<I1>, [std::iter_reference_t](iter_t.html)<I2>>; |  |  (since C++20)  
| |   
  
The concept `indirect_binary_predicate` specifies requirements for algorithms that call binary predicates as their arguments. The key difference between this concept and [std::predicate](../concepts/predicate.html "cpp/concepts/predicate") is that it is applied to the types that `I1` and `I2` references, rather than `I1` and `I2` themselves. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/indirect_binary_predicate&action=edit&section=1 "Edit section: Defect reports")] Defect reports
...
which mishandled projections resulting in incompatibility with predicate F& | defined in terms of /*indirect-value-t*/<I>  
to correctly handle such projections   
[P2997R1](https://wg21.link/P2997R1) | C++20  | `indirect_binary_predicate` required F& to satisfy [`predicate`](../concepts/predicate.html "cpp/concepts/predicate") with  
[std::iter_common_reference_t](iter_t.html)<I> | does not require 
