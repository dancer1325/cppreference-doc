...
BidirIt prev( BidirIt it, typename [std::iterator_traits](iterator_traits.html)<BidirIt>::difference_type n = 1 ); |  | (since C++11)   
(until C++17)  
template< class BidirIt >  
constexpr  
BidirIt prev( BidirIt it, typename [std::iterator_traits](iterator_traits.html)<BidirIt>::difference_type n = 1 ); |  |  (since C++17)  
| |   
...
### Possible implementation
    ...
    BidirIt prev(BidirIt it, typename [std::iterator_traits](iterator_traits.html)<BidirIt>::difference_type n = 1)
    {
