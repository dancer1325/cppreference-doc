...
[std::predicate](../concepts/predicate.html)<F&, /*indirect-value-t*/<I>> &&  
[std::predicate](../concepts/predicate.html)<F&, [std::iter_reference_t](iter_t.html)<I>>; |  |  (since C++20)  
| |   
...
---|---|---|---  
[P2609R3](https://wg21.link/P2609R3) | C++20  | one of the requirements was defined in terms of [std::iter_value_t](iter_t.html)<I>&  
...
[P2997R1](https://wg21.link/P2997R1) | C++20  | `indirect_unary_predicate` required F& to satisfy [`predicate`](../concepts/predicate.html "cpp/concepts/predicate") with  
