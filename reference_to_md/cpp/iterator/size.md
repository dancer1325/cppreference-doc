...
-> [std::common_type_t](../types/common_type.html)<[std::ptrdiff_t](../types/ptrdiff_t.html),  
[std::make_signed_t](../types/make_signed.html)<decltype(c.size())>>; |  (2) | (since C++20)  
template< class T, [std::size_t](../types/size_t.html) N >  
constexpr [std::size_t](../types/size_t.html) size( const T (&array)[N] ) noexcept; |  (3) | (since C++17)  
template< class T, [std::ptrdiff_t](../types/ptrdiff_t.html) N >  
constexpr [std::ptrdiff_t](../types/ptrdiff_t.html) ssize( const T (&array)[N] ) noexcept; |  (4) | (since C++20)  
| |   
...
## Contents
  ...
  * [3 Exceptions](size.html#Exceptions)
  * [4 Overloads](size.html#Overloads)
  * [5 Possible implementation](size.html#Possible_implementation)
  * [6 Notes](size.html#Notes)
  * [7 Example](size.html#Example)
  * [8 See also](size.html#See_also)
...
2) static_cast<[std::common_type_t](../types/common_type.html)<[std::ptrdiff_t](../types/ptrdiff_t.html),  
[std::make_signed_t](../types/make_signed.html)<decltype(c.size())>>>(c.size())
...
[ssize (2)](size.html#Version_2)  
      
    
    template<class C>
    constexpr auto ssize(const C& c)
        -> [std::common_type_t](../types/common_type.html)<[std::ptrdiff_t](../types/ptrdiff_t.html),
                              [std::make_signed_t](../types/make_signed.html)<decltype(c.size())>>
    {
        using R = [std::common_type_t](../types/common_type.html)<[std::ptrdiff_t](../types/ptrdiff_t.html),
                                     [std::make_signed_t](../types/make_signed.html)<decltype(c.size())>>;
        return static_cast<R>(c.size());
    }  
  
[size (3)](size.html#Version_3)  
      
    
    template<class T, [std::size_t](../types/size_t.html) N>
    constexpr [std::size_t](../types/size_t.html) size(const T (&array)[N]) noexcept
    {
        return N;
    }  
  
[ssize (4)](size.html#Version_4)  
      
    
    template<class T, [std::ptrdiff_t](../types/ptrdiff_t.html) N>
    constexpr [std::ptrdiff_t](../types/ptrdiff_t.html) ssize(const T (&array)[N]) noexcept
    {
        return N;
    }  
...
Run this code
    ...
     
        ...
        [std::cout](../io/cout.html) << sizeof(str_decayed) << '\n'; // Prints the size of the pointer!
     
        // Since C++20 the signed size (std::ssize) is available
        auto i = std::ssize(v);
        for (--i; i != -1; --i)
            [std::cout](../io/cout.html) << v[i] << (i ? ' ' : '\n');
        [assert](../error/assert.html)(i == -1);
     
    ...
     
        ...
        static_assert([std::string](../string/basic_string.html)(symbols).size() == 10);
        [assert](../error/assert.html)([std::strlen](../string/byte/strlen.html)(symbols) == 10);
    }
