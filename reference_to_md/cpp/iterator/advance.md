...
If n is negative, the iterator is decremented. In this case, `InputIt` must meet the requirements of [LegacyBidirectionalIterator](../named_req/BidirectionalIterator.html "cpp/named req/BidirectionalIterator"), otherwise the behavior is undefined. 
...
[Non-constexpr version](advance.html#Version_1)  
---  
    ...
    {
        template<class It>
        void do_advance(It& it, typename [std::iterator_traits](iterator_traits.html)<It>::difference_type n,
                        [std::input_iterator_tag](iterator_tags.html))
        {
            while (n > 0)
            {
                --n;
    ...
     
        template<class It>
        void do_advance(It& it, typename [std::iterator_traits](iterator_traits.html)<It>::difference_type n,
                        [std::bidirectional_iterator_tag](iterator_tags.html))
        {
            while (n > 0)
            {
                --n;
    ...
     
        template<class It>
        void do_advance(It& it, typename [std::iterator_traits](iterator_traits.html)<It>::difference_type n,
                        [std::random_access_iterator_tag](iterator_tags.html))
        {
            it += n;
        }
    } // namespace detail
    ...
    {
        detail::do_advance(it, typename [std::iterator_traits](iterator_traits.html)<It>::difference_type(n),
                           typename [std::iterator_traits](iterator_traits.html)<It>::iterator_category());
    }  
  
[constexpr version](advance.html#Version_2)  
    ...
     
        auto dist = typename [std::iterator_traits](iterator_traits.html)<It>::difference_type(n);
        ...
        else
        {
            ...
            if constexpr ([std::is_base_of_v](../types/is_base_of.html)<[std::bidirectional_iterator_tag](iterator_tags.html), category>)
                while (dist < 0)
                {
                    ++dist;
                    --it;
