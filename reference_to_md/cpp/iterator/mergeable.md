...
---|---|---  
template< class I1, class I2, class Out, class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less),  
class Proj1 = [std::identity](../utility/functional/identity.html), class Proj2 = [std::identity](../utility/functional/identity.html) >  
concept mergeable =  
[std::input_iterator](input_iterator.html)<I1> &&  
[std::input_iterator](input_iterator.html)<I2> &&  
[std::weakly_incrementable](weakly_incrementable.html)<Out> &&  
[std::indirectly_copyable](indirectly_copyable.html)<I1, Out> &&  
[std::indirectly_copyable](indirectly_copyable.html)<I2, Out> &&  
[std::indirect_strict_weak_order](indirect_strict_weak_order.html)<Comp,  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I1, Proj1>,  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I2, Proj2>>; |  |  (since C++20)  
| |   
