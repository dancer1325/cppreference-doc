...
[std::input_or_output_iterator](input_or_output_iterator.html)<I> &&  
[std::indirectly_readable](indirectly_readable.html)<I> &&  
requires { typename /*ITER_CONCEPT*/<I>; } &&  
[std::derived_from](../concepts/derived_from.html)</*ITER_CONCEPT*/<I>, [std::input_iterator_tag](iterator_tags.html)>; |  |  (since C++20)  
| |   
  
The `input_iterator` concept is a refinement of [`input_or_output_iterator`](input_or_output_iterator.html "cpp/iterator/input or output iterator"), adding the requirement that the referenced values can be read (via [`indirectly_readable`](indirectly_readable.html "cpp/iterator/indirectly readable")) and the requirement that the iterator concept tag be present. 

## Contents

  * [1 Iterator concept determination](input_iterator.html#Iterator_concept_determination)
  * [2 Notes](input_iterator.html#Notes)
  * [3 Example](input_iterator.html#Example)
  * [4 See also](input_iterator.html#See_also)
...
(That is, [std::derived_from](../concepts/derived_from.html)</*ITER_CONCEPT*/<I>, [std::input_iterator_tag](iterator_tags.html)> is assumed to be true.) 
