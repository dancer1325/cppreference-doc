...
| **indirectly_unary_invocable indirectly_regular_unary_invocable**(C++20)(C++20)` `  
---  
...
[std::indirectly_readable](indirectly_readable.html)<I> &&  
[std::copy_constructible](../concepts/copy_constructible.html)<F> &&  
[std::invocable](../concepts/invocable.html)<F&, /*indirect-value-t*/<I>> &&  
[std::invocable](../concepts/invocable.html)<F&, [std::iter_reference_t](iter_t.html)<I>> &&  
[std::common_reference_with](../concepts/common_reference_with.html)<  
[std::invoke_result_t](../types/result_of.html)<F&, /*indirect-value-t*/<I>>,  
[std::invoke_result_t](../types/result_of.html)<F&, [std::iter_reference_t](iter_t.html)<I>>>; |  |  (since C++20)  
`std::indirectly_regular_unary_invocable` |  |   
template< class F, class I >  
concept indirectly_regular_unary_invocable =  
[std::indirectly_readable](indirectly_readable.html)<I> &&  
[std::copy_constructible](../concepts/copy_constructible.html)<F> &&  
[std::regular_invocable](../concepts/invocable.html)<F&, /*indirect-value-t*/<I>> &&  
[std::regular_invocable](../concepts/invocable.html)<F&, [std::iter_reference_t](iter_t.html)<I>> &&  
[std::common_reference_with](../concepts/common_reference_with.html)<  
[std::invoke_result_t](../types/result_of.html)<F&, /*indirect-value-t*/<I>>,  
[std::invoke_result_t](../types/result_of.html)<F&, [std::iter_reference_t](iter_t.html)<I>>>; |  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        auto ints  = std::[views::iota](../ranges/iota_view.html)(1, 10);
        auto print = [] (IntWrapper w) { [std::print](../io/print.html)("{} ", w.i); };
        auto wrap  = [] (int i) { return IntWrapper{i}; };
     
        using Proj = std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<decltype(ints.begin()), decltype(wrap)>;
     
    ...
     
        ...
        std::[ranges::for_each](../algorithm/ranges/for_each.html)(ints, print, wrap);
    }
...
---|---|---|---  
[P2609R3](https://wg21.link/P2609R3) | C++20  | some requirements were defined in terms of [std::iter_value_t](iter_t.html)<I>&  
which mishandled projections resulting in incompatibility with invocable F& | defined in terms of /*indirect-value-t*/<I>  
to correctly handle such projections   
[P2997R1](https://wg21.link/P2997R1) | C++20  | corresponding concepts required F& to satisfy [`invocable`](../concepts/invocable.html "cpp/concepts/invocable") and  
[`regular_invocable`](../concepts/invocable.html "cpp/concepts/invocable"), respectively, with [std::iter_common_reference_t](iter_t.html)<I> | does not require 
