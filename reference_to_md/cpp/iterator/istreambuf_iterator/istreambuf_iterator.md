...
constexpr istreambuf_iterator( [std::default_sentinel_t](../default_sentinel.html) ) noexcept; |  (2)  |  (since C++20)  
| (3) |   
istreambuf_iterator( [std::basic_istream](../../io/basic_istream.html)<CharT,Traits>& is ) throw(); |  | (until C++11)  
istreambuf_iterator( [std::basic_istream](../../io/basic_istream.html)<CharT,Traits>& is ) noexcept; |  |  (since C++11)  
| (4) |   
istreambuf_iterator( [std::basic_streambuf](../../io/basic_streambuf.html)<CharT,Traits>* s ) throw(); |  | (until C++11)  
istreambuf_iterator( [std::basic_streambuf](../../io/basic_streambuf.html)<CharT,Traits>* s ) noexcept; |  |  (since C++11)  
| (5) |   
istreambuf_iterator( const /* proxy */& p ) throw(); |  | (until C++11)  
istreambuf_iterator( const /* proxy */& p ) noexcept; |  |  (since C++11)  
istreambuf_iterator( const istreambuf_iterator& ) noexcept = default; |  (6)  |  (since C++11)  
| |   
