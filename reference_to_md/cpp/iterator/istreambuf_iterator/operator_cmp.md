...
Member functions  
---  
[istreambuf_iterator::istreambuf_iterator](istreambuf_iterator.html "cpp/iterator/istreambuf iterator/istreambuf iterator")  
[istreambuf_iterator::operator*](operator*.html "cpp/iterator/istreambuf iterator/operator*")  
[istreambuf_iterator::operator++istreambuf_iterator::operator++(int)](operator_arith.html "cpp/iterator/istreambuf iterator/operator arith")  
[istreambuf_iterator::equal](equal.html "cpp/iterator/istreambuf iterator/equal")  
...
bool operator==( const [std::istreambuf_iterator](../istreambuf_iterator.html)<CharT,Traits>& lhs,  
const [std::istreambuf_iterator](../istreambuf_iterator.html)<CharT,Traits>& rhs ); |  (1)  |   
template< class CharT, class Traits >  
bool operator!=( const [std::istreambuf_iterator](../istreambuf_iterator.html)<CharT,Traits>& lhs,  
const [std::istreambuf_iterator](../istreambuf_iterator.html)<CharT,Traits>& rhs ); |  (2)  |  (until C++20)  
friend bool operator==( const istreambuf_iterator& lhs,  
[std::default_sentinel_t](../default_sentinel.html) ); |  (3)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/istreambuf_iterator/operator_cmp&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  stream buffer iterators to compare   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/istreambuf_iterator/operator_cmp&action=edit&section=2 "Edit section: Return value")] Return value
