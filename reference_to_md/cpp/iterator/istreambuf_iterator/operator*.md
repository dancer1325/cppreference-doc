...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/istreambuf_iterator/operator*&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/istreambuf_iterator/operator*&action=edit&section=2 "Edit section: Return value")] Return value
