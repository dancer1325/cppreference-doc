...
---|---|---  
template< class Iter >  
[std::reverse_iterator](reverse_iterator.html)<Iter> make_reverse_iterator( Iter i ); |  | (since C++14)   
(constexpr since C++17)  
| |   
  
`make_reverse_iterator` is a convenience function template that constructs a [std::reverse_iterator](reverse_iterator.html "cpp/iterator/reverse iterator") for the given iterator i (which must be a [LegacyBidirectionalIterator](../named_req/BidirectionalIterator.html "cpp/named req/BidirectionalIterator")) with the type deduced from the type of the argument. 

## Contents

  * [1 Parameters](make_reverse_iterator.html#Parameters)
  * [2 Return value](make_reverse_iterator.html#Return_value)
  * [3 Notes](make_reverse_iterator.html#Notes)
  * [4 Example](make_reverse_iterator.html#Example)
  * [5 See also](make_reverse_iterator.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v{1, 3, 10, 8, 22};
     
        [std::sort](../algorithm/sort.html)(v.begin(), v.end());
        [std::copy](../algorithm/copy.html)(v.begin(), v.end(), [std::ostream_iterator](ostream_iterator.html)<int>([std::cout](../io/cout.html), ", "));
        [std::cout](../io/cout.html) << '\n';
     
        [std::copy](../algorithm/copy.html)(std::make_reverse_iterator(v.end()),
