...
InputIt next( InputIt it, typename [std::iterator_traits](iterator_traits.html)<InputIt>::difference_type n = 1 ); |  | (since C++11)   
(until C++17)  
template< class InputIt >  
constexpr  
InputIt next( InputIt it, typename [std::iterator_traits](iterator_traits.html)<InputIt>::difference_type n = 1 ); |  |  (since C++17)  
| |   
...
## Contents
  ...
  * [7 Defect reports](next.html#Defect_reports)
  * [8 See also](next.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/next&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    InputIt next(InputIt it, typename [std::iterator_traits](iterator_traits.html)<InputIt>::difference_type n = 1)
    {
        [std::advance](advance.html)(it, n);
        return it;
    }  
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v{4, 5, 6};
     
        auto it = v.begin();
        auto nx = std::next(it, 2);
        [std::cout](../io/cout.html) << *it << ' ' << *nx << '\n';
     
        it = v.end();
        nx = std::next(it, -2);
        [std::cout](../io/cout.html) << ' ' << *nx << '\n';
    }
