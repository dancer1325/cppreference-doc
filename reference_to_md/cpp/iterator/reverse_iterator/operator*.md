...
---|---|---  
| (2) |   
pointer operator->() const; |  | (constexpr since C++17)   
(until C++20)  
constexpr pointer operator->() const  
requires ([std::is_pointer_v](../../types/is_pointer.html)<Iter> ||  
requires (const Iter i) { i.operator->(); }); |  |  (since C++20)  
| |   
  
Returns a reference or pointer to the element previous to `[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`. 

Member function  | Equivalent to   
---|---  
operator* | Iter tmp =` ``[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`; return *--tmp;  
operator-> |  |  return &(operator*()); | (until C++11)  
---|---  
return [std::addressof](../../memory/addressof.html)(operator*()); | (since C++11)  
(until C++20)  
  
  * return` ``[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`` `- 1; if `Iter` is a pointer type 
  * return [std::prev](../prev.html)(`[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`).operator->(); otherwise 
...
## Contents
  ...
  * [2 Example](operator*.html#Example)
...
Run this code
    ...
    int main()
    {
        using RI0 = [std::reverse_iterator](../reverse_iterator.html)<int*>;
        int a[]{0, 1, 2, 3};
        RI0 r0{[std::rbegin](../rbegin.html)(a)};
        [std::cout](../../io/cout.html) << "*r0 = " << *r0 << '\n';
        *r0 = 42;
        [std::cout](../../io/cout.html) << "a[3] = " << a[3] << '\n';
     
        using RI1 = [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator>;
        [std::vector](../../container/vector.html)<int> vi{0, 1, 2, 3};
        RI1 r1{vi.rend() - 2};
        [std::cout](../../io/cout.html) << "*r1 = " << *r1 << '\n';
     
        using RI2 = [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<double>>::iterator>;
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<double>> vc{{1, 2}, {3, 4}, {5, 6}, {7, 8}};
        RI2 r2{vc.rbegin() + 1};
        [std::cout](../../io/cout.html) << "vc[2] = (" << r2->real() << ',' << r2->imag() << ")\n";
    }
