...
Assigns other.`[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")` to `[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`. 

This overload participates in overload resolution only if [std::is_same_v](../../types/is_same.html)<U, Iter> is false and both [std::convertible_to](../../concepts/convertible_to.html)<const U&, Iter> and [std::assignable_from](../../concepts/assignable_from.html)<Iter&, const U&> are modeled.  | (since C++20)  
---|---  
...
Run this code
    ...
    int main()
    {
        ...
        short a3[]{40, 41, 42};
     
        [std::reverse_iterator](../reverse_iterator.html)<const int*> it1{[std::crbegin](../rbegin.html)(a1)};
        it1 = [std::reverse_iterator](../reverse_iterator.html)<int*>{[std::rbegin](../rbegin.html)(a2)};   // OK
    //  it1 = std::reverse_iterator<short*>{std::rbegin(a3)}; // Compilation error:
                                                              // incompatible pointer types
        [std::reverse_iterator](../reverse_iterator.html)<const short*> it2{nullptr};
        it2 = [std::rbegin](../rbegin.html)(a3); // OK
