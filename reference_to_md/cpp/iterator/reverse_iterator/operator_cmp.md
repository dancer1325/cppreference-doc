...
bool operator==( const [std::reverse_iterator](../reverse_iterator.html)<Iter1>& lhs,  
const [std::reverse_iterator](../reverse_iterator.html)<Iter2>& rhs ); |  (1) | (constexpr since C++17)  
template< class Iter1, class Iter2 >  
bool operator!=( const [std::reverse_iterator](../reverse_iterator.html)<Iter1>& lhs,  
const [std::reverse_iterator](../reverse_iterator.html)<Iter2>& rhs ); |  (2) | (constexpr since C++17)  
template< class Iter1, class Iter2 >  
bool operator< ( const [std::reverse_iterator](../reverse_iterator.html)<Iter1>& lhs,  
const [std::reverse_iterator](../reverse_iterator.html)<Iter2>& rhs ); |  (3) | (constexpr since C++17)  
template< class Iter1, class Iter2 >  
bool operator<=( const [std::reverse_iterator](../reverse_iterator.html)<Iter1>& lhs,  
const [std::reverse_iterator](../reverse_iterator.html)<Iter2>& rhs ); |  (4) | (constexpr since C++17)  
template< class Iter1, class Iter2 >  
bool operator> ( const [std::reverse_iterator](../reverse_iterator.html)<Iter1>& lhs,  
const [std::reverse_iterator](../reverse_iterator.html)<Iter2>& rhs ); |  (5) | (constexpr since C++17)  
template< class Iter1, class Iter2 >  
bool operator>=( const [std::reverse_iterator](../reverse_iterator.html)<Iter1>& lhs,  
const [std::reverse_iterator](../reverse_iterator.html)<Iter2>& rhs ); |  (6) | (constexpr since C++17)  
...
operator<=>( const [std::reverse_iterator](../reverse_iterator.html)<Iter1>& lhs,  
const [std::reverse_iterator](../reverse_iterator.html)<Iter2>& rhs ); |  (7)  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        ...
        [std::reverse_iterator](../reverse_iterator.html)<int*>
            x{[std::rend](../rend.html)(a) - [std::size](../size.html)(a)},
            y{[std::rend](../rend.html)(a) - [std::size](../size.html)(a)},
            z{[std::rbegin](../rbegin.html)(a) + 1};
     
        // two-way comparisons
