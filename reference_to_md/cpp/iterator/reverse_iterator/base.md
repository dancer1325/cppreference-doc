...
Run this code
    ...
     
        using RevIt = [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator>;
     
        const auto it = v.begin() + 3;
        RevIt r_it{it};
     
        [std::cout](../../io/cout.html) << "*it == " << *it << '\n'
                  << "*r_it == " << *r_it << '\n'
                  << "*r_it.base() == " << *r_it.base() << '\n'
