...
---|---  
(1) | \--`[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`; return *this;  
(2) | ++`[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`; return *this;  
(3) |  reverse_iterator tmp = *this; \--`[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`; return tmp;  
(4) | reverse_iterator tmp = *this; ++`[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`; return tmp;  
(5) | return reverse_iterator(`[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`` `- n);  
(6) | return reverse_iterator(`[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`` `+ n);  
(7) | `[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`` `-= n; return *this;  
(8) | `[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`` `+= n; return *this;  
...
Run this code
    ...
    int main()
    {
        ...
        auto rv = [std::reverse_iterator](../reverse_iterator.html){v.rbegin()};
        [std::cout](../../io/cout.html) << *(++rv) << ' '; // 3
        [std::cout](../../io/cout.html) << *(--rv) << ' '; // 4
        [std::cout](../../io/cout.html) << *(rv + 3) << ' '; // 1
        rv += 3;
        [std::cout](../../io/cout.html) << rv[0] << ' '; // 1
        rv -= 3;
        [std::cout](../../io/cout.html) << rv[0] << '\n'; // 4
     
        [std::list](../../container/list.html) l{5, 6, 7, 8};
        auto rl = [std::reverse_iterator](../reverse_iterator.html){l.rbegin()};
        [std::cout](../../io/cout.html) << *(++rl) << ' '; // OK: 3
        [std::cout](../../io/cout.html) << *(--rl) << '\n'; // OK: 4
