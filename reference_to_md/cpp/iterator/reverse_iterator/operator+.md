...
const reverse_iterator<Iter>& it ); |  | (constexpr since C++17)   
(until C++23)  
template< class Iter >   
constexpr reverse_iterator<Iter> operator+  
( [std::iter_difference_t](../iter_t.html)<Iter> n, const reverse_iterator<Iter>& it ); |  |  (since C++23)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator%2B&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  the number of positions to increment the iterator   
---|---|---  
it  |  \-  |  the iterator adaptor to increment   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator%2B&action=edit&section=2 "Edit section: Return value")] Return value

reverse_iterator<Iter>(it.base() - n)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator%2B&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    {
        {
            [std::vector](../../container/vector.html) v{0, 1, 2, 3};
            [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator>
                ri1{[std::reverse_iterator](../reverse_iterator.html){v.rbegin()}};
            [std::cout](../../io/cout.html) << *ri1 << ' '; // 3
            [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator> ri2{2 + ri1};
            [std::cout](../../io/cout.html) << *ri2 << ' '; // 1
        }
     
        {
            [std::list](../../container/list.html) l{5, 6, 7, 8};
            [std::reverse_iterator](../reverse_iterator.html)<[std::list](../../container/list.html)<int>::iterator>
                ri1{[std::reverse_iterator](../reverse_iterator.html){l.rbegin()}};
            [std::cout](../../io/cout.html) << *ri1 << '\n'; // 8
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator%2B&action=edit&section=4 "Edit section: See also")] See also
