...
[reverse_iterator::operator=](operator=.html "cpp/iterator/reverse iterator/operator=")  
[reverse_iterator::base](base.html "cpp/iterator/reverse iterator/base")  
[reverse_iterator::operator*reverse_iterator::operator->](operator*.html "cpp/iterator/reverse iterator/operator*")  
[reverse_iterator::operator[]](operator_at.html "cpp/iterator/reverse iterator/operator at")  
[reverse_iterator::operator++reverse_iterator::operator+reverse_iterator::operator+=reverse_iterator::operator--reverse_iterator::operator-reverse_iterator::operator-=](operator++.html "cpp/iterator/reverse iterator/operator arith")  
[Non-member functions](../reverse_iterator.html#Non-member_functions "cpp/iterator/reverse iterator")  
[operator==operator!=operator<operator<=operator>operator>=operator<=>](operator_cmp.html "cpp/iterator/reverse iterator/operator cmp")(C++20)  
[operator+](operator+.html "cpp/iterator/reverse iterator/operator+")  
[operator-](operator-.html "cpp/iterator/reverse iterator/operator-")  
[iter_move](iter_move.html "cpp/iterator/reverse iterator/iter move")(C++20)  
...
reverse_iterator(); |  (1) | (constexpr since C++17)  
---|---|---  
explicit reverse_iterator( iterator_type x ); |  (2) | (constexpr since C++17)  
template< class U >  
reverse_iterator( const reverse_iterator<U>& other ); |  (3) | (constexpr since C++17)  
| |   
  
Constructs a new `reverse_iterator`. 

Overload  | `[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`  
---|---  
(1) | [value-initialized](../../language/value_initialization.html "cpp/language/value initialization")  
(2) | initialized with x  
(3) |  initialized with other.`[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")`  
  
3) The converting constructor.  This overload participates in overload resolution only if [std::is_same_v](../../types/is_same.html)<U, Iter> is false and [std::convertible_to](../../concepts/convertible_to.html)<const U&, Iter> is modeled.  | (since C++20)  
---|---  
  
## Contents

  * [1 Parameters](reverse_iterator.html#Parameters)
  * [2 Example](reverse_iterator.html#Example)
  * [3 Defect reports](reverse_iterator.html#Defect_reports)
  * [4 See also](reverse_iterator.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/reverse_iterator&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  iterator to adapt   
---|---|---  
other  |  \-  |  iterator adaptor to copy   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/reverse_iterator&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html) v{0, 1, 2, 3, 4};
     
        using ReverseIt = [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<int>::const_iterator>;
     
        ReverseIt i1; // overload (1)
        i1 = v.crbegin();
        [assert](../../error/assert.html)(*i1 == 4);
     
        ReverseIt i2(i1); // overload (2)
        [assert](../../error/assert.html)(i2[0] == 4);
     
        int x[]{1, 2, 3};
        auto i3 = [std::reverse_iterator](../reverse_iterator.html)<int*>(x + [std::size](../size.html)(x)); // overload (1)
        i3[0] = -3;
        [assert](../../error/assert.html)(x[2] == -3);
        [std::reverse_iterator](../reverse_iterator.html)<int const*> i4(i3); // overload (3): int => const int
        static_assert([std::convertible_to](../../concepts/convertible_to.html)<decltype(i3)::value_type,
                                          decltype(i4)::value_type>);
        // i4[0] = 5; // Error: assignment of read-only location
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/reverse_iterator&action=edit&section=3 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 235](https://cplusplus.github.io/LWG/issue235) | C++98  | the effect of overload ([1](reverse_iterator.html#Version_1)) was not specified  | specified   
[LWG 1012](https://cplusplus.github.io/LWG/issue1012) | C++98  | overload ([1](reverse_iterator.html#Version_1)) default-initialized `[current](../reverse_iterator.html#current "cpp/iterator/reverse iterator")` | it is value-initialized   
[LWG 3435](https://cplusplus.github.io/LWG/issue3435) | C++20  | overload ([3](reverse_iterator.html#Version_3)) was not constrained  | constrained   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/reverse_iterator&action=edit&section=4 "Edit section: See also")] See also

[ operator=](operator=.html "cpp/iterator/reverse iterator/operator=") |  assigns another `reverse_iterator`   
...
---|---  
[ make_reverse_iterator](../make_reverse_iterator.html "cpp/iterator/make reverse iterator")(C++14) |  creates a [std::reverse_iterator](../reverse_iterator.html "cpp/iterator/reverse iterator") of type inferred from the argument   
