...
---  
[reverse_iterator::reverse_iterator](reverse_iterator.html "cpp/iterator/reverse iterator/reverse iterator")  
...
const reverse_iterator<Iter2>& rhs ); |  |  (until C++11)  
template< class Iter1, class Iter2 >  
auto operator-( const reverse_iterator<Iter1>& lhs,  
const reverse_iterator<Iter2>& rhs )  
-> decltype(rhs.base() - lhs.base()); |  | (since C++11)   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator-&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  iterator adaptors to compute the difference of   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator-&action=edit&section=2 "Edit section: Return value")] Return value

rhs.base() - lhs.base()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator-&action=edit&section=3 "Edit section: Notes")] Notes

operator- returns rhs.base() - lhs.base() rather than lhs.base() - rhs.base() because this is a reverse iterator. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator-&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html) vec{0, 1, 2, 3};
        [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator>
            vec_ri1{[std::reverse_iterator](../reverse_iterator.html){vec.rbegin()}},
            vec_ri2{[std::reverse_iterator](../reverse_iterator.html){vec.rend()}};
        [std::cout](../../io/cout.html) << (vec_ri2 - vec_ri1) << ' '; // 4
        [std::cout](../../io/cout.html) << (vec_ri1 - vec_ri2) << '\n'; // -4
     
        [std::list](../../container/list.html) lst{5, 6, 7, 8};
        [std::reverse_iterator](../reverse_iterator.html)<[std::list](../../container/list.html)<int>::iterator>
            lst_ri1{[std::reverse_iterator](../reverse_iterator.html){lst.rbegin()}},
            lst_ri2{[std::reverse_iterator](../reverse_iterator.html){lst.rend()}};
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator-&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 280](https://cplusplus.github.io/LWG/issue280) | C++98  | heterogeneous subtraction was not allowed  | allowed   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/operator-&action=edit&section=6 "Edit section: See also")] See also

[ operator++operator++(int)operator+=operator+operator--operator--(int)operator-=operator-](operator++.html "cpp/iterator/reverse iterator/operator arith") |  advances or decrements the `reverse_iterator`   
