...
Run this code
    ...
    {
        int a[]{0, 1, 2, 3};
        [std::reverse_iterator](../reverse_iterator.html)<int*> iter1{[std::rbegin](../rbegin.html)(a)};
        for ([std::size_t](../../types/size_t.html) i{}; i != [std::size](../size.html)(a); ++i)
            [std::cout](../../io/cout.html) << iter1[i] << ' '; // decltype(iter1[i]) is int&
        [std::cout](../../io/cout.html) << '\n';
     
        [std::vector](../../container/vector.html) v{0, 1, 2, 3};
        [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator> iter2{[std::rbegin](../rbegin.html)(v)};
        for ([std::size_t](../../types/size_t.html) i{}; i != [std::size](../size.html)(v); ++i)
            [std::cout](../../io/cout.html) << iter2[i] << ' '; // decltype(iter2[i]) is int&
        [std::cout](../../io/cout.html) << '\n';
     
        // constexpr context
        constexpr static [std::array](../../container/array.html)<int, 4> z{0, 1, 2, 3};
        constexpr [std::reverse_iterator](../reverse_iterator.html)<decltype(z)::const_iterator> iter3{[std::crbegin](../rbegin.html)(z)};
        static_assert(iter3[1] == 2);
     
        [std::list](../../container/list.html) li{0, 1, 2, 3};
        [std::reverse_iterator](../reverse_iterator.html)<[std::list](../../container/list.html)<int>::iterator> iter4{[std::rbegin](../rbegin.html)(li)};
        *iter4 = 42;   // OK
