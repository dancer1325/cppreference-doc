...
[istream_iterator::operator++istream_iterator::operator++(int)](operator_arith.html "cpp/iterator/istream iterator/operator arith")  
...
constexpr istream_iterator( [std::default_sentinel_t](../default_sentinel.html) ); |  (2)  |  (since C++20)  
istream_iterator( istream_type& stream ); |  (3)  |   
| (4) |   
istream_iterator( const istream_iterator& other ); |  | (until C++11)  
istream_iterator( const istream_iterator& other ) = default; |  |  (since C++11)  
| |   
...
4) Constructs a copy of other. If [std::is_trivially_copy_constructible](../../types/is_copy_constructible.html)<T>::value is true, this copy constructor is a trivial copy constructor.(since C++11)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/istream_iterator/istream_iterator&action=edit&section=1 "Edit section: Parameters")] Parameters

stream  |  \-  |  stream to initialize the `istream_iterator` with   
---|---|---  
other  |  \-  |  another `istream_iterator` of the same type   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/istream_iterator/istream_iterator&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::istringstream](../../io/basic_istringstream.html) stream("1 2 3 4 5");
        [std::copy](../../algorithm/copy.html)(
            [std::istream_iterator](../istream_iterator.html)<int>(stream),
            [std::istream_iterator](../istream_iterator.html)<int>(),
            [std::ostream_iterator](../ostream_iterator.html)<int>([std::cout](../../io/cout.html), " ")
        );
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/istream_iterator/istream_iterator&action=edit&section=3 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 1280](https://cplusplus.github.io/LWG/issue1280) | C++98  | overload (3) stored stream directly  | stores its address instead   
