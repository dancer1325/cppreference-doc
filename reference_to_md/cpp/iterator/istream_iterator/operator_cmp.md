...
bool operator==( const [std::istream_iterator](../istream_iterator.html)<T, CharT, Traits, Dist>& lhs,  
const [std::istream_iterator](../istream_iterator.html)<T, CharT, Traits, Dist>& rhs ); |  (1)  |   
template< class T, class CharT, class Traits, class Dist >  
bool operator!=( const [std::istream_iterator](../istream_iterator.html)<T, CharT, Traits, Dist>& lhs,  
const [std::istream_iterator](../istream_iterator.html)<T, CharT, Traits, Dist>& rhs ); |  (2)  |  (until C++20)  
friend bool operator==( const istream_iterator& i, [std::default_sentinel_t](../default_sentinel.html) ); |  (3)  |  (since C++20)  
| |   
...
2) true if lhs is _not equal to_ rhs, false otherwise.
...
---|---|---|---  
[LWG 261](https://cplusplus.github.io/LWG/issue261) | C++98  | the description of `operator!=` was missing  | added 
