...
[Member functions](../common_iterator.html#Member_functions "cpp/iterator/common iterator")  
---  
[common_iterator::common_iterator](common_iterator.html "cpp/iterator/common iterator/common iterator")  
[common_iterator::operator=](operator=.html "cpp/iterator/common iterator/operator=")  
[common_iterator::operator*common_iterator::operator->](operator*.html "cpp/iterator/common iterator/operator*")  
[common_iterator::operator++common_iterator::operator++(int)](operator_arith.html "cpp/iterator/common iterator/operator arith")  
[Non-member functions](../common_iterator.html#Non-member_functions "cpp/iterator/common iterator")  
[operator==](operator_cmp.html "cpp/iterator/common iterator/operator cmp")(C++20)  
[operator-](operator-.html "cpp/iterator/common iterator/operator-")(C++20)  
[iter_move](iter_move.html "cpp/iterator/common iterator/iter move")(C++20)  
[iter_swap](iter_swap.html "cpp/iterator/common iterator/iter swap")(C++20)  
[Helper classes](../common_iterator.html#Helper_classes "cpp/iterator/common iterator")  
...
---|---|---  
template< [std::input_iterator](../input_iterator.html) I, class S >  
struct iterator_traits<[std::common_iterator](../common_iterator.html)<I, S>>; |  |  (since C++20)  
| |   
  
Provides the uniform interface to the properties of the [std::common_iterator](../common_iterator.html "cpp/iterator/common iterator") type. 

## Contents

  * [1 Member types](iterator_traits.html#Member_types)
  * [2 Example](iterator_traits.html#Example)
  * [3 Defect reports](iterator_traits.html#Defect_reports)
  * [4 See also](iterator_traits.html#See_also)
...
`iterator_concept` | 
  ...
  * [std::forward_iterator_tag](../iterator_tags.html "cpp/iterator/iterator tags"), if `I` models [std::forward_iterator](../forward_iterator.html "cpp/iterator/forward iterator"). 
...
(conditionally present) | 
  ...
  * Not defined, if [std::iter_difference_t](../iter_t.html)<I> is not an integral type. 
  * [std::forward_iterator_tag](../iterator_tags.html "cpp/iterator/iterator tags") otherwise, if [std::iterator_traits](../iterator_traits.html)<I>::iterator_category is valid and denotes a type that models [std::derived_from](../../concepts/derived_from.html)<[std::forward_iterator_tag](../iterator_tags.html)>. 
  * [std::input_iterator_tag](../iterator_tags.html "cpp/iterator/iterator tags") otherwise. 

  
`value_type` |  [std::iter_value_t](../iter_t.html)<I>  
`difference_type` |  [std::iter_difference_t](../iter_t.html)<I>  
`pointer` | 

  * decltype(c.operator->()), if it is well-formed (where c is an lvalue of type const [std::common_iterator](../common_iterator.html)<I, S>). 
  * void otherwise. 
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html) v{1, 2, 3, 4};
        using CV = [std::common_iterator](../common_iterator.html)<
                        [std::counted_iterator](../counted_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator>,
                        [std::default_sentinel_t](../default_sentinel.html)>;
        CV i{[std::counted_iterator](../counted_iterator.html){v.begin(), 3}};
        using TRCV = [std::iterator_traits](../iterator_traits.html)<decltype(i)>;
        static_assert([std::is_same](../../types/is_same.html)<TRCV::iterator_concept, [std::forward_iterator_tag](../iterator_tags.html)>());
        static_assert([std::is_same](../../types/is_same.html)<TRCV::iterator_category, [std::forward_iterator_tag](../iterator_tags.html)>());
        static_assert([std::is_same](../../types/is_same.html)<TRCV::value_type, int>());
        static_assert([std::is_same](../../types/is_same.html)<TRCV::difference_type,
                      [std::vector](../../container/vector.html)<int>::difference_type>());
        static_assert([std::is_same](../../types/is_same.html)<TRCV::pointer, decltype(i.operator->())>());
        static_assert([std::is_same](../../types/is_same.html)<TRCV::reference, int&>());
     
        CV s{[std::default_sentinel](../default_sentinel.html)};
        using TRCS = [std::iterator_traits](../iterator_traits.html)<decltype(s)>;
        static_assert([std::is_same](../../types/is_same.html)<TRCS::iterator_concept, [std::forward_iterator_tag](../iterator_tags.html)>());
        static_assert([std::is_same](../../types/is_same.html)<TRCS::iterator_category, [std::forward_iterator_tag](../iterator_tags.html)>());
        static_assert([std::is_same](../../types/is_same.html)<TRCS::value_type, int>());
        static_assert([std::is_same](../../types/is_same.html)<TRCS::difference_type,
                      [std::vector](../../container/vector.html)<int>::difference_type>());
        static_assert([std::is_same](../../types/is_same.html)<TRCS::pointer, decltype(s.operator->())>());
...
---|---|---|---  
[LWG 3749](https://cplusplus.github.io/LWG/issue3749) | C++20  | if [std::iter_difference_t](../iter_t.html)<I> is not an integer type,  
