...
struct incrementable_traits<[std::common_iterator](../common_iterator.html)<I, S>> {  
...
Run this code
    ...
    int main()
    {
        ...
        using CL = [std::common_iterator](../common_iterator.html)<
                       [std::counted_iterator](../counted_iterator.html)<[std::list](../../container/list.html)<[std::string](../../string/basic_string.html)>::iterator>,
                       [std::default_sentinel_t](../default_sentinel.html)>;
        CL cl{[std::default_sentinel](../default_sentinel.html)};
        static_assert(
            [std::same_as](../../concepts/same_as.html)<[std::incrementable_traits](../incrementable_traits.html)<CI>::difference_type, [std::ptrdiff_t](../../types/ptrdiff_t.html)> &&
            [std::same_as](../../concepts/same_as.html)<[std::incrementable_traits](../incrementable_traits.html)<CL>::difference_type, [std::ptrdiff_t](../../types/ptrdiff_t.html)> &&
            [std::same_as](../../concepts/same_as.html)<[std::incrementable_traits](../incrementable_traits.html)<decltype(cl)>::difference_type,
