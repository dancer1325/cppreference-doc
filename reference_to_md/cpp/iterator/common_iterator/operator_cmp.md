...
const [std::common_iterator](../common_iterator.html)<I2, S2>& y ); |  (1)  |  (since C++20)  
---|---|---  
template <class I2, [std::sentinel_for](../sentinel_for.html)<I> S2>  
requires [std::sentinel_for](../sentinel_for.html)<S, I2> && [std::equality_comparable_with](../../concepts/equality_comparable.html)<I, I2>  
friend constexpr bool operator==( const common_iterator& x,   
const [std::common_iterator](../common_iterator.html)<I2, S2>& y ); |  (2)  |  (since C++20)  
| |   
  
Compares the iterators and/or sentinels held by underlying [std::variant](../../utility/variant.html "cpp/utility/variant") member objects `_var_`. Two incomparable iterators or two sentinels are considered equal. 
...
Run this code
    ...
     
        using CI = [std::common_iterator](../common_iterator.html)<
                       [std::counted_iterator](../counted_iterator.html)<int*>,
                       [std::default_sentinel_t](../default_sentinel.html)
                       >;
     
        CI i1{[std::counted_iterator](../counted_iterator.html){a + 0, 2}};
        CI i2{[std::counted_iterator](../counted_iterator.html){a + 1, 2}};
        CI i3{[std::counted_iterator](../counted_iterator.html){a + 0, 3}};
        CI i4{[std::counted_iterator](../counted_iterator.html){a + 0, 0}};
        CI s1{[std::default_sentinel](../default_sentinel.html)};
        CI s2{[std::default_sentinel](../default_sentinel.html)};
     
        [assert](../../error/assert.html)((i1 == i2) == true);
        [assert](../../error/assert.html)((i1 == i3) == false);
        [assert](../../error/assert.html)((i2 == i3) == false);
        [assert](../../error/assert.html)((s1 == s2) == true);
        [assert](../../error/assert.html)((i1 == s1) == false);
