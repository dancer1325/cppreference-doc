...
requires /* see description */; |  (3)  |  (since C++20)  
Helper types |  |   
class /*proxy*/ {  
[std::iter_value_t](../iter_t.html)<I> keep_;  
constexpr proxy([std::iter_reference_t](../iter_t.html)<I>&& x)  
: keep_(std::move(x)) {}  
public:  
constexpr const [std::iter_value_t](../iter_t.html)<I>* operator->() const noexcept {  
return [std::addressof](../../memory/addressof.html)(keep_);  
}  
}; |  (4)  |  (exposition only*)  
| |   
...
3) Returns a pointer or underlying iterator to the current element, or a proxy holding it: 
  ...
  * Otherwise, equivalent to auto&& tmp = *it; return [std::addressof](../../memory/addressof.html)(tmp);, if [std::iter_reference_t](../iter_t.html)<I> is a reference type. 
  * Otherwise, equivalent to return proxy(*it);, where `_proxy_` is an exposition only class (4).



The expression in the `requires`-clause is equivalent to  
[std::indirectly_readable](../indirectly_readable.html)<const I> && (  


requires(const I& i) { i.operator->(); } ||  
[std::is_reference_v](../../types/is_reference.html)<[std::iter_reference_t](../iter_t.html)<I>> ||  
[std::constructible_from](../../concepts/constructible_from.html)<[std::iter_value_t](../iter_t.html)<I>, [std::iter_reference_t](../iter_t.html)<I>>  
...
Run this code
    ...
     
        using CI = [std::common_iterator](../common_iterator.html)<
            [std::counted_iterator](../counted_iterator.html)<decltype(il)::iterator>,
            [std::default_sentinel_t](../default_sentinel.html)>;
     
        CI ci{[std::counted_iterator](../counted_iterator.html){[std::next](../next.html)(begin(il), 1), [std::ssize](../size.html)(il) - 1}};
     
        [std::cout](../../io/cout.html) << *ci << ' ' << ci->real() << '\n';
    }
