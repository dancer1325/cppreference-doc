...
Helper types |  |   
class /*postfix_proxy*/ {  
[std::iter_value_t](../iter_t.html)<I> keep_;  
constexpr postfix_proxy([std::iter_reference_t](../iter_t.html)<I>&& x)  
: keep_([std::forward](../../utility/forward.html)<[std::iter_reference_t](../iter_t.html)<I>>(x)) {}  
public:  
constexpr const [std::iter_value_t](../iter_t.html)<I>& operator*() const noexcept {  
return keep_;  
}  
}; |  (3)  |  (exposition only*)  
| |   
...
The behavior is undefined if the underlying [std::variant](../../utility/variant.html "cpp/utility/variant") member object `_var_` does not hold an object of type `I`, i.e. [std::holds_alternative](../../utility/variant/holds_alternative.html)<I>(var) is equal to false. 

Let `it` denote the iterator of type `I` held by `_var_`, that is std::get<I>(var). 

1) Pre-increments by one. Equivalent to ++it; return *this;.

2) Post-increments by one: 

  * Equivalent to: auto tmp = *this; ++*this; return tmp;, if I models [`forward_iterator`](../forward_iterator.html "cpp/iterator/forward iterator"). 
  ...
  * [std::indirectly_readable](../indirectly_readable.html)<I> or 
  * [std::constructible_from](../../concepts/constructible_from.html)<[std::iter_value_t](../iter_t.html)<I>, [std::iter_reference_t](../iter_t.html)<I>> or 
  * [std::move_constructible](../../concepts/move_constructible.html)<[std::iter_value_t](../iter_t.html)<I>>



     is false. 

  * Equivalent to: postfix_proxy p(**this); ++*this; return p; otherwise, where `_postfix_proxy_` is an exposition only helper type (3).
...
## Contents
  ...
  * [4 Defect reports](operator_arith.html#Defect_reports)
...
Run this code
    ...
     
        using CI = [std::common_iterator](../common_iterator.html)<
                       [std::counted_iterator](../counted_iterator.html)<[std::initializer_list](../../utility/initializer_list.html)<int>::iterator>,
                       [std::default_sentinel_t](../default_sentinel.html)
                       >;
     
        CI first{[std::counted_iterator](../counted_iterator.html){[std::begin](../begin.html)(il), [std::ssize](../size.html)(il) - 2}};
     
        for (; first != [std::default_sentinel](../default_sentinel.html); ++first)
...
---|---|---|---  
[P2259R1](https://wg21.link/P2259R1) | C++20  | post increment might discard its result in more situations  | a proxy class is used to keep the result   
[LWG 3546](https://cplusplus.github.io/LWG/issue3546) | C++20  | initialization of the proxy object was sometimes ill-formed  | situation and definition adjusted   
