...
const [std::common_iterator](../common_iterator.html)<I2, S2>& y ) noexcept(/*see below*/); |  |  (since C++20)  
---|---|---  
| |   
...
The function body is equivalent to [ranges::iter_swap](../ranges/iter_swap.html)(std::get<I>(x.var), std::get<I2>(y.var)). 
...
## Contents
  ...
  * [4 Exceptions](iter_swap.html#Exceptions)
  * [5 Example](iter_swap.html#Example)
  * [6 Defect reports](iter_swap.html#Defect_reports)
  * [7 See also](iter_swap.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)> v1{"1", "2", "3", "4", "5"},
                                 v2{"α", "β", "γ", "δ", "ε"};
     
        using CI = [std::common_iterator](../common_iterator.html)<
                       [std::counted_iterator](../counted_iterator.html)<[std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)>::iterator>,
                       [std::default_sentinel_t](../default_sentinel.html)
                       >;
     
        CI first1{[std::counted_iterator](../counted_iterator.html){v1.begin(), 3}};
        CI first2{[std::counted_iterator](../counted_iterator.html){v2.begin(), 4}};
        CI last{[std::default_sentinel](../default_sentinel.html)};
     
        auto print = [&](auto rem)
        {
            [std::cout](../../io/cout.html) << rem << "v1 = ";
            std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(v1, [std::ostream_iterator](../ostream_iterator.html)<[std::string](../../string/basic_string.html)>{[std::cout](../../io/cout.html), " "});
            [std::cout](../../io/cout.html) << "\nv2 = ";
            std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(v2, [std::ostream_iterator](../ostream_iterator.html)<[std::string](../../string/basic_string.html)>{[std::cout](../../io/cout.html), " "});
            [std::cout](../../io/cout.html) << '\n';
        };
     
