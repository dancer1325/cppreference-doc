...
template< class C >  
auto rbegin( C& c ) -> decltype(c.rbegin()); |  (1) | (since C++14)   
(constexpr since C++17)  
template< class C >  
auto rbegin( const C& c ) -> decltype(c.rbegin()); |  (2) | (since C++14)   
(constexpr since C++17)  
template< class T, [std::size_t](../types/size_t.html) N >  
[std::reverse_iterator](reverse_iterator.html)<T*> rbegin( T (&array)[N] ); |  (3) | (since C++14)   
(constexpr since C++17)  
template< class T >  
[std::reverse_iterator](reverse_iterator.html)<const T*> rbegin( [std::initializer_list](../utility/initializer_list.html)<T> il ); |  (4) | (since C++14)   
(constexpr since C++17)  
template< class C >  
auto crbegin( const C& c ) -> decltype(std::rbegin(c)); |  (5) | (since C++14)   
(constexpr since C++17)  
| |   
...
1) If `C` is a standard [Container](../named_req/Container.html "cpp/named req/Container"), returns a `C::reverse_iterator` object.

2) If `C` is a standard [Container](../named_req/Container.html "cpp/named req/Container"), returns a `C::const_reverse_iterator` object.

3) Returns a [std::reverse_iterator](reverse_iterator.html)<T*> object to the reverse-beginning of array.

4) Returns a [std::reverse_iterator](reverse_iterator.html)<const T*> object to the reverse-beginning of il.

5) Returns std::rbegin(c), with c always treated as const-qualified.

If `C` is a standard [Container](../named_req/Container.html "cpp/named req/Container"), returns a `C::const_reverse_iterator` object.
...
## Contents
  ...
  * [3 Exceptions](rbegin.html#Exceptions)
  * [4 Overloads](rbegin.html#Overloads)
  * [5 Notes](rbegin.html#Notes)
  * [6 Example](rbegin.html#Example)
  * [7 See also](rbegin.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/rbegin&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/rbegin&action=edit&section=2 "Edit section: Return value")] Return value

1,2) c.rbegin()

3) [std::reverse_iterator](reverse_iterator.html)<T*>(array + N)

4) [std::reverse_iterator](reverse_iterator.html)<const T*>(il.end())
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/rbegin&action=edit&section=3 "Edit section: Overloads")] Overloads
...
Overloads of `rbegin` found by [argument-dependent lookup](../language/adl.html "cpp/language/adl") can be used to customize the behavior of std::[ranges::rbegin](../ranges/rbegin.html) and [std::ranges::crbegin](../ranges/crbegin.html "cpp/ranges/crbegin").  | (since C++20)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/rbegin&action=edit&section=4 "Edit section: Notes")] Notes

The overload for [std::initializer_list](../utility/initializer_list.html "cpp/utility/initializer list") is necessary because it does not have a member function `rbegin`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/rbegin&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        for (auto it = std::rbegin(il); it != [std::rend](rend.html)(il); ++it)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/rbegin&action=edit&section=6 "Edit section: See also")] See also
