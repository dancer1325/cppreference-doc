...
Member functions  
---  
[insert_iterator::insert_iterator](insert_iterator/insert_iterator.html "cpp/iterator/insert iterator/insert iterator")  
...
class insert_iterator : public [std::iterator](iterator.html)<[std::output_iterator_tag](iterator_tags.html),  
void, void, void, void> |  |  (until C++17)  
template< class Container >  
class insert_iterator; |  |  (since C++17)  
| |   
  
`std::insert_iterator` is a [LegacyOutputIterator](../named_req/OutputIterator.html "cpp/named req/OutputIterator") that inserts elements into a container for which it was constructed, at the position pointed to by the supplied iterator. The container's `insert()` member function is called whenever the iterator (whether dereferenced or not) is assigned to. Incrementing the `std::insert_iterator` is a no-op. 

## Contents

  * [1 Member types](insert_iterator.html#Member_types)
  * [2 Member functions](insert_iterator.html#Member_functions)
  * [3 Member objects](insert_iterator.html#Member_objects)
  * [4 Example](insert_iterator.html#Example)
  * [5 See also](insert_iterator.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::list](../container/list.html)<int> l{-1, -2, -3};
        [std::copy](../algorithm/copy.html)(v.begin(), v.end(), // may be simplified with std::inserter
                  std::insert_iterator<[std::list](../container/list.html)<int>>(l, [std::next](next.html)(l.begin()))); 
        for (int n : l)
