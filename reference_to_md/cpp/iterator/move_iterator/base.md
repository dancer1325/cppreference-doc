...
## Contents
  ...
  * [1 Return value](base.html#Return_value)
  * [2 Example](base.html#Example)
  * [3 Defect reports](base.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        ...
        [std::move_iterator](../move_iterator.html)<[std::vector](../../container/vector.html)<int>::reverse_iterator>
            m1{v.rbegin()},
            m2{v.rend()};
     
        [std::copy](../../algorithm/copy.html)(m1.base(), m2.base(), [std::ostream_iterator](../ostream_iterator.html)<int>([std::cout](../../io/cout.html), " "));
