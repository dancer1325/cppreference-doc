...
template< class U >  
move_iterator( const move_iterator<U>& other ); |  (3) | (constexpr since C++17)  
| |   
  
Constructs a new `move_iterator`. 

Overload  | `_[current](../move_iterator.html#current "cpp/iterator/move iterator")_`  
---|---  
...
(3) | initialized with other.`_[current](../move_iterator.html#current "cpp/iterator/move iterator")_`  
  
3) The converting constructor.  If `U` is not convertible to `Iter`, the program is ill-formed.  | (until C++20)  
---|---  
This overload participates in overload resolution only if [std::is_same_v](../../types/is_same.html)<U, Iter> is false and [std::convertible_to](../../concepts/convertible_to.html)<const U&, Iter> is modeled.  | (since C++20)  
  
## Contents

  * [1 Parameters](move_iterator.html#Parameters)
  * [2 Example](move_iterator.html#Example)
  * [3 Defect reports](move_iterator.html#Defect_reports)
  * [4 See also](move_iterator.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/move_iterator&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  iterator to adapt   
---|---|---  
other  |  \-  |  iterator adaptor to copy   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/move_iterator&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/move_iterator&action=edit&section=3 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 3435](https://cplusplus.github.io/LWG/issue3435) | C++20  | overload ([3](move_iterator.html#Version_3)) was not constrained  | constrained   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/move_iterator&action=edit&section=4 "Edit section: See also")] See also

[ operator=](operator=.html "cpp/iterator/move iterator/operator=") |  assigns another `move_iterator`   
...
---|---  
[ make_move_iterator](../make_move_iterator.html "cpp/iterator/make move iterator")(C++11) |  creates a [std::move_iterator](../move_iterator.html "cpp/iterator/move iterator") of type inferred from the argument   
