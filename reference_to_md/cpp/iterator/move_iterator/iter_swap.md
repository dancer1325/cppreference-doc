...
const [std::move_iterator](../move_iterator.html)<Iter2>& y )  
...
Equivalent to [ranges::iter_swap](../ranges/iter_swap.html)(x.base(), y.base());. 
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)> p{"AA", "EE"},
                                 q{"ⱯⱯ", "ƎƎ"};
     
        [std::move_iterator](../move_iterator.html)<[std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)>::iterator>
            x = [std::make_move_iterator](../make_move_iterator.html)(p.begin()),
            y = [std::make_move_iterator](../make_move_iterator.html)(q.begin());
     
