...
Member functions  
---  
[move_iterator::move_iterator](move_iterator.html "cpp/iterator/move iterator/move iterator")  
[move_iterator::operator=](operator=.html "cpp/iterator/move iterator/operator=")  
[move_iterator::base](base.html "cpp/iterator/move iterator/base")  
[move_iterator::operator*move_iterator::operator->](operator*.html "cpp/iterator/move iterator/operator*")  
...
[operator==operator!=operator<operator<=operator>operator>=operator<=>](operator_cmp.html "cpp/iterator/move iterator/operator cmp")(until C++20)(C++20)  
[operator==(move_sentinel)](operator_cmp2.html "cpp/iterator/move iterator/operator cmp2")(C++20)  
[operator+](operator+.html "cpp/iterator/move iterator/operator+")  
[operator-](operator-.html "cpp/iterator/move iterator/operator-")  
[operator-(move_sentinel)](operator-2.html "cpp/iterator/move iterator/operator-2")(C++20)  
[iter_move](iter_move.html "cpp/iterator/move iterator/iter move")(C++20)  
...
move_iterator& operator++(); |  (1) | (constexpr since C++17)  
---|---|---  
move_iterator& operator\--(); |  (2) | (constexpr since C++17)  
| (3) |   
move_iterator operator++( int ); |  | (constexpr since C++17)   
(until C++20)  
constexpr auto operator++( int ); |  |  (since C++20)  
move_iterator operator\--( int ); |  (4) | (constexpr since C++17)  
move_iterator operator+( difference_type n ) const; |  (5) | (constexpr since C++17)  
move_iterator operator-( difference_type n ) const; |  (6) | (constexpr since C++17)  
move_iterator& operator+=( difference_type n ); |  (7) | (constexpr since C++17)  
move_iterator& operator-=( difference_type n ); |  (8) | (constexpr since C++17)  
| |   
...
---|---  
(1) | ++`_[current](../move_iterator.html#current "cpp/iterator/move iterator")_` ﻿; return *this;  
(2) | \--`_[current](../move_iterator.html#current "cpp/iterator/move iterator")_` ﻿; return *this;  
(3) |  |  move_iterator tmp = *this; ++`_[current](../move_iterator.html#current "cpp/iterator/move iterator")_` ﻿; return tmp; | (until C++20)  
---|---  
  
  * move_iterator tmp = *this; ++`_[current](../move_iterator.html#current "cpp/iterator/move iterator")_` ﻿; return tmp;  
if `Iter` models [`forward_iterator`](../forward_iterator.html "cpp/iterator/forward iterator")
  * ++`_[current](../move_iterator.html#current "cpp/iterator/move iterator")_` ; otherwise 

| (since C++20)  
(4) | move_iterator tmp = *this; \--`_[current](../move_iterator.html#current "cpp/iterator/move iterator")_` ﻿; return tmp;  
(5) | return move_iterator(`_[current](../move_iterator.html#current "cpp/iterator/move iterator")_`` `+ n);  
(6) | return move_iterator(`_[current](../move_iterator.html#current "cpp/iterator/move iterator")_`` `- n);  
(7) | `_[current](../move_iterator.html#current "cpp/iterator/move iterator")_`` `+= n; return *this;  
(8) | `_[current](../move_iterator.html#current "cpp/iterator/move iterator")_`` `-= n; return *this;  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator_arith&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  position relative to current location   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator_arith&action=edit&section=2 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator_arith&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator_arith&action=edit&section=4 "Edit section: See also")] See also

[ operator+](operator+.html "cpp/iterator/move iterator/operator+")(C++11) |  advances the iterator   
...
---|---  
[ operator-](operator-.html "cpp/iterator/move iterator/operator-")(C++11) |  computes the distance between two iterator adaptors   
