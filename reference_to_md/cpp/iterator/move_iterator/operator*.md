...
Run this code
    ...
    int main()
    {
        ...
        print("1) p: ", p);
        for ([std::move_iterator](../move_iterator.html) it{p.begin()}, end{p.end()}; it != end; ++it)
        {
    ...
     
        ...
        [std::move_iterator](../move_iterator.html) it{v.begin()};
...
---|---|---|---  
[LWG 2106](https://cplusplus.github.io/LWG/issue2106) | C++11  | operator* would return a dangling  
