...
Equivalent to return std::[ranges::iter_move](../ranges/iter_move.html)(i.base());. 
...
Run this code
    ...
     
        print("p", p), print("q", q);
     
        using MI = [std::move_iterator](../move_iterator.html)<[std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)>::iterator>;
     
