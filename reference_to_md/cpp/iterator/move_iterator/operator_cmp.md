...
[move_iterator::operator++move_iterator::operator+move_iterator::operator+=move_iterator::operator--move_iterator::operator-move_iterator::operator-=](operator_arith.html "cpp/iterator/move iterator/operator arith")  
...
bool operator==( const [std::move_iterator](../move_iterator.html)<Iter1>& lhs,  
const [std::move_iterator](../move_iterator.html)<Iter2>& rhs ); |  (1) | (constexpr since C++17)  
template< class Iter1, class Iter2 >  
bool operator!=( const [std::move_iterator](../move_iterator.html)<Iter1>& lhs,  
const [std::move_iterator](../move_iterator.html)<Iter2>& rhs ); |  (2) | (constexpr since C++17)   
(until C++20)  
template< class Iter1, class Iter2 >  
bool operator< ( const [std::move_iterator](../move_iterator.html)<Iter1>& lhs,  
const [std::move_iterator](../move_iterator.html)<Iter2>& rhs ); |  (3) | (constexpr since C++17)  
template< class Iter1, class Iter2 >  
bool operator<=( const [std::move_iterator](../move_iterator.html)<Iter1>& lhs,  
const [std::move_iterator](../move_iterator.html)<Iter2>& rhs ); |  (4) | (constexpr since C++17)  
template< class Iter1, class Iter2 >  
bool operator> ( const [std::move_iterator](../move_iterator.html)<Iter1>& lhs,  
const [std::move_iterator](../move_iterator.html)<Iter2>& rhs ); |  (5) | (constexpr since C++17)  
template< class Iter1, class Iter2 >  
bool operator>=( const [std::move_iterator](../move_iterator.html)<Iter1>& lhs,  
const [std::move_iterator](../move_iterator.html)<Iter2>& rhs ); |  (6) | (constexpr since C++17)  
template< class Iter1, [std::three_way_comparable_with](../../utility/compare/three_way_comparable.html)<Iter1> Iter2 >  
constexpr [std::compare_three_way_result_t](../../utility/compare/compare_three_way_result.html)<Iter1, Iter2>  
operator<=>( const [std::move_iterator](../move_iterator.html)<Iter1>& lhs,  
const [std::move_iterator](../move_iterator.html)<Iter2>& rhs ); |  (7)  |  (since C++20)  
| |   
  
Compares the underlying iterators of lhs and rhs. 

1) This overload participates in overload resolution only if lhs.base() == rhs.base() is well-formed and convertible to bool. 3-6) These overloads participate in overload resolution only if lhs.base() < rhs.base() is well-formed and convertible to bool. The `!=` operator is [synthesized](../../language/default_comparisons.html#Other_defaulted_comparison_operators "cpp/language/default comparisons") from `operator==`.  | (since C++20)  
---|---  
...
## Contents
  ...
  * [4 See also](operator_cmp.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator_cmp&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  iterator adaptors to compare   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator_cmp&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator_cmp&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::move_iterator](../move_iterator.html)<int*>
            x{[std::end](../end.html)(a) - 1},
            y{[std::end](../end.html)(a) - 1},
            z{[std::end](../end.html)(a) - 2};
     
        // two-way comparisons
        [assert](../../error/assert.html)(  x == y );
        [assert](../../error/assert.html)(!(x != y));
        [assert](../../error/assert.html)(!(x <  y));
        [assert](../../error/assert.html)(  x <= y );
        [assert](../../error/assert.html)(!(x == z));
        [assert](../../error/assert.html)(  x != z );
        [assert](../../error/assert.html)(!(x <  z));
        [assert](../../error/assert.html)(!(x <= z));
     
        // three-way comparisons
        [assert](../../error/assert.html)(  x <=> y == 0 );
        [assert](../../error/assert.html)(!(x <=> y <  0));
        [assert](../../error/assert.html)(!(x <=> y >  0));
        [assert](../../error/assert.html)(!(x <=> z == 0));
        [assert](../../error/assert.html)(!(x <=> z <  0));
        [assert](../../error/assert.html)(  x <=> z >  0 );
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator_cmp&action=edit&section=4 "Edit section: See also")] See also

[ operator==(std::move_sentinel)](operator_cmp2.html "cpp/iterator/move iterator/operator cmp2")(C++20) |  compares the underlying iterator and the underlying sentinel   
