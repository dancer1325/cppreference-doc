...
-> decltype(lhs.base() - rhs.base()); |  | (since C++11)   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator-&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  iterator adaptors to compute the difference of   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator-&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_iterator/operator-&action=edit&section=4 "Edit section: See also")] See also
