...
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> && [std::totally_ordered_with](../../concepts/totally_ordered.html)<Iter, I>; |  (1)  |  (since C++23)  
---|---|---  
template< /*not-a-const-iterator*/ I >  
friend constexpr bool operator>( const I& x, const basic_const_iterator& y )  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> && [std::totally_ordered_with](../../concepts/totally_ordered.html)<Iter, I>; |  (2)  |  (since C++23)  
template< /*not-a-const-iterator*/ I >  
friend constexpr bool operator<=( const I& x, const basic_const_iterator& y )  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> && [std::totally_ordered_with](../../concepts/totally_ordered.html)<Iter, I>; |  (3)  |  (since C++23)  
template< /*not-a-const-iterator*/ I >  
friend constexpr bool operator>=( const I& x, const basic_const_iterator& y )  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> && [std::totally_ordered_with](../../concepts/totally_ordered.html)<Iter, I>; |  (4)  |  (since C++23)  
| |   
...
These functions are not visible to ordinary [unqualified](../../language/unqualified_lookup.html "cpp/language/unqualified lookup") or [qualified lookup](../../language/qualified_lookup.html "cpp/language/qualified lookup"), and can only be found by [argument-dependent lookup](../../language/adl.html "cpp/language/adl") when basic_const_iterator<Iter> is an associated class of the arguments. 

## Contents

  * [1 Parameters](operator_cmp2.html#Parameters)
  * [2 Return value](operator_cmp2.html#Return_value)
  * [3 Notes](operator_cmp2.html#Notes)
  * [4 Example](operator_cmp2.html#Example)
  * [5 See also](operator_cmp2.html#See_also)
...
Run this code
    ...
    {
        static int arr[1];
        static constexpr [std::basic_const_iterator](../basic_const_iterator.html)<int*> it = [std::end](../end.html)(arr);
