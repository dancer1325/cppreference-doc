...
---  
[basic_const_iterator::basic_const_iterator](basic_const_iterator.html "cpp/iterator/basic const iterator/basic const iterator")  
[basic_const_iterator::base](base.html "cpp/iterator/basic const iterator/base")  
[basic_const_iterator::operator*basic_const_iterator::operator->](operator*.html "cpp/iterator/basic const iterator/operator*")  
[basic_const_iterator::operator[]](operator_at.html "cpp/iterator/basic const iterator/operator at")  
[basic_const_iterator::operator++basic_const_iterator::operator+=basic_const_iterator::operator--basic_const_iterator::operator-=](operator_arith.html "cpp/iterator/basic const iterator/operator arith")  
...
[basic_const_iterator::operator _constant-iterator_](operator_constant_iterator.html "cpp/iterator/basic const iterator/operator constant iterator")  
[Non-member functions](../basic_const_iterator.html#Non-member_functions "cpp/iterator/basic const iterator")  
[operator<operator<=operator>operator>=](operator_cmp2.html "cpp/iterator/basic const iterator/operator cmp2")(C++23)(C++23)(C++23)(C++23)  
[operator+](operator_arith2.html "cpp/iterator/basic const iterator/operator arith2")(C++23)  
[operator-](operator-.html "cpp/iterator/basic const iterator/operator-")(C++23)  
[iter_move(std::basic_const_iterator)](iter_move.html "cpp/iterator/basic const iterator/iter move")(C++23)  
...
Equality comparison |  |   
---|---|---  
template< [std::sentinel_for](../sentinel_for.html)<Iter> S >  
constexpr bool operator==( const S& s ) const; |  (1) | (since C++23)  
Relational comparisons between two `basic_const_iterator`s |  |   
constexpr bool operator<( const basic_const_iterator& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter>; |  (2)  |  (since C++23)  
constexpr bool operator>( const basic_const_iterator& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter>; |  (3)  |  (since C++23)  
constexpr bool operator<=( const basic_const_iterator& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter>; |  (4)  |  (since C++23)  
constexpr bool operator>=( const basic_const_iterator& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter>; |  (5)  |  (since C++23)  
constexpr auto operator<=>( const basic_const_iterator& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> && [std::three_way_comparable](../../utility/compare/three_way_comparable.html)<Iter>; |  (6)  |  (since C++23)  
Relational comparisons between `basic_const_iterator` and another type |  |   
template< /*different-from*/<basic_const_iterator> I >  
constexpr bool operator<( const I& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> && [std::totally_ordered_with](../../concepts/totally_ordered.html)<Iter, I>; |  (7)  |  (since C++23)  
template< /*different-from*/<basic_const_iterator> I >  
constexpr bool operator>( const I& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> && [std::totally_ordered_with](../../concepts/totally_ordered.html)<Iter, I>; |  (8)  |  (since C++23)  
template< /*different-from*/<basic_const_iterator> I >  
constexpr bool operator<=( const I& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> && [std::totally_ordered_with](../../concepts/totally_ordered.html)<Iter, I>; |  (9)  |  (since C++23)  
template< /*different-from*/<basic_const_iterator> I >  
constexpr bool operator>=( const I& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> && [std::totally_ordered_with](../../concepts/totally_ordered.html)<Iter, I>; |  (10)  |  (since C++23)  
template< /*different-from*/<basic_const_iterator> I >  
constexpr auto operator<=>( const I& y ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter> &&  
[std::totally_ordered_with](../../concepts/totally_ordered.html)<Iter, I> &&  
[std::three_way_comparable_with](../../utility/compare/three_way_comparable.html)<Iter, I>; |  (11)  |  (since C++23)  
| |   
...
I satisfies /*different-from*/<basic_const_iterator> if [std::same_as](../../concepts/same_as.html)<I, basic_const_iterator<Iter>> is false. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/operator_cmp&action=edit&section=1 "Edit section: Parameters")] Parameters

s  |  \-  |  a sentinel for `Iter`  
---|---|---  
y  |  \-  |  a value to compare with   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/operator_cmp&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/operator_cmp&action=edit&section=3 "Edit section: Notes")] Notes

Overload ([1](operator_cmp.html#Version_1)) can be used to compare two `basic_const_iterator<Iter>` values if `Iter` models sentinel_for<Iter>. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/operator_cmp&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/operator_cmp&action=edit&section=5 "Edit section: See also")] See also
