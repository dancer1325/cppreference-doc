...
[basic_const_iterator::operator==basic_const_iterator::operator<basic_const_iterator::operator<=basic_const_iterator::operator>basic_const_iterator::operator>=basic_const_iterator::operator<=>](operator_cmp.html "cpp/iterator/basic const iterator/operator cmp")  
...
The return type /*rvalue-reference*/ is [std::common_reference_t](../../types/common_reference.html)<const [std::iter_value_t](../iter_t.html)<Iter>&&, [std::iter_rvalue_reference_t](../iter_t.html)<Iter>>. 

The function body is equivalent to  
return static_cast</*rvalue-reference*/>(std::[ranges::iter_move](../ranges/iter_move.html)(i.base()));. 

This function is not visible to ordinary [unqualified](../../language/unqualified_lookup.html "cpp/language/unqualified lookup") or [qualified lookup](../../language/qualified_lookup.html "cpp/language/qualified lookup"), and can only be found by [argument-dependent lookup](../../language/adl.html "cpp/language/adl") when [std::basic_const_iterator](../basic_const_iterator.html)<Iter> is an associated class of the arguments. 

## Contents

  * [1 Parameter](iter_move.html#Parameter)
  * [2 Return value](iter_move.html#Return_value)
  * [3 Exceptions](iter_move.html#Exceptions)
  * [4 Example](iter_move.html#Example)
  * [5 See also](iter_move.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/iter_move&action=edit&section=1 "Edit section: Parameter")] Parameter

i  |  \-  |  a `basic_const_iterator`  
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/iter_move&action=edit&section=2 "Edit section: Return value")] Return value

An rvalue reference to const, or a prvalue. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/iter_move&action=edit&section=3 "Edit section: Exceptions")] Exceptions

[`noexcept`](../../language/noexcept_spec.html "cpp/language/noexcept spec") specification: 

noexcept(noexcept(static_cast</*rvalue-reference*/>(std::[ranges::iter_move](../ranges/iter_move.html)(i.base()))))

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/iter_move&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/iter_move&action=edit&section=5 "Edit section: See also")] See also
