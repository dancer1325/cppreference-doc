...
requires [std::is_lvalue_reference_v](../../types/is_lvalue_reference.html)<[std::iter_reference_t](../iter_t.html)<Iterator>> &&  
[std::same_as](../../concepts/same_as.html)<[std::remove_cvref_t](../../types/remove_cvref.html)<[std::iter_reference_t](../iter_t.html)<Iterator>>,  
value_type>; |  (2)  |  (since C++23)  
| |   
  
Returns a reference or pointer to the const version of the current element. 

1) Returns static_cast<[std::iter_const_reference_t](../iter_t.html)<Iter>>(*base()).

2) If `Iter` models [`contiguous_iterator`](../contiguous_iterator.html "cpp/iterator/contiguous iterator"), returns [std::to_address](../../memory/to_address.html)(base()); otherwise, returns [std::addressof](../../memory/addressof.html)(*base()).
