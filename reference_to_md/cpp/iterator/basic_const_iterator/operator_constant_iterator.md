...
**basic_const_iterator::operator _constant-iterator_**  
...
[std::convertible_to](../../concepts/convertible_to.html)<Iter const&, CI>  
constexpr operator CI() const &; |  (1)  |  (since C++23)  
---|---|---  
template< /*not-a-const-iterator*/ CI >  
requires /*constant-iterator*/<CI> &&   
[std::convertible_to](../../concepts/convertible_to.html)<Iter, CI>  
constexpr operator CI() &&; |  (2)  |  (since C++23)  
| |   
  
Returns the converted constant iterator to which an underlying iterator [`_current_`](../basic_const_iterator.html#Member_objects "cpp/iterator/basic const iterator") can be explicitly or implicitly convertible. 
...
Run this code
    ...
    #include <vector>
     
    void foo([std::vector](../../container/vector.html)<int>::const_iterator) {}
     
    int main()
    {
        auto v = [std::vector](../../container/vector.html)<int>();
        {
            ...
            auto i1 = std::[ranges::cbegin](../../ranges/cbegin.html)(v);
            foo(i1); // okay
        }
     
        auto t = v | std::[views::take_while](../../ranges/take_while_view.html)([](int const x) { return x < 100; });
        {
            // ranges::cbegin below returns basic_const_iterator<vector<int>::iterator>
            auto i2 = std::[ranges::cbegin](../../ranges/cbegin.html)(t);
