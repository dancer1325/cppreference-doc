...
requires [std::forward_iterator](../forward_iterator.html)<Iter>; |  (3)  |  (since C++23)  
constexpr basic_const_iterator& operator\--()  
requires [std::bidirectional_iterator](../bidirectional_iterator.html)<Iter>; |  (4)  |  (since C++23)  
constexpr basic_const_iterator operator\--(int)  
requires [std::bidirectional_iterator](../bidirectional_iterator.html)<Iter>; |  (5)  |  (since C++23)  
constexpr basic_const_iterator& operator+=( difference_type n )  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter>; |  (6)  |  (since C++23)  
constexpr basic_const_iterator& operator-=( difference_type n )  
requires [std::random_access_iterator](../random_access_iterator.html)<Iter>; |  (7)  |  (since C++23)  
| |   
