[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/iterator/inserter/operator*&action=edit)
...
Does nothing, this member function is provided to satisfy the requirements of [LegacyOutputIterator](../../named_req/OutputIterator.html "cpp/named req/OutputIterator"). 
