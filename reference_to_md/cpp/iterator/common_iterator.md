...
---  
[common_iterator::common_iterator](common_iterator/common_iterator.html "cpp/iterator/common iterator/common iterator")  
[common_iterator::operator=](common_iterator/operator=.html "cpp/iterator/common iterator/operator=")  
[common_iterator::operator*common_iterator::operator->](common_iterator/operator*.html "cpp/iterator/common iterator/operator*")  
[common_iterator::operator++common_iterator::operator++(int)](common_iterator/operator_arith.html "cpp/iterator/common iterator/operator arith")  
[Non-member functions](common_iterator.html#Non-member_functions "cpp/iterator/common iterator")  
[operator==](common_iterator/operator_cmp.html "cpp/iterator/common iterator/operator cmp")(C++20)  
[operator-](common_iterator/operator-.html "cpp/iterator/common iterator/operator-")(C++20)  
[iter_move](common_iterator/iter_move.html "cpp/iterator/common iterator/iter move")(C++20)  
[iter_swap](common_iterator/iter_swap.html "cpp/iterator/common iterator/iter swap")(C++20)  
...
---|---|---  
template< [std::input_or_output_iterator](input_or_output_iterator.html) I, [std::sentinel_for](sentinel_for.html)<I> S >  
requires ( ![std::same_as](../concepts/same_as.html)<I, S> && [std::copyable](../concepts/copyable.html)<I> )  
class common_iterator; |  |  (since C++20)  
| |   
  
`std::common_iterator` is an iterator `I` / sentinel `S` adaptor that may represent a non-common range (where the types of `I` and `S` differ) as a [`common_range`](../ranges/common_range.html "cpp/ranges/common range"), by containing either an iterator or a sentinel, and defining the appropriate equality comparison operators operator==. 

`std::common_iterator` can be used as a "bridge" between sequences represented by iterator/sentinel pair and legacy functions that expect [`common_range`](../ranges/common_range.html "cpp/ranges/common range")-like sequences. 

## Contents

  * [1 Data members](common_iterator.html#Data_members)
  * [2 Member functions](common_iterator.html#Member_functions)
  * [3 Non-member functions](common_iterator.html#Non-member_functions)
  * [4 Helper classes](common_iterator.html#Helper_classes)
  * [5 Example](common_iterator.html#Example)
  * [6 References](common_iterator.html#References)
  * [7 See also](common_iterator.html#See_also)
...
Run this code
    ...
    {
        [std::copy](../algorithm/copy.html)(first, last, [std::ostream_iterator](ostream_iterator.html)<[std::string](../string/basic_string.html)>{[std::cout](../io/cout.html), " "});    
    }
     
    int main()
    {
        [std::list](../container/list.html)<[std::string](../string/basic_string.html)> stars{"Pollux", "Arcturus", "Mira", "Aldebaran", "Sun"};
     
        using IT = std::common_iterator<
                       [std::counted_iterator](counted_iterator.html)<[std::list](../container/list.html)<[std::string](../string/basic_string.html)>::iterator>,
                       [std::default_sentinel_t](default_sentinel.html)>;
     
        fire(IT([std::counted_iterator](counted_iterator.html)(stars.begin(), stars.size() - 1)),
             IT([std::default_sentinel](default_sentinel.html)));
    }
