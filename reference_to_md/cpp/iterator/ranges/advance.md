...
constexpr void advance( I& i, [std::iter_difference_t](../iter_t.html)<I> n ); |  (1)  |  (since C++20)  
template< [std::input_or_output_iterator](../input_or_output_iterator.html) I, [std::sentinel_for](../sentinel_for.html)<I> S >  
constexpr void advance( I& i, S bound ); |  (2)  |  (since C++20)  
template< [std::input_or_output_iterator](../input_or_output_iterator.html) I, [std::sentinel_for](../sentinel_for.html)<I> S >  
constexpr [std::iter_difference_t](../iter_t.html)<I> advance( I& i, [std::iter_difference_t](../iter_t.html)<I> n, S bound ); |  (3)  |  (since C++20)  
| |   
...
If n is negative, the iterator is decremented. In this case, `I` must model [std::bidirectional_iterator](../bidirectional_iterator.html "cpp/iterator/bidirectional iterator"), and `S` must be the same type as `I` if bound is provided, otherwise the behavior is undefined. 
...
## Contents
  ...
  * [1 Parameters](advance.html#Parameters)
  * [2 Return value](advance.html#Return_value)
  * [3 Complexity](advance.html#Complexity)
  * [4 Notes](advance.html#Notes)
  * [5 Possible implementation](advance.html#Possible_implementation)
  * [6 Example](advance.html#Example)
  * [7 See also](advance.html#See_also)
...
### Possible implementation
    ...
    {
        template<[std::input_or_output_iterator](../input_or_output_iterator.html) I>
        constexpr void operator()(I& i, [std::iter_difference_t](../iter_t.html)<I> n) const
        {
            if constexpr ([std::random_access_iterator](../random_access_iterator.html)<I>)
                i += n;
            else
            {
                while (n > 0)
    ...
     
                if constexpr ([std::bidirectional_iterator](../bidirectional_iterator.html)<I>)
                {
                    while (n < 0)
                    {
                        ++n;
    ...
     
        ...
        {
            if constexpr ([std::assignable_from](../../concepts/assignable_from.html)<I&, S>)
                i = std::move(bound);
            else if constexpr ([std::sized_sentinel_for](../sized_sentinel_for.html)<S, I>)
                (*this)(i, bound - i);
            else
                while (i != bound)
                    ++i;
    ...
     
        ...
        operator()(I& i, [std::iter_difference_t](../iter_t.html)<I> n, S bound) const
        {
            if constexpr ([std::sized_sentinel_for](../sized_sentinel_for.html)<S, I>)
            {
                // std::abs is not constexpr until C++23
                auto abs = [](const [std::iter_difference_t](../iter_t.html)<I> x) { return x < 0 ? -x : x; };
     
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html) << "1) value: " << *vi << '\n' << [std::boolalpha](../../io/manip/boolalpha.html);
     
        std::ranges::advance(vi, v.end());
        [std::cout](../../io/cout.html) << "2) vi == v.end(): " << (vi == v.end()) << '\n';
     
        std::ranges::advance(vi, -3);
        [std::cout](../../io/cout.html) << "3) value: " << *vi << '\n';
     
        [std::cout](../../io/cout.html) << "4) diff: " << std::ranges::advance(vi, 2, v.end())
                  << ", value: " << *vi << '\n';
     
        [std::cout](../../io/cout.html) << "5) diff: " << std::ranges::advance(vi, 4, v.end())
                  << ", vi == v.end(): " << (vi == v.end()) << '\n';
    }
