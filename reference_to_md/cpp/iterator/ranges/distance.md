...
---  
[ranges::iter_move](iter_move.html "cpp/iterator/ranges/iter move")(C++20)  
[ranges::iter_swap](iter_swap.html "cpp/iterator/ranges/iter swap")(C++20)  
...
| [ranges::advance](advance.html "cpp/iterator/ranges/advance")(C++20)  
---  
**ranges::distance**(C++20)  
[ranges::prev](prev.html "cpp/iterator/ranges/prev")(C++20)  
[ranges::next](next.html "cpp/iterator/ranges/next")(C++20)  
...
---|---|---  
Call signature |  |   
template< class I, [std::sentinel_for](../sentinel_for.html)<I> S >  
requires (![std::sized_sentinel_for](../sized_sentinel_for.html)<S, I>)  
constexpr [std::iter_difference_t](../iter_t.html)<I>  
distance( I first, S last ); |  (1)  |  (since C++20)  
template< class I, [std::sized_sentinel_for](../sized_sentinel_for.html)<[std::decay_t](../../types/decay.html)<I>> S >  
constexpr [std::iter_difference_t](../iter_t.html)<[std::decay_t](../../types/decay.html)<I>>  
distance( I&& first, S last ); |  (2)  |  (since C++20)  
template< [ranges::range](../../ranges/range.html) R >  
constexpr [ranges::range_difference_t](../../ranges/range_size_t.html)<R>  
distance( R&& r ); |  (3)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](distance.html#Parameters)
  * [2 Return value](distance.html#Return_value)
  * [3 Complexity](distance.html#Complexity)
  * [4 Possible implementation](distance.html#Possible_implementation)
  * [5 Example](distance.html#Example)
  * [6 Defect reports](distance.html#Defect_reports)
  * [7 See also](distance.html#See_also)
...
2) last - static_cast<const [std::decay_t](../../types/decay.html)<I>&>(first).
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/ranges/distance&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct distance_fn
    {
        template<class I, [std::sentinel_for](../sentinel_for.html)<I> S>
            requires (![std::sized_sentinel_for](../sized_sentinel_for.html)<S, I>)
        constexpr [std::iter_difference_t](../iter_t.html)<I> operator()(I first, S last) const
        {
            [std::iter_difference_t](../iter_t.html)<I> result = 0;
            while (first != last)
            {
                ++first;
                ++result;
    ...
     
        template<class I, [std::sized_sentinel_for](../sized_sentinel_for.html)<[std::decay](../../types/decay.html)<I>> S>
        constexpr [std::iter_difference_t](../iter_t.html)<I> operator()(const I& first, S last) const
        {
            return last - first;
        }
     
        template<[ranges::range](../../ranges/range.html) R>
        constexpr [ranges::range_difference_t](../../ranges/range_size_t.html)<R> operator()(R&& r) const
        {
            if constexpr ([ranges::sized_range](../../ranges/sized_range.html)<[std::remove_cvref_t](../../types/remove_cvref.html)<R>>)
                return static_cast<[ranges::range_difference_t](../../ranges/range_size_t.html)<R>>([ranges::size](../../ranges/size.html)(r));
            else
...
Run this code
    ...
    int main() 
    {
        ...
        [assert](../../error/assert.html)(std::ranges::distance(v.begin(), v.end()) == 3);
        [assert](../../error/assert.html)(std::ranges::distance(v.end(), v.begin()) == -3);
        [assert](../../error/assert.html)(std::ranges::distance(v) == 3);
     
        [std::forward_list](../../container/forward_list.html)<int> l{2, 7, 1};
...
---|---|---|---  
[LWG 3392](https://cplusplus.github.io/LWG/issue3392) | C++20  | overload (1) takes iterator by value, thus move-only  
