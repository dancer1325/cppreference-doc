...
template< [std::input_or_output_iterator](../input_or_output_iterator.html) I >  
constexpr I next( I i, [std::iter_difference_t](../iter_t.html)<I> n ); |  (2)  |  (since C++20)  
...
template< [std::input_or_output_iterator](../input_or_output_iterator.html) I, [std::sentinel_for](../sentinel_for.html)<I> S >  
constexpr I next( I i, [std::iter_difference_t](../iter_t.html)<I> n, S bound ); |  (4)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](next.html#Parameters)
  * [2 Return value](next.html#Return_value)
  * [3 Complexity](next.html#Complexity)
  * [4 Possible implementation](next.html#Possible_implementation)
  * [5 Notes](next.html#Notes)
  * [6 Example](next.html#Example)
  * [7 See also](next.html#See_also)
...
2) Constant if `I` models [std::random_access_iterator](../random_access_iterator.html "cpp/iterator/random access iterator"); otherwise linear.

3) Constant if `I` and `S` models both [std::random_access_iterator](../random_access_iterator.html)<I> and [std::sized_sentinel_for](../sized_sentinel_for.html)<S, I>, or if `I` and `S` models [std::assignable_from](../../concepts/assignable_from.html)<I&, S>; otherwise linear.
...
### Possible implementation
    ...
     
        template<[std::input_or_output_iterator](../input_or_output_iterator.html) I>
        constexpr I operator()(I i, [std::iter_difference_t](../iter_t.html)<I> n) const
        {
            [ranges::advance](advance.html)(i, n);
            return i;
        }
     
        template<[std::input_or_output_iterator](../input_or_output_iterator.html) I, [std::sentinel_for](../sentinel_for.html)<I> S>
        ...
        {
            [ranges::advance](advance.html)(i, bound);
            return i;
        }
     
        template<[std::input_or_output_iterator](../input_or_output_iterator.html) I, [std::sentinel_for](../sentinel_for.html)<I> S>
        constexpr I operator()(I i, [std::iter_difference_t](../iter_t.html)<I> n, S bound) const
        {
            [ranges::advance](advance.html)(i, n, bound);
            return i;
        }
    };
     
...
Run this code
    ...
    int main() 
    {
        auto v = {3, 1, 4};
        {
            ...
            [assert](../../error/assert.html)(*n == 1);
        }
        {
            auto n = std::ranges::next(v.begin(), 2);
            [assert](../../error/assert.html)(*n == 4);
        }
        {
            auto n = std::ranges::next(v.begin(), v.end());
            [assert](../../error/assert.html)(n == v.end());
        }
        {
