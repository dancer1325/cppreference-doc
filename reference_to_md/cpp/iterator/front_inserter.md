...
[std::front_insert_iterator](front_insert_iterator.html)<Container> front_inserter( Container& c ); |  |  (constexpr since C++20)  
| |   
  
`front_inserter` is a convenience function template that constructs a [std::front_insert_iterator](front_insert_iterator.html "cpp/iterator/front insert iterator") for the container c with the type deduced from the type of the argument. 

## Contents

  * [1 Parameters](front_inserter.html#Parameters)
  * [2 Return value](front_inserter.html#Return_value)
  * [3 Possible implementation](front_inserter.html#Possible_implementation)
  * [4 Example](front_inserter.html#Example)
  * [5 See also](front_inserter.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_inserter&action=edit&section=1 "Edit section: Parameters")] Parameters

c  |  \-  |  container that supports a `push_front` operation   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_inserter&action=edit&section=2 "Edit section: Return value")] Return value

A [std::front_insert_iterator](front_insert_iterator.html "cpp/iterator/front insert iterator") which can be used to add elements to the beginning of the container c. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_inserter&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class Container>
    [std::front_insert_iterator](front_insert_iterator.html)<Container> front_inserter( Container& c )
    {
        return [std::front_insert_iterator](front_insert_iterator.html)<Container>(c);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_inserter&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::copy](../algorithm/copy.html)(v.begin(), v.end(), std::front_inserter(d));
        for (int n : d)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_inserter&action=edit&section=5 "Edit section: See also")] See also
