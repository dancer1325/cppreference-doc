...
---|---|---  
template< class I, class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less), class Proj = [std::identity](../utility/functional/identity.html) >  
concept sortable =  
[std::permutable](permutable.html)<I> &&  
[std::indirect_strict_weak_order](indirect_strict_weak_order.html)<Comp, std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>>; |  |  (since C++20)  
| |   
