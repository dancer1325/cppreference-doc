...
typename [std::iter_value_t](iter_t.html)<In>;  
typename [std::iter_reference_t](iter_t.html)<In>;  
typename [std::iter_rvalue_reference_t](iter_t.html)<In>;  
{ *in } -> [std::same_as](../concepts/same_as.html)<[std::iter_reference_t](iter_t.html)<In>>;  
{ [ranges::iter_move](ranges/iter_move.html)(in) } -> [std::same_as](../concepts/same_as.html)<[std::iter_rvalue_reference_t](iter_t.html)<In>>;  
} &&  
[std::common_reference_with](../concepts/common_reference_with.html)<  
[std::iter_reference_t](iter_t.html)<In>&&, [std::iter_value_t](iter_t.html)<In>&  
> &&  
[std::common_reference_with](../concepts/common_reference_with.html)<  
[std::iter_reference_t](iter_t.html)<In>&&, [std::iter_rvalue_reference_t](iter_t.html)<In>&&  
> &&  
[std::common_reference_with](../concepts/common_reference_with.html)<  
[std::iter_rvalue_reference_t](iter_t.html)<In>&&, const [std::iter_value_t](iter_t.html)<In>&  
>; |  |  (exposition only*)  
template< class In >  
concept indirectly_readable =  
__IndirectlyReadableImpl<[std::remove_cvref_t](../types/remove_cvref.html)<In>>; |  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/indirectly_readable&action=edit&section=1 "Edit section: Semantic requirements")] Semantic requirements

Given a value `i` of type `I`, `I` models `indirectly_readable` only if all concepts it subsumes are modeled and the expression *i is [equality-preserving](../concepts.html#Equality_preservation "cpp/concepts"). 
