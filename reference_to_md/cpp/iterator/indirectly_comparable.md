...
[std::indirect_binary_predicate](indirect_binary_predicate.html)<Comp, std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I1, Proj1>, std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I2, Proj2>>; |  |  (since C++20)  
| |   
