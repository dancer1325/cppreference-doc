...
**unreachable_sentinel_t unreachable_sentinel**(C++20)(C++20)  
...
## Contents
  ...
  * [1 Non-member functions](unreachable_sentinel_t.html#Non-member_functions)
  * [2 operator==(std::unreachable_sentinel_t)](unreachable_sentinel_t.html#operator.3D.3D.28std::unreachable_sentinel_t.29)
    * [2.1 Example](unreachable_sentinel_t.html#Example)
    * [2.2 See also](unreachable_sentinel_t.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/unreachable_sentinel_t&action=edit&section=1 "Edit section: Non-member functions")] Non-member functions

** operator==**(C++20) |  compares an `unreachable_sentinel_t` with a value of any [`weakly_incrementable`](weakly_incrementable.html "cpp/iterator/weakly incrementable") type   
(function template)  
---|---  
  
##  operator==(std::unreachable_sentinel_t)

template< [std::weakly_incrementable](weakly_incrementable.html) I >  
friend constexpr bool operator==( unreachable_sentinel_t, const I& ) noexcept  
{ return false; } |  |  (since C++20)  
---|---|---  
| |   
  
`unreachable_sentinel_t` can be compared with any [`weakly_incrementable`](weakly_incrementable.html "cpp/iterator/weakly incrementable") type and the result is always false. 

This function template is not visible to ordinary [unqualified](../language/unqualified_lookup.html "cpp/language/unqualified lookup") or [qualified lookup](../language/qualified_lookup.html "cpp/language/qualified lookup"), and can only be found by [argument-dependent lookup](../language/adl.html "cpp/language/adl") when `std::unreachable_sentinel_t` is an associated class of the arguments. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/unreachable_sentinel_t&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    constexpr [std::size_t](../types/size_t.html) trivial_strlen(R&& r)
    {
        auto iter = r.begin();
        while (*iter != [ranges::range_value_t](../ranges/range_size_t.html)<R>{})
            ++iter;
        return iter - r.begin();
    }
     
    template<[ranges::random_access_range](../ranges/random_access_range.html) R>
    constexpr [std::size_t](../types/size_t.html) my_strlen(R&& r)
    {
        if constexpr ([std::same_as](../concepts/same_as.html)<[ranges::sentinel_t](../ranges/iterator_t.html)<R>,
                                   std::unreachable_sentinel_t>)
            return trivial_strlen([std::forward](../utility/forward.html)<R>(r));
        else
            return [ranges::find](../algorithm/ranges/find.html)([std::forward](../utility/forward.html)<R>(r), [ranges::range_value_t](../ranges/range_size_t.html)<R>{}) -
                   [ranges::begin](../ranges/begin.html)(r);
    }
     
    int main()
    {
    ...
     
        ...
        constexpr auto unsafe_str = [ranges::subrange](../ranges/subrange.html){str, std::unreachable_sentinel};
        static_assert(my_strlen(unsafe_str) == 42);
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/unreachable_sentinel_t&action=edit&section=3 "Edit section: See also")] See also
