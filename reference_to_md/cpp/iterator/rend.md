...
template< class C >  
auto rend( C& c ) -> decltype(c.rend()); |  (1) | (since C++14)   
(constexpr since C++17)  
template< class C >  
auto rend( const C& c ) -> decltype(c.rend()); |  (2) | (since C++14)   
(constexpr since C++17)  
template< class T, [std::size_t](../types/size_t.html) N >  
[std::reverse_iterator](reverse_iterator.html)<T*> rend( T (&array)[N] ); |  (3) | (since C++14)   
(constexpr since C++17)  
template< class T >  
[std::reverse_iterator](reverse_iterator.html)<const T*> rend( [std::initializer_list](../utility/initializer_list.html)<T> il ); |  (4) | (since C++14)   
(constexpr since C++17)  
template< class C >  
auto crend( const C& c ) -> decltype(std::rend(c)); |  (5) | (since C++14)   
(constexpr since C++17)  
| |   
...
3) Returns an [std::reverse_iterator](reverse_iterator.html)<T*> object to the reverse-end of array.

4) Returns an [std::reverse_iterator](reverse_iterator.html)<const T*> object to the reverse-end of il.

5) Returns [std::end](end.html)(c), with c always treated as const-qualified.
...
## Contents
  ...
  * [3 Exceptions](rend.html#Exceptions)
  * [4 Overloads](rend.html#Overloads)
  * [5 Notes](rend.html#Notes)
  * [6 Example](rend.html#Example)
  * [7 See also](rend.html#See_also)
...
3) [std::reverse_iterator](reverse_iterator.html)<T*>(array)

4) [std::reverse_iterator](reverse_iterator.html)<const T*>(il.begin())
...
Run this code
    ...
    {
        int a[]{4, 6, -3, 9, 10};
        [std::cout](../io/cout.html) << "C-style array `a` backwards: ";
        [std::copy](../algorithm/copy.html)([std::rbegin](rbegin.html)(a), std::rend(a), [std::ostream_iterator](ostream_iterator.html)<int>([std::cout](../io/cout.html), " "));
     
        auto il = {3, 1, 4};
        [std::cout](../io/cout.html) << "\nstd::initializer_list `il` backwards: ";
        [std::copy](../algorithm/copy.html)([std::rbegin](rbegin.html)(il), std::rend(il), [std::ostream_iterator](ostream_iterator.html)<int>([std::cout](../io/cout.html), " "));
     
        [std::vector](../container/vector.html)<int> v{4, 6, -3, 9, 10};
        [std::cout](../io/cout.html) << "\nstd::vector `v` backwards: ";
        [std::copy](../algorithm/copy.html)([std::rbegin](rbegin.html)(v), std::rend(v), [std::ostream_iterator](ostream_iterator.html)<int>([std::cout](../io/cout.html), " "));
        [std::cout](../io/cout.html) << '\n';
    }
