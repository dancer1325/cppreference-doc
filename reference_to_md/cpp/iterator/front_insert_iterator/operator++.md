...
Member functions  
---  
[front_insert_iterator::front_insert_iterator](front_insert_iterator.html "cpp/iterator/front insert iterator/front insert iterator")  
...
---|---|---  
constexpr front_insert_iterator& operator++(); |  |  (since C++20)  
front_insert_iterator operator++( int ); |  | (until C++20)  
constexpr front_insert_iterator operator++( int ); |  |  (since C++20)  
| |   
