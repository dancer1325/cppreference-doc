...
requires ([std::indirectly_readable](indirectly_readable.html)<Is> && ...) &&  
[std::invocable](../concepts/invocable.html)<F, [std::iter_reference_t](iter_t.html)<Is>...>  
using indirect_result_t = [std::invoke_result_t](../types/result_of.html)<F, [std::iter_reference_t](iter_t.html)<Is>...>; |  |  (since C++20)  
| |   
...
Run this code
    ...
     
    static_assert(
        [std::is_same_v](../types/is_same.html)<std::indirect_result_t<Fn, const int*>, long> and
        [std::is_same_v](../types/is_same.html)<std::indirect_result_t<Fn, [std::move_iterator](move_iterator.html)<int*>>, int> and
        [std::is_same_v](../types/is_same.html)<std::indirect_result_t<const Fn, int*, int*>, short> and
        [std::is_same_v](../types/is_same.html)<std::indirect_result_t<Fn, float*>, int&> and
        [std::is_same_v](../types/is_same.html)<std::indirect_result_t<Fn, int**>, void>
    );
     
    int main() {}
