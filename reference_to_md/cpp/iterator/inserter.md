...
[std::insert_iterator](insert_iterator.html)<Container>  
inserter( Container& c, typename Container::iterator i ); |  | (until C++20)  
template< class Container >  
constexpr [std::insert_iterator](insert_iterator.html)<Container>  
inserter( Container& c, [ranges::iterator_t](../ranges/iterator_t.html)<Container> i ); |  |  (since C++20)  
| |   
  
`inserter` is a convenience function template that constructs a [std::insert_iterator](insert_iterator.html "cpp/iterator/insert iterator") for the container c and its iterator i with the type deduced from the type of the argument. 

## Contents

  * [1 Parameters](inserter.html#Parameters)
  * [2 Return value](inserter.html#Return_value)
  * [3 Possible implementation](inserter.html#Possible_implementation)
  * [4 Example](inserter.html#Example)
  * [5 Defect reports](inserter.html#Defect_reports)
  * [6 See also](inserter.html#See_also)
...
### Possible implementation
    ...
    template<class Container>
    [std::insert_iterator](insert_iterator.html)<Container> inserter(Container& c, typename Container::iterator i)
    {
        return [std::insert_iterator](insert_iterator.html)<Container>(c, i);
    }  
...
Run this code
    ...
    int main()
    {
        [std::multiset](../container/multiset.html)<int> s{1, 2, 3};
     
        // std::inserter is commonly used with multi-sets
        [std::fill_n](../algorithm/fill_n.html)(std::inserter(s, s.end()), 5, 2);
     
        for (int n : s)
            [std::cout](../io/cout.html) << n << ' ';
        [std::cout](../io/cout.html) << '\n';
     
        [std::vector](../container/vector.html)<int> d{100, 200, 300};
        [std::vector](../container/vector.html)<int> v{1, 2, 3, 4, 5};
     
        // when inserting in a sequence container, insertion point advances
        // because each std::insert_iterator::operator= updates the target iterator
        [std::copy](../algorithm/copy.html)(d.begin(), d.end(), std::inserter(v, [std::next](next.html)(v.begin())));
     
        for (int n : v)
            [std::cout](../io/cout.html) << n << ' ';
        [std::cout](../io/cout.html) << '\n';
