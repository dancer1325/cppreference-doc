...
Run this code
    ...
    int main()
    {
        [std::ostream_iterator](../ostream_iterator.html)<char> oo{[std::cout](../../io/cout.html)};
        [std::ostream_iterator](../ostream_iterator.html)<int> i1{[std::cout](../../io/cout.html), ", "};
        [std::fill_n](../../algorithm/fill_n.html)(i1, 5, -1);
        *oo++ = '\n';
     
        ...
        *oo++ = '\n';
     
        [std::common_iterator](../common_iterator.html)<[std::counted_iterator](../counted_iterator.html)<[std::ostream_iterator](../ostream_iterator.html)<float>>,
                             [std::default_sentinel_t](../default_sentinel.html)>
            first{[std::counted_iterator](../counted_iterator.html){[std::ostream_iterator](../ostream_iterator.html)<float>{[std::cout](../../io/cout.html)," ~ "}, 5}},
            last{[std::default_sentinel](../default_sentinel.html)};
        [std::iota](../../algorithm/iota.html)(first, last, 2.2);
        *oo++ = '\n';
    }
...
---|---|---|---  
[LWG 1280](https://cplusplus.github.io/LWG/issue1280) | C++98  | stream was stored directly  | stores its address instead   
