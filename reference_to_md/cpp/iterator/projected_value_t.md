...
[std::remove_cvref_t](../types/remove_cvref.html)<[std::invoke_result_t](../types/result_of.html)<Proj&, [std::iter_value_t](iter_t.html)<I>&>>; |  |  (since C++26)  
| |   
  
The alias template `projected_value_t` obtains the value type by stripping any reference and its topmost cv-qualifiers of the result type of applying `Proj` to [std::iter_value_t](iter_t.html)<I>&. 

`projected_value_t` is used to determine the default value type in some algorithms such as [ranges::contains](../algorithm/ranges/contains.html). 

## Contents

  * [1 Template parameters](projected_value_t.html#Template_parameters)
  * [2 Notes](projected_value_t.html#Notes)
  * [3 Example](projected_value_t.html#Example)
  * [4 See also](projected_value_t.html#See_also)
