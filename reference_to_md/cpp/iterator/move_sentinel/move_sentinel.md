...
[move_sentinel::operator=](operator=.html "cpp/iterator/move sentinel/operator=")  
...
constexpr move_sentinel(); |  (1)  |  (since C++20)  
---|---|---  
constexpr explicit move_sentinel( S x ); |  (2)  |  (since C++20)  
template< class S2 >  
requires [std::convertible_to](../../concepts/convertible_to.html)<const S2&, S>  
constexpr move_sentinel( const [std::move_sentinel](../move_sentinel.html)<S2>& other ); |  (3)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_sentinel/move_sentinel&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  sentinel to adapt   
---|---|---  
other  |  \-  |  sentinel adaptor to copy   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_sentinel/move_sentinel&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_sentinel/move_sentinel&action=edit&section=3 "Edit section: See also")] See also

[ (constructor)](../move_iterator/move_iterator.html "cpp/iterator/move iterator/move iterator") |  constructs a new `move_iterator`   
(public member function of `std::move_iterator<Iter>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/iterator/adaptor/dsc_constructor&action=edit)  
---|---
