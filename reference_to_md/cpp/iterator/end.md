...
template< class C >  
auto end( C& c ) -> decltype(c.end()); |  (1) | (since C++11)   
(constexpr since C++17)  
template< class C >  
auto end( const C& c ) -> decltype(c.end()); |  (2) | (since C++11)   
(constexpr since C++17)  
template< class T, [std::size_t](../types/size_t.html) N >  
T* end( T (&array)[N] ); |  (3) | (since C++11)   
(noexcept since C++14)   
...
1) If `C` is a standard [Container](../named_req/Container.html "cpp/named req/Container"), returns a `C::iterator` object.

2) If `C` is a standard [Container](../named_req/Container.html "cpp/named req/Container"), returns a `C::const_iterator` object.

3) Returns a pointer to the end of array.

4) Returns std::end(c), with c always treated as const-qualified.

If `C` is a standard [Container](../named_req/Container.html "cpp/named req/Container"), returns a `C::const_iterator` object.
...
## Contents
  ...
  * [3 Exceptions](end.html#Exceptions)
  * [4 Overloads](end.html#Overloads)
  * [5 Notes](end.html#Notes)
  * [6 Example](end.html#Example)
  * [7 See also](end.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        if ([std::find](../algorithm/find.html)([std::begin](begin.html)(v), std::end(v), 5) != std::end(v))
            [std::cout](../io/cout.html) << "Found a 5 in vector v!\n";
     
        int w[] = {5, 10, 15};
        if ([std::find](../algorithm/find.html)([std::begin](begin.html)(w), std::end(w), 5) != std::end(w))
            [std::cout](../io/cout.html) << "Found a 5 in array w!\n";
    }
