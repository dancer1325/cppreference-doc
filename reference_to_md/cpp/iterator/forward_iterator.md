...
[std::input_iterator](input_iterator.html)<I> &&  
[std::derived_from](../concepts/derived_from.html)</*ITER_CONCEPT*/<I>, [std::forward_iterator_tag](iterator_tags.html)> &&  
[std::incrementable](incrementable.html)<I> &&  
[std::sentinel_for](sentinel_for.html)<I, I>; |  |  (since C++20)  
| |   
  
This concept refines [std::input_iterator](input_iterator.html "cpp/iterator/input iterator") by requiring that `I` also model [std::incrementable](incrementable.html "cpp/iterator/incrementable") (thereby making it suitable for multi-pass algorithms), and guaranteeing that two iterators to the same range can be compared against each other. 

## Contents

  * [1 Iterator concept determination](forward_iterator.html#Iterator_concept_determination)
  * [2 Semantic requirements](forward_iterator.html#Semantic_requirements)
  * [3 Notes](forward_iterator.html#Notes)
  * [4 Example](forward_iterator.html#Example)
  * [5 See also](forward_iterator.html#See_also)
...
(That is, [std::derived_from](../concepts/derived_from.html)</*ITER_CONCEPT*/<I>, [std::forward_iterator_tag](iterator_tags.html)> is assumed to be true.) 
...
`I` models `std::forward_iterator` if, and only if `I` models all the concepts it subsumes, and given objects i and j of type `I`: 
  ...
  * If i and j are dereferenceable, they offer the _multi-pass guarantee_ , that is: 
