...
---|---|---  
template< class Iter >  
[std::move_iterator](move_iterator.html)<Iter> make_move_iterator( Iter i ); |  | (since C++11)   
(constexpr since C++17)  
| |   
  
`make_move_iterator` is a convenience function template that constructs a [std::move_iterator](move_iterator.html "cpp/iterator/move iterator") for the given iterator i with the type deduced from the type of the argument. 

## Contents

  * [1 Parameters](make_move_iterator.html#Parameters)
  * [2 Return value](make_move_iterator.html#Return_value)
  * [3 Example](make_move_iterator.html#Example)
  * [4 Defect reports](make_move_iterator.html#Defect_reports)
  * [5 See also](make_move_iterator.html#See_also)
...
Run this code
    ...
    {
        for ([std::cout](../io/cout.html) << rem; const auto& str : seq)
    ...
    int main()
    {
        [std::list](../container/list.html)<[std::string](../string/basic_string.html)> s{"one", "two", "three"};
     
        [std::vector](../container/vector.html)<[std::string](../string/basic_string.html)> v1(s.begin(), s.end()); // copy
     
        [std::vector](../container/vector.html)<[std::string](../string/basic_string.html)> v2(std::make_move_iterator(s.begin()),
