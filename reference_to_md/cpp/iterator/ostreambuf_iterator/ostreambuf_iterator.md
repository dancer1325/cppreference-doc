...
[ostreambuf_iterator::operator=](operator=.html "cpp/iterator/ostreambuf iterator/operator=")  
[ostreambuf_iterator::operator*](operator*.html "cpp/iterator/ostreambuf iterator/operator*")  
...
ostreambuf_iterator( streambuf_type* buffer ) noexcept; |  |  (since C++11)  
| (2) |   
ostreambuf_iterator( ostream_type& stream ) throw(); |  | (until C++11)  
ostreambuf_iterator( ostream_type& stream ) noexcept; |  |  (since C++11)  
| |   
  
1) Constructs the iterator with the private `streambuf_type*` member set to buffer and the [`failed()`](failed.html "cpp/iterator/ostreambuf iterator/failed") flag set to false. The behavior is undefined if buffer is a null pointer.
...
Run this code
    ...
    int main()
    {
        ...
        {
            [std::basic_filebuf](../../io/basic_filebuf.html)<char> f;
            f.open(file, std::ios::out);
            [std::ostreambuf_iterator](../ostreambuf_iterator.html)<char> out1(&f);
            *out1 = 'a'; // writes to file via iterator
        }
     
        // read back from the file
        char a;
        [std::cout](../../io/cout.html) << (([std::ifstream](../../io/basic_ifstream.html){file} >> a), a) << [std::endl](../../io/manip/endl.html);
     
        [std::ostreambuf_iterator](../ostreambuf_iterator.html)<wchar_t> out2{[std::wcout](../../io/cout.html)};
        *out2 = L'b';
    }
...
---|---|---|---  
[LWG 112](https://cplusplus.github.io/LWG/issue112) | C++98  | the requirement "the argument cannot  
be null" was applied to overload (2)  | applies to overload  
(1) instead   
