...
constexpr counted_iterator& operator=( const counted_iterator<I2>& other ); |  |  (since C++20)  
---|---|---  
| |   
  
The underlying iterator and _length_ are assigned with those of other. 
...
Run this code
    ...
    int main()
    {
        ...
        [std::counted_iterator](../counted_iterator.html)<[std::initializer_list](../../utility/initializer_list.html)<int>::iterator> p(begin(a), size(a) - 2);
        [std::counted_iterator](../counted_iterator.html)<[std::initializer_list](../../utility/initializer_list.html)<int>::iterator> q;
        [assert](../../error/assert.html)(q.count() == 0);
        [assert](../../error/assert.html)(q.count() != p.count());
        q = p;
        [assert](../../error/assert.html)(q.count() == p.count());
