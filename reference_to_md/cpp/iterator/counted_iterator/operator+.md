...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html) v{0, 1, 2, 3, 4, 5};
        [std::counted_iterator](../counted_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator> p{v.begin() + 1, 4};
        [std::cout](../../io/cout.html) << "*p:" << *p << ", count:" << p.count() << '\n';
        [std::counted_iterator](../counted_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator> q{2 + p};
        [std::cout](../../io/cout.html) << "*q:" << *q << ", count:" << q.count() << '\n';
     
        [std::list](../../container/list.html) l{6, 7, 8, 9};
        [std::counted_iterator](../counted_iterator.html)<[std::list](../../container/list.html)<int>::iterator> r{l.begin(), 3};
        [std::cout](../../io/cout.html) << "*r:" << *r << ", count:" << r.count() << '\n';
