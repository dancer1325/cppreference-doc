...
requires /*dereferenceable*/<const I>; |  (2)  |  (since C++20)  
constexpr auto operator->() const noexcept  
requires [std::contiguous_iterator](../contiguous_iterator.html)<I>; |  (3)  |  (since C++20)  
| |   
...
3) Returns a pointer to the current element. The function's body is equivalent to return [std::to_address](../../memory/to_address.html)(current);.
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/operator*&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
        for ([std::counted_iterator](../counted_iterator.html) i{il.begin() + 1, 3}; i != [std::default_sentinel](../default_sentinel.html); ++i)
            [std::cout](../../io/cout.html) << *i << ' ';
        [std::cout](../../io/cout.html) << '\n';
     
        for ([std::counted_iterator](../counted_iterator.html) i{il.begin() + 1, 3}; i != [std::default_sentinel](../default_sentinel.html); ++i)
            [std::cout](../../io/cout.html) << i->imag() << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/operator*&action=edit&section=4 "Edit section: See also")] See also

[ operator[]](operator_at.html "cpp/iterator/counted iterator/operator at") |  accesses an element by index   
