...
const counted_iterator& x, const counted_iterator<I2>& y ); |  (1)  |  (since C++20)  
---|---|---  
template< [std::common_with](../../concepts/common_with.html)<I> I2 >  
friend constexpr strong_ordering operator<=>(  
const counted_iterator& x, const counted_iterator<I2>& y ); |  (2)  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        ...
        static_assert(it2 <  it3);
        static_assert(it1 <= it2);
        static_assert(it3 != [std::default_sentinel](../default_sentinel.html));
        static_assert(it4 == [std::default_sentinel](../default_sentinel.html));
     
