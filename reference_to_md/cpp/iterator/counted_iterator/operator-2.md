...
---|---|---  
friend constexpr [std::iter_difference_t](../iter_t.html)<I> operator-(  
[std::default_sentinel_t](../default_sentinel.html), const counted_iterator& y ); |  (2)  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        ...
        constexpr [std::counted_iterator](../counted_iterator.html)<[std::initializer_list](../../utility/initializer_list.html)<int>::iterator>
            it{v.begin(), 3};
        constexpr auto d1 = it - [std::default_sentinel](../default_sentinel.html);
        static_assert(d1 == -3); // (1)
        constexpr auto d2 = [std::default_sentinel](../default_sentinel.html) - it;
