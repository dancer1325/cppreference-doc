...
## Contents
  ...
  * [3 Exceptions](base.html#Exceptions)
  * [4 Example](base.html#Example)
  * [5 Defect reports](base.html#Defect_reports)
  * [6 See also](base.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<int> v{0, 1, 2, 3, 4};
     
        [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator> reverse{v.rbegin()};
     
        [std::counted_iterator](../counted_iterator.html) counted{reverse, 3};
     
        static_assert([std::is_same](../../types/is_same.html)<
            decltype(counted.base()),
            [std::reverse_iterator](../reverse_iterator.html)<[std::vector](../../container/vector.html)<int>::iterator> const&
        >{});
     
        [std::cout](../../io/cout.html) << "Print with reverse_iterator: ";
        for (auto r = counted.base(); r != v.rend(); ++r)
            [std::cout](../../io/cout.html) << *r << ' ';
        [std::cout](../../io/cout.html) << '\n';
     
        [std::cout](../../io/cout.html) << "Print with counted_iterator: ";
        for (; counted != [std::default_sentinel](../default_sentinel.html); ++counted)
            [std::cout](../../io/cout.html) << counted[0] << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
