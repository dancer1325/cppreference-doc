...
Checks if the underlying _length_ (i.e. distance to the end) is equal to ​0​. 
...
Run this code
    ...
    int main()
    {
        ...
        constexpr [std::counted_iterator](../counted_iterator.html)<[std::initializer_list](../../utility/initializer_list.html)<int>::iterator>
            it1{v.begin(), 3},
            it2{v.begin(), 0};
        static_assert(it1 != [std::default_sentinel](../default_sentinel.html));
        static_assert(it2 == [std::default_sentinel](../default_sentinel.html));
        static_assert([std::default_sentinel](../default_sentinel.html) != it1);
