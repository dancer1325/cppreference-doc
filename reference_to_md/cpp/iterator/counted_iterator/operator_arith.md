...
requires [std::forward_iterator](../forward_iterator.html)<I>; |  (3)  |  (since C++20)  
constexpr counted_iterator& operator\--()  
requires [std::bidirectional_iterator](../bidirectional_iterator.html)<I>; |  (4)  |  (since C++20)  
constexpr counted_iterator operator\--( int )  
requires [std::bidirectional_iterator](../bidirectional_iterator.html)<I>; |  (5)  |  (since C++20)  
constexpr counted_iterator operator+( [std::iter_difference_t](../iter_t.html)<I> n ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<I>; |  (6)  |  (since C++20)  
constexpr counted_iterator& operator+=( [std::iter_difference_t](../iter_t.html)<I> n )  
requires [std::random_access_iterator](../random_access_iterator.html)<I>; |  (7)  |  (since C++20)  
constexpr counted_iterator operator-( [std::iter_difference_t](../iter_t.html)<I> n ) const  
requires [std::random_access_iterator](../random_access_iterator.html)<I>; |  (8)  |  (since C++20)  
constexpr counted_iterator& operator-=( [std::iter_difference_t](../iter_t.html)<I> n )  
requires [std::random_access_iterator](../random_access_iterator.html)<I>; |  (9)  |  (since C++20)  
| |   
  
Increments or decrements the underlying iterator `_current_` and the distance to the end `_length_`. 

The behavior of these functions is undefined if the `_length_` would be set to a minus value. 
...
Run this code
    ...
    int main()
    {
        ...
        [std::counted_iterator](../counted_iterator.html)<[std::initializer_list](../../utility/initializer_list.html)<int>::iterator> it1{v.begin(), 5};
     
        ++it1;              [assert](../../error/assert.html)(*it1 == 2 && it1.count() == 4); // (1)
        auto it2 = it1++;   [assert](../../error/assert.html)(*it2 == 2 && *it1 == 3);        // (3)
        --it1;              [assert](../../error/assert.html)(*it1 == 2 && it1.count() == 4); // (4)
        auto it3 = it1--;   [assert](../../error/assert.html)(*it3 == 2 && *it1 == 1);        // (5)
        auto it4 = it1 + 3; [assert](../../error/assert.html)(*it4 == 4 && it4.count() == 2); // (6)
        auto it5 = it4 - 3; [assert](../../error/assert.html)(*it5 == 1 && it5.count() == 5); // (8)
        it1 += 3;           [assert](../../error/assert.html)(*it1 == 4 && it1.count() == 2); // (7)
