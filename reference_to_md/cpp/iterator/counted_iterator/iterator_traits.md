...
requires /* see below */  
struct iterator_traits<[std::counted_iterator](../counted_iterator.html)<I>> : [std::iterator_traits](../iterator_traits.html)<I> {  
using pointer = [std::conditional_t](../../types/conditional.html)<[std::contiguous_iterator](../contiguous_iterator.html)<I>,  
[std::add_pointer_t](../../types/add_pointer.html)<[std::iter_reference_t](../iter_t.html)<I>>,  
void>;  
}; |  |  (since C++20)  
| |   
  
Inherits the properties from customized (generated from either a standard partial specialization or a program-defined specialization) [std::iterator_traits](../iterator_traits.html)<I>, with the member type `pointer` adjusted, where `I` models [`input_iterator`](../input_iterator.html "cpp/iterator/input iterator"). 

Notably, the `iterator_concept` (if present) and `iterator_category` are inherited from [std::iterator_traits](../iterator_traits.html)<I>. 

The condition in the requires-clause is true if and only if [std::iterator_traits](../iterator_traits.html)<I> is not generated from the primary template. 

## Contents

  * [1 Note](iterator_traits.html#Note)
...
Run this code
    ...
    int main()
    {
        ...
        [std::list](../../container/list.html) l{1, 2, 3, 4};
        [std::counted_iterator](../counted_iterator.html) iv{v.begin(), 3};
        [std::counted_iterator](../counted_iterator.html) il{l.begin(), 3};
        static_assert([std::is_same](../../types/is_same.html)<int*, [std::iterator_traits](../iterator_traits.html)<decltype(iv)>::pointer>());
