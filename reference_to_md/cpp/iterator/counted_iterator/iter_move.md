...
[Member functions](../counted_iterator.html#Member_functions "cpp/iterator/counted iterator")  
---  
[counted_iterator::counted_iterator](counted_iterator.html "cpp/iterator/counted iterator/counted iterator")  
[counted_iterator::operator=](operator=.html "cpp/iterator/counted iterator/operator=")  
[counted_iterator::base](base.html "cpp/iterator/counted iterator/base")  
[counted_iterator::count](count.html "cpp/iterator/counted iterator/count")  
[counted_iterator::operator*counted_iterator::operator->](operator*.html "cpp/iterator/counted iterator/operator*")  
[counted_iterator::operator[]](operator_at.html "cpp/iterator/counted iterator/operator at")  
[counted_iterator::operator++counted_iterator::operator++(int)counted_iterator::operator+counted_iterator::operator+=counted_iterator::operator--counted_iterator::operator--(int)counted_iterator::operator-counted_iterator::operator-=](operator_arith.html "cpp/iterator/counted iterator/operator arith")  
[Non-member functions](../counted_iterator.html#Non-member_functions "cpp/iterator/counted iterator")  
[operator==operator<=>](operator_cmp.html "cpp/iterator/counted iterator/operator cmp")(C++20)(C++20)  
[operator==(default_sentinel_t)](operator_cmp2.html "cpp/iterator/counted iterator/operator cmp2")(C++20)  
[operator+](operator+.html "cpp/iterator/counted iterator/operator+")(C++20)  
[operator-](operator-.html "cpp/iterator/counted iterator/operator-")(C++20)  
[operator-(default_sentinel_t)](operator-2.html "cpp/iterator/counted iterator/operator-2")(C++20)  
**iter_move**(C++20)  
[iter_swap](iter_swap.html "cpp/iterator/counted iterator/iter swap")(C++20)  
...
friend constexpr decltype(auto) iter_move( const [std::counted_iterator](../counted_iterator.html)& i )  
noexcept(noexcept([ranges::iter_move](../ranges/iter_move.html)(i.base())))  
requires [std::input_iterator](../input_iterator.html)<I>; |  |  (since C++20)  
---|---|---  
| |   
  
Casts the result of dereferencing the underlying iterator to its associated rvalue reference type. 

The function body is equivalent to return [ranges::iter_move](../ranges/iter_move.html)(i.base());. 

This function is not visible to ordinary [unqualified](../../language/unqualified_lookup.html "cpp/language/unqualified lookup") or [qualified lookup](../../language/qualified_lookup.html "cpp/language/qualified lookup"), and can only be found by [argument-dependent lookup](../../language/adl.html "cpp/language/adl") when [std::counted_iterator](../counted_iterator.html)<I> is an associated class of the arguments. 

If i.count() is equal to ​0​, the behavior is undefined. 

## Contents

  * [1 Parameters](iter_move.html#Parameters)
  * [2 Return value](iter_move.html#Return_value)
  * [3 Complexity](iter_move.html#Complexity)
  * [4 Example](iter_move.html#Example)
  * [5 Defect reports](iter_move.html#Defect_reports)
  * [6 See also](iter_move.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/iter_move&action=edit&section=1 "Edit section: Parameters")] Parameters

i  |  \-  |  a source iterator adaptor   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/iter_move&action=edit&section=2 "Edit section: Return value")] Return value

An rvalue reference or a prvalue temporary. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/iter_move&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/iter_move&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    {
        [std::cout](../../io/cout.html) << rem << '[' << size(v) << "] {";
        for (char comma[]{0, ' ', 0}; auto const& s : v)
            [std::cout](../../io/cout.html) << comma << [std::quoted](../../io/manip/quoted.html)(s), *comma = ',';
        [std::cout](../../io/cout.html) << "}\n";
    }
     
    int main()
    {
        [std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)> p{"Alpha", "Bravo", "Charlie"}, q;
        print("p", p);
        print("q", q);
     
        using RI = [std::counted_iterator](../counted_iterator.html)<[std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)>::iterator>;
     
        for (RI iter{p.begin(), 2}; iter != [std::default_sentinel](../default_sentinel.html); ++iter)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/iter_move&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 3953](https://cplusplus.github.io/LWG/issue3953) | C++20  | the return type was [std::iter_rvalue_reference_t](../iter_t.html)<I> | changed to decltype(auto)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/iter_move&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[ iter_swap](iter_swap.html "cpp/iterator/counted iterator/iter swap")(C++20) |  swaps the objects pointed to by two underlying iterators   
