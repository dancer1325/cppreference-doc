...
This header is part of the [compile-time rational arithmetic](../utility/ratio.html "cpp/numeric/ratio") library. 

| 

## Contents

  * [1 Classes](ratio.html#Classes)
    * [1.1 Arithmetic](ratio.html#Arithmetic)
    * [1.2 Comparison](ratio.html#Comparison)
    * [1.3 Type Aliases](ratio.html#Type_Aliases)
  * [2 Synopsis](ratio.html#Synopsis)
...
---  
`quecto` (C++26) |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000000000000000000000000000000>, if [std::intmax_t](../types/integer.html "cpp/types/integer") can represent the denominator   
`ronto` (C++26) |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000000000000000000000000000>, if [std::intmax_t](../types/integer.html "cpp/types/integer") can represent the denominator   
`yocto` |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000000000000000000000000>, if [std::intmax_t](../types/integer.html "cpp/types/integer") can represent the denominator   
`zepto` |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000000000000000000000>, if [std::intmax_t](../types/integer.html "cpp/types/integer") can represent the denominator   
`atto` |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000000000000000000>  
`femto` |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000000000000000>  
`pico` |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000000000000>  
`nano` |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000000000>  
`micro` |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000000>  
`milli` |  [std::ratio](../numeric/ratio/ratio.html)<1, 1000>  
`centi` |  [std::ratio](../numeric/ratio/ratio.html)<1, 100>  
`deci` |  [std::ratio](../numeric/ratio/ratio.html)<1, 10>  
`deca` |  [std::ratio](../numeric/ratio/ratio.html)<10, 1>  
`hecto` |  [std::ratio](../numeric/ratio/ratio.html)<100, 1>  
`kilo` |  [std::ratio](../numeric/ratio/ratio.html)<1000, 1>  
`mega` |  [std::ratio](../numeric/ratio/ratio.html)<1000000, 1>  
`giga` |  [std::ratio](../numeric/ratio/ratio.html)<1000000000, 1>  
`tera` |  [std::ratio](../numeric/ratio/ratio.html)<1000000000000, 1>  
`peta` |  [std::ratio](../numeric/ratio/ratio.html)<1000000000000000, 1>  
`exa` |  [std::ratio](../numeric/ratio/ratio.html)<1000000000000000000, 1>  
`zetta` |  [std::ratio](../numeric/ratio/ratio.html)<1000000000000000000000, 1>, if [std::intmax_t](../types/integer.html "cpp/types/integer") can represent the numerator   
`yotta` |  [std::ratio](../numeric/ratio/ratio.html)<1000000000000000000000000, 1>, if [std::intmax_t](../types/integer.html "cpp/types/integer") can represent the numerator   
`ronna` (C++26) |  [std::ratio](../numeric/ratio/ratio.html)<1000000000000000000000000000, 1>, if [std::intmax_t](../types/integer.html "cpp/types/integer") can represent the numerator   
`quetta` (C++26) |  [std::ratio](../numeric/ratio/ratio.html)<1000000000000000000000000000000, 1>, if [std::intmax_t](../types/integer.html "cpp/types/integer") can represent the numerator   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/header/ratio&action=edit&section=1 "Edit section: Synopsis")] Synopsis
