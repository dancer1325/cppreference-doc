...
## Contents
  ...
  * [1 Includes](unordered_set.html#Includes)
  * [2 Classes](unordered_set.html#Classes)
  * [3 Functions](unordered_set.html#Functions)
    * [3.1 Range access](unordered_set.html#Range_access)
  * [4 Synopsis](unordered_set.html#Synopsis)
    * [4.1 Class template std::unordered_set](unordered_set.html#Class_template_std::unordered_set)
    * [4.2 Class template std::unordered_multiset](unordered_set.html#Class_template_std::unordered_multiset)
...
[ std::swap(std::unordered_set)](../container/unordered_set/swap2.html "cpp/container/unordered set/swap2")(C++11) |  specializes the [std::swap](../utility/swap.html "cpp/algorithm/swap") algorithm   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_swap2&action=edit)  
[ erase_if(std::unordered_set)](../container/unordered_set/erase_if.html "cpp/container/unordered set/erase if")(C++20) |  erases all elements satisfying specific criteria   
...
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_operator_cmp_unord&action=edit)  
[ std::swap(std::unordered_multiset)](../container/unordered_multiset/swap2.html "cpp/container/unordered multiset/swap2")(C++11) |  specializes the [std::swap](../utility/swap.html "cpp/algorithm/swap") algorithm   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_swap2&action=edit)  
[ erase_if(std::unordered_multiset)](../container/unordered_multiset/erase_if.html "cpp/container/unordered multiset/erase if")(C++20) |  erases all elements satisfying specific criteria   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_erase_if&action=edit)  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/header/unordered_set&action=edit&section=1 "Edit section: Synopsis")] Synopsis
    ...
     
      namespace pmr {
        ...
        using unordered_set = [std::unordered_set](../container/unordered_set.html)<Key, Hash, Pred, polymorphic_allocator<Key>>;
     
        template<class Key, class Hash = hash<Key>, class Pred = equal_to<Key>>
        using unordered_multiset =
          [std::unordered_multiset](../container/unordered_multiset.html)<Key, Hash, Pred, polymorphic_allocator<Key>>;
      }
    }

#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/unordered_set&action=edit&section=T-1 "Template:cpp/synopsis/unordered set")] Class template [std::unordered_set](../container/unordered_set.html "cpp/container/unordered set")
    ...
     
        ...
        unordered_set(from_range_t, R&& rg, size_type n, const allocator_type& a)
          : unordered_set(from_range, [std::forward](../utility/forward.html)<R>(rg), n, hasher(), key_equal(), a)
        {
        }
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
        unordered_set(from_range_t,
                      ...
                      const hasher& hf,
                      const allocator_type& a)
          : unordered_set(from_range, [std::forward](../utility/forward.html)<R>(rg), n, hf, key_equal(), a)
        {
        }
        unordered_set(initializer_list<value_type> il,
                      size_type n,
    ...
     
      template<[ranges::input_range](../ranges/input_range.html) R,
               class Hash      = hash<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
               class Pred      = equal_to<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
               class Allocator = allocator<[ranges::range_value_t](../ranges/range_size_t.html)<R>>>
      unordered_set(from_range_t,
                    R&&,
                    typename /* see description */ ::size_type = /* see description */,
                    Hash                                       = Hash(),
                    Pred                                       = Pred(),
                    Allocator                                  = Allocator())
        -> unordered_set<[ranges::range_value_t](../ranges/range_size_t.html)<R>, Hash, Pred, Allocator>;
     
      template<class T,
               class Hash      = hash<T>,
    ...
     
      ...
      unordered_set(from_range_t, R&&, typename /* see description */ ::size_type, Allocator)
        -> unordered_set<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                         hash<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
                         equal_to<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
                         Allocator>;
     
      template<[ranges::input_range](../ranges/input_range.html) R, class Allocator>
      unordered_set(from_range_t, R&&, Allocator)
        -> unordered_set<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                         ...
                         Allocator>;
     
      template<[ranges::input_range](../ranges/input_range.html) R, class Hash, class Allocator>
      unordered_set(from_range_t,
                    R&&,
                    typename /* see description */ ::size_type,
                    Hash,
                    Allocator) -> unordered_set<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                                                Hash,
                                                equal_to<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
                                                Allocator>;
     
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/unordered_set&action=edit&section=T-2 "Template:cpp/synopsis/unordered set")] Class template [std::unordered_multiset](../container/unordered_multiset.html "cpp/container/unordered multiset")
    ...
     
        ...
        unordered_multiset(from_range_t, R&& rg, size_type n, const allocator_type& a)
          : unordered_multiset(from_range, [std::forward](../utility/forward.html)<R>(rg), n, hasher(), key_equal(), a)
        {
        }
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
        unordered_multiset(from_range_t,
                           ...
                           const hasher& hf,
                           const allocator_type& a)
          : unordered_multiset(from_range, [std::forward](../utility/forward.html)<R>(rg), n, hf, key_equal(), a)
        {
        }
        unordered_multiset(initializer_list<value_type> il,
                           size_type n,
    ...
     
      ...
      unordered_multiset(from_range_t,
                         ...
                         Pred                                       = Pred(),
                         Allocator                                  = Allocator())
        -> unordered_multiset<[ranges::range_value_t](../ranges/range_size_t.html)<R>, Hash, Pred, Allocator>;
     
      template<class T,
               class Hash      = hash<T>,
               class Pred      = equal_to<T>,
    ...
     
      ...
      unordered_multiset(from_range_t,
                         R&&,
                         typename /* see description */ ::size_type,
                         Allocator) -> unordered_multiset<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                                                          hash<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
                                                          equal_to<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
                                                          Allocator>;
     
      ...
      unordered_multiset(from_range_t, R&&, Allocator)
        -> unordered_multiset<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                              hash<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
                              equal_to<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
                              Allocator>;
     
