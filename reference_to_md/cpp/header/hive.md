...
## Contents
  ...
  * [1 Includes](hive.html#Includes)
  * [2 Classes](hive.html#Classes)
  * [3 Functions](hive.html#Functions)
  * [4 Synopsis](hive.html#Synopsis)
    * [4.1 Class template std::hive](hive.html#Class_template_std::hive)
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/hive&action=edit&section=T-1 "Template:cpp/synopsis/hive")] Class template std::hive
    ...
     
      ...
      hive(from_range_t, R&&, Allocator = Allocator())
        -> hive<[ranges::range_value_t](../ranges/range_size_t.html)<R>, Allocator>;
     
      template<[ranges::input_range](../ranges/input_range.html) R, class Allocator = allocator<[ranges::range_value_t](../ranges/range_size_t.html)<R>>>
