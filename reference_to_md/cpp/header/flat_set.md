...
## Contents
  ...
  * [1 Includes](flat_set.html#Includes)
  * [2 Classes](flat_set.html#Classes)
  * [3 Functions](flat_set.html#Functions)
  * [4 Tags](flat_set.html#Tags)
  * [5 Synopsis](flat_set.html#Synopsis)
    * [5.1 Class template std::flat_set](flat_set.html#Class_template_std::flat_set)
    * [5.2 Class template std::flat_multiset](flat_set.html#Class_template_std::flat_multiset)
  * [6 References](flat_set.html#References)
...
#### Class template [std::flat_set](../container/flat_set.html)
    ...
     
        ...
        flat_set(from_range_t fr, R&& rg)
          : flat_set(fr, [std::forward](../utility/forward.html)<R>(rg), key_compare())
        {
        }
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
        flat_set(from_range_t, R&& rg, const key_compare& comp)
          : flat_set(comp)
        {
          insert_range([std::forward](../utility/forward.html)<R>(rg));
        }
     
    ...
     
        ...
        flat_set(sorted_unique_t,
                 ...
                 const key_compare& comp,
                 const Alloc& a);
        template<[container-compatible-range](../ranges/to.html)<value_type> R, class Alloc>
    ...
     
      ...
      flat_set(from_range_t, R&&, Compare = Compare(), Allocator = Allocator())
        -> flat_set<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                    Compare,
                    vector<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                           /*alloc-rebind*/<Allocator, [ranges::range_value_t](../ranges/range_size_t.html)<R>>>>;
     
      template<[ranges::input_range](../ranges/input_range.html) R, class Allocator>
      flat_set(from_range_t, R&&, Allocator)
        -> flat_set<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                    less<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
                    vector<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                           /*alloc-rebind*/<Allocator, [ranges::range_value_t](../ranges/range_size_t.html)<R>>>>;
     
...
#### Class template [std::flat_multiset](../container/flat_multiset.html)
    ...
     
        ...
        flat_multiset(from_range_t fr, R&& rg)
          : flat_multiset(fr, [std::forward](../utility/forward.html)<R>(rg), key_compare())
        {
        }
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
    ...
     
      ...
      flat_multiset(from_range_t, R&&, Compare = Compare(), Allocator = Allocator())
        -> flat_multiset<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                         Compare,
                         vector<[ranges::range_value_t](../ranges/range_size_t.html)<R>,
                                /*alloc-rebind*/<Allocator, [ranges::range_value_t](../ranges/range_size_t.html)<R>>>>;
     
