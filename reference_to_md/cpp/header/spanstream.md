...
## Contents
  ...
  * [1 Classes](spanstream.html#Classes)
  * [2 Functions](spanstream.html#Functions)
  * [3 Synopsis](spanstream.html#Synopsis)
    * [3.1 Class template std::basic_spanbuf](spanstream.html#Class_template_std::basic_spanbuf)
    * [3.2 Class template std::basic_ispanstream](spanstream.html#Class_template_std::basic_ispanstream)
    * [3.3 Class template std::basic_ospanstream](spanstream.html#Class_template_std::basic_ospanstream)
    * [3.4 Class template std::basic_spanstream](spanstream.html#Class_template_std::basic_spanstream)
...
(typedef)  
`ispanstream` (C++23) |  [std::basic_ispanstream](../io/basic_ispanstream.html)<char>  
(typedef)  
`wispanstream` (C++23) |  [std::basic_ispanstream](../io/basic_ispanstream.html)<wchar_t>  
(typedef)  
`ospanstream` (C++23) |  [std::basic_ospanstream](../io/basic_ospanstream.html)<char>  
(typedef)  
`wospanstream` (C++23) |  [std::basic_ospanstream](../io/basic_ospanstream.html)<wchar_t>  
(typedef)  
`spanstream` (C++23) |  [std::basic_spanstream](../io/basic_spanstream.html)<char>  
(typedef)  
`wspanstream` (C++23) |  [std::basic_spanstream](../io/basic_spanstream.html)<wchar_t>  
(typedef)  
...
#### Class template std::basic_spanbuf
    ...
     
        ...
        explicit basic_spanbuf(ios_base::openmode which)
          : basic_spanbuf([std::span](../container/span.html)<CharT>(), which) {}
        explicit basic_spanbuf(
          [std::span](../container/span.html)<CharT> s,
    ...
     
        // get and set
        [std::span](../container/span.html)<CharT> span() const noexcept;
        void span([std::span](../container/span.html)<CharT> s) noexcept;
     
        protected:
    ...
     
      private:
        ...
        [std::span](../container/span.html)<CharT> buf; // exposition only
      };
     
...
#### Class template std::basic_ispanstream
    ...
     
        ...
        [std::span](../container/span.html)<const CharT> span() const noexcept;
        void span([std::span](../container/span.html)<CharT> s) noexcept;
        template<class ROS>
