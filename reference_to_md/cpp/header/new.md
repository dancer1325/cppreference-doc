...
## Contents
  ...
  * [1 Classes](new.html#Classes)
  * [2 Types](new.html#Types)
  * [3 Tags](new.html#Tags)
  * [4 Constants](new.html#Constants)
  * [5 Functions](new.html#Functions)
  * [6 Synopsis](new.html#Synopsis)
    * [6.1 Class std::bad_alloc](new.html#Class_std::bad_alloc)
    * [6.2 Class std::bad_array_new_length](new.html#Class_std::bad_array_new_length)
...
### Synopsis
    ...
    void*
    [operator new](../memory/new/operator_new.html)([std::size_t](../types/size_t.html) size);
    void*
    [operator new](../memory/new/operator_new.html)([std::size_t](../types/size_t.html) size, [std::align_val_t](../memory/new/align_val_t.html) alignment);
    void*
    [operator new](../memory/new/operator_new.html)([std::size_t](../types/size_t.html) size, const [std::nothrow_t](../memory/new/nothrow_t.html)&) noexcept;
    void*
    [operator new](../memory/new/operator_new.html)([std::size_t](../types/size_t.html) size,
                 [std::align_val_t](../memory/new/align_val_t.html) alignment,
                 const [std::nothrow_t](../memory/new/nothrow_t.html)&) noexcept;
     
    void
    [operator delete](../memory/new/operator_delete.html)(void* ptr) noexcept;
    void
    [operator delete](../memory/new/operator_delete.html)(void* ptr, [std::size_t](../types/size_t.html) size) noexcept;
    void
    [operator delete](../memory/new/operator_delete.html)(void* ptr, [std::align_val_t](../memory/new/align_val_t.html) alignment) noexcept;
    void
    [operator delete](../memory/new/operator_delete.html)(void* ptr, [std::size_t](../types/size_t.html) size, [std::align_val_t](../memory/new/align_val_t.html) alignment) noexcept;
    void
    [operator delete](../memory/new/operator_delete.html)(void* ptr, const [std::nothrow_t](../memory/new/nothrow_t.html)&) noexcept;
    void
    [operator delete](../memory/new/operator_delete.html)(void* ptr, [std::align_val_t](../memory/new/align_val_t.html) alignment, const [std::nothrow_t](../memory/new/nothrow_t.html)&) noexcept;
     
    void*
    [operator new](../memory/new/operator_new.html)[]([std::size_t](../types/size_t.html) size);
    void*
    ...
     
    constexpr void*
    [operator new](../memory/new/operator_new.html)([std::size_t](../types/size_t.html) size, void* ptr) noexcept;
    constexpr void*
    [operator new](../memory/new/operator_new.html)[]([std::size_t](../types/size_t.html) size, void* ptr) noexcept;
    void
