...
Compatibility header. true, false and bool are [keywords](../keywords.html "cpp/keyword") in C++, but they were not keywords in C until C23. 
...
---|---|---|---  
[LWG 3827](https://cplusplus.github.io/LWG/issue3827) | C++11  | C programs no longer need the compatibility macro  
`__bool_true_false_are_defined` since C23  | deprecated this  
macro in C++ 
