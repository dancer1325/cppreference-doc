...
## Contents
  ...
  * [1 Classes](span.html#Classes)
  * [2 Constants](span.html#Constants)
  * [3 Functions](span.html#Functions)
    * [3.1 Range access](span.html#Range_access)
  * [4 Synopsis](span.html#Synopsis)
    * [4.1 Class template std::span](span.html#Class_template_std::span)
...
[ dynamic_extent](../container/span/dynamic_extent.html "cpp/container/span/dynamic extent")(C++20) |  a constant of type [std::size_t](../types/size_t.html "cpp/types/size t") signifying that the `span` has dynamic extent   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/header/span&action=edit&section=1 "Edit section: Synopsis")] Synopsis
    ...
     
      ...
      constexpr bool [ranges::enable_view](../ranges/view.html)<span<ElementType, Extent>> = true;
      template<class ElementType, size_t Extent>
      constexpr bool [ranges::enable_borrowed_range](../ranges/borrowed_range.html)<span<ElementType, Extent>> = true;
     
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/span&action=edit&section=T-1 "Template:cpp/synopsis/span")] Class template std::span
    ...
    namespace std {
      ...
      public:
        ...
        using const_iterator              = [std::const_iterator](../iterator/const_iterator.html)<iterator>;
        using reverse_iterator            = [std::reverse_iterator](../iterator/reverse_iterator.html)<iterator>;
        using const_reverse_iterator      = [std::const_iterator](../iterator/const_iterator.html)<reverse_iterator>;
    ...
     
        ...
        constexpr explicit(extent != dynamic_extent)
          span([std::initializer_list](../utility/initializer_list.html)<value_type> il);
    ...
     
      ...
      template<class R>
      span(R&&) -> span<remove_reference_t<[ranges::range_reference_t](../ranges/range_reference_t.html)<R>>>;
    }
