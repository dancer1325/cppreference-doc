...
## Contents
  ...
  * [1 Includes](chrono.html#Includes)
  * [2 Classes](chrono.html#Classes)
    * [2.1 Duration](chrono.html#Duration)
    * [2.2 Convenience duration typedefs](chrono.html#Convenience_duration_typedefs)
    * [2.3 Time point](chrono.html#Time_point)
    * [2.4 Clocks](chrono.html#Clocks)
    * [2.5 Calendar](chrono.html#Calendar)
    * [2.6 Time of day](chrono.html#Time_of_day)
    * [2.7 Time zone](chrono.html#Time_zone)
    * [2.8 Leap second](chrono.html#Leap_second)
    * [2.9 Specializations](chrono.html#Specializations)
    * [2.10 Forward declarations](chrono.html#Forward_declarations)
  * [3 Functions](chrono.html#Functions)
    * [3.1 Duration](chrono.html#Duration_2)
    * [3.2 Time point](chrono.html#Time_point_2)
    * [3.3 Calendar](chrono.html#Calendar_2)
    * [3.4 Time of day](chrono.html#Time_of_day_2)
    * [3.5 Time zone](chrono.html#Time_zone_2)
    * [3.6 Leap second](chrono.html#Leap_second_2)
    * [3.7 I/O](chrono.html#I.2FO)
    * [3.8 Literals](chrono.html#Literals)
  * [4 Synopsis](chrono.html#Synopsis)
    * [4.1 Class template std::chrono::duration](chrono.html#Class_template_std::chrono::duration)
    * [4.2 Class template std::chrono::time_point](chrono.html#Class_template_std::chrono::time_point)
    * [4.3 Class template std::common_type's specialization for std::chrono::duration](chrono.html#Class_template_std::common_type.27s_specialization_for_std::chrono::duration)
    * [4.4 Class template std::common_type's specialization for std::chrono::time_point](chrono.html#Class_template_std::common_type.27s_specialization_for_std::chrono::time_point)
    * [4.5 Class template std::chrono::treat_as_floating_point](chrono.html#Class_template_std::chrono::treat_as_floating_point)
    * [4.6 Class template std::chrono::duration_values](chrono.html#Class_template_std::chrono::duration_values)
    * [4.7 Class std::chrono::system_clock](chrono.html#Class_std::chrono::system_clock)
    * [4.8 Class std::chrono::utc_clock](chrono.html#Class_std::chrono::utc_clock)
    * [4.9 Class std::chrono::tai_clock](chrono.html#Class_std::chrono::tai_clock)
    * [4.10 Class std::chrono::gps_clock](chrono.html#Class_std::chrono::gps_clock)
    * [4.11 Class std::chrono::steady_clock](chrono.html#Class_std::chrono::steady_clock)
    * [4.12 Class std::chrono::high_resolution_clock](chrono.html#Class_std::chrono::high_resolution_clock)
    * [4.13 Class template std::chrono::clock_time_conversion](chrono.html#Class_template_std::chrono::clock_time_conversion)
    * [4.14 Class std::chrono::last_spec](chrono.html#Class_std::chrono::last_spec)
    * [4.15 Class std::chrono::day](chrono.html#Class_std::chrono::day)
    * [4.16 Class std::chrono::month](chrono.html#Class_std::chrono::month)
    * [4.17 Class std::chrono::year](chrono.html#Class_std::chrono::year)
    * [4.18 Class std::chrono::weekday](chrono.html#Class_std::chrono::weekday)
    * [4.19 Class std::chrono::weekday_indexed](chrono.html#Class_std::chrono::weekday_indexed)
    * [4.20 Class std::chrono::weekday_last](chrono.html#Class_std::chrono::weekday_last)
    * [4.21 Class std::chrono::month_day](chrono.html#Class_std::chrono::month_day)
    * [4.22 Class std::chrono::month_day_last](chrono.html#Class_std::chrono::month_day_last)
    * [4.23 Class std::chrono::month_weekday](chrono.html#Class_std::chrono::month_weekday)
    * [4.24 Class std::chrono::month_weekday_last](chrono.html#Class_std::chrono::month_weekday_last)
    * [4.25 Class std::chrono::year_month](chrono.html#Class_std::chrono::year_month)
    * [4.26 Class std::chrono::year_month_day](chrono.html#Class_std::chrono::year_month_day)
    * [4.27 Class std::chrono::year_month_day_last](chrono.html#Class_std::chrono::year_month_day_last)
    * [4.28 Class std::chrono::year_month_weekday](chrono.html#Class_std::chrono::year_month_weekday)
    * [4.29 Class std::chrono::year_month_weekday_last](chrono.html#Class_std::chrono::year_month_weekday_last)
    * [4.30 Class template std::chrono::hh_mm_ss](chrono.html#Class_template_std::chrono::hh_mm_ss)
    * [4.31 Class std::chrono::tzdb](chrono.html#Class_std::chrono::tzdb)
    * [4.32 Class std::chrono::tzdb_list](chrono.html#Class_std::chrono::tzdb_list)
    * [4.33 Class std::chrono::nonexistent_local_time](chrono.html#Class_std::chrono::nonexistent_local_time)
    * [4.34 Class std::chrono::ambiguous_local_time](chrono.html#Class_std::chrono::ambiguous_local_time)
    * [4.35 Class std::chrono::sys_info](chrono.html#Class_std::chrono::sys_info)
    * [4.36 Class std::chrono::local_info](chrono.html#Class_std::chrono::local_info)
    * [4.37 Class std::chrono::time_zone](chrono.html#Class_std::chrono::time_zone)
    * [4.38 Class template std::chrono::zoned_traits](chrono.html#Class_template_std::chrono::zoned_traits)
    * [4.39 Class template std::chrono::zoned_time](chrono.html#Class_template_std::chrono::zoned_time)
    * [4.40 Class std::chrono::leap_second](chrono.html#Class_std::chrono::leap_second)
    * [4.41 Class std::chrono::time_zone_link](chrono.html#Class_std::chrono::time_zone_link)
    * [4.42 Class template _local-time-format-t_](chrono.html#Class_template_local-time-format-t)
...
Defined in namespace `std::chrono`  
[std::chrono::nanoseconds](../chrono/duration.html "cpp/chrono/duration")(C++11) |  duration type with Period [std::nano](../numeric/ratio/ratio.html "cpp/numeric/ratio/ratio")  
[std::chrono::microseconds](../chrono/duration.html "cpp/chrono/duration")(C++11) |  duration type with Period [std::micro](../numeric/ratio/ratio.html "cpp/numeric/ratio/ratio")  
[std::chrono::milliseconds](../chrono/duration.html "cpp/chrono/duration")(C++11) |  duration type with Period [std::milli](../numeric/ratio/ratio.html "cpp/numeric/ratio/ratio")  
[std::chrono::seconds](../chrono/duration.html "cpp/chrono/duration")(C++11) |  duration type with Period [std::ratio](../numeric/ratio/ratio.html)<1>  
[std::chrono::minutes](../chrono/duration.html "cpp/chrono/duration")(C++11) |  duration type with Period [std::ratio](../numeric/ratio/ratio.html)<60>  
[std::chrono::hours](../chrono/duration.html "cpp/chrono/duration")(C++11) |  duration type with Period [std::ratio](../numeric/ratio/ratio.html)<3600>  
std::chrono::days(C++20) |  duration type with Period [std::ratio](../numeric/ratio/ratio.html)<86400>  
std::chrono::weeks(C++20) |  duration type with Period [std::ratio](../numeric/ratio/ratio.html)<604800>  
std::chrono::months(C++20) |  duration type with Period [std::ratio](../numeric/ratio/ratio.html)<2629746>  
std::chrono::years(C++20) |  duration type with Period [std::ratio](../numeric/ratio/ratio.html)<31556952>  
