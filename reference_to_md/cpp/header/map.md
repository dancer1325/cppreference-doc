...
## Contents
  ...
  * [1 Includes](map.html#Includes)
  * [2 Classes](map.html#Classes)
  * [3 Functions](map.html#Functions)
    * [3.1 Range access](map.html#Range_access)
  * [4 Synopsis](map.html#Synopsis)
    * [4.1 Class template std::map](map.html#Class_template_std::map)
    * [4.2 Class template std::multimap](map.html#Class_template_std::multimap)
  * [5 Defect reports](map.html#Defect_reports)
...
### Synopsis
    ...
     
      namespace pmr {
        ...
        using map = [std::map](../container/map.html)<Key, T, Compare, polymorphic_allocator<pair<const Key, T>>>;
     
        template<class Key, class T, class Compare = less<Key>>
        using multimap =
          [std::multimap](../container/multimap.html)<Key, T, Compare, polymorphic_allocator<pair<const Key, T>>>;
      }
    }
    ...
     
        ...
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
          map(from_range_t, R&& rg, const Allocator& a))
            : map(from_range, [std::forward](../utility/forward.html)<R>(rg), Compare(), a)
        {
        }
    ...
     
        ...
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
          multimap(from_range_t, R&& rg, const Allocator& a))
            : multimap(from_range, [std::forward](../utility/forward.html)<R>(rg), Compare(), a)
        {
        }
...
---|---|---|---  
[LWG 133](https://cplusplus.github.io/LWG/issue133) | C++98  | [`map::get_allocator`](../container/map/get_allocator.html "cpp/container/map/get allocator") was missing in the synopsis  | added 
