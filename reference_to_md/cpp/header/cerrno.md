...
## Contents
  ...
  * [1 Macros](cerrno.html#Macros)
  * [2 Notes](cerrno.html#Notes)
  * [3 Synopsis](cerrno.html#Synopsis)
  * [4 Defect reports](cerrno.html#Defect_reports)
  * [5 See also](cerrno.html#See_also)
...
(macro constant)  
ENODATA(C++11) (deprecated in C++23) |  No message is available on the STREAM head read queue   
(macro constant)  
...
(macro constant)  
ENOSR(C++11) (deprecated in C++23) |  No STREAM resources   
(macro constant)  
ENOSTR(C++11) (deprecated in C++23) |  Not a STREAM   
(macro constant)  
...
(macro constant)  
ETIME(C++11) (deprecated in C++23) |  Stream `ioctl()` timeout   
(macro constant)  
