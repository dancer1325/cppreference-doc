...
## Contents
  ...
  * [1 Includes](forward_list.html#Includes)
  * [2 Classes](forward_list.html#Classes)
  * [3 Functions](forward_list.html#Functions)
    * [3.1 Range access](forward_list.html#Range_access)
  * [4 Synopsis](forward_list.html#Synopsis)
    * [4.1 Class template std::forward_list](forward_list.html#Class_template_std::forward_list)
...
[ std::swap(std::forward_list)](../container/forward_list/swap2.html "cpp/container/forward list/swap2")(C++11) |  specializes the [std::swap](../utility/swap.html "cpp/algorithm/swap") algorithm   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_swap2&action=edit)  
[ erase(std::forward_list)erase_if(std::forward_list)](../container/forward_list/erase2.html "cpp/container/forward list/erase2")(C++20) |  erases all elements satisfying specific criteria   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/header/forward_list&action=edit&section=1 "Edit section: Synopsis")] Synopsis
    ...
     
      namespace pmr {
        template<class T>
        using forward_list = [std::forward_list](../container/forward_list.html)<T, polymorphic_allocator<T>>;
      }
    }

#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/forward_list&action=edit&section=T-1 "Template:cpp/synopsis/forward list")] Class template [std::forward_list](../container/forward_list.html "cpp/container/forward list")
    ...
     
      ...
      forward_list(from_range_t, R&&, Allocator = Allocator())
        -> forward_list<[ranges::range_value_t](../ranges/range_size_t.html)<R>, Allocator>;
    }
