...
This header is part of the null-terminated [wide](../string/wide.html "cpp/string/wide") and [multibyte](../string/multibyte.html "cpp/string/multibyte") strings libraries. It also provides some [C-style I/O](../io/c.html "cpp/io/c") functions and conversion from [C-style Date](../chrono/c.html "cpp/chrono/c"). 

## Contents

  * [1 Macros](cwchar.html#Macros)
  * [2 Types](cwchar.html#Types)
  * [3 Functions](cwchar.html#Functions)
    * [3.1 String manipulation](cwchar.html#String_manipulation)
    * [3.2 String examination](cwchar.html#String_examination)
    * [3.3 Wide character array manipulation](cwchar.html#Wide_character_array_manipulation)
    * [3.4 Multibyte/wide character conversion](cwchar.html#Multibyte.2Fwide_character_conversion)
    * [3.5 Input/Output](cwchar.html#Input.2FOutput)
    * [3.6 String conversions](cwchar.html#String_conversions)
  * [4 Notes](cwchar.html#Notes)
  * [5 Synopsis](cwchar.html#Synopsis)
  * [6 Defect reports](cwchar.html#Defect_reports)
...
### Notes
  ...
  * `std::wint_t` is also defined in the following headers: 
    * [`<cwctype>`](cwctype.html "cpp/header/cwctype")
  * [std::tm](../chrono/c/tm.html "cpp/chrono/c/tm") is also defined in the following headers: 
    * [`<ctime>`](ctime.html "cpp/header/ctime")
...
---|---|---|---  
[LWG 345](https://cplusplus.github.io/LWG/issue345) | C++98  | [std::tm](../chrono/c/tm.html "cpp/chrono/c/tm") was not provided in `<cwchar>` | provided 
