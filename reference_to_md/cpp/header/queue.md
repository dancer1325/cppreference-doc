...
## Contents
  ...
  * [1 Includes](queue.html#Includes)
  * [2 Classes](queue.html#Classes)
  * [3 Functions](queue.html#Functions)
  * [4 Synopsis](queue.html#Synopsis)
    * [4.1 Class template std::queue](queue.html#Class_template_std::queue)
    * [4.2 Class template std::priority_queue](queue.html#Class_template_std::priority_queue)
...
#### Class template [std::queue](../container/queue.html "cpp/container/queue")
    ...
     
        ...
        {
          return c.emplace_back([std::forward](../utility/forward.html)<Args>(args)...);
        }
    ...
     
      ...
      queue(from_range_t, R&&) -> queue<[ranges::range_value_t](../ranges/range_size_t.html)<R>>;
     
    ...
     
      ...
      queue(from_range_t, R&&, Allocator)
        -> queue<[ranges::range_value_t](../ranges/range_size_t.html)<R>, deque<[ranges::range_value_t](../ranges/range_size_t.html)<R>, Allocator>>;
     
      template<class T, class Container, class Alloc>
      struct uses_allocator<queue<T, Container>, Alloc>
...
#### Class template [std::priority_queue](../container/priority_queue.html "cpp/container/priority queue")
    ...
     
      ...
      priority_queue(InputIter, InputIter, Compare, Container, Allocator)
        -> priority_queue<typename Container::value_type, Container, Compare>;
     
      template<[ranges::input_range](../ranges/input_range.html) R, class Compare, class Allocator>
