...
## Contents
  ...
  * [1 Classes](fstream.html#Classes)
  * [2 Functions](fstream.html#Functions)
  * [3 Synopsis](fstream.html#Synopsis)
    * [3.1 Class template std::basic_filebuf](fstream.html#Class_template_std::basic_filebuf)
    * [3.2 Class template std::basic_ifstream](fstream.html#Class_template_std::basic_ifstream)
    * [3.3 Class template std::basic_ofstream](fstream.html#Class_template_std::basic_ofstream)
    * [3.4 Class template std::basic_fstream](fstream.html#Class_template_std::basic_fstream)
...
(typedef)  
`ifstream` |  [std::basic_ifstream](../io/basic_ifstream.html)<char>  
(typedef)  
`wifstream` |  [std::basic_ifstream](../io/basic_ifstream.html)<wchar_t>  
(typedef)  
`ofstream` |  [std::basic_ofstream](../io/basic_ofstream.html)<char>  
(typedef)  
`wofstream` |  [std::basic_ofstream](../io/basic_ofstream.html)<wchar_t>  
(typedef)  
`fstream` |  [std::basic_fstream](../io/basic_fstream.html)<char>  
(typedef)  
`wfstream` |  [std::basic_fstream](../io/basic_fstream.html)<wchar_t>  
(typedef)  
