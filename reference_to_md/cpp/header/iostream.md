...
## Contents
  ...
  * [1 Includes](iostream.html#Includes)
...
---|---|---|---  
[LWG 155](https://cplusplus.github.io/LWG/issue155) | C++98  | the type of the static object was `std::basic_ios::Init`  
(not strictly wrong, but the wording was misleading)  | corrected to `std::ios_base::Init`  
[LWG 1123](https://cplusplus.github.io/LWG/issue1123) | C++98  | including `<iostream>` did not guarantee the  
construction of [std::ios_base::Init](../io/ios_base/Init.html "cpp/io/ios base/Init") objects  | guarantees 
