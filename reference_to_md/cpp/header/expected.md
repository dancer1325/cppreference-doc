...
## Contents
  ...
  * [1 Classes](expected.html#Classes)
  * [2 Synopsis](expected.html#Synopsis)
    * [2.1 Class template std::unexpected](expected.html#Class_template_std::unexpected)
    * [2.2 Class template std::bad_expected_access](expected.html#Class_template_std::bad_expected_access)
    * [2.3 Class template specialization std::bad_expected_access<void>](expected.html#Class_template_specialization_std::bad_expected_access.3Cvoid.3E)
    * [2.4 Class template std::expected](expected.html#Class_template_std::expected)
    * [2.5 Partial specialization of std::expected for void types](expected.html#Partial_specialization_of_std::expected_for_void_types)
...
#### Class template std::expected
    ...
     
        ...
        constexpr expected(expected&&) noexcept(/* see description */);
    ...
     
        template<class G>
        constexpr explicit(/* see description */) expected(const unexpected<G>&);
        template<class G>
        constexpr explicit(/* see description */) expected(unexpected<G>&&);
     
        template<class... Args>
