...
## Contents
  ...
  * [1 Classes](generator.html#Classes)
  * [2 Synopsis](generator.html#Synopsis)
    * [2.1 Class template std::generator](generator.html#Class_template_std::generator)
    * [2.2 Class std::generator::promise_type](generator.html#Class_std::generator::promise_type)
    * [2.3 Class std::generator::iterator](generator.html#Class_std::generator::iterator)
  * [3 References](generator.html#References)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/header/generator&action=edit&section=1 "Edit section: Synopsis")] Synopsis
    ...
     
      namespace pmr {
        ...
        using generator = [std::generator](../coroutine/generator.html)<Ref, V, polymorphic_allocator<>>;
      }
    }
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/generator&action=edit&section=T-1 "Template:cpp/synopsis/generator")] Class template [std::generator](../coroutine/generator.html)
    ...
    namespace std {
      template<class Ref, class V = void, class Allocator = void>
      class generator : public [ranges::view_interface](../ranges/view_interface.html)<generator<Ref, V, Allocator>>
      {
      private:
        using /*value*/ =
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/generator&action=edit&section=T-2 "Template:cpp/synopsis/generator")] Class std::generator::promise_type
    ...
     
        template<[ranges::input_range](../ranges/input_range.html) R, class Alloc>
          requires convertible_to<[ranges::range_reference_t](../ranges/range_reference_t.html)<R>, yielded>
    ...
     
        void* [operator new](../memory/new/operator_new.html)(size_t size)
          requires same_as<Allocator, void> || default_initializable<Allocator>;
     
        template<class Alloc, class... Args>
        void* [operator new](../memory/new/operator_new.html)(size_t size, allocator_arg_t, const Alloc& alloc, const Args&...);
     
        template<class This, class Alloc, class... Args>
        void* [operator new](../memory/new/operator_new.html)(size_t size, const This&, allocator_arg_t, const Alloc& alloc,
                           const Args&...);
     
        void [operator delete](../memory/new/operator_delete.html)(void* pointer, size_t size) noexcept;
     
      private:
