...
This header is part of the [filesystem support](../filesystem.html "cpp/filesystem") library. 

| 

## Contents

  * [1 Includes](filesystem.html#Includes)
  * [2 Classes](filesystem.html#Classes)
    * [2.1 Forward declarations](filesystem.html#Forward_declarations)
  * [3 Functions](filesystem.html#Functions)
    * [3.1 File types](filesystem.html#File_types)
  * [4 Synopsis](filesystem.html#Synopsis)
    * [4.1 Class std::filesystem::path](filesystem.html#Class_std::filesystem::path)
    * [4.2 Class std::filesystem::filesystem_error](filesystem.html#Class_std::filesystem::filesystem_error)
    * [4.3 Class std::filesystem::directory_entry](filesystem.html#Class_std::filesystem::directory_entry)
    * [4.4 Class std::filesystem::directory_iterator](filesystem.html#Class_std::filesystem::directory_iterator)
    * [4.5 Class std::filesystem::recursive_directory_iterator](filesystem.html#Class_std::filesystem::recursive_directory_iterator)
    * [4.6 Class std::filesystem::file_status](filesystem.html#Class_std::filesystem::file_status)
...
Defined in namespace `std::filesystem`  
[ u8path](../filesystem/path/u8path.html "cpp/filesystem/path/u8path")(C++17)(deprecated in C++20) |  creates a `path` from a UTF-8 encoded source   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/header/filesystem&action=edit&section=1 "Edit section: Synopsis")] Synopsis
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/filesystem&action=edit&section=T-1 "Template:cpp/synopsis/filesystem")] Class [std::filesystem::path](../filesystem/path.html "cpp/filesystem/path")
    ...
     
        ...
        [std::u8string](../string/basic_string.html)  u8string() const;
    ...
     
        ...
        [std::u8string](../string/basic_string.html)  generic_u8string() const;
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/filesystem&action=edit&section=T-2 "Template:cpp/synopsis/filesystem")] Class [std::filesystem::filesystem_error](../filesystem/filesystem_error.html "cpp/filesystem/filesystem error")
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/filesystem&action=edit&section=T-3 "Template:cpp/synopsis/filesystem")] Class [std::filesystem::directory_entry](../filesystem/directory_entry.html "cpp/filesystem/directory entry")
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/filesystem&action=edit&section=T-4 "Template:cpp/synopsis/filesystem")] Class [std::filesystem::directory_iterator](../filesystem/directory_iterator.html "cpp/filesystem/directory iterator")
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/filesystem&action=edit&section=T-5 "Template:cpp/synopsis/filesystem")] Class [std::filesystem::recursive_directory_iterator](../filesystem/recursive_directory_iterator.html "cpp/filesystem/recursive directory iterator")
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/filesystem&action=edit&section=T-6 "Template:cpp/synopsis/filesystem")] Class [std::filesystem::file_status](../filesystem/file_status.html "cpp/filesystem/file status")
