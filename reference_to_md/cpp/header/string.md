...
## Contents
  ...
  * [1 Includes](string.html#Includes)
  * [2 Classes](string.html#Classes)
  * [3 Functions](string.html#Functions)
    * [3.1 Input/output](string.html#Input.2Foutput)
    * [3.2 Numeric conversions](string.html#Numeric_conversions)
    * [3.3 Range access](string.html#Range_access)
    * [3.4 Literals](string.html#Literals)
  * [4 Synopsis](string.html#Synopsis)
    * [4.1 Class template std::char_traits](string.html#Class_template_std::char_traits)
    * [4.2 Class template std::basic_string](string.html#Class_template_std::basic_string)
  * [5 Defect reports](string.html#Defect_reports)
...
[ char_traits](../string/char_traits.html "cpp/string/char traits") |  Class Template which describes properties of a character type   
(class template)  
[std::char_traits](../string/char_traits.html)<char> |  (class template specialization)  
[std::char_traits](../string/char_traits.html)<wchar_t> |  (class template specialization)  
[std::char_traits](../string/char_traits.html)<char8_t> (C++20) |  (class template specialization)  
...
[std::u32string](../string/basic_string.html "cpp/string/basic string") (C++11) |  [std::basic_string](../string/basic_string.html)<char32_t> (typedef)  
[std::wstring](../string/basic_string.html "cpp/string/basic string") |  [std::basic_string](../string/basic_string.html)<wchar_t> (typedef)  
[std::pmr::basic_string](../string/basic_string.html "cpp/string/basic string") (C++17) |  (alias template)  
[std::pmr::string](../string/basic_string.html "cpp/string/basic string") (C++17) |  [std::pmr::basic_string](../string/basic_string.html)<char> (typedef)  
[std::pmr::u8string](../string/basic_string.html "cpp/string/basic string") (C++20) |  [std::pmr::basic_string](../string/basic_string.html)<char8_t> (typedef)  
[std::pmr::u16string](../string/basic_string.html "cpp/string/basic string") (C++17) |  [std::pmr::basic_string](../string/basic_string.html)<char16_t> (typedef)  
[std::pmr::u32string](../string/basic_string.html "cpp/string/basic string") (C++17) |  [std::pmr::basic_string](../string/basic_string.html)<char32_t> (typedef)  
[std::pmr::wstring](../string/basic_string.html "cpp/string/basic string") (C++17) |  [std::pmr::basic_string](../string/basic_string.html)<wchar_t> (typedef)  
...
### Synopsis
    ...
     
      namespace pmr {
        template<class CharT, class Traits = char_traits<CharT>>
          using basic_string = [std::basic_string](../string/basic_string.html)<CharT, Traits, polymorphic_allocator<CharT>>;
     
        using string    = basic_string<char>;
        using u8string  = basic_string<char8_t>;
        using u16string = basic_string<char16_t>;
    ...
     
      template<[ranges::input_range](../ranges/input_range.html) R,
        ...
        basic_string(from_range_t, R&&, Allocator = Allocator())
          -> basic_string<[ranges::range_value_t](../ranges/range_size_t.html)<R>, char_traits<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
                          Allocator>;
     
...
---|---|---|---  
[LWG 209](https://cplusplus.github.io/LWG/issue209) | C++98  | the declarations of the following [std::basic_string](../string/basic_string.html "cpp/string/basic string")  
