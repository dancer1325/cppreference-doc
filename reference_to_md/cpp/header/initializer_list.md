...
[ std::begin(std::initializer_list)](../utility/initializer_list/begin2.html "cpp/utility/initializer list/begin2")(C++11) |  overloads [std::begin](../iterator/begin.html "cpp/iterator/begin")   
...
[ std::end(std::initializer_list)](../utility/initializer_list/end2.html "cpp/utility/initializer list/end2")(C++11) |  specializes [std::end](../iterator/end.html "cpp/iterator/end")   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/header/initializer_list&action=edit&section=1 "Edit section: Synopsis")] Synopsis
