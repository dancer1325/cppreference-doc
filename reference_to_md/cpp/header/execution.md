...
## Contents
  ...
  * [1 Classes](execution.html#Classes)
  * [2 Constants](execution.html#Constants)
  * [3 Synopsis](execution.html#Synopsis)
    * [3.1 Helper concepts](execution.html#Helper_concepts)
    * [3.2 Helper classes](execution.html#Helper_classes)
    * [3.3 enum std::forward_progress_guarantee](execution.html#enum_std::forward_progress_guarantee)
    * [3.4 Concept scheduler](execution.html#Concept_scheduler)
    * [3.5 Concept receiver](execution.html#Concept_receiver)
    * [3.6 Concept operation_state](execution.html#Concept_operation_state)
...
### Synopsis
    ...
    namespace std {
      ...
      template<class T>
      constexpr bool is_execution_policy_v = is_execution_policy<T>::value; // freestanding
    }
     
...
#### Concept [`scheduler`](../execution/scheduler.html "cpp/execution/scheduler")
    ...
    namespace std::execution {
      ...
      concept scheduler =
        ...
        requires(Sch&& sch) {
          {
            schedule([std::forward](../utility/forward.html)<Sch>(sch))
          } -> sender;
          {
            auto(get_completion_scheduler<set_value_t>(
              get_env(schedule([std::forward](../utility/forward.html)<Sch>(sch)))))
