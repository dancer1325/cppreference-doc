...
## Contents
  ...
  * [1 Includes](set.html#Includes)
  * [2 Classes](set.html#Classes)
  * [3 Functions](set.html#Functions)
    * [3.1 Range access](set.html#Range_access)
  * [4 Synopsis](set.html#Synopsis)
    * [4.1 Class template std::set](set.html#Class_template_std::set)
    * [4.2 Class template std::multiset](set.html#Class_template_std::multiset)
...
### Synopsis
    ...
     
      namespace pmr {
        ...
        using set = [std::set](../container/set.html)<Key, Compare, polymorphic_allocator<Key>>;
     
        template<class Key, class Compare = less<Key>>
        using multiset = [std::multiset](../container/multiset.html)<Key, Compare, polymorphic_allocator<Key>>;
      }
    }
...
#### Class template [std::set](../container/set.html "cpp/container/set")
    ...
     
        ...
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
          set(from_range_t, R&& rg, const Allocator& a))
            : set(from_range, [std::forward](../utility/forward.html)<R>(rg), Compare(), a)
        {
        }
    ...
     
      template<[ranges::input_range](../ranges/input_range.html) R,
               class Compare   = less<[ranges::range_value_t](../ranges/range_size_t.html)<R>>,
               class Allocator = allocator<[ranges::range_value_t](../ranges/range_size_t.html)<R>>>
      set(from_range_t, R&&, Compare = Compare(), Allocator = Allocator())
        -> set<[ranges::range_value_t](../ranges/range_size_t.html)<R>, Compare, Allocator>;
     
      template<class Key, class Compare = less<Key>, class Allocator = allocator<Key>>
    ...
     
      ...
      set(from_range_t, R&&, Allocator)
        -> set<[ranges::range_value_t](../ranges/range_size_t.html)<R>, less<[ranges::range_value_t](../ranges/range_size_t.html)<R>>, Allocator>;
     
...
#### Class template [std::multiset](../container/multiset.html "cpp/container/multiset")
    ...
     
        ...
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
          multiset(from_range_t, R&& rg, const Allocator& a))
            : multiset(from_range, [std::forward](../utility/forward.html)<R>(rg), Compare(), a)
        {
        }
    ...
     
      ...
      multiset(from_range_t, R&&, Compare = Compare(), Allocator = Allocator())
        -> multiset<[ranges::range_value_t](../ranges/range_size_t.html)<R>, Compare, Allocator>;
     
      template<class Key, class Compare = less<Key>, class Allocator = allocator<Key>>
    ...
     
      ...
      multiset(from_range_t, R&&, Allocator)
        -> multiset<[ranges::range_value_t](../ranges/range_size_t.html)<R>, less<[ranges::range_value_t](../ranges/range_size_t.html)<R>>, Allocator>;
     
      template<class Key, class Allocator>
...
---|---|---|---  
[LWG 214](https://cplusplus.github.io/LWG/issue214) | C++98  | the declarations of the members `find`, `lower_bound`, `upper_bound`  
and `equal_range` of [std::set](../container/set.html "cpp/container/set") and [std::multiset](../container/multiset.html "cpp/container/multiset") in the synopsis  
