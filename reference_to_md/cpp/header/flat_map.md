...
## Contents
  ...
  * [1 Includes](flat_map.html#Includes)
  * [2 Classes](flat_map.html#Classes)
  * [3 Functions](flat_map.html#Functions)
  * [4 Tags](flat_map.html#Tags)
  * [5 Synopsis](flat_map.html#Synopsis)
    * [5.1 Class template std::flat_map](flat_map.html#Class_template_std::flat_map)
    * [5.2 Class template std::flat_multimap](flat_map.html#Class_template_std::flat_multimap)
  * [6 References](flat_map.html#References)
...
#### Class template [std::flat_map](../container/flat_map.html)
    ...
     
        ...
        flat_map(from_range_t fr, R&& rg)
          : flat_map(fr, [std::forward](../utility/forward.html)<R>(rg), key_compare())
        {
        }
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
...
#### Class template [std::flat_multimap](../container/flat_multimap.html)
    ...
     
        ...
        flat_multimap(from_range_t fr, R&& rg)
          : flat_multimap(fr, [std::forward](../utility/forward.html)<R>(rg), key_compare())
        {
        }
        template<[container-compatible-range](../ranges/to.html)<value_type> R>
