...
## Contents
  ...
  * [1 Classes](stacktrace.html#Classes)
    * [1.1 Forward declarations](stacktrace.html#Forward_declarations)
    * [1.2 Type aliases](stacktrace.html#Type_aliases)
  * [2 Functions](stacktrace.html#Functions)
  * [3 Synopsis](stacktrace.html#Synopsis)
    * [3.1 Class std::stacktrace_entry](stacktrace.html#Class_std::stacktrace_entry)
    * [3.2 Class template std::basic_stacktrace](stacktrace.html#Class_template_std::basic_stacktrace)
...
---  
Alias  |  Type   
`**std::stacktrace**` |  [std::basic_stacktrace](../utility/basic_stacktrace.html)<[std::allocator](../memory/allocator.html)<[std::stacktrace_entry](../utility/stacktrace_entry.html)>>  
`**std::pmr::stacktrace**` |  std::pmr::basic_stacktrace<  
` `[std::pmr::polymorphic_allocator](../memory/polymorphic_allocator.html)<[std::stacktrace_entry](../utility/stacktrace_entry.html)>>  
...
### Synopsis
    ...
     
      namespace pmr {
        using stacktrace = [std::basic_stacktrace](../utility/basic_stacktrace.html)<polymorphic_allocator<stacktrace_entry>>;
      }
     
      // hash support
