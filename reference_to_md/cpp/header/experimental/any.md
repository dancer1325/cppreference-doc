...
Name  |  Description   
---|---  
[ bad_any_cast](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/bad_any_cast&action=edit&redlink=1 "cpp/experimental/bad any cast \(page does not exist\)")(library fundamentals TS) |  exception that is thrown by a failed `any_cast`.   
(class)  
