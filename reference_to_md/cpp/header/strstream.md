...
## Contents
  ...
  * [1 Classes](strstream.html#Classes)
  * [2 Notes](strstream.html#Notes)
  * [3 Synopsis](strstream.html#Synopsis)
    * [3.1 Class std::strstreambuf](strstream.html#Class_std::strstreambuf)
    * [3.2 Class std::istrstream](strstream.html#Class_std::istrstream)
    * [3.3 Class std::ostrstream](strstream.html#Class_std::ostrstream)
    * [3.4 Class std::strstream](strstream.html#Class_std::strstream)
...
#### Class [std::strstreambuf](../io/strstreambuf.html "cpp/io/strstreambuf")
    ...
     
      protected:
        int_type overflow (int_type c = [EOF](../io/c.html)) override;
        int_type pbackfail(int_type c = [EOF](../io/c.html)) override;
