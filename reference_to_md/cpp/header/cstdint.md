...
This header is part of the [type support](../utility/rtti.html "cpp/types") library, providing [fixed width integer types](../types/integer.html "cpp/types/integer") and part of [C numeric limits interface](../types/climits.html "cpp/types/climits"). 

| 

## Contents

  * [1 Types](cstdint.html#Types)
  * [2 Macros](cstdint.html#Macros)
    * [2.1 Signed integers : minimum value](cstdint.html#Signed_integers_:_minimum_value)
    * [2.2 Signed integers : maximum value](cstdint.html#Signed_integers_:_maximum_value)
    * [2.3 Unsigned integers : maximum value](cstdint.html#Unsigned_integers_:_maximum_value)
    * [2.4 Limits of other integer types](cstdint.html#Limits_of_other_integer_types)
    * [2.5 Function macros for integer constants](cstdint.html#Function_macros_for_integer_constants)
  * [3 Synopsis](cstdint.html#Synopsis)
