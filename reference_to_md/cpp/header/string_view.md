...
## Contents
  ...
  * [1 Includes](string_view.html#Includes)
  * [2 Classes](string_view.html#Classes)
    * [2.1 Forward declarations](string_view.html#Forward_declarations)
  * [3 Functions](string_view.html#Functions)
    * [3.1 Range access](string_view.html#Range_access)
    * [3.2 Literals](string_view.html#Literals)
  * [4 Synopsis](string_view.html#Synopsis)
    * [4.1 Class template std::basic_string_view](string_view.html#Class_template_std::basic_string_view)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/header/string_view&action=edit&section=1 "Edit section: Synopsis")] Synopsis
    ...
     
      template<class CharT, class Traits>
        inline constexpr bool [ranges::enable_view](../ranges/view.html)<basic_string_view<CharT, Traits>> = true;
      template<class CharT, class Traits>
        inline constexpr bool [ranges::enable_borrowed_range](../ranges/borrowed_range.html)<basic_string_view<CharT, Traits>> =
          true;
     
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/synopsis/string_view&action=edit&section=T-1 "Template:cpp/synopsis/string view")] Class template [std::basic_string_view](../string/basic_string_view.html "cpp/string/basic string view")
    ...
     
      template<class R>
        basic_string_view(R&&) -> basic_string_view<[ranges::range_value_t](../ranges/range_size_t.html)<R>>;
    }
