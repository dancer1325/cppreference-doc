...
This C-compatibility header is part of the [general utility](../utility.html#Bit_manipulation "cpp/utility") library, in particular, it provides several function templates to access, manipulate, and process individual bits and bit sequences. The byte ordering (endianness) of scalar types can be inspected via __STDC_ENDIAN_NATIVE__ facility. 
...
Reason: add descriptors for functions and constants   
---|---  
| 

## Contents

  * [1 Functions](stdbit.h.html#Functions)
  * [2 Constants](stdbit.h.html#Constants)
  * [3 Synopsis](stdbit.h.html#Synopsis)
  * [4 See also](stdbit.h.html#See_also)
...
### Synopsis
    ...
     
    #define __STDC_ENDIAN_BIG__    /* see description */
    #define __STDC_ENDIAN_LITTLE__ /* see description */
    #define __STDC_ENDIAN_NATIVE__ /* see description */
     
    ...
    template<class T>
    /* see description */ stdc_leading_zeros(T value);
     
    ...
    template<class T>
    /* see description */ stdc_leading_ones(T value);
     
    ...
    template<class T>
    /* see description */ stdc_trailing_zeros(T value);
     
    ...
    template<class T>
    /* see description */ stdc_trailing_ones(T value);
     
    ...
    template<class T>
    /* see description */ stdc_first_leading_zero(T value);
     
    ...
    template<class T>
    /* see description */ stdc_first_leading_one(T value);
     
    ...
    template<class T>
    /* see description */ stdc_first_trailing_zero(T value);
     
    ...
    template<class T>
    /* see description */ stdc_first_trailing_one(T value);
     
    ...
    template<class T>
    /* see description */ stdc_count_zeros(T value);
     
    ...
    template<class T>
    /* see description */ stdc_count_ones(T value);
     
    ...
    template<class T>
    /* see description */ stdc_bit_width(T value);
     
