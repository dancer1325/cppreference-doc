...
If *this still has an associated running thread (i.e. joinable() == true), calls [std::terminate](../../error/terminate.html)(). Otherwise, assigns the state of other to *this and sets other to a default constructed state. 
