...
[Member classes](../thread.html#Member_classes "cpp/thread/thread")  
---  
[thread::id](id.html "cpp/thread/thread/id")  
[Member functions](../thread.html#Member_functions "cpp/thread/thread")  
**thread::thread**  
[thread::~thread](~thread.html "cpp/thread/thread/~thread")  
[thread::operator=](operator=.html "cpp/thread/thread/operator=")  
[Observers](../thread.html#Observers "cpp/thread/thread")  
[thread::joinable](joinable.html "cpp/thread/thread/joinable")  
[thread::get_id](get_id.html "cpp/thread/thread/get id")  
[thread::native_handle](native_handle.html "cpp/thread/thread/native handle")  
[thread::hardware_concurrency](hardware_concurrency.html "cpp/thread/thread/hardware concurrency")  
[Operations](../thread.html#Operations "cpp/thread/thread")  
[thread::join](join.html "cpp/thread/thread/join")  
[thread::detach](detach.html "cpp/thread/thread/detach")  
[thread::swap](swap.html "cpp/thread/thread/swap")  
...
3) Creates a new `std::thread` object and associates it with a thread of execution. The new thread of execution starts executing:  [`_INVOKE_`](../../functional.html "cpp/utility/functional")([`_decay-copy_`](../../standard_library/decay-copy.html "cpp/standard library/decay-copy")([std::forward](../../utility/forward.html)<F>(f)),  
...
This overload participates in overload resolution only if [std::decay](../../types/decay.html)<F>::type(until C++20)[std::remove_cvref_t](../../types/remove_cvref.html)<F>(since C++20) is not the same type as `std::thread`.  If any of the following conditions is satisfied, the program is ill-formed: 
...
## Contents
  ...
  * [1 Parameters](thread.html#Parameters)
  * [2 Postconditions](thread.html#Postconditions)
  * [3 Exceptions](thread.html#Exceptions)
  * [4 Notes](thread.html#Notes)
  * [5 Example](thread.html#Example)
  * [6 Defect reports](thread.html#Defect_reports)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/thread&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/thread&action=edit&section=2 "Edit section: Postconditions")] Postconditions

1) [get_id()](get_id.html "cpp/thread/thread/get id") equal to [std::thread::id](id.html)() (i.e. [joinable()](joinable.html "cpp/thread/thread/joinable") is false).

2) other.get_id() equal to [std::thread::id()](id.html "cpp/thread/thread/id") and [get_id()](get_id.html "cpp/thread/thread/get id") returns the value of other.get_id() prior to the start of construction.

3) [get_id()](get_id.html "cpp/thread/thread/get id") not equal to [std::thread::id()](id.html "cpp/thread/thread/id") (i.e. [joinable()](joinable.html "cpp/thread/thread/joinable") is true).

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/thread&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/thread&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/thread&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    void f1(int n)
    {
        for (int i = 0; i < 5; ++i)
        {
            ...
            ++n;
            [std::this_thread::sleep_for](../sleep_for.html)([std::chrono::milliseconds](../../chrono/duration.html)(10));
        }
    }
     
    void f2(int& n)
    ...
    int main()
    {
        ...
        foo f;
        baz b;
        [std::thread](../thread.html) t1; // t1 is not a thread
        [std::thread](../thread.html) t2(f1, n + 1); // pass by value
        [std::thread](../thread.html) t3(f2, [std::ref](../../utility/functional/ref.html)(n)); // pass by reference
        [std::thread](../thread.html) t4(std::move(t3)); // t4 is now running f2(). t3 is no longer a thread
        [std::thread](../thread.html) t5(&foo::bar, &f); // t5 runs foo::bar() on object f
        [std::thread](../thread.html) t6(b); // t6 runs baz::operator() on a copy of object b
        t2.join();
        t4.join();
        t5.join();
        t6.join();
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/thread&action=edit&section=6 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2097](https://cplusplus.github.io/LWG/issue2097) | C++11  | for overload (3), `F` could be `std::thread` | `F` is constrained   
...
requirements[[1]](thread.html#cite_note-1)  
  
  1. [↑](thread.html#cite_ref-1) The move-constructibility is already indirectly required by [std::is_constructible_v](../../types/is_constructible.html "cpp/types/is constructible").



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/thread&action=edit&section=7 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/thread&action=edit&section=8 "Edit section: See also")] See also
