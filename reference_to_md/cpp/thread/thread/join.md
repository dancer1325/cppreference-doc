[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/thread/join&action=edit)
...
The completion of the thread identified by *this _synchronizes with_ the corresponding successful return from `join()`. 
...
## Contents
  ...
  * [1 Parameters](join.html#Parameters)
  * [2 Return value](join.html#Return_value)
  * [3 Postconditions](join.html#Postconditions)
  * [4 Exceptions](join.html#Exceptions)
  * [5 Error conditions](join.html#Error_conditions)
  * [6 Example](join.html#Example)
  * [7 References](join.html#References)
  * [8 See also](join.html#See_also)
...
### Error conditions
  ...
  * [invalid_argument](../../error/errc.html "cpp/error/errc") if [joinable()](joinable.html "cpp/thread/thread/joinable") is false. 
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "starting first helper...\n";
        [std::thread](../thread.html) helper1(foo);
     
        [std::cout](../../io/cout.html) << "starting second helper...\n";
        [std::thread](../thread.html) helper2(bar);
     
        [std::cout](../../io/cout.html) << "waiting for helpers to finish..." << [std::endl](../../io/manip/endl.html);
        helper1.join();
        helper2.join();
     
