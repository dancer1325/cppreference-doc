...
---|---|---  
bool operator==( [std::thread::id](../id.html) lhs, [std::thread::id](../id.html) rhs ) noexcept; |  (1)  |  (since C++11)  
bool operator!=( [std::thread::id](../id.html) lhs, [std::thread::id](../id.html) rhs ) noexcept; |  (2)  |  (since C++11)   
(until C++20)  
bool operator< ( [std::thread::id](../id.html) lhs, [std::thread::id](../id.html) rhs ) noexcept; |  (3)  |  (since C++11)   
(until C++20)  
bool operator<=( [std::thread::id](../id.html) lhs, [std::thread::id](../id.html) rhs ) noexcept; |  (4)  |  (since C++11)   
(until C++20)  
bool operator> ( [std::thread::id](../id.html) lhs, [std::thread::id](../id.html) rhs ) noexcept; |  (5)  |  (since C++11)   
(until C++20)  
bool operator>=( [std::thread::id](../id.html) lhs, [std::thread::id](../id.html) rhs ) noexcept; |  (6)  |  (since C++11)   
(until C++20)  
[std::strong_ordering](../../../utility/compare/strong_ordering.html) operator<=>( [std::thread::id](../id.html) lhs,  
[std::thread::id](../id.html) rhs ) noexcept; |  (7)  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        auto work = [] { [std::this_thread::sleep_for](../../sleep_for.html)([std::chrono::seconds](../../../chrono/duration.html)(1)); };
        [std::thread](../../thread.html) t1(work);
        [std::thread](../../thread.html) t2(work);
     
        [assert](../../../error/assert.html)(t1.get_id() == t1.get_id() and
               t2.get_id() == t2.get_id() and
               t1.get_id() != t2.get_id());
     
        if (const auto cmp = t1.get_id() <=> t2.get_id(); cmp < 0)
            [std::cout](../../../io/cout.html) << "id1 < id2\n";
        else
            [std::cout](../../../io/cout.html) << "id1 > id2\n";
     
        [std::cout](../../../io/cout.html) << "id1: " << t1.get_id() << "\n"
                     "id2: " << t2.get_id() << '\n';
     
        t1.join();
        t2.join();
