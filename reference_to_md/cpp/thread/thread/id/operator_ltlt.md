...
operator<<( [std::basic_ostream](../../../io/basic_ostream.html)<CharT,Traits>& ost, [std::thread::id](../id.html) id ); |  |  (since C++11)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/id/operator_ltlt&action=edit&section=1 "Edit section: Parameters")] Parameters

ost  |  \-  |  output stream to insert the data into   
---|---|---  
id  |  \-  |  thread identifier   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/id/operator_ltlt&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread/id/operator_ltlt&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::thread](../../thread.html) t1([]{ [std::this_thread::sleep_for](../../sleep_for.html)(256ms); });
        [std::thread](../../thread.html) t2([]{ [std::this_thread::sleep_for](../../sleep_for.html)(512ms); });
     
        [std::clog](../../../io/clog.html) << t1.get_id() << '\n' << t2.get_id() << '\n';
     
        t1.join();
        t2.join();
    }
