...
Member functions  
---  
[id::id](id.html "cpp/thread/thread/id/id")  
Non-member functions  
[operator==operator!=operator<operator<=operator>operator>=operator<=>](operator_cmp.html "cpp/thread/thread/id/operator cmp")(until C++20)(until C++20)(until C++20)(until C++20)(until C++20)(C++20)  
[operator<<](operator_ltlt.html "cpp/thread/thread/id/operator ltlt")  
Helper classes  
...
struct formatter<[std::thread::id](../id.html), CharT>; |  |  (since C++23)  
| |   
  
The template specialization of [std::formatter](../../../utility/format/formatter.html "cpp/utility/format/formatter") for the [std::thread::id](../id.html "cpp/thread/thread/id") class allows users to convert a thread identifier to its textual representation using [formatting functions](../../../utility/format.html "cpp/utility/format"). 

## Contents

  * [1 Format specification](formatter.html#Format_specification)
  * [2 Notes](formatter.html#Notes)
  * [3 Example](formatter.html#Example)
...
fill-and-align and width have the same meaning as in [standard format specification](../../../utility/format/formatter.html#Standard_format_specification "cpp/utility/format/formatter"). The default alignment is `**>**`. 
...
Run this code
    ...
    int main()
    {
        [std::thread::id](../id.html) this_id = [std::this_thread::get_id](../../get_id.html)();
        [std::thread::id](../id.html) null_id;
     
        [std::cout](../../../io/cout.html) << [std::format](../../../utility/format/format.html)("current thread id: {}\n", this_id);
        [std::cout](../../../io/cout.html) << [std::format](../../../utility/format/format.html)("{:=^10}\n", null_id);
    }
