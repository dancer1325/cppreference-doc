[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/thread/native_handle&action=edit)
...
## Contents
  ...
  * [1 Parameters](native_handle.html#Parameters)
  * [2 Return value](native_handle.html#Return_value)
  * [3 Exceptions](native_handle.html#Exceptions)
  * [4 Example](native_handle.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/thread/native_handle&action=edit&section=T-1 "Template:cpp/thread/thread/native handle")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/thread/native_handle&action=edit&section=T-2 "Template:cpp/thread/thread/native handle")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/thread/native_handle&action=edit&section=T-3 "Template:cpp/thread/thread/native handle")] Example
...
Run this code
    ...
     
        ...
        [std::lock_guard](../lock_guard.html)<[std::mutex](../mutex.html)> lk(iomutex);
        [std::cout](../../io/cout.html) << "Thread " << num << " is executing at priority "
                  << sch.sched_priority << '\n';
    }
     
    int main()
    {
        [std::thread](../thread.html) t1(f, 1), t2(f, 2);
     
        sched_param sch;
        int policy; 
        ...
        if (pthread_setschedparam(t1.native_handle(), SCHED_FIFO, &sch))
            [std::cout](../../io/cout.html) << "Failed to setschedparam: " << [std::strerror](../../string/byte/strerror.html)(errno) << '\n';
     
        t1.join(); t2.join();
    }
