[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/thread/swap2&action=edit)
...
void swap( [std::thread](../thread.html)& lhs, [std::thread](../thread.html)& rhs ) noexcept; |  |  (since C++11)  
---|---|---  
| |   
  
Overloads the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::thread](../thread.html "cpp/thread/thread"). Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 
...
[ swap](swap.html "cpp/thread/thread/swap") |  swaps two thread objects   
