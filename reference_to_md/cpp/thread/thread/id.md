...
Member functions  
---  
[id::id](id/id.html "cpp/thread/thread/id/id")  
Non-member functions  
[operator==operator!=operator<operator<=operator>operator>=operator<=>](id/operator_cmp.html "cpp/thread/thread/id/operator cmp")(until C++20)(until C++20)(until C++20)(until C++20)(until C++20)(C++20)  
[operator<<](id/operator_ltlt.html "cpp/thread/thread/id/operator ltlt")  
Helper classes  
...
The class `thread::id` is a lightweight, trivially copyable class that serves as a unique identifier of [std::thread](../thread.html "cpp/thread/thread") and [std::jthread](../jthread.html "cpp/thread/jthread")(since C++20) objects. 
...
## Contents
  ...
  * [1 Member functions](id.html#Member_functions)
  * [2 Non-member functions](id.html#Non-member_functions)
  * [3 Helper classes](id.html#Helper_classes)
  * [4 See also](id.html#See_also)
