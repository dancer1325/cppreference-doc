[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/thread/hardware_concurrency&action=edit)
...
## Contents
  ...
  * [1 Parameters](hardware_concurrency.html#Parameters)
  * [2 Return value](hardware_concurrency.html#Return_value)
  * [3 Example](hardware_concurrency.html#Example)
  * [4 See also](hardware_concurrency.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << n << " concurrent threads are supported.\n";
    }
