...
A thread object does not have an associated thread (and is safe to destroy) after 
  ...
  * it was moved from. 
  * [join()](join.html "cpp/thread/thread/join") has been called. 
  * [detach()](detach.html "cpp/thread/thread/detach") has been called. 
...
Run this code
    ...
    int main()
    {
        auto bleah = [std::thread](../thread.html){[]{ [std::this_thread::sleep_for](../sleep_for.html)(13ms); }};
     
