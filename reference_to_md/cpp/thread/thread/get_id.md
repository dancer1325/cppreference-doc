[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/thread/get_id&action=edit)
...
Returns a value of [std::thread::id](id.html "cpp/thread/thread/id") identifying the thread associated with *this. 

## Contents

  * [1 Parameters](get_id.html#Parameters)
  * [2 Return value](get_id.html#Return_value)
  * [3 Example](get_id.html#Example)
  * [4 See also](get_id.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::thread::id](id.html) t1_id = t1.get_id();
     
        [std::thread](../thread.html) t2(foo);
        [std::thread::id](id.html) t2_id = t2.get_id();
     
        [std::cout](../../io/cout.html) << "t1's id: " << t1_id << '\n';
        [std::cout](../../io/cout.html) << "t2's id: " << t2_id << '\n';
     
        t1.join();
        t2.join();
     
        [std::cout](../../io/cout.html) << "t1's id after join: " << t1.get_id() << '\n';
        [std::cout](../../io/cout.html) << "t2's id after join: " << t2.get_id() << '\n';
    }
