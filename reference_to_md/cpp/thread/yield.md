...
## Contents
  ...
  * [1 Parameters](yield.html#Parameters)
  * [2 Return value](yield.html#Return_value)
  * [3 Notes](yield.html#Notes)
  * [4 Example](yield.html#Example)
  * [5 See also](yield.html#See_also)
...
Run this code
    ...
    void little_sleep([std::chrono::microseconds](../chrono/duration.html) us)
    {
        auto start = [std::chrono::high_resolution_clock::now](../chrono/high_resolution_clock/now.html)();
        auto end = start + us;
        do
        {
            std::this_thread::yield();
        }
        while ([std::chrono::high_resolution_clock::now](../chrono/high_resolution_clock/now.html)() < end);
    }
     
    int main()
    {
        auto start = [std::chrono::high_resolution_clock::now](../chrono/high_resolution_clock/now.html)();
     
        little_sleep([std::chrono::microseconds](../chrono/duration.html)(100));
     
        auto elapsed = [std::chrono::high_resolution_clock::now](../chrono/high_resolution_clock/now.html)() - start;
        [std::cout](../io/cout.html) << "waited for "
                  << [std::chrono::duration_cast](../chrono/duration/duration_cast.html)<[std::chrono::microseconds](../chrono/duration.html)>(elapsed).count()
                  << " microseconds\n";
    }
