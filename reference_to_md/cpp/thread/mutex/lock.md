...
Prior [unlock()](unlock.html "cpp/thread/mutex/unlock") operations on the same mutex _synchronize-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) this operation. 
...
[ try_lock](try_lock.html "cpp/thread/mutex/try lock") |  tries to lock the mutex, returns if the mutex is not available   
