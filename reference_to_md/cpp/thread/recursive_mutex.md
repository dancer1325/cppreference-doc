...
Member functions  
---  
[recursive_mutex::recursive_mutex](recursive_mutex/recursive_mutex.html "cpp/thread/recursive mutex/recursive mutex")  
[recursive_mutex::~recursive_mutex](recursive_mutex/~recursive_mutex.html "cpp/thread/recursive mutex/~recursive mutex")  
Locking  
[recursive_mutex::lock](recursive_mutex/lock.html "cpp/thread/recursive mutex/lock")  
[recursive_mutex::try_lock](recursive_mutex/try_lock.html "cpp/thread/recursive mutex/try lock")  
[recursive_mutex::unlock](recursive_mutex/unlock.html "cpp/thread/recursive mutex/unlock")  
Native handle  
...
`recursive_mutex` offers exclusive, recursive ownership semantics: 
  ...
  * A calling thread _owns_ a `recursive_mutex` for a period of time that starts when it successfully calls either [`lock`](recursive_mutex/lock.html "cpp/thread/recursive mutex/lock") or [`try_lock`](mutex/try_lock.html "cpp/thread/mutex/try lock"). During this period, the thread may make additional calls to [`lock`](recursive_mutex/lock.html "cpp/thread/recursive mutex/lock") or [`try_lock`](recursive_mutex/try_lock.html "cpp/thread/recursive mutex/try lock"). The period of ownership ends when the thread makes a matching number of calls to [`unlock`](recursive_mutex/unlock.html "cpp/thread/recursive mutex/unlock"). 
  * When a thread owns a `recursive_mutex`, all other threads will block (for calls to [`lock`](recursive_mutex/lock.html "cpp/thread/recursive mutex/lock")) or receive a false return value (for [`try_lock`](recursive_mutex/try_lock.html "cpp/thread/recursive mutex/try lock")) if they attempt to claim ownership of the `recursive_mutex`. 
  * The maximum number of times that a `recursive_mutex` may be locked is unspecified, but after that number is reached, calls to [`lock`](recursive_mutex/lock.html "cpp/thread/recursive mutex/lock") will throw [std::system_error](../error/system_error.html "cpp/error/system error") and calls to [`try_lock`](mutex/try_lock.html "cpp/thread/mutex/try lock") will return false. 



The behavior of a program is undefined if a `recursive_mutex` is destroyed while still owned by some thread. The `recursive_mutex` class satisfies all requirements of [Mutex](../named_req/Mutex.html "cpp/named req/Mutex") and [StandardLayoutType](../named_req/StandardLayoutType.html "cpp/named req/StandardLayoutType"). 

## Contents

  * [1 Member types](recursive_mutex.html#Member_types)
  * [2 Member functions](recursive_mutex.html#Member_functions)
    * [2.1 Locking](recursive_mutex.html#Locking)
    * [2.2 Native handle](recursive_mutex.html#Native_handle)
  * [3 Example](recursive_mutex.html#Example)
  * [4 See also](recursive_mutex.html#See_also)
...
Run this code
    ...
    class X
    {
        ...
        [std::string](../string/basic_string.html) shared;
    public:
        void fun1()
        {
            [std::lock_guard](lock_guard.html)<std::recursive_mutex> lk(m);
            shared = "fun1";
            [std::cout](../io/cout.html) << "in fun1, shared variable is now " << shared << '\n';
        }
        void fun2()
        {
            [std::lock_guard](lock_guard.html)<std::recursive_mutex> lk(m);
            shared = "fun2";
            [std::cout](../io/cout.html) << "in fun2, shared variable is now " << shared << '\n';
            fun1(); // recursive lock becomes useful here
            [std::cout](../io/cout.html) << "back in fun2, shared variable is " << shared << '\n';
        }
    };
     
    int main() 
    {
        X x;
        [std::thread](thread.html) t1(&X::fun1, &x);
        [std::thread](thread.html) t2(&X::fun2, &x);
        t1.join();
        t2.join();
    }
