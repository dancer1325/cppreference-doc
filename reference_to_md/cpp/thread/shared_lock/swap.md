...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  the lock to swap the state with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/swap&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/swap&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/swap&action=edit&section=4 "Edit section: See also")] See also

[ std::swap(std::shared_lock)](swap2.html "cpp/thread/shared lock/swap2")(C++14) |  specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm   
