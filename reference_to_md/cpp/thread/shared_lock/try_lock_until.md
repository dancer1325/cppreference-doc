...
Member functions  
---  
[shared_lock::shared_lock](shared_lock.html "cpp/thread/shared lock/shared lock")  
[shared_lock::~shared_lock](~shared_lock.html "cpp/thread/shared lock/~shared lock")  
[shared_lock::operator=](operator=.html "cpp/thread/shared lock/operator=")  
Shared locking  
[shared_lock::lock](lock.html "cpp/thread/shared lock/lock")  
[shared_lock::try_lock](try_lock.html "cpp/thread/shared lock/try lock")  
[shared_lock::try_lock_for](try_lock_for.html "cpp/thread/shared lock/try lock for")  
**shared_lock::try_lock_until**  
[shared_lock::unlock](unlock.html "cpp/thread/shared lock/unlock")  
Modifiers  
[shared_lock::swap](swap.html "cpp/thread/shared lock/swap")  
[shared_lock::release](release.html "cpp/thread/shared lock/release")  
Observers  
[shared_lock::mutex](mutex.html "cpp/thread/shared lock/mutex")  
[shared_lock::owns_lock](owns_lock.html "cpp/thread/shared lock/owns lock")  
[shared_lock::operator bool](operator_bool.html "cpp/thread/shared lock/operator bool")  
...
[std::system_error](../../error/system_error.html "cpp/error/system error") is thrown if there is no associated mutex or if the mutex is already locked. 

`Clock` must meet the [Clock](../../named_req/Clock.html "cpp/named req/Clock") requirements. The behavior is undefined if `Mutex` does not meet the [SharedTimedLockable](../../named_req/SharedTimedLockable.html "cpp/named req/SharedTimedLockable") requirements. The program is ill-formed if [std::chrono::is_clock_v](../../chrono/is_clock.html)<Clock> is false.(since C++20)

## Contents

  * [1 Parameters](try_lock_until.html#Parameters)
  * [2 Return value](try_lock_until.html#Return_value)
  * [3 Exceptions](try_lock_until.html#Exceptions)
  * [4 Example](try_lock_until.html#Example)
  * [5 See also](try_lock_until.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/try_lock_until&action=edit&section=1 "Edit section: Parameters")] Parameters

timeout_time  |  \-  |  maximum time point to block until   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/try_lock_until&action=edit&section=2 "Edit section: Return value")] Return value

true if the ownership of the mutex has been acquired successfully, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/try_lock_until&action=edit&section=3 "Edit section: Exceptions")] Exceptions

  * Any exceptions thrown by mutex()->try_lock_shared_for(timeout_time). 


  * If there is no associated mutex, [std::system_error](../../error/system_error.html "cpp/error/system error") with an error code of [std::errc::operation_not_permitted](../../error/errc.html "cpp/error/errc"). 


  * If the mutex is already locked, [std::system_error](../../error/system_error.html "cpp/error/system error") with an error code of [std::errc::resource_deadlock_would_occur](../../error/errc.html "cpp/error/errc"). 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/try_lock_until&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/try_lock_until&action=edit&section=5 "Edit section: See also")] See also
...
[ try_lock_for](try_lock_for.html "cpp/thread/shared lock/try lock for") |  tries to lock the associated mutex, for the specified duration   
...
(public member function of `std::unique_lock<Mutex>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/unique_lock/dsc_try_lock_until&action=edit)
