...
The behavior is undefined if `Mutex` does not meet the [SharedTimedLockable](../../named_req/SharedTimedLockable.html "cpp/named req/SharedTimedLockable") requirements. 
