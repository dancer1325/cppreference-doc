...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/mutex&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/mutex&action=edit&section=2 "Edit section: Return value")] Return value

Pointer to the associated mutex or a null pointer if there is no associated mutex. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_lock/mutex&action=edit&section=3 "Edit section: Example")] Example
