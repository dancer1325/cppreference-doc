...
void sleep_until( const [std::chrono::time_point](../chrono/time_point.html)<Clock, Duration>& sleep_time ); |  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Parameters](sleep_until.html#Parameters)
  * [2 Return value](sleep_until.html#Return_value)
  * [3 Exceptions](sleep_until.html#Exceptions)
  * [4 Example](sleep_until.html#Example)
  * [5 See also](sleep_until.html#See_also)
...
Run this code
    ...
    #include <thread>
     
    auto now() { return [std::chrono::steady_clock::now](../chrono/steady_clock/now.html)(); }
     
    auto awake_time()
    {
    ...
    int main()
    {
        ...
        [std::chrono::duration](../chrono/duration.html)<double, [std::milli](../numeric/ratio/ratio.html)> elapsed{now() - start};
        [std::cout](../io/cout.html) << "Waited " << elapsed.count() << " ms\n";
    }
