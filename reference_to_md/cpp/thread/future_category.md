...
---|---|---  
const [std::error_category](../error/error_category.html)& future_category() noexcept; |  |  (since C++11)  
| |   
  
Obtains a reference to the static error category object for the errors related to futures and promises. The object is required to override the virtual function error_category::name() to return a pointer to the string "future". It is used to identify error codes provided in the exceptions of type [std::future_error](future_error.html "cpp/thread/future error"). 

## Contents

  * [1 Parameters](future_category.html#Parameters)
  * [2 Return value](future_category.html#Return_value)
  * [3 Example](future_category.html#Example)
  * [4 See also](future_category.html#See_also)
