...
Member functions  
---  
[shared_lock::shared_lock](shared_lock/shared_lock.html "cpp/thread/shared lock/shared lock")  
[shared_lock::~shared_lock](shared_lock/~shared_lock.html "cpp/thread/shared lock/~shared lock")  
[shared_lock::operator=](shared_lock/operator=.html "cpp/thread/shared lock/operator=")  
Shared locking  
[shared_lock::lock](shared_lock/lock.html "cpp/thread/shared lock/lock")  
[shared_lock::try_lock](shared_lock/try_lock.html "cpp/thread/shared lock/try lock")  
[shared_lock::try_lock_for](shared_lock/try_lock_for.html "cpp/thread/shared lock/try lock for")  
[shared_lock::try_lock_until](shared_lock/try_lock_until.html "cpp/thread/shared lock/try lock until")  
[shared_lock::unlock](shared_lock/unlock.html "cpp/thread/shared lock/unlock")  
Modifiers  
[shared_lock::swap](shared_lock/swap.html "cpp/thread/shared lock/swap")  
[shared_lock::release](shared_lock/release.html "cpp/thread/shared lock/release")  
Observers  
[shared_lock::mutex](shared_lock/mutex.html "cpp/thread/shared lock/mutex")  
[shared_lock::owns_lock](shared_lock/owns_lock.html "cpp/thread/shared lock/owns lock")  
[shared_lock::operator bool](shared_lock/operator_bool.html "cpp/thread/shared lock/operator bool")  
...
The class `shared_lock` is a general-purpose shared mutex ownership wrapper allowing deferred locking, timed locking and transfer of lock ownership. Locking a `shared_lock` locks the associated shared mutex in shared mode (to lock it in exclusive mode, [std::unique_lock](unique_lock.html "cpp/thread/unique lock") can be used). 
...
`shared_lock` meets the [Lockable](../named_req/Lockable.html "cpp/named req/Lockable") requirements. If `Mutex` meets the [SharedTimedLockable](../named_req/SharedTimedLockable.html "cpp/named req/SharedTimedLockable") requirements, `shared_lock` also meets [TimedLockable](../named_req/TimedLockable.html "cpp/named req/TimedLockable") requirements. 

In order to wait in a shared mutex in shared ownership mode, [std::condition_variable_any](condition_variable_any.html "cpp/thread/condition variable any") can be used ([std::condition_variable](condition_variable.html "cpp/thread/condition variable") requires [std::unique_lock](unique_lock.html "cpp/thread/unique lock") and so can only wait in unique ownership mode). 

## Contents

  * [1 Template parameters](shared_lock.html#Template_parameters)
  * [2 Member types](shared_lock.html#Member_types)
  * [3 Member functions](shared_lock.html#Member_functions)
    * [3.1 Shared locking](shared_lock.html#Shared_locking)
    * [3.2 Modifiers](shared_lock.html#Modifiers)
    * [3.3 Observers](shared_lock.html#Observers)
  * [4 Non-member functions](shared_lock.html#Non-member_functions)
  * [5 Defect reports](shared_lock.html#Defect_reports)
...
---|---|---|---  
[LWG 2981](https://cplusplus.github.io/LWG/issue2981) | C++17  | redundant deduction guide from `shared_lock<Mutex>` was provided  | removed 
