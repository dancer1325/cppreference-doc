...
Member functions  
---  
[timed_mutex::timed_mutex](timed_mutex.html "cpp/thread/timed mutex/timed mutex")  
[timed_mutex::~timed_mutex](~timed_mutex.html "cpp/thread/timed mutex/~timed mutex")  
Locking  
[timed_mutex::lock](lock.html "cpp/thread/timed mutex/lock")  
**timed_mutex::try_lock**  
[timed_mutex::try_lock_for](try_lock_for.html "cpp/thread/timed mutex/try lock for")  
[timed_mutex::try_lock_until](try_lock_until.html "cpp/thread/timed mutex/try lock until")  
[timed_mutex::unlock](unlock.html "cpp/thread/timed mutex/unlock")  
Native handle  
...
Prior [unlock()](unlock.html "cpp/thread/timed mutex/unlock") operation on the same mutex _synchronizes-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) this operation if it returns true. Note that prior [lock()](lock.html "cpp/thread/timed mutex/lock") does not synchronize with this operation if it returns false. 
...
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/timed_mutex/example_try_lock&action=edit)
...
---|---  
[ try_lock_for](try_lock_for.html "cpp/thread/timed mutex/try lock for") |  tries to lock the mutex, returns if the mutex has been  
