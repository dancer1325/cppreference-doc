...
[timed_mutex::try_lock](try_lock.html "cpp/thread/timed mutex/try lock")  
...
If timeout_time has already passed, this function behaves like [try_lock()](try_lock.html "cpp/thread/timed mutex/try lock"). 
...
As with [try_lock()](try_lock.html "cpp/thread/timed mutex/try lock"), this function is allowed to fail spuriously and return false even if the mutex was not locked by any other thread at some point before timeout_time. 

Prior [unlock()](unlock.html "cpp/thread/timed mutex/unlock") operation on the same mutex _synchronizes-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) this operation if it returns true. 
