...
If timeout_duration is less or equal timeout_duration.zero(), the function behaves like [try_lock()](try_lock.html "cpp/thread/timed mutex/try lock"). 
...
As with [try_lock()](try_lock.html "cpp/thread/timed mutex/try lock"), this function is allowed to fail spuriously and return false even if the mutex was not locked by any other thread at some point during timeout_duration. 
