...
Provides a specialization of the [std::uses_allocator](../../memory/uses_allocator.html "cpp/memory/uses allocator") type trait for [std::promise](../promise.html "cpp/thread/promise"). 
