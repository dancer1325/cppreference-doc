...
The operation behaves as though [set_value](set_value.html "cpp/thread/promise/set value"), [set_exception](set_exception.html "cpp/thread/promise/set exception"), `set_value_at_thread_exit`, and [set_exception_at_thread_exit](set_exception_at_thread_exit.html "cpp/thread/promise/set exception at thread exit") acquire a single mutex associated with the promise object while updating the promise object. 
...
## Contents
  ...
  * [1 Parameters](set_value_at_thread_exit.html#Parameters)
  * [2 Return value](set_value_at_thread_exit.html#Return_value)
  * [3 Exceptions](set_value_at_thread_exit.html#Exceptions)
  * [4 Example](set_value_at_thread_exit.html#Example)
  * [5 Defect reports](set_value_at_thread_exit.html#Defect_reports)
  * [6 See also](set_value_at_thread_exit.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::thread](../thread.html)([&p]
        {
            [std::this_thread::sleep_for](../sleep_for.html)(1s);
            p.set_value_at_thread_exit(9);
        }).detach();
     
        [std::cout](../../io/cout.html) << "Waiting... " << [std::flush](../../io/manip/flush.html);
        f.wait();
