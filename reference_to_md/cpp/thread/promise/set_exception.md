...
## Contents
  ...
  * [1 Parameters](set_exception.html#Parameters)
  * [2 Return value](set_exception.html#Return_value)
  * [3 Exceptions](set_exception.html#Exceptions)
  * [4 Example](set_exception.html#Example)
  * [5 See also](set_exception.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_exception&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  exception pointer to store. The behavior is undefined if p is null   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_exception&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_exception&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_exception&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::promise](../promise.html)<int> p;
        [std::future](../future.html)<int> f = p.get_future();
     
        [std::thread](../thread.html) t([&p]
        {
            try
            {
                // code that may throw
                throw [std::runtime_error](../../error/runtime_error.html)("Example");
            }
            catch (...)
            {
                try
                {
                    ...
                    p.set_exception([std::current_exception](../../error/current_exception.html)());
    ...
     
        try
        {
            [std::cout](../../io/cout.html) << f.get();
        }
        catch (const [std::exception](../../error/exception.html)& e)
        {
            [std::cout](../../io/cout.html) << "Exception from the thread: " << e.what() << '\n';
        }
        t.join();
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_exception&action=edit&section=5 "Edit section: See also")] See also
