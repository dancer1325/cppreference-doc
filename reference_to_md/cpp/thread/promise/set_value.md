...
Member functions  
---  
[promise::promise](promise.html "cpp/thread/promise/promise")  
[promise::~promise](~promise.html "cpp/thread/promise/~promise")  
[promise::operator=](operator=.html "cpp/thread/promise/operator=")  
[promise::swap](swap.html "cpp/thread/promise/swap")  
Getting the result  
[promise::get_future](get_future.html "cpp/thread/promise/get future")  
Setting the result  
**promise::set_value**  
[promise::set_value_at_thread_exit](set_value_at_thread_exit.html "cpp/thread/promise/set value at thread exit")  
[promise::set_exception](set_exception.html "cpp/thread/promise/set exception")  
[promise::set_exception_at_thread_exit](set_exception_at_thread_exit.html "cpp/thread/promise/set exception at thread exit")  
Non-member Functions  
[swap(std::promise)](swap2.html "cpp/thread/promise/swap2")  
Helper Classes  
...
[std::promise](../promise.html)<R&> specializations |  |   
void set_value( R& value ); |  (3)  |  (since C++11)  
[std::promise](../promise.html)<void> specialization |  |   
...
The operation behaves as though `set_value`, [set_exception](set_exception.html "cpp/thread/promise/set exception"), [set_value_at_thread_exit](set_value_at_thread_exit.html "cpp/thread/promise/set value at thread exit"), and [set_exception_at_thread_exit](set_exception_at_thread_exit.html "cpp/thread/promise/set exception at thread exit") acquire a single mutex associated with the promise object while updating the promise object. 

Calls to this function do not introduce data races with calls to [get_future](get_future.html "cpp/thread/promise/get future") (therefore they need not synchronize with each other). 

## Contents

  * [1 Parameters](set_value.html#Parameters)
  * [2 Return value](set_value.html#Return_value)
  * [3 Exceptions](set_value.html#Exceptions)
  * [4 Example](set_value.html#Example)
  * [5 Defect reports](set_value.html#Defect_reports)
  * [6 See also](set_value.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_value&action=edit&section=1 "Edit section: Parameters")] Parameters

value  |  \-  |  value to store in the shared state   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_value&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_value&action=edit&section=3 "Edit section: Exceptions")] Exceptions

[std::future_error](../future_error.html "cpp/thread/future error") on the following conditions: 

  * *this has no shared state. The error code is set to [`no_state`](../future_errc.html "cpp/thread/future errc"). 
  * The shared state already stores a value or exception. The error code is set to [`promise_already_satisfied`](../future_errc.html "cpp/thread/future errc"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_value&action=edit&section=4 "Edit section: Example")] Example

This example shows how [std::promise](../promise.html)<void> can be used as signals between threads.
...
Run this code
    ...
    int main()
    {
        [std::istringstream](../../io/basic_istringstream.html) iss_numbers{"3 4 1 42 23 -23 93 2 -289 93"};
        [std::istringstream](../../io/basic_istringstream.html) iss_letters{" a 23 b,e a2 k k?a;si,ksa c"};
     
        [std::vector](../../container/vector.html)<int> numbers;
        [std::vector](../../container/vector.html)<char> letters;
        [std::promise](../promise.html)<void> numbers_promise, letters_promise;
     
        auto numbers_ready = numbers_promise.get_future();
        auto letter_ready = letters_promise.get_future();
     
        [std::thread](../thread.html) value_reader([&]
        {
            // I/O operations
            [std::copy](../../algorithm/copy.html)([std::istream_iterator](../../iterator/istream_iterator.html)<int>{iss_numbers},
                      [std::istream_iterator](../../iterator/istream_iterator.html)<int>{},
                      [std::back_inserter](../../iterator/back_inserter.html)(numbers));
     
            // notify for numbers
            numbers_promise.set_value();
     
            [std::copy_if](../../algorithm/copy.html)([std::istreambuf_iterator](../../iterator/istreambuf_iterator.html)<char>{iss_letters},
                         [std::istreambuf_iterator](../../iterator/istreambuf_iterator.html)<char>{},
                         [std::back_inserter](../../iterator/back_inserter.html)(letters),
                         ::isalpha);
     
            // notify for letters
    ...
     
        numbers_ready.wait();
     
        [std::sort](../../algorithm/sort.html)(numbers.begin(), numbers.end());
     
        if (letter_ready.wait_for(1s) == [std::future_status::timeout](../future_status.html))
        {
            // output the numbers while letters are being obtained
            for (int num : numbers)
                [std::cout](../../io/cout.html) << num << ' ';
            numbers.clear(); // numbers were already printed
        }
     
        letter_ready.wait();
        [std::sort](../../algorithm/sort.html)(letters.begin(), letters.end());
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_value&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2098](https://cplusplus.github.io/LWG/issue2098) | C++11  | overloads (1,2) could only throw the  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_value&action=edit&section=6 "Edit section: See also")] See also

[ set_value_at_thread_exit](set_value_at_thread_exit.html "cpp/thread/promise/set value at thread exit") |  sets the result to specific value while delivering the notification only at thread exit   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/promise/dsc_set_value_at_thread_exit&action=edit)  
---|---  
[ set_exception](set_exception.html "cpp/thread/promise/set exception") |  sets the result to indicate an exception   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/promise/dsc_set_exception&action=edit)
