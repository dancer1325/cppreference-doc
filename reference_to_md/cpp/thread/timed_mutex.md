...
Member functions  
---  
[timed_mutex::timed_mutex](timed_mutex/timed_mutex.html "cpp/thread/timed mutex/timed mutex")  
[timed_mutex::~timed_mutex](timed_mutex/~timed_mutex.html "cpp/thread/timed mutex/~timed mutex")  
Locking  
[timed_mutex::lock](timed_mutex/lock.html "cpp/thread/timed mutex/lock")  
[timed_mutex::try_lock](timed_mutex/try_lock.html "cpp/thread/timed mutex/try lock")  
[timed_mutex::try_lock_for](timed_mutex/try_lock_for.html "cpp/thread/timed mutex/try lock for")  
[timed_mutex::try_lock_until](timed_mutex/try_lock_until.html "cpp/thread/timed mutex/try lock until")  
[timed_mutex::unlock](timed_mutex/unlock.html "cpp/thread/timed mutex/unlock")  
Native handle  
[timed_mutex::native_handle](timed_mutex/native_handle.html "cpp/thread/timed mutex/native handle")  
...
In a manner similar to [`mutex`](mutex.html "cpp/thread/mutex"), `timed_mutex` offers exclusive, non-recursive ownership semantics. In addition, `timed_mutex` provides the ability to attempt to claim ownership of a `timed_mutex` with a timeout via the member functions [`try_lock_for()`](timed_mutex/try_lock_for.html "cpp/thread/timed mutex/try lock for") and [`try_lock_until()`](timed_mutex/try_lock_until.html "cpp/thread/timed mutex/try lock until"). 

The `timed_mutex` class satisfies all requirements of [TimedMutex](../named_req/TimedMutex.html "cpp/named req/TimedMutex") and [StandardLayoutType](../named_req/StandardLayoutType.html "cpp/named req/StandardLayoutType"). 

## Contents

  * [1 Member types](timed_mutex.html#Member_types)
  * [2 Member functions](timed_mutex.html#Member_functions)
    * [2.1 Locking](timed_mutex.html#Locking)
    * [2.2 Native handle](timed_mutex.html#Native_handle)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/timed_mutex&action=edit&section=1 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/timed_mutex&action=edit&section=2 "Edit section: Member functions")] Member functions

[ (constructor)](timed_mutex/timed_mutex.html "cpp/thread/timed mutex/timed mutex") |  constructs the mutex   
...
---|---  
[ (destructor)](timed_mutex/~timed_mutex.html "cpp/thread/timed mutex/~timed mutex") |  destroys the mutex   
...
[ lock](timed_mutex/lock.html "cpp/thread/timed mutex/lock") |  locks the mutex, blocks if the mutex is not available   
...
[ try_lock](timed_mutex/try_lock.html "cpp/thread/timed mutex/try lock") |  tries to lock the mutex, returns if the mutex is not available   
...
[ try_lock_for](timed_mutex/try_lock_for.html "cpp/thread/timed mutex/try lock for") |  tries to lock the mutex, returns if the mutex has been  
...
[ try_lock_until](timed_mutex/try_lock_until.html "cpp/thread/timed mutex/try lock until") |  tries to lock the mutex, returns if the mutex has been  
...
[ unlock](timed_mutex/unlock.html "cpp/thread/timed mutex/unlock") |  unlocks the mutex   
...
[ native_handle](timed_mutex/native_handle.html "cpp/thread/timed mutex/native handle") |  returns the underlying implementation-defined native handle object   
