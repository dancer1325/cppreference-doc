...
Member functions  
---  
[future_error::future_error](future_error/future_error.html "cpp/thread/future error/future error")  
[future_error::operator=](future_error/operator=.html "cpp/thread/future error/operator=")  
...
The class **std::future_error** defines an exception object that is thrown on failure by the functions in the thread library that deal with asynchronous execution and shared states ([std::future](future.html "cpp/thread/future"), [std::promise](promise.html "cpp/thread/promise"), etc). Similar to [std::system_error](../error/system_error.html "cpp/error/system error"), this exception carries an error code compatible with [std::error_code](../error/error_code.html "cpp/error/error code"). 

![std-future error-inheritance.svg](https://upload.cppreference.com/mwiki/images/a/ac/std-future_error-inheritance.svg)

Inheritance diagram

## Contents

  * [1 Member functions](future_error.html#Member_functions)
  * [2 Inherited from std::logic_error](future_error.html#Inherited_from_std::logic_error)
  * [3 Inherited from std::exception](future_error.html#Inherited_from_std::exception)
    * [3.1 Member functions](future_error.html#Member_functions_2)
    * [3.2 Example](future_error.html#Example)
    * [3.3 See also](future_error.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::future](future.html)<int> empty;
        try
        {
        ...
        {
            [std::cout](../io/cout.html) << "Caught a future_error with code \"" << e.code()
                      << "\"\nMessage: \"" << e.what() << "\"\n";
        }
    }
