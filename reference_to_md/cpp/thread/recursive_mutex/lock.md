...
Prior [unlock()](unlock.html "cpp/thread/recursive mutex/unlock") operations on the same mutex _synchronize-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) this operation. 
