...
Overloads the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::jthread](../jthread.html "cpp/thread/jthread"). Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). This function is not visible to ordinary [unqualified](../../language/unqualified_lookup.html "cpp/language/unqualified lookup") or [qualified lookup](../../language/qualified_lookup.html "cpp/language/qualified lookup"), and can only be found by [argument-dependent lookup](../../language/adl.html "cpp/language/adl") when std::jthread is an associated class of the arguments. 
