...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/jthread/request_stop&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/jthread/request_stop&action=edit&section=2 "Edit section: Return value")] Return value

true if this invocation made a stop request, otherwise false. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/jthread/request_stop&action=edit&section=3 "Edit section: Postconditions")] Postconditions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/jthread/request_stop&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/jthread/request_stop&action=edit&section=5 "Edit section: Example")] Example
