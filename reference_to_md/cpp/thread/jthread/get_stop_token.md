...
[std::stop_token](../stop_token.html) get_stop_token() const noexcept; |  |  (since C++20)  
---|---|---  
| |   
  
Returns a [std::stop_token](../stop_token.html "cpp/thread/stop token") associated with the same shared stop-state held internally by the `jthread` object. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/jthread/get_stop_token&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/jthread/get_stop_token&action=edit&section=2 "Edit section: Return value")] Return value

A value of type [std::stop_token](../stop_token.html "cpp/thread/stop token") associated with stop-state held internally by `jthread` object. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/jthread/get_stop_token&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
    void print([std::string_view](../../string/basic_string_view.html) name, const [std::stop_token](../stop_token.html)& token)
    {
        [std::cout](../../io/cout.html) << name << ": stop_possible = " << token.stop_possible();
        [std::cout](../../io/cout.html) << ", stop_requested = " << token.stop_requested() << '\n';
    }
     
    void finite_sleepy([std::stop_token](../stop_token.html) stoken)
    {
        for (int i = 10; i; --i)
        {
    ...
     
        ...
        [std::jthread](../jthread.html) stop_worker(finite_sleepy);
     
        // A worker thread that will only stop when completed
        [std::jthread](../jthread.html) inf_worker(infinite_sleepy);
     
