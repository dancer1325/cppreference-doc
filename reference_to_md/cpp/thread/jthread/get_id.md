...
Returns a value of std::jthread::id (which is a type alias for [std::thread::id](../thread/id.html "cpp/thread/thread/id")) identifying the thread associated with *this. 
...
Run this code
    ...
     
        [std::jthread](../jthread.html) t2(foo);
