...
[std::system_error](../../error/system_error.html "cpp/error/system error") is thrown if there is no associated mutex or if the mutex is already locked by the same thread. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_until&action=edit&section=1 "Edit section: Parameters")] Parameters

timeout_time  |  \-  |  maximum time point to block until   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_until&action=edit&section=2 "Edit section: Return value")] Return value

true if the ownership of the mutex has been acquired successfully, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_until&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_until&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_until&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[ try_lock](try_lock.html "cpp/thread/unique lock/try lock") |  tries to lock (i.e., takes ownership of) the associated mutex without blocking   
