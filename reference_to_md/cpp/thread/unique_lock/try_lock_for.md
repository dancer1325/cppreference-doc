...
[std::system_error](../../error/system_error.html "cpp/error/system error") is thrown if there is no associated mutex or if the mutex is already locked by this std::unique_lock. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_for&action=edit&section=1 "Edit section: Parameters")] Parameters

timeout_duration  |  \-  |  maximum duration to block for   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_for&action=edit&section=2 "Edit section: Return value")] Return value

true if the ownership of the mutex has been acquired successfully, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_for&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_for&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/try_lock_for&action=edit&section=5 "Edit section: See also")] See also
...
(public member function of `std::shared_lock<Mutex>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/shared_lock/dsc_try_lock_for&action=edit)  
