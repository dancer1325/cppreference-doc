...
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::unique_lock](../unique_lock.html "cpp/thread/unique lock"). Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 
