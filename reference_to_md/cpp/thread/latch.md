...
Member functions  
---  
[latch::latch](latch/latch.html "cpp/thread/latch/latch")  
[latch::~latch](latch/~latch.html "cpp/thread/latch/~latch")  
[latch::count_down](latch/count_down.html "cpp/thread/latch/count down")  
[latch::try_wait](latch/try_wait.html "cpp/thread/latch/try wait")  
[latch::wait](latch/wait.html "cpp/thread/latch/wait")  
[latch::arrive_and_wait](latch/arrive_and_wait.html "cpp/thread/latch/arrive and wait")  
Constants  
...
The `latch` class is a downward counter of type [std::ptrdiff_t](../types/ptrdiff_t.html "cpp/types/ptrdiff t") which can be used to synchronize threads. The value of the counter is initialized on creation. Threads may block on the latch until the counter is decremented to zero. There is no possibility to increase or reset the counter, which makes the latch a single-use barrier. 

Concurrent invocations of the member functions of `std::latch`, except for the destructor, do not introduce data races. 

## Contents

  * [1 Data Members](latch.html#Data_Members)
  * [2 Member functions](latch.html#Member_functions)
    * [2.1 Constants](latch.html#Constants)
  * [3 Notes](latch.html#Notes)
  * [4 Example](latch.html#Example)
  * [5 See also](latch.html#See_also)
...
Run this code
    ...
    struct Job
    {
        const [std::string](../string/basic_string.html) name;
        [std::string](../string/basic_string.html) product{"not worked"};
        [std::thread](thread.html) action{};
    };
     
    int main()
    {
    ...
     
        std::latch work_done{[std::size](../iterator/size.html)(jobs)};
    ...
     
        [std::cout](../io/cout.html) << "Work is starting... ";
        for (auto& job : jobs)
            job.action = [std::thread](thread.html){work, [std::ref](../utility/functional/ref.html)(job)};
     
        work_done.wait();
        [std::cout](../io/cout.html) << "done:\n";
        for (auto const& job : jobs)
            [std::cout](../io/cout.html) << "  " << job.product << '\n';
     
        [std::cout](../io/cout.html) << "Workers are cleaning up... ";
