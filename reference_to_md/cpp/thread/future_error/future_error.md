...
[future_error::operator=](operator=.html "cpp/thread/future error/operator=")  
...
---|---|---  
explicit future_error( [std::future_errc](../future_errc.html) ec ); |  (2)  |  (since C++17)  
| |   
  
1) Copy constructor. Initializes the contents of the new `future_error` object with those of other. If *this and other both have dynamic type `std::future_error` then [std::strcmp](../../string/byte/strcmp.html)(what(), other.what()) == 0.
