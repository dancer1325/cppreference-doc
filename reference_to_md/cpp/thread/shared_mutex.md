...
Member functions  
---  
[shared_mutex::shared_mutex](shared_mutex/shared_mutex.html "cpp/thread/shared mutex/shared mutex")  
[shared_mutex::~shared_mutex](shared_mutex/~shared_mutex.html "cpp/thread/shared mutex/~shared mutex")  
Exclusive locking  
[shared_mutex::lock](shared_mutex/lock.html "cpp/thread/shared mutex/lock")  
[shared_mutex::try_lock](shared_mutex/try_lock.html "cpp/thread/shared mutex/try lock")  
[shared_mutex::unlock](shared_mutex/unlock.html "cpp/thread/shared mutex/unlock")  
Shared locking  
[shared_mutex::lock_shared](shared_mutex/lock_shared.html "cpp/thread/shared mutex/lock shared")  
[shared_mutex::try_lock_shared](shared_mutex/try_lock_shared.html "cpp/thread/shared mutex/try lock shared")  
[shared_mutex::unlock_shared](shared_mutex/unlock_shared.html "cpp/thread/shared mutex/unlock shared")  
Native handle  
...
If one thread has acquired the _exclusive_ lock (through [lock](shared_mutex/lock.html "cpp/thread/shared mutex/lock"), [try_lock](shared_mutex/try_lock.html "cpp/thread/shared mutex/try lock")), no other threads can acquire the lock (including the _shared_). 

If one thread has acquired the _shared_ lock (through [lock_shared](shared_mutex/lock_shared.html "cpp/thread/shared mutex/lock shared"), [try_lock_shared](shared_mutex/try_lock_shared.html "cpp/thread/shared mutex/try lock shared")), no other thread can acquire the _exclusive_ lock, but can acquire the _shared_ lock. 
...
The `shared_mutex` class satisfies all requirements of [SharedMutex](../named_req/SharedMutex.html "cpp/named req/SharedMutex") and [StandardLayoutType](../named_req/StandardLayoutType.html "cpp/named req/StandardLayoutType"). 

## Contents

  * [1 Member types](shared_mutex.html#Member_types)
  * [2 Member functions](shared_mutex.html#Member_functions)
    * [2.1 Exclusive locking](shared_mutex.html#Exclusive_locking)
    * [2.2 Shared locking](shared_mutex.html#Shared_locking)
    * [2.3 Native handle](shared_mutex.html#Native_handle)
  * [3 Example](shared_mutex.html#Example)
  * [4 See also](shared_mutex.html#See_also)
...
Run this code
    ...
     
        ...
        {
            [std::shared_lock](shared_lock.html) lock(mutex_);
            return value_;
        }
     
        ...
        void increment()
        {
            [std::unique_lock](unique_lock.html) lock(mutex_);
            ++value_;
        }
     
    ...
     
        auto increment_and_print = [&counter]()
        {
            ...
            {
                counter.increment();
                [std::osyncstream](../io/basic_osyncstream.html)([std::cout](../io/cout.html))
                    << [std::this_thread::get_id](get_id.html)() << ' ' << counter.get() << '\n';
            }
        };
     
        [std::thread](thread.html) thread1(increment_and_print);
        [std::thread](thread.html) thread2(increment_and_print);
     
        thread1.join();
        thread2.join();
    }
