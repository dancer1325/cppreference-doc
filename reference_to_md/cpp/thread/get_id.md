...
---|---|---  
[std::thread::id](thread/id.html) get_id() noexcept; |  |  (since C++11)  
| |   
  
Returns the _id_ of the current thread. 
...
Run this code
    ...
    void foo()
    {
        [std::thread::id](thread/id.html) this_id = std::this_thread::get_id();
     
        [std::osyncstream](../io/basic_osyncstream.html)([std::cout](../io/cout.html)) << "thread " << this_id << " sleeping...\n";
     
