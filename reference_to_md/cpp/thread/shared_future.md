...
Member functions  
---  
[shared_future::shared_future](shared_future/shared_future.html "cpp/thread/shared future/shared future")  
[shared_future::~shared_future](shared_future/~shared_future.html "cpp/thread/shared future/~shared future")  
[shared_future::operator=](shared_future/operator=.html "cpp/thread/shared future/operator=")  
Getting the result  
[shared_future::get](shared_future/get.html "cpp/thread/shared future/get")  
State  
[shared_future::valid](shared_future/valid.html "cpp/thread/shared future/valid")  
[shared_future::wait](shared_future/wait.html "cpp/thread/shared future/wait")  
...
The class template `std::shared_future` provides a mechanism to access the result of asynchronous operations, similar to [std::future](future.html "cpp/thread/future"), except that multiple threads are allowed to wait for the same shared state. Unlike [std::future](future.html "cpp/thread/future"), which is only moveable (so only one instance can refer to any particular asynchronous result), `std::shared_future` is copyable and multiple shared future objects may refer to the same shared state. 
...
## Contents
  ...
  * [1 Member functions](shared_future.html#Member_functions)
    * [1.1 Getting the result](shared_future.html#Getting_the_result)
    * [1.2 State](shared_future.html#State)
  * [2 Example](shared_future.html#Example)
  * [3 See also](shared_future.html#See_also)
...
(public member function)  
[ operator=](shared_future/operator=.html "cpp/thread/shared future/operator=") |  assigns the contents   
(public member function)  
...
Run this code
    ...
    int main()
    {   
        [std::promise](promise.html)<void> ready_promise, t1_ready_promise, t2_ready_promise;
        std::shared_future<void> ready_future(ready_promise.get_future());
     
        [std::chrono::time_point](../chrono/time_point.html)<[std::chrono::high_resolution_clock](../chrono/high_resolution_clock.html)> start;
     
        auto fun1 = [&, ready_future]() -> [std::chrono::duration](../chrono/duration.html)<double, [std::milli](../numeric/ratio/ratio.html)> 
        {
            t1_ready_promise.set_value();
            ready_future.wait(); // waits for the signal from main()
            return [std::chrono::high_resolution_clock::now](../chrono/high_resolution_clock/now.html)() - start;
        };
     
     
        auto fun2 = [&, ready_future]() -> [std::chrono::duration](../chrono/duration.html)<double, [std::milli](../numeric/ratio/ratio.html)> 
        {
    ...
     
        auto result1 = [std::async](async.html)([std::launch::async](launch.html), fun1);
        auto result2 = [std::async](async.html)([std::launch::async](launch.html), fun2);
     
    ...
     
        ...
        start = [std::chrono::high_resolution_clock::now](../chrono/high_resolution_clock/now.html)();
     
        // signal the threads to go
        ready_promise.set_value();
     
        [std::cout](../io/cout.html) << "Thread 1 received the signal "
