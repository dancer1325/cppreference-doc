[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/future/wait&action=edit)
...
The behavior is undefined if [`valid`](valid.html "cpp/thread/shared future/valid")() == false before the call to this function. 
...
Run this code
    ...
    int main()
    {
        [std::shared_future](../shared_future.html)<int> f1 = [std::async](../async.html)([std::launch::async](../launch.html), []() { return fib(40); });
        [std::shared_future](../shared_future.html)<int> f2 = [std::async](../async.html)([std::launch::async](../launch.html), []() { return fib(43); });
     
    ...
     
        ...
        f2.wait();
     
        const auto diff = [std::chrono::system_clock::now](../../chrono/system_clock/now.html)() - start;
        [std::cout](../../io/cout.html) << [std::chrono::duration](../../chrono/duration.html)<double>(diff).count() << " seconds\n";
     
        [std::cout](../../io/cout.html) << "f1: " << f1.get() << '\n';
        [std::cout](../../io/cout.html) << "f2: " << f2.get() << '\n';
    }
