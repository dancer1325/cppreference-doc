[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/future/wait_for&action=edit)
...
Member functions  
---  
[shared_future::shared_future](shared_future.html "cpp/thread/shared future/shared future")  
[shared_future::~shared_future](~shared_future.html "cpp/thread/shared future/~shared future")  
[shared_future::operator=](operator=.html "cpp/thread/shared future/operator=")  
Getting the result  
[shared_future::get](get.html "cpp/thread/shared future/get")  
State  
[shared_future::valid](valid.html "cpp/thread/shared future/valid")  
[shared_future::wait](wait.html "cpp/thread/shared future/wait")  
...
[std::future_status](../future_status.html) wait_for( const [std::chrono::duration](../../chrono/duration.html)<Rep,Period>& timeout_duration ) const; |  |  (since C++11)  
---|---|---  
| |   
...
If the future is the result of a call to [std::async](../async.html "cpp/thread/async") that used lazy evaluation, this function returns immediately without waiting. 

This function may block for longer than timeout_duration due to scheduling or resource contention delays. 

The standard recommends that a steady clock is used to measure the duration. If an implementation uses a system clock instead, the wait time may also be sensitive to clock adjustments. 

The behavior is undefined if [`valid()`](../future/valid.html "cpp/thread/future/valid") is false before the call to this function. 
...
## Contents
  ...
  * [6 See also](wait_for.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/future/wait_for&action=edit&section=T-1 "Template:cpp/thread/future/wait for")] Parameters

timeout_duration  |  \-  |  maximum duration to block for   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/future/wait_for&action=edit&section=T-2 "Template:cpp/thread/future/wait for")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/future/wait_for&action=edit&section=T-3 "Template:cpp/thread/future/wait for")] Exceptions

Any exception thrown by clock, time_point, or duration during the execution (clocks, time points, and durations provided by the standard library never throw). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/future/wait_for&action=edit&section=T-4 "Template:cpp/thread/future/wait for")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/future/wait_for&action=edit&section=T-5 "Template:cpp/thread/future/wait for")] Example
...
Run this code
    ...
    int main()
    {
        [std::shared_future](../shared_future.html)<int> future = [std::async](../async.html)([std::launch::async](../launch.html), []()
        {
            [std::this_thread::sleep_for](../sleep_for.html)(3s);
            return 8;
        });
     
        [std::cout](../../io/cout.html) << "waiting...\n";
        [std::future_status](../future_status.html) status;
     
        do
        {
            switch (status = future.wait_for(1s); status)
            {
                case [std::future_status::deferred](../future_status.html):
                    [std::cout](../../io/cout.html) << "deferred\n";
                    break;
                case [std::future_status::timeout](../future_status.html):
                    [std::cout](../../io/cout.html) << "timeout\n";
                    break;
                case [std::future_status::ready](../future_status.html):
                    [std::cout](../../io/cout.html) << "ready!\n";
                    break;
            }
        }
        while (status != [std::future_status::ready](../future_status.html));
     
        [std::cout](../../io/cout.html) << "result is " << future.get() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/future/wait_for&action=edit&section=T-6 "Template:cpp/thread/future/wait for")] See also
...
---|---  
[ wait_until](wait_until.html "cpp/thread/shared future/wait until") |  waits for the result, returns if it is not available until specified time point has been reached   
