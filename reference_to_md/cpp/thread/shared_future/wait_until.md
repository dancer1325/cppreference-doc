...
The behavior is undefined if [valid()](valid.html "cpp/thread/shared future/valid") is false before the call to this function, or `Clock` does not meet the [Clock](../../named_req/Clock.html "cpp/named req/Clock") requirements. The programs is ill-formed if [std::chrono::is_clock_v](../../chrono/is_clock.html)<Clock> is false.(since C++20)
