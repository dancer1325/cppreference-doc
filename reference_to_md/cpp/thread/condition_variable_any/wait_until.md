...
template< class Lock, class Clock, class Duration, class Predicate >  
bool wait_until( Lock& lock, [std::stop_token](../stop_token.html) stoken,  
const [std::chrono::time_point](../../chrono/time_point.html)<Clock, Duration>& abs_time,  
...
The thread will be unblocked when [notify_all()](notify_all.html "cpp/thread/condition variable any/notify all") or [notify_one()](notify_one.html "cpp/thread/condition variable any/notify one") is executed, or abs_time is reached. It may also be unblocked spuriously.
...
Right after `wait_until` returns, lock is locked by the calling thread. If this postcondition cannot be satisfied[[1]](wait_until.html#cite_note-1), calls [std::terminate](../../error/terminate.html "cpp/error/terminate"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable_any/wait_until&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable_any/wait_until&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable_any/wait_until&action=edit&section=3 "Edit section: Exceptions")] Exceptions

1) Timeout-related exceptions.

2,3) Timeout-related exceptions, and any exception thrown by pred.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable_any/wait_until&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable_any/wait_until&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable_any/wait_until&action=edit&section=6 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable_any/wait_until&action=edit&section=7 "Edit section: See also")] See also
