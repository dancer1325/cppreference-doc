...
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::packaged_task](../packaged_task.html "cpp/thread/packaged task"). Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  packaged tasks whose states to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/swap2&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/swap2&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/swap2&action=edit&section=4 "Edit section: See also")] See also

[ swap](swap.html "cpp/thread/packaged task/swap") |  swaps two task objects   
