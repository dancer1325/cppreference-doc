...
Calls the stored task as if by [`_INVOKE <R>_`](../../functional.html "cpp/utility/functional")(f, args...), where f is the stored task. The return value of the task or any exceptions thrown are stored in the shared state. The shared state is made ready and any threads waiting for this are unblocked. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/operator\(\)&action=edit&section=1 "Edit section: Parameters")] Parameters

args  |  \-  |  the parameters to pass on invocation of the stored task   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/operator\(\)&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/operator\(\)&action=edit&section=3 "Edit section: Exceptions")] Exceptions

[std::future_error](../future_error.html "cpp/thread/future error") on the following error conditions: 

  * The stored task has already been invoked. The error category is set to [`promise_already_satisfied`](../future_errc.html "cpp/thread/future errc"). 
  * *this has no shared state. The error category is set to [`no_state`](../future_errc.html "cpp/thread/future errc"). 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/operator\(\)&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/operator\(\)&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2142](https://cplusplus.github.io/LWG/issue2142) | C++11  | a successful call to operator() synchronized with  
a call to any member function of a [std::future](../future.html "cpp/thread/future") or  
[std::shared_future](../shared_future.html "cpp/thread/shared future") that share their shared state with *this | no additional synchronization  
guarantees other than what is  
already provided by shared state   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/packaged_task/operator\(\)&action=edit&section=6 "Edit section: See also")] See also

[ make_ready_at_thread_exit](make_ready_at_thread_exit.html "cpp/thread/packaged task/make ready at thread exit") |  executes the function ensuring that the result is ready only once the current thread exits   
