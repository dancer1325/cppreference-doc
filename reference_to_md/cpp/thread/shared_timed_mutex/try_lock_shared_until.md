...
If timeout_time has already passed, this function behaves like [try_lock_shared()](try_lock_shared.html "cpp/thread/shared timed mutex/try lock shared"). 
...
As with [try_lock_shared()](try_lock_shared.html "cpp/thread/shared timed mutex/try lock shared"), this function is allowed to fail spuriously and return false even if the mutex was not locked by any other thread at some point before timeout_time. 
...
## Contents
  ...
  * [1 Parameters](try_lock_shared_until.html#Parameters)
  * [2 Return value](try_lock_shared_until.html#Return_value)
  * [3 Exceptions](try_lock_shared_until.html#Exceptions)
  * [4 Example](try_lock_shared_until.html#Example)
  * [5 See also](try_lock_shared_until.html#See_also)
