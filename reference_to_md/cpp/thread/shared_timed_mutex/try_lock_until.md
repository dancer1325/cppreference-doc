...
If timeout_time has already passed, this function behaves like [try_lock()](try_lock.html "cpp/thread/shared timed mutex/try lock"). 
...
As with [try_lock()](try_lock.html "cpp/thread/shared timed mutex/try lock"), this function is allowed to fail spuriously and return false even if the mutex was not locked by any other thread at some point before timeout_time. 
