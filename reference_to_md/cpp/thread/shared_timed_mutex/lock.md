[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/mutex/lock&action=edit)
...
Prior [unlock()](unlock.html "cpp/thread/shared timed mutex/unlock") operations on the same mutex _synchronize-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) this operation. 

## Contents

  * [1 Exceptions](lock.html#Exceptions)
  * [2 Notes](lock.html#Notes)
  * [3 Example](lock.html#Example)
  * [4 See also](lock.html#See_also)
...
Run this code
    ...
    [std::mutex](../mutex.html) g_num_mutex;
     
    void slow_increment(int id) 
    {
        for (int i = 0; i < 3; ++i)
        {
            ...
            [std::cout](../../io/cout.html) << "id: " << id << ", g_num: " << g_num << '\n';
            g_num_mutex.unlock();
     
            [std::this_thread::sleep_for](../sleep_for.html)([std::chrono::milliseconds](../../chrono/duration.html)(234));
        }
    }
     
    int main()
    {
        [std::thread](../thread.html) t1{slow_increment, 0};
        [std::thread](../thread.html) t2{slow_increment, 1};
        t1.join();
        t2.join();
    }
