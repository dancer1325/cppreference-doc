...
Member functions  
---  
[shared_timed_mutex::shared_timed_mutex](shared_timed_mutex.html "cpp/thread/shared timed mutex/shared timed mutex")  
[shared_timed_mutex::~shared_timed_mutex](~shared_timed_mutex.html "cpp/thread/shared timed mutex/~shared timed mutex")  
Exclusive locking  
[shared_timed_mutex::lock](lock.html "cpp/thread/shared timed mutex/lock")  
[shared_timed_mutex::try_lock](try_lock.html "cpp/thread/shared timed mutex/try lock")  
[shared_timed_mutex::try_lock_for](try_lock_for.html "cpp/thread/shared timed mutex/try lock for")  
[shared_timed_mutex::try_lock_until](try_lock_until.html "cpp/thread/shared timed mutex/try lock until")  
[shared_timed_mutex::unlock](unlock.html "cpp/thread/shared timed mutex/unlock")  
Shared locking  
[shared_timed_mutex::lock_shared](lock_shared.html "cpp/thread/shared timed mutex/lock shared")  
[shared_timed_mutex::try_lock_shared](try_lock_shared.html "cpp/thread/shared timed mutex/try lock shared")  
...
bool try_lock_shared_for( const [std::chrono::duration](../../chrono/duration.html)<Rep,Period>& timeout_duration ); |  |  (since C++14)  
---|---|---  
| |   
...
If timeout_duration is less or equal timeout_duration.zero(), the function behaves like [try_lock_shared()](try_lock_shared.html "cpp/thread/shared timed mutex/try lock shared"). 

This function may block for longer than timeout_duration due to scheduling or resource contention delays. 

The standard recommends that a steady clock is used to measure the duration. If an implementation uses a system clock instead, the wait time may also be sensitive to clock adjustments. 

As with [try_lock_shared()](try_lock_shared.html "cpp/thread/shared timed mutex/try lock shared"), this function is allowed to fail spuriously and return false even if the mutex was not locked by any other thread at some point during timeout_duration. 

Prior [unlock()](unlock.html "cpp/thread/shared timed mutex/unlock") operation on the same mutex _synchronizes-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) this operation if it returns true. 
...
## Contents
  ...
  * [1 Parameters](try_lock_shared_for.html#Parameters)
  * [2 Return value](try_lock_shared_for.html#Return_value)
  * [3 Exceptions](try_lock_shared_for.html#Exceptions)
  * [4 Example](try_lock_shared_for.html#Example)
  * [5 See also](try_lock_shared_for.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_timed_mutex/try_lock_shared_for&action=edit&section=1 "Edit section: Parameters")] Parameters

timeout_duration  |  \-  |  maximum duration to block for   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_timed_mutex/try_lock_shared_for&action=edit&section=2 "Edit section: Return value")] Return value

true if the lock was acquired successfully, otherwise false. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_timed_mutex/try_lock_shared_for&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Any exception thrown by clock, time_point, or duration during the execution (clocks, time points, and durations provided by the standard library never throw). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_timed_mutex/try_lock_shared_for&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_timed_mutex/try_lock_shared_for&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[ try_lock_shared_until](try_lock_shared_until.html "cpp/thread/shared timed mutex/try lock shared until") |  tries to lock the mutex for shared ownership, returns if the mutex has been  
