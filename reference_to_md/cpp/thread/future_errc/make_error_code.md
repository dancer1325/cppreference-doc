...
---  
**make_error_code**  
[make_error_condition](make_error_condition.html "cpp/thread/future errc/make error condition")  
Helper classes  
...
---|---|---  
[std::error_code](../../error/error_code.html) make_error_code( [std::future_errc](../future_errc.html) e ); |  |  (since C++11)  
| |   
  
Constructs an [std::error_code](../../error/error_code.html "cpp/error/error code") object from a value of type [std::future_errc](../future_errc.html "cpp/thread/future errc") as if by: 

[std::error_code](../../error/error_code.html)(static_cast<int>(e), [std::future_category](../future_category.html)()). 

This function is called by the constructor of [std::error_code](../../error/error_code.html "cpp/error/error code") when given an [std::future_errc](../future_errc.html "cpp/thread/future errc") argument. 
...
## Contents
  ...
  * [4 See also](make_error_code.html#See_also)
