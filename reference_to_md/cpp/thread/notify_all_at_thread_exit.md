...
---|---|---  
void notify_all_at_thread_exit( [std::condition_variable](condition_variable.html)& cond,  
[std::unique_lock](unique_lock.html)<[std::mutex](mutex.html)> lk ); |  |  (since C++11)  
| |   
  
`notify_all_at_thread_exit` provides a mechanism to notify other threads that a given thread has completely finished, including destroying all [`thread_local`](../keyword/thread_local.html "cpp/keyword/thread local") objects. It operates as follows: 
...
The implied lk.unlock() is [sequenced after](../atomic/memory_order.html "cpp/atomic/memory order") the destruction of all objects with [thread local storage duration](../keyword/thread_local.html "cpp/keyword/thread local") associated with the current thread. 
...
## Contents
  ...
  * [1 Notes](notify_all_at_thread_exit.html#Notes)
  * [2 Parameters](notify_all_at_thread_exit.html#Parameters)
  * [3 Return value](notify_all_at_thread_exit.html#Return_value)
  * [4 Example](notify_all_at_thread_exit.html#Example)
  * [5 Defect reports](notify_all_at_thread_exit.html#Defect_reports)
  * [6 See also](notify_all_at_thread_exit.html#See_also)
...
Run this code
    ...
     
    bool ready = false;
    [std::string](../string/basic_string.html) result; // some arbitrary type
     
    void thread_func()
    {
        thread_local [std::string](../string/basic_string.html) thread_local_data = "42";
     
        [std::unique_lock](unique_lock.html)<[std::mutex](mutex.html)> lk(m);
     
    ...
    int main()
    {
        [std::thread](thread.html) t(thread_func);
        t.detach();
     
        // do other work
        // ...
...
---|---|---|---  
[LWG 2140](https://cplusplus.github.io/LWG/issue2140) | C++11  | the call to `notify_all_at_thread_exit`  
