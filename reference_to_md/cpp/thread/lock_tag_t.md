...
---  
**defer_lock try_to_lockadopt_lockdefer_lock_ttry_to_lock_tadopt_lock_t**(C++11)(C++11)(C++11)(C++11)(C++11)(C++11)  
...
constexpr [std::defer_lock_t](lock_tag_t.html) defer_lock {}; |  (2)  |  (since C++11)   
(inline since C++17)  
struct try_to_lock_t { explicit try_to_lock_t() = default; }; |  (3)  |  (since C++11)  
constexpr [std::try_to_lock_t](lock_tag_t.html) try_to_lock {}; |  (4)  |  (since C++11)   
(inline since C++17)  
struct adopt_lock_t { explicit adopt_lock_t() = default; }; |  (5)  |  (since C++11)  
constexpr [std::adopt_lock_t](lock_tag_t.html) adopt_lock {}; |  (6)  |  (since C++11)   
(inline since C++17)  
| |   
  
1,3,5) The empty class tag types `std::defer_lock_t`, `std::try_to_lock_t` and `std::adopt_lock_t` can be used in the constructor's parameter list for [std::unique_lock](unique_lock.html "cpp/thread/unique lock") and [std::shared_lock](shared_lock.html "cpp/thread/shared lock") to specify locking strategy. 
...
One of the constructors of the class template [std::lock_guard](lock_guard.html "cpp/thread/lock guard") only accepts the tag `std::adopt_lock`. 
...
Run this code
    ...
     
        ...
        [std::lock](lock.html)(from.m, to.m);
        // make sure both already-locked mutexes are unlocked at the end of scope
        [std::lock_guard](lock_guard.html) lock1{from.m, std::adopt_lock};
        [std::lock_guard](lock_guard.html) lock2{to.m, std::adopt_lock};
     
    // equivalent approach:
    ...
     
        [std::thread](thread.html) t1{transfer, [std::ref](../utility/functional/ref.html)(my_account), [std::ref](../utility/functional/ref.html)(your_account), 10};
        [std::thread](thread.html) t2{transfer, [std::ref](../utility/functional/ref.html)(your_account), [std::ref](../utility/functional/ref.html)(my_account), 5};
     
        t1.join();
        t2.join();
     
        [std::cout](../io/cout.html) << "my_account.balance = " << my_account.balance << "\n"
