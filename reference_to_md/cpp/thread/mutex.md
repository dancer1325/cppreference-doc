...
Member functions  
---  
[mutex::mutex](mutex/mutex.html "cpp/thread/mutex/mutex")  
[mutex::~mutex](mutex/~mutex.html "cpp/thread/mutex/~mutex")  
Locking  
[mutex::lock](mutex/lock.html "cpp/thread/mutex/lock")  
[mutex::try_lock](mutex/try_lock.html "cpp/thread/mutex/try lock")  
[mutex::unlock](mutex/unlock.html "cpp/thread/mutex/unlock")  
Native handle  
...
`mutex` offers exclusive, non-recursive ownership semantics: 
  ...
  * A calling thread _owns_ a `mutex` from the time that it successfully calls either [`lock`](mutex/lock.html "cpp/thread/mutex/lock") or [`try_lock`](mutex/try_lock.html "cpp/thread/mutex/try lock") until it calls [`unlock`](mutex/unlock.html "cpp/thread/mutex/unlock"). 
  * When a thread owns a `mutex`, all other threads will block (for calls to [`lock`](mutex/lock.html "cpp/thread/mutex/lock")) or receive a false return value (for [`try_lock`](mutex/try_lock.html "cpp/thread/mutex/try lock")) if they attempt to claim ownership of the `mutex`. 
  * A calling thread must not own the `mutex` prior to calling [`lock`](mutex/lock.html "cpp/thread/mutex/lock") or [`try_lock`](mutex/try_lock.html "cpp/thread/mutex/try lock"). 



The behavior of a program is undefined if a `mutex` is destroyed while still owned by any threads, or a thread terminates while owning a `mutex`. The `mutex` class satisfies all requirements of [Mutex](../named_req/Mutex.html "cpp/named req/Mutex") and [StandardLayoutType](../named_req/StandardLayoutType.html "cpp/named req/StandardLayoutType"). 

`std::mutex` is neither copyable nor movable. 

## Contents

  * [1 Nested types](mutex.html#Nested_types)
  * [2 Member functions](mutex.html#Member_functions)
    * [2.1 Locking](mutex.html#Locking)
    * [2.2 Native handle](mutex.html#Native_handle)
  * [3 Notes](mutex.html#Notes)
  * [4 Example](mutex.html#Example)
  * [5 See also](mutex.html#See_also)
...
Run this code
    ...
    #include <thread>
     
    [std::map](../container/map.html)<[std::string](../string/basic_string.html), [std::string](../string/basic_string.html)> g_pages;
    std::mutex g_pages_mutex;
     
    void save_page(const [std::string](../string/basic_string.html)& url)
    {
        // simulate a long page fetch
        [std::this_thread::sleep_for](sleep_for.html)([std::chrono::seconds](../chrono/duration.html)(2));
        [std::string](../string/basic_string.html) result = "fake content";
     
        [std::lock_guard](lock_guard.html)<std::mutex> guard(g_pages_mutex);
        g_pages[url] = result;
    }
     
    int main() 
    {
        [std::thread](thread.html) t1(save_page, "http://foo");
        [std::thread](thread.html) t2(save_page, "http://bar");
        t1.join();
        t2.join();
     
        // safe to access g_pages without lock now, as the threads are joined
        for (const auto& [url, page] : g_pages)
            [std::cout](../io/cout.html) << url << " => " << page << '\n';
    }
