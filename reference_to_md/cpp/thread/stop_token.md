...
Member functions  
---  
[stop_token::stop_token](stop_token/stop_token.html "cpp/thread/stop token/stop token")  
[stop_token::~stop_token](stop_token/~stop_token.html "cpp/thread/stop token/~stop token")  
[stop_token::operator=](stop_token/operator=.html "cpp/thread/stop token/operator=")  
Modifiers  
[stop_token::swap](stop_token/swap.html "cpp/thread/stop token/swap")  
Observers  
[stop_token::stop_requested](stop_token/stop_requested.html "cpp/thread/stop token/stop requested")  
[stop_token::stop_possible](stop_token/stop_possible.html "cpp/thread/stop token/stop possible")  
...
The `stop_token` class provides the means to check if a stop request has been made or can be made, for its associated [`std::stop_source`](stop_source.html "cpp/thread/stop source") object. It is essentially a thread-safe "view" of the associated stop-state. 

The `stop_token` can also be passed to the constructor of [`std::stop_callback`](stop_callback.html "cpp/thread/stop callback"), such that the callback will be invoked if the `stop_token`'s associated [std::stop_source](stop_source.html "cpp/thread/stop source") is requested to stop. And `stop_token` can be passed to the interruptible waiting functions of [std::condition_variable_any](condition_variable_any.html "cpp/thread/condition variable any"), to interrupt the condition variable's wait if stop is requested. 

## Contents

  * [1 Member alias templates](stop_token.html#Member_alias_templates)
  * [2 Member functions](stop_token.html#Member_functions)
    * [2.1 Modifiers](stop_token.html#Modifiers)
    * [2.2 Observers](stop_token.html#Observers)
  * [3 Non-member functions](stop_token.html#Non-member_functions)
  * [4 Notes](stop_token.html#Notes)
  * [5 Example](stop_token.html#Example)
...
Run this code
    ...
    void f(std::stop_token stop_token, int value)
    {
        ...
        {
            [std::cout](../io/cout.html) << value++ << ' ' << [std::flush](../io/manip/flush.html);
    ...
    int main()
    {
        [std::jthread](jthread.html) thread(f, 5); // prints 5 6 7 8... for approximately 3 seconds
