...
---|---|---  
future& operator=( const future& other ) = delete; |  (2)  |  (since C++11)  
| |   
  
Assigns the contents of another future object. 

1) Releases any shared state and move-assigns the contents of other to *this. After the assignment, other.valid() == false and [this->valid()](valid.html "cpp/thread/future/valid") will yield the same value as other.valid() before the assignment.
