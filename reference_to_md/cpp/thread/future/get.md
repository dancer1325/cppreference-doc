...
---|---|---  
T get(); |  (1)  |  (since C++11)  
[std::future](../future.html)<T&> specializations |  |   
T& get(); |  (2)  |  (since C++11)  
[std::future](../future.html)<void> specialization |  |   
void get(); |  (3)  |  (since C++11)  
| |   
  
The `get` member function waits (by calling [wait()](wait.html "cpp/thread/future/wait")) until the shared state is ready, then retrieves the value stored in the shared state (if any). Right after calling this function, [valid()](valid.html "cpp/thread/future/valid") is false. 

If [valid()](valid.html "cpp/thread/future/valid") is false before the call to this function, the behavior is undefined. 

## Contents

  * [1 Return value](get.html#Return_value)
  * [2 Exceptions](get.html#Exceptions)
...
Run this code
    ...
    #include <thread>
     
    [std::string](../../string/basic_string.html) time()
    {
        static auto start = [std::chrono::steady_clock::now](../../chrono/steady_clock/now.html)();
        [std::chrono::duration](../../chrono/duration.html)<double> d = [std::chrono::steady_clock::now](../../chrono/steady_clock/now.html)() - start;
        return "[" + [std::to_string](../../string/basic_string/to_string.html)(d.count()) + "s]";
    }
     
    int main()
    {
    ...
     
        {
            [std::cout](../../io/cout.html) << time() << " launching thread\n";
            [std::future](../future.html)<int> f = [std::async](../async.html)([std::launch::async](../launch.html), []
            {
                [std::this_thread::sleep_for](../sleep_for.html)(1s);
                return 7;
            });
            [std::cout](../../io/cout.html) << time() << " waiting for the future, f.valid() = "
                      << f.valid() << '\n';
            int n = f.get();
            [std::cout](../../io/cout.html) << time() << " f.get() returned " << n << ", f.valid() = "
                      << f.valid() << '\n';
        }
     
        {
            ...
            {
                [std::this_thread::sleep_for](../sleep_for.html)(1s);
                return true ? throw [std::runtime_error](../../error/runtime_error.html)("7") : 7;
            });
            [std::cout](../../io/cout.html) << time() << " waiting for the future, f.valid() = "
                      << f.valid() << '\n';
     
            ...
            {
                int n = f.get();
                [std::cout](../../io/cout.html) << time() << " f.get() returned " << n
                          << ", f.valid() = " << f.valid() << '\n';
            }
            catch (const [std::exception](../../error/exception.html)& e)
            {
                [std::cout](../../io/cout.html) << time() << " caught exception " << e.what()
                          << ", f.valid() = " << f.valid() << '\n';
            }
        }
    }
