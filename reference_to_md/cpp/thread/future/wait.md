...
The behavior is undefined if [`valid`](valid.html "cpp/thread/future/valid")() == false before the call to this function. 
...
Run this code
    ...
    int main()
    {
        [std::future](../future.html)<int> f1 = [std::async](../async.html)([std::launch::async](../launch.html), []() { return fib(40); });
        [std::future](../future.html)<int> f2 = [std::async](../async.html)([std::launch::async](../launch.html), []() { return fib(43); });
     
