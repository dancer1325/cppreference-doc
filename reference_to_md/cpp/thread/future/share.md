...
Transfers the shared state of *this, if any, to a [std::shared_future](../shared_future.html "cpp/thread/shared future") object. Multiple [std::shared_future](../shared_future.html "cpp/thread/shared future") objects may reference the same shared state, which is not possible with [std::future](../future.html "cpp/thread/future"). 

After calling `share` on a [std::future](../future.html "cpp/thread/future"), [valid()](valid.html "cpp/thread/future/valid") == false. 

## Contents

  * [1 Parameters](share.html#Parameters)
  * [2 Return value](share.html#Return_value)
  * [3 Example](share.html#Example)
  * [4 Defect reports](share.html#Defect_reports)
  * [5 See also](share.html#See_also)
