...
The behavior is undefined if [`valid()`](valid.html "cpp/thread/future/valid") is false before the call to this function. 
...
Run this code
    ...
    int main()
    {
        [std::future](../future.html)<int> future = [std::async](../async.html)([std::launch::async](../launch.html), []()
        {
