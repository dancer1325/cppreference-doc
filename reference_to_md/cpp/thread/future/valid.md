[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/future/valid&action=edit)
...
This is the case only for futures that were not default-constructed or moved from (i.e. returned by [std::promise::get_future()](../promise/get_future.html "cpp/thread/promise/get future"), [std::packaged_task::get_future()](../packaged_task/get_future.html "cpp/thread/packaged task/get future") or [std::async()](../async.html "cpp/thread/async")) until the first time [get()](get.html "cpp/thread/future/get") or [share()](share.html "cpp/thread/future/share") is called. 

The behavior is undefined if any member function other than the destructor, the move-assignment operator, or `valid` is called on a `future ` that does not refer to shared state (although implementations are encouraged to throw [std::future_error](../future_error.html "cpp/thread/future error") indicating `no_state` in this case). It is valid to move from a future object for which `valid()` is false. 

## Contents

  * [1 Parameters](valid.html#Parameters)
  * [2 Return value](valid.html#Return_value)
  * [3 Example](valid.html#Example)
  * [4 See also](valid.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::promise](../promise.html)<void> p;
        [std::future](../future.html)<void> f = p.get_future();
     
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html);
     
        [std::cout](../../io/cout.html) << f.valid() << '\n';
        p.set_value();
        [std::cout](../../io/cout.html) << f.valid() << '\n';
        f.get();
        [std::cout](../../io/cout.html) << f.valid() << '\n';
