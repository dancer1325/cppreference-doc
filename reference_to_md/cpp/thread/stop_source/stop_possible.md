...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/stop_possible&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/stop_possible&action=edit&section=2 "Edit section: Return value")] Return value

true if the `stop_source` object has a stop-state, otherwise false. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/stop_possible&action=edit&section=3 "Edit section: Notes")] Notes

If the `stop_source` object has a stop-state and a stop request has already been made, this function still returns true. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/stop_possible&action=edit&section=4 "Edit section: Example")] Example
