...
Member functions  
---  
[stop_source::stop_source](stop_source.html "cpp/thread/stop source/stop source")  
[stop_source::~stop_source](~stop_source.html "cpp/thread/stop source/~stop source")  
[stop_source::operator=](operator=.html "cpp/thread/stop source/operator=")  
Modifiers  
[stop_source::request_stop](request_stop.html "cpp/thread/stop source/request stop")  
[stop_source::swap](swap.html "cpp/thread/stop source/swap")  
Observers  
[stop_source::get_token](get_token.html "cpp/thread/stop source/get token")  
[stop_source::stop_requested](stop_requested.html "cpp/thread/stop source/stop requested")  
[stop_source::stop_possible](stop_possible.html "cpp/thread/stop source/stop possible")  
Non-member functions  
[swap(std::stop_source)](swap2.html "cpp/thread/stop source/swap2")  
[operator==](operator_cmp.html "cpp/thread/stop source/operator cmp")  
Helper tags  
...
inline constexpr [std::nostopstate_t](nostopstate_t.html) nostopstate {}; |  (2)  |  (since C++20)  
| |   
  
1) Empty tag type intended for use as a placeholder in [std::stop_source](../stop_source.html "cpp/thread/stop source") non-default constructor, that makes the constructed [std::stop_source](../stop_source.html "cpp/thread/stop source") empty with no associated stop-state.

2) The corresponding constant object instance of `std::nostopstate_t` for use in constructing an empty [std::stop_source](../stop_source.html "cpp/thread/stop source"), as a placeholder value in the non-default constructor.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/nostopstate&action=edit&section=1 "Edit section: See also")] See also

[ stop_source](../stop_source.html "cpp/thread/stop source")(C++20) |  class representing a request to stop one or more [std::jthread](../jthread.html "cpp/thread/jthread")s   
