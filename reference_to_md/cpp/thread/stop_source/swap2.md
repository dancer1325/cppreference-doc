...
Overloads the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::stop_source](../stop_source.html "cpp/thread/stop source"). Exchanges the stop-state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 

This function is not visible to ordinary [unqualified](../../language/unqualified_lookup.html "cpp/language/unqualified lookup") or [qualified lookup](../../language/qualified_lookup.html "cpp/language/qualified lookup"), and can only be found by [argument-dependent lookup](../../language/adl.html "cpp/language/adl") when std::stop_source is an associated class of the arguments. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  `stop_source`s to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/swap2&action=edit&section=2 "Edit section: Return value")] Return value
