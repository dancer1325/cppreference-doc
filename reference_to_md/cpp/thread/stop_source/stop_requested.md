...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/stop_requested&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/stop_requested&action=edit&section=2 "Edit section: Return value")] Return value

true if the `stop_token` object has a stop-state and it has received a stop request, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/stop_source/stop_requested&action=edit&section=3 "Edit section: Example")] Example
