...
[condition_variable::wait_until](wait_until.html "cpp/thread/condition variable/wait until")  
Native handle  
...
void wait( [std::unique_lock](../unique_lock.html)<[std::mutex](../mutex.html)>& lock ); |  (1)  |  (since C++11)  
---|---|---  
template< class Predicate >  
void wait( [std::unique_lock](../unique_lock.html)<[std::mutex](../mutex.html)>& lock, Predicate pred ); |  (2)  |  (since C++11)  
| |   
...
The thread will be unblocked when [notify_all()](notify_all.html "cpp/thread/condition variable/notify all") or [notify_one()](notify_one.html "cpp/thread/condition variable/notify one") is executed. It may also be unblocked spuriously.
...
Right after `wait` returns, lock.owns_lock() is true, and lock.mutex() is locked by the calling thread. If these postconditions cannot be satisfied[[1]](wait.html#cite_note-1), calls [std::terminate](../../error/terminate.html "cpp/error/terminate"). 

If any of the following conditions is satisfied, the behavior is undefined: 

  * lock.owns_lock() is false. 
  * lock.mutex() is not locked by the calling thread. 
  * If some other threads are also waiting on *this, lock.mutex() is different from the mutex unlocked by the waiting functions (`wait`, [wait_for](wait_for.html "cpp/thread/condition variable/wait for") and [wait_until](wait_until.html "cpp/thread/condition variable/wait until")) called on *this by those threads. 


  1. [↑](wait.html#cite_ref-1) This can happen if the re-locking of the mutex throws an exception.



## Contents

  * [1 Parameters](wait.html#Parameters)
  * [2 Exceptions](wait.html#Exceptions)
  * [3 Notes](wait.html#Notes)
  * [4 Example](wait.html#Example)
  * [5 Defect reports](wait.html#Defect_reports)
  * [6 See also](wait.html#See_also)
  * [7 External links](wait.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable/wait&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable/wait&action=edit&section=2 "Edit section: Exceptions")] Exceptions

1) Throws nothing.

2) Any exception thrown by pred.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable/wait&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable/wait&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable/wait&action=edit&section=5 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable/wait&action=edit&section=6 "Edit section: See also")] See also
...
[C documentation](../../../c/thread/cnd_wait.html "c/thread/cnd wait") for cnd_wait  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/condition_variable/wait&action=edit&section=7 "Edit section: External links")] External links
