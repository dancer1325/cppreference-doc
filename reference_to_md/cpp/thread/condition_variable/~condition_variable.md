[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/condition_variable/destructor&action=edit)
...
Destroys the object of type [std::condition_variable](../condition_variable.html "cpp/thread/condition variable"). 
