...
---  
[thread::id](thread/id.html "cpp/thread/thread/id")  
[Member functions](thread.html#Member_functions "cpp/thread/thread")  
[thread::thread](thread/thread.html "cpp/thread/thread/thread")  
[thread::~thread](thread/~thread.html "cpp/thread/thread/~thread")  
[thread::operator=](thread/operator=.html "cpp/thread/thread/operator=")  
[Observers](thread.html#Observers "cpp/thread/thread")  
[thread::joinable](thread/joinable.html "cpp/thread/thread/joinable")  
[thread::get_id](thread/get_id.html "cpp/thread/thread/get id")  
[thread::native_handle](thread/native_handle.html "cpp/thread/thread/native handle")  
[thread::hardware_concurrency](thread/hardware_concurrency.html "cpp/thread/thread/hardware concurrency")  
[Operations](thread.html#Operations "cpp/thread/thread")  
[thread::join](thread/join.html "cpp/thread/thread/join")  
[thread::detach](thread/detach.html "cpp/thread/thread/detach")  
[thread::swap](thread/swap.html "cpp/thread/thread/swap")  
...
Threads begin execution immediately upon construction of the associated thread object (pending any OS scheduling delays), starting at the top-level function provided as a [constructor argument](thread/thread.html "cpp/thread/thread/thread"). The return value of the top-level function is ignored and if it terminates by throwing an exception, [std::terminate](../error/terminate.html "cpp/error/terminate") is called. The top-level function may communicate its return value or an exception to the caller via [std::promise](promise.html "cpp/thread/promise") or by modifying shared variables (which may require synchronization, see [std::mutex](mutex.html "cpp/thread/mutex") and [std::atomic](../atomic/atomic.html "cpp/atomic/atomic")). 

`std::thread` objects may also be in the state that does not represent any thread (after default construction, move from, [detach](thread/detach.html "cpp/thread/thread/detach"), or [join](thread/join.html "cpp/thread/thread/join")), and a thread of execution may not be associated with any `thread` objects (after [detach](thread/detach.html "cpp/thread/thread/detach")). 

No two `std::thread` objects may represent the same thread of execution; `std::thread` is not [CopyConstructible](../named_req/CopyConstructible.html "cpp/named req/CopyConstructible") or [CopyAssignable](../named_req/CopyAssignable.html "cpp/named req/CopyAssignable"), although it is [MoveConstructible](../named_req/MoveConstructible.html "cpp/named req/MoveConstructible") and [MoveAssignable](../named_req/MoveAssignable.html "cpp/named req/MoveAssignable"). 

## Contents

  * [1 Member types](thread.html#Member_types)
  * [2 Member classes](thread.html#Member_classes)
  * [3 Member functions](thread.html#Member_functions)
    * [3.1 Observers](thread.html#Observers)
    * [3.2 Operations](thread.html#Operations)
  * [4 Non-member functions](thread.html#Non-member_functions)
  * [5 See also](thread.html#See_also)
