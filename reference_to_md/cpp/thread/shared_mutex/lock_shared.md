...
Member functions  
---  
[shared_mutex::shared_mutex](shared_mutex.html "cpp/thread/shared mutex/shared mutex")  
[shared_mutex::~shared_mutex](~shared_mutex.html "cpp/thread/shared mutex/~shared mutex")  
Exclusive locking  
[shared_mutex::lock](lock.html "cpp/thread/shared mutex/lock")  
[shared_mutex::try_lock](try_lock.html "cpp/thread/shared mutex/try lock")  
[shared_mutex::unlock](unlock.html "cpp/thread/shared mutex/unlock")  
Shared locking  
**shared_mutex::lock_shared**  
[shared_mutex::try_lock_shared](try_lock_shared.html "cpp/thread/shared mutex/try lock shared")  
[shared_mutex::unlock_shared](unlock_shared.html "cpp/thread/shared mutex/unlock shared")  
Native handle  
...
A prior [unlock()](unlock.html "cpp/thread/shared mutex/unlock") operation on the same mutex _synchronizes-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) this operation. 

## Contents

  * [1 Parameters](lock_shared.html#Parameters)
  * [2 Return value](lock_shared.html#Return_value)
  * [3 Exceptions](lock_shared.html#Exceptions)
  * [4 Notes](lock_shared.html#Notes)
  * [5 Example](lock_shared.html#Example)
  * [6 See also](lock_shared.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/lock_shared&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/lock_shared&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/lock_shared&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/lock_shared&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/lock_shared&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    #include <vector>
     
    [std::mutex](../mutex.html) stream_mutx;
    void print(auto v)
    {
        [std::unique_lock](../unique_lock.html)<[std::mutex](../mutex.html)> lock(stream_mutx);
        [std::cout](../../io/cout.html) << [std::this_thread::get_id](../get_id.html)() << " saw: ";
        for (auto e : v)
    ...
     
        [std::shared_mutex](../shared_mutex.html) smtx;
        int product = 0;
     
        auto writer = [&smtx, &product](int start, int end)
        {
            for (int i = start; i < end; ++i)
            {
                auto data = i;            
                {
                    [std::unique_lock](../unique_lock.html)<[std::shared_mutex](../shared_mutex.html)> lock(smtx);
                    product = data;
                } 
                [std::this_thread::sleep_for](../sleep_for.html)(3ms);
            }
     
    ...
     
        ...
        {
            int data = 0;
            [std::vector](../../container/vector.html)<int> seen;
            do
            {
                {
    ...
     
                seen.push_back(data);
                [std::this_thread::sleep_for](../sleep_for.html)(2ms);
            }
            while (data != LAST);
     
            print(seen);
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/lock_shared&action=edit&section=6 "Edit section: See also")] See also

[ lock](lock.html "cpp/thread/shared mutex/lock") |  locks the mutex, blocks if the mutex is not available   
...
---|---  
[ try_lock_shared](try_lock_shared.html "cpp/thread/shared mutex/try lock shared") |  tries to lock the mutex for shared ownership, returns if the mutex is not available   
...
[ unlock_shared](unlock_shared.html "cpp/thread/shared mutex/unlock shared") |  unlocks the mutex (shared ownership)   
