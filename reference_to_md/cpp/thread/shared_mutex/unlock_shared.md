...
This operation _synchronizes-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) any subsequent [lock()](lock.html "cpp/thread/shared mutex/lock") operation that obtains ownership of the same mutex. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/unlock_shared&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/unlock_shared&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/unlock_shared&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/unlock_shared&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/unlock_shared&action=edit&section=5 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/shared_mutex/unlock_shared&action=edit&section=6 "Edit section: See also")] See also
