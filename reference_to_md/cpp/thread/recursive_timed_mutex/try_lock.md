[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/mutex/try_lock&action=edit)
...
Member functions  
---  
[recursive_timed_mutex::recursive_timed_mutex](recursive_timed_mutex.html "cpp/thread/recursive timed mutex/recursive timed mutex")  
[recursive_timed_mutex::~recursive_timed_mutex](~recursive_timed_mutex.html "cpp/thread/recursive timed mutex/~recursive timed mutex")  
Locking  
[recursive_timed_mutex::lock](lock.html "cpp/thread/recursive timed mutex/lock")  
**recursive_timed_mutex::try_lock**  
[recursive_timed_mutex::try_lock_for](try_lock_for.html "cpp/thread/recursive timed mutex/try lock for")  
[recursive_timed_mutex::try_lock_until](try_lock_until.html "cpp/thread/recursive timed mutex/try lock until")  
[recursive_timed_mutex::unlock](unlock.html "cpp/thread/recursive timed mutex/unlock")  
Native handle  
...
A thread may call `try_lock` on a recursive mutex repeatedly. Successful calls to `try_lock` increment the ownership count: the mutex will only be released after the thread makes a matching number of calls to [unlock](unlock.html "cpp/thread/recursive timed mutex/unlock"). 

The maximum number of levels of ownership is unspecified. A call to `try_lock` will return false if this number is exceeded. 

Prior [unlock()](unlock.html "cpp/thread/recursive timed mutex/unlock") operation on the same mutex _synchronizes-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) this operation if it returns true. Note that prior [lock()](lock.html "cpp/thread/recursive timed mutex/lock") does not synchronize with this operation if it returns false. 

## Contents

  * [1 Parameters](try_lock.html#Parameters)
  * [2 Return value](try_lock.html#Return_value)
  * [3 Exceptions](try_lock.html#Exceptions)
  * [4 Example](try_lock.html#Example)
  * [5 See also](try_lock.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/mutex/try_lock&action=edit&section=T-1 "Template:cpp/thread/mutex/try lock")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/mutex/try_lock&action=edit&section=T-2 "Template:cpp/thread/mutex/try lock")] Return value

true if the lock was acquired successfully, otherwise false. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/mutex/try_lock&action=edit&section=T-3 "Template:cpp/thread/mutex/try lock")] Exceptions

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/mutex/try_lock&action=edit&section=T-4 "Template:cpp/thread/mutex/try lock")] Example

[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/recursive_timed_mutex/example_try_lock&action=edit)

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/thread/mutex/try_lock&action=edit&section=T-5 "Template:cpp/thread/mutex/try lock")] See also

[ lock](lock.html "cpp/thread/recursive timed mutex/lock") |  locks the mutex, blocks if the mutex is not available   
...
[C documentation](../../../c/thread/mtx_trylock.html "c/thread/mtx trylock") for mtx_trylock
