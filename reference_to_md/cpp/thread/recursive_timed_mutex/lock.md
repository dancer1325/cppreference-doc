...
The maximum number of levels of ownership is unspecified. An exception of type [std::system_error](../../error/system_error.html "cpp/error/system error") will be thrown if this number is exceeded. 

Prior [unlock()](unlock.html "cpp/thread/recursive timed mutex/unlock") operations on the same mutex _synchronize-with_ (as defined in [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) this operation. 
