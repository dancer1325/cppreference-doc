...
---|---|---  
#define ATOMIC_VAR_INIT(value) /* implementation-defined */ |  |  (since C++11)   
(deprecated in C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::atomic](atomic.html)<int> a = ATOMIC_VAR_INIT(1);
        // std::atomic<int> a(1);   // C++-only alternative
        [std::cout](../io/cout.html) << "Initialized std::atomic<int> as: " << a << '\n';
    }
