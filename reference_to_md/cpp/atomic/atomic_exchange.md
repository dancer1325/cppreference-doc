...
## Contents
  ...
  * [3 Example](atomic_exchange.html#Example)
  * [4 Defect reports](atomic_exchange.html#Defect_reports)
  * [5 See also](atomic_exchange.html#See_also)
...
Run this code
    ...
    #include <vector>
     
    [std::atomic](atomic.html)<bool> lock(false); // holds true when locked
    ...
    void f(int n)
    {
        ...
        {
            while (std::atomic_exchange_explicit(&lock, true, [std::memory_order_acquire](memory_order.html)))
                ; // spin until acquired
            [std::cout](../io/cout.html) << n << (new_line++ % 80 ? "" : "\n");
            [std::atomic_store_explicit](atomic_store.html)(&lock, false, [std::memory_order_release](memory_order.html));
        }
    }
     
    int main()
...
(function template)  
---|---  
[C documentation](../../c/atomic/atomic_exchange.html "c/atomic/atomic exchange") for atomic_exchange, atomic_exchange_explicit
