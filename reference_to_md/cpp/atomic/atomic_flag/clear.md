...
---|---|---  
void clear( [std::memory_order](../memory_order.html) order =  
[std::memory_order_seq_cst](../memory_order.html) ) volatile noexcept; |  (1)  |  (since C++11)  
void clear( [std::memory_order](../memory_order.html) order =  
[std::memory_order_seq_cst](../memory_order.html) ) noexcept; |  (2)  |  (since C++11)  
| |   
  
Atomically changes the state of a [std::atomic_flag](../atomic_flag.html "cpp/atomic/atomic flag") to clear (false). 
