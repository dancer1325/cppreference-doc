...
Constructs a new [std::atomic_flag](../atomic_flag.html "cpp/atomic/atomic flag"). 

1) Trivial default constructor, initializes [std::atomic_flag](../atomic_flag.html "cpp/atomic/atomic flag") to unspecified state.  | (until C++20)  
---|---  
1) Initializes [std::atomic_flag](../atomic_flag.html "cpp/atomic/atomic flag") to clear state.  | (since C++20)  
  
2) The copy constructor is deleted; [std::atomic_flag](../atomic_flag.html "cpp/atomic/atomic flag") is not copyable.
