...
---|---|---  
template< class T >  
T atomic_fetch_max( [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg ) noexcept; |  (1)  |  (since C++26)  
template< class T >  
T atomic_fetch_max( volatile [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg ) noexcept; |  (2)  |  (since C++26)  
template< class T >  
T atomic_fetch_max_explicit( [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg,  
[std::memory_order](memory_order.html) order ) noexcept; |  (3)  |  (since C++26)  
template< class T >  
T atomic_fetch_max_explicit( volatile [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg,  
[std::memory_order](memory_order.html) order ) noexcept; |  (4)  |  (since C++26)  
| |   
  
Atomically replaces the value pointed by obj with the result of [std::max](../algorithm/max.html "cpp/algorithm/max") between the old value of obj and arg. Returns the value obj held previously. The operation is performed as if the following was executed: 

1,2) obj->fetch_max(arg)

3,4) obj->fetch_max(arg, order)

If `std::atomic<T>` has no `fetch_max` member (this member is only provided for [integral](atomic.html#Specializations_for_integral_types "cpp/atomic/atomic") and [pointer](atomic.html#Partial_specializations "cpp/atomic/atomic") types except bool), the program is ill-formed. 

## Contents

  * [1 Parameters](atomic_fetch_max.html#Parameters)
  * [2 Return value](atomic_fetch_max.html#Return_value)
  * [3 Notes](atomic_fetch_max.html#Notes)
  * [4 Example](atomic_fetch_max.html#Example)
  * [5 See also](atomic_fetch_max.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_max&action=edit&section=1 "Edit section: Parameters")] Parameters

obj  |  \-  |  pointer to the atomic object to modify   
---|---|---  
arg  |  \-  |  the value to [std::max](../algorithm/max.html "cpp/algorithm/max") with the value stored in the atomic object   
order  |  \-  |  the memory synchronization ordering   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_max&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_max&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_max&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_max&action=edit&section=5 "Edit section: See also")] See also
...
(public member function of `std::atomic<T>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/atomic/atomic/dsc_fetch_max&action=edit)  
---|---  
[ atomic_fetch_minatomic_fetch_min_explicit](atomic_fetch_min.html "cpp/atomic/atomic fetch min")(C++26)(C++26) |  replaces the atomic object with the result of [std::min](../algorithm/min.html "cpp/algorithm/min") with a non-atomic argument and obtains the previous value of the atomic   
