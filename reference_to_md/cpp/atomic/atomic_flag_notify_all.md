...
---|---|---  
void atomic_flag_notify_all( [std::atomic_flag](atomic_flag.html)* object ) noexcept; |  (1)  |  (since C++20)  
void atomic_flag_notify_all( volatile [std::atomic_flag](atomic_flag.html)* object ) noexcept; |  (2)  |  (since C++20)  
| |   
  
Performs atomic notifying operations. 

Unblocks all threads blocked in atomic waiting operations (i.e. [std::atomic_flag_wait()](atomic_flag_wait.html "cpp/atomic/atomic flag wait"), [std::atomic_flag_wait_explicit()](atomic_flag_wait.html "cpp/atomic/atomic flag wait"), or [`std::atomic_flag::wait()`](atomic_flag/wait.html "cpp/atomic/atomic flag/wait")) on *object, if there are any; otherwise does nothing. 

Equivalent to object->notify_all(). 

## Contents

  * [1 Parameters](atomic_flag_notify_all.html#Parameters)
  * [2 Return value](atomic_flag_notify_all.html#Return_value)
  * [3 Notes](atomic_flag_notify_all.html#Notes)
  * [4 Example](atomic_flag_notify_all.html#Example)
  * [5 See also](atomic_flag_notify_all.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_notify_all&action=edit&section=1 "Edit section: Parameters")] Parameters

object  |  \-  |  pointer to the `atomic_flag` object to notify   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_notify_all&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_notify_all&action=edit&section=3 "Edit section: Notes")] Notes

This form of change-detection is often more efficient than simple polling or pure spinlocks. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_notify_all&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_notify_all&action=edit&section=5 "Edit section: See also")] See also
