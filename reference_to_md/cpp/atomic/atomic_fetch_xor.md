...
If `std::atomic<T>` has no `fetch_xor` member (this member is only provided for [integral types](atomic.html#Specializations_for_integral_types "cpp/atomic/atomic") except bool), the program is ill-formed. 

## Contents

  * [1 Parameters](atomic_fetch_xor.html#Parameters)
  * [2 Return value](atomic_fetch_xor.html#Return_value)
  * [3 Example](atomic_fetch_xor.html#Example)
  * [4 Defect reports](atomic_fetch_xor.html#Defect_reports)
  * [5 See also](atomic_fetch_xor.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_xor&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_xor&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_xor&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_xor&action=edit&section=4 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_xor&action=edit&section=5 "Edit section: See also")] See also
...
(public member function of `std::atomic<T>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/atomic/atomic/dsc_fetch_xor&action=edit)  
---|---  
...
[C documentation](../../c/atomic/atomic_fetch_xor.html "c/atomic/atomic fetch xor") for atomic_fetch_xor, atomic_fetch_xor_explicit
