...
If `std::atomic<T>` has no `fetch_sub` member (this member is only provided for [integral](atomic.html#Specializations_for_integral_types "cpp/atomic/atomic"), [floating-point](atomic.html#Specializations_for_floating-point_types "cpp/atomic/atomic")(since C++20) and [pointer](atomic.html#Partial_specializations "cpp/atomic/atomic") types except bool), the program is ill-formed. 

## Contents

  * [1 Parameters](atomic_fetch_sub.html#Parameters)
  * [2 Return value](atomic_fetch_sub.html#Return_value)
  * [3 Example](atomic_fetch_sub.html#Example)
  * [4 Defect reports](atomic_fetch_sub.html#Defect_reports)
  * [5 See also](atomic_fetch_sub.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_sub&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_sub&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_sub&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
    const int N = 50;
    [std::atomic](atomic.html)<int> cnt;
    [std::vector](../container/vector.html)<int> data(N);
     
    void reader(int id) 
    {
        for (;;)
        {
            int idx = atomic_fetch_sub_explicit(&cnt, 1, [std::memory_order_relaxed](memory_order.html));
            if (idx >= 0)
                [std::cout](../io/cout.html) << "reader " << [std::to_string](../string/basic_string/to_string.html)(id) << " processed item "
                          << [std::to_string](../string/basic_string/to_string.html)(data[idx]) << '\n';
            else
            {
                [std::cout](../io/cout.html) << "reader " << [std::to_string](../string/basic_string/to_string.html)(id) << " done\n";
                break;
            }
        }
    }
    ...
    int main()
    {
        [std::iota](../algorithm/iota.html)(data.begin(), data.end(), 1);
        cnt = data.size() - 1;
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_sub&action=edit&section=4 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_sub&action=edit&section=5 "Edit section: See also")] See also
...
(public member function of `std::atomic<T>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/atomic/atomic/dsc_fetch_sub&action=edit)  
---|---  
...
[C documentation](../../c/atomic/atomic_fetch_sub.html "c/atomic/atomic fetch sub") for atomic_fetch_sub, atomic_fetch_sub_explicit
