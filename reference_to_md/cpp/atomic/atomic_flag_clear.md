...
---|---|---  
void atomic_flag_clear( volatile [std::atomic_flag](atomic_flag.html)* obj ) noexcept; |  (1)  |  (since C++11)  
void atomic_flag_clear( [std::atomic_flag](atomic_flag.html)* obj ) noexcept; |  (2)  |  (since C++11)  
void atomic_flag_clear_explicit( volatile [std::atomic_flag](atomic_flag.html)* obj,   
[std::memory_order](memory_order.html) order ) noexcept; |  (3)  |  (since C++11)  
void atomic_flag_clear_explicit( [std::atomic_flag](atomic_flag.html)* obj,   
[std::memory_order](memory_order.html) order ) noexcept; |  (4)  |  (since C++11)  
| |   
  
Atomically changes the state of the [std::atomic_flag](atomic_flag.html "cpp/atomic/atomic flag") pointed to by obj to clear (false). 

1,2) The memory synchronization ordering is [std::memory_order_seq_cst](memory_order.html).
...
## Contents
  ...
  * [2 Notes](atomic_flag_clear.html#Notes)
  * [3 Defect reports](atomic_flag_clear.html#Defect_reports)
  * [4 See also](atomic_flag_clear.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_clear&action=edit&section=1 "Edit section: Parameters")] Parameters

obj  |  \-  |  pointer to [std::atomic_flag](atomic_flag.html "cpp/atomic/atomic flag") to access   
---|---|---  
order  |  \-  |  the memory synchronization ordering   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_clear&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_clear&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_clear&action=edit&section=4 "Edit section: See also")] See also
...
[C documentation](../../c/atomic/atomic_flag_clear.html "c/atomic/atomic flag clear") for atomic_flag_clear, atomic_flag_clear_explicit
