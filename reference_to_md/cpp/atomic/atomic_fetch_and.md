...
---|---|---  
template< class T >  
T atomic_fetch_and( [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg ) noexcept; |  (1)  |  (since C++11)  
template< class T >  
T atomic_fetch_and( volatile [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg ) noexcept; |  (2)  |  (since C++11)  
template< class T >  
T atomic_fetch_and_explicit( [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg,   
[std::memory_order](memory_order.html) order ) noexcept; |  (3)  |  (since C++11)  
template< class T >  
T atomic_fetch_and_explicit( volatile [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg,  
...
If `std::atomic<T>` has no `fetch_and` member (this member is only provided for [integral types](atomic.html#Specializations_for_integral_types "cpp/atomic/atomic") except bool), the program is ill-formed. 

## Contents

  * [1 Parameters](atomic_fetch_and.html#Parameters)
  * [2 Return value](atomic_fetch_and.html#Return_value)
  * [3 Example](atomic_fetch_and.html#Example)
  * [4 Defect reports](atomic_fetch_and.html#Defect_reports)
  * [5 See also](atomic_fetch_and.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_and&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_and&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_and&action=edit&section=3 "Edit section: Example")] Example

[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/atomic/atomic_fetch_cond_example&action=edit)
...
Run this code
    ...
    class Semaphore
    {
        [std::atomic_char](atomic.html) m_signaled;
    public:
        ...
        void take() 
        {
            ...
            {
                [std::this_thread::sleep_for](../thread/sleep_for.html)([std::chrono::milliseconds](../chrono/duration.html)(10));
            }
        }
     
        void put() 
        {
            [std::atomic_fetch_or](atomic_fetch_or.html)(&m_signaled, true);
        }
    };
     
    ...
     
        void count_up() 
        {
            ...
            [std::cout](../io/cout.html) << "count_up() done\n";
            m_done = true;
            m_print_sem.put();
        }
     
        void print_count() 
        {
            ...
            {
                m_print_sem.take();
                [std::cout](../io/cout.html) << m_count << '\n';
                m_count_sem.put();
            }
            while (!m_done);
            [std::cout](../io/cout.html) << "print_count() done\n";
        }
     
    public:
        ...
        void run() 
        {
            auto print_thread = [std::thread](../thread/thread.html)(&ThreadedCounter::print_count, this);
            auto count_thread = [std::thread](../thread/thread.html)(&ThreadedCounter::count_up, this);
            print_thread.join();
            count_thread.join();
        }
    };
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_and&action=edit&section=4 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_and&action=edit&section=5 "Edit section: See also")] See also
...
(public member function of `std::atomic<T>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/atomic/atomic/dsc_fetch_and&action=edit)  
---|---  
[ atomic_fetch_oratomic_fetch_or_explicit](atomic_fetch_or.html "cpp/atomic/atomic fetch or")(C++11)(C++11) |  replaces the atomic object with the result of bitwise OR with a non-atomic argument and obtains the previous value of the atomic   
...
[C documentation](../../c/atomic/atomic_fetch_and.html "c/atomic/atomic fetch and") for atomic_fetch_and, atomic_fetch_and_explicit
