...
## Contents
  ...
  * [3 Example](fetch_sub.html#Example)
  * [4 Defect reports](fetch_sub.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/fetch_sub&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  the other argument of arithmetic subtraction   
---|---|---  
order  |  \-  |  memory order constraints to enforce   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/fetch_sub&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/fetch_sub&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/fetch_sub&action=edit&section=4 "Edit section: Defect reports")] Defect reports
...
([P3323R1](https://wg21.link/P3323R1))  | C++20  | `fetch_sub` was meaningless for const T | constrained to accept only non-const `T`
