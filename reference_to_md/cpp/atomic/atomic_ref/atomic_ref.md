...
If obj is not aligned to [`required_alignment`](required_alignment.html "cpp/atomic/atomic ref/required alignment"), the behavior is undefined.
...
Run this code
    ...
    int main()
    {
        using Data = [std::vector](../../container/vector.html)<char>;
     
        auto inc_atomically = [](Data& data)
        {
            for (Data::value_type& x : data)
            {
                auto xx = [std::atomic_ref](../atomic_ref.html)<Data::value_type>(x);
    ...
     
        auto test_run = [](const auto Fun)
        {
            ...
            {
                [std::jthread](../../thread/jthread.html) j1{Fun, [std::ref](../../utility/functional/ref.html)(data)};
                [std::jthread](../../thread/jthread.html) j2{Fun, [std::ref](../../utility/functional/ref.html)(data)};
                [std::jthread](../../thread/jthread.html) j3{Fun, [std::ref](../../utility/functional/ref.html)(data)};
                [std::jthread](../../thread/jthread.html) j4{Fun, [std::ref](../../utility/functional/ref.html)(data)};
            }
            [std::cout](../../io/cout.html) << "sum = " << [std::accumulate](../../algorithm/accumulate.html)(cbegin(data), cend(data), 0) << '\n';
        };
     
