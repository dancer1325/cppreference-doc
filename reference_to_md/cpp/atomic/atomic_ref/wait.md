...
void wait( value_type old, [std::memory_order](../memory_order.html) order =  
...
[ notify_one](notify_one.html "cpp/atomic/atomic ref/notify one") |  notifies at least one thread waiting on the atomic object   
(public member function)   
---|---  
[ notify_all](notify_all.html "cpp/atomic/atomic ref/notify all") |  notifies all threads blocked waiting on the atomic object   
(public member function)   
