[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/atomic/atomic/notify_one&action=edit)
...
If there is a thread blocked in atomic waiting operation (i.e. [`wait()`](wait.html "cpp/atomic/atomic ref/wait")) on *`_[ptr](../atomic_ref.html#ptr "cpp/atomic/atomic ref")_` , then unblocks _at least_ one such thread; otherwise does nothing. This overload participates in overload resolution only if [std::is_const_v](../../types/is_const.html)<T> is false. 

## Contents

  * [1 Notes](notify_one.html#Notes)
  * [2 Example](notify_one.html#Example)
  * [3 Defect reports](notify_one.html#Defect_reports)
  * [4 See also](notify_one.html#See_also)
...
([P3323R1](https://wg21.link/P3323R1))  | C++20  | `notify_one` was meaningless for const T | constrained to accept only non-const `T`  
