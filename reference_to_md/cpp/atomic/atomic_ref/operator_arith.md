...
4) Performs atomic post-decrement. Equivalent to return fetch_sub(1);.
  ...
  * For pointer-to-object types, the result may be an undefined address, but the operations otherwise have no undefined behavior. The program is ill-formed if [std::remove_pointer_t](../../types/remove_pointer.html)<T> is not a complete object type. 
...
## Contents
  ...
  * [3 Defect reports](operator_arith.html#Defect_reports)
