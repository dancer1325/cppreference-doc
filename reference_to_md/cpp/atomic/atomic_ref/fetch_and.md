...
[std::memory_order_seq_cst](../memory_order.html) ) const noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](fetch_and.html#Parameters)
  * [2 Return value](fetch_and.html#Return_value)
  * [3 Example](fetch_and.html#Example)
  * [4 Defect reports](fetch_and.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/fetch_and&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  the other argument of bitwise AND   
---|---|---  
order  |  \-  |  memory order constraints to enforce   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/fetch_and&action=edit&section=2 "Edit section: Return value")] Return value

The value of the referenced object, immediately preceding the effects of this function. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/fetch_and&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/fetch_and&action=edit&section=4 "Edit section: Defect reports")] Defect reports
...
([P3323R1](https://wg21.link/P3323R1))  | C++20  | `fetch_and` was meaningless for const T | constrained to accept only non-const `T`
