...
Atomically replaces the current value of the referenced object with the result of [std::min](../../algorithm/min.html "cpp/algorithm/min") of the value and arg. That is, it performs atomic minimum operation. The operation is a read-modify-write operation. Memory is affected according to the value of order. 
