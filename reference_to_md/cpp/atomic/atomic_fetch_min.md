...
---|---|---  
template< class T >  
T atomic_fetch_min( [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg ) noexcept; |  (1)  |  (since C++26)  
template< class T >  
T atomic_fetch_min( volatile [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg ) noexcept; |  (2)  |  (since C++26)  
template< class T >  
T atomic_fetch_min_explicit( [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg,  
[std::memory_order](memory_order.html) order ) noexcept; |  (3)  |  (since C++26)  
template< class T >  
T atomic_fetch_min_explicit( volatile [std::atomic](atomic.html)<T>* obj,  
typename [std::atomic](atomic.html)<T>::value_type arg,  
[std::memory_order](memory_order.html) order ) noexcept; |  (4)  |  (since C++26)  
| |   
  
Atomically replaces the value pointed by obj with the result of [std::min](../algorithm/min.html "cpp/algorithm/min") between the old value of obj and arg. Returns the value obj held previously. The operation is performed as if the following was executed: 

1,2) obj->fetch_min(arg)

3,4) obj->fetch_min(arg, order)

If `std::atomic<T>` has no `fetch_min` member (this member is only provided for [integral](atomic.html#Specializations_for_integral_types "cpp/atomic/atomic") and [pointer](atomic.html#Partial_specializations "cpp/atomic/atomic") types except bool), the program is ill-formed. 

## Contents

  * [1 Parameters](atomic_fetch_min.html#Parameters)
  * [2 Return value](atomic_fetch_min.html#Return_value)
  * [3 Notes](atomic_fetch_min.html#Notes)
  * [4 Example](atomic_fetch_min.html#Example)
  * [5 See also](atomic_fetch_min.html#See_also)
