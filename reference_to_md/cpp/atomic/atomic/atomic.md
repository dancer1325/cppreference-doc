...
| (1) |   
---|---|---  
atomic() noexcept = default; |  | (since C++11)   
(until C++20)  
constexpr atomic() noexcept([std::is_nothrow_default_constructible_v](../../types/is_default_constructible.html)<T>); |  |  (since C++20)  
...
1) The default constructor is trivial: no initialization takes place other than [zero initialization](../../language/zero_initialization.html "cpp/language/zero initialization") of static and thread-local objects. [std::atomic_init](../atomic_init.html "cpp/atomic/atomic init") may be used to complete initialization.  | (until C++20)  
---|---  
1) Value-initializes the underlying object (i.e. with T()). The initialization is not atomic. This overload participates in overload resolution only if [std::is_default_constructible_v](../../types/is_default_constructible.html)<T> is true.  | (since C++20)  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/atomic&action=edit&section=1 "Edit section: Parameters")] Parameters

desired  |  \-  |  value to initialize with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/atomic&action=edit&section=2 "Edit section: Notes")] Notes

The default-initialized [std::atomic](../atomic.html)<T> does not contain a `T` object, and its only valid uses are destruction and initialization by [std::atomic_init](../atomic_init.html "cpp/atomic/atomic init"), see [LWG issue 2334](https://cplusplus.github.io/LWG/issue2334).  | (until C++20)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/atomic&action=edit&section=3 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 4169](https://cplusplus.github.io/LWG/issue4169) | C++20  | [std::is_default_constructible_v](../../types/is_default_constructible.html "cpp/types/is default constructible") could report false positive  | the default constructor is constrained 
