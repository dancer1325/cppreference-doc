...
If there is a thread blocked in atomic waiting operation (i.e. [`wait()`](wait.html "cpp/atomic/atomic/wait")) on *this, then unblocks _at least_ one such thread; otherwise does nothing. 
