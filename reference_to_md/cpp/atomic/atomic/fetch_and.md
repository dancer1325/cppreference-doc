...
---|---|---  
T fetch_and( T arg, [std::memory_order](../memory_order.html) order =  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_and&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  the other argument of bitwise AND   
---|---|---  
order  |  \-  |  memory order constraints to enforce   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_and&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_and&action=edit&section=3 "Edit section: See also")] See also
