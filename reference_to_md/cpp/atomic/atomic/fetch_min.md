...
---|---|---  
T fetch_min( T arg, [std::memory_order](../memory_order.html) order =  
...
Atomically replaces the current value with the result of [std::min](../../algorithm/min.html "cpp/algorithm/min") of the value and arg. That is, it performs atomic minimum operation. The operation is a read-modify-write operation. Memory is affected according to the value of order. 
...
## Contents
  ...
  * [1 Parameters](fetch_min.html#Parameters)
  * [2 Return value](fetch_min.html#Return_value)
  * [3 Notes](fetch_min.html#Notes)
  * [4 Example](fetch_min.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_min&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  the other argument of [std::min](../../algorithm/min.html "cpp/algorithm/min")  
---|---|---  
order  |  \-  |  memory order constraints to enforce   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_min&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_min&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_min&action=edit&section=4 "Edit section: Example")] Example
