...
---|---|---  
T fetch_sub( T arg, [std::memory_order](../memory_order.html) order =  
...
T* fetch_sub( [std::ptrdiff_t](../../types/ptrdiff_t.html) arg,  
...
1,2) For signed integral types, arithmetic is defined to use two’s complement representation. There are no undefined results.  For floating-point types, the [floating-point environment](../../numeric/fenv.html "cpp/numeric/fenv") in effect may be different from the calling thread's floating-point environment. The operation need not be conform to the corresponding [std::numeric_limits](../../types/numeric_limits.html "cpp/types/numeric limits") traits but is encouraged to do so. If the result is not a representable value for its type, the result is unspecified but the operation otherwise has no undefined behavior.  | (since C++20)  
---|---  
...
## Contents
  ...
  * [1 Parameters](fetch_sub.html#Parameters)
  * [2 Return value](fetch_sub.html#Return_value)
  * [3 Defect reports](fetch_sub.html#Defect_reports)
  * [4 See also](fetch_sub.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_sub&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  the other argument of arithmetic subtraction   
---|---|---  
order  |  \-  |  memory order constraints to enforce   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_sub&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_sub&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_sub&action=edit&section=4 "Edit section: See also")] See also
