...
---|---|---  
T fetch_max( T arg, [std::memory_order](../memory_order.html) order =  
[std::memory_order_seq_cst](../memory_order.html) ) noexcept; |  (1)  |  (since C++26)  
T fetch_max( T arg, [std::memory_order](../memory_order.html) order =  
[std::memory_order_seq_cst](../memory_order.html) ) volatile noexcept; |  (2)  |  (since C++26)  
member only of `atomic<T*>` partial specialization |  |   
T* fetch_max( T* arg, [std::memory_order](../memory_order.html) order =  
[std::memory_order_seq_cst](../memory_order.html) ) noexcept; |  (3)  |  (since C++26)  
T* fetch_max( T* arg, [std::memory_order](../memory_order.html) order =  
[std::memory_order_seq_cst](../memory_order.html) ) volatile noexcept; |  (4)  |  (since C++26)  
| |   
  
Atomically replaces the current value with the result of [std::max](../../algorithm/max.html "cpp/algorithm/max") of the value and arg. That is, it performs atomic maximum operation. The operation is a read-modify-write operation. Memory is affected according to the value of order. 

3,4) If the pointers point to different complete objects (or subobjects thereof), [pointer comparison](../../language/operator_comparison.html#Built-in_pointer_relational_comparison "cpp/language/operator comparison") does not establish a [strict weak ordering](https://en.wikipedia.org/wiki/strict_weak_ordering "enwiki:strict weak ordering").

It is deprecated if [std::atomic](../atomic.html)<T>::is_always_lock_free is false and overload (2) or (4) participates in overload resolution. 

## Contents

  * [1 Parameters](fetch_max.html#Parameters)
  * [2 Return value](fetch_max.html#Return_value)
  * [3 Notes](fetch_max.html#Notes)
  * [4 Example](fetch_max.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_max&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  the other argument of [std::max](../../algorithm/max.html "cpp/algorithm/max")  
---|---|---  
order  |  \-  |  memory order constraints to enforce   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_max&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_max&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/fetch_max&action=edit&section=4 "Edit section: Example")] Example
