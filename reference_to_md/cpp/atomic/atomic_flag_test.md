...
---|---|---  
bool atomic_flag_test( const volatile [std::atomic_flag](atomic_flag.html)* object ) noexcept; |  (1)  |  (since C++20)  
bool atomic_flag_test( const [std::atomic_flag](atomic_flag.html)* object ) noexcept; |  (2)  |  (since C++20)  
bool atomic_flag_test_explicit( const volatile [std::atomic_flag](atomic_flag.html)* object,  
[std::memory_order](memory_order.html) order ) noexcept; |  (3)  |  (since C++20)  
bool atomic_flag_test_explicit( const [std::atomic_flag](atomic_flag.html)* object,  
[std::memory_order](memory_order.html) order ) noexcept; |  (4)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](atomic_flag_test.html#Parameters)
  * [2 Return value](atomic_flag_test.html#Return_value)
  * [3 Notes](atomic_flag_test.html#Notes)
  * [4 Example](atomic_flag_test.html#Example)
  * [5 See also](atomic_flag_test.html#See_also)
