...
If `std::atomic<T>` has no `fetch_or` member (this member is only provided for [integral types](atomic.html#Specializations_for_integral_types "cpp/atomic/atomic") except bool), the program is ill-formed. 

## Contents

  * [1 Parameters](atomic_fetch_or.html#Parameters)
  * [2 Return value](atomic_fetch_or.html#Return_value)
  * [3 Example](atomic_fetch_or.html#Example)
  * [4 Defect reports](atomic_fetch_or.html#Defect_reports)
  * [5 See also](atomic_fetch_or.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_or&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_or&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_or&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    public:
        ...
        void take() 
        {
            while (![std::atomic_fetch_and](atomic_fetch_and.html)(&m_signaled, false))
            {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_or&action=edit&section=4 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_or&action=edit&section=5 "Edit section: See also")] See also
...
(public member function of `std::atomic<T>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/atomic/atomic/dsc_fetch_or&action=edit)  
---|---  
[ atomic_fetch_andatomic_fetch_and_explicit](atomic_fetch_and.html "cpp/atomic/atomic fetch and")(C++11)(C++11) |  replaces the atomic object with the result of bitwise AND with a non-atomic argument and obtains the previous value of the atomic   
...
[C documentation](../../c/atomic/atomic_fetch_or.html "c/atomic/atomic fetch or") for atomic_fetch_or, atomic_fetch_or_explicit
