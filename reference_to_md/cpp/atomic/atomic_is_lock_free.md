...
---|---|---  
template< class T >  
bool atomic_is_lock_free( const volatile [std::atomic](atomic.html)<T>* obj ) noexcept; |  (1)  |  (since C++11)  
template< class T >  
bool atomic_is_lock_free( const [std::atomic](atomic.html)<T>* obj ) noexcept; |  (2)  |  (since C++11)  
...
#define ATOMIC_POINTER_LOCK_FREE /* unspecified */ |  (3)  |  (since C++11)  
...
3,4) Expands to an integer constant expression with value 
  ...
  * 1 for the built-in atomic types that are _sometimes_ lock-free, 
...
## Contents
  ...
  * [3 Notes](atomic_is_lock_free.html#Notes)
  * [4 Example](atomic_is_lock_free.html#Example)
  * [5 Defect reports](atomic_is_lock_free.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        [std::atomic](atomic.html)<A> a;
        [std::atomic](atomic.html)<B> b;
...
---|---|---|---  
[LWG 3249](https://cplusplus.github.io/LWG/issue3249) | C++11  | `atomic_is_lock_free` was specified via pointers, which  
...
(function template)  
---|---  
[C documentation](../../c/atomic/atomic_is_lock_free.html "c/atomic/atomic is lock free") for atomic_is_lock_free  
[C documentation](../../c/atomic/ATOMIC_LOCK_FREE_consts.html "c/atomic/ATOMIC LOCK FREE consts") for ATOMIC_*_LOCK_FREE
