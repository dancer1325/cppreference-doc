...
## Contents
  ...
  * [4 Possible implementation](exchange.html#Possible_implementation)
  * [5 Notes](exchange.html#Notes)
  * [6 Example](exchange.html#Example)
  * [7 See also](exchange.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/exchange&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
        ...
        )
    {
        ...
        obj = [std::forward](forward.html)<U>(new_value);
        return old_value;
    }  
...
Run this code
    ...
     
    void f() { [std::cout](../io/cout.html) << "f()"; }
     
    int main()
    {
        stream s;
     
        [std::cout](../io/cout.html) << s.flags() << '\n';
        [std::cout](../io/cout.html) << s.flags(12) << '\n';
        [std::cout](../io/cout.html) << s.flags() << "\n\n";
     
    ...
     
        [std::copy](../algorithm/copy.html)(begin(v), end(v), [std::ostream_iterator](../iterator/ostream_iterator.html)<int>([std::cout](../io/cout.html), ", "));
     
