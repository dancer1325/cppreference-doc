...
`map` |  allows to format range as map representation with modified brackets "{", "}" and separator ": " for underlying [_pair-like_](../tuple/tuple-like.html "cpp/utility/tuple/tuple-like") types in the following format:  
