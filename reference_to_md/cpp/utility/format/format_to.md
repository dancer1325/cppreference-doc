...
template< class OutputIt, class... Args >  
OutputIt format_to( OutputIt out, const [std::locale](../../locale/locale.html)& loc,  
...
1) return [std::vformat_to](vformat_to.html)(std::move(out), fmt.str, [std::make_format_args](make_format_args.html)(args...));

2) return [std::vformat_to](vformat_to.html)(std::move(out), fmt.str, [std::make_wformat_args](make_format_args.html)(args...));

3) return [std::vformat_to](vformat_to.html)(std::move(out), loc, fmt.str, [std::make_format_args](make_format_args.html)(args...));

4) return [std::vformat_to](vformat_to.html)(std::move(out), loc, fmt.str, [std::make_wformat_args](make_format_args.html)(args...));.
...
If any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * `OutputIt` does not model [std::output_iterator](../../iterator/output_iterator.html)<const CharT&>. 
  * [std::formatter](formatter.html)<Ti, CharT> does not meet the [BasicFormatter](../../named_req/BasicFormatter.html "cpp/named req/BasicFormatter") requirements (as required by [std::make_format_args](make_format_args.html "cpp/utility/format/make format args") and [std::make_wformat_args](make_format_args.html "cpp/utility/format/make format args")) for some `Ti` in `Args`. 



## Contents

  * [1 Parameters](format_to.html#Parameters)
  * [2 Return value](format_to.html#Return_value)
  * [3 Exceptions](format_to.html#Exceptions)
  * [4 Notes](format_to.html#Notes)
  * [5 Example](format_to.html#Example)
  * [6 Defect reports](format_to.html#Defect_reports)
  * [7 See also](format_to.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::string](../../string/basic_string.html) buffer;
     
        std::format_to
        (
            [std::back_inserter](../../iterator/back_inserter.html)(buffer), // < OutputIt
            "Hello, C++{}!\n",          // < fmt
            "20"                        // < arg
        );
    ...
     
        ...
        [std::cout](../../io/cout.html) << buffer << [std::flush](../../io/manip/flush.html);
     
        [std::wstring](../../string/basic_string.html) wbuffer;
        std::format_to
        (
            [std::back_inserter](../../iterator/back_inserter.html)(wbuffer),// < OutputIt
            L"Hello, {2}::{1}!{0}",     // < fmt
            L"\n",                      // < arg {0}
            L"format_to()",             // < arg {1}
            L"std",                     // < arg {2}
        ...
        [std::wcout](../../io/cout.html) << wbuffer;
    }
...
---|---|---|---  
[LWG 3539](https://cplusplus.github.io/LWG/issue3539) | C++20  | out could not be a move-only iterator  | it can be   
[P2216R3](https://wg21.link/P2216R3) | C++20  | throws [std::format_error](format_error.html "cpp/utility/format/format error") for invalid format string  | results in compile-time error instead   
