...
class basic_format_arg<Context>::handle; |  |  (since C++20)  
| |   
  
A type-erased wrapper that allows formatting an object of a user-defined type. 

`handle` objects are typically created by [std::make_format_args](../make_format_args.html "cpp/utility/format/make format args") and accessed through [std::visit_format_arg](../visit_format_arg.html "cpp/utility/format/visit format arg") or the `visit` member functions of [std::basic_format_arg](../basic_format_arg.html "cpp/utility/format/basic format arg")(since C++26). 

## Contents

  * [1 Data members](handle.html#Data_members)
  * [2 Member functions](handle.html#Member_functions)
  * [3 std::basic_format_arg<Context>::handle::format](handle.html#std::basic_format_arg.3CContext.3E::handle::format)
    * [3.1 Notes](handle.html#Notes)
    * [3.2 See also](handle.html#See_also)
...
A typical implementation of `handle` is [TriviallyCopyable](../../../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable") and only stores two non-static data members: 
  ...
  * a void (*)([std::basic_format_parse_context](../basic_format_parse_context.html)<Context::char_type>&, Context&, const void*) function pointer to the function performing needed operations in the `format` member function (see below). 
...
void format( [std::basic_format_parse_context](../basic_format_parse_context.html)<Context::char_type>& parse_ctx,  
Context& format_ctx ) const; |  |  (since C++20)  
---|---|---  
| |   
...
Let 
  ...
  * `TD` be [std::remove_const_t](../../../types/remove_cv.html)<T>, 
  * `TQ` be const TD if const TD satisfies [`___formattable_with_`](../formattable.html "cpp/utility/format/formattable") <Context> or `TD` otherwise, and 
