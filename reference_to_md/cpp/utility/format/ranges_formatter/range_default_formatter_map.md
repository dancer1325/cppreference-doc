...
_range-default-formatter_ specializations  
---  
[_range-default-formatter_ <std::range_format::sequence>](range_default_formatter_sequence.html "cpp/utility/format/ranges formatter/range default formatter sequence")  
**_range-default-formatter_ <std::range_format::map>**  
[_range-default-formatter_ <std::range_format::set>](range_default_formatter_set.html "cpp/utility/format/ranges formatter/range default formatter set")  
[_range-default-formatter_ <std::range_format::string>  
_range-default-formatter_ <std::range_format::debug_string>](range_default_formatter_string.html "cpp/utility/format/ranges formatter/range default formatter string")  
...
---|---|---  
template< [ranges::input_range](../../../ranges/input_range.html) R, class CharT >  
struct /*range-default-formatter*/<range_format::map, R, CharT>; |  |  (since C++23)   
(exposition only*)  
| |   
  
The class template /*range-default-formatter*/ for range types is specialized for formatting range as a map of keys to values if [std::format_kind](../format_kind.html)<R> is std::range_format::map. 

## Contents

  * [1 Member types](range_default_formatter_map.html#Member_types)
  * [2 Data members](range_default_formatter_map.html#Data_members)
  * [3 Member functions](range_default_formatter_map.html#Member_functions)
  * [4 std::_range-default-formatter_ <std::range_format::map>::_range-default-formatter_](range_default_formatter_map.html#std::range-default-formatter.3Cstd::range_format::map.3E::range-default-formatter)
  * [5 std::_range-default-formatter_ <std::range_format::map>::parse](range_default_formatter_map.html#std::range-default-formatter.3Cstd::range_format::map.3E::parse)
  * [6 std::_range-default-formatter_ <std::range_format::map>::format](range_default_formatter_map.html#std::range-default-formatter.3Cstd::range_format::map.3E::format)
    * [6.1 See also](range_default_formatter_map.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/format/ranges_formatter/range_default_formatter_map&action=edit&section=1 "Edit section: Member types")] Member types

Member  |  Definition   
---|---  
`_maybe-const-map_` (private) |  `_[fmt-maybe-const](../../format.html#fmt-maybe-const "cpp/utility/format")_` <R, CharT>  
(exposition-only member type*)  
`_element-type_` (private) |  [std::remove_cvref_t](../../../types/remove_cvref.html)<[ranges::range_reference_t](../../../ranges/range_reference_t.html)<`_maybe-const-map_` >>  
(exposition-only member type*)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/format/ranges_formatter/range_default_formatter_map&action=edit&section=2 "Edit section: Data members")] Data members

Member  |  Definition   
---|---  
`_underlying__` (private) |  the underlying formatter of type [std::range_formatter](../range_formatter.html)<`_element-type_` , CharT>  
(exposition-only member object*)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/format/ranges_formatter/range_default_formatter_map&action=edit&section=3 "Edit section: Member functions")] Member functions

(constructor) |  constructs a `_range-default-formatter_`   
(public member function)  
---|---  
parse |  parses the format specifier as specified by _[range-format-spec](../range_formatter.html#Range_format_specification "cpp/utility/format/range formatter")_   
(public member function)  
format |  writes the range formatted output as specified by _[range-format-spec](../range_formatter.html#Range_format_specification "cpp/utility/format/range formatter")_   
(public member function)  
...
The program is ill-formed unless: 
  ...
  * `_element-type_` is a specialization of [std::pair](../../pair.html "cpp/utility/pair"), or 
  * `_element-type_` is a specialization of [std::tuple](../../tuple.html "cpp/utility/tuple") and `std::tuple_size_v<_element-type_ >` is 2. 
...
Equivalent to: return` `` _[underlying_](range_default_formatter_map.html#underlying)_`.format(ctx);. 

Returns an iterator past the end of the _[range-format-spec](../range_formatter.html#Range_format_specification "cpp/utility/format/range formatter")_. 
...
Equivalent to: return` `` _[underlying_](range_default_formatter_map.html#underlying)_`.format(r, ctx);. 

Returns an iterator past the end of the output range. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/format/ranges_formatter/range_default_formatter_map&action=edit&section=4 "Edit section: See also")] See also
