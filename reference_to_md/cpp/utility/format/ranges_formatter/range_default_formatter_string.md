...
The class template /*range-default-formatter*/ for range types is specialized for formatting range as a string or an escaped string if [std::format_kind](../format_kind.html)<R> is either std::range_format::string or std::range_format::debug_string. 

## Contents

  * [1 Data members](range_default_formatter_string.html#Data_members)
  * [2 Member functions](range_default_formatter_string.html#Member_functions)
  * [3 std::_range-default-formatter_ <std::range_format::string>::parsestd::_range-default-formatter_ <std::range_format::debug_string>::parse](range_default_formatter_string.html#std::range-default-formatter.3Cstd::range_format::string.3E::parsestd::range-default-formatter.3Cstd::range_format::debug_string.3E::parse)
  * [4 std::_range-default-formatter_ <std::range_format::string>::formatstd::_range-default-formatter_ <std::range_format::debug_string>::format](range_default_formatter_string.html#std::range-default-formatter.3Cstd::range_format::string.3E::formatstd::range-default-formatter.3Cstd::range_format::debug_string.3E::format)
    * [4.1 See also](range_default_formatter_string.html#See_also)
...
---|---  
parse |  parses the format specifier as specified by _[std-format-spec](../spec.html "cpp/utility/format/spec")_   
(public member function)  
format |  writes the formatted output as specified by _[std-format-spec](../spec.html "cpp/utility/format/spec")_   
(public member function)  
...
Returns an iterator past the end of the _[std-format-spec](../spec.html "cpp/utility/format/spec")_. 
...
If [ranges::input_range](../../../ranges/input_range.html)<const R> is true, the type of r is const R&. Otherwise, the type is R&. 

Let s be a [std::basic_string](../../../string/basic_string.html)<CharT> as if by constructing s with [std::basic_string](../../../string/basic_string.html)<CharT>([std::from_range](../../../ranges/from_range.html), r) such that [ranges::equal](../../../algorithm/ranges/equal.html)(s, r) is true. 
