...
[_range-default-formatter_ <std::range_format::map>](range_default_formatter_map.html "cpp/utility/format/ranges formatter/range default formatter map")  
**_range-default-formatter_ <std::range_format::set>**  
...
The class template /*range-default-formatter*/ for range types is specialized for formatting range as a set of keys if [std::format_kind](../format_kind.html)<R> is std::range_format::set. 

## Contents

  * [1 Member types](range_default_formatter_set.html#Member_types)
  * [2 Data members](range_default_formatter_set.html#Data_members)
  * [3 Member functions](range_default_formatter_set.html#Member_functions)
  * [4 std::_range-default-formatter_ <std::range_format::set>::_range-default-formatter_](range_default_formatter_set.html#std::range-default-formatter.3Cstd::range_format::set.3E::range-default-formatter)
  * [5 std::_range-default-formatter_ <std::range_format::set>::parse](range_default_formatter_set.html#std::range-default-formatter.3Cstd::range_format::set.3E::parse)
  * [6 std::_range-default-formatter_ <std::range_format::set>::format](range_default_formatter_set.html#std::range-default-formatter.3Cstd::range_format::set.3E::format)
    * [6.1 See also](range_default_formatter_set.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/format/ranges_formatter/range_default_formatter_set&action=edit&section=1 "Edit section: Member types")] Member types

Member  |  Definition   
---|---  
`_maybe-const-set_` (private) |  `_[fmt-maybe-const](../../format.html#fmt-maybe-const "cpp/utility/format")_` <R, CharT>  
(exposition-only member type*)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/format/ranges_formatter/range_default_formatter_set&action=edit&section=2 "Edit section: Data members")] Data members

Member  |  Definition   
---|---  
`_underlying__` (private) |  the underlying formatter of type: [std::range_formatter](../range_formatter.html)<[std::remove_cvref_t](../../../types/remove_cvref.html)<  
` `[ranges::range_reference_t](../../../ranges/range_reference_t.html)<`_maybe-const-set_` >>, CharT>  
(exposition-only member object*)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/format/ranges_formatter/range_default_formatter_set&action=edit&section=3 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/format/ranges_formatter/range_default_formatter_set&action=edit&section=4 "Edit section: See also")] See also
