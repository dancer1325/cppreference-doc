...
---|---|---  
[std::string](../../string/basic_string.html) vformat( [std::string_view](../../string/basic_string_view.html) fmt, [std::format_args](basic_format_args.html) args ); |  (1)  |  (since C++20)  
[std::wstring](../../string/basic_string.html) vformat( [std::wstring_view](../../string/basic_string_view.html) fmt, [std::wformat_args](basic_format_args.html) args ); |  (2)  |  (since C++20)  
[std::string](../../string/basic_string.html) vformat( const [std::locale](../../locale/locale.html)& loc,  
[std::string_view](../../string/basic_string_view.html) fmt, [std::format_args](basic_format_args.html) args ); |  (3)  |  (since C++20)  
[std::wstring](../../string/basic_string.html) vformat( const [std::locale](../../locale/locale.html)& loc,  
...
## Contents
  ...
  * [1 Parameters](vformat.html#Parameters)
  * [2 Return value](vformat.html#Return_value)
  * [3 Exceptions](vformat.html#Exceptions)
  * [4 Example](vformat.html#Example)
  * [5 See also](vformat.html#See_also)
...
Run this code
    ...
    inline void println(const [std::format_string](basic_format_string.html)<Args...> fmt, Args&&... args)
    {
        [std::cout](../../io/cout.html) << std::vformat(fmt.get(), [std::make_format_args](make_format_args.html)(args...)) << '\n';
    }
     
    int main()
    {
