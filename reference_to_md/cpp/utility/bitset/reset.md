...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/reset&action=edit&section=1 "Edit section: Parameters")] Parameters

pos  |  \-  |  the position of the bit to set   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/reset&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/reset&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/reset&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/reset&action=edit&section=5 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/reset&action=edit&section=6 "Edit section: See also")] See also
