...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/count&action=edit&section=1 "Edit section: Return value")] Return value

Number of bits that are set to true. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/count&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/count&action=edit&section=3 "Edit section: See also")] See also
