...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/set&action=edit&section=1 "Edit section: Parameters")] Parameters

pos  |  \-  |  the position (counting from ​0​, i.e. from least significant to most significant) of the bit to set   
---|---|---  
value  |  \-  |  the value to set the bit to   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/set&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/set&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/set&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/set&action=edit&section=5 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/set&action=edit&section=6 "Edit section: See also")] See also
