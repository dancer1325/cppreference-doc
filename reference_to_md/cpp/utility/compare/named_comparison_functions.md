...
|  | **is_eq is_ltis_lteq**(C++20)(C++20)(C++20)` `  
---  
  
| **is_neq is_gtis_gteq**(C++20)(C++20)(C++20)  
---  
...
---|---|---  
constexpr bool is_eq( [std::partial_ordering](partial_ordering.html) cmp ) noexcept; |  (1)  |  (since C++20)  
constexpr bool is_neq( [std::partial_ordering](partial_ordering.html) cmp ) noexcept; |  (2)  |  (since C++20)  
constexpr bool is_lt( [std::partial_ordering](partial_ordering.html) cmp ) noexcept; |  (3)  |  (since C++20)  
constexpr bool is_lteq( [std::partial_ordering](partial_ordering.html) cmp ) noexcept; |  (4)  |  (since C++20)  
constexpr bool is_gt( [std::partial_ordering](partial_ordering.html) cmp ) noexcept; |  (5)  |  (since C++20)  
constexpr bool is_gteq( [std::partial_ordering](partial_ordering.html) cmp ) noexcept; |  (6)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](named_comparison_functions.html#Parameters)
  * [2 Return value](named_comparison_functions.html#Return_value)
  * [3 Example](named_comparison_functions.html#Example)
  * [4 See also](named_comparison_functions.html#See_also)
