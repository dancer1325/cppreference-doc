...
Let `t` and `u` denote lvalue of const [std::remove_reference_t](../../types/remove_reference.html)<T> and const [std::remove_reference_t](../../types/remove_reference.html)<U> respectively, if the expression t <=> u is well-formed, provides the member typedef `type` equal to decltype(t <=> u), otherwise there is no member `type`. 

If the program adds specializations for `std::compare_three_way_result`, the behavior is undefined. 

## Contents

  * [1 Member types](compare_three_way_result.html#Member_types)
  * [2 Helper types](compare_three_way_result.html#Helper_types)
  * [3 Possible implementation](compare_three_way_result.html#Possible_implementation)
  * [4 Example](compare_three_way_result.html#Example)
  * [5 See also](compare_three_way_result.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/compare/compare_three_way_result&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    ...
    using compare_three_way_result_t = decltype(
        [std::declval](../declval.html)<const [std::remove_reference_t](../../types/remove_reference.html)<T>&>() <=>
        [std::declval](../declval.html)<const [std::remove_reference_t](../../types/remove_reference.html)<U>&>()
    );
     
    template<class T, class U = T>
...
Run this code
    ...
    void print_cmp_type()
    {
        if constexpr ([std::is_same_v](../../types/is_same.html)<Ord, [std::strong_ordering](strong_ordering.html)>)
            [std::cout](../../io/cout.html) << "strong ordering\n";
        else if constexpr ([std::is_same_v](../../types/is_same.html)<Ord, [std::weak_ordering](weak_ordering.html)>)
            [std::cout](../../io/cout.html) << "weak ordering\n";
        else if constexpr ([std::is_same_v](../../types/is_same.html)<Ord, [std::partial_ordering](partial_ordering.html)>)
            [std::cout](../../io/cout.html) << "partial ordering\n";
        else
            [std::cout](../../io/cout.html) << "illegal comparison result type\n";
    }
     
    int main()
    {
