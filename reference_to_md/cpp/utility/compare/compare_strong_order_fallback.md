...
requires /* see below */  
constexpr [std::strong_ordering](strong_ordering.html)  
compare_strong_order_fallback( T&& t, U&& u ) noexcept(/* see below */); |  |  (since C++20)  
| |   
  
Performs three-way comparison on [subexpressions](../../language/expressions.html#Full-expressions "cpp/language/expressions") t and u and produces a result of type [`std::strong_ordering`](strong_ordering.html "cpp/utility/compare/strong ordering"), even if the operator `<=>` is unavailable. 

If [std::decay_t](../../types/decay.html)<T> and [std::decay_t](../../types/decay.html)<U> are the same type, std::compare_strong_order_fallback(t, u) is [expression-equivalent](../../language/expressions.html#Expression-equivalence "cpp/language/expressions") to: 

  * [std::strong_order](strong_order.html)(t, u), if it is a well-formed expression; 
...
std::strong_ordering::greater
     ...
     if the expressions t == u and t < u are both well-formed and each of decltype(t == u) and decltype(t < u) models [`_boolean-testable_`](../../concepts/boolean-testable.html "cpp/concepts/boolean-testable"), except that t and u are evaluated only once. 

In all other cases, std::compare_strong_order_fallback(t, u) is ill-formed, which can result in [substitution failure](../../language/sfinae.html "cpp/language/sfinae") when it appears in the immediate context of a template instantiation. 

## Contents

  * [1 Customization point objects](compare_strong_order_fallback.html#Customization_point_objects)
  * [2 Example](compare_strong_order_fallback.html#Example)
  * [3 Defect reports](compare_strong_order_fallback.html#Defect_reports)
  * [4 See also](compare_strong_order_fallback.html#See_also)
