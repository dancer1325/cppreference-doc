...
The class type `std::partial_ordering` is the result type of a [three-way comparison](../../language/operator_comparison.html#Three-way_comparison "cpp/language/operator comparison") that: 
  ...
  * [Admits incomparable values](https://en.wikipedia.org/wiki/Connected_relation "enwiki:Connected relation"): a < b, a == b, and a > b may all be false. 



## Contents

  * [1 Constants](partial_ordering.html#Constants)
  * [2 Conversions](partial_ordering.html#Conversions)
  * [3 Comparisons](partial_ordering.html#Comparisons)
  * [4 operator==](partial_ordering.html#operator.3D.3D)
    * [4.1 Parameters](partial_ordering.html#Parameters)
    * [4.2 Return value](partial_ordering.html#Return_value)
  * [5 operator<](partial_ordering.html#operator.3C)
    * [5.1 Parameters](partial_ordering.html#Parameters_2)
    * [5.2 Return value](partial_ordering.html#Return_value_2)
  * [6 operator<=](partial_ordering.html#operator.3C.3D)
    * [6.1 Parameters](partial_ordering.html#Parameters_3)
    * [6.2 Return value](partial_ordering.html#Return_value_3)
  * [7 operator>](partial_ordering.html#operator.3E)
    * [7.1 Parameters](partial_ordering.html#Parameters_4)
    * [7.2 Return value](partial_ordering.html#Return_value_4)
  * [8 operator>=](partial_ordering.html#operator.3E.3D)
    * [8.1 Parameters](partial_ordering.html#Parameters_5)
    * [8.2 Return value](partial_ordering.html#Return_value_5)
  * [9 operator<=>](partial_ordering.html#operator.3C.3D.3E)
    * [9.1 Parameters](partial_ordering.html#Parameters_6)
    * [9.2 Return value](partial_ordering.html#Return_value_6)
    * [9.3 Notes](partial_ordering.html#Notes)
    * [9.4 Example](partial_ordering.html#Example)
    * [9.5 See also](partial_ordering.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/compare/partial_ordering&action=edit&section=1 "Edit section: Constants")] Constants

The type `std::partial_ordering` has four valid values, implemented as const static data members of its type: 

Name  |  Definition   
---|---  
inline constexpr std::partial_ordering less[static] |  a valid value indicating less-than (ordered before) relationship   
(public static member constant)  
inline constexpr std::partial_ordering equivalent[static] |  a valid value indicating equivalence (neither ordered before nor ordered after)   
(public static member constant)  
inline constexpr std::partial_ordering greater[static] |  a valid value indicating greater-than (ordered after) relationship   
(public static member constant)  
inline constexpr std::partial_ordering unordered[static] |  a valid value indicating relationship with an incomparable value   
(public static member constant)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/compare/partial_ordering&action=edit&section=2 "Edit section: Conversions")] Conversions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/compare/partial_ordering&action=edit&section=3 "Edit section: Comparisons")] Comparisons
...
** operator==operator<operator>operator<=operator>=operator<=>** |  compares with zero or a `partial_ordering`   
(function)  
---|---  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/compare/partial_ordering&action=edit&section=16 "Edit section: Notes")] Notes

The [built-in `operator<=>`](../../language/operator_comparison.html#Three-way_comparison "cpp/language/operator comparison") between floating-point values uses this ordering: the positive zero and the negative zero compare `equivalent`, but can be distinguished, and NaN values compare `unordered` with any other value. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/compare/partial_ordering&action=edit&section=17 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/compare/partial_ordering&action=edit&section=18 "Edit section: See also")] See also
