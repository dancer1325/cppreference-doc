...
---|---|---  
template<>  
struct formatter<[std::stacktrace_entry](../stacktrace_entry.html)>; |  |  (since C++23)  
| |   
...
fill-and-align and width have the same meaning as in [standard format specification](../format/formatter.html#Standard_format_specification "cpp/utility/format/formatter"). 
