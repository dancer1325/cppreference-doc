...
[std::uint_least32_t](../../types/integer.html) source_line() const; |  |  (since C++23)  
---|---|---  
| |   
...
Either [`source_file`](source_file.html "cpp/utility/stacktrace entry/source file") returns the presumed source file name and `source_line` returns the presumed line number, or [`source_file`](source_file.html "cpp/utility/stacktrace entry/source file") returns the actual source file name and `source_line` returns the actual line number. 

## Contents

  * [1 Parameters](source_line.html#Parameters)
  * [2 Return value](source_line.html#Return_value)
  * [3 Exceptions](source_line.html#Exceptions)
  * [4 Notes](source_line.html#Notes)
  * [5 Example](source_line.html#Example)
  * [6 See also](source_line.html#See_also)
...
Throws [std::bad_alloc](../../memory/new/bad_alloc.html "cpp/memory/new/bad alloc") if memory for the internal data structures cannot be allocated. 

### Notes

The presumed line number is what the predefined macro [`__LINE__`](../../preprocessor/replace.html "cpp/preprocessor/replace") expands to, and can be changed by the [` #line`](../../preprocessor/line.html "cpp/preprocessor/line") directive. 
