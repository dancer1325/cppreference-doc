...
---|---|---  
template<> struct hash<[std::stacktrace_entry](../stacktrace_entry.html)>; |  |  (since C++23)  
| |   
  
The template specialization of [std::hash](../hash.html "cpp/utility/hash") for std::stacktrace_entry allows users to obtain hashes of values of type std::stacktrace_entry. 
