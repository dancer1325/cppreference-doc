...
---|---|---  
friend constexpr [std::strong_ordering](../compare/strong_ordering.html)  
operator<=>( const stacktrace_entry& lhs, const stacktrace_entry& rhs ) noexcept; |  (2)  |  (since C++23)  
| |   
