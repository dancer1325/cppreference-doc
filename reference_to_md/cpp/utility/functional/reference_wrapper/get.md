...
**reference_wrapper::get reference_wrapper::operator T&**  
[reference_wrapper::operator()](operator\(\).html "cpp/utility/functional/reference wrapper/operator\(\)")  
...
---|---|---  
T& get() const noexcept; |  (2)  |  (since C++11)   
(constexpr since C++20)  
| |   
...
Run this code
    ...
    #include <string_view>
     
    using Map = [std::map](../../../container/map.html)<[std::string_view](../../../string/basic_string_view.html), int>;
    using Opt = [std::optional](../../optional.html)<[std::reference_wrapper](../reference_wrapper.html)<Map::value_type>>;
     
    Opt find(Map& m, [std::string_view](../../../string/basic_string_view.html) s)
    {
        auto it = m.find(s);
