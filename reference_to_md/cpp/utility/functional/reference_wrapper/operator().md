...
operator() ( ArgTypes&&... args ) const; |  | (since C++11)   
(until C++17)  
---|---|---  
template< class... ArgTypes >  
[std::invoke_result_t](../../../types/result_of.html)<T&, ArgTypes...>  
operator() ( ArgTypes&&... args ) const noexcept(/* see below */); |  |  (since C++17)   
(constexpr since C++20)  
| |   
  
Calls the [Callable](../../../named_req/Callable.html "cpp/named req/Callable") object, reference to which is stored, as if by [`_INVOKE_`](../../../functional.html "cpp/utility/functional")([`get()`](get.html "cpp/utility/functional/reference wrapper/get"), [std::forward](../../forward.html)<ArgTypes>(args)...). This function is available only if the stored reference points to a [Callable](../../../named_req/Callable.html "cpp/named req/Callable") object. 
...
Run this code
    ...
    void f1()
    {
        [std::cout](../../../io/cout.html) << "reference to function called\n";
    }
     
    void f2(int n)
    {
        [std::cout](../../../io/cout.html) << "bind expression called with " << n << " as the argument\n";
    }
     
    int main()
    {
        [std::reference_wrapper](../reference_wrapper.html)<void()> ref1 = [std::ref](../ref.html)(f1);
        ref1();
     
        auto b = [std::bind](../bind.html)(f2, std::placeholders::_1);
        auto ref2 = [std::ref](../ref.html)(b);
        ref2(7);
     
        auto c = []{ [std::cout](../../../io/cout.html) << "lambda function called\n"; };
        auto ref3 = [std::ref](../ref.html)(c);
        ref3();
    }
