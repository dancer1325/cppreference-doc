...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/minus_void&action=edit&section=1 "Edit section: Member types")] Member types

Type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/minus_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/minus_void&action=edit&section=5 "Edit section: Example")] Example
