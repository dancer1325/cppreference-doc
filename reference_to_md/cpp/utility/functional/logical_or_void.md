...
[std::logical_or](logical_or.html)<void> is a specialization of [std::logical_or](logical_or.html "cpp/utility/functional/logical or") with parameter and return type deduced. 

## Contents

  * [1 Nested types](logical_or_void.html#Nested_types)
  * [2 Member functions](logical_or_void.html#Member_functions)
  * [3 std::logical_or<void>::operator()](logical_or_void.html#std::logical_or.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](logical_or_void.html#Parameters)
    * [3.2 Return value](logical_or_void.html#Return_value)
    * [3.3 Example](logical_or_void.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/logical_or_void&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/logical_or_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/logical_or_void&action=edit&section=5 "Edit section: Example")] Example
