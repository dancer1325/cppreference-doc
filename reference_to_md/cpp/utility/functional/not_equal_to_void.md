...
[std::not_equal_to](not_equal_to.html)<void> is a specialization of [std::not_equal_to](not_equal_to.html "cpp/utility/functional/not equal to") with parameter and return type deduced. 

## Contents

  * [1 Nested types](not_equal_to_void.html#Nested_types)
  * [2 Member functions](not_equal_to_void.html#Member_functions)
  * [3 std::not_equal_to<void>::operator()](not_equal_to_void.html#std::not_equal_to.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](not_equal_to_void.html#Parameters)
    * [3.2 Return value](not_equal_to_void.html#Return_value)
    * [3.3 Example](not_equal_to_void.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/not_equal_to_void&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/not_equal_to_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/not_equal_to_void&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::not_equal_to](not_equal_to.html)<> not_equal{};
