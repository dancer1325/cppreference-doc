...
Invokes the stored `_[thunk-ptr](../function_ref.html#thunk-ptr "cpp/utility/functional/function ref")_` with `_[bound-entity](../function_ref.html#bound-entity "cpp/utility/functional/function ref")_` as its first parameter and the rest of the parameters `args`. The /*noex*/ part of operator() is identical to those of the template parameter of `std::function_ref`. 

Equivalent to return `_[thunk-ptr](../function_ref.html#thunk-ptr "cpp/utility/functional/function ref")_`(`_[bound-entity](../function_ref.html#bound-entity "cpp/utility/functional/function ref")_` , [std::forward](../../forward.html)<Args>(args)...);. 
