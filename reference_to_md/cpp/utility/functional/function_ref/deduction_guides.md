...
---|---|---  
template< class F >  
function_ref( F* ) -> function_ref<F>; |  (1)  |  (since C++26)  
template< auto f >  
function_ref( [std::nontype_t](../../nontype.html)<f> ) -> function_ref</*see below*/>; |  (2)  |  (since C++26)  
template< auto f, class T >  
function_ref( [std::nontype_t](../../nontype.html)<f>, T&& ) -> function_ref</*see below*/>; |  (3)  |  (since C++26)  
| |   
  
1) This overload participates in overload resolution only if [std::is_function_v](../../../types/is_function.html)<F> is true.

2) Let type F be [std::remove_pointer_t](../../../types/remove_pointer.html)<decltype(f)>. This overload participates in overload resolution only if [std::is_function_v](../../../types/is_function.html)<F> is true. The deduced type is [std::function_ref](../function_ref.html)<F>.
...
3) Let type F be decltype(f). This overload participates in overload resolution only if : 
  ...
  * F is of the form M G::* for a type G and an object type M, in which case let R be [std::invoke_result_t](../../../types/result_of.html)<F, T&>, A... be an empty pack, and E be false, or 
  * F is of the form R(*)(G, A...) noexcept(E) for a type G.
    ...
    The deduced type is [std::function_ref](../function_ref.html)<R(A...) noexcept(E)>. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/function_ref/deduction_guides&action=edit&section=1 "Edit section: Example")] Example
