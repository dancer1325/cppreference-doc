...
---|---|---  
template< class F >  
function_ref( F&& f ) noexcept; |  (2) | (since C++26)  
template< auto f >  
function_ref( [std::nontype_t](../../nontype.html)<f> ) noexcept; |  (3)  |  (since C++26)  
template< auto f, class U >  
function_ref( [std::nontype_t](../../nontype.html)<f>, U&& obj ) noexcept; |  (4) | (since C++26)  
template< auto f, class T >  
function_ref( [std::nontype_t](../../nontype.html)<f>, /*cv*/ T* obj ) noexcept; |  (5) | (since C++26)  
function_ref( const function_ref& other ) = default; |  (6)  |  (since C++26)  
| |   
  
Creates a new `std::function_ref`. 

1) Initializes `_[bound-entity](../function_ref.html#bound-entity "cpp/utility/functional/function ref")_` with f, and `_[thunk-ptr](../function_ref.html#thunk-ptr "cpp/utility/functional/function ref")_` with the address of a function `_thunk_`. The behavior is undefined if f is a null pointer. 

  * This overload participates in overload resolution only if both [std::is_function_v](../../../types/is_function.html)<F> and /*is-invocable-using*/<F> are true.



2) Initializes `_bound-entity_` with [std::addressof](../../../memory/addressof.html)(f), and `_thunk-ptr_` with the address of a function `_thunk_`. 

  * Let T be [std::remove_reference_t](../../../types/remove_reference.html)<F>. This overload participates in overload resolution only if : 
    * [std::remove_cvref_t](../../../types/remove_cvref.html)<F> is not the same type as `function_ref`, 
    * [std::is_member_pointer_v](../../../types/is_member_pointer.html)<T> is false, and 
    * /*is-invocable-using*/</*cv*/ T&> is true.



3) Initializes `_bound-entity_` with a pointer to an unspecified object or null pointer value, and `_thunk-ptr_` with the address of a function `_thunk_`. 

  * Let F be decltype(f). This overload participates in overload resolution only if /*is-invocable-using*/<F> is true. 
  * The program is ill-formed if f != nullptr is false when [std::is_pointer_v](../../../types/is_pointer.html)<F> || [std::is_member_pointer_v](../../../types/is_member_pointer.html)<F> is true.



4) Initializes `_bound-entity_` with [std::addressof](../../../memory/addressof.html)(obj), and `_thunk-ptr_` with the address of a function `_thunk_`. 

  * Let T be [std::remove_reference_t](../../../types/remove_reference.html)<U> and F be decltype(f). This overload participates in overload resolution only if : 
    * [std::is_rvalue_reference_v](../../../types/is_rvalue_reference.html)<U&&> is false, and 
    * /*is-invocable-using*/<F, /*cv*/ T&> is true. 
  * The program is ill-formed if f != nullptr is false when [std::is_pointer_v](../../../types/is_pointer.html)<F> || [std::is_member_pointer_v](../../../types/is_member_pointer.html)<F> is true.



5) Initializes `_bound-entity_` with obj, and `_thunk-ptr_` with the address of a function `_thunk_`. The behavior is undefined if obj is a null pointer when [std::is_member_pointer_v](../../../types/is_member_pointer.html)<F> is true. 
...
6) Defaulted copy constructor copies the `_bound-entity_` and `_thunk-ptr_` of other.

The address of a function `_thunk_` is used to initialize `_thunk-ptr_` such that a call to `_thunk_`(`_bound-entity_` ,`_call-args_`...) is [expression-equivalent](../../../language/expressions.html#Expression-equivalence "cpp/language/expressions") to: 

Overloads  | Expression-equivalence   
---|---  
([1,3](function_ref.html#Version_1)) | [std::invoke_r](../invoke.html)<R>(f,`_call-args_`...)  
([2](function_ref.html#Version_2)) | [std::invoke_r](../invoke.html)<R>(static_cast<cv T&>(f),`_call-args_`...)  
([4](function_ref.html#Version_4)) | [std::invoke_r](../invoke.html)<R>(f, static_cast<cv T&>(obj),`_call-args_`...)  
([5](function_ref.html#Version_5)) | [std::invoke_r](../invoke.html)<R>(f, obj,`_call-args_`...)  
  
/*is-invocable-using*/<T...> is true if and only if: 

  * [std::is_nothrow_invocable_r_v](../../../types/is_invocable.html)<R, T..., Args...> is true if noex is true, or 
  * [std::is_invocable_r_v](../../../types/is_invocable.html)<R, T..., Args...> is true
