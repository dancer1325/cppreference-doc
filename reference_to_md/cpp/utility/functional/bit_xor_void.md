...
[std::bit_xor](bit_xor.html)<void> is a specialization of std::bit_xor with parameter and return type deduced. 

## Contents

  * [1 Nested types](bit_xor_void.html#Nested_types)
  * [2 Member functions](bit_xor_void.html#Member_functions)
  * [3 std::bit_xor<void>::operator()](bit_xor_void.html#std::bit_xor.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](bit_xor_void.html#Parameters)
    * [3.2 Return value](bit_xor_void.html#Return_value)
    * [3.3 Example](bit_xor_void.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/bit_xor_void&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/bit_xor_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/bit_xor_void&action=edit&section=5 "Edit section: Example")] Example
