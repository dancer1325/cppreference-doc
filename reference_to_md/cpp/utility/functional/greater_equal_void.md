...
[std::greater_equal](greater_equal.html)<void> is a specialization of [std::greater_equal](greater_equal.html "cpp/utility/functional/greater equal") with parameter and return type deduced. 

## Contents

  * [1 Nested types](greater_equal_void.html#Nested_types)
  * [2 Member functions](greater_equal_void.html#Member_functions)
  * [3 std::greater_equal<void>::operator()](greater_equal_void.html#std::greater_equal.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](greater_equal_void.html#Parameters)
    * [3.2 Return value](greater_equal_void.html#Return_value)
    * [3.3 Exceptions](greater_equal_void.html#Exceptions)
    * [3.4 Example](greater_equal_void.html#Example)
    * [3.5 Defect reports](greater_equal_void.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/greater_equal_void&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/greater_equal_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/greater_equal_void&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        return [std::greater_equal](greater_equal.html)<>()(lhs, 0);
    }
     
    int main()
    {
        constexpr int low = 0, high = 8;
        [std::greater_equal](greater_equal.html)<> greater_equal{};
        static_assert(greater_equal(high, low));
        static_assert(greater_equal(low, low));
     
        static constexpr auto arr = {-1, 0, 1, 2, 3, 4};
        static_assert(![std::all_of](../../algorithm/none_of.html)(arr.begin(), arr.end(), strictly_not_negative));
        static_assert([std::all_of](../../algorithm/none_of.html)(arr.begin() + 1, arr.end(), strictly_not_negative));
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/greater_equal_void&action=edit&section=6 "Edit section: Defect reports")] Defect reports
