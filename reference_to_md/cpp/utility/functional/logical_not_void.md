...
---|---|---  
template<>  
class logical_not<void>; |  |  (since C++14)  
| |   
  
[std::logical_not](logical_not.html)<void> is a specialization of [std::logical_not](logical_not.html "cpp/utility/functional/logical not") with parameter and return type deduced. 

## Contents

  * [1 Nested types](logical_not_void.html#Nested_types)
  * [2 Member functions](logical_not_void.html#Member_functions)
  * [3 std::logical_not<void>::operator()](logical_not_void.html#std::logical_not.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](logical_not_void.html#Parameters)
    * [3.2 Return value](logical_not_void.html#Return_value)
    * [3.3 Example](logical_not_void.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/logical_not_void&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/logical_not_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
Returns the result of ![std::forward](../forward.html)<T>(arg). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/logical_not_void&action=edit&section=5 "Edit section: Example")] Example
