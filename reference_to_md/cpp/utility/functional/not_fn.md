...
---|---|---  
template< class F >  
/* unspecified */ not_fn( F&& f ); |  (1) | (since C++17)   
(constexpr since C++20)  
template< auto ConstFn >  
constexpr /* unspecified */ not_fn() noexcept; |  (2) | (since C++26)  
| |   
...
## Contents
  ...
  * [3 std::not_fn _return type_](not_fn.html#std::not_fn_return_type)
    * [3.1 Member objects](not_fn.html#Member_objects)
    * [3.2 Constructors](not_fn.html#Constructors)
    * [3.3 Member function operator()](not_fn.html#Member_function_operator.28.29)
  * [4 std::not_fn _stateless return type_](not_fn.html#std::not_fn_stateless_return_type)
    * [4.1 Member function operator()](not_fn.html#Member_function_operator.28.29_2)
    * [4.2 Exceptions](not_fn.html#Exceptions)
    * [4.3 Possible implementation](not_fn.html#Possible_implementation)
    * [4.4 Notes](not_fn.html#Notes)
    * [4.5 Example](not_fn.html#Example)
    * [4.6 See also](not_fn.html#See_also)
...
##  std::not_fn _return type_

####  Member objects

The return type of `std::not_fn` holds a member object of type [std::decay_t](../../types/decay.html)<F>. 

####  Constructors

explicit T( F&& f ); |  (1)  |  (since C++17)   
(constexpr since C++20)  
(exposition only*)  
---|---|---  
T( T&& f ) = default;  
T( const T& f ) = default; |  (2)  |  (since C++17)  
| |   
  
1) The constructor direct-non-list-initializes the member object (of type [std::decay_t](../../types/decay.html)<F>) from [std::forward](../forward.html)<F>(f). Throws any exception thrown by the constructor selected.

2) Because [std::decay_t](../../types/decay.html)<F> is required to be [MoveConstructible](../../named_req/MoveConstructible.html "cpp/named req/MoveConstructible"), the returned call wrapper is always [MoveConstructible](../../named_req/MoveConstructible.html "cpp/named req/MoveConstructible"), and is [CopyConstructible](../../named_req/CopyConstructible.html "cpp/named req/CopyConstructible") if [std::decay_t](../../types/decay.html)<F> is [CopyConstructible](../../named_req/CopyConstructible.html "cpp/named req/CopyConstructible").  The explicitly defaulted definitions make the return type not assignable.  | (until C++20)  
---|---  
...
-> decltype(![std::declval](../declval.html)<  
[std::invoke_result_t](../../types/result_of.html)<[std::decay_t](../../types/decay.html)<F>&, Args...>>());  
template< class... Args >  
auto operator()( Args&&... args ) const&  
-> decltype(![std::declval](../declval.html)<  
[std::invoke_result_t](../../types/result_of.html)<[std::decay_t](../../types/decay.html)<F> const&, Args...>>()); |  | (since C++17)   
(until C++20)  
template< class... Args >  
constexpr auto operator()( Args&&... args ) &  
noexcept(/* see below */)  
-> decltype(![std::invoke](invoke.html)(  
[std::declval](../declval.html)<[std::decay_t](../../types/decay.html)<F>&>(), [std::declval](../declval.html)<Args>()...));  
template< class... Args >  
constexpr auto operator()( Args&&... args ) const&  
noexcept(/* see below */)  
-> decltype(![std::invoke](invoke.html)(  
[std::declval](../declval.html)<[std::decay_t](../../types/decay.html)<F> const&>(), [std::declval](../declval.html)<Args>()...)); |  |  (since C++20)  
| (2) |   
template< class... Args >  
auto operator()( Args&&... args ) &&  
-> decltype(![std::declval](../declval.html)<  
...
Let fd be the member object of type [std::decay_t](../../types/decay.html)<F>. 

1) Equivalent to return ![std::invoke](invoke.html)(fd, [std::forward](../forward.html)<Args>(args)...); 2) Equivalent to return ![std::invoke](invoke.html)(std::move(fd), [std::forward](../forward.html)<Args>(args)...); While invoking the result, if the substitution into the return type of the originally selected operator() overload fails, [another overload may be selected](../../language/sfinae.html "cpp/language/sfinae").  | (since C++17)  
(until C++20)  
---|---  
1) [Expression-equivalent](../../language/expressions.html#Expression-equivalence "cpp/language/expressions") to ![std::invoke](invoke.html)(fd, [std::forward](../forward.html)<Args>(args)...) 2) [Expression-equivalent](../../language/expressions.html#Expression-equivalence "cpp/language/expressions") to ![std::invoke](invoke.html)(std::move(fd), [std::forward](../forward.html)<Args>(args)...) While invoking the result, if the substitution into the return type of the originally selected operator() overload fails, the invocation is ill-formed, which can also be a [substitution failure](../../language/sfinae.html "cpp/language/sfinae").  | (since C++20)  
  
2) A value of the following type. 

##  std::not_fn _stateless return type_

The return type is a [CopyConstructible](../../named_req/CopyConstructible.html "cpp/named req/CopyConstructible") stateless class. It is unspecified whether the return type is assignable. 
...
constexpr auto operator()( Args&&... args ) const  
noexcept(/* see below */)  
-> decltype(![std::invoke](invoke.html)(ConstFn, [std::declval](../declval.html)<Args>()...)); |  |  (since C++26)  
---|---|---  
| |   
...
---  
    ...
    namespace detail
    {
        ...
        constexpr bool negate_invocable_impl<[std::void_t](../../types/void_t.html)<decltype(
            ![std::invoke](invoke.html)([std::declval](../declval.html)<F>(), [std::declval](../declval.html)<Args>()...))>, F, Args...> = true;
     
        template<class F, class... Args>
    ...
     
            template<class... Args,
                [std::enable_if_t](../../types/enable_if.html)<negate_invocable_v<F&, Args...>, int> = 0>
            constexpr decltype(auto) operator()(Args&&... args) &
                noexcept(noexcept(![std::invoke](invoke.html)(f, [std::forward](../forward.html)<Args>(args)...)))
            {
                return ![std::invoke](invoke.html)(f, [std::forward](../forward.html)<Args>(args)...);
            }
     
            template<class... Args,
                [std::enable_if_t](../../types/enable_if.html)<negate_invocable_v<const F&, Args...>, int> = 0>
    ...
     
            template<class... Args,
                [std::enable_if_t](../../types/enable_if.html)<negate_invocable_v<F, Args...>, int> = 0>
            constexpr decltype(auto) operator()(Args&&... args) &&
                noexcept(noexcept(![std::invoke](invoke.html)(std::move(f), [std::forward](../forward.html)<Args>(args)...)))
            {
                return ![std::invoke](invoke.html)(std::move(f), [std::forward](../forward.html)<Args>(args)...);
            }
     
            template<class... Args,
                [std::enable_if_t](../../types/enable_if.html)<negate_invocable_v<const F, Args...>, int> = 0>
    ...
     
    template<class F>
    constexpr detail::not_fn_t<[std::decay_t](../../types/decay.html)<F>> not_fn(F&& f)
    {
        return {[std::forward](../forward.html)<F>(f)};
    }  
  
[(2) not_fn](not_fn.html#Version_2)  
    ...
    namespace detail
    {
        ...
        struct stateless_not_fn
        {
            template<class... Args>
            constexpr auto operator()(Args&&... args) const
                noexcept(noexcept(![std::invoke](invoke.html)(ConstFn, [std::forward](../forward.html)<Args>(args)...)))
                -> decltype(![std::invoke](invoke.html)(ConstFn, [std::forward](../forward.html)<Args>(args)...))
            {
                return ![std::invoke](invoke.html)(ConstFn, [std::forward](../forward.html)<Args>(args)...);
            }
        };
    }
     
    ...
    {
        if constexpr ([std::is_pointer_v](../../types/is_pointer.html)<decltype(ConstFn)> ||
                      [std::is_member_pointer_v](../../types/is_member_pointer.html)<decltype(ConstFn)>)
...
Run this code
    ...
    int main()
    {
        ...
        [assert](../../error/assert.html)(is_differ(8, 8) == false); // equivalent to: !is_same(8, 8) == false
        [assert](../../error/assert.html)(is_differ(6, 9) == true); // equivalent to: !is_same(8, 0) == true
     
        // Using with a member function:
        auto member_differ = std::not_fn(&S::is_same);
        [assert](../../error/assert.html)(member_differ(S{3}, 3) == false); //: S tmp{6}; !tmp.is_same(6) == false
     
    ...
     
        ...
        [assert](../../error/assert.html)(differ(1, 2) == true); //: !same(1, 2) == true
        [assert](../../error/assert.html)(differ(2, 2) == false); //: !same(2, 2) == false
     
    #if __cpp_lib_not_fn >= 202306L
        auto is_differ_cpp26 = std::not_fn<is_same>();
        [assert](../../error/assert.html)(is_differ_cpp26(8, 8) == false);
        [assert](../../error/assert.html)(is_differ_cpp26(6, 9) == true);
     
        auto member_differ_cpp26 = std::not_fn<&S::is_same>();
        [assert](../../error/assert.html)(member_differ_cpp26(S{3}, 3) == false);
     
