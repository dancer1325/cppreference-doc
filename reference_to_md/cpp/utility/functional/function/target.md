...
---|---|---  
template< class T >   
const T* target() const noexcept; |  (2)  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Parameters](target.html#Parameters)
  * [2 Return value](target.html#Return_value)
  * [3 Example](target.html#Example)
  * [4 Defect reports](target.html#Defect_reports)
  * [5 See also](target.html#See_also)
...
Run this code
    ...
    void test([std::function](../function.html)<int(int, int)> const& arg)
    {
        [std::cout](../../../io/cout.html) << "test function: ";
        if (arg.target<[std::plus](../plus.html)<int>>())
            [std::cout](../../../io/cout.html) << "it is plus\n";
        if (arg.target<[std::minus](../minus.html)<int>>())
            [std::cout](../../../io/cout.html) << "it is minus\n";
     
        int (*const* ptr)(int, int) = arg.target<int(*)(int, int)>();
        if (ptr && *ptr == f)
            [std::cout](../../../io/cout.html) << "it is the function f\n";
        if (ptr && *ptr == g)
            [std::cout](../../../io/cout.html) << "it is the function g\n";
    }
     
    int main()
    {
        test([std::function](../function.html)<int(int, int)>([std::plus](../plus.html)<int>()));
        test([std::function](../function.html)<int(int, int)>([std::minus](../minus.html)<int>()));
        test([std::function](../function.html)<int(int, int)>(f));
        test([std::function](../function.html)<int(int, int)>(g));
    }
