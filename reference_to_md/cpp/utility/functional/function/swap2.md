...
void swap( [std::function](../function.html)<R(Args...)>& lhs, [std::function](../function.html)<R(Args...)>& rhs ) noexcept; |  |  (since C++11)  
| |   
  
Overloads the [std::swap](../../swap.html "cpp/algorithm/swap") algorithm for [std::function](../function.html "cpp/utility/functional/function"). Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 
...
## Contents
  ...
  * [4 Defect reports](swap2.html#Defect_reports)
  * [5 See also](swap2.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/function/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  polymorphic function wrappers whose states to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/function/swap2&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/function/swap2&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    {
        [std::cout](../../../io/cout.html) << "foo(\"" << str << "\", " << x << ")\n";
    }
     
    void bar(const char* str, int x)
    {
        [std::cout](../../../io/cout.html) << "bar(\"" << str << "\", " << x << ")\n";
    }
     
    int main()
    {
        [std::function](../function.html)<void(const char*, int)> f1{foo};
        [std::function](../function.html)<void(const char*, int)> f2{bar};
     
        f1("f1", 1);
        f2("f2", 2);
     
        [std::cout](../../../io/cout.html) << "std::swap(f1, f2);\n";
        [std::swap](../../../algorithm/swap.html)(f1, f2);
     
        f1("f1", 1);
        f2("f2", 2);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/function/swap2&action=edit&section=4 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2062](https://cplusplus.github.io/LWG/issue2062) | C++11  | overload of `swap` for `function` was not required to be noexcept  | required   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/function/swap2&action=edit&section=5 "Edit section: See also")] See also

[ swap](swap.html "cpp/utility/functional/function/swap") |  swaps the contents   
