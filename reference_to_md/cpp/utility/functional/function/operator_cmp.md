...
bool operator==( const [std::function](../function.html)<R(ArgTypes...)>& f,  
[std::nullptr_t](../../../types/nullptr_t.html) ) noexcept; |  (1)  |  (since C++11)  
template< class R, class... ArgTypes >  
bool operator==( [std::nullptr_t](../../../types/nullptr_t.html),  
const [std::function](../function.html)<R(ArgTypes...)>& f ) noexcept; |  (2)  |  (since C++11)   
(until C++20)  
template< class R, class... ArgTypes >  
bool operator!=( const [std::function](../function.html)<R(ArgTypes...)>& f,  
[std::nullptr_t](../../../types/nullptr_t.html) ) noexcept; |  (3)  |  (since C++11)   
(until C++20)  
template< class R, class... ArgTypes >  
bool operator!=( [std::nullptr_t](../../../types/nullptr_t.html),  
const [std::function](../function.html)<R(ArgTypes...)>& f ) noexcept; |  (4)  |  (since C++11)   
(until C++20)  
| |   
...
Run this code
    ...
    #include <iostream>
     
    using SomeVoidFunc = [std::function](../function.html)<void(int)>;
     
    class C
    {
    public:
        C(SomeVoidFunc void_func = nullptr) : void_func_(void_func)
        {
            if (void_func_ == nullptr) // specialized compare with nullptr
                void_func_ = [std::bind](../bind.html)(&C::default_func, this, std::placeholders::_1);
            void_func_(7);
        }
     
        void default_func(int i) { [std::cout](../../../io/cout.html) << i << '\n'; };
     
    private:
