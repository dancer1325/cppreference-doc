...
Effectively does [`_INVOKE <R>_`](../../../functional.html "cpp/utility/functional")(f, [std::forward](../../forward.html)<Args>(args)...), where f is the [target object](../function.html "cpp/utility/functional/function") of *this. 
...
Run this code
    ...
    #include <iostream>
     
    void call([std::function](../function.html)<int()> f) // can be passed by value
    { 
    ...
    {
        int n = 1;
        [std::function](../function.html)<int()> f;
        try
        {
            call(f);
        }
    ...
     
        ...
        call(f);
     
        [std::function](../function.html)<void([std::string](../../../string/basic_string.html), int)> g;
        g = []([std::string](../../../string/basic_string.html) str, int i) { [std::cout](../../../io/cout.html) << str << ' ' << i << '\n'; };
        g("Hi", 052);
    }
