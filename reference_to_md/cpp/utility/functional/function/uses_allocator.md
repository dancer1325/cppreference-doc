...
struct uses_allocator<[std::function](../function.html)<R(ArgTypes...)>, Alloc> : [std::true_type](../../../types/integral_constant.html) { }; |  |  (since C++11)   
(until C++17)  
| |   
  
This specialization of [std::uses_allocator](../../../memory/uses_allocator.html "cpp/memory/uses allocator") informs other library components that all objects of type [std::function](../function.html "cpp/utility/functional/function") support _uses-allocator construction_ , even though they do not have a nested `allocator_type`. 

## Contents

  * [1 Notes](uses_allocator.html#Notes)
  * [2 Inherited from std::integral_constant](uses_allocator.html#Inherited_from_std::integral_constant)
    ...
    * [2.4 See also](uses_allocator.html#See_also)
