...
function& operator=( [std::nullptr_t](../../../types/nullptr_t.html) ) noexcept; |  (3) | (since C++11)  
template< class F >  
function& operator=( F&& f ); |  (4) | (since C++11)  
template< class F >  
function& operator=( [std::reference_wrapper](../reference_wrapper.html)<F> f ) noexcept; |  (5)  |  (since C++11)  
| |   
  
Assigns a new _target_ to `std::function`. 

1) Assigns a copy of _target_ of other, as if by executing function(other).swap(*this);

2) Moves the _target_ of other to *this. other is in a valid state with an unspecified value.

3) Drops the current _target_. *this is _empty_ after the call.

4) Sets the _target_ of *this to the callable f, as if by executing function([std::forward](../../forward.html)<F>(f)).swap(*this);. This operator does not participate in overload resolution unless f is [Callable](../../../named_req/Callable.html "cpp/named req/Callable") for argument types `Args...` and return type `R`.

5) Sets the _target_ of *this to a copy of f, as if by executing function(f).swap(*this);
...
---|---|---  
f  |  \-  |  a callable to initialize the _target_ with   
Type requirements   
...
Run this code
    ...
    int main()
    {
        [std::function](../function.html)<int(int)> f1;
        [std::function](../function.html)<int(int)> f2(inc);
        [assert](../../../error/assert.html)(f1 == nullptr and f2 != nullptr);
     
        f1 = f2; // overload (1)
    ...
     
        ...
        [assert](../../../error/assert.html)(f1 == nullptr);
     
        f1 = inc; // overload (4)
        [assert](../../../error/assert.html)(f1 != nullptr and f1(1) == 2);
     
        f1 = [](int n) { return n + n; }; // overload (4)
        [assert](../../../error/assert.html)(f1 != nullptr and f1(2) == 4);
     
        [std::reference_wrapper](../reference_wrapper.html)<int(int)> ref1 = [std::ref](../ref.html)(inc);
        f1 = ref1; // overload (5)
        [assert](../../../error/assert.html)(f1 != nullptr and f1(1) == 2);
    }
