...
---  
**function::function**  
[function::~function](~function.html "cpp/utility/functional/function/~function")  
[function::operator=](operator=.html "cpp/utility/functional/function/operator=")  
[function::swap](swap.html "cpp/utility/functional/function/swap")  
[function::assign](assign.html "cpp/utility/functional/function/assign")(until C++17)  
[function::operator bool](operator_bool.html "cpp/utility/functional/function/operator bool")  
[function::operator()](operator\(\).html "cpp/utility/functional/function/operator\(\)")  
[function::target_type](target_type.html "cpp/utility/functional/function/target type")  
[function::target](target.html "cpp/utility/functional/function/target")  
[Non-member functions](../function.html#Non-member_functions "cpp/utility/functional/function")  
[operator==operator!=](operator_cmp.html "cpp/utility/functional/function/operator cmp")(until C++20)  
[swap(std::function)](swap2.html "cpp/utility/functional/function/swap2")  
...
---|---|---  
function( [std::nullptr_t](../../../types/nullptr_t.html) ) noexcept; |  (2)  |  (since C++11)  
...
function( [std::allocator_arg_t](../../../memory/allocator_arg_t.html), const Alloc& alloc ) noexcept; |  (6) | (since C++11)   
(removed in C++17)  
template< class Alloc >   
function( [std::allocator_arg_t](../../../memory/allocator_arg_t.html), const Alloc& alloc,   
[std::nullptr_t](../../../types/nullptr_t.html) ) noexcept; |  (7)  |  (since C++11)   
(removed in C++17)  
template< class Alloc >   
function( [std::allocator_arg_t](../../../memory/allocator_arg_t.html), const Alloc& alloc,   
const function& other ); |  (8)  |  (since C++11)   
(removed in C++17)  
template< class Alloc >   
function( [std::allocator_arg_t](../../../memory/allocator_arg_t.html), const Alloc& alloc,   
function&& other ); |  (9)  |  (since C++11)   
(removed in C++17)  
template< class F, class Alloc >   
function( [std::allocator_arg_t](../../../memory/allocator_arg_t.html), const Alloc& alloc, F f ); |  (10)  |  (since C++11)   
(removed in C++17)  
| |   
  
Constructs a `std::function` from a variety of sources. 

1,2) Creates an [empty](../function.html "cpp/utility/functional/function") `std::function`.

3) Copies the [target](../function.html "cpp/utility/functional/function") of other to the target of *this.
...
5) Initializes the target with [std::forward](../../forward.html)<F>(f). The target is of type [std::decay](../../../types/decay.html)<F>::type.
...
This overload participates in overload resolution only if all following conditions are satisfied: 
  ...
  * [std::is_same_v](../../../types/is_same.html)<[std::remove_cvref_t](../../../types/remove_cvref.html)<F>, [std::function](../function.html)<R(Args...)> is false. 

| (since C++23)  
---|---  
  
  * An lvalue of type [std::decay](../../../types/decay.html)<F>::type is callable for argument types `Args...` and return type `R`. 

If [std::is_copy_constructible_v](../../../types/is_copy_constructible.html)<[std::decay_t](../../../types/decay.html)<F>> or [std::is_constructible_v](../../../types/is_constructible.html)<[std::decay_t](../../../types/decay.html)<F>, F> is false, the program is ill-formed.  | (since C++23)  
---|---  
  
If `F` is not [CopyConstructible](../../../named_req/CopyConstructible.html "cpp/named req/CopyConstructible"), the behavior is undefined.
...
When the target is a function pointer or a [std::reference_wrapper](../reference_wrapper.html "cpp/utility/functional/reference wrapper"), small object optimization is guaranteed, that is, these targets are always directly stored inside the [std::function](../function.html "cpp/utility/functional/function") object, no dynamic allocation takes place. Other large objects may be constructed in dynamic allocated storage and accessed by the [std::function](../function.html "cpp/utility/functional/function") object through a pointer. 

## Contents

  * [1 Parameters](function.html#Parameters)
  * [2 Exceptions](function.html#Exceptions)
  * [3 Notes](function.html#Notes)
  * [4 Example](function.html#Example)
  * [5 Defect reports](function.html#Defect_reports)
  * [6 See also](function.html#See_also)
...
alloc  |  \-  |  an [Allocator](../../../named_req/Allocator.html "cpp/named req/Allocator") used for internal memory allocation   
Type requirements   
...
4) Does not throw if other's target is a function pointer or a [std::reference_wrapper](../reference_wrapper.html "cpp/utility/functional/reference wrapper"), otherwise may throw [std::bad_alloc](../../../memory/new/bad_alloc.html "cpp/memory/new/bad alloc") or any exception thrown by the constructor used to copy or move the stored callable object. | (until C++20)  
---|---  
...
Run this code
    ...
    #include <utility>
     
    void print_num(int i) { [std::cout](../../../io/cout.html) << "print_num(" << i << ")\n"; }
     
    int main()
    {
        [std::function](../function.html)<void(int)> func1; // (1) empty constructor
        try
        {
            func1(333 << 1);
        }
        catch (const [std::bad_function_call](../bad_function_call.html)& ex)
        {
            [std::cout](../../../io/cout.html) << "1) " << ex.what() << '\n';
        }
     
        [std::function](../function.html)<void(int)> func2{nullptr}; // (2) empty constructor
        try
        {
            func1(222 * 3);
        }
    ...
     
        [std::function](../function.html)<void(int)> func3{func1}; // (3) copy constructor
        func3(33);
     
        [std::function](../function.html)<void(int)> func4{std::move(func3)}; // (4) move constructor,
                                                          // func3 in unspecified state
        func4(44);
     
        [std::function](../function.html)<void(int)> func5{print_num}; // (5) constructor with function
        func5(55);
     
        // (5) constructor with lambda
        [std::function](../function.html)<void(int)> func6([](int i) { [std::cout](../../../io/cout.html) << "lambda(" << i << ")\n"; });
        func6(66);
    }
