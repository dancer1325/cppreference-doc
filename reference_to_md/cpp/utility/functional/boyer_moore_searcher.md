...
class boyer_moore_searcher; |  |  (since C++17)  
| |   
  
A searcher suitable for use with the [Searcher](https://en.cppreference.com/mwiki/index.php?title=cpp/named_req/Searcher&action=edit&redlink=1 "cpp/named req/Searcher \(page does not exist\)") overload of [std::search](../../algorithm/search.html "cpp/algorithm/search") that implements the [Boyer-Moore string searching algorithm](https://en.wikipedia.org/wiki/Boyer%E2%80%93Moore_string_search_algorithm "enwiki:Boyer–Moore string search algorithm"). 

`std::boyer_moore_searcher` is [CopyConstructible](../../named_req/CopyConstructible.html "cpp/named req/CopyConstructible") and [CopyAssignable](../../named_req/CopyAssignable.html "cpp/named req/CopyAssignable"). 
...
## Contents
  ...
  * [2 std::boyer_moore_searcher::boyer_moore_searcher](boyer_moore_searcher.html#std::boyer_moore_searcher::boyer_moore_searcher)
    * [2.1 Parameters](boyer_moore_searcher.html#Parameters)
    * [2.2 Exceptions](boyer_moore_searcher.html#Exceptions)
  * [3 std::boyer_moore_searcher::operator()](boyer_moore_searcher.html#std::boyer_moore_searcher::operator.28.29)
    * [3.1 Parameters](boyer_moore_searcher.html#Parameters_2)
    * [3.2 Return value](boyer_moore_searcher.html#Return_value)
    * [3.3 Notes](boyer_moore_searcher.html#Notes)
    * [3.4 Example](boyer_moore_searcher.html#Example)
    * [3.5 See also](boyer_moore_searcher.html#See_also)
...
[std::pair](../pair.html)<RandomIt2, RandomIt2> operator()( RandomIt2 first, RandomIt2 last ) const; |  |  (since C++17)  
---|---|---  
| |   
...
Run this code
    ...
    int main()
    {
        constexpr [std::string_view](../../string/basic_string_view.html) haystack =
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed "
            "do eiusmod tempor incididunt ut labore et dolore magna aliqua";
     
        const [std::string_view](../../string/basic_string_view.html) needle{"pisci"};
     
        if (const auto it = [std::search](../../algorithm/search.html)(haystack.begin(), haystack.end(),
