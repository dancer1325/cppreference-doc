...
## Contents
  ...
  * [1 Nested types](equal_to.html#Nested_types)
  * [2 Member functions](equal_to.html#Member_functions)
  * [3 std::ranges::equal_to::operator()](equal_to.html#std::ranges::equal_to::operator.28.29)
    * [3.1 Notes](equal_to.html#Notes)
    * [3.2 Example](equal_to.html#Example)
    * [3.3 Defect reports](equal_to.html#Defect_reports)
...
Given the expression [std::forward](../../forward.html)<T>(t) == [std::forward](../../forward.html)<U>(u) as expr: 
  ...
  * For the two converted pointers (of type `P`), if one pointer precedes the other in the [implementation-defined strict total order over pointers](../../../language/operator_comparison.html#Pointer_total_order "cpp/language/operator comparison"), returns false, otherwise returns true. 
  ...
  * If [std::equality_comparable_with](../../../concepts/equality_comparable.html)<T, U> is not modeled, the behavior is undefined. 
