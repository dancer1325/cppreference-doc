...
---  
[ranges::equal_to](equal_to.html "cpp/utility/functional/ranges/equal to")(C++20)  
[ranges::not_equal_to](not_equal_to.html "cpp/utility/functional/ranges/not equal to")(C++20)  
[ranges::greater](greater.html "cpp/utility/functional/ranges/greater")(C++20)  
**ranges::less**(C++20)  
[ranges::greater_equal](greater_equal.html "cpp/utility/functional/ranges/greater equal")(C++20)  
[ranges::less_equal](less_equal.html "cpp/utility/functional/ranges/less equal")(C++20)  
[compare_three_way](../../compare/compare_three_way.html "cpp/utility/compare/compare three way")(C++20)  
...
## Contents
  ...
  * [1 Nested types](less.html#Nested_types)
  * [2 Member functions](less.html#Member_functions)
  * [3 std::ranges::less::operator()](less.html#std::ranges::less::operator.28.29)
    * [3.1 Notes](less.html#Notes)
    * [3.2 Example](less.html#Example)
    * [3.3 Defect reports](less.html#Defect_reports)
    * [3.4 See also](less.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/less&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/less&action=edit&section=2 "Edit section: Member functions")] Member functions

operator() |  checks if the first argument is _less_ than the second   
...
Given the expression [std::forward](../../forward.html)<T>(t) < [std::forward](../../forward.html)<U>(u) as expr: 
  ...
  * If expr results in a call to [built-in](../../../language/operator_comparison.html#Built-in_pointer_relational_comparison "cpp/language/operator comparison") operator< comparing pointers, given the [composite pointer type](../../../language/pointer.html#Composite_pointer_type "cpp/language/pointer") of t and u as `P`: 



    

  * If the converted t precedes the converted u (both are of type `P`) in the [implementation-defined strict total order over pointers](../../../language/operator_comparison.html#Pointer_total_order "cpp/language/operator comparison"), returns true, otherwise returns false. 
  ...
  * If [std::totally_ordered_with](../../../concepts/totally_ordered.html)<T, U> is not modeled, the behavior is undefined. 
...
If there exists an expression expr1 of type `T` and an expression expr2 of `U`, such that the comparison results of expr1 and expr2 violate [strict total ordering](https://en.wikipedia.org/wiki/Total_order#Strict_and_non-strict_total_orders "enwiki:Total order") (rules are defined below), the behavior is undefined. 
...
The comparison results of expr1 and expr2 follow strict total ordering only if **exactly one** of the following expressions is true: 
  ...
  * std::[ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less){}(expr1, expr2)
  * std::[ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less){}(expr2, expr1)
  * std::[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to){}(expr1, expr2)



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/less&action=edit&section=3 "Edit section: Notes")] Notes

Unlike [std::less](../less.html "cpp/utility/functional/less"), `std::ranges::less` requires all six comparison operators `<`, `<=`, `>`, `>=`, `==` and `!=` to be valid (via the [`totally_ordered_with`](../../../concepts/totally_ordered.html "cpp/concepts/totally ordered") constraint). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/less&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/less&action=edit&section=5 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/less&action=edit&section=6 "Edit section: See also")] See also
