...
## Contents
  ...
  * [1 Nested types](not_equal_to.html#Nested_types)
  * [2 Member functions](not_equal_to.html#Member_functions)
  * [3 std::ranges::not_equal_to::operator()](not_equal_to.html#std::ranges::not_equal_to::operator.28.29)
    * [3.1 Notes](not_equal_to.html#Notes)
    * [3.2 Example](not_equal_to.html#Example)
    * [3.3 Defect reports](not_equal_to.html#Defect_reports)
    * [3.4 See also](not_equal_to.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/not_equal_to&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/not_equal_to&action=edit&section=2 "Edit section: Member functions")] Member functions
...
Equivalent to return ![ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to){}([std::forward](../../forward.html)<T>(t), [std::forward](../../forward.html)<U>(u));. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/not_equal_to&action=edit&section=3 "Edit section: Notes")] Notes

Unlike [std::not_equal_to](../not_equal_to.html "cpp/utility/functional/not equal to"), `std::ranges::not_equal_to` requires both `==` and `!=` to be valid (via the [`equality_comparable_with`](../../../concepts/equality_comparable.html "cpp/concepts/equality comparable") constraint), and is entirely defined in terms of std::ranges::equal_to. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/not_equal_to&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/not_equal_to&action=edit&section=5 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/ranges/not_equal_to&action=edit&section=6 "Edit section: See also")] See also
