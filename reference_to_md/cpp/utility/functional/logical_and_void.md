...
[std::logical_and](logical_and.html)<void> is a specialization of [std::logical_and](logical_and.html "cpp/utility/functional/logical and") with parameter and return type deduced. 

## Contents

  * [1 Nested types](logical_and_void.html#Nested_types)
  * [2 Member functions](logical_and_void.html#Member_functions)
  * [3 std::logical_and<void>::operator()](logical_and_void.html#std::logical_and.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](logical_and_void.html#Parameters)
    * [3.2 Return value](logical_and_void.html#Return_value)
    * [3.3 Example](logical_and_void.html#Example)
