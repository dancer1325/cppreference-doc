...
---|---|---  
template<>  
class bit_or<void>; |  |  (since C++14)  
| |   
  
[std::bit_or](bit_or.html)<void> is a specialization of [std::bit_or](bit_or.html "cpp/utility/functional/bit or") with parameter and return type deduced. 

## Contents

  * [1 Nested types](bit_or_void.html#Nested_types)
  * [2 Member functions](bit_or_void.html#Member_functions)
  * [3 std::bit_or<void>::operator()](bit_or_void.html#std::bit_or.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](bit_or_void.html#Parameters)
    * [3.2 Return value](bit_or_void.html#Return_value)
    * [3.3 Example](bit_or_void.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/bit_or_void&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/bit_or_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/bit_or_void&action=edit&section=5 "Edit section: Example")] Example
