...
[std::negate](negate.html)<> is a specialization of [std::negate](negate.html "cpp/utility/functional/negate") with parameter and return type deduced. 

## Contents

  * [1 Member types](negate_void.html#Member_types)
  * [2 Member functions](negate_void.html#Member_functions)
  * [3 std::negate<void>::operator()](negate_void.html#std::negate.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](negate_void.html#Parameters)
    * [3.2 Return value](negate_void.html#Return_value)
    * [3.3 Example](negate_void.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/negate_void&action=edit&section=1 "Edit section: Member types")] Member types

Type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/negate_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
-> decltype(-[std::forward](../forward.html)<T>(arg)); |  |   
---|---|---  
| |   
...
-[std::forward](../forward.html)<T>(arg). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/negate_void&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto complex_negate = [std::negate](negate.html)<void>{}; // “void” can be omitted
        constexpr [std::complex](../../numeric/complex.html) z(4, 2);
        [std::cout](../../io/cout.html) << z << '\n';
        [std::cout](../../io/cout.html) << -z << '\n';
        [std::cout](../../io/cout.html) << complex_negate(z) << '\n';
    }
