...
copyable_function& operator=( [std::nullptr_t](../../../types/nullptr_t.html) ) noexcept; |  (3)  |  (since C++26)  
template< class F >  
copyable_function& operator=( F&& f ); |  (4)  |  (since C++26)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/copyable_function/operator%3D&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/copyable_function/operator%3D&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/copyable_function/operator%3D&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/copyable_function/operator%3D&action=edit&section=4 "Edit section: See also")] See also
