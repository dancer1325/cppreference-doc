...
[`std::copyable_function`](../copyable_function.html "cpp/utility/functional/copyable function")
...
[copyable_function::~copyable_function](~copyable_function.html "cpp/utility/functional/copyable function/~copyable function")  
[copyable_function::operator=](operator=.html "cpp/utility/functional/copyable function/operator=")  
[copyable_function::swap](swap.html "cpp/utility/functional/copyable function/swap")  
[copyable_function::operator bool](operator_bool.html "cpp/utility/functional/copyable function/operator bool")  
[copyable_function::operator()](operator\(\).html "cpp/utility/functional/copyable function/operator\(\)")  
[Non-member functions](../copyable_function.html#Non-member_functions "cpp/utility/functional/copyable function")  
[operator==](operator==.html "cpp/utility/functional/copyable function/operator==")  
[swap(std::copyable_function)](swap2.html "cpp/utility/functional/copyable function/swap2")  
  


copyable_function() noexcept; |  (1)  |  (since C++26)  
---|---|---  
copyable_function( [std::nullptr_t](../../../types/nullptr_t.html) ) noexcept; |  (2)  |  (since C++26)  
...
template< class F >   
copyable_function( F&& f ); |  (5)  |  (since C++26)  
template< class T, class... CArgs >   
explicit copyable_function( [std::in_place_type_t](../../in_place.html)<T>, CArgs&&... args ); |  (6)  |  (since C++26)  
template< class T, class U, class... CArgs >   
explicit copyable_function( [std::in_place_type_t](../../in_place.html)<T>,  
[std::initializer_list](../../initializer_list.html)<U> il, CArgs&&... args ); |  (7)  |  (since C++26)  
| |   
...
5) Let `VT` be [std::decay_t](../../../types/decay.html)<F>. If f is a null function pointer, a null pointer to member value, or an empty `std::copyable_function` (may be any other specialization), then constructs an empty `std::copyable_function`. Otherwise, constructs a `std::copyable_function` whose target is of type `VT` and direct-non-list-initialized with [std::forward](../../forward.html)<F>(f). 

  * This overload participates in overload resolution only if `VT` is neither same as `copyable_function` nor a specialization of [std::in_place_type_t](../../in_place.html "cpp/utility/in place"), and /*is-callable-from*/<VT> (see below) is true. 
  * The program is ill-formed if [std::is_constructible_v](../../../types/is_constructible.html)<VT, F> or [std::is_copy_constructible_v](../../../types/is_copy_constructible.html)<VT> is not true.



6) Let `VT` be [std::decay_t](../../../types/decay.html)<T>. Constructs a `std::copyable_function` whose target is of type `VT` and direct-non-list-initialized with [std::forward](../../forward.html)<CArgs>(args).... 

  * This overload participates in overload resolution only if both [std::is_constructible_v](../../../types/is_constructible.html)<VT, CArgs...> and /*is-callable-from*/<VT> (see below) are true. 
  * The program is ill-formed if `VT` is not the same type as `T` or [std::is_copy_constructible_v](../../../types/is_copy_constructible.html)<VT> is not true.



7) Let `VT` be [std::decay_t](../../../types/decay.html)<T>. Constructs a `std::copyable_function` whose target is of type `VT` and direct-non-list-initialized with il, [std::forward](../../forward.html)<CArgs>(args).... 

  * This overload participates in overload resolution only if both [std::is_constructible_v](../../../types/is_constructible.html)<VT, [std::initializer_list](../../initializer_list.html)<U>&, CArgs...> and /*is-callable-from*/<VT> (see below) are true. 
  * The program is ill-formed if `VT` is not the same type as `T` or [std::is_copy_constructible_v](../../../types/is_copy_constructible.html)<VT> is not true.



For constructors (5-7), the behavior is undefined unless `VT` satisfies both [Destructible](../../../named_req/Destructible.html "cpp/named req/Destructible") and [CopyConstructible](../../../named_req/CopyConstructible.html "cpp/named req/CopyConstructible") requirements. 
...
---|---  
noexcept(false) | [std::is_invocable_r_v](../../../types/is_invocable.html)<R, VT, Args...> &&  
[std::is_invocable_r_v](../../../types/is_invocable.html)<R, VT&, Args...>  
noexcept(true) | [std::is_nothrow_invocable_r_v](../../../types/is_invocable.html)<R, VT, Args...> &&  
[std::is_nothrow_invocable_r_v](../../../types/is_invocable.html)<R, VT&, Args...>  
const noexcept(false) | [std::is_invocable_r_v](../../../types/is_invocable.html)<R, const VT, Args...> &&  
[std::is_invocable_r_v](../../../types/is_invocable.html)<R, const VT&, Args...>  
const noexcept(true) | [std::is_nothrow_invocable_r_v](../../../types/is_invocable.html)<R, const VT, Args...> &&  
[std::is_nothrow_invocable_r_v](../../../types/is_invocable.html)<R, const VT&, Args...>  
& noexcept(false) | [std::is_invocable_r_v](../../../types/is_invocable.html)<R, VT&, Args...>  
& noexcept(true) | [std::is_nothrow_invocable_r_v](../../../types/is_invocable.html)<R, VT&, Args...>  
const & noexcept(false) | [std::is_invocable_r_v](../../../types/is_invocable.html)<R, const VT&, Args...>  
const & noexcept(true) | [std::is_nothrow_invocable_r_v](../../../types/is_invocable.html)<R, const VT&, Args...>  
...
## Contents
  ...
  * [1 Parameters](copyable_function.html#Parameters)
  * [2 Exceptions](copyable_function.html#Exceptions)
  * [3 Example](copyable_function.html#Example)
  * [4 See also](copyable_function.html#See_also)
...
3) May throw [std::bad_alloc](../../../memory/new/bad_alloc.html "cpp/memory/new/bad alloc") on allocation failure or propagate the exception thrown by the initialization of the target. 
