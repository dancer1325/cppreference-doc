...
friend void swap( [std::copyable_function](../copyable_function.html)& lhs, [std::copyable_function](../copyable_function.html)& rhs ) noexcept; |  |  (since C++26)  
---|---|---  
| |   
  
Overloads the [std::swap](../../swap.html "cpp/algorithm/swap") algorithm for std::copyable_function. Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/copyable_function/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  `std::copyable_function` objects whose states to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/copyable_function/swap2&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/copyable_function/swap2&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/copyable_function/swap2&action=edit&section=4 "Edit section: See also")] See also

[ swap](swap.html "cpp/utility/functional/copyable function/swap") |  swaps the targets of two `std::copyable_function` objects   
