...
---|---|---  
template<>  
class greater<void>; |  |  (since C++14)  
| |   
  
[std::greater](greater.html)<void> is a specialization of [std::greater](greater.html "cpp/utility/functional/greater") with parameter and return type deduced. 

## Contents

  * [1 Nested types](greater_void.html#Nested_types)
  * [2 Member functions](greater_void.html#Member_functions)
  * [3 std::greater<void>::operator()](greater_void.html#std::greater.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](greater_void.html#Parameters)
    * [3.2 Return value](greater_void.html#Return_value)
    * [3.3 Exceptions](greater_void.html#Exceptions)
    * [3.4 Example](greater_void.html#Example)
    * [3.5 Defect reports](greater_void.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/greater_void&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/greater_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/greater_void&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        return [std::greater](greater.html)<>()(lhs, 0);
    }
     
    int main()
    {
        constexpr [std::int64_t](../../types/integer.html) low = 0B11;
        constexpr [std::uint16_t](../../types/integer.html) high = 0X11;
        [std::greater](greater.html)<> greater{};
        static_assert(greater(high, low));
     
        constexpr static auto arr = {0, 1, 2, 3, 4, 5};
        static_assert(![std::all_of](../../algorithm/none_of.html)(arr.begin(), arr.end(), strictly_positive));
        static_assert([std::all_of](../../algorithm/none_of.html)(arr.begin() + 1, arr.end(), strictly_positive));
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/greater_void&action=edit&section=6 "Edit section: Defect reports")] Defect reports
