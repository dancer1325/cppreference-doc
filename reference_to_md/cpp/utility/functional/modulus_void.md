...
[std::modulus](modulus.html)<void> is a specialization of [std::modulus](modulus.html "cpp/utility/functional/modulus") with parameter and return type deduced. 

## Contents

  * [1 Nested types](modulus_void.html#Nested_types)
  * [2 Member functions](modulus_void.html#Member_functions)
  * [3 std::modulus<void>::operator()](modulus_void.html#std::modulus.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](modulus_void.html#Parameters)
    * [3.2 Return value](modulus_void.html#Return_value)
    * [3.3 Example](modulus_void.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/modulus_void&action=edit&section=1 "Edit section: Nested types")] Nested types

Nested type  |  Definition   
---|---  
`is_transparent` |  [unspecified](../../functional.html#Transparent_function_objects "cpp/utility/functional")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/modulus_void&action=edit&section=2 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/modulus_void&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    struct M
    {
        M(int x) { [std::cout](../../io/cout.html) << "M(" << x << ");\n"; }
        M() {}
    };
     
    auto operator%(M, M) { [std::cout](../../io/cout.html) << "operator%(M, M);\n"; return M{}; }
    auto operator%(M, int) { [std::cout](../../io/cout.html) << "operator%(M, int);\n"; return M{}; }
    auto operator%(int, M) { [std::cout](../../io/cout.html) << "operator%(int, M);\n"; return M{}; }
     
    int main()
    {
        M m;
     
        ...
        [std::modulus](modulus.html)<M>{}(m, 42);    // calls operator%(M, M)
     
        // no temporary object
        [std::modulus](modulus.html)<void>{}(m, 42); // calls operator%(M, int)
        [std::modulus](modulus.html)<void>{}(42, m); // calls operator%(int, M)
    }
