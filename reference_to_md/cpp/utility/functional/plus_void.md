...
---|---|---  
template<>  
class plus<void>; |  |  (since C++14)  
| |   
  
[std::plus](plus.html)<void> is a specialization of [std::plus](plus.html "cpp/utility/functional/plus") with parameter and return type deduced. 

## Contents

  * [1 Member types](plus_void.html#Member_types)
  * [2 Member functions](plus_void.html#Member_functions)
  * [3 std::plus<void>::operator()](plus_void.html#std::plus.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](plus_void.html#Parameters)
    * [3.2 Return value](plus_void.html#Return_value)
    * [3.3 Example](plus_void.html#Example)
...
Run this code
    ...
    int main()
    {
        auto string_plus = [std::plus](plus.html)<void>{}; // “void” can be omitted
        [std::string](../../string/basic_string.html) a = "Hello ";
        const char* b = "world";
        [std::cout](../../io/cout.html) << string_plus(a, b) << '\n';
    }
