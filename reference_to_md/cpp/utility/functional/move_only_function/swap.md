...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/move_only_function/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  function wrapper to exchange the stored callable object with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/move_only_function/swap&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/move_only_function/swap&action=edit&section=3 "Edit section: See also")] See also
