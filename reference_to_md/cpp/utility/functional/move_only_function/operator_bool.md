...
## Contents
  ...
  * [1 Parameters](operator_bool.html#Parameters)
  * [2 Return value](operator_bool.html#Return_value)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/move_only_function/operator_bool&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/move_only_function/operator_bool&action=edit&section=2 "Edit section: Return value")] Return value

true if *this stores a callable target, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/move_only_function/operator_bool&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    void sampleFunction()
    {
        [std::cout](../../../io/cout.html) << "This is the sample function!\n";
    }
     
    void checkFunc([std::move_only_function](../move_only_function.html)<void() const> const& func)
    {
        // Use operator bool to determine if callable target is available.
        if (func)
        {
            [std::cout](../../../io/cout.html) << "Function is not empty! Calling function.\n";
            func();
        }
        else
            [std::cout](../../../io/cout.html) << "Function is empty. Nothing to do.\n";
    }
     
    int main()
    {
        [std::move_only_function](../move_only_function.html)<void() const> f1{};
        [std::move_only_function](../move_only_function.html)<void() const> f2{sampleFunction};
     
        [std::cout](../../../io/cout.html) << "f1: ";
        checkFunc(f1);
     
        [std::cout](../../../io/cout.html) << "f2: ";
        checkFunc(f2);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/move_only_function/operator_bool&action=edit&section=4 "Edit section: See also")] See also

[ operator==](operator==.html "cpp/utility/functional/move only function/operator==")(C++23) |  compares a `std::move_only_function` with nullptr   
