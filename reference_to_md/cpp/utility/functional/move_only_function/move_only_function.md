...
[move_only_function::~move_only_function](~move_only_function.html "cpp/utility/functional/move only function/~move only function")  
[move_only_function::operator=](operator=.html "cpp/utility/functional/move only function/operator=")  
[move_only_function::swap](swap.html "cpp/utility/functional/move only function/swap")  
[move_only_function::operator bool](operator_bool.html "cpp/utility/functional/move only function/operator bool")  
[move_only_function::operator()](operator\(\).html "cpp/utility/functional/move only function/operator\(\)")  
...
---|---|---  
move_only_function( [std::nullptr_t](../../../types/nullptr_t.html) ) noexcept; |  (2)  |  (since C++23)  
...
template< class F >   
move_only_function( F&& f ); |  (5)  |  (since C++23)  
template< class T, class... CArgs >   
explicit move_only_function( [std::in_place_type_t](../../in_place.html)<T>, CArgs&&... args ); |  (6)  |  (since C++23)  
template< class T, class U, class... CArgs >   
explicit move_only_function( [std::in_place_type_t](../../in_place.html)<T>,  
[std::initializer_list](../../initializer_list.html)<U> il, CArgs&&... args ); |  (7)  |  (since C++23)  
| |   
...
4) Copy constructor is deleted. `std::move_only_function` does not satisfy [CopyConstructible](../../../named_req/CopyConstructible.html "cpp/named req/CopyConstructible").

5) Let `VT` be [std::decay_t](../../../types/decay.html)<F>. If f is a null function pointer, a null pointer to member value, or an empty `std::move_only_function` (may be any other specialization), then constructs an empty `std::move_only_function`. Otherwise, constructs a `std::move_only_function` whose target is of type `VT` and direct-non-list-initialized with [std::forward](../../forward.html)<F>(f). 

  * This overload participates in overload resolution only if `VT` is neither same as `move_only_function` nor a specialization of [std::in_place_type_t](../../in_place.html "cpp/utility/in place"), and /*is-callable-from*/<VT> (see below) is true. 
  * The program is ill-formed if [std::is_constructible_v](../../../types/is_constructible.html)<VT, F> is not true.



6) Let `VT` be [std::decay_t](../../../types/decay.html)<T>. Constructs a `std::move_only_function` whose target is of type `VT` and direct-non-list-initialized with [std::forward](../../forward.html)<CArgs>(args).... 
...
7) Let `VT` be [std::decay_t](../../../types/decay.html)<T>. Constructs a `std::move_only_function` whose target is of type `VT` and direct-non-list-initialized with il, [std::forward](../../forward.html)<CArgs>(args).... 
...
For constructors (5-7), the behavior is undefined if `VT` does not satisfy the [Destructible](../../../named_req/Destructible.html "cpp/named req/Destructible") requirements, or [std::is_move_constructible_v](../../../types/is_move_constructible.html)<VT> is true but `VT` does not satisfy the [MoveConstructible](../../../named_req/MoveConstructible.html "cpp/named req/MoveConstructible") requirements. 
...
## Contents
  ...
  * [1 Parameters](move_only_function.html#Parameters)
  * [2 Exceptions](move_only_function.html#Exceptions)
  * [3 Example](move_only_function.html#Example)
  * [4 See also](move_only_function.html#See_also)
