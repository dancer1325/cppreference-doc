...
**basic_stacktrace::rend basic_stacktrace::crend**  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/rend&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/rend&action=edit&section=2 "Edit section: Return value")] Return value

The end iterator of the reversed `basic_stacktrace`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/rend&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/rend&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        auto empty_trace = [std::stacktrace](../basic_stacktrace.html){};
     
        // Print stacktrace.
        [std::for_each](../../algorithm/for_each.html)(trace.rbegin(), trace.rend(),
                      [](const auto& f) { [std::cout](../../io/cout.html) << f << '\n'; });
     
        if (empty_trace.rbegin() == empty_trace.rend())
            [std::cout](../../io/cout.html) << "stacktrace 'empty_trace' is indeed empty.\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/rend&action=edit&section=5 "Edit section: See also")] See also

[ rbegincrbegin](rbegin.html "cpp/utility/basic stacktrace/rbegin") |  returns a reverse iterator to the beginning   
