...
**basic_stacktrace::begin basic_stacktrace::cbegin**  
...
const_iterator begin() const noexcept; |  (1)  |  (since C++23)  
---|---|---  
const_iterator cbegin() const noexcept; |  (2)  |  (since C++23)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/begin&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/begin&action=edit&section=2 "Edit section: Return value")] Return value

Iterator to the first entry. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/begin&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/begin&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        // Print stacktrace.
        [std::for_each](../../algorithm/for_each.html)(trace.begin(), trace.end(),
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/begin&action=edit&section=5 "Edit section: See also")] See also

[ endcend](end.html "cpp/utility/basic stacktrace/end") |  returns an iterator to the end   
