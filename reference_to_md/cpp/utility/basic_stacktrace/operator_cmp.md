...
---|---|---  
template< class Allocator2 >  
friend [std::strong_ordering](../compare/strong_ordering.html)  
...
Equivalent to return [std::equal](../../algorithm/equal.html)(lhs.begin(), lhs.end(), rhs.begin(), rhs.end());.
