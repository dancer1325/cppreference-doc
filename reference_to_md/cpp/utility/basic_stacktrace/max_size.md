...
---  
[basic_stacktrace::basic_stacktrace](basic_stacktrace.html "cpp/utility/basic stacktrace/basic stacktrace")  
[basic_stacktrace::~basic_stacktrace](~basic_stacktrace.html "cpp/utility/basic stacktrace/~basic stacktrace")  
[basic_stacktrace::operator=](operator=.html "cpp/utility/basic stacktrace/operator=")  
[basic_stacktrace::current](current.html "cpp/utility/basic stacktrace/current")  
[basic_stacktrace::get_allocator](get_allocator.html "cpp/utility/basic stacktrace/get allocator")  
[Iterators](../basic_stacktrace.html#Iterators "cpp/utility/basic stacktrace")  
[basic_stacktrace::beginbasic_stacktrace::cbegin](begin.html "cpp/utility/basic stacktrace/begin")  
[basic_stacktrace::endbasic_stacktrace::cend](end.html "cpp/utility/basic stacktrace/end")  
[basic_stacktrace::rbeginbasic_stacktrace::crbegin](rbegin.html "cpp/utility/basic stacktrace/rbegin")  
[basic_stacktrace::rendbasic_stacktrace::crend](rend.html "cpp/utility/basic stacktrace/rend")  
[Capacity](../basic_stacktrace.html#Capacity "cpp/utility/basic stacktrace")  
[basic_stacktrace::empty](empty.html "cpp/utility/basic stacktrace/empty")  
[basic_stacktrace::size](size.html "cpp/utility/basic stacktrace/size")  
...
[basic_stacktrace::at](at.html "cpp/utility/basic stacktrace/at")  
[Modifiers](../basic_stacktrace.html#Modifiers "cpp/utility/basic stacktrace")  
[basic_stacktrace::swap](swap.html "cpp/utility/basic stacktrace/swap")  
[Non-member functions](../basic_stacktrace.html#Non-member_functions "cpp/utility/basic stacktrace")  
[operator==  
operator<=>](operator_cmp.html "cpp/utility/basic stacktrace/operator cmp")  
[swap(std::basic_stacktrace)](swap2.html "cpp/utility/basic stacktrace/swap2")  
[to_string(std::basic_stacktrace)](to_string.html "cpp/utility/basic stacktrace/to string")  
[operator<<](operator_ltlt.html "cpp/utility/basic stacktrace/operator ltlt")  
...
Returns the maximum number of elements the underlying container (typically a [std::vector](../../container/vector.html "cpp/container/vector")) is able to hold due to system or library implementation limitations, i.e. [std::distance](../../iterator/distance.html)(begin(), end()) for the largest underlying container. 
...
## Contents
  ...
  * [4 Notes](max_size.html#Notes)
  * [5 Example](max_size.html#Example)
  * [6 See also](max_size.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/max_size&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/max_size&action=edit&section=2 "Edit section: Return value")] Return value

Maximum number of elements. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/max_size&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/max_size&action=edit&section=4 "Edit section: Notes")] Notes

This value typically reflects the theoretical limit on the size of the underlying container, at most [std::numeric_limits](../../types/numeric_limits.html)<difference_type>::max(). At runtime, the size of the container may be limited to a value smaller than `max_size()` by the amount of RAM available. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/max_size&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::stacktrace](../basic_stacktrace.html) trace;
        [std::cout](../../io/cout.html) << "Maximum size of a 'basic_stacktrace' is " << trace.max_size() << "\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/max_size&action=edit&section=6 "Edit section: See also")] See also

[ size](size.html "cpp/utility/basic stacktrace/size") |  returns the number of stacktrace entries   
