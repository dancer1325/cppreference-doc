...
[basic_stacktrace::max_size](max_size.html "cpp/utility/basic stacktrace/max size")  
...
If `pos` is not within the range of the stacktrace, an exception of type [std::out_of_range](../../error/out_of_range.html "cpp/error/out of range") is thrown. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/at&action=edit&section=1 "Edit section: Parameters")] Parameters

pos  |  \-  |  position of the stacktrace entry to return   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/at&action=edit&section=2 "Edit section: Return value")] Return value

Reference to the requested entry. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/at&action=edit&section=3 "Edit section: Exceptions")] Exceptions

[std::out_of_range](../../error/out_of_range.html "cpp/error/out of range") if pos >= size(). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/at&action=edit&section=4 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/at&action=edit&section=5 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/at&action=edit&section=6 "Edit section: See also")] See also

[ operator[]](operator_at.html "cpp/utility/basic stacktrace/operator at") |  access specified stacktrace entry   
