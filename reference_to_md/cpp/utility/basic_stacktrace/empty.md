...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/empty&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/empty&action=edit&section=2 "Edit section: Return value")] Return value

true if the stacktrace is empty, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/empty&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/empty&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::stacktrace](../basic_stacktrace.html) bktr;
        [std::cout](../../io/cout.html) << "Initially, bktr.empty(): " << bktr.empty() << '\n';
     
        bktr = std::stacktrace::current();
        [std::cout](../../io/cout.html) << "After getting entries, bktr.empty(): " << bktr.empty() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/empty&action=edit&section=5 "Edit section: See also")] See also
