...
[std::string](../../string/basic_string.html) to_string( const [std::basic_stacktrace](../basic_stacktrace.html)<Allocator>& st ); |  |  (since C++23)  
| |   
  
Returns a string with a description of `st`. 

The description of a `basic_stacktrace` typically contains description of its entries, although the number of lines is not required to be equal to [`size()`](size.html "cpp/utility/basic stacktrace/size"). 
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << [std::to_string](../../string/basic_string/to_string.html)(trace) << '\n';
    }
