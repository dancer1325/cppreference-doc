...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/operator_at&action=edit&section=1 "Edit section: Parameters")] Parameters

pos  |  \-  |  position of the stacktrace entry to return   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/operator_at&action=edit&section=2 "Edit section: Return value")] Return value

Reference to the requested entry. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/operator_at&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/operator_at&action=edit&section=4 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/operator_at&action=edit&section=5 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/operator_at&action=edit&section=6 "Edit section: See also")] See also

[ at](at.html "cpp/utility/basic stacktrace/at") |  access specified stacktrace entry with bounds checking   
