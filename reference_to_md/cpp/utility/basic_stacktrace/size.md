...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/size&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/size&action=edit&section=2 "Edit section: Return value")] Return value

The number of entries in the stacktrace. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/size&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/size&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << "trace contains " << trace.size() << " entries.\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/size&action=edit&section=5 "Edit section: See also")] See also

[ empty](empty.html "cpp/utility/basic stacktrace/empty") |  checks whether the `basic_stacktrace` is empty   
...
---|---  
[ max_size](max_size.html "cpp/utility/basic stacktrace/max size") |  returns the maximum possible number of stacktrace entries   
