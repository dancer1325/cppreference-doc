...
void swap( [std::basic_stacktrace](../basic_stacktrace.html)<Allocator>& lhs, [std::basic_stacktrace](../basic_stacktrace.html)<Allocator>& rhs )  
noexcept(noexcept(lhs.swap(rhs))); |  |  (since C++23)  
| |   
  
Specializes the [std::swap](../swap.html "cpp/algorithm/swap") algorithm for std::basic_stacktrace. Swaps the contents of lhs and rhs. Equivalent to lhs.swap(rhs);. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  stacktraces whose contents to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/swap2&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/swap2&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/swap2&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/basic_stacktrace/swap2&action=edit&section=5 "Edit section: See also")] See also

[ swap](swap.html "cpp/utility/basic stacktrace/swap") |  swaps the contents   
