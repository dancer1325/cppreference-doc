...
[std::ostream](../../io/basic_ostream.html)& operator<<( [std::ostream](../../io/basic_ostream.html)& os, const [std::basic_stacktrace](../basic_stacktrace.html)<Allocator>& st ); |  |  (since C++23)  
| |   
  
Inserts the description of `st` into the output stream `os`. Equivalent to return os << [std::to_string](../../string/basic_string/to_string.html)(st);. 

## Contents

  * [1 Parameters](operator_ltlt.html#Parameters)
  * [2 Return value](operator_ltlt.html#Return_value)
  * [3 Exceptions](operator_ltlt.html#Exceptions)
  * [4 Example](operator_ltlt.html#Example)
  * [5 See also](operator_ltlt.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "The stacktrace obtained in the main function:\n";
        [std::cout](../../io/cout.html) << std::stacktrace::current() << '\n';
        []{
            [std::cout](../../io/cout.html) << "The stacktrace obtained in a nested lambda:\n";
            [std::cout](../../io/cout.html) << std::stacktrace::current() << '\n';
        }();
    }
