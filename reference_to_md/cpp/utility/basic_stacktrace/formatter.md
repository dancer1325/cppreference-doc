...
struct formatter<[std::basic_stacktrace](../basic_stacktrace.html)<Allocator>>; |  |  (since C++23)  
| |   
  
The template specialization of [std::formatter](../format/formatter.html "cpp/utility/format/formatter") for std::basic_stacktrace<Allocator> allows users to convert a stacktrace object to string using [formatting functions](../format.html "cpp/utility/format") such as [std::format](../format/format.html "cpp/utility/format/format"). 
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << [std::format](../format/format.html)("{}\n", trace);
    }
