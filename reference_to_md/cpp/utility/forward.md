...
| (1) |   
template< class T >  
T&& forward( typename [std::remove_reference](../types/remove_reference.html)<T>::type& t ) noexcept; |  | (since C++11)   
(until C++14)  
template< class T >  
constexpr T&& forward( [std::remove_reference_t](../types/remove_reference.html)<T>& t ) noexcept; |  |  (since C++14)  
| (2) |   
template< class T >  
T&& forward( typename [std::remove_reference](../types/remove_reference.html)<T>::type&& t ) noexcept; |  | (since C++11)   
(until C++14)  
...
When t is a [forwarding reference](../language/reference.html#Forwarding_references "cpp/language/reference") (a function argument that is declared as an rvalue reference to a cv-unqualified function template parameter), this overload forwards the argument to another function with the [value category](../language/value_category.html "cpp/language/value category") it had when passed to the calling function. 
...
## Contents
  ...
  * [1 Notes](forward.html#Notes)
  * [2 Parameters](forward.html#Parameters)
  * [3 Return value](forward.html#Return_value)
  * [4 Complexity](forward.html#Complexity)
  * [5 Example](forward.html#Example)
  * [6 See also](forward.html#See_also)
...
Run this code
    ...
    struct A
    {
        A(int&& n) { [std::cout](../io/cout.html) << "rvalue overload, n=" << n << '\n'; }
        A(int& n)  { [std::cout](../io/cout.html) << "lvalue overload, n=" << n << '\n'; }
    };
     
    class B
    {
    ...
    [std::unique_ptr](../memory/unique_ptr.html)<T> make_unique1(U&& u)
    {
        return [std::unique_ptr](../memory/unique_ptr.html)<T>(new T(std::forward<U>(u)));
    }
     
    template<class T, class... U>
    [std::unique_ptr](../memory/unique_ptr.html)<T> make_unique2(U&&... u)
    {
        return [std::unique_ptr](../memory/unique_ptr.html)<T>(new T(std::forward<U>(u)...));
    }
     
