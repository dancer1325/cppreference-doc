...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/program/atexit&action=edit&section=1 "Edit section: Parameters")] Parameters

func  |  \-  |  pointer to a function to be called on normal program termination   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/program/atexit&action=edit&section=2 "Edit section: Return value")] Return value

​0​ if the registration succeeds, nonzero value otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/program/atexit&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/program/atexit&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/program/atexit&action=edit&section=5 "Edit section: See also")] See also
