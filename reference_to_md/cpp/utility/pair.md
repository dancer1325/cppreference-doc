...
`std::pair` is a class template that provides a way to store two heterogeneous objects as a single unit. A pair is a specific case of a [std::tuple](tuple.html "cpp/utility/tuple") with two elements. 
...
## Contents
  ...
  * [1 Template parameters](pair.html#Template_parameters)
  * [2 Member types](pair.html#Member_types)
  * [3 Member objects](pair.html#Member_objects)
  * [4 Member functions](pair.html#Member_functions)
  * [5 Non-member functions](pair.html#Non-member_functions)
  * [6 Helper classes](pair.html#Helper_classes)
  * [7 Helper specializations](pair.html#Helper_specializations)
  * [8 Deduction guides(since C++17)](pair.html#Deduction_guides.28since_C.2B.2B17.29)
  * [9 Defect reports](pair.html#Defect_reports)
  * [10 See also](pair.html#See_also)
...
enable_nonlocking_formatter_optimization<U>; |  |  (since C++23)  
---|---|---  
| |   
