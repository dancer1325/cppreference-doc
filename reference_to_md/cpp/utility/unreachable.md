...
---  
| [abort](program/abort.html "cpp/utility/program/abort")  
---  
[exit](program/exit.html "cpp/utility/program/exit")  
[quick_exit](program/quick_exit.html "cpp/utility/program/quick exit")(C++11)  
[_Exit](program/_Exit.html "cpp/utility/program/ Exit")(C++11)  
  
| [atexit](program/atexit.html "cpp/utility/program/atexit")  
---  
[at_quick_exit](program/at_quick_exit.html "cpp/utility/program/at quick exit")(C++11)  
[EXIT_SUCCESSEXIT_FAILURE](program/EXIT_status.html "cpp/utility/program/EXIT status")  
...
| [system](program/system.html "cpp/utility/program/system")  
---  
  
| [getenv](program/getenv.html "cpp/utility/program/getenv")  
---  
  
[Signals](program.html#Signals "cpp/utility/program")  
| [signal](program/signal.html "cpp/utility/program/signal")  
---  
[raise](program/raise.html "cpp/utility/program/raise")  
[sig_atomic_t](program/sig_atomic_t.html "cpp/utility/program/sig atomic t")  
  
| [SIG_DFLSIG_IGN](program/SIG_strategies.html "cpp/utility/program/SIG strategies")  
---  
[SIG_ERR](program/SIG_ERR.html "cpp/utility/program/SIG ERR")  
  
[Signal types](program.html#Signal_types "cpp/utility/program")  
| [SIGABRTSIGFPESIGILL](program/SIG_types.html "cpp/utility/program/SIG types")  
---  
  
| [SIGINTSIGSEGVSIGTERM](program/SIG_types.html "cpp/utility/program/SIG types")  
---  
  
[Non-local jumps](program.html#Non-local_jumps "cpp/utility/program")  
| [setjmp](program/setjmp.html "cpp/utility/program/setjmp")  
---  
  
| [longjmp](program/longjmp.html "cpp/utility/program/longjmp")  
---  
...
Invokes [undefined behavior](../language/ub.html "cpp/language/ub") at a given point. 
...
## Contents
  ...
  * [1 Notes](unreachable.html#Notes)
  * [2 Possible implementation](unreachable.html#Possible_implementation)
  * [3 Example](unreachable.html#Example)
  * [4 See also](unreachable.html#See_also)
  * [5 External Links](unreachable.html#External_Links)
...
Run this code
    ...
    #include <vector>
     
    struct Color { [std::uint8_t](../types/integer.html) r, g, b, a; };
     
    // Assume that only restricted set of texture caps is supported.
    void generate_texture([std::vector](../container/vector.html)<Color>& tex, [std::size_t](../types/size_t.html) xy)
    {
        switch (xy)
        {
    ...
    int main()
    {
        [std::vector](../container/vector.html)<Color> tex;
