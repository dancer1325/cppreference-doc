...
---|---|---  
class bad_optional_access : public [std::exception](../error/exception.html) |  |  (since C++17)  
| |   
  
Defines a type of object to be thrown by [std::optional::value](optional/value.html "cpp/utility/optional/value") when accessing an optional object that does not contain a value. 
...
![std-bad optional access-inheritance-lwg2806.svg](https://upload.cppreference.com/mwiki/images/8/8a/std-bad_optional_access-inheritance-lwg2806.svg)

Inheritance diagram

## Contents

  * [1 Member functions](bad_optional_access.html#Member_functions)
  * [2 std::bad_optional_access::bad_optional_access](bad_optional_access.html#std::bad_optional_access::bad_optional_access)
    * [2.1 Parameters](bad_optional_access.html#Parameters)
  * [3 std::bad_optional_access::operator=](bad_optional_access.html#std::bad_optional_access::operator.3D)
    * [3.1 Parameters](bad_optional_access.html#Parameters_2)
    * [3.2 Return value](bad_optional_access.html#Return_value)
  * [4 std::bad_optional_access::what](bad_optional_access.html#std::bad_optional_access::what)
    * [4.1 Return value](bad_optional_access.html#Return_value_2)
    * [4.2 Notes](bad_optional_access.html#Notes)
  * [5 Inherited from std::exception](bad_optional_access.html#Inherited_from_std::exception)
    * [5.1 Member functions](bad_optional_access.html#Member_functions_2)
    * [5.2 Notes](bad_optional_access.html#Notes_2)
    * [5.3 Example](bad_optional_access.html#Example)
    * [5.4 See also](bad_optional_access.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/optional/bad_optional_access&action=edit&section=1 "Edit section: Member functions")] Member functions
...
Constructs a new `bad_optional_access` object with an implementation-defined null-terminated byte string which is accessible through [`what()`](../error/exception/what.html "cpp/error/exception/what"). 

1) Default constructor.

2) Copy constructor. If *this and other both have dynamic type `std::bad_optional_access` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0.
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::bad_optional_access` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/optional/bad_optional_access&action=edit&section=2 "Edit section: Notes")] Notes

[Feature-test](feature_test.html "cpp/utility/feature test") macro  | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_constexpr_exceptions`](../experimental/feature_test.html#cpp_lib_constexpr_exceptions "cpp/feature test") | [`202502L`](../compiler_support/26.html#cpp_lib_constexpr_exceptions_202502L "cpp/compiler support/26") | (C++26) | constexpr `std::bad_optional_access`  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/optional/bad_optional_access&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::optional](optional.html)<int> opt; // creates an empty optional
        try
        {
            [[maybe_unused]] auto x = opt.value(); // throws
        }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/utility/optional/bad_optional_access&action=edit&section=4 "Edit section: See also")] See also
