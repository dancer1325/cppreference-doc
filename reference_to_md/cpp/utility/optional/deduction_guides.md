...
---|---|---  
template< class T >  
optional(T) -> optional<T>; |  |  (since C++17)  
| |   
...
Run this code
    ...
    {
        int a[2];
        [std::optional](../optional.html) oa{a}; // uses explicit deduction guide
        static_assert([std::is_same_v](../../types/is_same.html)<decltype(oa), [std::optional](../optional.html)<int*>> == true);
    }
