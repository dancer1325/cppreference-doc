...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=1 "Edit section: Constrained algorithms \(since C++20\)")] [Constrained algorithms](algorithm/ranges.html "cpp/algorithm/ranges") (since C++20)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=2 "Edit section: Execution policies \(since C++17\)")] Execution policies (since C++17)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=3 "Edit section: Non-modifying sequence operations")] Non-modifying sequence operations

#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=4 "Edit section: Batch operations")] Batch operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=5 "Edit section: Search operations")] Search operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=6 "Edit section: Fold operations \(since C++23\)")] Fold operations (since C++23)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=7 "Edit section: Modifying sequence operations")] Modifying sequence operations

#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=8 "Edit section: Copy operations")] Copy operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=9 "Edit section: Swap operations")] Swap operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=10 "Edit section: Transformation operations")] Transformation operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=11 "Edit section: Generation operations")] Generation operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=12 "Edit section: Removing operations")] Removing operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=13 "Edit section: Order-changing operations")] Order-changing operations

Defined in header `[<algorithm>](header/algorithm.html "cpp/header/algorithm")`  
---  
[ reverse](algorithm/reverse.html "cpp/algorithm/reverse") |  reverses the order of elements in a range   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/algorithm/dsc_reverse&action=edit)  
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=14 "Edit section: Sampling operations")] Sampling operations
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=15 "Edit section: Sorting and related operations")] Sorting and related operations

#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=16 "Edit section: Requirements")] Requirements
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=17 "Edit section: Partitioning operations")] Partitioning operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=18 "Edit section: Sorting operations")] Sorting operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=19 "Edit section: Binary search operations \(on partitioned ranges\)")] Binary search operations (on partitioned ranges)
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=20 "Edit section: Set operations \(on sorted ranges\)")] Set operations (on sorted ranges)
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=21 "Edit section: Merge operations \(on sorted ranges\)")] Merge operations (on sorted ranges)
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=22 "Edit section: Heap operations")] Heap operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=23 "Edit section: Minimum/maximum operations")] Minimum/maximum operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=24 "Edit section: Lexicographical comparison operations")] Lexicographical comparison operations
...
#### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=25 "Edit section: Permutation operations")] Permutation operations
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=26 "Edit section: Numeric operations")] Numeric operations
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=27 "Edit section: Operations on uninitialized memory")] Operations on uninitialized memory
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=28 "Edit section: Random number generation \(since C++26\)")] Random number generation (since C++26)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=29 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=30 "Edit section: C library")] C library
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=31 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm&action=edit&section=32 "Edit section: See also")] See also
