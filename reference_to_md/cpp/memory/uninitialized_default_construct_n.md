...
( NoThrowForwardIt first, Size count ); |  (1) | (since C++17)   
(constexpr since C++26)  
template< class ExecutionPolicy, class NoThrowForwardIt, class Size >  
NoThrowForwardIt uninitialized_default_construct_n  
( ExecutionPolicy&& policy, NoThrowForwardIt first, Size count ); |  (2)  |  (since C++17)  
| |   
  
1) Constructs objects of type typename [std::iterator_traits](../iterator/iterator_traits.html)<NoThrowForwardIt>::value_type in the uninitialized memory area first` + ``[`​0​`, `count`)` by [default-initialization](../language/default_initialization.html "cpp/language/default initialization"), as if by 

for (; count > 0; (void)++first, \--count)  
` `::new ([`_voidify_`](voidify.html "cpp/memory/voidify")(*first))  
` `typename [std::iterator_traits](../iterator/iterator_traits.html)<NoThrowForwardIt>::value_type;  
return first;
...
## Contents
  ...
  * [6 Possible implementation](uninitialized_default_construct_n.html#Possible_implementation)
  * [7 Example](uninitialized_default_construct_n.html#Example)
  * [8 Defect reports](uninitialized_default_construct_n.html#Defect_reports)
  * [9 See also](uninitialized_default_construct_n.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct_n&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct_n&action=edit&section=2 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in n. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct_n&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct_n&action=edit&section=5 "Edit section: Notes")] Notes

[Feature-test](../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_raw_memory_algorithms`](../experimental/feature_test.html#cpp_lib_raw_memory_algorithms "cpp/feature test") | [`202411L`](../compiler_support/26.html#cpp_lib_raw_memory_algorithms_202411L "cpp/compiler support/26") | (C++26) | constexpr for [specialized memory algorithms](../memory.html#Uninitialized_memory_algorithms "cpp/memory"), ([1](uninitialized_default_construct_n.html#Version_1))  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct_n&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class NoThrowForwardIt, class Size>
    constexpr ForwardIt uninitialized_default_construct_n(NoThrowForwardIt first, Size count)
    {
        using T = typename [std::iterator_traits](../iterator/iterator_traits.html)<NoThrowForwardIt>::value_type;
        NoThrowForwardIt current = first;
     
        try
        {
            for (; countn > 0; (void) ++current, --count)
                ::new (static_cast<void*>([std::addressof](addressof.html)(*current))) T;
            return current;
        }
        catch (...)
        {
            [std::destroy](destroy.html)(first, current);
            throw;
        }
    }  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct_n&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    struct S
    {
        [std::string](../string/basic_string.html) m{"default value"};
    };
     
    int main()
    {
    ...
     
        ...
        std::uninitialized_default_construct_n([std::begin](../iterator/begin.html)(v), [std::size](../iterator/size.html)(v));
     
    ...
     
        ...
        [std::cout](../io/cout.html) << ([std::memcmp](../string/byte/memcmp.html)(v, original, sizeof(v)) == 0 ? "un" : "") << "modified\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct_n&action=edit&section=8 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct_n&action=edit&section=9 "Edit section: See also")] See also
...
[ ranges::uninitialized_default_construct_n](ranges/uninitialized_default_construct_n.html "cpp/memory/ranges/uninitialized default construct n")(C++20) |  constructs objects by [default-initialization](../language/default_initialization.html "cpp/language/default initialization") in an uninitialized area of memory, defined by a start and count  
