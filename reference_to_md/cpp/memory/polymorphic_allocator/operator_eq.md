...
bool operator==( const [std::pmr::polymorphic_allocator](../polymorphic_allocator.html)<T1>& lhs,  
const [std::pmr::polymorphic_allocator](../polymorphic_allocator.html)<T2>& rhs ) noexcept; |  (1)  |  (since C++17)  
friend bool operator==( const polymorphic_allocator& lhs,  
const polymorphic_allocator& rhs ) noexcept; |  (2)  |  (since C++17)  
template< class T1, class T2 >  
bool operator!=( const [std::pmr::polymorphic_allocator](../polymorphic_allocator.html)<T1>& lhs,  
const [std::pmr::polymorphic_allocator](../polymorphic_allocator.html)<T2>& rhs ) noexcept; |  (3)  |  (since C++17)   
(until C++20)  
friend bool operator!=( const polymorphic_allocator& lhs,  
const polymorphic_allocator& rhs ) noexcept; |  (4)  |  (since C++17)   
(until C++20)  
| |   
...
---|---|---|---  
[LWG 3683](https://cplusplus.github.io/LWG/issue3683) | C++17  | `polymorphic_allocator` could not be compared with types convertible to it  | overload added 
