...
polymorphic_allocator( [std::pmr::memory_resource](../memory_resource.html)* r ); |  (4)  |   
| |   
  
Constructs a new `polymorphic_allocator`. 

1) Constructs a `polymorphic_allocator` using the return value of [std::pmr::get_default_resource](../get_default_resource.html)() as the underlying memory resource.

2,3) Constructs a `polymorphic_allocator` using other.resource() as the underlying memory resource.

4) Constructs a `polymorphic_allocator` using r as the underlying memory resource. This constructor provides an implicit conversion from [std::pmr::memory_resource](../memory_resource.html)*.

## Contents

  * [1 Parameters](polymorphic_allocator.html#Parameters)
  * [2 Exceptions](polymorphic_allocator.html#Exceptions)
  * [3 Notes](polymorphic_allocator.html#Notes)
  * [4 See also](polymorphic_allocator.html#See_also)
