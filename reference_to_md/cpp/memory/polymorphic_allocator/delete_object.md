...
Equivalent to  
[std::allocator_traits](../allocator_traits.html)<polymorphic_allocator>::destroy(*this, p);  
deallocate_object(p);

## Contents

  * [1 Parameters](delete_object.html#Parameters)
  * [2 Exceptions](delete_object.html#Exceptions)
  * [3 Notes](delete_object.html#Notes)
  * [4 See also](delete_object.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic_allocator/delete_object&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  pointer to the object to destroy and deallocate   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic_allocator/delete_object&action=edit&section=2 "Edit section: Exceptions")] Exceptions

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic_allocator/delete_object&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic_allocator/delete_object&action=edit&section=4 "Edit section: See also")] See also
