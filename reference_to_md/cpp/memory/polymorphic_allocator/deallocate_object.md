...
template< class U >  
void deallocate_object( U* p, [std::size_t](../../types/size_t.html) n = 1 ); |  |  (since C++20)  
---|---|---  
| |   
  
Deallocates the storage pointed to by p, which must have been allocated from a [std::pmr::memory_resource](../memory_resource.html "cpp/memory/memory resource") x that compares equal to *resource(), using x.allocate(n * sizeof(U), alignof(U)), typically through a call to allocate_object<U>(n). 

Equivalent to deallocate_bytes(p, n * sizeof(U), alignof(U));. 

## Contents

  * [1 Parameters](deallocate_object.html#Parameters)
  * [2 Exceptions](deallocate_object.html#Exceptions)
  * [3 Notes](deallocate_object.html#Notes)
  * [4 See also](deallocate_object.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic_allocator/deallocate_object&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  pointer to memory to deallocate   
---|---|---  
n  |  \-  |  number of objects of type U the memory was for   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic_allocator/deallocate_object&action=edit&section=2 "Edit section: Exceptions")] Exceptions

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic_allocator/deallocate_object&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic_allocator/deallocate_object&action=edit&section=4 "Edit section: See also")] See also

[ deallocate_bytes](deallocate_bytes.html "cpp/memory/polymorphic allocator/deallocate bytes")(C++20) |  free raw memory obtained from `allocate_bytes`   
