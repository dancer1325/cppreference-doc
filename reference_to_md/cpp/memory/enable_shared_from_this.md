...
---  
[enable_shared_from_this::enable_shared_from_this](enable_shared_from_this/enable_shared_from_this.html "cpp/memory/enable shared from this/enable shared from this")  
[enable_shared_from_this::~enable_shared_from_this](enable_shared_from_this/~enable_shared_from_this.html "cpp/memory/enable shared from this/~enable shared from this")  
[enable_shared_from_this::operator=](enable_shared_from_this/operator=.html "cpp/memory/enable shared from this/operator=")  
...
---|---|---  
template< class T >  
class enable_shared_from_this; |  |  (since C++11)  
| |   
  
`std::enable_shared_from_this` allows an object t that is currently managed by a [std::shared_ptr](shared_ptr.html "cpp/memory/shared ptr") named pt to safely generate additional [std::shared_ptr](shared_ptr.html "cpp/memory/shared ptr") instances pt1, pt2 etc. that all share ownership of t with pt. 

Publicly inheriting from `std::enable_shared_from_this<T>` provides the type `T` with a member function `shared_from_this`. If an object t of type `T` is managed by a [std::shared_ptr](shared_ptr.html)<T> named pt, then calling `T::shared_from_this` will return a new [std::shared_ptr](shared_ptr.html)<T> that shares ownership of t with pt. 

## Contents

  * [1 Data members](enable_shared_from_this.html#Data_members)
  * [2 Member functions](enable_shared_from_this.html#Member_functions)
  * [3 Notes](enable_shared_from_this.html#Notes)
  * [4 Example](enable_shared_from_this.html#Example)
  * [5 Defect reports](enable_shared_from_this.html#Defect_reports)
  * [6 See also](enable_shared_from_this.html#See_also)
...
---|---  
[ (destructor)](enable_shared_from_this/~enable_shared_from_this.html "cpp/memory/enable shared from this/~enable shared from this") |  destroys an `enable_shared_from_this` object   
(protected member function)  
[ operator=](enable_shared_from_this/operator=.html "cpp/memory/enable shared from this/operator=") |  returns a reference to *this   
(protected member function)  
[ shared_from_this](enable_shared_from_this/shared_from_this.html "cpp/memory/enable shared from this/shared from this") |  returns a [std::shared_ptr](shared_ptr.html "cpp/memory/shared ptr") which shares ownership of *this   
...
It is permitted to call `shared_from_this` only on a previously shared object, i.e. on an object managed by [std::shared_ptr](shared_ptr.html)<T>. Otherwise, [std::bad_weak_ptr](bad_weak_ptr.html "cpp/memory/bad weak ptr") is thrown (by the [std::shared_ptr](shared_ptr.html "cpp/memory/shared ptr") constructor from a default-constructed `_weak_this_` ﻿). 
...
Run this code
    ...
    {
    public:
        [std::shared_ptr](shared_ptr.html)<Good> getptr()
        {
    ...
     
        ...
        static [std::shared_ptr](shared_ptr.html)<Best> create()
        {
            return [std::make_shared](shared_ptr/make_shared.html)<Best>(Private());
        }
     
        [std::shared_ptr](shared_ptr.html)<Best> getptr()
        {
            return shared_from_this();
        }
    };
    ...
    struct Bad
    {
        [std::shared_ptr](shared_ptr.html)<Bad> getptr()
        {
            return [std::shared_ptr](shared_ptr.html)<Bad>(this);
        }
        ~Bad() { [std::cout](../io/cout.html) << "Bad::~Bad() called\n"; }
    };
     
    void testGood()
    {
        // Good: the two shared_ptr's share the same object
        [std::shared_ptr](shared_ptr.html)<Good> good0 = [std::make_shared](shared_ptr/make_shared.html)<Good>();
        [std::shared_ptr](shared_ptr.html)<Good> good1 = good0->getptr();
        [std::cout](../io/cout.html) << "good1.use_count() = " << good1.use_count() << '\n';
    }
     
    void misuseGood()
    {
        ...
        {
            Good not_so_good;
            [std::shared_ptr](shared_ptr.html)<Good> gp1 = not_so_good.getptr();
        }
        catch ([std::bad_weak_ptr](bad_weak_ptr.html)& e)
        {
    ...
    void testBest()
    {
        ...
        [std::shared_ptr](shared_ptr.html)<Best> best0 = Best::create();
        [std::shared_ptr](shared_ptr.html)<Best> best1 = best0->getptr();
        [std::cout](../io/cout.html) << "best1.use_count() = " << best1.use_count() << '\n';
     
    ...
    void testBad()
    {
        ...
        [std::shared_ptr](shared_ptr.html)<Bad> bad0 = [std::make_shared](shared_ptr/make_shared.html)<Bad>();
        [std::shared_ptr](shared_ptr.html)<Bad> bad1 = bad0->getptr();
        [std::cout](../io/cout.html) << "bad1.use_count() = " << bad1.use_count() << '\n';
...
([P0033R1](https://wg21.link/P0033R1))  | C++11  | given type `T` derived from `enable_shared_from_this`, the behavior of  
constructing two [std::shared_ptr](shared_ptr.html)<T>s from the same T* object was unclear  | the behavior is  
