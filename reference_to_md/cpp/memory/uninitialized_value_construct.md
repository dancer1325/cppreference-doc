...
1) Constructs objects of type typename [std::iterator_traits](../iterator/iterator_traits.html)<NoThrowForwardIt>::value_type in the uninitialized memory area `[`first`, `last`)` by [value-initialization](../language/value_initialization.html "cpp/language/value initialization"), as if by 
...
## Contents
  ...
  * [2 Complexity](uninitialized_value_construct.html#Complexity)
  * [3 Exceptions](uninitialized_value_construct.html#Exceptions)
  * [4 Notes](uninitialized_value_construct.html#Notes)
  * [5 Possible implementation](uninitialized_value_construct.html#Possible_implementation)
  * [6 Example](uninitialized_value_construct.html#Example)
  * [7 Defect reports](uninitialized_value_construct.html#Defect_reports)
  * [8 See also](uninitialized_value_construct.html#See_also)
...
Run this code
    ...
     
        ...
        std::uninitialized_value_construct([std::begin](../iterator/begin.html)(v), [std::end](../iterator/end.html)(v));
        for (const int i : v)
            [std::cout](../io/cout.html) << i << ' ';
        [std::cout](../io/cout.html) << '\n';
    }
