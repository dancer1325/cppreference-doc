...
---|---|---  
template< class T >  
T* addressof( T& arg ) noexcept; |  (1)  |  (since C++11)   
...
The expression `std::addressof(e)` is a [constant subexpression](../language/constant_expression.html "cpp/language/constant expression"), if e is an lvalue constant subexpression.  | (since C++17)  
---|---  
  
## Contents

  * [1 Parameters](addressof.html#Parameters)
  * [2 Return value](addressof.html#Return_value)
  * [3 Possible implementation](addressof.html#Possible_implementation)
  * [4 Notes](addressof.html#Notes)
  * [5 Example](addressof.html#Example)
  * [6 Defect reports](addressof.html#Defect_reports)
  * [7 See also](addressof.html#See_also)
...
The implementation below is not constexpr, because reinterpret_cast is not usable in a constant expression. Compiler support is needed (see below). 
    ...
    template<class T>
    typename [std::enable_if](../types/enable_if.html)<[std::is_object](../types/is_object.html)<T>::value, T*>::type addressof(T& arg) noexcept
    {
...
---|---|---|---  
[`__cpp_lib_addressof_constexpr`](../experimental/feature_test.html#cpp_lib_addressof_constexpr "cpp/feature test") | [`201603L`](../compiler_support/17.html#cpp_lib_addressof_constexpr_201603L "cpp/compiler support/17") | (C++17) | constexpr `std::addressof`  
...
There are some weird cases where use of built-in operator& is ill-formed due to [argument-dependent lookup](../language/adl.html "cpp/language/adl") even if it is not overloaded, and `std::addressof` can be used instead. 
...
Run this code
    ...
    struct Ptr
    {
        ...
        {
            [std::cout](../io/cout.html) << "Ctor this = " << this << '\n';
        }
     
        ~Ptr() { delete data; }
    ...
    void f(Ptr<T>* p)
    {
        [std::cout](../io/cout.html) << "Ptr   overload called with p = " << p << '\n';
    }
     
    void f(int** p)
    {
        [std::cout](../io/cout.html) << "int** overload called with p = " << p << '\n';
    }
     
    int main()
    {
