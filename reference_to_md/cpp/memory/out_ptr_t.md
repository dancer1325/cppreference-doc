...
Member functions  
---  
[out_ptr_t::out_ptr_t](out_ptr_t/out_ptr_t.html "cpp/memory/out ptr t/out ptr t")  
[out_ptr_t::~out_ptr_t](out_ptr_t/~out_ptr_t.html "cpp/memory/out ptr t/~out ptr t")  
[out_ptr_t::operator Pointer*out_ptr_t::operator void**](out_ptr_t/operator_ptr.html "cpp/memory/out ptr t/operator ptr")  
Non-member functions  
[out_ptr](out_ptr_t/out_ptr.html "cpp/memory/out ptr t/out ptr")  
...
## Contents
  ...
  * [1 Template parameters](out_ptr_t.html#Template_parameters)
  * [2 Specializations](out_ptr_t.html#Specializations)
  * [3 Member functions](out_ptr_t.html#Member_functions)
  * [4 Non-member functions](out_ptr_t.html#Non-member_functions)
  * [5 Notes](out_ptr_t.html#Notes)
  * [6 Example](out_ptr_t.html#Example)
  * [7 See also](out_ptr_t.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/out_ptr_t&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
-The program is ill-formed if `Smart` is a [std::shared_ptr](shared_ptr.html "cpp/memory/shared ptr") specialization and sizeof...(Args) == 0.   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/out_ptr_t&action=edit&section=2 "Edit section: Specializations")] Specializations

Unlike most class templates in the standard library, [program-defined specializations](../language/type-id.html#Program-defined_type "cpp/language/type") of `out_ptr_t` that depend on at least one [program-defined type](../language/type-id.html#Program-defined_type "cpp/language/type") need not meet the requirements for the primary template. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/out_ptr_t&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](out_ptr_t/out_ptr_t.html "cpp/memory/out ptr t/out ptr t")(C++23) |  constructs an `out_ptr_t`   
(public member function)  
---|---  
operator=[deleted](C++23) |  `out_ptr_t` is not assignable   
(public member function)  
[ (destructor)](out_ptr_t/~out_ptr_t.html "cpp/memory/out ptr t/~out ptr t")(C++23) |  resets the adapted smart pointer   
(public member function)  
[ operator Pointer*operator void**](out_ptr_t/operator_ptr.html "cpp/memory/out ptr t/operator ptr")(C++23) |  converts the `out_ptr_t` to the address of the storage for output   
(public member function)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/out_ptr_t&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ out_ptr](out_ptr_t/out_ptr.html "cpp/memory/out ptr t/out ptr")(C++23) |  creates an `out_ptr_t` with an associated smart pointer and resetting arguments   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/out_ptr_t&action=edit&section=5 "Edit section: Notes")] Notes
...
The typical usage of `out_ptr_t` is creating its temporary objects by std::out_ptr, which resets the adapted smart pointer immediately. E.g. given a setter function and a smart pointer of appropriate type declared with int foreign_setter(T**); and [std::unique_ptr](unique_ptr.html)<T, D> up; respectively, 
    
    
    int foreign_setter(T**);
    [std::unique_ptr](unique_ptr.html)<T, D> up;
     
    if (int ec = foreign_setter([std::out_ptr](out_ptr_t/out_ptr.html)(up)))
        return ec;
...
It is not recommended to create an `out_ptr_t` object of a [storage duration](../language/storage_duration.html "cpp/language/storage duration") other than automatic storage duration, because such code is likely to produce dangling references and result in undefined behavior on destruction. 

`out_ptr_t` forbids the usage that would reset a [std::shared_ptr](shared_ptr.html "cpp/memory/shared ptr") without specifying a deleter, because it would call [std::shared_ptr::reset](shared_ptr/reset.html "cpp/memory/shared ptr/reset") and replace a custom deleter later. 

Captured arguments are typically packed into a [std::tuple](../utility/tuple.html)<Args...>. Implementations may use different mechanism to provide the `Pointer` or void* object they need hold. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/out_ptr_t&action=edit&section=6 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/out_ptr_t&action=edit&section=7 "Edit section: See also")] See also

[ inout_ptr_t](inout_ptr_t.html "cpp/memory/inout ptr t")(C++23) |  interoperates with foreign pointer setters, obtains the initial pointer value from a smart pointer, and resets it on destruction   
