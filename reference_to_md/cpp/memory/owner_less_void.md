...
---|---|---  
template<>  
struct owner_less<void>; |  |  (since C++17)  
| |   
  
[std::owner_less](owner_less.html)<void> is a specialization of [std::owner_less](owner_less.html "cpp/memory/owner less") with parameter types deduced. 

## Contents

  * [1 Nested types](owner_less_void.html#Nested_types)
  * [2 Member functions](owner_less_void.html#Member_functions)
  * [3 std::owner_less<void>::operator()](owner_less_void.html#std::owner_less.3Cvoid.3E::operator.28.29)
    * [3.1 Parameters](owner_less_void.html#Parameters)
    * [3.2 Return value](owner_less_void.html#Return_value)
    * [3.3 Notes](owner_less_void.html#Notes)
    * [3.4 See also](owner_less_void.html#See_also)
...
const [std::shared_ptr](shared_ptr.html)<U>& rhs ) const noexcept; |  |  (since C++17)  
---|---|---  
template< class T, class U >  
bool operator()( const [std::shared_ptr](shared_ptr.html)<T>& lhs,  
const [std::weak_ptr](weak_ptr.html)<U>& rhs ) const noexcept; |  |  (since C++17)  
template< class T, class U >  
