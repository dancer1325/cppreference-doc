...
Size count, const T& value ); |  (1) | (constexpr since C++26)  
...
## Contents
  ...
  * [1 Parameters](uninitialized_fill_n.html#Parameters)
  * [2 Return value](uninitialized_fill_n.html#Return_value)
  * [3 Complexity](uninitialized_fill_n.html#Complexity)
  * [4 Exceptions](uninitialized_fill_n.html#Exceptions)
  * [5 Notes](uninitialized_fill_n.html#Notes)
  * [6 Possible implementation](uninitialized_fill_n.html#Possible_implementation)
  * [7 Example](uninitialized_fill_n.html#Example)
  * [8 Defect reports](uninitialized_fill_n.html#Defect_reports)
  * [9 See also](uninitialized_fill_n.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_fill_n&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_fill_n&action=edit&section=2 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_fill_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in count. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_fill_n&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_fill_n&action=edit&section=5 "Edit section: Notes")] Notes

[Feature-test](../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_raw_memory_algorithms`](../experimental/feature_test.html#cpp_lib_raw_memory_algorithms "cpp/feature test") | [`202411L`](../compiler_support/26.html#cpp_lib_raw_memory_algorithms_202411L "cpp/compiler support/26") | (C++26) | constexpr for [specialized memory algorithms](../memory.html#Uninitialized_memory_algorithms "cpp/memory"), ([1](uninitialized_fill_n.html#Version_1))  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_fill_n&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
    ...
    {
        using V = typename [std::iterator_traits](../iterator/iterator_traits.html)<NoThrowForwardIt>::value_type;
        NoThrowForwardIt current = first;
        try
        {
            for (; count > 0; ++current, (void) --count)
                ::new (static_cast<void*>([std::addressof](addressof.html)(*current))) V(value);
            return current;
        }
        catch (...)
        {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_fill_n&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::string](../string/basic_string.html)* p;
        [std::size_t](../types/size_t.html) sz;
        [std::tie](../utility/tuple/tie.html)(p, sz) = [std::get_temporary_buffer](get_temporary_buffer.html)<[std::string](../string/basic_string.html)>(4);
        std::uninitialized_fill_n(p, sz, "Example");
     
        for ([std::string](../string/basic_string.html)* i = p; i != p + sz; ++i)
        {
            [std::cout](../io/cout.html) << *i << '\n';
            i->~basic_string<char>();
        }
        [std::return_temporary_buffer](return_temporary_buffer.html)(p);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_fill_n&action=edit&section=8 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 866](https://cplusplus.github.io/LWG/issue866) | C++98  | given `T` as the value type of `NoThrowForwardIt`, if  
T::[operator new](new/operator_new.html) exists, the program might be ill-formed  | uses global placement new instead   
[LWG 1339](https://cplusplus.github.io/LWG/issue1339) | C++98  | the location of the first element following  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_fill_n&action=edit&section=9 "Edit section: See also")] See also
...
---|---  
[ ranges::uninitialized_fill_n](ranges/uninitialized_fill_n.html "cpp/memory/ranges/uninitialized fill n")(C++20) |  copies an object to an uninitialized area of memory, defined by a start and a count  
