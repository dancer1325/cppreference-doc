...
If the above is not possible (e.g., `Alloc` does not have the member function `max_size()`), then returns [std::numeric_limits](../../types/numeric_limits.html)<size_type>::max() / sizeof(value_type). 

## Contents

  * [1 Parameters](max_size.html#Parameters)
  * [2 Return value](max_size.html#Return_value)
  * [3 Defect reports](max_size.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        [std::allocator](../allocator.html)<short> b;
        [std::allocator](../allocator.html)<int> d;
     
        const auto p = [std::allocator_traits](../allocator_traits.html)<decltype(b)>::max_size(b);
        const auto q = [std::allocator_traits](../allocator_traits.html)<decltype(d)>::max_size(d);
     
        ...
        [std::cout](../../io/cout.html) << [std::uppercase](../../io/manip/uppercase.html)
                  << "p = " << [std::dec](../../io/manip/hex.html) << p << " = 0x" << [std::hex](../../io/manip/hex.html) << p << '\n'
                  << "q = " << [std::dec](../../io/manip/hex.html) << q << " = 0x" << [std::hex](../../io/manip/hex.html) << q << '\n';
    }
