...
Member functions  
---  
[raw_storage_iterator::raw_storage_iterator](raw_storage_iterator.html "cpp/memory/raw storage iterator/raw storage iterator")  
[raw_storage_iterator::operator=](operator=.html "cpp/memory/raw storage iterator/operator=")  
[raw_storage_iterator::operator*](operator*.html "cpp/memory/raw storage iterator/operator*")  
[raw_storage_iterator::base](base.html "cpp/memory/raw storage iterator/base")(C++17)  
**raw_storage_iterator::operator++ raw_storage_iterator::operator++(int)**  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/raw_storage_iterator/operator_arith&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/raw_storage_iterator/operator_arith&action=edit&section=2 "Edit section: Return value")] Return value
