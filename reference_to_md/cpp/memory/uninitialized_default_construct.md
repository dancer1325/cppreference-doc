...
NoThrowForwardIt last ); |  (1) | (since C++17)   
(constexpr since C++26)  
template< class ExecutionPolicy, class NoThrowForwardIt >  
void uninitialized_default_construct( ExecutionPolicy&& policy,  
NoThrowForwardIt first,  
NoThrowForwardIt last ); |  (2)  |  (since C++17)  
| |   
  
1) Constructs objects of type typename [std::iterator_traits](../iterator/iterator_traits.html)<NoThrowForwardIt>::value_type in the uninitialized memory area `[`first`, `last`)` by [default-initialization](../language/default_initialization.html "cpp/language/default initialization"), as if by 
...
## Contents
  ...
  * [2 Complexity](uninitialized_default_construct.html#Complexity)
  * [3 Exceptions](uninitialized_default_construct.html#Exceptions)
  * [4 Notes](uninitialized_default_construct.html#Notes)
  * [5 Possible implementation](uninitialized_default_construct.html#Possible_implementation)
  * [6 Example](uninitialized_default_construct.html#Example)
  * [7 Defect reports](uninitialized_default_construct.html#Defect_reports)
  * [8 See also](uninitialized_default_construct.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct&action=edit&section=2 "Edit section: Complexity")] Complexity

Linear in the distance between first and last. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct&action=edit&section=4 "Edit section: Notes")] Notes

[Feature-test](../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_raw_memory_algorithms`](../experimental/feature_test.html#cpp_lib_raw_memory_algorithms "cpp/feature test") | [`202411L`](../compiler_support/26.html#cpp_lib_raw_memory_algorithms_202411L "cpp/compiler support/26") | (C++26) | constexpr for [specialized memory algorithms](../memory.html#Uninitialized_memory_algorithms "cpp/memory"), ([1](uninitialized_default_construct.html#Version_1))  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
    ...
    {
        using Value = typename [std::iterator_traits](../iterator/iterator_traits.html)<NoThrowForwardIt>::value_type;
        NoThrowForwardIt current = first;
        try
        {
            for (; current != last; ++current)
            {
                ::new (static_cast<void*>([std::addressof](addressof.html)(*current))) Value;
            }
        }
        catch (...)
        {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        std::uninitialized_default_construct([std::begin](../iterator/begin.html)(v), [std::end](../iterator/end.html)(v));
     
    ...
     
        ...
        [std::cout](../io/cout.html) <<
            ([std::memcmp](../string/byte/memcmp.html)(v, original, sizeof(v)) == 0 ? "Unmodified\n" : "Modified\n");
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct&action=edit&section=7 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_default_construct&action=edit&section=8 "Edit section: See also")] See also
