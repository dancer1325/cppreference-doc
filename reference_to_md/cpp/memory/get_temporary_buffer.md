...
---|---|---  
template< class T >  
[std::pair](../utility/pair.html)<T*, [std::ptrdiff_t](../types/ptrdiff_t.html)>  
get_temporary_buffer( [std::ptrdiff_t](../types/ptrdiff_t.html) count ); |  |  (until C++11)  
template< class T >  
[std::pair](../utility/pair.html)<T*, [std::ptrdiff_t](../types/ptrdiff_t.html)>  
get_temporary_buffer( [std::ptrdiff_t](../types/ptrdiff_t.html) count ) noexcept; |  |  (since C++11)   
(deprecated in C++17)   
(removed in C++20)  
| |   
...
It is implementation-defined whether [over-aligned](../language.html#object.23Alignment "cpp/language") types are supported.  | (since C++11)  
---|---  
  
## Contents

  * [1 Parameters](get_temporary_buffer.html#Parameters)
  * [2 Return value](get_temporary_buffer.html#Return_value)
  * [3 Notes](get_temporary_buffer.html#Notes)
  * [4 Example](get_temporary_buffer.html#Example)
  * [5 Defect reports](get_temporary_buffer.html#Defect_reports)
  * [6 See also](get_temporary_buffer.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        const auto p = std::get_temporary_buffer<[std::string](../string/basic_string.html)>(4);
