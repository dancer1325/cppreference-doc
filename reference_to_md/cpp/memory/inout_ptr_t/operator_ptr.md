...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/inout_ptr_t/operator_ptr&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/inout_ptr_t/operator_ptr&action=edit&section=2 "Edit section: Return value")] Return value

1) The address of stored `Pointer` object.

2) The address of the void* object that satisfies aforementioned requirements.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/inout_ptr_t/operator_ptr&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/inout_ptr_t/operator_ptr&action=edit&section=4 "Edit section: Example")] Example
