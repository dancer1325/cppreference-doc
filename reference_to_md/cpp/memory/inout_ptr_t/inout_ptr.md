...
## Contents
  ...
  * [1 Parameters](inout_ptr.html#Parameters)
  * [2 Return value](inout_ptr.html#Return_value)
  * [3 Notes](inout_ptr.html#Notes)
  * [4 Example](inout_ptr.html#Example)
  * [5 See also](inout_ptr.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/inout_ptr_t/inout_ptr&action=edit&section=1 "Edit section: Parameters")] Parameters

s  |  \-  |  the object (typically a smart pointer) to adapt   
---|---|---  
args...  |  \-  |  the arguments for resetting to capture   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/inout_ptr_t/inout_ptr&action=edit&section=2 "Edit section: Return value")] Return value

[std::inout_ptr_t](../inout_ptr_t.html)<Smart, P, Args&&>(s, [std::forward](../../utility/forward.html)<Args>(args)...), where `P` is 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/inout_ptr_t/inout_ptr&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/inout_ptr_t/inout_ptr&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/inout_ptr_t/inout_ptr&action=edit&section=5 "Edit section: See also")] See also
