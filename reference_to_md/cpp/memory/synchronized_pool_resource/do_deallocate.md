...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/synchronized_pool_resource/do_deallocate&action=edit&section=1 "Edit section: Exceptions")] Exceptions 

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/synchronized_pool_resource/do_deallocate&action=edit&section=2 "Edit section: See also")] See also 
