...
---|---|---  
static element_type* to_address( pointer p ) noexcept; |  |  (since C++20)   
(optional member of program-defined specialization)  
| |   
  
Constructs a raw pointer that references the same object as its pointer-like (["fancy pointer"](../../named_req/Allocator.html#Fancy_pointers "cpp/named req/Allocator")) argument. 
