...
[allocator_traits::allocate](allocator_traits/allocate.html "cpp/memory/allocator traits/allocate")  
[allocator_traits::allocate_at_least](allocator_traits/allocate_at_least.html "cpp/memory/allocator traits/allocate at least")(C++23)  
[allocator_traits::deallocate](allocator_traits/deallocate.html "cpp/memory/allocator traits/deallocate")  
[allocator_traits::construct](allocator_traits/construct.html "cpp/memory/allocator traits/construct")  
[allocator_traits::destroy](allocator_traits/destroy.html "cpp/memory/allocator traits/destroy")  
...
The `allocator_traits` class template provides the standardized way to access various properties of [Allocators](../named_req/Allocator.html "cpp/named req/Allocator"). The standard containers and other standard library components access allocators through this template. 

It is possible to use any class type as an allocator, as long as the user-provided specialization of `std::allocator_traits` implements all required functionality.  | (until C++23)  
---|---  
...
## Contents
  ...
  * [1 Member types](allocator_traits.html#Member_types)
  * [2 Member alias templates](allocator_traits.html#Member_alias_templates)
  * [3 Member functions](allocator_traits.html#Member_functions)
  * [4 Defect reports](allocator_traits.html#Defect_reports)
  * [5 See also](allocator_traits.html#See_also)
...
`const_pointer` |  `Alloc::const_pointer` if present, otherwise [std::pointer_traits](pointer_traits.html)<pointer>::rebind<const value_type>  
`void_pointer` |  `Alloc::void_pointer` if present, otherwise [std::pointer_traits](pointer_traits.html)<pointer>::rebind<void>  
`const_void_pointer` |  `Alloc::const_void_pointer` if present, otherwise [std::pointer_traits](pointer_traits.html)<pointer>::rebind<const void>  
`difference_type` |  `Alloc::difference_type` if present, otherwise [std::pointer_traits](pointer_traits.html)<pointer>::difference_type  
`size_type` |  `Alloc::size_type` if present, otherwise [std::make_unsigned](../types/make_unsigned.html)<difference_type>::type  
`propagate_on_container_copy_assignment` |  `Alloc::propagate_on_container_copy_assignment` if present, otherwise [std::false_type](../types/integral_constant.html "cpp/types/integral constant")  
`propagate_on_container_move_assignment` |  `Alloc::propagate_on_container_move_assignment` if present, otherwise [std::false_type](../types/integral_constant.html "cpp/types/integral constant")  
