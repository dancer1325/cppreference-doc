...
Member functions  
---  
[inout_ptr_t::inout_ptr_t](inout_ptr_t/inout_ptr_t.html "cpp/memory/inout ptr t/inout ptr t")  
[inout_ptr_t::~inout_ptr_t](inout_ptr_t/~inout_ptr_t.html "cpp/memory/inout ptr t/~inout ptr t")  
[inout_ptr_t::operator Pointer*inout_ptr_t::operator void**](inout_ptr_t/operator_ptr.html "cpp/memory/inout ptr t/operator ptr")  
...
## Contents
  ...
  * [1 Template parameters](inout_ptr_t.html#Template_parameters)
  * [2 Specializations](inout_ptr_t.html#Specializations)
  * [3 Member functions](inout_ptr_t.html#Member_functions)
  * [4 Non-member functions](inout_ptr_t.html#Non-member_functions)
  * [5 Notes](inout_ptr_t.html#Notes)
  * [6 Example](inout_ptr_t.html#Example)
  * [7 See also](inout_ptr_t.html#See_also)
...
---|---  
operator=[deleted](C++23) |  `inout_ptr_t` is not assignable   
(public member function)  
[ (destructor)](inout_ptr_t/~inout_ptr_t.html "cpp/memory/inout ptr t/~inout ptr t")(C++23) |  resets the adapted smart pointer after releasing its ownership   
(public member function)  
...
The typical usage of `inout_ptr_t` is creating its temporary objects by std::inout_ptr, which resets the adapted smart pointer immediately. E.g. given a setter function and a smart pointer of appropriate type declared with int foreign_resetter(T**); and [std::unique_ptr](unique_ptr.html)<T, D> up; respectively, 
    
    
    if (int ec = foreign_resetter([std::inout_ptr](inout_ptr_t/inout_ptr.html)(up)))
        return ec;
...
It is not recommended to create an `inout_ptr_t` object of a [storage duration](../language/storage_duration.html "cpp/language/storage duration") other than automatic storage duration, because such code is likely to produce dangling references and result in undefined behavior on destruction. 
