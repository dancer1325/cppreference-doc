...
If p is not a pointer value returned by an earlier call to [std::get_temporary_buffer](get_temporary_buffer.html "cpp/memory/get temporary buffer"), or has been invalidated by an intervening `std::return_temporary_buffer` call, the behavior is undefined. 

## Contents

  * [1 Parameters](return_temporary_buffer.html#Parameters)
  * [2 Return value](return_temporary_buffer.html#Return_value)
  * [3 Exceptions](return_temporary_buffer.html#Exceptions)
  * [4 Example](return_temporary_buffer.html#Example)
  * [5 Defect reports](return_temporary_buffer.html#Defect_reports)
  * [6 See also](return_temporary_buffer.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/return_temporary_buffer&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  the pointer referring to the storage to be declloated   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/return_temporary_buffer&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/return_temporary_buffer&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/return_temporary_buffer&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        const [std::string](../string/basic_string.html) s[] = {"string", "1", "test", "..."};
        const auto p = [std::get_temporary_buffer](get_temporary_buffer.html)<[std::string](../string/basic_string.html)>(4);
        // requires that p.first is passed to return_temporary_buffer
        // (beware of early exit points and exceptions), or better use:
        [std::unique_ptr](unique_ptr.html)<[std::string](../string/basic_string.html), void(*)([std::string](../string/basic_string.html)*)> on_exit(p.first,
        []([std::string](../string/basic_string.html)* p)
        {
            [std::cout](../io/cout.html) << "returning temporary buffer...\n";
            std::return_temporary_buffer(p);
        });
     
        [std::copy](../algorithm/copy.html)(s, s + p.second,
                  [std::raw_storage_iterator](raw_storage_iterator.html)<[std::string](../string/basic_string.html)*, [std::string](../string/basic_string.html)>(p.first));
        // has same effect as: std::uninitialized_copy(s, s + p.second, p.first);
        // requires that each string in p is individually destroyed
        // (beware of early exit points and exceptions)
     
        [std::copy](../algorithm/copy.html)(p.first, p.first + p.second,
                  [std::ostream_iterator](../iterator/ostream_iterator.html)<[std::string](../string/basic_string.html)>{[std::cout](../io/cout.html), "\n"});
     
        [std::for_each](../algorithm/for_each.html)(p.first, p.first + p.second, []([std::string](../string/basic_string.html)& e)
        {
            e.~basic_string<char>();
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/return_temporary_buffer&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2072](https://cplusplus.github.io/LWG/issue2072) | C++98  | the storage allocated by [std::get_temporary_buffer](get_temporary_buffer.html "cpp/memory/get temporary buffer")  
could be deallocated multiple times  | the behavior is  
undefined in this case   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/return_temporary_buffer&action=edit&section=6 "Edit section: See also")] See also
