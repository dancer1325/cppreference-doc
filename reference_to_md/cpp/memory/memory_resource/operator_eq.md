...
---|---|---  
bool operator==( const [std::pmr::memory_resource](../memory_resource.html)& a,  
const [std::pmr::memory_resource](../memory_resource.html)& b ) noexcept; |  (1)  |  (since C++17)  
bool operator!=( const [std::pmr::memory_resource](../memory_resource.html)& a,  
const [std::pmr::memory_resource](../memory_resource.html)& b ) noexcept; |  (2)  |  (since C++17)   
(until C++20)  
| |   
