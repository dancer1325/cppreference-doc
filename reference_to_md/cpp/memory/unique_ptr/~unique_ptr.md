...
If [get()](get.html "cpp/memory/unique ptr/get") `==` nullptr there are no effects. Otherwise, the owned object is destroyed via [get_deleter()](get_deleter.html "cpp/memory/unique ptr/get deleter")`(`[get()](get.html "cpp/memory/unique ptr/get")`)`. 
...
Run this code
    ...
    int main () 
    {
        ...
        {
            [std::cout](../../io/cout.html) << "[deleter called]\n";
            delete ptr;
        };
     
        [std::unique_ptr](../unique_ptr.html)<int, decltype(deleter)> uniq(new int, deleter);
        [std::cout](../../io/cout.html) << (uniq ? "not empty\n" : "empty\n");
        uniq.reset();
        [std::cout](../../io/cout.html) << (uniq ? "not empty\n" : "empty\n");
    }
