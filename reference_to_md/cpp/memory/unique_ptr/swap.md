...
Run this code
    ...
    int main()
    {
        [std::unique_ptr](../unique_ptr.html)<Foo> up1(new Foo(1));
        [std::unique_ptr](../unique_ptr.html)<Foo> up2(new Foo(2));
     
        up1.swap(up2);
     
        [std::cout](../../io/cout.html) << "up1->val:" << up1->val << '\n';
        [std::cout](../../io/cout.html) << "up2->val:" << up2->val << '\n';
    }
