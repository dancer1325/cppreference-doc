...
[unsynchronized_pool_resource::do_allocate](do_allocate.html "cpp/memory/unsynchronized pool resource/do allocate")  
...
---|---|---  
explicit unsynchronized_pool_resource( [std::pmr::memory_resource](../memory_resource.html)* upstream ); |  (2)  |  (since C++17)  
explicit unsynchronized_pool_resource( const [std::pmr::pool_options](../pool_options.html)& opts ); |  (3)  |  (since C++17)  
unsynchronized_pool_resource( const [std::pmr::pool_options](../pool_options.html)& opts,  
...
The overloads not taking opts as a parameter uses a default constructed instance of [`pool_options`](../pool_options.html "cpp/memory/pool options") as the options. The overloads not taking upstream as a parameter use the return value of [std::pmr::get_default_resource](../get_default_resource.html)() as the upstream memory resource.

5) Copy constructor is deleted.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/unsynchronized_pool_resource/unsynchronized_pool_resource&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/unsynchronized_pool_resource/unsynchronized_pool_resource&action=edit&section=2 "Edit section: Exceptions")] Exceptions
