...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/unsynchronized_pool_resource/release&action=edit&section=1 "Edit section: See also")] See also 
