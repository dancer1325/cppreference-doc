...
Releases all allocated memory by calling the `deallocate` function on the upstream memory resource as necessary. Resets _current buffer_ and _next buffer size_ to their initial values at construction. 
