...
Compare *this with other for identity - memory allocated using a [`monotonic_buffer_resource`](../monotonic_buffer_resource.html "cpp/memory/monotonic buffer resource") can only be deallocated using that same resource. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/monotonic_buffer_resource/do_is_equal&action=edit&section=1 "Edit section: Return value")] Return value

this == &other

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/monotonic_buffer_resource/do_is_equal&action=edit&section=2 "Edit section: Defect report")] Defect report
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/monotonic_buffer_resource/do_is_equal&action=edit&section=3 "Edit section: See also")] See also
