...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic/valueless_after_move&action=edit&section=1 "Edit section: Return value")] Return value

true if *this is valueless, otherwise false. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/polymorphic/valueless_after_move&action=edit&section=2 "Edit section: Example")] Example
