...
If *this is not valueless, destroys the owned object using [std::allocator_traits](../allocator_traits.html)<Allocator>::destroy and then the storage is deallocated. 
