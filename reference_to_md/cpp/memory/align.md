...
---|---|---  
void* align( [std::size_t](../types/size_t.html) alignment,  
[std::size_t](../types/size_t.html) size,  
void*& ptr,  
[std::size_t](../types/size_t.html)& space ); |  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Parameters](align.html#Parameters)
  * [2 Return value](align.html#Return_value)
  * [3 Example](align.html#Example)
  * [4 Defect reports](align.html#Defect_reports)
  * [5 See also](align.html#See_also)
...
Run this code
    ...
    struct MyAllocator
    {
        [std::byte](../types/byte.html) data[N];
        [std::size_t](../types/size_t.html) sz{N};
        void* p{data};
     
        MyAllocator() = default;
     
        ...
        template<typename T>
        T* implicit_aligned_alloc([std::size_t](../types/size_t.html) a = alignof(T))
        {
            if (std::align(a, sizeof(T), p, sz))
            {
                T* result = [std::launder](../utility/launder.html)(reinterpret_cast<T*>(p));
                p = static_cast<[std::byte](../types/byte.html)*>(p) + sizeof(T);
                sz -= sizeof(T);
                return result;
            }
            return nullptr;
    ...
    {
        MyAllocator<64> a;
        [std::cout](../io/cout.html) << "allocated a.data at " << (void*)a.data
                  << " (" << sizeof a.data << " bytes)\n";
     
        // Allocate a char
        ...
        {
            *p = 'a';
            [std::cout](../io/cout.html) << "allocated a char at " << (void*)p << '\n';
        }
     
        // Allocate an int
        ...
        {
            *p = 1;
            [std::cout](../io/cout.html) << "allocated an int at " << (void*)p << '\n';
        }
     
        ...
        {
            *p = 2;
            [std::cout](../io/cout.html) << "allocated an int at " << (void*)p << " (32-byte alignment)\n";
        }
    }
