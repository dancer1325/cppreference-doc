[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/memory/owner_equal&action=edit)
...
template< class Y >   
bool owner_equal( const [std::weak_ptr](../weak_ptr.html)<Y>& other ) const noexcept; |  (1)  |  (since C++26)  
---|---|---  
template< class Y >  
bool owner_equal( const [std::shared_ptr](../shared_ptr.html)<Y>& other ) const noexcept; |  (2)  |  (since C++26)  
| |   
...
## Contents
  ...
  * [1 Parameters](owner_equal.html#Parameters)
  * [2 Return value](owner_equal.html#Return_value)
  * [3 Notes](owner_equal.html#Notes)
  * [4 Example](owner_equal.html#Example)
  * [5 See also](owner_equal.html#See_also)
