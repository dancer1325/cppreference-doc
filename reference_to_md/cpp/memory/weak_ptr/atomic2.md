...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/weak_ptr/atomic2&action=edit&section=1 "Edit section: Member types")] Member types

Member type  |  Definition   
---|---  
`value_type` |  [std::weak_ptr](../weak_ptr.html)<T>  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/weak_ptr/atomic2&action=edit&section=2 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/weak_ptr/atomic2&action=edit&section=3 "Edit section: Member constants")] Member constants
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/weak_ptr/atomic2&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/weak_ptr/atomic2&action=edit&section=5 "Edit section: See also")] See also
