...
---|---|---  
Call signature |  |   
template< [no-throw-forward-range](nothrow_concepts.html) I, class T >  
requires [std::constructible_from](../../concepts/constructible_from.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>, const T&>  
I uninitialized_fill_n( I first, [std::iter_difference_t](../../iterator/iter_t.html)<I> count,  
const T& value ); |  | (since C++20)   
(constexpr since C++26)  
| |   
  
Copies value to an uninitialized memory area first` + ``[`​0​`, `count`)` as if by return [ranges::uninitialized_fill](uninitialized_fill.html)([std::counted_iterator](../../iterator/counted_iterator.html)(first, count),  
[std::default_sentinel](../../iterator/default_sentinel.html), value).base();
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_fill_n&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
    ...
    struct uninitialized_fill_n_fn
    {
        template<[no-throw-forward-range](nothrow_concepts.html) I, class T>
        requires [std::constructible_from](../../concepts/constructible_from.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>, const T&>
        I operator()(I first, [std::iter_difference_t](../../iterator/iter_t.html)<I> n, const T& x) const
        {
            I rollback{first};
            try
            {
                for (; n-- > 0; ++first)
                    [ranges::construct_at](construct_at.html)([std::addressof](../addressof.html)(*first), x);
                return first;
            }
