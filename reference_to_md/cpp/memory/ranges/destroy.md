...
---|---|---  
Call signature |  |   
template< [no-throw-input-iterator](nothrow_concepts.html) I, no-throw-sentinel-for<I> S >  
requires [std::destructible](../../concepts/destructible.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>>  
constexpr I destroy( I first, S last ) noexcept; |  (1)  |  (since C++20)  
template< [no-throw-input-range](nothrow_concepts.html) R >  
requires [std::destructible](../../concepts/destructible.html)<[ranges::range_value_t](../../ranges/range_size_t.html)<R>>  
constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R> destroy( R&& r ) noexcept; |  (2)  |  (since C++20)  
| |   
...
1) Destroys the objects in the range `[`first`, `last`)`, as if by 
    ...
    for (; first != last; ++first)
        std::[ranges::destroy_at](destroy_at.html)([std::addressof](../addressof.html)(*first));
    return first;
...
## Contents
  ...
  * [3 Complexity](destroy.html#Complexity)
  * [4 Possible implementation](destroy.html#Possible_implementation)
  * [5 Example](destroy.html#Example)
  * [6 See also](destroy.html#See_also)
...
### Possible implementation
    ...
     
        template<[no-throw-input-range](nothrow_concepts.html) R>
            requires [std::destructible](../../concepts/destructible.html)<std::[ranges::range_value_t](../../ranges/range_size_t.html)<R>>
        constexpr std::[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R> operator()(R&& r) const noexcept
        {
            return operator()(std::[ranges::begin](../../ranges/begin.html)(r), std::[ranges::end](../../ranges/end.html)(r));
        }
    };
     
