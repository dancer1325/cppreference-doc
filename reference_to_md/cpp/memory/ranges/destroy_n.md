...
---|---|---  
Call signature |  |   
template< [no-throw-input-iterator](nothrow_concepts.html) I >  
requires [std::destructible](../../concepts/destructible.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>>  
constexpr I destroy_n( I first, [std::iter_difference_t](../../iterator/iter_t.html)<I> n ) noexcept; |  |  (since C++20)  
| |   
  
Destroys the n objects in the range starting at first, equivalent to 
    
    
    return std::[ranges::destroy](destroy.html)([std::counted_iterator](../../iterator/counted_iterator.html)(first, n), [std::default_sentinel](../../iterator/default_sentinel.html)).base();
...
## Contents
  ...
  * [4 Possible implementation](destroy_n.html#Possible_implementation)
  * [5 Example](destroy_n.html#Example)
  * [6 See also](destroy_n.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/destroy_n&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct destroy_n_fn
    {
        template<[no-throw-input-iterator](nothrow_concepts.html) I>
            requires [std::destructible](../../concepts/destructible.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>>
        constexpr I operator()(I first, [std::iter_difference_t](../../iterator/iter_t.html)<I> n) const noexcept
        {
