...
---|---|---  
Call signature |  |   
template< [no-throw-forward-iterator](nothrow_concepts.html) I >  
...
[std::iter_difference_t](../../iterator/iter_t.html)<I> count ); |  | (since C++20)   
(constexpr since C++26)  
| |   
  
Constructs objects of type [std::iter_value_t](../../iterator/iter_t.html)<I> in the uninitialized memory area first` + ``[`​0​`, `count`)` by [default-initialization](../../language/default_initialization.html "cpp/language/default initialization"), as if by return [ranges::uninitialized_default_construct](uninitialized_default_construct.html)([std::counted_iterator](../../iterator/counted_iterator.html)(first, count),  
[std::default_sentinel](../../iterator/default_sentinel.html)).base();
...
## Contents
  ...
  * [1 Parameters](uninitialized_default_construct_n.html#Parameters)
  * [2 Return value](uninitialized_default_construct_n.html#Return_value)
  * [3 Complexity](uninitialized_default_construct_n.html#Complexity)
  * [4 Exceptions](uninitialized_default_construct_n.html#Exceptions)
  * [5 Notes](uninitialized_default_construct_n.html#Notes)
  * [6 Notes](uninitialized_default_construct_n.html#Notes_2)
  * [7 Possible implementation](uninitialized_default_construct_n.html#Possible_implementation)
  * [8 Example](uninitialized_default_construct_n.html#Example)
  * [9 Defect reports](uninitialized_default_construct_n.html#Defect_reports)
  * [10 See also](uninitialized_default_construct_n.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=1 "Edit section: Parameters")] Parameters

first  |  \-  |  the beginning of the range of elements to initialize   
---|---|---  
count  |  \-  |  the number of elements to construct   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=2 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in count. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=4 "Edit section: Exceptions")] Exceptions

Any exception thrown on construction of the elements in the destination range. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=6 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=7 "Edit section: Possible implementation")] Possible implementation
    ...
    struct uninitialized_default_construct_n_fn
    {
        template<[no-throw-forward-iterator](nothrow_concepts.html) I>
            requires [std::default_initializable](../../concepts/default_initializable.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>>
        constexpr I operator()(I first, [std::iter_difference_t](../../iterator/iter_t.html)<I> count) const
        {
            auto iter = [std::counted_iterator](../../iterator/counted_iterator.html)(first, count);
            return [ranges::uninitialized_default_construct](uninitialized_default_construct.html)(iter, [std::default_sentinel](../../iterator/default_sentinel.html)).base();
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=8 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        int v[]{1, 2, 3, 4, 5, 6};
        std::ranges::uninitialized_default_construct_n([std::begin](../../iterator/begin.html)(v), [std::size](../../iterator/size.html)(v));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=9 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_default_construct_n&action=edit&section=10 "Edit section: See also")] See also
...
[ uninitialized_default_construct_n](../uninitialized_default_construct_n.html "cpp/memory/uninitialized default construct n")(C++17) |  constructs objects by [default-initialization](../../language/default_initialization.html "cpp/language/default initialization") in an uninitialized area of memory, defined by a start and a count   
