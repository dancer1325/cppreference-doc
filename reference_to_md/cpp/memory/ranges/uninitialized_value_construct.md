...
I uninitialized_value_construct( I first, S last ); |  (1) | (since C++20)   
...
uninitialized_value_construct( R&& r ); |  (2) | (since C++20)   
(constexpr since C++26)  
| |   
  
1) Constructs objects of type [std::iter_value_t](../../iterator/iter_t.html)<I> in the uninitialized memory area `[`first`, `last`)` by [value-initialization](../../language/value_initialization.html "cpp/language/value initialization"), as if by 
...
2) Equivalent to ranges::uninitialized_value_construct([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r)).
...
## Contents
  ...
  * [1 Parameters](uninitialized_value_construct.html#Parameters)
  * [2 Return value](uninitialized_value_construct.html#Return_value)
  * [3 Complexity](uninitialized_value_construct.html#Complexity)
  * [4 Exceptions](uninitialized_value_construct.html#Exceptions)
  * [5 Notes](uninitialized_value_construct.html#Notes)
  * [6 Possible implementation](uninitialized_value_construct.html#Possible_implementation)
  * [7 Example](uninitialized_value_construct.html#Example)
  * [8 Defect reports](uninitialized_value_construct.html#Defect_reports)
  * [9 See also](uninitialized_value_construct.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to value-initialize   
---|---|---  
r  |  \-  |  the [`range`](../../ranges/range.html "cpp/ranges/range") of the elements to value-initialize   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct&action=edit&section=2 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in the distance between first and last. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct&action=edit&section=4 "Edit section: Exceptions")] Exceptions

Any exception thrown on construction of the elements in the destination range. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct&action=edit&section=5 "Edit section: Notes")] Notes

An implementation may improve the efficiency of the `ranges::uninitialized_value_construct`, e.g. by using [ranges::fill](../../algorithm/ranges/fill.html "cpp/algorithm/ranges/fill"), if the value type of the range is a [CopyAssignable](../../named_req/CopyAssignable.html "cpp/named req/CopyAssignable") [TrivialType](../../named_req/TrivialType.html "cpp/named req/TrivialType"). 

[Feature-test](../../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_raw_memory_algorithms`](../../experimental/feature_test.html#cpp_lib_raw_memory_algorithms "cpp/feature test") | [`202411L`](../../compiler_support/26.html#cpp_lib_raw_memory_algorithms_202411L "cpp/compiler support/26") | (C++26) | constexpr for [specialized memory algorithms](../../memory.html#Uninitialized_memory_algorithms "cpp/memory"), ([1,2](uninitialized_value_construct.html#Version_1))  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
    
    
    struct uninitialized_value_construct_fn
    {
        template<[no-throw-forward-iterator](nothrow_concepts.html) I, no-throw-sentinel-for<I> S>
            requires std::value_initializable<[std::iter_value_t](../../iterator/iter_t.html)<I>>
        constexpr I operator()(I first, S last) const
        {
            ...
            if constexpr ([std::is_trivially_default_constructible_v](../../types/is_default_constructible.html)<ValueType>)
                return [ranges::fill](../../algorithm/ranges/fill.html)(first, last, ValueType());
            I rollback{first};
            try
            {
                for (; !(first == last); ++first)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        for (const int i : v)
            [std::cout](../../io/cout.html) << ' ' << static_cast<char>(i + 'A');
        [std::cout](../../io/cout.html) << "\n ";
        std::ranges::uninitialized_value_construct([std::begin](../../iterator/begin.html)(v), [std::end](../../iterator/end.html)(v));
        for (const int i : v)
            [std::cout](../../io/cout.html) << ' ' << static_cast<char>(i + 'A');
        [std::cout](../../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct&action=edit&section=8 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct&action=edit&section=9 "Edit section: See also")] See also
...
---|---  
[ ranges::uninitialized_default_construct](uninitialized_default_construct.html "cpp/memory/ranges/uninitialized default construct")(C++20) |  constructs objects by [default-initialization](../../language/default_initialization.html "cpp/language/default initialization") in an uninitialized area of memory, defined by a range  
