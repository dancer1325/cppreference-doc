...
[no-throw-forward-iterator](nothrow_concepts.html) O, no-throw-sentinel-for<O> S >  
...
uninitialized_move_n( I ifirst, [std::iter_difference_t](../../iterator/iter_t.html)<I> count,  
O ofirst, S olast ); |  (1) | (since C++20)   
(constexpr since C++26)  
Helper types |  |   
template< class I, class O >  
using uninitialized_move_n_result = [ranges::in_out_result](../../algorithm/ranges/return_types/in_out_result.html)<I, O>; |  (2)  |  (since C++20)  
| |   
...
Copies \\(\scriptsize N\\)N elements from the range beginning at ifirst (using move semantics if supported) to an uninitialized memory area `[`ofirst`, `olast`)` as if by auto ret = [ranges::uninitialized_move](uninitialized_move.html)([std::counted_iterator](../../iterator/counted_iterator.html)(std::move(ifirst), count),  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_move_n&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
    ...
    struct uninitialized_move_n_fn
    {
            ...
            operator()(I ifirst, [std::iter_difference_t](../../iterator/iter_t.html)<I> count, O ofirst, S olast) const
        {
            ...
            auto ret = [ranges::uninitialized_move](uninitialized_move.html)(iter, [std::default_sentinel](../../iterator/default_sentinel.html), ofirst, olast);
            return {std::move(ret.in).base(), ret.out};
        }
    };
     
...
Run this code
    ...
    int main()
    {
        [std::string](../../string/basic_string.html) in[]{ "No", "Diagnostic", "Required", };
    ...
     
        ...
        )
        {
            try
            {
                ...
                auto last{first + sz};
                std::ranges::uninitialized_move_n([std::begin](../../iterator/begin.html)(in), sz, first, last);
     
