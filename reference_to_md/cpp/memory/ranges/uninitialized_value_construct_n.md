...
Constructs objects of type [std::iter_value_t](../../iterator/iter_t.html)<I> in the uninitialized memory area first` + ``[`​0​`, `count`)` by [value-initialization](../../language/value_initialization.html "cpp/language/value initialization"), as if by return [ranges::uninitialized_value_construct](uninitialized_value_construct.html)([std::counted_iterator](../../iterator/counted_iterator.html)(first, count),  
...
## Contents
  ...
  * [1 Parameters](uninitialized_value_construct_n.html#Parameters)
  * [2 Return value](uninitialized_value_construct_n.html#Return_value)
  * [3 Complexity](uninitialized_value_construct_n.html#Complexity)
  * [4 Exceptions](uninitialized_value_construct_n.html#Exceptions)
  * [5 Notes](uninitialized_value_construct_n.html#Notes)
  * [6 Possible implementation](uninitialized_value_construct_n.html#Possible_implementation)
  * [7 Example](uninitialized_value_construct_n.html#Example)
  * [8 Defect reports](uninitialized_value_construct_n.html#Defect_reports)
  * [9 See also](uninitialized_value_construct_n.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct_n&action=edit&section=1 "Edit section: Parameters")] Parameters

first  |  \-  |  the beginning of the range of elements to initialize   
---|---|---  
count  |  \-  |  the number of elements to construct   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct_n&action=edit&section=2 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in count. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct_n&action=edit&section=4 "Edit section: Exceptions")] Exceptions

Any exception thrown on construction of the elements in the destination range. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct_n&action=edit&section=5 "Edit section: Notes")] Notes

An implementation may improve the efficiency of the `ranges::uninitialized_value_construct_n`, e.g. by using [ranges::fill_n](../../algorithm/ranges/fill_n.html "cpp/algorithm/ranges/fill n"), if the value type of the range is a [CopyAssignable](../../named_req/CopyAssignable.html "cpp/named req/CopyAssignable") [TrivialType](../../named_req/TrivialType.html "cpp/named req/TrivialType"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct_n&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
    ...
    struct uninitialized_value_construct_n_fn
    {
        ...
        constexpr I operator()(I first, [std::iter_difference_t](../../iterator/iter_t.html)<I> count) const
        {
            ...
            return [ranges::uninitialized_value_construct](uninitialized_value_construct.html)(iter, [std::default_sentinel](../../iterator/default_sentinel.html)).base();
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct_n&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html) << "\n ";
        std::ranges::uninitialized_value_construct_n([std::begin](../../iterator/begin.html)(v), [std::size](../../iterator/size.html)(v));
        for (const int i : v)
            [std::cout](../../io/cout.html) << i << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct_n&action=edit&section=8 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/ranges/uninitialized_value_construct_n&action=edit&section=9 "Edit section: See also")] See also
