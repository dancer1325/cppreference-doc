...
---|---|---  
Call signature |  |   
template< [std::destructible](../../concepts/destructible.html) T >  
constexpr void destroy_at( T* p ) noexcept; |  |  (since C++20)  
| |   
  
If `T` is not an array type, calls the destructor of the object pointed to by p, as if by p->~T(). Otherwise, recursively destroys elements of *p in order, as if by calling [std::destroy](../destroy.html)([std::begin](../../iterator/begin.html)(*p), [std::end](../../iterator/end.html)(*p)). 
...
## Contents
  ...
  * [1 Parameters](destroy_at.html#Parameters)
  * [2 Possible implementation](destroy_at.html#Possible_implementation)
  * [3 Notes](destroy_at.html#Notes)
  * [4 Example](destroy_at.html#Example)
  * [5 See also](destroy_at.html#See_also)
...
### Possible implementation
    ...
    struct destroy_at_fn
    {
        ...
        {
            if constexpr ([std::is_array_v](../../types/is_array.html)<T>)
                for (auto& elem : *p)
                    operator()([std::addressof](../addressof.html)(elem));
            else
                p->~T();
        }
    };
