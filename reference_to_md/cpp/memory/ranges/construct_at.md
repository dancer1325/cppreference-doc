...
Equivalent to  if constexpr ([std::is_array_v](../../types/is_array.html)<T>)  
` `return ::new ([`_voidify_`](../voidify.html "cpp/memory/voidify") ﻿(*location)) T[1]();  
else  
` `return ::new ([`_voidify_`](../voidify.html "cpp/memory/voidify") ﻿(*location)) T([std::forward](../../utility/forward.html)<Args>(args)...); , except that `construct_at` may be used in evaluation of [constant expressions](../../language/constant_expression.html "cpp/language/constant expression")(until C++26). 

When `construct_at` is called in the evaluation of some constant expression expr, location must point to either a storage obtained by [std::allocator](../allocator.html)<T>::allocate or an object whose lifetime began within the evaluation of expr. 

This overload participates in overload resolution only if all following conditions are satisfied: 

  * [std::is_unbounded_array_v](../../types/is_unbounded_array.html)<T> is false. 
  * ::new([std::declval](../../utility/declval.html)<void*>()) T([std::declval](../../utility/declval.html)<Args>()...) is well-formed when treated as an [unevaluated operand](../../language/expressions.html#Potentially-evaluated_expressions "cpp/language/expressions"). 



If [std::is_array_v](../../types/is_array.html)<T> is true and sizeof...(Args) is nonzero, the program is ill-formed. 
...
## Contents
  ...
  * [1 Parameters](construct_at.html#Parameters)
  * [2 Return value](construct_at.html#Return_value)
  * [3 Notes](construct_at.html#Notes)
  * [4 Example](construct_at.html#Example)
  * [5 Defect reports](construct_at.html#Defect_reports)
  * [6 See also](construct_at.html#See_also)
...
Run this code
    ...
    struct S
    {
        ...
        double z;
     
        S(int x, float y, double z) : x{x}, y{y}, z{z} { [std::cout](../../io/cout.html) << "S::S();\n"; }
     
        ~S() { [std::cout](../../io/cout.html) << "S::~S();\n"; }
     
        void print() const
        {
            [std::cout](../../io/cout.html) << "S { x=" << x << "; y=" << y << "; z=" << z << "; };\n";
        }
    };
     
    int main()
    ...
     
        ...
        ptr->print();
     
        std::[ranges::destroy_at](destroy_at.html)(ptr);
    }
