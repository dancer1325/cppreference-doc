...
NoThrowForwardIt d_first ); |  (1) | (constexpr since C++26)  
...
Run this code
    ...
     
        auto sz = [std::size](../iterator/size.html)(v);
     
        if (void *pbuf = [std::aligned_alloc](c/aligned_alloc.html)(alignof([std::string](../string/basic_string.html)), sizeof([std::string](../string/basic_string.html)) * sz))
        {
            try
            {
                auto first = static_cast<[std::string](../string/basic_string.html)*>(pbuf);
                auto last = std::uninitialized_copy([std::begin](../iterator/begin.html)(v), [std::end](../iterator/end.html)(v), first);
     
                for (auto it = first; it != last; ++it)
                    [std::cout](../io/cout.html) << *it << '_';
...
T::[operator new](new/operator_new.html) exists, the program might be ill-formed  | uses global replacement-  
new instead   
