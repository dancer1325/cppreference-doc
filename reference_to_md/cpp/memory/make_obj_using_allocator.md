...
Creates an object of the given type `T` by means of [uses-allocator construction](uses_allocator.html "cpp/memory/uses allocator"). 

Equivalent to 
    
    
    return [std::make_from_tuple](../utility/make_from_tuple.html)<T>(
...
## Contents
  ...
  * [1 Parameters](make_obj_using_allocator.html#Parameters)
  * [2 Return value](make_obj_using_allocator.html#Return_value)
  * [3 Exceptions](make_obj_using_allocator.html#Exceptions)
  * [4 Example](make_obj_using_allocator.html#Example)
  * [5 See also](make_obj_using_allocator.html#See_also)
