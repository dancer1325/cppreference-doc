...
const Alloc& alloc,  
Args&&... args ); |  |  (since C++20)  
| |   
  
Creates an object of the given type `T` by means of [uses-allocator construction](uses_allocator.html "cpp/memory/uses allocator") at the uninitialized memory location indicated by p. 
...
Equivalent to 
    ...
    return [std::apply](../utility/apply.html)(
        [&]<class... Xs>(Xs&&...xs)
        {
            return [std::construct_at](construct_at.html)(p, [std::forward](../utility/forward.html)<Xs>(xs)...);
        },
        [std::uses_allocator_construction_args](uses_allocator_construction_args.html)<T>(alloc, [std::forward](../utility/forward.html)<Args>(args)...));

## Contents

  * [1 Parameters](uninitialized_construct_using_allocator.html#Parameters)
  * [2 Return value](uninitialized_construct_using_allocator.html#Return_value)
  * [3 Exceptions](uninitialized_construct_using_allocator.html#Exceptions)
  * [4 Example](uninitialized_construct_using_allocator.html#Example)
  * [5 See also](uninitialized_construct_using_allocator.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_construct_using_allocator&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_construct_using_allocator&action=edit&section=2 "Edit section: Return value")] Return value

Pointer to the newly-created object of type `T`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_construct_using_allocator&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_construct_using_allocator&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_construct_using_allocator&action=edit&section=5 "Edit section: See also")] See also
