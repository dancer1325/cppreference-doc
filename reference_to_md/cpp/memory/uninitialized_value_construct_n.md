...
1) Constructs objects of type typename [std::iterator_traits](../iterator/iterator_traits.html)<NoThrowForwardIt>::value_type in the uninitialized memory area first` + ``[`​0​`, `count`)` by [value-initialization](../language/value_initialization.html "cpp/language/value initialization"), as if by 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_value_construct_n&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_value_construct_n&action=edit&section=2 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_value_construct_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in count. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_value_construct_n&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_value_construct_n&action=edit&section=5 "Edit section: Notes")] Notes

[Feature-test](../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_raw_memory_algorithms`](../experimental/feature_test.html#cpp_lib_raw_memory_algorithms "cpp/feature test") | [`202411L`](../compiler_support/26.html#cpp_lib_raw_memory_algorithms_202411L "cpp/compiler support/26") | (C++26) | constexpr for [specialized memory algorithms](../memory.html#Uninitialized_memory_algorithms "cpp/memory"), ([1](uninitialized_value_construct_n.html#Version_1))  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_value_construct_n&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_value_construct_n&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        struct S { [std::string](../string/basic_string.html) m{"Default value"}; };
     
        constexpr int n{3};
    ...
     
        ...
        std::uninitialized_value_construct_n([std::begin](../iterator/begin.html)(v), [std::size](../iterator/size.html)(v));
        for (const int i : v)
            [std::cout](../io/cout.html) << i << ' ';
        [std::cout](../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_value_construct_n&action=edit&section=8 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_value_construct_n&action=edit&section=9 "Edit section: See also")] See also
