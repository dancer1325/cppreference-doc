...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/auto_ptr/get&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/auto_ptr/get&action=edit&section=2 "Edit section: Return value")] Return value

The pointer held by *this. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/auto_ptr/get&action=edit&section=3 "Edit section: See also")] See also

[ operator*operator->](operator*.html "cpp/memory/auto ptr/operator*") |  accesses the managed object   
