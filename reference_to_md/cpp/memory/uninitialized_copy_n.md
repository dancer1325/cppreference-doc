...
` `typename [std::iterator_traits](../iterator/iterator_traits.html)<NoThrowForwardIt>::value_type(*first);
...
## Contents
  ...
  * [8 Defect reports](uninitialized_copy_n.html#Defect_reports)
  * [9 See also](uninitialized_copy_n.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_copy_n&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_copy_n&action=edit&section=2 "Edit section: Return value")] Return value

Iterator to the element past the last element copied. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_copy_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in count. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_copy_n&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_copy_n&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_copy_n&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
                                                    ...
                                                    NoThrowForwardIt d_first)
    {
        ...
        try
        {
            for (; count > 0; ++first, (void) ++current, --count)
                ::new (static_cast<void*>([std::addressof](addressof.html)(*current))) T(*first);
        }
        catch (...)
        {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_copy_n&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<[std::string](../string/basic_string.html)> v = {"This", "is", "an", "example"};
     
        [std::string](../string/basic_string.html)* p;
        [std::size_t](../types/size_t.html) sz;
        [std::tie](../utility/tuple/tie.html)(p, sz) = [std::get_temporary_buffer](get_temporary_buffer.html)<[std::string](../string/basic_string.html)>(v.size());
        sz = [std::min](../algorithm/min.html)(sz, v.size());
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_copy_n&action=edit&section=8 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2133](https://cplusplus.github.io/LWG/issue2133) | C++98  | the effect description used a for loop with the iteration  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_copy_n&action=edit&section=9 "Edit section: See also")] See also
...
---|---  
[ ranges::uninitialized_copy_n](ranges/uninitialized_copy_n.html "cpp/memory/ranges/uninitialized copy n")(C++20) |  copies a number of objects to an uninitialized area of memory  
