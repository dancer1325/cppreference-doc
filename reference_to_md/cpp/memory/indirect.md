...
---  
[indirect::indirect](indirect/indirect.html "cpp/memory/indirect/indirect")  
[indirect::~indirect](indirect/~indirect.html "cpp/memory/indirect/~indirect")  
[indirect::operator=](indirect/operator=.html "cpp/memory/indirect/operator=")  
[Observers](indirect.html#Observers "cpp/memory/indirect")  
[indirect::operator->indirect::operator*](indirect/operator*.html "cpp/memory/indirect/operator*")  
[indirect::valueless_after_move](indirect/valueless_after_move.html "cpp/memory/indirect/valueless after move")  
[indirect::get_allocator](indirect/get_allocator.html "cpp/memory/indirect/get allocator")  
[Modifiers](indirect.html#Modifiers "cpp/memory/indirect")  
[indirect::swap](indirect/swap.html "cpp/memory/indirect/swap")  
[Non-member functions](indirect.html#Non-member_functions "cpp/memory/indirect")  
[operator==operator<=>](indirect/operator_cmp.html "cpp/memory/indirect/operator cmp")  
[swap(std::indirect)](indirect/swap2.html "cpp/memory/indirect/swap2")  
...
namespace pmr {  
template< class T >  
using indirect = std::indirect<T, [std::pmr::polymorphic_allocator](polymorphic_allocator.html)<T>>;  
} |  (2)  |  (since C++26)  
| |   
  
1) `std::indirect` is a wrapper containing dynamically-allocated object with value-like semantics.

2) `std::pmr::indirect` is an alias template that uses a [polymorphic allocator](polymorphic_allocator.html "cpp/memory/polymorphic allocator").

An `std::indirect` object manages the [lifetime](../language/lifetime.html "cpp/language/lifetime") of an owned object. An `std::indirect` object can only have no owned object after it has been moved from, in this case it is _valueless ﻿_. 
...
## Contents
  ...
  * [1 Template parameters](indirect.html#Template_parameters)
  * [2 Nested types](indirect.html#Nested_types)
  * [3 Data members](indirect.html#Data_members)
  * [4 Member functions](indirect.html#Member_functions)
    * [4.1 Observers](indirect.html#Observers)
    * [4.2 Modifiers](indirect.html#Modifiers)
  * [5 Non-member functions](indirect.html#Non-member_functions)
  * [6 Helper classes](indirect.html#Helper_classes)
  * [7 Deduction guides](indirect.html#Deduction_guides)
  * [8 Notes](indirect.html#Notes)
  * [9 Example](indirect.html#Example)
  * [10 See also](indirect.html#See_also)
...
Member  |  Description   
---|---  
`pointer` `_p_` |  a pointer to the owned value  
