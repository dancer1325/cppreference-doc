...
indirect( Value ) -> indirect<Value>; |  (1)  |  (since C++26)  
template< class Alloc, class Value >  
indirect( [std::allocator_arg_t](../allocator_arg_t.html), Alloc, Value )  
-> indirect<Value, typename [std::allocator_traits](../allocator_traits.html)<Alloc>::  
template rebind_alloc<Value>>; |  (2)  |  (since C++26)  
| |   
  
1) This [deduction guide](../../language/ctad.html "cpp/language/class template argument deduction") is provided for std::indirect to allow deduction from a single value.
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/indirect/deduction_guides&action=edit&section=1 "Edit section: Example")] Example
