...
`std::bad_weak_ptr` is the type of the object thrown as exceptions by the constructors of [std::shared_ptr](shared_ptr.html "cpp/memory/shared ptr") that take [std::weak_ptr](weak_ptr.html "cpp/memory/weak ptr") as the argument, when the [std::weak_ptr](weak_ptr.html "cpp/memory/weak ptr") refers to an already deleted object. 

![std-bad weak ptr-inheritance.svg](https://upload.cppreference.com/mwiki/images/6/62/std-bad_weak_ptr-inheritance.svg)

Inheritance diagram

## Contents

  * [1 Member functions](bad_weak_ptr.html#Member_functions)
  * [2 std::bad_weak_ptr::bad_weak_ptr](bad_weak_ptr.html#std::bad_weak_ptr::bad_weak_ptr)
    * [2.1 Parameters](bad_weak_ptr.html#Parameters)
  * [3 std::bad_weak_ptr::operator=](bad_weak_ptr.html#std::bad_weak_ptr::operator.3D)
    * [3.1 Parameters](bad_weak_ptr.html#Parameters_2)
    * [3.2 Return value](bad_weak_ptr.html#Return_value)
  * [4 std::bad_weak_ptr::what](bad_weak_ptr.html#std::bad_weak_ptr::what)
    * [4.1 Return value](bad_weak_ptr.html#Return_value_2)
    * [4.2 Notes](bad_weak_ptr.html#Notes)
  * [5 Inherited from std::exception](bad_weak_ptr.html#Inherited_from_std::exception)
    * [5.1 Member functions](bad_weak_ptr.html#Member_functions_2)
    * [5.2 Example](bad_weak_ptr.html#Example)
    * [5.3 Defect reports](bad_weak_ptr.html#Defect_reports)
    * [5.4 See also](bad_weak_ptr.html#See_also)
...
Constructs a new `bad_weak_ptr` object with an implementation-defined null-terminated byte string which is accessible through [`what()`](../error/exception/what.html "cpp/error/exception/what"). 

1) Default constructor.

2) Copy constructor. If *this and other both have dynamic type `std::bad_weak_ptr` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0.
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::bad_weak_ptr` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment. 
...
Run this code
    ...
    int main()
    {
        ...
        [std::weak_ptr](weak_ptr.html)<int> wp(p1);
        p1.reset();
        try
        {
            [std::shared_ptr](shared_ptr.html)<int> p2(wp);
        }
