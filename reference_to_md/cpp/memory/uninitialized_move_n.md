...
[std::pair](../utility/pair.html)<InputIt, NoThrowForwardIt>  
...
[std::pair](../utility/pair.html)<ForwardIt, NoThrowForwardIt>  
...
## Contents
  ...
  * [1 Parameters](uninitialized_move_n.html#Parameters)
  * [2 Return value](uninitialized_move_n.html#Return_value)
  * [3 Complexity](uninitialized_move_n.html#Complexity)
  * [4 Exceptions](uninitialized_move_n.html#Exceptions)
  * [5 Notes](uninitialized_move_n.html#Notes)
  * [6 Possible implementation](uninitialized_move_n.html#Possible_implementation)
  * [7 Example](uninitialized_move_n.html#Example)
  * [8 Defect reports](uninitialized_move_n.html#Defect_reports)
  * [9 See also](uninitialized_move_n.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_move_n&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_move_n&action=edit&section=2 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_move_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in count. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_move_n&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_move_n&action=edit&section=5 "Edit section: Notes")] Notes

When the input iterator deferences to an rvalue, the behavior of `std::uninitialized_move_n` is same as [std::uninitialized_copy_n](uninitialized_copy_n.html "cpp/memory/uninitialized copy n"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_move_n&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class InputIt, class Size, class NoThrowForwardIt>
    constexpr [std::pair](../utility/pair.html)<InputIt, NoThrowForwardIt>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_move_n&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::string](../string/basic_string.html) in[]{"One", "Definition", "Rule"};
    ...
     
            ...
            void* out = [std::aligned_alloc](c/aligned_alloc.html)(alignof([std::string](../string/basic_string.html)), sizeof([std::string](../string/basic_string.html)) * sz))
        {
            try
            {
                ...
                auto last{first + sz};
                std::uninitialized_move_n([std::begin](../iterator/begin.html)(in), sz, first);
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_move_n&action=edit&section=8 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/uninitialized_move_n&action=edit&section=9 "Edit section: See also")] See also
...
[ ranges::uninitialized_move_n](ranges/uninitialized_move_n.html "cpp/memory/ranges/uninitialized move n")(C++20) |  moves a number of objects to an uninitialized area of memory  
