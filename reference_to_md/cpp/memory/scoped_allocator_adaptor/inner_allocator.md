...
If sizeof...(InnerAllocs) == 0, that is, no inner allocators were declared, returns *this. Otherwise returns a reference to [std::scoped_allocator_adaptor](../scoped_allocator_adaptor.html)<InnerAllocs...>, that is, a scoped allocator composed of all inner allocators of *this, with the first inner allocator becoming the outer allocator. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/scoped_allocator_adaptor/inner_allocator&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/scoped_allocator_adaptor/inner_allocator&action=edit&section=2 "Edit section: Return value")] Return value

A reference to the inner allocator, which is itself a `std::scoped_allocator_adaptor`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/scoped_allocator_adaptor/inner_allocator&action=edit&section=3 "Edit section: See also")] See also

[ outer_allocator](outer_allocator.html "cpp/memory/scoped allocator adaptor/outer allocator") |  obtains an `outer_allocator` reference   
