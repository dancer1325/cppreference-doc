...
**_scoped_allocator_adaptor::outermost_  
 ...
 _scoped_allocator_adaptor::outermost-destroy_**  
...
These exposition-only helper member function templates are used in member functions [`construct()`](construct.html "cpp/memory/scoped allocator adaptor/construct") and [`destroy()`](destroy.html "cpp/memory/scoped allocator adaptor/destroy"). 

1) Obtains the outermost allocator of alloc. 

  * If the expression alloc.outer_allocator() is valid, returns `_outermost_` ﻿(alloc.outer_allocator()). 
...
Given the type [std::allocator_traits](../allocator_traits.html)<[std::remove_reference_t](../../types/remove_reference.html)<decltype(`_outermost_` ﻿())>> as `outermost_traits`:

2) Equivalent to outermost_traits::construct(`_outermost_` ﻿(), p, [std::forward](../../utility/forward.html)<Args>(args)...);.

3) Equivalent to outermost_traits::destroy(`_outermost_` ﻿(), p);.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/scoped_allocator_adaptor/helpers&action=edit&section=1 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 3116](https://cplusplus.github.io/LWG/issue3116) | C++11  | the recursion condition for `_outermost_` was “alloc  
has the member function `outer_allocator()`”  | changed to “the expression  
alloc.outer_allocator() is valid”   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/scoped_allocator_adaptor/helpers&action=edit&section=2 "Edit section: See also")] See also
