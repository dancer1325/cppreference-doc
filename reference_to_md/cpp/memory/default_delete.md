...
`std::default_delete` is the default destruction policy used by [std::unique_ptr](unique_ptr.html "cpp/memory/unique ptr") when no deleter is specified. Specializations of `default_delete` are empty classes on typical implementations, and used in the [empty base class optimization](../language/ebo.html "cpp/language/ebo"). 
...
## Contents
  ...
  * [1 Member functions](default_delete.html#Member_functions)
  * [2 std::default_delete::default_delete](default_delete.html#std::default_delete::default_delete)
    * [2.1 Parameters](default_delete.html#Parameters)
    * [2.2 Notes](default_delete.html#Notes)
  * [3 std::default_delete::operator()](default_delete.html#std::default_delete::operator.28.29)
    * [3.1 Parameters](default_delete.html#Parameters_2)
    * [3.2 Exceptions](default_delete.html#Exceptions)
    * [3.3 Invoking over Incomplete Types](default_delete.html#Invoking_over_Incomplete_Types)
    * [3.4 Notes](default_delete.html#Notes_2)
    * [3.5 Example](default_delete.html#Example)
    * [3.6 Defect reports](default_delete.html#Defect_reports)
    * [3.7 See also](default_delete.html#See_also)
...
template< class U >  
default_delete( const default_delete<U>& d ) noexcept; |  (2)  |  (since C++11)   
(constexpr since C++23)  
Array specializations |  |   
template< class U >  
default_delete( const default_delete<U[]>& d ) noexcept; |  (3)  |  (since C++11)   
(constexpr since C++23)  
| |   
...
The [converting constructor](../language/converting_constructor.html "cpp/language/converting constructor") template of `std::default_delete` makes possible the implicit conversion from [std::unique_ptr](unique_ptr.html)<Derived> to [std::unique_ptr](unique_ptr.html)<Base>. 
...
Array specializations |  |   
template< class U >  
void operator()( U* ptr ) const; |  (2)  |  (since C++11)   
(constexpr since C++23)  
| |   
...
Run this code
    ...
     
        {
            [std::shared_ptr](shared_ptr.html)<int> shared_good(new int[10], std::default_delete<int[]>());
        } // OK: the destructor calls delete[]
     
        {
            [std::unique_ptr](unique_ptr.html)<int> ptr(new int(5));
        } // unique_ptr<int> uses default_delete<int>
     
        {
            [std::unique_ptr](unique_ptr.html)<int[]> ptr(new int[10]);
        } // unique_ptr<int[]> uses default_delete<int[]>
     
