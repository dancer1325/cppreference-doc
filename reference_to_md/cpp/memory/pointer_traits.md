...
---|---|---  
template< class Ptr >  
struct pointer_traits; |  (1)  |  (since C++11)  
template< class T >  
struct pointer_traits<T*>; |  (2)  |  (since C++11)  
| |   
  
The `pointer_traits` class template provides the standardized way to access certain properties of pointer-like types ([fancy pointers](../named_req/Allocator.html#Fancy_pointers "cpp/named req/Allocator"), such as [`boost::interprocess::offset_ptr`](https://www.boost.org/doc/libs/release/doc/html/interprocess/offset_ptr.html)). The standard template [std::allocator_traits](allocator_traits.html "cpp/memory/allocator traits") relies on `pointer_traits` to determine the defaults for various typedefs required by [Allocator](../named_req/Allocator.html "cpp/named req/Allocator"). 
...
## Contents
  ...
  * [1 Member types](pointer_traits.html#Member_types)
  * [2 Member alias templates](pointer_traits.html#Member_alias_templates)
  * [3 Member functions](pointer_traits.html#Member_functions)
  * [4 Member types](pointer_traits.html#Member_types_2)
  * [5 Member alias templates](pointer_traits.html#Member_alias_templates_2)
  * [6 Member functions](pointer_traits.html#Member_functions_2)
  * [7 Optional member functions of program-defined specializations](pointer_traits.html#Optional_member_functions_of_program-defined_specializations)
  * [8 Notes](pointer_traits.html#Notes)
  * [9 Example](pointer_traits.html#Example)
  * [10 Defect reports](pointer_traits.html#Defect_reports)
  * [11 See also](pointer_traits.html#See_also)
...
The rebind member template alias makes it possible, given a pointer-like type that points to `T`, to obtain the same pointer-like type that points to `U`. For example, 
    ...
    using another_pointer = std::pointer_traits<[std::shared_ptr](shared_ptr.html)<int>>::rebind<double>;
    static_assert([std::is_same](../types/is_same.html)<another_pointer, [std::shared_ptr](shared_ptr.html)<double>>::value);
...
Run this code
    ...
     
        BlockList<[std::shared_ptr](shared_ptr.html)<char>> bl2;
        // The type of bl2.free_blocks is
        // std::shared_ptr<BlockList<std::shared_ptr<char>>::block>
        [std::cout](../io/cout.html) << bl2.free_blocks.use_count() << '\n';
    }
