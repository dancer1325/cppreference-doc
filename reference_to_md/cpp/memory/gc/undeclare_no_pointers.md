...
---|---|---  
void undeclare_no_pointers( char *p, [std::size_t](../../types/size_t.html) n ); |  |  (since C++11)   
(removed in C++23)  
| |   
  
Unregisters a range earlier registered with [std::declare_no_pointers](declare_no_pointers.html)(). 

## Contents

  * [1 Parameters](undeclare_no_pointers.html#Parameters)
  * [2 Return value](undeclare_no_pointers.html#Return_value)
  * [3 Exceptions](undeclare_no_pointers.html#Exceptions)
  * [4 See also](undeclare_no_pointers.html#See_also)
