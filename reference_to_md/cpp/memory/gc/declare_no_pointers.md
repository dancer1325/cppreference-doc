...
---|---|---  
void declare_no_pointers( char *p, [std::size_t](../../types/size_t.html) n ); |  |  (since C++11)   
(removed in C++23)  
| |   
...
## Contents
  ...
  * [1 Parameters](declare_no_pointers.html#Parameters)
  * [2 Return value](declare_no_pointers.html#Return_value)
  * [3 Exceptions](declare_no_pointers.html#Exceptions)
  * [4 See also](declare_no_pointers.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/gc/declare_no_pointers&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  pointer to the beginning of the range   
---|---|---  
n  |  \-  |  the number of bytes in the range   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/gc/declare_no_pointers&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/gc/declare_no_pointers&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/gc/declare_no_pointers&action=edit&section=4 "Edit section: See also")] See also

[ undeclare_no_pointers](undeclare_no_pointers.html "cpp/memory/gc/undeclare no pointers")(C++11)(removed in C++23) |  cancels the effect of **std::declare_no_pointers**   
