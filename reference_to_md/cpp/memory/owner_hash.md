...
This function object provides owner-based (as opposed to value-based) hashing of both [std::weak_ptr](weak_ptr.html "cpp/memory/weak ptr") and [std::shared_ptr](shared_ptr.html "cpp/memory/shared ptr"). 

## Contents

  * [1 Nested types](owner_hash.html#Nested_types)
  * [2 Member functions](owner_hash.html#Member_functions)
  * [3 std::owner_hash::operator()](owner_hash.html#std::owner_hash::operator.28.29)
    * [3.1 Parameters](owner_hash.html#Parameters)
    * [3.2 Return value](owner_hash.html#Return_value)
    * [3.3 Notes](owner_hash.html#Notes)
    * [3.4 See also](owner_hash.html#See_also)
...
template< class T >  
[std::size_t](../types/size_t.html) operator()( const [std::shared_ptr](shared_ptr.html)<T>& key ) const noexcept; |  (1)  |  (since C++26)  
---|---|---  
template< class T >  
[std::size_t](../types/size_t.html) operator()( const [std::weak_ptr](weak_ptr.html)<T>& key ) const noexcept; |  (2)  |  (since C++26)  
| |   
