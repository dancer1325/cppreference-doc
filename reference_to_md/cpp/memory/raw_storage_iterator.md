...
Member functions  
---  
[raw_storage_iterator::raw_storage_iterator](raw_storage_iterator/raw_storage_iterator.html "cpp/memory/raw storage iterator/raw storage iterator")  
[raw_storage_iterator::operator=](raw_storage_iterator/operator=.html "cpp/memory/raw storage iterator/operator=")  
[raw_storage_iterator::operator*](raw_storage_iterator/operator*.html "cpp/memory/raw storage iterator/operator*")  
...
: public [std::iterator](../iterator/iterator.html)<[std::output_iterator_tag](../iterator/iterator_tags.html), void, void, void, void>; |  |  (until C++17)  
template< class OutputIt, class T >  
...
## Contents
  ...
  * [1 Type requirements](raw_storage_iterator.html#Type_requirements)
  * [2 Member functions](raw_storage_iterator.html#Member_functions)
  * [3 Member types](raw_storage_iterator.html#Member_types)
  * [4 Note](raw_storage_iterator.html#Note)
  * [5 Example](raw_storage_iterator.html#Example)
  * [6 See also](raw_storage_iterator.html#See_also)
...
Run this code
    ...
    int main()
    {
        const [std::string](../string/basic_string.html) s[] = {"This", "is", "a", "test", "."};
        [std::string](../string/basic_string.html)* p = [std::allocator](allocator.html)<[std::string](../string/basic_string.html)>().allocate(5);
     
        [std::copy](../algorithm/copy.html)([std::begin](../iterator/begin.html)(s), [std::end](../iterator/end.html)(s),
                  std::raw_storage_iterator<[std::string](../string/basic_string.html)*, [std::string](../string/basic_string.html)>(p));
     
        for ([std::string](../string/basic_string.html)* i = p; i != p + 5; ++i)
        {
            [std::cout](../io/cout.html) << *i << '\n';
            i->~basic_string<char>();
        }
        [std::allocator](allocator.html)<[std::string](../string/basic_string.html)>().deallocate(p, 5);
    }
