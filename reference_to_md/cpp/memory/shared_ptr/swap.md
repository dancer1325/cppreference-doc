...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/shared_ptr/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

r  |  \-  |  smart pointer to exchange the contents with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/shared_ptr/swap&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/shared_ptr/swap&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::shared_ptr](../shared_ptr.html)<Foo> p1 = [std::make_shared](make_shared.html)<Foo>(100);
        [std::shared_ptr](../shared_ptr.html)<Foo> p2 = [std::make_shared](make_shared.html)<Foo>(200);
        auto print = [&]()
        {
