...
## Contents
  ...
  * [3 Notes](unique.html#Notes)
  * [4 Example](unique.html#Example)
  * [5 See also](unique.html#See_also)
...
Run this code
    ...
    { 
        ...
        [std::cout](../../io/cout.html) << "sp1.unique() == " << sp1.unique() << '\n'; 
     
        [std::shared_ptr](../shared_ptr.html)<int> sp2 = sp1; 
        [std::cout](../../io/cout.html) << "sp1.unique() == " << sp1.unique() << '\n'; 
    }
