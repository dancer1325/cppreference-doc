...
---|---|---  
class bad_alloc : public [std::exception](../../error/exception.html) |  |   
| |   
  
`std::bad_alloc` is the type of the object thrown as exceptions by the [allocation functions](operator_new.html "cpp/memory/new/operator new") to report failure to allocate storage. 

![std-bad alloc-inheritance.svg](https://upload.cppreference.com/mwiki/images/9/96/std-bad_alloc-inheritance.svg)

Inheritance diagram

## Contents

  * [1 Member functions](bad_alloc.html#Member_functions)
  * [2 std::bad_alloc::bad_alloc](bad_alloc.html#std::bad_alloc::bad_alloc)
    * [2.1 Parameters](bad_alloc.html#Parameters)
  * [3 std::bad_alloc::operator=](bad_alloc.html#std::bad_alloc::operator.3D)
    * [3.1 Parameters](bad_alloc.html#Parameters_2)
    * [3.2 Return value](bad_alloc.html#Return_value)
  * [4 std::bad_alloc::what](bad_alloc.html#std::bad_alloc::what)
    * [4.1 Return value](bad_alloc.html#Return_value_2)
    * [4.2 Notes](bad_alloc.html#Notes)
  * [5 Inherited from std::exception](bad_alloc.html#Inherited_from_std::exception)
    * [5.1 Member functions](bad_alloc.html#Member_functions_2)
    * [5.2 Notes](bad_alloc.html#Notes_2)
    * [5.3 Example](bad_alloc.html#Example)
    * [5.4 See also](bad_alloc.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/new/bad_alloc&action=edit&section=1 "Edit section: Member functions")] Member functions
...
Constructs a new `bad_alloc` object with an implementation-defined null-terminated byte string which is accessible through [`what()`](../../error/exception/what.html "cpp/error/exception/what"). 

1) Default constructor.

2) Copy constructor. If *this and other both have dynamic type `std::bad_alloc` then [std::strcmp](../../string/byte/strcmp.html)(what(), other.what()) == 0.(since C++11)
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::bad_alloc` then [std::strcmp](../../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment.(since C++11)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/new/bad_alloc&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/new/bad_alloc&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        {
            [std::cout](../../io/cout.html) << "Allocation failed: " << e.what() << '\n';
        }
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/memory/new/bad_alloc&action=edit&section=4 "Edit section: See also")] See also
