...
constexpr [std::allocator_arg_t](allocator_arg_t.html) allocator_arg {}; |  (2)  |  (since C++11)   
(inline since C++17)  
| |   
  
1) `std::allocator_arg_t` is an empty class type used to disambiguate the overloads of constructors and member functions of allocator-aware objects, including [std::tuple](../utility/tuple.html "cpp/utility/tuple"), [std::function](../utility/functional/function.html "cpp/utility/functional/function"), [std::packaged_task](../thread/packaged_task.html "cpp/thread/packaged task"),(until C++17) and [std::promise](../thread/promise.html "cpp/thread/promise").
