...
## Contents
  ...
  * [1 Requirements](MoveInsertable.html#Requirements)
  * [2 Notes](MoveInsertable.html#Notes)
  * [3 Defect reports](MoveInsertable.html#Defect_reports)
  * [4 See also](MoveInsertable.html#See_also)
...
expr |  [std::allocator_traits](../memory/allocator_traits.html)<A>::construct(m, p, rv)  
...
If [std::allocator](../memory/allocator.html)<T> or a similar allocator is used, a class does not have to implement a [move constructor](../language/move_constructor.html "cpp/language/move constructor") to satisfy this type requirement: a [copy constructor](../language/copy_constructor.html "cpp/language/copy constructor") that takes a const T& argument can bind rvalue expressions. If a MoveInsertable class implements a move constructor, it may also implement [move semantics](../utility/move.html "cpp/utility/move") to take advantage of the fact that the value of `rv` after construction is unspecified. 
