...
`OutputIt` |  a [LegacyOutputIterator](OutputIterator.html "cpp/named req/OutputIterator") type   
`ParseCtx` |  [std::basic_format_parse_context](../utility/format/basic_format_parse_context.html)<CharT>  
`FmtCtx` |  [std::basic_format_context](../utility/format/basic_format_context.html)<OutputIt, CharT>  
Value  |  Definition   
...
parse_ctx |  an lvalue of type `ParseCtx` satisfying all following conditions: 
  ...
  * parse_ctx.begin() points to the beginning of the format-spec of the replacement field being formatted in the [format string](../utility/format/basic_format_string.html#Format_specification "cpp/utility/format/basic format string"). 
...
g.parse(parse_ctx) | `ParseCtx::iterator` | 
  ...
  * Throws [std::format_error](../utility/format/format_error.html "cpp/utility/format/format error") unless the whole range is parsed or the unmatched character is }. [[note 1]](BasicFormatter.html#cite_note-1)
...
f.format(arg, fmt_ctx) | `FmtCtx::iterator` | 
  ...
  * The output shall only depend on 
    ...
    * fmt_ctx.arg(n) for any value n of type [std::size_t](../types/size_t.html "cpp/types/size t"). 

  
  
  1. [↑](BasicFormatter.html#cite_ref-1) This allows formatters to emit meaningful error messages.
...
---|---|---|---  
[LWG 3892](https://cplusplus.github.io/LWG/issue3892) | C++20  | the value of pc.begin() was unclear if format-spec is not present  | made clear 
