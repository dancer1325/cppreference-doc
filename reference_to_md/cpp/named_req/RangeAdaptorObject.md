...
If a range adaptor object takes only one argument, it is also a [RangeAdaptorClosureObject](RangeAdaptorClosureObject.html "cpp/named req/RangeAdaptorClosureObject"). 
...
expression a(args...) has following properties: 
  ...
  * it is valid if and only if for every argument e in args... such that `E` is decltype((e)), [std::is_constructible_v](../types/is_constructible.html)<[std::decay_t](../types/decay.html)<E>, E> is true, 
  * when the call is valid, its result object stores a subobject of type [std::decay_t](../types/decay.html)<E> direct-non-list-initialized with [std::forward](../utility/forward.html)<E>(e), for every argument e in args... (in other words, range adaptor objects bind arguments by value), 
  * the result object is a [RangeAdaptorClosureObject](RangeAdaptorClosureObject.html "cpp/named req/RangeAdaptorClosureObject"), 
  * calling the [RangeAdaptorClosureObject](RangeAdaptorClosureObject.html "cpp/named req/RangeAdaptorClosureObject") forwards the bound arguments (if any) to the associated range adaptor object. The bound arguments (if any) are considered to have the value category and cv-qualification of the [RangeAdaptorClosureObject](RangeAdaptorClosureObject.html "cpp/named req/RangeAdaptorClosureObject"). In other words, a(args...)(r) is equivalent to [std::bind_back](../utility/functional/bind_front.html)(a, args...)(r) (but the former also supports the pipe syntax).(since C++23)
...
calls to 
  ...
  * a(args...), 
  * [std::as_const](../utility/as_const.html)(a)(args...), 
  * std::move(a)(args...), and 
  * std::move([std::as_const](../utility/as_const.html)(a))(args...)
