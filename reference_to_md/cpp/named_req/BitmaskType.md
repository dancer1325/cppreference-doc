...
The following standard library types satisfy BitmaskType: 
  ...
  * [`std::chars_format`](../utility/chars_format.html "cpp/utility/chars format")

| (since C++17)  
---|---  
  
  * [std::ctype_base::mask](../locale/ctype_base.html "cpp/locale/ctype base")
  * [std::ios_base::fmtflags](../io/ios_base/fmtflags.html "cpp/io/ios base/fmtflags")
  * [std::ios_base::iostate](../io/ios_base/iostate.html "cpp/io/ios base/iostate")
  * [std::ios_base::openmode](../io/ios_base/openmode.html "cpp/io/ios base/openmode")



  * [`std::regex_traits::char_class_type`](../regex/regex_traits.html#Member_types "cpp/regex/regex traits")
  * [std::regex_constants::syntax_option_type](../regex/syntax_option_type.html "cpp/regex/syntax option type")
  * [std::regex_constants::match_flag_type](../regex/match_flag_type.html "cpp/regex/match flag type")
  * [std::launch](../thread/launch.html "cpp/thread/launch")

| (since C++11)  
---|---  
  
  * [std::filesystem::perms](../filesystem/perms.html "cpp/filesystem/perms")
  * [`std::filesystem::perm_options`](../filesystem/perm_options.html "cpp/filesystem/perm options")
  * [std::filesystem::copy_options](../filesystem/copy_options.html "cpp/filesystem/copy options")
  * [std::filesystem::directory_options](../filesystem/directory_options.html "cpp/filesystem/directory options")

| (since C++17)  
---|---  
  
Code that relies on some particular implementation option (e.g. int n = [std::ios_base::hex](../io/ios_base/fmtflags.html)) is non-portable because [std::ios_base::fmtflags](../io/ios_base/fmtflags.html "cpp/io/ios base/fmtflags") is not necessarily implicitly convertible to int. 
