...
## Contents
  ...
  * [1 Requirements](BooleanTestable.html#Requirements)
  * [2 Notes](BooleanTestable.html#Notes)
  * [3 Defect reports](BooleanTestable.html#Defect_reports)
  * [4 See also](BooleanTestable.html#See_also)
...
Let e be an expression of a certain type and value category. The type and value category meet the BooleanTestable requirements if: 
  ...
  * Both e and !e are convertible to bool by both [implicit conversion](../language/implicit_cast.html "cpp/language/implicit conversion") and [`static_cast`](../language/static_cast.html "cpp/language/static cast"). 
  ...
  * bool(!e) == !bool(e) holds. 
  * No viable non-member operator&& and operator|| is visible by [argument-dependent lookup](../language/adl.html "cpp/language/adl") for the type of e or !e. 
...
The type and value category of an expression e meet the BooleanTestable requirements if and only if decltype((e)) models `_[boolean-testable](../concepts/boolean-testable.html "cpp/concepts/boolean-testable")_`.  | (since C++20)  
---|---  
