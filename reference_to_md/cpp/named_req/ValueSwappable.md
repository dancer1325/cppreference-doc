...
A type T is ValueSwappable if 
  ...
  1. `T` satisfies the [LegacyIterator](Iterator.html "cpp/named req/Iterator") requirements. 
  2. For any dereferenceable object `x` of type `T` (that is, any value other than the end iterator), `*x` satisfies the [Swappable](Swappable.html "cpp/named req/Swappable") requirements. 
...
Run this code
    ...
    int main()
    {
        ...
        [std::iter_swap](../algorithm/iter_swap.html)(p1, p2); // OK: iter_swap requires ValueSwappable
