...
## Contents
  ...
  * [1 Requirements](ReversibleContainer.html#Requirements)
    * [1.1 Types](ReversibleContainer.html#Types)
    * [1.2 Expressions](ReversibleContainer.html#Expressions)
  * [2 Library types](ReversibleContainer.html#Library_types)
  * [3 Example](ReversibleContainer.html#Example)
  * [4 Defect reports](ReversibleContainer.html#Defect_reports)
...
`const_reverse_iterator` for constant a | reverse_iterator(a.end()) | Constant   
a.rend() | `reverse_iterator`  
`const_reverse_iterator` for constant a | reverse_iterator(a.begin()) | Constant   
...
Run this code
    ...
     
        for ([std::vector](../container/vector.html)<int>::const_reverse_iterator i{v.crbegin()}; i != v.crend(); ++i)
...
---|---|---|---  
[LWG 2105](https://cplusplus.github.io/LWG/issue2105) | C++98  | typename X::const_reverse_iterator was  
required to be an iterator type of value type const T | required to be a constant  
