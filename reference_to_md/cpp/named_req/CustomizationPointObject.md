...
_Customization point objects_ are stateless [function objects](FunctionObject.html "cpp/named req/FunctionObject") of a [literal](LiteralType.html "cpp/named req/LiteralType") [`semiregular`](../concepts/semiregular.html "cpp/concepts/semiregular") class type. 
...
Let `Fn` be the type of a customization point object, and `Args...` be a set of types, if [std::declval](../utility/declval.html)<Args>()... meet the requirements for arguments to `Fn`, `Fn` models  


  * [std::invocable](../concepts/invocable.html)<Fn, Args...>, 
  * [std::invocable](../concepts/invocable.html)<const Fn, Args...>, 
  * [std::invocable](../concepts/invocable.html)<Fn&, Args...>, and 
  * [std::invocable](../concepts/invocable.html)<const Fn&, Args...>.  
