...
The following types are collectively called _implicit-lifetime types_ : 
  ...
  * [implicit-lifetime class types](../language/classes.html#Implicit-lifetime_class "cpp/language/classes")
  * array types 
...
---|---|---|---  
[CWG 2489](https://cplusplus.github.io/CWG/issues/2489.html) | C++20  | an operation that begins the lifetime of a char array implicitly creates objects  | it does not 
