...
## Contents
  ...
  * [1 Requirements](BasicLockable.html#Requirements)
    * [1.1 Non-shared locks](BasicLockable.html#Non-shared_locks)
  * [2 Standard library](BasicLockable.html#Standard_library)
  * [3 See also](BasicLockable.html#See_also)
...
A lock on an object is said to be _non-shared lock_ if it is acquired by a call to `lock`, `try_lock`, `try_lock_for`, or `try_lock_until` member function. 
