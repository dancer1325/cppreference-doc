...
## Contents
  ...
  * [1 Requirements](FormattedOutputFunction.html#Requirements)
  * [2 Padding](FormattedOutputFunction.html#Padding)
  * [3 Standard library](FormattedOutputFunction.html#Standard_library)
  * [4 Defect reports](FormattedOutputFunction.html#Defect_reports)
...
A FormattedOutputFunction is a member function of [std::basic_ostream](../io/basic_ostream.html "cpp/io/basic ostream") or a non-member function involving [std::basic_ostream](../io/basic_ostream.html "cpp/io/basic ostream") that performs the following operations: 
  ...
  1. Constructs an object sentry of type [`std::basic_ostream::sentry`](../io/basic_ostream/sentry.html "cpp/io/basic ostream/sentry"). 
  2. If bool(sentry) is true, attempts to perform the desired output by inserting the characters into the output stream as if by calling rdbuf()->sputc(). Other public members of [std::basic_ostream](../io/basic_ostream.html "cpp/io/basic ostream") may also be used, but virtual members of rdbuf() except [`overflow()`](../io/basic_streambuf/overflow.html "cpp/io/basic streambuf/overflow"), [`xsputn()`](../io/basic_streambuf/sputn.html "cpp/io/basic streambuf/sputn") and [`sync()`](../io/basic_streambuf/pubsync.html "cpp/io/basic streambuf/pubsync") will never be called. 
...
If the output could not be generated, calls setstate([std::ios_base::failbit](../io/ios_base/iostate.html)), which can throw an exception. 

If an exception is thrown during output, then [std::ios_base::badbit](../io/ios_base/iostate.html) is set in *this’s error state without causing a [std::ios_base::failure](../io/ios_base/failure.html "cpp/io/ios base/failure") to be thrown. If exceptions on `badbit` are enabled in this stream's [exception mask](../io/basic_ios/exceptions.html "cpp/io/basic ios/exceptions") (i.e., (exceptions() & badbit) != 0), the exception is also rethrown. 
...
The following standard library functions are **FormattedOutputFunction s**. 
  ...
  * [`basic_ostream::operator<<(std::basic_ostream&, int / long / double / void* / bool)`](../io/basic_ostream/operator_ltlt.html "cpp/io/basic ostream/operator ltlt")
  * [`operator<<(std::basic_ostream&, char)`](../io/basic_ostream/operator_ltlt2.html "cpp/io/basic ostream/operator ltlt2")
  * [`operator<<(std::basic_ostream&, char*)`](../io/basic_ostream/operator_ltlt2.html "cpp/io/basic ostream/operator ltlt2")
  * [`operator<<(std::basic_ostream&, const std::bitset&)`](../utility/bitset/operator_ltltgtgt2.html "cpp/utility/bitset/operator ltltgtgt2")
  * [`operator<<(std::basic_ostream&, const std::basic_string&)`](../string/basic_string/operator_ltltgtgt.html "cpp/string/basic string/operator ltltgtgt")
  * `operator<< `, when called on the return value of [std::put_money](../io/manip/put_money.html "cpp/io/manip/put money")



  * [`operator<<(std::basic_ostream&, std::basic_string_view)`](../string/basic_string_view/operator_ltlt.html "cpp/string/basic string view/operator ltlt")

| (since C++17)  
---|---  
  
  * [`print(std::ostream&, std::format_string<Args...>, Args&&...)`](../io/basic_ostream/print.html "cpp/io/basic ostream/print"), 
  * [`println(std::ostream&, std::format_string<Args...>, Args&&...)`](../io/basic_ostream/println.html "cpp/io/basic ostream/println"), 
  * [`vprint_unicode(std::ostream&, std::string_view, std::format_args)`](../io/basic_ostream/vprint_unicode.html "cpp/io/basic ostream/vprint unicode"), 
  * [`vprint_nonunicode(std::ostream&, std::string_view, std::format_args)`](../io/basic_ostream/vprint_nonunicode.html "cpp/io/basic ostream/vprint nonunicode"), 



     except that (given os is an output stream object): 

  * any exception thrown by the call to [std::vformat](../utility/format/vformat.html "cpp/utility/format/vformat") is propagated without regard to the value of os.exceptions() and without turning on [ios_base::badbit](../io/ios_base/iostate.html "cpp/io/ios base/iostate") in the error state of os; 
  * if inserting into os fails, calls os.setstate(ios_base::badbit) (which may throw [ios_base::failure](../io/ios_base/failure.html "cpp/io/ios base/failure")). 
...
[LWG 165](https://cplusplus.github.io/LWG/issue165) | C++98  | the only virtual member allowed to be  
