...
## Contents
  ...
  * [1 Requirements](EqualityComparable.html#Requirements)
  * [2 Notes](EqualityComparable.html#Notes)
  * [3 Defect reports](EqualityComparable.html#Defect_reports)
  * [4 See also](EqualityComparable.html#See_also)
...
---|---|---  
a == b | meets [BooleanTestable](BooleanTestable.html "cpp/named req/BooleanTestable")  
(until C++20) | Establishes an [equivalence relation](https://en.wikipedia.org/wiki/Equivalence_relation "enwiki:Equivalence relation"), that is, it satisfies the following properties: 
...
For the types that are both EqualityComparable and [LessThanComparable](LessThanComparable.html "cpp/named req/LessThanComparable"), the C++ standard library makes a distinction between 

  * _Equality_ , which is the value of the expression a == b and 
  * _Equivalence_ , which is the value of the expression !(a < b) && !(b < a). 
...
---|---|---|---  
[LWG 283](https://cplusplus.github.io/LWG/issue283) | C++98  | even if `T` is EqualityComparable, the  
requirements did not apply to const T objects  | they apply to  
