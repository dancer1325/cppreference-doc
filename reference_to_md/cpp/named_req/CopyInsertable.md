...
expr |  [std::allocator_traits](../memory/allocator_traits.html)<A>::construct(m, p, v)  
  
`T` is CopyInsertable into `X` if all following conditions are satisfied: 

  * `T` is [MoveInsertable](MoveInsertable.html "cpp/named req/MoveInsertable") into `X`. 
  * expr is well-formed. 
...
[LWG 3957](https://cplusplus.github.io/LWG/issue3957) | C++11  | v could denote an rvalue of type `T` | excluded 
