...
The type `T` satisfies Hash if 
  ...
  * The type `T` satisfies [FunctionObject](FunctionObject.html "cpp/named req/FunctionObject"), [CopyConstructible](CopyConstructible.html "cpp/named req/CopyConstructible"), [Destructible](Destructible.html "cpp/named req/Destructible"), and 
...
Given 
  ...
  * u, an [lvalue](../language/value_category.html "cpp/language/value category") expression of type `Key`. 
...
---|---|---|---  
[LWG 2291](https://cplusplus.github.io/LWG/issue2291) | C++11  | same results for same arguments were required in all cases  | only required within a single execution 
