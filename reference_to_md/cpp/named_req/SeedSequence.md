...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/named_req/SeedSequence&action=edit&section=1 "Edit section: Requirements")] Requirements
  ...
  * `**ib**`, `**ie**` are [LegacyInputIterators](InputIterator.html "cpp/named req/InputIterator") with a `value_type` of unsigned integer values of at least 32 bits. 
  * `**il**` is a [std::initializer_list](../utility/initializer_list.html)<T>. 
  * `**rb**`, `**re**` are [mutable](OutputIterator.html "cpp/named req/OutputIterator") [LegacyRandomAccessIterators](RandomAccessIterator.html "cpp/named req/RandomAccessIterator") with a `value_type` of unsigned integer values of at least 32 bits. 
  * `**ob**` is a [LegacyOutputIterator](OutputIterator.html "cpp/named req/OutputIterator"). 
