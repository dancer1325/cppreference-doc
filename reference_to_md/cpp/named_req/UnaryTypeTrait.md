...
### Requirements
  ...
  * Publicly and unambiguously derived from a specialization of [std::integral_constant](../types/integral_constant.html "cpp/types/integral constant"), known as its _base characteristic_. 
  * The member names of the _base characteristic_ are not hidden and are unambiguously available. 
...
The following [type traits](../meta.html "cpp/meta") all satisfy UnaryTypeTrait: 
  ...
  * [Primary type categories](../meta.html#Primary_type_categories "cpp/meta")
  * [Composite type categories](../meta.html#Composite_type_categories "cpp/meta")
  * [Type properties](../meta.html#Type_properties "cpp/meta")
  * [Supported operations](../meta.html#Supported_operations "cpp/meta")
  * [Property queries](../meta.html#Property_queries "cpp/meta")



The following standard library class templates also satisfy UnaryTypeTrait. 

[ integral_constant](../types/integral_constant.html "cpp/types/integral constant")(C++11) |  compile-time constant of specified type with specified value   
(class template)  
---|---  
