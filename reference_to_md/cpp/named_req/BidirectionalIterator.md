...
If a **LegacyBidirectionalIterator** it originates from a [Container](Container.html "cpp/named req/Container"), then it's `value_type` is the same as the container's, so dereferencing (*it) obtains the container's `value_type`. 

## Contents

  * [1 Requirements](BidirectionalIterator.html#Requirements)
  * [2 Notes](BidirectionalIterator.html#Notes)
  * [3 Concept](BidirectionalIterator.html#Concept)
  * [4 Defect reports](BidirectionalIterator.html#Defect_reports)
  * [5 See also](BidirectionalIterator.html#See_also)
...
The type `It` satisfies LegacyBidirectionalIterator if 
  ...
  * The type `It` satisfies [LegacyForwardIterator](ForwardIterator.html "cpp/named req/ForwardIterator")
...
Postconditions: 
  ...
  * a is [dereferenceable](../iterator.html#Dereferenceability_and_validity "cpp/iterator")
  * \--(++a) == a
  * If \--a == \--b then a == b
...
{ i\-- } -> [std::convertible_to](../concepts/convertible_to.html)<const I&>;  
{ *i\-- } -> [std::same_as](../concepts/same_as.html)<[std::iter_reference_t](../iterator/iter_t.html)<I>>;  
}; |  |   
---|---|---  
| |   
  
where the exposition-only concept `__LegacyForwardIterator` is described in [LegacyForwardIterator](ForwardIterator.html#Concept "cpp/named req/ForwardIterator"). 
...
([N3066](https://wg21.link/N3066))  | C++98  | the return type of *a\-- was  
required to be convertible to `T` | changed the return  
type to `reference`[[1]](BidirectionalIterator.html#cite_note-1)  
[LWG 383](https://cplusplus.github.io/LWG/issue383) | C++98  | b was required to be dereferenceable after \--a | a is required to be dereferenceable instead   
[LWG 1212](https://cplusplus.github.io/LWG/issue1212)  
([N3066](https://wg21.link/N3066))  | C++98  | the return type of *a\-- did not match the return  
type of *a++ required by [LegacyForwardIterator](ForwardIterator.html "cpp/named req/ForwardIterator") | changed the return  
type to `reference`  
  
  1. [↑](BidirectionalIterator.html#cite_ref-1) This issue was initially resolved by [N2758](https://wg21.link/N2758) (iterator concepts), which was dropped later from the C++ standard.
