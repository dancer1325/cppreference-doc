...
where `**X::allocator_type**` is identical to [std::allocator_traits](../memory/allocator_traits.html)<A>::rebind_alloc<T>, 

the following expression is well-formed: 
    
    
    [std::allocator_traits](../memory/allocator_traits.html)<A>::construct(m, p, args);
