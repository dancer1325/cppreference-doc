...
C1::period | A specialization of [std::ratio](../numeric/ratio/ratio.html "cpp/numeric/ratio/ratio") | The tick period of the clock in seconds.   
C1::duration | [std::chrono::duration](../chrono/duration.html)<C1::rep, C1::period> | The duration type of the clock.   
C1::time_point | [std::chrono::time_point](../chrono/time_point.html)<C1> or [std::chrono::time_point](../chrono/time_point.html)<C2, C1::duration> | The [std::chrono::time_point](../chrono/time_point.html "cpp/chrono/time point") type of the clock. C1 and C2 shall refer to the same epoch.   
