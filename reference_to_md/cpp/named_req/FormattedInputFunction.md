...
A FormattedInputFunction is a stream input function that performs the following: 
  ...
  * Constructs an object of type [`basic_istream::sentry`](../io/basic_istream/sentry.html "cpp/io/basic istream/sentry") with automatic storage duration and with the `noskipws` argument set to false, which performs the following: 



    

  * if [`eofbit`](../io/ios_base/iostate.html "cpp/io/ios base/iostate") or [`badbit`](../io/ios_base/iostate.html "cpp/io/ios base/iostate") are set on the input stream, sets the `failbit` as well, and if exceptions on `failbit` are enabled in this input stream's [exception mask](../io/basic_ios/exceptions.html "cpp/io/basic ios/exceptions") ((exceptions() & failbit) != 0), throws [`ios_base::failure`](../io/ios_base/failure.html "cpp/io/ios base/failure"). 
  ...
  * the next available character on the input stream is not a whitespace character, as tested by the [std::ctype](../locale/ctype.html "cpp/locale/ctype") facet of the locale currently imbued in this input stream. The non-whitespace character is not extracted. 
  * the end of the stream is reached, in which case `failbit` and `eofbit` are set and if the stream is on for exceptions on one of these bits, [`ios_base::failure`](../io/ios_base/failure.html "cpp/io/ios base/failure") is thrown. 



  * Checks the status of the sentry by calling `sentry::operator bool()`, which is equivalent to [`basic_ios::good`](../io/basic_ios/good.html "cpp/io/basic ios/good"). 
...
The following standard library functions are **FormattedInputFunction s**. 
  ...
  * [`basic_istream::operator>>(int, long, double, void*, bool)`](../io/basic_istream/operator_gtgt.html "cpp/io/basic istream/operator gtgt")
  * [`operator>>(std::basic_istream, char&)`](../io/basic_istream/operator_gtgt2.html "cpp/io/basic istream/operator gtgt2")
  * [`operator>>(std::basic_istream, char*)`](../io/basic_istream/operator_gtgt2.html "cpp/io/basic istream/operator gtgt2")
  * [`operator>>(std::basic_istream, std::bitset)`](../utility/bitset/operator_ltltgtgt2.html "cpp/utility/bitset/operator ltltgtgt2")
  * [`operator>>(std::basic_istream, std::string)`](../string/basic_string/operator_ltltgtgt.html "cpp/string/basic string/operator ltltgtgt")
  * `operator>>`, when called on the return value of [std::get_money](../io/manip/get_money.html "cpp/io/manip/get money")
