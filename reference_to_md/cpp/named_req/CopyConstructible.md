...
## Contents
  ...
  * [1 Requirements](CopyConstructible.html#Requirements)
  * [2 Notes](CopyConstructible.html#Notes)
  * [3 References](CopyConstructible.html#References)
  * [4 See also](CopyConstructible.html#See_also)
...
The type `T` satisfies CopyConstructible if 
  ...
  * The type `T` satisfies [MoveConstructible](MoveConstructible.html "cpp/named req/MoveConstructible"), and 



Given 

  * v, an [lvalue](../language/value_category.html#lvalue "cpp/language/value category") expression of type `T` or const T or an [rvalue](../language/value_category.html#rvalue "cpp/language/value category") expression of type const T, 
...
Since C++11, the standard library uses [std::addressof](../memory/addressof.html "cpp/memory/addressof") whenever the address of an object is needed. 

Extended content  
---  
Being a CopyConstructible class implies [std::is_copy_constructible](../types/is_copy_constructible.html "cpp/types/is copy constructible") but not vice versa since [std::is_copy_constructible](../types/is_copy_constructible.html "cpp/types/is copy constructible") will only check for the ability to call the constructor with the correct arguments, and, e.g., not a [MoveConstructible](MoveConstructible.html "cpp/named req/MoveConstructible") requirement.  Run this code
    ...
    static_assert([std::is_copy_constructible_v](../types/is_copy_constructible.html)<S>);
     
    int main()
    {
        S s1;
