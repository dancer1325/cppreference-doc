...
## Contents
  ...
  * [1 Requirements](LessThanComparable.html#Requirements)
  * [2 Notes](LessThanComparable.html#Notes)
  * [3 Defect reports](LessThanComparable.html#Defect_reports)
  * [4 See also](LessThanComparable.html#See_also)
...
(until C++20) | Establishes [strict weak ordering](https://en.wikipedia.org/wiki/strict_weak_ordering "enwiki:strict weak ordering") relation with the following properties: 
...
For the types that are both [EqualityComparable](EqualityComparable.html "cpp/named req/EqualityComparable") and LessThanComparable, the C++ standard library makes a distinction between 
