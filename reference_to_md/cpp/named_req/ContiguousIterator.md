...
## Contents
  ...
  * [1 Requirements](ContiguousIterator.html#Requirements)
  * [2 Standard library](ContiguousIterator.html#Standard_library)
  * [3 Notes](ContiguousIterator.html#Notes)
  * [4 See also](ContiguousIterator.html#See_also)
...
The type It satisfies LegacyContiguousIterator if 
  ...
  * The type It satisfies [LegacyIterator](Iterator.html "cpp/named req/Iterator")
...
then 
  ...
  * *(a + n) is equivalent to *([std::addressof](../memory/addressof.html)(*a) + n). 
...
The following standard library types are **LegacyContiguousIterator s**. 
  ...
  * [`array::iterator`](../container/array.html "cpp/container/array"). 
  * [`basic_string_view::iterator`](../string/basic_string_view.html "cpp/string/basic string view"). 
  * [`basic_string::iterator`](../string/basic_string.html "cpp/string/basic string"). 
  * [`vector::iterator`](../container/vector.html "cpp/container/vector") for `value_type` other than bool. 
  * The return type of [`begin(valarray)`](../numeric/valarray/begin2.html "cpp/numeric/valarray/begin2") and [`end(valarray)`](../numeric/valarray/end2.html "cpp/numeric/valarray/end2"). 
