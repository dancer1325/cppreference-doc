...
LegacyIterator is the base set of requirements used by other iterator types: [LegacyInputIterator](InputIterator.html "cpp/named req/InputIterator"), [LegacyOutputIterator](OutputIterator.html "cpp/named req/OutputIterator"), [LegacyForwardIterator](ForwardIterator.html "cpp/named req/ForwardIterator"), [LegacyBidirectionalIterator](BidirectionalIterator.html "cpp/named req/BidirectionalIterator"), and [LegacyRandomAccessIterator](RandomAccessIterator.html "cpp/named req/RandomAccessIterator"). Iterators can be thought of as an abstraction of pointers. 
...
## Contents
  ...
  * [1 Requirements](Iterator.html#Requirements)
  * [2 Concept](Iterator.html#Concept)
  * [3 Notes](Iterator.html#Notes)
  * [4 Defect reports](Iterator.html#Defect_reports)
  * [5 See also](Iterator.html#See_also)
...
The type `It` satisfies LegacyIterator if 
  ...
  * The type `It` satisfies [CopyConstructible](CopyConstructible.html "cpp/named req/CopyConstructible"), and 
  * The type `It` satisfies [CopyAssignable](CopyAssignable.html "cpp/named req/CopyAssignable"), and 
  * The type `It` satisfies [Destructible](Destructible.html "cpp/named req/Destructible"), and 
  * The type `It` satisfies [Swappable](Swappable.html "cpp/named req/Swappable"), and 
  * [std::iterator_traits](../iterator/iterator_traits.html)<It> has member typedefs: `value_type`,(until C++20) `difference_type`, `reference`, `pointer`, and `iterator_category`, and 
  * Given r, an lvalue of type `It`, the following expressions must be valid and have their specified effects: 

Expression | Return Type | Precondition   
---|---|---  
*r | unspecified  | r is [dereferenceable](../iterator.html#Dereferenceability_and_validity "cpp/iterator")  
++r | It& | r is _incrementable_ (the behavior of the expression ++r is defined)   
...
{ *i++ } -> __Referenceable;  
} && [std::copyable](../concepts/copyable.html)<I>; |  |   
---|---|---  
| |   
...
---|---|---  
**LegacyIterator** | [`Cpp17Iterator`](https://eel.is/c++draft/iterator.cpp17#iterator.iterators) | [`input_or_output_iterator`](../iterator/input_or_output_iterator.html "cpp/iterator/input or output iterator")  
[LegacyInputIterator](InputIterator.html "cpp/named req/InputIterator") | [`Cpp17InputIterator`](https://eel.is/c++draft/input.iterators) | [`input_iterator`](../iterator/input_iterator.html "cpp/iterator/input iterator")  
[LegacyOutputIterator](OutputIterator.html "cpp/named req/OutputIterator") | [`Cpp17OutputIterator`](https://eel.is/c++draft/output.iterators) | [`output_iterator`](../iterator/output_iterator.html "cpp/iterator/output iterator")  
[LegacyForwardIterator](ForwardIterator.html "cpp/named req/ForwardIterator") | [`Cpp17ForwardIterator`](https://eel.is/c++draft/forward.iterators) | [`forward_iterator`](../iterator/forward_iterator.html "cpp/iterator/forward iterator")  
[LegacyBidirectionalIterator](BidirectionalIterator.html "cpp/named req/BidirectionalIterator") | [`Cpp17BidirectionalIterator`](https://eel.is/c++draft/bidirectional.iterators) | [`bidirectional_iterator`](../iterator/bidirectional_iterator.html "cpp/iterator/bidirectional iterator")  
[LegacyRandomAccessIterator](RandomAccessIterator.html "cpp/named req/RandomAccessIterator") | [`Cpp17RandomAccessIterator`](https://eel.is/c++draft/random.access.iterators) | [`random_access_iterator`](../iterator/random_access_iterator.html "cpp/iterator/random access iterator")  
[LegacyContiguousIterator](ContiguousIterator.html "cpp/named req/ContiguousIterator")[[1]](Iterator.html#cite_note-1) |  | [`contiguous_iterator`](../iterator/contiguous_iterator.html "cpp/iterator/contiguous iterator")  
