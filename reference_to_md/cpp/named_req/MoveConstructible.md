...
## Contents
  ...
  * [1 Requirements](MoveConstructible.html#Requirements)
  * [2 Notes](MoveConstructible.html#Notes)
  * [3 References](MoveConstructible.html#References)
  * [4 See also](MoveConstructible.html#See_also)
...
Given 
  ...
  * `rv`, an [rvalue](../language/value_category.html "cpp/language/value category") expression of type `T`, 
...
If a MoveConstructible class implements a move constructor, it may also implement [move semantics](../utility/move.html "cpp/utility/move") to take advantage of the fact that the value of `rv` after construction is unspecified. 

Extended content  
---  
Being a MoveConstructible class implies [std::is_move_constructible](../types/is_move_constructible.html "cpp/types/is move constructible") but not vice versa since [std::is_move_constructible](../types/is_move_constructible.html "cpp/types/is move constructible") will only check for the ability to call the constructor with the correct arguments, not a post-condition value.  Run this code
    ...
    static_assert([std::is_move_constructible_v](../types/is_move_constructible.html)<S>);
     
    int main()
    {
        S v{1};
        [std::cout](../io/cout.html) << "v.n = " << v.n << '\n';
        S u = std::move(v);
     
