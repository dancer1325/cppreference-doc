...
`_INVOKE_` can be performed explicitly using the library function [std::invoke](../utility/functional/invoke.html "cpp/utility/functional/invoke").  | (since C++17)  
---|---  
`_INVOKE <R>_` can be performed explicitly using the library function [`std::invoke_r`](../utility/functional/invoke.html "cpp/utility/functional/invoke").  | (since C++23)  
  
## Contents

  * [1 Requirements](Callable.html#Requirements)
  * [2 Notes](Callable.html#Notes)
  * [3 Standard library](Callable.html#Standard_library)
  * [4 See also](Callable.html#See_also)
