...
The type `D` satisfies RandomNumberDistribution if 
  ...
  * `D` satisfies [CopyConstructible](CopyConstructible.html "cpp/named req/CopyConstructible")
  * `D` satisfies [CopyAssignable](CopyAssignable.html "cpp/named req/CopyAssignable")
...
Given 
  ...
  * satisfies [CopyConstructible](CopyConstructible.html "cpp/named req/CopyConstructible")
  * satisfies [CopyAssignable](CopyAssignable.html "cpp/named req/CopyAssignable")
  * satisfies [EqualityComparable](EqualityComparable.html "cpp/named req/EqualityComparable")
  ...
  * `g`, `g1`, `g2`, lvalues of a type satisfying [UniformRandomBitGenerator](UniformRandomBitGenerator.html "cpp/named req/UniformRandomBitGenerator")
  * `os`, lvalue of a specialization of [std::basic_ostream](../io/basic_ostream.html "cpp/io/basic ostream")
  * `is`, lvalue of a specialization of [std::basic_istream](../io/basic_istream.html "cpp/io/basic istream")
...
---|---|---|---  
`D::result_type` | `T` | An [arithmetic type](../language/type-id.html "cpp/language/type") | Compile-time   
