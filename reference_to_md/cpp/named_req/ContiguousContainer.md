...
The type `X` satisfies ContiguousContainer if 
  ...
  * The type `X` satisfies [Container](Container.html "cpp/named req/Container")
  * The type `X` supports [LegacyRandomAccessIterators](RandomAccessIterator.html "cpp/named req/RandomAccessIterator")
  * The member types X::iterator and X::const_iterator are [LegacyContiguousIterators](ContiguousIterator.html "cpp/named req/ContiguousIterator")(until C++20)[`contiguous_iterator`s](../iterator/contiguous_iterator.html "cpp/iterator/contiguous iterator")(since C++20)
