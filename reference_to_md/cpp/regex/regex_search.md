...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_search&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_search&action=edit&section=2 "Edit section: Return value")] Return value

Returns true if a match exists, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_search&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_search&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_search&action=edit&section=5 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_search&action=edit&section=6 "Edit section: See also")] See also
