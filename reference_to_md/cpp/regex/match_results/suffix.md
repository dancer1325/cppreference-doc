...
Obtains a reference to the [std::sub_match](../sub_match.html "cpp/regex/sub match") object representing the target sequence between the end of the entire match of the regular expression and the end of the target sequence. 

[`ready()`](ready.html "cpp/regex/match results/ready") must be true. Otherwise, the behavior is undefined. 

## Contents

  * [1 Parameters](suffix.html#Parameters)
  * [2 Return value](suffix.html#Return_value)
  * [3 Example](suffix.html#Example)
  * [4 See also](suffix.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/suffix&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/suffix&action=edit&section=2 "Edit section: Return value")] Return value

Reference to the unmatched suffix. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/suffix&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::regex](../basic_regex.html) re("a(a)*by");
        [std::string](../../string/basic_string.html) target("baaaby123");
        [std::smatch](../match_results.html) sm;
     
        [std::regex_search](../regex_search.html)(target, sm, re);
        [std::cout](../../io/cout.html) << sm.suffix() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/suffix&action=edit&section=4 "Edit section: See also")] See also

[ prefix](prefix.html "cpp/regex/match results/prefix") |  returns sub-sequence between the beginning of the target sequence and the beginning of the full match   
