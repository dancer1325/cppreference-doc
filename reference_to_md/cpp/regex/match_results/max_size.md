...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/max_size&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/max_size&action=edit&section=2 "Edit section: Return value")] Return value

Maximum number of submatches. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/max_size&action=edit&section=3 "Edit section: Complexity")] Complexity
