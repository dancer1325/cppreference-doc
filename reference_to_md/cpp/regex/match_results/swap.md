...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  the `match_results` to swap with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/swap&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/swap&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/swap&action=edit&section=4 "Edit section: See also")] See also

[ std::swap(std::match_results)](swap2.html "cpp/regex/match results/swap2")(C++11) |  specializes the [`std::swap`](../../utility/swap.html "cpp/algorithm/swap") algorithm   
