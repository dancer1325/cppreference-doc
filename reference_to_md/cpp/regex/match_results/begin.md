...
Iterators  
**match_results::begin match_results::cbegin**  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/begin&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/begin&action=edit&section=2 "Edit section: Return value")] Return value

Iterator to the first sub-match. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/begin&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/begin&action=edit&section=4 "Edit section: See also")] See also
