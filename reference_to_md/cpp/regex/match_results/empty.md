...
## Contents
  ...
  * [4 Complexity](empty.html#Complexity)
  * [5 See also](empty.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/empty&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/empty&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/empty&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/empty&action=edit&section=4 "Edit section: See also")] See also

[ size](size.html "cpp/regex/match results/size") |  returns the number of matches in a fully-established result state   
