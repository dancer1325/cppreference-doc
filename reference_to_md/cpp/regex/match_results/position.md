...
## Contents
  ...
  * [1 Parameters](position.html#Parameters)
  * [2 Return value](position.html#Return_value)
  * [3 Example](position.html#Example)
  * [4 See also](position.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/position&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  integral number specifying which match to examine   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/position&action=edit&section=2 "Edit section: Return value")] Return value

The position of the first character of the specified match or sub-match. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/position&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html) << sm.position(1) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/position&action=edit&section=4 "Edit section: See also")] See also
