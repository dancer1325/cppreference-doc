...
## Contents
  ...
  * [3 Example](length.html#Example)
  * [4 See also](length.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/length&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  integral number specifying which match to examine   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/length&action=edit&section=2 "Edit section: Return value")] Return value

The length of the specified match or sub-match. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/length&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/match_results/length&action=edit&section=4 "Edit section: See also")] See also
...
(public member function of `std::sub_match<BidirIt>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/regex/sub_match/dsc_length&action=edit)
