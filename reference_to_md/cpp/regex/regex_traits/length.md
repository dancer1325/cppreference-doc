...
static [std::size_t](../../types/size_t.html) length( const char_type* p ); |  |   
---|---|---  
| |   
  
Calculates the length of a null-terminated character sequence, that is, the smallest `i` such that p[i] == 0. 

Standard library specializations of [std::regex_traits](../regex_traits.html "cpp/regex/regex traits") execute [std::char_traits](../../string/char_traits.html)<CharT>::length(p);. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_traits/length&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  pointer to the first element of the null-terminated character sequence   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_traits/length&action=edit&section=2 "Edit section: Return value")] Return value

The length of the null-terminated character string. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_traits/length&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::regex_traits](../regex_traits.html)<char>::length("Кошка") << '\n'
                  << [std::regex_traits](../regex_traits.html)<wchar_t>::length(L"Кошка") << '\n';
    }
