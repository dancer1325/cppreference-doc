...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_traits/imbue&action=edit&section=1 "Edit section: Parameters")] Parameters

loc  |  \-  |  the locale to imbue   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_traits/imbue&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_traits/imbue&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/regex_traits/imbue&action=edit&section=4 "Edit section: See also")] See also

[ getloc](getloc.html "cpp/regex/regex traits/getloc") |  gets the locale   
