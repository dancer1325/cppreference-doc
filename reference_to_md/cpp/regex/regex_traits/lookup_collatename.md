...
Run this code
    ...
    #include <string>
     
    struct noisy_traits : [std::regex_traits](../regex_traits.html)<char>
    {
        template<class Iter>
        string_type lookup_collatename(Iter first, Iter last) const
        {
            string_type result = regex_traits::lookup_collatename(first, last);
            [std::cout](../../io/cout.html) << "regex_traits<>::lookup_collatename(\""
    ...
    int main()
    {
        [std::string](../../string/basic_string.html) str = "z|}a"; // C locale collation order: x,y,z,{,|,},~
        [std::basic_regex](../basic_regex.html)<char, noisy_traits> re("[x-[.tilde.]]*a", std::regex::basic);
