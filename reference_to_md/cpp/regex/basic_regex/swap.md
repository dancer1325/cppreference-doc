...
void swap( basic_regex& other ) noexcept; |  |  (since C++11)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/basic_regex/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  the regular expression to swap with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/basic_regex/swap&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/basic_regex/swap&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/basic_regex/swap&action=edit&section=4 "Edit section: See also")] See also

[ std::swap(std::basic_regex)](swap2.html "cpp/regex/basic regex/swap2")(C++11) |  specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm   
