...
Default constructs a [std::sub_match](../sub_match.html "cpp/regex/sub match"). The [`matched`](../sub_match.html#Data_members "cpp/regex/sub match") member is set to false and the inherited members [`first`](../sub_match.html#Data_members "cpp/regex/sub match") and [`second`](../sub_match.html#Data_members "cpp/regex/sub match") are value-initialized. 

This is the only publicly accessible and defined constructor. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/regex/sub_match/sub_match&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::sub_match](../sub_match.html)<const char*> s;
        [assert](../../error/assert.html)(!s.matched);
    }
