...
Converts to an object of the underlying [std::basic_string](../../string/basic_string.html "cpp/string/basic string") type. 
...
Run this code
    ...
    int main()
    {
        const [std::string](../../string/basic_string.html) html{R"("<a href="https://cppreference.com/">)"};
        const std::regex re{"(http|https|ftp)://([a-z]+)\\.([a-z]{3})"};
        [std::smatch](../match_results.html) parts;
        [std::regex_search](../regex_search.html)(html, parts, re);
        for ([std::ssub_match](../sub_match.html) const& sub : parts)
        {
            const [std::string](../../string/basic_string.html) s = sub; // (1) implicit conversion
            [assert](../../error/assert.html)(s == sub.str());    // (2)
