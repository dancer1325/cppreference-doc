...
---|---|---  
regex_error( [std::regex_constants::error_type](../error_type.html) ecode ); |  (1)  |  (since C++11)  
regex_error( const regex_error& other ); |  (2)  |  (since C++11)  
| |   
  
1) Constructs a `regex_error` with a given ecode of type [std::regex_constants::error_type](../error_type.html "cpp/regex/error type").
