...
---|---|---  
void qsort( void *ptr, [std::size_t](../types/size_t.html) count,  
[std::size_t](../types/size_t.html) size, /* c-compare-pred */* comp );  
void qsort( void *ptr, [std::size_t](../types/size_t.html) count,  
[std::size_t](../types/size_t.html) size, /* compare-pred */* comp ); |  (1)  |   
...
If the type of the elements of the array is not a [PODType](../named_req/PODType.html "cpp/named req/PODType")(until C++11)[TriviallyCopyable](../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable") type(since C++11), the behavior is undefined. 
...
## Contents
  ...
  * [5 Defect reports](qsort.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        [std::array](../container/array.html) a{-2, 99, 0, -743, [INT_MAX](../types/climits.html), 2, [INT_MIN](../types/climits.html), 4};
     
        std::qsort
        (
            a.data(),
