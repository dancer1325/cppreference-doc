...
2,4) Same as (1,3), but executed according to policy. These overloads participate in overload resolution only if all following conditions are satisfied:  [std::is_execution_policy_v](is_execution_policy.html)<[std::decay_t](../types/decay.html)<ExecutionPolicy>> is true.  | (until C++20)  
---|---  
...
## Contents
  ...
  * [4 Exceptions](lexicographical_compare.html#Exceptions)
  * [5 Possible implementation](lexicographical_compare.html#Possible_implementation)
  * [6 Example](lexicographical_compare.html#Example)
  * [7 Defect reports](lexicographical_compare.html#Defect_reports)
  * [8 See also](lexicographical_compare.html#See_also)
...
[lexicographical_compare (3)](lexicographical_compare.html#Version_3)  
...
Run this code
    ...
    #include <vector>
     
    void print(const [std::vector](../container/vector.html)<char>& v, auto suffix)
    {
        for (char c : v)
            [std::cout](../io/cout.html) << c << ' ';
        [std::cout](../io/cout.html) << suffix;
    }
     
    int main()
    {
    ...
     
        for ([std::mt19937](../numeric/random/mersenne_twister_engine.html) g{[std::random_device](../numeric/random/random_device.html){}()};
                                           ...
                                           v2.begin(), v2.end());)
        {
            ...
            print(v2, '\n');
     
            [std::shuffle](random_shuffle.html)(v1.begin(), v1.end(), g);
            [std::shuffle](random_shuffle.html)(v2.begin(), v2.end(), g);
        }
     
        print(v1, "<  ");
        print(v2, '\n');
...
---|---|---|---  
[LWG 142](https://cplusplus.github.io/LWG/issue142) | C++98  | at most \\(\scriptsize \min(N_1,N_2)\\)min(N1,N2) comparisons were allowed, but that  
