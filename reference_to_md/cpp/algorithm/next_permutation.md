...
bool next_permutation( BidirIt first, BidirIt last ); |  (1)  |  (constexpr since C++20)  
template< class BidirIt, class Compare >  
bool next_permutation( BidirIt first, BidirIt last, Compare comp ); |  (2)  |  (constexpr since C++20)  
| |   
  
Permutes the range `[`first`, `last`)` into the next [permutation](https://en.wikipedia.org/wiki/permutation "enwiki:permutation"). Returns true if such a “next permutation” exists; otherwise transforms the range into the lexicographically first permutation (as if by [std::sort](sort.html "cpp/algorithm/sort")) and returns false. 
...
## Contents
  ...
  * [1 Parameters](next_permutation.html#Parameters)
  * [2 Return value](next_permutation.html#Return_value)
  * [3 Complexity](next_permutation.html#Complexity)
  * [4 Exceptions](next_permutation.html#Exceptions)
  * [5 Possible implementation](next_permutation.html#Possible_implementation)
  * [6 Notes](next_permutation.html#Notes)
  * [7 Example](next_permutation.html#Example)
  * [8 See also](next_permutation.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/next_permutation&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/next_permutation&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/next_permutation&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/next_permutation&action=edit&section=4 "Edit section: Exceptions")] Exceptions

Any exceptions thrown from iterator operations or the element swap. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/next_permutation&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class BidirIt>
    bool next_permutation(BidirIt first, BidirIt last)
    {
        auto r_first = [std::make_reverse_iterator](../iterator/make_reverse_iterator.html)(last);
        auto r_last = [std::make_reverse_iterator](../iterator/make_reverse_iterator.html)(first);
        auto left = [std::is_sorted_until](is_sorted_until.html)(r_first, r_last);
     
        if (left != r_last)
        {
            auto right = [std::upper_bound](upper_bound.html)(r_first, left, *left);
            [std::iter_swap](iter_swap.html)(left, right);
        }
     
        [std::reverse](reverse.html)(left.base(), last);
        return left != r_last;
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/next_permutation&action=edit&section=6 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/next_permutation&action=edit&section=7 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/next_permutation&action=edit&section=8 "Edit section: See also")] See also
