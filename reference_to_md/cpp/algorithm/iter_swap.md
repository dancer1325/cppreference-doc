...
void iter_swap( ForwardIt1 a, ForwardIt2 b ); |  |  (constexpr since C++20)  
| |   
...
If any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * a or b is not [dereferenceable](../iterator.html#Dereferenceability_and_validity "cpp/iterator"). 
  * *a is not [Swappable](../named_req/Swappable.html "cpp/named req/Swappable") with *b. 
...
## Contents
  ...
  * [4 Notes](iter_swap.html#Notes)
  * [5 Possible implementation](iter_swap.html#Possible_implementation)
  * [6 Example](iter_swap.html#Example)
  * [7 Defect reports](iter_swap.html#Defect_reports)
  * [8 See also](iter_swap.html#See_also)
...
Run this code
    ...
    void selection_sort(ForwardIt begin, ForwardIt end)
    {
        for (ForwardIt it = begin; it != end; ++it)
            std::iter_swap(it, [std::min_element](min_element.html)(it, end));
    }
     
    void println([std::string_view](../string/basic_string_view.html) rem, [std::vector](../container/vector.html)<int> const& v)
    {
    ...
    int rand_int()
    {
        static [std::uniform_int_distribution](../numeric/random/uniform_int_distribution.html) dist(min, max);
        static [std::mt19937](../numeric/random/mersenne_twister_engine.html) gen([std::random_device](../numeric/random/random_device.html){}());
        return dist(gen);
    }
     
    int main()
    {
        ...
        [std::generate_n](generate_n.html)([std::back_inserter](../iterator/back_inserter.html)(v), 20, rand_int<-9, +9>);
     
