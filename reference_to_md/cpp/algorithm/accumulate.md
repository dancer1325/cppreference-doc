...
## Contents
  ...
  * [1 Parameters](accumulate.html#Parameters)
  * [2 Return value](accumulate.html#Return_value)
  * [3 Possible implementation](accumulate.html#Possible_implementation)
  * [4 Notes](accumulate.html#Notes)
  * [5 Example](accumulate.html#Example)
  * [6 Defect reports](accumulate.html#Defect_reports)
  * [7 See also](accumulate.html#See_also)
...
[accumulate (2)](accumulate.html#Version_2)  
...
Run this code
    ...
     
        ...
        int product = std::accumulate(v.begin(), v.end(), 1, [std::multiplies](../utility/functional/multiplies.html)<int>());
     
        auto dash_fold = []([std::string](../string/basic_string.html) a, int b)
        {
            return std::move(a) + '-' + [std::to_string](../string/basic_string/to_string.html)(b);
        };
     
        [std::string](../string/basic_string.html) s = std::accumulate([std::next](../iterator/next.html)(v.begin()), v.end(),
                                        [std::to_string](../string/basic_string/to_string.html)(v[0]), // start with first element
                                        dash_fold);
     
        // Right fold using reverse iterators
        [std::string](../string/basic_string.html) rs = std::accumulate([std::next](../iterator/next.html)(v.rbegin()), v.rend(),
                                         [std::to_string](../string/basic_string/to_string.html)(v.back()), // start with last element
                                         dash_fold);
     
