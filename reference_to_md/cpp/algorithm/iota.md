...
void iota( ForwardIt first, ForwardIt last, T value ); |  |  (since C++11)   
...
If any of the following conditions is satisfied, the program is ill-formed: 
  ...
  * `T` is not convertible to the [value type](../iterator.html#Types_and_writability "cpp/iterator") of `ForwardIt`. 
...
## Contents
  ...
  * [2 Complexity](iota.html#Complexity)
  * [3 Possible implementation](iota.html#Possible_implementation)
  * [4 Notes](iota.html#Notes)
  * [5 Example](iota.html#Example)
  * [6 See also](iota.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::list](../container/list.html)<BigData> l(10);
        std::iota(l.begin(), l.end(), -4);
     
        [std::vector](../container/vector.html)<[std::list](../container/list.html)<BigData>::iterator> v(l.size());
    ...
     
        [std::shuffle](random_shuffle.html)(v.begin(), v.end(), [std::mt19937](../numeric/random/mersenne_twister_engine.html){[std::random_device](../numeric/random/random_device.html){}()});
     
        [std::cout](../io/cout.html) << "Original contents of the list l:\t";
        for (const auto& n : l)
            [std::cout](../io/cout.html) << [std::setw](../io/manip/setw.html)(2) << n << ' ';
        [std::cout](../io/cout.html) << '\n';
     
        [std::cout](../io/cout.html) << "Contents of l, viewed via shuffled v:\t";
        for (const auto i : v)
            [std::cout](../io/cout.html) << [std::setw](../io/manip/setw.html)(2) << *i << ' ';
        [std::cout](../io/cout.html) << '\n';
    }
