...
ForwardIt adjacent_find( ForwardIt first, ForwardIt last ); |  (1) | (constexpr since C++20)  
...
## Contents
  ...
  * [4 Exceptions](adjacent_find.html#Exceptions)
  * [5 Possible implementation](adjacent_find.html#Possible_implementation)
  * [6 Example](adjacent_find.html#Example)
  * [7 Defect reports](adjacent_find.html#Defect_reports)
  * [8 See also](adjacent_find.html#See_also)
...
[adjacent_find (3)](adjacent_find.html#Version_3)  
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v1{0, 1, 2, 3, 40, 40, 41, 41, 5};
     
    ...
     
        if (i1 == v1.end())
            ...
            [std::cout](../io/cout.html) << "The first adjacent pair of equal elements is at "
                      << [std::distance](../iterator/distance.html)(v1.begin(), i1) << ", *i1 = "
                      << *i1 << '\n';
     
        auto i2 = std::adjacent_find(v1.begin(), v1.end(), [std::greater](../utility/functional/greater.html)<int>());
        if (i2 == v1.end())
            ...
            [std::cout](../io/cout.html) << "The last element in the non-decreasing subsequence is at "
                      << [std::distance](../iterator/distance.html)(v1.begin(), i2) << ", *i2 = " << *i2 << '\n';
    }
...
---|---|---|---  
[LWG 240](https://cplusplus.github.io/LWG/issue240) | C++98  | the predicate was applied [std::find](find.html)  
(first, last, value) - first times  
for (1,3), where value was never defined  | applied [std::min](min.html)(  
(result - first) + 1,  
(last - first) - 1) times   
