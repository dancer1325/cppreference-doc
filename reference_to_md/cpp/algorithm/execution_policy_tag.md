...
| **execution::seq execution::parexecution::par_unseqexecution::unseq**(C++17) (C++17)(C++17)(C++20)  
---  
...
---|---|---  
inline constexpr  
[std::execution::sequenced_policy](execution_policy_tag_t.html) seq { /* unspecified */ }; |  |  (since C++17)  
inline constexpr  
[std::execution::parallel_policy](execution_policy_tag_t.html) par { /* unspecified */ }; |  |  (since C++17)  
inline constexpr  
[std::execution::parallel_unsequenced_policy](execution_policy_tag_t.html) par_unseq { /* unspecified */ }; |  |  (since C++17)  
inline constexpr  
[std::execution::unsequenced_policy](execution_policy_tag_t.html) unseq { /* unspecified */ }; |  |  (since C++20)  
| |   
  
The execution policy types 

  * [std::execution::sequenced_policy](execution_policy_tag_t.html "cpp/algorithm/execution policy tag t"), 
  * [std::execution::parallel_policy](execution_policy_tag_t.html "cpp/algorithm/execution policy tag t"), 
  * [std::execution::parallel_unsequenced_policy](execution_policy_tag_t.html "cpp/algorithm/execution policy tag t"), and 
  * [std::execution::unsequenced_policy](execution_policy_tag_t.html "cpp/algorithm/execution policy tag t")
...
Run this code
    ...
    #endif
     
    void measure([[maybe_unused]] auto policy, [std::vector](../container/vector.html)<[std::uint64_t](../types/integer.html)> v)
    {
        const auto start = [std::chrono::steady_clock::now](../chrono/steady_clock/now.html)();
    #ifdef PARALLEL
        [std::sort](sort.html)(policy, v.begin(), v.end());
    #else
        [std::sort](sort.html)(v.begin(), v.end());
    #endif
        const auto finish = [std::chrono::steady_clock::now](../chrono/steady_clock/now.html)();
        [std::cout](../io/cout.html) << [std::chrono::duration_cast](../chrono/duration/duration_cast.html)<[std::chrono::milliseconds](../chrono/duration.html)>(finish - start)
                  << '\n';
    };
     
    int main()
    {
        [std::vector](../container/vector.html)<[std::uint64_t](../types/integer.html)> v(1'000'000);
        [std::mt19937](../numeric/random/mersenne_twister_engine.html) gen {[std::random_device](../numeric/random/random_device.html){}()};
        std::[ranges::generate](ranges/generate.html)(v, gen);
     
