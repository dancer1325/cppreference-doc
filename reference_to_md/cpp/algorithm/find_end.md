...
## Contents
  ...
  * [4 Exceptions](find_end.html#Exceptions)
  * [5 Possible implementation](find_end.html#Possible_implementation)
  * [6 Example](find_end.html#Example)
  * [7 Defect reports](find_end.html#Defect_reports)
  * [8 See also](find_end.html#See_also)
...
---  
    ...
     
        ...
        while (true)
        {
            ForwardIt1 new_result = [std::search](search.html)(first, last, s_first, s_last);
            if (new_result == last)
                break;
            else
            {
...
[find_end (3)](find_end.html#Version_3)  
    ...
     
        ...
        while (true)
        {
            ForwardIt1 new_result = [std::search](search.html)(first, last, s_first, s_last, p);
            if (new_result == last)
                break;
            else
            {
...
Run this code
    ...
    {
        result == v.end()
            ? [std::cout](../io/cout.html) << "Sequence not found\n"
            : [std::cout](../io/cout.html) << "Last occurrence is at: " << [std::distance](../iterator/distance.html)(v.begin(), result)
                        << '\n';
    };
     
    int main()
    ...
     
        for (auto const& x : {[std::array](../container/array.html){1, 2, 3}, {4, 5, 6}})
        {
