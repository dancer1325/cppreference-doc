...
BidirIt2 copy_backward( BidirIt1 first, BidirIt1 last, BidirIt2 d_last ); |  |  (constexpr since C++20)  
| |   
...
The behavior is undefined if d_last is within `(`first`, `last`]`. [std::copy](copy.html "cpp/algorithm/copy") must be used instead of `std::copy_backward` in that case. 
...
## Contents
  ...
  * [7 Defect reports](copy_backward.html#Defect_reports)
  * [8 See also](copy_backward.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> source(4);
        [std::iota](iota.html)(source.begin(), source.end(), 1); // fills with 1, 2, 3, 4
     
        [std::vector](../container/vector.html)<int> destination(6);
     
...
---|---|---|---  
[LWG 1206](https://cplusplus.github.io/LWG/issue1206) | C++98  | 1\. the behavior was well-defined if d_last == last  
