...
ForwardIt2 first2 ); |  (1)  |  (constexpr since C++20)  
...
1) Exchanges elements between range `[`first1`, `last1`)` and another range of [std::distance](../iterator/distance.html)(first1, last1) elements starting at first2.
...
If any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * There exists a pair of corresponding iterators iter1 and iter2 in the two ranges such that *iter1 is not [Swappable](../named_req/Swappable.html "cpp/named req/Swappable") with *iter2. 
...
## Contents
  ...
  * [4 Exceptions](swap_ranges.html#Exceptions)
  * [5 Notes](swap_ranges.html#Notes)
  * [6 Possible implementation](swap_ranges.html#Possible_implementation)
  * [7 Example](swap_ranges.html#Example)
  * [8 See also](swap_ranges.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/swap_ranges&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
    ...
    ForwardIt2 swap_ranges(ForwardIt1 first1, ForwardIt1 last1, ForwardIt2 first2)
    {
        for (; first1 != last1; ++first1, ++first2)
            [std::iter_swap](iter_swap.html)(first1, first2);
     
        return first2;
    }  
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<char> v{'a', 'b', 'c', 'd', 'e'};
        [std::list](../container/list.html)<char> l{'1', '2', '3', '4', '5'};
     
