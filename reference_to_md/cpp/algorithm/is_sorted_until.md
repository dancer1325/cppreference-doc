...
ForwardIt is_sorted_until( ForwardIt first, ForwardIt last ); |  (1) | (since C++11)   
...
1) Finds the largest range whether elements are [sorted](../algorithm.html#Requirements "cpp/algorithm") with respect to operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).
...
## Contents
  ...
  * [4 Exceptions](is_sorted_until.html#Exceptions)
  * [5 Possible implementation](is_sorted_until.html#Possible_implementation)
...
[is_sorted_until (1)](is_sorted_until.html#Version_1)  
---  
    ...
    ForwardIt is_sorted_until(ForwardIt first, ForwardIt last)
    {
        return std::is_sorted_until(first, last, [std::less](../utility/functional/less.html)<>());
    }  
  
[is_sorted_until (2)](is_sorted_until.html#Version_3)  
...
Run this code
    ...
     
        ...
        {
            [std::shuffle](random_shuffle.html)(nums, nums + N, g);
            int *const sorted_end = std::is_sorted_until(nums, nums + N);
            sorted_size = [std::distance](../iterator/distance.html)(nums, sorted_end);
            [assert](../error/assert.html)(sorted_size >= 1);
     
            for (const auto i : nums)
                [std::cout](../io/cout.html) << i << ' ';
            [std::cout](../io/cout.html) << ": " << sorted_size << " initial sorted elements\n"
                      << [std::string](../string/basic_string.html)(sorted_size * 2 - 1, '^') << '\n';
        }
    }
