...
bool is_sorted( ForwardIt first, ForwardIt last ); |  (1) | (since C++11)   
(constexpr since C++20)  
template< class ExecutionPolicy, class ForwardIt >  
bool is_sorted( ExecutionPolicy&& policy,  
ForwardIt first, ForwardIt last ); |  (2)  |  (since C++17)  
template< class ForwardIt, class Compare >  
bool is_sorted( ForwardIt first, ForwardIt last, Compare comp ); |  (3) | (since C++11)   
(constexpr since C++20)  
...
1) Checks if the elements are [sorted](../algorithm.html#Requirements "cpp/algorithm") with respect to operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).
...
## Contents
  ...
  * [4 Exceptions](is_sorted.html#Exceptions)
  * [5 Possible implementation](is_sorted.html#Possible_implementation)
  * [6 Notes](is_sorted.html#Notes)
  * [7 Example](is_sorted.html#Example)
  * [8 See also](is_sorted.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_sorted&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_sorted&action=edit&section=2 "Edit section: Return value")] Return value

true if the elements in the range are sorted in non-descending order, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_sorted&action=edit&section=3 "Edit section: Complexity")] Complexity

Given \\(\scriptsize N\\)N as [std::distance](../iterator/distance.html)(first, last): 

1,2) \\(\scriptsize O(N)\\)O(N) comparisons using operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).

3,4) \\(\scriptsize O(N)\\)O(N) applications of the comparator comp.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_sorted&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_sorted&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
...
[is_sorted (1)](is_sorted.html#Version_1)  
---  
    ...
    {
        return [std::is_sorted_until](is_sorted_until.html)(first, last) == last;
    }  
  
[is_sorted (3)](is_sorted.html#Version_3)  
      
    
    template<class ForwardIt, class Compare>
    bool is_sorted(ForwardIt first, ForwardIt last, Compare comp)
    {
        return [std::is_sorted_until](is_sorted_until.html)(first, last, comp) == last;
    }  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_sorted&action=edit&section=6 "Edit section: Notes")] Notes

`std::is_sorted` returns true for empty ranges and ranges of length one. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_sorted&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [assert](../error/assert.html)(std::is_sorted(v.cbegin(), v.cend()) && "an empty range is always sorted");
        v.push_back(42);
        [assert](../error/assert.html)(std::is_sorted(v.cbegin(), v.cend()) && "a range of size 1 is always sorted");
     
        int data[] = {3, 1, 4, 1, 5};
        [assert](../error/assert.html)(not std::is_sorted([std::begin](../iterator/begin.html)(data), [std::end](../iterator/end.html)(data)));
     
        [std::sort](sort.html)([std::begin](../iterator/begin.html)(data), [std::end](../iterator/end.html)(data));
        [assert](../error/assert.html)(std::is_sorted([std::begin](../iterator/begin.html)(data), [std::end](../iterator/end.html)(data)));
        [assert](../error/assert.html)(not std::is_sorted([std::begin](../iterator/begin.html)(data), [std::end](../iterator/end.html)(data), [std::greater](../utility/functional/greater.html)<>{}));
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_sorted&action=edit&section=8 "Edit section: See also")] See also
