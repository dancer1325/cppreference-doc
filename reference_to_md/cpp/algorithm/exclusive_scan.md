...
OutputIt d_first, T init ); |  (1)  |  (since C++17)   
...
OutputIt exclusive_scan( InputIt first, InputIt last,  
OutputIt d_first, T init, BinaryOp op ); |  (3)  |  (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy,  
...
ForwardIt2 exclusive_scan( ExecutionPolicy&& policy,  
ForwardIt1 first, ForwardIt1 last,  
ForwardIt2 d_first, T init, BinaryOp op ); |  (4)  |  (since C++17)  
| |   
  
1) Equivalent to exclusive_scan(first, last, d_first, init, [std::plus](../utility/functional/plus.html)<>().
...
## Contents
  ...
  * [1 Parameters](exclusive_scan.html#Parameters)
  * [2 Return value](exclusive_scan.html#Return_value)
  * [3 Complexity](exclusive_scan.html#Complexity)
  * [4 Exceptions](exclusive_scan.html#Exceptions)
  * [5 Example](exclusive_scan.html#Example)
  * [6 See also](exclusive_scan.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/exclusive_scan&action=edit&section=1 "Edit section: Parameters")] Parameters
...
op  |  \-  |  binary [FunctionObject](../named_req/FunctionObject.html "cpp/named req/FunctionObject") that will be applied in to the result of dereferencing the input iterators, the results of other op, and init  
Type requirements   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/exclusive_scan&action=edit&section=2 "Edit section: Return value")] Return value

Iterator to the element past the last element written. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/exclusive_scan&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/exclusive_scan&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/exclusive_scan&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::inclusive_scan](inclusive_scan.html)(data.begin(), data.end(),
                            [std::ostream_iterator](../iterator/ostream_iterator.html)<int>([std::cout](../io/cout.html), " "));
     
        [std::cout](../io/cout.html) << "\n\nExclusive product: ";
        std::exclusive_scan(data.begin(), data.end(),
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/exclusive_scan&action=edit&section=6 "Edit section: See also")] See also
