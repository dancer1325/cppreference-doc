...
bool is_partitioned( InputIt first, InputIt last, UnaryPred p ); |  (1)  |  (since C++11)   
...
## Contents
  ...
  * [4 Exceptions](is_partitioned.html#Exceptions)
  * [5 Possible implementation](is_partitioned.html#Possible_implementation)
  * [6 Example](is_partitioned.html#Example)
  * [7 See also](is_partitioned.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::array](../container/array.html)<int, 9> v {1, 2, 3, 4, 5, 6, 7, 8, 9};
     
        auto is_even = [](int i) { return i % 2 == 0; };
        [std::cout](../io/cout.html).setf([std::ios_base::boolalpha](../io/ios_base/fmtflags.html));
        [std::cout](../io/cout.html) << std::is_partitioned(v.begin(), v.end(), is_even) << ' ';
     
        [std::partition](partition.html)(v.begin(), v.end(), is_even);
        [std::cout](../io/cout.html) << std::is_partitioned(v.begin(), v.end(), is_even) << ' ';
     
        [std::reverse](reverse.html)(v.begin(), v.end());
        [std::cout](../io/cout.html) << std::is_partitioned(v.cbegin(), v.cend(), is_even) << ' ';
        [std::cout](../io/cout.html) << std::is_partitioned(v.crbegin(), v.crend(), is_even) << '\n';
    }
