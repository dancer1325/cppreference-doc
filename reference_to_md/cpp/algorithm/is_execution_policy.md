...
---|---|---  
template< class T >  
struct is_execution_policy; |  |  (since C++17)  
| |   
  
Checks whether `T` is a standard or implementation-defined execution policy type. 

Provides the member constant value which is equal to true, if `T` is [a standard execution policy type](execution_policy_tag_t.html "cpp/algorithm/execution policy tag t"), or an implementation-defined execution policy type. Otherwise, value is equal to false. 

If the program adds specializations for `std::is_execution_policy` or `std::is_execution_policy_v`, the behavior is undefined. 

## Contents

  * [1 Template parameters](is_execution_policy.html#Template_parameters)
  * [2 Helper template](is_execution_policy.html#Helper_template)
  * [3 Inherited from std::integral_constant](is_execution_policy.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_execution_policy.html#Member_constants)
    * [3.2 Member functions](is_execution_policy.html#Member_functions)
    * [3.3 Member types](is_execution_policy.html#Member_types)
    * [3.4 See also](is_execution_policy.html#See_also)
...
value[static] |  true if `T` is a standard or implementation-defined execution policy type, false otherwise   
...
Run this code
    ...
    #include <execution>
     
    static_assert(std::is_execution_policy_v<[std::execution::unsequenced_policy](execution_policy_tag_t.html)>);
