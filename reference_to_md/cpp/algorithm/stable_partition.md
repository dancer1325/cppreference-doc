...
BidirIt stable_partition( BidirIt first, BidirIt last, UnaryPred p ); |  (1) | (constexpr since C++26)  
template< class ExecutionPolicy, class BidirIt, class UnaryPred >  
BidirIt stable_partition( ExecutionPolicy&& policy,  
BidirIt first, BidirIt last, UnaryPred p ); |  (2)  |  (since C++17)  
| |   
...
---|---  
  ...
  * `BidirIt` is not [ValueSwappable](../named_req/ValueSwappable.html "cpp/named req/ValueSwappable"). 
...
## Contents
  ...
  * [4 Exceptions](stable_partition.html#Exceptions)
  * [5 Notes](stable_partition.html#Notes)
  * [6 Example](stable_partition.html#Example)
  * [7 Defect reports](stable_partition.html#Defect_reports)
  * [8 See also](stable_partition.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v{0, 0, 3, -1, 2, 4, 5, 0, 7};
...
---|---|---|---  
[LWG 2150](https://cplusplus.github.io/LWG/issue2150) | C++98  | `std::stable_partition` was only required to place one  
