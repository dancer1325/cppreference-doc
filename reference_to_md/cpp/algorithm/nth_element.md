...
1,2) bool(*j < *i)(until C++20)[std::less](../utility/functional/less.html){}(*j, *i)(since C++20) is false.
...
1) Elements are hypothetically [sorted](../algorithm.html#Requirements "cpp/algorithm") with respect to operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).
...
If any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * `[`first`, `nth`)` or `[`nth`, `last`)` is not a [valid range](../iterator.html#Ranges "cpp/iterator"). 
...
## Contents
  ...
  * [2 Complexity](nth_element.html#Complexity)
  * [3 Exceptions](nth_element.html#Exceptions)
  * [4 Possible implementation](nth_element.html#Possible_implementation)
  * [5 Notes](nth_element.html#Notes)
  * [6 Example](nth_element.html#Example)
  * [7 Defect reports](nth_element.html#Defect_reports)
  * [8 See also](nth_element.html#See_also)
...
1) \\(\scriptsize O(N)\\)O(N) comparisons using operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20) on average.

2) \\(\scriptsize O(N)\\)O(N) comparisons using operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20), and \\(\scriptsize O(N \cdot \log(N))\\)O(N·log(N)) swaps.
...
Run this code
    ...
    #include <vector>
     
    void printVec(const [std::vector](../container/vector.html)<int>& vec)
    {
        [std::cout](../io/cout.html) << "v = {";
        for (char sep[]{0, ' ', 0}; const int i : vec)
            [std::cout](../io/cout.html) << sep << i, sep[0] = ',';
        [std::cout](../io/cout.html) << "};\n";
    }
     
    int main()
    {
        [std::vector](../container/vector.html)<int> v{5, 10, 6, 4, 3, 2, 6, 7, 9, 3};
        printVec(v);
     
        ...
        [assert](../error/assert.html)([std::accumulate](accumulate.html)(v.begin(), m, 0) < [std::accumulate](accumulate.html)(m, v.end(), 0));
        printVec(v);
     
        // Note: comp function changed
        std::nth_element(v.begin(), v.begin() + 1, v.end(), [std::greater](../utility/functional/greater.html){});
...
---|---|---|---  
[LWG 2150](https://cplusplus.github.io/LWG/issue2150) | C++98  | after the rearrangement, only one element before nth  
was required to be not greater than one element after nth | corrected the  
requirement   
[LWG 2163](https://cplusplus.github.io/LWG/issue2163) | C++98  | overload ([1](nth_element.html#Version_1)) used operator> to compare the elements  | changed to operator<  
[P0896R4](https://wg21.link/P0896R4) | C++98  | `[`first`, `nth`)` and `[`nth`, `last`)`  
