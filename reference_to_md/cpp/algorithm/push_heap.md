...
void push_heap( RandomIt first, RandomIt last ); |  (1)  |  (constexpr since C++20)  
template< class RandomIt, class Compare >  
void push_heap( RandomIt first, RandomIt last, Compare comp ); |  (2)  |  (constexpr since C++20)  
| |   
  
Inserts the element at the position last - 1 into the [heap](../algorithm.html#Heap_operations "cpp/algorithm") `[`first`, `last - 1`)`. The heap after the insertion will be `[`first`, `last`)`. 

1) The heap is with respect to operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).
...
## Contents
  ...
  * [2 Complexity](push_heap.html#Complexity)
  * [3 Example](push_heap.html#Example)
  * [4 Defect reports](push_heap.html#Defect_reports)
  * [5 See also](push_heap.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/push_heap&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the pair of iterators defining the [range](../iterator.html#Ranges "cpp/iterator") of elements that form the binary heap after insertion   
---|---|---  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/push_heap&action=edit&section=2 "Edit section: Complexity")] Complexity

Given \\(\scriptsize N\\)N as [std::distance](../iterator/distance.html)(first, last): 

1) At most \\(\scriptsize \log(N)\\)log(N) comparisons using operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).

2) At most \\(\scriptsize \log(N)\\)log(N) applications of the comparison function comp.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/push_heap&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    #include <vector>
     
    void println([std::string_view](../string/basic_string_view.html) rem, const [std::vector](../container/vector.html)<int>& v)
    {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/push_heap&action=edit&section=4 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/push_heap&action=edit&section=5 "Edit section: See also")] See also
