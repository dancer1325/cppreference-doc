...
## Contents
  ...
  * [4 Exceptions](max_element.html#Exceptions)
  * [5 Possible implementation](max_element.html#Possible_implementation)
  * [6 Example](max_element.html#Example)
  * [7 Defect reports](max_element.html#Defect_reports)
  * [8 See also](max_element.html#See_also)
...
[max_element (3)](max_element.html#Version_3)  
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v{3, 1, -14, 1, 5, 9, -14, 9};
        [std::vector](../container/vector.html)<int>::iterator result;
     
        result = std::max_element(v.begin(), v.end());
        [std::cout](../io/cout.html) << "Max element found at index "
    ...
     
        ...
        [std::cout](../io/cout.html) << "Absolute max element found at index "
                  << [std::distance](../iterator/distance.html)(v.begin(), result)
                  << " has value " << *result << '\n';
    }
