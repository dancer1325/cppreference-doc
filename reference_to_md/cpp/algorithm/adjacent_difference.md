...
OutputIt adjacent_difference( InputIt first, InputIt last,   
OutputIt d_first, BinaryOp op ); |  (3) | (constexpr since C++20)  
template< class ExecutionPolicy,  
...
Otherwise, performs the following operations in order: 
  ...
  2. For each integer i in `[`1`, `[std::distance](../iterator/distance.html)(first, last)`)`, performs the following operations in order:
...
Given binary_op as the actual binary operation: 
  ...
  * Given d_last as the iterator to be [returned](adjacent_difference.html#Return_value), if any of the following conditions is satisfied, the behavior is undefined: 



    

  * For overloads (1,3), `T` is not [MoveAssignable](../named_req/MoveAssignable.html "cpp/named req/MoveAssignable"). 
...
## Contents
  ...
  * [1 Parameters](adjacent_difference.html#Parameters)
  * [2 Return value](adjacent_difference.html#Return_value)
  * [3 Complexity](adjacent_difference.html#Complexity)
  * [4 Exceptions](adjacent_difference.html#Exceptions)
  * [5 Possible implementation](adjacent_difference.html#Possible_implementation)
  * [6 Notes](adjacent_difference.html#Notes)
  * [7 Example](adjacent_difference.html#Example)
  * [8 Defect reports](adjacent_difference.html#Defect_reports)
  * [9 See also](adjacent_difference.html#See_also)
...
---  
    ...
    OutputIt adjacent_difference(InputIt first, InputIt last, OutputIt d_first)
    {
        if (first == last)
            return d_first;
     
        typedef typename [std::iterator_traits](../iterator/iterator_traits.html)<InputIt>::value_type value_t;
        value_t acc = *first;
        *d_first = acc;
     
        while (++first != last)
...
[adjacent_difference (3)](adjacent_difference.html#Version_3)  
...
Run this code
    ...
    int main()
    {
        ...
        [std::vector](../container/vector.html) v{4, 6, 9, 13, 18, 19, 19, 15, 10};
        println("Initially, v = ", v);
        std::adjacent_difference(v.begin(), v.end(), v.begin());
        println("Modified v = ", v);
     
        // Fibonacci
        [std::array](../container/array.html)<int, 10> a {1};
        std::adjacent_difference([std::begin](../iterator/begin.html)(a), [std::prev](../iterator/prev.html)([std::end](../iterator/end.html)(a)),
                                 [std::next](../iterator/next.html)([std::begin](../iterator/begin.html)(a)), [std::plus](../utility/functional/plus.html)<>{});
...
---|---|---|---  
[LWG 242](https://cplusplus.github.io/LWG/issue242) | C++98  | op could not have side effects  | it cannot modify  
the ranges involved   
...
[LWG 3058](https://cplusplus.github.io/LWG/issue3058) | C++17  | for overloads (2,4), the result of each invocation  
of operator- or op was assigned to a temporary  
object, and that object is assigned to the output range  | assign the results  
to the output  
range directly   
