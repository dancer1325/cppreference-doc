...
template< class T >  
T max( [std::initializer_list](../utility/initializer_list.html)<T> ilist ); |  (3) | (since C++11)   
(constexpr since C++14)  
template< class T, class Compare >  
T max( [std::initializer_list](../utility/initializer_list.html)<T> ilist, Compare comp ); |  (4) | (since C++11)   
(constexpr since C++14)  
| |   
...
If `T` is not [LessThanComparable](../named_req/LessThanComparable.html "cpp/named req/LessThanComparable"), the behavior is undefined.

2) Use the comparison function comp to compare the values.

3,4) Returns the greatest of the values in initializer list ilist.

If ilist.size() is zero, or `T` is not [CopyConstructible](../named_req/CopyConstructible.html "cpp/named req/CopyConstructible"), the behavior is undefined.
...
## Contents
  ...
  * [7 Defect reports](max.html#Defect_reports)
  * [8 See also](max.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/max&action=edit&section=1 "Edit section: Parameters")] Parameters

a, b  |  \-  |  the values to compare   
---|---|---  
ilist  |  \-  |  initializer list with the values to compare   
comp  |  \-  |  comparison function object (i.e. an object that satisfies the requirements of [Compare](../named_req/Compare.html "cpp/named req/Compare")) which returns true if a is _less_ than b.  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/max&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/max&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/max&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation

[max (1)](max.html#Version_1)  
---  
...
[max (3)](max.html#Version_3)  
      
    
    template<class T>
    T max([std::initializer_list](../utility/initializer_list.html)<T> ilist)
    {
        return *[std::max_element](max_element.html)(ilist.begin(), ilist.end());
    }  
  
[max (4)](max.html#Version_4)  
      
    
    template<class T, class Compare>
    T max([std::initializer_list](../utility/initializer_list.html)<T> ilist, Compare comp)
    {
        return *[std::max_element](max_element.html)(ilist.begin(), ilist.end(), comp);
    }  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/max&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/max&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto longest = [](const [std::string_view](../string/basic_string_view.html) s1, const [std::string_view](../string/basic_string_view.html) s2)
                       {
                           return s1.size() < s2.size();
                       };
     
        [std::cout](../io/cout.html) << "Larger of 69 and 96 is " << std::max(69, 96) << "\n"
                  ...
                  << [std::quoted](../io/manip/quoted.html)(std::max({"long", "short", "int"}, longest)) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/max&action=edit&section=7 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 281](https://cplusplus.github.io/LWG/issue281) | C++98  | `T` was required to be [CopyConstructible](../named_req/CopyConstructible.html "cpp/named req/CopyConstructible") for overloads ([1,2](max.html#Version_1)) | not required   
[LWG 2239](https://cplusplus.github.io/LWG/issue2239) | C++98  
C++11  | 1\. `T` was required to be [LessThanComparable](../named_req/LessThanComparable.html "cpp/named req/LessThanComparable") for  
overloads ([2](max.html#Version_2)) (C++98) and ([4](max.html#Version_4)) (C++11)  
2\. the complexity requirements were missing  | 1\. not required  
2\. added the requirements   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/max&action=edit&section=8 "Edit section: See also")] See also
