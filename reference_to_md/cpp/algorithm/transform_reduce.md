...
InputIt2 first2, T init ); |  (1)  |  (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy,  
class ForwardIt1, class ForwardIt2, class T >  
T transform_reduce( ExecutionPolicy&& policy,  
ForwardIt1 first1, ForwardIt1 last1,  
ForwardIt2 first2, T init ); |  (2)  |  (since C++17)  
template< class InputIt1, class InputIt2, class T,  
class BinaryOp1, class BinaryOp2 >  
T transform_reduce( InputIt1 first1, InputIt1 last1,  
InputIt2 first2, T init,  
BinaryOp1 reduce, BinaryOp2 transform ); |  (3)  |  (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy,  
class ForwardIt1, class ForwardIt2, class T,  
class BinaryOp1, class BinaryOp2 >  
...
BinaryOp1 reduce, BinaryOp2 transform ); |  (4)  |  (since C++17)  
template< class InputIt, class T,  
class BinaryOp, class UnaryOp >  
T transform_reduce( InputIt first, InputIt last, T init,  
BinaryOp reduce, UnaryOp transform ); |  (5)  |  (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy,  
...
BinaryOp reduce, UnaryOp transform ); |  (6)  |  (since C++17)  
| |   
  
1) Equivalent to transform_reduce(first1, last1, first2, init,  
[std::plus](../utility/functional/plus.html)<>(), [std::multiplies](../utility/functional/multiplies.html)<>()), effectively parallelized version of the default [std::inner_product](inner_product.html "cpp/algorithm/inner product").

3) Applies transform to each pair of elements from the ranges `[`first1`, `last1`)` and the range of [std::distance](../iterator/distance.html)(first1, last1) elements starting from first2 and reduces the results (possibly permuted and aggregated in unspecified manner) along with the initial value init over reduce.
...
Given last2 as the [std::distance](../iterator/distance.html)(first1, last1)th next iterator of first2, if any of the following conditions is satisfied, the behavior is undefined: 

  * `T` is not [MoveConstructible](../named_req/MoveConstructible.html "cpp/named req/MoveConstructible"). 
...
## Contents
  ...
  * [1 Parameters](transform_reduce.html#Parameters)
  * [2 Return value](transform_reduce.html#Return_value)
  * [3 Complexity](transform_reduce.html#Complexity)
  * [4 Exceptions](transform_reduce.html#Exceptions)
  * [5 Notes](transform_reduce.html#Notes)
  * [6 Example](transform_reduce.html#Example)
  * [7 See also](transform_reduce.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_reduce&action=edit&section=1 "Edit section: Parameters")] Parameters

first1, last1  |  \-  |  the pair of iterators defining the [range](../iterator.html#Ranges "cpp/iterator") of elements to be taken as the left operand of transform  
---|---|---  
first2  |  \-  |  the start of range of elements to be taken as the right operand of transform  
first, last  |  \-  |  the pair of iterators defining the [range](../iterator.html#Ranges "cpp/iterator") of elements to be taken as the operand of transform  
init  |  \-  |  the initial value of the generalized sum   
policy  |  \-  |  the [execution policy](execution_policy_tag_t.html "cpp/algorithm/execution policy tag t") to use   
reduce  |  \-  |  binary [FunctionObject](../named_req/FunctionObject.html "cpp/named req/FunctionObject") that will be applied in unspecified order to the results of transform, the results of other reduce and init.   
transform  |  \-  |  unary or binary [FunctionObject](../named_req/FunctionObject.html "cpp/named req/FunctionObject") that will be applied to each element of the input range(s). The return type must be acceptable as input to reduce.   
Type requirements   
-`InputIt1, InputIt2, InputIt` must meet the requirements of [LegacyInputIterator](../named_req/InputIterator.html "cpp/named req/InputIterator").   
-`ForwardIt1, ForwardIt2, ForwardIt` must meet the requirements of [LegacyForwardIterator](../named_req/ForwardIterator.html "cpp/named req/ForwardIterator").   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_reduce&action=edit&section=2 "Edit section: Return value")] Return value

1,2) The generalized sum of init and values over [std::plus](../utility/functional/plus.html)<>(), where values are the values transformed by [std::multiplies](../utility/functional/multiplies.html)<>(), each value is transformed from a pair of elements from the two input ranges.
...
The _generalized sum_ of a group of elements over an binary operation binary_op is defined as follows: 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_reduce&action=edit&section=3 "Edit section: Complexity")] Complexity

Given \\(\scriptsize N\\)N as [std::distance](../iterator/distance.html)(first1, last1) (or [std::distance](../iterator/distance.html)(first, last) for overloads (5,6)): 

1,2) \\(\scriptsize O(N)\\)O(N) applications of [std::plus](../utility/functional/plus.html)<>() and [std::multiplies](../utility/functional/multiplies.html)<>() respectively.

3-6) \\(\scriptsize O(N)\\)O(N) applications of reduce and transform respectively.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_reduce&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_reduce&action=edit&section=5 "Edit section: Notes")] Notes

transform is never applied to init. 

If first == last or first1 == last1, init is returned, unmodified. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_reduce&action=edit&section=6 "Edit section: Example")] Example

`transform_reduce` can be used to parallelize [std::inner_product](inner_product.html "cpp/algorithm/inner product"). Some systems may need additional support to get advantages of parallel execution. E.g., on GNU/Linux, the [Intel TBB](https://en.wikipedia.org/wiki/Threading_Building_Blocks "enwiki:Threading Building Blocks") be installed and -ltbb option be provided to gcc/clang compiler.
...
Run this code
    ...
    void print_sum_squared(long const num)
    {
        ...
        [std::cout](../io/cout.html) << "num = " << num << '\n';
     
        // create an immutable vector filled with pattern: 1,2,3,4, 1,2,3,4 ...
        const [std::vector](../container/vector.html)<long> v{[n = num * 4] {
            [std::vector](../container/vector.html)<long> v;
            v.reserve(n);
            [std::generate_n](generate_n.html)([std::back_inserter](../iterator/back_inserter.html)(v), n,
    ...
     
        auto sum1 = [std::accumulate](accumulate.html)(v.cbegin(), v.cend(), 0L, squared_sum);
        [std::cout](../io/cout.html) << "accumulate(): " << sum1 << '\n';
     
        auto sum2 = [std::reduce](reduce.html)(PAR v.cbegin(), v.cend(), 0L, squared_sum);
        [std::cout](../io/cout.html) << "reduce(): " << sum2 << '\n';
     
        auto sum3 = std::transform_reduce(PAR v.cbegin(), v.cend(), 0L, [std::plus](../utility/functional/plus.html){},
                                          [](auto val) { return val * val; });
        [std::cout](../io/cout.html) << "transform_reduce(): " << sum3 << "\n\n";
    }
     
    int main()
    {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_reduce&action=edit&section=7 "Edit section: See also")] See also
