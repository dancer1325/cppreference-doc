...
const T& old_value, const T& new_value ); |  | (constexpr since C++20)   
(until C++26)  
...
const T& old_value, const T& new_value ); |  |  (since C++26)  
| (2) |   
template< class ExecutionPolicy, class ForwardIt, class T >  
void replace( ExecutionPolicy&& policy,  
ForwardIt first, ForwardIt last,  
const T& old_value, const T& new_value ); |  |  (since C++17)   
(until C++26)  
...
If *first = new_value is invalid(until C++20)new_value is not [writable](../iterator.html#Types_and_writability "cpp/iterator") to first(since C++20), the program is ill-formed. 

## Contents

  * [1 Parameters](replace.html#Parameters)
  * [2 Complexity](replace.html#Complexity)
  ...
  * [7 Defect reports](replace.html#Defect_reports)
  * [8 See also](replace.html#See_also)
...
[replace_if (3)](replace.html#Version_3)  
...
Run this code
    ...
     
        ...
        std::replace_if(s.begin(), s.end(), 
                        [std::bind](../utility/functional/bind.html)([std::less](../utility/functional/less.html)<int>(), std::placeholders::_1, 5), 55);
        println(s);
     
        ...
        #else
            std::replace(nums.begin(), nums.end(), [std::complex](../numeric/complex.html)<double>{1, 3},
...
---|---|---|---  
[LWG 283](https://cplusplus.github.io/LWG/issue283) | C++98  | `T` was required to be [CopyAssignable](../named_req/CopyAssignable.html "cpp/named req/CopyAssignable") (and [EqualityComparable](../named_req/EqualityComparable.html "cpp/named req/EqualityComparable")  
