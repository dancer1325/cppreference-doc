...
1) Uses operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20) to compare the values.

If `T` is not [LessThanComparable](../named_req/LessThanComparable.html "cpp/named req/LessThanComparable"), the behavior is undefined.[[1]](clamp.html#cite_note-1)

2) Uses the comparison function comp to compare the values.

If lo is greater than hi, the behavior is undefined. 

  1. [↑](clamp.html#cite_ref-1) If `NaN` is avoided, `T` can be a floating-point type.
...
Run this code
    ...
    int main()
    {
        [std::cout](../io/cout.html) << "[raw] "
                     "[" << [INT8_MIN](../types/integer.html) << ',' << [INT8_MAX](../types/integer.html) << "] "
    ...
     
        for (const int v : {-129, -128, -1, 0, 42, 127, 128, 255, 256})
            [std::cout](../io/cout.html) << [std::setw](../io/manip/setw.html)(4) << v
                      << [std::setw](../io/manip/setw.html)(11) << std::clamp(v, [INT8_MIN](../types/integer.html), [INT8_MAX](../types/integer.html))
                      << [std::setw](../io/manip/setw.html)(8) << std::clamp(v, 0, [UINT8_MAX](../types/integer.html)) << '\n';
    }
