...
void fill( ForwardIt first, ForwardIt last, const T& value ); |  | (constexpr since C++20)   
(until C++26)  
...
If value is not [writable](../iterator.html#Types_and_writability "cpp/iterator") to first, the program is ill-formed. 

## Contents

  * [1 Parameters](fill.html#Parameters)
  * [2 Complexity](fill.html#Complexity)
  * [3 Exceptions](fill.html#Exceptions)
  * [4 Possible implementation](fill.html#Possible_implementation)
  * [5 Notes](fill.html#Notes)
  * [6 Example](fill.html#Example)
  * [7 Defect reports](fill.html#Defect_reports)
  * [8 See also](fill.html#See_also)
...
first, last  |  \-  |  the pair of iterators defining the [range](../iterator.html#Ranges "cpp/iterator") of elements to modify   
---|---|---  
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v{0, 1, 2, 3, 4, 5, 6, 7, 8};
        println(v);
     
    ...
     
        ...
        #else
            std::fill(nums.begin(), nums.end(), [std::complex](../numeric/complex.html)<double>{4, 2});
        #endif
        println(nums);
    }
...
`T` is not always writable to `ForwardIt` | required to be writable instead   
