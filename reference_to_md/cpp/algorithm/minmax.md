...
---|---|---  
template< class T >  
[std::pair](../utility/pair.html)<const T&, const T&> minmax( const T& a, const T& b ); |  (1) | (since C++11)   
(constexpr since C++14)  
template< class T, class Compare >  
[std::pair](../utility/pair.html)<const T&, const T&> minmax( const T& a, const T& b,  
Compare comp ); |  (2) | (since C++11)   
(constexpr since C++14)  
template< class T >  
[std::pair](../utility/pair.html)<T, T> minmax( [std::initializer_list](../utility/initializer_list.html)<T> ilist ); |  (3) | (since C++11)   
(constexpr since C++14)  
template< class T, class Compare >  
[std::pair](../utility/pair.html)<T, T> minmax( [std::initializer_list](../utility/initializer_list.html)<T> ilist,  
Compare comp ); |  (4) | (since C++11)   
(constexpr since C++14)  
| |   
...
## Contents
  ...
  * [7 Defect reports](minmax.html#Defect_reports)
  * [8 See also](minmax.html#See_also)
...
---  
    ...
    template<class T>
    constexpr [std::pair](../utility/pair.html)<const T&, const T&> minmax(const T& a, const T& b)
    {
        return (b < a) ? [std::pair](../utility/pair.html)<const T&, const T&>(b, a)
                       : [std::pair](../utility/pair.html)<const T&, const T&>(a, b);
    }  
  
[minmax (2)](minmax.html#Version_2)  
      
    
    template<class T, class Compare>
    constexpr [std::pair](../utility/pair.html)<const T&, const T&> minmax(const T& a, const T& b, Compare comp)
    {
        return comp(b, a) ? [std::pair](../utility/pair.html)<const T&, const T&>(b, a)
                          : [std::pair](../utility/pair.html)<const T&, const T&>(a, b);
    }  
  
[minmax (3)](minmax.html#Version_3)  
      
    
    template<class T>
    constexpr [std::pair](../utility/pair.html)<T, T> minmax([std::initializer_list](../utility/initializer_list.html)<T> ilist)
    {
        auto p = [std::minmax_element](minmax_element.html)(ilist.begin(), ilist.end());
        return [std::pair](../utility/pair.html)(*p.first, *p.second);
    }  
  
[minmax (4)](minmax.html#Version_4)  
      
    
    template<class T, class Compare>
    constexpr [std::pair](../utility/pair.html)<T, T> minmax([std::initializer_list](../utility/initializer_list.html)<T> ilist, Compare comp)
    {
        auto p = [std::minmax_element](minmax_element.html)(ilist.begin(), ilist.end(), comp);
        return [std::pair](../utility/pair.html)(*p.first, *p.second);
    }  
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v{3, 1, 4, 1, 5, 9, 2, 6};
        [std::srand](../numeric/random/srand.html)([std::time](../chrono/c/time.html)(0));
        [std::pair](../utility/pair.html)<int, int> bounds = std::minmax([std::rand](../numeric/random/rand.html)() % v.size(),
                                                 [std::rand](../numeric/random/rand.html)() % v.size());
     
        [std::cout](../io/cout.html) << "v[" << bounds.first << "," << bounds.second << "]: ";
