...
## Contents
  ...
  * [4 Exceptions](set_union.html#Exceptions)
  * [5 Possible implementation](set_union.html#Possible_implementation)
  * [6 Notes](set_union.html#Notes)
  * [7 Example](set_union.html#Example)
  * [8 Defect reports](set_union.html#Defect_reports)
  * [9 See also](set_union.html#See_also)
...
---|---|---  
first2, last2  |  \-  |  the pair of iterators defining the second input sorted [range](../iterator.html#Ranges "cpp/iterator") of elements   
...
[set_union (3)](set_union.html#Version_3)  
...
Run this code
    ...
    #include <vector>
     
    void println(const [std::vector](../container/vector.html)<int>& v)
    {
        for (int i : v)
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v1, v2, dest;
     
        v1 = {1, 2, 3, 4, 5};
        v2 = {3, 4, 5, 6, 7};
     
        std::set_union(v1.cbegin(), v1.cend(),
                       v2.cbegin(), v2.cend(),
                       [std::back_inserter](../iterator/back_inserter.html)(dest));
        println(dest);
     
        dest.clear();
     
