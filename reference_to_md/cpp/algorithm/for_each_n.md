...
InputIt for_each_n( InputIt first, Size n, UnaryFunc f ); |  (1)  |  (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy,  
class ForwardIt, class Size, class UnaryFunc >  
ForwardIt for_each_n( ExecutionPolicy&& policy,  
ForwardIt first, Size n, UnaryFunc f ); |  (2)  |  (since C++17)  
| |   
...
If `UnaryFunc` is not [MoveConstructible](../named_req/MoveConstructible.html "cpp/named req/MoveConstructible"), the behavior is undefined.
...
If `UnaryFunc` is not [CopyConstructible](../named_req/CopyConstructible.html "cpp/named req/CopyConstructible"), the behavior is undefined.
...
Unlike the rest of the parallel algorithms, `for_each_n` is not allowed to make copies of the elements in the sequence even if they are [TriviallyCopyable](../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable"). 
...
## Contents
  ...
  * [4 Exceptions](for_each_n.html#Exceptions)
  * [5 Possible implementation](for_each_n.html#Possible_implementation)
  * [6 Example](for_each_n.html#Example)
  * [7 See also](for_each_n.html#See_also)
...
Run this code
    ...
    void println(auto const& v)
    {
        for (auto count{v.size()}; const auto& e : v)
            [std::cout](../io/cout.html) << e << (--count ? ", " : "\n");
    }
     
    int main()
    {
        [std::vector](../container/vector.html)<int> vi{1, 2, 3, 4, 5};
        println(vi);
     
