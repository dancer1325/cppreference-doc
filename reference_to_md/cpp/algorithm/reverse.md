...
void reverse( BidirIt first, BidirIt last ); |  (1)  |  (constexpr since C++20)  
...
Behaves as if applying [std::iter_swap](iter_swap.html "cpp/algorithm/iter swap") to every pair of iterators first + i and (last - i) - 1 for each integer i in `[`​0​`, `[std::distance](../iterator/distance.html)(first, last) / 2`)`.
...
If *first is not [Swappable](../named_req/Swappable.html "cpp/named req/Swappable")(until C++20)`BidirIt` is not [ValueSwappable](../named_req/ValueSwappable.html "cpp/named req/ValueSwappable")(since C++20), the behavior is undefined. 

## Contents

  * [1 Parameters](reverse.html#Parameters)
  * [2 Complexity](reverse.html#Complexity)
  * [3 Exceptions](reverse.html#Exceptions)
  * [4 Possible implementation](reverse.html#Possible_implementation)
  * [5 Notes](reverse.html#Notes)
  * [6 Example](reverse.html#Example)
  * [7 Defect reports](reverse.html#Defect_reports)
  * [8 See also](reverse.html#See_also)
...
See also the implementations in [libstdc++](https://github.com/gcc-mirror/gcc/blob/14d8a5ae472ca5743016f37da2dd4770d83dea21/libstdc%2B%2B-v3/include/bits/stl_algo.h#L1087-L1152), [libc++](https://github.com/llvm/llvm-project/blob/6adbc83ee9e46b476e0f75d5671c3a21f675a936/libcxx/include/__algorithm/reverse.h), and [MSVC STL](https://github.com/microsoft/STL/blob/472161105d596192194d4715ccad307c6c163b4a/stl/inc/xutility#L5335-L5370). 
    ...
    {
        using iter_cat = typename [std::iterator_traits](../iterator/iterator_traits.html)<BidirIt>::iterator_category;
     
        // Tag dispatch, e.g. calling reverse_impl(first, last, iter_cat()),
        // can be used in C++14 and earlier modes.
        if constexpr ([std::is_base_of_v](../types/is_base_of.html)<[std::random_access_iterator_tag](../iterator/iterator_tags.html), iter_cat>)
        {
            if (first == last)
                return;
     
            for (--last; first < last; (void)++first, --last)
                [std::iter_swap](iter_swap.html)(first, last);
        }
        else
...
Run this code
    ...
    {
        for ([std::cout](../io/cout.html) << rem; auto e : v)
    ...
     
        int a[] = {4, 5, 6, 7};
        std::reverse([std::begin](../iterator/begin.html)(a), [std::end](../iterator/end.html)(a));
...
---|---|---|---  
[LWG 223](https://cplusplus.github.io/LWG/issue223) | C++98  | [std::swap](../utility/swap.html "cpp/algorithm/swap") was applied to each pair of iterators  | applies [std::iter_swap](iter_swap.html "cpp/algorithm/iter swap") instead   
