...
ForwardIt s_first, ForwardIt s_last ); |  (1) | (constexpr since C++20)  
...
## Contents
  ...
  * [4 Exceptions](find_first_of.html#Exceptions)
  * [5 Possible implementation](find_first_of.html#Possible_implementation)
  * [6 Example](find_first_of.html#Example)
  * [7 Defect reports](find_first_of.html#Defect_reports)
  * [8 See also](find_first_of.html#See_also)
...
[find_first_of (3)](find_first_of.html#Version_3)  
...
Run this code
    ...
    auto print_sequence = [](const auto id, const auto& seq, int pos = -1)
    {
        ...
        for (int i{}; auto const& e : seq)
        {
            ...
            [std::cout](../io/cout.html) << (mark ? "[ " : "") << e << (mark ? " ]" : "");
        }
    ...
    int main()
    {
        const [std::vector](../container/vector.html)<int> v{0, 2, 3, 25, 5};
    ...
     
        auto find_any_of = [](const auto& v, const auto& t)
        {
            ...
            if (result == v.end())
            {
                [std::cout](../io/cout.html) << "No elements of v are equal to any element of ";
                print_sequence("t = ", t);
                print_sequence("v = ", v);
            }
            else
            {
                const auto pos = [std::distance](../iterator/distance.html)(v.begin(), result);
                [std::cout](../io/cout.html) << "Found a match (" << *result << ") at position " << pos;
...
---|---|---|---  
[LWG 576](https://cplusplus.github.io/LWG/issue576) | C++98  | first and last needed to be [LegacyForwardIterators](../named_req/ForwardIterator.html "cpp/named req/ForwardIterator") | they only need to be  
