...
RandomIt is_heap_until( RandomIt first, RandomIt last ); |  (1)  |  (since C++11)   
(constexpr since C++20)  
template< class ExecutionPolicy, class RandomIt >  
RandomIt is_heap_until( ExecutionPolicy&& policy,  
RandomIt first, RandomIt last ); |  (2)  |  (since C++17)  
template< class RandomIt, class Compare >  
RandomIt is_heap_until( RandomIt first, RandomIt last, Compare comp ); |  (3)  |  (since C++11)   
(constexpr since C++20)  
...
Examines the range `[`first`, `last`)` and finds the largest range beginning at first which is a [heap](../algorithm.html#Heap_operations "cpp/algorithm"). 
...
## Contents
  ...
  * [4 Exceptions](is_heap_until.html#Exceptions)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_heap_until&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_heap_until&action=edit&section=2 "Edit section: Return value")] Return value

The last iterator it for which range `[`first`, `it`)` is a heap. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_heap_until&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_heap_until&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_heap_until&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::cout](../io/cout.html) << "all of v:  ";
        for (const auto& i : v)
            [std::cout](../io/cout.html) << i << ' ';
        [std::cout](../io/cout.html) << '\n';
     
        [std::cout](../io/cout.html) << "only heap: ";
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/is_heap_until&action=edit&section=6 "Edit section: See also")] See also
