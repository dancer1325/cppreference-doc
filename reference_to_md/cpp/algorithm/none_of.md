...
| **all_of any_ofnone_of**(C++11) (C++11)(C++11)  
---  
...
bool all_of( InputIt first, InputIt last, UnaryPred p ); |  (1) | (since C++11)   
(constexpr since C++20)  
template< class ExecutionPolicy, class ForwardIt, class UnaryPred >  
bool all_of( ExecutionPolicy&& policy,  
ForwardIt first, ForwardIt last, UnaryPred p ); |  (2)  |  (since C++17)  
template< class InputIt, class UnaryPred >  
bool any_of( InputIt first, InputIt last, UnaryPred p ); |  (3) | (since C++11)   
(constexpr since C++20)  
template< class ExecutionPolicy, class ForwardIt, class UnaryPred >  
bool any_of( ExecutionPolicy&& policy,  
ForwardIt first, ForwardIt last, UnaryPred p ); |  (4)  |  (since C++17)  
template< class InputIt, class UnaryPred >  
bool none_of( InputIt first, InputIt last, UnaryPred p ); |  (5) | (since C++11)   
(constexpr since C++20)  
template< class ExecutionPolicy, class ForwardIt, class UnaryPred >  
bool none_of( ExecutionPolicy&& policy,  
ForwardIt first, ForwardIt last, UnaryPred p ); |  (6)  |  (since C++17)  
| |   
...
## Contents
  ...
  * [1 Parameters](none_of.html#Parameters)
  * [2 Return value](none_of.html#Return_value)
  * [3 Complexity](none_of.html#Complexity)
  * [4 Exceptions](none_of.html#Exceptions)
  * [5 Possible implementation](none_of.html#Possible_implementation)
  * [6 Example](none_of.html#Example)
  * [7 See also](none_of.html#See_also)
...
---|---|---  
Range has some false element  | Yes  | No  | Yes  |  No[[1]](none_of.html#cite_note-1)  
[`all_of`](none_of.html#Version_1) | false | true | false | true  
[`any_of`](none_of.html#Version_3) | true | true |  false |  false  
[`none_of`](none_of.html#Version_5) |  false |  false | true | true  
  
  1. [↑](none_of.html#cite_ref-1) The range is empty in this case.
...
---  
    ...
    {
        return [std::find_if_not](find.html)(first, last, p) == last;
    }  
  
[any_of](none_of.html#Version_3)  
...
[none_of](none_of.html#Version_5)  
...
Run this code
    ...
     
        if (std::none_of(v.cbegin(), v.cend(), [std::bind](../utility/functional/bind.html)([std::modulus](../utility/functional/modulus.html)<>(),
