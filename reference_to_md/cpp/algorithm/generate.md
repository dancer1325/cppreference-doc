...
void generate( ForwardIt first, ForwardIt last, Generator g ); |  (1)  |  (constexpr since C++20)  
...
## Contents
  ...
  * [2 Complexity](generate.html#Complexity)
...
Run this code
    ...
    {
        for ([std::cout](../io/cout.html) << fmt; const auto& e : v)
