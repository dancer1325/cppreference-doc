...
RandomIt d_first, RandomIt d_last ); |  (1)  |  (constexpr since C++20)  
...
At most d_last - d_first of the elements are placed sorted to the range `[`d_first`, `d_first + n`)`. n is the number of elements to sort ([std::min](min.html)([std::distance](../iterator/distance.html)(first, last), d_last - d_first)). The order of equal elements is not guaranteed to be preserved. 

1) Elements are [sorted](../algorithm.html#Requirements "cpp/algorithm") with respect to operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).
...
If *first is not [writable](../iterator.html#Types_and_writability "cpp/iterator") to d_first, the program is ill-formed. 

If any of the following conditions is satisfied, the behavior is undefined: 

  * The type of *d_first is not [Swappable](../named_req/Swappable.html "cpp/named req/Swappable"). 

| (until C++11)  
---|---  
  
  * `RandomIt` is not [ValueSwappable](../named_req/ValueSwappable.html "cpp/named req/ValueSwappable"). 
  * The type of *d_first is not [MoveConstructible](../named_req/MoveConstructible.html "cpp/named req/MoveConstructible"). 
  * The type of *d_first is not [MoveAssignable](../named_req/MoveAssignable.html "cpp/named req/MoveAssignable"). 
...
## Contents
  ...
  * [4 Exceptions](partial_sort_copy.html#Exceptions)
  * [5 Possible implementation](partial_sort_copy.html#Possible_implementation)
  * [6 Example](partial_sort_copy.html#Example)
  * [7 Defect reports](partial_sort_copy.html#Defect_reports)
  * [8 See also](partial_sort_copy.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/partial_sort_copy&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the pair of iterators defining the [range](../iterator.html#Ranges "cpp/iterator") of elements to sort   
---|---|---  
d_first, d_last  |  \-  |  the pair of iterators defining the [range](../iterator.html#Ranges "cpp/iterator") of elements to which the sorted data will be assigned   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/partial_sort_copy&action=edit&section=2 "Edit section: Return value")] Return value

An iterator to the element defining the upper boundary of the sorted range, i.e. d_first + [std::min](min.html)([std::distance](../iterator/distance.html)(first, last), d_last - d_first). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/partial_sort_copy&action=edit&section=3 "Edit section: Complexity")] Complexity

Given \\(\scriptsize N\\)N as [std::distance](../iterator/distance.html)(first, last), \\(\scriptsize D\\)D as d_last - d_first: 

1,2) Approximately \\(\scriptsize N \cdot \log(\min(N,D))\\)N·log(min(N,D)) comparisons using operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).

3,4) Approximately \\(\scriptsize N \cdot \log(\min(N,D))\\)N·log(min(N,D)) applications of the comparator comp.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/partial_sort_copy&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/partial_sort_copy&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/partial_sort_copy&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    #include <vector>
     
    void println([std::string_view](../string/basic_string_view.html) rem, const auto& v)
    {
    ...
    int main()
    {
        ...
        [std::vector](../container/vector.html)<int> v1{10, 11, 12};
        [std::vector](../container/vector.html)<int> v2{10, 11, 12, 13, 14, 15, 16};
        [std::vector](../container/vector.html)<int>::iterator it;
     
    ...
     
        it = std::partial_sort_copy(v0.begin(), v0.end(), v2.begin(), v2.end(),
                                    [std::greater](../utility/functional/greater.html)<int>());
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/partial_sort_copy&action=edit&section=7 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[P0896R4](https://wg21.link/P0896R4) | C++98  | *first was not required to be writable to d_first | the program is ill-formed if not writable   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/partial_sort_copy&action=edit&section=8 "Edit section: See also")] See also
