...
void pop_heap( RandomIt first, RandomIt last ); |  (1)  |  (constexpr since C++20)  
template< class RandomIt, class Compare >  
void pop_heap( RandomIt first, RandomIt last, Compare comp ); |  (2)  |  (constexpr since C++20)  
| |   
  
Swaps the value in the position first and the value in the position last - 1 and makes the subrange `[`first`, `last - 1`)` into a heap. This has the effect of removing the first element from the [heap](../algorithm.html#Heap_operations "cpp/algorithm") `[`first`, `last`)`. 

1) `[`first`, `last`)` is a heap with respect to operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).
...
## Contents
  ...
  * [2 Complexity](pop_heap.html#Complexity)
  * [3 Example](pop_heap.html#Example)
  * [4 Defect reports](pop_heap.html#Defect_reports)
  * [5 See also](pop_heap.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/pop_heap&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the pair of iterators defining the non-empty binary heap [range](../iterator.html#Ranges "cpp/iterator") of elements to modify (extract root item)   
---|---|---  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/pop_heap&action=edit&section=2 "Edit section: Complexity")] Complexity

Given \\(\scriptsize N\\)N as [std::distance](../iterator/distance.html)(first, last): 

1) At most \\(\scriptsize 2\log(N)\\)2log(N) comparisons using operator<(until C++20)[std::less](../utility/functional/less.html){}(since C++20).

2) At most \\(\scriptsize 2\log(N)\\)2log(N) applications of the comparison function comp.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/pop_heap&action=edit&section=3 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/pop_heap&action=edit&section=4 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 1205](https://cplusplus.github.io/LWG/issue1205) | C++98  | the behavior was unclear if `[`first`, `last`)` is empty  | the behavior is undefined in this case   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/pop_heap&action=edit&section=5 "Edit section: See also")] See also
