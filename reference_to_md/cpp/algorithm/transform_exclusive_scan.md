...
BinaryOp binary_op, UnaryOp unary_op ); |  (1)  |  (since C++17)   
...
BinaryOp binary_op, UnaryOp unary_op ); |  (2)  |  (since C++17)  
| |   
...
For each integer i in `[`​0​`, `[std::distance](../iterator/distance.html)(first, last)`)`, performs the following operations in order: 
  ...
  1. Creates a sequence which is formed by init followed by the values transformed from the elements of `[`first`, `iter`)` in order by unary_op, where iter is the next ith iterator of first. 
...
## Contents
  ...
  * [1 Parameters](transform_exclusive_scan.html#Parameters)
  * [2 Return value](transform_exclusive_scan.html#Return_value)
  * [3 Complexity](transform_exclusive_scan.html#Complexity)
  * [4 Exceptions](transform_exclusive_scan.html#Exceptions)
  * [5 Notes](transform_exclusive_scan.html#Notes)
  * [6 Example](transform_exclusive_scan.html#Example)
  * [7 See also](transform_exclusive_scan.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_exclusive_scan&action=edit&section=1 "Edit section: Parameters")] Parameters
...
unary_op  |  \-  |  unary [FunctionObject](../named_req/FunctionObject.html "cpp/named req/FunctionObject") that will be applied to each element of the input range. The return type must be acceptable as input to binary_op.   
binary_op  |  \-  |  binary [FunctionObject](../named_req/FunctionObject.html "cpp/named req/FunctionObject") that will be applied in to the result of unary_op, the results of other binary_op, and init.   
Type requirements   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_exclusive_scan&action=edit&section=2 "Edit section: Return value")] Return value

Iterator to the element past the last element written. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_exclusive_scan&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_exclusive_scan&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_exclusive_scan&action=edit&section=5 "Edit section: Notes")] Notes

unary_op is never applied to init. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_exclusive_scan&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::cout](../io/cout.html) << "10 times exclusive sum: ";
        std::transform_exclusive_scan(data.begin(), data.end(),
                                      [std::ostream_iterator](../iterator/ostream_iterator.html)<int>([std::cout](../io/cout.html), " "),
                                      0, [std::plus](../utility/functional/plus.html)<int>{}, times_10);
        [std::cout](../io/cout.html) << "\n10 times inclusive sum: ";
        [std::transform_inclusive_scan](transform_inclusive_scan.html)(data.begin(), data.end(),
                                      [std::ostream_iterator](../iterator/ostream_iterator.html)<int>([std::cout](../io/cout.html), " "),
                                      [std::plus](../utility/functional/plus.html)<int>{}, times_10);
        [std::cout](../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_exclusive_scan&action=edit&section=7 "Edit section: See also")] See also
