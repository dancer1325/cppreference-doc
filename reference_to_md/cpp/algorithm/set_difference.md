...
If `[`first1`, `last1`)` contains m elements that are equivalent to each other and `[`first2`, `last2`)` contains n elements that are equivalent to them, the final [std::max](max.html)(m - n, 0) elements will be copied from `[`first1`, `last1`)` to the output range, preserving order. 
...
## Contents
  ...
  * [4 Exceptions](set_difference.html#Exceptions)
  * [5 Possible implementation](set_difference.html#Possible_implementation)
  * [6 Example](set_difference.html#Example)
  * [7 Defect reports](set_difference.html#Defect_reports)
  * [8 See also](set_difference.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/set_difference&action=edit&section=1 "Edit section: Parameters")] Parameters

first1, last1  |  \-  |  the pair of iterators defining the first input sorted [range](../iterator.html#Ranges "cpp/iterator") of elements to examine   
---|---|---  
first2, last2  |  \-  |  the pair of iterators defining the second input sorted [range](../iterator.html#Ranges "cpp/iterator") of elements to search for   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/set_difference&action=edit&section=2 "Edit section: Return value")] Return value

Iterator past the end of the constructed range. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/set_difference&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/set_difference&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/set_difference&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation

[set_difference (1)](set_difference.html#Version_1)  
---  
...
[set_difference (3)](set_difference.html#Version_3)  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/set_difference&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
    template<typename T>
    [std::ostream](../io/basic_ostream.html)& operator<<([std::ostream](../io/basic_ostream.html)& os, const [std::vector](../container/vector.html)<T>& v)
    {
        os << '{';
    ...
    int main()
    {
        const [std::vector](../container/vector.html)<int> v1{1, 2, 5, 5, 5, 9};
        const [std::vector](../container/vector.html)<int> v2{2, 5, 7};
        [std::vector](../container/vector.html)<int> diff;
     
        std::set_difference(v1.begin(), v1.end(), v2.begin(), v2.end(),
                            [std::inserter](../iterator/inserter.html)(diff, diff.begin()));
     
        [std::cout](../io/cout.html) << v1 << " ∖ " << v2 << " == " << diff << "\n\n";
     
        // we want to know which orders "cut" between old and new states:
        [std::vector](../container/vector.html)<Order> old_orders{{1}, {2}, {5}, {9}};
        [std::vector](../container/vector.html)<Order> new_orders{{2}, {5}, {7}};
        [std::vector](../container/vector.html)<Order> cut_orders;
     
        std::set_difference(old_orders.begin(), old_orders.end(),
                            new_orders.begin(), new_orders.end(),
                            [std::back_inserter](../iterator/back_inserter.html)(cut_orders),
                            [](auto& a, auto& b) { return a.order_id < b.order_id; });
     
        [std::cout](../io/cout.html) << "old orders: " << old_orders << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/set_difference&action=edit&section=7 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/set_difference&action=edit&section=8 "Edit section: See also")] See also
