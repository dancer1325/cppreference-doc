...
reduce( InputIt first, InputIt last ); |  (1)  |  (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy, class ForwardIt >  
typename [std::iterator_traits](../iterator/iterator_traits.html)<ForwardIt>::value_type  
reduce( ExecutionPolicy&& policy,  
ForwardIt first, ForwardIt last ); |  (2)  |  (since C++17)  
template< class InputIt, class T >  
T reduce( InputIt first, InputIt last, T init ); |  (3)  |  (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy, class ForwardIt, class T >  
T reduce( ExecutionPolicy&& policy,  
ForwardIt first, ForwardIt last, T init ); |  (4)  |  (since C++17)  
template< class InputIt, class T, class BinaryOp >  
T reduce( InputIt first, InputIt last, T init, BinaryOp op ); |  (5)  |  (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy,  
class ForwardIt, class T, class BinaryOp >  
T reduce( ExecutionPolicy&& policy,  
ForwardIt first, ForwardIt last, T init, BinaryOp op ); |  (6)  |  (since C++17)  
| |   
  
1) Equivalent to reduce(first, last, typename [std::iterator_traits](../iterator/iterator_traits.html)<InputIt>::value_type{}).

3) Equivalent to reduce(first, last, init, [std::plus](../utility/functional/plus.html)<>()).
...
op  |  \-  |  binary [FunctionObject](../named_req/FunctionObject.html "cpp/named req/FunctionObject") that will be applied in unspecified order to the result of dereferencing the input iterators, the results of other op and init.   
Type requirements   
...
1-4) \\(\scriptsize O(N)\\)O(N) applications of [std::plus](../utility/functional/plus.html)<>().
...
Run this code
    ...
     
        auto eval = [](auto fun)
        {
            const auto t1 = [std::chrono::high_resolution_clock::now](../chrono/high_resolution_clock/now.html)();
            const auto [name, result] = fun();
            const auto t2 = [std::chrono::high_resolution_clock::now](../chrono/high_resolution_clock/now.html)();
            const [std::chrono::duration](../chrono/duration.html)<double, [std::milli](../numeric/ratio/ratio.html)> ms = t2 - t1;
            [std::cout](../io/cout.html) << [std::setw](../io/manip/setw.html)(28) << [std::left](../io/manip/left.html) << name << "sum: "
                      << result << '\t' << "time: " << ms.count() << " ms\n";
        };
     
        {
            const [std::vector](../container/vector.html)<double> v(100'000'007, 0.1);
     
            eval([&v]{ return [std::pair](../utility/pair.html){"std::accumulate (double)",
                [std::accumulate](accumulate.html)(v.cbegin(), v.cend(), 0.0)}; });
            eval([&v]{ return [std::pair](../utility/pair.html){"std::reduce (seq, double)",
                std::reduce(SEQ v.cbegin(), v.cend())}; });
            eval([&v]{ return [std::pair](../utility/pair.html){"std::reduce (par, double)",
                std::reduce(PAR v.cbegin(), v.cend())}; });
        }
     
        {
            const [std::vector](../container/vector.html)<long> v(100'000'007, 1);
     
            eval([&v]{ return [std::pair](../utility/pair.html){"std::accumulate (long)",
                [std::accumulate](accumulate.html)(v.cbegin(), v.cend(), 0l)}; });
            eval([&v]{ return [std::pair](../utility/pair.html){"std::reduce (seq, long)",
                std::reduce(SEQ v.cbegin(), v.cend())}; });
            eval([&v]{ return [std::pair](../utility/pair.html){"std::reduce (par, long)",
                std::reduce(PAR v.cbegin(), v.cend())}; });
        }
    }
