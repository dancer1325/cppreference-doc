...
InputIt2 first2, T init ); |  (1) | (constexpr since C++20)  
template< class InputIt1, class InputIt2, class T,  
class BinaryOp1, class BinaryOp2 >  
T inner_product( InputIt1 first1, InputIt1 last1,  
InputIt2 first2, T init,  
BinaryOp1 op1, BinaryOp2 op2 ); |  (2) | (constexpr since C++20)  
| |   
  
Computes inner product (i.e. sum of products) or performs ordered map/reduce operation on the range `[`first1`, `last1`)` and the range of [std::distance](../iterator/distance.html)(first1, last1) elements beginning at first2. 
...
Given last2 as the [std::distance](../iterator/distance.html)(first1, last1)th next iterator of first2, if any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * `T` is not [CopyConstructible](../named_req/CopyConstructible.html "cpp/named req/CopyConstructible"). 
...
## Contents
  ...
  * [1 Parameters](inner_product.html#Parameters)
  * [2 Return value](inner_product.html#Return_value)
  * [3 Possible implementation](inner_product.html#Possible_implementation)
  * [4 Notes](inner_product.html#Notes)
  * [5 Example](inner_product.html#Example)
  * [6 Defect reports](inner_product.html#Defect_reports)
  * [7 See also](inner_product.html#See_also)
...
[inner_product (2)](inner_product.html#Version_2)  
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> a{0, 1, 2, 3, 4};
        [std::vector](../container/vector.html)<int> b{5, 4, 2, 3, 1};
     
        int r1 = std::inner_product(a.begin(), a.end(), b.begin(), 0);
        [std::cout](../io/cout.html) << "Inner product of a and b: " << r1 << '\n';
     
        int r2 = std::inner_product(a.begin(), a.end(), b.begin(), 0,
                                    [std::plus](../utility/functional/plus.html)<>(), [std::equal_to](../utility/functional/equal_to.html)<>());
        [std::cout](../io/cout.html) << "Number of pairwise matches between a and b: " <<  r2 << '\n';
    }
