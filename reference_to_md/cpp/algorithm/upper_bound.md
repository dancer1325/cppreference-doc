...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/upper_bound&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/upper_bound&action=edit&section=2 "Edit section: Return value")] Return value

Iterator to the first element of the range `[`first`, `last`)` ordered after value, or last if no such element is found. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/upper_bound&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/upper_bound&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/upper_bound&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/upper_bound&action=edit&section=6 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/upper_bound&action=edit&section=7 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/upper_bound&action=edit&section=8 "Edit section: See also")] See also
...
(public member function of `std::set<Key,Compare,Allocator>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_upper_bound&action=edit)  
...
(public member function of `std::multiset<Key,Compare,Allocator>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_upper_bound&action=edit)
