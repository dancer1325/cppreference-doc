...
OutputIt generate_n( OutputIt first, Size count, Generator g ); |  (1)  |  (constexpr since C++20)  
template< class ExecutionPolicy,  
class ForwardIt, class Size, class Generator >  
ForwardIt generate_n( ExecutionPolicy&& policy,  
ForwardIt first, Size count, Generator g ); |  (2)  |  (since C++17)  
| |   
...
If `Size` is not [convertible](../language/implicit_cast.html "cpp/language/implicit cast") to an [integral type](../language/type-id.html "cpp/language/type"), the program is ill-formed. 
...
## Contents
  ...
  * [4 Exceptions](generate_n.html#Exceptions)
  * [5 Possible implementation](generate_n.html#Possible_implementation)
  * [6 Example](generate_n.html#Example)
  * [7 Defect reports](generate_n.html#Defect_reports)
  * [8 See also](generate_n.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::mt19937](../numeric/random/mersenne_twister_engine.html) rng; // default constructed, seeded with fixed seed
        std::generate_n([std::ostream_iterator](../iterator/ostream_iterator.html)<std::mt19937::result_type>([std::cout](../io/cout.html), " "),
                        5, [std::ref](../utility/functional/ref.html)(rng));
...
---|---|---|---  
[LWG 426](https://cplusplus.github.io/LWG/issue426) | C++98  | the complexity requirement was “exactly count invocations  
