...
ForwardIt d_first ); |  (2)  |  (since C++17)  
| |   
  
1) Given \\(\scriptsize N\\)N as [std::distance](../iterator/distance.html)(first, last). Copies the elements from the range `[`first`, `last`)` (source range) to another range of \\(\scriptsize N\\)N elements beginning at d_first (destination range) in such a way that the elements in the destination range are in reverse order.

Behaves as if by executing the assignment *(d_first + N - 1 - i) = *(first + i)[[1]](reverse_copy.html#cite_note-plusminus-1) once for each integer i in `[`​0​`, `N`)`.
...
## Contents
  ...
  * [1 Parameters](reverse_copy.html#Parameters)
  * [2 Return value](reverse_copy.html#Return_value)
  * [3 Complexity](reverse_copy.html#Complexity)
  * [4 Exceptions](reverse_copy.html#Exceptions)
  * [5 Possible implementation](reverse_copy.html#Possible_implementation)
  * [6 Notes](reverse_copy.html#Notes)
  * [7 Example](reverse_copy.html#Example)
  * [8 Defect reports](reverse_copy.html#Defect_reports)
  * [9 See also](reverse_copy.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/reverse_copy&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/reverse_copy&action=edit&section=2 "Edit section: Return value")] Return value

Output iterator to the element past the last element copied. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/reverse_copy&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly \\(\scriptsize N\\)N assignments. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/reverse_copy&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/reverse_copy&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/reverse_copy&action=edit&section=6 "Edit section: Notes")] Notes

Implementations (e.g. [MSVC STL](https://github.com/microsoft/STL/blob/main/stl/src/vector_algorithms.cpp)) may enable vectorization when the both iterator types satisfy [LegacyContiguousIterator](../named_req/ContiguousIterator.html "cpp/named req/ContiguousIterator") and have the same value type, and the value type is [TriviallyCopyable](../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable"). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/reverse_copy&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto print = [](const [std::vector](../container/vector.html)<int>& v)
        {
    ...
     
        ...
        print(v);
     
        [std::vector](../container/vector.html)<int> destination(3);
        std::reverse_copy([std::begin](../iterator/begin.html)(v), [std::end](../iterator/end.html)(v), [std::begin](../iterator/begin.html)(destination));
        print(destination);
     
        std::reverse_copy([std::rbegin](../iterator/rbegin.html)(v), [std::rend](../iterator/rend.html)(v), [std::begin](../iterator/begin.html)(destination));
        print(destination);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/reverse_copy&action=edit&section=8 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2074](https://cplusplus.github.io/LWG/issue2074) | C++98  | for each i, the assignment was  
*(d_first + N - i) = *(first + i)[[1]](reverse_copy.html#cite_note-plusminus-1) | corrected to  
*(d_first + N - 1 - i) = *(first + i)[[1]](reverse_copy.html#cite_note-plusminus-1)  
[LWG 2150](https://cplusplus.github.io/LWG/issue2150) | C++98  | only one element was required to be assigned  | corrected the requirement   
  
  1. ↑ [1.0](reverse_copy.html#cite_ref-plusminus_1-0) [1.1](reverse_copy.html#cite_ref-plusminus_1-1) [1.2](reverse_copy.html#cite_ref-plusminus_1-2) [LegacyOutputIterator](../named_req/OutputIterator.html "cpp/named req/OutputIterator") is not required to support binary `+` and `-`. The usages of `+` and `-` here are exposition-only: the actual computation does not need to use them.



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/reverse_copy&action=edit&section=9 "Edit section: See also")] See also

[ reverse](reverse.html "cpp/algorithm/reverse") |  reverses the order of elements in a range   
