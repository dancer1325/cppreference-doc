...
UnaryFunc for_each( InputIt first, InputIt last, UnaryFunc f ); |  (1) | (constexpr since C++20)  
template< class ExecutionPolicy, class ForwardIt, class UnaryFunc >  
void for_each( ExecutionPolicy&& policy,  
ForwardIt first, ForwardIt last, UnaryFunc f ); |  (2) | (since C++17)  
| |   
  
Applies the given unary [function object](../named_req/FunctionObject.html "cpp/named req/FunctionObject") f to the result of dereferencing every [iterator](../iterator.html "cpp/iterator") in the [range](../iterator.html#Ranges "cpp/iterator") `[`first`, `last`)`. If f returns a result, the result is ignored. 

1) f is applied in order starting from first.  If `UnaryFunc` is not [MoveConstructible](../named_req/MoveConstructible.html "cpp/named req/MoveConstructible"), the [behavior is undefined](../language/ub.html "cpp/language/ub").  | (since C++11)  
---|---  
...
If `UnaryFunc` is not [CopyConstructible](../named_req/CopyConstructible.html "cpp/named req/CopyConstructible"), the [behavior is undefined](../language/ub.html "cpp/language/ub").

If the iterator type (`InputIt`/`ForwardIt`) is mutable, f may modify the elements of the [range](../iterator.html#Ranges "cpp/iterator") through the dereferenced iterator. 

Unlike the rest of the parallel algorithms, `for_each` is not allowed to make copies of the elements in the sequence even if they are [TriviallyCopyable](../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable"). 
...
## Contents
  ...
  * [4 Exceptions](for_each.html#Exceptions)
  * [5 Possible implementation](for_each.html#Possible_implementation)
  * [6 Notes](for_each.html#Notes)
  * [7 Example](for_each.html#Example)
  * [8 Defect reports](for_each.html#Defect_reports)
  * [9 See also](for_each.html#See_also)
...
f  |  \-  |  function object, to be applied to the result of dereferencing every iterator in the [range](../iterator.html#Ranges "cpp/iterator") `[`first`, `last`)`  
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v{3, -4, 2, -8, 15, 267};
     
    ...
     
        ...
        [std::cout](../io/cout.html) << "sum:\t" << s.sum << '\n';
    }
...
---|---|---|---  
[LWG 475](https://cplusplus.github.io/LWG/issue475) | C++98  | it was unclear whether f can modify the elements  
