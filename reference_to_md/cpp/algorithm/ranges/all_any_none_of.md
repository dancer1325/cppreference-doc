...
constexpr bool all_of( I first, S last, Pred pred, Proj proj = {} ); |  (1) | (since C++20)  
...
constexpr bool all_of( R&& r, Pred pred, Proj proj = {} ); |  (2)  |  (since C++20)  
template< [std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Pred >  
constexpr bool any_of( I first, S last, Pred pred, Proj proj = {} ); |  (3) | (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>,Proj>> Pred >  
constexpr bool any_of( R&& r, Pred pred, Proj proj = {} ); |  (4)  |  (since C++20)  
template< [std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Pred >  
constexpr bool none_of( I first, S last, Pred pred, Proj proj = {} ); |  (5) | (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>,Proj>> Pred >  
constexpr bool none_of( R&& r, Pred pred, Proj proj = {} ); |  (6)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/all_any_none_of&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/all_any_none_of&action=edit&section=2 "Edit section: Return value")] Return value

1,2) true if [std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *i)) != false for every iterator i in the range, false otherwise. Returns true if the range is empty.

3,4) true if [std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *i)) != false for at least one iterator i in the range, false otherwise. Returns false if the range is empty.

5,6) true if [std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *i)) == false for every iterator i in the range, false otherwise. Returns true if the range is empty.

Range has some true element  | Yes  | No   
---|---|---  
Range has some false element  | Yes  | No  | Yes  |  No[[1]](all_any_none_of.html#cite_note-1)  
[`all_of`](all_any_none_of.html#Version_1) | false | true | false | true  
[`any_of`](all_any_none_of.html#Version_3) | true | true |  false |  false  
[`none_of`](all_any_none_of.html#Version_5) |  false |  false | true | true  
  
  1. [↑](all_any_none_of.html#cite_ref-1) The range is empty in this case.



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/all_any_none_of&action=edit&section=3 "Edit section: Complexity")] Complexity

At most last - first applications of the predicate and the projection. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/all_any_none_of&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation

[all_of (1,2)](all_any_none_of.html#Version_1)  
---  
    ...
    struct all_of_fn
    {
        ...
        {
            return [ranges::find_if_not](find.html)(first, last, [std::ref](../../utility/functional/ref.html)(pred), [std::ref](../../utility/functional/ref.html)(proj)) == last;
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<
        ...
        {
            return operator()([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r),
...
[any_of (3,4)](all_any_none_of.html#Version_3)  
    ...
    struct any_of_fn
    {
        ...
        constexpr bool operator()(I first, S last, Pred pred, Proj proj = {}) const
        {
            return [ranges::find_if](find.html)(first, last, [std::ref](../../utility/functional/ref.html)(pred), [std::ref](../../utility/functional/ref.html)(proj)) != last;
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<
...
[none_of (5,6)](all_any_none_of.html#Version_5)  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/all_any_none_of&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        return not ([ranges::all_of](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/all_any_none_of)(r, pred) or [ranges::none_of](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/all_any_none_of)(r, pred));
    }
     
    ...
    int main()
    {
        ...
        [std::partial_sum](../partial_sum.html)(v.cbegin(), v.cend(), v.begin());
        [std::cout](../../io/cout.html) << "Among the numbers: ";
        [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(v, [std::ostream_iterator](../../iterator/ostream_iterator.html)<int>([std::cout](../../io/cout.html), " "));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/all_any_none_of&action=edit&section=6 "Edit section: See also")] See also

[ all_ofany_ofnone_of](../none_of.html "cpp/algorithm/all any none of")(C++11)(C++11)(C++11) |  checks if a predicate is true for all, any or none of the elements in a range   
