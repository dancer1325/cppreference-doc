...
constexpr const T&  
min( const T& a, const T& b, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [std::copyable](../../concepts/copyable.html) T, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<const T*, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr T  
min( [std::initializer_list](../../utility/initializer_list.html)<T> r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
...
min( R&& r, Comp comp = {}, Proj proj = {} ); |  (3)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [4 Possible implementation](min.html#Possible_implementation)
  * [5 Notes](min.html#Notes)
  * [6 Example](min.html#Example)
  * [7 See also](min.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/min&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct min_fn
    {
        ...
        {
            return [std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, b), [std::invoke](../../utility/functional/invoke.html)(proj, a)) ? b : a;
        }
     
        template<[std::copyable](../../concepts/copyable.html) T, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<
        ...
        {
            return *[ranges::min_element](min_element.html)(r, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<
        ...
        [ranges::range_value_t](../../ranges/range_size_t.html)<R> operator()(R&& r, Comp comp = {}, Proj proj = {}) const
        {
            ...
            if constexpr ([ranges::forward_range](../../ranges/forward_range.html)<R>)
                return
                    static_cast<V>(*[ranges::min_element](min_element.html)(r, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj)));
            else
            {
                ...
                V m(*i);
                while (++i != s)
                    if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *i), [std::invoke](../../utility/functional/invoke.html)(proj, m)))
                        m = *i;
                return m;
            }
        }
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << "smaller of 1 and 9999: " << ranges::min(1, 9999) << '\n'
