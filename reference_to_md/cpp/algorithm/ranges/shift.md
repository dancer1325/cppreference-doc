...
| **shift_left shift_right**(C++23)(C++23)` `  
---  
...
shift_left( I first, S last, [std::iter_difference_t](../../iterator/iter_t.html)<I> n ); |  (1)  |  (since C++23)  
...
shift_left( R&& r, [ranges::range_difference_t](../../ranges/range_size_t.html)<R> n ); |  (2)  |  (since C++23)  
template< [std::permutable](../../iterator/permutable.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S >  
constexpr [ranges::subrange](../../ranges/subrange.html)<I>  
shift_right( I first, S last, [std::iter_difference_t](../../iterator/iter_t.html)<I> n ); |  (3)  |  (since C++23)  
template< [ranges::forward_range](../../ranges/forward_range.html) R >  
requires [std::permutable](../../iterator/permutable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>>  
constexpr [ranges::borrowed_subrange_t](../../ranges/borrowed_iterator_t.html)<R>  
shift_right( R&& r, [ranges::range_difference_t](../../ranges/range_size_t.html)<R> n ); |  (4)  |  (since C++23)  
| |   
...
3) Shifts the elements towards the end of the range: 
  ...
  * If n == 0 || n >= last - first, there are no effects. 
  * If n < 0, the behavior is undefined. 
  * Otherwise, for every integer `i` in `[`​0​`, `last - first - n`)`, moves the element originally at position first + i to position first + n + i. If `I` models [`bidirectional_iterator`](../../iterator/bidirectional_iterator.html "cpp/iterator/bidirectional iterator"), then the moves are performed in decreasing order of `i` starting from last - first - n - 1.



2,4) Same as (1) or (3) respectively, but uses r as the range, as if using [ranges::begin](../../ranges/begin.html)(r) as first and [ranges::end](../../ranges/end.html)(r) as last.
...
## Contents
  ...
  * [4 Notes](shift.html#Notes)
  * [5 Example](shift.html#Example)
  * [6 See also](shift.html#See_also)
...
3,4) {/*NEW_FIRST*/, last}, where `_NEW_FIRST_` is the beginning of the resulting range and equivalent to: 
