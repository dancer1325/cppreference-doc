...
class Pred = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), class Proj = [std::identity](../../utility/functional/identity.html) >  
requires [std::indirectly_comparable](../../iterator/indirectly_comparable.html)<I, const T*, Pred, Proj>  
constexpr [ranges::subrange](../../ranges/subrange.html)<I>  
search_n( I first, S last, [std::iter_difference_t](../../iterator/iter_t.html)<I> count,  
...
constexpr [ranges::subrange](../../ranges/subrange.html)<I>  
search_n( I first, S last, [std::iter_difference_t](../../iterator/iter_t.html)<I> count,  
const T& value, Pred pred = {}, Proj proj = {} ); |  |  (since C++26)  
| (2) |   
template< [ranges::forward_range](../../ranges/forward_range.html) R, class T,  
class Pred = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), class Proj = [std::identity](../../utility/functional/identity.html) >  
requires [std::indirectly_comparable](../../iterator/indirectly_comparable.html)  
<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, const T*, Pred, Proj>  
constexpr [ranges::borrowed_subrange_t](../../ranges/borrowed_iterator_t.html)<R>  
search_n( R&& r, [ranges::range_difference_t](../../ranges/range_size_t.html)<R> count,  
const T& value, Pred pred = {}, Proj proj = {} ); |  |  (since C++20)   
(until C++26)  
...
1) Searches the range `[`first`, `last`)` for the _first_ sequence of count elements whose projected values are each equal to the given value according to the binary predicate pred.
...
## Contents
  ...
  * [4 Notes](search_n.html#Notes)
  * [5 Possible implementation](search_n.html#Possible_implementation)
  * [6 Example](search_n.html#Example)
  * [7 See also](search_n.html#See_also)
...
---|---|---  
r  |  \-  |  the range of elements to examine (aka _haystack_)   
count  |  \-  |  the length of the sequence to search for   
value  |  \-  |  the value to search for (aka _needle_)   
...
If no such subsequence is found, returns std::[ranges::subrange](../../ranges/subrange.html){last, last}. 

If count <= 0, returns std::[ranges::subrange](../../ranges/subrange.html){first, first}.
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/search_n&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
    ...
    struct search_n_fn
    {
        ...
        requires [std::indirectly_comparable](../../iterator/indirectly_comparable.html)<I, const T*, Pred, Proj>
        constexpr [ranges::subrange](../../ranges/subrange.html)<I>
            operator()(I first, S last, [std::iter_difference_t](../../iterator/iter_t.html)<I> count,
                       const T& value, Pred pred = {}, Proj proj = {}) const
        {
            if (count <= 0)
                return {first, first};
            for (; first != last; ++first)
                if ([std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *first), value))
                {
                    I start = first;
                    [std::iter_difference_t](../../iterator/iter_t.html)<I> n{1};
                    for (;;)
                    {
                        if (n++ == count)
                            return {start, [std::next](../../iterator/next.html)(first)}; // found
                        if (++first == last)
    ...
     
        template<[ranges::forward_range](../../ranges/forward_range.html) R,
                 class Pred = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), class Proj = [std::identity](../../utility/functional/identity.html),
                 class T = std::projected_value_t<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>>
        requires [std::indirectly_comparable](../../iterator/indirectly_comparable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, const T*, Pred, Proj>
        constexpr [ranges::borrowed_subrange_t](../../ranges/borrowed_iterator_t.html)<R>
            operator()(R&& r, [ranges::range_difference_t](../../ranges/range_size_t.html)<R> count,
                       const T& value, Pred pred = {}, Proj proj = {}) const
        {
...
Run this code
    ...
     
        ...
        (
            result1.size() == count &&
            [std::distance](../../iterator/distance.html)(nums.begin(), result1.begin()) == 6 &&
            [std::distance](../../iterator/distance.html)(nums.begin(), result1.end()) == 9
        );
     
        ...
        (
            result2.size() == count &&
            [std::distance](../../iterator/distance.html)(nums.begin(), result2.begin()) == 6 &&
            [std::distance](../../iterator/distance.html)(nums.begin(), result2.end()) == 9
        );
     
    ...
     
        [std::cout](../../io/cout.html) << "Find a sub-sequence " << [std::string](../../string/basic_string.html)(count, symbol) << " in the ";
        std::[ranges::transform](transform.html)(nums, [std::ostream_iterator](../../iterator/ostream_iterator.html)<char>([std::cout](../../io/cout.html), ""), to_ascii);
        [std::cout](../../io/cout.html) << '\n';
     
        auto result5 = ranges::search_n(nums, count, symbol, is_equ, to_ascii);
        if (not result5.empty())
            [std::cout](../../io/cout.html) << "Found at position "
                      << [ranges::distance](../../iterator/ranges/distance.html)(nums.begin(), result5.begin()) << '\n';
     
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<double>> nums2{{4, 2}, {4, 2}, {1, 3}};
        #ifdef __cpp_lib_algorithm_default_value_type
            auto it = ranges::search_n(nums2, 2, {4, 2});
        #else
            auto it = ranges::search_n(nums2, 2, [std::complex](../../numeric/complex.html)<double>{4, 2});
        #endif
        [assert](../../error/assert.html)(it.size() == 2);
    }
