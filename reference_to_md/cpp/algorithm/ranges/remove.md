...
Call signature |  |   
| (1) |   
template< [std::permutable](../../iterator/permutable.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class T, class Proj = [std::identity](../../utility/functional/identity.html) >  
requires [std::indirect_binary_predicate](../../iterator/indirect_binary_predicate.html)  
...
constexpr [ranges::subrange](../../ranges/subrange.html)<I>  
remove( I first, S last, const T& value, Proj proj = {} ); |  | (since C++20)   
(until C++26)  
template< [std::permutable](../../iterator/permutable.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
...
<[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>, const T*>  
constexpr [ranges::subrange](../../ranges/subrange.html)<I>  
remove( I first, S last, const T& value, Proj proj = {} ); |  |  (since C++26)  
| (2) |   
template< [ranges::forward_range](../../ranges/forward_range.html) R,  
class T, class Proj = [std::identity](../../utility/functional/identity.html) >  
requires [std::permutable](../../iterator/permutable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>> &&  
...
constexpr [ranges::borrowed_subrange_t](../../ranges/borrowed_iterator_t.html)<R>  
remove( R&& r, const T& value, Proj proj = {} ); |  |  (since C++20)   
(until C++26)  
template< [ranges::forward_range](../../ranges/forward_range.html) R,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>, const T*>  
constexpr [ranges::borrowed_subrange_t](../../ranges/borrowed_iterator_t.html)<R>  
remove( R&& r, const T& value, Proj proj = {} ); |  |  (since C++26)  
template< [std::permutable](../../iterator/permutable.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
constexpr [ranges::subrange](../../ranges/subrange.html)<I>  
remove_if( I first, S last, Pred pred, Proj proj = {} ); |  (3) | (since C++20)  
template< [ranges::forward_range](../../ranges/forward_range.html) R,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
requires [std::permutable](../../iterator/permutable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>>  
constexpr [ranges::borrowed_subrange_t](../../ranges/borrowed_iterator_t.html)<R>  
remove_if( R&& r, Pred pred, Proj proj = {} ); |  (4)  |  (since C++20)  
| |   
...
1) Removes all elements that are equal to value, using [std::invoke](../../utility/functional/invoke.html)(proj, *i) == value to compare.

3) Removes all elements for which [std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *i)) returns true.
...
## Contents
  ...
  * [3 Complexity](remove.html#Complexity)
  * [4 Notes](remove.html#Notes)
  * [5 Possible implementation](remove.html#Possible_implementation)
  * [6 Notes](remove.html#Notes_2)
  * [7 Example](remove.html#Example)
  * [8 See also](remove.html#See_also)
...
The similarly-named container [member functions](../../container.html#Member_function_table "cpp/container") [`list::remove`](../../container/list/remove.html "cpp/container/list/remove"), [`list::remove_if`](../../container/list/remove.html "cpp/container/list/remove"), [`forward_list::remove`](../../container/forward_list/remove.html "cpp/container/forward list/remove"), and [`forward_list::remove_if`](../../container/forward_list/remove.html "cpp/container/forward list/remove") erase the removed elements. 

These algorithms usually cannot be used with associative containers such as [std::set](../../container/set.html "cpp/container/set") and [std::map](../../container/map.html "cpp/container/map") because their iterator types do not dereference to [MoveAssignable](../../named_req/MoveAssignable.html "cpp/named req/MoveAssignable") types (the keys in these containers are not modifiable). 
...
---  
    ...
    struct remove_fn
    {
        template<[std::permutable](../../iterator/permutable.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S, class Proj = [std::identity](../../utility/functional/identity.html),
                 class T = std::projected_value_t<I, Proj>>
        requires [std::indirect_binary_predicate](../../iterator/indirect_binary_predicate.html)
                     <[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>, const T*>
        constexpr [ranges::subrange](../../ranges/subrange.html)<I>
        ...
        {
            first = [ranges::find](find.html)(std::move(first), last, value, proj);
            if (first != last)
            {
                for (I i{[std::next](../../iterator/next.html)(first)}; i != last; ++i)
                    if (value != [std::invoke](../../utility/functional/invoke.html)(proj, *i))
                    {
                        *first = [ranges::iter_move](../../iterator/ranges/iter_move.html)(i);
                        ++first;
                    }
            }
            return {first, last};
    ...
     
        template<[ranges::forward_range](../../ranges/forward_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 class T = std::projected_value_t<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>>
        requires [std::permutable](../../iterator/permutable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>> &&
                 [std::indirect_binary_predicate](../../iterator/indirect_binary_predicate.html)
                     <[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to),
        ...
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), value, std::move(proj));
        }
    };
     
    inline constexpr remove_fn remove {};  
  
[remove_if (3,4)](remove.html#Version_3)  
    ...
    struct remove_if_fn
    {
        ...
        {
            first = [ranges::find_if](find.html)(std::move(first), last, pred, proj);
            if (first != last)
            {
                for (I i{[std::next](../../iterator/next.html)(first)}; i != last; ++i)
                    if (![std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *i)))
                    {
                        *first = [ranges::iter_move](../../iterator/ranges/iter_move.html)(i);
                        ++first;
                    }
    ...
     
        ...
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), pred, std::move(proj));
        }
    };
     
...
Run this code
    ...
    int main()
    {
        [std::string](../../string/basic_string.html) v1{"No - Diagnostic - Required"};
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(v1) << " (v1, size: " << v1.size() << ")\n";
        const auto ret = std::ranges::remove(v1, ' ');
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(v1) << " (v1 after `remove`, size: " << v1.size() << ")\n";
        [std::cout](../../io/cout.html) << ' ' << [std::string](../../string/basic_string.html)([std::distance](../../iterator/distance.html)(v1.begin(), ret.begin()), '^') << '\n';
        v1.erase(ret.begin(), ret.end());
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(v1) << " (v1 after `erase`, size: " << v1.size() << ")\n\n";
     
        // remove_if with custom unary predicate:
        auto rm = [](char c) { return ![std::isupper](../../string/byte/isupper.html)(c); };
        [std::string](../../string/basic_string.html) v2{"Substitution Failure Is Not An Error"};
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(v2) << " (v2, size: " << v2.size() << ")\n";
        const auto [first, last] = std::ranges::remove_if(v2, rm);
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(v2) << " (v2 after `remove_if`, size: " << v2.size() << ")\n";
        [std::cout](../../io/cout.html) << ' ' << [std::string](../../string/basic_string.html)([std::distance](../../iterator/distance.html)(v2.begin(), first), '^') << '\n';
        v2.erase(first, last);
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(v2) << " (v2 after `erase`, size: " << v2.size() << ")\n\n";
     
        // creating a view into a container that is modified by `remove_if`:
        for ([std::string](../../string/basic_string.html) s : {"Small Object Optimization", "Non-Type Template Parameter"})
            [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(s) << " => "
                << [std::string_view](../../string/basic_string_view.html){begin(s), std::ranges::remove_if(s, rm).begin()} << '\n';
     
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<double>> nums{{2, 2}, {1, 3}, {4, 8}};
        #ifdef __cpp_lib_algorithm_default_value_type
            auto e = std::ranges::remove(nums, {1, 3}); // T gets deduced
        #else
            auto e = std::ranges::remove(nums, [std::complex](../../numeric/complex.html)<double>{1, 3});
        #endif
        nums.erase(e.begin(), e.end());
        [assert](../../error/assert.html)((nums == [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<double>>{{2, 2}, {4, 8}}));
    }
