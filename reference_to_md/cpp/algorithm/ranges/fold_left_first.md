...
constexpr auto  
fold_left_first( I first, S last, F f ); |  (1)  |  (since C++23)  
...
constexpr auto  
fold_left_first( R&& r, F f ); |  (2)  |  (since C++23)  
Helper concepts |  |   
...
Informally, `ranges::fold_left_first` behaves like [std::accumulate](../accumulate.html "cpp/algorithm/accumulate")'s overload that accepts a binary predicate, except that the *first is used internally as an initial element. 

The behavior is undefined if `[`first`, `last`)` is not a valid range. 

1) The range is `[`first`, `last`)`. Equivalent to return [ranges::fold_left_first_with_iter](fold_left_first_with_iter.html)(std::move(first), last, f).value.
...
## Contents
  ...
  * [1 Parameters](fold_left_first.html#Parameters)
  * [2 Return value](fold_left_first.html#Return_value)
  * [3 Possible implementations](fold_left_first.html#Possible_implementations)
  * [4 Complexity](fold_left_first.html#Complexity)
  * [5 Notes](fold_left_first.html#Notes)
  * [6 Example](fold_left_first.html#Example)
  * [7 References](fold_left_first.html#References)
  * [8 See also](fold_left_first.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first&action=edit&section=2 "Edit section: Return value")] Return value

An object of type [std::optional](../../utility/optional.html)<U> that contains the result of left-[fold](https://en.wikipedia.org/wiki/Fold_\(higher-order_function\) "enwiki:Fold \(higher-order function\)") of the given range over f, where U is equivalent to decltype([ranges::fold_left](fold_left.html)(std::move(first), last, [std::iter_value_t](../../iterator/iter_t.html)<I>(*first), f)). 

If the range is empty, [std::optional](../../utility/optional.html)<U>() is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first&action=edit&section=3 "Edit section: Possible implementations")] Possible implementations
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first&action=edit&section=4 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first&action=edit&section=5 "Edit section: Notes")] Notes
...
ranges::fold_left_first | left | first element | [std::optional](../../utility/optional.html)<U>  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr [std::array](../../container/array.html) v{1, 2, 3, 4, 5, 6, 7, 8};
        static_assert
        (
            *std::ranges::fold_left_first(v.begin(), v.end(), [std::plus](../../utility/functional/plus.html){}) == 36
            && *std::ranges::fold_left_first(v, [std::multiplies](../../utility/functional/multiplies.html){}) == 40320
        );
     
        constexpr [std::array](../../container/array.html) w
        {
            1, 2, 3, 4, 13,
            1, 2, 3, 4, 13,
            1, 2, 3, 4, 13,
    ...
     
        constexpr auto pairs = [std::to_array](../../container/array/to_array.html)<[std::pair](../../utility/pair.html)<char, float>>
        ({
            {'A', 3.0f},
            {'B', 3.5f},
            {'C', 4.0f}
        ...
        (
            ...
            (
                pairs | std::ranges::[views::values](../../ranges/values_view.html), [std::multiplies](../../utility/functional/multiplies.html){}
            ) == 42
        );
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first&action=edit&section=7 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first&action=edit&section=8 "Edit section: See also")] See also
