...
[std::copy_constructible](../../concepts/copy_constructible.html) F, class Proj = [std::identity](../../utility/functional/identity.html) >  
requires [std::indirectly_writable](../../iterator/indirectly_writable.html)<O,  
[std::indirect_result_t](../../iterator/indirect_result_t.html)<F&, std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>>>  
constexpr unary_transform_result<I, O>  
transform( I first1, S last1, O result, F op, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,  
[std::copy_constructible](../../concepts/copy_constructible.html) F, class Proj = [std::identity](../../utility/functional/identity.html) >  
requires [std::indirectly_writable](../../iterator/indirectly_writable.html)<O,  
[std::indirect_result_t](../../iterator/indirect_result_t.html)<F&, std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>>>  
constexpr unary_transform_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>  
transform( R&& r, O result, F op, Proj proj = {} ); |  (2)  |  (since C++20)  
...
[std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,  
...
requires [std::indirectly_writable](../../iterator/indirectly_writable.html)<O,  
[std::indirect_result_t](../../iterator/indirect_result_t.html)<F&,  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I1, Proj1>,  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I2, Proj2>>>  
constexpr binary_transform_result<I1, I2, O>  
transform( I1 first1, S1 last1, I2 first2, S2 last2, O result,  
F binary_op, Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (3)  |  (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R1,  
[ranges::input_range](../../ranges/input_range.html) R2,  
[std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,  
[std::copy_constructible](../../concepts/copy_constructible.html) F,  
class Proj1 = [std::identity](../../utility/functional/identity.html), class Proj2 = [std::identity](../../utility/functional/identity.html) >  
requires [std::indirectly_writable](../../iterator/indirectly_writable.html)<O,  
...
constexpr binary_transform_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,  
[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>, O>  
transform( R1&& r1, R2&& r2, O result, F binary_op,  
Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (4)  |  (since C++20)  
Helper types |  |   
template< class I, class O >  
using unary_transform_result = [ranges::in_out_result](return_types/in_out_result.html)<I, O>; |  (5)  |  (since C++20)  
template< class I1, class I2, class O >  
using binary_transform_result = [ranges::in_in_out_result](return_types/in_in_out_result.html)<I1, I2, O>; |  (6)  |  (since C++20)  
| |   
...
4) Same as (3), but uses r1 as the first source range, as if using [ranges::begin](../../ranges/begin.html)(r1) as first1 and [ranges::end](../../ranges/end.html)(r1) as last1, and similarly for r2.
...
## Contents
  ...
  * [3 Complexity](transform.html#Complexity)
  * [4 Possible implementation](transform.html#Possible_implementation)
  * [5 Notes](transform.html#Notes)
  * [6 Example](transform.html#Example)
  * [7 See also](transform.html#See_also)
...
first2, last2  |  \-  |  the iterator-sentinel pair defining the second [range](../../iterator.html#Ranges "cpp/iterator") of elements to transform   
...
### Possible implementation
    ...
    struct transform_fn
    {
        ...
        template<[std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,
                 [std::copy_constructible](../../concepts/copy_constructible.html) F, class Proj = [std::identity](../../utility/functional/identity.html)>
        requires [std::indirectly_writable](../../iterator/indirectly_writable.html)<O, [std::indirect_result_t](../../iterator/indirect_result_t.html)<F&,
                                                                    std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>>>
        constexpr ranges::unary_transform_result<I, O>
            operator()(I first1, S last1, O result, F op, Proj proj = {}) const
        {
            for (; first1 != last1; ++first1, (void)++result)
                *result = [std::invoke](../../utility/functional/invoke.html)(op, [std::invoke](../../utility/functional/invoke.html)(proj, *first1));
     
    ...
     
        ...
        requires [std::indirectly_writable](../../iterator/indirectly_writable.html)<O,
                     [std::indirect_result_t](../../iterator/indirect_result_t.html)<F&, std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>>>
        constexpr ranges::unary_transform_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>
    ...
     
                       ...
                       F binary_op, Proj1 proj1 = {}, Proj2 proj2 = {}) const
        {
            for (; first1 != last1 && first2 != last2;
                ...
                *result = [std::invoke](../../utility/functional/invoke.html)(binary_op,
    ...
     
        ...
        template<[ranges::input_range](../../ranges/input_range.html) R1, [ranges::input_range](../../ranges/input_range.html) R2,
                 [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O, [std::copy_constructible](../../concepts/copy_constructible.html) F,
                 class Proj1 = [std::identity](../../utility/functional/identity.html), class Proj2 = [std::identity](../../utility/functional/identity.html)>
        requires [std::indirectly_writable](../../iterator/indirectly_writable.html)<O,
                     [std::indirect_result_t](../../iterator/indirect_result_t.html)<F&,
                         std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>, Proj1>,
                         std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R2>, Proj2>>>
        constexpr ranges::binary_transform_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,
                                                  [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>, O>
...
Run this code
    ...
    int main()
    {
        [std::string](../../string/basic_string.html) s{"hello"};
        auto op = [](unsigned char c) -> unsigned char { return [std::toupper](../../string/byte/toupper.html)(c); };
     
    ...
     
        [std::vector](../../container/vector.html)<[std::size_t](../../types/size_t.html)> ordinals;
        // convert each char to size_t
        ranges::transform(s, [std::back_inserter](../../iterator/back_inserter.html)(ordinals),
                          [](unsigned char c) -> [std::size_t](../../types/size_t.html) { return c; });
     
        [std::cout](../../io/cout.html) << s << ':';
        for (auto ord : ordinals)
            [std::cout](../../io/cout.html) << ' ' << ord;
     
        // double each ordinal
        ranges::transform(ordinals, ordinals, ordinals.begin(), [std::plus](../../utility/functional/plus.html){});
     
    ...
     
        struct Foo { char bar; };
        const [std::vector](../../container/vector.html)<Foo> f = {{'h'},{'e'},{'l'},{'l'},{'o'}};
        [std::string](../../string/basic_string.html) result;
        // project, then uppercase
        ranges::transform(f, [std::back_inserter](../../iterator/back_inserter.html)(result), op, &Foo::bar);
        [std::cout](../../io/cout.html) << result << '\n';
    }
