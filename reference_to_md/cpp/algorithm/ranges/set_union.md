...
[std::weakly_incrementable](../../iterator/weakly_incrementable.html) O, class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less),  
class Proj1 = [std::identity](../../utility/functional/identity.html), class Proj2 = [std::identity](../../utility/functional/identity.html) >  
requires [std::mergeable](../../iterator/mergeable.html)<I1, I2, O, Comp, Proj1, Proj2>  
...
[std::weakly_incrementable](../../iterator/weakly_incrementable.html) O, class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less),  
class Proj1 = [std::identity](../../utility/functional/identity.html), class Proj2 = [std::identity](../../utility/functional/identity.html) >  
requires [std::mergeable](../../iterator/mergeable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>, [ranges::iterator_t](../../ranges/iterator_t.html)<R2>,  
O, Comp, Proj1, Proj2>  
constexpr set_union_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,  
[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>, O>  
set_union( R1&& r1, R2&& r2, O result, Comp comp = {},  
Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I1, class I2, class O >  
using set_union_result = [ranges::in_in_out_result](return_types/in_in_out_result.html)<I1, I2, O>; |  (3)  |  (since C++20)  
| |   
...
2) Same as (1), but uses r1 as the first range and r2 as the second range, as if using [ranges::begin](../../ranges/begin.html)(r1) as first1, [ranges::end](../../ranges/end.html)(r1) as last1, [ranges::begin](../../ranges/begin.html)(r2) as first2, and [ranges::end](../../ranges/end.html)(r2) as last2.
...
## Contents
  ...
  * [1 Parameters](set_union.html#Parameters)
  * [2 Return value](set_union.html#Return_value)
  * [3 Complexity](set_union.html#Complexity)
  * [4 Notes](set_union.html#Notes)
  * [5 Possible implementation](set_union.html#Possible_implementation)
  * [6 Example](set_union.html#Example)
  * [7 See also](set_union.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_union&action=edit&section=1 "Edit section: Parameters")] Parameters
...
---|---|---  
first2, last2  |  \-  |  the iterator-sentinel pair defining the second input sorted [range](../../iterator.html#Ranges "cpp/iterator") of elements   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_union&action=edit&section=2 "Edit section: Return value")] Return value

{last1, last2, result_last}, where result_last is the end of the constructed range. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_union&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_union&action=edit&section=4 "Edit section: Notes")] Notes

This algorithm performs a similar task as [ranges::merge](merge.html "cpp/algorithm/ranges/merge") does. Both consume two sorted input ranges and produce a sorted output with elements from both inputs. The difference between these two algorithms is with handling values from both input ranges which compare equivalent (see notes on [LessThanComparable](../../named_req/LessThanComparable.html "cpp/named req/LessThanComparable")). If any equivalent values appeared `n` times in the first range and `m` times in the second, [ranges::merge](merge.html "cpp/algorithm/ranges/merge") would output all n+m occurrences whereas `ranges::set_union` would output [std::max](../max.html)(n, m) ones only. So [ranges::merge](merge.html "cpp/algorithm/ranges/merge") outputs exactly \\(\scriptsize (N_1+N_2)\\)(N1+N2) values and `ranges::set_union` may produce less. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_union&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
    ...
    struct set_union_fn
    {
                       ...
                       Proj1 proj1 = {}, Proj2 proj2 = {}) const
        {
            ...
            {
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj1, *first1), 
                                      [std::invoke](../../utility/functional/invoke.html)(proj2, *first2)))
                {
                    *result = *first1;
                    ++first1;
                }
                else if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj2, *first2),
                                           [std::invoke](../../utility/functional/invoke.html)(proj1, *first1)))
                {
                    *result = *first2;
                    ++first2;
                }
            ...
            auto res1 = [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(std::move(first1), std::move(last1), std::move(result));
            auto res2 = [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(std::move(first2), std::move(last2), std::move(res1.out));
    ...
     
        ...
        requires [std::mergeable](../../iterator/mergeable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>, [ranges::iterator_t](../../ranges/iterator_t.html)<R2>,
                                O, Comp, Proj1, Proj2>
        constexpr ranges::set_union_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,
                                           [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>, O>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_union&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<int> in1, in2, out;
     
        in1 = {1, 2, 3, 4, 5};
        in2 = {      3, 4, 5, 6, 7};
    ...
     
        ...
        std::ranges::set_union(in1, in2, [std::back_inserter](../../iterator/back_inserter.html)(out));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_union&action=edit&section=7 "Edit section: See also")] See also
