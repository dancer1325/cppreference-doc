...
class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less), class Proj = [std::identity](../../utility/functional/identity.html) >  
requires [std::sortable](../../iterator/sortable.html)<I, Comp, Proj>  
constexpr prev_permutation_result<I>  
prev_permutation( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [ranges::bidirectional_range](../../ranges/bidirectional_range.html) R, class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less),  
class Proj = [std::identity](../../utility/functional/identity.html) >  
requires [std::sortable](../../iterator/sortable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Comp, Proj>  
constexpr prev_permutation_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>>  
prev_permutation( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
Helper type |  |   
template< class I >  
using prev_permutation_result = [ranges::in_found_result](return_types/in_found_result.html)<I>; |  (3)  |  (since C++20)  
| |   
  
1) Transforms the range `[`first`, `last`)` into the previous [permutation](https://en.wikipedia.org/wiki/permutation "enwiki:permutation"), where the set of all permutations is ordered [lexicographically](https://en.wikipedia.org/wiki/Lexicographic_order "enwiki:Lexicographic order") with respect to binary comparison function object comp and projection function object proj.
...
Returns: 
  ...
  * {last, false}, and transforms the range into the (lexicographically) last permutation, as if by 
    ...
    [ranges::sort](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/sort)(first, last, comp, proj);
    [ranges::reverse](reverse.html)(first, last);
...
## Contents
  ...
  * [1 Parameters](prev_permutation.html#Parameters)
  * [2 Return value](prev_permutation.html#Return_value)
  * [3 Exceptions](prev_permutation.html#Exceptions)
  * [4 Complexity](prev_permutation.html#Complexity)
  * [5 Notes](prev_permutation.html#Notes)
  * [6 Possible implementation](prev_permutation.html#Possible_implementation)
  * [7 Example](prev_permutation.html#Example)
  * [8 See also](prev_permutation.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/prev_permutation&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to "permute"   
---|---|---  
r  |  \-  |  the [`range`](../../ranges/range.html "cpp/ranges/range") of elements to "permute"   
comp  |  \-  |  comparison [FunctionObject](../../named_req/FunctionObject.html "cpp/named req/FunctionObject") which returns true if the first argument is less than the second   
proj  |  \-  |  projection to apply to the elements   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/prev_permutation&action=edit&section=2 "Edit section: Return value")] Return value
...
2) Same as (1) except that the return type is ranges::prev_permutation_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>>.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/prev_permutation&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Any exceptions thrown from iterator operations or the element swap. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/prev_permutation&action=edit&section=4 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/prev_permutation&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/prev_permutation&action=edit&section=6 "Edit section: Possible implementation")] Possible implementation
    ...
    struct prev_permutation_fn
    {
            ...
            operator()(I first, S last, Comp comp = {}, Proj proj = {}) const
        {
            ...
            auto i_last{[ranges::next](../../iterator/ranges/next.html)(first, last)};
            i = i_last;
            --i;
            ...
            for (;;)
            {
                auto i1{i};
                --i;
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *i1), [std::invoke](../../utility/functional/invoke.html)(proj, *i)))
                {
                    auto j{i_last};
                    while (![std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *--j), [std::invoke](../../utility/functional/invoke.html)(proj, *i)))
                        ;
                    [ranges::iter_swap](../../iterator/ranges/iter_swap.html)(i, j);
                    [ranges::reverse](reverse.html)(i1, last);
    ...
     
        template<[ranges::bidirectional_range](../../ranges/bidirectional_range.html) R, class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less),
                 class Proj = [std::identity](../../utility/functional/identity.html)>
        requires [std::sortable](../../iterator/sortable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Comp, Proj>
        constexpr ranges::prev_permutation_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/prev_permutation&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "Generate all permutations (iterators case):\n";
        [std::string](../../string/basic_string.html) s{"cba"};
        do print(s);
        while (std::ranges::prev_permutation(s.begin(), s.end()).found);
     
        [std::cout](../../io/cout.html) << "\nGenerate all permutations (range case):\n";
        [std::array](../../container/array.html) a{'c', 'b', 'a'};
        do print(a);
        while (std::ranges::prev_permutation(a).found);
     
        [std::cout](../../io/cout.html) << "\nGenerate all permutations using comparator:\n";
        using namespace std::literals;
        [std::array](../../container/array.html) z{"▁"s, "▄"s, "█"s};
        do print(z);
        while (std::ranges::prev_permutation(z, [std::greater](../../utility/functional/greater.html)()).found);
     
        [std::cout](../../io/cout.html) << "\nGenerate all permutations using projection:\n";
        [std::array](../../container/array.html)<S, 3> r{S{'C',1}, S{'B',2}, S{'A',3}};
        do print(r, '\n');
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/prev_permutation&action=edit&section=8 "Edit section: See also")] See also
