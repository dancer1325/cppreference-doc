...
---|---|---  
Call signature |  |   
template< [std::input_or_output_iterator](../../iterator/input_or_output_iterator.html) O, [std::copy_constructible](../../concepts/copy_constructible.html) F >  
requires [std::invocable](../../concepts/invocable.html)<F&> && [std::indirectly_writable](../../iterator/indirectly_writable.html)<O, [std::invoke_result_t](../../types/result_of.html)<F&>>  
constexpr O  
generate_n( O first, [std::iter_difference_t](../../iterator/iter_t.html)<O> n, F gen ); |  |  (since C++20)  
| |   
  
Assigns the result of _successive_ invocations of the function object gen to each element in the range `[`first`, `first + n`)`, if 0 < n. Does nothing otherwise. 
...
## Contents
  ...
  * [1 Parameters](generate_n.html#Parameters)
  * [2 Return value](generate_n.html#Return_value)
  * [3 Complexity](generate_n.html#Complexity)
  * [4 Possible implementation](generate_n.html#Possible_implementation)
  * [5 Example](generate_n.html#Example)
  * [6 See also](generate_n.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/generate_n&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/generate_n&action=edit&section=2 "Edit section: Return value")] Return value

Iterator one past the last element assigned if 0 < count, first otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/generate_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly n invocations of gen() and assignments. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/generate_n&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct generate_n_fn
    {
        template<[std::input_or_output_iterator](../../iterator/input_or_output_iterator.html) O, [std::copy_constructible](../../concepts/copy_constructible.html) F>
        requires [std::invocable](../../concepts/invocable.html)<F&> && [std::indirectly_writable](../../iterator/indirectly_writable.html)<O, [std::invoke_result_t](../../types/result_of.html)<F&>>
        constexpr O operator()(O first, [std::iter_difference_t](../../iterator/iter_t.html)<O> n, F gen) const
        {
            for (; n-- > 0; *first = [std::invoke](../../utility/functional/invoke.html)(gen), ++first)
            {}
            return first;
        }
    };
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/generate_n&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    auto dice()
    {
        static [std::uniform_int_distribution](../../numeric/random/uniform_int_distribution.html)<int> distr {1, 6};
    ...
     
    void print(const auto& v, [std::string_view](../../string/basic_string_view.html) comment)
    {
        for (int i : v)
    ...
    int main()
    {
        [std::array](../../container/array.html)<int, 8> v;
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/generate_n&action=edit&section=6 "Edit section: See also")] See also
