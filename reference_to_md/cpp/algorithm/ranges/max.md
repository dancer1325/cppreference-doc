...
constexpr const T&  
max( const T& a, const T& b, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [std::copyable](../../concepts/copyable.html) T, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<const T*, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr T  
max( [std::initializer_list](../../utility/initializer_list.html)<T> r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
...
constexpr [ranges::range_value_t](../../ranges/range_size_t.html)<R>  
max( R&& r, Comp comp = {}, Proj proj = {} ); |  (3)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](max.html#Parameters)
  * [2 Return value](max.html#Return_value)
  * [3 Complexity](max.html#Complexity)
  * [4 Possible implementation](max.html#Possible_implementation)
  * [5 Notes](max.html#Notes)
  * [6 Example](max.html#Example)
  * [7 See also](max.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max&action=edit&section=2 "Edit section: Return value")] Return value

1) The greater of a and b, according to their respective projected values. If they are equivalent, returns a.

2,3) The greatest value in r, according to the projection. If several values are equivalent to the greatest, returns the leftmost one. If the range is empty (as determined by [ranges::distance](../../iterator/ranges/distance.html)(r)), the behavior is undefined.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max&action=edit&section=3 "Edit section: Complexity")] Complexity

1) Exactly one comparison.

2,3) Exactly [ranges::distance](../../iterator/ranges/distance.html)(r) - 1 comparisons.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct max_fn
    {
        ...
        {
            return [std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, a), [std::invoke](../../utility/functional/invoke.html)(proj, b)) ? b : a;
        }
     
        template<[std::copyable](../../concepts/copyable.html) T, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<
                     std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<const T*, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less)>
        constexpr
        T operator()([std::initializer_list](../../utility/initializer_list.html)<T> r, Comp comp = {}, Proj proj = {}) const
        {
            return *[ranges::max_element](max_element.html)(r, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<
        ...
        requires [std::indirectly_copyable_storable](../../iterator/indirectly_copyable_storable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>,
                                                   [ranges::range_value_t](../../ranges/range_size_t.html)<R>*>
        constexpr
        [ranges::range_value_t](../../ranges/range_size_t.html)<R> operator()(R&& r, Comp comp = {}, Proj proj = {}) const
        {
            using V = [ranges::range_value_t](../../ranges/range_size_t.html)<R>;
            if constexpr ([ranges::forward_range](../../ranges/forward_range.html)<R>)
                return
                    static_cast<V>(*[ranges::max_element](max_element.html)(r, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj)));
            else
            {
                auto i = [ranges::begin](../../ranges/begin.html)(r);
                auto s = [ranges::end](../../ranges/end.html)(r);
                V m(*i);
                while (++i != s)
                    if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, m), [std::invoke](../../utility/functional/invoke.html)(proj, *i)))
                        m = *i;
                return m;
            }
        }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << "larger of 1 and 9999: " << ranges::max(1, 9999) << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max&action=edit&section=7 "Edit section: See also")] See also
