...
minmax_element( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
...
constexpr minmax_element_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>>  
minmax_element( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I >  
using minmax_element_result = [ranges::min_max_result](return_types/min_max_result.html)<I>; |  (3)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [4 Possible implementation](minmax_element.html#Possible_implementation)
  * [5 Example](minmax_element.html#Example)
  * [6 See also](minmax_element.html#See_also)
...
### Possible implementation
    ...
     
            if (first == last || ++first == last)
                return {min, max};
     
            if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *first),
                                  [std::invoke](../../utility/functional/invoke.html)(proj, *min)))
                min = first;
            else
                max = first;
     
            while (++first != last)
            {
                ...
                if (++first == last)
                {
                    if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *i),
                                          [std::invoke](../../utility/functional/invoke.html)(proj, *min)))
                        min = i;
                    else if (!([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *i),
                                                 [std::invoke](../../utility/functional/invoke.html)(proj, *max))))
                        max = i;
                    break;
                }
                else
                {
                    if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *first),
                                          [std::invoke](../../utility/functional/invoke.html)(proj, *i)))
                    {
                      if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *first),
                                            [std::invoke](../../utility/functional/invoke.html)(proj, *min)))
                          min = first;
    ...
     
        template<[ranges::forward_range](../../ranges/forward_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<
                     std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less)>
        constexpr ranges::minmax_element_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>>
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html)
            << "min = " << *min << ", at [" << [ranges::distance](../../iterator/ranges/distance.html)(v.begin(), min) << "]\n"
            << "max = " << *max << ", at [" << [ranges::distance](../../iterator/ranges/distance.html)(v.begin(), max) << "]\n";
    }
