...
requires ([std::forward_iterator](../../iterator/forward_iterator.html)<I1> || [std::sized_sentinel_for](../../iterator/sized_sentinel_for.html)<S1, I1>) &&  
([std::forward_iterator](../../iterator/forward_iterator.html)<I2> || [std::sized_sentinel_for](../../iterator/sized_sentinel_for.html)<S2, I2>) &&  
[std::indirectly_comparable](../../iterator/indirectly_comparable.html)<I1, I2, Pred, Proj1, Proj2>  
constexpr bool ends_with( I1 first1, S1 last1,  
I2 first2, S2 last2, Pred pred = {},  
Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (1)  |  (since C++23)  
template< [ranges::input_range](../../ranges/input_range.html) R1, [ranges::input_range](../../ranges/input_range.html) R2,  
class Pred = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to),  
class Proj1 = [std::identity](../../utility/functional/identity.html), class Proj2 = [std::identity](../../utility/functional/identity.html) >  
requires ([ranges::forward_range](../../ranges/forward_range.html)<R1> || [ranges::sized_range](../../ranges/sized_range.html)<R1>) &&  
([ranges::forward_range](../../ranges/forward_range.html)<R2> || [ranges::sized_range](../../ranges/sized_range.html)<R2>) &&  
[std::indirectly_comparable](../../iterator/indirectly_comparable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>,  
[ranges::iterator_t](../../ranges/iterator_t.html)<R2>,  
Pred, Proj1, Proj2>  
constexpr bool ends_with( R1&& r1, R2&& r2, Pred pred = {},  
Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (2) | (since C++23)  
| |   
  
Checks whether the second range matches the suffix of the first range. 

1) Let N1 be [ranges::distance](../../iterator/ranges/distance.html)(first1, last1) and N2 be [ranges::distance](../../iterator/ranges/distance.html)(first2, last2): 

  * If N1 < N2 is true, returns false. 
  * Otherwise, returns [ranges::equal](equal.html)(std::move(first1) + (N1 - N2), last1,  
std::move(first2), last2, pred, proj1, proj2).



2) Let N1 be [ranges::distance](../../iterator/ranges/distance.html)(r1) and N2 be [ranges::distance](../../iterator/ranges/distance.html)(r2). 

  * If N1 < N2 is true, returns false. 
  * Otherwise, returns [ranges::equal](equal.html)([views::drop](../../ranges/drop_view.html)([ranges::ref_view](../../ranges/ref_view.html)(r1),  
...
## Contents
  ...
  * [3 Complexity](ends_with.html#Complexity)
  * [4 Possible implementation](ends_with.html#Possible_implementation)
  * [5 Notes](ends_with.html#Notes)
  * [6 Example](ends_with.html#Example)
  * [7 Defect reports](ends_with.html#Defect_reports)
  * [8 See also](ends_with.html#See_also)
...
first2, last2  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to be used as the suffix   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/ends_with&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct ends_with_fn
    {
        ...
        {
            const auto n1 = [ranges::distance](../../iterator/ranges/distance.html)(first1, last1);
            const auto n2 = [ranges::distance](../../iterator/ranges/distance.html)(first2, last2);
            if (n1 < n2)
                return false;
            [ranges::advance](../../iterator/ranges/advance.html)(first1, n1 - n2);
            return [ranges::equal](equal.html)(std::move(first1), last1,
    ...
     
        ...
        constexpr bool operator()(R1&& r1, R2&& r2,
                                  Pred pred = {}, Proj1 proj1 = {}, Proj2 proj2 = {}) const
        {
            const auto n1 = [ranges::distance](../../iterator/ranges/distance.html)(r1);
            const auto n2 = [ranges::distance](../../iterator/ranges/distance.html)(r2);
            if (n1 < n2)
                return false;
            return [ranges::equal](equal.html)([views::drop](../../ranges/drop_view.html)([ranges::ref_view](../../ranges/ref_view.html)(r1),
                                             n1 - static_cast<decltype(n1)>(n2)),
                                 r2, pred, proj1, proj2);
        }
    };
...
Run this code
    ...
    (
        ...
        std::ranges::ends_with([std::array](../../container/array.html){1, 2, 3, 4}, [std::array](../../container/array.html){3, 4}) &&
        ! std::ranges::ends_with([std::array](../../container/array.html){1, 2, 3, 4}, [std::array](../../container/array.html){4, 5})
    );
     
    int main() {}
...
---|---|---|---  
[LWG 4105](https://cplusplus.github.io/LWG/issue4105) | C++23  | overload ([2](ends_with.html#Version_2)) calculated the size  
difference by N1 - N2[[1]](ends_with.html#cite_note-1) | changed to  
N1 - static_cast<decltype(N1)>(N2)  
  
  1. [↑](ends_with.html#cite_ref-1) Its result might be of an [integer-class type](../../iterator/is-integer-like.html "cpp/iterator/is-integer-like"), in this case ranges::drop_view cannot be constructed.
