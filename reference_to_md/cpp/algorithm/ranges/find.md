...
requires [std::indirect_binary_predicate](../../iterator/indirect_binary_predicate.html)  
<[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>, const T*>  
constexpr I find( I first, S last, const T& value, Proj proj = {} ); |  |  (since C++26)  
| (2) |   
...
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>, const T*>  
constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>  
find( R&& r, const T& value, Proj proj = {} ); |  |  (since C++26)  
template< [std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
constexpr I find_if( I first, S last, Pred pred, Proj proj = {} ); |  (3) | (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
...
class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Pred >  
constexpr I find_if_not( I first, S last, Pred pred, Proj proj = {} ); |  (5) | (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)  
<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Pred >  
constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>  
...
## Contents
  ...
  * [5 Notes](find.html#Notes)
  * [6 Example](find.html#Example)
  * [7 See also](find.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find&action=edit&section=2 "Edit section: Return value")] Return value

Iterator to the first element satisfying the condition or iterator equal to last if no such element is found. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find&action=edit&section=3 "Edit section: Complexity")] Complexity

At most last - first applications of the predicate and projection. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct find_fn
    {
        ...
        constexpr I operator()(I first, S last, const T& value, Proj proj = {}) const
        {
            for (; first != last; ++first)
                if ([std::invoke](../../utility/functional/invoke.html)(proj, *first) == value)
                    return first;
            return first;
        }
     
        ...
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), value, [std::ref](../../utility/functional/ref.html)(proj));
        }
    };
     
    inline constexpr find_fn find;  
  
[find_if (3)](find.html#Version_3)  
    ...
     
        ...
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), [std::ref](../../utility/functional/ref.html)(pred), [std::ref](../../utility/functional/ref.html)(proj));
        }
    };
     
    inline constexpr find_if_fn find_if;  
  
[find_if_not (5)](find.html#Version_5)  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    void projector_example()
    {
        ...
        {
            unsigned uid;
            [std::string](../../string/basic_string.html) name, position;
        };
     
        [std::vector](../../container/vector.html)<folk_info> folks
        {
            {0, "Ana", "dev"},
            {1, "Bob", "devops"},
            {2, "Eve", "ops"}
    ...
     
        ...
        if (auto it = std::ranges::find(folks, who, &folk_info::name); it != folks.end())
            [std::cout](../../io/cout.html) << [std::format](../../utility/format/format.html)("Profile:\n"
                                     "    UID: {}\n"
                                     "    Name: {}\n"
                                     "    Position: {}\n\n",
    ...
     
        if (ranges::find(v, n1) != v.end())
            [std::cout](../../io/cout.html) << "v contains: " << n1 << '\n';
        else
            [std::cout](../../io/cout.html) << "v does not contain: " << n1 << '\n';
     
        if (ranges::find(v.begin(), v.end(), n2) != v.end())
            [std::cout](../../io/cout.html) << "v contains: " << n2 << '\n';
        else
            [std::cout](../../io/cout.html) << "v does not contain: " << n2 << '\n';
     
        auto is_even = [](int x) { return x % 2 == 0; };
     
        if (auto result = ranges::find_if(v.begin(), v.end(), is_even); result != v.end())
            [std::cout](../../io/cout.html) << "First even element in v: " << *result << '\n';
        else
            [std::cout](../../io/cout.html) << "No even elements in v\n";
     
        if (auto result = ranges::find_if_not(v, is_even); result != v.end())
            [std::cout](../../io/cout.html) << "First odd element in v: " << *result << '\n';
        else
            [std::cout](../../io/cout.html) << "No odd elements in v\n";
     
        auto divides_13 = [](int x) { return x % 13 == 0; };
     
        if (auto result = ranges::find_if(v, divides_13); result != v.end())
            [std::cout](../../io/cout.html) << "First element divisible by 13 in v: " << *result << '\n';
        else
            [std::cout](../../io/cout.html) << "No elements in v are divisible by 13\n";
     
        if (auto result = ranges::find_if_not(v.begin(), v.end(), divides_13);
            result != v.end())
            [std::cout](../../io/cout.html) << "First element indivisible by 13 in v: " << *result << '\n';
        else
            [std::cout](../../io/cout.html) << "All elements in v are divisible by 13\n";
     
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<double>> nums{{4, 2}};
        #ifdef __cpp_lib_algorithm_default_value_type
            // T gets deduced in (2) making list-initialization possible
            const auto it = ranges::find(nums, {4, 2});
        #else
            const auto it = ranges::find(nums, [std::complex](../../numeric/complex.html)<double>{4, 2});
        #endif
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find&action=edit&section=7 "Edit section: See also")] See also
