...
---|---|---  
Call signature |  |   
template< [std::random_access_iterator](../../iterator/random_access_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
...
constexpr I  
partial_sort( I first, I middle, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [ranges::random_access_range](../../ranges/random_access_range.html) R,  
class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less), class Proj = [std::identity](../../utility/functional/identity.html) >  
...
partial_sort( R&& r, [ranges::iterator_t](../../ranges/iterator_t.html)<R> middle, Comp comp = {},  
...
The order of equal elements is _not_ guaranteed to be preserved. The order of the remaining elements in the range `[`middle`, `last`)` is _unspecified_.

The elements are compared using the given binary comparison function comp and projected using proj function object.

2) Same as (1), but uses r as the range, as if using [ranges::begin](../../ranges/begin.html)(r) as first and [ranges::end](../../ranges/end.html)(r) as last.
...
## Contents
  ...
  * [1 Parameters](partial_sort.html#Parameters)
  * [2 Return value](partial_sort.html#Return_value)
  * [3 Complexity](partial_sort.html#Complexity)
  * [4 Possible implementation](partial_sort.html#Possible_implementation)
  * [5 Example](partial_sort.html#Example)
  * [6 See also](partial_sort.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partial_sort&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to rearrange   
---|---|---  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partial_sort&action=edit&section=2 "Edit section: Return value")] Return value

An iterator equal to last. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partial_sort&action=edit&section=3 "Edit section: Complexity")] Complexity

\\(\scriptsize \mathcal{O}(N\cdot\log{(M)})\\)𝓞(N·log(M)) comparisons and twice as many projections, where \\(\scriptsize N\\)N is [ranges::distance](../../iterator/ranges/distance.html)(first, last), \\(\scriptsize M\\)M is [ranges::distance](../../iterator/ranges/distance.html)(first, middle). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partial_sort&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct partial_sort_fn
    {
        ...
        {
            if (first == middle)
                return [ranges::next](../../iterator/ranges/next.html)(first, last);
            [ranges::make_heap](make_heap.html)(first, middle, comp, proj);
            auto it {middle};
            for (; it != last; ++it)
            {
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *it), [std::invoke](../../utility/functional/invoke.html)(proj, *first)))
                {
                    [ranges::pop_heap](pop_heap.html)(first, middle, comp, proj);
                    [ranges::iter_swap](../../iterator/ranges/iter_swap.html)(middle - 1, it);
                    [ranges::push_heap](push_heap.html)(first, middle, comp, proj);
                }
            }
            [ranges::sort_heap](sort_heap.html)(first, middle, comp, proj);
            return it;
        }
     
        template<[ranges::random_access_range](../../ranges/random_access_range.html) R, class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less),
                 class Proj = [std::identity](../../utility/functional/identity.html)>
        requires [std::sortable](../../iterator/sortable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Comp, Proj>
        constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>
            operator()(R&& r, [ranges::iterator_t](../../ranges/iterator_t.html)<R> middle, Comp comp = {}, Proj proj = {}) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), std::move(middle), [ranges::end](../../ranges/end.html)(r),
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partial_sort&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        static_assert('A' < 'a');
        [std::vector](../../container/vector.html)<char> v {'x', 'P', 'y', 'C', 'z', 'w', 'P', 'o'};
        print(v);
        const int m {3};
    ...
     
        static_assert('1' < 'a');
        [std::string](../../string/basic_string.html) s {"3a1b41c5"};
        print(s);
        std::ranges::partial_sort(s.begin(), s.begin() + m, s.end(), [std::greater](../../utility/functional/greater.html) {});
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partial_sort&action=edit&section=6 "Edit section: See also")] See also
...
[ ranges::nth_element](nth_element.html "cpp/algorithm/ranges/nth element")(C++20) |  partially sorts the given range making sure that it is partitioned by the given element  
