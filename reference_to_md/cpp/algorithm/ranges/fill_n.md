...
---|---|---  
Call signature |  |   
template< class T, [std::output_iterator](../../iterator/output_iterator.html)<const T&> O >  
constexpr O fill_n( O first, [std::iter_difference_t](../../iterator/iter_t.html)<O> n, const T& value ); |  |  (since C++20)   
(until C++26)  
template< class O, class T = [std::iter_value_t](../../iterator/iter_t.html)<O> >  
requires [std::output_iterator](../../iterator/output_iterator.html)<O, const T&>  
constexpr O fill_n( O first, [std::iter_difference_t](../../iterator/iter_t.html)<O> n, const T& value ); |  |  (since C++26)  
| |   
...
## Contents
  ...
  * [1 Parameters](fill_n.html#Parameters)
  * [2 Return value](fill_n.html#Return_value)
  * [3 Complexity](fill_n.html#Complexity)
  * [4 Possible implementation](fill_n.html#Possible_implementation)
  * [5 Notes](fill_n.html#Notes)
  * [6 Example](fill_n.html#Example)
  * [7 See also](fill_n.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill_n&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill_n&action=edit&section=2 "Edit section: Return value")] Return value

An output iterator that compares equal to first + n. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly n assignments. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill_n&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct fill_n_fn
    {
        template<class O, class T = [std::iter_value_t](../../iterator/iter_t.html)<O>>
        requires [std::output_iterator](../../iterator/output_iterator.html)<O, const T&>
        constexpr O operator()(O first, [std::iter_difference_t](../../iterator/iter_t.html)<O> n, const T& value) const
        {
            for ([std::iter_difference_t](../../iterator/iter_t.html)<O> i {}; i != n; ++first, ++i)
                *first = value;
            return first;
        }
    };
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill_n&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill_n&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr auto n{8};
     
        [std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)> v(n, "▓▓░░");
        println(v);
     
    ...
     
        ...
        #else
            std::ranges::fill_n(nums.begin(), 2, [std::complex](../../numeric/complex.html)<double>{4, 2});
        #endif
        println(nums);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill_n&action=edit&section=7 "Edit section: See also")] See also
