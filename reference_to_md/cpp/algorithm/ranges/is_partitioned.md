...
constexpr bool  
is_partitioned( I first, S last, Pred pred, Proj proj = {} ); |  (1)  |  (since C++20)  
...
constexpr bool  
is_partitioned( R&& r, Pred pred, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](is_partitioned.html#Parameters)
  * [2 Return value](is_partitioned.html#Return_value)
  * [3 Complexity](is_partitioned.html#Complexity)
  * [4 Possible implementation](is_partitioned.html#Possible_implementation)
  * [5 Example](is_partitioned.html#Example)
  * [6 See also](is_partitioned.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_partitioned&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_partitioned&action=edit&section=2 "Edit section: Return value")] Return value

true if the range `[`first`, `last`)` is empty or is partitioned by pred, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_partitioned&action=edit&section=3 "Edit section: Complexity")] Complexity

At most [ranges::distance](../../iterator/ranges/distance.html)(first, last) applications of pred and proj. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_partitioned&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
     
        template<[ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Pred>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_partitioned&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::array](../../container/array.html)<int, 9> v;
     
        auto print = [&v](bool o)
        {
            for (int x : v)
                [std::cout](../../io/cout.html) << x << ' ';
            [std::cout](../../io/cout.html) << (o ? "=> " : "=> not ") << "partitioned\n";
        };
     
        auto is_even = [](int i) { return i % 2 == 0; };
     
        [std::iota](../iota.html)(v.begin(), v.end(), 1); // or std::ranges::iota(v, 1);
        print(std::ranges::is_partitioned(v, is_even));
     
        std::[ranges::partition](partition.html)(v, is_even);
        print(std::ranges::is_partitioned([std::as_const](../../utility/as_const.html)(v), is_even));
     
        std::[ranges::reverse](reverse.html)(v);
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_partitioned&action=edit&section=6 "Edit section: See also")] See also
