...
---|---|---  
Call signature |  |   
template< [std::bidirectional_iterator](../../iterator/bidirectional_iterator.html) I1, [std::sentinel_for](../../iterator/sentinel_for.html)<I1> S1,  
[std::bidirectional_iterator](../../iterator/bidirectional_iterator.html) I2 >  
requires [std::indirectly_movable](../../iterator/indirectly_movable.html)<I1, I2>  
constexpr move_backward_result<I1, I2>  
move_backward( I1 first, S1 last, I2 d_last ); |  (1)  |  (since C++20)  
template< [ranges::bidirectional_range](../../ranges/bidirectional_range.html) R, [std::bidirectional_iterator](../../iterator/bidirectional_iterator.html) I >  
requires [std::indirectly_movable](../../iterator/indirectly_movable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, I>  
constexpr move_backward_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, I>  
move_backward( R&& r, I d_last ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I, class O >  
using move_backward_result = [ranges::in_out_result](return_types/in_out_result.html)<I, O>; |  (3)  |  (since C++20)  
| |   
  
1) Moves the elements in the range, defined by `[`first`, `last`)`, to another range `[`d_last - N`, `d_last`)`, where N = [ranges::distance](../../iterator/ranges/distance.html)(first, last). The elements are moved in reverse order (the last element is moved first), but their relative order is preserved. The behavior is undefined if d_last is within `**(** first, last**]**`. In such a case, [ranges::move](move.html "cpp/algorithm/ranges/move") may be used instead.
...
The elements in the _moved-from_ range will still contain valid values of the appropriate type, but not necessarily the same values as before the move, as if using *(d_last - n) = [ranges::iter_move](../../iterator/ranges/iter_move.html)(last - n) for each integer `n`, where 0 ≤ n < N. 
...
## Contents
  ...
  * [1 Parameters](move_backward.html#Parameters)
  * [2 Return value](move_backward.html#Return_value)
  * [3 Complexity](move_backward.html#Complexity)
  * [4 Notes](move_backward.html#Notes)
  * [5 Possible implementation](move_backward.html#Possible_implementation)
  * [6 Example](move_backward.html#Example)
  * [7 See also](move_backward.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move_backward&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to move   
---|---|---  
r  |  \-  |  the range of the elements to move   
d_last  |  \-  |  the end of the destination range   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move_backward&action=edit&section=2 "Edit section: Return value")] Return value

{last, d_last - N}. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move_backward&action=edit&section=3 "Edit section: Complexity")] Complexity

1) Exactly N move assignments.

2) Exactly [ranges::distance](../../iterator/ranges/distance.html)(r) move assignments.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move_backward&action=edit&section=4 "Edit section: Notes")] Notes

When moving overlapping ranges, [ranges::move](move.html "cpp/algorithm/ranges/move") is appropriate when moving to the left (beginning of the destination range is outside the source range) while **ranges::move_backward** is appropriate when moving to the right (end of the destination range is outside the source range). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move_backward&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
    ...
    struct move_backward_fn
    {
        ...
        {
            auto i {last};
            for (; i != first; *--d_last = [ranges::iter_move](../../iterator/ranges/iter_move.html)(--i))
            {}
    ...
     
        template<[ranges::bidirectional_range](../../ranges/bidirectional_range.html) R, [std::bidirectional_iterator](../../iterator/bidirectional_iterator.html) I>
        requires [std::indirectly_movable](../../iterator/indirectly_movable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, I>
        constexpr ranges::move_backward_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, I>
            operator()(R&& r, I d_last) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), std::move(d_last));
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move_backward&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    #include <vector>
     
    using Vec = [std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)>;
     
    void print([std::string_view](../../string/basic_string_view.html) rem, Vec const& vec)
    {
        [std::cout](../../io/cout.html) << rem << "[" << vec.size() << "]: ";
        for (const [std::string](../../string/basic_string.html)& s : vec)
            [std::cout](../../io/cout.html) << (s.size() ? s : [std::string](../../string/basic_string.html){"·"}) << ' ';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move_backward&action=edit&section=7 "Edit section: See also")] See also
