...
---|---|---  
Call signature |  |   
template< [std::input_iterator](../../iterator/input_iterator.html) I, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirectly_unary_invocable](../../iterator/indirectly_unary_invocable.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Fun >  
constexpr for_each_n_result<I, Fun>  
for_each_n( I first, [std::iter_difference_t](../../iterator/iter_t.html)<I> n, Fun f, Proj proj = {}); |  (1)  |  (since C++20)  
Helper types |  |   
template< class I, class F >  
using for_each_n_result = [ranges::in_fun_result](return_types/in_fun_result.html)<I, F>; |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](for_each_n.html#Parameters)
  * [2 Return value](for_each_n.html#Return_value)
  * [3 Complexity](for_each_n.html#Complexity)
  * [4 Possible implementation](for_each_n.html#Possible_implementation)
  * [5 Example](for_each_n.html#Example)
  * [6 See also](for_each_n.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/for_each_n&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/for_each_n&action=edit&section=2 "Edit section: Return value")] Return value

An object {first + n, std::move(f)}, where first + n may be evaluated as std::[ranges::next](../../iterator/ranges/next.html)(std::move(first), n) depending on iterator category. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/for_each_n&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly n applications of f and proj. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/for_each_n&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct for_each_n_fn
    {
        template<[std::input_iterator](../../iterator/input_iterator.html) I, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirectly_unary_invocable](../../iterator/indirectly_unary_invocable.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Fun>
        constexpr for_each_n_result<I, Fun>
            operator()(I first, [std::iter_difference_t](../../iterator/iter_t.html)<I> n, Fun fun, Proj proj = Proj{}) const
        {
            for (; n-- > 0; ++first)
                [std::invoke](../../utility/functional/invoke.html)(fun, [std::invoke](../../utility/functional/invoke.html)(proj, *first));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/for_each_n&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    struct P
    {
        int first;
        char second;
        friend [std::ostream](../../io/basic_ostream.html)& operator<<([std::ostream](../../io/basic_ostream.html)& os, const P& p)
        {
            return os << '{' << p.first << ",'" << p.second << "'}";
        }
    };
     
    auto print = []([std::string_view](../../string/basic_string_view.html) name, auto const& v)
    {
        [std::cout](../../io/cout.html) << name << ": ";
        for (auto n = v.size(); const auto& e : v)
            [std::cout](../../io/cout.html) << e << (--n ? ", " : "\n");
    };
     
    int main()
    {
        ...
        print("a", a);
     
        [std::array](../../container/array.html) s { P{1,'a'}, P{2, 'b'}, P{3, 'c'}, P{4, 'd'} };
        print("s", s);
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/for_each_n&action=edit&section=6 "Edit section: See also")] See also
