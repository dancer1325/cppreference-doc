...
/*indirectly-binary-left-foldable*/<[std::iter_value_t](../../iterator/iter_t.html)<I>, I> F >  
requires [std::constructible_from](../../concepts/constructible_from.html)<  
[std::iter_value_t](../../iterator/iter_t.html)<I>, [std::iter_reference_t](../../iterator/iter_t.html)<I>>  
constexpr /* see description */  
fold_left_first_with_iter( I first, S last, F f ); |  (1)  |  (since C++23)  
template< [ranges::input_range](../../ranges/input_range.html) R,  
/*indirectly-binary-left-foldable*/<  
[ranges::range_value_t](../../ranges/range_size_t.html)<R>, [ranges::iterator_t](../../ranges/iterator_t.html)<R>> F >  
requires [std::constructible_from](../../concepts/constructible_from.html)<  
[ranges::range_value_t](../../ranges/range_size_t.html)<R>, [ranges::range_reference_t](../../ranges/range_reference_t.html)<R>>  
constexpr /* see description */  
fold_left_first_with_iter( R&& r, F f ); |  (2)  |  (since C++23)  
Helper concepts |  |   
template< class F, class T, class I >  
concept /*indirectly-binary-left-foldable*/ = /* see description */; |  (3)  |  (exposition only*)  
Helper class template |  |   
template< class I, class T >  
using fold_left_first_with_iter_result = [ranges::in_value_result](return_types/in_value_result.html)<I, T>; |  (4)  |  (since C++23)  
| |   
...
Informally, `ranges::fold_left_first_with_iter` behaves like [std::accumulate](../accumulate.html "cpp/algorithm/accumulate")'s overload that accepts a binary predicate, except that the *first is used internally as an initial element. 
...
4) The return type alias. See "[Return value](fold_left_first_with_iter.html#Return_value)" section for details.
...
## Contents
  ...
  * [1 Parameters](fold_left_first_with_iter.html#Parameters)
  * [2 Return value](fold_left_first_with_iter.html#Return_value)
  * [3 Possible implementations](fold_left_first_with_iter.html#Possible_implementations)
  * [4 Complexity](fold_left_first_with_iter.html#Complexity)
  * [5 Notes](fold_left_first_with_iter.html#Notes)
  * [6 Example](fold_left_first_with_iter.html#Example)
  * [7 References](fold_left_first_with_iter.html#References)
  * [8 See also](fold_left_first_with_iter.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first_with_iter&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first_with_iter&action=edit&section=2 "Edit section: Return value")] Return value

Let U be decltype([ranges::fold_left](fold_left.html)(std::move(first), last, [std::iter_value_t](../../iterator/iter_t.html)<I>(*first), f)). 

1) An object of type ranges::fold_left_first_with_iter_result<I, [std::optional](../../utility/optional.html)<U>>. 
...
If the range is empty, the return value is {std::move(first), [std::optional](../../utility/optional.html)<U>()}.

2) Same as (1) except that the return type is ranges::fold_left_first_with_iter_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, [std::optional](../../utility/optional.html)<U>>.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first_with_iter&action=edit&section=3 "Edit section: Possible implementations")] Possible implementations
    ...
    class fold_left_first_with_iter_fn
    {
        ...
        {
            using U = decltype(
                [ranges::fold_left](fold_left.html)(std::move(first), last, [std::iter_value_t](../../iterator/iter_t.html)<I>(*first), f)
            );
            using Ret = ranges::fold_left_first_with_iter_result<O, [std::optional](../../utility/optional.html)<U>>;
            if (first == last)
                return Ret{std::move(first), [std::optional](../../utility/optional.html)<U>()};
            [std::optional](../../utility/optional.html)<U> init([std::in_place](../../utility/in_place.html), *first);
            for (++first; first != last; ++first)
                *init = [std::invoke](../../utility/functional/invoke.html)(f, std::move(*init), *first);
    ...
    public:
        template<[std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,
                 /*indirectly-binary-left-foldable*/<[std::iter_value_t](../../iterator/iter_t.html)<I>, I> F>
        requires [std::constructible_from](../../concepts/constructible_from.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>, [std::iter_reference_t](../../iterator/iter_t.html)<I>>
        constexpr auto operator()(I first, S last, F f) const
        {
            return impl<I>(std::move(first), std::move(last), [std::ref](../../utility/functional/ref.html)(f));
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R, /*indirectly-binary-left-foldable*/<
            [ranges::range_value_t](../../ranges/range_size_t.html)<R>, [ranges::iterator_t](../../ranges/iterator_t.html)<R>> F>
        requires
            [std::constructible_from](../../concepts/constructible_from.html)<[ranges::range_value_t](../../ranges/range_size_t.html)<R>, [ranges::range_reference_t](../../ranges/range_reference_t.html)<R>>
        constexpr auto operator()(R&& r, F f) const
        {
            return impl<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>>(
                [ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), [std::ref](../../utility/functional/ref.html)(f)
            );
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first_with_iter&action=edit&section=4 "Edit section: Complexity")] Complexity

Exactly [ranges::distance](../../iterator/ranges/distance.html)(first, last) - 1 (assuming the range is not empty) applications of the function object f. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first_with_iter&action=edit&section=5 "Edit section: Notes")] Notes
...
[ranges::fold_left_with_iter](fold_left_with_iter.html) | left | init |  (1) [ranges::in_value_result](return_types/in_value_result.html)<I, U> (2) [ranges::in_value_result](return_types/in_value_result.html)<BR, U>, where BR is [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>  
ranges::fold_left_first_with_iter | left | first element |  (1) [ranges::in_value_result](return_types/in_value_result.html)<I, [std::optional](../../utility/optional.html)<U>> (2) [ranges::in_value_result](return_types/in_value_result.html)<BR, [std::optional](../../utility/optional.html)<U>> where BR is [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first_with_iter&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        (
            v.begin(), v.end(), [std::plus](../../utility/functional/plus.html)<int>()
        );
        [std::cout](../../io/cout.html) << "sum: " << sum.value.value() << '\n';
        [assert](../../error/assert.html)(sum.in == v.end());
     
        auto mul = std::ranges::fold_left_first_with_iter(v, [std::multiplies](../../utility/functional/multiplies.html)<int>());
        [std::cout](../../io/cout.html) << "mul: " << mul.value.value() << '\n';
        [assert](../../error/assert.html)(mul.in == v.end());
     
        // get the product of the std::pair::second of all pairs in the vector:
        [std::vector](../../container/vector.html)<[std::pair](../../utility/pair.html)<char, float>> data {{'A', 2.f}, {'B', 3.f}, {'C', 7.f}};
        auto sec = std::ranges::fold_left_first_with_iter
        (
            data | std::ranges::[views::values](../../ranges/values_view.html), [std::multiplies](../../utility/functional/multiplies.html)<>()
        );
        [std::cout](../../io/cout.html) << "sec: " << sec.value.value() << '\n';
     
        // use a program defined function object (lambda-expression):
        auto lambda = [](int x, int y) { return x + y + 2; };
        auto val = std::ranges::fold_left_first_with_iter(v, lambda);
        [std::cout](../../io/cout.html) << "val: " << val.value.value() << '\n';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first_with_iter&action=edit&section=7 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first_with_iter&action=edit&section=8 "Edit section: See also")] See also
