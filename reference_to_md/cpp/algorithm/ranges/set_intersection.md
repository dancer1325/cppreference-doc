...
O, Comp, Proj1, Proj2>  
constexpr set_intersection_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,  
...
using set_intersection_result = [ranges::in_in_out_result](return_types/in_in_out_result.html)<I1, I2, O>; |  (3)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [4 Possible implementation](set_intersection.html#Possible_implementation)
  * [5 Example](set_intersection.html#Example)
  * [6 See also](set_intersection.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_intersection&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_intersection&action=edit&section=2 "Edit section: Return value")] Return value

{last1, last2, result_last}, where result_last is the end of the constructed range. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_intersection&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_intersection&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct set_intersection_fn
    {
                       ...
                       Proj1 proj1 = {}, Proj2 proj2 = {}) const
        {
            ...
            return {[ranges::next](../../iterator/ranges/next.html)(std::move(first1), std::move(last1)),
                    [ranges::next](../../iterator/ranges/next.html)(std::move(first2), std::move(last2)),
                    std::move(result)};
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R1, [ranges::input_range](../../ranges/input_range.html) R2,
        ...
        requires [std::mergeable](../../iterator/mergeable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>, [ranges::iterator_t](../../ranges/iterator_t.html)<R2>,
                                O, Comp, Proj1, Proj2>
        constexpr ranges::set_intersection_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,
                                                  [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>, O>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_intersection&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::vector](../../container/vector.html)<int> out {};
     
        std::ranges::set_intersection(in1, in2, [std::back_inserter](../../iterator/back_inserter.html)(out));
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_intersection&action=edit&section=6 "Edit section: See also")] See also
