...
For `ranges::binary_search` to succeed, the range `[`first`, `last`)` must be at least partially ordered with respect to value, i.e. it must satisfy all of the following requirements: 
  ...
  * partitioned with respect to [std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, element), value) (that is, all projected elements for which the expression is true precedes all elements for which the expression is false). 
  * partitioned with respect to ![std::invoke](../../utility/functional/invoke.html)(comp, value, [std::invoke](../../utility/functional/invoke.html)(proj, element)). 
  * for all elements, if [std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, element), value) is true then ![std::invoke](../../utility/functional/invoke.html)(comp, value, [std::invoke](../../utility/functional/invoke.html)(proj, element)) is also true. 
...
## Contents
  ...
  * [1 Parameters](binary_search.html#Parameters)
  * [2 Return value](binary_search.html#Return_value)
  * [3 Complexity](binary_search.html#Complexity)
  * [4 Notes](binary_search.html#Notes)
  * [5 Possible implementation](binary_search.html#Possible_implementation)
  * [6 Example](binary_search.html#Example)
  * [7 See also](binary_search.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/binary_search&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
    ...
    struct binary_search_fn
    {
        ...
        {
            auto x = [ranges::lower_bound](lower_bound.html)(first, last, value, comp, proj);
            return (!(x == last) && !([std::invoke](../../utility/functional/invoke.html)(comp, value, [std::invoke](../../utility/functional/invoke.html)(proj, *x))));
        }
     
...
Run this code
    ...
    int main()
    {
        ...
        static_assert(std::[ranges::is_sorted](is_sorted.html)(haystack));
     
        for (const int needle : std::[views::iota](../../ranges/iota_view.html)(1)
                              | std::[views::take](../../ranges/take_view.html)(3))
        {
            [std::cout](../../io/cout.html) << "Searching for " << needle << ": ";
            std::ranges::binary_search(haystack, needle)
                ? [std::cout](../../io/cout.html) << "found " << needle << '\n'
                : [std::cout](../../io/cout.html) << "no dice!\n";
        }
     
        using CD = [std::complex](../../numeric/complex.html)<double>;
        [std::vector](../../container/vector.html)<CD> nums{{1, 1}, {2, 3}, {4, 2}, {4, 3}};
        auto cmpz = [](CD x, CD y){ return abs(x) < abs(y); };
        #ifdef __cpp_lib_algorithm_default_value_type
            [assert](../../error/assert.html)(std::ranges::binary_search(nums, {4, 2}, cmpz));
        #else
            [assert](../../error/assert.html)(std::ranges::binary_search(nums, CD{4, 2}, cmpz));
        #endif
    }
