...
template< [ranges::input_range](../../ranges/input_range.html) R1, [ranges::forward_range](../../ranges/forward_range.html) R2,  
class Pred = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to),  
class Proj1 = [std::identity](../../utility/functional/identity.html),  
class Proj2 = [std::identity](../../utility/functional/identity.html) >  
requires [std::indirectly_comparable](../../iterator/indirectly_comparable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>,  
[ranges::iterator_t](../../ranges/iterator_t.html)<R2>,  
Pred, Proj1, Proj2>  
constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>  
find_first_of( R1&& r1, R2&& r2, Pred pred = {},  
Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (2)  |  (since C++20)  
| |   
  
1) Searches the range `[`first1`, `last1`)` for _any_ of the elements in the range `[`first2`, `last2`)`, after projecting the ranges with proj1 and proj2 respectively. The projected elements are compared using the binary predicate pred.
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find_first_of&action=edit&section=1 "Edit section: Parameters")] Parameters
...
---|---|---  
first2, last2  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to search for (aka _needles_)   
r1  |  \-  |  the range of elements to examine (aka _haystack_)   
r2  |  \-  |  the range of elements to search for (aka _needles_)   
pred  |  \-  |  binary predicate to compare the elements   
proj1  |  \-  |  projection to apply to the elements in the first range   
proj2  |  \-  |  projection to apply to the elements in the second range   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find_first_of&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find_first_of&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find_first_of&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
                                ...
                                Proj1 proj1 = {}, Proj2 proj2 = {}) const
        {
            for (; first1 != last1; ++first1)
                for (auto i = first2; i != last2; ++i)
                    if ([std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj1, *first1), [std::invoke](../../utility/functional/invoke.html)(proj2, *i)))
                        return first1;
            return first1;
        }
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find_first_of&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        static_assert([std::distance](../../iterator/distance.html)(haystack.begin(), found1) == 2);
     
        constexpr auto found2 = rng::find_first_of(haystack, needles);
        static_assert([std::distance](../../iterator/distance.html)(haystack.begin(), found2) == 2);
     
    ...
     
        ...
        static_assert([std::distance](../../iterator/distance.html)(haystack.begin(), found3) == 2);
     
        struct P { int x, y; };
    ...
     
        ...
        [std::cout](../../io/cout.html) << "First equivalent element {" << found4->x << ", " << found4->y
                  << "} was found at position " << [std::distance](../../iterator/distance.html)(p1.begin(), found4)
                  << ".\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find_first_of&action=edit&section=6 "Edit section: See also")] See also
