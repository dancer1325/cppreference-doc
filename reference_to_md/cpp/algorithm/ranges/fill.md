...
Call signature |  |   
| (1) |   
template< class T, [std::output_iterator](../../iterator/output_iterator.html)<const T&> O, [std::sentinel_for](../../iterator/sentinel_for.html)<O> S >  
constexpr O fill( O first, S last, const T& value ); |  | (since C++20)   
(until C++26)  
template< class O, [std::sentinel_for](../../iterator/sentinel_for.html)<O> S, class T = [std::iter_value_t](../../iterator/iter_t.html)<O> >  
requires [std::output_iterator](../../iterator/output_iterator.html)<O, const T&>  
constexpr O fill( O first, S last, const T& value ); |  |  (since C++26)  
| (2) |   
template< class T, [ranges::output_range](../../ranges/output_range.html)<const T&> R >  
constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R> fill( R&& r, const T& value ); |  |  (since C++20)   
(until C++26)  
template< class R, class T = [ranges::range_value_t](../../ranges/range_size_t.html)<R> >  
requires [ranges::output_range](../../ranges/output_range.html)<R, const T&>  
constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R> fill( R&& r, const T& value ); |  |  (since C++26)  
| |   
...
## Contents
  ...
  * [1 Parameters](fill.html#Parameters)
  * [2 Return value](fill.html#Return_value)
  * [3 Complexity](fill.html#Complexity)
  * [4 Possible implementation](fill.html#Possible_implementation)
  * [5 Notes](fill.html#Notes)
  * [6 Example](fill.html#Example)
  * [7 See also](fill.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill&action=edit&section=2 "Edit section: Return value")] Return value

An output iterator that compares equal to last. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly last - first assignments. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill&action=edit&section=5 "Edit section: Notes")] Notes

[Feature-test](../../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_algorithm_default_value_type`](../../experimental/feature_test.html#cpp_lib_algorithm_default_value_type "cpp/feature test") | [`202403`](../../compiler_support/26.html#cpp_lib_algorithm_default_value_type_202403 "cpp/compiler support/26") | (C++26) | [List-initialization](../../language/list_initialization.html "cpp/language/list initialization") for algorithms ([1,2](fill.html#Version_1))  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        println(v);
     
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<double>> nums{{1, 3}, {2, 2}, {4, 8}};
        println(nums);
        #ifdef __cpp_lib_algorithm_default_value_type
            std::ranges::fill(nums, {4, 2}); // T gets deduced
        #else
            std::ranges::fill(nums, [std::complex](../../numeric/complex.html)<double>{4, 2});
        #endif
        println(nums);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fill&action=edit&section=7 "Edit section: See also")] See also
