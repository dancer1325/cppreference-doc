...
---|---|---  
Call signature |  |   
template< [std::random_access_iterator](../../iterator/random_access_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S, class Gen >  
...
I shuffle( I first, S last, Gen&& gen ); |  (1)  |  (since C++20)  
template< [ranges::random_access_range](../../ranges/random_access_range.html) R, class Gen >  
...
shuffle( R&& r, Gen&& gen ); |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [4 Possible implementation](shuffle.html#Possible_implementation)
  * [5 Example](shuffle.html#Example)
  * [6 See also](shuffle.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/shuffle&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to shuffle randomly   
---|---|---  
r  |  \-  |  the range of elements to shuffle randomly   
gen  |  \-  |  the random number generator   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/shuffle&action=edit&section=2 "Edit section: Return value")] Return value

An iterator equal to last. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/shuffle&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly (last - first) - 1 swaps. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/shuffle&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct shuffle_fn
    {
        ...
        I operator()(I first, S last, Gen&& gen) const
        {
            ...
            using distr_t = [std::uniform_int_distribution](../../numeric/random/uniform_int_distribution.html)<diff_t>;
            using param_t = typename distr_t::param_type;
            distr_t D;
            const auto n {last - first};
            for (diff_t i {1}; i < n; ++i)
                [ranges::iter_swap](../../iterator/ranges/iter_swap.html)(first + i, first + D(gen, param_t(0, i)));
    ...
     
        ...
        requires [std::permutable](../../iterator/permutable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>> &&
                 [std::uniform_random_bit_generator](../../numeric/random/UniformRandomBitGenerator.html)<[std::remove_reference_t](../../types/remove_reference.html)<Gen>>
        [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R> operator()(R&& r, Gen&& gen) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), [std::forward](../../utility/forward.html)<Gen>(gen));
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/shuffle&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::array](../../container/array.html) a {'A', 'B', 'C', 'D', 'E', 'F'};
        print(a);
     
        [std::random_device](../../numeric/random/random_device.html) rd;
        [std::mt19937](../../numeric/random/mersenne_twister_engine.html) gen {rd()};
     
        for (int i {}; i != 3; ++i)
        {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/shuffle&action=edit&section=6 "Edit section: See also")] See also
