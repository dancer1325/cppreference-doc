...
[std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)  
<const T*, std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr [ranges::subrange](../../ranges/subrange.html)<I> equal_range( I first, S last, const T& value,  
Comp comp = {}, Proj proj = {} ); |  | (since C++20)   
(until C++26)  
template< [std::forward_iterator](../../iterator/forward_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
...
<const T*, std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr [ranges::subrange](../../ranges/subrange.html)<I> equal_range( I first, S last, const T& value,  
Comp comp = {}, Proj proj = {} ); |  |  (since C++26)  
| (2) |   
template< [ranges::forward_range](../../ranges/forward_range.html) R,  
class T, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)  
<const T*, std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>,  
Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
...
Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr [ranges::borrowed_subrange_t](../../ranges/borrowed_iterator_t.html)<R>  
equal_range( R&& r, const T& value, Comp comp = {}, Proj proj = {} ); |  |  (since C++26)  
| |   
...
The returned view is constructed from two iterators, one pointing to the first element that is _not less_ than value and another pointing to the first element _greater_ than value. The first iterator may be alternatively obtained with std::ranges::lower_bound(), the second - with std::ranges::upper_bound(). 

2) Same as (1), but uses r as the source range, as if using the range [ranges::begin](../../ranges/begin.html)(r) as first and [ranges::end](../../ranges/end.html)(r) as last.
...
## Contents
  ...
  * [4 Possible implementation](equal_range.html#Possible_implementation)
  * [5 Notes](equal_range.html#Notes)
  * [6 Example](equal_range.html#Example)
  * [7 See also](equal_range.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/equal_range&action=edit&section=1 "Edit section: Parameters")] Parameters
...
comp  |  \-  |  if the first argument is _less_ than (i.e. is ordered before) the second   
proj  |  \-  |  projection to apply to the elements   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/equal_range&action=edit&section=2 "Edit section: Return value")] Return value

[std::ranges::subrange](../../ranges/subrange.html "cpp/ranges/subrange") containing a pair of iterators defining the wanted range, the first pointing to the first element that is _not less_ than value and the second pointing to the first element _greater_ than value. 

If there are no elements _not less_ than value, the last iterator (iterator that is equal to last or [ranges::end](../../ranges/end.html)(r)) is returned as the first element. Similarly if there are no elements _greater_ than value, the last iterator is returned as the second element. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/equal_range&action=edit&section=3 "Edit section: Complexity")] Complexity

The number of comparisons performed is logarithmic in the distance between first and last (at most 2 * log2(last - first) + O(1) comparisons). However, for an iterator that does not model [`random_access_iterator`](../../iterator/random_access_iterator.html "cpp/iterator/random access iterator"), the number of iterator increments is linear. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/equal_range&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct equal_range_fn
    {
        ...
        {
            return [ranges::subrange](../../ranges/subrange.html)
            (
                [ranges::lower_bound](lower_bound.html)(first, last, value, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj)),
                [ranges::upper_bound](upper_bound.html)(first, last, value, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj))
            );
        }
     
            ...
            operator()(R&& r, const T& value, Comp comp = {}, Proj proj = {}) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), value,
                           [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/equal_range&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/equal_range&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    struct S
    {
        ...
        friend [std::ostream](../../io/basic_ostream.html)& operator<<([std::ostream](../../io/basic_ostream.html)& os, S o)
        {
    ...
    int main()
    {
        ...
        [std::vector](../../container/vector.html)<S> vec
        {
    ...
     
        ...
        println("2. ", b);
     
        auto c = ranges::equal_range(vec, 'D', [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) {}, &S::name);
        println("3. ", c);
     
        auto d = ranges::equal_range(vec.begin(), vec.end(), 'D', [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) {}, &S::name);
        println("4. ", d);
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/equal_range&action=edit&section=7 "Edit section: See also")] See also
