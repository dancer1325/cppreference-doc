...
/* indirectly-binary-left-foldable */<T, I> F >  
constexpr auto fold_left( I first, S last, T init, F f ); |  |  (since C++26)  
| (2) |   
...
/* indirectly-binary-left-foldable */  
<T, [ranges::iterator_t](../../ranges/iterator_t.html)<R>> F >  
constexpr auto fold_left( R&& r, T init, F f ); |  |  (since C++26)  
Helper concepts |  |   
...
Informally, `ranges::fold_left` behaves like [std::accumulate](../accumulate.html "cpp/algorithm/accumulate")'s overload that accepts a binary predicate. 

The behavior is undefined if `[`first`, `last`)` is not a valid range. 

1) The range is `[`first`, `last`)`. Equivalent to return [ranges::fold_left_with_iter](fold_left_with_iter.html)(std::move(first), last, std::move(init), f).value.
...
## Contents
  ...
  * [1 Parameters](fold_left.html#Parameters)
  * [2 Return value](fold_left.html#Return_value)
  * [3 Possible implementations](fold_left.html#Possible_implementations)
  * [4 Complexity](fold_left.html#Complexity)
  * [5 Notes](fold_left.html#Notes)
  * [6 Example](fold_left.html#Example)
  * [7 References](fold_left.html#References)
  * [8 See also](fold_left.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left&action=edit&section=2 "Edit section: Return value")] Return value

An object of type U that contains the result of left-[fold](https://en.wikipedia.org/wiki/Fold_\(higher-order_function\) "enwiki:Fold \(higher-order function\)") of the given range over f, where U is equivalent to [std::decay_t](../../types/decay.html)<[std::invoke_result_t](../../types/result_of.html)<F&, T, [std::iter_reference_t](../../iterator/iter_t.html)<I>>>. 

If the range is empty, U(std::move(init)) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left&action=edit&section=3 "Edit section: Possible implementations")] Possible implementations
    ...
     
        ...
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), std::move(init), [std::ref](../../utility/functional/ref.html)(f));
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left&action=edit&section=4 "Edit section: Complexity")] Complexity

Exactly [ranges::distance](../../iterator/ranges/distance.html)(first, last) applications of the function object f. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left&action=edit&section=5 "Edit section: Notes")] Notes
...
[`__cpp_lib_algorithm_default_value_type`](../../experimental/feature_test.html#cpp_lib_algorithm_default_value_type "cpp/feature test") | [`202403L`](../../compiler_support/26.html#cpp_lib_algorithm_default_value_type_202403L "cpp/compiler support/26") | (C++26) | [List-initialization](../../language/list_initialization.html "cpp/language/list initialization") for algorithms ([1,2](fold_left.html#Version_1))  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        int sum = ranges::fold_left(v.begin(), v.end(), 0, [std::plus](../../utility/functional/plus.html)<int>()); // (1)
        [std::cout](../../io/cout.html) << "sum: " << sum << '\n';
     
        int mul = ranges::fold_left(v, 1, [std::multiplies](../../utility/functional/multiplies.html)<int>()); // (2)
        [std::cout](../../io/cout.html) << "mul: " << mul << '\n';
     
        ...
        [std::cout](../../io/cout.html) << "sec: " << sec << '\n';
     
        // use a program defined function object (lambda-expression):
        [std::string](../../string/basic_string.html) str = ranges::fold_left
        (
            v, "A", []([std::string](../../string/basic_string.html) s, int x) { return s + ':' + [std::to_string](../../string/basic_string/to_string.html)(x); }
        );
        [std::cout](../../io/cout.html) << "str: " << str << '\n';
     
        using CD = [std::complex](../../numeric/complex.html)<double>;
        [std::vector](../../container/vector.html)<CD> nums{{1, 1}, {2, 0}, {3, 0}};
        #ifdef __cpp_lib_algorithm_default_value_type
            auto res = ranges::fold_left(nums, {7, 0}, [std::multiplies](../../utility/functional/multiplies.html){}); // (2)
        #else
            auto res = ranges::fold_left(nums, CD{7, 0}, [std::multiplies](../../utility/functional/multiplies.html){}); // (2)
        #endif
        [std::cout](../../io/cout.html) << "res: " << res << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left&action=edit&section=7 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left&action=edit&section=8 "Edit section: See also")] See also
