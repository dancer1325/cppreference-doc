...
O, Comp, Proj1, Proj2>  
constexpr set_difference_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>, O>  
set_difference( R1&& r1, R2&& r2, O result, Comp comp = {},  
Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I, class O >  
using set_difference_result = [ranges::in_out_result](return_types/in_out_result.html)<I, O>; |  (3)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](set_difference.html#Parameters)
  * [2 Return value](set_difference.html#Return_value)
  * [3 Complexity](set_difference.html#Complexity)
  * [4 Possible implementation](set_difference.html#Possible_implementation)
  * [5 Example](set_difference.html#Example)
  * [6 See also](set_difference.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_difference&action=edit&section=1 "Edit section: Parameters")] Parameters

first1, last1  |  \-  |  the iterator-sentinel pair defining the first sorted input [range](../../iterator.html#Ranges "cpp/iterator") of elements   
---|---|---  
first2, last2  |  \-  |  the iterator-sentinel pair defining the second sorted input [range](../../iterator.html#Ranges "cpp/iterator") of elements   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_difference&action=edit&section=2 "Edit section: Return value")] Return value

{last1, result_last}, where result_last is the end of the constructed range. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_difference&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_difference&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct set_difference_fn
    {
                       ...
                       Proj1 proj1 = {}, Proj2 proj2 = {}) const
        {
            ...
            {
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj1, *first1), [std::invoke](../../utility/functional/invoke.html)(proj2, *first2)))
                {
                    *result = *first1;
                    ++first1;
                    ++result;
            ...
            return [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(std::move(first1), std::move(last1), std::move(result));
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R1, [ranges::input_range](../../ranges/input_range.html) R2,
                 [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O, class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less),
        ...
        requires [std::mergeable](../../iterator/mergeable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>, [ranges::iterator_t](../../ranges/iterator_t.html)<R2>,
                                O, Comp, Proj1, Proj2>
        constexpr ranges::set_difference_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>, O>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_difference&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    #include <vector>
     
    auto print = [](const auto& v, [std::string_view](../../string/basic_string_view.html) end = "")
    {
        [std::cout](../../io/cout.html) << "{ ";
        for (auto n{v.size()}; auto i : v)
            [std::cout](../../io/cout.html) << i << (--n ? ", " : " ");
    ...
    struct Order // a struct with some very interesting data
    {
        int order_id{};
     
        friend [std::ostream](../../io/basic_ostream.html)& operator<<([std::ostream](../../io/basic_ostream.html)& os, const Order& ord)
        {
    ...
    int main()
    {
        ...
        const auto v2 = {2, 5, 7};
        [std::vector](../../container/vector.html)<int> diff{};
     
        std::ranges::set_difference(v1, v2, [std::back_inserter](../../iterator/back_inserter.html)(diff));
        print(v1, "∖ ");
        print(v2, "= ");
        print(diff, "\n\n");
     
        // We want to know which orders "cut" between old and new states:
        const [std::vector](../../container/vector.html)<Order> old_orders{{1}, {2}, {5}, {9}};
        const [std::vector](../../container/vector.html)<Order> new_orders{{2}, {5}, {7}};
        [std::vector](../../container/vector.html)<Order> cut_orders(old_orders.size() + new_orders.size());
     
        auto [old_orders_end, cut_orders_last] =
            std::ranges::set_difference(old_orders, new_orders,
                                        cut_orders.begin(), {},
                                        &Order::order_id, &Order::order_id);
        [assert](../../error/assert.html)(old_orders_end == old_orders.end());
     
        [std::cout](../../io/cout.html) << "old orders = ";
        print(old_orders, "\n");
        [std::cout](../../io/cout.html) << "new orders = ";
        print(new_orders, "\n");
        [std::cout](../../io/cout.html) << "cut orders = ";
        print(cut_orders, "\n");
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_difference&action=edit&section=6 "Edit section: See also")] See also
