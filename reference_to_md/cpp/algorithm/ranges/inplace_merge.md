...
Comp comp = {}, Proj proj = {} ); |  (1) | (since C++20)   
...
inplace_merge( R&& r, [ranges::iterator_t](../../ranges/iterator_t.html)<R> middle,  
Comp comp = {}, Proj proj = {} ); |  (2) | (since C++20)   
(constexpr since C++26)  
| |   
  
Merges two consecutive _sorted_ ranges `[`first`, `middle`)` and `[`middle`, `last`)` into one _sorted_ range `[`first`, `last`)`. 

A sequence is said to be _sorted_ with respect to the comparator comp and projection proj if for any iterator `it` pointing to the sequence and any non-negative integer `n` such that `it + n` is a valid iterator pointing to an element of the sequence, [std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *(it + n)), [std::invoke](../../utility/functional/invoke.html)(proj, *it))) evaluates to false. 

This merge function is _stable_ , which means that for equivalent elements in the original two ranges, the elements from the first range (preserving their original order) precede the elements from the second range (preserving their original order). 
...
## Contents
  ...
  * [1 Parameters](inplace_merge.html#Parameters)
  * [2 Return value](inplace_merge.html#Return_value)
  * [3 Complexity](inplace_merge.html#Complexity)
  * [4 Notes](inplace_merge.html#Notes)
  * [5 Possible implementation](inplace_merge.html#Possible_implementation)
  * [6 Example](inplace_merge.html#Example)
  * [7 See also](inplace_merge.html#See_also)
...
This implementation only shows the slower algorithm used when no additional memory is available. See also the implementation in [MSVC STL](https://github.com/microsoft/STL/blob/e745bad3b1d05b5b19ec652d68abb37865ffa454/stl/inc/algorithm#L7131-L7235) and [libstdc++](https://github.com/gcc-mirror/gcc/blob/54258e22b0846aaa6bd3265f592feb161eecda75/libstdc%2B%2B-v3/include/bits/ranges_algo.h#L2573-L2602). 
    ...
    struct inplace_merge_fn
    {
        ...
        {
            I last_it = [ranges::next](../../iterator/ranges/next.html)(middle, last);
            inplace_merge_slow(first, middle, last_it,
                               [ranges::distance](../../iterator/ranges/distance.html)(first, middle),
                               [ranges::distance](../../iterator/ranges/distance.html)(middle, last_it),
    ...
     
        ...
        constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>
            operator()(R&& r, [ranges::iterator_t](../../ranges/iterator_t.html)<R> middle,
    ...
    private:
        ...
        static constexpr void inplace_merge_slow(I first, I middle, I last,
                                                 [std::iter_difference_t](../../iterator/iter_t.html)<I> n1,
                                                 [std::iter_difference_t](../../iterator/iter_t.html)<I> n2,
                                                 Comp comp, Proj proj)
        {
            if (n1 == 0 || n2 == 0)
                return;
            ...
            {
                [ranges::iter_swap](../../iterator/ranges/iter_swap.html)(first, middle);
                return;
            }
     
            I cut1 = first, cut2 = middle;
            [std::iter_difference_t](../../iterator/iter_t.html)<I> d1{}, d2{};
     
            if (n1 > n2)
            {
                d1 = n1 / 2;
                [ranges::advance](../../iterator/ranges/advance.html)(cut1, d1);
                cut2 = [ranges::lower_bound](lower_bound.html)(middle, last, *cut1,
                                           [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
                d2 = [ranges::distance](../../iterator/ranges/distance.html)(middle, cut2);
            }
            else
            {
                d2 = n2 / 2;
                [ranges::advance](../../iterator/ranges/advance.html)(cut2, d2);
                cut1 = [ranges::upper_bound](upper_bound.html)(first, middle, *cut2,
                                           [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
                d1 = [ranges::distance](../../iterator/ranges/distance.html)(first, cut1);
            }
     
            I new_middle = [ranges::rotate](rotate.html)(cut1, middle, cut2);
...
Run this code
    ...
    {
        for (int i{}; auto n : v)
            [std::cout](../../io/cout.html) << (i++ == middle ? "│ " : "") << n << ' ';
    ...
    requires [std::sortable](../../iterator/sortable.html)<I>
    ...
    int main()
    {
        ...
        [std::vector](../../container/vector.html) v{8, 2, 0, 4, 9, 8, 1, 7, 3};
        print(v, ": before sort");
    ...
     
        ...
        [std::vector](../../container/vector.html)<CI> r{{0,1}, {0,2}, {0,3}, {1,1}, {1,2}};
        const auto middle{std::[ranges::next](../../iterator/ranges/next.html)(r.begin(), 3)};
        auto comp{std::[ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less){}};
