...
**contains contains_subrange**(C++23)(C++23)  
...
constexpr bool contains( I first, S last, const T& value, Proj proj = {} ); |  | (since C++23)   
(until C++26)  
template< [std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
requires [std::indirect_binary_predicate](../../iterator/indirect_binary_predicate.html)  
<[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>, const T*>  
constexpr bool contains( I first, S last, const T& value, Proj proj = {} ); |  |  (since C++26)  
| (2) |   
...
constexpr bool contains( R&& r, const T& value, Proj proj = {} ); |  | (since C++23)   
(until C++26)  
template< [ranges::input_range](../../ranges/input_range.html) R,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
<[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to),  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>, const T*>  
constexpr bool contains( R&& r, const T& value, Proj proj = {} ); |  |  (since C++26)  
...
class Pred = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to),  
class Proj1 = [std::identity](../../utility/functional/identity.html), class Proj2 = [std::identity](../../utility/functional/identity.html) >  
requires [std::indirectly_comparable](../../iterator/indirectly_comparable.html)  
<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>, [ranges::iterator_t](../../ranges/iterator_t.html)<R2>,  
Pred, Proj1, Proj2>  
...
2) The source range is `[`[ranges::begin](../../ranges/begin.html)(r)`, `[ranges::end](../../ranges/end.html)(r)`)`.
...
4) The first source range is `[`[ranges::begin](../../ranges/begin.html)(r1)`, `[ranges::end](../../ranges/end.html)(r1)`)`, and the second source range is `[`[ranges::begin](../../ranges/begin.html)(r2)`, `[ranges::end](../../ranges/end.html)(r2)`)`.
...
## Contents
  ...
  * [4 Notes](contains.html#Notes)
  * [5 Possible implementation](contains.html#Possible_implementation)
  * [6 Example](contains.html#Example)
  * [7 See also](contains.html#See_also)
...
2) [ranges::find](find.html)(std::move([ranges::begin](../../ranges/begin.html)(r)), [ranges::end](../../ranges/end.html)(r), value, proj) != [ranges::end](../../ranges/end.html)(r)

3) first2 == last2 || ![ranges::search](search.html)(first1, last1, first2, last2, pred, proj1, proj2).empty()

4) [ranges::begin](../../ranges/begin.html)(r2) == [ranges::end](../../ranges/end.html)(r2) ||  
...
2) At most [ranges::distance](../../iterator/ranges/distance.html)(r) comparisons.

3) At most [ranges::distance](../../iterator/ranges/distance.html)(first1, last1) * [ranges::distance](../../iterator/ranges/distance.html)(first2, last2) comparisons.
...
`ranges::contains_subrange`, like [ranges::search](search.html "cpp/algorithm/ranges/search"), and unlike [std::search](../search.html "cpp/algorithm/search"), has no support for [searchers](../../functional.html#Searchers "cpp/utility/functional") (such as [std::boyer_moore_searcher](../../utility/functional/boyer_moore_searcher.html "cpp/utility/functional/boyer moore searcher")). 
...
---  
    ...
    struct __contains_fn
    {
        template<[std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,
                 class Proj = [std::identity](../../utility/functional/identity.html),
                 class T = std::projected_value_t<I, Proj>>
        requires [std::indirect_binary_predicate](../../iterator/indirect_binary_predicate.html)<[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>,
                                                const T*>
        constexpr bool operator()(I first, S last, const T& value, Proj proj = {}) const
        {
            return [ranges::find](find.html)(std::move(first), last, value, proj) != last;
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R,
                 class Proj = [std::identity](../../utility/functional/identity.html),
                 class T = std::projected_value_t<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>>
        requires [std::indirect_binary_predicate](../../iterator/indirect_binary_predicate.html)<[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to),
                                                std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>,
                                                const T*>
        constexpr bool operator()(R&& r, const T& value, Proj proj = {}) const
        {
            return [ranges::find](find.html)(std::move([ranges::begin](../../ranges/begin.html)(r)),
                                [ranges::end](../../ranges/end.html)(r), value, proj) != [ranges::end](../../ranges/end.html)(r);
        }
    };
     
    inline constexpr __contains_fn contains{};  
  
[contains_subrange (3,4)](contains.html#Version_3)  
    ...
    struct __contains_subrange_fn
    {
        ...
        {
            return (first2 == last2) ||
                       ![ranges::search](search.html)(first1, last1, first2, last2,
    ...
     
        template<[ranges::forward_range](../../ranges/forward_range.html) R1, [ranges::forward_range](../../ranges/forward_range.html) R2,
                 class Pred = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to),
                 class Proj1 = [std::identity](../../utility/functional/identity.html), class Proj2 = [std::identity](../../utility/functional/identity.html)>
        requires [std::indirectly_comparable](../../iterator/indirectly_comparable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>,
                                            [ranges::iterator_t](../../ranges/iterator_t.html)<R2>, Pred, Proj1, Proj2>
...
Run this code
    ...
    int main()
    {
        constexpr auto haystack = [std::array](../../container/array.html){3, 1, 4, 1, 5};
        constexpr auto needle = [std::array](../../container/array.html){1, 4, 1};
        constexpr auto bodkin = [std::array](../../container/array.html){2, 5, 2};
     
        static_assert
        (
    ...
     
        constexpr [std::array](../../container/array.html)<[std::complex](../../numeric/complex.html)<double>, 3> nums{{{1, 2}, {3, 4}, {5, 6}}};
        #ifdef __cpp_lib_algorithm_default_value_type
            static_assert(ranges::contains(nums, {3, 4}));
        #else
            static_assert(ranges::contains(nums, [std::complex](../../numeric/complex.html)<double>{3, 4}));
        #endif
    }
