...
[std::weakly_incrementable](../../iterator/weakly_incrementable.html) O, class Gen >  
requires ([std::forward_iterator](../../iterator/forward_iterator.html)<I> || [std::random_access_iterator](../../iterator/random_access_iterator.html)<O>) &&  
[std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O> &&  
[std::uniform_random_bit_generator](../../numeric/random/UniformRandomBitGenerator.html)<[std::remove_reference_t](../../types/remove_reference.html)<Gen>>  
O sample( I first, S last, O out, [std::iter_difference_t](../../iterator/iter_t.html)<I> n, Gen&& gen ); |  (1)  |  (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O, class Gen >  
requires ([ranges::forward_range](../../ranges/forward_range.html)<R> || [std::random_access_iterator](../../iterator/random_access_iterator.html)<O>) &&  
[std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O> &&  
[std::uniform_random_bit_generator](../../numeric/random/UniformRandomBitGenerator.html)<[std::remove_reference_t](../../types/remove_reference.html)<Gen>>  
O sample( R&& r, O out, [ranges::range_difference_t](../../ranges/range_size_t.html)<R> n, Gen&& gen ); |  (2)  |  (since C++20)  
| |   
  
1) Selects M = min(n, last - first) elements from the sequence `[`first`, `last`)` (without replacement) such that each possible _sample_ has equal probability of appearance, and writes those selected elements into the range beginning at out.

The algorithm is _stable_ (preserves the relative order of the selected elements) only if `I` models [std::forward_iterator](../../iterator/forward_iterator.html).
...
## Contents
  ...
  * [5 Possible implementation](sample.html#Possible_implementation)
  * [6 Example](sample.html#Example)
  * [7 See also](sample.html#See_also)
...
---|---|---  
r  |  \-  |  the range from which to make the sampling (_the population_)   
...
### Possible implementation
    ...
    struct sample_fn
    {
        template<[std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,
                 [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O, class Gen>
        requires ([std::forward_iterator](../../iterator/forward_iterator.html)<I> or
                  [std::random_access_iterator](../../iterator/random_access_iterator.html)<O>) &&
                  [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O> &&
                  [std::uniform_random_bit_generator](../../numeric/random/UniformRandomBitGenerator.html)<[std::remove_reference_t](../../types/remove_reference.html)<Gen>>
        O operator()(I first, S last, O out, [std::iter_difference_t](../../iterator/iter_t.html)<I> n, Gen&& gen) const
        {
            using diff_t = [std::iter_difference_t](../../iterator/iter_t.html)<I>;
            using distrib_t = [std::uniform_int_distribution](../../numeric/random/uniform_int_distribution.html)<diff_t>;
            using param_t = typename distrib_t::param_type;
            distrib_t D{};
     
            if constexpr ([std::forward_iterator](../../iterator/forward_iterator.html)<I>)
            {
                // this branch preserves "stability" of the sample elements
                auto rest{[ranges::distance](../../iterator/ranges/distance.html)(first, last)};
                for (n = [ranges::min](min.html)(n, rest); n != 0; ++first)
    ...
     
        template<[ranges::input_range](../../ranges/input_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O, class Gen>
        requires ([ranges::forward_range](../../ranges/forward_range.html)<R> or [std::random_access_iterator](../../iterator/random_access_iterator.html)<O>) &&
                  [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O> &&
                  [std::uniform_random_bit_generator](../../numeric/random/UniformRandomBitGenerator.html)<[std::remove_reference_t](../../types/remove_reference.html)<Gen>>
        O operator()(R&& r, O out, [ranges::range_difference_t](../../ranges/range_size_t.html)<R> n, Gen&& gen) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), std::move(out), n,
                           [std::forward](../../utility/forward.html)<Gen>(gen));
        }
    };
     
...
Run this code
    ...
    {
        [std::cout](../../io/cout.html) << rem << " = [" << [std::size](../../iterator/size.html)(v) << "] { ";
        for (auto const& e : v)
    ...
     
        ...
        auto gen = [std::mt19937](../../numeric/random/mersenne_twister_engine.html){[std::random_device](../../numeric/random/random_device.html){}()};
     
        for (int n{}; n != max; ++n)
        {
            out.clear();
            std::ranges::sample(in, [std::back_inserter](../../iterator/back_inserter.html)(out), n, gen);
