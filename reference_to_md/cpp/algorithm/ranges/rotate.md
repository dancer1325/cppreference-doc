...
rotate( I first, I middle, S last ); |  (1)  |  (since C++20)  
...
rotate( R&& r, [ranges::iterator_t](../../ranges/iterator_t.html)<R> middle ); |  (2)  |  (since C++20)  
| |   
  
1) Performs a _left rotation_ on a range of elements. Specifically, `ranges::rotate` swaps the elements in the range `[`first`, `last`)` in such a way that the element *middle becomes the first element of the new range and *(middle - 1) becomes the last element.
...
## Contents
  ...
  * [4 Notes](rotate.html#Notes)
  * [5 Possible implementation](rotate.html#Possible_implementation)
  * [6 Example](rotate.html#Example)
  * [7 See also](rotate.html#See_also)
...
See also the implementations in [libstdc++](https://github.com/gcc-mirror/gcc/blob/14d8a5ae472ca5743016f37da2dd4770d83dea21/libstdc%2B%2B-v3/include/bits/ranges_algo.h#L1361-L1506) and [MSVC STL](https://github.com/microsoft/STL/blob/472161105d596192194d4715ccad307c6c163b4a/stl/inc/algorithm#L4407-L4434). 
    ...
    struct rotate_fn
    {
            ...
            operator()(I first, I middle, S last) const
        {
            if (first == middle)
            {
                auto last_it = [ranges::next](../../iterator/ranges/next.html)(first, last);
                return {last_it, last_it};
            }
            if (middle == last)
                return {std::move(first), std::move(middle)};
     
            if constexpr ([std::bidirectional_iterator](../../iterator/bidirectional_iterator.html)<I>)
            {
                [ranges::reverse](reverse.html)(first, middle);
                auto last_it = [ranges::next](../../iterator/ranges/next.html)(first, last);
                [ranges::reverse](reverse.html)(middle, last_it);
     
                if constexpr ([std::random_access_iterator](../../iterator/random_access_iterator.html)<I>)
                {
                    [ranges::reverse](reverse.html)(first, last_it);
                ...
                else
                {
                    ...
                    do
                    {
                        [ranges::iter_swap](../../iterator/ranges/iter_swap.html)(first, --mid_last);
                        ++first;
                    }
                    while (first != middle && mid_last != middle);
                    [ranges::reverse](reverse.html)(first, mid_last);
     
                    if (first == middle)
            ...
            { // I is merely a forward_iterator
                ...
                { // rotate the first cycle
                    [ranges::iter_swap](../../iterator/ranges/iter_swap.html)(first, next_it);
                    ++first;
                    ++next_it;
                    if (first == middle)
                        middle = next_it;
    ...
     
        ...
        requires [std::permutable](../../iterator/permutable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>>
        constexpr [ranges::borrowed_subrange_t](../../ranges/borrowed_iterator_t.html)<R>
            operator()(R&& r, [ranges::iterator_t](../../ranges/iterator_t.html)<R> middle) const
        {
...
Run this code
    ...
    int main()
    {
        [std::string](../../string/basic_string.html) s(16, ' ');
     
        for (int k {}; k != 5; ++k)
        {
            [std::iota](../iota.html)(s.begin(), s.end(), 'A');
            std::ranges::rotate(s, s.begin() + k);
            [std::cout](../../io/cout.html) << "Rotate left (" << k << "): " << s << '\n';
        }
    ...
     
        for (int k {}; k != 5; ++k)
        {
            ...
            [std::cout](../../io/cout.html) << "Rotate right (" << k << "): " << s << '\n';
        }
     
    ...
     
        ...
        {
            [std::cout](../../io/cout.html) << "i = " << std::[ranges::distance](../../iterator/ranges/distance.html)(s.begin(), i) << ": ";
            std::ranges::rotate(std::[ranges::upper_bound](upper_bound.html)(s.begin(), i, *i), i, i + 1);
            [std::cout](../../io/cout.html) << s << '\n';
        }
        [std::cout](../../io/cout.html) << (std::[ranges::is_sorted](is_sorted.html)(s) ? "Sorted!" : "Not sorted.") << '\n';
    }
