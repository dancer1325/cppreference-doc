...
Pred pred = {}, Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (1)  |  (since C++20)  
...
1) Searches for the _last_ occurrence of the sequence `[`first2`, `last2`)` in the range `[`first1`, `last1`)`, after projection with proj1 and proj2 respectively. The projected elements are compared using the binary predicate pred.
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/find_end&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
    ...
    struct find_end_fn
    {
                       ...
                       Proj1 proj1 = {}, Proj2 proj2 = {}) const
        {
            if (first2 == last2)
            {
                auto last_it = [ranges::next](../../iterator/ranges/next.html)(first1, last1);
                return {last_it, last_it};
            }
            auto result = [ranges::search](search.html)(
    ...
     
            for (;;)
            {
                auto new_result = [ranges::search](search.html)(
                    [std::next](../../iterator/next.html)(result.begin()), last1, first2, last2, pred, proj1, proj2);
                if (new_result.empty())
                    return result;
                else
...
Run this code
    ...
    {
        const auto pos = [std::distance](../../iterator/distance.html)(haystack.begin(), needle.begin());
        ...
        for (const auto c : needle)
            [std::cout](../../io/cout.html) << c;
        [std::cout](../../io/cout.html) << "\" at position [" << pos << ".." << pos + needle.size() << ")\n"
            << [std::string](../../string/basic_string.html)(4 + pos, ' ') << [std::string](../../string/basic_string.html)(needle.size(), '^') << '\n';
    }
     
    int main()
    {
    ...
     
        const auto found3 = std::ranges::find_end(secret, "ORD"sv,
            [](const char x, const char y) { // uses a binary predicate
                return [std::tolower](../../string/byte/tolower.html)(x) == [std::tolower](../../string/byte/tolower.html)(y);
            });
        print(secret, found3);
     
        const auto found4 = std::ranges::find_end(secret, "SWORD"sv, {}, {},
            [](char c) { return [std::tolower](../../string/byte/tolower.html)(c); }); // projects the 2nd range
        print(secret, found4);
     
