...
O, Comp, Proj1, Proj2>  
constexpr merge_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,  
...
using merge_result = [ranges::in_in_out_result](return_types/in_in_out_result.html)<I1, I2, O>; |  (3)  |  (since C++20)  
| |   
  
Merges two _sorted_ ranges `[`[first1`, `last1`)` and `[`first2`, `last2`)` into one _sorted_ range beginning at result. 

A sequence is said to be _sorted_ with respect to the comparator comp if for any iterator `it` pointing to the sequence and any non-negative integer `n` such that `it + n` is a valid iterator pointing to an element of the sequence, [std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj2, *(it + n)), [std::invoke](../../utility/functional/invoke.html)(proj1, *it))) evaluates to false. 
...
## Contents
  ...
  * [4 Notes](merge.html#Notes)
  * [5 Possible implementation](merge.html#Possible_implementation)
  * [6 Example](merge.html#Example)
  * [7 See also](merge.html#See_also)
...
---|---|---  
first2, last2  |  \-  |  the iterator-sentinel pair defining the second input sorted [range](../../iterator.html#Ranges "cpp/iterator") of elements to merge   
...
### Possible implementation
    ...
    struct merge_fn
    {
                       ...
                       Proj1 proj1 = {}, Proj2 proj2 = {}) const
        {
            ...
            {
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj2, *first2), [std::invoke](../../utility/functional/invoke.html)(proj1, *first1)))
                    *result = *first2, ++first2;
                else
                    *result = *first1, ++first1;
            }
            auto ret1{[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(std::move(first1), std::move(last1), std::move(result))};
            auto ret2{[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(std::move(first2), std::move(last2), std::move(ret1.out))};
            return {std::move(ret1.in), std::move(ret2.in), std::move(ret2.out)};
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R1, [ranges::input_range](../../ranges/input_range.html) R2, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,
                 class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less),
                 class Proj1 = [std::identity](../../utility/functional/identity.html), class Proj2 = [std::identity](../../utility/functional/identity.html)>
        requires [std::mergeable](../../iterator/mergeable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>, [ranges::iterator_t](../../ranges/iterator_t.html)<R2>,
                                O, Comp, Proj1, Proj2>
        constexpr ranges::merge_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,
                                       [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>, O>
...
Run this code
    ...
     
        ...
        std::ranges::merge(in1, in2, [std::back_inserter](../../iterator/back_inserter.html)(out));
