...
Call signature |  |   
| (1) |   
template< [std::bidirectional_iterator](../../iterator/bidirectional_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S, class T,  
/* indirectly-binary-right-foldable */<T, I> F >  
constexpr auto fold_right( I first, S last, T init, F f ); |  | (since C++23)   
(until C++26)  
...
/* indirectly-binary-right-foldable */<T, I> F >  
constexpr auto fold_right( I first, S last, T init, F f ); |  |  (since C++26)  
| (2) |   
template< [ranges::bidirectional_range](../../ranges/bidirectional_range.html) R, class T,  
/* indirectly-binary-right-foldable */  
<T, [ranges::iterator_t](../../ranges/iterator_t.html)<R>> F >  
constexpr auto fold_right( R&& r, T init, F f ); |  |  (since C++23)   
(until C++26)  
template< [ranges::bidirectional_range](../../ranges/bidirectional_range.html) R, class T = [ranges::range_value_t](../../ranges/range_size_t.html)<R>,  
/* indirectly-binary-right-foldable */  
<T, [ranges::iterator_t](../../ranges/iterator_t.html)<R>> F >  
constexpr auto fold_right( R&& r, T init, F f ); |  |  (since C++26)  
Helper concepts |  |   
...
Informally, `ranges::fold_right` behaves like [ranges::fold_left](fold_left.html)([views::reverse](../../ranges/reverse_view.html)(r), init, /*flipped*/(f)). 
...
## Contents
  ...
  * [1 Parameters](fold_right.html#Parameters)
  * [2 Return value](fold_right.html#Return_value)
  * [3 Possible implementations](fold_right.html#Possible_implementations)
  * [4 Complexity](fold_right.html#Complexity)
  * [5 Notes](fold_right.html#Notes)
  * [6 Example](fold_right.html#Example)
  * [7 References](fold_right.html#References)
  * [8 See also](fold_right.html#See_also)
...
### Possible implementations
    ...
    struct fold_right_fn
    {
        ...
        {
            using U = [std::decay_t](../../types/decay.html)<[std::invoke_result_t](../../types/result_of.html)<F&, [std::iter_reference_t](../../iterator/iter_t.html)<I>, T>>;
            if (first == last)
                return U(std::move(init));
            I tail = [ranges::next](../../iterator/ranges/next.html)(first, last);
            U accum = [std::invoke](../../utility/functional/invoke.html)(f, *--tail, std::move(init));
            while (first != tail)
                accum = [std::invoke](../../utility/functional/invoke.html)(f, *--tail, std::move(accum));
            return accum;
        }
     
        template<[ranges::bidirectional_range](../../ranges/bidirectional_range.html) R, class T = [ranges::range_value_t](../../ranges/range_size_t.html)<R>,
                 /* indirectly-binary-right-foldable */<T, [ranges::iterator_t](../../ranges/iterator_t.html)<R>> F>
...
Run this code
    ...
     
        auto r1 = ranges::fold_right(v.begin(), v.end(), 6, [std::plus](../../utility/functional/plus.html)<>()); // (1)
        [std::cout](../../io/cout.html) << "r1: " << r1 << '\n';
     
        auto r2 = ranges::fold_right(vs, "!"s, [std::plus](../../utility/functional/plus.html)<>()); // (2)
        [std::cout](../../io/cout.html) << "r2: " << r2 << '\n';
     
        // Use a program defined function object (lambda-expression):
        [std::string](../../string/basic_string.html) r3 = ranges::fold_right
        (
            v, "A", [](int x, [std::string](../../string/basic_string.html) s) { return s + ':' + [std::to_string](../../string/basic_string/to_string.html)(x); }
        );
    ...
     
        ...
        [std::vector](../../container/vector.html)<CD> nums{{1, 1}, {2, 0}, {3, 0}};
            ...
            auto r5 = ranges::fold_right(nums, {7, 0}, [std::multiplies](../../utility/functional/multiplies.html){});
        #else
            auto r5 = ranges::fold_right(nums, CD{7, 0}, [std::multiplies](../../utility/functional/multiplies.html){});
        #endif
        [std::cout](../../io/cout.html) << "r5: " << r5 << '\n';
    }
