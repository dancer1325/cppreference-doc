...
[std::weakly_incrementable](../../iterator/weakly_incrementable.html) O1, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O2,  
...
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O1> &&  
[std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O2>  
constexpr partition_copy_result<I, O1, O2>  
partition_copy( I first, S last, O1 out_true, O2 out_false,  
Pred pred, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R,  
[std::weakly_incrementable](../../iterator/weakly_incrementable.html) O1, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O2,  
class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<iterator_t<R>, Proj>> Pred >  
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O1> &&  
[std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O2>  
constexpr partition_copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O1, O2>  
partition_copy( R&& r, O1 out_true, O2 out_false,  
Pred pred, Proj proj = {} ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I, class O1, class O2 >  
using partition_copy_result = [ranges::in_out_out_result](return_types/in_out_out_result.html)<I, O1, O2>; |  (3)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](partition_copy.html#Parameters)
  * [2 Return value](partition_copy.html#Return_value)
  * [3 Complexity](partition_copy.html#Complexity)
  * [4 Possible implementation](partition_copy.html#Possible_implementation)
  * [5 Example](partition_copy.html#Example)
  * [6 See also](partition_copy.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partition_copy&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partition_copy&action=edit&section=2 "Edit section: Return value")] Return value

{last, o1, o2}, where `o1` and `o2` are the ends of the output ranges respectively, after the copying is complete. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partition_copy&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partition_copy&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct partition_copy_fn
    {
        template<[std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,
                 [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O1, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O2,
                 class Proj = [std::identity](../../utility/functional/identity.html), [std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<
                 std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Pred>
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O1> && [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O2>
    ...
     
        ...
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O1> &&
                 [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O2>
        constexpr ranges::partition_copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O1, O2>
            operator()(R&& r, O1 out_true, O2 out_false, Pred pred, Proj proj = {}) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), std::move(out_true),
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partition_copy&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::vector](../../container/vector.html)<int> o1(size(in)), o2(size(in));
     
        auto pred = [](char c) { return [std::isalpha](../../string/byte/isalpha.html)(c); };
     
        auto ret = std::ranges::partition_copy(in, o1.begin(), o2.begin(), pred);
     
        [std::ostream_iterator](../../iterator/ostream_iterator.html)<char> cout {[std::cout](../../io/cout.html), " "};
        [std::cout](../../io/cout.html) << "in = ";
        std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(in, cout);
        [std::cout](../../io/cout.html) << "\no1 = ";
        [std::copy](../copy.html)(o1.begin(), ret.out1, cout);
        [std::cout](../../io/cout.html) << "\no2 = ";
        [std::copy](../copy.html)(o2.begin(), ret.out2, cout);
        [std::cout](../../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partition_copy&action=edit&section=6 "Edit section: See also")] See also
