...
constexpr I  
is_sorted_until( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [std::forward_range](../../ranges/forward_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
...
is_sorted_until( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](is_sorted_until.html#Parameters)
  * [2 Return value](is_sorted_until.html#Return_value)
  * [3 Complexity](is_sorted_until.html#Complexity)
  * [4 Possible implementation](is_sorted_until.html#Possible_implementation)
  * [5 Notes](is_sorted_until.html#Notes)
  * [6 Example](is_sorted_until.html#Example)
  * [7 See also](is_sorted_until.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_sorted_until&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
     
            for (auto next = first; ++next != last; first = next)
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *next), [std::invoke](../../utility/functional/invoke.html)(proj, *first)))
                    return next;
     
            return first;
        }
...
Run this code
    ...
    int main()
    {
        ...
        [std::array](../../container/array.html) nums {3, 1, 4, 1, 5, 9};
     
        constexpr int min_sorted_size = 4;
        int sorted_size = 0;
        do
        {
            std::[ranges::shuffle](shuffle.html)(nums, g);
            const auto sorted_end = std::ranges::is_sorted_until(nums);
            sorted_size = std::[ranges::distance](../../iterator/ranges/distance.html)(nums.begin(), sorted_end);
     
            std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(nums, [std::ostream_iterator](../../iterator/ostream_iterator.html)<int>([std::cout](../../io/cout.html), " "));
            [std::cout](../../io/cout.html) << " : " << sorted_size << " leading sorted element(s)\n";
        }
