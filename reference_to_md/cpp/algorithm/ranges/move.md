...
requires [std::indirectly_movable](../../iterator/indirectly_movable.html)<I, O>  
constexpr move_result<I, O>  
move( I first, S last, O result ); |  (1)  |  (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O >  
requires [std::indirectly_movable](../../iterator/indirectly_movable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>  
constexpr move_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>  
move( R&& r, O result ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I, class O >  
using move_result = [ranges::in_out_result](return_types/in_out_result.html)<I, O>; |  (3)  |  (since C++20)  
| |   
  
1) Moves the elements in the range, defined by `[`first`, `last`)`, to another range beginning at result. The behavior is undefined if result is within the range `[`first`, `last`)`. In such a case, [ranges::move_backward](move_backward.html "cpp/algorithm/ranges/move backward") may be used instead.
...
The elements in the _moved-from_ range will still contain valid values of the appropriate type, but not necessarily the same values as before the move. 
...
## Contents
  ...
  * [3 Complexity](move.html#Complexity)
  * [4 Notes](move.html#Notes)
  * [5 Possible implementation](move.html#Possible_implementation)
  * [6 Example](move.html#Example)
  * [7 See also](move.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move&action=edit&section=2 "Edit section: Return value")] Return value

{last, result + N}, where 

1) N = [ranges::distance](../../iterator/ranges/distance.html)(first, last).

2) N = [ranges::distance](../../iterator/ranges/distance.html)(r).

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly N move assignments. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move&action=edit&section=4 "Edit section: Notes")] Notes

When moving overlapping ranges, **ranges::move** is appropriate when moving to the left (beginning of the destination range is outside the source range) while [ranges::move_backward](move_backward.html "cpp/algorithm/ranges/move backward") is appropriate when moving to the right (end of the destination range is outside the source range). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
    ...
    struct move_fn
    {
            ...
            operator()(I first, S last, O result) const
        {
            for (; first != last; ++first, ++result)
                *result = [ranges::iter_move](../../iterator/ranges/iter_move.html)(first);
            return {std::move(first), std::move(result)};
        }
        template<[ranges::input_range](../../ranges/input_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O>
        requires [std::indirectly_movable](../../iterator/indirectly_movable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>
        constexpr ranges::move_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move&action=edit&section=6 "Edit section: Example")] Example

The following code moves thread objects (which themselves are _non copyable_) from one container to another.
...
Run this code
    ...
     
    void f([std::chrono::milliseconds](../../chrono/duration.html) n)
    {
        [std::this_thread::sleep_for](../../thread/sleep_for.html)(n);
        [std::cout](../../io/cout.html) << "thread with n=" << n.count() << "ms ended" << [std::endl](../../io/manip/endl.html);
    }
     
    int main()
    {
        [std::vector](../../container/vector.html)<[std::jthread](../../thread/jthread.html)> v;
        v.emplace_back(f, 400ms);
        v.emplace_back(f, 600ms);
        v.emplace_back(f, 800ms);
     
        [std::list](../../container/list.html)<[std::jthread](../../thread/jthread.html)> l;
     
        // std::ranges::copy() would not compile, because std::jthread is non-copyable
        std::ranges::move(v, [std::back_inserter](../../iterator/back_inserter.html)(l));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/move&action=edit&section=7 "Edit section: See also")] See also
