...
Call signature |  |   
| (1) |   
template< [std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S, class T1, class T2,  
[std::output_iterator](../../iterator/output_iterator.html)<const T2&> O, class Proj = [std::identity](../../utility/functional/identity.html) >  
...
class O, class Proj = [std::identity](../../utility/functional/identity.html),  
class T1 = std::projected_value_t<I, Proj>,  
class T2 = [std::iter_value_t](../../iterator/iter_t.html)<O> >  
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O> &&  
[std::indirect_binary_predicate](../../iterator/indirect_binary_predicate.html)  
<[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>, const T1*> &&  
[std::output_iterator](../../iterator/output_iterator.html)<O, const T2&>  
constexpr replace_copy_result<I, O>  
replace_copy( I first, S last, O result, const T1& old_value,  
const T2& new_value, Proj proj = {} ); |  | (since C++26)  
| (2) |   
template< [ranges::input_range](../../ranges/input_range.html) R, class T1, class T2,  
[std::output_iterator](../../iterator/output_iterator.html)<const T2&> O, class Proj = [std::identity](../../utility/functional/identity.html) >  
...
constexpr replace_copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>  
...
| (3) |   
template< [std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class T, [std::output_iterator](../../iterator/output_iterator.html)<const T&> O,  
...
(until C++26)  
template< [std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class O, class T = [std::iter_value_t](../../iterator/iter_t.html)<O>  
class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Pred >  
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O> && [std::output_iterator](../../iterator/output_iterator.html)<O, const T&>  
constexpr replace_copy_if_result<I, O>  
replace_copy_if( I first, S last, O result, Pred pred,  
...
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>  
constexpr replace_copy_if_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>  
...
<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Pred >  
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O> &&  
[std::output_iterator](../../iterator/output_iterator.html)<O, const T&>  
constexpr replace_copy_if_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>  
replace_copy_if( R&& r, O result, Pred pred,  
const T& new_value, Proj proj = {} ); |  |  (since C++26)  
Helper types |  |   
template< class I, class O >  
using replace_copy_result = [ranges::in_out_result](return_types/in_out_result.html)<I, O>; |  (5)  |  (since C++20)  
template< class I, class O >  
using replace_copy_if_result = [ranges::in_out_result](return_types/in_out_result.html)<I, O>; |  (6)  |  (since C++20)  
| |   
...
1) Replaces all elements that are equal to old_value, using [std::invoke](../../utility/functional/invoke.html)(proj, *(first + (i - result))) == old_value to compare.

3) Replaces all elements for which the predicate pred evaluates to true, where the evaluating expression is [std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *(first + (i - result)))).
...
## Contents
  ...
  * [1 Parameters](replace_copy.html#Parameters)
  * [2 Return value](replace_copy.html#Return_value)
  * [3 Complexity](replace_copy.html#Complexity)
  * [4 Possible implementation](replace_copy.html#Possible_implementation)
  * [5 Notes](replace_copy.html#Notes)
  * [6 Example](replace_copy.html#Example)
  * [7 See also](replace_copy.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/replace_copy&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to copy   
---|---|---  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/replace_copy&action=edit&section=2 "Edit section: Return value")] Return value

{last, result + N}, where 

1,3) N = [ranges::distance](../../iterator/ranges/distance.html)(first, last);

2,4) N = [ranges::distance](../../iterator/ranges/distance.html)(r).

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/replace_copy&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly N applications of the corresponding predicate comp and any projection proj. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/replace_copy&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation

[replace_copy (1,2)](replace_copy.html#Version_1)  
---  
    ...
    struct replace_copy_fn
    {
                       ...
                       const T2& new_value, Proj proj = {}) const
        {
            for (; first != last; ++first, ++result)
                *result = ([std::invoke](../../utility/functional/invoke.html)(proj, *first) == old_value) ? new_value : *first;
            return {std::move(first), std::move(result)};
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R, class O, class Proj = [std::identity](../../utility/functional/identity.html),
                 class T1 = std::projected_value_t<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>,
                 class T2 = [std::iter_value_t](../../iterator/iter_t.html)<O>>
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O> &&
                 [std::indirect_binary_predicate](../../iterator/indirect_binary_predicate.html)
                     <[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to),
                      std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>, const T1*>
        constexpr ranges::replace_copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>
...
[replace_copy_if (3,4)](replace_copy.html#Version_3)  
    ...
    struct replace_copy_if_fn
    {
        ...
        {
            for (; first != last; ++first, ++result)
                 *result = [std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *first)) ? new_value : *first;
            return {std::move(first), std::move(result)};
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R, class O, class T = [std::iter_value_t](../../iterator/iter_t.html)<O>
                 class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)
                     <std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Pred>
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O> &&
                 [std::output_iterator](../../iterator/output_iterator.html)<O, const T&>
        constexpr ranges::replace_copy_if_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/replace_copy&action=edit&section=5 "Edit section: Notes")] Notes

[Feature-test](../../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_algorithm_default_value_type`](../../experimental/feature_test.html#cpp_lib_algorithm_default_value_type "cpp/feature test") | [`202403`](../../compiler_support/26.html#cpp_lib_algorithm_default_value_type_202403 "cpp/compiler support/26") | (C++26) | [list-initialization](../../language/list_initialization.html "cpp/language/list initialization") for algorithms ([1-4](replace_copy.html#Version_1))  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/replace_copy&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {    
        [std::vector](../../container/vector.html)<int> o;
     
    ...
     
        ...
        println("o", o);
     
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<short>> r{{1, 3}, {2, 2}, {4, 8}};
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<float>> s(r.size());
        println("r", r);
        ...
        #else
            std::ranges::replace_copy(r, s.begin(),
                                      [std::complex](../../numeric/complex.html)<short>{1, 3},
                                      [std::complex](../../numeric/complex.html)<float>{2.2, 4.8});
        #endif
        println("s", s);
     
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<double>> b{{1, 3}, {2, 2}, {4, 8}},
                                          d(b.size());
        println("b", b);
        #ifdef __cpp_lib_algorithm_default_value_type
            std::ranges::replace_copy_if(b, d.begin(),
                []([std::complex](../../numeric/complex.html)<double> z){ return std::abs(z) < 5; },
                {4, 2}); // Possible, since the T is deduced.
        #else
            std::ranges::replace_copy_if(b, d.begin(),
                []([std::complex](../../numeric/complex.html)<double> z){ return std::abs(z) < 5; },
                [std::complex](../../numeric/complex.html)<double>{4, 2});
        #endif
        println("d", d);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/replace_copy&action=edit&section=7 "Edit section: See also")] See also

[ ranges::replaceranges::replace_if](replace.html "cpp/algorithm/ranges/replace")(C++20)(C++20) |  replaces all values satisfying specific criteria with another value  
