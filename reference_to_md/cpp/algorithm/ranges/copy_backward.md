...
copy_backward( I1 first, S1 last, I2 d_last ); |  (1)  |  (since C++20)  
...
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, I>  
constexpr copy_backward_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, I>  
copy_backward( R&& r, I d_last ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I1, class I2 >  
using copy_backward_result = [ranges::in_out_result](return_types/in_out_result.html)<I1, I2>; |  (3)  |  (since C++20)  
| |   
  
1) Copies the elements from the range, defined by `[`first`, `last`)`, to another range `[`d_last - N`, `d_last`)`, where N = [ranges::distance](../../iterator/ranges/distance.html)(first, last). The elements are copied in reverse order (the last element is copied first), but their relative order is preserved. The behavior is undefined if d_last is within `**(** first, last**]**`. In such a case std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy) can be used instead.
...
## Contents
  ...
  * [1 Parameters](copy_backward.html#Parameters)
  * [2 Return value](copy_backward.html#Return_value)
  * [3 Complexity](copy_backward.html#Complexity)
  * [4 Notes](copy_backward.html#Notes)
  * [5 Possible implementation](copy_backward.html#Possible_implementation)
  * [6 Example](copy_backward.html#Example)
  * [7 See also](copy_backward.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy_backward&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to copy from   
---|---|---  
r  |  \-  |  the range of the elements to copy from   
d_last  |  \-  |  the end of the destination range   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy_backward&action=edit&section=2 "Edit section: Return value")] Return value

{last, d_last - N}

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy_backward&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly N assignments. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy_backward&action=edit&section=4 "Edit section: Notes")] Notes

When copying overlapping ranges, [`ranges::copy`](copy.html "cpp/algorithm/ranges/copy") is appropriate when copying to the left (beginning of the destination range is outside the source range) while `ranges::copy_backward` is appropriate when copying to the right (end of the destination range is outside the source range). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy_backward&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation
    ...
    struct copy_backward_fn
    {
        ...
        {
            I1 last1 {[ranges::next](../../iterator/ranges/next.html)(first, std::move(last))};
    ...
     
        template<[ranges::bidirectional_range](../../ranges/bidirectional_range.html) R, [std::bidirectional_iterator](../../iterator/bidirectional_iterator.html) I>
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, I>
        constexpr ranges::copy_backward_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, I>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy_backward&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    #include <vector>
     
    void print([std::string_view](../../string/basic_string_view.html) rem, std::[ranges::forward_range](../../ranges/forward_range.html) auto const& r)
    {
        for ([std::cout](../../io/cout.html) << rem << ": "; auto const& elem : r)
    ...
    int main()
    {
        ...
        print("src", src);
     
        [std::vector](../../container/vector.html)<int> dst(src.size() + 2);
        std::ranges::copy_backward(src, dst.end());
        print("dst", dst);
     
        std::[ranges::fill](fill.html)(dst, 0);
        const auto [in, out] =
            std::ranges::copy_backward(src.begin(), src.end() - 2, dst.end());
        print("dst", dst);
     
        [std::cout](../../io/cout.html)
            << "(in - src.begin) == " << [std::distance](../../iterator/distance.html)(src.begin(), in) << '\n'
            << "(out - dst.begin) == " << [std::distance](../../iterator/distance.html)(dst.begin(), out) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy_backward&action=edit&section=7 "Edit section: See also")] See also
