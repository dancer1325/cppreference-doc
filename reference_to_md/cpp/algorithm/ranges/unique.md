...
unique( I first, S last, C comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [ranges::forward_range](../../ranges/forward_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_equivalence_relation](../../iterator/indirect_equivalence_relation.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>>  
C = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to) >  
...
unique( R&& r, C comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [5 Possible implementation](unique.html#Possible_implementation)
  * [6 Example](unique.html#Example)
  * [7 See also](unique.html#See_also)
...
### Possible implementation
    ...
    struct unique_fn
    {
        ...
        {
            first = [ranges::adjacent_find](adjacent_find.html)(first, last, comp, proj);
            if (first == last)
                return {first, first};
            auto i {first};
            ++first;
            while (++first != last)
                if (![std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *i), [std::invoke](../../utility/functional/invoke.html)(proj, *first)))
                    *++i = [ranges::iter_move](../../iterator/ranges/iter_move.html)(first);
            return {++i, first};
        }
     
        template<[ranges::forward_range](../../ranges/forward_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
...
Run this code
    ...
    void print(id i, const auto& v)
    {
        ...
        std::[ranges::for_each](for_each.html)(v, [](auto const& e) { [std::cout](../../io/cout.html) << e << ' '; });
    ...
    int main()
    {
        ...
        [std::vector](../../container/vector.html)<int> v {1, 2, 1, 1, 3, 3, 3, 4, 5, 4};
     
        print(id {1}, v);
     
    ...
     
        ...
        std::[ranges::sort](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/sort)(v); // {1 1 2 3 4 4 5}
        print(id {3}, v);
     
    ...
     
        ...
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<int>> vc { {1, 1}, {-1, 2}, {-2, 3}, {2, 4}, {-3, 5} };
        print(id {5}, vc);
     
        const auto ret2 = std::ranges::unique(vc,
            ...
            []([std::complex](../../numeric/complex.html)<int> z) { return z.real(); }             // proj
        );
