...
constexpr I sort_heap( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
...
sort_heap( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
  
[Sorts](../../algorithm.html#Requirements "cpp/algorithm") the elements in the specified range with respect to comp and proj, where the range originally represents a [heap](../../algorithm.html#Heap_operations "cpp/algorithm") with respect to comp and proj. The sorted range no longer maintains the heap property. 
...
## Contents
  ...
  * [2 Return value](sort_heap.html#Return_value)
  * [3 Complexity](sort_heap.html#Complexity)
  * [4 Possible implementation](sort_heap.html#Possible_implementation)
  * [5 Example](sort_heap.html#Example)
    ...
    struct sort_heap_fn
    {
        ...
        constexpr I operator()(I first, S last, Comp comp = {}, Proj proj = {}) const
        {
            ...
            for (auto last{ret}; first != last; --last)
                [ranges::pop_heap](pop_heap.html)(first, last, comp, proj);
            return ret;
        }
     
        template<[ranges::random_access_range](../../ranges/random_access_range.html) R,
...
Run this code
    ...
    int main()
    {
        [std::array](../../container/array.html) v{3, 1, 4, 1, 5, 9};
