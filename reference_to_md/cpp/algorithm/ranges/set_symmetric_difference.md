...
O, Comp, Proj1, Proj2>  
constexpr set_symmetric_difference_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,   
[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>, O>  
set_symmetric_difference( R1&& r1, R2&& r2, O result, Comp comp = {},  
Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I1, class I2, class O >  
using set_symmetric_difference_result = [ranges::in_in_out_result](return_types/in_in_out_result.html)<I1, I2, O>; |  (3)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](set_symmetric_difference.html#Parameters)
  * [2 Return value](set_symmetric_difference.html#Return_value)
  * [3 Complexity](set_symmetric_difference.html#Complexity)
  * [4 Possible implementation](set_symmetric_difference.html#Possible_implementation)
  * [5 Example](set_symmetric_difference.html#Example)
  * [6 See also](set_symmetric_difference.html#See_also)
...
### Possible implementation
    ...
     
        ...
        constexpr ranges::set_symmetric_difference_result<
            [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>, [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>, O>
...
Run this code
    ...
    void visualize_this(const auto& v, int min = 1, int max = 9)
    {
        ...
        {
            std::[ranges::binary_search](binary_search.html)(v, i) ? [std::cout](../../io/cout.html) << i : [std::cout](../../io/cout.html) << '.';
    ...
     
        std::ranges::set_symmetric_difference(in1, in2, [std::back_inserter](../../iterator/back_inserter.html)(out));
     
        visualize_this(in1);
        visualize_this(in2);
        visualize_this(out);
