...
---|---|---  
Call signature |  |   
template< [std::bidirectional_iterator](../../iterator/bidirectional_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
/*indirectly-binary-right-foldable*/<[std::iter_value_t](../../iterator/iter_t.html)<I>, I> F >  
...
constexpr auto  
fold_right_last( I first, S last, F f ); |  (1)  |  (since C++23)  
template< [ranges::bidirectional_range](../../ranges/bidirectional_range.html) R,  
...
constexpr auto  
fold_right_last( R&& r, F f ); |  (2)  |  (since C++23)  
Helper concepts |  |   
template< class F, class T, class I >  
concept /*indirectly-binary-left-foldable*/ = /* see description */; |  (3)  |  (exposition only*)  
template< class F, class T, class I >  
concept /*indirectly-binary-right-foldable*/ = /* see description */; |  (4)  |  (exposition only*)  
| |   
  
Right-[folds](https://en.wikipedia.org/wiki/Fold_\(higher-order_function\) "enwiki:Fold \(higher-order function\)") the elements of given range, that is, returns the result of evaluation of the chain expression:  
`f(x1, f(x2, ...f(xn-1, xn)))`, where `x1`, `x2`, ..., `xn` are elements of the range. 

Informally, `ranges::fold_right_last` behaves like [ranges::fold_left](fold_left.html)([views::reverse](../../ranges/reverse_view.html)(r), *--last, /*flipped*/(f)) (assuming the range is not empty). 

The behavior is undefined if `[`first`, `last`)` is not a valid range. 

1) The range is `[`first`, `last`)`. Given U as decltype([ranges::fold_right](fold_right.html)(first, last, [std::iter_value_t](../../iterator/iter_t.html)<I>(*first), f)), equivalent to: 
    
    
    if (first == last)
        return [std::optional](../../utility/optional.html)<U>();
    I tail = [ranges::prev](../../iterator/ranges/prev.html)([ranges::next](../../iterator/ranges/next.html)(first, std::move(last)));
    return [std::optional](../../utility/optional.html)<U>([std::in_place](../../utility/in_place.html), [ranges::fold_right](fold_right.html)(std::move(first), tail,
        [std::iter_value_t](../../iterator/iter_t.html)<I>(*tail), std::move(f)));
...
4) Equivalent to:  Helper concepts |  |   
---|---|---  
template< class F, class T, class I >  
concept /*indirectly-binary-right-foldable*/ =  
/*indirectly-binary-left-foldable*/</*flipped*/<F>, T, I>; |  (4A)  |  (exposition only*)  
...
requires [std::invocable](../../concepts/invocable.html)<F&, U, T>  
[std::invoke_result_t](../../types/result_of.html)<F&, U, T> operator()( T&&, U&& );  
}; |  (4B)  |  (exposition only*)  
| |   
...
## Contents
  ...
  * [1 Parameters](fold_right_last.html#Parameters)
  * [2 Return value](fold_right_last.html#Return_value)
  * [3 Possible implementations](fold_right_last.html#Possible_implementations)
  * [4 Complexity](fold_right_last.html#Complexity)
  * [5 Notes](fold_right_last.html#Notes)
  * [6 Example](fold_right_last.html#Example)
  * [7 References](fold_right_last.html#References)
  * [8 See also](fold_right_last.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right_last&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right_last&action=edit&section=2 "Edit section: Return value")] Return value

An object of type [std::optional](../../utility/optional.html)<U> that contains the result of right-[fold](https://en.wikipedia.org/wiki/Fold_\(higher-order_function\) "enwiki:Fold \(higher-order function\)") of the given range over f. 

If the range is empty, [std::optional](../../utility/optional.html)<U>() is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right_last&action=edit&section=3 "Edit section: Possible implementations")] Possible implementations
    ...
    struct fold_right_last_fn
    {
        template<[std::bidirectional_iterator](../../iterator/bidirectional_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,
                 /*indirectly-binary-right-foldable*/<[std::iter_value_t](../../iterator/iter_t.html)<I>, I> F>
        requires
            [std::constructible_from](../../concepts/constructible_from.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>, [std::iter_reference_t](../../iterator/iter_t.html)<I>>
        constexpr auto operator()(I first, S last, F f) const
        {
            using U = decltype(
                [ranges::fold_right](fold_right.html)(first, last, [std::iter_value_t](../../iterator/iter_t.html)<I>(*first), f));
     
            if (first == last)
                return [std::optional](../../utility/optional.html)<U>();
            I tail = [ranges::prev](../../iterator/ranges/prev.html)([ranges::next](../../iterator/ranges/next.html)(first, std::move(last)));
            return [std::optional](../../utility/optional.html)<U>([std::in_place](../../utility/in_place.html),
                [ranges::fold_right](fold_right.html)(std::move(first), tail, [std::iter_value_t](../../iterator/iter_t.html)<I>(*tail),
                                   std::move(f)));
        }
     
        template<[ranges::bidirectional_range](../../ranges/bidirectional_range.html) R,
        ...
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), [std::ref](../../utility/functional/ref.html)(f));
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right_last&action=edit&section=4 "Edit section: Complexity")] Complexity

Exactly [ranges::distance](../../iterator/ranges/distance.html)(first, last) applications of the function object f. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right_last&action=edit&section=5 "Edit section: Notes")] Notes
...
ranges::fold_right_last | right | last element | [std::optional](../../utility/optional.html)<U>  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right_last&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)> vs {"A", "B", "C", "D"};
     
        auto r1 = std::ranges::fold_right_last(v.begin(), v.end(), [std::plus](../../utility/functional/plus.html)<>()); // (1)
        [std::cout](../../io/cout.html) << "*r1: " << *r1 << '\n';
     
        auto r2 = std::ranges::fold_right_last(vs, [std::plus](../../utility/functional/plus.html)<>()); // (2)
        [std::cout](../../io/cout.html) << "*r2: " << *r2 << '\n';
     
        // Use a program defined function object (lambda-expression):
        auto r3 = std::ranges::fold_right_last(v, [](int x, int y) { return x + y + 99; });
        [std::cout](../../io/cout.html) << "*r3: " << *r3 << '\n';
     
        // Get the product of the std::pair::second of all pairs in the vector:
        [std::vector](../../container/vector.html)<[std::pair](../../utility/pair.html)<char, float>> data {{'A', 3.f}, {'B', 3.5f}, {'C', 4.f}};
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right_last&action=edit&section=7 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right_last&action=edit&section=8 "Edit section: See also")] See also
