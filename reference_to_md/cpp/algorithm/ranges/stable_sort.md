...
I stable_sort( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1) | (since C++20)   
...
stable_sort( R&& r, Comp comp = {}, Proj proj = {} ); |  (2) | (since C++20)   
(constexpr since C++26)  
| |   
  
Sorts the elements in the range `[`first`, `last`)` in non-descending order. The order of equivalent elements is _stable_ , i.e. guaranteed to be preserved. 
...
## Contents
  ...
  * [1 Parameters](stable_sort.html#Parameters)
  * [2 Return value](stable_sort.html#Return_value)
  * [3 Complexity](stable_sort.html#Complexity)
  * [4 Notes](stable_sort.html#Notes)
  * [5 Possible implementation](stable_sort.html#Possible_implementation)
  * [6 Example](stable_sort.html#Example)
  * [7 See also](stable_sort.html#See_also)
...
This implementation only shows the slower algorithm used when no additional memory is available. See also implementation in [MSVC STL](https://github.com/microsoft/STL/blob/e745bad3b1d05b5b19ec652d68abb37865ffa454/stl/inc/algorithm#L7842-L8094) and [libstdc++](https://github.com/gcc-mirror/gcc/blob/54258e22b0846aaa6bd3265f592feb161eecda75/libstdc%2B%2B-v3/include/bits/ranges_algo.h#L1836-L1862). 
    ...
    struct stable_sort_fn
    {
        ...
        {
            auto count = [ranges::distance](../../iterator/ranges/distance.html)(first, last);
    ...
     
            if (count <= 1)
                return last_it;
     
            (*this)(first, mid, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
            (*this)(mid, last_it, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
     
            [ranges::inplace_merge](inplace_merge.html)(first, mid, last_it);
     
            return last_it;
        }
     
        ...
        requires [std::sortable](../../iterator/sortable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Comp, Proj>
        constexpr //< since C++26
        [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R> operator()(R&& r, Comp comp = {}, Proj proj = {}) const
        {
...
Run this code
    ...
    struct Particle
    {
        ...
        friend [std::ostream](../../io/basic_ostream.html)& operator<<([std::ostream](../../io/basic_ostream.html)& os, const Particle& p)
        {
            return os << '\n' << [std::left](../../io/manip/left.html) << [std::setw](../../io/manip/setw.html)(8) << p.name << " : " << p.mass;
        }
    };
     
    int main()
    ...
     
        ...
        std::ranges::stable_sort(s, std::[ranges::greater](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/greater)());
        print(s);
     
