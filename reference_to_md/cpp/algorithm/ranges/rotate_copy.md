...
rotate_copy( I first, I middle, S last, O result ); |  (1)  |  (since C++20)  
template< [ranges::forward_range](../../ranges/forward_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O >  
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>  
constexpr rotate_copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>  
rotate_copy( R&& r, [ranges::iterator_t](../../ranges/iterator_t.html)<R> middle, O result ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I, class O >  
using rotate_copy_result = in_out_result<I, O>; |  (3)  |  (since C++20)  
| |   
  
Copies the _left rotation_ of `[`first`, `last`)` to result. 
...
## Contents
  ...
  * [1 Parameters](rotate_copy.html#Parameters)
  * [2 Return value](rotate_copy.html#Return_value)
  * [3 Complexity](rotate_copy.html#Complexity)
  * [4 Notes](rotate_copy.html#Notes)
  * [5 Possible implementation](rotate_copy.html#Possible_implementation)
  * [6 Example](rotate_copy.html#Example)
  * [7 See also](rotate_copy.html#See_also)
...
See also the implementations in [libstdc++](https://github.com/gcc-mirror/gcc/blob/14d8a5ae472ca5743016f37da2dd4770d83dea21/libstdc%2B%2B-v3/include/bits/ranges_algo.h#L1511-L1539) and [MSVC STL](https://github.com/microsoft/STL/blob/472161105d596192194d4715ccad307c6c163b4a/stl/inc/algorithm#L4466-L4514). 
    ...
    {
        template<[std::forward_iterator](../../iterator/forward_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O>
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O>
        constexpr ranges::rotate_copy_result<I, O>
            operator()(I first, I middle, S last, O result) const
        {
            auto c1 {[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(middle, std::move(last), std::move(result))};
            auto c2 {[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(std::move(first), std::move(middle), std::move(c1.out))};
            return {std::move(c1.in), std::move(c2.out)};
        }
     
        template<[ranges::forward_range](../../ranges/forward_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O>
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>
        constexpr ranges::rotate_copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>
            operator()(R&& r, [ranges::iterator_t](../../ranges/iterator_t.html)<R> middle, O result) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), std::move(middle),
                           [ranges::end](../../ranges/end.html)(r), std::move(result));
        }
    };
     
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<int> src {1, 2, 3, 4, 5};
        [std::vector](../../container/vector.html)<int> dest(src.size());
        auto pivot = std::[ranges::find](find.html)(src, 3);
     
    ...
     
        ...
        pivot = std::[ranges::find](find.html)(dest, 1);
        std::ranges::rotate_copy(dest, pivot, [std::ostream_iterator](../../iterator/ostream_iterator.html)<int>([std::cout](../../io/cout.html), " "));
        [std::cout](../../io/cout.html) << '\n';
    }
