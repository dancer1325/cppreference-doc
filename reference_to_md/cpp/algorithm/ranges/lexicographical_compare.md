...
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I2, Proj2>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr bool  
...
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R2>, Proj2>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr bool  
lexicographical_compare( R1&& r1, R2&& r2, Comp comp = {},  
Proj1 proj1 = {}, Proj2 proj2 = {} ); |  (2)  |  (since C++20)  
| |   
  
Checks if the first range `[`first1`, `last1`)` is lexicographically _less_ than the second range `[`first2`, `last2`)`. 
...
first2, last2  |  \-  |  the iterator-sentinel pair defining the second [range](../../iterator.html#Ranges "cpp/iterator") of elements to examine   
    ...
     
                                  ...
                                  Proj1 proj1 = {}, Proj2 proj2 = {}) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r1), [ranges::end](../../ranges/end.html)(r1),
                           ...
                           [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj1), [std::ref](../../utility/functional/ref.html)(proj2));
        }
    };
     
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<char> v1 {'a', 'b', 'c', 'd'};
        [std::vector](../../container/vector.html)<char> v2 {'a', 'b', 'c', 'd'};
     
        namespace ranges = std::ranges;
        auto os = [std::ostream_iterator](../../iterator/ostream_iterator.html)<char>([std::cout](../../io/cout.html), " ");
     
        [std::mt19937](../../numeric/random/mersenne_twister_engine.html) g {[std::random_device](../../numeric/random/random_device.html) {}()};
        while (not ranges::lexicographical_compare(v1, v2))
        {
            [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(v1, os);
            [std::cout](../../io/cout.html) << ">= ";
            [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(v2, os);
            [std::cout](../../io/cout.html) << '\n';
     
            [ranges::shuffle](shuffle.html)(v1, g);
            [ranges::shuffle](shuffle.html)(v2, g);
        }
     
        [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(v1, os);
        [std::cout](../../io/cout.html) << "<  ";
