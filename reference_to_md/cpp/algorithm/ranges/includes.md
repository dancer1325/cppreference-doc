...
constexpr bool  
includes( R1&& r1, R2&& r2, Comp comp = {}, Proj1 proj1 = {}, Proj2 proj2 = {} ) |  (2)  |  (since C++20)  
| |   
  
1) Returns true if the projections of the sorted range `[`first2`, `last2`)` is a [subsequence](https://en.wikipedia.org/wiki/subsequence "enwiki:subsequence") of the projections of the sorted range `[`first1`, `last1`)`.

2) Same as (1), but uses r1 and r2 as the source ranges, as if by using [ranges::begin](../../ranges/begin.html)(r1) and [ranges::begin](../../ranges/begin.html)(r2) as first1 and first2 respectively, and [ranges::end](../../ranges/end.html)(r1) and [ranges::end](../../ranges/end.html)(r2) as last1 and last2 respectively.
...
## Contents
  ...
  * [4 Possible implementation](includes.html#Possible_implementation)
  * [5 Example](includes.html#Example)
  * [6 See also](includes.html#See_also)
...
first2, last2  |  \-  |  the iterator-sentinel pair defining the sorted [range](../../iterator.html#Ranges "cpp/iterator") of elements to search for   
...
Run this code
    ...
     
    template<class T>
    [std::ostream](../../io/basic_ostream.html)& operator<<([std::ostream](../../io/basic_ostream.html)& os, [std::initializer_list](../../utility/initializer_list.html)<T> const& list)
    {
    ...
     
    struct true_false : [std::numpunct](../../locale/numpunct.html)<char>
    {
        [std::string](../../string/basic_string.html) do_truename() const { return "? Yes\n"; }
        [std::string](../../string/basic_string.html) do_falsename() const { return "? No\n"; }
    };
     
    int main()
    {
        [std::cout](../../io/cout.html).imbue([std::locale](../../locale/locale.html)([std::cout](../../io/cout.html).getloc(), new true_false));
     
        auto ignore_case = [](char a, char b) { return [std::tolower](../../string/byte/tolower.html)(a) < [std::tolower](../../string/byte/tolower.html)(b); };
     
        const auto
            a = {'a', 'b', 'c'},
            b = {'a', 'c'},
