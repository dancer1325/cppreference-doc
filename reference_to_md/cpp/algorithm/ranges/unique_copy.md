...
[std::indirect_equivalence_relation](../../iterator/indirect_equivalence_relation.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>>  
C = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to) >  
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O> && ([std::forward_iterator](../../iterator/forward_iterator.html)<I> ||  
([std::input_iterator](../../iterator/input_iterator.html)<O> && [std::same_as](../../concepts/same_as.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>,  
[std::iter_value_t](../../iterator/iter_t.html)<O>>) || [std::indirectly_copyable_storable](../../iterator/indirectly_copyable_storable.html)<I, O>)  
constexpr unique_copy_result<I, O>  
unique_copy( I first, S last, O result, C comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,  
class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_equivalence_relation](../../iterator/indirect_equivalence_relation.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>,  
Proj>> C = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to) >  
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O> &&  
([std::forward_iterator](../../iterator/forward_iterator.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>> ||  
([std::input_iterator](../../iterator/input_iterator.html)<O> && [std::same_as](../../concepts/same_as.html)<[ranges::range_value_t](../../ranges/range_size_t.html)<R>,  
[std::iter_value_t](../../iterator/iter_t.html)<O>>) ||  
[std::indirectly_copyable_storable](../../iterator/indirectly_copyable_storable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>)  
constexpr unique_copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>  
unique_copy( R&& r, O result, C comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I, class O >  
using unique_copy_result = [ranges::in_out_result](return_types/in_out_result.html)<I, O>; |  (3)  |  (since C++20)  
| |   
...
The ranges `[`first`, `last`)` and `[`result`, `result + N`)` must not overlap. N = [ranges::distance](../../iterator/ranges/distance.html)(first, last).

Two consecutive elements *(i - 1) and *i are considered equivalent if [std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *(i - 1)), [std::invoke](../../utility/functional/invoke.html)(proj, *i)) == true, where `i` is an iterator in the range `[`first + 1`, `last`)`.
...
## Contents
  ...
  * [4 Possible implementation](unique_copy.html#Possible_implementation)
  * [5 Example](unique_copy.html#Example)
  * [6 See also](unique_copy.html#See_also)
...
See also the implementations in [libstdc++](https://github.com/gcc-mirror/gcc/blob/master/libstdc%2B%2B-v3/include/bits/ranges_algo.h#L1198-L1276) and [MSVC STL](https://github.com/microsoft/STL/blob/472161105d596192194d4715ccad307c6c163b4a/stl/inc/algorithm#L4022-L4113) (and third-party libraries: [cmcstl2](https://github.com/CaseyCarter/cmcstl2/blob/master/include/stl2/detail/algorithm/unique_copy.hpp), [NanoRange](https://github.com/tcbrindle/NanoRange/blob/master/include/nanorange/algorithm/unique_copy.hpp), and [range-v3](https://github.com/ericniebler/range-v3/blob/master/include/range/v3/algorithm/unique_copy.hpp)). 
    ...
    struct unique_copy_fn
    {
        template<[std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,
                 class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_equivalence_relation](../../iterator/indirect_equivalence_relation.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I,
                     Proj>> C = [ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to)>
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<I, O> && ([std::forward_iterator](../../iterator/forward_iterator.html)<I> ||
                     ([std::input_iterator](../../iterator/input_iterator.html)<O> && [std::same_as](../../concepts/same_as.html)<[std::iter_value_t](../../iterator/iter_t.html)<I>,
                         [std::iter_value_t](../../iterator/iter_t.html)<O>>) || [std::indirectly_copyable_storable](../../iterator/indirectly_copyable_storable.html)<I, O>)
            ...
            operator()(I first, S last, O result, C comp = {}, Proj proj = {}) const
        {
            if (!(first == last))
            {
                [std::iter_value_t](../../iterator/iter_t.html)<I> value = *first;
                *result = value;
                ++result;
                while (!(++first == last))
                {
                    auto&& value2 = *first;
                    if (![std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, value2),
                            [std::invoke](../../utility/functional/invoke.html)(proj, value)))
                    {
                        value = [std::forward](../../utility/forward.html)<decltype(value2)>(value2);
                        *result = value;
                        ++result;
                    }
                }
    ...
     
        ...
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O> &&
                     ...
                     ([std::input_iterator](../../iterator/input_iterator.html)<O> && [std::same_as](../../concepts/same_as.html)<[ranges::range_value_t](../../ranges/range_size_t.html)<R>,
                         [std::iter_value_t](../../iterator/iter_t.html)<O>>) ||
                     [std::indirectly_copyable_storable](../../iterator/indirectly_copyable_storable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>)
        constexpr ranges::unique_copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>
...
Run this code
    ...
    {
        using V = [std::remove_cvref_t](../../types/remove_cvref.html)<decltype(v)>;
        constexpr bool sep{[std::is_same_v](../../types/is_same.html)<typename V::value_type, int>};
        [std::cout](../../io/cout.html) << rem << [std::showpos](../../io/manip/showpos.html);
        for (const auto& e : v)
            [std::cout](../../io/cout.html) << e << (sep ? " " : "");
        [std::cout](../../io/cout.html) << '\n';
    }
     
    int main()
    {
        [std::string](../../string/basic_string.html) s1{"The      string    with many       spaces!"};
        print("s1: ", s1);
     
        [std::string](../../string/basic_string.html) s2;
        std::ranges::unique_copy(
            s1.begin(), s1.end(), [std::back_inserter](../../iterator/back_inserter.html)(s2),
    ...
     
        ...
        print("v1: ", v1);
        [std::list](../../container/list.html)<int> v2;
        std::ranges::unique_copy(
            v1, [std::back_inserter](../../iterator/back_inserter.html)(v2),
