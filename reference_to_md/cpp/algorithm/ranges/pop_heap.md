...
constexpr I pop_heap( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
...
Swaps the first element and the last element of the specified [heap](../../algorithm.html#Heap_operations "cpp/algorithm") with respect to comp and proj and makes the subrange excluding the first position into a heap with respect to comp and proj. This has the effect of removing the first element from the specified heap. 
...
## Contents
  ...
  * [1 Parameters](pop_heap.html#Parameters)
  * [2 Return value](pop_heap.html#Return_value)
  * [3 Complexity](pop_heap.html#Complexity)
  * [4 Example](pop_heap.html#Example)
  * [5 See also](pop_heap.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/pop_heap&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/pop_heap&action=edit&section=2 "Edit section: Return value")] Return value

1) last

2) [ranges::end](../../ranges/end.html)(r)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/pop_heap&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/pop_heap&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    void print([std::string_view](../../string/basic_string_view.html) rem, I first = {}, I last = {},
               [std::string_view](../../string/basic_string_view.html) term = "\n")
    {
    ...
    int main()
    {
        [std::array](../../container/array.html) v{3, 1, 4, 1, 5, 9, 2, 6, 5, 3};
    ...
     
        ...
        for (auto n {[std::ssize](../../iterator/size.html)(v)}; n >= 0; --n)
        {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/pop_heap&action=edit&section=5 "Edit section: See also")] See also
