...
---|---|---  
Call signature |  |   
template< [std::forward_iterator](../../iterator/forward_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr I  
min_element( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
...
min_element( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](min_element.html#Parameters)
  * [2 Return value](min_element.html#Return_value)
  * [3 Complexity](min_element.html#Complexity)
  * [4 Possible implementation](min_element.html#Possible_implementation)
  * [5 Example](min_element.html#Example)
  * [6 See also](min_element.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/min_element&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to examine   
---|---|---  
r  |  \-  |  the [`range`](../../ranges/range.html "cpp/ranges/range") to examine   
comp  |  \-  |  comparison to apply to the projected elements   
proj  |  \-  |  projection to apply to the elements   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/min_element&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/min_element&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly max(N - 1, 0) comparisons, where N = [ranges::distance](../../iterator/ranges/distance.html)(first, last). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/min_element&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct min_element_fn
    {
        ...
        constexpr I operator()(I first, S last, Comp comp = {}, Proj proj = {}) const
        {
            ...
            auto smallest = first;
            while (++first != last)
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *first), [std::invoke](../../utility/functional/invoke.html)(proj, *smallest)))
                    smallest = first;
            return smallest;
        }
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/min_element&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::array](../../container/array.html) v{3, 1, -13, 1, 3, 7, -13};
     
        auto iterator = ranges::min_element(v.begin(), v.end());
        auto position = [ranges::distance](../../iterator/ranges/distance.html)(v.begin(), iterator);
        [std::cout](../../io/cout.html) << "min element is v[" << position << "] == " << *iterator << '\n';
     
        auto abs_compare = [](int a, int b) { return (std::abs(a) < std::abs(b)); };
        iterator = ranges::min_element(v, abs_compare);
        position = [ranges::distance](../../iterator/ranges/distance.html)(v.begin(), iterator);
        [std::cout](../../io/cout.html) << "|min| element is v[" << position << "] == " << *iterator << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/min_element&action=edit&section=6 "Edit section: See also")] See also
