...
requires [std::indirectly_swappable](../../iterator/indirectly_swappable.html)<I1, I2>  
constexpr swap_ranges_result<I1, I2>  
swap_ranges( I1 first1, S1 last1, I2 first2, S2 last2 ); |  (1)  |  (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R1, [ranges::input_range](../../ranges/input_range.html) R2 >  
requires [std::indirectly_swappable](../../iterator/indirectly_swappable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>, [ranges::iterator_t](../../ranges/iterator_t.html)<R2>>  
constexpr swap_ranges_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,  
[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>>  
swap_ranges( R1&& r1, R2&& r2 ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I1, class I2 >  
using swap_ranges_result = [ranges::in_in_result](return_types/in_in_result.html)<I1, I2>; |  (3)  |  (since C++20)  
| |   
  
1) Exchanges elements between first range `[`first1`, `first1 + M`)` and second range `[`first2`, `first2 + M`)` via [ranges::iter_swap](../../iterator/ranges/iter_swap.html)(first1 + i, first2 + i), where M = [ranges::min](min.html)([ranges::distance](../../iterator/ranges/distance.html)(first1, last1), [ranges::distance](../../iterator/ranges/distance.html)(first2, last2)).
...
## Contents
  ...
  * [1 Parameters](swap_ranges.html#Parameters)
  * [2 Return value](swap_ranges.html#Return_value)
  * [3 Complexity](swap_ranges.html#Complexity)
  * [4 Notes](swap_ranges.html#Notes)
  * [5 Possible implementation](swap_ranges.html#Possible_implementation)
  * [6 Example](swap_ranges.html#Example)
  * [7 See also](swap_ranges.html#See_also)
...
---|---|---  
first2, last2  |  \-  |  the iterator-sentinel pair defining the second [range](../../iterator.html#Ranges "cpp/iterator") of elements to swap   
    ...
    struct swap_ranges_fn
    {
            ...
            operator()(I1 first1, S1 last1, I2 first2, S2 last2) const
        {
            for (; !(first1 == last1 or first2 == last2); ++first1, ++first2)
                [ranges::iter_swap](../../iterator/ranges/iter_swap.html)(first1, first2);
            return {std::move(first1), std::move(first2)};
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R1, [ranges::input_range](../../ranges/input_range.html) R2>
        requires [std::indirectly_swappable](../../iterator/indirectly_swappable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R1>, [ranges::iterator_t](../../ranges/iterator_t.html)<R2>>
        constexpr ranges::swap_ranges_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R1>,
                                             [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R2>>
...
Run this code
    ...
    #include <vector>
     
    auto print([std::string_view](../../string/basic_string_view.html) name, auto const& seq, [std::string_view](../../string/basic_string_view.html) term = "\n")
    {
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<char> p {'A', 'B', 'C', 'D', 'E'};
        [std::list](../../container/list.html)<char> q {'1', '2', '3', '4', '5', '6'};
     
        print("p", p);
        print("q", q, "\n\n");
     
        ...
        std::ranges::swap_ranges(p.begin(),
                                 p.begin() + 4,
                                 std::[ranges::next](../../iterator/ranges/next.html)(q.begin(), 1),
                                 std::[ranges::next](../../iterator/ranges/next.html)(q.begin(), 3));
        print("p", p);
        print("q", q, "\n\n");
     
