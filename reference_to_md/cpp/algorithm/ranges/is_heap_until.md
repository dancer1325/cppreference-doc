...
< std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr I is_heap_until( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [ranges::random_access_range](../../ranges/random_access_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)  
<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)  
<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>  
is_heap_until( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
  
Within the specified range, finds the longest range which starting from the beginning of the specified range and represents a [heap](../../algorithm.html#Heap_operations "cpp/algorithm") with respect to comp and proj. 
...
## Contents
  ...
  * [1 Parameters](is_heap_until.html#Parameters)
  * [2 Return value](is_heap_until.html#Return_value)
  * [3 Complexity](is_heap_until.html#Complexity)
  * [4 Possible implementation](is_heap_until.html#Possible_implementation)
  * [5 Example](is_heap_until.html#Example)
  * [6 See also](is_heap_until.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_heap_until&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_heap_until&action=edit&section=2 "Edit section: Return value")] Return value

The last iterator iter in the specified range for which: 

1) The range `[`first`, `iter`)` is a heap with respect to comp and proj.

2) The range `[`[ranges::begin](../../ranges/begin.html)(r)`, `iter`)` is a heap with respect to comp and proj.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_heap_until&action=edit&section=3 "Edit section: Complexity")] Complexity

\\(\scriptsize O(N) \\)O(N) applications of comp and proj, where \\(\scriptsize N \\)N is: 

1) [ranges::distance](../../iterator/ranges/distance.html)(first, last)

2) [ranges::distance](../../iterator/ranges/distance.html)(r)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_heap_until&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct is_heap_until_fn
    {
        ...
        {
            [std::iter_difference_t](../../iterator/iter_t.html)<I> n{[ranges::distance](../../iterator/ranges/distance.html)(first, last)}, dad{0}, son{1};
            for (; son != n; ++son)
            {
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *(first + dad)),
                                      [std::invoke](../../utility/functional/invoke.html)(proj, *(first + son))))
                    return first + son;
                else if ((son % 2) == 0)
                    ++dad;
            }
    ...
     
        ...
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), std::move(comp), std::move(proj));
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_heap_until&action=edit&section=5 "Edit section: Example")] Example

The example renders a given vector as a (balanced) [Binary tree](https://en.wikipedia.org/wiki/Binary_tree "enwiki:Binary tree").
...
Run this code
    ...
     
        const auto size{std::[ranges::distance](../../iterator/ranges/distance.html)(first, last)};
        const int m{static_cast<int>([std::ceil](../../numeric/math/ceil.html)([std::log2](../../numeric/math/log2.html)(1 + size)))};
        for (int i{}; i != m; ++i)
            tier(i, m, first, last);
    }
     
    int main()
    {
        ...
        std::[ranges::make_heap](make_heap.html)(v);
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_heap_until&action=edit&section=6 "Edit section: See also")] See also
