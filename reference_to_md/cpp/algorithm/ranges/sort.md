...
---  
Constrained algorithms, e.g. [`ranges::copy`](copy.html "cpp/algorithm/ranges/copy"), **`ranges::sort`** , ...  
...
constexpr I   
sort( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
...
sort( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [4 Possible implementation](sort.html#Possible_implementation)
  * [5 Notes](sort.html#Notes)
  * [6 Example](sort.html#Example)
  * [7 See also](sort.html#See_also)
    ...
    struct sort_fn
    {
            ...
            operator()(I first, S last, Comp comp = {}, Proj proj = {}) const
        {
            if (first == last)
                return first;
     
            I last_iter = [ranges::next](../../iterator/ranges/next.html)(first, last);
            [ranges::make_heap](make_heap.html)(first, last_iter, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
            [ranges::sort_heap](sort_heap.html)(first, last_iter, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
     
            return last_iter;
        }
     
...
Run this code
    ...
    {
        for ([std::cout](../../io/cout.html) << comment << '\n'; auto const& elem : seq)
            [std::cout](../../io/cout.html) << elem << term;
        [std::cout](../../io/cout.html) << '\n';
    }
     
    struct Particle
    {
        [std::string](../../string/basic_string.html) name; double mass; // MeV
        template<class Os> friend
        Os& operator<<(Os& os, Particle const& p)
        {
            return os << [std::left](../../io/manip/left.html) << [std::setw](../../io/manip/setw.html)(8) << p.name << " : " << p.mass << ' ';
        }
    };
     
    int main()
    {
        [std::array](../../container/array.html) s {5, 7, 4, 2, 8, 6, 1, 9, 0, 3};
     
        namespace ranges = std::ranges;
     
        [ranges::sort](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/sort)(s);
        print("Sort using the default operator<", s);
     
        [ranges::sort](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/sort)(s, [ranges::greater](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/greater)());
    ...
     
        ...
        [ranges::sort](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/sort)(s.begin(), s.end(), customLess);
        print("Sort using a custom function object", s);
     
        [ranges::sort](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/sort)(s, [](int a, int b) { return a > b; });
    ...
     
        ...
        [ranges::sort](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/sort)(particles, {}, &Particle::name);
        print("\nSort by name using a projection", particles, '\n');
        [ranges::sort](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/sort)(particles, {}, &Particle::mass);
