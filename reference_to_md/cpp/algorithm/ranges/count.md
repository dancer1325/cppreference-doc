...
constexpr [std::iter_difference_t](../../iterator/iter_t.html)<I>  
...
<[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>, const T*>  
constexpr [std::iter_difference_t](../../iterator/iter_t.html)<I>  
count( I first, S last, const T& value, Proj proj = {} ); |  |  (since C++26)  
| (2) |   
...
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>, const T*>  
constexpr [ranges::range_difference_t](../../ranges/range_size_t.html)<R>  
count( R&& r, const T& value, Proj proj = {} ); |  |  (since C++26)  
template< [std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
constexpr [std::iter_difference_t](../../iterator/iter_t.html)<I>  
count_if( I first, S last, Pred pred, Proj proj = {} ); |  (3) | (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
...
constexpr [ranges::range_difference_t](../../ranges/range_size_t.html)<R>  
count_if( R&& r, Pred pred, Proj proj = {} ); |  (4)  |  (since C++20)  
| |   
...
---  
    ...
    struct count_fn
    {
        ...
        {
            [std::iter_difference_t](../../iterator/iter_t.html)<I> counter = 0;
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<int> v{1, 2, 3, 4, 4, 3, 7, 8, 9, 10};
     
    ...
     
        ...
        [std::cout](../../io/cout.html) << "number: " << target1 << " count: " << num_items1 << '\n';
        [std::cout](../../io/cout.html) << "number: " << target2 << " count: " << num_items2 << '\n';
     
        // use a lambda expression to count elements divisible by 3.
        int num_items3 = ranges::count_if(v.begin(), v.end(), [](int i){ return i % 3 == 0; });
        [std::cout](../../io/cout.html) << "number divisible by three: " << num_items3 << '\n';
     
        // use a lambda expression to count elements divisible by 11.
        int num_items11 = ranges::count_if(v, [](int i){ return i % 11 == 0; });
        [std::cout](../../io/cout.html) << "number divisible by eleven: " << num_items11 << '\n';
     
        [std::vector](../../container/vector.html)<[std::complex](../../numeric/complex.html)<double>> nums{{4, 2}, {1, 3}, {4, 2}};
        #ifdef __cpp_lib_algorithm_default_value_type
            auto c = ranges::count(nums, {4, 2});
        #else
            auto c = ranges::count(nums, [std::complex](../../numeric/complex.html)<double>{4, 2});
        #endif
