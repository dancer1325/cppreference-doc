...
constexpr I  
nth_element( I first, I nth, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [ranges::random_access_range](../../ranges/random_access_range.html) R,  
class Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less), class Proj = [std::identity](../../utility/functional/identity.html) >  
requires [std::sortable](../../iterator/sortable.html)<iterator_t<R>, Comp, Proj>  
constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>  
nth_element( R&& r, iterator_t<R> nth, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
...
Reorders the elements in `[`first`, `last`)` such that: 
  ...
  * All of the elements before this new `**nth**` element are _less than or equal to_ the elements after the new nth element. That is, for every iterator _i_ , _j_ in the ranges `[`first`, `nth`)`, `[`nth`, `last`)` respectively, the expression [std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *j), [std::invoke](../../utility/functional/invoke.html)(proj, *i)) evaluates to false. 
...
## Contents
  ...
  * [1 Parameters](nth_element.html#Parameters)
  * [2 Return value](nth_element.html#Return_value)
  * [3 Complexity](nth_element.html#Complexity)
  * [4 Notes](nth_element.html#Notes)
  * [5 Possible implementation](nth_element.html#Possible_implementation)
  * [6 Example](nth_element.html#Example)
  * [7 See also](nth_element.html#See_also)
...
Run this code
    ...
    #include <string_view>
     
    void print([std::string_view](../../string/basic_string_view.html) rem, std::[ranges::input_range](../../ranges/input_range.html) auto const& a)
    {
        for ([std::cout](../../io/cout.html) << rem; const auto e : a)
    ...
    int main()
    {
        [std::array](../../container/array.html) v{5, 6, 4, 3, 2, 6, 7, 9, 3};
        print("Before nth_element: ", v);
     
        std::ranges::nth_element(v, v.begin() + v.size() / 2);
        print("After nth_element:  ", v);
        [std::cout](../../io/cout.html) << "The median is: " << v[v.size() / 2] << '\n';
     
        std::ranges::nth_element(v, v.begin() + 1, [std::greater](../../utility/functional/greater.html)<int>());
        print("After nth_element:  ", v);
        [std::cout](../../io/cout.html) << "The second largest element is: " << v[1] << '\n';
        [std::cout](../../io/cout.html) << "The largest element is: " << v[0] << "\n\n";
     
        using namespace std::literals;
        [std::array](../../container/array.html) names
        {
            "Diva"sv, "Cornelius"sv, "Munro"sv, "Rhod"sv,
            "Zorg"sv, "Korben"sv, "Bender"sv, "Leeloo"sv,
        };
        print("Before nth_element: ", names);
        auto fifth_element{std::[ranges::next](../../iterator/ranges/next.html)(names.begin(), 4)};
        std::ranges::nth_element(names, fifth_element);
        print("After nth_element:  ", names);
        [std::cout](../../io/cout.html) << "The 5th element is: " << *fifth_element << '\n';
    }
