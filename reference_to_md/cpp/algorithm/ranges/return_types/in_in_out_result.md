...
## Contents
  ...
  * [1 Template parameters](in_in_out_result.html#Template_parameters)
  * [2 Data members](in_in_out_result.html#Data_members)
  * [3 Member functions](in_in_out_result.html#Member_functions)
  * [4 std::ranges::in_in_out_result::operator in_in_out_result<II1, II2, OO>](in_in_out_result.html#std::ranges::in_in_out_result::operator_in_in_out_result.3CII1.2C_II2.2C_OO.3E)
    * [4.1 Standard library](in_in_out_result.html#Standard_library)
      * [4.1.1 Algorithm functions](in_in_out_result.html#Algorithm_functions)
    * [4.2 Synopsis](in_in_out_result.html#Synopsis)
    * [4.3 Notes](in_in_out_result.html#Notes)
    * [4.4 Example](in_in_out_result.html#Example)
    * [4.5 See also](in_in_out_result.html#See_also)
...
requires [std::convertible_to](../../../concepts/convertible_to.html)<const I1&, II1> &&  
[std::convertible_to](../../../concepts/convertible_to.html)<const I2&, II2> &&  
[std::convertible_to](../../../concepts/convertible_to.html)<const O&, OO>  
constexpr operator in_in_out_result<II1, II2, OO>() const &; |  (1)  |   
---|---|---  
template<class II1, class II2, class OO>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<I1, II1> &&  
[std::convertible_to](../../../concepts/convertible_to.html)<I2, II2> &&  
[std::convertible_to](../../../concepts/convertible_to.html)<O, OO>  
...
Run this code
    ...
    int main()
    {
        ...
        [std::array](../../../container/array.html)<int, [std::size](../../../iterator/size.html)(in1) + [std::size](../../../iterator/size.html)(in2)> out;
     
        const auto result = std::[ranges::merge](../merge.html)(in1, in2, out.begin());
