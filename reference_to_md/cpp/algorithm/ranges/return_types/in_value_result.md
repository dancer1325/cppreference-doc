...
## Contents
  ...
  * [1 Template parameters](in_value_result.html#Template_parameters)
  * [2 Data members](in_value_result.html#Data_members)
  * [3 Member functions](in_value_result.html#Member_functions)
  * [4 std::ranges::in_value_result::operator in_value_result<I2, T2>](in_value_result.html#std::ranges::in_value_result::operator_in_value_result.3CI2.2C_T2.3E)
    * [4.1 Standard library](in_value_result.html#Standard_library)
      * [4.1.1 Algorithm functions](in_value_result.html#Algorithm_functions)
    * [4.2 Synopsis](in_value_result.html#Synopsis)
    * [4.3 Notes](in_value_result.html#Notes)
    * [4.4 Example](in_value_result.html#Example)
    * [4.5 See also](in_value_result.html#See_also)
...
Run this code
    ...
    {
        const auto v = {1, 2, 3};
        const auto ret = std::[ranges::fold_left_with_iter](../fold_left_with_iter.html)(v, 4, [std::plus](../../../utility/functional/plus.html)<>());
        [assert](../../../error/assert.html)(ret.in == v.end());
