...
| [in_out_out_result](in_out_out_result.html "cpp/algorithm/ranges/return types/in out out result")` `  
---  
...
[ranges::in_out_out_result](in_out_out_result.html "cpp/algorithm/ranges/return types/in out out result")  
...
## Contents
  ...
  * [1 Template parameters](in_fun_result.html#Template_parameters)
  * [2 Data members](in_fun_result.html#Data_members)
  * [3 Member functions](in_fun_result.html#Member_functions)
  * [4 std::ranges::in_fun_result::operator in_fun_result<I2, F2>](in_fun_result.html#std::ranges::in_fun_result::operator_in_fun_result.3CI2.2C_F2.3E)
    * [4.1 Standard library](in_fun_result.html#Standard_library)
      * [4.1.1 Algorithm functions](in_fun_result.html#Algorithm_functions)
    * [4.2 Synopsis](in_fun_result.html#Synopsis)
    * [4.3 Notes](in_fun_result.html#Notes)
    * [4.4 Example](in_fun_result.html#Example)
    * [4.5 See also](in_fun_result.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_fun_result&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_fun_result&action=edit&section=2 "Edit section: Data members")] Data members
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_fun_result&action=edit&section=3 "Edit section: Member functions")] Member functions

##  std::ranges::in_fun_result::operator in_fun_result<I2, F2>

template<class I2, class F2>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<const I&, I2> && [std::convertible_to](../../../concepts/convertible_to.html)<const F&, F2>  
constexpr operator in_fun_result<I2, F2>() const &; |  (1)  |   
---|---|---  
template<class I2, class F2>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<I, I2> && [std::convertible_to](../../../concepts/convertible_to.html)<F, F2>  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_fun_result&action=edit&section=4 "Edit section: Standard library")] Standard library
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_fun_result&action=edit&section=5 "Edit section: Synopsis")] Synopsis 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_fun_result&action=edit&section=6 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_fun_result&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        int v[]{1, 2, 3};
     
        const std::ranges::in_fun_result res1 = std::[ranges::for_each_n](../for_each_n.html)(
            v, [std::size](../../../iterator/size.html)(v),
            [](int& x) { return x = -x; } // negating lambda
        );
        [assert](../../../error/assert.html)(res1.in == [std::end](../../../iterator/end.html)(v));
     
        const std::ranges::in_fun_result res2 = std::[ranges::for_each](../for_each.html)(
            [std::begin](../../../iterator/begin.html)(v),
            res1.in,
            [](int x) { [std::cout](../../../io/cout.html) << x << ' '; } // printing lambda
        );
     
        [std::cout](../../../io/cout.html) << "│ ";
     
        std::[ranges::for_each](../for_each.html)(v, res1.fun); // uses negating lambda
        std::[ranges::for_each](../for_each.html)(v, res2.fun); // uses printing lambda
        [std::cout](../../../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_fun_result&action=edit&section=8 "Edit section: See also")] See also
