...
## Contents
  ...
  * [1 Template parameters](in_out_result.html#Template_parameters)
  * [2 Data members](in_out_result.html#Data_members)
  * [3 Member functions](in_out_result.html#Member_functions)
  * [4 std::ranges::in_out_result::operator in_out_result<I2, O2>](in_out_result.html#std::ranges::in_out_result::operator_in_out_result.3CI2.2C_O2.3E)
    * [4.1 Standard library](in_out_result.html#Standard_library)
      * [4.1.1 Algorithm functions](in_out_result.html#Algorithm_functions)
      * [4.1.2 Memory functions](in_out_result.html#Memory_functions)
    * [4.2 Synopsis](in_out_result.html#Synopsis)
    * [4.3 Notes](in_out_result.html#Notes)
    * [4.4 Example](in_out_result.html#Example)
    * [4.5 See also](in_out_result.html#See_also)
...
requires [std::convertible_to](../../../concepts/convertible_to.html)<const I&, I2> && [std::convertible_to](../../../concepts/convertible_to.html)<const O&, O2>  
constexpr operator in_out_result<I2, O2>() const &; |  (1)  |   
---|---|---  
template<class I2, class O2>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<I, I2> && [std::convertible_to](../../../concepts/convertible_to.html)<O, O2>  
...
Run this code
    ...
    int main()
    {
        ...
        [std::array](../../../container/array.html)<char, sizeof(in)> out;
     
        const auto result = std::[ranges::transform](../transform.html)(in, out.begin(),
            [](char c) { return [std::toupper](../../../string/byte/toupper.html)(c); });
     
        auto print = [](char c) { [std::cout](../../../io/cout.html) << c; };
        std::[ranges::for_each](../for_each.html)([std::cbegin](../../../iterator/begin.html)(in), result.in, print);
        std::[ranges::for_each](../for_each.html)(out.cbegin(), result.out, print);
    }
