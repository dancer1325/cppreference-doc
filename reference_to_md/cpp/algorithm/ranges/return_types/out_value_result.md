...
## Contents
  ...
  * [1 Template parameters](out_value_result.html#Template_parameters)
  * [2 Data members](out_value_result.html#Data_members)
  * [3 Member functions](out_value_result.html#Member_functions)
  * [4 std::ranges::out_value_result::operator out_value_result<O2, T2>](out_value_result.html#std::ranges::out_value_result::operator_out_value_result.3CO2.2C_T2.3E)
    * [4.1 Standard library](out_value_result.html#Standard_library)
      * [4.1.1 Algorithm functions](out_value_result.html#Algorithm_functions)
    * [4.2 Synopsis](out_value_result.html#Synopsis)
    * [4.3 Notes](out_value_result.html#Notes)
    * [4.4 Example](out_value_result.html#Example)
    * [4.5 See also](out_value_result.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/out_value_result&action=edit&section=1 "Edit section: Template parameters")] Template parameters

O, T  |  \-  |  the types of the objects that the `ranges::out_value_result` stores.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/out_value_result&action=edit&section=2 "Edit section: Data members")] Data members
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/out_value_result&action=edit&section=3 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/out_value_result&action=edit&section=4 "Edit section: Standard library")] Standard library
...
---  
[ ranges::iota](../iota.html "cpp/algorithm/ranges/iota")(C++23) |  fills a range with successive increments of the starting value  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/out_value_result&action=edit&section=5 "Edit section: Synopsis")] Synopsis
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/out_value_result&action=edit&section=6 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/out_value_result&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::array](../../../container/array.html)<int, 4> a{};
        constexpr [std::array](../../../container/array.html) expected{2, 3, 4, 5};
        const auto result = std::[ranges::iota](../iota.html)(a, 2);
        [assert](../../../error/assert.html)(std::[ranges::distance](../../../iterator/ranges/distance.html)(a.cbegin(), result.out) == 4);
        [assert](../../../error/assert.html)(result.value == 6);
        [assert](../../../error/assert.html)(a == expected);
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/out_value_result&action=edit&section=8 "Edit section: See also")] See also
