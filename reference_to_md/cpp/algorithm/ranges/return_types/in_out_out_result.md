...
|  | [in_fun_result](in_fun_result.html "cpp/algorithm/ranges/return types/in fun result")  
---  
[in_in_result](in_in_result.html "cpp/algorithm/ranges/return types/in in result")  
[in_found_result](in_found_result.html "cpp/algorithm/ranges/return types/in found result")` `  
  
| [in_out_result](in_out_result.html "cpp/algorithm/ranges/return types/in out result")  
---  
[in_in_out_result](in_in_out_result.html "cpp/algorithm/ranges/return types/in in out result")` `  
  
  
  
| **in_out_out_result**` `  
---  
[min_max_result](min_max_result.html "cpp/algorithm/ranges/return types/min max result")  
  
  
  
| [out_value_result](out_value_result.html "cpp/algorithm/ranges/return types/out value result")(C++23)  
---  
[in_value_result](in_value_result.html "cpp/algorithm/ranges/return types/in value result")(C++23)  
...
Return types  
---  
[ranges::in_found_result](in_found_result.html "cpp/algorithm/ranges/return types/in found result")  
[ranges::in_fun_result](in_fun_result.html "cpp/algorithm/ranges/return types/in fun result")  
[ranges::in_in_out_result](in_in_out_result.html "cpp/algorithm/ranges/return types/in in out result")  
[ranges::in_in_result](in_in_result.html "cpp/algorithm/ranges/return types/in in result")  
**ranges::in_out_out_result**  
[ranges::in_out_result](in_out_result.html "cpp/algorithm/ranges/return types/in out result")  
[ranges::in_value_result](in_value_result.html "cpp/algorithm/ranges/return types/in value result")(C++23)  
...
This class template has no base classes or declared members other than those shown below. Thus it is suitable for use with [structured bindings](../../../language/structured_binding.html "cpp/language/structured binding"). 

All special member functions of this class template are implicitly declared, which makes specializations be [aggregate classes](../../../language/aggregate_initialization.html "cpp/language/aggregate initialization"), and propagate triviality, potentially-throwing-ness, and constexpr-ness of corresponding operations on data members. 

## Contents

  * [1 Template parameters](in_out_out_result.html#Template_parameters)
  * [2 Data members](in_out_out_result.html#Data_members)
  * [3 Member functions](in_out_out_result.html#Member_functions)
  * [4 std::ranges::in_out_out_result::operator in_out_out_result<II, OO1, OO2>](in_out_out_result.html#std::ranges::in_out_out_result::operator_in_out_out_result.3CII.2C_OO1.2C_OO2.3E)
    * [4.1 Standard library](in_out_out_result.html#Standard_library)
      * [4.1.1 Algorithm functions](in_out_out_result.html#Algorithm_functions)
    * [4.2 Synopsis](in_out_out_result.html#Synopsis)
    * [4.3 Notes](in_out_out_result.html#Notes)
    * [4.4 Example](in_out_out_result.html#Example)
    * [4.5 See also](in_out_out_result.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_out_out_result&action=edit&section=1 "Edit section: Template parameters")] Template parameters

I, O1, O2  |  \-  |  the types of the objects that the `ranges::in_out_out_result` stores.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_out_out_result&action=edit&section=2 "Edit section: Data members")] Data members
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_out_out_result&action=edit&section=3 "Edit section: Member functions")] Member functions

##  std::ranges::in_out_out_result::operator in_out_out_result<II, OO1, OO2>

template<class II, class OO1, class OO2>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<const I&, II> &&  
[std::convertible_to](../../../concepts/convertible_to.html)<const O1&, OO1> &&  
[std::convertible_to](../../../concepts/convertible_to.html)<const O2&, OO2>  
constexpr operator in_out_out_result<II, OO1, OO2>() const &; |  (1)  |   
---|---|---  
template<class II, class OO1, class OO2>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<I, II> &&  
[std::convertible_to](../../../concepts/convertible_to.html)<O1, OO1> &&  
[std::convertible_to](../../../concepts/convertible_to.html)<O2, OO2>  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_out_out_result&action=edit&section=4 "Edit section: Standard library")] Standard library
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_out_out_result&action=edit&section=5 "Edit section: Synopsis")] Synopsis 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_out_out_result&action=edit&section=6 "Edit section: Notes")] Notes
...
The names for such aliases are formed by adding the suffix "_`_result`_ " to the algorithm's name. So, the return type of `std::ranges::merge` can be named as `std::ranges::merge_result`. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_out_out_result&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    #include <string_view>
     
    void print([std::string_view](../../../string/basic_string_view.html) rem, auto first, auto last)
    {
        for ([std::cout](../../../io/cout.html) << rem << ": { "; first != last; ++first)
            [std::cout](../../../io/cout.html) << *first << ' ';
        [std::cout](../../../io/cout.html) << "}\n";
    }
     
    int main()
    {
        constexpr [std::string_view](../../../string/basic_string_view.html) in {"TvEeNcStOoRr"};
        [std::array](../../../container/array.html)<char, in.size()> o1, o2;
     
        const auto result = std::[ranges::partition_copy](../partition_copy.html)(in, o1.begin(), o2.begin(),
            [](char c) { return [std::isupper](../../../string/byte/isupper.html)(c); });
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_out_out_result&action=edit&section=8 "Edit section: See also")] See also
