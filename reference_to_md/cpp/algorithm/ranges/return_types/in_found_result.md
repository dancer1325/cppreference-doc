...
## Contents
  ...
  * [1 Template parameters](in_found_result.html#Template_parameters)
  * [2 Data members](in_found_result.html#Data_members)
  * [3 Member functions](in_found_result.html#Member_functions)
  * [4 std::ranges::in_found_result::operator in_found_result<I2>](in_found_result.html#std::ranges::in_found_result::operator_in_found_result.3CI2.3E)
    * [4.1 Standard library](in_found_result.html#Standard_library)
      * [4.1.1 Algorithm functions](in_found_result.html#Algorithm_functions)
    * [4.2 Synopsis](in_found_result.html#Synopsis)
    * [4.3 Notes](in_found_result.html#Notes)
    * [4.4 Example](in_found_result.html#Example)
    * [4.5 See also](in_found_result.html#See_also)
...
---|---  
in |  a value (that is supposed to be an iterator) of type `I`. It is declared with `[[[no_unique_address](../../../language/attributes/no_unique_address.html "cpp/language/attributes/no unique address")]]` attribute.   
...
template<class I2>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<const I&, I2>  
constexpr operator in_found_result<I2>() const &; |  (1)  |   
---|---|---  
template<class I2>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<I, I2>  
...
Run this code
    ...
    int main()
    {
        int v[] {1, 2, 3};
     
        const auto result = std::[ranges::next_permutation](../next_permutation.html)(v);
     
        std::[ranges::for_each](../for_each.html)([std::cbegin](../../../iterator/begin.html)(v), result.in, [](int e) {[std::cout](../../../io/cout.html) << e << ' ';});
     
