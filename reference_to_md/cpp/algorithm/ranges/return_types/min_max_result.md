...
## Contents
  ...
  * [1 Template parameters](min_max_result.html#Template_parameters)
  * [2 Data members](min_max_result.html#Data_members)
  * [3 Member functions](min_max_result.html#Member_functions)
  * [4 std::ranges::min_max_result::operator min_max_result<T2>](min_max_result.html#std::ranges::min_max_result::operator_min_max_result.3CT2.3E)
    * [4.1 Standard library](min_max_result.html#Standard_library)
      * [4.1.1 Algorithm functions](min_max_result.html#Algorithm_functions)
    * [4.2 Synopsis](min_max_result.html#Synopsis)
    * [4.3 Notes](min_max_result.html#Notes)
    * [4.4 Example](min_max_result.html#Example)
    * [4.5 See also](min_max_result.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/min_max_result&action=edit&section=1 "Edit section: Template parameters")] Template parameters

T  |  \-  |  the type of the objects or references that the `ranges::min_max_result` stores.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/min_max_result&action=edit&section=2 "Edit section: Data members")] Data members

Member name  |  Definition   
---|---  
min |  may be a reference to, a copy of, or an iterator of type `T` to a minimum element in a range.   
(public member object)  
max |  may be a reference to, a copy of, or an iterator of type `T` to a maximum element in a range   
(public member object)  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/min_max_result&action=edit&section=3 "Edit section: Member functions")] Member functions

##  std::ranges::min_max_result::operator min_max_result<T2>

template<class T2>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<const T&, T2>  
constexpr operator min_max_result<T2>() const &; |  (1)  |   
---|---|---  
template<class T2>  
requires [std::convertible_to](../../../concepts/convertible_to.html)<T, T2>  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/min_max_result&action=edit&section=4 "Edit section: Standard library")] Standard library
...
[ ranges::minmax_element](../minmax_element.html "cpp/algorithm/ranges/minmax element")(C++20) |  returns the smallest and the largest elements in a range  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/min_max_result&action=edit&section=5 "Edit section: Synopsis")] Synopsis 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/min_max_result&action=edit&section=6 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/min_max_result&action=edit&section=7 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        {
            constexpr auto result = std::[ranges::minmax](../minmax.html)(v);
            static_assert(1 == result.min && 9 == result.max);
        }
        {
            constexpr auto result = std::[ranges::minmax_element](../minmax_element.html)(v);
            static_assert(1 == *result.min && 9 == *result.max);
        }
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/min_max_result&action=edit&section=8 "Edit section: See also")] See also
