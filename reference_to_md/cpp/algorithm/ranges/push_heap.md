...
constexpr I push_heap( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
...
push_heap( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
  
Inserts the last element in the specified range into a [heap](../../algorithm.html#Heap_operations "cpp/algorithm") with respect to comp and proj, where the heap consists of all elements in the range except the last. The heap after the insertion will be the entire range. 
...
## Contents
  ...
  * [1 Parameters](push_heap.html#Parameters)
  * [2 Return value](push_heap.html#Return_value)
  * [3 Complexity](push_heap.html#Complexity)
  * [4 Possible implementation](push_heap.html#Possible_implementation)
  * [5 Example](push_heap.html#Example)
  * [6 See also](push_heap.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/push_heap&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to modify   
---|---|---  
r  |  \-  |  the [`range`](../../ranges/range.html "cpp/ranges/range") of elements to modify   
comp  |  \-  |  comparator to apply to the projected elements   
proj  |  \-  |  projection to apply to the elements   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/push_heap&action=edit&section=2 "Edit section: Return value")] Return value

1) last

2) [ranges::end](../../ranges/end.html)(r)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/push_heap&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/push_heap&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct push_heap_fn
    {
        ...
        {
            const auto n{[ranges::distance](../../iterator/ranges/distance.html)(first, last)};
            const auto length{n};
            if (n > 1)
            {
                I last{first + n};
                n = (n - 2) / 2;
                I i{first + n};
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *i), [std::invoke](../../utility/functional/invoke.html)(proj, *--last)))
                {
                    [std::iter_value_t](../../iterator/iter_t.html)<I> v {[ranges::iter_move](../../iterator/ranges/iter_move.html)(last)};
                    do
                    {
                        *last = [ranges::iter_move](../../iterator/ranges/iter_move.html)(i);
                        last = i;
                        if (n == 0)
                            break;
                        n = (n - 1) / 2;
                    ...
                    while ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *i), [std::invoke](../../utility/functional/invoke.html)(proj, v)));
                    *last = std::move(v);
                }
            }
            return first + length;
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/push_heap&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        const int m{static_cast<int>([std::ceil](../../numeric/math/ceil.html)([std::log2](../../numeric/math/log2.html)(1 + v.size())))};
        auto first{v.cbegin()};
        for (int i{}; i != m; ++i)
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<int> v{1, 6, 1, 8, 0, 3,};
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/push_heap&action=edit&section=6 "Edit section: See also")] See also
