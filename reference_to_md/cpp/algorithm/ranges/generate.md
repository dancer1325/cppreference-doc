...
constexpr O  
generate( O first, S last, F gen ); |  (1)  |  (since C++20)  
template< class R, [std::copy_constructible](../../concepts/copy_constructible.html) F >  
requires [std::invocable](../../concepts/invocable.html)<F&> && [ranges::output_range](../../ranges/output_range.html)<R, [std::invoke_result_t](../../types/result_of.html)<F&>>  
constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>  
generate( R&& r, F gen ); |  (2)  |  (since C++20)  
| |   
  
1) Assigns the result of _successive_ invocations of the function object gen to each element in the range `[`first`, `last`)`.
...
## Contents
  ...
  * [1 Parameters](generate.html#Parameters)
  * [2 Return value](generate.html#Return_value)
  * [3 Complexity](generate.html#Complexity)
  * [4 Possible implementation](generate.html#Possible_implementation)
  * [5 Example](generate.html#Example)
  * [6 See also](generate.html#See_also)
...
### Possible implementation
    ...
    struct generate_fn
    {
        ...
        {
            for (; first != last; *first = [std::invoke](../../utility/functional/invoke.html)(gen), ++first)
            {}
            return first;
        }
     
        template<class R, [std::copy_constructible](../../concepts/copy_constructible.html) F>
        requires [std::invocable](../../concepts/invocable.html)<F&> && [ranges::output_range](../../ranges/output_range.html)<R, [std::invoke_result_t](../../types/result_of.html)<F&>>
        constexpr [ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R> operator()(R&& r, F gen) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), std::move(gen));
        }
    };
     
...
Run this code
    ...
    auto dice()
    {
        ...
        static [std::random_device](../../numeric/random/random_device.html) device;
        static [std::mt19937](../../numeric/random/mersenne_twister_engine.html) engine {device()};
        return distr(engine);
    }
     
    ...
     
    void print([std::string_view](../../string/basic_string_view.html) comment, const auto& v)
    {
        for ([std::cout](../../io/cout.html) << comment; int i : v)
