...
2) Same as (1), but uses r1 and r2 as the source ranges, as if using [ranges::begin](../../ranges/begin.html)(r1) as first1, [ranges::begin](../../ranges/begin.html)(r2) as first2, [ranges::end](../../ranges/end.html)(r1) as last1, and [ranges::end](../../ranges/end.html)(r2) as last2.
...
## Contents
  ...
  * [3 Complexity](starts_with.html#Complexity)
  * [4 Possible implementation](starts_with.html#Possible_implementation)
  * [5 Notes](starts_with.html#Notes)
  * [6 Example](starts_with.html#Example)
  * [7 See also](starts_with.html#See_also)
...
first2, last2  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to be used as the prefix   
...
### Possible implementation
    ...
    struct starts_with_fn
    {
        ...
        {
            return [ranges::mismatch](mismatch.html)(std::move(first1), last1, std::move(first2), last2,
...
Run this code
    ...
     
        ...
        static_assert(std::ranges::starts_with(v, std::[views::iota](../../ranges/iota_view.html)(1)
                                                | std::[views::filter](../../ranges/filter_view.html)(odd)
