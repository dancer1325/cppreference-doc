...
constexpr I make_heap( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
...
make_heap( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
  
Constructs a [heap](../../algorithm.html#Heap_operations "cpp/algorithm") with respect to comp and proj from the elements in the specified range. 
...
## Contents
  ...
  * [2 Return value](make_heap.html#Return_value)
  * [3 Complexity](make_heap.html#Complexity)
  * [4 Example](make_heap.html#Example)
  * [5 See also](make_heap.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/make_heap&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/make_heap&action=edit&section=2 "Edit section: Return value")] Return value

1) last

2) [ranges::end](../../ranges/end.html)(r)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/make_heap&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/make_heap&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html) h{1, 6, 1, 8, 0, 3, 3, 9, 8, 8, 7, 4, 9, 8, 9};
        print("source: ", h);
     
        ...
        draw_heap(h);
     
        std::ranges::make_heap(h, [std::greater](../../utility/functional/greater.html){});
        print("\n" "min-heap: ", h);
        draw_heap(h);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/make_heap&action=edit&section=5 "Edit section: See also")] See also
