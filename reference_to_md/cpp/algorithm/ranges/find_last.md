...
---  
**find_last find_last_iffind_last_if_not**(C++23)(C++23)(C++23)` `  
...
find_last( I first, S last, const T& value, Proj proj = {} ); |  | (since C++23)   
(until C++26)  
template< [std::forward_iterator](../../iterator/forward_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
<[ranges::equal_to](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/equal_to), std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>, const T*>  
constexpr [ranges::subrange](../../ranges/subrange.html)<I>  
find_last( I first, S last, const T& value, Proj proj = {} ); |  |  (since C++26)  
| (2) |   
...
find_last( R&& r, const T& value, Proj proj = {} ); |  | (since C++23)   
(until C++26)  
template< [ranges::forward_range](../../ranges/forward_range.html) R,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>, const T*>  
constexpr [ranges::borrowed_subrange_t](../../ranges/borrowed_iterator_t.html)<R>  
find_last( R&& r, const T& value, Proj proj = {} ); |  |  (since C++26)  
template< [std::forward_iterator](../../iterator/forward_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
## Contents
  ...
  * [1 Parameters](find_last.html#Parameters)
  * [2 Return value](find_last.html#Return_value)
  * [3 Complexity](find_last.html#Complexity)
  * [4 Notes](find_last.html#Notes)
  * [5 Possible implementation](find_last.html#Possible_implementation)
  * [6 Example](find_last.html#Example)
  * [7 See also](find_last.html#See_also)
...
Returns [ranges::subrange](../../ranges/subrange.html)<I>{i, last}, or [ranges::subrange](../../ranges/subrange.html)<I>{last, last} if no such iterator is found.

1) E is bool([std::invoke](../../utility/functional/invoke.html)(proj, *i) == value).

3) E is bool([std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *i))).

5) E is bool(![std::invoke](../../utility/functional/invoke.html)(pred, [std::invoke](../../utility/functional/invoke.html)(proj, *i))).
...
---|---|---|---  
[`__cpp_lib_ranges_find_last`](../../experimental/feature_test.html#cpp_lib_ranges_find_last "cpp/feature test") | [`202207L`](../../compiler_support/23.html#cpp_lib_ranges_find_last_202207L "cpp/compiler support/23") | (C++23) | `ranges::find_last`,  
`ranges::find_last_if`,  
...
[find_last (1,2)](find_last.html#Version_1)  
---  
    ...
    struct find_last_fn
    {
            ...
            operator()(I first, S last, const T &value, Proj proj = {}) const
        {
            ...
            [std::optional](../../utility/optional.html)<I> found;
    ...
     
            if (!found)
                return {first, first};
     
            return {*found, std::[ranges::next](../../iterator/ranges/next.html)(*found, last)};
        }
     
        template<[ranges::forward_range](../../ranges/forward_range.html) R,
                 class Proj = [std::identity](../../utility/functional/identity.html),
        ...
        {
            return this->operator()([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), value, [std::ref](../../utility/functional/ref.html)(proj));
        }
    };
     
    inline constexpr find_last_fn find_last;  
  
[find_last_if (3,4)](find_last.html#Version_3)  
    ...
     
        ...
        {
            return this->operator()([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r),
...
[find_last_if_not (5,6)](find_last.html#Version_5)  
...
Run this code
    ...
     
        {
            ...
            static_assert([ranges::distance](../../iterator/ranges/distance.html)(v.begin(), i1.begin()) == 5);
            static_assert([ranges::distance](../../iterator/ranges/distance.html)(v.begin(), i2.begin()) == 5);
        }
        {
            constexpr auto i1 = ranges::find_last(v.begin(), v.end(), -3);
            constexpr auto i2 = ranges::find_last(v, -3);
    ...
     
        using P = [std::pair](../../utility/pair.html)<[std::string_view](../../string/basic_string_view.html), int>;
        [std::forward_list](../../container/forward_list.html)<P> list
        {
            {"one", 1}, {"two", 2}, {"three", 3},
            {"one", 4}, {"two", 5}, {"three", 6},
        };
        auto cmp_one = [](const [std::string_view](../../string/basic_string_view.html) &s) { return s == "one"; };
     
    ...
     
        [std::cout](../../io/cout.html) << "The found element and the tail after it are:\n";
        for (P const& e : subrange)
            [std::cout](../../io/cout.html) << '{' << [std::quoted](../../io/manip/quoted.html)(e.first) << ", " << e.second << "} ";
    ...
    #endif
        [assert](../../error/assert.html)(i3.begin()->first == "three" && i3.begin()->second == 3);
    }
