...
## Contents
  ...
  * [1 Parameters](max_element.html#Parameters)
  * [2 Return value](max_element.html#Return_value)
  * [3 Complexity](max_element.html#Complexity)
  * [4 Possible implementation](max_element.html#Possible_implementation)
  * [5 Example](max_element.html#Example)
  * [6 See also](max_element.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max_element&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max_element&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max_element&action=edit&section=3 "Edit section: Complexity")] Complexity

Exactly max(N - 1, 0) comparisons, where N = [ranges::distance](../../iterator/ranges/distance.html)(first, last). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max_element&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
     
            auto largest = first;
            while (++first != last)
                if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, *largest), [std::invoke](../../utility/functional/invoke.html)(proj, *first)))
                    largest = first;
            return largest;
        }
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max_element&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html) << "Max element at pos " << [ranges::distance](../../iterator/ranges/distance.html)(v.begin(), result) << '\n';
     
        auto abs_compare = [](int a, int b) { return std::abs(a) < std::abs(b); };
        result = ranges::max_element(v, abs_compare);
        [std::cout](../../io/cout.html) << "Absolute max element at pos "
                  << [ranges::distance](../../iterator/ranges/distance.html)(v.begin(), result) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/max_element&action=edit&section=6 "Edit section: See also")] See also
