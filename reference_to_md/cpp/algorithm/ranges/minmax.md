...
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<const T*, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr ranges::minmax_result<const T&>  
minmax( const T& a, const T& b, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [std::copyable](../../concepts/copyable.html) T, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<const T*, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr ranges::minmax_result<T>  
minmax( [std::initializer_list](../../utility/initializer_list.html)<T> r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
requires [std::indirectly_copyable_storable](../../iterator/indirectly_copyable_storable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, [ranges::range_value_t](../../ranges/range_size_t.html)<R>*>  
constexpr ranges::minmax_result<[ranges::range_value_t](../../ranges/range_size_t.html)<R>>  
minmax( R&& r, Comp comp = {}, Proj proj = {} ); |  (3)  |  (since C++20)  
Helper types |  |   
template< class T >  
using minmax_result = [ranges::min_max_result](return_types/min_max_result.html)<T>; |  (4)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](minmax.html#Parameters)
  * [2 Return value](minmax.html#Return_value)
  * [3 Complexity](minmax.html#Complexity)
  * [4 Possible implementation](minmax.html#Possible_implementation)
  * [5 Notes](minmax.html#Notes)
  * [6 Example](minmax.html#Example)
  * [7 See also](minmax.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/minmax&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/minmax&action=edit&section=2 "Edit section: Return value")] Return value

1) {b, a} if, according to their respective projected value, b is smaller than a; otherwise it returns {a, b}.

2,3) {s, l}, where `s` and `l` are respectively the smallest and largest values in r, according to their projected value. If several values are equivalent to the smallest and largest, returns the leftmost smallest value, and the rightmost largest value. If the range is empty (as determined by [ranges::distance](../../iterator/ranges/distance.html)(r)), the behavior is undefined.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/minmax&action=edit&section=3 "Edit section: Complexity")] Complexity

1) Exactly one comparison and two applications of the projection.

2,3) At most 3 / 2 * [ranges::distance](../../iterator/ranges/distance.html)(r) comparisons and twice as many applications of the projection.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/minmax&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct minmax_fn
    {
        ...
        {
            if ([std::invoke](../../utility/functional/invoke.html)(comp, [std::invoke](../../utility/functional/invoke.html)(proj, b), [std::invoke](../../utility/functional/invoke.html)(proj, a)))
                return {b, a};
     
            return {a, b};
        }
     
        template<[std::copyable](../../concepts/copyable.html) T, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<
                     std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<const T*, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less)>
        constexpr ranges::minmax_result<T>
            operator()([std::initializer_list](../../utility/initializer_list.html)<T> r, Comp comp = {}, Proj proj = {}) const
        {
            auto result = [ranges::minmax_element](minmax_element.html)(r, [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
    ...
     
        template<[ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<
                     std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less)>
        requires [std::indirectly_copyable_storable](../../iterator/indirectly_copyable_storable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>,
                                                   [ranges::range_value_t](../../ranges/range_size_t.html)<R>*>
        constexpr ranges::minmax_result<[ranges::range_value_t](../../ranges/range_size_t.html)<R>>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/minmax&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/minmax&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        constexpr [std::array](../../container/array.html) v{3, 1, 4, 1, 5, 9, 2, 6, 5};
     
        [std::random_device](../../numeric/random/random_device.html) rd;
        [std::mt19937_64](../../numeric/random/mersenne_twister_engine.html) generator(rd());
        [std::uniform_int_distribution](../../numeric/random/uniform_int_distribution.html)<> distribution(0, [ranges::distance](../../iterator/ranges/distance.html)(v)); // [0..9]
     
    ...
     
        [std::cout](../../io/cout.html) << "v[" << bounds.min << ":" << bounds.max << "]: ";
        for (int i = bounds.min; i < bounds.max; ++i)
            [std::cout](../../io/cout.html) << v[i] << ' ';
        [std::cout](../../io/cout.html) << '\n';
     
        auto [min, max] = ranges::minmax(v);
        [std::cout](../../io/cout.html) << "smallest: " << min << ", " << "largest: " << max << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/minmax&action=edit&section=7 "Edit section: See also")] See also
