...
for_each( I first, S last, Fun f, Proj proj = {} ); |  (1)  |  (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),  
[std::indirectly_unary_invocable](../../iterator/indirectly_unary_invocable.html)<  
std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Fun >  
constexpr for_each_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, Fun>  
for_each( R&& r, Fun f, Proj proj = {} ); |  (2)  |  (since C++20)  
Helper types |  |   
template< class I, class F >  
using for_each_result = [ranges::in_fun_result](return_types/in_fun_result.html)<I, F>; |  (3)  |  (since C++20)  
| |   
    ...
    struct for_each_fn
    {
            ...
            operator()(I first, S last, Fun f, Proj proj = {}) const
        {
            for (; first != last; ++first)
                [std::invoke](../../utility/functional/invoke.html)(f, [std::invoke](../../utility/functional/invoke.html)(proj, *first));
            return {std::move(first), std::move(f)};
        }
     
        template<[ranges::input_range](../../ranges/input_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirectly_unary_invocable](../../iterator/indirectly_unary_invocable.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>,
                 Proj>> Fun>
        constexpr ranges::for_each_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, Fun>
            operator()(R&& r, Fun f, Proj proj = {}) const
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), std::move(f), [std::ref](../../utility/functional/ref.html)(proj));
        }
    };
     
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<int> nums {3, 4, 2, 8, 15, 267};
     
        auto print = [](const auto& n) { [std::cout](../../io/cout.html) << ' ' << n; };
     
        namespace ranges = std::ranges;
        [std::cout](../../io/cout.html) << "before:";
        ranges::for_each([std::as_const](../../utility/as_const.html)(nums), print);
        print('\n');
     
    ...
     
        ...
        [assert](../../error/assert.html)(i == nums.end());
     
    ...
     
        using pair = [std::pair](../../utility/pair.html)<int, [std::string](../../string/basic_string.html)>; 
        [std::vector](../../container/vector.html)<pair> pairs {{1,"one"}, {2,"two"}, {3,"tree"}};
     
        [std::cout](../../io/cout.html) << "project the pair::first: ";
