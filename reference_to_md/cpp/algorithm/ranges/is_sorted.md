...
[std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<I, Proj>>  
Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr bool  
is_sorted( I first, S last, Comp comp = {}, Proj proj = {} ); |  (1)  |  (since C++20)  
...
Comp = [ranges::less](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/less) >  
constexpr bool  
is_sorted( R&& r, Comp comp = {}, Proj proj = {} ); |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](is_sorted.html#Parameters)
  * [2 Return value](is_sorted.html#Return_value)
  * [3 Complexity](is_sorted.html#Complexity)
  * [4 Possible implementation](is_sorted.html#Possible_implementation)
  * [5 Notes](is_sorted.html#Notes)
  * [6 Example](is_sorted.html#Example)
  * [7 See also](is_sorted.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_sorted&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the iterator-sentinel pair defining the [range](../../iterator.html#Ranges "cpp/iterator") of elements to check if it is sorted   
---|---|---  
r  |  \-  |  the range of elements to check if it is sorted   
comp  |  \-  |  comparison function to apply to the projected elements   
proj  |  \-  |  projection to apply to the elements   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_sorted&action=edit&section=2 "Edit section: Return value")] Return value

true if the elements in the range are sorted according to `comp`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_sorted&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in the distance between first and last. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_sorted&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct is_sorted_fn
    {
        ...
        {
            return [ranges::is_sorted_until](is_sorted_until.html)(first, last, comp, proj) == last;
        }
     
        template<[ranges::forward_range](../../ranges/forward_range.html) R, class Proj = [std::identity](../../utility/functional/identity.html),
                 [std::indirect_strict_weak_order](../../iterator/indirect_strict_weak_order.html)<
        ...
        {
            return (*this)([ranges::begin](../../ranges/begin.html)(r), [ranges::end](../../ranges/end.html)(r), [std::ref](../../utility/functional/ref.html)(comp), [std::ref](../../utility/functional/ref.html)(proj));
        }
    };
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_sorted&action=edit&section=5 "Edit section: Notes")] Notes

`ranges::is_sorted` returns true for empty ranges and ranges of length one. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_sorted&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::array](../../container/array.html) digits {3, 1, 4, 1, 5};
     
        [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(digits, [std::ostream_iterator](../../iterator/ostream_iterator.html)<int>([std::cout](../../io/cout.html), " "));
        ranges::is_sorted(digits)
            ? [std::cout](../../io/cout.html) << ": sorted\n"
            : [std::cout](../../io/cout.html) << ": not sorted\n";
     
        [ranges::sort](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/sort)(digits);
     
        [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(digits, [std::ostream_iterator](../../iterator/ostream_iterator.html)<int>([std::cout](../../io/cout.html), " "));
        ranges::is_sorted([ranges::begin](../../ranges/begin.html)(digits), [ranges::end](../../ranges/end.html)(digits))
            ? [std::cout](../../io/cout.html) << ": sorted\n"
            : [std::cout](../../io/cout.html) << ": not sorted\n";
     
        [ranges::reverse](reverse.html)(digits);
     
        [ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(digits, [std::ostream_iterator](../../iterator/ostream_iterator.html)<int>([std::cout](../../io/cout.html), " "));
        ranges::is_sorted(digits, [ranges::greater](http://en.cppreference.com/w/cpp/ranges-functional-placeholder/greater) {})
            ? [std::cout](../../io/cout.html) << ": sorted (with 'greater')\n"
            : [std::cout](../../io/cout.html) << ": not sorted\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/is_sorted&action=edit&section=7 "Edit section: See also")] See also

[ ranges::is_sorted_until](is_sorted_until.html "cpp/algorithm/ranges/is sorted until")(C++20) |  finds the largest sorted subrange  
