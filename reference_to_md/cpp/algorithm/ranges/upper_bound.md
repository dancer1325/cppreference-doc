...
## Contents
  ...
  * [7 See also](upper_bound.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/upper_bound&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/upper_bound&action=edit&section=2 "Edit section: Return value")] Return value

Iterator pointing to the first element that is _greater_ than value, or last if no such element is found. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/upper_bound&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/upper_bound&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    struct upper_bound_fn
    {
                               ...
                               Comp comp = {}, Proj proj = {}) const
        {
            ...
            count = [ranges::distance](../../iterator/ranges/distance.html)(first, last);
     
            while (count > 0)
            {
                it = first; 
                ...
                if (!comp(value, [std::invoke](../../utility/functional/invoke.html)(proj, *it)))
                {
                    first = ++it;
                    count -= step + 1;
                }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/upper_bound&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/upper_bound&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::vector](../../container/vector.html)<int> data{1, 1, 2, 3, 3, 3, 3, 4, 4, 4, 5, 5, 6};
     
        {
            auto lower = [ranges::lower_bound](lower_bound.html)(data.begin(), data.end(), 4);
    ...
     
        ...
        {
            auto lower = [ranges::lower_bound](lower_bound.html)(data, 3);
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/upper_bound&action=edit&section=7 "Edit section: See also")] See also
