...
---  
Constrained algorithms, e.g. **`ranges::copy`** , [`ranges::sort`](sort.html "cpp/algorithm/ranges/sort"), ...  
...
copy( I first, S last, O result ); |  (1) | (since C++20)  
...
constexpr copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>  
copy( R&& r, O result ); |  (2)  |  (since C++20)  
template< [std::input_iterator](../../iterator/input_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,  
...
copy_if( I first, S last, O result, Pred pred, Proj proj = {} ); |  (3) | (since C++20)  
template< [ranges::input_range](../../ranges/input_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,  
class Proj = [std::identity](../../utility/functional/identity.html),  
...
requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>  
constexpr copy_if_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>  
copy_if( R&& r, O result, Pred pred, Proj proj = {} ); |  (4)  |  (since C++20)  
Helper types |  |   
template< class I, class O >  
using copy_result = [ranges::in_out_result](return_types/in_out_result.html)<I, O>; |  (5)  |  (since C++20)  
template< class I, class O >  
using copy_if_result = [ranges::in_out_result](return_types/in_out_result.html)<I, O>; |  (6)  |  (since C++20)  
| |   
  
Copies the elements in the range, defined by `[`first`, `last`)`, to another range beginning at result. 

1) Copies all elements in the range `[`first`, `last`)` starting from first and proceeding to last - 1. The behavior is undefined if result is within the range `[`first`, `last`)`. In this case, [ranges::copy_backward](copy_backward.html "cpp/algorithm/ranges/copy backward") may be used instead.
...
## Contents
  ...
  * [6 Example](copy.html#Example)
  * [7 See also](copy.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy&action=edit&section=2 "Edit section: Return value")] Return value

A [ranges::in_out_result](return_types/in_out_result.html "cpp/algorithm/ranges/return types/in out result") containing an input iterator equal to last and an output iterator past the last element copied. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy&action=edit&section=4 "Edit section: Notes")] Notes

In practice, implementations of `ranges::copy` avoid multiple assignments and use bulk copy functions such as [std::memmove](../../string/byte/memmove.html "cpp/string/byte/memmove") if the value type is [TriviallyCopyable](../../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable") and the iterator types satisfy [`contiguous_iterator`](../../iterator/contiguous_iterator.html "cpp/iterator/contiguous iterator"). 

When copying overlapping ranges, `ranges::copy` is appropriate when copying to the left (beginning of the destination range is outside the source range) while [`ranges::copy_backward`](copy_backward.html "cpp/algorithm/ranges/copy backward") is appropriate when copying to the right (end of the destination range is outside the source range). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy&action=edit&section=5 "Edit section: Possible implementation")] Possible implementation

[copy (1)(2)](copy.html#Version_1)  
---  
    ...
     
        template<[ranges::input_range](../../ranges/input_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O>
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>
        constexpr ranges::copy_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>
...
[copy_if (3)(4)](copy.html#Version_3)  
    ...
     
        template<[ranges::input_range](../../ranges/input_range.html) R, [std::weakly_incrementable](../../iterator/weakly_incrementable.html) O,
                 ...
                 [std::indirect_unary_predicate](../../iterator/indirect_unary_predicate.html)<
                     std::[projected](http://en.cppreference.com/w/cpp/ranges-placeholder/iterator/projected)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, Proj>> Pred>
        requires [std::indirectly_copyable](../../iterator/indirectly_copyable.html)<[ranges::iterator_t](../../ranges/iterator_t.html)<R>, O>
        constexpr ranges::copy_if_result<[ranges::borrowed_iterator_t](../../ranges/borrowed_iterator_t.html)<R>, O>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy&action=edit&section=6 "Edit section: Example")] Example

The following code uses `ranges::copy` to both copy the contents of one [std::vector](../../container/vector.html "cpp/container/vector") to another and to display the resulting `std::vector`.
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<int> source(10);
        [std::iota](../iota.html)(source.begin(), source.end(), 0);
        [std::vector](../../container/vector.html)<int> destination;
        std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(source.begin(), source.end(), [std::back_inserter](../../iterator/back_inserter.html)(destination));
     
    // or, alternatively,
    ...
     
        [std::cout](../../io/cout.html) << "Destination contains: ";
        std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(destination, [std::ostream_iterator](../../iterator/ostream_iterator.html)<int>([std::cout](../../io/cout.html), " "));
        [std::cout](../../io/cout.html) << '\n';
     
        [std::cout](../../io/cout.html) << "Odd numbers in destination are: ";
        std::[ranges::copy_if](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(destination, [std::ostream_iterator](../../iterator/ostream_iterator.html)<int>([std::cout](../../io/cout.html), " "),
                             [](int x) { return (x % 2) == 1; });
        [std::cout](../../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/copy&action=edit&section=7 "Edit section: See also")] See also
