...
## Contents
  ...
  * [4 Exceptions](set_symmetric_difference.html#Exceptions)
  * [5 Possible implementation](set_symmetric_difference.html#Possible_implementation)
  * [6 Example](set_symmetric_difference.html#Example)
  * [7 Defect reports](set_symmetric_difference.html#Defect_reports)
  * [8 See also](set_symmetric_difference.html#See_also)
...
---|---|---  
first2, last2  |  \-  |  the pair of iterators defining the second sorted [range](../iterator.html#Ranges "cpp/iterator") of elements   
...
[set_symmetric_difference (3)](set_symmetric_difference.html#Version_3)  
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html)<int> v1{1, 2, 3, 4, 5, 6, 7, 8};
        [std::vector](../container/vector.html)<int> v2{5, 7, 9, 10};
        [std::sort](sort.html)(v1.begin(), v1.end());
        [std::sort](sort.html)(v2.begin(), v2.end());
     
        [std::vector](../container/vector.html)<int> v_symDifference;
     
        std::set_symmetric_difference(v1.begin(), v1.end(), v2.begin(), v2.end(),
                                      [std::back_inserter](../iterator/back_inserter.html)(v_symDifference));
     
