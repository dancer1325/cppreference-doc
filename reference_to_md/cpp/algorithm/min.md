...
template< class T >  
T min( [std::initializer_list](../utility/initializer_list.html)<T> ilist ); |  (3) | (since C++11)   
(constexpr since C++14)  
template< class T, class Compare >  
T min( [std::initializer_list](../utility/initializer_list.html)<T> ilist, Compare comp ); |  (4) | (since C++11)   
(constexpr since C++14)  
| |   
...
## Contents
  ...
  * [7 Defect reports](min.html#Defect_reports)
  * [8 See also](min.html#See_also)
...
cmp  |  \-  |  comparison function object (i.e. an object that satisfies the requirements of [Compare](../named_req/Compare.html "cpp/named req/Compare")) which returns true if a is _less_ than b.  
...
[min (3)](min.html#Version_3)  
      
    
    template<class T>
    T min([std::initializer_list](../utility/initializer_list.html)<T> ilist)
    {
        return *[std::min_element](min_element.html)(ilist.begin(), ilist.end());
    }  
  
[min (4)](min.html#Version_4)  
      
    
    template<class T, class Compare>
    T min([std::initializer_list](../utility/initializer_list.html)<T> ilist, Compare comp)
    {
...
Run this code
    ...
    int main()
    {
        [std::cout](../io/cout.html) << "smaller of 10 and 010 is " << std::min(10, 010) << '\n'
                  << "smaller of 'd' and 'b' is '" << std::min('d', 'b') << "'\n"
                  << "shortest of \"foo\", \"bar\", and \"hello\" is \""
                  << std::min({"foo", "bar", "hello"},
                              [](const [std::string_view](../string/basic_string_view.html) s1, const [std::string_view](../string/basic_string_view.html) s2)
                              {
...
---|---|---|---  
[LWG 281](https://cplusplus.github.io/LWG/issue281) | C++98  | `T` was required to be [CopyConstructible](../named_req/CopyConstructible.html "cpp/named req/CopyConstructible") for overloads ([1,2](min.html#Version_1)) | not required   
...
overloads ([2](min.html#Version_2)) (C++98) and ([4](min.html#Version_4)) (C++11)  
