...
If *first is not [writable](../iterator.html#Types_and_writability "cpp/iterator") to d_first_true or d_first_false, the program is ill-formed. 
...
## Contents
  ...
  * [4 Exceptions](partition_copy.html#Exceptions)
  * [5 Possible implementation](partition_copy.html#Possible_implementation)
  * [6 Example](partition_copy.html#Example)
  * [7 Defect reports](partition_copy.html#Defect_reports)
  * [8 See also](partition_copy.html#See_also)
...
-`OutputIt1, OutputIt2` must meet the requirements of [LegacyOutputIterator](../named_req/OutputIterator.html "cpp/named req/OutputIterator").   
...
Run this code
    ...
    {
        for ([std::cout](../io/cout.html) << rem; const auto& x : v)
    ...
    int main()
    {
        ...
        int false_arr[5] = {0};
     
        std::partition_copy([std::begin](../iterator/begin.html)(arr), [std::end](../iterator/end.html)(arr),
                            [std::begin](../iterator/begin.html)(true_arr), [std::begin](../iterator/begin.html)(false_arr),
                            [](int i) { return 4 < i; });
     
...
was required to be [CopyAssignable](../named_req/CopyAssignable.html "cpp/named req/CopyAssignable")  
