...
OutputIt inclusive_scan( InputIt first, InputIt last,  
OutputIt d_first, BinaryOp op ); |  (3) | (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy,  
class ForwardIt1, class ForwardIt2, class BinaryOp >  
ForwardIt2 inclusive_scan( ExecutionPolicy&& policy,  
ForwardIt1 first, ForwardIt1 last,  
ForwardIt2 d_first, BinaryOp op ); |  (4)  |  (since C++17)  
template< class InputIt, class OutputIt,  
class BinaryOp, class T >  
OutputIt inclusive_scan( InputIt first, InputIt last,  
OutputIt d_first, BinaryOp op, T init ); |  (5) | (since C++17)   
(constexpr since C++20)  
template< class ExecutionPolicy,  
class ForwardIt1, class ForwardIt2,  
class BinaryOp, class T >  
ForwardIt2 inclusive_scan( ExecutionPolicy&& policy,  
ForwardIt1 first, ForwardIt1 last,  
ForwardIt2 d_first, BinaryOp op, T init ); |  (6)  |  (since C++17)  
| |   
  
1) Equivalent to inclusive_scan(first, last, d_first, [std::plus](../utility/functional/plus.html)<>().

3) Computes the inclusive prefix sum using op.

For each integer i in `[`​0​`, `[std::distance](../iterator/distance.html)(first, last)`)`, performs the following operations in order: 

  1. Creates a sequence which is formed by the elements of `[`first`, `iter`]` in order, where iter is the next ith iterator of first. 
...
The _generalized, noncommutative sum_ of a sequence of elements over a binary operation binary_op is defined as follows: 
...
Given binary_op as the actual binary operation: 
  ...
  * For overloads (1-4), if binary_op(*first, *first) is not convertible to the [value type](../iterator.html#Types_and_writability "cpp/iterator") of decltype(first), the program is ill-formed. 
  ...
  * For overloads (1-4), the value type of decltype(first) is not [MoveConstructible](../named_req/MoveConstructible.html "cpp/named req/MoveConstructible"). 
  * For overloads (5,6), `T` is not [MoveConstructible](../named_req/MoveConstructible.html "cpp/named req/MoveConstructible"). 
...
## Contents
  ...
  * [1 Parameters](inclusive_scan.html#Parameters)
  * [2 Return value](inclusive_scan.html#Return_value)
  * [3 Complexity](inclusive_scan.html#Complexity)
  * [4 Exceptions](inclusive_scan.html#Exceptions)
  * [5 Example](inclusive_scan.html#Example)
  * [6 See also](inclusive_scan.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/inclusive_scan&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  the pair of iterators defining the source [range](../iterator.html#Ranges "cpp/iterator") of elements to sum   
---|---|---  
d_first  |  \-  |  the beginning of the destination [range](../iterator.html#Ranges "cpp/iterator"); may be equal to first  
policy  |  \-  |  the [execution policy](execution_policy_tag_t.html "cpp/algorithm/execution policy tag t") to use   
init  |  \-  |  the initial value   
op  |  \-  |  binary [FunctionObject](../named_req/FunctionObject.html "cpp/named req/FunctionObject") that will be applied in to the result of dereferencing the input iterators, the results of other op, and init (if provided)   
Type requirements   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/inclusive_scan&action=edit&section=2 "Edit section: Return value")] Return value

Iterator to the element past the last element written. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/inclusive_scan&action=edit&section=3 "Edit section: Complexity")] Complexity

Given \\(\scriptsize N\\)N as [std::distance](../iterator/distance.html)(first, last): 

1,2) \\(\scriptsize O(N)\\)O(N) applications of [std::plus](../utility/functional/plus.html)<>().

3-6) \\(\scriptsize O(N)\\)O(N) applications of op.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/inclusive_scan&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/inclusive_scan&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::vector](../container/vector.html) data{3, 1, 4, 1, 5, 9, 2, 6};
     
        [std::cout](../io/cout.html) << "Exclusive sum: ";
        [std::exclusive_scan](exclusive_scan.html)(data.begin(), data.end(),
    ...
     
        ...
        [std::exclusive_scan](exclusive_scan.html)(data.begin(), data.end(),
                            [std::ostream_iterator](../iterator/ostream_iterator.html)<int>([std::cout](../io/cout.html), " "),
                            1, [std::multiplies](../utility/functional/multiplies.html)<>{});
     
        [std::cout](../io/cout.html) << "\nInclusive product: ";
        std::inclusive_scan(data.begin(), data.end(),
                            [std::ostream_iterator](../iterator/ostream_iterator.html)<int>([std::cout](../io/cout.html), " "),
                            [std::multiplies](../utility/functional/multiplies.html)<>{});
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/inclusive_scan&action=edit&section=6 "Edit section: See also")] See also
...
[ transform_inclusive_scan](transform_inclusive_scan.html "cpp/algorithm/transform inclusive scan")(C++17) |  applies an invocable, then calculates inclusive scan   
...
[ exclusive_scan](exclusive_scan.html "cpp/algorithm/exclusive scan")(C++17) |  similar to [std::partial_sum](partial_sum.html "cpp/algorithm/partial sum"), excludes the ith input element from the ith sum   
