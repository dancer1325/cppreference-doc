...
2  | a++ a\-- | Suffix/postfix [increment and decrement](operator_incdec.html "cpp/language/operator incdec")  
`_type_`(a) ` _type_`{a} | [Functional cast](explicit_cast.html "cpp/language/explicit cast")  
...
(`_type_`)a | [C-style cast](explicit_cast.html "cpp/language/explicit cast")  
...
5  | a * b a / b a % b | [Multiplication, division, and remainder](operator_arithmetic.html#Multiplicative_operators "cpp/language/operator arithmetic")  
6  | a + b a - b | [Addition and subtraction](operator_arithmetic.html#Additive_operators "cpp/language/operator arithmetic")  
7  | a << b a >> b | Bitwise [left shift and right shift](operator_arithmetic.html#Bitwise_shift_operators "cpp/language/operator arithmetic")  
8  | a <=> b | [Three-way comparison operator](operator_comparison.html#Three-way_comparison "cpp/language/operator comparison") (since C++20)  
9  | a < b a <= b a > b a >= b | For [relational operators](operator_comparison.html "cpp/language/operator comparison") `**<**` and `**< =**` and `**>**` and `**> =**` respectively   
10  | a == b a != b | For [equality operators](operator_comparison.html "cpp/language/operator comparison") `**=**` and `**!=**` respectively   
11  | a & b | [Bitwise AND](operator_arithmetic.html#Bitwise_logic_operators "cpp/language/operator arithmetic")  
12  | a ^ b | [Bitwise XOR](operator_arithmetic.html#Bitwise_logic_operators "cpp/language/operator arithmetic") (exclusive or)   
13  | a | b | [Bitwise OR](operator_arithmetic.html#Bitwise_logic_operators "cpp/language/operator arithmetic") (inclusive or)   
14  | a && b | [Logical AND](operator_logical.html "cpp/language/operator logical")  
15  | a || b | [Logical OR](operator_logical.html "cpp/language/operator logical")  
...
When parsing an expression, an operator which is listed on some row of the table above with a precedence will be bound tighter (as if by parentheses) to its arguments than any operator that is listed on a row further below it with a lower precedence. For example, the expressions [std::cout](../io/cout.html) << a & b and *p++ are parsed as ([std::cout](../io/cout.html) << a) & b and *(p++), and not as [std::cout](../io/cout.html) << (a & b) or (*p)++. 
