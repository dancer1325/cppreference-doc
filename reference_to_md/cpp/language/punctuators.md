...
#### ::
  ...
  * a [qualified name](qualified_lookup.html "cpp/language/qualified lookup")
  * a [pointer-to-member declaration](pointer.html#Pointers_to_members "cpp/language/pointer")
  * a [`new`](new.html "cpp/language/new") or [`delete`](delete.html "cpp/language/delete") expression, to indicate that only global allocation or deallocation functions are looked up 



  * In an [attribute](attributes.html "cpp/language/attributes"), indicate attribute scope. 

| (since C++11)  
---|---  
  
  * Part of [nested namespace definition](namespace.html "cpp/language/namespace"). 
