...
Run this code
    ...
    void print(int* val)
    {
        [std::cout](../../io/cout.html) << *val << [std::endl](../../io/manip/endl.html);
    }
     
    ...
    {
        int x{42};
        [std::atomic](../../atomic/atomic.html)<int*> p = &x;
        int* local = p.load([std::memory_order_consume](../../atomic/memory_order.html));
     
        if (local)
        {
            ...
            [std::cout](../../io/cout.html) << *local << [std::endl](../../io/manip/endl.html);
        }
     
        if (local)
        {
