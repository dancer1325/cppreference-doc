...
Checks whether the [environment encoding](environment.html "cpp/text/text encoding/environment") is equal to the encoding whose MIBenum value is the specified value I. A call to this function is equivalent to return environment() == I;. 
