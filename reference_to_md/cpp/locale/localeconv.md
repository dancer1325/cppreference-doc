...
---|---|---  
[std::lconv](lconv.html)* localeconv(); |  |   
| |   
  
The `localeconv` function obtains a pointer to a static object of type [std::lconv](lconv.html "cpp/locale/lconv"), which represents numeric and monetary formatting rules of the current C locale. 
...
## Contents
  ...
  * [5 See also](localeconv.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::lconv](lconv.html)* lc = std::localeconv();
