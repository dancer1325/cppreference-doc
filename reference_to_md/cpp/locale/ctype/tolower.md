...
**ctype::tolower ctype::do_tolower**  
...
---|---|---  
public:  
CharT tolower( CharT c ) const; |  (1)  |   
public:  
const CharT* tolower( CharT* beg, const CharT* end ) const; |  (2)  |   
protected:  
virtual CharT do_tolower( CharT c ) const; |  (3)  |   
protected:  
virtual const CharT* do_tolower( CharT* beg, const CharT* end ) const; |  (4)  |   
| |   
...
Run this code
    ...
    #include <locale>
     
    void try_lower(const [std::ctype](../ctype.html)<wchar_t>& f, wchar_t c)
    {
        wchar_t up = f.tolower(c);
        if (up != c)
            [std::wcout](../../io/cout.html) << "Lower case form of \'" << c << "' is " << up << '\n';
        else
            [std::wcout](../../io/cout.html) << '\'' << c << "' has no lower case form\n";
    }
     
    int main()
    {
        ...
        [std::wcout](../../io/cout.html) << "In US English UTF-8 locale:\n";
        auto& f = [std::use_facet](../use_facet.html)<[std::ctype](../ctype.html)<wchar_t>>([std::locale](../locale.html)());
        try_lower(f, L'Σ');
        try_lower(f, L'Ɛ');
        try_lower(f, L'Ａ');
     
        [std::wstring](../../string/basic_string.html) str = L"HELLo, wORLD!";
        [std::wcout](../../io/cout.html) << "Lowercase form of the string '" << str << "' is ";
