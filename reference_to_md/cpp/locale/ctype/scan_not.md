...
**ctype::scan_not ctype::do_scan_not**  
...
[ctype::narrowctype::do_narrow](narrow.html "cpp/locale/ctype/narrow")  
...
---|---|---  
public:  
const CharT* scan_not( mask m, const CharT* beg, const CharT* end ) const; |  (1)  |   
protected:  
...
## Contents
  ...
  * [3 Example](scan_not.html#Example)
  * [4 See also](scan_not.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/ctype/scan_not&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/ctype/scan_not&action=edit&section=2 "Edit section: Return value")] Return value

Pointer to the first character in `[`beg`, `end`)` that doesn't satisfy the mask, or end if no such character was found. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/ctype/scan_not&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::setlocale](../setlocale.html)([LC_ALL](../LC_categories.html), "en_US.utf8");
        [std::wcout](../../io/cout.html).imbue([std::locale](../locale.html)("en_US.utf8"));
        auto& f = [std::use_facet](../use_facet.html)<[std::ctype](../ctype.html)<wchar_t>>([std::wcout](../../io/cout.html).getloc());
     
        // skip leading whitespace
        wchar_t s1[] = L"      \t\t\n  Кошка";
        const wchar_t* p1 = f.scan_not([std::ctype_base::space](../ctype_base.html), [std::begin](../../iterator/begin.html)(s1), [std::end](../../iterator/end.html)(s1));
        [std::wcout](../../io/cout.html) << '\'' << p1 << "'\n";
     
        // skip leading digits
        wchar_t s2[] = L"123456789ネプネプ";
        const wchar_t* p2 = f.scan_not([std::ctype_base::digit](../ctype_base.html), [std::begin](../../iterator/begin.html)(s2), [std::end](../../iterator/end.html)(s2));
        [std::wcout](../../io/cout.html) << '\'' << p2 << "'\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/ctype/scan_not&action=edit&section=4 "Edit section: See also")] See also
...
---|---  
[ do_scan_is](scan_is.html "cpp/locale/ctype/scan is")[virtual] |  locates the first character in a sequence that conforms to given classification   
