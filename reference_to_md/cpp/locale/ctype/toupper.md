...
**ctype::toupper ctype::do_toupper**  
...
---|---|---  
public:  
CharT toupper( CharT c ) const; |  (1)  |   
public:  
const CharT* toupper( CharT* beg, const CharT* end ) const; |  (2)  |   
protected:  
virtual CharT do_toupper( CharT c ) const; |  (3)  |   
protected:  
virtual const CharT* do_toupper( CharT* beg, const CharT* end ) const; |  (4)  |   
| |   
...
## Contents
  ...
  * [3 Notes](toupper.html#Notes)
  * [4 Example](toupper.html#Example)
...
Run this code
    ...
    #include <locale>
     
    void try_upper(const [std::ctype](../ctype.html)<wchar_t>& f, wchar_t c)
    {
        wchar_t up = f.toupper(c);
        if (up != c)
            [std::wcout](../../io/cout.html) << "Upper case form of \'" << c << "' is " << up << '\n';
        else
            [std::wcout](../../io/cout.html) << '\'' << c << "' has no upper case form\n";
    }
     
    int main()
    {
    ...
     
        ...
        [std::wcout](../../io/cout.html) << "Uppercase form of the string '" << str << "' is ";
