...
**ctype::scan_is ctype::do_scan_is**  
...
---|---|---  
public:  
const CharT* scan_is( mask m, const CharT* beg, const CharT* end ) const; |  (1)  |   
protected:  
...
## Contents
  ...
  * [1 Parameters](scan_is.html#Parameters)
  * [2 Return value](scan_is.html#Return_value)
  * [3 Example](scan_is.html#Example)
  * [4 Defect reports](scan_is.html#Defect_reports)
  * [5 See also](scan_is.html#See_also)
...
Run this code
    ...
     
        ...
        wchar_t s1[] = L"      \t\t\n  Кошка";
        const wchar_t* p1 = f.scan_is([std::ctype_base::alpha](../ctype_base.html), [std::begin](../../iterator/begin.html)(s1), [std::end](../../iterator/end.html)(s1));
        [std::wcout](../../io/cout.html) << '\'' << p1 << "'\n";
     
        // skip until the first letter
        wchar_t s2[] = L"123456789ネプネプ";
        const wchar_t* p2 = f.scan_is([std::ctype_base::alpha](../ctype_base.html), [std::begin](../../iterator/begin.html)(s2), [std::end](../../iterator/end.html)(s2));
