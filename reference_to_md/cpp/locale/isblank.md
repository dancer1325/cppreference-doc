...
bool isblank( CharT ch, const locale& loc ); |  |  (since C++11)  
| |   
  
Checks if the given character is classified as a blank character by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 

## Contents

  * [1 Parameters](isblank.html#Parameters)
  * [2 Return value](isblank.html#Return_value)
  * [3 Possible implementation](isblank.html#Possible_implementation)
  * [4 Example](isblank.html#Example)
  * [5 See also](isblank.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isblank&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character   
---|---|---  
loc  |  \-  |  locale   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isblank&action=edit&section=2 "Edit section: Return value")] Return value

Returns true if the character is classified as a blank character, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isblank&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class CharT>
    bool isblank(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).is([std::ctype_base::blank](ctype_base.html), ch);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isblank&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    {
        [std::wcout](../io/cout.html) << "isblank('" << c << "', locale(\"" << loc << "\")) returned "
                   << [std::boolalpha](../io/manip/boolalpha.html)
                   << [std::isblank](../string/byte/isblank.html)(c, [std::locale](locale.html)(loc)) << '\n';
    }
     
    int main()
    {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isblank&action=edit&section=5 "Edit section: See also")] See also
