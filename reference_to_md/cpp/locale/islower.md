...
Checks if the given character is classified as a lowercase alphabetic character by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 

## Contents

  * [1 Parameters](islower.html#Parameters)
  * [2 Return value](islower.html#Return_value)
  * [3 Possible implementation](islower.html#Possible_implementation)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/islower&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character   
---|---|---  
loc  |  \-  |  locale   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/islower&action=edit&section=2 "Edit section: Return value")] Return value

Returns true if the character is classified as lowercase, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/islower&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class CharT>
    bool islower(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).is([std::ctype_base::lower](ctype_base.html), ch);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/islower&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../io/cout.html) << [std::boolalpha](../io/manip/boolalpha.html)
                  ...
                  << [std::islower](../string/byte/islower.html)(c, loc1) << '\n'
                  << "isupper('π', C locale) returned "
                  << [std::isupper](../string/byte/isupper.html)(c, loc1) << '\n';
     
        [std::locale](locale.html) loc2("en_US.UTF8");
        [std::cout](../io/cout.html) << "islower('π', Unicode locale) returned "
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/islower&action=edit&section=5 "Edit section: See also")] See also
