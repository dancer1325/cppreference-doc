...
---|---|---  
explicit facet( [std::size_t](../../../types/size_t.html) refs = 0 ); |  (1)  |   
facet( const facet& ) = delete; |  (2)  |   
| |   
...
2) Copy constructor is deleted; [std::locale::facet](../facet.html "cpp/locale/locale/facet") is not copyable.
