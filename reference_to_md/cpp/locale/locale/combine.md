...
The program is ill-formed if Facet is not a [facet](facet.html#Facet_class "cpp/locale/locale/facet") or it is a volatile-qualified facet. 

## Contents

  * [1 Return value](combine.html#Return_value)
  * [2 Exceptions](combine.html#Exceptions)
  * [3 Example](combine.html#Example)
  * [4 Defect reports](combine.html#Defect_reports)
  * [5 See also](combine.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "\"C\" locale: " << number << '\n';
        [std::locale](../locale.html) loc = [std::locale](../locale.html)()
            .combine<[std::numpunct](../numpunct.html)<char>>([std::locale](../locale.html)("en_US.UTF8"));
        [std::cout](../../io/cout.html).imbue(loc);
        [std::cout](../../io/cout.html) << "\"C\" locale with en_US numpunct: " << number << '\n';
    }
