...
---|---|---  
[std::string](../../string/basic_string.html) name() const; |  |   
| |   
...
Run this code
    ...
    int main()
    {
        [std::locale](../locale.html) loc([std::locale](../locale.html)(), new [std::ctype](../ctype.html)<char>);
        [std::cout](../../io/cout.html) << "The default locale is " << [std::locale](../locale.html)().name() << '\n'
                  << "The user's locale is " << [std::locale](../locale.html)("").name() << '\n'
