...
The class `std::locale::id` provides implementation-specific identification of a locale facet. Each [facet](facet.html "cpp/locale/locale/facet") has a public static member named `**id**` of type `std::locale::id` and each [std::locale](../locale.html "cpp/locale/locale") object maintains a list of facets it implements, indexed by their `id`s. 
...
Run this code
    ...
    #include <locale>
     
    struct myfacet : [std::locale::facet](facet.html)
    {
        myfacet([std::size_t](../../types/size_t.html) refs = 0) : facet(refs) {}
    ...
    int main()
    {
        [std::locale](../locale.html) myloc([std::locale](../locale.html)(), new myfacet);
        [std::cout](../../io/cout.html) << "has_facet<myfacet>(myloc) returns " << [std::boolalpha](../../io/manip/boolalpha.html)
                  << [std::has_facet](../has_facet.html)<myfacet>(myloc) << '\n';
    }
