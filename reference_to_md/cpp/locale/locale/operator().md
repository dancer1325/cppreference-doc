...
const [std::basic_string](../../string/basic_string.html)<CharT,Traits,Alloc>& s2 ) const; |  |   
---|---|---  
| |   
  
Compares two string arguments s1 and s2 according to the lexicographic comparison rules defined by this locale's [std::collate](../collate.html)<CharT> facet. This operator allows any locale object that has a collate facet to be used as a binary predicate in the standard algorithms (such as [std::sort](../../algorithm/sort.html "cpp/algorithm/sort")) and ordered containers (such as [std::set](../../container/set.html "cpp/container/set")). 

## Contents

  * [1 Parameters](operator\(\).html#Parameters)
  * [2 Return value](operator\(\).html#Return_value)
  * [3 Possible implementation](operator\(\).html#Possible_implementation)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/locale/operator\(\)&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    ...
    bool operator()(const [std::basic_string](../../string/basic_string.html)<CharT,Traits,Alloc>& s1,
                    const [std::basic_string](../../string/basic_string.html)<CharT,Traits,Alloc>& s2) const
    {
        return [std::use_facet](../use_facet.html)<[std::collate](../collate.html)<CharT>>(*this).compare(
...
Run this code
    ...
    int main()
    {
        [std::vector](../../container/vector.html)<[std::wstring](../../string/basic_string.html)> v = {L"жил", L"был", L"пёс"};
        [std::sort](../../algorithm/sort.html)(v.begin(), v.end(), [std::locale](../locale.html)("ru_RU.UTF8"));
        [assert](../../error/assert.html)(v[0] == L"был");
        [assert](../../error/assert.html)(v[1] == L"жил");
