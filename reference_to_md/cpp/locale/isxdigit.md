...
Checks if the given character is classified as a hexadecimal digit by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 

## Contents

  * [1 Parameters](isxdigit.html#Parameters)
  * [2 Return value](isxdigit.html#Return_value)
  * [3 Possible implementation](isxdigit.html#Possible_implementation)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isxdigit&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    ...
    template<class CharT>
    bool isxdigit(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).is([std::ctype_base::xdigit](ctype_base.html), ch);
    }  
...
Run this code
    ...
     
    struct gxdigit_ctype : [std::ctype](ctype.html)<wchar_t>
    {
        [std::unordered_set](../container/unordered_set.html)<wchar_t> greek_digits{L'α', L'β', L'γ', L'δ', L'ε', L'ζ'};
     
    ...
    int main()
    {
        [std::wstring](../string/basic_string.html) text = L"0123456789abcdefABCDEFαβγδεζηθικλμ";
        [std::locale](locale.html) loc([std::locale](locale.html)(""), new gxdigit_ctype);
     
    ...
     
        [std::wcout](../io/cout.html) << "Hexadecimal digits in text: ";
        for (const wchar_t c : text)
            if ([std::isxdigit](../string/byte/isxdigit.html)(c, loc))
                [std::wcout](../io/cout.html) << c << L' ';
        [std::wcout](../io/cout.html) << L'\n';
     
        [std::wcout](../io/cout.html) << "Not hexadecimal digits in text: ";
        for (const wchar_t c : text)
            if (not [std::isxdigit](../string/byte/isxdigit.html)(c, loc))
                [std::wcout](../io/cout.html) << c << L' ';
        [std::wcout](../io/cout.html) << L'\n';
    }
