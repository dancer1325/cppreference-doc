...
Member functions  
---  
[time_get::time_get](time_get.html "cpp/locale/time get/time get")  
[time_get::~time_get](~time_get.html "cpp/locale/time get/~time get")  
[time_get::date_ordertime_get::do_date_order](date_order.html "cpp/locale/time get/date order")  
[time_get::get_timetime_get::do_get_time](get_time.html "cpp/locale/time get/get time")  
[time_get::get_datetime_get::do_get_date](get_date.html "cpp/locale/time get/get date")  
**time_get::get_weekday time_get::do_get_weekday**  
[time_get::get_monthnametime_get::do_get_monthname](get_monthname.html "cpp/locale/time get/get monthname")  
...
---|---|---  
public:  
iter_type get_weekday( iter_type beg, iter_type end, [std::ios_base](../../io/ios_base.html)& str,  
[std::ios_base::iostate](../../io/ios_base/iostate.html)& err, [std::tm](../../chrono/c/tm.html)* t ) const; |  (1)  |   
protected:  
virtual iter_type do_get_weekday( iter_type beg, iter_type end, [std::ios_base](../../io/ios_base.html)& str,  
[std::ios_base::iostate](../../io/ios_base/iostate.html)& err, [std::tm](../../chrono/c/tm.html)* t ) const; |  (2)  |   
| |   
  
1) Public member function, calls the protected virtual member function `do_get_weekday` of the most derived class.

2) Reads successive characters from the sequence `[`beg`, `end`)` and parses out the weekday name (possibly abbreviated), using the default format for weekdays expected by this locale, which is the same format as "%a" as used by the functions [std::get_time](../../io/manip/get_time.html "cpp/io/manip/get time"), [`time_get::get`](get.html "cpp/locale/time get/get"), and the POSIX function `strptime()`.
...
The parsed weekday is stored in the [std::tm](../../chrono/c/tm.html "cpp/chrono/c/tm") field t->tm_wday. 

If the end iterator is reached before a valid weekday name is read, the function sets [std::ios_base::eofbit](../../io/ios_base/iostate.html "cpp/io/ios base/iostate") in err. If a parsing error is encountered, the function sets [std::ios_base::failbit](../../io/ios_base/iostate.html "cpp/io/ios base/iostate") in err. 

## Contents

  * [1 Parameters](get_weekday.html#Parameters)
  * [2 Return value](get_weekday.html#Return_value)
  * [3 Notes](get_weekday.html#Notes)
  * [4 Example](get_weekday.html#Example)
  * [5 Defect reports](get_weekday.html#Defect_reports)
  * [6 See also](get_weekday.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_weekday&action=edit&section=1 "Edit section: Parameters")] Parameters

beg  |  \-  |  iterator designating the start of the sequence to parse   
---|---|---  
end  |  \-  |  one past the end iterator for the sequence to parse   
str  |  \-  |  a stream object that this function uses to obtain locale facets when needed, e.g. [std::ctype](../ctype.html "cpp/locale/ctype") to skip whitespace or [std::collate](../collate.html "cpp/locale/collate") to compare strings   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_weekday&action=edit&section=2 "Edit section: Return value")] Return value

Iterator pointing one past the last character in `[`beg`, `end`)` that was recognized as a part of a valid weekday name. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_weekday&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_weekday&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    #include <string_view>
     
    void try_get_wday([std::string_view](../../string/basic_string_view.html) s)
    {
        [std::cout](../../io/cout.html) << "Parsing the weekday out of '" << s
                  << "' in the locale " << [std::locale](../locale.html)().name() << '\n';
        [std::istringstream](../../io/basic_istringstream.html) str{s.data()};
        [std::ios_base::iostate](../../io/ios_base/iostate.html) err{[std::ios_base::goodbit](../../io/ios_base/iostate.html)};
     
        [std::tm](../../chrono/c/tm.html) t;
        [std::time_get](../time_get.html)<char> const& facet = [std::use_facet](../use_facet.html)<[std::time_get](../time_get.html)<char>>(str.getloc());
        [std::istreambuf_iterator](../../iterator/istreambuf_iterator.html)<char> ret = facet.get_weekday({str}, {}, str, err, &t);
        str.setstate(err);
        [std::istreambuf_iterator](../../iterator/istreambuf_iterator.html)<char> last{};
     
        if (str)
        {
            [std::cout](../../io/cout.html) << "Successfully parsed, weekday number is " << t.tm_wday;
     
            if (ret != last)
            {
    ...
     
    void demo([std::string_view](../../string/basic_string_view.html) locale_name, [std::initializer_list](../../utility/initializer_list.html)<[std::string_view](../../string/basic_string_view.html)>&& data)
    {
        try
        {
            [std::locale::global](../locale/global.html)([std::locale](../locale.html)(locale_name.data()));
        }
        catch ([std::runtime_error](../../error/runtime_error.html) const& ex)
        {
            [std::cout](../../io/cout.html) << "Cannot setup locale: " << locale_name << "\n"
                         "Exception: " << ex.what() << '\n';
            return;
        }
     
        for ([std::string_view](../../string/basic_string_view.html) const weekday : data)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_weekday&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 248](https://cplusplus.github.io/LWG/issue248) | C++98  | `eofbit` was not set upon reaching the end iterator  | sets `eofbit` if a valid weekday name has not been read   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_weekday&action=edit&section=6 "Edit section: See also")] See also
