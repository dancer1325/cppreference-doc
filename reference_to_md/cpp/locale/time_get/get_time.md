...
**time_get::get_time time_get::do_get_time**  
...
---|---|---  
public:  
iter_type get_time( iter_type beg, iter_type end, [std::ios_base](../../io/ios_base.html)& str,  
[std::ios_base::iostate](../../io/ios_base/iostate.html)& err, [std::tm](../../chrono/c/tm.html)* t ) const; |  (1)  |   
protected:  
virtual iter_type do_get_time( iter_type beg, iter_type end, [std::ios_base](../../io/ios_base.html)& str,  
...
2) Reads successive characters from the sequence `[`beg`, `end`)` and parses out the time value following the same rules as the format specifier "%H:%M:%S" as used by the functions [std::get_time](../../io/manip/get_time.html "cpp/io/manip/get time"), [`time_get::get`](get.html "cpp/locale/time get/get"), and the POSIX function `strptime()`.

    

     The parsed time is stored in the corresponding fields of the [std::tm](../../chrono/c/tm.html "cpp/chrono/c/tm") structure pointed to by the argument t. 

    

     If the end iterator is reached before a valid time is read, the function sets [std::ios_base::eofbit](../../io/ios_base/iostate.html "cpp/io/ios base/iostate") in err. If a parsing error is encountered, the function sets [std::ios_base::failbit](../../io/ios_base/iostate.html "cpp/io/ios base/iostate") in err. 

## Contents

  * [1 Parameters](get_time.html#Parameters)
  * [2 Return value](get_time.html#Return_value)
  * [3 Notes](get_time.html#Notes)
  * [4 Example](get_time.html#Example)
  * [5 Defect reports](get_time.html#Defect_reports)
  * [6 See also](get_time.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_time&action=edit&section=1 "Edit section: Parameters")] Parameters

beg  |  \-  |  iterator designating the start of the sequence to parse   
---|---|---  
end  |  \-  |  one past the end iterator for the sequence to parse   
str  |  \-  |  a stream object that this function uses to obtain locale facets when needed, e.g. [std::ctype](../ctype.html "cpp/locale/ctype") to skip whitespace   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_time&action=edit&section=2 "Edit section: Return value")] Return value

Iterator pointing one past the last character in `[`beg`, `end`)` that was recognized as a part of a valid date. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_time&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_time&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    #include <sstream>
     
    void try_get_time(const [std::string](../../string/basic_string.html)& s)
    {
        [std::cout](../../io/cout.html) << "Parsing the time out of '" << s
    ...
     
        ...
        [std::time_get](../time_get.html)<char> const& facet =
            [std::use_facet](../use_facet.html)<[std::time_get](../time_get.html)<char>>(str.getloc());
    ...
     
        if (str)
        {
            [std::cout](../../io/cout.html) << "Hours: " << t.tm_hour << ", "
                         "Minutes: " << t.tm_min  << ", "
                         "Seconds: " << t.tm_sec  << '\n';
        }
        else
        {
            ...
            [std::copy](../../algorithm/copy.html)(ret, {}, [std::ostreambuf_iterator](../../iterator/ostreambuf_iterator.html)<char>([std::cout](../../io/cout.html)));
    ...
    int main()
    {
        [std::locale::global](../locale/global.html)([std::locale](../locale.html)("ru_RU.utf8"));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_time&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 248](https://cplusplus.github.io/LWG/issue248) | C++98  | `eofbit` was not set upon reaching the end iterator  | sets `eofbit` if a valid time has not been read   
[LWG 461](https://cplusplus.github.io/LWG/issue461) | C++98  | `do_get_time` needed to parse localized time representation  | parses with "%H:%M:%S" format   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/get_time&action=edit&section=6 "Edit section: See also")] See also
