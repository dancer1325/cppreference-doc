...
[time_get::~time_get](~time_get.html "cpp/locale/time get/~time get")  
**time_get::date_order time_get::do_date_order**  
...
---|---|---  
public:  
dateorder date_order() const; |  (1)  |   
protected:  
virtual dateorder do_date_order() const; |  (2)  |   
| |   
  
1) Public member function, calls the protected virtual member function `do_date_order` of the most derived class.

2) Returns a value of type [std::time_base::dateorder](../time_base.html "cpp/locale/time base"), which describes the default date format used by this locale (expected by [get_date()](get_date.html "cpp/locale/time get/get date") and produced by [std::strftime()](../../chrono/c/strftime.html "cpp/chrono/c/strftime") with format specifier '%x').

The valid values (inherited from [std::time_base](../time_base.html "cpp/locale/time base")) are: 
...
## Contents
  ...
  * [1 Return value](date_order.html#Return_value)
  * [2 Notes](date_order.html#Notes)
  * [3 Example](date_order.html#Example)
  * [4 See also](date_order.html#See_also)
...
Run this code
    ...
    {
        [std::time_base::dateorder](../time_base.html) d =
            [std::use_facet](../use_facet.html)<[std::time_get](../time_get.html)<char>>([std::locale](../locale.html)()).date_order();
        switch (d)
        {
            case [std::time_base::no_order](../time_base.html):
                [std::cout](../../io/cout.html) << "no_order\n";
                break;
            case [std::time_base::dmy](../time_base.html):
                [std::cout](../../io/cout.html) << "day, month, year\n";
                break;
            case [std::time_base::mdy](../time_base.html):
                [std::cout](../../io/cout.html) << "month, day, year\n";
                break;
            case [std::time_base::ymd](../time_base.html):
                [std::cout](../../io/cout.html) << "year, month, day\n";
                break;
            case [std::time_base::ydm](../time_base.html):
                [std::cout](../../io/cout.html) << "year, day, month\n";
                break;
        }
    }
     
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "In U.S. locale, the default date order is: ";
        show_date_order();
     
        [std::locale::global](../locale/global.html)([std::locale](../locale.html)("ja_JP.utf8"));
        [std::cout](../../io/cout.html) << "In Japanese locale, the default date order is: ";
        show_date_order();
     
        [std::locale::global](../locale/global.html)([std::locale](../locale.html)("de_DE.utf8"));
        [std::cout](../../io/cout.html) << "In German locale, the default date order is: ";
        show_date_order();
    }
