...
**time_get::get_date time_get::do_get_date**  
...
---|---|---  
public:  
iter_type get_date( iter_type beg, iter_type end, [std::ios_base](../../io/ios_base.html)& str,  
[std::ios_base::iostate](../../io/ios_base/iostate.html)& err, [std::tm](../../chrono/c/tm.html)* t ) const; |  (1)  |   
protected:  
virtual iter_type do_get_date( iter_type beg, iter_type end, [std::ios_base](../../io/ios_base.html)& str,  
...
2) Reads successive characters from the sequence `[`beg`, `end`)` and parses out the calendar date value using the default format expected by this locale, which is determined as  [date_order()](date_order.html "cpp/locale/time get/date order") | Format   
---|---  
`no_order` | "%m/%d/%y"  
`dmy` | "%d/%m/%y"  
`mdy` | "%m/%d/%y"  
...
as used by the functions [std::get_time()](../../io/manip/get_time.html "cpp/io/manip/get time"), [get()](get.html "cpp/locale/time get/get"), and the POSIX function `strptime()`.

The parsed date is stored in the corresponding fields of the [std::tm](../../chrono/c/tm.html "cpp/chrono/c/tm") structure pointed to by the argument t.

If the end iterator is reached before a valid date is read, the function sets [std::ios_base::eofbit](../../io/ios_base/iostate.html "cpp/io/ios base/iostate") in err. If a parsing error is encountered, the function sets [std::ios_base::failbit](../../io/ios_base/iostate.html "cpp/io/ios base/iostate") in err.

## Contents

  * [1 Parameters](get_date.html#Parameters)
  * [2 Return value](get_date.html#Return_value)
  * [3 Notes](get_date.html#Notes)
  * [4 Example](get_date.html#Example)
  * [5 Defect reports](get_date.html#Defect_reports)
  * [6 See also](get_date.html#See_also)
...
Run this code
    ...
    #include <sstream>
     
    void try_get_date(const [std::string](../../string/basic_string.html)& s)
    {
        [std::cout](../../io/cout.html) << "Parsing the date out of '" << s
    ...
     
        ...
        const [std::time_get](../time_get.html)<char>& facet = [std::use_facet](../use_facet.html)<[std::time_get](../time_get.html)<char>>(str.getloc());
        [std::istreambuf_iterator](../../iterator/istreambuf_iterator.html)<char> ret = facet.get_date({str}, {}, str, err, &t);
        str.setstate(err);
     
        if (str)
        {
            [std::cout](../../io/cout.html) << "Day: " << t.tm_mday << ' '
                      << "Month: " << t.tm_mon + 1 << ' '
                      << "Year: " << t.tm_year + 1900 << '\n';
        }
        else
