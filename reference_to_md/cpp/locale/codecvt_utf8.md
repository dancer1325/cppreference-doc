...
`std::codecvt_utf8` is a [std::codecvt](codecvt.html "cpp/locale/codecvt") facet which encapsulates conversion between a UTF-8 encoded byte string and UCS-2 or UTF-32 character string (depending on the type of `Elem`). This [std::codecvt](codecvt.html "cpp/locale/codecvt") facet can be used to read and write UTF-8 files, both text and binary. 
...
## Contents
  ...
  * [1 Template Parameters](codecvt_utf8.html#Template_Parameters)
  * [2 Member functions](codecvt_utf8.html#Member_functions)
  * [3 std::codecvt_utf8::codecvt_utf8](codecvt_utf8.html#std::codecvt_utf8::codecvt_utf8)
    * [3.1 Parameters](codecvt_utf8.html#Parameters)
  * [4 std::codecvt_utf8::~codecvt_utf8](codecvt_utf8.html#std::codecvt_utf8::.7Ecodecvt_utf8)
  * [5 Inherited from std::codecvt](codecvt_utf8.html#Inherited_from_std::codecvt)
    * [5.1 Nested types](codecvt_utf8.html#Nested_types)
    * [5.2 Data members](codecvt_utf8.html#Data_members)
    * [5.3 Member functions](codecvt_utf8.html#Member_functions_2)
    * [5.4 Protected member functions](codecvt_utf8.html#Protected_member_functions)
  * [6 Inherited from std::codecvt_base](codecvt_utf8.html#Inherited_from_std::codecvt_base)
    * [6.1 Notes](codecvt_utf8.html#Notes)
    * [6.2 Example](codecvt_utf8.html#Example)
    * [6.3 Defect reports](codecvt_utf8.html#Defect_reports)
    * [6.4 See also](codecvt_utf8.html#See_also)
...
explicit codecvt_utf8( [std::size_t](../types/size_t.html) refs = 0 ); |  |   
---|---|---  
| |   
...
Run this code
    ...
    int main()
    {
        ...
        [std::string](../string/basic_string.html) utf8 = "z\u6c34\U0001d10b";
     
        // the UTF-8 / UTF-16 standard conversion facet
        [std::wstring_convert](wstring_convert.html)<[std::codecvt_utf8_utf16](codecvt_utf8_utf16.html)<char16_t>, char16_t> utf16conv;
        [std::u16string](../string/basic_string.html) utf16 = utf16conv.from_bytes(utf8);
        [std::cout](../io/cout.html) << "UTF-16 conversion produced " << utf16.size() << " code units:\n"
    ...
     
        ...
        [std::wstring_convert](wstring_convert.html)<std::codecvt_utf8<char16_t>, char16_t> ucs2conv;
        try
        {
            [std::u16string](../string/basic_string.html) ucs2 = ucs2conv.from_bytes(utf8);
        }
        catch(const [std::range_error](../error/range_error.html)& e)
        {
            [std::u16string](../string/basic_string.html) ucs2 = ucs2conv.from_bytes(utf8.substr(0, ucs2conv.converted()));
            [std::cout](../io/cout.html) << "\nUCS-2 failed after producing " << [std::dec](../io/manip/hex.html) << ucs2.size()
                      << " characters:\n" << [std::showbase](../io/manip/showbase.html) << [std::hex](../io/manip/hex.html);
            for (char16_t c : ucs2)
                [std::cout](../io/cout.html) << static_cast<[std::uint16_t](../types/integer.html)>(c) << ' ';
            [std::cout](../io/cout.html) << '\n';
...
UCS-2  | [`c16rtomb`](../string/multibyte/c16rtomb.html "cpp/string/multibyte/c16rtomb") (without C11's DR488) | **`codecvt_utf8`** <char16_t> | [`codecvt_utf16`](codecvt_utf16.html "cpp/locale/codecvt utf16")<char16_t>  
...
**`codecvt_utf8`** <char32_t> |  [`codecvt_utf16`](codecvt_utf16.html "cpp/locale/codecvt utf16")<char32_t>  
...
<wchar_t,char,mbstate_t>>([`locale`](locale.html "cpp/locale/locale"))  | **`codecvt_utf8`** <wchar_t> | [`codecvt_utf16`](codecvt_utf16.html "cpp/locale/codecvt utf16")<wchar_t>  
