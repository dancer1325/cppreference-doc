...
Member functions  
---  
[codecvt::codecvt](codecvt.html "cpp/locale/codecvt/codecvt")  
[codecvt::~codecvt](~codecvt.html "cpp/locale/codecvt/~codecvt")  
**codecvt::out codecvt::do_out**  
[codecvt::incodecvt::do_in](in.html "cpp/locale/codecvt/in")  
[codecvt::unshiftcodecvt::do_unshift](unshift.html "cpp/locale/codecvt/unshift")  
[codecvt::encodingcodecvt::do_encoding](encoding.html "cpp/locale/codecvt/encoding")  
[codecvt::always_noconvcodecvt::do_always_noconv](always_noconv.html "cpp/locale/codecvt/always noconv")  
...
If this `codecvt` facet does not define a conversion, no characters are converted. to_next is set to be equal to to, state is unchanged, and [std::codecvt_base::noconv](../codecvt_base.html "cpp/locale/codecvt base") is returned. 

do_out(state, from, from + 1, from_next, to, to_end, to_next) must return `ok` if 

  * this `codecvt` facet is used by [`basic_filebuf`](../../io/basic_filebuf.html "cpp/io/basic filebuf"), and 
...
## Contents
  ...
  * [1 Return value](out.html#Return_value)
  * [2 Notes](out.html#Notes)
  * [3 Example](out.html#Example)
  * [4 Defect reports](out.html#Defect_reports)
  * [5 See also](out.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        auto& f = [std::use_facet](../use_facet.html)<[std::codecvt](../codecvt.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>>([std::locale](../locale.html)());
        [std::wstring](../../string/basic_string.html) internal = L"z\u00df\u6c34\U0001f34c"; // L"zß水🍌"
     
        // note that the following can be done with wstring_convert
        [std::mbstate_t](../../string/multibyte/mbstate_t.html) mb{}; // initial shift state
        [std::string](../../string/basic_string.html) external(internal.size() * f.max_length(), '\0'); 
    ...
     
        [std::cout](../../io/cout.html) << "The string in narrow multibyte encoding: " << external << '\n';
    }
...
---|---|---|---  
[LWG 76](https://cplusplus.github.io/LWG/issue76) | C++98  | it was unclear whether the conversion is required  
to support taking one internal character at a time  | only required if used  
by [`basic_filebuf`](../../io/basic_filebuf.html "cpp/io/basic filebuf")  
  
### See also

[ overflow](../../io/basic_filebuf/overflow.html "cpp/io/basic filebuf/overflow")[virtual] |  writes characters to the associated file from the put area   
