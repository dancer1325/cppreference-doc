...
Destructs a [std::codecvt](../codecvt.html) facet. This destructor is protected and virtual (due to [base class](../locale/facet.html "cpp/locale/locale/facet") destructor being virtual). An object of type [std::codecvt](../codecvt.html), like most facets, can only be destroyed when the last [std::locale](../locale.html "cpp/locale/locale") object that implements this facet goes out of scope or if a user-defined class is derived from [std::codecvt](../codecvt.html) and implements a public destructor. 
...
Run this code
    ...
    #include <locale>
     
    struct Destructible_codecvt : public [std::codecvt](../codecvt.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>
    {
        Destructible_codecvt([std::size_t](../../types/size_t.html) refs = 0) : codecvt(refs) {}
