...
[std::size_t](../../types/size_t.html) max ) const; |  (1)  |   
protected:  
virtual int do_length( StateT& state, const ExternT* from, const ExternT* from_end,  
[std::size_t](../../types/size_t.html) max ) const; |  (2)  |   
| |   
...
## Contents
  ...
  * [1 Return value](length.html#Return_value)
  * [2 Example](length.html#Example)
  * [3 Defect reports](length.html#Defect_reports)
  * [4 See also](length.html#See_also)
...
Run this code
    ...
    int main()
    {
        using facet_type = [std::codecvt](../codecvt.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>;
     
        // narrow multibyte encoding
        [std::string](../../string/basic_string.html) s = "z\u00df\u6c34\U0001d10b"; // or u8"zß水𝄋"
                  // or "\x7a\xc3\x9f\xe6\xb0\xb4\xf0\x9d\x84\x8b"
     
        [std::locale](../locale.html) loc("en_US.UTF-8");
        facet_type const& codecvt_facet = [std::use_facet](../use_facet.html)<facet_type>(loc);
        [std::mbstate_t](../../string/multibyte/mbstate_t.html) mb = [std::mbstate_t](../../string/multibyte/mbstate_t.html)();
        [std::cout](../../io/cout.html) << "Only the first "
