...
[codecvt::~codecvt](~codecvt.html "cpp/locale/codecvt/~codecvt")  
[codecvt::outcodecvt::do_out](out.html "cpp/locale/codecvt/out")  
**codecvt::in codecvt::do_in**  
...
## Contents
  ...
  * [1 Return value](in.html#Return_value)
  * [2 Notes](in.html#Notes)
  * [3 Example](in.html#Example)
  * [4 Defect reports](in.html#Defect_reports)
  * [5 See also](in.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        auto const& f = [std::use_facet](../use_facet.html)<[std::codecvt](../codecvt.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>>
            ([std::locale](../locale.html)());
        [std::string](../../string/basic_string.html) external = "z\u00df\u6c34\U0001d10b"; // or u8"zß水𝄋"
                         // or "\x7a\xc3\x9f\xe6\xb0\xb4\xf0\x9d\x84\x8b"
     
        // note that the following can be done with wstring_convert
        [std::mbstate_t](../../string/multibyte/mbstate_t.html) mb = [std::mbstate_t](../../string/multibyte/mbstate_t.html)(); // initial shift state
        [std::wstring](../../string/basic_string.html) internal(external.size(), '\0'); 
    ...
     
        [std::wcout](../../io/cout.html) << L"The string in wide encoding: " << internal << '\n';
    }
...
---|---|---|---  
[LWG 76](https://cplusplus.github.io/LWG/issue76) | C++98  | it was unclear whether the conversion is required to  
