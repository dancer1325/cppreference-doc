...
**codecvt::always_noconv codecvt::do_always_noconv**  
...
| (1) |   
public:  
bool always_noconv() const throw(); |  | (until C++11)  
public:  
bool always_noconv() const noexcept; |  |  (since C++11)  
| (2) |   
protected:  
virtual bool do_always_noconv() const throw(); |  | (until C++11)  
protected:  
virtual bool do_always_noconv() const noexcept; |  |  (since C++11)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "The non-converting char<->char codecvt::always_noconv() returns " 
                  << [std::boolalpha](../../io/manip/boolalpha.html)
                  << [std::use_facet](../use_facet.html)<[std::codecvt](../codecvt.html)<char, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>>(
