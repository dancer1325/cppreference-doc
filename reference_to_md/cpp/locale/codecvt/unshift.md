...
**codecvt::unshift codecvt::do_unshift**  
...
## Contents
  ...
  * [1 Return value](unshift.html#Return_value)
  * [2 Notes](unshift.html#Notes)
  * [3 Example](unshift.html#Example)
  * [4 Defect reports](unshift.html#Defect_reports)
  * [5 See also](unshift.html#See_also)
...
---|---|---|---  
[LWG 305](https://cplusplus.github.io/LWG/issue305) | C++98  | [std::codecvt](../codecvt.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>::do_unshift  
was required not to write any character  | not required   
[LWG 380](https://cplusplus.github.io/LWG/issue380) | C++98  | the meaning of returning partial was 'more characters need to  
be supplied to complete termination', but no character is supplied  | corrected to indicating  
insufficient buffer space   
[LWG 381](https://cplusplus.github.io/LWG/issue381) | C++98  | state was not required to be valid, and  
error is returned if state is invalid  | state is required to be valid, and  
returning error indicates an error   
[LWG 664](https://cplusplus.github.io/LWG/issue664) | C++98  | [std::codecvt](../codecvt.html)<char, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>::do_unshift  
was required not to write any character  | not required   
