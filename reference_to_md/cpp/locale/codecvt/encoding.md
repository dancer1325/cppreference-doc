...
**codecvt::encoding codecvt::do_encoding**  
...
| (1) |   
public:  
int encoding() const throw(); |  | (until C++11)  
public:  
int encoding() const noexcept; |  |  (since C++11)  
| (2) |   
protected:  
virtual int do_encoding() const throw(); |  | (until C++11)  
protected:  
virtual int do_encoding() const noexcept; |  |  (since C++11)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "en_US.utf8 is a variable-length encoding, encoding() returns "
    ...
     
        [std::cout](../../io/cout.html) << "zh_CN.gb18030 is also variable-length, encoding() == "
                  << [std::use_facet](../use_facet.html)<[std::codecvt](../codecvt.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>>(
                         [std::locale](../locale.html)("zh_CN.gb18030")
                     ).encoding() << '\n';
     
        [std::cout](../../io/cout.html) << "ru_RU.koi8r is a single-byte encoding, encoding() == "
                  << [std::use_facet](../use_facet.html)<[std::codecvt](../codecvt.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>>(
                         [std::locale](../locale.html)("ru_RU.koi8r")
                     ).encoding() << '\n';
    }
