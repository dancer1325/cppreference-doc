...
| (1) |   
public:  
int max_length() const throw(); |  | (until C++11)  
public:  
int max_length() const noexcept; |  |  (since C++11)  
| (2) |   
protected:  
virtual int do_max_length() const throw(); |  | (until C++11)  
protected:  
virtual int do_max_length() const noexcept; |  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Return value](max_length.html#Return_value)
  * [2 Notes](max_length.html#Notes)
  * [3 Example](max_length.html#Example)
  * [4 See also](max_length.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "In codecvt_utf8, the longest multibyte character is "
                  << [std::codecvt_utf8](../codecvt_utf8.html)<wchar_t>().max_length() << " bytes long\n";
     
        [std::cout](../../io/cout.html) << "In header-consuming codecvt_utf8, the longest multibyte character is "
                  << [std::codecvt_utf8](../codecvt_utf8.html)<wchar_t,
                                       0x10ffff,
                                       [std::consume_header](../codecvt_mode.html)>().max_length() << " bytes long\n";
     
        [std::cout](../../io/cout.html) << "In this system's en_US.utf8, the longest multibyte character is "
                  << [std::use_facet](../use_facet.html)<[std::codecvt](../codecvt.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>>(
                         [std::locale](../locale.html)("en_US.utf8")
                     ).max_length() << " bytes long\n";
     
        [std::cout](../../io/cout.html) << "In this system's zh_CN.gb18030, the longest multibyte character is "
                  << [std::use_facet](../use_facet.html)<[std::codecvt](../codecvt.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>>(
                         [std::locale](../locale.html)("zh_CN.gb18030")
                     ).max_length() << " bytes long\n";
    }
