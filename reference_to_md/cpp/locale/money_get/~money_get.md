...
**money_get::~money_get**  
[money_get::getmoney_get::do_get](get.html "cpp/locale/money get/get")  
...
Destructs a [std::money_get](../money_get.html) facet. This destructor is protected and virtual (due to [base class](../locale/facet.html "cpp/locale/locale/facet") destructor being virtual). An object of type [std::money_get](../money_get.html), like most facets, can only be destroyed when the last [std::locale](../locale.html "cpp/locale/locale") object that implements this facet goes out of scope or if a user-defined class is derived from [std::money_get](../money_get.html) and implements a public destructor. 
...
Run this code
    ...
    #include <locale>
     
    struct Destructible_money_get : public [std::money_get](../money_get.html)<wchar_t>
    {
        Destructible_money_get([std::size_t](../../types/size_t.html) refs = 0) : money_get(refs) {}
