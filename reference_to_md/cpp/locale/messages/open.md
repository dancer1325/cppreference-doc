...
Member functions  
---  
[messages::messages](messages.html "cpp/locale/messages/messages")  
[messages::~messages](~messages.html "cpp/locale/messages/~messages")  
**messages::open messages::do_open**  
...
---|---|---  
public:  
catalog open( const [std::string](../../string/basic_string.html)& name, const [std::locale](../locale.html)& loc ) const; |  (1)  |   
protected:  
virtual catalog do_open( const [std::string](../../string/basic_string.html)& name, const [std::locale](../locale.html)& loc ) const; |  (2)  |   
| |   
  
1) Public member function, calls the protected virtual member function `do_open` of the most derived class.

2) Obtains a value of type `catalog` (inherited from [std::messages_base](../messages_base.html "cpp/locale/messages base")), which can be passed to [get()](get.html "cpp/locale/messages/get") to retrieve messages from the message catalog named by name. This value is usable until passed to [close()](close.html "cpp/locale/messages/close").
...
Run this code
    ...
    int main()
    {
        ...
        auto& facet = [std::use_facet](../use_facet.html)<[std::messages](../messages.html)<char>>(loc);
        auto cat = facet.open("sed", loc);
        if (cat < 0)
            [std::cout](../../io/cout.html) << "Could not open german \"sed\" message catalog\n";
        else
            [std::cout](../../io/cout.html) << "\"No match\" in German: "
