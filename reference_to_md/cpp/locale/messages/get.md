...
---|---|---  
public:  
string_type get( catalog cat, int set, int msgid, const string_type& dfault ) const; |  (1)  |   
protected:  
virtual string_type do_get( catalog cat, int set, int msgid, const string_type& dfault ) const; |  (2)  |   
| |   
