...
Each of the above macro constants expand to integer constant expressions with distinct values that are suitable for use as the first argument of [std::setlocale](setlocale.html "cpp/locale/setlocale"). 
...
Run this code
    ...
    int main()
    {
        ...
        [std::setlocale](setlocale.html)(LC_ALL, "en_US.UTF-8");
     
        // decimal dot will be German:
        [std::setlocale](setlocale.html)(LC_NUMERIC, "de_DE.UTF-8");
     
        // date/time formatting will be Japanese:
        [std::setlocale](setlocale.html)(LC_TIME, "ja_JP.UTF-8");
     
        wchar_t str[100];
        [std::time_t](../chrono/c/time_t.html) t = [std::time](../chrono/c/time.html)(nullptr);
        [std::wcsftime](../chrono/c/wcsftime.html)(str, 100, L"%A %c", [std::localtime](../chrono/c/localtime.html)(&t));
