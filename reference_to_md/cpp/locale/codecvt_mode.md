...
Run this code
    ...
    {
        // UTF-8 data with BOM
        [std::ofstream](../io/basic_ofstream.html){"text.txt"} << "\ufeffz\u6c34\U0001d10b";
     
        ...
        fin.imbue([std::locale](locale.html)(fin.getloc(),
                              new [std::codecvt_utf8](codecvt_utf8.html)<wchar_t, 0x10ffff, std::consume_header>));
     
        for (wchar_t c; fin.get(c);)
            [std::cout](../io/cout.html) << [std::hex](../io/manip/hex.html) << [std::showbase](../io/manip/showbase.html) << ([std::wint_t](../string/wide.html))c << '\n';
    }
