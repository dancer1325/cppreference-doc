...
Converts the character ch to uppercase if possible, using the conversion rules specified by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 
...
## Contents
  ...
  * [4 Possible implementation](toupper.html#Possible_implementation)
  * [5 Example](toupper.html#Example)
  * [6 See also](toupper.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/toupper&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    template<class CharT>
    CharT toupper(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).toupper(ch);
    }  
...
Run this code
    ...
     
        [std::cout](../io/cout.html) << "in the default locale, toupper(" << ([std::wint_t](../string/wide.html))c << ") = "
                  << ([std::wint_t](../string/wide.html))[std::toupper](../string/byte/toupper.html)(c, [std::locale](locale.html)()) << '\n';
     
        [std::cout](../io/cout.html) << "in Unicode locale, toupper(" << ([std::wint_t](../string/wide.html))c << ") = "
                  << ([std::wint_t](../string/wide.html))[std::toupper](../string/byte/toupper.html)(c, [std::locale](locale.html)("en_US.utf8")) << '\n';
    }
