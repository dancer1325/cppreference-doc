...
Checks if the given character is classified as an uppercase alphabetic character by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 

## Contents

  * [1 Parameters](isupper.html#Parameters)
  * [2 Return value](isupper.html#Return_value)
  * [3 Possible implementation](isupper.html#Possible_implementation)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isupper&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character   
---|---|---  
loc  |  \-  |  locale   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isupper&action=edit&section=2 "Edit section: Return value")] Return value

Returns true if the character is classified as uppercase, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isupper&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class CharT>
    bool isupper(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).is([std::ctype_base::upper](ctype_base.html), ch);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isupper&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::locale](locale.html) loc1("C");
        [std::cout](../io/cout.html) << [std::boolalpha](../io/manip/boolalpha.html)
                  << "isupper('Þ', C locale) returned " << [std::isupper](../string/byte/isupper.html)(c, loc1) << '\n'
                  << "islower('Þ', C locale) returned " << [std::islower](../string/byte/islower.html)(c, loc1) << '\n';
     
        [std::locale](locale.html) loc2("en_US.UTF8");
        [std::cout](../io/cout.html) << "isupper('Þ', Unicode locale) returned "
                  << [std::isupper](../string/byte/isupper.html)(c, loc2) << '\n'
                  << "islower('Þ', Unicode locale) returned "
                  << [std::islower](../string/byte/islower.html)(c, loc2) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isupper&action=edit&section=5 "Edit section: See also")] See also
