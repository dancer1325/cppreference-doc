...
[wbuffer_convert::~wbuffer_convert](~wbuffer_convert.html "cpp/locale/wbuffer convert/~wbuffer convert")  
...
---|---|---  
explicit wbuffer_convert( [std::streambuf](../../io/basic_streambuf.html)* bytebuf,  
Codecvt* pcvt = new Codecvt,  
state_type state = state_type() ); |  (2)  |   
wbuffer_convert( const [std::wbuffer_convert](../wbuffer_convert.html)& ) = delete; |  (3)  |  (since C++14)  
| |   
Overload  | [Data members](../wbuffer_convert.html#Data_members "cpp/locale/wbuffer convert")  
---|---  
`_bufptr_` | `_cvtptr_` | `_cvtstate_`  
...
Run this code
    ...
    int main()
    {
        ...
        [std::stringbuf](../../io/basic_stringbuf.html) utf8buf("z\u00df\u6c34\U0001f34c");
                           // or "\x7a\xc3\x9f\xe6\xb0\xb4\xf0\x9f\x8d\x8c"
                           // or u8"zß水🍌"
        [std::wbuffer_convert](../wbuffer_convert.html)<[std::codecvt_utf8](../codecvt_utf8.html)<wchar_t>> conv_in(&utf8buf);
        [std::wistream](../../io/basic_istream.html) ucsbuf(&conv_in);
        [std::cout](../../io/cout.html) << "Reading from a UTF-8 stringbuf via wbuffer_convert: "
    ...
     
        ...
        [std::wbuffer_convert](../wbuffer_convert.html)<[std::codecvt_utf8](../codecvt_utf8.html)<wchar_t>> conv_out([std::cout](../../io/cout.html).rdbuf());
        [std::wostream](../../io/basic_ostream.html) out(&conv_out);
