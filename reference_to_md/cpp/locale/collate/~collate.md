...
Destructs a [std::collate](../collate.html) facet. This destructor is protected and virtual (due to [base class](../locale/facet.html "cpp/locale/locale/facet") destructor being virtual). An object of type [std::collate](../collate.html), like most facets, can only be destroyed when the last [std::locale](../locale.html "cpp/locale/locale") object that implements this facet goes out of scope or if a user-defined class is derived from [std::collate](../collate.html) and implements a public destructor. 
...
Run this code
    ...
    #include <locale>
     
    struct Destructible_collate : public [std::collate](../collate.html)<wchar_t>
    {
        Destructible_collate([std::size_t](../../types/size_t.html) refs = 0) : collate(refs) {}
