...
[collate::~collate](~collate.html "cpp/locale/collate/~collate")  
**collate::compare collate::do_compare**  
...
const CharT* low2, const CharT* high2 ) const; |  (1)  |   
protected:  
...
Run this code
    ...
    void try_compare(const [std::locale](../locale.html)& l, const CharT* p1, const CharT* p2)
    {
        auto& f = [std::use_facet](../use_facet.html)<[std::collate](../collate.html)<CharT>>(l);
     
        [std::basic_string](../../string/basic_string.html)<CharT> s1(p1), s2(p2);
    ...
     
        ...
        try_compare([std::locale](../locale.html)(), "hrnec", "chrt");
        [std::wcout](../../io/cout.html) << "In the Czech locale: ";
        try_compare([std::locale](../locale.html)("cs_CZ.utf8"), "hrnec", "chrt");
     
        [std::wcout](../../io/cout.html) << "In the American locale: ";
        try_compare([std::locale](../locale.html)(), L"år", L"ängel");
        [std::wcout](../../io/cout.html) << "In the Swedish locale: ";
        try_compare([std::locale](../locale.html)("sv_SE.utf8"), L"år", L"ängel");
    }
