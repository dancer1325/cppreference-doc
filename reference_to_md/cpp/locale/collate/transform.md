...
---|---|---  
public:  
string_type transform( const CharT* low, const CharT* high ) const; |  (1)  |   
protected:  
virtual string_type do_transform( const CharT* low, const CharT* high ) const; |  (2)  |   
| |   
  
1) Public member function, calls the protected virtual member function `do_transform` of the most derived class.

2) Converts the character sequence `[`low`, `high`)` to a string that, compared lexicographically (e.g. with `operator<` for strings) with the result of calling `transform()` on another string, produces the same result as calling [do_compare()](compare.html "cpp/locale/collate/compare") on the same two strings.
...
Run this code
    ...
    int main()
    {
        [std::locale::global](../locale/global.html)([std::locale](../locale.html)("sv_SE.utf8"));
        auto& f = [std::use_facet](../use_facet.html)<[std::collate](../collate.html)<wchar_t>>([std::locale](../locale.html)());
     
        [std::wstring](../../string/basic_string.html) in1 = L"\u00e4ngel";
        [std::wstring](../../string/basic_string.html) in2 = L"\u00e5r";
     
        [std::wstring](../../string/basic_string.html) out1 = f.transform(&in1[0], &in1[0] + in1.size());
        [std::wstring](../../string/basic_string.html) out2 = f.transform(&in2[0], &in2[0] + in2.size());
     
    ...
     
        [std::wcout](../../io/cout.html) << "In lexicographic comparison: ";
        if (in1 < in2)
            [std::wcout](../../io/cout.html) << in1 << " before " << in2 << '\n';
        else
            [std::wcout](../../io/cout.html) << in2 << " before " << in1 << '\n';
