...
Member functions  
---  
[collate::collate](collate.html "cpp/locale/collate/collate")  
[collate::~collate](~collate.html "cpp/locale/collate/~collate")  
[collate::comparecollate::do_compare](compare.html "cpp/locale/collate/compare")  
...
---|---|---  
public:  
long hash( const CharT* beg, const CharT* end ) const; |  (1)  |   
protected:  
virtual long do_hash( const CharT* beg, const CharT* end ) const; |  (2)  |   
| |   
  
1) Public member function, calls the protected virtual member function `do_hash` of the most derived class.

2) Converts the character sequence `[`beg`, `end`)` to an integer value that is equal to the hash obtained for all strings that collate equivalent in this locale ([compare()](compare.html "cpp/locale/collate/compare") returns ​0​). For two strings that do not collate equivalent, the probability that their hashes are equal should be very small, approaching 1.0 / [std::numeric_limits](../../types/numeric_limits.html)<unsigned long>::max().

## Contents

  * [1 Parameters](hash.html#Parameters)
  * [2 Return value](hash.html#Return_value)
  * [3 Note](hash.html#Note)
  * [4 Example](hash.html#Example)
  * [5 See also](hash.html#See_also)
...
Run this code
    ...
    struct CollateHash
    {
        ...
        long operator()(const [std::basic_string](../../string/basic_string.html)<CharT>& s) const
        {
            return [std::use_facet](../use_facet.html)<[std::collate](../collate.html)<CharT>>([std::locale](../locale.html)()).hash(
                       &s[0], &s[0] + s.size()
                   );
        }
    };
    ...
    {
        template<typename CharT>
        bool operator()(const [std::basic_string](../../string/basic_string.html)<CharT>& s1,
                        const [std::basic_string](../../string/basic_string.html)<CharT>& s2) const
        {
            return [std::use_facet](../use_facet.html)<[std::collate](../collate.html)<CharT>>([std::locale](../locale.html)()).compare(
                         &s1[0], &s1[0] + s1.size(),
                         &s2[0], &s2[0] + s2.size()
                   ) == 0;
        }
    ...
     
        [std::unordered_set](../../container/unordered_set.html)<[std::wstring](../../string/basic_string.html), CollateHash, CollateEq> s2 = {L"Foo", L"Bar"};
        for (auto& str : s2)
