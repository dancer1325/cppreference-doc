...
Checks if the given character is classified as a printable character (including space) by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 

## Contents

  * [1 Parameters](isprint.html#Parameters)
  * [2 Return value](isprint.html#Return_value)
  * [3 Possible implementation](isprint.html#Possible_implementation)
...
### Possible implementation
    ...
    template<class CharT>
    bool isprint(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).is([std::ctype_base::print](ctype_base.html), ch);
    }  
...
Run this code
    ...
     
        ...
        [std::cout](../io/cout.html) << "isprint('™', C locale) returned "
                  << [std::boolalpha](../io/manip/boolalpha.html) << [std::isprint](../string/byte/isprint.html)(c, loc1) << '\n';
     
        [std::locale](locale.html) loc2("en_US.UTF-8");
        [std::cout](../io/cout.html) << "isprint('™', Unicode locale) returned "
                  << [std::boolalpha](../io/manip/boolalpha.html) << [std::isprint](../string/byte/isprint.html)(c, loc2) << '\n';
    }
