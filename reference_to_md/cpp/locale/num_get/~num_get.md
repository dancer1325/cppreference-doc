...
**num_get::~num_get**  
[num_get::getnum_get::do_get](get.html "cpp/locale/num get/get")  
...
Destructs a [std::num_get](../num_get.html) facet. This destructor is protected and virtual (due to [base class](../locale/facet.html "cpp/locale/locale/facet") destructor being virtual). An object of type [std::num_get](../num_get.html), like most facets, can only be destroyed when the last [std::locale](../locale.html "cpp/locale/locale") object that implements this facet goes out of scope or if a user-defined class is derived from [std::num_get](../num_get.html) and implements a public destructor. 
...
Run this code
    ...
    #include <locale>
     
    struct Destructible_num_get : public [std::num_get](../num_get.html)<wchar_t>
    {
        Destructible_num_get([std::size_t](../../types/size_t.html) refs = 0) : num_get(refs) {}
