...
**moneypunct::curr_symbol moneypunct::do_curr_symbol**  
...
Run this code
    ...
    void show_ccy(const char* locname)
    {
        ...
        [std::cout](../../io/cout.html) << locname << " currency symbol is "
                  << [std::use_facet](../use_facet.html)<[std::moneypunct](../moneypunct.html)<char, true>>(loc).curr_symbol()
                  << "or " << [std::use_facet](../use_facet.html)<[std::moneypunct](../moneypunct.html)<char>>(loc).curr_symbol()
                  << " for short\n";
    }
     
    int main()
