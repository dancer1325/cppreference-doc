...
---|---|---  
public:  
pattern pos_format() const; |  (1)  |   
public:  
pattern neg_format() const; |  (2)  |   
protected:  
virtual pattern do_pos_format() const; |  (3)  |   
protected:  
virtual pattern do_neg_format() const; |  (4)  |   
| |   
...
3) Returns the format structure (of type [`std::money_base::format`](../money_base.html "cpp/locale/money base")) which describes the formatting of positive monetary values.

4) Returns the format structure (of type [`std::money_base::format`](../money_base.html "cpp/locale/money base")) which describes the formatting of negative monetary values.

The standard specializations of [std::moneypunct](../moneypunct.html) return the pattern {symbol, sign, none, value}. 

## Contents

  * [1 Return value](pos_format.html#Return_value)
  * [2 Notes](pos_format.html#Notes)
  * [3 Example](pos_format.html#Example)
  * [4 See also](pos_format.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html).imbue([std::locale](../locale.html)("en_US.utf8"));
    ...
     
        [std::cout](../../io/cout.html).imbue([std::locale](../locale.html)([std::cout](../../io/cout.html).getloc(), new my_punct("en_US.utf8")));
