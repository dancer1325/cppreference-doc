...
[moneypunct::groupingmoneypunct::do_grouping](grouping.html "cpp/locale/moneypunct/grouping")  
...
---|---|---  
public:  
string_type positive_sign() const; |  (1)  |   
public:  
string_type negative_sign() const; |  (2)  |   
protected:  
virtual string_type do_positive_sign() const; |  (3)  |   
protected:  
virtual string_type do_negative_sign() const; |  (4)  |   
| |   
...
Only the first character of the string returned is the character that appears in the [pos_format()](pos_format.html "cpp/locale/moneypunct/pos format")/[neg_format()](pos_format.html "cpp/locale/moneypunct/pos format") position indicated by the value sign. The rest of the characters appear _after_ the rest of the monetary string. 
...
Run this code
    ...
    int main()
    {
        [std::locale](../locale.html) loc("de_DE.utf8");
        [std::cout](../../io/cout.html).imbue(loc);
        [std::cout](../../io/cout.html) << loc.name() << " negative sign is '"
                  << [std::use_facet](../use_facet.html)<[std::moneypunct](../moneypunct.html)<char>>(loc).negative_sign()
                  << "' for example: " << [std::showbase](../../io/manip/showbase.html) << [std::put_money](../../io/manip/put_money.html)(-1234) << '\n';
     
        [std::locale](../locale.html) loc2("ms_MY.utf8");
        [std::cout](../../io/cout.html).imbue(loc2);
        [std::cout](../../io/cout.html) << loc2.name() << " negative sign is '"
                  << [std::use_facet](../use_facet.html)<[std::moneypunct](../moneypunct.html)<char>>(loc2).negative_sign()
                  << "' for example: " << [std::put_money](../../io/manip/put_money.html)(-1234) << '\n';
     
        [std::cout](../../io/cout.html).imbue([std::locale](../locale.html)([std::cout](../../io/cout.html).getloc(), new my_punct("de_DE.utf8")));
        [std::cout](../../io/cout.html) << "de_DE.utf8 with negative_sign set to \"()\": "
                  << [std::put_money](../../io/manip/put_money.html)(-1234) << '\n';
    }
