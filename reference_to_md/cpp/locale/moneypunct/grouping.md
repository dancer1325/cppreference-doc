...
Member functions  
---  
[moneypunct::moneypunct](moneypunct.html "cpp/locale/moneypunct/moneypunct")  
[moneypunct::~moneypunct](~moneypunct.html "cpp/locale/moneypunct/~moneypunct")  
[moneypunct::decimal_pointmoneypunct::do_decimal_point](decimal_point.html "cpp/locale/moneypunct/decimal point")  
[moneypunct::thousands_sepmoneypunct::do_thousands_sep](thousands_sep.html "cpp/locale/moneypunct/thousands sep")  
**moneypunct::grouping moneypunct::do_grouping**  
[moneypunct::curr_symbolmoneypunct::do_curr_symbol](curr_symbol.html "cpp/locale/moneypunct/curr symbol")  
[moneypunct::frac_digitsmoneypunct::do_frac_digits](frac_digits.html "cpp/locale/moneypunct/frac digits")  
...
---|---|---  
public:  
[std::string](../../string/basic_string.html) grouping() const; |  (1)  |   
protected:  
virtual [std::string](../../string/basic_string.html) do_grouping() const; |  (2)  |   
| |   
  
1) Public member function, calls the member function `do_grouping` of the most derived class.

2) Returns the pattern that determines the grouping of the digits in the monetary output, with the same exact meaning as [std::numpunct::do_grouping](../numpunct/grouping.html "cpp/locale/numpunct/grouping").

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/moneypunct/grouping&action=edit&section=1 "Edit section: Return value")] Return value

The object of type [std::string](../../string/basic_string.html "cpp/string/basic string") holding the groups. The standard specializations of `std::moneypunct` return an empty string, indicating no grouping. Typical groupings (e.g. the `en_US` locale) return "\003". 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/moneypunct/grouping&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    #include <locale>
     
    struct space_out : [std::moneypunct](../moneypunct.html)<char>
    {
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "american locale: " << [std::showbase](../../io/manip/showbase.html)
                  << [std::put_money](../../io/manip/put_money.html)(12345678.0) << '\n';
     
        [std::cout](../../io/cout.html).imbue([std::locale](../locale.html)([std::cout](../../io/cout.html).getloc(), new space_out));
        [std::cout](../../io/cout.html) << "locale with modified moneypunct: "
                  << [std::put_money](../../io/manip/put_money.html)(12345678.0) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/moneypunct/grouping&action=edit&section=3 "Edit section: See also")] See also
