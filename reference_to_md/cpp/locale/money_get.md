...
Member functions  
---  
[money_get::money_get](money_get/money_get.html "cpp/locale/money get/money get")  
[money_get::~money_get](money_get/~money_get.html "cpp/locale/money get/~money get")  
[money_get::getmoney_get::do_get](money_get/get.html "cpp/locale/money get/get")  
...
Class template `std::money_get` encapsulates the rules for parsing monetary values from character streams. The standard I/O manipulator [std::get_money](../io/manip/get_money.html "cpp/io/manip/get money") uses the `std::money_get` facet of the I/O stream's locale. 

![std-money get-inheritance.svg](https://upload.cppreference.com/mwiki/images/1/1b/std-money_get-inheritance.svg)

Inheritance diagram

If a `std::money_get` specialization is not guaranteed to be provided by the standard library (see below), the behaviors of its [get()](money_get/get.html "cpp/locale/money get/get") and [do_get()](money_get/get.html "cpp/locale/money get/get") are not guaranteed as specified. 

## Contents

  * [1 Specializations](money_get.html#Specializations)
  * [2 Nested types](money_get.html#Nested_types)
  * [3 Data members](money_get.html#Data_members)
  * [4 Member functions](money_get.html#Member_functions)
  * [5 Protected member functions](money_get.html#Protected_member_functions)
  * [6 Example](money_get.html#Example)
  * [7 Defect reports](money_get.html#Defect_reports)
  * [8 See also](money_get.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/money_get&action=edit&section=1 "Edit section: Specializations")] Specializations
...
In addition, the standard library is also guaranteed to provide every specialization that satisfies the following type requirements: 
  ...
  * `CharT` is one of 
    * char, 
    * wchar_t, and 
    * any other implementation-defined [character container type](../string.html "cpp/string") that meets the requirements for a character on which any of the [iostream components](../io.html "cpp/io") can be instantiated; and 
  * `InputIt` must meet the requirements of [LegacyInputIterator](../named_req/InputIterator.html "cpp/named req/InputIterator"). 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/money_get&action=edit&section=2 "Edit section: Nested types")] Nested types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/money_get&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](money_get/money_get.html "cpp/locale/money get/money get") |  constructs a new `money_get` facet   
(public member function)  
---|---  
[ get](money_get/get.html "cpp/locale/money get/get") |  invokes `do_get`   
(public member function)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/money_get&action=edit&section=4 "Edit section: Protected member functions")] Protected member functions

[ (destructor)](money_get/~money_get.html "cpp/locale/money get/~money get") |  destructs a `money_get` facet   
(protected member function)  
---|---  
[ do_get](money_get/get.html "cpp/locale/money get/get")[virtual] |  parses a monetary value from an input stream   
(virtual protected member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/locale/money_get/dsc_do_get&action=edit)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/money_get&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::string](../string/basic_string.html) str = "$1.11 $2.22 $3.33";
        [std::cout](../io/cout.html) << [std::fixed](../io/manip/fixed.html) << [std::setprecision](../io/manip/setprecision.html)(2);
     
        [std::cout](../io/cout.html) << '\"' << str << "\" parsed with the I/O manipulator: ";
        [std::istringstream](../io/basic_istringstream.html) s1(str);
        s1.imbue([std::locale](locale.html)("en_US.UTF-8"));
     
        long double val;
        while (s1 >> [std::get_money](../io/manip/get_money.html)(val))
            [std::cout](../io/cout.html) << val / 100 << ' ';
        [std::cout](../io/cout.html) << '\n';
     
        str = "USD  1,234.56";
        [std::cout](../io/cout.html) << '\"' << str << "\" parsed with the facet directly: ";
        [std::istringstream](../io/basic_istringstream.html) s2(str);
        s2.imbue([std::locale](locale.html)("en_US.UTF-8"));
     
        auto& f = [std::use_facet](use_facet.html)<std::money_get<char>>(s2.getloc());
        [std::ios_base::iostate](../io/ios_base/iostate.html) err;
        [std::istreambuf_iterator](../iterator/istreambuf_iterator.html)<char> beg(s2), end;
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/money_get&action=edit&section=6 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 427](https://cplusplus.github.io/LWG/issue427) | C++98  | `money_get` was guaranteed to accept any `CharT` that  
...
[LWG 2392](https://cplusplus.github.io/LWG/issue2392) | C++98  | only character type `CharT` could be  
guaranteed to be accepted by `money_get` | can guarantee to accept implementation-  
defined character container types   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/money_get&action=edit&section=7 "Edit section: See also")] See also

[ moneypunct](moneypunct.html "cpp/locale/moneypunct") |  defines monetary formatting parameters used by **std::money_get** and [std::money_put](money_put.html "cpp/locale/money put")   
