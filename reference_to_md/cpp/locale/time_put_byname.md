...
template<  
class CharT,  
class OutputIt = [std::ostreambuf_iterator](../iterator/ostreambuf_iterator.html)<CharT>  
> class time_put_byname : public [std::time_put](time_put.html)<CharT, OutputIt> |  |   
| |   
  
`std::time_put_byname` is a [std::time_put](time_put.html "cpp/locale/time put") facet which encapsulates time and date formatting rules of the locale specified at its construction. 

## Contents

  * [1 Specializations](time_put_byname.html#Specializations)
  * [2 Nested types](time_put_byname.html#Nested_types)
  * [3 Member functions](time_put_byname.html#Member_functions)
  * [4 std::time_put_byname::time_put_byname](time_put_byname.html#std::time_put_byname::time_put_byname)
    * [4.1 Parameters](time_put_byname.html#Parameters)
  * [5 std::time_put_byname::~time_put_byname](time_put_byname.html#std::time_put_byname::.7Etime_put_byname)
  * [6 Inherited from std::time_put](time_put_byname.html#Inherited_from_std::time_put)
    * [6.1 Data members](time_put_byname.html#Data_members)
    * [6.2 Member functions](time_put_byname.html#Member_functions_2)
    * [6.3 Protected member functions](time_put_byname.html#Protected_member_functions)
    * [6.4 Example](time_put_byname.html#Example)
    * [6.5 See also](time_put_byname.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_put_byname&action=edit&section=1 "Edit section: Specializations")] Specializations
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_put_byname&action=edit&section=2 "Edit section: Nested types")] Nested types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_put_byname&action=edit&section=3 "Edit section: Member functions")] Member functions
...
explicit time_put_byname( const char* name, [std::size_t](../types/size_t.html) refs = 0 ); |  |   
---|---|---  
explicit time_put_byname( const [std::string](../string/basic_string.html)& name, [std::size_t](../types/size_t.html) refs = 0 ); |  |  (since C++11)  
| |   
...
##  Inherited from [std::time_put](time_put.html "cpp/locale/time put")
...
(public member function of `std::time_put<CharT,OutputIt>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/locale/time_put/dsc_put&action=edit)  
---|---  
  
###  Protected member functions

[ do_put](time_put/put.html "cpp/locale/time put/put")[virtual] |  formats date/time and writes to output stream   
(virtual protected member function of `std::time_put<CharT,OutputIt>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/locale/time_put/dsc_do_put&action=edit)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_put_byname&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::wbuffer_convert](wbuffer_convert.html)<[std::codecvt_utf8](codecvt_utf8.html)<wchar_t>> conv([std::cout](../io/cout.html).rdbuf());
        [std::wostream](../io/basic_ostream.html) out(&conv);
     
        out.imbue([std::locale](locale.html)(out.getloc(),
                              new std::time_put_byname<wchar_t>("ja_JP.utf8")));
        out << [std::put_time](../io/manip/put_time.html)([std::localtime](../chrono/c/localtime.html)(&t), L"%A %c") << '\n';
     
        out.imbue([std::locale](locale.html)(out.getloc(),
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_put_byname&action=edit&section=5 "Edit section: See also")] See also
