...
class collate_byname : public [std::collate](collate.html)<CharT>; |  |   
| |   
  
`std::collate_byname` is a [std::collate](collate.html "cpp/locale/collate") facet which encapsulates locale-specific collation (comparison) and hashing of strings. Just like [std::collate](collate.html "cpp/locale/collate"), it can be imbued in [std::regex](../regex/basic_regex.html "cpp/regex/basic regex") and applied, by means of [`std::locale::operator()`](locale/operator\(\).html "cpp/locale/locale/operator\(\)"), directly to all standard algorithms that expect a string comparison predicate. 

## Contents

  * [1 Specializations](collate_byname.html#Specializations)
  * [2 Member functions](collate_byname.html#Member_functions)
  * [3 std::collate_byname::collate_byname](collate_byname.html#std::collate_byname::collate_byname)
    * [3.1 Parameters](collate_byname.html#Parameters)
  * [4 std::collate_byname::~collate_byname](collate_byname.html#std::collate_byname::.7Ecollate_byname)
  * [5 Inherited from std::collate](collate_byname.html#Inherited_from_std::collate)
    * [5.1 Nested types](collate_byname.html#Nested_types)
    * [5.2 Data members](collate_byname.html#Data_members)
    * [5.3 Member functions](collate_byname.html#Member_functions_2)
    * [5.4 Protected member functions](collate_byname.html#Protected_member_functions)
    * [5.5 Notes](collate_byname.html#Notes)
    * [5.6 Example](collate_byname.html#Example)
    * [5.7 See also](collate_byname.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/collate_byname&action=edit&section=1 "Edit section: Specializations")] Specializations
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/collate_byname&action=edit&section=2 "Edit section: Member functions")] Member functions
...
explicit collate_byname( const char* name, [std::size_t](../types/size_t.html) refs = 0 ); |  |   
---|---|---  
explicit collate_byname( const [std::string](../string/basic_string.html)& name, [std::size_t](../types/size_t.html) refs = 0 ); |  |  (since C++11)  
| |   
...
##  Inherited from [std::collate](collate.html "cpp/locale/collate")
...
(public member function of `std::collate<CharT>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/locale/collate/dsc_compare&action=edit)  
---|---  
[ transform](collate/transform.html "cpp/locale/collate/transform") |  invokes `do_transform`   
(public member function of `std::collate<CharT>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/locale/collate/dsc_transform&action=edit)  
[ hash](collate/hash.html "cpp/locale/collate/hash") |  invokes `do_hash`   
(public member function of `std::collate<CharT>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/locale/collate/dsc_hash&action=edit)  
...
(virtual protected member function of `std::collate<CharT>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/locale/collate/dsc_do_hash&action=edit)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/collate_byname&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/collate_byname&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/collate_byname&action=edit&section=5 "Edit section: See also")] See also
