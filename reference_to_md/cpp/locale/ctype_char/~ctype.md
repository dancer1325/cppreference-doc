...
Destructs a [std::ctype](../ctype.html)<char> facet. This destructor is protected and virtual (due to [base class](../locale/facet.html "cpp/locale/locale/facet") destructor being virtual). An object of type [std::ctype](../ctype.html)<char>, like most facets, can only be destroyed when the last [std::locale](../locale.html "cpp/locale/locale") object that implements this facet goes out of scope or if a user-defined class is derived from [std::ctype](../ctype.html)<char> and implements a public destructor. 

If, when this instance of [std::ctype](../ctype.html)<char> was constructed, a custom classification table was provided and the second argument to the constructor (the boolean `del`) was true, then this destructor executes delete[] table(). 
