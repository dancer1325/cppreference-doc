...
## Contents
  ...
  * [3 Notes](scan_is.html#Notes)
  * [4 Example](scan_is.html#Example)
...
Run this code
    ...
    int main()
    {
        [std::locale](../locale.html) loc("");
        auto& f = [std::use_facet](../use_facet.html)<[std::ctype](../ctype.html)<char>>(loc);
     
        // skip until the first letter
        char s1[] = "      \t\t\n  Test";
        const char* p1 = f.scan_is([std::ctype_base::alpha](../ctype_base.html), [std::begin](../../iterator/begin.html)(s1), [std::end](../../iterator/end.html)(s1));
        [std::cout](../../io/cout.html) << '\'' << p1 << "'\n";
     
        // skip until the first letter
        char s2[] = "123456789abcd";
        const char* p2 = f.scan_is([std::ctype_base::alpha](../ctype_base.html), [std::begin](../../iterator/begin.html)(s2), [std::end](../../iterator/end.html)(s2));
