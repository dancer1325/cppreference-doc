...
![std-num get-inheritance.svg](https://upload.cppreference.com/mwiki/images/5/59/std-num_get-inheritance.svg)

Inheritance diagram

If a `std::num_get` specialization is not guaranteed to be provided by the standard library (see below), the behaviors of its [get()](num_get/get.html "cpp/locale/num get/get") and [do_get()](num_get/get.html "cpp/locale/num get/get") are not guaranteed as specified. 

## Contents

  * [1 Specializations](num_get.html#Specializations)
  * [2 Nested types](num_get.html#Nested_types)
  * [3 Data members](num_get.html#Data_members)
  * [4 Member functions](num_get.html#Member_functions)
  * [5 Protected member functions](num_get.html#Protected_member_functions)
  * [6 Example](num_get.html#Example)
  * [7 Defect reports](num_get.html#Defect_reports)
  * [8 See also](num_get.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::string](../string/basic_string.html) de_double = "1.234.567,89";
        [std::string](../string/basic_string.html) us_double = "1,234,567.89";
     
        // parse using streams
        [std::istringstream](../io/basic_istringstream.html) de_in(de_double);
        de_in.imbue([std::locale](locale.html)("de_DE.UTF-8"));
        double f1;
        de_in >> f1;
     
        [std::istringstream](../io/basic_istringstream.html) us_in(de_double);
        us_in.imbue([std::locale](locale.html)("en_US.UTF-8"));
        double f2;
        us_in >> f2;
     
        [std::cout](../io/cout.html) << "Parsing " << de_double << " as double gives " << [std::fixed](../io/manip/fixed.html)
                  << f1 << " in de_DE locale and " << f2 << " in en_US\n";
     
        // use the facet directly
        [std::istringstream](../io/basic_istringstream.html) s3(us_double);
        s3.imbue([std::locale](locale.html)("en_US.UTF-8"));
     
        auto& f = [std::use_facet](use_facet.html)<std::num_get<char>>(s3.getloc());
        [std::istreambuf_iterator](../iterator/istreambuf_iterator.html)<char> beg(s3), end;
        double f3;
        std::ios::iostate err;
        f.get(beg, end, s3, err, f3);
     
        [std::cout](../io/cout.html) << "parsing " << us_double
...
---|---|---|---  
[LWG 427](https://cplusplus.github.io/LWG/issue427) | C++98  | `num_get` was guaranteed to accept any `CharT` that  
