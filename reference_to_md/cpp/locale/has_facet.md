...
bool has_facet( const locale& loc ) throw(); |  | (until C++11)  
template< class Facet >  
bool has_facet( const locale& loc ) noexcept; |  |  (since C++11)  
| |   
  
Checks if the locale loc implements the facet `Facet`. 

The program is ill-formed if Facet is not a [facet](locale/facet.html#Facet_class "cpp/locale/locale/facet") or it is a volatile-qualified facet. 

## Contents

  * [1 Parameters](has_facet.html#Parameters)
  * [2 Return value](has_facet.html#Return_value)
  * [3 Notes](has_facet.html#Notes)
  * [4 Example](has_facet.html#Example)
  * [5 Defect reports](has_facet.html#Defect_reports)
  * [6 See also](has_facet.html#See_also)
...
Run this code
    ...
    struct myfacet : public [std::locale::facet](locale/facet.html)
    {
        static [std::locale::id](locale/id.html) id;
    };
     
    [std::locale::id](locale/id.html) myfacet::id;
     
    int main()
    {
        // loc is a "C" locale with myfacet added
        [std::locale](locale.html) loc([std::locale::classic](locale/classic.html)(), new myfacet);
        [std::cout](../io/cout.html) << [std::boolalpha](../io/manip/boolalpha.html)
                  << "Can loc classify chars? "
                  << std::has_facet<[std::ctype](ctype.html)<char>>(loc) << '\n'
                  << "Can loc classify char32_t? "
                  << std::has_facet<[std::ctype](ctype.html)<char32_t>>(loc) << '\n'
