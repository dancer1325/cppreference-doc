...
[numpunct::~numpunct](~numpunct.html "cpp/locale/numpunct/~numpunct")  
**numpunct::decimal_point numpunct::do_decimal_point**  
...
---|---|---  
public:  
char_type decimal_point() const; |  (1)  |   
protected:  
virtual char_type do_decimal_point() const; |  (2)  |   
| |   
...
Run this code
    ...
    #include <locale>
     
    struct slash : [std::numpunct](../numpunct.html)<char>
    {
    ...
    int main()
    {
        [std::cout](../../io/cout.html).precision(10);
        [std::cout](../../io/cout.html) << "default locale: " << 1234.5678 << '\n';
        [std::cout](../../io/cout.html).imbue([std::locale](../locale.html)([std::cout](../../io/cout.html).getloc(), new slash));
        [std::cout](../../io/cout.html) << "locale with modified numpunct: " << 1234.5678 << '\n';
    }
