...
**numpunct::truename numpunct::do_truenamenumpunct::falsenamenumpunct::do_falsename**  
...
---|---|---  
public:  
string_type truename() const; |  (1)  |   
public:  
string_type falsename() const; |  (2)  |   
protected:  
virtual string_type do_truename() const; |  (3)  |   
protected:  
virtual string_type do_falsename() const; |  (4)  |   
| |   
...
Run this code
    ...
    #include <locale>
     
    struct custom_tf : [std::numpunct](../numpunct.html)<char>
    {
        [std::string](../../string/basic_string.html) do_truename()  const { return {'t'}; }
        [std::string](../../string/basic_string.html) do_falsename() const { return {'f'}; }
    };
     
    int main()
    {
    ...
     
        ...
        [std::cout](../../io/cout.html).imbue([std::locale](../locale.html)([std::cout](../../io/cout.html).getloc(), new custom_tf));
