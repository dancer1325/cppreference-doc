...
Class template `std::time_put` encapsulates date and time formatting rules. The I/O manipulator [std::put_time](../io/manip/put_time.html "cpp/io/manip/put time") uses the `std::time_put` facet of the I/O stream's locale to generate text representation of an [std::tm](../chrono/c/tm.html "cpp/chrono/c/tm") object. 

![std-time put-inheritance.svg](https://upload.cppreference.com/mwiki/images/4/4b/std-time_put-inheritance.svg)

Inheritance diagram

If a `std::time_put` specialization is not guaranteed to be provided by the standard library (see below), the behaviors of its [put()](time_put/put.html "cpp/locale/time put/put") and [do_put()](time_put/put.html "cpp/locale/time put/put") are not guaranteed as specified. 

## Contents

  * [1 Specializations](time_put.html#Specializations)
  * [2 Nested types](time_put.html#Nested_types)
  * [3 Data members](time_put.html#Data_members)
  * [4 Member functions](time_put.html#Member_functions)
  * [5 Protected member functions](time_put.html#Protected_member_functions)
  * [6 Example](time_put.html#Example)
  * [7 See also](time_put.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        out.imbue([std::locale](locale.html)("ja_JP.utf8"));
     
