...
Checks if the given character is classified as an alphabetic character by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 

## Contents

  * [1 Parameters](isalpha.html#Parameters)
  * [2 Return value](isalpha.html#Return_value)
  * [3 Possible implementation](isalpha.html#Possible_implementation)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isalpha&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character   
---|---|---  
loc  |  \-  |  locale   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isalpha&action=edit&section=2 "Edit section: Return value")] Return value

Returns true if the character is classified as alphabetic, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isalpha&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class CharT>
    bool isalpha(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).is([std::ctype_base::alpha](ctype_base.html), ch);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isalpha&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../io/cout.html) << "isalpha('Я', C locale) returned "
                  << [std::boolalpha](../io/manip/boolalpha.html) << [std::isalpha](../string/byte/isalpha.html)(c, loc1) << '\n';
     
        [std::locale](locale.html) loc2("en_US.UTF8");
        [std::cout](../io/cout.html) << "isalpha('Я', Unicode locale) returned "
                  << [std::boolalpha](../io/manip/boolalpha.html) << [std::isalpha](../string/byte/isalpha.html)(c, loc2) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isalpha&action=edit&section=5 "Edit section: See also")] See also
