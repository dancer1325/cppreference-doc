...
Checks if the given character is classified as a digit by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 

## Contents

  * [1 Parameters](isdigit.html#Parameters)
  * [2 Return value](isdigit.html#Return_value)
  * [3 Possible implementation](isdigit.html#Possible_implementation)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isdigit&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character   
---|---|---  
loc  |  \-  |  locale   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isdigit&action=edit&section=2 "Edit section: Return value")] Return value

Returns true if the character is classified as a digit, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isdigit&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class CharT>
    bool isdigit(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).is([std::ctype_base::digit](ctype_base.html), ch);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isdigit&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
    struct jdigit_ctype : [std::ctype](ctype.html)<wchar_t>
    {
        [std::unordered_set](../container/unordered_set.html)<wchar_t> jdigits{
    ...
    int main()
    {
        [std::wstring](../string/basic_string.html) text = L"123一二三１２３";
        [std::locale](locale.html) loc([std::locale](locale.html)(""), new jdigit_ctype);
     
    ...
     
        for (const wchar_t c : text)
            if ([std::isdigit](../string/byte/isdigit.html)(c, loc))
                [std::wcout](../io/cout.html) << c << " is a digit\n";
            else
                [std::wcout](../io/cout.html) << c << " is NOT a digit\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isdigit&action=edit&section=5 "Edit section: See also")] See also
