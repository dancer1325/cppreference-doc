...
Converts the character ch to lowercase if possible, using the conversion rules specified by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 
...
## Contents
  ...
  * [4 Possible implementation](tolower.html#Possible_implementation)
  * [5 Example](tolower.html#Example)
  * [6 See also](tolower.html#See_also)
...
### Possible implementation
    ...
    template<class CharT>
    CharT tolower(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).tolower(ch);
    }  
...
Run this code
    ...
     
        [std::cout](../io/cout.html) << "in the default locale, tolower(" << ([std::wint_t](../string/wide.html))c << ") = "
                  << ([std::wint_t](../string/wide.html))[std::tolower](../string/byte/tolower.html)(c, [std::locale](locale.html)()) << '\n';
     
        [std::cout](../io/cout.html) << "in Unicode locale, tolower(" << ([std::wint_t](../string/wide.html))c << ") = "
                  << ([std::wint_t](../string/wide.html))[std::tolower](../string/byte/tolower.html)(c, [std::locale](locale.html)("en_US.utf8")) << '\n';
    }
