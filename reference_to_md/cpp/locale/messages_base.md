...
---|---|---|---  
[LWG 2028](https://cplusplus.github.io/LWG/issue2028) | C++98  | `catalog` was defined as int | defined as an unspecified signed integer type[[1]](messages_base.html#cite_note-1)  
  
  1. [↑](messages_base.html#cite_ref-1) The catalog type `nl_catd` used in [POSIX messaging API](https://unix.org/version4/) is a typedef of an unspecified type.
