...
Checks if the given character is classified as a control character by the given locale's [std::ctype](ctype.html "cpp/locale/ctype") facet. 

## Contents

  * [1 Parameters](iscntrl.html#Parameters)
  * [2 Return value](iscntrl.html#Return_value)
  * [3 Possible implementation](iscntrl.html#Possible_implementation)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/iscntrl&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character   
---|---|---  
loc  |  \-  |  locale   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/iscntrl&action=edit&section=2 "Edit section: Return value")] Return value

Returns true if the character is classified as a control character, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/iscntrl&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class CharT>
    bool iscntrl(CharT ch, const [std::locale](locale.html)& loc)
    {
        return [std::use_facet](use_facet.html)<[std::ctype](ctype.html)<CharT>>(loc).is([std::ctype_base::cntrl](ctype_base.html), ch);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/iscntrl&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../io/cout.html) << "iscntrl(CCH, C locale) returned "
                  << [std::boolalpha](../io/manip/boolalpha.html) << [std::iscntrl](../string/byte/iscntrl.html)(CCH, loc1) << '\n';
     
        [std::locale](locale.html) loc2("en_US.UTF8");
        [std::cout](../io/cout.html) << "iscntrl(CCH, Unicode locale) returned "
                  << [std::boolalpha](../io/manip/boolalpha.html) << [std::iscntrl](../string/byte/iscntrl.html)(CCH, loc2) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/iscntrl&action=edit&section=5 "Edit section: See also")] See also
