...
[wstring_convert::~wstring_convert](~wstring_convert.html "cpp/locale/wstring convert/~wstring convert")  
[wstring_convert::from_bytes](from_bytes.html "cpp/locale/wstring convert/from bytes")  
...
Converts a wide sequence to a byte string using the facet pointed to by `_[cvtptr](../wstring_convert.html#cvtptr "cpp/locale/wstring convert")_` ﻿. 
...
Before the conversion begins, if *this was **not** constructed with constructor overload [(3)](wstring_convert.html "cpp/locale/wstring convert/wstring convert"), `_[cvtstate](../wstring_convert.html#cvtstate "cpp/locale/wstring convert")_` will be set to its default value (the initial conversion state). 
...
## Contents
  ...
  * [1 Return value](to_bytes.html#Return_value)
  * [2 Exceptions](to_bytes.html#Exceptions)
  * [3 Example](to_bytes.html#Example)
  * [4 See also](to_bytes.html#See_also)
...
Run this code
    ...
    void hex_print(const [std::string](../../string/basic_string.html)& s)
    {
        [std::cout](../../io/cout.html) << [std::hex](../../io/manip/hex.html) << [std::setfill](../../io/manip/setfill.html)('0');
    ...
    {
        // wide character data
        [std::wstring](../../string/basic_string.html) wstr = L"z\u00df\u6c34\U0001f34c"; // or L"zß水🍌"
     
        // wide to UTF-8
        [std::wstring_convert](../wstring_convert.html)<[std::codecvt_utf8](../codecvt_utf8.html)<wchar_t>> conv1;
        [std::string](../../string/basic_string.html) u8str = conv1.to_bytes(wstr);
        [std::cout](../../io/cout.html) << "UTF-8 conversion produced " << u8str.size() << " bytes:\n";
        hex_print(u8str);
     
        // wide to UTF-16le
        [std::wstring_convert](../wstring_convert.html)<[std::codecvt_utf16](../codecvt_utf16.html)<wchar_t, 0x10ffff, [std::little_endian](../codecvt_mode.html)>> conv2;
        [std::string](../../string/basic_string.html) u16str = conv2.to_bytes(wstr);
        [std::cout](../../io/cout.html) << "UTF-16le conversion produced " << u16str.size() << " bytes:\n";
        hex_print(u16str);
    }
