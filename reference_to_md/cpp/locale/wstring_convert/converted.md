...
---|---|---  
[std::size_t](../../types/size_t.html) converted() const noexcept; |  |   
| |   
  
Returns the number of source characters that were successfully processed by the most recent [from_bytes()](from_bytes.html "cpp/locale/wstring convert/from bytes") or [to_bytes()](to_bytes.html "cpp/locale/wstring convert/to bytes"). 

## Contents

  * [1 Return value](converted.html#Return_value)
  * [2 Example](converted.html#Example)
  * [3 Defect reports](converted.html#Defect_reports)
  * [4 See also](converted.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "original UTF-8 string size: " << utf8.size() << '\n';
     
        // the UTF-8 - UTF-32 standard conversion facet
        [std::wstring_convert](../wstring_convert.html)<[std::codecvt_utf8](../codecvt_utf8.html)<char32_t>, char32_t> cvt;
     
        // UTF-8 to UTF-32
        [std::u32string](../../string/basic_string.html) utf32 = cvt.from_bytes(utf8);
        [std::cout](../../io/cout.html) << "UTF-32 string size: " << utf32.size() << '\n';
        [std::cout](../../io/cout.html) << "converted() == " << cvt.converted() << '\n';
     
        // UTF-32 to UTF-8
        utf8 = cvt.to_bytes(utf32);
        [std::cout](../../io/cout.html) << "new UTF-8 string size: " << utf8.size() << '\n';
        [std::cout](../../io/cout.html) << "converted() == " << cvt.converted() << '\n';
    }
