...
wstring_convert( const [std::wstring_convert](../wstring_convert.html)& ) = delete; |  (5)  |  (since C++14)  
| |   
Overload  | [Data members](../wstring_convert.html#Data_members "cpp/locale/wstring convert")  
---|---  
` _byte_err_string_` |  ` _wide_err_string_` | `_cvtptr_` | `_cvtstate_` | `_cvtcount_`  
(1) | [default-initialized](../../language/default_initialization.html "cpp/language/default initialization") |  new Codecvt |  default-initialized  |  uninitialized   
(2) | pcvt  
(3) | state  
...
Run this code
    ...
    int main()
    {
        ...
        [std::wstring_convert](../wstring_convert.html)
            <[std::codecvt_utf16](../codecvt_utf16.html)<char32_t, 0x10ffff, [std::little_endian](../codecvt_mode.html)>> u16to32;
     
        // UTF-8 / wide string conversion with custom messages
        [std::wstring_convert](../wstring_convert.html)<[std::codecvt_utf8](../codecvt_utf8.html)<wchar_t>> u8towide("Error!", L"Error!");
     
        // GB18030 / wide string conversion facet
        using F = deletable_facet<[std::codecvt_byname](../codecvt_byname.html)<wchar_t, char, [std::mbstate_t](../../string/multibyte/mbstate_t.html)>>;
...
---|---|---|---  
[LWG 2175](https://cplusplus.github.io/LWG/issue2175) | C++11  | pcvt could be a null pointer  | the behavior is undefined in this case   
[LWG 2176](https://cplusplus.github.io/LWG/issue2176) | C++11  | constructors accepting single argument were implicit  | made explicit   
