...
**money_put::~money_put**  
[money_put::putmoney_put::do_put](put.html "cpp/locale/money put/put")  
...
Destructs a [std::money_put](../money_put.html) facet. This destructor is protected and virtual (due to [base class](../locale/facet.html "cpp/locale/locale/facet") destructor being virtual). An object of type [std::money_put](../money_put.html), like most facets, can only be destroyed when the last [std::locale](../locale.html "cpp/locale/locale") object that implements this facet goes out of scope or if a user-defined class is derived from [std::money_put](../money_put.html) and implements a public destructor. 
...
Run this code
    ...
    #include <locale>
     
    struct Destructible_money_put : public [std::money_put](../money_put.html)<wchar_t>
    {
        Destructible_money_put([std::size_t](../../types/size_t.html) refs = 0) : money_put(refs) {}
