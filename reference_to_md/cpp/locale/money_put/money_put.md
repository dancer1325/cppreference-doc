...
---|---|---  
explicit money_put( [std::size_t](../../types/size_t.html) refs = 0 ); |  |   
| |   
  
Creates a [std::money_put](../money_put.html) facet and forwards the starting reference count refs to the base class constructor, [`locale::facet::facet()`](../locale/facet/facet.html "cpp/locale/locale/facet/facet"). 
