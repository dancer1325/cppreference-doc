...
[std::codecvt_mode](codecvt_mode.html) Mode = ([std::codecvt_mode](codecvt_mode.html))0 >  
class codecvt_utf8_utf16  
: public [std::codecvt](codecvt.html)<Elem, char, [std::mbstate_t](../string/multibyte/mbstate_t.html)>; |  |  (since C++11)   
(deprecated in C++17)   
(removed in C++26)  
| |   
  
`std::codecvt_utf8_utf16` is a [std::codecvt](codecvt.html "cpp/locale/codecvt") facet which encapsulates conversion between a UTF-8 encoded byte string and UTF-16 encoded character string. If `Elem` is a 32-bit type, one UTF-16 code unit will be stored in each 32-bit character of the output sequence. 

This is an N:M conversion facet, and cannot be used with [std::basic_filebuf](../io/basic_filebuf.html "cpp/io/basic filebuf") (which only permits 1:N conversions, such as UTF-32/UTF-8, between the internal and the external encodings). This facet can be used with [std::wstring_convert](wstring_convert.html "cpp/locale/wstring convert"). 

## Contents

  * [1 Template Parameters](codecvt_utf8_utf16.html#Template_Parameters)
  * [2 Member functions](codecvt_utf8_utf16.html#Member_functions)
  * [3 std::codecvt_utf8_utf16::codecvt_utf8_utf16](codecvt_utf8_utf16.html#std::codecvt_utf8_utf16::codecvt_utf8_utf16)
    * [3.1 Parameters](codecvt_utf8_utf16.html#Parameters)
  * [4 std::codecvt_utf8_utf16::~codecvt_utf8_utf16](codecvt_utf8_utf16.html#std::codecvt_utf8_utf16::.7Ecodecvt_utf8_utf16)
  * [5 Inherited from std::codecvt](codecvt_utf8_utf16.html#Inherited_from_std::codecvt)
    * [5.1 Nested types](codecvt_utf8_utf16.html#Nested_types)
    * [5.2 Data members](codecvt_utf8_utf16.html#Data_members)
    * [5.3 Member functions](codecvt_utf8_utf16.html#Member_functions_2)
    * [5.4 Protected member functions](codecvt_utf8_utf16.html#Protected_member_functions)
  * [6 Inherited from std::codecvt_base](codecvt_utf8_utf16.html#Inherited_from_std::codecvt_base)
    * [6.1 Example](codecvt_utf8_utf16.html#Example)
    * [6.2 Defect reports](codecvt_utf8_utf16.html#Defect_reports)
    * [6.3 See also](codecvt_utf8_utf16.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/codecvt_utf8_utf16&action=edit&section=1 "Edit section: Template Parameters")] Template Parameters
...
Mode  |  \-  |  a constant of type [std::codecvt_mode](codecvt_mode.html "cpp/locale/codecvt mode")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/codecvt_utf8_utf16&action=edit&section=2 "Edit section: Member functions")] Member functions
...
explicit codecvt_utf8_utf16( [std::size_t](../types/size_t.html) refs = 0 ); |  |   
---|---|---  
| |   
...
##  Inherited from [std::codecvt](codecvt.html "cpp/locale/codecvt")
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/codecvt_utf8_utf16&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::string](../string/basic_string.html) u8 = "z\u00df\u6c34\U0001f34c";
        [std::u16string](../string/basic_string.html) u16 = u"z\u00df\u6c34\U0001f34c";
     
        // UTF-8 to UTF-16/char16_t
        [std::u16string](../string/basic_string.html) u16_conv = [std::wstring_convert](wstring_convert.html)<
            std::codecvt_utf8_utf16<char16_t>, char16_t>{}.from_bytes(u8);
        [assert](../error/assert.html)(u16 == u16_conv);
        [std::cout](../io/cout.html) << "UTF-8 to UTF-16 conversion produced " << u16_conv.size()
                  << " code units:\n" << [std::showbase](../io/manip/showbase.html) << [std::hex](../io/manip/hex.html);
        for (char16_t c : u16_conv)
            [std::cout](../io/cout.html) << static_cast<[std::uint16_t](../types/integer.html)>(c) << ' ';
     
        // UTF-16/char16_t to UTF-8
        [std::string](../string/basic_string.html) u8_conv = [std::wstring_convert](wstring_convert.html)<
            std::codecvt_utf8_utf16<char16_t>, char16_t>{}.to_bytes(u16);
        [assert](../error/assert.html)(u8 == u8_conv);
        [std::cout](../io/cout.html) << "\nUTF-16 to UTF-8 conversion produced "
                  << [std::dec](../io/manip/hex.html) << u8_conv.size() << " bytes:\n" << [std::hex](../io/manip/hex.html);
        for (char c : u8_conv)
            [std::cout](../io/cout.html) << +static_cast<unsigned char>(c) << ' ';
        [std::cout](../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/codecvt_utf8_utf16&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2229](https://cplusplus.github.io/LWG/issue2229) | C++98  | the constructor and destructor were not specified  | specifies them   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/locale/codecvt_utf8_utf16&action=edit&section=6 "Edit section: See also")] See also
...
---|---|---|---  
UTF-16  | [`mbrtoc16`](../string/multibyte/mbrtoc16.html "cpp/string/multibyte/mbrtoc16") / [`c16rtomb`](../string/multibyte/c16rtomb.html "cpp/string/multibyte/c16rtomb") (with C11's DR488) |  [`codecvt`](codecvt.html "cpp/locale/codecvt")<char16_t,char,mbstate_t>  
...
UTF-32  |  [`mbrtoc32`](../string/multibyte/mbrtoc32.html "cpp/string/multibyte/mbrtoc32") / [`c32rtomb`](../string/multibyte/c32rtomb.html "cpp/string/multibyte/c32rtomb") |  [`codecvt`](codecvt.html "cpp/locale/codecvt")<char32_t,char,mbstate_t>  
...
---|---  
[ codecvt_mode](codecvt_mode.html "cpp/locale/codecvt mode")(C++11)(deprecated in C++17)(removed in C++26) |  tags to alter behavior of the standard codecvt facets   
