...
concept relation =  
[std::predicate](predicate.html)<R, T, T> && [std::predicate](predicate.html)<R, U, U> &&  
[std::predicate](predicate.html)<R, T, U> && [std::predicate](predicate.html)<R, U, T>; |  (1)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/concepts/relation&action=edit&section=1 "Edit section: References")] References
