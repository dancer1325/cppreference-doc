...
---|---|---  
template< class T >  
concept default_initializable = [std::constructible_from](constructible_from.html)<T> && requires { T{}; } &&   
/* T t; is well-formed, see below */; |  |  (since C++20)  
| |   
  
The `default_initializable` concept checks whether variables of type `T` can be 

  * [value-initialized](../language/value_initialization.html "cpp/language/value initialization") (i.e., whether T() is well-formed); 
  * [direct-list-initialized](../language/list_initialization.html "cpp/language/list initialization") from an empty initializer list (i.e., whether T{} is well-formed); and 
  * [default-initialized](../language/default_initialization.html "cpp/language/default initialization") (i.e., whether T t; is well-formed). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/concepts/default_initializable&action=edit&section=1 "Edit section: Possible implementation")] Possible implementation
    ...
    concept default_initializable =
        [std::constructible_from](constructible_from.html)<T> &&
        requires { T{}; ::new T; };  
