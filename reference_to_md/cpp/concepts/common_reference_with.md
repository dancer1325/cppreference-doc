...
[std::same_as](same_as.html)<[std::common_reference_t](../types/common_reference.html)<T, U>, [std::common_reference_t](../types/common_reference.html)<U, T>> &&  
[std::convertible_to](convertible_to.html)<T, [std::common_reference_t](../types/common_reference.html)<T, U>> &&  
[std::convertible_to](convertible_to.html)<U, [std::common_reference_t](../types/common_reference.html)<T, U>>; |  |  (since C++20)  
| |   
...
T and U model std::common_reference_with<T, U> only if, given [equality-preserving](../concepts.html#Equality_preservation "cpp/concepts") expressions `t1`, `t2`, `u1` and `u2` such that decltype((t1)) and decltype((t2)) are both `T` and decltype((u1)) and decltype((u2)) are both `U`, 
  ...
  * [std::common_reference_t](../types/common_reference.html)<T, U>(t1) equals [std::common_reference_t](../types/common_reference.html)<T, U>(t2) if and only if `t1` equals `t2`; and 
  * [std::common_reference_t](../types/common_reference.html)<T, U>(u1) equals [std::common_reference_t](../types/common_reference.html)<T, U>(u2) if and only if `u1` equals `u2`. 
