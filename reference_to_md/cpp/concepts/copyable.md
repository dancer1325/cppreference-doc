...
template< class T >  
concept copyable =  
[std::copy_constructible](copy_constructible.html)<T> &&  
[std::movable](movable.html)<T> &&  
[std::assignable_from](assignable_from.html)<T&, T&> &&  
[std::assignable_from](assignable_from.html)<T&, const T&> &&  
[std::assignable_from](assignable_from.html)<T&, const T>; |  |  (since C++20)  
| |   
  
The concept `copyable<T>` specifies that `T` is a [`movable`](movable.html "cpp/concepts/movable") object type that can also be copied (that is, it supports copy construction and copy assignment). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/concepts/copyable&action=edit&section=1 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/concepts/copyable&action=edit&section=2 "Edit section: See also")] See also

[ movable](movable.html "cpp/concepts/movable")(C++20) |  specifies that an object of a type can be moved and swapped   
