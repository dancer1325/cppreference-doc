...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/length_error&action=edit&section=1 "Edit section: Member functions")] Member functions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/length_error&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/length_error&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/length_error&action=edit&section=4 "Edit section: See also")] See also

[ resize](../string/basic_string/resize.html "cpp/string/basic string/resize") |  changes the number of characters stored   
(public member function of `std::basic_string<CharT,Traits,Allocator>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string/dsc_resize&action=edit)  
---|---
