...
---|---|---  
[std::unexpected_handler](exception/unexpected_handler.html) set_unexpected( [std::unexpected_handler](exception/unexpected_handler.html) f ) throw(); |  |  (until C++11)  
[std::unexpected_handler](exception/unexpected_handler.html) set_unexpected( [std::unexpected_handler](exception/unexpected_handler.html) f ) noexcept; |  |  (deprecated in C++11)   
(removed in C++17)  
| |   
  
Makes f the new global [std::unexpected_handler](exception/unexpected_handler.html "cpp/error/unexpected handler") and returns the previously installed [std::unexpected_handler](exception/unexpected_handler.html "cpp/error/unexpected handler"). 

This function is thread-safe. Every call to `std::set_unexpected` _synchronizes-with_ (see [std::memory_order](../atomic/memory_order.html "cpp/atomic/memory order")) the subsequent calls to `std::set_unexpected` and [std::get_unexpected](exception/get_unexpected.html "cpp/error/get unexpected") | (since C++11)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/set_unexpected&action=edit&section=1 "Edit section: Parameters")] Parameters

f  |  \-  |  pointer to function of type [std::unexpected_handler](exception/unexpected_handler.html "cpp/error/unexpected handler"), or null pointer   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/set_unexpected&action=edit&section=2 "Edit section: Return value")] Return value

The previously-installed unexpected handler, or a null pointer value if none was installed. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/set_unexpected&action=edit&section=3 "Edit section: See also")] See also
...
---|---  
[ get_unexpected](exception/get_unexpected.html "cpp/error/get unexpected")(deprecated in C++11)(removed in C++17) |  obtains the current `unexpected_handler`   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/error/dsc_get_unexpected&action=edit)  
[ unexpected_handler](exception/unexpected_handler.html "cpp/error/unexpected handler")(deprecated in C++11)(removed in C++17) |  the type of the function called by [std::unexpected](unexpected.html "cpp/error/unexpected")   
