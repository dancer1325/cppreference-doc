...
virtual ~error_category(); |  |  (since C++11)  
---|---|---  
| |   
  
Destroys the object. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/error_category/%7Eerror_category&action=edit&section=1 "Edit section: Parameters")] Parameters
