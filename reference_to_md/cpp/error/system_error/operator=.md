...
Run this code
    ...
     
    void print(const [std::system_error](../system_error.html)& e)
    {
        [std::cout](../../io/cout.html) << "code:    [" << e.code() << "]\n"
    ...
    int main()
    {
        [std::system_error](../system_error.html) e1([EDOM](../errno_macros.html), [std::generic_category](../generic_category.html)(), "Error info #1");
        print(e1);
     
        [std::system_error](../system_error.html) e2([EIO](../errno_macros.html), [std::system_category](../system_category.html)(), "Error info #2");
        print(e2);
     
        e1 = e2;
        [assert](../assert.html)([std::strcmp](../../string/byte/strcmp.html)(e1.what(), e2.what()) == 0);
        print(e1);
    }
