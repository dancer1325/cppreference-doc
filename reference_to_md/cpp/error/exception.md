...
Member functions  
---  
[exception::exception](exception/exception.html "cpp/error/exception/exception")  
[exception::~exception](exception/~exception.html "cpp/error/exception/~exception")  
...
Provides consistent interface to handle errors through the [throw expression](../language/throw.html "cpp/language/throw"). 
...
## Contents
  ...
  * [1 Member functions](exception.html#Member_functions)
  * [2 Standard exception requirements](exception.html#Standard_exception_requirements)
  * [3 Standard exceptions](exception.html#Standard_exceptions)
  * [4 Notes](exception.html#Notes)
  * [5 Defect reports](exception.html#Defect_reports)
...
Each standard library class `T` that derives from `std::exception` has the following publicly accessible member functions, each of them do not exit with an exception(until C++11)having a [non-throwing exception specification](../language/noexcept_spec.html "cpp/language/noexcept spec")(since C++11): 
  ...
  * [default constructor](../language/default_constructor.html "cpp/language/default constructor") (unless other constructors are provided) 
  * [copy constructor](../language/copy_constructor.html "cpp/language/copy constructor")
  * [copy assignment operator](../language/as_operator.html "cpp/language/copy assignment")



The copy constructor and the copy assignment operator meet the following postcondition: 

  * If two objects lhs and rhs both have dynamic type `T` and lhs is a copy of rhs, then [std::strcmp](../string/byte/strcmp.html)(lhs.what(), rhs.what()) is equal to ​0​. 
...
### Standard exceptions
  ...
  * [`future_error`](../thread/future_error.html "cpp/thread/future error")
...
---|---  
  ...
  * [`regex_error`](../regex/regex_error.html "cpp/regex/regex error")
  * [`system_error`](system_error.html "cpp/error/system error")



    

  * [`ios_base::failure`](../io/ios_base/failure.html "cpp/io/ios base/failure")
...
---|---  
  ...
  * [`tx_exception`](tx_exception.html "cpp/error/tx exception")
...
---|---  
  ...
  * [`nonexistent_local_time`](../chrono/nonexistent_local_time.html "cpp/chrono/nonexistent local time")
  * [`ambiguous_local_time`](../chrono/ambiguous_local_time.html "cpp/chrono/ambiguous local time")
  * [`format_error`](../utility/format/format_error.html "cpp/utility/format/format error")
...
---|---  
  ...
  * [`bad_any_cast`](../utility/any/bad_any_cast.html "cpp/utility/any/bad any cast")



  * [`bad_optional_access`](../utility/bad_optional_access.html "cpp/utility/optional/bad optional access")

| (since C++17)  
---|---  
  
  * [`bad_expected_access`](../utility/expected/bad_expected_access.html "cpp/utility/expected/bad expected access")

| (since C++23)  
---|---  
  
  * [`bad_weak_ptr`](../memory/bad_weak_ptr.html "cpp/memory/bad weak ptr")
  * [`bad_function_call`](../utility/functional/bad_function_call.html "cpp/utility/functional/bad function call")
...
---|---  
  ...
  * [`bad_array_new_length`](../memory/new/bad_array_new_length.html "cpp/memory/new/bad array new length")
...
---|---  
  ...
  * [`bad_variant_access`](../utility/variant/bad_variant_access.html "cpp/utility/variant/bad variant access")
...
---|---|---|---  
[LWG 471](https://cplusplus.github.io/LWG/issue471) | C++98  | there was no requirement on standard library classes derived from `std::exception` | added 
