...
All member functions of `std::runtime_error` are constexpr: it is possible to create and use `std::runtime_error` objects in the evaluation of a constant expression.However, `std::runtime_error` objects generally cannot be constexpr, because any dynamically allocated storage must be released in the same evaluation of constant expression. | (since C++26)  
---|---  
  
![std-runtime error-inheritance.svg](https://upload.cppreference.com/mwiki/images/1/1d/std-runtime_error-inheritance.svg)

Inheritance diagram

Exceptions of type `std::runtime_error` are thrown by the following standard library components: 

  * [std::locale::locale](../locale/locale/locale.html "cpp/locale/locale/locale")
  * [std::locale::combine](../locale/locale/combine.html "cpp/locale/locale/combine")



  * [std::chrono::current_zone](../chrono/current_zone.html)
  * [std::chrono::get_tzdb_list](../chrono/tzdb_functions.html)
  * [std::chrono::get_tzdb](../chrono/tzdb_functions.html)
  * [std::chrono::locate_zone](../chrono/locate_zone.html)
  * [std::chrono::reload_tzdb](../chrono/tzdb_functions.html)
  * [std::chrono::remote_version](../chrono/tzdb_functions.html)
  * [std::chrono::tzdb::locate_zone](../chrono/tzdb/locate_zone.html)
...
In addition, the following standard exception types are derived from `std::runtime_error`: 
  ...
  * [std::range_error](range_error.html "cpp/error/range error")
  * [std::overflow_error](overflow_error.html "cpp/error/overflow error")
  * [std::underflow_error](underflow_error.html "cpp/error/underflow error")



  * [std::ios_base::failure](../io/ios_base/failure.html "cpp/io/ios base/failure")
  * [std::regex_error](../regex/regex_error.html "cpp/regex/regex error")
  * [std::system_error](system_error.html "cpp/error/system error")

| (since C++11)  
---|---  
  
  * [std::filesystem::filesystem_error](../filesystem/filesystem_error.html "cpp/filesystem/filesystem error")

| (since C++17)  
---|---  
  
  * [std::chrono::ambiguous_local_time](../chrono/ambiguous_local_time.html)
  * [std::chrono::nonexistent_local_time](../chrono/nonexistent_local_time.html)
  * [std::format_error](../utility/format/format_error.html)
...
## Contents
  ...
  * [1 Member functions](runtime_error.html#Member_functions)
  * [2 std::runtime_error::runtime_error](runtime_error.html#std::runtime_error::runtime_error)
    * [2.1 Parameters](runtime_error.html#Parameters)
    * [2.2 Exceptions](runtime_error.html#Exceptions)
    * [2.3 Notes](runtime_error.html#Notes)
  * [3 std::runtime_error::operator=](runtime_error.html#std::runtime_error::operator.3D)
    * [3.1 Parameters](runtime_error.html#Parameters_2)
    * [3.2 Return value](runtime_error.html#Return_value)
    * [3.3 Notes](runtime_error.html#Notes_2)
  * [4 Inherited from std::exception](runtime_error.html#Inherited_from_std::exception)
    * [4.1 Member functions](runtime_error.html#Member_functions_2)
    * [4.2 Notes](runtime_error.html#Notes_3)
    * [4.3 Defect reports](runtime_error.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/runtime_error&action=edit&section=1 "Edit section: Member functions")] Member functions
...
runtime_error( const [std::string](../string/basic_string.html)& what_arg ); |  (1) | (constexpr since C++26)  
---|---|---  
runtime_error( const char* what_arg ); |  (2) | (constexpr since C++26)  
...
3) Copy constructor. If *this and other both have dynamic type `std::runtime_error` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0. No exception can be thrown from the copy constructor.
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::runtime_error` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment. No exception can be thrown from the copy assignment operator. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/runtime_error&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/runtime_error&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
[LWG 471](https://cplusplus.github.io/LWG/issue471) | C++98  | the explanatory strings of `std::runtime_error`'s  
