...
Member functions  
---  
[bad_exception::bad_exception](bad_exception/bad_exception.html "cpp/error/bad exception/bad exception")  
[bad_exception::operator=](bad_exception/operator=.html "cpp/error/bad exception/operator=")  
[bad_exception::what](bad_exception/what.html "cpp/error/bad exception/what")  
...
`std::bad_exception` is the type of the exception thrown by the C++ runtime in the following situations: 
  ...
  * If [std::exception_ptr](exception_ptr.html "cpp/error/exception ptr") stores a copy of the caught exception and if the copy constructor of the exception object caught by [std::current_exception](current_exception.html "cpp/error/current exception") throws an exception, the captured exception is an instance of `std::bad_exception`. 

| (since C++11)  
---|---  
  
  * If a [dynamic exception specification](../language/except_spec.html "cpp/language/except spec") is violated and [std::unexpected](unexpected.html "cpp/error/unexpected") throws or rethrows an exception that still violates the exception specification, but the exception specification allows `std::bad_exception`, `std::bad_exception` is thrown. 

| (until C++17)  
  
![std-bad exception-inheritance.svg](https://upload.cppreference.com/mwiki/images/0/02/std-bad_exception-inheritance.svg)
...
## Contents
  ...
  * [1 Member functions](bad_exception.html#Member_functions)
  * [2 Inherited from std::exception](bad_exception.html#Inherited_from_std::exception)
    * [2.1 Member functions](bad_exception.html#Member_functions_2)
    * [2.2 Notes](bad_exception.html#Notes)
    * [2.3 Example](bad_exception.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/bad_exception&action=edit&section=1 "Edit section: Member functions")] Member functions

[ (constructor)](bad_exception/bad_exception.html "cpp/error/bad exception/bad exception") |  constructs the `bad_exception` object   
(public member function)  
---|---  
[ operator=](bad_exception/operator=.html "cpp/error/bad exception/operator=") |  copies the object   
(public member function)  
[ what](bad_exception/what.html "cpp/error/bad exception/what")[virtual] |  returns the explanatory string   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/bad_exception&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/bad_exception&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    {
        throw [std::runtime_error](runtime_error.html)("test");
    }
     
    int main()
    {
        [std::set_unexpected](set_unexpected.html)(my_unexp); // Deprecated in C++11, removed in C++17
     
        try
        {
            test();
        ...
        {
            [std::cerr](../io/cerr.html) << "Caught " << e.what() << '\n';
        }
    }
