...
The standard library components do not throw this exception (mathematical functions report domain errors as specified in [math_errhandling](../numeric/math/math_errhandling.html "cpp/numeric/math/math errhandling")). Third-party libraries, however, use this. For example, [boost.math](https://www.boost.org/doc/libs/1_55_0/libs/math/doc/html/math_toolkit/error_handling.html) throws `std::domain_error` if `boost::math::policies::throw_on_error` is enabled (the default setting). 

All member functions of `std::domain_error` are constexpr: it is possible to create and use `std::domain_error` objects in the evaluation of a constant expression.However, `std::domain_error` objects generally cannot be constexpr, because any dynamically allocated storage must be released in the same evaluation of constant expression. | (since C++26)  
---|---  
  
![std-domain error-inheritance.svg](https://upload.cppreference.com/mwiki/images/2/26/std-domain_error-inheritance.svg)

Inheritance diagram

## Contents

  * [1 Member functions](domain_error.html#Member_functions)
  * [2 std::domain_error::domain_error](domain_error.html#std::domain_error::domain_error)
    * [2.1 Parameters](domain_error.html#Parameters)
    * [2.2 Exceptions](domain_error.html#Exceptions)
    * [2.3 Notes](domain_error.html#Notes)
  * [3 std::domain_error::operator=](domain_error.html#std::domain_error::operator.3D)
    * [3.1 Parameters](domain_error.html#Parameters_2)
    * [3.2 Return value](domain_error.html#Return_value)
    * [3.3 Notes](domain_error.html#Notes_2)
  * [4 Inherited from std::logic_error](domain_error.html#Inherited_from_std::logic_error)
  * [5 Inherited from std::exception](domain_error.html#Inherited_from_std::exception)
    * [5.1 Member functions](domain_error.html#Member_functions_2)
    * [5.2 Notes](domain_error.html#Notes_3)
    * [5.3 Defect reports](domain_error.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/domain_error&action=edit&section=1 "Edit section: Member functions")] Member functions
...
domain_error( const [std::string](../string/basic_string.html)& what_arg ); |  (1) | (constexpr since C++26)  
---|---|---  
domain_error( const char* what_arg ); |  (2) | (constexpr since C++26)  
...
3) Copy constructor. If *this and other both have dynamic type `std::domain_error` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0. No exception can be thrown from the copy constructor.
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::domain_error` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment. No exception can be thrown from the copy assignment operator. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/domain_error&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/domain_error&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
[LWG 471](https://cplusplus.github.io/LWG/issue471) | C++98  | the explanatory strings of `std::domain_error`'s  
