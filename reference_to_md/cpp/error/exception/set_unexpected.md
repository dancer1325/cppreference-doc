...
---|---|---  
[std::unexpected_handler](unexpected_handler.html) set_unexpected( [std::unexpected_handler](unexpected_handler.html) f ) throw(); |  |  (until C++11)  
[std::unexpected_handler](unexpected_handler.html) set_unexpected( [std::unexpected_handler](unexpected_handler.html) f ) noexcept; |  |  (deprecated in C++11)   
(removed in C++17)  
| |   
  
Makes f the new global [std::unexpected_handler](unexpected_handler.html "cpp/error/unexpected handler") and returns the previously installed [std::unexpected_handler](unexpected_handler.html "cpp/error/unexpected handler"). 

This function is thread-safe. Every call to `std::set_unexpected` _synchronizes-with_ (see [std::memory_order](../../atomic/memory_order.html "cpp/atomic/memory order")) the subsequent calls to `std::set_unexpected` and [std::get_unexpected](get_unexpected.html "cpp/error/get unexpected") | (since C++11)  
---|---  
...
f  |  \-  |  pointer to function of type [std::unexpected_handler](unexpected_handler.html "cpp/error/unexpected handler"), or null pointer   
---|---|---  
