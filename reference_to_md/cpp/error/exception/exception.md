...
1) Default constructor. [what()](what.html "cpp/error/exception/what") returns an implementation-defined string.
...
---|---|---|---  
[LWG 471](https://cplusplus.github.io/LWG/issue471) | C++98  | there is no requirement on [what()](what.html "cpp/error/exception/what") of the exception copy  | added 
