...
No standard library components throw this exception directly, but the exception types [std::invalid_argument](invalid_argument.html "cpp/error/invalid argument"), [std::domain_error](domain_error.html "cpp/error/domain error"), [std::length_error](length_error.html "cpp/error/length error"), [std::out_of_range](out_of_range.html "cpp/error/out of range"), [std::future_error](../thread/future_error.html "cpp/thread/future error"), and [`std::experimental::bad_optional_access`](../experimental/optional/bad_optional_access.html "cpp/experimental/optional/bad optional access") are derived from `std::logic_error`. 
...
![std-logic error-inheritance.svg](https://upload.cppreference.com/mwiki/images/c/c4/std-logic_error-inheritance.svg)

Inheritance diagram

## Contents

  * [1 Member functions](logic_error.html#Member_functions)
  * [2 std::logic_error::logic_error](logic_error.html#std::logic_error::logic_error)
    * [2.1 Parameters](logic_error.html#Parameters)
    * [2.2 Exceptions](logic_error.html#Exceptions)
    * [2.3 Notes](logic_error.html#Notes)
  * [3 std::logic_error::operator=](logic_error.html#std::logic_error::operator.3D)
    * [3.1 Parameters](logic_error.html#Parameters_2)
    * [3.2 Return value](logic_error.html#Return_value)
    * [3.3 Notes](logic_error.html#Notes_2)
  * [4 Inherited from std::exception](logic_error.html#Inherited_from_std::exception)
    * [4.1 Member functions](logic_error.html#Member_functions_2)
    * [4.2 Notes](logic_error.html#Notes_3)
    * [4.3 Defect reports](logic_error.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/logic_error&action=edit&section=1 "Edit section: Member functions")] Member functions
...
logic_error( const [std::string](../string/basic_string.html)& what_arg ); |  (1) | (constexpr since C++26)  
---|---|---  
logic_error( const char* what_arg ); |  (2) | (constexpr since C++26)  
...
3) Copy constructor. If *this and other both have dynamic type `std::logic_error` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0. No exception can be thrown from the copy constructor.
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::logic_error` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment. No exception can be thrown from the copy assignment operator. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/logic_error&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/logic_error&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
[LWG 471](https://cplusplus.github.io/LWG/issue471) | C++98  | the explanatory strings of `std::logic_error`'s  
