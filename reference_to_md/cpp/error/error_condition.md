...
Member functions  
---  
[error_condition::error_condition](error_condition/error_condition.html "cpp/error/error condition/error condition")  
[error_condition::operator=](error_condition/operator=.html "cpp/error/error condition/operator=")  
[error_condition::assign](error_condition/assign.html "cpp/error/error condition/assign")  
[error_condition::clear](error_condition/clear.html "cpp/error/error condition/clear")  
[error_condition::value](error_condition/value.html "cpp/error/error condition/value")  
[error_condition::category](error_condition/category.html "cpp/error/error condition/category")  
[error_condition::message](error_condition/message.html "cpp/error/error condition/message")  
[error_condition::operator bool](error_condition/operator_bool.html "cpp/error/error condition/operator bool")  
Non-member functions  
[operator==operator!=operator<operator<=>](error_condition/operator_cmp.html "cpp/error/error condition/operator cmp")(until C++20)(until C++20)(C++20)  
Helper classes  
...
`std::error_condition` holds a platform-independent value identifying an error condition. Like [std::error_code](error_code.html "cpp/error/error code"), it is uniquely identified by an integer value and a [std::error_category](error_category.html "cpp/error/error category"), but unlike [std::error_code](error_code.html "cpp/error/error code"), the value is not platform-dependent. 

A typical implementation holds one integer data member (the value) and a pointer to an [std::error_category](error_category.html "cpp/error/error category"). 

## Contents

  * [1 Member functions](error_condition.html#Member_functions)
  * [2 Non-member functions](error_condition.html#Non-member_functions)
  * [3 Helper classes](error_condition.html#Helper_classes)
  * [4 Notes](error_condition.html#Notes)
  * [5 See also](error_condition.html#See_also)
...
A [std::errc](errc.html "cpp/error/errc") value can be compared to an error code via implicit conversion to `std::error_condition`. 
...
Run this code
    ...
    int main()
    {
        [std::error_code](error_code.html) ec{ERROR_FILE_EXISTS, [std::system_category](system_category.html)()};
        std::error_condition econd{[EEXIST](errno_macros.html), [std::generic_category](generic_category.html)()};
     
        [std::cout](../io/cout.html).setf(std::ios::boolalpha);
        [std::cout](../io/cout.html) << (ec == econd) << '\n'; // typically true
        [std::cout](../io/cout.html) << (ec == [std::errc::file_exists](errc.html)) << '\n'; // ditto
        [std::cout](../io/cout.html) << (ec == make_error_code([std::errc::file_exists](errc.html))) << '\n'; // false:
                                                                         // different category
    }
