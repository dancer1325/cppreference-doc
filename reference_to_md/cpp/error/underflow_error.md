...
The standard library components do not throw this exception (mathematical functions report underflow errors as specified in [math_errhandling](../numeric/math/math_errhandling.html "cpp/numeric/math/math errhandling")). Third-party libraries, however, use this. For example, [boost.math](https://www.boost.org/doc/libs/1_66_0/libs/math/doc/html/math_toolkit/error_handling.html) throws `std::underflow_error` if `boost::math::policies::throw_on_error` is enabled (the default setting). 

All member functions of `std::underflow_error` are constexpr: it is possible to create and use `std::underflow_error` objects in the evaluation of a constant expression.However, `std::underflow_error` objects generally cannot be constexpr, because any dynamically allocated storage must be released in the same evaluation of constant expression. | (since C++26)  
---|---  
  
![std-underflow error-inheritance.svg](https://upload.cppreference.com/mwiki/images/a/a7/std-underflow_error-inheritance.svg)

Inheritance diagram

## Contents

  * [1 Member functions](underflow_error.html#Member_functions)
  * [2 std::underflow_error::underflow_error](underflow_error.html#std::underflow_error::underflow_error)
    * [2.1 Parameters](underflow_error.html#Parameters)
    * [2.2 Exceptions](underflow_error.html#Exceptions)
    * [2.3 Notes](underflow_error.html#Notes)
  * [3 std::underflow_error::operator=](underflow_error.html#std::underflow_error::operator.3D)
    * [3.1 Parameters](underflow_error.html#Parameters_2)
    * [3.2 Return value](underflow_error.html#Return_value)
    * [3.3 Notes](underflow_error.html#Notes_2)
  * [4 Inherited from std::runtime_error](underflow_error.html#Inherited_from_std::runtime_error)
  * [5 Inherited from std::exception](underflow_error.html#Inherited_from_std::exception)
    * [5.1 Member functions](underflow_error.html#Member_functions_2)
    * [5.2 Notes](underflow_error.html#Notes_3)
    * [5.3 Defect reports](underflow_error.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/underflow_error&action=edit&section=1 "Edit section: Member functions")] Member functions
...
underflow_error( const [std::string](../string/basic_string.html)& what_arg ); |  (1) | (constexpr since C++26)  
---|---|---  
underflow_error( const char* what_arg ); |  (2) | (constexpr since C++26)  
...
3) Copy constructor. If *this and other both have dynamic type `std::underflow_error` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0. No exception can be thrown from the copy constructor.
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::underflow_error` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment. No exception can be thrown from the copy assignment operator. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/underflow_error&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/underflow_error&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
[LWG 471](https://cplusplus.github.io/LWG/issue471) | C++98  | the explanatory strings of `std::underflow_error`'s  
