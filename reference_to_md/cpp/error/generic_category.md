...
---|---|---  
const [std::error_category](error_category.html)& generic_category() noexcept; |  |  (since C++11)  
| |   
  
Obtains a reference to the static error category object for generic errors. The object is required to override the virtual function error_category::name() to return a pointer to the string "generic". It is used to identify error conditions that correspond to the POSIX [errno](errno.html "cpp/error/errno") codes. 

## Contents

  * [1 Parameters](generic_category.html#Parameters)
  * [2 Return value](generic_category.html#Return_value)
  * [3 Example](generic_category.html#Example)
  * [4 See also](generic_category.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::error_condition](error_condition.html) econd = std::generic_category().default_error_condition([EDOM](errno_macros.html));
