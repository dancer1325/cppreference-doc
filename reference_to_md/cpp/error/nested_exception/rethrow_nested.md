...
Rethrows the stored exception. If there is no stored exceptions (i.e., [nested_ptr()](nested_ptr.html "cpp/error/nested exception/nested ptr") returns null pointer), then [std::terminate](../terminate.html "cpp/error/terminate") is called. 
