...
[nested_exception::~nested_exception](~nested_exception.html "cpp/error/nested exception/~nested exception")  
[nested_exception::operator=](operator=.html "cpp/error/nested exception/operator=")  
...
1) Default constructor. Stores an exception object obtained by calling [std::current_exception](../current_exception.html)() within the new `nested_exception` object.

2) Copy constructor. Initializes the object with the exception stored in `other`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/nested_exception/nested_exception&action=edit&section=1 "Edit section: Parameters")] Parameters
