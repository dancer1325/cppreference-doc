...
---|---|---  
template<> struct hash<[std::error_code](../error_code.html)>; |  |  (since C++11)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [std::error_code](../error_code.html "cpp/error/error code") allows users to obtain hashes of objects of type [std::error_code](../error_code.html "cpp/error/error code"). 
