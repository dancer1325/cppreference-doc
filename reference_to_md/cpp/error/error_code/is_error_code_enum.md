...
If `T` is an error code enumeration (such as [std::io_errc](../../io/io_errc.html "cpp/io/io errc") and [std::future_errc](../../thread/future_errc.html "cpp/thread/future errc")), this template provides the member constant value equal true. For any other type, value is false. 

This template may be specialized for a [program-defined type](../../language/type-id.html#Program-defined_type "cpp/language/type") to indicate that the type is eligible for [std::error_code](../error_code.html "cpp/error/error code") implicit conversion. 

## Contents

  * [1 Helper variable template](is_error_code_enum.html#Helper_variable_template)
  * [2 Inherited from std::integral_constant](is_error_code_enum.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](is_error_code_enum.html#Member_constants)
    * [2.2 Member functions](is_error_code_enum.html#Member_functions)
    * [2.3 Member types](is_error_code_enum.html#Member_types)
    * [2.4 See also](is_error_code_enum.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/error_code/is_error_code_enum&action=edit&section=1 "Edit section: Helper variable template")] Helper variable template

template< class T >  
constexpr bool is_error_code_enum_v = is_error_code_enum<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
Run this code
    ...
     
    static_assert(std::is_error_code_enum_v<decltype([std::io_errc::stream](../../io/io_errc.html))>);
    static_assert(!std::is_error_code_enum_v<[std::error_category](../error_category.html)>);
     
    int main() {}

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/error_code/is_error_code_enum&action=edit&section=2 "Edit section: See also")] See also
