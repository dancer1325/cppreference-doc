...
Equivalent to *this = error_code(0, [std::system_category](../system_category.html)()). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/error_code/clear&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/error_code/clear&action=edit&section=2 "Edit section: Return value")] Return value
