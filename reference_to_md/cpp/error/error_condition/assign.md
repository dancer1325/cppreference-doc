...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/error_condition/assign&action=edit&section=1 "Edit section: Parameters")] Parameters

val  |  \-  |  error value   
---|---|---  
cat  |  \-  |  error category   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error/error_condition/assign&action=edit&section=2 "Edit section: Return value")] Return value
