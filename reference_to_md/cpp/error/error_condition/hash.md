...
**hash <std::error_condition>**  
  


Defined in header `[<system_error>](../../header/system_error.html "cpp/header/system error")` |  |   
---|---|---  
template<> struct hash<[std::error_condition](../error_condition.html)>; |  |  (since C++17)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [std::error_condition](../error_condition.html "cpp/error/error condition") allows users to obtain hashes of objects of type [std::error_condition](../error_condition.html "cpp/error/error condition"). 
