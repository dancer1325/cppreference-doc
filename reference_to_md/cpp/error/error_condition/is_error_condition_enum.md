...
---|---|---  
template< class T >  
struct is_error_condition_enum; |  |  (since C++11)  
| |   
  
If `T` is an error condition enum (such as [std::errc](../errc.html "cpp/error/errc")), this template provides the member constant `value` equal true. For any other type, `value` is false. 

This template may be specialized for a [program-defined type](../../language/type-id.html#Program-defined_type "cpp/language/type") to indicate that the type is eligible for [std::error_condition](../error_condition.html "cpp/error/error condition") implicit conversions. 

## Contents

  * [1 Helper variable template](is_error_condition_enum.html#Helper_variable_template)
  * [2 Inherited from std::integral_constant](is_error_condition_enum.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](is_error_condition_enum.html#Member_constants)
    * [2.2 Member functions](is_error_condition_enum.html#Member_functions)
    * [2.3 Member types](is_error_condition_enum.html#Member_types)
    * [2.4 See also](is_error_condition_enum.html#See_also)
...
is_error_condition_enum<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
value[static] |  true if `T` is an error condition enum, false otherwise   
