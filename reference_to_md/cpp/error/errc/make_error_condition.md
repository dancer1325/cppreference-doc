...
---|---|---  
[std::error_condition](../error_condition.html) make_error_condition( [std::errc](../errc.html) e ) noexcept; |  |  (since C++11)  
| |   
...
Run this code
    ...
    int main()
    {
        auto err = std::make_error_condition([std::errc::invalid_argument](../errc.html));
        [std::cout](../../io/cout.html) << err.message() << '\n';
    }
