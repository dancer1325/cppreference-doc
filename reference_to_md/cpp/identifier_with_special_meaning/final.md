...
| **final**(C++11)  
---  
[import](import.html "cpp/identifier with special meaning/import")(C++20)  
[module](module.html "cpp/identifier with special meaning/module")(C++20)  
  
| [override](override.html "cpp/identifier with special meaning/override")(C++11)  
---  
[post](post.html "cpp/identifier with special meaning/post")(C++26)  
[pre](pre.html "cpp/identifier with special meaning/pre")(C++26)  
  
| [replaceable_if_eligible](replaceable_if_eligible.html "cpp/identifier with special meaning/replaceable if eligible")(C++26)  
---  
[trivially_relocatable_if_eligible](trivially_relocatable_if_eligible.html "cpp/identifier with special meaning/trivially relocatable if eligible")(C++26)  
  
  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/keyword/navbar_content&action=edit)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/identifier_with_special_meaning/final&action=edit&section=1 "Edit section: Usage")] Usage

  * [`final`](../language/final.html "cpp/language/final") specifier 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/identifier_with_special_meaning/final&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/identifier_with_special_meaning/final&action=edit&section=3 "Edit section: See also")] See also

  * [`class`](../keyword/class.html "cpp/keyword/class"), [`struct`](../keyword/struct.html "cpp/keyword/struct"), [`union`](../keyword/union.html "cpp/keyword/union")
  * [`virtual`](../keyword/virtual.html "cpp/keyword/virtual"), [`override`](override.html "cpp/identifier with special meaning/override")
  * [`replaceable_if_eligible`](replaceable_if_eligible.html "cpp/identifier with special meaning/replaceable if eligible") (since C++26), [`trivially_relocatable_if_eligible`](trivially_relocatable_if_eligible.html "cpp/identifier with special meaning/trivially relocatable if eligible") (since C++26)
