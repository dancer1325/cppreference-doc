...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/identifier_with_special_meaning/trivially_relocatable_if_eligible&action=edit&section=1 "Edit section: Usage")] Usage

trivially_relocatable_if_eligible [class property specifier](../language/class_property_specifiers.html "cpp/language/class property specifiers"): marks a class as _trivially relocatable ﻿_ if it is _eligible for trivial relocation ﻿_

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/identifier_with_special_meaning/trivially_relocatable_if_eligible&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/identifier_with_special_meaning/trivially_relocatable_if_eligible&action=edit&section=3 "Edit section: See also")] See also

  * [`final`](final.html "cpp/identifier with special meaning/final"), [`replaceable_if_eligible`](replaceable_if_eligible.html "cpp/identifier with special meaning/replaceable if eligible")
