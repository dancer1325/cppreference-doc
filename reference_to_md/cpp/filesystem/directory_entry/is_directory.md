...
---|---|---  
bool is_directory( [std::error_code](../../error/error_code.html)& ec ) const noexcept; |  (2)  |  (since C++17)  
| |   
  
Checks whether the pointed-to object is a directory. Effectively returns: 

1) [std::filesystem::is_directory](../is_directory.html)(status()),

2) [std::filesystem::is_directory](../is_directory.html)(status(ec)).

## Contents

  * [1 Parameters](is_directory.html#Parameters)
  * [2 Return value](is_directory.html#Return_value)
  * [3 Exceptions](is_directory.html#Exceptions)
  * [4 Example](is_directory.html#Example)
  * [5 See also](is_directory.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_directory&action=edit&section=1 "Edit section: Parameters")] Parameters

ec  |  \-  |  out-parameter for error reporting in the non-throwing overload   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_directory&action=edit&section=2 "Edit section: Return value")] Return value

true if the referred-to filesystem object is a directory, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_directory&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_directory&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
    void check_directory(fs::directory_entry const& d, [std::string_view](../../string/basic_string_view.html) rem = "")
    {
        [std::cout](../../io/cout.html) << "is_directory(" << d << "): " << d.is_directory() << rem << '\n';
    }
     
    int main()
    {
    ...
     
        [std::filesystem::create_directory](../create_directory.html)("new_dir");
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_directory&action=edit&section=5 "Edit section: See also")] See also
