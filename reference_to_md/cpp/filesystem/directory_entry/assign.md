...
void assign( const [std::filesystem::path](../path.html)& p ); |  (1)  |  (since C++17)  
---|---|---  
void assign( const [std::filesystem::path](../path.html)& p, [std::error_code](../../error/error_code.html)& ec ); |  (2)  |  (since C++17)  
| |   
  
Assigns new content to the directory entry object. Sets the path to p and calls [`refresh`](refresh.html "cpp/filesystem/directory entry/refresh") to update the cached attributes. If an error occurs, the values of the cached attributes are unspecified. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/assign&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  path to the filesystem object to which the directory entry will refer   
---|---|---  
ec  |  \-  |  out-parameter for error reporting in the non-throwing overload   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/assign&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/assign&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/assign&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    #include <iostream>
     
    void print_entry_info(const [std::filesystem::directory_entry](../directory_entry.html)& entry)
    {
        if ([std::cout](../../io/cout.html) << "The entry " << entry; not entry.exists())
        {
            [std::cout](../../io/cout.html) << " does not exists on the file system\n";
            return;
        }
        [std::cout](../../io/cout.html) << " is ";
        if (entry.is_directory())
            [std::cout](../../io/cout.html) << "a directory\n";
        if (entry.is_regular_file())
            [std::cout](../../io/cout.html) << "a regular file\n";
        /*...*/
    }
     
    int main()
    ...
     
        [std::filesystem::directory_entry](../directory_entry.html) entry{[std::filesystem::current_path](../current_path.html)()};
        print_entry_info(entry);
     
        [std::filesystem::path](../path.html) name{"cppreference.html"};
        [std::ofstream](../../io/basic_ofstream.html){name} << "C++";
     
        [std::cout](../../io/cout.html) << "entry.assign();\n";
        entry.assign(entry/name);
        print_entry_info(entry);
     
        [std::cout](../../io/cout.html) << "remove(entry);\n";
        [std::filesystem::remove](../remove.html)(entry);
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/assign&action=edit&section=5 "Edit section: See also")] See also

[ operator=](operator=.html "cpp/filesystem/directory entry/operator=") |  assigns contents   
