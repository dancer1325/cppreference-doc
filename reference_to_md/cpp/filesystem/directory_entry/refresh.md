...
---|---|---  
void refresh( [std::error_code](../../error/error_code.html)& ec ) noexcept; |  (2)  |  (since C++17)  
| |   
  
Examines the filesystem object referred to by this directory entry and stores its attributes for retrieval with [`status`](status.html "cpp/filesystem/directory entry/status"), [`exists`](exists.html "cpp/filesystem/directory entry/exists"), [`is_regular_file`](is_regular_file.html "cpp/filesystem/directory entry/is regular file"), and other status accessors. 

If an error occurs, the value of any cached attributes is unspecified. 

## Contents

  * [1 Parameters](refresh.html#Parameters)
  * [2 Return value](refresh.html#Return_value)
  * [3 Exceptions](refresh.html#Exceptions)
  * [4 Notes](refresh.html#Notes)
  * [5 Example](refresh.html#Example)
  * [6 See also](refresh.html#See_also)
