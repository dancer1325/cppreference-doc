...
[std::uintmax_t](../../types/integer.html) hard_link_count() const; |  (1)  |  (since C++17)  
---|---|---  
[std::uintmax_t](../../types/integer.html) hard_link_count( [std::error_code](../../error/error_code.html)& ec ) const noexcept; |  (2)  |  (since C++17)  
| |   
  
If the number of hard links is cached in this [`directory_entry`](directory_entry.html "cpp/filesystem/directory entry/directory entry"), returns the cached value. Otherwise, returns: 

1) [std::filesystem::hard_link_count](../hard_link_count.html)(path()),

2) [std::filesystem::hard_link_count](../hard_link_count.html)(path(), ec).
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/hard_link_count&action=edit&section=1 "Edit section: Parameters")] Parameters

ec  |  \-  |  out-parameter for error reporting in the non-throwing overload   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/hard_link_count&action=edit&section=2 "Edit section: Return value")] Return value

The number of hard links for the referred-to filesystem object. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/hard_link_count&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/hard_link_count&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/hard_link_count&action=edit&section=5 "Edit section: See also")] See also
