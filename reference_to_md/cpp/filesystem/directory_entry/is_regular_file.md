...
---|---|---  
bool is_regular_file( [std::error_code](../../error/error_code.html)& ec ) const noexcept; |  (2)  |  (since C++17)  
| |   
  
Checks whether the pointed-to object is a regular file. Effectively returns: 

1) [std::filesystem::is_regular_file](../is_regular_file.html)(status()).

2) [std::filesystem::is_regular_file](../is_regular_file.html)(status(ec)).
...
## Contents
  ...
  * [4 Example](is_regular_file.html#Example)
  * [5 See also](is_regular_file.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_regular_file&action=edit&section=1 "Edit section: Parameters")] Parameters

ec  |  \-  |  out-parameter for error reporting in the non-throwing overload   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_regular_file&action=edit&section=2 "Edit section: Return value")] Return value

true if the referred-to filesystem object is a regular file, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_regular_file&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_regular_file&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
            [std::cout](../../io/cout.html) << "Current dir: " << dir << '\n'
                      << [std::string](../../string/basic_string.html)(40, '-') << '\n';
     
            for (fs::directory_entry const& entry : fs::directory_iterator(dir))
                if (entry.is_regular_file())
                    [std::cout](../../io/cout.html) << entry.path().filename() << '\n';
        }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/is_regular_file&action=edit&section=5 "Edit section: See also")] See also
