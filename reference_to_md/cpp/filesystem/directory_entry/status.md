...
**directory_entry::status directory_entry::symlink_status**  
...
[std::filesystem::file_status](../file_status.html) status() const; |  (1)  |  (since C++17)  
---|---|---  
[std::filesystem::file_status](../file_status.html) status( [std::error_code](../../error/error_code.html)& ec ) const noexcept; |  (2)  |  (since C++17)  
[std::filesystem::file_status](../file_status.html) symlink_status() const; |  (3)  |  (since C++17)  
[std::filesystem::file_status](../file_status.html) symlink_status( [std::error_code](../../error/error_code.html)& ec ) const noexcept; |  (4)  |  (since C++17)  
| |   
  
1,2) Returns status of the entry, as if determined by a [filesystem::status](../status.html "cpp/filesystem/status") call (symlinks are followed to their targets).

3,4) Returns status of the entry, as if determined by a [filesystem::symlink_status](../status.html "cpp/filesystem/status") call (symlinks are not followed).
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/status&action=edit&section=1 "Edit section: Parameters")] Parameters

ec  |  \-  |  out-parameter for error reporting in the non-throwing overload   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/status&action=edit&section=2 "Edit section: Return value")] Return value

The status of the file referred to by the entry. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/status&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/status&action=edit&section=4 "Edit section: Notes")] Notes

Many low-level OS APIs for directory traversal retrieve file attributes along with the next directory entry. The constructors and the non-const member functions of [std::filesystem::directory_iterator](../directory_iterator.html "cpp/filesystem/directory iterator") store these attributes, if any, in the pointed-to [std::filesystem::directory_entry](../directory_entry.html "cpp/filesystem/directory entry") without calling [`directory_entry::refresh`](refresh.html "cpp/filesystem/directory entry/refresh"), which makes it possible to examine the attributes of the directory entries as they are being iterated over, without making additional system calls. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/status&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_entry/status&action=edit&section=6 "Edit section: See also")] See also

[ refresh](refresh.html "cpp/filesystem/directory entry/refresh") |  updates the cached file attributes   
