...
1) Checks whether [`root_path()`](root_path.html "cpp/filesystem/path/root path") is empty.

2) Checks whether [`root_name()`](root_name.html "cpp/filesystem/path/root name") is empty.

3) Checks whether [`root_directory()`](root_directory.html "cpp/filesystem/path/root directory") is empty.

4) Checks whether [`relative_path()`](relative_path.html "cpp/filesystem/path/relative path") is empty.

5) Checks whether [`parent_path()`](parent_path.html "cpp/filesystem/path/parent path") is empty.

6) Checks whether [`filename()`](filename.html "cpp/filesystem/path/filename") is empty.

7) Checks whether [`stem()`](stem.html "cpp/filesystem/path/stem") is empty.

8) Checks whether [`extension()`](extension.html "cpp/filesystem/path/extension") is empty.
...
## Contents
  ...
  * [4 Example](has_path.html#Example)
  * [5 See also](has_path.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/has_path&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/has_path&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/has_path&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/has_path&action=edit&section=4 "Edit section: See also")] See also

[ empty](empty.html "cpp/filesystem/path/empty") |  checks if the path is empty   
