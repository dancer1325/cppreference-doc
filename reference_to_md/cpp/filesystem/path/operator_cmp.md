...
---|---|---  
friend bool operator!=( const path& lhs, const path& rhs ) noexcept; |  (2)  |  (since C++17)   
(until C++20)  
friend bool operator<( const path& lhs, const path& rhs ) noexcept; |  (3)  |  (since C++17)   
(until C++20)  
friend bool operator<=( const path& lhs, const path& rhs ) noexcept; |  (4)  |  (since C++17)   
(until C++20)  
friend bool operator>( const path& lhs, const path& rhs ) noexcept; |  (5)  |  (since C++17)   
(until C++20)  
friend bool operator>=( const path& lhs, const path& rhs ) noexcept; |  (6)  |  (since C++17)   
(until C++20)  
friend [std::strong_ordering](../../utility/compare/strong_ordering.html)  
operator<=>( const path& lhs, const path& rhs ) noexcept; |  (7)  |  (since C++20)  
| |   
