...
---|---|---  
void swap( [std::filesystem::path](../path.html)& lhs, [std::filesystem::path](../path.html)& rhs ) noexcept; |  |  (since C++17)  
| |   
...
[ swap](swap.html "cpp/filesystem/path/swap") |  swaps two paths   
