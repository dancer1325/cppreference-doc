...
Clears the stored pathname. [`empty()`](empty.html "cpp/filesystem/path/empty") is true after the call. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/clear&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/clear&action=edit&section=2 "Edit section: Return value")] Return value
