...
string( const Alloc& a = Alloc() ) const; |  (1)  |  (since C++17)  
---|---|---  
| (2) | (since C++17)  
...
| (3) |   
[std::string](../../string/basic_string.html) u8string() const; |  |  (since C++17)   
(until C++20)  
[std::u8string](../../string/basic_string.html) u8string() const; |  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        ...
        [std::setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), localeName);
        [std::locale::global](../../locale/locale/global.html)([std::locale](../../locale/locale.html)(localeName));
     
        const [std::filesystem::path](../path.html) p(u8"要らない.txt");
        [std::ofstream](../../io/basic_ofstream.html)(p) << "File contents";
     
        // native string representation can be used with OS APIs
        if ([std::FILE](../../io/c/FILE.html)* const f = [std::fopen](../../io/c/fopen.html)(p.string().c_str(), "r"))
        {
            for (int ch; (ch = [std::fgetc](../../io/c/fgetc.html)(f)) != [EOF](../../io/c.html);)
                [std::putchar](../../io/c/putchar.html)(ch);
     
    ...
     
        ...
        [std::wcout](../../io/cout.html) << "File name in wide encoding: " << p.wstring() << '\n';
     
