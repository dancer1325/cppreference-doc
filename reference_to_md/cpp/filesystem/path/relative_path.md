...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/relative_path&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/relative_path&action=edit&section=2 "Edit section: Return value")] Return value

Path relative to the [root path](root_path.html "cpp/filesystem/path/root path"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/relative_path&action=edit&section=3 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/path/relative_path&action=edit&section=4 "Edit section: See also")] See also

[ root_name](root_name.html "cpp/filesystem/path/root name") |  returns the root-name of the path, if present   
...
---|---  
[ root_directory](root_directory.html "cpp/filesystem/path/root directory") |  returns the root directory of the path, if present   
...
[ root_path](root_path.html "cpp/filesystem/path/root path") |  returns the root path of the path, if present   
