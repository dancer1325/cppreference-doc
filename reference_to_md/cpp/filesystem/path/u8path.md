...
[std::filesystem::path](../path.html) u8path( const Source& source ); |  (1)  |  (since C++17)   
(deprecated in C++20)  
template< class InputIt >  
[std::filesystem::path](../path.html) u8path( InputIt first, InputIt last ); |  (2)  |  (since C++17)   
(deprecated in C++20)  
| |   
  
Constructs a path `p` from a UTF-8 encoded sequence of chars or char8_ts(since C++20), supplied either as an [std::string](../../string/basic_string.html "cpp/string/basic string"), or as [std::string_view](../../string/basic_string_view.html "cpp/string/basic string view"), or as a null-terminated multibyte string, or as a [first, last) iterator pair. 
...
Run this code
    ...
    #else
        [std::setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "");
        [std::locale::global](../../locale/locale/global.html)([std::locale](../../locale/locale.html)(""));
    #endif
     
        [std::filesystem::path](../path.html) p(u8"要らない.txt");
        [std::ofstream](../../io/basic_ofstream.html)(p) << "File contents"; // Prior to LWG2676 uses operator string_type()
    ...
    #ifdef _MSC_VER
        if ([std::FILE](../../io/c/FILE.html)* f = _wfopen(p.c_str(), L"r"))
    #else
        if ([std::FILE](../../io/c/FILE.html)* f = [std::fopen](../../io/c/fopen.html)(p.c_str(), "r"))
    #endif
        {
            for (int ch; (ch = fgetc(f)) != [EOF](../../io/c.html); [std::putchar](../../io/c/putchar.html)(ch))
            {}
