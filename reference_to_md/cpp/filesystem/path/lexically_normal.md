...
**path::lexically_normal path::lexically_relativepath::lexically_proximate**  
...
1) Returns *this converted to [normal form](../path.html "cpp/filesystem/path") in its generic format.
...
## Contents
  ...
  * [1 Parameters](lexically_normal.html#Parameters)
  * [2 Return value](lexically_normal.html#Return_value)
  * [3 Exceptions](lexically_normal.html#Exceptions)
  * [4 Notes](lexically_normal.html#Notes)
  * [5 Example](lexically_normal.html#Example)
  * [6 Defect reports](lexically_normal.html#Defect_reports)
  * [7 See also](lexically_normal.html#See_also)
...
Run this code
    ...
    int main()
    {
        [assert](../../error/assert.html)(fs::path("a/./b/..").lexically_normal() == "a/");
        [assert](../../error/assert.html)(fs::path("a/.///b/../").lexically_normal() == "a/");
        [assert](../../error/assert.html)(fs::path("/a/d").lexically_relative("/a/b/c") == "../../d");
        [assert](../../error/assert.html)(fs::path("/a/b/c").lexically_relative("/a/d") == "../b/c");
        [assert](../../error/assert.html)(fs::path("a/b/c").lexically_relative("a") == "b/c");
        [assert](../../error/assert.html)(fs::path("a/b/c").lexically_relative("a/b/c/x/y") == "../..");
        [assert](../../error/assert.html)(fs::path("a/b/c").lexically_relative("a/b/c") == ".");
        [assert](../../error/assert.html)(fs::path("a/b").lexically_relative("c/d") == "../../a/b");
        [assert](../../error/assert.html)(fs::path("a/b").lexically_relative("/a/b") == "");
