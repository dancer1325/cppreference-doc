...
Concatenates two path components using the preferred directory separator if appropriate (see [`operator/=`](append.html "cpp/filesystem/path/append") for details). 
...
## Contents
  ...
  * [3 Example](operator_slash.html#Example)
  * [4 Defect reports](operator_slash.html#Defect_reports)
...
Run this code
    ...
     
        [std::filesystem::path](../path.html) p = "C:";
     
        [std::cout](../../io/cout.html) << R"("C:\" / "Users" / "batman" == )" << p / "Users" / "batman" << '\n';
     
    #   else // __linux__ etc
     
        [std::filesystem::path](../path.html) p = "/home";
     
        [std::cout](../../io/cout.html) << R"("/home" / "tux" / ".fonts" ==)" << p / "tux" / ".fonts" << '\n';
     
    #   endif
    }
