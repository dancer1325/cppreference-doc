...
---|---|---  
[std::size_t](../../types/size_t.html) hash_value( const [std::filesystem::path](../path.html)& p ) noexcept; |  |  (since C++17)  
| |   
  
## Contents

  * [1 Parameters](hash_value.html#Parameters)
  * [2 Return value](hash_value.html#Return_value)
  * [3 Notes](hash_value.html#Notes)
  * [4 Example](hash_value.html#Example)
  * [5 See also](hash_value.html#See_also)
...
Run this code
    ...
     
        ...
        struct PathHash
        {
            [std::size_t](../../types/size_t.html) operator()(fs::path const& p) const noexcept
            {
                return fs::hash_value(p);
            }
        };
        [std::unordered_set](../../container/unordered_set.html)<fs::path, PathHash> dirs{
