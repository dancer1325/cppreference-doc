...
generic_string( const Alloc& a = Alloc() ) const; |  (1)  |  (since C++17)  
---|---|---  
| (2) | (since C++17)  
...
| (3) |   
[std::string](../../string/basic_string.html) generic_u8string() const; |  |  (since C++17)   
(until C++20)  
[std::u8string](../../string/basic_string.html) generic_u8string() const; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [4 Example](generic_string.html#Example)
  * [5 See also](generic_string.html#See_also)
...
Run this code
    ...
    #include <string_view>
     
    void print([std::string_view](../../string/basic_string_view.html) rem, auto const& str)
    {
        [std::cout](../../io/cout.html) << rem << [std::hex](../../io/manip/hex.html) << [std::uppercase](../../io/manip/uppercase.html) << [std::setfill](../../io/manip/setfill.html)('0');
        for (const auto b : [std::as_bytes](../../container/span/as_bytes.html)([std::span](../../container/span.html){str}))
            [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(2) << [std::to_integer](../../types/byte.html)<unsigned>(b) << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
     
    int main()
    {
        [std::filesystem::path](../path.html) p{"/家/屋"};
