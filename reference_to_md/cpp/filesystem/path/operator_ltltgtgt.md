...
operator<<( [std::basic_ostream](../../io/basic_ostream.html)<CharT,Traits>& os, const path& p ); |  (1) | (since C++17)  
---|---|---  
template< class CharT, class Traits >  
friend [std::basic_istream](../../io/basic_istream.html)<CharT,Traits>&  
operator>>( [std::basic_istream](../../io/basic_istream.html)<CharT,Traits>& is, path& p ); |  (2) | (since C++17)  
| |   
...
## Contents
  ...
  * [6 Defect reports](operator_ltltgtgt.html#Defect_reports)
...
[operator>>](operator_ltltgtgt.html#Version_2)  
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::filesystem::current_path](../current_path.html)() << '\n';
        [std::cout](../../io/cout.html) << [std::filesystem::temp_directory_path](../temp_directory_path.html)() << '\n';
    }
...
---|---|---|---  
[LWG 2989](https://cplusplus.github.io/LWG/issue2989) | C++17  | allowed insertion of everything convertible to `path` in the presence of a _using-directive_ | made hidden friend 
