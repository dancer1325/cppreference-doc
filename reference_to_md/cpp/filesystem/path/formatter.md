...
struct formatter<[std::filesystem::path](../path.html), CharT>; |  |  (since C++26)  
| |   
  
The template specialization of [std::formatter](../../utility/format/formatter.html "cpp/utility/format/formatter") for the [std::filesystem::path](../path.html "cpp/filesystem/path") class allows users to convert a pathname to its textual representation using [formatting functions](../../utility/format.html "cpp/utility/format"). This specialization is [_debug-enabled_](../../utility/format/formatter.html#Basic_standard_specializations "cpp/utility/format/formatter"). 

## Contents

  * [1 Format specification](formatter.html#Format_specification)
  * [2 Member functions](formatter.html#Member_functions)
  * [3 std::formatter<std::filesystem::path>::set_debug_format](formatter.html#std::formatter.3Cstd::filesystem::path.3E::set_debug_format)
  * [4 std::formatter<std::filesystem::path>::parse](formatter.html#std::formatter.3Cstd::filesystem::path.3E::parse)
  * [5 std::formatter<std::filesystem::path>::format](formatter.html#std::formatter.3Cstd::filesystem::path.3E::format)
    * [5.1 Notes](formatter.html#Notes)
    * [5.2 Example](formatter.html#Example)
    * [5.3 See also](formatter.html#See_also)
...
fill-and-align and width have the same meaning as in [standard format specification](../../utility/format/formatter.html#Standard_format_specification "cpp/utility/format/formatter"). 

The `**?**` option is used to format the pathname as an [escaped string](../../utility/format/spec.html#Formatting_escaped_characters_and_strings "cpp/utility/format/spec"). 
...
Allows the current object to format pathname as an [escaped string](../../utility/format/spec.html#Formatting_escaped_characters_and_strings "cpp/utility/format/spec"). 

##  std::formatter<std::filesystem::path>::parse

constexpr auto parse( [std::basic_format_parse_context](../../utility/format/basic_format_parse_context.html)<CharT>& ctx )   
-> [std::basic_format_parse_context](../../utility/format/basic_format_parse_context.html)<CharT>::iterator; |  |   
---|---|---  
| |   
...
auto format( const [std::filesystem::path](../path.html)& p, FormatContext& ctx ) const   
...
For character transcoding of the pathname: 
  ...
  * The pathname is transcoded from the native encoding for wide character strings to UTF-8 with maximal subparts of ill-formed subsequences substituted with `U+FFFD` REPLACEMENT CHARACTER if 
    * [std::is_same_v](../../types/is_same.html)<CharT, char> is true, 
    * [std::is_same_v](../../types/is_same.html)<typename path::value_type, wchar_t> is true, and 
    * [ordinary literal encoding](../../language/charset.html#Code_unit_and_literal_encoding "cpp/language/charset") is UTF-8. 
  * Otherwise, no transcoding is performed if [std::is_same_v](../../types/is_same.html)<typename path::value_type, CharT> is true. 
