...
---|---|---  
template<>  
struct hash<[std::filesystem::path](../path.html)>; |  |  (since C++17)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [std::filesystem::path](../path.html "cpp/filesystem/path") allows users to obtain hash values of [std::filesystem::path](../path.html "cpp/filesystem/path"). 

The operator() of this specialization is noexcept. For every [std::filesystem::path](../path.html "cpp/filesystem/path") value `p`, [std::hash](../../utility/hash.html)<[std::filesystem::path](../path.html)>{}(p) is equal to std::filesystem::hash_value(p). 
...
Run this code
    ...
    {
        [std::cout](../../io/cout.html) << [std::hex](../../io/manip/hex.html) << [std::uppercase](../../io/manip/uppercase.html) << [std::setw](../../io/manip/setw.html)(16)
                  << [std::hash](../../utility/hash.html)<fs::path>{}(p) << " : " << p << '\n';
    }
     
    int main()
    {
        ...
        [assert](../../error/assert.html)(!(tmp1 == tmp2));
        [assert](../../error/assert.html)(fs::equivalent(tmp1, tmp2));
        show_hash(tmp1);
        show_hash(tmp2);
     
        for (auto s : {"/a///b", "/a//b", "/a/c", "...", "..", ".", ""})
            show_hash(s);
     
        [std::unordered_set](../../container/unordered_set.html)<fs::path, [std::hash](../../utility/hash.html)<fs::path>> dirs{
