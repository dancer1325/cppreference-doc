...
Removes a single generic-format filename component (as returned by [`filename`](filename.html "cpp/filesystem/path/filename")) from the given generic-format path. 

After this function completes, [`has_filename`](has_path.html "cpp/filesystem/path/has path") returns false. 
