...
---|---|---  
struct space_info {  
[std::uintmax_t](../types/integer.html) capacity;  
[std::uintmax_t](../types/integer.html) free;   
[std::uintmax_t](../types/integer.html) available;   
}; |  |  (since C++17)  
| |   
  
Represents the filesystem information as determined by [`filesystem::space`](space.html "cpp/filesystem/space"). 

## Contents

  * [1 Member objects](space_info.html#Member_objects)
  * [2 Non-member functions](space_info.html#Non-member_functions)
  * [3 operator==(std::filesystem::space_info)](space_info.html#operator.3D.3D.28std::filesystem::space_info.29)
    * [3.1 Example](space_info.html#Example)
    * [3.2 See also](space_info.html#See_also)
...
Run this code
    ...
    #include <locale>
     
    [std::uintmax_t](../types/integer.html) disk_usage_percent(const std::filesystem::space_info& si,
    ...
     
        for ([std::cout](../io/cout.html) << '\n'; auto const& dir : dirs)
        {
            ...
            const std::filesystem::space_info si = [std::filesystem::space](space.html)(dir, ec);
