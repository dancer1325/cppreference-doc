...
---|---|---  
void resize_file( const [std::filesystem::path](path.html)& p,  
[std::uintmax_t](../types/integer.html) new_size ); |  (1)  |  (since C++17)  
void resize_file( const [std::filesystem::path](path.html)& p,  
[std::uintmax_t](../types/integer.html) new_size,  
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../io/cout.html) << "File size:  " << [std::filesystem::file_size](file_size.html)(p) << '\n'
                  << "Free space: " << [std::filesystem::space](space.html)(p).free << '\n';
