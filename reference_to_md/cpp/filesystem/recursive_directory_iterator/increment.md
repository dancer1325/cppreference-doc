...
---|---|---  
recursive_directory_iterator& increment( [std::error_code](../../error/error_code.html)& ec ); |  (2)  |  (since C++17)  
| |   
...
Otherwise, if *this refers to a directory, it is iterated into if the following conditions are met: 
  ...
  * [disable_recursion_pending()](disable_recursion_pending.html "cpp/filesystem/recursive directory iterator/disable recursion pending") has not been called before this increment, i.e. recursion_pending() == true. 
...
## Contents
  ...
  * [1 Parameters](increment.html#Parameters)
  * [2 Return value](increment.html#Return_value)
  * [3 Exceptions](increment.html#Exceptions)
  * [4 Example](increment.html#Example)
  * [5 Defect reports](increment.html#Defect_reports)
