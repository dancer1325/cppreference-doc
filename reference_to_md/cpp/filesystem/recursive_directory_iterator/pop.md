...
---|---|---  
void pop( [std::error_code](../../error/error_code.html)& ec ); |  (2)  |  (since C++17)  
| |   
...
## Contents
  ...
  * [3 Exceptions](pop.html#Exceptions)
  * [4 Example](pop.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/recursive_directory_iterator/pop&action=edit&section=1 "Edit section: Parameters")] Parameters

ec  |  \-  |  error code to store the error status to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/recursive_directory_iterator/pop&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/recursive_directory_iterator/pop&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/recursive_directory_iterator/pop&action=edit&section=4 "Edit section: Example")] Example
