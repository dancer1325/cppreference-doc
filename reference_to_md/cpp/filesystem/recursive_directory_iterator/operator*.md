...
---|---|---  
const [std::filesystem::directory_entry](../directory_entry.html)* operator->() const; |  (2)  |  (since C++17)  
| |   
  
Accesses the pointed-to [`directory_entry`](../directory_entry.html "cpp/filesystem/directory entry"). 
