...
[recursive_directory_iterator::operator*recursive_directory_iterator::operator->](operator*.html "cpp/filesystem/recursive directory iterator/operator*")  
[recursive_directory_iterator::options](options.html "cpp/filesystem/recursive directory iterator/options")  
[recursive_directory_iterator::depth](depth.html "cpp/filesystem/recursive directory iterator/depth")  
[recursive_directory_iterator::recursion_pending](recursion_pending.html "cpp/filesystem/recursive directory iterator/recursion pending")  
[recursive_directory_iterator::operator=](operator=.html "cpp/filesystem/recursive directory iterator/operator=")  
[recursive_directory_iterator::incrementrecursive_directory_iterator::operator++](increment.html "cpp/filesystem/recursive directory iterator/increment")  
[recursive_directory_iterator::pop](pop.html "cpp/filesystem/recursive directory iterator/pop")  
[recursive_directory_iterator::disable_recursion_pending](disable_recursion_pending.html "cpp/filesystem/recursive directory iterator/disable recursion pending")  
...
explicit recursive_directory_iterator( const [std::filesystem::path](../path.html)& p ); |  (4)  |  (since C++17)  
recursive_directory_iterator(  
const [std::filesystem::path](../path.html)& p,  
[std::filesystem::directory_options](../directory_options.html) options ); |  (5)  |  (since C++17)  
recursive_directory_iterator(  
const [std::filesystem::path](../path.html)& p,  
[std::filesystem::directory_options](../directory_options.html) options,  
[std::error_code](../../error/error_code.html)& ec ); |  (6)  |  (since C++17)  
recursive_directory_iterator( const [std::filesystem::path](../path.html)& p, [std::error_code](../../error/error_code.html)& ec ); |  (7)  |  (since C++17)  
| |   
...
## Contents
  ...
  * [1 Parameters](recursive_directory_iterator.html#Parameters)
  * [2 Exceptions](recursive_directory_iterator.html#Exceptions)
  * [3 Notes](recursive_directory_iterator.html#Notes)
  * [4 Example](recursive_directory_iterator.html#Example)
  * [5 Defect reports](recursive_directory_iterator.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/recursive_directory_iterator/recursive_directory_iterator&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/recursive_directory_iterator/recursive_directory_iterator&action=edit&section=2 "Edit section: Exceptions")] Exceptions
...
4,5) Throws [std::filesystem::filesystem_error](../filesystem_error.html "cpp/filesystem/filesystem error") on underlying OS API errors, constructed with p as the first path argument and the OS error code as the error code argument.

6,7) Sets a [std::error_code](../../error/error_code.html)& parameter to the OS API error code if an OS API call fails, and executes ec.[`clear`](../../error/error_code/clear.html "cpp/error/error code/clear")() if no errors occur.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/recursive_directory_iterator/recursive_directory_iterator&action=edit&section=3 "Edit section: Notes")] Notes

Recursive directory iterators do not follow directory symlinks by default. To enable this behavior, specify [directory_options::follow_directory_symlink](../directory_options.html "cpp/filesystem/directory options") among the options option set. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/recursive_directory_iterator/recursive_directory_iterator&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/recursive_directory_iterator/recursive_directory_iterator&action=edit&section=5 "Edit section: Defect reports")] Defect reports
