...
---|---|---  
void copy_symlink( const [std::filesystem::path](path.html)& from,  
...
1) Effectively calls f(read_symlink(from), to) where `f` is [`create_symlink`](create_symlink.html "cpp/filesystem/create symlink") or [`create_directory_symlink`](create_symlink.html "cpp/filesystem/create symlink") depending on whether `from` resolves to a file or directory.

2) Effectively calls f(read_symlink(from, ec), to, ec) where `f` is [`create_symlink`](create_symlink.html "cpp/filesystem/create symlink") or [`create_directory_symlink`](create_symlink.html "cpp/filesystem/create symlink") depending on whether `from` resolves to a file or directory.

## Contents

  * [1 Parameters](copy_symlink.html#Parameters)
  * [2 Return value](copy_symlink.html#Return_value)
  * [3 Exceptions](copy_symlink.html#Exceptions)
  * [4 Example](copy_symlink.html#Example)
  * [5 See also](copy_symlink.html#See_also)
...
1) Throws [std::filesystem::filesystem_error](filesystem_error.html "cpp/filesystem/filesystem error") on underlying OS API errors, constructed with from as the first path argument, to as the second path argument, and the OS error code as the error code argument.
