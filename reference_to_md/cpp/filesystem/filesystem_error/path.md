...
---|---|---  
const [std::filesystem::path](../path.html)& path2() const noexcept; |  |  (since C++17)  
| |   
...
Run this code
    ...
    int main()
    {
        const [std::filesystem::path](../path.html) old_p{[std::tmpnam](../../io/c/tmpnam.html)(nullptr)},
                                    new_p{[std::tmpnam](../../io/c/tmpnam.html)(nullptr)};
        try {
            [std::filesystem::rename](../rename.html)(old_p, new_p); // throws since old_p does not exist
        }
