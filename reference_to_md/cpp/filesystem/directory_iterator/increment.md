...
---|---|---  
directory_iterator& increment( [std::error_code](../../error/error_code.html)& ec ); |  (2)  |  (since C++17)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_iterator/increment&action=edit&section=1 "Edit section: Parameters")] Parameters

ec  |  \-  |  error code to store error status to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_iterator/increment&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_iterator/increment&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_iterator/increment&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/directory_iterator/increment&action=edit&section=5 "Edit section: Defect reports")] Defect reports
