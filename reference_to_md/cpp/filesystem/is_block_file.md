...
---|---|---  
bool is_block_file( [std::filesystem::file_status](file_status.html) s ) noexcept; |  (1)  |  (since C++17)  
bool is_block_file( const [std::filesystem::path](path.html)& p ); |  (2)  |  (since C++17)  
bool is_block_file( const [std::filesystem::path](path.html)& p, [std::error_code](../error/error_code.html)& ec ) noexcept; |  (3)  |  (since C++17)  
| |   
...
## Contents
  ...
  * [1 Parameters](is_block_file.html#Parameters)
  * [2 Return value](is_block_file.html#Return_value)
  * [3 Exceptions](is_block_file.html#Exceptions)
  * [4 Example](is_block_file.html#Example)
  * [5 See also](is_block_file.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/is_block_file&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/is_block_file&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/is_block_file&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/is_block_file&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/filesystem/is_block_file&action=edit&section=5 "Edit section: See also")] See also
...
(public member function of `std::filesystem::directory_entry`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/filesystem/directory_entry/dsc_is_block_file&action=edit)
