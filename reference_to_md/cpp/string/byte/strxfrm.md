...
---|---|---  
[std::size_t](../../types/size_t.html) strxfrm( char* dest, const char* src, [std::size_t](../../types/size_t.html) count ); |  |   
| |   
  
Transforms the null-terminated byte string pointed to by src into the implementation-defined form such that comparing two transformed strings with [std::strcmp](strcmp.html "cpp/string/byte/strcmp") gives the same result as comparing the original strings with [std::strcoll](strcoll.html "cpp/string/byte/strcoll"), in the current C locale. 
...
## Contents
  ...
  * [5 See also](strxfrm.html#See_also)
...
Run this code
    ...
    int main()
    {
        char* loc = [std::setlocale](../../locale/setlocale.html)([LC_COLLATE](../../locale/LC_categories.html), "cs_CZ.iso88592");
        [assert](../../error/assert.html)(loc);
     
        [std::string](../basic_string.html) in1 = "hrnec";
        [std::string](../basic_string.html) out1(1 + std::strxfrm(nullptr, in1.c_str(), 0), ' ');
        [std::string](../basic_string.html) in2 = "chrt";
        [std::string](../basic_string.html) out2(1 + std::strxfrm(nullptr, in2.c_str(), 0), ' ');
     
        std::strxfrm(&out1[0], in1.c_str(), out1.size());
        std::strxfrm(&out2[0], in2.c_str(), out2.size());
     
        [std::cout](../../io/cout.html) << "In the Czech locale: ";
        if (out1 < out2)
            [std::cout](../../io/cout.html) << in1 << " before " << in2 << '\n';
        else
            [std::cout](../../io/cout.html) << in2 << " before " << in1 << '\n';
     
        [std::cout](../../io/cout.html) << "In lexicographical comparison: ";
        if (in1 < in2)
            [std::cout](../../io/cout.html) << in1 << " before " << in2 << '\n';
        else
            [std::cout](../../io/cout.html) << in2 << " before " << in1 << '\n';
