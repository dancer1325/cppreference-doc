...
## Contents
  ...
  * [3 Possible implementation](atoi.html#Possible_implementation)
  * [4 Example](atoi.html#Example)
  * [5 See also](atoi.html#See_also)
...
### Possible implementation
    ...
    {
        while ([std::isspace](isspace.html)(static_cast<unsigned char>(*str)))
            ++str;
     
        bool negative = false;
     
    ...
     
        T result = 0;
        for (; [std::isdigit](isdigit.html)(static_cast<unsigned char>(*str)); ++str)
        {
            int digit = *str - '0';
            result *= 10;
...
Run this code
    ...
     
        for (const char* s : data)
        {
            ...
            [std::cout](../../io/cout.html) << "std::atoi('" << s << "') is " << i << '\n';
            if (const long long ll{std::atoll(s)}; i != ll)
                [std::cout](../../io/cout.html) << "std::atoll('" << s << "') is " << ll << '\n';
        }
    }
