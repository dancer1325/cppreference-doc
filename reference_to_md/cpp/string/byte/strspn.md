...
## Contents
  ...
  * [4 See also](strspn.html#See_also)
...
Run this code
    ...
     
        [std::size_t](../../types/size_t.html) spnsz = std::strspn(s.c_str(), low_alpha);
        [std::cout](../../io/cout.html) << "After skipping initial lowercase letters from '" << s
