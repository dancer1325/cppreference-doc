...
---|---|---  
void* memcpy( void* dest, const void* src, [std::size_t](../../types/size_t.html) count ); |  |   
| |   
  
Performs the following operations in order: 

  1. [Implicitly creates](../../language/objects.html#Object_creation "cpp/language/object") objects at dest. 
...
If any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * dest or src is a [null pointer](../../language/pointer.html#Null_pointers "cpp/language/pointer") or [invalid pointer](../../language/pointer.html#Invalid_pointers "cpp/language/pointer"). 
...
## Contents
  ...
  * [5 Defect reports](memcpy.html#Defect_reports)
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << [std::hexfloat](../../io/manip/fixed.html) << d << " is " << [std::hex](../../io/manip/hex.html) << n
    ...
     
        ...
        {
            int x{42};
            void print() const { [std::cout](../../io/cout.html) << '{' << x << "}\n"; }
        } s;
