...
A sequence of calls to `std::strtok` breaks the string pointed to by str into a sequence of tokens, each of which is delimited by a character from the string pointed to by delim. Each call in the sequence has a _search target ﻿_ : 
...
## Contents
  ...
  * [3 Notes](strtok.html#Notes)
  * [4 Possible implementation](strtok.html#Possible_implementation)
  * [5 Example](strtok.html#Example)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/byte/strtok&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
     
        if (str != nullptr)
            buffer = str;
     
        buffer += [std::strspn](strspn.html)(buffer, delim);
     
        if (*buffer == '\0')
            return nullptr;
     
    ...
     
        buffer += [std::strcspn](strcspn.html)(buffer, delim);
     
        if (*buffer != '\0')
            *buffer++ = '\0';
     
...
Run this code
    ...
    int main() 
    {
        ...
        while (token)
        {
            [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(token) << ' ';
            token = std::strtok(nullptr, delimiters);
        }
     
        [std::cout](../../io/cout.html) << "\nContents of the input string now:\n\"";
        for ([std::size_t](../../types/size_t.html) n = 0; n < sizeof input; ++n)
        {
            if (const char c = input[n]; c != '\0')
                [std::cout](../../io/cout.html) << c;
            else
                [std::cout](../../io/cout.html) << "\\0";
        }
        [std::cout](../../io/cout.html) << "\"\n";
    }
