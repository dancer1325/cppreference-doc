...
---|---|---  
const void* memchr( const void* ptr, int ch, [std::size_t](../../types/size_t.html) count ); |  |   
void* memchr( void* ptr, int ch, [std::size_t](../../types/size_t.html) count ); |  |   
| |   
...
## Contents
  ...
  * [4 See also](memchr.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        if (pc != nullptr)
            [std::cout](../../io/cout.html) << "search character found\n";
        else
            [std::cout](../../io/cout.html) << "search character not found\n";
    }
