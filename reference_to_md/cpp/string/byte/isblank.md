...
## Contents
  ...
  * [3 Notes](isblank.html#Notes)
  * [4 See also](isblank.html#See_also)
...
Similarly, they should not be directly used with standard algorithms when the iterator's value type is char or signed char. Instead, convert the value to unsigned char first: 
    ...
    int count_blanks(const [std::string](../basic_string.html)& s)
    {
...
[`iswspace`](../wide/iswspace.html "cpp/string/wide/iswspace") |  **`isblank`**  
