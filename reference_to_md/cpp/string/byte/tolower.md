...
## Contents
  ...
  * [3 Notes](tolower.html#Notes)
  * [4 Example](tolower.html#Example)
  * [5 See also](tolower.html#See_also)
  * [6 External links](tolower.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/byte/tolower&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character to be converted. If the value of ch is not representable as unsigned char and does not equal [EOF](../../io/c.html), the behavior is undefined   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/byte/tolower&action=edit&section=2 "Edit section: Return value")] Return value

Lowercase version of ch or unmodified ch if no lowercase version is listed in the current C locale. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/byte/tolower&action=edit&section=3 "Edit section: Notes")] Notes

Like all other functions from [`<cctype>`](../../header/cctype.html "cpp/header/cctype"), the behavior of `std::tolower` is undefined if the argument's value is neither representable as unsigned char nor equal to [EOF](../../io/c.html). To use these functions safely with plain chars (or signed chars), the argument should first be converted to unsigned char: 
...
Similarly, they should not be directly used with standard algorithms when the iterator's value type is char or signed char. Instead, convert the value to unsigned char first: 
    ...
    [std::string](../basic_string.html) str_tolower([std::string](../basic_string.html) s)
    {
        [std::transform](../../algorithm/transform.html)(s.begin(), s.end(), s.begin(),
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/byte/tolower&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "en_US.iso88591");
        [std::cout](../../io/cout.html) << [std::hex](../../io/manip/hex.html) << [std::showbase](../../io/manip/showbase.html);
        [std::cout](../../io/cout.html) << "in iso8859-1, tolower('0xb4') gives " << std::tolower(c) << '\n';
        [std::setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "en_US.iso885915");
        [std::cout](../../io/cout.html) << "in iso8859-15, tolower('0xb4') gives " << std::tolower(c) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/byte/tolower&action=edit&section=5 "Edit section: See also")] See also

[ toupper](toupper.html "cpp/string/byte/toupper") |  converts a character to uppercase   
...
[C documentation](../../../c/string/byte/tolower.html "c/string/byte/tolower") for tolower  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/byte/tolower&action=edit&section=6 "Edit section: External links")] External links

1\.  | [ISO/IEC 8859-1](https://en.wikipedia.org/wiki/ISO/IEC_8859-1 "enwiki:ISO/IEC 8859-1"). From Wikipedia.   
---|---  
2\.  | [ISO/IEC 8859-15](https://en.wikipedia.org/wiki/ISO/IEC_8859-15 "enwiki:ISO/IEC 8859-15"). From Wikipedia. 
