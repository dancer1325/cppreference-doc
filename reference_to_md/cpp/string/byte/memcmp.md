...
---|---|---  
int memcmp( const void* lhs, const void* rhs, [std::size_t](../../types/size_t.html) count ); |  |   
| |   
...
## Contents
  ...
  * [5 See also](memcmp.html#See_also)
...
Run this code
    ...
    #include <iostream>
     
    void demo(const char* lhs, const char* rhs, [std::size_t](../../types/size_t.html) sz)
    {
        [std::cout](../../io/cout.html) << [std::string](../basic_string.html)(lhs, sz);
        const int rc = std::memcmp(lhs, rhs, sz);
        if (rc < 0)
            [std::cout](../../io/cout.html) << " precedes ";
        else if (rc > 0)
            [std::cout](../../io/cout.html) << " follows ";
        else
            [std::cout](../../io/cout.html) << " compares equal to ";
        [std::cout](../../io/cout.html) << [std::string](../basic_string.html)(rhs, sz) << " in lexicographical order\n";
    }
     
    int main()
    {
