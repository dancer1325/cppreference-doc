...
---|---|---  
char* strncpy( char* dest, const char* src, [std::size_t](../../types/size_t.html) count ); |  |   
| |   
...
## Contents
  ...
  * [3 Example](strncpy.html#Example)
  * [4 See also](strncpy.html#See_also)
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << "The contents of dest are: ";
        for (char c : dest)
        {
            if (c)
