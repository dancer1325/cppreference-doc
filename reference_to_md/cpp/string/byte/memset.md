...
## Contents
  ...
  * [5 See also](memset.html#See_also)
...
Run this code
    ...
    {
        int a[4];
        using bits = [std::bitset](../../utility/bitset.html)<sizeof(int) * [CHAR_BIT](../../types/climits.html)>;
        std::memset(a, 0b1111'0000'0011, sizeof a);
        for (int ai : a)
            [std::cout](../../io/cout.html) << bits(ai) << '\n';
    }
