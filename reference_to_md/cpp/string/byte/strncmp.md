...
---|---|---  
int strncmp( const char* lhs, const char* rhs, [std::size_t](../../types/size_t.html) count ); |  |   
| |   
...
## Contents
  ...
  * [5 See also](strncmp.html#See_also)
...
This function is not locale-sensitive, unlike [std::strcoll](strcoll.html "cpp/string/byte/strcoll") and [std::strxfrm](strxfrm.html "cpp/string/byte/strxfrm"). 
...
Run this code
    ...
    void demo(const char* lhs, const char* rhs, int sz)
    {
        ...
        if (rc < 0)
            [std::cout](../../io/cout.html) << "First " << sz << " chars of ["
                      << lhs << "] precede [" << rhs << "]\n";
        else if (rc > 0)
            [std::cout](../../io/cout.html) << "First " << sz << " chars of ["
                      << lhs << "] follow [" << rhs << "]\n";
...
(function)   
[C documentation](../../../c/string/byte/strncmp.html "c/string/byte/strncmp") for strncmp
