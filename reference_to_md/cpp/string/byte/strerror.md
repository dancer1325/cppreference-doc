...
Returns a pointer to the textual description of the system error code errnum, identical to the description that would be printed by [std::perror()](../../io/c/perror.html "cpp/io/c/perror"). 
...
## Contents
  ...
  * [5 See also](strerror.html#See_also)
...
Run this code
    ...
     
        ...
        {
            [std::cout](../../io/cout.html) << "log(-1) failed: " << std::strerror(errno) << '\n';
            [std::setlocale](../../locale/setlocale.html)(LC_MESSAGES, "de_DE.utf8");
            [std::cout](../../io/cout.html) << "Or, in German, " << std::strerror(errno) << '\n';
        }
    }
