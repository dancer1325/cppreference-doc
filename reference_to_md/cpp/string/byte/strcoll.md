...
Compares two null-terminated byte strings according to the current locale as defined by the [LC_COLLATE](../../locale/LC_categories.html "cpp/locale/LC categories") category. 
...
## Contents
  ...
  * [5 See also](strcoll.html#See_also)
...
Run this code
    ...
     
        ...
        if (std::strcoll(s1, s2) < 0)
            [std::cout](../../io/cout.html) << s1 << " before " << s2 << '\n';
        else
            [std::cout](../../io/cout.html) << s2 << " before " << s1 << '\n';
     
        [std::cout](../../io/cout.html) << "In lexicographical comparison: ";
        if ([std::strcmp](strcmp.html)(s1, s2) < 0)
            [std::cout](../../io/cout.html) << s1 << " before " << s2 << '\n';
        else
            [std::cout](../../io/cout.html) << s2 << " before " << s1 << '\n';
    }
