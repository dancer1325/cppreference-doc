...
## Contents
  ...
  * [3 Example](strcmp.html#Example)
  * [4 See also](strcmp.html#See_also)
...
Run this code
    ...
    int main() 
    {
        [std::vector](../../container/vector.html)<const char*> cats{"Heathcliff", "Snagglepuss", "Hobbes", "Garfield"};
        [std::sort](../../algorithm/sort.html)(cats.begin(), cats.end(), [](const char* strA, const char* strB)
        {
            return std::strcmp(strA, strB) < 0;
        }); 
     
        for (const char* cat : cats)
            [std::cout](../../io/cout.html) << cat << '\n';
    }
