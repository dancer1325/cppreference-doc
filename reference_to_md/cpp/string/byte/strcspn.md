...
---|---|---  
[std::size_t](../../types/size_t.html) strcspn( const char *dest, const char *src ); |  |   
| |   
  
Returns the length of the maximum initial segment of the byte string pointed to by dest, that consists of only the characters _not_ found in byte string pointed to by src. 
...
## Contents
  ...
  * [3 Example](strcspn.html#Example)
  * [4 See also](strcspn.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::string](../basic_string.html) s = "abcde312$#@";
        const char* invalid = "*$#";
     
        const [std::size_t](../../types/size_t.html) valid_len = std::strcspn(s.c_str(), invalid);
        if (valid_len != s.size())
        {
            [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(s)
                      << " contains invalid chars starting at position "
                      << valid_len << '\n'
                      << [std::string](../basic_string.html)(valid_len + 1, '-') << "^\n";
        }
    }
