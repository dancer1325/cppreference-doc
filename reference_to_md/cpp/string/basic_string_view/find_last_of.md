...
constexpr size_type  
find_last_of( basic_string_view v, size_type pos = npos ) const noexcept; |  (1)  |  (since C++17)  
---|---|---  
constexpr size_type  
find_last_of( CharT ch, size_type pos = npos ) const noexcept; |  (2)  |  (since C++17)  
constexpr size_type  
find_last_of( const CharT* s, size_type pos, size_type count ) const; |  (3)  |  (since C++17)  
constexpr size_type  
find_last_of( const CharT* s, size_type pos = npos ) const; |  (4)  |  (since C++17)  
| |   
  
Finds the last character equal to one of characters in the given character sequence. Exact search algorithm is not specified. The search considers only the interval `[`​0​`, `pos`]`. If the character is not present in the interval, [npos](npos.html "cpp/string/basic string view/npos") will be returned. 

1) Finds the last occurence of any of the characters of v in this view, ending at position pos.

2) Equivalent to find_last_of(basic_string_view([std::addressof](../../memory/addressof.html)(ch), 1), pos).
...
## Contents
  ...
  * [5 See also](find_last_of.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/find_last_of&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/find_last_of&action=edit&section=2 "Edit section: Return value")] Return value

Position of the last occurrence of any character of the substring, or [npos](npos.html "cpp/string/basic string view/npos") if no such character is found. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/find_last_of&action=edit&section=3 "Edit section: Complexity")] Complexity

O([size()](size.html "cpp/string/basic string view/size") * v.[size()](size.html "cpp/string/basic string view/size")) at worst. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/find_last_of&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    constexpr auto N = [std::string_view::npos](npos.html);
     
    static_assert(
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/find_last_of&action=edit&section=5 "Edit section: See also")] See also
...
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_rfind&action=edit)  
[ find_first_of](find_first_of.html "cpp/string/basic string view/find first of") |  find first occurrence of characters   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_find_first_of&action=edit)  
[ find_first_not_of](find_first_not_of.html "cpp/string/basic string view/find first not of") |  find first absence of characters   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_find_first_not_of&action=edit)  
[ find_last_not_of](find_last_not_of.html "cpp/string/basic string view/find last not of") |  find last absence of characters   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_find_last_not_of&action=edit)  
[ find_last_of](../basic_string/find_last_of.html "cpp/string/basic string/find last of") |  find last occurrence of characters   
(public member function of `std::basic_string<CharT,Traits,Allocator>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string/dsc_find_last_of&action=edit)
