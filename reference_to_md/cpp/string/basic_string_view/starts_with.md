...
**basic_string_view::starts_with**(C++20)  
...
1) the prefix is a string view. Effectively returns basic_string_view(data(), [std::min](../../algorithm/min.html)(size(), sv.size())) == sv.
...
Run this code
    ...
     
            ...
            && [std::string_view](../basic_string_view.html)("string_view").starts_with("string") == true
            && [std::string_view](../basic_string_view.html)("string_view").starts_with("String") == false
        );
    }
