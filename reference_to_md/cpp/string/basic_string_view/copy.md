...
Run this code
    ...
    int main()
    {
        constexpr [std::basic_string_view](../basic_string_view.html)<char> source{"ABCDEF"};
        [std::array](../../container/array.html)<char, 8> dest;
        [std::size_t](../../types/size_t.html) count{}, pos{};
     
        dest.fill('\0');
        source.copy(dest.data(), count = 4); // pos = 0
        [std::cout](../../io/cout.html) << dest.data() << '\n'; // ABCD
     
        dest.fill('\0');
