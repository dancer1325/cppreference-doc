...
Checks if the view has no characters, i.e. whether [size()](size.html "cpp/string/basic string view/size") `==` ​0​. 
...
Run this code
    ...
    void check_string([std::string_view](../basic_string_view.html) ref)
    {
