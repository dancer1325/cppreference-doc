...
constexpr size_type  
find_first_of( basic_string_view v, size_type pos = 0 ) const noexcept; |  (1)  |  (since C++17)  
---|---|---  
constexpr size_type  
find_first_of( CharT ch, size_type pos = 0 ) const noexcept; |  (2)  |  (since C++17)  
constexpr size_type  
find_first_of( const CharT* s, size_type pos, size_type count ) const; |  (3)  |  (since C++17)  
constexpr size_type  
find_first_of( const CharT* s, size_type pos = 0 ) const; |  (4)  |  (since C++17)  
| |   
...
2) Equivalent to find_first_of(basic_string_view([std::addressof](../../memory/addressof.html)(ch), 1), pos).
...
## Contents
  ...
  * [4 Example](find_first_of.html#Example)
  * [5 See also](find_first_of.html#See_also)
...
Position of the first occurrence of any character of the substring, or [npos](npos.html "cpp/string/basic string view/npos") if no such character is found. 
