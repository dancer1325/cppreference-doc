...
## Contents
  ...
  * [2 Complexity](remove_prefix.html#Complexity)
  * [3 Example](remove_prefix.html#Example)
  * [4 See also](remove_prefix.html#See_also)
...
Run this code
    ...
    constexpr [std::size_t](../../types/size_t.html) count_substrings([std::string_view](../basic_string_view.html) hive, const [std::string_view](../basic_string_view.html) bee)
    {
        if (hive.empty() || bee.empty())
            return 0U;
     
        [std::size_t](../../types/size_t.html) buzz{};
    ...
    int main()
    {
        [std::string](../basic_string.html) str = "   trim me";
    ...
     
        ...
        [std::cout](../../io/cout.html) << "There are " << count_substrings(hive, "bee") << " bees in this hive.\n";
    }
...
[ remove_suffix](remove_suffix.html "cpp/string/basic string view/remove suffix") |  shrinks the view by moving its end backward   
