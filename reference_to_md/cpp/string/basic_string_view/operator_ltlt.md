...
[std::basic_string_view](../basic_string_view.html)<CharT, Traits> v ); |  |  (since C++17)  
| |   
  
Behaves as a [FormattedOutputFunction](../../named_req/FormattedOutputFunction.html "cpp/named req/FormattedOutputFunction"). After constructing and checking the sentry object, [determines the output format padding](../../named_req/FormattedOutputFunction.html#Padding "cpp/named req/FormattedOutputFunction"). 

Then stores each character from the resulting sequence seq (the contents of v with padding) to the output stream os as if by calling os.rdbuf()->sputn(seq, n), where n is [std::max](../../algorithm/max.html)(os.width(), str.size()). 

Finally, calls os.width(0) to cancel the effects of [std::setw](../../io/manip/setw.html "cpp/io/manip/setw"), if any. 

## Contents

  * [1 Exceptions](operator_ltlt.html#Exceptions)
  * [2 Parameters](operator_ltlt.html#Parameters)
  * [3 Return value](operator_ltlt.html#Return_value)
...
Run this code
    ...
    int main()
    {
        constexpr [std::string_view](../basic_string_view.html) s{"abc"};
        constexpr int width{5};
     
        // fill/left/right properties are kept until changed
        [std::cout](../../io/cout.html) << [std::setfill](../../io/manip/setfill.html)('-');
        [std::cout](../../io/cout.html) << [std::left](../../io/manip/left.html);
     
        [std::cout](../../io/cout.html) << '[' << [std::setw](../../io/manip/setw.html)(width) << s << "]\n";
        [std::cout](../../io/cout.html) << '[' << [std::setw](../../io/manip/setw.html)(width) << s << "]\n";
     
        [std::cout](../../io/cout.html) << [std::right](../../io/manip/left.html);
        [std::cout](../../io/cout.html) << '[' << [std::setw](../../io/manip/setw.html)(width) << s << "]\n";
     
