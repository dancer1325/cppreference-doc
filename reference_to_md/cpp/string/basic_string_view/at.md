...
Returns a `const` reference to the character at specified location pos. Bounds checking is performed, exception of type [std::out_of_range](../../error/out_of_range.html "cpp/error/out of range") will be thrown on invalid access. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/at&action=edit&section=1 "Edit section: Parameters")] Parameters

pos  |  \-  |  position of the character to return   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/at&action=edit&section=2 "Edit section: Return value")] Return value

`Const` reference to the requested character. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/at&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Throws [std::out_of_range](../../error/out_of_range.html "cpp/error/out of range") if pos >= size(). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/at&action=edit&section=4 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/at&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        try
        {
            for ([std::size_t](../../types/size_t.html) i = 0; true; ++i)
                [std::cout](../../io/cout.html) << i << ": " << str_view.at(i) << '\n';
        }
        catch (const [std::out_of_range](../../error/out_of_range.html)& e)
        {
            [std::cout](../../io/cout.html) << "Whooops. Index is out of range.\n";
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/at&action=edit&section=6 "Edit section: See also")] See also

[ operator[]](operator_at.html "cpp/string/basic string view/operator at") |  accesses the specified character   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_operator_at&action=edit)  
---|---  
[ at](../basic_string/at.html "cpp/string/basic string/at") |  accesses the specified character with bounds checking   
(public member function of `std::basic_string<CharT,Traits,Allocator>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string/dsc_at&action=edit)
