...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/begin&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/begin&action=edit&section=2 "Edit section: Return value")] Return value

`const_iterator` to the first character. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/begin&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/begin&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        static_assert(
            ...
            *begin == *cbegin and
            begin == cbegin and
            [std::same_as](../../concepts/same_as.html)<decltype(begin), decltype(cbegin)>);
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/begin&action=edit&section=5 "Edit section: See also")] See also

[ endcend](end.html "cpp/string/basic string view/end") |  returns an iterator to the end   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_end&action=edit)  
---|---  
[ begincbegin](../basic_string/begin.html "cpp/string/basic string/begin")(C++11) |  returns an iterator to the beginning   
(public member function of `std::basic_string<CharT,Traits,Allocator>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string/dsc_begin&action=edit)
