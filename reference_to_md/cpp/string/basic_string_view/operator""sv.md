...
---|---|---  
constexpr [std::string_view](../basic_string_view.html)  
operator ""sv( const char* str, [std::size_t](../../types/size_t.html) len ) noexcept; |  (1)  |  (since C++17)  
constexpr [std::u8string_view](../basic_string_view.html)  
operator ""sv( const char8_t* str, [std::size_t](../../types/size_t.html) len ) noexcept; |  (2)  |  (since C++20)  
constexpr [std::u16string_view](../basic_string_view.html)  
operator ""sv( const char16_t* str, [std::size_t](../../types/size_t.html) len ) noexcept; |  (3)  |  (since C++17)  
constexpr [std::u32string_view](../basic_string_view.html)  
operator ""sv( const char32_t* str, [std::size_t](../../types/size_t.html) len ) noexcept; |  (4)  |  (since C++17)  
constexpr [std::wstring_view](../basic_string_view.html)  
operator ""sv( const wchar_t* str, [std::size_t](../../types/size_t.html) len ) noexcept; |  (5)  |  (since C++17)  
| |   
  
Forms a string view of a character literal. 

1) Returns [std::string_view](../basic_string_view.html){str, len}.

2) Returns [std::u8string_view](../basic_string_view.html){str, len}.

3) Returns [std::u16string_view](../basic_string_view.html){str, len}.

4) Returns [std::u32string_view](../basic_string_view.html){str, len}.

5) Returns [std::wstring_view](../basic_string_view.html){str, len}.

## Contents

  * [1 Parameters](operator""sv.html#Parameters)
  * [2 Return value](operator""sv.html#Return_value)
  * [3 Notes](operator""sv.html#Notes)
  * [4 Example](operator""sv.html#Example)
  * [5 See also](operator""sv.html#See_also)
...
Run this code
    ...
    #include <typeinfo>
     
    void print_each_character(const [std::string_view](../basic_string_view.html) sw)
    {
        for (char c : sw)
    ...
    int main()
    {
        using namespace std::literals;
     
        [std::string_view](../basic_string_view.html) s1 = "abc\0\0def";
        [std::string_view](../basic_string_view.html) s2 = "abc\0\0def"sv;
     
        [std::cout](../../io/cout.html) << "s1.size(): " << s1.size() << "; s1: ";
        print_each_character(s1);
        [std::cout](../../io/cout.html) << "s2.size(): " << s2.size() << "; s2: ";
        print_each_character(s2);
     
        [std::cout](../../io/cout.html) << "substr(1, 4): " << "abcdef"sv.substr(1, 4) << '\n';
     
        auto value_type_info = []<typename T>(T)
        {
            using V = typename T::value_type;
            [std::cout](../../io/cout.html) << "sizeof " << typeid(V).name() << ": " << sizeof(V) << '\n';
        };
     
