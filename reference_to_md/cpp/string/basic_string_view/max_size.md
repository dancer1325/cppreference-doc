...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/max_size&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/max_size&action=edit&section=2 "Edit section: Return value")] Return value

Maximum number of characters. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/max_size&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/max_size&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::numeric_limits](../../types/numeric_limits.html)<[std::int64_t](../../types/integer.html)>::max()
                  << " <- numeric_limits<int64_t>::max()\n"
                  << [std::string_view](../basic_string_view.html){}.max_size()
                  << " <- string_view::max_size()\n"
                  << [std::basic_string_view](../basic_string_view.html)<char>{}.max_size()
                  << " <- basic_string_view<char>::max_size()\n"
                  << [std::basic_string_view](../basic_string_view.html)<char16_t>{}.max_size()
                  << " <- basic_string_view<char16_t>::max_size()\n"
                  << [std::wstring_view](../basic_string_view.html){}.max_size()
                  << " <- wstring_view::max_size()\n"
                  << [std::basic_string_view](../basic_string_view.html)<char32_t>{}.max_size()
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/max_size&action=edit&section=5 "Edit section: See also")] See also
...
(public member function of `std::basic_string<CharT,Traits,Allocator>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string/dsc_max_size&action=edit)
