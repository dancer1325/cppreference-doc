...
**basic_string_view::contains**(C++23)  
...
Run this code
    ...
     
        ...
        [std::string_view](../basic_string_view.html)("basic_string_view").contains("string") == true and
        [std::string_view](../basic_string_view.html)("basic_string_view").contains("String") == false
    );
     
    int main() {}
