...
## Contents
  ...
  * [5 Example](substr.html#Example)
  * [6 See also](substr.html#See_also)
...
Run this code
    ...
    int main()
    {
        typedef [std::size_t](../../types/size_t.html) count_t, pos_t;
     
        constexpr [std::string_view](../basic_string_view.html) data{"ABCDEF"};
     
        [std::cout](../../io/cout.html) << data.substr() << '\n'; // ABCDEF, i.e. data[0, 5] that is [0, 6)
        [std::cout](../../io/cout.html) << data.substr(pos_t(1)) << '\n'; // BCDEF, i.e. [1, 6)
        [std::cout](../../io/cout.html) << data.substr(pos_t(2), count_t(3)) << '\n'; // CDE, i.e. [2, 2 + 3)
        [std::cout](../../io/cout.html) << data.substr(pos_t(4), count_t(42)) << '\n'; // EF, i.e. [4, 6)
     
        try
        {
            [[maybe_unused]]
