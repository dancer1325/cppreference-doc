...
basic_string_view v ) const; |  (2)  |  (since C++17)  
constexpr int compare( size_type pos1, size_type count1, basic_string_view v,  
size_type pos2, size_type count2 ) const; |  (3)  |  (since C++17)  
constexpr int compare( const CharT* s ) const; |  (4)  |  (since C++17)  
constexpr int compare( size_type pos1, size_type count1,  
const CharT* s ) const; |  (5)  |  (since C++17)  
constexpr int compare( size_type pos1, size_type count1,  
const CharT* s, size_type count2 ) const; |  (6)  |  (since C++17)  
| |   
