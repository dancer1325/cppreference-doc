...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/char_traits/move&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/char_traits/move&action=edit&section=2 "Edit section: Return value")] Return value

dest

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/char_traits/move&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/char_traits/move&action=edit&section=4 "Edit section: Complexity")] Complexity

Linear in count. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/char_traits/move&action=edit&section=5 "Edit section: Defect reports")] Defect reports
