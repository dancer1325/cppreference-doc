...
basic_string& insert( size_type index, const basic_string& str,  
size_type s_index, size_type count = npos ); |  |  (since C++14)   
...
(constexpr since C++20)  
iterator insert( const_iterator pos, [std::initializer_list](../../utility/initializer_list.html)<CharT> ilist ); |  (9)  |  (since C++11)   
(constexpr since C++20)  
template< class StringViewLike >  
basic_string& insert( size_type index, const StringViewLike& t ); |  (10)  |  (since C++17)   
(constexpr since C++20)  
template< class StringViewLike >  
basic_string& insert( size_type index, const StringViewLike& t,  
size_type t_index, size_type count = npos ); |  (11)  |  (since C++17)   
(constexpr since C++20)  
| |   
...
8) Inserts characters from the range `[`first`, `last`)` before the element (if any) pointed by pos, as if by insert(pos - begin(), basic_string(first, last, get_allocator())).  This overload does not participate in overload resolution if `InputIt` does not satisfy [LegacyInputIterator](../../named_req/InputIterator.html "cpp/named req/InputIterator").  | (since C++11)  
---|---  
  
9) Inserts elements from initializer list ilist before the element (if any) pointed by pos.

10) Implicitly converts t to a string view sv as if by [std::basic_string_view](../basic_string_view.html)<CharT, Traits> sv = t;, then inserts the elements from sv before the element (if any) pointed by index, as if by insert(index, sv.data(), sv.size()).
...
11) Implicitly converts t to a string view sv as if by [std::basic_string_view](../basic_string_view.html)<CharT, Traits> sv = t;, then inserts, before the element (if any) pointed by index, the characters from the subview `[`t_index`, `t_index + count`)` of sv. 

  * If the requested subview lasts past the end of sv, or if count == npos, the resulting subview is `[`t_index`, `sv.size()`)`. 
  * If t_index > sv.size(), or if index > size(), [std::out_of_range](../../error/out_of_range.html "cpp/error/out of range") is thrown.
...
## Contents
  ...
  * [4 Example](insert.html#Example)
  * [5 Defect reports](insert.html#Defect_reports)
...
ilist  |  \-  |  [std::initializer_list](../../utility/initializer_list.html "cpp/utility/initializer list") to insert the characters from   
t  |  \-  |  object (convertible to [std::basic_string_view](../basic_string_view.html "cpp/string/basic string view")) to insert the characters from   
...
5) Throws [std::out_of_range](../../error/out_of_range.html "cpp/error/out of range") if index > size() or if s_index > str.size().

11) Throws [std::out_of_range](../../error/out_of_range.html "cpp/error/out of range") if index > size() or if t_index > sv.size().

In all cases, throws [std::length_error](../../error/length_error.html "cpp/error/length error") if size() + ins_count > max_size() where ins_count is the number of characters that will be inserted. 

In all cases, if [std::allocator_traits](../../memory/allocator_traits.html)<Allocator>::allocate throws an exception, it is rethrown.  | (since C++20)  
---|---  
...
Run this code
    ...
    int main()
    {
        [std::string](../basic_string.html) s = "xmplr";
     
        // insert(size_type index, size_type count, char ch)
        s.insert(0, 1, 'E');
        [assert](../../error/assert.html)("Exmplr" == s);
     
        // insert(size_type index, const char* s)
        s.insert(2, "e");
        [assert](../../error/assert.html)("Exemplr" == s);
     
        // insert(size_type index, string const& str)
        s.insert(6, "a"s);
        [assert](../../error/assert.html)("Exemplar" == s);
     
        // insert(size_type index, string const& str,
        //        size_type s_index, size_type count)
        s.insert(8, " is an example string."s, 0, 14);
        [assert](../../error/assert.html)("Exemplar is an example" == s);
     
    ...
     
        ...
        {
            [std::string](../basic_string.html) seq = " string";
            s.insert(s.begin() + s.find_last_of('e') + 1,
                [std::begin](../../iterator/begin.html)(seq), [std::end](../../iterator/end.html)(seq));
...
---|---|---|---  
[LWG 7](https://cplusplus.github.io/LWG/issue7) | C++98  | overload (8) referred to a non-existing overload  | refers to overload (4) correctly   
