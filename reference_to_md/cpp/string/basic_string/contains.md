...
constexpr bool  
contains( [std::basic_string_view](../basic_string_view.html)<CharT,Traits> sv ) const noexcept; |  (1)  |  (since C++23)  
---|---|---  
constexpr bool  
...
Run this code
    ...
    void test_substring(const [std::string](../basic_string.html)& str, SubstrType subs)
    {
        constexpr char delim = [std::is_scalar_v](../../types/is_scalar.html)<SubstrType> ? '\'' : '\"';
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(str)
                  << (str.contains(subs) ? " contains "
                                         : " does not contain ")
                  << [std::quoted](../../io/manip/quoted.html)([std::string](../basic_string.html){subs}, delim) << '\n';
    }
     
    int main()
    {
