...
Run this code
    ...
    #include <string>
     
    void show_capacity([std::string](../basic_string.html) const& s)
    {
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(s) << " has capacity " << s.capacity() << ".\n";
    }
     
    int main()
    {
    ...
     
        [std::string](../basic_string.html) g;
    ...
     
        for (int mark{}; mark != 5; ++mark)
        {
            while (old_cap == g.capacity())
                g.push_back('.');
     
            [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)( 7) << g.size()
                      << [std::setw](../../io/manip/setw.html)(11) << g.capacity()
                      << [std::setw](../../io/manip/setw.html)(10) << g.capacity() / static_cast<float>(old_cap) << '\n';
     
            old_cap = g.capacity();
        }
    }
