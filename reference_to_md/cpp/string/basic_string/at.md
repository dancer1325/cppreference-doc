...
## Contents
  ...
  * [6 Defect reports](at.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        [std::string](../basic_string.html) s("message"); // for capacity
     
        s = "abc";
        s.at(2) = 'x'; // OK
        [std::cout](../../io/cout.html) << s << '\n';
     
        [std::cout](../../io/cout.html) << "string size = " << s.size() << '\n';
        [std::cout](../../io/cout.html) << "string capacity = " << s.capacity() << '\n';
     
        try
        {
        ...
        catch ([std::out_of_range](../../error/out_of_range.html) const& exc)
        {
            [std::cout](../../io/cout.html) << exc.what() << '\n';
        }
    }
