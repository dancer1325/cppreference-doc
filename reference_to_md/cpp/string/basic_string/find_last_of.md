...
size_type find_last_of( CharT ch, size_type pos = npos ) const; |  (4) | (noexcept since C++11)   
(constexpr since C++20)  
...
5) Implicitly converts t to a string view sv as if by [std::basic_string_view](../basic_string_view.html)<CharT, Traits> sv = t;, then finds the last character equal to one of characters in sv.
...
## Contents
  ...
  * [3 Exceptions](find_last_of.html#Exceptions)
  * [4 Example](find_last_of.html#Example)
  * [5 Defect reports](find_last_of.html#Defect_reports)
  * [6 See also](find_last_of.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_of&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_of&action=edit&section=2 "Edit section: Return value")] Return value

Position of the found character or [npos](npos.html "cpp/string/basic string/npos") if no such character is found. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_of&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_of&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        const [std::string](../basic_string.html) path = "/root/config";
        auto const pos = path.find_last_of('/');
        const auto leaf = path.substr(pos + 1);
     
        [std::cout](../../io/cout.html) << leaf << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_of&action=edit&section=5 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_of&action=edit&section=6 "Edit section: See also")] See also
...
(public member function of `std::basic_string_view<CharT,Traits>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_find_last_of&action=edit)
