...
constexpr [std::basic_string](../basic_string.html)& append_range( R&& rg ); |  |  (since C++23)  
---|---|---  
| |   
...
Equivalent to 
    ...
    return append([std::basic_string](../basic_string.html)( [std::from_range](../../ranges/from_range.html), std​::​forward<R>(rg), get_allocator()));

## Contents

  * [1 Parameters](append_range.html#Parameters)
  * [2 Return value](append_range.html#Return_value)
  * [3 Complexity](append_range.html#Complexity)
  * [4 Exceptions](append_range.html#Exceptions)
  * [5 Notes](append_range.html#Notes)
  * [6 Example](append_range.html#Example)
  * [7 See also](append_range.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/append_range&action=edit&section=1 "Edit section: Parameters")] Parameters

rg  |  \-  |  a [container compatible range](../../ranges/to.html#container_compatible_range "cpp/ranges/to")  
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/append_range&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/append_range&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in size of rg. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/append_range&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/append_range&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/append_range&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::string](../basic_string.html) head{"long long"};
    ...
    #endif
     
        [assert](../../error/assert.html)(head == "long long int");
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/append_range&action=edit&section=7 "Edit section: See also")] See also
