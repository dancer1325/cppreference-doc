...
constexpr bool  
ends_with( [std::basic_string_view](../basic_string_view.html)<CharT, Traits> sv ) const noexcept; |  (1)  |  (since C++20)  
---|---|---  
constexpr bool  
ends_with( CharT ch ) const noexcept; |  (2)  |  (since C++20)  
constexpr bool  
ends_with( const CharT* s ) const; |  (3)  |  (since C++20)  
| |   
...
All three overloads effectively return [std::basic_string_view](../basic_string_view.html)<CharT, Traits>(data(), size()).ends_with(x), where `x` is the parameter. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/ends_with&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/ends_with&action=edit&section=2 "Edit section: Return value")] Return value

true if the string ends with the provided suffix, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/ends_with&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/ends_with&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/ends_with&action=edit&section=5 "Edit section: See also")] See also

[ starts_with](starts_with.html "cpp/string/basic string/starts with")(C++20) |  checks if the string starts with the given prefix   
