...
5) Implicitly converts t to a string view sv as if by [std::basic_string_view](../basic_string_view.html)<CharT, Traits> sv = t;, then finds the first substring equal to sv.
...
Formally, a substring str is said to be _found_ at position xpos if all of the following are true: 
...
In particular, this implies that 
  ...
  * for a non-empty substring, if pos >= size(), the function always returns [npos](npos.html "cpp/string/basic string/npos"). 
...
## Contents
  ...
  * [3 Exceptions](find.html#Exceptions)
  * [4 Example](find.html#Example)
  * [5 Defect reports](find.html#Defect_reports)
...
Run this code
    ...
    #include <string>
     
    void print(int id, std::string::size_type n, [std::string](../basic_string.html) const& s)
    {
        [std::cout](../../io/cout.html) << id << ") ";
        if ([std::string::npos](npos.html) == n)
            [std::cout](../../io/cout.html) << "not found! n == npos\n";
        else
            [std::cout](../../io/cout.html) << "found @ n = " << n << ", substr(" << n << ") = "
                      << [std::quoted](../../io/manip/quoted.html)(s.substr(n)) << '\n';
    }
     
    int main()
    {
