...
## Contents
  ...
  * [1 Complexity](pop_back.html#Complexity)
  * [2 Exceptions](pop_back.html#Exceptions)
  * [3 Notes](pop_back.html#Notes)
  * [4 Example](pop_back.html#Example)
  * [5 Defect reports](pop_back.html#Defect_reports)
  * [6 See also](pop_back.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::string](../basic_string.html) str("Short string!");
        [std::cout](../../io/cout.html) << "Before: " << [std::quoted](../../io/manip/quoted.html)(str) << '\n';
        [assert](../../error/assert.html)(str.size() == 13);
     
        str.pop_back();
        [std::cout](../../io/cout.html) << "After:  " << [std::quoted](../../io/manip/quoted.html)(str) << '\n';
        [assert](../../error/assert.html)(str.size() == 12);
     
        str.clear();
...
---|---|---|---  
[LWG 534](https://cplusplus.github.io/LWG/issue534) | C++98  | [std::basic_string](../basic_string.html "cpp/string/basic string") did not have the member function `pop_back()` | added   
