...
**basic_string::rbegin basic_string::crbegin**(C++11)  
...
## Contents
  ...
  * [4 Notes](rbegin.html#Notes)
  * [5 Example](rbegin.html#Example)
  * [6 See also](rbegin.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/rbegin&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/rbegin&action=edit&section=2 "Edit section: Return value")] Return value

Reverse iterator to the first character. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/rbegin&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/rbegin&action=edit&section=4 "Edit section: Notes")] Notes

libc++ backports `crbegin()` to C++98 mode. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/rbegin&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::copy](../../algorithm/copy.html)(s.crbegin(), s.crend(), [std::back_inserter](../../iterator/back_inserter.html)(c));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/rbegin&action=edit&section=6 "Edit section: See also")] See also

[ rendcrend](rend.html "cpp/string/basic string/rend")(C++11) |  returns a reverse iterator to the end   
...
(public member function of `std::basic_string_view<CharT,Traits>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_rbegin&action=edit)
