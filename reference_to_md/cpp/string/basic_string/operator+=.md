...
basic_string& operator+=( [std::initializer_list](../../utility/initializer_list.html)<CharT> ilist ); |  (4)  |  (since C++11)   
(constexpr since C++20)  
template< class StringViewLike >  
basic_string& operator+=( const StringViewLike& t ); |  (5) | (since C++17)   
(constexpr since C++20)  
| |   
...
4) Appends characters in the [std::initializer_list](../../utility/initializer_list.html "cpp/utility/initializer list") ilist.

5) Implicitly converts t to a string view sv as if by [std::basic_string_view](../basic_string_view.html)<CharT, Traits> sv = t;, then appends characters in the string view sv as if by append(sv).
...
Run this code
    ...
    int main()
    {
        [std::string](../basic_string.html) str;
     
    ...
     
        ...
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(str) << '\n';
     
        str += [std::string](../basic_string.html)(" is ");
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(str) << '\n';
     
        str += 'a';
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(str) << '\n';
    ...
     
        ...
        str += [std::to_string](to_string.html)(1729);
     
        [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)(str) << '\n';
    }
