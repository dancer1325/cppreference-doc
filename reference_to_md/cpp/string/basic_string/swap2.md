...
void swap( [std::basic_string](../basic_string.html)<CharT, Traits, Alloc>& lhs,  
[std::basic_string](../basic_string.html)<CharT, Traits, Alloc>& rhs ); |  | (until C++17)  
template< class CharT, class Traits, class Alloc >  
void swap( [std::basic_string](../basic_string.html)<CharT, Traits, Alloc>& lhs,  
[std::basic_string](../basic_string.html)<CharT, Traits, Alloc>& rhs ) noexcept(/* see below */); |  |  (since C++17)   
(constexpr since C++20)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::basic_string](../basic_string.html "cpp/string/basic string"). Swaps the contents of lhs and rhs. 
...
## Contents
  ...
  * [4 Exceptions](swap2.html#Exceptions)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  strings whose contents to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/swap2&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/swap2&action=edit&section=3 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/swap2&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/swap2&action=edit&section=6 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2064](https://cplusplus.github.io/LWG/issue2064) | C++11  | non-member `swap` was noexcept and inconsistent with member `swap` | noexcept removed   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/swap2&action=edit&section=7 "Edit section: See also")] See also

[ swap](swap.html "cpp/string/basic string/swap") |  swaps the contents   
