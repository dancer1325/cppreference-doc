...
If [empty()](empty.html "cpp/string/basic string/empty") is true, the behavior is undefined.  | (until C++26)  
---|---  
If [empty()](empty.html "cpp/string/basic string/empty") is true: 
...
## Contents
  ...
  * [5 Defect reports](back.html#Defect_reports)
  * [6 See also](back.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/back&action=edit&section=1 "Edit section: Return value")] Return value

operator[](size() - 1)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/back&action=edit&section=2 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/back&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/back&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::string](../basic_string.html) s("Exemplary");
        char& back1 = s.back();
        back1 = 's';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/back&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 534](https://cplusplus.github.io/LWG/issue534) | C++98  | [std::basic_string](../basic_string.html "cpp/string/basic string") did not have the member function `back()` | added   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/back&action=edit&section=6 "Edit section: See also")] See also
...
(public member function of `std::basic_string_view<CharT,Traits>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_back&action=edit)
