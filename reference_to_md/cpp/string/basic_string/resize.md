...
## Contents
  ...
  * [2 Exceptions](resize.html#Exceptions)
  * [3 Example](resize.html#Example)
  * [4 Defect reports](resize.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        ...
        [std::string](../basic_string.html) long_string("Where is the end?");
        [std::string](../basic_string.html) short_string("H");
     
        [std::cout](../../io/cout.html) << "Basic functionality:\n"
                  << "Shorten:\n"
                  << "1. Before: " << [std::quoted](../../io/manip/quoted.html)(long_string) << '\n';
        long_string.resize(desired_length);
        [std::cout](../../io/cout.html) << "2. After:  " << [std::quoted](../../io/manip/quoted.html)(long_string) << '\n';
     
        [std::cout](../../io/cout.html) << "Lengthen with a given value 'a':\n"
                  << "3. Before: " << [std::quoted](../../io/manip/quoted.html)(short_string) << '\n';
        short_string.resize(desired_length, 'a');
        [std::cout](../../io/cout.html) << "4. After:  " << [std::quoted](../../io/manip/quoted.html)(short_string) << '\n';
     
        [std::cout](../../io/cout.html) << "Lengthen with char() == " << static_cast<int>(char()) << '\n'
                  << "5. Before: " << [std::quoted](../../io/manip/quoted.html)(short_string) << '\n';
        short_string.resize(desired_length + 3);
        [std::cout](../../io/cout.html) << "6. After:  \"";
        for (char c : short_string)
            [std::cout](../../io/cout.html) << (c == char() ? '@' : c);
        [std::cout](../../io/cout.html) << "\"\n\n";
     
        [std::cout](../../io/cout.html) << "Errors:\n";
    ...
     
        ...
        catch (const [std::length_error](../../error/length_error.html)& ex)
        {
            [std::cout](../../io/cout.html) << "3. Length error: " << ex.what() << '\n';
        }
    }
