...
constexpr typename [std::basic_string](../basic_string.html)<CharT, Traits, Alloc>::size_type  
erase( [std::basic_string](../basic_string.html)<CharT, Traits, Alloc>& c, const U& value ); |  |  (since C++20)   
(until C++26)  
template< class CharT, class Traits, class Alloc, class U = CharT >  
constexpr typename [std::basic_string](../basic_string.html)<CharT, Traits, Alloc>::size_type  
erase( [std::basic_string](../basic_string.html)<CharT, Traits, Alloc>& c, const U& value ); |  |  (since C++26)  
template< class CharT, class Traits, class Alloc, class Pred >  
constexpr typename [std::basic_string](../basic_string.html)<CharT, Traits, Alloc>::size_type  
erase_if( [std::basic_string](../basic_string.html)<CharT, Traits, Alloc>& c, Pred pred ); |  (2) | (since C++20)  
| |   
...
## Contents
  ...
  * [6 See also](erase2.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::string](../basic_string.html) word{"startling"};
        [std::cout](../../io/cout.html) << "Initially, word = " << [std::quoted](../../io/manip/quoted.html)(word) << '\n';
     
        [std::erase](../../container/vector/erase2.html)(word, 'l');
        [std::cout](../../io/cout.html) << "After erase 'l': " << [std::quoted](../../io/manip/quoted.html)(word) << '\n';
     
        auto erased = [std::erase_if](../../container/vector/erase2.html)(word, [](char x)
        {
            return x == 'a' or x == 'r' or x == 't';
        });
     
        [std::cout](../../io/cout.html) << "After erase all 'a', 'r', and 't': " << [std::quoted](../../io/manip/quoted.html)(word) << '\n';
        [std::cout](../../io/cout.html) << "Erased symbols count: " << erased << '\n';
     
    #if __cpp_lib_algorithm_default_value_type
        [std::erase](../../container/vector/erase2.html)(word, {'g'});
        [std::cout](../../io/cout.html) << "After erase {'g'}: " << [std::quoted](../../io/manip/quoted.html)(word) << '\n';
    #endif
    }
