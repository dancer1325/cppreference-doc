...
---|---|---  
[std::string](../basic_string.html) operator""s( const char* str, [std::size_t](../../types/size_t.html) len ); |  (1) | (since C++14)   
(constexpr since C++20)  
constexpr [std::u8string](../basic_string.html) operator""s( const char8_t* str,  
[std::size_t](../../types/size_t.html) len ); |  (2)  |  (since C++20)  
[std::u16string](../basic_string.html) operator""s( const char16_t* str, [std::size_t](../../types/size_t.html) len ); |  (3) | (since C++14)   
(constexpr since C++20)  
[std::u32string](../basic_string.html) operator""s( const char32_t* str, [std::size_t](../../types/size_t.html) len ); |  (4) | (since C++14)   
(constexpr since C++20)  
[std::wstring](../basic_string.html) operator""s( const wchar_t* str, [std::size_t](../../types/size_t.html) len ); |  (5) | (since C++14)   
(constexpr since C++20)  
| |   
  
Forms a string literal of the desired type. 

1) Returns [std::string](../basic_string.html){str, len}.

2) Returns [std::u8string](../basic_string.html){str, len}.

3) Returns [std::u16string](../basic_string.html){str, len}.

4) Returns [std::u32string](../basic_string.html){str, len}.

5) Returns [std::wstring](../basic_string.html){str, len}.

## Contents

  * [1 Parameters](operator""s.html#Parameters)
  * [2 Return value](operator""s.html#Return_value)
  * [3 Notes](operator""s.html#Notes)
  * [4 Example](operator""s.html#Example)
  * [5 See also](operator""s.html#See_also)
...
[std::chrono::duration](../../chrono/duration.html "cpp/chrono/duration") also defines [`operator""s`](../../chrono/operator""s.html "cpp/chrono/operator""s") to represent literal seconds, but it is an arithmetic literal: 10.0s and 10s are ten seconds, but "10"s is a string. 
...
Run this code
    ...
    #include <string>
     
    void print_with_zeros(const auto note, const [std::string](../basic_string.html)& s)
    {
        [std::cout](../../io/cout.html) << note;
        for (const char c : s)
            c ? [std::cout](../../io/cout.html) << c : [std::cout](../../io/cout.html) << "₀";
        [std::cout](../../io/cout.html) << " (size = " << s.size() << ")\n";
    }
     
    int main()
    {
        using namespace std::string_literals;
     
        [std::string](../basic_string.html) s1 = "abc\0\0def";
        [std::string](../basic_string.html) s2 = "abc\0\0def"s;
        print_with_zeros("s1: ", s1);
        print_with_zeros("s2: ", s2);
     
        [std::cout](../../io/cout.html) << "abcdef"s.substr(1,4) << '\n';
    }
