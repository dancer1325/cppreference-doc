...
The returned array is not required to be null-terminated. If [empty()](empty.html "cpp/string/basic string/empty") returns true, the pointer is a non-null pointer that should not be dereferenced.  | (until C++11)  
---|---  
The returned array is null-terminated, that is, `data()` and [c_str()](c_str.html "cpp/string/basic string/c str") perform the same function. If [empty()](empty.html "cpp/string/basic string/empty") returns true, the pointer points to a single null character.  | (since C++11)  
  
The pointer obtained from `data()` may be invalidated by: 

  * Passing a non-const reference to the string to any standard library function, or 
  * Calling non-const member functions on the string, excluding [`operator[]()`](operator_at.html "cpp/string/basic string/operator at"), [at()](at.html "cpp/string/basic string/at"), [front()](front.html "cpp/string/basic string/front"), [back()](back.html "cpp/string/basic string/back"), [begin()](begin.html "cpp/string/basic string/begin"), [end()](end.html "cpp/string/basic string/end"), [rbegin()](rbegin.html "cpp/string/basic string/rbegin"), [rend()](rend.html "cpp/string/basic string/rend"). 



1) Modifying the character array accessed through the const overload of `data` has undefined behavior.

2) Modifying the past-the-end null terminator stored at `data() + `[size()](size.html "cpp/string/basic string/size") to any value other than `CharT()` has undefined behavior.
...
Run this code
    ...
    int main()
    {
        [std::string](../basic_string.html) const s("Emplary");
        [assert](../../error/assert.html)(s.size() == [std::strlen](../byte/strlen.html)(s.data()));
        [assert](../../error/assert.html)([std::equal](../../algorithm/equal.html)(s.begin(), s.end(), s.data()));
        [assert](../../error/assert.html)([std::equal](../../algorithm/equal.html)(s.data(), s.data() + s.size(), s.begin()));
