...
size_type find_first_of( CharT ch, size_type pos = 0 ) const; |  (4) | (noexcept since C++11)   
(constexpr since C++20)  
...
5) Implicitly converts t to a string view sv as if by [std::basic_string_view](../basic_string_view.html)<CharT, Traits> sv = t;, then finds the first character equal to one of the characters in sv.
...
## Contents
  ...
  * [3 Exceptions](find_first_of.html#Exceptions)
  * [4 Notes](find_first_of.html#Notes)
  * [5 Example](find_first_of.html#Example)
  * [6 Defect reports](find_first_of.html#Defect_reports)
  * [7 See also](find_first_of.html#See_also)
...
Run this code
    ...
     
        ...
        //     └────────────────────────┘
        [assert](../../error/assert.html)(sz == 1);
     
        sz = "alignof"s.find_first_of("wxyz"s);
        // no match
        [assert](../../error/assert.html)(sz == [std::string::npos](npos.html));
     
        // (2)
    ...
     
        ...
        //    └───────────────────────────────┘
        [assert](../../error/assert.html)(sz == 0);
     
        // (3)
        sz = "decltype"s.find_first_of("xyzabc");
        //      └────────────────────────────┘
        [assert](../../error/assert.html)(sz == 2);
     
        // (4)
        sz = "co_await"s.find_first_of('a');
        //       └──────────────────────┘
        [assert](../../error/assert.html)(sz == 3);
     
        // (5)
        ...
        [assert](../../error/assert.html)(sz == 2);
     
        [std::cout](../../io/cout.html) << "All tests passed.\n";
    }
