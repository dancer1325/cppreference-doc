...
size_type pos = 0 ) const; |  (1) | (noexcept since C++11)   
(constexpr since C++20)  
---|---|---  
size_type find_first_not_of( const CharT* s,  
size_type pos, size_type count ) const; |  (2) | (constexpr since C++20)  
size_type find_first_not_of( const CharT* s,  
size_type pos = 0 ) const; |  (3) | (constexpr since C++20)  
size_type find_first_not_of( CharT ch, size_type pos = 0 ) const; |  (4) | (noexcept since C++11)   
(constexpr since C++20)  
template< class StringViewLike >  
size_type  
find_first_not_of( const StringViewLike& t,  
size_type pos = 0 ) const noexcept(/* see below */); |  (5) | (since C++17)   
(constexpr since C++20)  
| |   
  
Finds the first character equal to none of the characters in the given character sequence. The search considers only the range `[`pos`, `[size()](size.html "cpp/string/basic string/size")`)`. If all characters in the range can be found in the given character sequence, [npos](npos.html "cpp/string/basic string/npos") will be returned. 
...
If `[`s`, `s + count`)` is not a [valid range](../../iterator.html#Ranges "cpp/iterator"), the behavior is undefined.
...
If `[`s`, `s + Traits::length(s)`)` is not a [valid range](../../iterator.html#Ranges "cpp/iterator"), the behavior is undefined.

4) Finds the first character not equal to ch.

5) Implicitly converts t to a string view sv as if by [std::basic_string_view](../basic_string_view.html)<CharT, Traits> sv = t;, then finds the first character equal to none of characters in sv.
...
In all cases, equality is checked by calling [`Traits::eq`](../char_traits/cmp.html "cpp/string/char traits/cmp"). 

## Contents

  * [1 Parameters](find_first_not_of.html#Parameters)
  * [2 Return value](find_first_not_of.html#Return_value)
  * [3 Exceptions](find_first_not_of.html#Exceptions)
  * [4 Example](find_first_not_of.html#Example)
  * [5 Defect reports](find_first_not_of.html#Defect_reports)
  * [6 See also](find_first_not_of.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_first_not_of&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_first_not_of&action=edit&section=2 "Edit section: Return value")] Return value

Position of the found character or [std::string::npos](npos.html "cpp/string/basic string/npos") if no such character is found. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_first_not_of&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
noexcept([std::is_nothrow_convertible_v](../../types/is_convertible.html)<const T&, [std::basic_string_view](../basic_string_view.html)<CharT, Traits>>)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_first_not_of&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        const char* pattern = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
                              ...
                              "0123456789";
     
        [std::string](../basic_string.html) data = "1) %FIX, 2) %HACK, and 3) %TODO";
        const [std::string](../basic_string.html) replacement = "%DONE%";
     
        [std::cout](../../io/cout.html) << "Before: " << data << '\n';
     
        for (std::string::size_type first{}, last{};
            (first = data.find('%', first)) != [std::string::npos](npos.html);
            first += replacement.size())
        {
            last = data.find_first_not_of(pattern, first + 1);
            if (last == [std::string::npos](npos.html))
                last = data.length();
     
    ...
     
        [std::cout](../../io/cout.html) << "After: " << data << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_first_not_of&action=edit&section=5 "Edit section: Defect reports")] Defect reports
...
[LWG 2064](https://cplusplus.github.io/LWG/issue2064) | C++11  | overloads (3,4) were noexcept  | removed   
[LWG 2946](https://cplusplus.github.io/LWG/issue2946) | C++17  | overload (5) caused ambiguity in some cases  | avoided by making it a template   
[P1148R0](https://wg21.link/P1148R0) | C++11  
C++17  | noexcept for overloads (4,5) were  
accidentally dropped by LWG2064/LWG2946  | restored   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_first_not_of&action=edit&section=6 "Edit section: See also")] See also
...
(public member function of `std::basic_string_view<CharT,Traits>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_find_first_not_of&action=edit)
