...
---|---|---  
[std::wstring](../basic_string.html) to_wstring( int value ); |  (1)  |  (since C++11)  
[std::wstring](../basic_string.html) to_wstring( long value ); |  (2)  |  (since C++11)  
[std::wstring](../basic_string.html) to_wstring( long long value ); |  (3)  |  (since C++11)  
[std::wstring](../basic_string.html) to_wstring( unsigned value ); |  (4)  |  (since C++11)  
[std::wstring](../basic_string.html) to_wstring( unsigned long value ); |  (5)  |  (since C++11)  
[std::wstring](../basic_string.html) to_wstring( unsigned long long value ); |  (6)  |  (since C++11)  
[std::wstring](../basic_string.html) to_wstring( float value ); |  (7)  |  (since C++11)  
[std::wstring](../basic_string.html) to_wstring( double value ); |  (8)  |  (since C++11)  
[std::wstring](../basic_string.html) to_wstring( long double value ); |  (9)  |  (since C++11)  
| |   
  
Converts a numeric value to [std::wstring](../basic_string.html "cpp/string/basic string"). 

Let `_buf_` be an internal to the conversion functions buffer, sufficiently large to contain the result of conversion.  1) Converts a signed decimal integer to a wide string as if by [std::swprintf](../../io/c/fwprintf.html)(buf, sz, L"%d", value). 2) Converts a signed decimal integer to a wide string as if by [std::swprintf](../../io/c/fwprintf.html)(buf, sz, L"%ld", value). 3) Converts a signed decimal integer to a wide string as if by [std::swprintf](../../io/c/fwprintf.html)(buf, sz, L"%lld", value). 4) Converts an unsigned decimal integer to a wide string as if by [std::swprintf](../../io/c/fwprintf.html)(buf, sz, L"%u", value). 5) Converts an unsigned decimal integer to a wide string as if by [std::swprintf](../../io/c/fwprintf.html)(buf, sz, L"%lu", value). 6) Converts an unsigned decimal integer to a wide string as if by [std::swprintf](../../io/c/fwprintf.html)(buf, sz, L"%llu", value). 7,8) Converts a floating point value to a wide string as if by [std::swprintf](../../io/c/fwprintf.html)(buf, sz, L"%f", value). 9) Converts a floating point value to a wide string as if by [std::swprintf](../../io/c/fwprintf.html)(buf, sz, L"%Lf", value).  | (until C++26)  
---|---  
1-9) Converts a numeric value to a wide string as if by [std::format](../../utility/format/format.html)(L"{}", value).  | (since C++26)  
  
## Contents

  * [1 Parameters](to_wstring.html#Parameters)
  * [2 Return value](to_wstring.html#Return_value)
  * [3 Exceptions](to_wstring.html#Exceptions)
  * [4 Example](to_wstring.html#Example)
  * [5 See also](to_wstring.html#See_also)
...
Run this code
    ...
    int main()
    {
        for (const double f : {23.43, 1e-9, 1e40, 1e-40, 123456789.0})
            [std::wcout](../../io/cout.html) << "std::wcout: " << f << '\n'
