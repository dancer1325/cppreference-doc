...
**basic_string::begin basic_string::cbegin**(C++11)  
...
`begin()` returns a [mutable](../../iterator.html "cpp/iterator") or [constant](../../iterator.html "cpp/iterator") iterator, depending on the constness of *this. 

`cbegin()` always returns a [constant](../../iterator.html "cpp/iterator") iterator. It is equivalent to const_cast<const basic_string&>(*this).begin(). 
...
## Contents
  ...
  * [4 Notes](begin.html#Notes)
  * [5 Example](begin.html#Example)
  * [6 See also](begin.html#See_also)
