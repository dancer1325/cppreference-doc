...
---|---|---  
[std::string](../basic_string.html) to_string( int value ); |  (1)  |  (since C++11)  
[std::string](../basic_string.html) to_string( long value ); |  (2)  |  (since C++11)  
[std::string](../basic_string.html) to_string( long long value ); |  (3)  |  (since C++11)  
[std::string](../basic_string.html) to_string( unsigned value ); |  (4)  |  (since C++11)  
[std::string](../basic_string.html) to_string( unsigned long value ); |  (5)  |  (since C++11)  
[std::string](../basic_string.html) to_string( unsigned long long value ); |  (6)  |  (since C++11)  
[std::string](../basic_string.html) to_string( float value ); |  (7)  |  (since C++11)  
[std::string](../basic_string.html) to_string( double value ); |  (8)  |  (since C++11)  
[std::string](../basic_string.html) to_string( long double value ); |  (9)  |  (since C++11)  
| |   
  
Converts a numeric value to [std::string](../basic_string.html "cpp/string/basic string"). 

Let `_buf_` be an internal to the conversion functions buffer, sufficiently large to contain the result of conversion.  1) Converts a signed integer to a string as if by [std::sprintf](../../io/c/fprintf.html)(buf, "%d", value). 2) Converts a signed integer to a string as if by [std::sprintf](../../io/c/fprintf.html)(buf, "%ld", value). 3) Converts a signed integer to a string as if by [std::sprintf](../../io/c/fprintf.html)(buf, "%lld", value). 4) Converts an unsigned integer to a string as if by [std::sprintf](../../io/c/fprintf.html)(buf, "%u", value). 5) Converts an unsigned integer to a string as if by [std::sprintf](../../io/c/fprintf.html)(buf, "%lu", value). 6) Converts an unsigned integer to a string as if by [std::sprintf](../../io/c/fprintf.html)(buf, "%llu", value). 7,8) Converts a floating point value to a string as if by [std::sprintf](../../io/c/fprintf.html)(buf, "%f", value). 9) Converts a floating point value to a string as if by [std::sprintf](../../io/c/fprintf.html)(buf, "%Lf", value).  | (until C++26)  
---|---  
1-9) Converts a numeric value to a string as if by [std::format](../../utility/format/format.html)("{}", value).  | (since C++26)  
...
## Contents
  ...
  * [6 See also](to_string.html#See_also)
...
C++17 provides [`std::to_chars`](../../utility/to_chars.html "cpp/utility/to chars") as a higher-performance locale-independent alternative. 
...
Run this code
    ...
    int main()
    {
        ...
        {
            [std::cout](../../io/cout.html) << "to_string:\t" << std::to_string(f) << revision() << '\n';
     
            // Before C++26, the output of std::to_string matches std::printf.
            [std::printf](../../io/c/fprintf.html)("printf:\t\t%f\n", f);
     
            // As of C++26, the output of std::to_string matches std::format.
            [std::cout](../../io/cout.html) << [std::format](../../utility/format/format.html)("format:\t\t{}\n", f);
     
            [std::cout](../../io/cout.html) << "std::cout:\t" << f << "\n\n";
        }
    }
