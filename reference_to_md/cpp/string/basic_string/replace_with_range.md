...
constexpr [std::basic_string](../basic_string.html)& replace_with_range( const_iterator first,  
const_iterator last,  
R&& rg ); |  |  (since C++23)  
---|---|---  
| |   
...
Equivalent to 
    ...
    return replace(first,
                   last,
                   [std::basic_string](../basic_string.html)(
                       [std::from_range](../../ranges/from_range.html),
                       [std::forward](../../utility/forward.html)<R>(rg),
                       get_allocator())
    );

## Contents

  * [1 Parameters](replace_with_range.html#Parameters)
  * [2 Return value](replace_with_range.html#Return_value)
  * [3 Complexity](replace_with_range.html#Complexity)
  * [4 Exceptions](replace_with_range.html#Exceptions)
  * [5 Notes](replace_with_range.html#Notes)
  * [6 Example](replace_with_range.html#Example)
  * [7 See also](replace_with_range.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/replace_with_range&action=edit&section=1 "Edit section: Parameters")] Parameters

first, last  |  \-  |  range of characters that is going to be replaced   
---|---|---  
rg  |  \-  |  a [container compatible range](../../ranges/to.html#container_compatible_range "cpp/ranges/to")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/replace_with_range&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/replace_with_range&action=edit&section=3 "Edit section: Complexity")] Complexity

Linear in size of rg. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/replace_with_range&action=edit&section=4 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/replace_with_range&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/replace_with_range&action=edit&section=6 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::forward_list](../../container/forward_list.html)<char> rg;
        std::[ranges::reverse_copy](../../algorithm/ranges/reverse_copy.html)(tomorrow, [std::front_inserter](../../iterator/front_inserter.html)(rg));
     
        const auto pos{s.rfind(today)};
        [assert](../../error/assert.html)(pos != s.npos);
        const auto first{[std::next](../../iterator/next.html)(s.begin(), pos)};
        const auto last{[std::next](../../iterator/next.html)(first, today.length())};
     
    ...
    #endif
     
        [assert](../../error/assert.html)("Today is tomorrow's yesterday!" == s);
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/replace_with_range&action=edit&section=7 "Edit section: See also")] See also

[ replace](replace.html "cpp/string/basic string/replace") |  replaces specified portion of a string   
