...
size_type pos = npos ) const; |  (1) | (noexcept since C++11)   
...
size_type find_last_not_of( CharT ch, size_type pos = npos ) const; |  (4) | (noexcept since C++11)   
(constexpr since C++20)  
...
Finds the last character equal to none of the characters in the given character sequence. The search considers only the range `[`​0​`, `pos`]`. If all characters in the range can be found in the given character sequence, [npos](npos.html "cpp/string/basic string/npos") will be returned. 
...
5) Implicitly converts t to a string view sv as if by [std::basic_string_view](../basic_string_view.html)<CharT, Traits> sv = t;, then finds the last character equal to none of characters in sv.
...
## Contents
  ...
  * [3 Exceptions](find_last_not_of.html#Exceptions)
  * [4 Example](find_last_not_of.html#Example)
  * [5 Defect reports](find_last_not_of.html#Defect_reports)
  * [6 See also](find_last_not_of.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_not_of&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_not_of&action=edit&section=2 "Edit section: Return value")] Return value

Position of the found character or [npos](npos.html "cpp/string/basic string/npos") if no such character is found. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_not_of&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
noexcept([std::is_nothrow_convertible_v](../../types/is_convertible.html)<  
const T&, [std::basic_string_view](../basic_string_view.html)<CharT, Traits>>)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_not_of&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    #include <string>
     
    void show_pos(const [std::string](../basic_string.html)& str, std::string::size_type found)
    {
        if (found != [std::string::npos](npos.html))
            [std::cout](../../io/cout.html) << '[' << found << "] = \'" << str[found] << "\'\n";
        else
    ...
    int main()
    {
        [std::string](../basic_string.html) str{"abc_123"};
        char const* skip_set{"0123456789"};
        std::string::size_type str_last_pos{[std::string::npos](npos.html)};
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_not_of&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 141](https://cplusplus.github.io/LWG/issue141) | C++98  | overload (1) could only return [npos](npos.html "cpp/string/basic string/npos") if pos >= size() | the search range is  
`[`​0​`, `size()`)` in this case   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/find_last_not_of&action=edit&section=6 "Edit section: See also")] See also
...
(public member function of `std::basic_string_view<CharT,Traits>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/string/basic_string_view/dsc_find_last_not_of&action=edit)
