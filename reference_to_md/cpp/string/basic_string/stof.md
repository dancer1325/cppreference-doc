...
---|---|---  
float stof ( const [std::string](../basic_string.html)& str, [std::size_t](../../types/size_t.html)* pos = nullptr ); |  (1)  |  (since C++11)  
float stof ( const [std::wstring](../basic_string.html)& str, [std::size_t](../../types/size_t.html)* pos = nullptr ); |  (2)  |  (since C++11)  
double stod ( const [std::string](../basic_string.html)& str, [std::size_t](../../types/size_t.html)* pos = nullptr ); |  (3)  |  (since C++11)  
double stod ( const [std::wstring](../basic_string.html)& str, [std::size_t](../../types/size_t.html)* pos = nullptr ); |  (4)  |  (since C++11)  
long double stold( const [std::string](../basic_string.html)& str, [std::size_t](../../types/size_t.html)* pos = nullptr ); |  (5)  |  (since C++11)  
long double stold( const [std::wstring](../basic_string.html)& str, [std::size_t](../../types/size_t.html)* pos = nullptr ); |  (6)  |  (since C++11)  
| |   
...
1) Calls [std::strtof](../byte/strtof.html)(str.c_str(), &ptr).

2) Calls [std::wcstof](../wide/wcstof.html)(str.c_str(), &ptr).

3) Calls [std::strtod](../byte/strtof.html)(str.c_str(), &ptr).

4) Calls [std::wcstod](../wide/wcstof.html)(str.c_str(), &ptr).

5) Calls [std::strtold](../byte/strtof.html)(str.c_str(), &ptr).

6) Calls [std::wcstold](../wide/wcstof.html)(str.c_str(), &ptr).
...
## Contents
  ...
  * [1 Parameters](stof.html#Parameters)
  * [2 Return value](stof.html#Return_value)
  * [3 Exceptions](stof.html#Exceptions)
  * [4 Example](stof.html#Example)
  * [5 Defect reports](stof.html#Defect_reports)
  * [6 See also](stof.html#See_also)
...
---|---|---|---  
[LWG 2009](https://cplusplus.github.io/LWG/issue2009) | C++11  | [std::out_of_range](../../error/out_of_range.html "cpp/error/out of range") would not be thrown if the converted  
