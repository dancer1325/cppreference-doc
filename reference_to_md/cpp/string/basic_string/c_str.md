...
The pointer obtained from `c_str()` may be invalidated by: 
  ...
  * Calling non-const member functions on the string, excluding [operator[]](operator_at.html "cpp/string/basic string/operator at"), [at()](at.html "cpp/string/basic string/at"), [front()](front.html "cpp/string/basic string/front"), [back()](back.html "cpp/string/basic string/back"), [begin()](begin.html "cpp/string/basic string/begin"), [rbegin()](rbegin.html "cpp/string/basic string/rbegin"), [end()](end.html "cpp/string/basic string/end") and [rend()](rend.html "cpp/string/basic string/rend")(since C++11). 



Writing to the character array accessed through `c_str()` is undefined behavior. 

`c_str()` and [data()](data.html "cpp/string/basic string/data") perform the same function.  | (since C++11)  
---|---  
  
## Contents

  * [1 Parameters](c_str.html#Parameters)
  * [2 Return value](c_str.html#Return_value)
  * [3 Complexity](c_str.html#Complexity)
  * [4 Notes](c_str.html#Notes)
  * [5 Example](c_str.html#Example)
  * [6 See also](c_str.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [assert](../../error/assert.html)(s.size() == [std::strlen](../byte/strlen.html)(p));
        [assert](../../error/assert.html)([std::equal](../../algorithm/equal.html)(s.begin(), s.end(), p));
        [assert](../../error/assert.html)([std::equal](../../algorithm/equal.html)(p, p + s.size(), s.begin()));
        [assert](../../error/assert.html)('\0' == *(p + s.size()));
     
        c_func(s.c_str());
    }
