...
## Contents
  ...
  * [3 Notes](clear.html#Notes)
  * [4 Complexity](clear.html#Complexity)
  * [5 Example](clear.html#Example)
...
Run this code
    ...
     
        s.clear();
        [assert](../../error/assert.html)(s.empty());
        [assert](../../error/assert.html)(s.size() == 0);
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html) << (s.capacity() == capacity) << '\n';
    }
