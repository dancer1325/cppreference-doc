...
[class](../keyword/class.html "cpp/keyword/class")  
...
[consteval](../keyword/consteval.html "cpp/keyword/consteval")(C++20)  
[constexpr](../keyword/constexpr.html "cpp/keyword/constexpr")(C++11)  
...
[decltype](decltype.html "cpp/keyword/decltype")(C++11)  
...
[enum](../keyword/enum.html "cpp/keyword/enum")  
[explicit](../keyword/explicit.html "cpp/keyword/explicit")  
[export](../keyword/export.html "cpp/keyword/export")  
...
[int](../keyword/int.html "cpp/keyword/int")  
[long](../keyword/long.html "cpp/keyword/long")  
[mutable](../keyword/mutable.html "cpp/keyword/mutable")  
...
| [register](../keyword/register.html "cpp/keyword/register")  
---  
...
[static](static.html "cpp/keyword/static")  
...
[struct](../keyword/struct.html "cpp/keyword/struct")  
...
[typename](../keyword/typename.html "cpp/keyword/typename")  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/if&action=edit&section=1 "Edit section: Usage")] Usage

  * [`if` statement](../language/if.html "cpp/language/if"): begins the `if` statement 



  * [`constexpr` `if` statement](../language/if.html#Constexpr_if "cpp/language/if"): begins the `constexpr` `if` statement 

| (since C++17)  
---|---  
  
  * [`consteval` `if` statement](../language/if.html#Consteval_if "cpp/language/if"): begins the `consteval` `if` statement 

| (since C++23)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/if&action=edit&section=2 "Edit section: See also")] See also

  * [`if`](../language/if.html "cpp/language/if") statement: [`else`](../keyword/else.html "cpp/keyword/else")


  * [`switch`](../language/switch.html "cpp/language/switch") statement: [`switch`](../keyword/switch.html "cpp/keyword/switch"), [`case`](../keyword/case.html "cpp/keyword/case")
  * [`default`](../language/switch.html "cpp/language/switch") (as case label declaration) etc: [`default`](../keyword/default.html "cpp/keyword/default")
  * [`goto`](../language/goto.html "cpp/language/goto") statement: [`goto`](../keyword/goto.html "cpp/keyword/goto")
  * [`continue`](../language/continue.html "cpp/language/continue") statement: [`continue`](../keyword/continue.html "cpp/keyword/continue")
  * [`break`](../language/break.html "cpp/language/break") statement: [`break`](../keyword/break.html "cpp/keyword/break")
  * [`return`](../language/return.html "cpp/language/return") statement: [`return`](../keyword/return.html "cpp/keyword/return")



  * [`co_return`](../language/return.html "cpp/language/return") statement (return from a coroutine): [`co_return`](../keyword/co_return.html "cpp/keyword/co return")

| (since C++20)  
---|---  
  
  * [`do-while`](../language/do.html "cpp/language/do") loop and [`while` loop](../language/while.html "cpp/language/while"): [`do`](../keyword/do.html "cpp/keyword/do"), [`while`](../keyword/while.html "cpp/keyword/while")
  * [`for`](../language/for.html "cpp/language/for") loop and [range-based `for` loop](../language/range-for.html "cpp/language/range-for"): [`for`](../keyword/for.html "cpp/keyword/for")
