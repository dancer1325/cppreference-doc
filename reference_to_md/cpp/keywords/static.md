...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/static&action=edit&section=1 "Edit section: Usage")] Usage

  * [declarations of namespace members with static storage duration and internal linkage](../language/storage_duration.html "cpp/language/storage duration")
  * [definitions of block scope variables with static storage duration and initialized once](../language/storage_duration.html#Static_block_variables "cpp/language/storage duration")
  * [declarations of class members not bound to specific instances](../language/static.html "cpp/language/static")
