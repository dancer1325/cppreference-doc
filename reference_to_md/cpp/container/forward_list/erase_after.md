...
If any iterator in the range `(`first`, `last`)` is not dereferceable, the behavior is undefined.

## Contents

  * [1 Parameters](erase_after.html#Parameters)
  * [2 Return value](erase_after.html#Return_value)
  * [3 Complexity](erase_after.html#Complexity)
  * [4 Exceptions](erase_after.html#Exceptions)
  * [5 Example](erase_after.html#Example)
  * [6 See also](erase_after.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::forward_list](../forward_list.html)<int> l = {1, 2, 3, 4, 5, 6, 7, 8, 9};
     
    ...
     
        auto fi = [std::next](../../iterator/next.html)(l.begin());
        auto la = [std::next](../../iterator/next.html)(fi, 3);
     
        l.erase_after(fi, la);
     
        for (auto n : l)
