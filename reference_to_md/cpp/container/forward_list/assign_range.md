...
All iterators (including the [`end()`](end.html "cpp/container/forward list/end") iterator) and all references to the elements are invalidated. 
...
## Contents
  ...
  * [2 Notes](assign_range.html#Notes)
...
Run this code
    ...
    int main()
    {
        const auto source = [std::list](../list.html){2, 7, 1};
        auto destination = [std::forward_list](../forward_list.html){3, 1, 4};
