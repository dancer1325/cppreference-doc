[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/sort&action=edit)
...
## Contents
  ...
  * [2 Complexity](sort.html#Complexity)
  * [3 Notes](sort.html#Notes)
...
Run this code
    ...
    int main()
    {
        [std::forward_list](../forward_list.html)<int> list{8, 7, 5, 9, 0, 1, 3, 2, 6, 4};
        [std::cout](../../io/cout.html) << "initially: " << list << '\n';
     
        list.sort();
        [std::cout](../../io/cout.html) << "ascending: " << list << '\n';
     
        list.sort([std::greater](../../utility/functional/greater.html)<int>());
        [std::cout](../../io/cout.html) << "descending:" << list << '\n';
    }
