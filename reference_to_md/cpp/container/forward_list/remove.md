[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/remove&action=edit)
...
void remove_if( UnaryPred p ); |  |  (since C++11)   
(until C++20)  
template< class UnaryPred >  
size_type remove_if( UnaryPred p ); |  | (since C++20)   
(constexpr since C++26)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::forward_list](../forward_list.html)<int> l = {1, 100, 2, 3, 10, 1, 11, -1, 12};
     
        auto count1 = l.remove(1);
        [std::cout](../../io/cout.html) << count1 << " elements equal to 1 were removed\n";
     
        auto count2 = l.remove_if([](int n){ return n > 10; });
        [std::cout](../../io/cout.html) << count2 << " elements greater than 10 were removed\n";
     
        [std::cout](../../io/cout.html) << "Finally, the list contains: ";
        for (int n : l)
