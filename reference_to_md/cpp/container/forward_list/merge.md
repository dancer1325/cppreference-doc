[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/merge&action=edit)
...
1,2) Equivalent to merge(other, [std::less](../../utility/functional/less.html)<T>())(until C++14)merge(other, [std::less](../../utility/functional/less.html)<>())(since C++14).

3,4) Elements are compared using comp.

If any of the following conditions is satisfied, the behavior is undefined: 

  * *this or other is not [sorted](../../algorithm.html#Requirements "cpp/algorithm") with respect to the comparator comp. 
...
## Contents
  ...
  * [2 Exceptions](merge.html#Exceptions)
  * [3 Complexity](merge.html#Complexity)
  * [4 Example](merge.html#Example)
  * [5 Defect reports](merge.html#Defect_reports)
  * [6 See also](merge.html#See_also)
...
Otherwise, given \\(\scriptsize N_1\\)N1 as [std::distance](../../iterator/distance.html)(begin(), end()) and \\(\scriptsize N_2\\)N2 as [std::distance](../../iterator/distance.html)(other.begin(), other.end()): 
...
Run this code
    ...
     
    [std::ostream](../../io/basic_ostream.html)& operator<<([std::ostream](../../io/basic_ostream.html)& ostr, const [std::forward_list](../forward_list.html)<int>& list)
    {
    ...
    int main()
    {
        [std::forward_list](../forward_list.html)<int> list1 = {5, 9, 1, 3, 3};
        [std::forward_list](../forward_list.html)<int> list2 = {8, 7, 2, 3, 4, 4};
     
        list1.sort();
        list2.sort();
        [std::cout](../../io/cout.html) << "list1: " << list1 << '\n';
        [std::cout](../../io/cout.html) << "list2: " << list2 << '\n';
     
        list1.merge(list2);
        [std::cout](../../io/cout.html) << "merged:" << list1 << '\n';
    }
...
---|---|---|---  
[LWG 2045](https://cplusplus.github.io/LWG/issue2045) | C++11  | O(1) node moving could not be guaranteed if  
get_allocator() != other.get_allocator() | the behavior is  
undefined in this case   
[LWG 3088](https://cplusplus.github.io/LWG/issue3088) | C++11  | the effect when *this and other refer  
to the same object was not specified  
operator< could misbehave for pointer elements  | specified as no-op  
