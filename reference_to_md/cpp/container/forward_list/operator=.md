...
(constexpr since C++26)  
forward_list& operator=( [std::initializer_list](../../utility/initializer_list.html)<value_type> ilist ); |  (3) | (since C++11)   
(constexpr since C++26)  
| |   
...
2) [`noexcept`](../../language/noexcept_spec.html "cpp/language/noexcept spec") specification: noexcept([std::allocator_traits](../../memory/allocator_traits.html)<Allocator>::is_always_equal::value) | (since C++17)  
---|---  
...
The following code uses operator= to assign one [std::forward_list](../forward_list.html "cpp/container/forward list") to another:
...
Run this code
    ...
    {
        auto size = std::[ranges::distance](../../iterator/ranges/distance.html)(container);
    ...
    int main()
    {
        [std::forward_list](../forward_list.html)<int> x{1, 2, 3}, y, z;
...
[ (constructor)](forward_list.html "cpp/container/forward list/forward list") |  constructs the `forward_list`   
