...
void insert( InputIt first, InputIt last ); |  (5)  |  (since C++23)  
template< class InputIt >  
void insert( [std::sorted_equivalent_t](../sorted_equivalent.html), InputIt first, InputIt last ); |  (6)  |  (since C++23)  
void insert( [std::initializer_list](../../utility/initializer_list.html)<key_type> ilist ); |  (7)  |  (since C++23)  
void insert( [std::sorted_equivalent_t](../sorted_equivalent.html) s, [std::initializer_list](../../utility/initializer_list.html)<key_type> ilist ); |  (8)  |  (since C++23)  
| |   
...
5) Inserts elements from range `[`first`, `last`)` as if performing the following operations sequentially: 
  ...
  1. Adds elements to [`c`](../flat_multiset.html#Member_objects "cpp/container/flat multiset") as if by c.insert(c.end(), first, last);. 
  2. Sorts the range of newly inserted elements with respect to [`compare`](../flat_multiset.html#Member_objects "cpp/container/flat multiset"). 
...
s  |  \-  |  a disambiguation tag indicating that the input sequence is sorted (with respect to [`key_compare`](../flat_multiset.html#Member_objects "cpp/container/flat multiset"))   
Type requirements   
...
5) N + M·log(M), where NN is the [`size()`](size.html "cpp/container/flat multiset/size") before the operation and `M` is [std::distance](../../iterator/distance.html)(first, last).

6) Linear.

7) N + M·log(M), where NN is the [`size()`](size.html "cpp/container/flat multiset/size") before the operation and `M` is ilist.size().
