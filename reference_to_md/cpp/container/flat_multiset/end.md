...
**flat_multiset::end flat_multiset::cend**  
...
Run this code
    ...
    int main()
    {
        [std::flat_multiset](../flat_multiset.html)<int> set{3, 1, 4, 1, 5, 9, 2, 6, 5};
        [std::for_each](../../algorithm/for_each.html)(set.cbegin(), set.cend(), [](int x)
        {
...
[ begincbegin](begin.html "cpp/container/flat multiset/begin") |  returns an iterator to the beginning   
