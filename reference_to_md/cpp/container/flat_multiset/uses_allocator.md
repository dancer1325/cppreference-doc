...
struct uses_allocator<[std::flat_multiset](../flat_multiset.html)<Key, Compare, KeyContainer>, Allocator>  
: [std::bool_constant](../../types/integral_constant.html)<[std::uses_allocator_v](../../memory/uses_allocator.html)<KeyContainer, Allocator>> {}; |  |  (since C++23)  
| |   
  
Provides a transparent specialization of the [std::uses_allocator](../../memory/uses_allocator.html "cpp/memory/uses allocator") type trait for [std::flat_multiset](../flat_multiset.html): the container adaptor uses allocator if and only if the underlying container does. 
...
Run this code
    ...
     
    static_assert(
        [std::uses_allocator](../../memory/uses_allocator.html)<[std::flat_multiset](../flat_multiset.html)<int>, void>::value == false &&
        [std::uses_allocator](../../memory/uses_allocator.html)<[std::flat_multiset](../flat_multiset.html)<int>, [std::allocator](../../memory/allocator.html)<int>>::value == true
    );
     
    int main() {}
