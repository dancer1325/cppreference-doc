...
Replaces the underlying container [`_c_`](../flat_multiset.html#Member_objects "cpp/container/flat multiset"). Equivalent to: c = std::move(cont);. 

The elements of cont must be sorted with respect to [`_compare_`](../flat_multiset.html#Member_objects "cpp/container/flat multiset"). Otherwise, the behavior is undefined. 
...
Run this code
    ...
     
        [std::flat_multiset](../flat_multiset.html)<int> set;
        [assert](../../error/assert.html)(set.empty());
     
        set.replace(keys);
        [assert](../../error/assert.html)(set.size() == 3);
        [assert](../../error/assert.html)(keys.empty());
     
        [std::println](../../io/println.html)("{}", set); // set.keys()
    }
...
[ extract](extract.html "cpp/container/flat multiset/extract") |  extracts the underlying container   
