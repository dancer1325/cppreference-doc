...
Returns the number of elements in the container adaptor. Equivalent to: return` `[`c`](../flat_multiset.html#Member_objects "cpp/container/flat multiset").size(). 
...
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/set/example_size&action=edit)
...
Run this code
    ...
    int main()
    {
        [std::flat_multiset](../flat_multiset.html)<int> nums{4, 2, 4, 2};
...
[ empty](empty.html "cpp/container/flat multiset/empty") |  checks whether the container adaptor is empty   
...
[ max_size](max_size.html "cpp/container/flat multiset/max size") |  returns the maximum possible number of elements   
