...
Run this code
    ...
    #include <flat_set>
     
    void print_info([std::string_view](../../string/basic_string_view.html) rem, const [std::flat_multiset](../flat_multiset.html)<int>& v)
    {
    ...
    int main()
    {
        [std::flat_multiset](../flat_multiset.html)<int> container{1, 2, 3};
...
[ erase](erase.html "cpp/container/flat multiset/erase") |  erases elements   
