...
Inserts a copy of each element in the range rg into underlying container [`_c_`](../flat_multiset.html#Member_objects "cpp/container/flat multiset") as if by: 
    
    
    for (const auto& e : rg)
        c.insert(c.end(), e);

Then, sorts the range of newly inserted elements with respect to [`_compare_`](../flat_multiset.html#Member_objects "cpp/container/flat multiset"). Merges the resulting sorted range and the sorted range of pre-existing elements into a single sorted range. 

Each iterator in the range rg is dereferenced exactly once. 

If any of the following conditions is satisfied, the behavior is undefined: 

  * `value_type` is not [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `flat_multiset` from *[ranges::begin](../../ranges/begin.html)(rg)
  * rg and *this overlap. 
...
Run this code
    ...
    int main()
    {
        auto container = [std::flat_multiset](../flat_multiset.html){1, 3, 2, 4};
        const auto rg = {-1, 3, -2};
...
[ insert](insert.html "cpp/container/flat multiset/insert") |  inserts elements   
