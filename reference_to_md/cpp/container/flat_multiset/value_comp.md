...
Run this code
    ...
     
            [std::cout](../../io/cout.html) << "Key (" << key << ") ";
            if (!before && !after)
                [std::cout](../../io/cout.html) << "equivalent to key (" << val << ")\n";
            else if (before)
                [std::cout](../../io/cout.html) << "goes before key (" << val << ")\n";
            else if (after)
                [std::cout](../../io/cout.html) << "goes after key (" << val << ")\n";
            else
...
[ key_comp](key_comp.html "cpp/container/flat multiset/key comp") |  returns the function that compares keys   
