...
Run this code
    ...
    int main()
    {
        [std::flat_multiset](../flat_multiset.html)<int, ModCmp> cont{1, 2, 3, 4, 5};
     
...
[ value_comp](value_comp.html "cpp/container/flat multiset/value comp") |  returns the function that compares keys in objects of type `value_type`   
