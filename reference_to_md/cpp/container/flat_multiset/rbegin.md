...
**flat_multiset::rbegin flat_multiset::crbegin**  
...
The [underlying iterator](../../iterator/reverse_iterator/base.html "cpp/iterator/reverse iterator/base") of the returned reverse iterator is the [end iterator](end.html "cpp/container/flat multiset/end"). Hence the returned iterator is invalidated if and when the end iterator is invalidated.
...
Run this code
    ...
    int main()
    {
        [std::flat_multiset](../flat_multiset.html)<unsigned> rep{1, 2, 3, 4, 1, 2, 3, 4};
     
...
[ rendcrend](rend.html "cpp/container/flat multiset/rend") |  returns a reverse iterator to the end   
