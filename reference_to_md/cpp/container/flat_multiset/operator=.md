...
(implicitly declared)  
---|---|---  
flat_multiset& operator=( flat_multiset&& other ); |  (2)  |  (since C++23)   
(implicitly declared)  
flat_multiset& operator=( [std::initializer_list](../../utility/initializer_list.html)<key_type> ilist ); |  (3)  |  (since C++23)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::flat_multiset](../flat_multiset.html)<int> x{1, 2, 3}, y, z;
