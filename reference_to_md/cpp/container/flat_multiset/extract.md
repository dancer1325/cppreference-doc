...
Extracts adapted container [`_c_`](../flat_multiset.html#Member_objects "cpp/container/flat multiset"). Equivalent to return std::move(c);. 
...
Run this code
    ...
    int main()
    {
        [std::flat_multiset](../flat_multiset.html)<int> set{1, 2, 3};
        const auto size{set.size()};
     
        auto c{std::move(set).extract()};
        [assert](../../error/assert.html)(c.size() == size);
        [assert](../../error/assert.html)(set.empty());
        [assert](../../error/assert.html)(set.keys().empty());
        [assert](../../error/assert.html)(set.values().empty());
     
        // The default keys container is std::vector:
        static_assert([std::is_same_v](../../types/is_same.html)<decltype(c), [std::vector](../vector.html)<int>>);
     
        [std::println](../../io/println.html)("{}", c);
    }
