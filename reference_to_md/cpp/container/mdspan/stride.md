...
Returns the stride of the layout mapping [`_map__`](../mdspan.html#Data_members "cpp/container/mdspan") in rth dimension. Equivalent to return map_.stride(r);. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/stride&action=edit&section=1 "Edit section: Parameters")] Parameters

r  |  \-  |  the index of the dimension   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/stride&action=edit&section=2 "Edit section: Return value")] Return value

The stride. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/stride&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/stride&action=edit&section=4 "Edit section: See also")] See also
