...
Run this code
    ...
     
        ...
        {
            for ([std::size_t](../../types/size_t.html) i = 0; i != view.extent(0); ++i)
            {
                for ([std::size_t](../../types/size_t.html) j = 0; j != view.extent(1); ++j)
                    [std::print](../../io/print.html)("{} ", view[i, j]);
        ...
        {
            for ([std::size_t](../../types/size_t.html) i = 0; i != view.extent(0); ++i)
                [std::print](../../io/print.html)("{} ", view[i]);
            [std::println](../../io/println.html)();
        }
        else
            [std::println](../../io/println.html)("{}", view[]);
     
        [std::println](../../io/println.html)();
    }
     
    int main()
    {
        ...
        const [std::mdspan](../mdspan.html) view(letters, 3, 3);
     
        print(view);
        print([std::submdspan](http://en.cppreference.com/w/cpp/container/mdspan/submdspan)(view, std::full_extent, std::full_extent));
        print([std::submdspan](http://en.cppreference.com/w/cpp/container/mdspan/submdspan)(view, std::full_extent, 1));
        print([std::submdspan](http://en.cppreference.com/w/cpp/container/mdspan/submdspan)(view, 1, std::full_extent));
        print([std::submdspan](http://en.cppreference.com/w/cpp/container/mdspan/submdspan)(view, 2, 1));
    }
