...
A specialization of `std::default_accessor` class template is the default [AccessorPolicy](../../named_req/AccessorPolicy.html "cpp/named req/AccessorPolicy") used by std::mdspan if no user-specified accessor policy is provided. 

Each specialization of `default_accessor` models [`semiregular`](../../concepts/semiregular.html "cpp/concepts/semiregular") and is [TriviallyCopyable](../../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable"). 

## Contents

  * [1 Template parameters](default_accessor.html#Template_parameters)
  * [2 Member types](default_accessor.html#Member_types)
  * [3 Member functions](default_accessor.html#Member_functions)
  * [4 std::default_accessor::default_accessor](default_accessor.html#std::default_accessor::default_accessor)
  * [5 std::default_accessor::access](default_accessor.html#std::default_accessor::access)
  * [6 std::default_accessor::offset](default_accessor.html#std::default_accessor::offset)
    * [6.1 Example](default_accessor.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/default_accessor&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/default_accessor&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/default_accessor&action=edit&section=3 "Edit section: Member functions")] Member functions

(constructor) |  constructs a `default_accessor`   
(public member function)  
---|---  
access |  returns a nth element provided by arguments   
(public member function)  
offset |  returns a data handle advanced by an offset value   
(public member function)  
...
2) Constructs a `default_accessor` from default_accessor<OtherElementType>. The constructor has no visible effect. This overload participates in overload resolution only if [std::is_convertible_v](../../types/is_convertible.html)<OtherElementType(*)[], element_type(*)[]> is true. 

##  std::default_accessor::access

constexpr reference access( data_handle_type p, [std::size_t](../../types/size_t.html) i ) const noexcept; |  |   
---|---|---  
| |   
...
constexpr data_handle_type offset( data_handle_type p, [std::size_t](../../types/size_t.html) i ) const noexcept; |  |   
---|---|---  
| |   
  
Equivalent to return p + i;. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/default_accessor&action=edit&section=4 "Edit section: Example")] Example
