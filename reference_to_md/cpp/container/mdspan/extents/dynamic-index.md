...
private:  
static constexpr auto /*dynamic-index*/( rank_type i ) noexcept; |  |  (since C++23)   
(exposition only*)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents/dynamic-index&action=edit&section=1 "Edit section: Parameters")] Parameters

i  |  \-  |  the index   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents/dynamic-index&action=edit&section=2 "Edit section: Return value")] Return value

The number of `_E r_` with `r < i` for which `_E r_` is a dynamic extent. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents/dynamic-index&action=edit&section=3 "Edit section: See also")] See also
