...
Returns the number of dynamic dimensions in [`extents`](../extents.html "cpp/container/mdspan/extents"). 

## Contents

  * [1 Parameters](rank_dynamic.html#Parameters)
  * [2 Return value](rank_dynamic.html#Return_value)
  * [3 Example](rank_dynamic.html#Example)
  * [4 See also](rank_dynamic.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents/rank_dynamic&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents/rank_dynamic&action=edit&section=2 "Edit section: Return value")] Return value

The number of dynamic dimensions. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents/rank_dynamic&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::extents](../extents.html)<int, 3, 4, [std::dynamic_extent](../../span/dynamic_extent.html)> e2(5);
        [std::extents](../extents.html)<int, [std::dynamic_extent](../../span/dynamic_extent.html), 7, [std::dynamic_extent](../../span/dynamic_extent.html)> e3(6, 8);
        [std::cout](../../../io/cout.html) << e1.rank_dynamic() << ", "
                  << e2.rank_dynamic() << ", "
                  << e3.rank_dynamic() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents/rank_dynamic&action=edit&section=4 "Edit section: See also")] See also

[ rank](rank.html "cpp/container/mdspan/extents/rank")[static] |  returns the static rank of an `extents`   
