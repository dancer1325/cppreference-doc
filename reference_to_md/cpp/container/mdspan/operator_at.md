...
( [std::span](../span.html)<OtherIndexType, rank()> indices ) const; |  (2)  |  (since C++23)  
template< class OtherIndexType >  
constexpr reference operator[]  
( const [std::array](../array.html)<OtherIndexType, rank()>& indices ) const; |  (3)  |  (since C++23)  
| |   
  
Returns a reference to the indicesth element of the mdspan. 

1) Equivalent to return` `` _[acc_](../mdspan.html#acc "cpp/container/mdspan")_` ﻿.access(`_[ptr_](../mdspan.html#ptr "cpp/container/mdspan")_` ,` `` _[map_](../mdspan.html#map "cpp/container/mdspan")_` ﻿(static_cast<index_type>(std::move(indices))...));.
...
This overload participates in overload resolution only if all following values are true: 
  ...
  * ([std::is_nothrow_constructible_v](../../types/is_constructible.html)<index_type, OtherIndexTypes> && ...)
  * sizeof...(OtherIndexTypes) == rank()



If extents_type::`_index-cast_` ﻿(std::move(indices)) is not a multidimensional index in extents(), the behavior is undefined.  | (until C++26)  
---|---  
If extents_type::`_index-cast_` ﻿(std::move(indices)) is not a multidimensional index in extents(): 
...
2,3) Let `P` be a parameter pack such that [std::is_same_v](../../types/is_same.html)<[std::make_index_sequence](../../utility/integer_sequence.html)<rank()>,  
[std::index_sequence](../../utility/integer_sequence.html)<P...>> is true, equivalent to return operator[](extents_type::`_index-cast_` ﻿([std::as_const](../../utility/as_const.html)(indices[P]))...);.
...
## Contents
  ...
  * [3 Example](operator_at.html#Example)
  * [4 Defect reports](operator_at.html#Defect_reports)
  * [5 See also](operator_at.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/operator_at&action=edit&section=1 "Edit section: Parameters")] Parameters

indices  |  \-  |  the indices of the element to access   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/operator_at&action=edit&section=2 "Edit section: Return value")] Return value

A reference to the element. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/operator_at&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/operator_at&action=edit&section=4 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 3974](https://cplusplus.github.io/LWG/issue3974) | C++23  | overloads (2,3) did not apply `extents_type::``_index-cast_` | applies   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/operator_at&action=edit&section=5 "Edit section: See also")] See also
