...
constexpr index_type extent( rank_type r ) const noexcept; |  |  (since C++23)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extent&action=edit&section=1 "Edit section: Parameters")] Parameters

r  |  \-  |  The rank index to get the extent size of   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extent&action=edit&section=2 "Edit section: Return value")] Return value

The extent at the given rank index. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extent&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extent&action=edit&section=4 "Edit section: See also")] See also
...
(public member function of `std::extents<IndexType,Extents...>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/mdspan/extents/dsc_extent&action=edit)  
---|---  
[ static_extent](static_extent.html "cpp/container/mdspan/static extent")[static] |  returns the static extent size of a `mdspan` at a given rank index   
