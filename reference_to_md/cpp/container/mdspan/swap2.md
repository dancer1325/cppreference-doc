...
Overloads the [`std::swap`](../../utility/swap.html "cpp/utility/swap") algorithm for [`std::mdspan`](../mdspan.html "cpp/container/mdspan"). Exchanges the state of x with that of y. Equivalent to: 

std::[`swap`](../../utility/swap.html "cpp/utility/swap")(x.`_[acc_](../mdspan.html#acc "cpp/container/mdspan")_` , y.`_[acc_](../mdspan.html#acc "cpp/container/mdspan")_`);  
std::[`swap`](../../utility/swap.html "cpp/utility/swap")(x.`_[map_](../mdspan.html#map "cpp/container/mdspan")_` , y.`_[map_](../mdspan.html#map "cpp/container/mdspan")_`);  
std::[`swap`](../../utility/swap.html "cpp/utility/swap")(x.`_[ptr_](../mdspan.html#ptr "cpp/container/mdspan")_` , y.`_[ptr_](../mdspan.html#ptr "cpp/container/mdspan")_`);

This function is not visible to ordinary [unqualified](../../language/unqualified_lookup.html "cpp/language/unqualified lookup") or [qualified lookup](../../language/qualified_lookup.html "cpp/language/qualified lookup"), and can only be found by [argument-dependent lookup](../../language/adl.html "cpp/language/adl") when `std::mdspan` is an associated class of the arguments. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  [`mdspan`](../mdspan.html "cpp/container/mdspan") objects whose states to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/swap2&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/swap2&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/swap2&action=edit&section=4 "Edit section: See also")] See also
