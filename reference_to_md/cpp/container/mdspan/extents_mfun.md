...
Returns a const reference to the extents of the layout mapping [`_map__`](../mdspan.html#Data_members "cpp/container/mdspan"). Equivalent to return map_.extents();. 

## Contents

  * [1 Parameters](extents_mfun.html#Parameters)
  * [2 Return value](extents_mfun.html#Return_value)
  * [3 Example](extents_mfun.html#Example)
  * [4 See also](extents_mfun.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents_mfun&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents_mfun&action=edit&section=2 "Edit section: Return value")] Return value

A const reference to the extents. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents_mfun&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents_mfun&action=edit&section=4 "Edit section: See also")] See also
