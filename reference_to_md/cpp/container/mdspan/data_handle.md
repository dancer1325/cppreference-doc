...
Returns the underlying data handle of [`data_handle_type`](../mdspan.html#Member_types "cpp/container/mdspan"). Equivalent to return` `[`_ptr__`](../mdspan.html#Data_members "cpp/container/mdspan") ;. 

## Contents

  * [1 Parameters](data_handle.html#Parameters)
  * [2 Return value](data_handle.html#Return_value)
  * [3 Example](data_handle.html#Example)
  * [4 See also](data_handle.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/data_handle&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/data_handle&action=edit&section=2 "Edit section: Return value")] Return value

A const reference to the underlying data handle. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/data_handle&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/data_handle&action=edit&section=4 "Edit section: See also")] See also
