...
Returns the number of elements in [`mdspan`](mdspan.html "cpp/container/mdspan/mdspan"). 

Equivalent to [`extents`](extents.html "cpp/container/mdspan/extents")().[`_fwd-prod-of-extents_`](extents/fwd-prod-of-extents.html "cpp/container/mdspan/extents/fwd-prod-of-extents")([`rank`](extents/rank.html "cpp/container/mdspan/extents/rank")()). 

The size of the multidimensional index space [`extents()`](extents.html "cpp/container/mdspan/extents") must be representable as a value of type [`size_type`](../mdspan.html#Member_types "cpp/container/mdspan"). Otherwise, the behavior is undefined. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/size&action=edit&section=1 "Edit section: Return value")] Return value

The number of elements. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/size&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/size&action=edit&section=3 "Edit section: See also")] See also
