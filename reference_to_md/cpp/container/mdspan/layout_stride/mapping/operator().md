...
[mapping::required_span_size](required_span_size.html "cpp/container/mdspan/layout stride/mapping/required span size")  
**mapping::operator()**  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_stride/mapping/operator\(\)&action=edit&section=1 "Edit section: Parameters")] Parameters

indices  |  \-  |  the multidimensional index in the underlying extents object   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_stride/mapping/operator\(\)&action=edit&section=2 "Edit section: Return value")] Return value

The offset value. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_stride/mapping/operator\(\)&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_stride/mapping/operator\(\)&action=edit&section=4 "Edit section: See also")] See also
