...
const OtherMapping& rhs ) noexcept; |  |  (since C++23)  
---|---|---  
| |   
...
This overload participates in overload resolution only if all of the following constraints are satisfied: 
  ...
  * [`_layout-mapping-alike_`](../../../../named_req/LayoutMapping.html#layout-mapping-alike "cpp/named req/LayoutMapping") <OtherMapping> is satisfied, 
...
If `OtherMapping` does not meet the [LayoutMapping](../../../../named_req/LayoutMapping.html "cpp/named req/LayoutMapping") requirements, the behavior is undefined. 
