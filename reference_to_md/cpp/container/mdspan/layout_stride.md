...
`layout_stride` is a [LayoutMappingPolicy](../../named_req/LayoutMappingPolicy.html "cpp/named req/LayoutMappingPolicy") which provides a layout mapping where the strides are user-defined. 

`layout_stride` is a [TrivialType](../../named_req/TrivialType.html "cpp/named req/TrivialType").  | (until C++26)  
---|---  
`layout_stride` is [TriviallyCopyable](../../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable"), and [std::is_trivially_default_constructible_v](../../types/is_default_constructible.html)<layout_stride> is true.  | (since C++26)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_stride&action=edit&section=1 "Edit section: Nested class templates")] Nested class templates

[ mapping](layout_stride/mapping.html "cpp/container/mdspan/layout stride/mapping") |  a layout mapping of layout_stride  
(public member class template)[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/mdspan/layout_stride/dsc_mapping&action=edit)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_stride&action=edit&section=2 "Edit section: See also")] See also
...
---|---  
[ layout_left_padded](layout_left_padded.html "cpp/container/mdspan/layout left padded")(C++26) |  column-major layout mapping policy with padding stride that can be greater than or equal to the leftmost extent   
...
[ layout_right_padded](layout_right_padded.html "cpp/container/mdspan/layout right padded")(C++26) |  row-major layout mapping policy with padding stride that can be greater than or equal to the rightmost extent   
