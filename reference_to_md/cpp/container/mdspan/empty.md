...
constexpr bool empty() const noexcept; |  |  (since C++23)  
---|---|---  
| |   
  
Check if the [`mdspan`](../mdspan.html "cpp/container/mdspan") is empty. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/empty&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/empty&action=edit&section=2 "Edit section: Return value")] Return value

true if the size of the multidimensional index space extents() is ​0​, otherwise false. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/empty&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/empty&action=edit&section=4 "Edit section: See also")] See also
