...
1) [defaulted copy assignment operator](../../language/as_operator.html#Implicitly-defined_copy_assignment_operator "cpp/language/copy assignment"),

2) [defaulted move assignment operator](../../language/move_operator.html#Implicitly-defined_move_assignment_operator "cpp/language/move assignment").
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/operator%3D&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  another mdspan to copy or move from   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/operator%3D&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/operator%3D&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/operator%3D&action=edit&section=4 "Edit section: See also")] See also
