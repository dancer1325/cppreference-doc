...
---|---|---  
template< [std::size_t](../../types/size_t.html) PaddingValue = [std::dynamic_extent](../span/dynamic_extent.html) >  
struct layout_right_padded; |  |  (since C++26)  
| |   
  
Every specialization of `layout_right_padded` is a [LayoutMappingPolicy](../../named_req/LayoutMappingPolicy.html "cpp/named req/LayoutMappingPolicy") which provides a layout mapping that is similar to [`layout_right::mapping`](layout_right/mapping.html "cpp/container/mdspan/layout right/mapping") except that it has a _padding stride_. 

Every specialization of `layout_right_padded` is [TriviallyCopyable](../../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable"), and [std::is_trivially_default_constructible_v](../../types/is_default_constructible.html)<T> is true for any such specialization `T`. 

Let m be the instance of the mapping type [`layout_right_padded::mapping`](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_right_padded/mapping&action=edit&redlink=1 "cpp/container/mdspan/layout right padded/mapping \(page does not exist\)"). The padding stride of the mapping is the second to last stride m.stride(rank() - 2) which is guaranteed to be at least the last extent value m.extent(rank() - 1), called _extent to pad_. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_right_padded&action=edit&section=1 "Edit section: Nested class templates")] Nested class templates
...
(public member class template)[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/mdspan/layout_right_padded/dsc_mapping&action=edit)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_right_padded&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_right_padded&action=edit&section=3 "Edit section: See also")] See also

[ layout_right](layout_right.html "cpp/container/mdspan/layout right")(C++23) |  row-major multidimensional array layout mapping policy; rightmost extent has stride `1`   
