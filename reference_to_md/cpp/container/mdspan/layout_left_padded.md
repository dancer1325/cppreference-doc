...
struct layout_left_padded; |  |  (since C++26)  
| |   
  
Every specialization of `layout_left_padded` is a [LayoutMappingPolicy](../../named_req/LayoutMappingPolicy.html "cpp/named req/LayoutMappingPolicy") which provides a layout mapping that is similar to [`layout_left::mapping`](layout_left/mapping.html "cpp/container/mdspan/layout left/mapping") except that it has a _padding stride_. 

Every specialization of `layout_left_padded` is [TriviallyCopyable](../../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable"), and [std::is_trivially_default_constructible_v](../../types/is_default_constructible.html)<T> is true for any such specialization `T`. 
