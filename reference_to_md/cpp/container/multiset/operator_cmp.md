...
bool operator==( const [std::multiset](../multiset.html)<Key, Compare, Alloc>& lhs,  
const [std::multiset](../multiset.html)<Key, Compare, Alloc>& rhs ); |  (1) | (constexpr since C++26)  
template< class Key, class Compare, class Alloc >  
bool operator!=( const [std::multiset](../multiset.html)<Key, Compare, Alloc>& lhs,  
const [std::multiset](../multiset.html)<Key, Compare, Alloc>& rhs ); |  (2)  |  (until C++20)  
template< class Key, class Compare, class Alloc >  
bool operator< ( const [std::multiset](../multiset.html)<Key, Compare, Alloc>& lhs,  
const [std::multiset](../multiset.html)<Key, Compare, Alloc>& rhs ); |  (3)  |  (until C++20)  
template< class Key, class Compare, class Alloc >  
bool operator<=( const [std::multiset](../multiset.html)<Key, Compare, Alloc>& lhs,  
const [std::multiset](../multiset.html)<Key, Compare, Alloc>& rhs ); |  (4)  |  (until C++20)  
template< class Key, class Compare, class Alloc >  
bool operator> ( const [std::multiset](../multiset.html)<Key, Compare, Alloc>& lhs,  
const [std::multiset](../multiset.html)<Key, Compare, Alloc>& rhs ); |  (5)  |  (until C++20)  
template< class Key, class Compare, class Alloc >  
bool operator>=( const [std::multiset](../multiset.html)<Key, Compare, Alloc>& lhs,  
const [std::multiset](../multiset.html)<Key, Compare, Alloc>& rhs ); |  (6)  |  (until C++20)  
template< class Key, class Compare, class Alloc >  
/* see below */  
operator<=>( const [std::multiset](../multiset.html)<Key, Compare, Alloc>& lhs,  
const [std::multiset](../multiset.html)<Key, Compare, Alloc>& rhs ); |  (7) | (since C++20)   
...
Run this code
    ...
    int main()
    {
        const [std::multiset](../multiset.html)
            a{1, 2, 3},
            b{1, 2, 3},
            c{7, 8, 9, 10};
     
