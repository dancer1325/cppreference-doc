...
**multiset::end multiset::cend**(C++11)  
...
Run this code
    ...
    int main()
    {
        const [std::multiset](../multiset.html)<[std::string](../../string/basic_string.html)> words =
        {
    ...
     
        for (auto it = words.begin(); it != words.end(); )
        {
            ...
            [std::cout](../../io/cout.html) << *it << ":\t" << count << '\n';
            [std::advance](../../iterator/advance.html)(it, count); // all count elements have equivalent keys
        }
    }
...
[ begincbegin](begin.html "cpp/container/multiset/begin")(C++11) |  returns an iterator to the beginning   
