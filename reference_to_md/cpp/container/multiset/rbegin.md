...
**multiset::rbegin multiset::crbegin**(C++11)` `  
...
If *this is empty, the returned iterator is equal to [rend()](rend.html "cpp/container/multiset/rend"). 
...
The [underlying iterator](../../iterator/reverse_iterator/base.html "cpp/iterator/reverse iterator/base") of the returned reverse iterator is the [end iterator](end.html "cpp/container/multiset/end"). Hence the returned iterator is invalidated if and when the end iterator is invalidated.
...
Run this code
    ...
    int main()
    {
        [std::multiset](../multiset.html)<unsigned> rep{1, 2, 3, 4, 1, 2, 3, 4};
     
