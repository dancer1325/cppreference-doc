...
requires(![std::same_as](../../concepts/same_as.html)<iterator, const_iterator>); |  | (since C++23)   
...
Only one overload is provided if `iterator` and `const_iterator` are the same type.  | (since C++11)  
---|---  
...
The iterator pos must be dereferenceable. Thus the [end()](end.html "cpp/container/multiset/end") iterator (which is valid, but is not dereferenceable) cannot be used as a value for pos. 
...
Run this code
    ...
    int main()
    {
        [std::multiset](../multiset.html)<int> c = {1, 2, 3, 4, 1, 2, 3, 4};
     
        auto print = [&c]
        {
        ...
        print();
     
        [std::cout](../../io/cout.html) << "Erase all odd numbers:\n";
        ...
        print();
     
        [std::cout](../../io/cout.html) << "Erase 1, erased count: " << c.erase(1) << '\n';
        [std::cout](../../io/cout.html) << "Erase 2, erased count: " << c.erase(2) << '\n';
        [std::cout](../../io/cout.html) << "Erase 2, erased count: " << c.erase(2) << '\n';
        print();
    }
...
[ clear](clear.html "cpp/container/multiset/clear") |  clears the contents   
