...
An iterator to the requested element. If no such element is found, past-the-end (see [end()](end.html "cpp/container/multiset/end")) iterator is returned. 
...
Run this code
    ...
    int main()
    {
        ...
        [std::multiset](../multiset.html)<int> example{1, 2, 3, 4};
     
        if (auto search = example.find(2); search != example.end())
            [std::cout](../../io/cout.html) << "Found " << (*search) << '\n';
        else
            [std::cout](../../io/cout.html) << "Not found\n";
     
        // Transparent comparison demo.
        [std::multiset](../multiset.html)<FatKey, [std::less](../../utility/functional/less.html)<>> example2{{1, {}}, {2, {}}, {3, {}}, {4, {}}};
     
        LightKey lk = {2};
        if (auto search = example2.find(lk); search != example2.end())
            [std::cout](../../io/cout.html) << "Found " << search->x << '\n';
        else
            [std::cout](../../io/cout.html) << "Not found\n";
    }
