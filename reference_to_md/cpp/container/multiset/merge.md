...
template< class C2 >  
void merge( [std::set](../set.html)<Key, C2, Allocator>& source ); |  (1) | (since C++17)   
(constexpr since C++26)  
---|---|---  
template< class C2 >  
void merge( [std::set](../set.html)<Key, C2, Allocator>&& source ); |  (2) | (since C++17)   
(constexpr since C++26)  
template< class C2 >  
void merge( [std::multiset](../multiset.html)<Key, C2, Allocator>& source ); |  (3) | (since C++17)   
(constexpr since C++26)  
template< class C2 >  
void merge( [std::multiset](../multiset.html)<Key, C2, Allocator>&& source ); |  (4) | (since C++17)   
(constexpr since C++26)  
| |   
...
## Contents
  ...
  * [5 See also](merge.html#See_also)
...
Run this code
    ...
    Os& operator<<(Os& os, const [std::multiset](../multiset.html)<K>& v)
    {
        os << '[' << v.size() << "] {";
        bool o{};
        for (const auto& e : v)
    ...
    int main()
    {
        [std::multiset](../multiset.html)<char>
            p{'C', 'B', 'B', 'A'}, 
            q{'E', 'D', 'E', 'C'};
     
...
[ extract](extract.html "cpp/container/multiset/extract")(C++17) |  extracts nodes from the container   
