...
class Pred >  
[std::multiset](../multiset.html)<Key, Compare, Alloc>::size_type  
erase_if( [std::multiset](../multiset.html)<Key, Compare, Alloc>& c,  
...
Run this code
    ...
    int main()
    {
        [std::multiset](../multiset.html) data{3, 3, 4, 5, 5, 6, 6, 7, 2, 1, 0};
        println("Original:\n", data);
     
