...
equal_range( const Key& key ) const; |  (2) | (constexpr since C++26)  
template< class K >  
[std::pair](../../utility/pair.html)<iterator, iterator> equal_range( const K& x ); |  (3) | (since C++14)   
(constexpr since C++26)  
template< class K >  
[std::pair](../../utility/pair.html)<const_iterator, const_iterator>  
equal_range( const K& x ) const; |  (4) | (since C++14)   
(constexpr since C++26)  
| |   
...
Alternatively, the first iterator may be obtained with [lower_bound()](lower_bound.html "cpp/container/multiset/lower bound"), and the second with [upper_bound()](upper_bound.html "cpp/container/multiset/upper bound"). 
...
Run this code
    ...
    int main()
    {
        [std::multiset](../multiset.html)<int> c{4, 3, 2, 1, 3, 3};
