...
---|---|---  
| (2) |   
multiset& operator=( multiset&& other ); |  | (since C++11)   
(until C++17)  
multiset& operator=( multiset&& other )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
multiset& operator=( [std::initializer_list](../../utility/initializer_list.html)<value_type> ilist ); |  (3) | (since C++11)   
(constexpr since C++26)  
| |   
...
3) \\(\scriptsize O(N \cdot \log(N))\\)O(N·log(N)) in general, where \\(\scriptsize N\\)N is size() + ilist.size(). Linear if ilist is sorted with respect to [value_comp()](value_comp.html "cpp/container/multiset/value comp").
...
&& [std::is_nothrow_move_assignable](../../types/is_move_assignable.html)<Compare>::value) | (since C++17)  
---|---  
...
The following code uses operator= to assign one [std::multiset](../multiset.html "cpp/container/multiset") to another:
...
Run this code
    ...
    int main()
    {
        [std::multiset](../multiset.html)<int> x{1, 2, 3}, y, z;
...
[ (constructor)](multiset.html "cpp/container/multiset/multiset") |  constructs the `multiset`   
