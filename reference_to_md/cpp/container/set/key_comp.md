...
Returns the function object that compares the keys, which is a copy of the key comparison object used by *this.It is the same as [value_comp()](value_comp.html "cpp/container/set/value comp"). 
