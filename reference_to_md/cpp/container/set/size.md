...
Run this code
    ...
    int main()
    {
        [std::set](../set.html)<int> nums{4, 2, 4, 2};
...
[ empty](empty.html "cpp/container/set/empty") |  checks whether the container is empty   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_empty&action=edit)  
---|---  
[ max_size](max_size.html "cpp/container/set/max size") |  returns the maximum possible number of elements   
