...
An iterator to the requested element. If no such element is found, past-the-end (see [end()](end.html "cpp/container/set/end")) iterator is returned. 
...
Run this code
    ...
    int main()
    {
        ...
        [std::set](../set.html)<int> example{1, 2, 3, 4};
     
    ...
     
        ...
        [std::set](../set.html)<FatKey, [std::less](../../utility/functional/less.html)<>> example2{{1, {}}, {2, {}}, {3, {}}, {4, {}}};
     
        LightKey lk = {2};
