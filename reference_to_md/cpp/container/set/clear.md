...
Erases all elements from the container. After this call, [size()](size.html "cpp/container/set/size") returns zero. 
...
Run this code
    ...
    #include <set>
     
    void print_info([std::string_view](../../string/basic_string_view.html) rem, const [std::set](../set.html)<int>& v)
    {
    ...
    int main()
    {
        [std::set](../set.html)<int> container{1, 2, 3};
...
[ erase](erase.html "cpp/container/set/erase") |  erases elements   
