...
(constexpr since C++26)  
set( [std::initializer_list](../../utility/initializer_list.html)<value_type> init,  
const Compare& comp = Compare(),  
...
set( [std::from_range_t](../../ranges/from_range.html), R&& rg,  
const Compare& comp = Compare(),  
...
set( [std::from_range_t](../../ranges/from_range.html), R&& rg,  
const Allocator& alloc )  
: set([std::from_range](../../ranges/from_range.html), [std::forward](../../utility/forward.html)<R>(rg), Compare(), alloc) {} |  (13) | (since C++23)   
(constexpr since C++26)  
| |   
...
## Contents
  ...
  * [2 Complexity](set.html#Complexity)
  * [3 Exceptions](set.html#Exceptions)
  * [4 Notes](set.html#Notes)
  * [5 Example](set.html#Example)
  * [6 Defect reports](set.html#Defect_reports)
  * [7 See also](set.html#See_also)
...
After container move construction (overload ([8,9](set.html#Version_8))), references, pointers, and iterators (other than the end iterator) to other remain valid, but refer to elements that are now in *this. The current standard makes this guarantee via the blanket statement in [[container.reqmts]/67](https://eel.is/c++draft/container.reqmts#67), and a more direct guarantee is under consideration via [LWG issue 2321](https://cplusplus.github.io/LWG/issue2321). 
...
Run this code
    ...
    struct PointCmp
    {
        ...
        {
            return [std::hypot](../../numeric/math/hypot.html)(lhs.x, lhs.y) < [std::hypot](../../numeric/math/hypot.html)(rhs.x, rhs.y);
        }
    };
     
    [std::ostream](../../io/basic_ostream.html)& operator<<([std::ostream](../../io/basic_ostream.html)& os, Point pt)
    {
        return os << '(' << pt.x << ',' << pt.x << ')';
    }
     
    ...
    int main()
    {
        ...
        [std::set](../set.html)<[std::string](../../string/basic_string.html)> a;
        a.insert("horse");
        a.insert("cat");
        a.insert("dog");
        println("1) a: ", a);
     
        // (4) Range constructor
        [std::set](../set.html)<[std::string](../../string/basic_string.html)> b(a.find("dog"), a.end());
        println("2) b: ", b);
     
        // (6) Copy constructor
        [std::set](../set.html)<[std::string](../../string/basic_string.html)> c(a);
        c.insert("another horse");
        println("3) c: ", c);
     
        // (8) Move constructor
        [std::set](../set.html)<[std::string](../../string/basic_string.html)> d(std::move(a));
        println("4) d: ", d);
        println("5) a: ", a);
     
        // (10) Initializer list constructor
        [std::set](../set.html)<[std::string](../../string/basic_string.html)> e{"one", "two", "three", "five", "eight"};
        println("6) e: ", e);
     
        // Custom comparison
        [std::set](../set.html)<Point, PointCmp> f = {{2, 5}, {3, 4}, {1, 1}};
    ...
     
        ...
        [std::set](../set.html)<[std::string](../../string/basic_string.html)> g([std::from_range](../../ranges/from_range.html), w); // overload (12)
    #else
        [std::set](../set.html)<[std::string](../../string/basic_string.html)> g(w.begin(), w.end()); // fallback to (4)
    #endif
        println("8) g: ", g);
    }
...
---|---|---|---  
[LWG 2076](https://cplusplus.github.io/LWG/issue2076) | C++11  | overload ([4](set.html#Version_4)) conditionally required `Key` to be [CopyInsertable](../../named_req/CopyInsertable.html "cpp/named req/CopyInsertable") into *this | not required   
...
[ operator=](operator=.html "cpp/container/set/operator=") |  assigns values to the container   
