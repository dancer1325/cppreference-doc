...
void swap( [std::set](../set.html)<Key, Compare, Alloc>& lhs,  
[std::set](../set.html)<Key, Compare, Alloc>& rhs ); |  |  (until C++17)  
template< class Key, class Compare, class Alloc >  
void swap( [std::set](../set.html)<Key, Compare, Alloc>& lhs,  
[std::set](../set.html)<Key, Compare, Alloc>& rhs )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::set](../set.html "cpp/container/set"). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). 
...
Run this code
    ...
    int main()
    {
        [std::set](../set.html)<int> alice{1, 2, 3};
        [std::set](../set.html)<int> bob{7, 8, 9, 10};
     
...
[ swap](swap.html "cpp/container/set/swap") |  swaps the contents   
