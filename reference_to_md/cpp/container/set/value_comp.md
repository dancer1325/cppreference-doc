...
Returns the function object that compares the values. It is the same as [key_comp()](key_comp.html "cpp/container/set/key comp"). 
...
Run this code
    ...
    int main()
    {
        [std::set](../set.html)<int, ModCmp> cont{1, 2, 3, 4, 5};
     
...
[ key_comp](key_comp.html "cpp/container/set/key comp") |  returns the function that compares keys   
