...
Run this code
    ...
    Os& operator<<(Os& os, const [std::set](../set.html)<K>& v)
    {
        os << '[' << v.size() << "] {";
        bool o{};
        for (const auto& e : v)
...
[ extract](extract.html "cpp/container/set/extract")(C++17) |  extracts nodes from the container   
