...
Run this code
    ...
    {
        int x;
        S(int i) : x{i} { [std::cout](../../io/cout.html) << "S{" << i << "} "; }
    ...
    {
        int x;
        R(int i) : x{i} { [std::cout](../../io/cout.html) << "R{" << i << "} "; }
    ...
    int main()
    {
        [std::set](../set.html)<int> t{3, 1, 4, 1, 5};
        [std::cout](../../io/cout.html) << t.count(1) << ", " << t.count(2) << ".\n";
     
        [std::set](../set.html)<S> s{3, 1, 4, 1, 5};
        [std::cout](../../io/cout.html) << ": " << s.count(1) << ", " << s.count(2) << ".\n";
            // Two temporary objects S{1} and S{2} were created.
            // Comparison function object is defaulted std::less<S>,
            // which is not transparent (has no “is_transparent” nested type).
     
        [std::set](../set.html)<R, [std::less](../../utility/functional/less.html)<>> r{3, 1, 4, 1, 5};
        [std::cout](../../io/cout.html) << ": " << r.count(1) << ", " << r.count(2) << ".\n";
