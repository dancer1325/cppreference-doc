...
Erases all elements from the container. After this call, [size()](size.html "cpp/container/list/size") returns zero. 
...
Run this code
    ...
    #include <list>
     
    void print_info([std::string_view](../../string/basic_string_view.html) rem, const [std::list](../list.html)<int>& v)
    {
    ...
    int main()
    {
        [std::list](../list.html)<int> container{1, 2, 3};
...
[ erase](erase.html "cpp/container/list/erase") |  erases elements   
