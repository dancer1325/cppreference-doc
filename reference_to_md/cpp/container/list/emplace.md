...
The element is constructed through [std::allocator_traits::construct](../../memory/allocator_traits/construct.html "cpp/memory/allocator traits/construct"), which uses placement new to construct the element in-place at a location provided by the container. 
...
Run this code
    ...
    int main()
    {
        [std::list](../list.html)<A> container;
     
