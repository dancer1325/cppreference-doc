...
Type requirements   
- |  If the following condition is satisfied, the behavior is undefined:  1) `T` is not [DefaultInsertable](../../named_req/DefaultInsertable.html "cpp/named req/DefaultInsertable") into `list`. 2) `T` is not [CopyInsertable](../../named_req/CopyInsertable.html "cpp/named req/CopyInsertable") into `list`. | (since C++11)  
---|---  
...
Run this code
    ...
    #include <iostream>
     
    void print(auto rem, const [std::list](../list.html)<int>& c)
    {
    ...
    int main()
    {
        [std::list](../list.html)<int> c = {1, 2, 3};
...
---|---|---|---  
[LWG 132](https://cplusplus.github.io/LWG/issue132) | C++98  | random-access iterators were used to determine the erase range  | use bidirectional iterators   
[LWG 679](https://cplusplus.github.io/LWG/issue679) | C++98  | `resize()` passed value by value  | passes by const reference   
[LWG 1420](https://cplusplus.github.io/LWG/issue1420) | C++98  | the behavior of resize(size()) was not specified  | specified   
...
---|---  
[ size](size.html "cpp/container/list/size") |  returns the number of elements   
