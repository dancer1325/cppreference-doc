...
All iterators and references remain valid. It is unspecified whether an iterator holding the [`end()`](end.html "cpp/container/list/end") value in this container will refer to this or the other container after the operation. 
...
Run this code
    ...
    int main()
    {
        [std::list](../list.html)<int> a1{1, 2, 3}, a2{4, 5};
     
...
[ std::swap(std::list)](swap2.html "cpp/container/list/swap2") |  specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm   
