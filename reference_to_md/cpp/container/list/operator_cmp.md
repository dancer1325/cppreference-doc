...
bool operator==( const [std::list](../list.html)<T, Alloc>& lhs,  
const [std::list](../list.html)<T, Alloc>& rhs ); |  (1) | (constexpr since C++26)  
template< class T, class Alloc >  
bool operator!=( const [std::list](../list.html)<T, Alloc>& lhs,  
const [std::list](../list.html)<T, Alloc>& rhs ); |  (2)  |  (until C++20)  
template< class T, class Alloc >  
bool operator< ( const [std::list](../list.html)<T, Alloc>& lhs,  
const [std::list](../list.html)<T, Alloc>& rhs ); |  (3)  |  (until C++20)  
template< class T, class Alloc >  
bool operator<=( const [std::list](../list.html)<T, Alloc>& lhs,  
const [std::list](../list.html)<T, Alloc>& rhs ); |  (4)  |  (until C++20)  
template< class T, class Alloc >  
bool operator> ( const [std::list](../list.html)<T, Alloc>& lhs,  
const [std::list](../list.html)<T, Alloc>& rhs ); |  (5)  |  (until C++20)  
template< class T, class Alloc >  
bool operator>=( const [std::list](../list.html)<T, Alloc>& lhs,  
const [std::list](../list.html)<T, Alloc>& rhs ); |  (6)  |  (until C++20)  
template< class T, class Alloc >  
/* see below */  
operator<=>( const [std::list](../list.html)<T, Alloc>& lhs,  
const [std::list](../list.html)<T, Alloc>& rhs ); |  (7) | (since C++20)   
(constexpr since C++26)  
| |   
  
Compares the contents of two `list`s. 

Let `value_type` be the value type of `list` (i.e., typename list::value_type): 
...
1,2) Constant if lhs and rhs are of different size, otherwise linear in the size of the `list`.

3-7) Linear in the size of the `list`.
