...
Inserts, in non-reversing order, copies of elements in rg before [`begin()`](begin.html "cpp/container/list/begin"). Each iterator in the range rg is dereferenced exactly once. 
...
Run this code
    ...
    int main()
    {
        auto container = [std::list](../list.html){0, 1, 2, 3};
    ...
    #endif
        [assert](../../error/assert.html)(std::[ranges::equal](../../algorithm/ranges/equal.html)(container, [std::list](../list.html){-3, -2, -1, 0, 1, 2, 3}));
    }
