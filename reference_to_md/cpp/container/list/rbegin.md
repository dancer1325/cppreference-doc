...
If *this is empty, the returned iterator is equal to [rend()](rend.html "cpp/container/list/rend"). 
...
The [underlying iterator](../../iterator/reverse_iterator/base.html "cpp/iterator/reverse iterator/base") of the returned reverse iterator is the [end iterator](end.html "cpp/container/list/end"). Hence the returned iterator is invalidated if and when the end iterator is invalidated.
...
Run this code
    ...
    int main()
    {
        [std::list](../list.html)<int> nums{1, 2, 4, 8, 16};
        [std::list](../list.html)<[std::string](../../string/basic_string.html)> fruits{"orange", "apple", "raspberry"};
        [std::list](../list.html)<char> empty;
     
        // Print list.
        [std::for_each](../../algorithm/for_each.html)(nums.rbegin(), nums.rend(), [](const int n) { [std::cout](../../io/cout.html) << n << ' '; });
        [std::cout](../../io/cout.html) << '\n';
     
        // Sums all integers in the list nums (if any), printing only the result.
        [std::cout](../../io/cout.html) << "Sum of nums: "
                  << [std::accumulate](../../algorithm/accumulate.html)(nums.rbegin(), nums.rend(), 0) << '\n';
     
        // Prints the first fruit in the list fruits, checking if there is any.
        if (!fruits.empty())
            [std::cout](../../io/cout.html) << "First fruit: " << *fruits.rbegin() << '\n';
     
        if (empty.rbegin() == empty.rend())
            [std::cout](../../io/cout.html) << "list 'empty' is indeed empty.\n";
    }
...
[ rendcrend](rend.html "cpp/container/list/rend")(C++11) |  returns a reverse iterator to the end   
