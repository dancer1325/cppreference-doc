...
void swap( [std::list](../list.html)<T, Alloc>& lhs,  
[std::list](../list.html)<T, Alloc>& rhs ); |  |  (until C++17)  
template< class T, class Alloc >  
void swap( [std::list](../list.html)<T, Alloc>& lhs,  
[std::list](../list.html)<T, Alloc>& rhs )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::list](../list.html "cpp/container/list"). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). 
...
Run this code
    ...
    int main()
    {
        [std::list](../list.html)<int> alice{1, 2, 3};
        [std::list](../list.html)<int> bob{7, 8, 9, 10};
     
...
[ swap](swap.html "cpp/container/list/swap") |  swaps the contents   
