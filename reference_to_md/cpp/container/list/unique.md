...
void unique( BinaryPred p ); |  |  (until C++20)  
template< class BinaryPred >  
...
## Contents
  ...
  * [6 Defect reports](unique.html#Defect_reports)
...
If [empty()](empty.html "cpp/container/list/empty") is true, no comparison is performed. 
...
Run this code
    ...
    #include <list>
     
    [std::ostream](../../io/basic_ostream.html)& operator<< ([std::ostream](../../io/basic_ostream.html)& os, [std::list](../list.html)<int> const& container)
    {
    ...
    int main()
    {
        [std::list](../list.html)<int> c{1, 2, 2, 3, 3, 2, 1, 1, 2};
...
---|---|---|---  
[LWG 1207](https://cplusplus.github.io/LWG/issue1207) | C++98  | it was unclear whether iterators  
