...
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/list/example_empty&action=edit)

The following code uses `empty` to check if a [std::list](../list.html)<int> contains any elements:
...
Run this code
    ...
    int main()
    {
        [std::list](../list.html)<int> numbers;
