...
const_iterator first, const_iterator last ); |  (5) | (constexpr since C++26)  
void splice( const_iterator pos, list&& other,   
...
## Contents
  ...
  * [1 Parameters](splice.html#Parameters)
  * [2 Complexity](splice.html#Complexity)
  * [3 Example](splice.html#Example)
  * [4 Defect reports](splice.html#Defect_reports)
  * [5 See also](splice.html#See_also)
...
Run this code
    ...
    int main ()
    {
        [std::list](../list.html)<int> list1{1, 2, 3, 4, 5};
        [std::list](../list.html)<int> list2{10, 20, 30, 40, 50};
     
        auto it = list1.begin();
        [std::advance](../../iterator/advance.html)(it, 2);
     
...
---|---|---|---  
[LWG 250](https://cplusplus.github.io/LWG/issue250) | C++98  | references and iterators to the moved  
element(s) were all invalidated  | they refer or point to the  
same element(s) in *this  
[N2525](https://wg21.link/N2525) | C++98  | O(1) splicing could not be guaranteed if  
