...
Inserts copies of elements from the range rg before [`end()`](end.html "cpp/container/list/end"), in non-reversing order. 
...
Run this code
    ...
    int main()
    {
        auto head = [std::list](../list.html){1, 2, 3, 4};
        const auto tail = [std::vector](../vector.html){-5, -6, -7};
    #ifdef __cpp_lib_containers_ranges
        head.append_range(tail);
    #else
        head.insert(head.end(), tail.cbegin(), tail.cend());
    #endif
        [assert](../../error/assert.html)((head == [std::list](../list.html){1, 2, 3, 4, -5, -6, -7}));
    }
