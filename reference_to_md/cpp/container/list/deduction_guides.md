...
-> list<typename [std::iterator_traits](../../iterator/iterator_traits.html)<InputIt>::value_type, Alloc>; |  (1)  |  (since C++17)  
...
list( [std::from_range_t](../../ranges/from_range.html), R&&, Alloc = Alloc() )  
-> list<[ranges::range_value_t](../../ranges/range_size_t.html)<R>, Alloc>; |  (2)  |  (since C++23)  
| |   
  
1) This [deduction guide](../../language/ctad.html "cpp/language/class template argument deduction") is provided for list to allow deduction from an iterator range. This overload participates in overload resolution only if `InputIt` satisfies [LegacyInputIterator](../../named_req/InputIterator.html "cpp/named req/InputIterator") and `Alloc` satisfies [Allocator](../../named_req/Allocator.html "cpp/named req/Allocator").

2) This deduction guide is provided for list to allow deduction from a [`std::from_range_t`](../../ranges/from_range.html "cpp/ranges/from range") tag and an [`input_range`](../../ranges/input_range.html "cpp/ranges/input range").
...
Run this code
    ...
     
        ...
        [std::list](../list.html) x(v.begin(), v.end());
     
        ...
        [std::list](../list.html) y{v.begin(), v.end()};
    }
