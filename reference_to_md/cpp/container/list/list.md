...
[erase(std::list)erase_if(std::list)](erase2.html "cpp/container/list/erase2")(C++20)(C++20)  
...
list( [std::from_range_t](../../ranges/from_range.html), R&& rg,  
...
(until C++23)  
list( list&& other, const [std::type_identity_t](../../types/type_identity.html)<Allocator>& alloc ); |  | (since C++23)   
(constexpr since C++26)  
list( [std::initializer_list](../../utility/initializer_list.html)<T> init,  
...
If `T` is not [DefaultInsertable](../../named_req/DefaultInsertable.html "cpp/named req/DefaultInsertable") into `list`, the behavior is undefined.

4) Constructs a `list` with count copies of elements with value value.  If `T` is not [CopyInsertable](../../named_req/CopyInsertable.html "cpp/named req/CopyInsertable") into `list`, the behavior is undefined.  | (since C++11)  
---|---  
  
5) Constructs a `list` with the contents of the range `[`first`, `last`)`. Each iterator in `[`first`, `last`)` is dereferenced exactly once.  If `InputIt` does not satisfy the requirements of [LegacyInputIterator](../../named_req/InputIterator.html "cpp/named req/InputIterator"), overload (4) is called instead with arguments static_cast<size_type>(first), last and alloc.  | (until C++11)  
---|---  
This overload participates in overload resolution only if `InputIt` satisfies the requirements of [LegacyInputIterator](../../named_req/InputIterator.html "cpp/named req/InputIterator"). If `T` is not [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `list` from *first, the behavior is undefined.  | (since C++11)  
  
6) Constructs a `list` with the contents of the range rg. Each iterator in rg is dereferenced exactly once.

If `T` is not [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `list` from *[ranges::begin](../../ranges/begin.html)(rg), the behavior is undefined.

7) The copy constructor. Constructs a `list` with the contents of other.  The allocator is obtained as if by calling [std::allocator_traits](../../memory/allocator_traits.html)<Allocator>::select_on_container_copy_construction  
...
If `T` is not [CopyInsertable](../../named_req/CopyInsertable.html "cpp/named req/CopyInsertable") into `list`, the behavior is undefined.

10) Same as the move constructor, except that alloc is used as the allocator.

If `T` is not [MoveInsertable](../../named_req/MoveInsertable.html "cpp/named req/MoveInsertable") into `list`, the behavior is undefined.

11) Equivalent to list(il.begin(), il.end(), alloc).

## Contents

  * [1 Parameters](list.html#Parameters)
  * [2 Complexity](list.html#Complexity)
  * [3 Exceptions](list.html#Exceptions)
  * [4 Notes](list.html#Notes)
  * [5 Example](list.html#Example)
  * [6 Defect reports](list.html#Defect_reports)
  * [7 See also](list.html#See_also)
...
Run this code
    ...
     
    template<typename T>
    [std::ostream](../../io/basic_ostream.html)& operator<<([std::ostream](../../io/basic_ostream.html)& s, const [std::list](../list.html)<T>& v)
    {
        s.put('{');
    ...
    int main()
    {
        ...
        [std::list](../list.html)<[std::string](../../string/basic_string.html)> words1{"the", "frogurt", "is", "also", "cursed"};
        [std::cout](../../io/cout.html) << "1: " << words1;
     
        // words2 == words1
        [std::list](../list.html)<[std::string](../../string/basic_string.html)> words2(words1.begin(), words1.end());
        [std::cout](../../io/cout.html) << "2: " << words2;
     
        // words3 == words1
        [std::list](../list.html)<[std::string](../../string/basic_string.html)> words3(words1);
        [std::cout](../../io/cout.html) << "3: " << words3;
     
        // words4 is {"Mo", "Mo", "Mo", "Mo", "Mo"}
        [std::list](../list.html)<[std::string](../../string/basic_string.html)> words4(5, "Mo");
        [std::cout](../../io/cout.html) << "4: " << words4;
     
        const auto rg = {"cat", "cow", "crow"};
    #ifdef __cpp_lib_containers_ranges
        [std::list](../list.html)<[std::string](../../string/basic_string.html)> words5([std::from_range](../../ranges/from_range.html), rg); // overload (6)
    #else
        [std::list](../list.html)<[std::string](../../string/basic_string.html)> words5(rg.begin(), rg.end()); // overload (5)
    #endif
...
---|---|---|---  
[LWG 438](https://cplusplus.github.io/LWG/issue438) | C++98  | overload ([5](list.html#Version_5)) would only call overload ([4](list.html#Version_4))  
if `InputIt` is an integral type  | calls overload ([4](list.html#Version_4)) if `InputIt`  
...
[LWG 2210](https://cplusplus.github.io/LWG/issue2210) | C++11  | overload ([3](list.html#Version_3)) did not have an allocator parameter  | added the parameter   
[N3346](https://wg21.link/N3346) | C++11  | for overload ([3](list.html#Version_3)), the elements in  
the container were value-initialized  | they are default-inserted   
  
### See also

[ assign](assign.html "cpp/container/list/assign") |  assigns values to the container   
