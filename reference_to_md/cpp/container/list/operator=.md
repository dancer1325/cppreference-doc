...
list& operator=( const list& other ); |  (1) | (constexpr since C++26)  
---|---|---  
| (2) |   
list& operator=( list&& other ); |  | (since C++11)   
(until C++17)  
list& operator=( list&& other )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
list& operator=( [std::initializer_list](../../utility/initializer_list.html)<value_type> ilist ); |  (3) | (since C++11)   
(constexpr since C++26)  
| |   
...
The following code uses operator= to assign one [std::list](../list.html "cpp/container/list") to another:
...
Run this code
    ...
    int main()
    {
        [std::list](../list.html)<int> x{1, 2, 3}, y, z;
...
[ (constructor)](list.html "cpp/container/list/list") |  constructs the `list`   
