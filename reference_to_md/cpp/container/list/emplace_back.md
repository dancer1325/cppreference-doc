...
The following code uses `emplace_back` to append an object of type `President` to a [std::list](../list.html "cpp/container/list"). It demonstrates how `emplace_back` forwards parameters to the `President` constructor and shows how using `emplace_back` avoids the extra copy or move operation required when using [push_back](push_back.html "cpp/container/list/push back").
...
Run this code
    ...
    int main()
    {
        [std::list](../list.html)<President> elections;
    ...
     
        [std::list](../list.html)<President> reElections;
