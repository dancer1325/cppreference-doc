...
All iterators (including the [`end()`](end.html "cpp/container/list/end") iterator) and all references to the elements are invalidated. 
...
Run this code
    ...
    int main()
    {
        const auto source = [std::vector](../vector.html){2, 7, 1};
        auto destination = [std::list](../list.html){3, 1, 4};
