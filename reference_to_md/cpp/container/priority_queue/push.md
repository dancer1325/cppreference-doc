...
1) Equivalent to: c.push_back(value); [std::push_heap](../../algorithm/push_heap.html)(c.begin(), c.end(), comp);.

2) Equivalent to: c.push_back(std::move(value)); [std::push_heap](../../algorithm/push_heap.html)(c.begin(), c.end(), comp);.
