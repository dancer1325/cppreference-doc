...
Checks if the underlying container has no elements. Equivalent to: return` `[`c`](../priority_queue.html#Member_objects "cpp/container/priority queue").empty(). 
...
[ size](size.html "cpp/container/priority queue/size") |  returns the number of elements   
