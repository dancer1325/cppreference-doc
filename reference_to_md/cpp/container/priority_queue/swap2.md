...
void swap( [std::priority_queue](../priority_queue.html)<T, Container, Compare>& lhs,  
[std::priority_queue](../priority_queue.html)<T, Container, Compare>& rhs ); |  |  (since C++11)   
(until C++17)  
template< class T, class Container, class Compare >  
void swap( [std::priority_queue](../priority_queue.html)<T, Container, Compare>& lhs,  
[std::priority_queue](../priority_queue.html)<T, Container, Compare>& rhs )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
| |   
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::priority_queue](../priority_queue.html "cpp/container/priority queue"). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). This overload participates in overload resolution only if [std::is_swappable_v](../../types/is_swappable.html)<Container> and [std::is_swappable_v](../../types/is_swappable.html)<Compare> are both true.  | (since C++17)  
---|---  
...
## Contents
  ...
  * [6 See also](swap2.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::priority_queue](../priority_queue.html)<int> alice;
        [std::priority_queue](../priority_queue.html)<int> bob;
     
        auto print = [](const auto& title, const auto& cont)
        {
            [std::cout](../../io/cout.html) << title << " size=" << cont.size();
            [std::cout](../../io/cout.html) << " top=" << cont.top() << '\n';
        };
     
        for (int i = 1; i < 4; ++i)
            alice.push(i);
...
[ swap](swap.html "cpp/container/priority queue/swap")(C++11) |  swaps the contents   
