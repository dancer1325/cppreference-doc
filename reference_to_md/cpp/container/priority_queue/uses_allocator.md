...
struct uses_allocator<[std::priority_queue](../priority_queue.html)<T, Compare, Container>, Alloc>  
: [std::uses_allocator](../../memory/uses_allocator.html)<Container, Alloc>::type {}; |  |  (since C++11)  
| |   
  
Provides a transparent specialization of the [std::uses_allocator](../../memory/uses_allocator.html "cpp/memory/uses allocator") type trait for [std::priority_queue](../priority_queue.html): the container adaptor uses allocator if and only if the underlying container does. 
...
Run this code
    ...
     
    static_assert(
        [std::uses_allocator](../../memory/uses_allocator.html)<[std::priority_queue](../priority_queue.html)<int>, void>::value == false &&
        [std::uses_allocator](../../memory/uses_allocator.html)<[std::priority_queue](../priority_queue.html)<int>, [std::allocator](../../memory/allocator.html)<int>>::value == true
    );
     
    int main() {}
