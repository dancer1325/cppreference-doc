[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/formatter_ad&action=edit)
...
---|---|---  
template< class CharT, class T, [std::formattable](../../utility/format/formattable.html)<CharT> Container, class... U >  
struct formatter<[std::priority_queue](../priority_queue.html)<T, Container, U...>, CharT>; |  |  (since C++23)  
| |   
  
The template specialization of [std::formatter](../../utility/format/formatter.html "cpp/utility/format/formatter") for the container adaptor type [std::priority_queue](../priority_queue.html "cpp/container/priority queue") allows users to convert the underlying container to its textual representation as a collection of elements using [formatting functions](../../utility/format.html "cpp/utility/format"). 

The specialization is enabled if [std::formattable](../../utility/format/formattable.html)<Container, CharT> is true. 

## Contents

  * [1 Member types](formatter.html#Member_types)
  * [2 Data members](formatter.html#Data_members)
  * [3 Member functions](formatter.html#Member_functions)
  * [4 std::formatter<std::priority_queue>::parse](formatter.html#std::formatter.3Cstd::priority_queue.3E::parse)
    * [4.1 Return value](formatter.html#Return_value)
  * [5 std::formatter<std::priority_queue>::format](formatter.html#std::formatter.3Cstd::priority_queue.3E::format)
    * [5.1 Return value](formatter.html#Return_value_2)
...
Name  |  Definition   
---|---  
`_maybe-const-container﻿_` |  `_fmt-maybe-const_` ﻿<Container, CharT>  
(exposition-only member type*)  
`_maybe-const-adaptor_` |  [`_maybe-const_`](../../ranges.html#Version_maybe-const "cpp/ranges") ﻿<  
` `[std::is_const_v](../../types/is_const.html)<`_maybe-const-container_` >,  
...
Equivalent to return` `` _[underlying_](formatter.html#underlying)_` ﻿.parse(ctx);. 
...
Equivalent to return` `` _[underlying_](formatter.html#underlying)_` ﻿.format(r.c, ctx);. 
