...
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/array/example_empty&action=edit)

The following code uses `empty` to check if a [std::array](../array.html "cpp/container/array") contains any elements:
...
Run this code
    ...
    int main()
    {
        [std::array](../array.html)<int, 4> numbers{3, 1, 4, 1};
        [std::array](../array.html)<int, 0> no_numbers;
     
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html);
        [std::cout](../../io/cout.html) << "numbers.empty(): " << numbers.empty() << '\n';
        [std::cout](../../io/cout.html) << "no_numbers.empty(): " << no_numbers.empty() << '\n';
    }
