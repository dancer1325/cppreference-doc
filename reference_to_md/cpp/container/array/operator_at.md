...
reference operator[]( size_type pos ); |  (1) | (since C++11)   
(constexpr since C++17)  
---|---|---  
const_reference operator[]( size_type pos ) const; |  (2) | (since C++11)   
...
The following code uses operator[] to read from and write to a [std::array](../array.html)<int, N>:
...
Run this code
    ...
    int main()
    {
        [std::array](../array.html)<int, 4> numbers{2, 4, 6, 8};
     
