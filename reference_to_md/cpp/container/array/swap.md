...
---|---  
[`noexcept`](../../language/noexcept_spec.html "cpp/language/noexcept spec") specification: noexcept([std::is_nothrow_swappable_v](../../types/is_swappable.html)<T>) | (since C++17)  
...
Run this code
    ...
    int main()
    {
        [std::array](../array.html)<int, 3> a1{1, 2, 3}, a2{4, 5, 6};
     
        auto it1 = a1.begin();
        auto it2 = a2.begin();
        int& ref1 = a1[1];
