...
## Contents
  ...
  * [4 Example](fill.html#Example)
  * [5 See also](fill.html#See_also)
...
Run this code
    ...
    int main()
    {
        constexpr [std::size_t](../../types/size_t.html) xy = 4;
     
        using Cell = [std::array](../array.html)<unsigned char, 8>;
     
        [std::array](../array.html)<Cell, xy * xy> board;
     
        board.fill({0xE2, 0x96, 0x84, 0xE2, 0x96, 0x80, 0, 0}); // "▄▀";
     
        for ([std::size_t](../../types/size_t.html) count{}; Cell c : board)
            [std::cout](../../io/cout.html) << c.data() << ((++count % xy) ? "" : "\n");
    }
