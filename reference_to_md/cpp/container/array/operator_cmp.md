...
bool operator==( const [std::array](../array.html)<T, N>& lhs,  
const [std::array](../array.html)<T, N>& rhs ); |  (1) | (since C++11)   
(constexpr since C++20)  
template< class T, [std::size_t](../../types/size_t.html) N >  
bool operator!=( const [std::array](../array.html)<T, N>& lhs,  
const [std::array](../array.html)<T, N>& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
template< class T, [std::size_t](../../types/size_t.html) N >  
bool operator< ( const [std::array](../array.html)<T, N>& lhs,  
const [std::array](../array.html)<T, N>& rhs ); |  (3)  |  (since C++11)   
(until C++20)  
template< class T, [std::size_t](../../types/size_t.html) N >  
bool operator<=( const [std::array](../array.html)<T, N>& lhs,  
const [std::array](../array.html)<T, N>& rhs ); |  (4)  |  (since C++11)   
(until C++20)  
template< class T, [std::size_t](../../types/size_t.html) N >  
bool operator> ( const [std::array](../array.html)<T, N>& lhs,  
const [std::array](../array.html)<T, N>& rhs ); |  (5)  |  (since C++11)   
(until C++20)  
template< class T, [std::size_t](../../types/size_t.html) N >  
bool operator>=( const [std::array](../array.html)<T, N>& lhs,  
const [std::array](../array.html)<T, N>& rhs ); |  (6)  |  (since C++11)   
(until C++20)  
template< class T, [std::size_t](../../types/size_t.html) N >  
constexpr /* see below */  
operator<=>( const [std::array](../array.html)<T, N>& lhs,  
const [std::array](../array.html)<T, N>& rhs ); |  (7) | (since C++20)  
| |   
