...
array( T, U... ) -> array<T, 1 + sizeof...(U)>; |  |  (since C++17)  
| |   
  
One [deduction guide](../../language/ctad.html "cpp/language/class template argument deduction") is provided for [std::array](../array.html "cpp/container/array") to provide an equivalent of [std::experimental::make_array](../../experimental/make_array.html "cpp/experimental/make array") for construction of `std::array` from a [variadic parameter pack](../../language/parameter_pack.html "cpp/language/pack"). 
...
Run this code
    ...
    {
        const int x = 10;
        [std::array](../array.html) a{1, 2, 3, 5, x}; // OK, creates std::array<int, 5>
        [assert](../../error/assert.html)(a.back() == x);
     
    //  std::array b{1, 2u}; // Error, all arguments must have the same type
     
    //  std::array<short> c{3, 2, 1}; // Error, wrong number of template args
        [std::array](../array.html) c{[std::to_array](to_array.html)<short>({3, 2, 1})}; // C++20 facility
        [assert](../../error/assert.html)(std::[ranges::equal](../../algorithm/ranges/equal.html)(c, [std::array](../array.html){3, 2, 1}));
        static_assert([std::is_same_v](../../types/is_same.html)<short, decltype(c)::value_type>);
    }
