...
9) If nh is an empty [node handle](../node_handle.html "cpp/container/node handle"), does nothing. Otherwise, inserts the element owned by nh into the container and returns an iterator pointing at the inserted element. The behavior is undefined if nh is not empty and get_allocator() != nh.get_allocator().
...
---|---|---|---  
[LWG 2005](https://cplusplus.github.io/LWG/issue2005) | C++11  | overloads (3,6) would only participate in overload  
