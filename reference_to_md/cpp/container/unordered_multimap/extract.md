...
1-3) Average case O(1), worst case O([size()](size.html "cpp/container/unordered multimap/size")).
...
Run this code
    ...
    int main()
    {
        [std::unordered_multimap](../unordered_multimap.html)<int, char> cont{{1, 'a'}, {2, 'b'}, {3, 'c'}};
     
        print("Start:", cont);
     
...
[ merge](merge.html "cpp/container/unordered multimap/merge")(C++17) |  splices nodes from another container   
