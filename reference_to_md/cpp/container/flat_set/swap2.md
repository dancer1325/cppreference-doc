...
---|---|---  
void swap( [std::flat_set](../flat_set.html)& lhs, [std::flat_set](../flat_set.html)& rhs ) noexcept; |  | (since C++23)   
(constexpr since C++26)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for std::flat_set. Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). 
...
Run this code
    ...
    int main()
    {
        [std::flat_set](../flat_set.html)<int> alice{1, 2, 3};
        [std::flat_set](../flat_set.html)<int> bob{7, 8, 9, 10};
     
