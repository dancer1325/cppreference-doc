...
Run this code
    ...
    int main()
    {
        [std::flat_set](../flat_set.html)<int> set{3, 1, 4, 1, 5, 9, 2, 6, 5};
...
[ begincbegin](begin.html "cpp/container/flat set/begin") |  returns an iterator to the beginning   
