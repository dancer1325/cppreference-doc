...
flat_set& operator=( const flat_set& other ); |  (1)  |  (since C++23)   
(implicitly declared)  
---|---|---  
flat_set& operator=( flat_set&& other ); |  (2)  |  (since C++23)   
(implicitly declared)  
flat_set& operator=( [std::initializer_list](../../utility/initializer_list.html)<key_type> ilist ); |  (3)  |  (since C++23)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::flat_set](../flat_set.html)<int> x{1, 2, 3}, y, z;
...
[ (constructor)](flat_set.html "cpp/container/flat set/flat set") |  constructs the `flat_set`   
(public member function)   
---|---  
[ replace](replace.html "cpp/container/flat set/replace") |  replaces the underlying container   
(public member function) 
