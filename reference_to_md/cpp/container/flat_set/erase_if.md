...
class Pred >  
[std::flat_set](../flat_set.html)<Key, Compare, KeyContainer>::size_type  
erase_if( [std::flat_set](../flat_set.html)<Key, Compare, KeyContainer>& c,  
...
Run this code
    ...
    int main()
    {
        [std::flat_set](../flat_set.html) data{3, 3, 4, 5, 5, 6, 6, 7, 2, 1, 0};
        println("Original:\n", data);
     
