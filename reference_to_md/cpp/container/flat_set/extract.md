...
Extracts adapted container [`_c_`](../flat_set.html#Member_objects "cpp/container/flat set"). Equivalent to return std::move(c);. 
...
Run this code
    ...
    int main()
    {
        [std::flat_set](../flat_set.html)<int> set{1, 2, 3};
