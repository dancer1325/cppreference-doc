...
Run this code
    ...
    #include <flat_set>
     
    void print_info([std::string_view](../../string/basic_string_view.html) rem, const [std::flat_set](../flat_set.html)<int>& v)
    {
    ...
    int main()
    {
        [std::flat_set](../flat_set.html)<int> container{1, 2, 3};
