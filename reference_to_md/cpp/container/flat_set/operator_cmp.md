...
friend bool operator==( const [std::flat_set](../flat_set.html)& lhs,  
const [std::flat_set](../flat_set.html)& rhs ); |  (1)  |  (since C++23)  
---|---|---  
friend synth-three-way-result<value_type>  
operator<=>( const [std::flat_set](../flat_set.html)& lhs,  
const [std::flat_set](../flat_set.html)& rhs ); |  (2)  |  (since C++23)  
| |   
