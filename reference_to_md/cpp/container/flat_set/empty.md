...
The following code uses `empty` to check if a [std::flat_set](../flat_set.html)<int> contains any elements:
...
Run this code
    ...
    int main()
    {
        [std::flat_set](../flat_set.html)<int> numbers;
...
[ size](size.html "cpp/container/flat set/size") |  returns the number of elements   
