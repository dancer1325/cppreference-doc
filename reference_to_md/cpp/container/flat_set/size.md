...
Returns the number of elements in the container adaptor. Equivalent to: return` `[`c`](../flat_set.html#Member_objects "cpp/container/flat set").size(). 
...
Run this code
    ...
    int main()
    {
        [std::flat_set](../flat_set.html)<int> nums{4, 2, 4, 2};
...
[ empty](empty.html "cpp/container/flat set/empty") |  checks whether the container adaptor is empty   
...
[ max_size](max_size.html "cpp/container/flat set/max size") |  returns the maximum possible number of elements   
