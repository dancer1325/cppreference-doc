...
**flat_set::rbegin flat_set::crbegin**  
...
The [underlying iterator](../../iterator/reverse_iterator/base.html "cpp/iterator/reverse iterator/base") of the returned reverse iterator is the [end iterator](end.html "cpp/container/flat set/end"). Hence the returned iterator is invalidated if and when the end iterator is invalidated.
...
Run this code
    ...
    int main()
    {
        [std::flat_set](../flat_set.html)<unsigned> rep{1, 2, 3, 4, 1, 2, 3, 4};
     
...
[ rendcrend](rend.html "cpp/container/flat set/rend") |  returns a reverse iterator to the end   
