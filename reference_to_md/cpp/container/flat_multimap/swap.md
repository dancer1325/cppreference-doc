...
Exchanges the contents of the container adaptor with those of `other`. Effectively calls 
    ...
    [ranges::swap](http://en.cppreference.com/w/cpp/ranges-utility-placeholder/swap)(compare, other.compare);
    [ranges::swap](http://en.cppreference.com/w/cpp/ranges-utility-placeholder/swap)(c.keys, other.c.keys);
    [ranges::swap](http://en.cppreference.com/w/cpp/ranges-utility-placeholder/swap)(c.values, other.c.values);
...
[ std::swap(std::flat_multimap)](swap2.html "cpp/container/flat multimap/swap2")(C++23) |  specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm   
