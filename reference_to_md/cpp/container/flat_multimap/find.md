...
Run this code
    ...
     
        ...
        [std::flat_multimap](../flat_multimap.html)<FatKey, char, [std::less](../../utility/functional/less.html)<>> example2{{{1, {}}, 'a'}, {{2, {}}, 'b'}};
     
        LightKey lk = {2};
        if (auto search = example2.find(lk); search != example2.end())
            [std::cout](../../io/cout.html) << "Found " << search->first.x << ' ' << search->second << '\n';
        else
            [std::cout](../../io/cout.html) << "Not found\n";
     
