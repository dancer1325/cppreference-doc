...
**flat_multimap::rbegin flat_multimap::crbegin**  
...
The [underlying iterator](../../iterator/reverse_iterator/base.html "cpp/iterator/reverse iterator/base") of the returned reverse iterator is the [end iterator](end.html "cpp/container/flat multimap/end"). Hence the returned iterator is invalidated if and when the end iterator is invalidated.
...
Run this code
    ...
    int main()
    {
        [std::flat_multimap](../flat_multimap.html)<[std::string](../../string/basic_string.html), int> map
        {
            {"█", 1},
            {"▒", 5},
            {"░", 3},
    ...
     
        [std::cout](../../io/cout.html) << "Print out in reverse order using const reverse iterators:\n";
        [std::for_each](../../algorithm/for_each.html)(map.crbegin(), map.crend(),
            []([std::pair](../../utility/pair.html)<const [std::string](../../string/basic_string.html), int> const& e)
            {
...
[ rendcrend](rend.html "cpp/container/flat multimap/rend") |  returns a reverse iterator to the end   
