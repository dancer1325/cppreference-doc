[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/key_comp&action=edit)
...
## Contents
  ...
  * [1 Return value](key_comp.html#Return_value)
  * [2 Complexity](key_comp.html#Complexity)
  * [3 Example](key_comp.html#Example)
  * [4 See also](key_comp.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::flat_multimap](../flat_multimap.html)<int, char, ModCmp> cont;
    ...
     
            [std::cout](../../io/cout.html) << "Key (" << it.first << ',' << it.second << ") ";
            if (!before && !after)
                [std::cout](../../io/cout.html) << "equivalent to key (100)\n";
            else if (before)
                [std::cout](../../io/cout.html) << "goes before key (100)\n";
            else if (after)
                [std::cout](../../io/cout.html) << "goes after key (100)\n";
            else
                [std::unreachable](../../utility/unreachable.html)();
        }
    }
...
[ value_comp](value_comp.html "cpp/container/flat multimap/value comp") |  returns the function that compares keys in objects of type `value_type`   
