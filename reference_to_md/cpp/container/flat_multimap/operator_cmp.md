[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container_adaptor/operator_cmp&action=edit)
...
friend bool operator==( const [std::flat_multimap](../flat_multimap.html)& lhs,  
const [std::flat_multimap](../flat_multimap.html)& rhs ); |  (1)  |  (since C++23)  
---|---|---  
friend synth-three-way-result<value_type>  
operator<=>( const [std::flat_multimap](../flat_multimap.html)& lhs,  
const [std::flat_multimap](../flat_multimap.html)& rhs ); |  (2)  |  (since C++23)  
| |   
...
Reason: For "flat" containers only: copy parts of [Template:cpp/container/operator_cmp](https://en.cppreference.com/w/Template:cpp/container/operator_cmp "Template:cpp/container/operator cmp")  
---|---  
