[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/keys&action=edit)
...
## Contents
  ...
  * [1 Parameters](keys.html#Parameters)
  * [2 Return value](keys.html#Return_value)
  * [3 Complexity](keys.html#Complexity)
  * [4 Example](keys.html#Example)
  * [5 See also](keys.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::flat_multimap](../flat_multimap.html)<int, double> adaptor{{1, 1.1}, {2, 2.2}, {3, 3.3}};
     
        // The default keys container is std::vector:
        static_assert([std::is_same_v](../../types/is_same.html)<decltype(adaptor.keys()), const [std::vector](../vector.html)<int>&>);
     
        [std::println](../../io/println.html)("{}", adaptor.keys());
    }
...
[ values](values.html "cpp/container/flat multimap/values") |  direct access to the underlying values container   
