...
struct uses_allocator<[std::flat_multimap](../flat_multimap.html)<Key, T, Compare,  
...
Provides a transparent specialization of the [std::uses_allocator](../../memory/uses_allocator.html "cpp/memory/uses allocator") type trait for [std::flat_multimap](../flat_multimap.html): the container adaptor uses allocator if and only if the underlying container does. 
...
Run this code
    ...
     
    static_assert(
        [std::uses_allocator](../../memory/uses_allocator.html)<[std::flat_multimap](../flat_multimap.html)<int, int>, void>::value == false &&
        [std::uses_allocator](../../memory/uses_allocator.html)<[std::flat_multimap](../flat_multimap.html)<int, int>, [std::allocator](../../memory/allocator.html)<int>>::value == true
    );
     
    int main() {}
