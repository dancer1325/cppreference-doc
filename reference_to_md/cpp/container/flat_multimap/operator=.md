[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/operator%3D_ad&action=edit)
...
flat_multimap& operator=( const flat_multimap& other ); |  (1)  |  (since C++23)   
(implicitly declared)  
---|---|---  
flat_multimap& operator=( flat_multimap&& other ); |  (2)  |  (since C++23)   
(implicitly declared)  
flat_multimap& operator=( [std::initializer_list](../../utility/initializer_list.html)<value_type> ilist ); |  (3)  |  (since C++23)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::flat_multimap](../flat_multimap.html)<int, int> x{{1, 1}, {2, 2}, {3, 3}}, y, z;
    ...
     
        ...
        [std::println](../../io/println.html)("Move assignment moves data from x to z, modifying both x and z:");
        [std::println](../../io/println.html)("x = {}", x);
        [std::println](../../io/println.html)("z = {}", z);
     
        z = w; // overload (3)
        [std::println](../../io/println.html)("Assignment of initializer_list w to z:");
...
[ (constructor)](flat_multimap.html "cpp/container/flat multimap/flat multimap") |  constructs the `flat_multimap`   
...
---|---  
[ replace](replace.html "cpp/container/flat multimap/replace") |  replaces the underlying containers   
