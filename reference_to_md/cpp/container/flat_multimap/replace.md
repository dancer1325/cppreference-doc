[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/replace_ad&action=edit)
...
Replaces the underlying containers [`_c_`](../flat_multimap.html#Member_objects "cpp/container/flat multimap"). Equivalent to: 
...
The following conditions must be met: 
  ...
  * The elements of key_cont are sorted with respect to [`_compare_`](../flat_multimap.html#Member_objects "cpp/container/flat multimap").
...
## Contents
  ...
  * [5 See also](replace.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<int> keys{1, 2, 3};
        [assert](../../error/assert.html)(std::[ranges::is_sorted](../../algorithm/ranges/is_sorted.html)(keys));
        [std::vector](../vector.html)<double> values{2.2, 3.3, 1.1};
        [assert](../../error/assert.html)(keys.size() == values.size());
     
        [std::flat_multimap](../flat_multimap.html)<int, double> map;
        [assert](../../error/assert.html)(map.empty());
     
        map.replace(keys, values);
        [assert](../../error/assert.html)(map.size() == 3);
        [assert](../../error/assert.html)(map.keys() == 3);
        [assert](../../error/assert.html)(map.values() == 3);
        [assert](../../error/assert.html)(keys.empty());
        [assert](../../error/assert.html)(values.empty());
     
        [std::println](../../io/println.html)("{}", map);
    }
...
[ extract](extract.html "cpp/container/flat multimap/extract") |  extracts the underlying containers   
