...
**flat_multimap::rend flat_multimap::crend**  
...
Run this code
    ...
    int main()
    {
        const [std::flat_multimap](../flat_multimap.html)<year_month_day, int> messages
        {
            {February/17/2023, 10},
            {February/17/2023, 20},
            {February/16/2022, 30},
    ...
     
        [std::cout](../../io/cout.html) << "Messages received (date order is reversed):\n";
...
[ rbegincrbegin](rbegin.html "cpp/container/flat multimap/rbegin") |  returns a reverse iterator to the beginning   
