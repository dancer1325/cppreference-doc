[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/max_size_ad&action=edit)
...
Returns the maximum number of elements the container is able to hold due to system or library implementation limitations. Equivalent to [std::min](../../algorithm/min.html)<size_type>(c.keys.max_size(), c.values.max_size()). 
...
Run this code
    ...
    int main()
    {
        [std::flat_multimap](../flat_multimap.html)<char, char> q;
        [std::cout](../../io/cout.html).imbue([std::locale](../../locale/locale.html)("en_US.UTF-8"));
        [std::cout](../../io/cout.html) << "Maximum size of a std::flat_multimap is " << q.max_size() << '\n';
    }
