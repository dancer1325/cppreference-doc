[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/value_compare_flat&action=edit)
...
`std::flat_multimap::value_compare` is a function object that compares objects of type [`std::flat_multimap::const_reference`](../flat_multimap.html#Member_types "cpp/container/flat multimap") (a pair of references to the stored key/value) by comparing the first components (i.e. keys) of the passed pairs. 

## Contents

  * [1 Member objects](value_compare.html#Member_objects)
  * [2 Member functions](value_compare.html#Member_functions)
  * [3 std::flat_multimap<Key,T,Compare,KeyContainer,MappedContainer>::value_compare::value_compare](value_compare.html#std::flat_multimap.3CKey.2CT.2CCompare.2CKeyContainer.2CMappedContainer.3E::value_compare::value_compare)
    * [3.1 Parameters](value_compare.html#Parameters)
  * [4 std::flat_multimap<Key,T,Compare,KeyContainer,MappedContainer>::value_compare::operator()](value_compare.html#std::flat_multimap.3CKey.2CT.2CCompare.2CKeyContainer.2CMappedContainer.3E::value_compare::operator.28.29)
    * [4.1 Parameters](value_compare.html#Parameters_2)
    * [4.2 Return value](value_compare.html#Return_value)
    * [4.3 Exceptions](value_compare.html#Exceptions)
...
---|---  
`_comp_` (private) |  the comparison function object of type [`std::flat_multimap::key_compare`](../flat_multimap.html#Member_types "cpp/container/flat multimap")  
...
private:  
value_compare( key_compare c ); |  |  (exposition only*)  
---|---|---  
| |   
