...
Run this code
    ...
    int main()
    {
        [std::flat_multimap](../flat_multimap.html)<int, [std::string](../../string/basic_string.html)> c =
        {
            {1, "one"}, {2, "two"}, {3, "three"},
            {4, "four"}, {5, "five"}, {6, "six"}
        };
...
[ clear](clear.html "cpp/container/flat multimap/clear") |  clears the contents   
