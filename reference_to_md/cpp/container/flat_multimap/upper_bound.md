[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/upper_bound&action=edit)
...
(constexpr since C++26)  
template< class K >  
iterator upper_bound( const K& x ); |  (3) | (since C++23)   
(constexpr since C++26)  
template< class K >  
const_iterator upper_bound( const K& x ) const; |  (4) | (since C++23)   
(constexpr since C++26)  
| |   
...
## Contents
  ...
  * [4 Example](upper_bound.html#Example)
  * [5 See also](upper_bound.html#See_also)
