...
[std::flat_multimap](../flat_multimap.html)<Key, T, Compare,  
KeyContainer, MappedContainer>::size_type  
erase_if( [std::flat_multimap](../flat_multimap.html)<Key, T, Compare,  
KeyContainer, MappedContainer>& c,  
Pred pred ); |  | (since C++23)   
(constexpr since C++26)  
| |   
  
Erases all elements that satisfy the predicate pred from c. 

The predicate pred is satisfied if the expression bool(pred([std::pair](../../utility/pair.html)<const Key&, const T&>(e))) is true, where e is some element in c. 

If `Key` or `T` is not [MoveAssignable](../../named_req/MoveAssignable.html "cpp/named req/MoveAssignable"), the behavior is undefined. 
...
## Contents
  ...
  * [4 Exceptions](erase_if.html#Exceptions)
  * [5 Notes](erase_if.html#Notes)
  * [6 Example](erase_if.html#Example)
  * [7 See also](erase_if.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::flat_multimap](../flat_multimap.html)<int, char> data
        {
            {1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'},
            {5, 'e'}, {4, 'f'}, {5, 'g'}, {5, 'g'},
        };
