[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/extract_ad&action=edit)
...
Extracts adapted containers [`_c_`](../flat_multimap.html#Member_objects "cpp/container/flat multimap"). Equivalent to return std::move(c);. 

After this operation *this is empty, even if an exception is thrown. 

## Contents

  * [1 Return value](extract.html#Return_value)
  * [2 Complexity](extract.html#Complexity)
  * [3 Example](extract.html#Example)
  * [4 See also](extract.html#See_also)
...
Run this code
    ...
     
        ...
        [assert](../../error/assert.html)(c.keys.size() == size);
        [assert](../../error/assert.html)(c.values.size() == size);
        [assert](../../error/assert.html)(map.empty());
        [assert](../../error/assert.html)(map.keys().empty());
        [assert](../../error/assert.html)(map.values().empty());
     
        // The default keys and values containers are std::vector:
        static_assert([std::is_same_v](../../types/is_same.html)<decltype(c.keys), [std::vector](../vector.html)<int>>);
        static_assert([std::is_same_v](../../types/is_same.html)<decltype(c.values), [std::vector](../vector.html)<double>>);
     
        [std::println](../../io/println.html)("keys: {}", c.keys);
        [std::println](../../io/println.html)("values: {}", c.values);
    }
