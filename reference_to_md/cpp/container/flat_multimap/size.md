...
Returns the number of elements in the container adaptor. Equivalent to: return` `[` _c_`](../flat_multimap.html#Member_objects "cpp/container/flat multimap").keys.size(). 
...
Run this code
    ...
    int main()
    {
        [std::flat_multimap](../flat_multimap.html)<int, char> nums{{1, 'a'}, {1, 'b'}, {2, 'c'}, {2, 'd'}};
        [assert](../../error/assert.html)(nums.size() == 4); 
    }

### See also

[ empty](empty.html "cpp/container/flat multimap/empty") |  checks whether the container adaptor is empty   
(public member function)   
---|---  
[ sizessize](../../iterator/size.html "cpp/iterator/size")(C++17)(C++20) |  returns the size of a container or array   
(function template)   
[ max_size](max_size.html "cpp/container/flat multimap/max size") |  returns the maximum possible number of elements   
(public member function) 
