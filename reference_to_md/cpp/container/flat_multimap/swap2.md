...
---|---|---  
void swap( [std::flat_multimap](../flat_multimap.html)& lhs, [std::flat_multimap](../flat_multimap.html)& rhs ) noexcept; |  | (since C++23)   
(constexpr since C++26)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for std::flat_multimap. Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). 

## Contents

  * [1 Parameters](swap2.html#Parameters)
  * [2 Complexity](swap2.html#Complexity)
  * [3 Example](swap2.html#Example)
  * [4 See also](swap2.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::flat_multimap](../flat_multimap.html)<int, char> alice{{1, 'a'}, {2, 'b'}, {3, 'c'}};
        [std::flat_multimap](../flat_multimap.html)<int, char> bob{{7, 'Z'}, {8, 'Y'}, {9, 'X'}, {10, 'W'}};
     
