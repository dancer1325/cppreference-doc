...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<[std::string](../../string/basic_string.html)> v1{"1","2","3","4"},
                                 v2{"Ɐ","B","Ɔ","D","Ǝ"};
     
        [std::queue](../queue.html) s1(std::move(v1));
        [std::queue](../queue.html) s2(std::move(v2));
     
        print("s1", s1);
        print("s2", s2);
     
...
[ std::swap(std::queue)](swap2.html "cpp/container/queue/swap2")(C++11) |  specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm   
