...
Returns reference to the first element in the queue. This element will be the first element to be removed on a call to [pop()](pop.html "cpp/container/queue/pop"). Effectively calls c.front(). 
