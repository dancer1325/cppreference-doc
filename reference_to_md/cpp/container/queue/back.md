...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/queue/back&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/queue/back&action=edit&section=2 "Edit section: Return value")] Return value

Reference to the last element. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/queue/back&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/queue/back&action=edit&section=4 "Edit section: See also")] See also

[ front](front.html "cpp/container/queue/front") |  access the first element   
