...
struct formatter<[std::queue](../queue.html)<T, Container, U...>, CharT>; |  |  (since C++23)  
| |   
  
The template specialization of [std::formatter](../../utility/format/formatter.html "cpp/utility/format/formatter") for the container adaptor type [std::queue](../queue.html "cpp/container/queue") allows users to convert the underlying container to its textual representation as a collection of elements using [formatting functions](../../utility/format.html "cpp/utility/format"). 
...
## Contents
  ...
  * [4 std::formatter<std::queue>::parse](formatter.html#std::formatter.3Cstd::queue.3E::parse)
    * [4.1 Return value](formatter.html#Return_value)
  * [5 std::formatter<std::queue>::format](formatter.html#std::formatter.3Cstd::queue.3E::format)
...
` `[std::queue](../queue.html)<T, Container, U...>>  
(exposition-only member type*)  
