...
Checks if the underlying container has no elements. Equivalent to: return` `[`c`](../queue.html#Member_objects "cpp/container/queue").empty(). 
...
Run this code
    ...
    int main()
    {
        [std::queue](../queue.html)<int> queue;
        [assert](../../error/assert.html)(queue.empty());
     
        queue.push(42);
        [assert](../../error/assert.html)(!queue.empty());
     
...
[ size](size.html "cpp/container/queue/size") |  returns the number of elements   
