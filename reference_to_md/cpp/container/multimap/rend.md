...
**multimap::rend multimap::crend**(C++11)  
...
Run this code
    ...
    int main()
    {
        const [std::multimap](../multimap.html)<year_month_day, int> messages
        {
            {February/17/2023, 10},
            {February/17/2023, 20},
            {February/16/2022, 30},
...
[ rbegincrbegin](rbegin.html "cpp/container/multimap/rbegin")(C++11) |  returns a reverse iterator to the beginning   
