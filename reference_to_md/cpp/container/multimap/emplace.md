...
If `value_type` is not [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `multimap` from args, the behavior is undefined. 
...
Run this code
    ...
    int main()
    {
        [std::multimap](../multimap.html)<[std::string](../../string/basic_string.html), [std::string](../../string/basic_string.html)> m;
     
