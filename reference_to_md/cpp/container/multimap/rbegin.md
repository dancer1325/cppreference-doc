...
**multimap::rbegin multimap::crbegin**(C++11)` `  
...
If *this is empty, the returned iterator is equal to [rend()](rend.html "cpp/container/multimap/rend"). 
...
The [underlying iterator](../../iterator/reverse_iterator/base.html "cpp/iterator/reverse iterator/base") of the returned reverse iterator is the [end iterator](end.html "cpp/container/multimap/end"). Hence the returned iterator is invalidated if and when the end iterator is invalidated.
...
Run this code
    ...
    int main()
    {
        [std::multimap](../multimap.html)<[std::string](../../string/basic_string.html), int> map
        {
            {"█", 1},
            {"▒", 5},
            {"░", 3},
...
[ rendcrend](rend.html "cpp/container/multimap/rend")(C++11) |  returns a reverse iterator to the end   
