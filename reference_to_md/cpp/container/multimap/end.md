...
**multimap::end multimap::cend**(C++11)  
...
Run this code
    ...
    int main()
    {
        ...
        {
            [std::cout](../../io/cout.html) << "{ " << node.first << ", " << node.second << " }" << ending;
        };
     
        [std::multimap](../multimap.html)<[std::size_t](../../types/size_t.html), [std::string](../../string/basic_string.html)> mmap;
        [assert](../../error/assert.html)(mmap.begin() == mmap.end());   // OK
        [assert](../../error/assert.html)(mmap.cbegin() == mmap.cend()); // OK
     
    ...
     
        [std::cout](../../io/cout.html) << "mmap = { ";
        [std::for_each](../../algorithm/for_each.html)(mmap.cbegin(), mmap.cend(), [&](const auto& n) { show_node(n, ' '); });
...
[ begincbegin](begin.html "cpp/container/multimap/begin")(C++11) |  returns an iterator to the beginning   
