...
If any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * `value_type` is not [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `multimap` from *[ranges::begin](../../ranges/begin.html)(rg)
  * rg and *this overlap. 
...
Run this code
    ...
    int main()
    {
        auto container = [std::multimap](../multimap.html){[std::pair](../../utility/pair.html){1, 11}, {3, 33}, {2, 22}, {4, 44}};
