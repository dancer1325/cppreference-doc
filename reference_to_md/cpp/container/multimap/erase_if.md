...
class Pred >  
[std::multimap](../multimap.html)<Key, T, Compare, Alloc>::size_type  
erase_if( [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& c,  
...
Run this code
    ...
    int main()
    {
        [std::multimap](../multimap.html)<int, char> data
        {
            {1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'},
            {5, 'e'}, {4, 'f'}, {5, 'g'}, {5, 'g'},
        };
