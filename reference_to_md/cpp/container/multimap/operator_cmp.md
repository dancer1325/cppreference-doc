...
bool operator==( const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& lhs,  
const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& rhs ); |  (1) | (constexpr since C++26)  
template< class Key, class T, class Compare, class Alloc >  
bool operator!=( const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& lhs,  
const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& rhs ); |  (2)  |  (until C++20)  
template< class Key, class T, class Compare, class Alloc >  
bool operator< ( const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& lhs,  
const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& rhs ); |  (3)  |  (until C++20)  
template< class Key, class T, class Compare, class Alloc >  
bool operator<=( const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& lhs,  
const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& rhs ); |  (4)  |  (until C++20)  
template< class Key, class T, class Compare, class Alloc >  
bool operator> ( const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& lhs,  
const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& rhs ); |  (5)  |  (until C++20)  
template< class Key, class T, class Compare, class Alloc >  
bool operator>=( const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& lhs,  
const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& rhs ); |  (6)  |  (until C++20)  
template< class Key, class T, class Compare, class Alloc >  
/* see below */  
operator<=>( const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& lhs,  
const [std::multimap](../multimap.html)<Key, T, Compare, Alloc>& rhs ); |  (7) | (since C++20)   
...
Run this code
    ...
    int main()
    {
        [std::multimap](../multimap.html)<int, char> a{{1, 'a'}, {2, 'b'}, {3, 'c'}};
        [std::multimap](../multimap.html)<int, char> b{{1, 'a'}, {2, 'b'}, {3, 'c'}};
        [std::multimap](../multimap.html)<int, char> c{{7, 'Z'}, {8, 'Y'}, {9, 'X'}, {10, 'W'}};
     
