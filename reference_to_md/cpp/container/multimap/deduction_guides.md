[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/map_deduction_guides&action=edit)
...
class Comp = [std::less](../../utility/functional/less.html)</*iter-key-t*/<InputIt>>,  
class Alloc = [std::allocator](../../memory/allocator.html)</*iter-to-alloc-t*/<InputIt>> >  
multimap( InputIt, InputIt, Comp = Comp(), Alloc = Alloc() )  
-> multimap</*iter-key-t*/<InputIt>, /*iter-val-t*/<InputIt>, Comp, Alloc>; |  (1)  |  (since C++17)  
template< class Key,  
class T,  
class Comp = [std::less](../../utility/functional/less.html)<Key>,  
class Alloc = [std::allocator](../../memory/allocator.html)<[std::pair](../../utility/pair.html)<const Key, T>> >  
multimap( [std::initializer_list](../../utility/initializer_list.html)<[std::pair](../../utility/pair.html)<Key, T>>, Comp = Comp(), Alloc = Alloc() )  
-> multimap<Key, T, Comp, Alloc>; |  (2) | (since C++17)  
template< class InputIt, class Alloc >  
multimap( InputIt, InputIt, Alloc )  
-> multimap</*iter-key-t*/<InputIt>, /*iter-val-t*/<InputIt>,  
[std::less](../../utility/functional/less.html)</*iter-key-t*/<InputIt>>, Alloc>; |  (3)  |  (since C++17)  
template< class Key, class T, class Alloc >  
multimap( [std::initializer_list](../../utility/initializer_list.html)<[std::pair](../../utility/pair.html)<Key, T>>, Alloc )  
-> multimap<Key, T, [std::less](../../utility/functional/less.html)<Key>, Alloc>; |  (4)  |  (since C++17)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Compare = [std::less](../../utility/functional/less.html)</*range-key-t*/<R>,  
class Alloc = [std::allocator](../../memory/allocator.html)</*range-to-alloc-t*/<R>> >  
multimap( [std::from_range_t](../../ranges/from_range.html), R&&, Compare = Compare(), Alloc = Alloc() )  
-> multimap</*range-key-t*/<R>, range_mapped_t<R>, Compare, Alloc>; |  (5) | (since C++23)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Alloc >  
multimap( [std::from_range_t](../../ranges/from_range.html), R&&, Alloc )  
-> multimap</*range-key-t*/<R>, range_mapped_t<R>,  
multimap [std::less](../../utility/functional/less.html)</*range-key-t*/<R>>, Alloc>; |  (6)  |  (since C++23)  
...
1-4) These [deduction guides](../../language/ctad.html "cpp/language/class template argument deduction") are provided for `multimap` to allow deduction from an iterator range (overloads (1,3)) and [std::initializer_list](../../utility/initializer_list.html "cpp/utility/initializer list") (overloads (2,4)).

5,6) These deduction guides are provided for `multimap` to allow deduction from a [`std::from_range_t`](../../ranges/from_range.html "cpp/ranges/from range") tag and an [`input_range`](../../ranges/input_range.html "cpp/ranges/input range").
...
Run this code
    ...
     
        [std::multimap](../multimap.html) m1 = {[std::pair](../../utility/pair.html){"foo", 2}, {"bar", 3}}; // guide #2
        [std::multimap](../multimap.html) m2(m1.begin(), m1.end()); // guide #1
    }
...
---|---|---|---  
[LWG 3025](https://cplusplus.github.io/LWG/issue3025) | C++17  | initializer-list guides ([2,4](deduction_guides.html#Version_2)) take [std::pair](../../utility/pair.html)<const Key, T> | use [std::pair](../../utility/pair.html)<Key, T>
