...
template< class C2 >  
void merge( [std::map](../map.html)<Key, T, C2, Allocator>& source ); |  (1) | (since C++17)   
(constexpr since C++26)  
---|---|---  
template< class C2 >  
void merge( [std::map](../map.html)<Key, T, C2, Allocator>&& source ); |  (2) | (since C++17)   
(constexpr since C++26)  
template< class C2 >  
void merge( [std::multimap](../multimap.html)<Key, T, C2, Allocator>& source ); |  (3) | (since C++17)   
(constexpr since C++26)  
template< class C2 >  
void merge( [std::multimap](../multimap.html)<Key, T, C2, Allocator>&& source ); |  (4) | (since C++17)   
(constexpr since C++26)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::multimap](../multimap.html)<int, [std::string](../../string/basic_string.html)> ma{{1, "apple"}, {5, "pear"}, {10, "banana"}};
        [std::multimap](../multimap.html)<int, [std::string](../../string/basic_string.html)> mb{{2, "zorro"}, {4, "batman"}, {5, "X"}, {8, "alpaca"}};
        [std::multimap](../multimap.html)<int, [std::string](../../string/basic_string.html)> u;
        u.merge(ma);
        [std::cout](../../io/cout.html) << "ma.size(): " << ma.size() << '\n';
        u.merge(mb);
        [std::cout](../../io/cout.html) << "mb.size(): " << mb.size() << '\n';
     
        for (const auto& kv : u)
            [std::cout](../../io/cout.html) << kv.first << ", " << kv.second << '\n';
    }
...
[ extract](extract.html "cpp/container/multimap/extract")(C++17) |  extracts nodes from the container   
...
---|---  
[ insert](insert.html "cpp/container/multimap/insert") |  inserts elements or nodes(since C++17)   
