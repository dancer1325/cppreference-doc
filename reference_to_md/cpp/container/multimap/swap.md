...
All iterators and references remain valid. The [`end()`](end.html "cpp/container/multimap/end") iterator is invalidated. `Compare` must be [Swappable](../../named_req/Swappable.html "cpp/named req/Swappable"), and objects of this type are exchanged using unqualified call to non-member `swap`. 
...
Run this code
    ...
    int main()
    {
        [std::multimap](../multimap.html)<[std::string](../../string/basic_string.html), [std::string](../../string/basic_string.html)>
...
[ std::swap(std::multimap)](swap2.html "cpp/container/multimap/swap2") |  specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm   
