...
The returned value is valid only for instances of the container for which [bucket_count()](bucket_count.html "cpp/container/unordered set/bucket count") returns the same value (e.g., [rehash()](rehash.html "cpp/container/unordered set/rehash") invalidates previously obtained value). 

The behavior is undefined if [bucket_count()](bucket_count.html "cpp/container/unordered set/bucket count") is zero. 
