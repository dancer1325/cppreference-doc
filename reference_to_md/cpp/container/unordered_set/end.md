...
**unordered_set::end unordered_set::cend**  
...
Run this code
    ...
     
        ...
        [std::unordered_set](../unordered_set.html)<Point*> points = { pts, pts + 1, pts + 2 };
     
        ...
        for (auto iter = points.begin(); iter != points.end(); ++iter)
        {
            ...
            [std::cout](../../io/cout.html) << "(" << (*iter)->x << ", " << (*iter)->y << ") ";
        }
...
[ begincbegin](begin.html "cpp/container/unordered set/begin") |  returns an iterator to the beginning   
