...
[std::pair](../../utility/pair.html "cpp/utility/pair") containing a pair of iterators defining the wanted range. If there are no such elements, past-the-end (see [end()](end.html "cpp/container/unordered set/end")) iterators are returned as both elements of the pair. 
