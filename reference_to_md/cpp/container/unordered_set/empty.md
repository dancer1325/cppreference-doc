...
The following code uses `empty` to check if a [std::unordered_set](../unordered_set.html)<int> contains any elements:
...
Run this code
    ...
    int main()
    {
        [std::unordered_set](../unordered_set.html)<int> numbers;
