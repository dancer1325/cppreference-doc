...
void swap( [std::unordered_set](../unordered_set.html)<Key, Hash, KeyEqual, Alloc>& lhs,  
[std::unordered_set](../unordered_set.html)<Key, Hash, KeyEqual, Alloc>& rhs ); |  |  (since C++11)   
(until C++17)  
template< class Key, class Hash, class KeyEqual, class Alloc >  
void swap( [std::unordered_set](../unordered_set.html)<Key, Hash, KeyEqual, Alloc>& lhs,  
[std::unordered_set](../unordered_set.html)<Key, Hash, KeyEqual, Alloc>& rhs )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::unordered_set](../unordered_set.html "cpp/container/unordered set"). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). 
...
Run this code
    ...
    int main()
    {
        [std::unordered_set](../unordered_set.html)<int> alice{1, 2, 3};
        [std::unordered_set](../unordered_set.html)<int> bob{7, 8, 9, 10};
     
