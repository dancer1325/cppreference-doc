...
Run this code
    ...
    int main()
    {
        [std::unordered_set](../unordered_set.html)<char> p;
        [std::unordered_set](../unordered_set.html)<long> q;
     
...
[ size](size.html "cpp/container/unordered set/size") |  returns the number of elements   
