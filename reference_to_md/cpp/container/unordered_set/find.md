...
An iterator to the requested element. If no such element is found, past-the-end (see [end()](end.html "cpp/container/unordered set/end")) iterator is returned. 
...
Run this code
    ...
     
    inline void who(const [std::source_location](../../utility/source_location.html) sloc = std::source_location::current())
    {
        if (logger::enabled)
            [std::cout](../../io/cout.html) << sloc.function_name() << '\n';
    }
     
    struct string_hash // C++20's transparent hashing
    {
        using hash_type = [std::hash](../../utility/hash.html)<[std::string_view](../../string/basic_string_view.html)>;
        using is_transparent = void;
     
        [std::size_t](../../types/size_t.html) operator()(const char* str) const
        {
            who();
            return hash_type{}(str);
        }
        [std::size_t](../../types/size_t.html) operator()([std::string_view](../../string/basic_string_view.html) str) const
        {
            who();
            return hash_type{}(str);
        }
        [std::size_t](../../types/size_t.html) operator()(const [std::string](../../string/basic_string.html)& str) const
        {
            who();
            return hash_type{}(str);
        }
    ...
    int main()
    {
        [std::unordered_set](../unordered_set.html)<int> example{1, 2, -10};
     
        [std::cout](../../io/cout.html) << "Simple comparison demo:\n" << [std::boolalpha](../../io/manip/boolalpha.html);
        if (auto search = example.find(2); search != example.end())
            [std::cout](../../io/cout.html) << "Found " << *search << '\n';
        else
            [std::cout](../../io/cout.html) << "Not found\n";
     
        [std::unordered_set](../unordered_set.html)<[std::string](../../string/basic_string.html), string_hash, [std::equal_to](../../utility/functional/equal_to.html)<>> set{"one"s, "two"s};
     
        logger::enabled = true;
        [std::cout](../../io/cout.html) << "Heterogeneous lookup for unordered containers (transparent hashing):\n"
...
[ count](count.html "cpp/container/unordered set/count") |  returns the number of elements matching specific key   
