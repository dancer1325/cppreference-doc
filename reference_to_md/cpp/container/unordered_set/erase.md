...
The iterator pos must be dereferenceable. Thus the [end()](end.html "cpp/container/unordered set/end") iterator (which is valid, but is not dereferenceable) cannot be used as a value for pos. 
...
Run this code
    ...
    int main()
    {
        [std::unordered_set](../unordered_set.html)<int> c = {1, 2, 3, 4, 1, 2, 3, 4};
     
        auto print = [&c]
        {
...
[ clear](clear.html "cpp/container/unordered set/clear") |  clears the contents   
