...
Returns the average number of elements per bucket, that is, [size()](size.html "cpp/container/unordered set/size") divided by [bucket_count()](bucket_count.html "cpp/container/unordered set/bucket count"). 
...
[ max_load_factor](max_load_factor.html "cpp/container/unordered set/max load factor") |  manages maximum average number of elements per bucket   
