...
Erases all elements from the container. After this call, [size()](size.html "cpp/container/unordered set/size") returns zero. 
...
Run this code
    ...
     
    void print_info([std::string_view](../../string/basic_string_view.html) rem, const [std::unordered_set](../unordered_set.html)<int>& v)
    {
    ...
    int main()
    {
        [std::unordered_set](../unordered_set.html)<int> container{1, 2, 3};
