...
-> unordered_set<typename [std::iterator_traits](../../iterator/iterator_traits.html)<InputIt>::value_type,  
...
unordered_set( [std::initializer_list](../../utility/initializer_list.html)<T>,  
typename /* see below */::size_type = /* see below */,  
Hash = Hash(), Pred = Pred(), Alloc = Alloc() )  
-> unordered_set<T, Hash, Pred, Alloc>; |  (2)  |  (since C++17)  
...
-> unordered_set<typename [std::iterator_traits](../../iterator/iterator_traits.html)<InputIt>::value_type, Hash,  
[std::equal_to](../../utility/functional/equal_to.html)<typename [std::iterator_traits](../../iterator/iterator_traits.html)<InputIt>::value_type>,  
Alloc>; |  (4)  |  (since C++17)  
template< class T, class Alloc >  
unordered_set( [std::initializer_list](../../utility/initializer_list.html)<T>, typename /* see below */::size_type, Alloc )  
-> unordered_set<T, [std::hash](../../utility/hash.html)<T>, [std::equal_to](../../utility/functional/equal_to.html)<T>, Alloc>; |  (5)  |  (since C++17)  
template< class T, class Hash, class Alloc >  
unordered_set( [std::initializer_list](../../utility/initializer_list.html)<T>, typename /* see below */::size_type,  
Hash, Alloc )  
-> unordered_set<T, Hash, [std::equal_to](../../utility/functional/equal_to.html)<T>, Alloc>; |  (6)  |  (since C++17)  
...
unordered_set( [std::from_range_t](../../ranges/from_range.html), R&&,  
typename /* see below */::size_type = /* see below */,  
Hash = Hash(), Pred = Pred(), Alloc = Alloc() )  
-> unordered_set<[ranges::range_value_t](../../ranges/range_size_t.html)<R>, Hash, Pred, Alloc>; |  (7)  |  (since C++23)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Alloc >  
unordered_set( [std::from_range_t](../../ranges/from_range.html), R&&,  
typename /* see below */::size_type, Alloc )  
-> unordered_set<[ranges::range_value_t](../../ranges/range_size_t.html)<R>, hash<[ranges::range_value_t](../../ranges/range_size_t.html)<R>>,  
[std::equal_to](../../utility/functional/equal_to.html)<[ranges::range_value_t](../../ranges/range_size_t.html)<R>>, Alloc>; |  (8)  |  (since C++23)  
template< [ranges::input_range](../../ranges/input_range.html) R, class Alloc >  
unordered_set( [std::from_range_t](../../ranges/from_range.html), R&&, Alloc )  
-> unordered_set<[ranges::range_value_t](../../ranges/range_size_t.html)<R>, hash<[ranges::range_value_t](../../ranges/range_size_t.html)<R>>,  
...
Run this code
    ...
    int main()
    {
        ...
        [std::unordered_set](../unordered_set.html) s = {1, 2, 3, 4};
     
        // guide #1 deduces std::unordered_set<int>
        [std::unordered_set](../unordered_set.html) s2(s.begin(), s.end());
    }
