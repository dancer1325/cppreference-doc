...
Run this code
    ...
    int main()
    {
        [std::unordered_set](../unordered_set.html)<int> a1{3, 1, 3, 2}, a2{5, 4, 5};
     
...
[ std::swap(std::unordered_set)](swap2.html "cpp/container/unordered set/swap2")(C++11) |  specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm   
