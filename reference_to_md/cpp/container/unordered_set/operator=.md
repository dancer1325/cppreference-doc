...
---|---|---  
| (2) |   
unordered_set& operator=( unordered_set&& other ); |  | (since C++11)   
(until C++17)  
unordered_set& operator=( unordered_set&& other )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
unordered_set& operator=( [std::initializer_list](../../utility/initializer_list.html)<value_type> ilist ); |  (3) | (since C++11)   
(constexpr since C++26)  
| |   
...
The following code uses operator= to assign one [std::unordered_set](../unordered_set.html "cpp/container/unordered set") to another:
...
Run this code
    ...
    int main()
    {
        [std::unordered_set](../unordered_set.html)<int> x{1, 2, 3}, y, z;
...
[ (constructor)](unordered_set.html "cpp/container/unordered set/unordered set") |  constructs the `unordered_set`   
