...
Run this code
    ...
     
        auto c1 = [std::unordered_set](../unordered_set.html)<char>{};
        auto c2 = [std::unordered_set](../unordered_set.html)<long>{};
        auto c3 = [std::unordered_set](../unordered_set.html)<long, [std::hash](../../utility/hash.html)<int>>{};
        auto c4 = [std::unordered_set](../unordered_set.html)<long, Ha>{};
     
...
[ bucket_count](bucket_count.html "cpp/container/unordered set/bucket count") |  returns the number of buckets   
