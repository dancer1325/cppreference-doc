...
Run this code
    ...
    Os& operator<<(Os& os, const [std::unordered_set](../unordered_set.html)<K>& v)
    {
        os << '[' << v.size() << "] {";
        bool o{};
        for (const auto& e : v)
    ...
    int main()
    {
        [std::unordered_set](../unordered_set.html)<char>
            p{'C', 'B', 'B', 'A'}, 
            q{'E', 'D', 'E', 'C'};
     
...
[ extract](extract.html "cpp/container/unordered set/extract")(C++17) |  extracts nodes from the container   
