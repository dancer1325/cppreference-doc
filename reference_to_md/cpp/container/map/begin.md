...
If *this is empty, the returned iterator will be equal to [end()](end.html "cpp/container/map/end"). 
...
## Contents
  ...
  * [4 Example](begin.html#Example)
    * [4.1 Example using a custom comparison function](begin.html#Example_using_a_custom_comparison_function)
