...
Run this code
    ...
    int main()
    {
        [std::map](../map.html)<int, [std::string](../../string/basic_string.html)> ma{{1, "apple"}, {5, "pear"}, {10, "banana"}};
        [std::map](../map.html)<int, [std::string](../../string/basic_string.html)> mb{{2, "zorro"}, {4, "batman"}, {5, "X"}, {8, "alpaca"}};
        [std::map](../map.html)<int, [std::string](../../string/basic_string.html)> u;
        u.merge(ma);
        [std::cout](../../io/cout.html) << "ma.size(): " << ma.size() << '\n';
        u.merge(mb);
        [std::cout](../../io/cout.html) << "mb.size(): " << mb.size() << '\n';
        [std::cout](../../io/cout.html) << "mb.at(5): " << mb.at(5) << '\n';
        for (const auto& kv : u)
...
[ extract](extract.html "cpp/container/map/extract")(C++17) |  extracts nodes from the container   
