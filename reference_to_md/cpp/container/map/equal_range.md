...
Alternatively, the first iterator may be obtained with [lower_bound()](lower_bound.html "cpp/container/map/lower bound"), and the second with [upper_bound()](upper_bound.html "cpp/container/map/upper bound"). 
...
Run this code
    ...
    int main()
    {
        const [std::map](../map.html)<int, const char*> m
        {
            {0, "zero"},
            {1, "one"},
            {2, "two"}
...
---|---  
[ contains](contains.html "cpp/container/map/contains")(C++20) |  checks if the container contains element with specific key   
...
[ count](count.html "cpp/container/map/count") |  returns the number of elements matching specific key   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_count&action=edit)  
[ upper_bound](upper_bound.html "cpp/container/map/upper bound") |  returns an iterator to the first element _greater_ than the given key   
...
[ lower_bound](lower_bound.html "cpp/container/map/lower bound") |  returns an iterator to the first element _not less_ than the given key   
