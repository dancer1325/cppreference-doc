...
If *this is empty, the returned iterator is equal to [rend()](rend.html "cpp/container/map/rend"). 
...
The [underlying iterator](../../iterator/reverse_iterator/base.html "cpp/iterator/reverse iterator/base") of the returned reverse iterator is the [end iterator](end.html "cpp/container/map/end"). Hence the returned iterator is invalidated if and when the end iterator is invalidated.
...
Run this code
    ...
    int main()
    {
        const [std::map](../map.html)<int, [std::string_view](../../string/basic_string_view.html)> coins
        {
            {10, "dime"},
            {100, "dollar"},
            {50, "half dollar"},
...
[ rendcrend](rend.html "cpp/container/map/rend")(C++11) |  returns a reverse iterator to the end   
