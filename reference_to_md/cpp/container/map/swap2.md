...
void swap( [std::map](../map.html)<Key, T, Compare, Alloc>& lhs,  
[std::map](../map.html)<Key, T, Compare, Alloc>& rhs ); |  |  (until C++17)  
template< class Key, class T, class Compare, class Alloc >  
void swap( [std::map](../map.html)<Key, T, Compare, Alloc>& lhs,  
[std::map](../map.html)<Key, T, Compare, Alloc>& rhs )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::map](../map.html "cpp/container/map"). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). 
...
Run this code
    ...
    int main()
    {
        [std::map](../map.html)<int, char> alice{{1, 'a'}, {2, 'b'}, {3, 'c'}};
        [std::map](../map.html)<int, char> bob{{7, 'Z'}, {8, 'Y'}, {9, 'X'}, {10, 'W'}};
     
...
[ swap](swap.html "cpp/container/map/swap") |  swaps the contents   
