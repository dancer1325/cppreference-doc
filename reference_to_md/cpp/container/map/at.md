...
template< class K >  
T& at( const K& x ); |  (3) | (since C++26)  
template< class K >  
const T& at( const K& x ) const; |  (4)  |  (since C++26)  
| |   
...
## Contents
  ...
  * [5 Notes](at.html#Notes)
  * [6 Example](at.html#Example)
  * [7 Defect reports](at.html#Defect_reports)
  * [8 See also](at.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::map](../map.html)<int, char> map{{1, 'a'}, {2, 'b'}};
    ...
     
        ...
        [std::map](../map.html)<HeavyKey, char, [std::less](../../utility/functional/less.html)<>> map2{{{1}, 'a'}, {{2}, 'b'}};
...
---|---|---|---  
[LWG 464](https://cplusplus.github.io/LWG/issue464) | C++98  | `map` did not have this member function  | added   
