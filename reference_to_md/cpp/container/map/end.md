...
## Contents
  ...
  * [4 Example](end.html#Example)
    * [4.1 Example using a custom comparison function](end.html#Example_using_a_custom_comparison_function)
...
Run this code
    ...
    int main()
    {
        [std::map](../map.html)<int, float> num_map;
        num_map[4] = 4.13;
        num_map[9] = 9.24;
        num_map[1] = 1.09;
...
Run this code
    ...
     
        ...
        {
            auto cur = iter->first;
            mag[cur] = [std::hypot](../../numeric/math/hypot.html)(cur->x, cur->y);
            [std::cout](../../io/cout.html) << "The magnitude of (" << cur->x << ", " << cur->y << ") is ";
            [std::cout](../../io/cout.html) << iter->second << '\n';
        }
     
