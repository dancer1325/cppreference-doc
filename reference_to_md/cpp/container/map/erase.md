...
The iterator pos must be dereferenceable. Thus the [end()](end.html "cpp/container/map/end") iterator (which is valid, but is not dereferenceable) cannot be used as a value for pos. 
...
Run this code
    ...
    int main()
    {
        [std::map](../map.html)<int, [std::string](../../string/basic_string.html)> c =
        {
            {1, "one"}, {2, "two"}, {3, "three"},
            {4, "four"}, {5, "five"}, {6, "six"}
        };
