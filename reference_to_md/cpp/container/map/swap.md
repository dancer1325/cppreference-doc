...
All iterators and references remain valid. The [`end()`](end.html "cpp/container/map/end") iterator is invalidated. `Compare` must be [Swappable](../../named_req/Swappable.html "cpp/named req/Swappable"), and objects of this type are exchanged using unqualified call to non-member `swap`. 
...
Run this code
    ...
    int main()
    {
        [std::map](../map.html)<[std::string](../../string/basic_string.html), [std::string](../../string/basic_string.html)>
