...
Erases all elements from the container. After this call, [size()](size.html "cpp/container/map/size") returns zero. 
...
Run this code
    ...
    #include <map>
     
    void print_info([std::string_view](../../string/basic_string_view.html) rem, const [std::map](../map.html)<int, char>& v)
    {
    ...
    int main()
    {
        [std::map](../map.html)<int, char> container{{1, 'x'}, {2, 'y'}, {3, 'z'}};
...
[ erase](erase.html "cpp/container/map/erase") |  erases elements   
