...
An iterator to the requested element. If no such element is found, past-the-end (see [end()](end.html "cpp/container/map/end")) iterator is returned. 
...
Run this code
    ...
    int main()
    {
        ...
        [std::map](../map.html)<int, char> example{{1, 'a'}, {2, 'b'}};
     
    ...
     
        ...
        [std::map](../map.html)<FatKey, char, [std::less](../../utility/functional/less.html)<>> example2{{{1, {}}, 'a'}, {{2, {}}, 'b'}};
     
        LightKey lk = {2};
