...
const [std::stack](../stack.html)<T, Container>& rhs ); |  (1)  |   
---|---|---  
template< class T, class Container >  
bool operator!=( const [std::stack](../stack.html)<T, Container>& lhs,  
const [std::stack](../stack.html)<T, Container>& rhs ); |  (2)  |   
template< class T, class Container >  
bool operator< ( const [std::stack](../stack.html)<T, Container>& lhs,  
const [std::stack](../stack.html)<T, Container>& rhs ); |  (3)  |   
template< class T, class Container >  
bool operator<=( const [std::stack](../stack.html)<T, Container>& lhs,  
const [std::stack](../stack.html)<T, Container>& rhs ); |  (4)  |   
template< class T, class Container >  
bool operator> ( const [std::stack](../stack.html)<T, Container>& lhs,  
const [std::stack](../stack.html)<T, Container>& rhs ); |  (5)  |   
template< class T, class Container >  
bool operator>=( const [std::stack](../stack.html)<T, Container>& lhs,  
const [std::stack](../stack.html)<T, Container>& rhs ); |  (6)  |   
...
operator<=>( const [std::stack](../stack.html)<T, Container>& lhs,  
const [std::stack](../stack.html)<T, Container>& rhs ); |  (7)  |  (since C++20)  
| |   
...
---|---|---|---  
[LWG 410](https://cplusplus.github.io/LWG/issue410) | C++98  | the semantics of all comparison operators were missing  | added 
