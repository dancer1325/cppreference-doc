...
Returns reference to the top element in the stack. This is the most recently pushed element. This element will be removed on a call to [pop()](pop.html "cpp/container/stack/pop"). Equivalent to: [`c`](../stack.html#Member_objects "cpp/container/stack").back(). 

## Contents

  * [1 Parameters](top.html#Parameters)
  * [2 Return value](top.html#Return_value)
  * [3 Complexity](top.html#Complexity)
  * [4 Example](top.html#Example)
  * [5 See also](top.html#See_also)
...
Run this code
    ...
    #include <stack>
     
    void reportStackSize(const [std::stack](../stack.html)<int>& s)
    {
        [std::cout](../../io/cout.html) << s.size() << " elements on stack\n";
    }
     
    void reportStackTop(const [std::stack](../stack.html)<int>& s)
    {
        // Leaves element on stack
        [std::cout](../../io/cout.html) << "Top element: " << s.top() << '\n';
    }
     
    int main()
    {
        [std::stack](../stack.html)<int> s;
        s.push(2);
        s.push(6);
        s.push(51);
     
