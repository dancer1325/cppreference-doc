...
void swap( [std::stack](../stack.html)<T, Container>& lhs,  
[std::stack](../stack.html)<T, Container>& rhs ); |  |  (since C++11)   
(until C++17)  
template< class T, class Container >  
void swap( [std::stack](../stack.html)<T, Container>& lhs,  
[std::stack](../stack.html)<T, Container>& rhs )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
| |   
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::stack](../stack.html "cpp/container/stack"). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). This overload participates in overload resolution only if [std::is_swappable_v](../../types/is_swappable.html)<Container> is true.  | (since C++17)  
---|---  
...
Run this code
    ...
    int main()
    {
        [std::stack](../stack.html)<int> alice;
        [std::stack](../stack.html)<int> bob;
     
