...
Checks if the underlying container has no elements. Equivalent to: return` `[`c`](../stack.html#Member_objects "cpp/container/stack").empty(). 
...
Run this code
    ...
    int main()
    {
        [std::stack](../stack.html)<int> stack;
        [assert](../../error/assert.html)(stack.empty());
     
        stack.push(42);
        [assert](../../error/assert.html)(!stack.empty());
     
...
[ size](size.html "cpp/container/stack/size") |  returns the number of elements   
