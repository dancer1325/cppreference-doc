...
[stack::pop](pop.html "cpp/container/stack/pop")  
...
struct formatter<[std::stack](../stack.html)<T, Container, U...>, CharT>; |  |  (since C++23)  
| |   
  
The template specialization of [std::formatter](../../utility/format/formatter.html "cpp/utility/format/formatter") for the container adaptor type [std::stack](../stack.html "cpp/container/stack") allows users to convert the underlying container to its textual representation as a collection of elements using [formatting functions](../../utility/format.html "cpp/utility/format"). 
...
## Contents
  ...
  * [4 std::formatter<std::stack>::parse](formatter.html#std::formatter.3Cstd::stack.3E::parse)
    * [4.1 Return value](formatter.html#Return_value)
  * [5 std::formatter<std::stack>::format](formatter.html#std::formatter.3Cstd::stack.3E::format)
...
` `[std::stack](../stack.html)<T, Container, U...>>  
(exposition-only member type*)  
