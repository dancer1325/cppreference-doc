[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/value_comp&action=edit)
...
## Contents
  ...
  * [1 Return value](value_comp.html#Return_value)
  * [2 Complexity](value_comp.html#Complexity)
  * [3 Example](value_comp.html#Example)
  * [4 See also](value_comp.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::flat_map](../flat_map.html)<int, char, ModCmp> cont;
        cont = {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}};
     
        auto comp_func = cont.value_comp();
     
        for (const [std::pair](../../utility/pair.html)<int, char> val = {100, 'a'}; auto it : cont)
        {
    ...
     
            ...
            if (!before && !after)
                [std::cout](../../io/cout.html) << "equivalent to key (" << val.first << ")\n";
            else if (before)
                [std::cout](../../io/cout.html) << "goes before key (" << val.first << ")\n";
            else if (after)
                [std::cout](../../io/cout.html) << "goes after key (" << val.first << ")\n";
            else
...
[ key_comp](key_comp.html "cpp/container/flat map/key comp") |  returns the function that compares keys   
