...
template< class... Args >  
[std::pair](../../utility/pair.html)<iterator, bool> emplace( Args&&... args ); |  | (since C++23)   
...
If `value_type` is not [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `flat_map` from args, the behavior is undefined. 
...
Run this code
    ...
    int main()
    {
        [std::flat_map](../flat_map.html)<[std::string](../../string/basic_string.html), [std::string](../../string/basic_string.html)> m;
     
