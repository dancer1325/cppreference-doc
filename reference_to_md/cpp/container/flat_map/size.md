...
Returns the number of elements in the container adaptor. Equivalent to: return` `[` _c_`](../flat_map.html#Member_objects "cpp/container/flat map").keys.size(). 
...
Run this code
    ...
    int main()
    {
        [std::flat_map](../flat_map.html)<int, char> nums{{1, 'a'}, {1, 'b'}, {2, 'c'}, {2, 'd'}};
