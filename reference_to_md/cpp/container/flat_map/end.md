...
Run this code
    ...
    int main()
    {
        [std::flat_map](../flat_map.html)<int, double> map{{4, 4.13}, {9, 9.24}, {1, 1.09}};
     
    ...
     
        ...
        auto it = map.cbegin();
        [assert](../../error/assert.html)(it[0] == map[1]);
        [assert](../../error/assert.html)(it[1] == map[4]);
        [assert](../../error/assert.html)(it[2] == map[9]);
    }
...
[ begincbegin](begin.html "cpp/container/flat map/begin") |  returns an iterator to the beginning   
