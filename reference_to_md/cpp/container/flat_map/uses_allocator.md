[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/uses_allocator&action=edit)
...
struct uses_allocator<[std::flat_map](../flat_map.html)<Key, T, Compare,  
KeyContainer, MappedContainer>, Allocator>  
: [std::bool_constant](../../types/integral_constant.html)<[std::uses_allocator_v](../../memory/uses_allocator.html)<KeyContainer, Allocator> &&  
[std::uses_allocator_v](../../memory/uses_allocator.html)<MappedContainer, Allocator>> {}; |  |  (since C++23)  
| |   
  
Provides a transparent specialization of the [std::uses_allocator](../../memory/uses_allocator.html "cpp/memory/uses allocator") type trait for [std::flat_map](../flat_map.html): the container adaptor uses allocator if and only if the underlying container does. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/uses_allocator&action=edit&section=T-1 "Template:cpp/container/uses allocator")] Example
...
Run this code
    ...
     
    static_assert(
        [std::uses_allocator](../../memory/uses_allocator.html)<[std::flat_map](../flat_map.html)<int, int>, void>::value == false &&
        [std::uses_allocator](../../memory/uses_allocator.html)<[std::flat_map](../flat_map.html)<int, int>, [std::allocator](../../memory/allocator.html)<int>>::value == true
    );
     
    int main() {}

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/uses_allocator&action=edit&section=T-2 "Template:cpp/container/uses allocator")] See also
