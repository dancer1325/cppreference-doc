...
Run this code
    ...
     
    [std::size_t](../../types/size_t.html) map_emplace()
    {
        [std::flat_map](../flat_map.html)<int, char> map;
        for (int i = 0; i < n_operations; ++i)
            map.emplace(i, 'a');
        return map.size();
    }
     
    [std::size_t](../../types/size_t.html) map_emplace_hint()
    {
        [std::flat_map](../flat_map.html)<int, char> map;
        auto it = map.begin();
        for (int i = 0; i < n_operations; ++i)
    ...
     
    [std::size_t](../../types/size_t.html) map_emplace_hint_wrong()
    {
        [std::flat_map](../flat_map.html)<int, char> map;
        auto it = map.begin();
    ...
     
    [std::size_t](../../types/size_t.html) map_emplace_hint_corrected()
    {
        [std::flat_map](../flat_map.html)<int, char> map;
        auto it = map.begin();
        for (int i = n_operations; i > 0; --i)
    ...
     
    [std::size_t](../../types/size_t.html) map_emplace_hint_closest()
    {
        [std::flat_map](../flat_map.html)<int, char> map;
        auto it = map.begin();
        for (int i = 0; i < n_operations; ++i)
    ...
     
    double time_it([std::function](../../utility/functional/function.html)<[std::size_t](../../types/size_t.html)()> map_test,
                   [std::string](../../string/basic_string.html) what = "", double ratio = 0.0)
    {
        const auto start = [std::chrono::system_clock::now](../../chrono/system_clock/now.html)();
        const [std::size_t](../../types/size_t.html) map_size = map_test();
        const auto stop = [std::chrono::system_clock::now](../../chrono/system_clock/now.html)();
        [std::chrono::duration](../../chrono/duration.html)<double, [std::milli](../../numeric/ratio/ratio.html)> time = stop - start;
