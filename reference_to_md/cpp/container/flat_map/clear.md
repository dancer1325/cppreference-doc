...
Run this code
    ...
    #include <flat_map>
     
    void print_info([std::string_view](../../string/basic_string_view.html) rem, const [std::flat_map](../flat_map.html)<int, char>& v)
    {
    ...
    int main()
    {
        [std::flat_map](../flat_map.html)<int, char> container{{1, 'x'}, {2, 'y'}, {3, 'z'}};
...
[ erase](erase.html "cpp/container/flat map/erase") |  erases elements   
