...
Inserts a copy of each element in the range rg into underlying containers [`_c_`](../flat_map.html#Member_objects "cpp/container/flat map") as if by: 
...
If any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * `value_type` is not [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `flat_map` from *[ranges::begin](../../ranges/begin.html)(rg)
  * rg and *this overlap. 
...
Run this code
    ...
    int main()
    {
        auto container = [std::flat_map](../flat_map.html){[std::pair](../../utility/pair.html){1, 11}, {3, 33}, {2, 22}, {4, 44}};
