...
Run this code
    ...
    int main()
    {
        const [std::flat_map](../flat_map.html)<year_month_day, int> messages
        {
            {February/17/2023, 10},
            {February/17/2023, 20},
            {February/16/2022, 30},
...
[ rbegincrbegin](rbegin.html "cpp/container/flat map/rbegin") |  returns a reverse iterator to the beginning   
