...
1) Inserts a [`value_type`](../flat_map.html#Member_types "cpp/container/flat map") object constructed in-place if the key does not exist. Equivalent to return try_emplace(x).first->second;.

2) Inserts a [`value_type`](../flat_map.html#Member_types "cpp/container/flat map") object constructed in-place if the key does not exist. Equivalent to return try_emplace(std::move(x)).first->second;

3) Inserts a [`value_type`](../flat_map.html#Member_types "cpp/container/flat map") object constructed in-place if there is no key that transparently compares _equivalent_ to the value x.
...
Run this code
    ...
    int main()
    {
        [std::flat_map](../flat_map.html)<char, int> letter_counts{{'a', 27}, {'b', 3}, {'c', 1}};
     
    ...
     
        ...
        [std::flat_map](../flat_map.html)<[std::string](../../string/basic_string.html), int>  word_map;
