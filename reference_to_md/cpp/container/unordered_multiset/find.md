...
An iterator to the requested element. If no such element is found, past-the-end (see [end()](end.html "cpp/container/unordered multiset/end")) iterator is returned. 
