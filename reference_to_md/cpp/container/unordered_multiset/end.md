...
**unordered_multiset::end unordered_multiset::cend**  
...
Run this code
    ...
    int main()
    {
        const [std::unordered_multiset](../unordered_multiset.html)<[std::string](../../string/basic_string.html)> words =
        {
            "some", "words", "to", "count",
            "count", "these", "words"
        };
...
[ begincbegin](begin.html "cpp/container/unordered multiset/begin") |  returns an iterator to the beginning   
