...
Run this code
    ...
    int main()
    {
        [std::unordered_multiset](../unordered_multiset.html)<int> a1{3, 1, 3, 2}, a2{5, 4, 5};
     
...
[ std::swap(std::unordered_multiset)](swap2.html "cpp/container/unordered multiset/swap2")(C++11) |  specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm   
(function template)   
---|---
