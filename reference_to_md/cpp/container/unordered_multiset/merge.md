...
void merge( [std::unordered_set](../unordered_set.html)<Key, H2, P2, Allocator>& source ); |  (1) | (since C++17)   
(constexpr since C++26)  
---|---|---  
template< class H2, class P2 >  
void merge( [std::unordered_set](../unordered_set.html)<Key, H2, P2, Allocator>&& source ); |  (2) | (since C++17)   
(constexpr since C++26)  
template< class H2, class P2 >  
void merge( [std::unordered_multiset](../unordered_multiset.html)<Key, H2, P2, Allocator>& source ); |  (3) | (since C++17)   
(constexpr since C++26)  
template< class H2, class P2 >  
void merge( [std::unordered_multiset](../unordered_multiset.html)<Key, H2, P2, Allocator>&& source ); |  (4) | (since C++17)   
(constexpr since C++26)  
| |   
...
Run this code
    ...
    Os& operator<<(Os& os, const [std::unordered_multiset](../unordered_multiset.html)<K>& v)
    {
        os << '[' << v.size() << "] {";
        bool o{};
        for (const auto& e : v)
    ...
    int main()
    {
        [std::unordered_multiset](../unordered_multiset.html)<char>
            p{'C', 'B', 'B', 'A'}, 
            q{'E', 'D', 'E', 'C'};
     
...
[ extract](extract.html "cpp/container/unordered multiset/extract")(C++17) |  extracts nodes from the container   
