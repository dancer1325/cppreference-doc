...
If any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * `value_type` is not [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `unordered_multiset` from *[ranges::begin](../../ranges/begin.html)(rg)
  * rg and *this overlap. 



If after the operation the new number of elements is greater than old [`max_load_factor()`](max_load_factor.html "cpp/container/unordered multiset/max load factor")` *`` `[`bucket_count()`](bucket_count.html "cpp/container/unordered multiset/bucket count") a rehashing takes place.  
...
Run this code
    ...
    int main()
    {
        auto container = [std::unordered_multiset](../unordered_multiset.html){1, 3, 2, 4};
        const auto rg = {-1, 3, -2};
