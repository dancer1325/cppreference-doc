...
Run this code
    ...
    int main()
    {
        [std::unordered_multiset](../unordered_multiset.html)<char> p;
        [std::unordered_multiset](../unordered_multiset.html)<long> q;
     
...
[ size](size.html "cpp/container/unordered multiset/size") |  returns the number of elements   
