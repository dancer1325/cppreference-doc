...
The following code uses `empty` to check if a [std::unordered_multiset](../unordered_multiset.html)<int> contains any elements:
...
Run this code
    ...
    int main()
    {
        [std::unordered_multiset](../unordered_multiset.html)<int> numbers;
