...
**unordered_multiset::begin unordered_multiset::cbegin**  
...
If *this is empty, the returned iterator will be equal to [end()](end.html "cpp/container/unordered multiset/end"). 
...
[ endcend](end.html "cpp/container/unordered multiset/end") |  returns an iterator to the end   
