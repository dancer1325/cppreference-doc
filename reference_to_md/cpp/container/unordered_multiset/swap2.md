...
void swap( [std::unordered_multiset](../unordered_multiset.html)<Key, Hash, KeyEqual, Alloc>& lhs,  
[std::unordered_multiset](../unordered_multiset.html)<Key, Hash, KeyEqual, Alloc>& rhs ); |  |  (since C++11)   
(until C++17)  
template< class Key, class Hash, class KeyEqual, class Alloc >  
void swap( [std::unordered_multiset](../unordered_multiset.html)<Key, Hash, KeyEqual, Alloc>& lhs,  
[std::unordered_multiset](../unordered_multiset.html)<Key, Hash, KeyEqual, Alloc>& rhs )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::unordered_multiset](../unordered_multiset.html "cpp/container/unordered multiset"). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). 
...
Run this code
    ...
    int main()
    {
        [std::unordered_multiset](../unordered_multiset.html)<int> alice{1, 2, 3};
        [std::unordered_multiset](../unordered_multiset.html)<int> bob{7, 8, 9, 10};
     
...
[ swap](swap.html "cpp/container/unordered multiset/swap") |  swaps the contents   
