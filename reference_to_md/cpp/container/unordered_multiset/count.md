...
Run this code
    ...
    int main()
    {
        [std::unordered_multiset](../unordered_multiset.html) set{2, 7, 1, 8, 2, 8, 1, 8, 2, 8};
     
        [std::cout](../../io/cout.html) << "The set is:\n";
        for (int e : set)
            [std::cout](../../io/cout.html) << e << ' ';
     
        const auto [min, max] = std::[ranges::minmax](../../algorithm/ranges/minmax.html)(set);
     
        [std::cout](../../io/cout.html) << "\nNumbers [" << min << ".." << max << "] frequency:\n";
     
        for (int i{min}; i <= max; ++i)
            [std::cout](../../io/cout.html) << i << ':' << set.count(i) << "; ";
        [std::cout](../../io/cout.html) << '\n';
    }
...
[ equal_range](equal_range.html "cpp/container/unordered multiset/equal range") |  returns range of elements matching a specific key   
