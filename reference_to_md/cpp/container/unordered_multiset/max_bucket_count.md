...
Run this code
    ...
     
        auto c1 = [std::unordered_multiset](../unordered_multiset.html)<char>{};
        auto c2 = [std::unordered_multiset](../unordered_multiset.html)<long>{};
        auto c3 = [std::unordered_multiset](../unordered_multiset.html)<long, [std::hash](../../utility/hash.html)<int>>{};
        auto c4 = [std::unordered_multiset](../unordered_multiset.html)<long, Ha>{};
     
...
[ bucket_count](bucket_count.html "cpp/container/unordered multiset/bucket count") |  returns the number of buckets   
