...
last( size_type count ) const; |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](last.html#Parameters)
  * [2 Return value](last.html#Return_value)
  * [3 Example](last.html#Example)
  * [4 See also](last.html#See_also)
...
Run this code
    ...
    #include <string_view>
     
    void println(const [std::string_view](../../string/basic_string_view.html) title, const auto& container)
    {
        [std::cout](../../io/cout.html) << title << '[' << [std::size](../../iterator/size.html)(container) << "]{ ";
        for (const auto& elem : container)
            [std::cout](../../io/cout.html) << elem << ", ";
        [std::cout](../../io/cout.html) << "};\n";
    };
     
    void run([std::span](../span.html)<const int> span)
    {
        println("span: ", span);
     
        [std::span](../span.html)<const int, 3> span_last = span.last<3>();
        println("span.last<3>(): ", span_last);
     
        [std::span](../span.html)<const int, [std::dynamic_extent](dynamic_extent.html)> span_last_dynamic = span.last(2);
