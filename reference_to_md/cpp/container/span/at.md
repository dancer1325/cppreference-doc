...
If pos is not within the range of the span, an exception of type [std::out_of_range](../../error/out_of_range.html "cpp/error/out of range") is thrown. 
