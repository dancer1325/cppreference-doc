...
first( size_type count ) const; |  (2)  |  (since C++20)  
| |   
...
If Count > size() or count > size() is true, the behavior is undefined.  | (until C++26)  
---|---  
...
## Contents
  ...
  * [1 Parameters](first.html#Parameters)
  * [2 Return value](first.html#Return_value)
  * [3 Example](first.html#Example)
  * [4 See also](first.html#See_also)
...
Run this code
    ...
    #include <string_view>
     
    void print(const [std::string_view](../../string/basic_string_view.html) title,
               const std::[ranges::forward_range](../../ranges/forward_range.html) auto& container)
    {
        auto size{[std::size](../../iterator/size.html)(container)};
        [std::cout](../../io/cout.html) << title << '[' << size << "]{";
        for (const auto& elem : container)
            [std::cout](../../io/cout.html) << elem << (--size ? ", " : "");
        [std::cout](../../io/cout.html) << "};\n";
    }
     
    void run_game([std::span](../span.html)<const int> span)
    {
        print("span: ", span);
     
        [std::span](../span.html)<const int, 5> span_first = span.first<5>();
        print("span.first<5>(): ", span_first);
     
        [std::span](../span.html)<const int, [std::dynamic_extent](dynamic_extent.html)> span_first_dynamic = span.first(4);
