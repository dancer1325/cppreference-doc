...
---|---|---  
inline constexpr [std::size_t](../../types/size_t.html) dynamic_extent = [std::numeric_limits](../../types/numeric_limits.html)<[std::size_t](../../types/size_t.html)>::max(); |  |  (since C++20)  
| |   
  
`std::dynamic_extent` is a constant of type [std::size_t](../../types/size_t.html "cpp/types/size t") that is generally used to indicate that any type using `std::dynamic_extent` will _dynamically_ store its value (e.g., size) rather than having the value _statically_ known in the type. 

It is being used in several contexts: 

  * To differentiate [`std::span`](../span.html "cpp/container/span") of static and dynamic extent. 



  * To indicate that the extent at a certain rank index will be stored dynamically in [`std::extents`](../mdspan/extents.html "cpp/container/mdspan/extents"). 

| (since C++23)  
---|---  
  
  * To indicate that the padded layouts for [`std::mdspan`](../mdspan.html "cpp/container/mdspan") will dynamically store its padding value. 
...
Since [std::size_t](../../types/size_t.html "cpp/types/size t") is an unsigned type, an equivalent definition is: 
    ...
    inline constexpr [std::size_t](../../types/size_t.html) dynamic_extent = -1;
...
Run this code
    ...
    int main()
    {
        auto print = []([std::string_view](../../string/basic_string_view.html) const name, [std::size_t](../../types/size_t.html) ex)
        {
            [std::cout](../../io/cout.html) << name << ", ";
            if (std::dynamic_extent == ex)
                [std::cout](../../io/cout.html) << "dynamic extent\n";
            else
                [std::cout](../../io/cout.html) << "static extent = " << ex << '\n';
        };
     
        int a[]{1, 2, 3, 4, 5};
     
        [std::span](../span.html) span1{a};
        print("span1", span1.extent);
     
        [std::span](../span.html)<int, std::dynamic_extent> span2{a};
        print("span2", span2.extent);
     
        [std::array](../array.html) ar{1, 2, 3, 4, 5};
        [std::span](../span.html) span3{ar};
        print("span3", span3.extent);
     
        [std::vector](../vector.html) v{1, 2, 3, 4, 5};
        [std::span](../span.html) span4{v};
