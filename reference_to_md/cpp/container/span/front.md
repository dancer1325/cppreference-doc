...
If [`empty()`](empty.html "cpp/container/span/empty") is true, the behavior is undefined.  | (until C++26)  
---|---  
If [`empty()`](empty.html "cpp/container/span/empty") is true: 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/span/front&action=edit&section=1 "Edit section: Return value")] Return value

A reference to the first element. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/span/front&action=edit&section=2 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/span/front&action=edit&section=3 "Edit section: Notes")] Notes

For a span c, the expression c.front() is equivalent to *c.begin(). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/span/front&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    #include <span>
     
    void print([std::span](../span.html)<const int> const data)
    {
        for (auto offset{0U}; offset != data.size(); ++offset)
            [std::cout](../../io/cout.html) << data.subspan(offset).front() << ' ';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/container/span/front&action=edit&section=5 "Edit section: See also")] See also

[ back](back.html "cpp/container/span/back") |  access the last element   
