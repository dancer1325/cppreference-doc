...
constexpr iterator end() const noexcept; |  (1)  |  (since C++20)  
---|---|---  
constexpr const_iterator cend() const noexcept; |  (2)  |  (since C++23)  
| |   
...
Run this code
    ...
    #include <span>
     
    void print([std::span](../span.html)<const int> array)
    {
        [std::cout](../../io/cout.html) << "array = ";
        for (auto it = array.begin(); it != array.end(); ++it)
            [std::cout](../../io/cout.html) << *it << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
     
    void set_first_element([std::span](../span.html)<int> sp, int new_value)
    {
        if (!sp.empty())
        {
            [std::cout](../../io/cout.html) << "old *begin = " << *sp.begin() << '\n';
            *sp.begin() = new_value;
            [std::cout](../../io/cout.html) << "new *begin = " << *sp.begin() << '\n';
        }
    }
     
    int main()
...
[ begincbegin](begin.html "cpp/container/span/begin")(C++23) |  returns an iterator to the beginning   
