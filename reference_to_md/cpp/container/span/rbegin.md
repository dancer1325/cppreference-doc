...
The [underlying iterator](../../iterator/reverse_iterator/base.html "cpp/iterator/reverse iterator/base") of the returned reverse iterator is the [end iterator](end.html "cpp/container/span/end"). Hence the returned iterator is invalidated if and when the end iterator is invalidated.
...
Run this code
    ...
    int main()
    {
        constexpr [std::span](../span.html)<const char> code{"@droNE_T0P_w$s@s#_SECRET_a,p^42!"};
     
        auto hack = [](const unsigned O) { return O - 0141 < 120; };
     
        [std::copy_if](../../algorithm/copy.html)(code.rbegin(), code.rend(),
            [std::ostream_iterator](../../iterator/ostream_iterator.html)<const char>([std::cout](../../io/cout.html)), hack);
     
...
[ rendcrend](rend.html "cpp/container/span/rend")(C++23) |  returns a reverse iterator to the end   
