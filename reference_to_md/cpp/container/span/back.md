...
Run this code
    ...
    #include <span>
     
    void print_forward(const [std::span](../span.html)<const int> span)
    {
        for (auto n{span.size()}; n != 0; --n)
            [std::cout](../../io/cout.html) << span.last(n).front() << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
     
    void print_backward(const [std::span](../span.html)<const int> span)
    {
        for (auto n{span.size()}; n != 0; --n)
            [std::cout](../../io/cout.html) << span.first(n).back() << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
     
    int main()
