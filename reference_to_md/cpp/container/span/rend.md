...
Run this code
    ...
    #include <string_view>
     
    void ascending(const [std::span](../span.html)<const [std::string_view](../../string/basic_string_view.html)> data,
                   const [std::string_view](../../string/basic_string_view.html) term)
    {
        [std::for_each](../../algorithm/for_each.html)(data.begin(), data.end(),
            [](const [std::string_view](../../string/basic_string_view.html) x) { [std::cout](../../io/cout.html) << x << ' '; });
        [std::cout](../../io/cout.html) << term;
    }
     
    void descending(const [std::span](../span.html)<const [std::string_view](../../string/basic_string_view.html)> data,
                    const [std::string_view](../../string/basic_string_view.html) term)
    {
        [std::for_each](../../algorithm/for_each.html)(data.rbegin(), data.rend(),
            [](const [std::string_view](../../string/basic_string_view.html) x) { [std::cout](../../io/cout.html) << x << ' '; });
        [std::cout](../../io/cout.html) << term;
    }
     
    int main()
    {
        constexpr [std::string_view](../../string/basic_string_view.html) bars[]{"▁","▂","▃","▄","▅","▆","▇","█"};
        ascending(bars, " ");
        descending(bars, "\n");
    }
...
[ rbegincrbegin](rbegin.html "cpp/container/span/rbegin")(C++23) |  returns a reverse iterator to the beginning   
