...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<int, char> nums{{1, 'a'}, {1, 'b'}, {2, 'c'}, {2, 'd'}};
        [assert](../../error/assert.html)(nums.size() == 2); 
    }

### See also

[ empty](empty.html "cpp/container/unordered map/empty") |  checks whether the container is empty   
(public member function)   
---|---  
[ max_size](max_size.html "cpp/container/unordered map/max size") |  returns the maximum possible number of elements   
(public member function)   
