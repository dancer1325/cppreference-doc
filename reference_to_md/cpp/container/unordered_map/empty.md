...
The following code uses `empty` to check if a [std::unordered_map](../unordered_map.html)<int, int> contains any elements:
...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<int,int> numbers;
