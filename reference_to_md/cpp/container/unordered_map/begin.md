...
**unordered_map::begin unordered_map::cbegin**  
...
If *this is empty, the returned iterator will be equal to [end()](end.html "cpp/container/unordered map/end"). 
...
Run this code
    ...
     
        ...
        [std::unordered_map](../unordered_map.html)<Node*, double> mag =
        {
            { nodes + 0, 1 },
            { nodes + 1, 2 },
            { nodes + 2, 3 }
...
[ endcend](end.html "cpp/container/unordered map/end") |  returns an iterator to the end   
