...
---  
**erase_if(std::unordered_map)**(C++20)  
...
class Pred >  
[std::unordered_map](../unordered_map.html)<Key, T, Hash, KeyEqual, Alloc>::size_type  
erase_if( [std::unordered_map](../unordered_map.html)<Key, T, Hash, KeyEqual, Alloc>& c,  
...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<int, char> data
        {
            {1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'},
            {5, 'e'}, {4, 'f'}, {5, 'g'}, {5, 'g'},
        };
