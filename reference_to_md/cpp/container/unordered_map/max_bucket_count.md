...
Run this code
    ...
     
        auto c1 = [std::unordered_map](../unordered_map.html)<char, long>{};
        auto c2 = [std::unordered_map](../unordered_map.html)<long, long>{};
        auto c3 = [std::unordered_map](../unordered_map.html)<long, long, [std::hash](../../utility/hash.html)<int>>{};
        auto c4 = [std::unordered_map](../unordered_map.html)<long, long, Ha>{};
     
