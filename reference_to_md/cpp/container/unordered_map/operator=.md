...
(constexpr since C++26)  
unordered_map& operator=( [std::initializer_list](../../utility/initializer_list.html)<value_type> ilist ); |  (3) | (since C++11)   
(constexpr since C++26)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<int, int> x{{1,1}, {2,2}, {3,3}}, y, z;
