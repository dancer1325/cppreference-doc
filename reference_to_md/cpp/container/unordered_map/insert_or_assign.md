...
1,4) If a key equivalent to k already exists in the container, assigns [std::forward](../../utility/forward.html)<M>(obj) to the [`mapped_type`](../unordered_map.html#Member_types "cpp/container/unordered map") corresponding to the key k. If the key does not exist, inserts the new value as if by [`insert`](insert.html "cpp/container/unordered map/insert"), constructing it from value_type(k, [std::forward](../../utility/forward.html)<M>(obj)).

2,5) Same as (1,4), except the mapped value is constructed from value_type(std::move(k), [std::forward](../../utility/forward.html)<M>(obj)).

3,6) If a key equivalent to k already exists in the container, assigns [std::forward](../../utility/forward.html)<M>(obj) to the [`mapped_type`](../unordered_map.html#Member_types "cpp/container/unordered map") corresponding to the key k. If the key does not exist, constructs an object `u` of `value_type` with [std::forward](../../utility/forward.html)<K>(k), [std::forward](../../utility/forward.html)<M>(obj)), then inserts `u` into *this. If hash_function()(u.first) != hash_function()(k) || contains(u.first) is true, the behavior is undefined. The `value_type` must be [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `unordered_map` from [std::forward](../../utility/forward.html)<K>(k), [std::forward](../../utility/forward.html)<M>(obj). This overload participates in overload resolution only if `Hash` and `KeyEqual` are both [transparent](../../functional.html#Transparent_function_objects "cpp/utility/functional"). This assumes that such `Hash` is callable with both `K` and `Key` type, and that the `KeyEqual` is transparent, which, together, allows calling this function without constructing an instance of `Key`.
...
---|---|---|---  
[`__cpp_lib_unordered_map_try_emplace`](../../experimental/feature_test.html#cpp_lib_unordered_map_try_emplace "cpp/feature test") | [`201411L`](../../compiler_support/17.html#cpp_lib_unordered_map_try_emplace_201411L "cpp/compiler support/17") | (C++17) | [std::unordered_map::try_emplace](try_emplace.html "cpp/container/unordered map/try emplace"),  
...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<[std::string](../../string/basic_string.html), [std::string](../../string/basic_string.html)> myMap;
     
