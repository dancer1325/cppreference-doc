...
Run this code
    ...
    Os& operator<<(Os& os, const [std::unordered_map](../unordered_map.html)<K, V>& v)
    {
        os << '[' << v.size() << "] {";
        bool o{};
        for (const auto& e : v)
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<[std::string](../../string/basic_string.html), int>
            p{{"C", 3}, {"B", 2}, {"A", 1}, {"A", 0}},
            q{{"E", 6}, {"E", 7}, {"D", 5}, {"A", 4}};
     
...
[ extract](extract.html "cpp/container/unordered map/extract")(C++17) |  extracts nodes from the container   
