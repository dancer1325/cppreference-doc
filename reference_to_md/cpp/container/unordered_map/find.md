...
Run this code
    ...
     
        [std::size_t](../../types/size_t.html) operator()(const char* str) const        { return hash_type{}(str); }
        [std::size_t](../../types/size_t.html) operator()([std::string_view](../../string/basic_string_view.html) str) const   { return hash_type{}(str); }
        [std::size_t](../../types/size_t.html) operator()(const [std::string](../../string/basic_string.html)& str) const { return hash_type{}(str); }
    };
     
    int main()
    {
        // simple comparison demo
        [std::unordered_map](../unordered_map.html)<int, char> example{{1, 'a'}, {2, 'b'}};
     
    ...
     
        ...
        [std::unordered_map](../unordered_map.html)<[std::string](../../string/basic_string.html), size_t, string_hash, [std::equal_to](../../utility/functional/equal_to.html)<>> map{{"one"s, 1}};
