...
Erases all elements from the container. After this call, [size()](size.html "cpp/container/unordered map/size") returns zero. 
...
Run this code
    ...
     
    void print_info([std::string_view](../../string/basic_string_view.html) rem, const [std::unordered_map](../unordered_map.html)<int, char>& v)
    {
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<int, char> container{{1, 'x'}, {2, 'y'}, {3, 'z'}};
