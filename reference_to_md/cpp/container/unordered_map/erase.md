...
The iterator pos must be dereferenceable. Thus the [end()](end.html "cpp/container/unordered map/end") iterator (which is valid, but is not dereferenceable) cannot be used as a value for pos. 
...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<int, [std::string](../../string/basic_string.html)> c =
        {
            {1, "one"}, {2, "two"}, {3, "three"},
            {4, "four"}, {5, "five"}, {6, "six"}
        };
...
[ clear](clear.html "cpp/container/unordered map/clear") |  clears the contents   
