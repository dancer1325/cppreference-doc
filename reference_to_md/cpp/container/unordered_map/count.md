...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<int, [std::string](../../string/basic_string.html)> dict = {
            {1, "one"}, {6, "six"}, {3, "three"}
        };
        dict.insert({4, "four"});
        dict.insert({5, "five"});
...
---|---  
[ contains](contains.html "cpp/container/unordered map/contains")(C++20) |  checks if the container contains element with specific key   
