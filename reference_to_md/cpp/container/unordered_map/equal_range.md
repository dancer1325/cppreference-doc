...
[std::pair](../../utility/pair.html "cpp/utility/pair") containing a pair of iterators defining the wanted range. If there are no such elements, past-the-end (see [end()](end.html "cpp/container/unordered map/end")) iterators are returned as both elements of the pair. 
...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<int,char> map = {{1, 'a'},{2, 'b'}};
