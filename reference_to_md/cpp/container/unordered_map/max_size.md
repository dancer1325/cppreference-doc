...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<char, char> p;
        [std::unordered_map](../unordered_map.html)<long, char> q;
     
...
[ size](size.html "cpp/container/unordered map/size") |  returns the number of elements   
