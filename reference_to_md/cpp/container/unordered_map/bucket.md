...
The returned value is valid only for instances of the container for which [bucket_count()](bucket_count.html "cpp/container/unordered map/bucket count") returns the same value (e.g., [rehash()](rehash.html "cpp/container/unordered map/rehash") invalidates previously obtained value). 

The behavior is undefined if [bucket_count()](bucket_count.html "cpp/container/unordered map/bucket count") is zero. 
...
[ bucket_size](bucket_size.html "cpp/container/unordered map/bucket size") |  returns the number of elements in specific bucket   
