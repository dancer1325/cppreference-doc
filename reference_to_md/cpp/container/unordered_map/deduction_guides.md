...
unordered_map( [std::initializer_list](../../utility/initializer_list.html)<[std::pair](../../utility/pair.html)<Key, T>>,  
typename /* see below */::size_type = /* see below */,  
Hash = Hash(), Pred = Pred(), Alloc = Alloc() )  
-> unordered_map<Key, T, Hash, Pred, Alloc>; |  (2) | (since C++17)  
...
-> unordered_map<Key, T, [std::hash](../../utility/hash.html)<Key>, [std::equal_to](../../utility/functional/equal_to.html)<Key>, Alloc>; |  (6) | (since C++17)  
template< class Key, class T, typename Alloc >  
unordered_map( [std::initializer_list](../../utility/initializer_list.html)<[std::pair](../../utility/pair.html)<Key, T>>, Alloc )  
-> unordered_map<Key, T, [std::hash](../../utility/hash.html)<Key>, [std::equal_to](../../utility/functional/equal_to.html)<Key>, Alloc>; |  (7)  |  (since C++17)  
template< class Key, class T, class Hash, class Alloc >  
unordered_map( [std::initializer_list](../../utility/initializer_list.html)<[std::pair](../../utility/pair.html)<Key, T>>,  
typename /* see below */::size_type, Hash, Alloc )  
-> unordered_map<Key, T, Hash, [std::equal_to](../../utility/functional/equal_to.html)<Key>, Alloc>; |  (8)  |  (since C++17)  
...
unordered_map( [std::from_range_t](../../ranges/from_range.html), R&&,  
typename /* see below */::size_type = /* see below */,  
Hash = Hash(), Pred = Pred(), Alloc = Alloc() )  
...
template< [ranges::input_range](../../ranges/input_range.html) R, class Alloc >  
unordered_map( [std::from_range_t](../../ranges/from_range.html), R&&, Alloc )  
-> unordered_map</*range-key-t*/<R>, /*range-mapped-t*/<R>,  
[std::hash](../../utility/hash.html)</*range-key-t*/<R>>,  
...
unordered_map( [std::from_range_t](../../ranges/from_range.html), R&&, typename /* see below */::size_type,  
Hash, Alloc )  
...
1-8) These [deduction guide](../../language/ctad.html "cpp/language/class template argument deduction") are provided for `unordered_map` to allow deduction from an iterator range (overloads (1,3-5)) and [std::initializer_list](../../utility/initializer_list.html "cpp/utility/initializer list") (overloads (2,6-8)).

9-12) These deduction guides are provided for `unordered_map` to allow deduction from a [`std::from_range_t`](../../ranges/from_range.html "cpp/ranges/from range") tag and an [`input_range`](../../ranges/input_range.html "cpp/ranges/input range").
...
Run this code
    ...
     
        [std::unordered_map](../unordered_map.html) m1 = {[std::pair](../../utility/pair.html){"foo", 2}, {"bar", 3}}; // guide #2
        [std::unordered_map](../unordered_map.html) m2(m1.begin(), m1.end()); // guide #1
    }
