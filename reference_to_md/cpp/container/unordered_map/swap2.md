...
void swap( [std::unordered_map](../unordered_map.html)<Key, T, Hash, KeyEqual, Alloc>& lhs,  
[std::unordered_map](../unordered_map.html)<Key, T, Hash, KeyEqual, Alloc>& rhs ); |  |  (since C++11)   
(until C++17)  
template< class Key, class T, class Hash, class KeyEqual, class Alloc >  
void swap( [std::unordered_map](../unordered_map.html)<Key, T, Hash, KeyEqual, Alloc>& lhs,  
[std::unordered_map](../unordered_map.html)<Key, T, Hash, KeyEqual, Alloc>& rhs )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::unordered_map](../unordered_map.html "cpp/container/unordered map"). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). 
...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../unordered_map.html)<int, char> alice{{1, 'a'}, {2, 'b'}, {3, 'c'}};
        [std::unordered_map](../unordered_map.html)<int, char> bob{{7, 'Z'}, {8, 'Y'}, {9, 'X'}, {10, 'W'}};
     
...
[ swap](swap.html "cpp/container/unordered map/swap") |  swaps the contents   
