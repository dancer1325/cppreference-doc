...
Run this code
    ...
    #include <vector>
     
    void println([std::string_view](../../string/basic_string_view.html) fmt, [std::vector](../vector.html)<bool> const& vb = {})
    {
        for ([std::cout](../../io/cout.html) << fmt; bool const e : vb)
    ...
    int main()
    {
        ...
        [std::vector](../vector.html)<bool> x{1, 0};
    ...
     
        ...
        [std::vector](../vector.html)<bool> y{0, 0, 1};
        println("before swap, x: ", x);
