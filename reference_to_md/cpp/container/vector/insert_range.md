...
constexpr iterator insert_range( const_iterator pos, R&& rg ); |  | (since C++23)  
---|---|---  
| |   
...
## Contents
  ...
  * [3 Complexity](insert_range.html#Complexity)
  * [4 Notes](insert_range.html#Notes)
  * [5 Example](insert_range.html#Example)
  * [6 See also](insert_range.html#See_also)
...
pos  |  \-  |  iterator before which the content will be inserted (pos may be the [`end()`](end.html "cpp/container/vector/end") iterator)   
---|---|---  
...
Run this code
    ...
    int main()
    {
        auto container = [std::vector](../vector.html){1, 2, 3, 4};
        auto pos = [std::next](../../iterator/next.html)(container.begin(), 2);
        [assert](../../error/assert.html)(*pos == 3);
        const auto rg = [std::list](../list.html){-1, -2, -3};
     
...
[ insert](insert.html "cpp/container/vector/insert") |  inserts elements   
