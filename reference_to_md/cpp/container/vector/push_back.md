[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/push_back&action=edit)
...
## Contents
  ...
  * [2 Complexity](push_back.html#Complexity)
  * [3 Exceptions](push_back.html#Exceptions)
  * [4 Notes](push_back.html#Notes)
...
If the move constructor of `T` is not noexcept and `T` is not [CopyInsertable](../../named_req/CopyInsertable.html "cpp/named req/CopyInsertable") into *this, `vector` will use the throwing move constructor. If it throws, the guarantee is waived and the effects are unspecified.  | (since C++11)  
---|---  
...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<[std::string](../../string/basic_string.html)> letters;
     
        letters.push_back("abc");
        [std::string](../../string/basic_string.html) s{"def"};
        letters.push_back(std::move(s));
     
        [std::cout](../../io/cout.html) << "std::vector letters holds: ";
        for (auto&& e : letters)
