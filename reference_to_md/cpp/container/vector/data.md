...
Returns a pointer to the underlying array serving as element storage. The pointer is such that range `[`data()`, `data() +` `[size()](size.html "cpp/container/vector/size")`)` is always a [valid range](../../iterator.html#Ranges "cpp/iterator")
...
## Contents
  ...
  * [5 Defect reports](data.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<int> container{1, 2, 3, 4};
     
