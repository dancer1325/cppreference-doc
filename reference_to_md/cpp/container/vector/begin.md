...
**vector::begin vector::cbegin**(C++11)  
...
If *this is empty, the returned iterator will be equal to [end()](end.html "cpp/container/vector/end"). 
...
[ endcend](end.html "cpp/container/vector/end")(C++11) |  returns an iterator to the end   
