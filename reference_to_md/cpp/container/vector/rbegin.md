...
**vector::rbegin vector::crbegin**(C++11)  
...
If *this is empty, the returned iterator is equal to [rend()](rend.html "cpp/container/vector/rend"). 
...
The [underlying iterator](../../iterator/reverse_iterator/base.html "cpp/iterator/reverse iterator/base") of the returned reverse iterator is the [end iterator](end.html "cpp/container/vector/end"). Hence the returned iterator is invalidated if and when the end iterator is invalidated.
...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<int> nums{1, 2, 4, 8, 16};
        [std::vector](../vector.html)<[std::string](../../string/basic_string.html)> fruits{"orange", "apple", "raspberry"};
        [std::vector](../vector.html)<char> empty;
     
        // Print vector.
    ...
     
        if (empty.rbegin() == empty.rend())
            [std::cout](../../io/cout.html) << "vector 'empty' is indeed empty.\n";
    }
...
[ rendcrend](rend.html "cpp/container/vector/rend")(C++11) |  returns a reverse iterator to the end   
