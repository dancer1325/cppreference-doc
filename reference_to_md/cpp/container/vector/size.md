...
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/vector/example_size&action=edit)

The following code uses `size` to display the number of elements in a [std::vector](../vector.html)<int>:
...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<int> nums;
