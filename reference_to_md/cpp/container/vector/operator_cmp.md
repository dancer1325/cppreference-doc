...
bool operator==( const [std::vector](../vector.html)<T, Alloc>& lhs,  
const [std::vector](../vector.html)<T, Alloc>& rhs ); |  (1) | (constexpr since C++20)  
template< class T, class Alloc >  
bool operator!=( const [std::vector](../vector.html)<T, Alloc>& lhs,  
const [std::vector](../vector.html)<T, Alloc>& rhs ); |  (2)  |  (until C++20)  
template< class T, class Alloc >  
bool operator< ( const [std::vector](../vector.html)<T, Alloc>& lhs,  
const [std::vector](../vector.html)<T, Alloc>& rhs ); |  (3)  |  (until C++20)  
template< class T, class Alloc >  
bool operator<=( const [std::vector](../vector.html)<T, Alloc>& lhs,  
const [std::vector](../vector.html)<T, Alloc>& rhs ); |  (4)  |  (until C++20)  
template< class T, class Alloc >  
bool operator> ( const [std::vector](../vector.html)<T, Alloc>& lhs,  
const [std::vector](../vector.html)<T, Alloc>& rhs ); |  (5)  |  (until C++20)  
template< class T, class Alloc >  
bool operator>=( const [std::vector](../vector.html)<T, Alloc>& lhs,  
const [std::vector](../vector.html)<T, Alloc>& rhs ); |  (6)  |  (until C++20)  
template< class T, class Alloc >  
constexpr /* see below */  
operator<=>( const [std::vector](../vector.html)<T, Alloc>& lhs,  
const [std::vector](../vector.html)<T, Alloc>& rhs ); |  (7) | (since C++20)   
(constexpr since C++20)  
| |   
  
Compares the contents of two `vector`s. 

Let `value_type` be the value type of `vector` (i.e., typename vector::value_type): 
