[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/capacity&action=edit)
...
## Contents
  ...
  * [4 Example](capacity.html#Example)
  * [5 See also](capacity.html#See_also)
...
Run this code
    ...
     
        auto cap = v.capacity();
        [std::cout](../../io/cout.html) << "Initial size: " << v.size() << ", capacity: " << cap << '\n';
     
        ...
        while (sz-- > 0)
        {
            ...
            if (cap != v.capacity())
            {
                [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)( 7) << v.size()
                          << [std::setw](../../io/manip/setw.html)(11) << v.capacity()
                          << [std::setw](../../io/manip/setw.html)(10) << v.capacity() / static_cast<float>(cap) << '\n';
                cap = v.capacity();
            }
        }
     
