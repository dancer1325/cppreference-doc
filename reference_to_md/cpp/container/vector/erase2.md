...
constexpr typename [std::vector](../vector.html)<T, Alloc>::size_type  
erase( [std::vector](../vector.html)<T, Alloc>& c, const U& value ); |  |  (since C++20)   
(until C++26)  
template< class T, class Alloc, class U = T >  
constexpr typename [std::vector](../vector.html)<T, Alloc>::size_type  
erase( [std::vector](../vector.html)<T, Alloc>& c, const U& value ); |  |  (since C++26)  
template< class T, class Alloc, class Pred >  
constexpr typename [std::vector](../vector.html)<T, Alloc>::size_type  
erase_if( [std::vector](../vector.html)<T, Alloc>& c, Pred pred ); |  (2) | (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<char> cnt(10);
    ...
     
        [std::vector](../vector.html)<[std::complex](../../numeric/complex.html)<double>> nums{{2, 2}, {4, 2}, {4, 8}, {4, 2}};
        #ifdef __cpp_lib_algorithm_default_value_type
            std::erase(nums, {4, 2});
        #else
            std::erase(nums, [std::complex](../../numeric/complex.html)<double>{4, 2});
        #endif
