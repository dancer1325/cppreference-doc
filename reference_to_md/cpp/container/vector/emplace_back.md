[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/emplace_back&action=edit)
...
If after the operation the new [`size()`](size.html "cpp/container/vector/size") is greater than old [`capacity()`](capacity.html "cpp/container/vector/capacity") a reallocation takes place, in which case all iterators (including the [`end()`](end.html "cpp/container/vector/end") iterator) and all references to the elements are invalidated. Otherwise only the [`end()`](end.html "cpp/container/vector/end") iterator is invalidated. 
...
## Contents
  ...
  * [5 Notes](emplace_back.html#Notes)
  * [6 Example](emplace_back.html#Example)
  * [7 See also](emplace_back.html#See_also)
...
-If any of the following conditions is satisfied, the behavior is undefined: 
  ...
  * `T` is not [EmplaceConstructible](../../named_req/EmplaceConstructible.html "cpp/named req/EmplaceConstructible") into `vector` from args.... 
  * `T` is not [MoveInsertable](../../named_req/MoveInsertable.html "cpp/named req/MoveInsertable") into `vector`. 
...
If an exception is thrown for any reason, this function has no effect ([strong exception safety guarantee](../../language/exceptions.html#Exception_safety "cpp/language/exceptions")). If the move constructor of `T` is not noexcept and is not [CopyInsertable](../../named_req/CopyInsertable.html "cpp/named req/CopyInsertable") into *this, `vector` will use the throwing move constructor. If it throws, the guarantee is waived and the effects are unspecified. 

###  Notes

Since reallocation may take place, `emplace_back` requires the element type to be [MoveInsertable](../../named_req/MoveInsertable.html "cpp/named req/MoveInsertable") for `vector`. 
...
Run this code
    ...
    struct President
    {
        ...
        [std::string](../../string/basic_string.html) country;
        int year;
     
        President([std::string](../../string/basic_string.html) p_name, [std::string](../../string/basic_string.html) p_country, int p_year)
            : name(std::move(p_name)), country(std::move(p_country)), year(p_year)
        {
            [std::cout](../../io/cout.html) << "I am being constructed.\n";
        }
     
        President(President&& other)
            : name(std::move(other.name)), country(std::move(other.country)), year(other.year)
        {
            [std::cout](../../io/cout.html) << "I am being moved.\n";
        }
     
    ...
    int main()
    {
        [std::vector](../vector.html)<President> elections;
        [std::cout](../../io/cout.html) << "emplace_back:\n";
        auto& ref = elections.emplace_back("Nelson Mandela", "South Africa", 1994);
        [assert](../../error/assert.html)(ref.year == 1994 && "uses a reference to the created object (C++17)");
     
        [std::vector](../vector.html)<President> reElections;
        [std::cout](../../io/cout.html) << "\npush_back:\n";
        reElections.push_back(President("Franklin Delano Roosevelt", "the USA", 1936));
     
        [std::cout](../../io/cout.html) << "\nContents:\n";
        for (const President& president: elections)
            [std::cout](../../io/cout.html) << president.name << " was elected president of "
                      << president.country << " in " << president.year << ".\n";
     
        for (const President& president: reElections)
            [std::cout](../../io/cout.html) << president.name << " was re-elected president of "
                      << president.country << " in " << president.year << ".\n";
    }
