...
vector& operator=( [std::initializer_list](../../utility/initializer_list.html)<value_type> ilist ); |  (3) | (since C++11)   
(constexpr since C++20)  
| |   
...
2) [`noexcept`](../../language/noexcept_spec.html "cpp/language/noexcept spec") specification: noexcept([std::allocator_traits](../../memory/allocator_traits.html)<Allocator>::propagate_on_container_move_assignment::value  
...
The following code uses operator= to assign one [std::vector](../vector.html "cpp/container/vector") to another:
...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<int> x{1, 2, 3}, y, z;
...
[ (constructor)](vector.html "cpp/container/vector/vector") |  constructs the `vector`   
