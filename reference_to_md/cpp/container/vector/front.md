...
If [empty()](empty.html "cpp/container/vector/empty") is true, the behavior is undefined.  | (until C++26)  
---|---  
If [empty()](empty.html "cpp/container/vector/empty") is true: 
...
The following code uses `front` to display the first element of a [std::vector](../vector.html)<char>:
...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<char> letters{'a', 'b', 'c', 'd'};
...
(public member function)   
[ data](data.html "cpp/container/vector/data") |  direct access to the underlying contiguous storage   
(public member function) 
