...
Inserts copies of elements from the range rg before [`end()`](end.html "cpp/container/vector/end"), in non-reversing order. 
...
## Contents
  ...
  * [4 Notes](append_range.html#Notes)
  * [5 Example](append_range.html#Example)
  * [6 See also](append_range.html#See_also)
...
Run this code
    ...
    int main()
    {
        auto head = [std::vector](../vector.html){1, 2, 3, 4};
        const auto tail = [std::list](../list.html){-5, -6, -7};
