...
void swap( [std::vector](../vector.html)<T, Alloc>& lhs,  
[std::vector](../vector.html)<T, Alloc>& rhs ); |  |  (until C++17)  
template< class T, class Alloc >  
void swap( [std::vector](../vector.html)<T, Alloc>& lhs,  
[std::vector](../vector.html)<T, Alloc>& rhs )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++20)  
| |   
  
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::vector](../vector.html "cpp/container/vector"). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs). 

## Contents

  * [1 Parameters](std_swap.html#Parameters)
  * [2 Complexity](std_swap.html#Complexity)
  * [3 Exceptions](std_swap.html#Exceptions)
  * [4 Example](std_swap.html#Example)
  * [5 See also](std_swap.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::vector](../vector.html)<int> alice{1, 2, 3};
        [std::vector](../vector.html)<int> bob{7, 8, 9, 10};
     
...
[ swap](swap.html "cpp/container/vector/swap") |  swaps the contents   
