...
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/deque/example_size&action=edit)

The following code uses `size` to display the number of elements in a [std::deque](../deque.html "cpp/container/deque"):
...
Run this code
    ...
    int main()
    { 
        [std::deque](../deque.html)<int> nums{1, 3, 5, 7};
     
...
[ resize](resize.html "cpp/container/deque/resize") |  changes the number of elements stored   
