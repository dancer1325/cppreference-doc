...
Erases all elements from the container. After this call, [size()](size.html "cpp/container/deque/size") returns zero. 
...
Run this code
    ...
    #include <deque>
     
    void print_info([std::string_view](../../string/basic_string_view.html) rem, const [std::deque](../deque.html)<int>& v)
    {
    ...
    int main()
    {
        [std::deque](../deque.html)<int> container{1, 2, 3};
