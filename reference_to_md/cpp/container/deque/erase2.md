...
typename [std::deque](../deque.html)<T, Alloc>::size_type  
erase( [std::deque](../deque.html)<T, Alloc>& c, const U& value ); |  |  (since C++20)   
(until C++26)  
template< class T, class Alloc, class U = T >  
constexpr typename [std::deque](../deque.html)<T, Alloc>::size_type  
erase( [std::deque](../deque.html)<T, Alloc>& c, const U& value ); |  |  (since C++26)  
template< class T, class Alloc, class Pred >  
typename [std::deque](../deque.html)<T, Alloc>::size_type  
erase_if( [std::deque](../deque.html)<T, Alloc>& c, Pred pred ); |  (2) | (since C++20)   
...
Run this code
    ...
    int main()
    {
        [std::deque](../deque.html)<char> cnt(10);
    ...
     
        [std::deque](../deque.html)<[std::complex](../../numeric/complex.html)<double>> nums{{2, 2}, {4, 2}, {4, 8}, {4, 2}};
