...
If *this is empty, the returned iterator will be equal to [end()](end.html "cpp/container/deque/end"). 
...
[ endcend](end.html "cpp/container/deque/end")(C++11) |  returns an iterator to the end   
