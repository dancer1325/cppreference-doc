...
---|---|---  
const_reference back() const; |  (2) | (constexpr since C++26)  
| |   
  
Returns a reference to the last element in the container. 

If [empty()](empty.html "cpp/container/deque/empty") is true, the behavior is undefined.  | (until C++26)  
---|---  
If [empty()](empty.html "cpp/container/deque/empty") is true: 
...
Run this code
    ...
    int main()
    {
        [std::deque](../deque.html)<char> letters{'a', 'b', 'c', 'd'};
