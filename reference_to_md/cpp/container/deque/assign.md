...
void assign( InputIt first, InputIt last ); |  (2) | (constexpr since C++26)  
...
The following code uses `assign` to add several characters to a [std::deque](../deque.html)<char>:
...
Run this code
    ...
    int main()
    {
        [std::deque](../deque.html)<char> characters;
     
        auto print_deque = [&]()
        {
...
---|---|---|---  
[LWG 2209](https://cplusplus.github.io/LWG/issue2209) | C++98  | the replacement operation was required to be implemented as  
erasing all existing elements followed by inserting the given elements  | removed the  
requirement   
  
### See also

[ assign_range](assign_range.html "cpp/container/deque/assign range")(C++23) |  assigns a range of values to the container   
