...
Iterators and references to the last element are invalidated. The [`end()`](end.html "cpp/container/deque/end") iterator is also invalidated. 
...
Run this code
    ...
    int main()
    {
        [std::deque](../deque.html)<int> numbers{1, 2, 3};
        stq::println("{}", numbers);
