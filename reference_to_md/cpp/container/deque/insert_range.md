...
pos  |  \-  |  iterator before which the content will be inserted (pos may be the [`end()`](end.html "cpp/container/deque/end") iterator)   
---|---|---  
...
Run this code
    ...
    int main()
    {
        auto container = [std::deque](../deque.html){1, 2, 3, 4};
    ...
    #endif
        [assert](../../error/assert.html)(std::[ranges::equal](../../algorithm/ranges/equal.html)(container, [std::deque](../deque.html){1, 2, -1, -2, -3, 3, 4}));
    }
