...
deque& operator=( const deque& other ); |  (1) | (constexpr since C++26)  
---|---|---  
| (2) |   
deque& operator=( deque&& other ); |  | (since C++11)   
(until C++17)  
deque& operator=( deque&& other )  
noexcept(/* see below */); |  | (since C++17)   
(constexpr since C++26)  
deque& operator=( [std::initializer_list](../../utility/initializer_list.html)<value_type> ilist ); |  (3) | (since C++11)   
(constexpr since C++26)  
| |   
...
The following code uses operator= to assign one [std::deque](../deque.html "cpp/container/deque") to another:
...
Run this code
    ...
    int main()
    {
        [std::deque](../deque.html)<int> x{1, 2, 3}, y, z;
...
[ (constructor)](deque.html "cpp/container/deque/deque") |  constructs the `deque`   
