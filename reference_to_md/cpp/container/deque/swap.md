...
All iterators and references remain valid. The [`end()`](end.html "cpp/container/deque/end") iterator is invalidated. 
...
Run this code
    ...
    int main()
    {
        [std::deque](../deque.html)<int> a1{1, 2, 3}, a2{4, 5};
     
...
[ std::swap(std::deque)](swap2.html "cpp/container/deque/swap2") |  specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm   
(function template)   
---|---
