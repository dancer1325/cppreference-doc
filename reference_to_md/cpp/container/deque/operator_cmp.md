...
bool operator==( const [std::deque](../deque.html)<T, Alloc>& lhs,  
const [std::deque](../deque.html)<T, Alloc>& rhs ); |  (1) | (constexpr since C++26)  
template< class T, class Alloc >  
bool operator!=( const [std::deque](../deque.html)<T, Alloc>& lhs,  
const [std::deque](../deque.html)<T, Alloc>& rhs ); |  (2)  |  (until C++20)  
template< class T, class Alloc >  
bool operator< ( const [std::deque](../deque.html)<T, Alloc>& lhs,  
const [std::deque](../deque.html)<T, Alloc>& rhs ); |  (3)  |  (until C++20)  
template< class T, class Alloc >  
bool operator<=( const [std::deque](../deque.html)<T, Alloc>& lhs,  
const [std::deque](../deque.html)<T, Alloc>& rhs ); |  (4)  |  (until C++20)  
template< class T, class Alloc >  
bool operator> ( const [std::deque](../deque.html)<T, Alloc>& lhs,  
const [std::deque](../deque.html)<T, Alloc>& rhs ); |  (5)  |  (until C++20)  
template< class T, class Alloc >  
bool operator>=( const [std::deque](../deque.html)<T, Alloc>& lhs,  
const [std::deque](../deque.html)<T, Alloc>& rhs ); |  (6)  |  (until C++20)  
template< class T, class Alloc >  
/* see below */  
operator<=>( const [std::deque](../deque.html)<T, Alloc>& lhs,  
const [std::deque](../deque.html)<T, Alloc>& rhs ); |  (7) | (since C++20)   
(constexpr since C++26)  
| |   
  
Compares the contents of two `deque`s. 

Let `value_type` be the value type of `deque` (i.e., typename deque::value_type): 
...
1,2) Constant if lhs and rhs are of different size, otherwise linear in the size of the `deque`.
