...
The following code uses `front` to display the first element of a [std::deque](../deque.html)<char>:
...
[ back](back.html "cpp/container/deque/back") |  access the last element   
