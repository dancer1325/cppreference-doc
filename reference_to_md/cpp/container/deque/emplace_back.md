...
All iterators (including the [`end()`](end.html "cpp/container/deque/end") iterator) are invalidated. No references are invalidated. 
...
Run this code
    ...
    int main()
    {
        [std::deque](../deque.html)<President> elections;
    ...
     
        [std::deque](../deque.html)<President> reElections;
