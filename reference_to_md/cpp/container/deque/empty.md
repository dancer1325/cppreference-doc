...
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/deque/example_empty&action=edit)

The following code uses `empty` to check if a [std::deque](../deque.html)<int> contains any elements:
...
Run this code
    ...
    int main()
    {
        [std::deque](../deque.html)<int> numbers;
