...
Member functions  
---  
[indirect_array::indirect_array](indirect_array/indirect_array.html "cpp/numeric/valarray/indirect array/indirect array")  
[indirect_array::~indirect_array](indirect_array/~indirect_array.html "cpp/numeric/valarray/indirect array/~indirect array")  
...
Run this code
    ...
     
        [std::valarray](../valarray.html)<[std::size_t](../../types/size_t.html)> idx{0, 2, 4, 6, 8};
     
        [std::cout](../../io/cout.html) << "Original valarray: ";
        for (int n : data)
    ...
     
        [std::cout](../../io/cout.html) << "After indirect modification: ";
        for (int n : data)
            [std::cout](../../io/cout.html) << n << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
