...
## Contents
  ...
  * [3 Notes](abs.html#Notes)
  * [4 Possible implementation](abs.html#Possible_implementation)
  * [5 Example](abs.html#Example)
  * [6 See also](abs.html#See_also)
...
Unqualified function (abs) is used to perform the computation. If such function is not available, std::abs is used due to [argument-dependent lookup](../../language/adl.html "cpp/language/adl"). 
...
Run this code
    ...
    int main()
    {
        ...
        [std::valarray](../valarray.html)<int> v2 = std::abs(v);
        for (auto n : v2)
