...
## Contents
  ...
  * [3 Notes](log.html#Notes)
  * [4 Possible implementation](log.html#Possible_implementation)
...
Unqualified function (log) is used to perform the computation. If such function is not available, [std::log](../math/log.html) is used due to [argument-dependent lookup](../../language/adl.html "cpp/language/adl"). 
...
Run this code
    ...
    {
        [std::cout](../../io/cout.html) << title << " :" << [std::right](../../io/manip/left.html) << [std::fixed](../../io/manip/fixed.html);
        for (double x : va)
            [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(10) << x;
        [std::cout](../../io/cout.html) << '\n';
    }
     
    int main()
    {
        const [std::valarray](../valarray.html)<double> n{0.0, 1.0, 2.0, 3.0};
        const [std::valarray](../valarray.html)<double> exp_n{[std::exp](../math/exp.html)(n)};
        const [std::valarray](../valarray.html)<double> log_exp_n{[std::log](../math/log.html)(exp_n)};
     
        show("n      ", n);
        show("eⁿ     ", exp_n);
...
[ log10(std::valarray)](log10.html "cpp/numeric/valarray/log10") |  applies the function [std::log10](../math/log10.html "cpp/numeric/math/log10") to each element of valarray   
(function template)   
---|---  
[ exp(std::valarray)](exp.html "cpp/numeric/valarray/exp") |  applies the function [std::exp](../math/exp.html "cpp/numeric/math/exp") to each element of valarray   
(function template)   
