...
---|---|---  
template< class T >   
[std::valarray](../valarray.html)<T> pow( const [std::valarray](../valarray.html)<T>& base, const [std::valarray](../valarray.html)<T>& exp ); |  (1)  |   
template< class T >   
[std::valarray](../valarray.html)<T> pow( const [std::valarray](../valarray.html)<T>& base,   
const typename [std::valarray](../valarray.html)<T>::value_type& vexp ); |  (2)  |   
template< class T >   
[std::valarray](../valarray.html)<T> pow( const typename [std::valarray](../valarray.html)<T>::value_type& vbase,  
const [std::valarray](../valarray.html)<T>& exp ); |  (3)  |   
| |   
...
## Contents
  ...
  * [5 Defect reports](pow.html#Defect_reports)
...
Run this code
    ...
    class show
    {
        friend [std::ostream](../../io/basic_ostream.html)& operator<<([std::ostream](../../io/basic_ostream.html)& os, show const& r)
        {
    ...
     
            for ([std::size_t](../../types/size_t.html) n = 0; n != r.bases.size(); ++n)
            {
                os << [std::left](../../io/manip/left.html) << r.bases[n] << [std::left](../../io/manip/left.html);
    ...
     
            ...
            {
                os << '=';
                for ([std::size_t](../../types/size_t.html) n = 0; n != r.results.size(); ++n)
                    os << ' ' << r.results[n];
            }
     
            return os << '\n';
    ...
     
    public:
        [std::valarray](../valarray.html)<int> bases{}, exponents{}, results{};
    };
     
    int main()
    {
        ...
        const [std::valarray](../valarray.html)<int> bases{1, 2, 3, 4, 5, 6, 7};
        const [std::valarray](../valarray.html)<int> exponents{0, 1, 2, 3, 4, 5, 6};
        const [std::valarray](../valarray.html)<int> powers1 = [std::pow](../math/pow.html)(bases, exponents);
        const [std::valarray](../valarray.html)<int> powers2 = [std::pow](../math/pow.html)(bases, exponent);
        const [std::valarray](../valarray.html)<int> powers3 = [std::pow](../math/pow.html)(base, exponents);
     
        [std::cout](../../io/cout.html)
            ...
            << "base : " << show{bases}
            << "vexp : " << exponent << '\n'
            << "pow  : " << show{bases, [std::valarray](../valarray.html)<int>(exponent, bases.size()), powers2}
            << '\n'
            << "pow(const value_type& vbase, const std::valarray<T>& exp); (3)\n"
            << "vbase: " << base << '\n'
            << "exp  : " << show{exponents}
            << "pow  : " << show{[std::valarray](../valarray.html)<int>(base, bases.size()), exponents, powers3};
    }
