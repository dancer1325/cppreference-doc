...
template< class T >   
/* see below */ begin( valarray<T>& v ); |  (1)  |  (since C++11)  
---|---|---  
template< class T >   
/* see below */ begin( const valarray<T>& v ); |  (2)  |  (since C++11)  
| |   
  
The overload of [std::begin](../../iterator/begin.html "cpp/iterator/begin") for `valarray` returns an iterator of unspecified type referring to the first element in the numeric array. 

1) The return type must 

  * meet the requirements of [mutable](../../iterator.html "cpp/iterator") [LegacyRandomAccessIterator](../../named_req/RandomAccessIterator.html "cpp/named req/RandomAccessIterator"), 



  * model [`contiguous_iterator`](../../iterator/contiguous_iterator.html "cpp/iterator/contiguous iterator"), 
...
2) The return type must 
  ...
  * meet the requirements of [constant](../../iterator.html "cpp/iterator") [LegacyRandomAccessIterator](../../named_req/RandomAccessIterator.html "cpp/named req/RandomAccessIterator"), 
...
The iterator returned from this function is invalidated when the member function [`resize()`](resize.html "cpp/numeric/valarray/resize") is called on v or when the lifetime of v ends, whichever comes first. 

## Contents

  * [1 Parameters](begin2.html#Parameters)
  * [2 Return value](begin2.html#Return_value)
  * [3 Exceptions](begin2.html#Exceptions)
  * [4 Notes](begin2.html#Notes)
  * [5 Example](begin2.html#Example)
  * [6 Defect reports](begin2.html#Defect_reports)
  * [7 See also](begin2.html#See_also)
...
Run this code
    ...
    #include <valarray>
     
    void show(const [std::valarray](../valarray.html)<int>& v)
    {
        [std::for_each](../../algorithm/for_each.html)([std::begin](../../iterator/begin.html)(v), [std::end](../../iterator/end.html)(v), [](int c)
        {
    ...
    int main()
    {
        const [std::valarray](../valarray.html)<int> x{47, 70, 37, 52, 90, 23, 17, 33, 22, 16, 21, 4};
        const [std::valarray](../valarray.html)<int> y{25, 31, 71, 56, 21, 21, 15, 34, 21, 27, 12, 6};
     
        show(x); 
        show(y); 
     
        const [std::valarray](../valarray.html)<int> z{x + y};
     
        for (char c : z)
            [std::cout](../../io/cout.html) << c;
    }
...
---|---|---|---  
[LWG 2058](https://cplusplus.github.io/LWG/issue2058) | C++11  | 1\. `begin()` was required to support replacement types  
2\. it was unspecified when the returned iterators will be invalidated  | 1\. not required  
2\. specified   
  
### See also

[ std::end(std::valarray)](end2.html "cpp/numeric/valarray/end2")(C++11) |  specializes [std::end](../../iterator/end.html "cpp/iterator/end")   
(function template)   
---|---
