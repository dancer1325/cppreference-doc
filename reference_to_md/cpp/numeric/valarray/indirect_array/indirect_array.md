...
[indirect_array::operator=](operator=.html "cpp/numeric/valarray/indirect array/operator=")  
...
---|---|---  
private:  
indirect_array(); |  |  (until C++11)  
public:  
indirect_array() = delete; |  |  (since C++11)  
public:  
indirect_array( const indirect_array& other ); |  (2)  |   
| |   
  
1) The default constructor is declared private and not defined(until C++11)explicitly defined as deleted(since C++11): `indirect_array` is not [DefaultConstructible](../../../named_req/DefaultConstructible.html "cpp/named req/DefaultConstructible").
