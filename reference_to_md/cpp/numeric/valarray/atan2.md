...
---|---|---  
template< class T >   
[std::valarray](../valarray.html)<T> atan2( const [std::valarray](../valarray.html)<T>& y, const [std::valarray](../valarray.html)<T>& x ); |  (1)  |   
template< class T >   
[std::valarray](../valarray.html)<T> atan2( const [std::valarray](../valarray.html)<T>& y,  
const typename [std::valarray](../valarray.html)<T>::value_type& vx ); |  (2)  |   
template< class T >   
[std::valarray](../valarray.html)<T> atan2( const typename [std::valarray](../valarray.html)<T>::value_type& vy,  
const [std::valarray](../valarray.html)<T>& x ); |  (3)  |   
| |   
...
## Contents
  ...
  * [3 Notes](atan2.html#Notes)
  * [4 Example](atan2.html#Example)
  * [5 Defect reports](atan2.html#Defect_reports)
  * [6 See also](atan2.html#See_also)
...
Run this code
    ...
    #include <valarray>
     
    void show(char const* title, const [std::valarray](../valarray.html)<double>& va)
    {
        [std::cout](../../io/cout.html) << title << ' ';
        [std::for_each](../../algorithm/for_each.html)([std::begin](../../iterator/begin.html)(va), [std::end](../../iterator/end.html)(va), [](const double x)
        { 
            [std::cout](../../io/cout.html) << ' ' << [std::right](../../io/manip/left.html) << [std::setw](../../io/manip/setw.html)(4) << x << "°";
        });
        [std::cout](../../io/cout.html) << '\n';
    }
     
    const double pi = [std::acos](../math/acos.html)(-1.0); // C++20: std::numbers::pi
     
    int main()
    {
    ...
     
        const [std::valarray](../valarray.html)<double> degrees{-90, -60, -45, -30, 0, 30, 45, 60, 90};
        const [std::valarray](../valarray.html)<double> radians = degrees.apply(degrees_to_radians);
     
        const auto sin = [std::sin](../math/sin.html)(radians);
        const auto cos = [std::cos](../math/cos.html)(radians);
     
        show("(1)", [std::atan2](../math/atan2.html)(sin, cos).apply(radians_to_degrees));
        show("(2)", [std::atan2](../math/atan2.html)(sin/cos, 1.0).apply(radians_to_degrees));
        show("(3)", [std::atan2](../math/atan2.html)(1.0, cos/sin).apply(radians_to_degrees));
    }
