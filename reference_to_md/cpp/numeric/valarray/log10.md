...
## Contents
  ...
  * [3 Notes](log10.html#Notes)
  * [4 Possible implementation](log10.html#Possible_implementation)
...
Run this code
    ...
    #include <valarray>
     
    void show(char const* title, const [std::valarray](../valarray.html)<float>& va)
    {
        [std::cout](../../io/cout.html) << title << " : " << [std::right](../../io/manip/left.html);
        for (float x : va)
            [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(6) << x;
        [std::cout](../../io/cout.html) << '\n';
    }
     
    int main()
    {
        const [std::valarray](../valarray.html)<float> n{-2.f, -1.f, 0.f, 1.f, 2.f, 3.f, [INFINITY](../math/INFINITY.html)};
        const [std::valarray](../valarray.html)<float> pow10{[std::pow](../math/pow.html)(10.f, n)};
        const [std::valarray](../valarray.html)<float> log10_pow10{[std::log10](../math/log10.html)(pow10)};
     
        show("n      ", n);
        show("10ⁿ    ", pow10);
