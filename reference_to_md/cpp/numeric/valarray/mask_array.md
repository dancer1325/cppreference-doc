...
Member functions  
---  
[mask_array::mask_array](mask_array/mask_array.html "cpp/numeric/valarray/mask array/mask array")  
[mask_array::~mask_array](mask_array/~mask_array.html "cpp/numeric/valarray/mask array/~mask array")  
...
`std::mask_array` is a helper template used by the [valarray subscript operator](operator_at.html "cpp/numeric/valarray/operator at") with [std::valarray](../valarray.html)<bool> argument. It has reference semantics and provides access to the subset of the valarray consisting of the elements whose indices correspond to true values in the [std::valarray](../valarray.html)<bool> mask. 

## Contents

  * [1 Member types](mask_array.html#Member_types)
  * [2 Member functions](mask_array.html#Member_functions)
  * [3 Example](mask_array.html#Example)
  * [4 See also](mask_array.html#See_also)
...
Run this code
    ...
    {
        for ([std::cout](../../io/cout.html) << rem; int n : data)
