...
---|---|---  
private:  
mask_array(); |  |  (until C++11)  
public:  
mask_array() = delete; |  |  (since C++11)  
public:  
mask_array( const mask_array& other ); |  (2)  |   
| |   
  
1) The default constructor is declared private and not defined(until C++11)explicitly defined as deleted(since C++11): `mask_array` is not [DefaultConstructible](../../../named_req/DefaultConstructible.html "cpp/named req/DefaultConstructible").
