...
Member functions  
---  
[mask_array::mask_array](mask_array.html "cpp/numeric/valarray/mask array/mask array")  
[mask_array::~mask_array](~mask_array.html "cpp/numeric/valarray/mask array/~mask array")  
**mask_array::operator=**  
...
Run this code
    ...
    #include <valarray>
     
    void print([std::valarray](../../valarray.html)<int> const& v)
    {
        for (int e : v)
            [std::cout](../../../io/cout.html) << [std::setw](../../../io/manip/setw.html)(2) << e << ' ';
    ...
    int main()
    {
        ...
        [std::valarray](../../valarray.html)<int> v;
     
        v = init;
        v[(v % 2) == 0] = 0; // (1)
        print(v);
     
        v = init;
        v[(v % 2) == 1] = [std::valarray](../../valarray.html)<int>{-1, -2, -3, -4}; // (2)
        print(v);
     
        v = init;
        v[(v % 2) == 0] = v[(v % 2) == 1]; // (3)
