...
---|---|---  
template< class T >  
[std::valarray](../valarray.html)<T> operator+ ( const [std::valarray](../valarray.html)<T>& lhs, const [std::valarray](../valarray.html)<T>& rhs );  
template< class T >  
[std::valarray](../valarray.html)<T> operator- ( const [std::valarray](../valarray.html)<T>& lhs, const [std::valarray](../valarray.html)<T>& rhs );  
template< class T >  
[std::valarray](../valarray.html)<T> operator* ( const [std::valarray](../valarray.html)<T>& lhs, const [std::valarray](../valarray.html)<T>& rhs );  
...
[std::valarray](../valarray.html)<T> operator>>( const [std::valarray](../valarray.html)<T>& lhs, const [std::valarray](../valarray.html)<T>& rhs );  
template< class T >  
[std::valarray](../valarray.html)<bool> operator&&( const [std::valarray](../valarray.html)<T>& lhs, const [std::valarray](../valarray.html)<T>& rhs );  
template< class T >  
[std::valarray](../valarray.html)<bool> operator||( const [std::valarray](../valarray.html)<T>& lhs, const [std::valarray](../valarray.html)<T>& rhs ); |  (1)  |   
template< class T >  
[std::valarray](../valarray.html)<T> operator+ ( const typename [std::valarray](../valarray.html)<T>::value_type & val,  
const [std::valarray](../valarray.html)<T>& rhs );  
template< class T >  
[std::valarray](../valarray.html)<T> operator- ( const typename [std::valarray](../valarray.html)<T>::value_type & val,  
const [std::valarray](../valarray.html)<T>& rhs );  
template< class T >  
...
const [std::valarray](../valarray.html)<T>& rhs );  
template< class T >  
[std::valarray](../valarray.html)<bool> operator&&( const typename [std::valarray](../valarray.html)<T>::value_type & val,  
const [std::valarray](../valarray.html)<T>& rhs );  
template< class T >  
[std::valarray](../valarray.html)<bool> operator||( const typename [std::valarray](../valarray.html)<T>::value_type & val,  
const [std::valarray](../valarray.html)<T>& rhs ); |  (2)  |   
template< class T >  
[std::valarray](../valarray.html)<T> operator+ ( const [std::valarray](../valarray.html)<T>& lhs,  
const typename [std::valarray](../valarray.html)<T>::value_type & val );  
template< class T >  
[std::valarray](../valarray.html)<T> operator- ( const [std::valarray](../valarray.html)<T>& lhs,  
const typename [std::valarray](../valarray.html)<T>::value_type & val );  
template< class T >  
...
const typename [std::valarray](../valarray.html)<T>::value_type & val );  
template< class T >  
[std::valarray](../valarray.html)<bool> operator&&( const [std::valarray](../valarray.html)<T>& lhs,  
const typename [std::valarray](../valarray.html)<T>::value_type & val );  
template< class T >  
[std::valarray](../valarray.html)<bool> operator||( const [std::valarray](../valarray.html)<T>& lhs,  
const typename [std::valarray](../valarray.html)<T>::value_type & val ); |  (3)  |   
| |   
...
## Contents
  ...
  * [3 Note](operator_arith3.html#Note)
  * [4 Example](operator_arith3.html#Example)
  * [5 Defect reports](operator_arith3.html#Defect_reports)
  * [6 See also](operator_arith3.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::valarray](../valarray.html)<double> a(1, 8);
        [std::valarray](../valarray.html)<double> b{1, 2, 3, 4, 5, 6, 7, 8};
        [std::valarray](../valarray.html)<double> c = -b;
        // literals must also be of type T until LWG3074 (double in this case)
        [std::valarray](../valarray.html)<double> d = [std::sqrt](../math/sqrt.html)(b * b - 4.0 * a * c);
        [std::valarray](../valarray.html)<double> x1 = 2.0 * c / (-b + d);
        [std::valarray](../valarray.html)<double> x2 = 2.0 * c / (-b - d);
        [std::cout](../../io/cout.html) << "quadratic equation:  root 1:    root 2:   b: c:\n";
        for ([std::size_t](../../types/size_t.html) i = 0; i < a.size(); ++i)
            [std::cout](../../io/cout.html) << a[i] << "\u00B7x\u00B2 + " << b[i] << "\u00B7x + "
                      << c[i] << " = 0  " << [std::fixed](../../io/manip/fixed.html) << x1[i]
                      << "  " << x2[i] << [std::defaultfloat](../../io/manip/fixed.html)
                      << "  " << -x1[i] - x2[i]
                      << "  " << x1[i] * x2[i] << '\n';
    }
