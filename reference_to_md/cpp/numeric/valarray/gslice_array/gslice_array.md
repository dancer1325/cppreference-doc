[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/valarray/array/constructor&action=edit)
...
[`std::gslice_array`](../gslice_array.html "cpp/numeric/valarray/gslice array")

Member functions  
---  
**gslice_array::gslice_array**  
[gslice_array::~gslice_array](~gslice_array.html "cpp/numeric/valarray/gslice array/~gslice array")  
[gslice_array::operator=](operator=.html "cpp/numeric/valarray/gslice array/operator=")  
[gslice_array::operator+=gslice_array::operator-=gslice_array::operator*=gslice_array::operator/=gslice_array::operator%=gslice_array::operator&=gslice_array::operator|=gslice_array::operator^=gslice_array::operator<<=gslice_array::operator>>=](operator_arith.html "cpp/numeric/valarray/gslice array/operator arith")  
...
---|---|---  
private:  
gslice_array(); |  |  (until C++11)  
public:  
gslice_array() = delete; |  |  (since C++11)  
public:  
gslice_array( const gslice_array& other ); |  (2)  |   
| |   
  
1) The default constructor is declared private and not defined(until C++11)explicitly defined as deleted(since C++11): `gslice_array` is not [DefaultConstructible](../../../named_req/DefaultConstructible.html "cpp/named req/DefaultConstructible").
...
---|---|---|---  
[LWG 253](https://cplusplus.github.io/LWG/issue253) | C++98  | the copy constructor was private  | made public 
