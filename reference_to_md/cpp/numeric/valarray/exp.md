...
For each element in va computes _e_ raised to the power equal to the value of the element. 

## Contents

  * [1 Parameters](exp.html#Parameters)
  * [2 Return value](exp.html#Return_value)
  * [3 Notes](exp.html#Notes)
  * [4 Possible implementation](exp.html#Possible_implementation)
...
Run this code
    ...
    int main()
    {
        const double pi = [std::numbers::pi](../constants.html);
        [std::valarray](../valarray.html)<[std::complex](../complex.html)<double>> v =
        {
            {0, 0}, {0, pi / 2}, {0, pi}, {0, 3 * pi / 2}, {0, 2 * pi}
        };
        [std::valarray](../valarray.html)<[std::complex](../complex.html)<double>> v2 = [std::exp](../math/exp.html)(v);
        for ([std::cout](../../io/cout.html) << [std::showpos](../../io/manip/showpos.html) << [std::fixed](../../io/manip/fixed.html); auto n : v2)
