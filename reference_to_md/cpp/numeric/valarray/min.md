...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/min&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/min&action=edit&section=2 "Edit section: Return value")] Return value

The minimum of the elements. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/min&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "Minimum value : " << a.min() << "\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/min&action=edit&section=4 "Edit section: See also")] See also

[ max](max.html "cpp/numeric/valarray/max") |  returns the largest element   
