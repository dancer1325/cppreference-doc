...
`std::slice` is the selector class that identifies a subset of [std::valarray](../valarray.html "cpp/numeric/valarray") similar to [BLAS](https://en.wikipedia.org/wiki/BLAS "enwiki:BLAS") slice. An object of type `std::slice` holds three values: the starting index, the stride, and the total number of values in the subset. Objects of type `std::slice` can be used as indices with valarray's operator[]. 

## Contents

  * [1 Member functions](slice.html#Member_functions)
  * [2 std::slice::slice](slice.html#std::slice::slice)
    * [2.1 Parameters](slice.html#Parameters)
  * [3 std::slice::start, size, stride](slice.html#std::slice::start.2C_size.2C_stride)
    * [3.1 Parameters](slice.html#Parameters_2)
    * [3.2 Return value](slice.html#Return_value)
    * [3.3 Complexity](slice.html#Complexity)
    * [3.4 Non-member functions](slice.html#Non-member_functions)
  * [4 operator==(std::slice)](slice.html#operator.3D.3D.28std::slice.29)
    * [4.1 Parameters](slice.html#Parameters_3)
    * [4.2 Return value](slice.html#Return_value_2)
    * [4.3 Example](slice.html#Example)
    * [4.4 Defect reports](slice.html#Defect_reports)
    * [4.5 See also](slice.html#See_also)
...
---|---  
** startsizestride** |  returns the parameters of the slice   
(public member function)  
...
slice() |  (1)  |   
---|---|---  
slice( [std::size_t](../../types/size_t.html) start, [std::size_t](../../types/size_t.html) size, [std::size_t](../../types/size_t.html) stride ); |  (2)  |   
...
[std::size_t](../../types/size_t.html) start() const; |  (1)  |   
---|---|---  
[std::size_t](../../types/size_t.html) size() const; |  (2)  |   
[std::size_t](../../types/size_t.html) stride() const; |  (3)  |   
| |   
...
Run this code
    ...
    class Matrix
    {
        [std::valarray](../valarray.html)<int> data;
        int dim;
    public:
    ...
    int main()
    {
        ...
        for (int r = 0; r < 3; ++r)
           for (int c = 0; c < 3; ++c)
               m(r, c) = ++n;
        [std::cout](../../io/cout.html) << "Trace of the matrix (1,2,3) (4,5,6) (7,8,9) is " << m.trace() << '\n';
    }
