...
## Contents
  ...
  * [1 Member functions](gslice.html#Member_functions)
  * [2 std::gslice::gslice](gslice.html#std::gslice::gslice)
    * [2.1 Parameters](gslice.html#Parameters)
  * [3 std::slice::start, size, stride](gslice.html#std::slice::start.2C_size.2C_stride)
    * [3.1 Parameters](gslice.html#Parameters_2)
    * [3.2 Return value](gslice.html#Return_value)
    * [3.3 Complexity](gslice.html#Complexity)
    * [3.4 Example](gslice.html#Example)
    * [3.5 Defect reports](gslice.html#Defect_reports)
    * [3.6 See also](gslice.html#See_also)
...
gslice() |  (1)  |   
---|---|---  
gslice( [std::size_t](../../types/size_t.html) start, const [std::valarray](../valarray.html)<[std::size_t](../../types/size_t.html)>& sizes,  
const [std::valarray](../valarray.html)<[std::size_t](../../types/size_t.html)>& strides ); |  (2)  |   
gslice( const gslice& other ); |  (3)  |   
| |   
  
Constructs a new generic slice. 

1) Default constructor. Equivalent to gslice(0, [std::valarray](../valarray.html)<[std::size_t](../../types/size_t.html)>(), [std::valarray](../valarray.html)<[std::size_t](../../types/size_t.html)>()). This constructor exists only to allow construction of arrays of slices.
...
---|---|---  
[std::valarray](../valarray.html)<[std::size_t](../../types/size_t.html)> size() const; |  (2)  |   
[std::valarray](../valarray.html)<[std::size_t](../../types/size_t.html)> stride() const; |  (3)  |   
| |   
...
Run this code
    ...
    #include <valarray>
     
    void test_print([std::valarray](../valarray.html)<int>& v, int planes, int rows, int cols)
    {
        for (int r = 0; r < rows; ++r)
        {
            for (int z = 0; z < planes; ++z)
            {
                for (int c = 0; c < cols; ++c)
                    [std::cout](../../io/cout.html) << v[z * rows * cols + r * cols + c] << ' ';
    ...
    int main()
    {
        [std::valarray](../valarray.html)<int> v = // 3d array: 2 x 4 x 3 elements
            {111,112,113 , 121,122,123 , 131,132,133 , 141,142,143,
             211,212,213 , 221,222,223 , 231,232,233 , 241,242,243};
        // int ar3d[2][4][3]
        [std::cout](../../io/cout.html) << "Initial 2x4x3 array:\n";
        test_print(v, 2, 4, 3);
     
