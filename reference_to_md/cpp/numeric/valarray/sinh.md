...
## Contents
  ...
  * [1 Parameters](sinh.html#Parameters)
  * [2 Return value](sinh.html#Return_value)
  * [3 Notes](sinh.html#Notes)
  * [4 Possible implementation](sinh.html#Possible_implementation)
  * [5 Example](sinh.html#Example)
  * [6 See also](sinh.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/sinh&action=edit&section=1 "Edit section: Parameters")] Parameters

va  |  \-  |  value array to apply the operation to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/sinh&action=edit&section=2 "Edit section: Return value")] Return value

Value array containing hyperbolic sine of the values in va. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/sinh&action=edit&section=3 "Edit section: Notes")] Notes

Unqualified function (sinh) is used to perform the computation. If such function is not available, [std::sinh](../math/sinh.html) is used due to [argument-dependent lookup](../../language/adl.html "cpp/language/adl"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/sinh&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/sinh&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
    template<typename T>
    void show(char const* title, const [std::valarray](../valarray.html)<T>& va)
    {
        [std::cout](../../io/cout.html) << title << " : " << [std::right](../../io/manip/left.html);
        for (T x : va)
            [std::cout](../../io/cout.html) << [std::fixed](../../io/manip/fixed.html) << x << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
     
    template<typename T>
    void sinh_for([std::valarray](../valarray.html)<T> const& z)
    {
        // Hyperbolic sine is sinh(z) = (eᶻ - e⁻ᶻ) / 2.
     
        const [std::valarray](../valarray.html)<T> sinh_z{[std::sinh](../math/sinh.html)(z)};
        const [std::valarray](../valarray.html)<T> e_z{[std::exp](../math/exp.html)(z)};
        const [std::valarray](../valarray.html)<T> e_neg_z{[std::exp](../math/exp.html)(-z)};
        const [std::valarray](../valarray.html)<T> sinh_def{(e_z - e_neg_z) / 2.0f};
     
        show("n         ", z);
        show("sinh(n)   ", sinh_z);
        show("(eⁿ-e⁻ⁿ)/2", sinh_def);
     
        [std::cout](../../io/cout.html).put('\n');
    }
     
    int main()
    {
        sinh_for([std::valarray](../valarray.html)<float>{-.2f, -.1f, 0.f, .1f, .2f, [INFINITY](../math/INFINITY.html)});
        sinh_for([std::valarray](../valarray.html)<[std::complex](../complex.html)<double>>{{-.2,-.1}, {.2,.1}});
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/sinh&action=edit&section=6 "Edit section: See also")] See also

[ cosh(std::valarray)](cosh.html "cpp/numeric/valarray/cosh") |  applies the function [std::cosh](../math/cosh.html "cpp/numeric/math/cosh") to each element of valarray   
...
---|---  
[ tanh(std::valarray)](tanh.html "cpp/numeric/valarray/tanh") |  applies the function [std::tanh](../math/tanh.html "cpp/numeric/math/tanh") to each element of valarray   
