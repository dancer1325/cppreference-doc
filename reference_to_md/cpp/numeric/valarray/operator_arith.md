...
## Contents
  ...
  * [3 Exceptions](operator_arith.html#Exceptions)
  * [4 Notes](operator_arith.html#Notes)
  * [5 Example](operator_arith.html#Example)
  * [6 See also](operator_arith.html#See_also)
...
Run this code
    ...
     
    template<typename T>
    void print([std::string_view](../../string/basic_string_view.html) const note,
               [std::valarray](../valarray.html)<T> const vala, // by-value, see Notes above
               [std::string_view](../../string/basic_string_view.html) const term = "\n")
    {
        [std::cout](../../io/cout.html) << note << [std::boolalpha](../../io/manip/boolalpha.html) << [std::showpos](../../io/manip/showpos.html);
    ...
    int main()
    {
        [std::valarray](../valarray.html)<int> x{1, 2, 3, 4};
        print<int>("x: ", x);
        print<int>("+x: ", +x);
        print<int>("+ + x: ", + + x);
        print<int>("-x: ", -x);
        print<int>("- - x: ", - - x, "\n\n");
     
        [std::valarray](../valarray.html)<short> y{0, 1, -1, 0x7fff};
        print<short>("y: ", y);
        print<short>("~y: ", ~y);
        print<short>("~~y: ", ~~y, "\n\n");
     
        [std::valarray](../valarray.html)<bool> z{true, false};
        print<bool>("z: ", z);
        print<bool>("!z: ", !z);
        print<bool>("!!z: ", !!z);
    }
