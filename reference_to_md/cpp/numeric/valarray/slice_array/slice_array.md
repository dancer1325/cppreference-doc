...
---|---|---  
private:  
slice_array(); |  |  (until C++11)  
public:  
slice_array() = delete; |  |  (since C++11)  
public:  
slice_array( const slice_array& other ); |  (2)  |   
| |   
  
1) The default constructor is declared private and not defined(until C++11)explicitly defined as deleted(since C++11): `slice_array` is not [DefaultConstructible](../../../named_req/DefaultConstructible.html "cpp/named req/DefaultConstructible").
