...
Member functions  
---  
[slice_array::slice_array](slice_array.html "cpp/numeric/valarray/slice array/slice array")  
[slice_array::~slice_array](~slice_array.html "cpp/numeric/valarray/slice array/~slice array")  
...
other_arr  |  \-  |  [std::slice_array](../slice_array.html "cpp/numeric/valarray/slice array") to assign   
...
Run this code
    ...
    #include <valarray>
     
    void print(char const* remark, [std::valarray](../../valarray.html)<int> const& v = {})
    {
    ...
    int main()
    {
        [std::valarray](../../valarray.html)<int> v1{1, 2, 3, 4, 5, 6, 7, 8};
        [std::slice_array](../slice_array.html)<int> s1 = v1[[std::slice](../slice.html)(1, 4, 2)];
        print("v1", v1);
        print("s1", s1);
     
        print("\n(1) operator=( const T& )");
    ...
     
        ...
        [std::valarray](../../valarray.html)<int> v2{10, 11, 12, 13, 14, 15};
        print("v2", v2);
        print("s1 = v2");
        s1 = v2; // (2)
        print("s1", s1);
    ...
     
        ...
        v1 = {1, 2, 3, 4, 5, 6, 7, 8};
        [std::slice_array](../slice_array.html)<int> s2 = v1[[std::slice](../slice.html)(0, 4, 1)];
        [std::slice_array](../slice_array.html)<int> s3 = v2[[std::slice](../slice.html)(1, 4, 1)];
        print("v1", v1);
        print("v2", v2);
        print("s2", s2);
        print("s3", s3);
