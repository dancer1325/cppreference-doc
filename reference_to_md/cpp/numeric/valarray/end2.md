...
---|---|---  
template< class T >   
/* see below */ end( const valarray<T>& v ); |  (2)  |  (since C++11)  
| |   
  
The overload of [std::end](../../iterator/end.html "cpp/iterator/end") for `valarray` returns an iterator of unspecified type referring to the one past the last element in the numeric array. 
...
## Contents
  ...
  * [3 Exceptions](end2.html#Exceptions)
  * [4 Notes](end2.html#Notes)
  * [5 Example](end2.html#Example)
  * [6 Defect reports](end2.html#Defect_reports)
  * [7 See also](end2.html#See_also)
...
Run this code
    ...
    int main()
    {
        const [std::valarray](../valarray.html)<char> va
        {
            'H', 'e', 'l', 'l', 'o', 
            ',', ' ', 
            'C', '+', '+', '!', '\n'
    ...
     
        [std::for_each](../../algorithm/for_each.html)([std::begin](../../iterator/begin.html)(va), [std::end](../../iterator/end.html)(va),
                      [](char c){ [std::cout](../../io/cout.html) << c; });
    }
...
---|---|---|---  
[LWG 2058](https://cplusplus.github.io/LWG/issue2058) | C++11  | 1\. `end()` was required to support replacement types  
