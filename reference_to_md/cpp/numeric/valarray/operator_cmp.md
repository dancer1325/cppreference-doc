...
template< class T >   
[std::valarray](../valarray.html)<bool> operator==( const typename [std::valarray](../valarray.html)<T>::value_type & lhsv,  
...
const typename [std::valarray](../valarray.html)<T>::value_type & rhsv );  
template< class T >   
[std::valarray](../valarray.html)<bool> operator!=( const [std::valarray](../valarray.html)<T>& lhs,  
const typename [std::valarray](../valarray.html)<T>::value_type & rhsv );  
template< class T >   
...
template< class T >   
[std::valarray](../valarray.html)<bool> operator>=( const [std::valarray](../valarray.html)<T>& lhs,  
const typename [std::valarray](../valarray.html)<T>::value_type & rhsv ); |  (3)  |   
| |   
...
Run this code
    ...
    int main()
    {
        ...
        [std::valarray](../valarray.html)<int> v = {1, -1, 0, -3, 10, -1, -2};
        [std::cout](../../io/cout.html) << "Before: ";
        for (auto n : v)
    ...
     
        ...
        [std::valarray](../valarray.html)<int> a = {1, 2, 3};
        [std::valarray](../valarray.html)<int> b = {2, 4, 6};
     
        [std::cout](../../io/cout.html) << "2*a == b is " << [std::boolalpha](../../io/manip/boolalpha.html)
                  << (2 * a == b).min() << '\n';
    }
...
---|---|---|---  
[LWG 3074](https://cplusplus.github.io/LWG/issue3074) | C++98  | `T` is deduced from both the scalar and the `valarray` for (2,3),  
