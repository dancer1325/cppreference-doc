...
valarray(); |  (1)  |   
---|---|---  
explicit valarray( [std::size_t](../../types/size_t.html) count ); |  (2)  |   
valarray( const T& val, [std::size_t](../../types/size_t.html) count ); |  (3)  |   
valarray( const T* vals, [std::size_t](../../types/size_t.html) count ); |  (4)  |   
valarray( const valarray& other ); |  (5)  |   
valarray( valarray&& other ) noexcept; |  (6)  |  (since C++11)  
valarray( const [std::slice_array](slice_array.html)<T>& sa ); |  (7)  |   
valarray( const [std::gslice_array](gslice_array.html)<T>& gsa ); |  (8)  |   
valarray( const [std::mask_array](mask_array.html)<T>& ma ); |  (9)  |   
valarray( const [std::indirect_array](indirect_array.html)<T>& ia ); |  (10)  |   
valarray( [std::initializer_list](../../utility/initializer_list.html)<T> il ); |  (11)  |  (since C++11)  
| |   
...
2) Constructs a numeric array with count copies of [value-initialized](../../language/value_initialization.html "cpp/language/value initialization") elements.
...
7-10) [Converting constructor](../../language/converting_constructor.html "cpp/language/converting constructor"). Convert the corresponding data structure to a `valarray`.
