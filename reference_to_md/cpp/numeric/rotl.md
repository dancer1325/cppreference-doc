...
---|---|---  
template< class T >  
constexpr T rotl( T x, int s ) noexcept; |  |  (since C++20)  
| |   
...
Formally, let `N` be [std::numeric_limits](../types/numeric_limits.html)<T>::digits and r be s % N. 

  * If r is ​0​, returns x; 
  * if r is positive, returns (x << r) | (x >> (N - r)); 
  * if r is negative, returns [std::rotr](rotr.html)(x, -r). 
...
## Contents
  ...
  * [1 Parameters](rotl.html#Parameters)
  * [2 Return value](rotl.html#Return_value)
  * [3 Notes](rotl.html#Notes)
  * [4 Example](rotl.html#Example)
  * [5 See also](rotl.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/rotl&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  value of unsigned integer type   
---|---|---  
s  |  \-  |  number of positions to shift   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/rotl&action=edit&section=2 "Edit section: Return value")] Return value

The result of bitwise left-rotating x by s positions. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/rotl&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/rotl&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        const [std::uint8_t](../types/integer.html) x{0b00011101};
        [std::cout](../io/cout.html) << bin(x) << " <- x\n";
        for (const int s : {0, 1, 4, 9, -1})
            [std::cout](../io/cout.html) << bin(std::rotl(x, s)) << " <- rotl(x, " << s << ")\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/rotl&action=edit&section=5 "Edit section: See also")] See also
