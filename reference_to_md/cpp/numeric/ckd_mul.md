...
bool ckd_mul( type1* result, type2 a, type3 b ); |  |  (since C++26)  
| |   
...
The function template `ckd_mul` has the same semantics as the corresponding [type-generic macro](../../c/language/generic.html "c/language/generic") with the same name specified in [C23](../../c/numeric/ckd_mul.html "c/numeric/ckd mul"). 
...
[ ckd_add](ckd_add.html "cpp/numeric/ckd add")(C++26) |  checked addition operation on two integers   
(function template)   
---|---  
[ ckd_sub](ckd_sub.html "cpp/numeric/ckd sub")(C++26) |  checked subtraction operation on two integers   
(function template)   
[C documentation](../../c/numeric/ckd_mul.html "c/numeric/ckd mul") for ckd_mul
