...
struct ratio_greater_equal : [std::integral_constant](../../types/integral_constant.html)<bool, /* see below */> { }; |  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Helper variable template](ratio_greater_equal.html#Helper_variable_template)
  * [2 Inherited from std::integral_constant](ratio_greater_equal.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](ratio_greater_equal.html#Member_constants)
    * [2.2 Member functions](ratio_greater_equal.html#Member_functions)
    * [2.3 Member types](ratio_greater_equal.html#Member_types)
    * [2.4 Example](ratio_greater_equal.html#Example)
    * [2.5 See also](ratio_greater_equal.html#See_also)
...
Run this code
    ...
    int main()
    {
        static_assert(std::ratio_greater_equal<
            [std::ratio](ratio.html)<2, 3>,
            [std::ratio](ratio.html)<2, 3>>::value, "2/3 >= 2/3");
     
        // since C++17
        static_assert(std::ratio_greater_equal_v<
            [std::ratio](ratio.html)<999'998, 999'999>,
