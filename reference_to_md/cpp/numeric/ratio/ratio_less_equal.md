...
struct ratio_less_equal : [std::integral_constant](../../types/integral_constant.html)<bool, /* see below */> { }; |  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Helper variable template](ratio_less_equal.html#Helper_variable_template)
  * [2 Inherited from std::integral_constant](ratio_less_equal.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](ratio_less_equal.html#Member_constants)
    * [2.2 Member functions](ratio_less_equal.html#Member_functions)
    * [2.3 Member types](ratio_less_equal.html#Member_types)
    * [2.4 Example](ratio_less_equal.html#Example)
    * [2.5 See also](ratio_less_equal.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_less_equal&action=edit&section=1 "Edit section: Helper variable template")] Helper variable template

template< class R1, class R2 >  
constexpr bool ratio_less_equal_v = ratio_less_equal<R1, R2>::value; |  |  (since C++17)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_less_equal&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        static_assert(std::ratio_less_equal<[std::ratio](ratio.html)<1, 2>, [std::ratio](ratio.html)<3, 4>>::value,
                      "1/2 <= 3/4");
     
        if (std::ratio_less_equal<[std::ratio](ratio.html)<10,11>, [std::ratio](ratio.html)<11,12>>::value)
            [std::cout](../../io/cout.html) << "10/11 <= 11/12" "\n";
     
        static_assert(std::ratio_less_equal_v<[std::ratio](ratio.html)<10, 11>, [std::ratio](ratio.html)<11, 12>>);
     
        if constexpr (std::ratio_less_equal_v<[std::ratio](ratio.html)<10, 11>, [std::ratio](ratio.html)<11, 12>>)
            [std::cout](../../io/cout.html) << "11/12 <= 12/13" "\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_less_equal&action=edit&section=3 "Edit section: See also")] See also
