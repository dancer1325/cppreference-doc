...
Comparison  
[ratio_equal](ratio_equal.html "cpp/numeric/ratio/ratio equal")(C++11)  
...
struct ratio_greater : [std::integral_constant](../../types/integral_constant.html)<bool, /* see below */> { }; |  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Helper variable template](ratio_greater.html#Helper_variable_template)
  * [2 Inherited from std::integral_constant](ratio_greater.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](ratio_greater.html#Member_constants)
    * [2.2 Member functions](ratio_greater.html#Member_functions)
    * [2.3 Member types](ratio_greater.html#Member_types)
    * [2.4 Example](ratio_greater.html#Example)
    * [2.5 See also](ratio_greater.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_greater&action=edit&section=1 "Edit section: Helper variable template")] Helper variable template

template< class R1, class R2 >  
constexpr bool ratio_greater_v = ratio_greater<R1, R2>::value; |  |  (since C++17)  
---|---|---  
| |   
...
value[static] |  true if R1::num * R2::den > R2::num * R1::den, or equivalent expression that avoids overflow, false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_greater&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        static_assert(std::ratio_greater<[std::ratio](ratio.html)<3, 4>, [std::ratio](ratio.html)<1, 2>>::value,
                      "3/4 > 1/2");
     
        if (std::ratio_greater<[std::ratio](ratio.html)<11, 12>, [std::ratio](ratio.html)<10, 11>>::value)
            [std::cout](../../io/cout.html) << "11/12 > 10/11" "\n";
     
        // Since C++17
        static_assert(std::ratio_greater_v<[std::ratio](ratio.html)<12, 13>, [std::ratio](ratio.html)<11, 12>>);
     
        if constexpr (std::ratio_greater_v<[std::ratio](ratio.html)<12, 13>, [std::ratio](ratio.html)<11, 12>>)
            [std::cout](../../io/cout.html) << "12/13 > 11/12" "\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_greater&action=edit&section=3 "Edit section: See also")] See also

[ ratio_greater_equal](ratio_greater_equal.html "cpp/numeric/ratio/ratio greater equal")(C++11) |  compares two `ratio` objects for _greater than or equal to_ at compile-time   
