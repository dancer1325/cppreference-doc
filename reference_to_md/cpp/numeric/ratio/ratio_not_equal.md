...
struct ratio_not_equal : [std::integral_constant](../../types/integral_constant.html)<bool, /* see below */> { }; |  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Helper variable template](ratio_not_equal.html#Helper_variable_template)
  * [2 Inherited from std::integral_constant](ratio_not_equal.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](ratio_not_equal.html#Member_constants)
    * [2.2 Member functions](ratio_not_equal.html#Member_functions)
    * [2.3 Member types](ratio_not_equal.html#Member_types)
    * [2.4 Possible implementation](ratio_not_equal.html#Possible_implementation)
    * [2.5 Example](ratio_not_equal.html#Example)
    * [2.6 See also](ratio_not_equal.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_not_equal&action=edit&section=1 "Edit section: Helper variable template")] Helper variable template

template< class R1, class R2 >  
constexpr bool ratio_not_equal_v = ratio_not_equal<R1, R2>::value; |  |  (since C++17)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_not_equal&action=edit&section=2 "Edit section: Possible implementation")] Possible implementation
    
    
    template< class R1, class R2 >
    struct ratio_not_equal : [std::integral_constant](../../types/integral_constant.html) <
                                  bool,
                                  ![std::ratio_equal](ratio_equal.html)<R1, R2>
                             > {};  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_not_equal&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    #include <ratio>
     
    static_assert(std::ratio_not_equal_v<[std::ratio](ratio.html)<6, 9>, [std::ratio](ratio.html)<9, 6>>, "6/9 != 9/6");
     
    int main() {}

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_not_equal&action=edit&section=4 "Edit section: See also")] See also
