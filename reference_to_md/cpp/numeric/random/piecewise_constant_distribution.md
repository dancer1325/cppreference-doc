...
Member functions  
---  
[piecewise_constant_distribution::piecewise_constant_distribution](piecewise_constant_distribution/piecewise_constant_distribution.html "cpp/numeric/random/piecewise constant distribution/piecewise constant distribution")  
[piecewise_constant_distribution::reset](piecewise_constant_distribution/reset.html "cpp/numeric/random/piecewise constant distribution/reset")  
Generation  
[piecewise_constant_distribution::operator()](piecewise_constant_distribution/operator\(\).html "cpp/numeric/random/piecewise constant distribution/operator\(\)")  
Characteristics  
[piecewise_constant_distribution::intervalspiecewise_constant_distribution::densities](piecewise_constant_distribution/params.html "cpp/numeric/random/piecewise constant distribution/params")  
[piecewise_constant_distribution::param](piecewise_constant_distribution/param.html "cpp/numeric/random/piecewise constant distribution/param")  
[piecewise_constant_distribution::min](piecewise_constant_distribution/min.html "cpp/numeric/random/piecewise constant distribution/min")  
[piecewise_constant_distribution::max](piecewise_constant_distribution/max.html "cpp/numeric/random/piecewise constant distribution/max")  
Non-member functions  
[operator==operator!=](piecewise_constant_distribution/operator_cmp.html "cpp/numeric/random/piecewise constant distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](piecewise_constant_distribution/operator_ltltgtgt.html "cpp/numeric/random/piecewise constant distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/piecewise_constant_distribution/navbar_content&action=edit)

Defined in header `[<random>](../../header/random.html "cpp/header/random")` |  |   
---|---|---  
template< class RealType = double >  
class piecewise_constant_distribution; |  |  (since C++11)  
| |   
...
[`std::piecewise_constant_distribution`](piecewise_constant_distribution.html#top) satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](piecewise_constant_distribution.html#Template_parameters)
  * [2 Member types](piecewise_constant_distribution.html#Member_types)
  * [3 Member functions](piecewise_constant_distribution.html#Member_functions)
    * [3.1 Generation](piecewise_constant_distribution.html#Generation)
    * [3.2 Characteristics](piecewise_constant_distribution.html#Characteristics)
  * [4 Non-member functions](piecewise_constant_distribution.html#Non-member_functions)
  * [5 Example](piecewise_constant_distribution.html#Example)
  * [6 References](piecewise_constant_distribution.html#References)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_constant_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_constant_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_constant_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](piecewise_constant_distribution/piecewise_constant_distribution.html "cpp/numeric/random/piecewise constant distribution/piecewise constant distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](piecewise_constant_distribution/reset.html "cpp/numeric/random/piecewise constant distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](piecewise_constant_distribution/operator\(\).html "cpp/numeric/random/piecewise constant distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ intervalsdensities](piecewise_constant_distribution/params.html "cpp/numeric/random/piecewise constant distribution/params") |  returns the distribution parameters   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/piecewise_constant_distribution/dsc_params&action=edit)  
[ param](piecewise_constant_distribution/param.html "cpp/numeric/random/piecewise constant distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](piecewise_constant_distribution/min.html "cpp/numeric/random/piecewise constant distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](piecewise_constant_distribution/max.html "cpp/numeric/random/piecewise constant distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_constant_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](piecewise_constant_distribution/operator_cmp.html "cpp/numeric/random/piecewise constant distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](piecewise_constant_distribution/operator_ltltgtgt.html "cpp/numeric/random/piecewise constant distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_constant_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::vector](../../container/vector.html)<double> i {0, 1, 10, 15};
        [std::vector](../../container/vector.html)<double> w {1, 0, 1};
    ...
     
        ...
        for (int n {}; n < 1e4; ++n)
            ++hist[d(gen)];
     
        for ([std::cout](../../io/cout.html) << [std::hex](../../io/manip/hex.html) << [std::uppercase](../../io/manip/uppercase.html); auto [x, y] : hist)
            [std::cout](../../io/cout.html) << x << ' ' << [std::string](../../string/basic_string.html)(y / 100, '*') << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_constant_distribution&action=edit&section=6 "Edit section: References")] References
