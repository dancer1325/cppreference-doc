[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/seed&action=edit)
...
Member functions  
---  
[linear_congruential_engine::linear_congruential_engine](linear_congruential_engine.html "cpp/numeric/random/linear congruential engine/linear congruential engine")  
...
void seed( SeedSeq& seq ); |  (2) | (since C++11)  
| |   
  
Sets the [state](../linear_congruential_engine.html#Generator_properties "cpp/numeric/random/linear congruential engine") of the random-number engine. 

1) Right after the state is set, *this == [std::linear_congruential_engine](../linear_congruential_engine.html)(value) is true.

2) Right after the state is set, *this == [std::linear_congruential_engine](../linear_congruential_engine.html)(seq) is true.

## Contents

  * [1 Parameters](seed.html#Parameters)
  * [2 Exceptions](seed.html#Exceptions)
  * [3 Complexity](seed.html#Complexity)
  * [4 Defect reports](seed.html#Defect_reports)
  * [5 See also](seed.html#See_also)
...
1) Same as [std::linear_congruential_engine](../linear_congruential_engine.html)(value).

2) Same as [std::linear_congruential_engine](../linear_congruential_engine.html)(seq).
...
[ (constructor)](linear_congruential_engine.html "cpp/numeric/random/linear congruential engine/linear congruential engine") |  constructs the engine   
