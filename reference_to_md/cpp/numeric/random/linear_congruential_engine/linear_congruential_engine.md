...
[`std::linear_congruential_engine`](../linear_congruential_engine.html "cpp/numeric/random/linear congruential engine")

Member functions  
---  
**linear_congruential_engine::linear_congruential_engine**  
[linear_congruential_engine::seed](seed.html "cpp/numeric/random/linear congruential engine/seed")  
Generation  
[linear_congruential_engine::operator()](operator\(\).html "cpp/numeric/random/linear congruential engine/operator\(\)")  
[linear_congruential_engine::discard](discard.html "cpp/numeric/random/linear congruential engine/discard")  
Characteristics  
[linear_congruential_engine::min](min.html "cpp/numeric/random/linear congruential engine/min")  
[linear_congruential_engine::max](max.html "cpp/numeric/random/linear congruential engine/max")  
Non-member functions  
[operator==operator!=](operator_cmp.html "cpp/numeric/random/linear congruential engine/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](operator_ltltgtgt.html "cpp/numeric/random/linear congruential engine/operator ltltgtgt")(C++11)(C++11)  
...
explicit linear_congruential_engine( SeedSeq& seq ); |  (3) | (since C++11)  
linear_congruential_engine( const linear_congruential_engine& other ); |  (4)  |  (since C++11)   
(implicitly declared)  
| |   
...
2) Constructs the engine with a seed value value. The engine's initial [state](../linear_congruential_engine.html#Generator_properties "cpp/numeric/random/linear congruential engine") is determined as follows: 
...
3) Constructs the engine with a seed sequence seq. Given [std::size_t](../../../types/size_t.html)([std::log2](../../math/log2.html)(m) / 32) + 1 as k, the engine's initial [state](../linear_congruential_engine.html#Generator_properties "cpp/numeric/random/linear congruential engine") is determined as follows: 
...
This overload participates in overload resolution only if `SeedSeq` meets the requirements of [SeedSequence](../../../named_req/SeedSequence.html "cpp/named req/SeedSequence").

4) The copy constructor. Upon construction, *this == other is true.

## Contents

  * [1 Parameters](linear_congruential_engine.html#Parameters)
  * [2 Complexity](linear_congruential_engine.html#Complexity)
  * [3 Exceptions](linear_congruential_engine.html#Exceptions)
  * [4 Defect reports](linear_congruential_engine.html#Defect_reports)
  * [5 See also](linear_congruential_engine.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine/linear_congruential_engine&action=edit&section=1 "Edit section: Parameters")] Parameters

value  |  \-  |  seed value to use in the initialization of the internal state   
---|---|---  
seq  |  \-  |  seed sequence to use in the initialization of the internal state   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine/linear_congruential_engine&action=edit&section=2 "Edit section: Complexity")] Complexity
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine/linear_congruential_engine&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine/linear_congruential_engine&action=edit&section=4 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2181](https://cplusplus.github.io/LWG/issue2181) | C++11  | overload ([3](linear_congruential_engine.html#Version_3)) would not throw even if the `seq.generate` call throws  | propagates the exception   
[P0935R0](https://wg21.link/P0935R0) | C++11  | the default constructor was explicit  | made implicit   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine/linear_congruential_engine&action=edit&section=5 "Edit section: See also")] See also

[ seed](seed.html "cpp/numeric/random/linear congruential engine/seed") |  sets the current state of the engine   
