[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/operator\(\)&action=edit)
...
[ discard](discard.html "cpp/numeric/random/linear congruential engine/discard") |  advances the engine's state by a specified amount   
