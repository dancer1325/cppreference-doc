[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/max&action=edit)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/max&action=edit&section=T-1 "Template:cpp/numeric/random/engine/max")] Return value

m - 1u

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/max&action=edit&section=T-2 "Template:cpp/numeric/random/engine/max")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/max&action=edit&section=T-3 "Template:cpp/numeric/random/engine/max")] See also

[ min](min.html "cpp/numeric/random/linear congruential engine/min")[static] |  gets the smallest possible value in the output range   
