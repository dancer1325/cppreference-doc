[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/min&action=edit)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/min&action=edit&section=T-1 "Template:cpp/numeric/random/engine/min")] Return value

c == 0u ? 1u: 0u;

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/min&action=edit&section=T-2 "Template:cpp/numeric/random/engine/min")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/min&action=edit&section=T-3 "Template:cpp/numeric/random/engine/min")] See also

[ max](max.html "cpp/numeric/random/linear congruential engine/max")[static] |  gets the largest possible value in the output range   
