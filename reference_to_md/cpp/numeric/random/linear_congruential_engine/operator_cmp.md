[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/engine/operator_cmp&action=edit)
...
const linear_congruential_engine& rhs ); |  (1)  |  (since C++11)  
---|---|---  
friend bool operator!=( const linear_congruential_engine& lhs,  
const linear_congruential_engine& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
