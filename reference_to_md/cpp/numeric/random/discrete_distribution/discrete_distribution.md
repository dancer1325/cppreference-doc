...
discrete_distribution( InputIt first, InputIt last ); |  (2)  |  (since C++11)  
discrete_distribution( [std::initializer_list](../../../utility/initializer_list.html)<double> weights ); |  (3)  |  (since C++11)  
template< class UnaryOperation >  
discrete_distribution( [std::size_t](../../../types/size_t.html) count, double xmin, double xmax,  
...
4) Constructs the distribution with count weights that are generated using function unary_op. Each of the weights is equal to wi = unary_op(xmin + δ(i + 0.5)), where δ = (xmax − xmin)  
---  
count  
