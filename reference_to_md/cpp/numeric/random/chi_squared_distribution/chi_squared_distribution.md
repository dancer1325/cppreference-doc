...
chi_squared_distribution() : chi_squared_distribution(1.0) {} |  (1)  |  (since C++11)  
---|---|---  
explicit chi_squared_distribution( RealType n ); |  (2)  |  (since C++11)  
explicit chi_squared_distribution( const param_type& params ); |  (3)  |  (since C++11)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/chi_squared_distribution/chi_squared_distribution&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  the _n_ distribution parameter (degrees of freedom)   
---|---|---  
params  |  \-  |  the distribution parameter set   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/chi_squared_distribution/chi_squared_distribution&action=edit&section=2 "Edit section: Defect reports")] Defect reports 
