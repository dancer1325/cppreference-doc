...
Generation  
[random_device::operator()](operator\(\).html "cpp/numeric/random/random device/operator\(\)")  
Characteristics  
[random_device::entropy](entropy.html "cpp/numeric/random/random device/entropy")  
...
---|---|---  
explicit random_device( const [std::string](../../../string/basic_string.html)& token ); |  (2)  |  (since C++11)  
random_device( const random_device& ) = delete; |  (3)  |  (since C++11)  
| |   
  
1) Default constructs a new [std::random_device](../random_device.html "cpp/numeric/random/random device") object with an implementation-defined `token`.

2) Constructs a new [std::random_device](../random_device.html "cpp/numeric/random/random device") object, making use of the argument token in an implementation-defined manner. 

3) The copy constructor is deleted: `std::random_device` is not copyable nor movable.

## Contents

  * [1 Exceptions](random_device.html#Exceptions)
  * [2 Notes](random_device.html#Notes)
  * [3 Example](random_device.html#Example)
  * [4 Defect reports](random_device.html#Defect_reports)
...
Run this code
    ...
    #include <random>
     
    void demo([std::random_device](../random_device.html)&& rd)
    {
        static [std::uniform_int_distribution](../uniform_int_distribution.html)<int> d(0, 9);
        for (int n = 0; n != 10; ++n)
            [std::cout](../../../io/cout.html) << d(rd) << ' ';
    ...
     
        ...
        demo([std::random_device](../random_device.html) {"hw"});
    }
