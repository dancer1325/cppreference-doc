...
Member functions  
---  
[seed_seq::seed_seq](seed_seq/seed_seq.html "cpp/numeric/random/seed seq/seed seq")  
[seed_seq::generate](seed_seq/generate.html "cpp/numeric/random/seed seq/generate")  
...
[`std::seed_seq`](seed_seq.html#top) meets the requirements of [SeedSequence](../../named_req/SeedSequence.html "cpp/named req/SeedSequence"). 

## Contents

  * [1 Nested types](seed_seq.html#Nested_types)
  * [2 Data members](seed_seq.html#Data_members)
  * [3 Member functions](seed_seq.html#Member_functions)
  * [4 Example](seed_seq.html#Example)
...
---|---  
operator=[deleted] |  `std::seed_seq` is not assignable   
(public member function)  
[ generate](seed_seq/generate.html "cpp/numeric/random/seed seq/generate") |  calculates the bias-eliminated, evenly distributed 32-bit values   
(public member function)  
[ size](seed_seq/size.html "cpp/numeric/random/seed seq/size") |  obtains the number of stored 32-bit values   
(public member function)  
...
Run this code
    ...
    int main()
    {
        ...
        [std::vector](../../container/vector.html)<[std::uint32_t](../../types/integer.html)> seeds(10);
        seq.generate(seeds.begin(), seeds.end());
        for ([std::uint32_t](../../types/integer.html) n : seeds)
