...
Member functions  
---  
[fisher_f_distribution::fisher_f_distribution](fisher_f_distribution/fisher_f_distribution.html "cpp/numeric/random/fisher f distribution/fisher f distribution")  
[fisher_f_distribution::reset](fisher_f_distribution/reset.html "cpp/numeric/random/fisher f distribution/reset")  
Generation  
[fisher_f_distribution::operator()](fisher_f_distribution/operator\(\).html "cpp/numeric/random/fisher f distribution/operator\(\)")  
Characteristics  
[fisher_f_distribution::mfisher_f_distribution::n](fisher_f_distribution/params.html "cpp/numeric/random/fisher f distribution/params")  
[fisher_f_distribution::param](fisher_f_distribution/param.html "cpp/numeric/random/fisher f distribution/param")  
[fisher_f_distribution::min](fisher_f_distribution/min.html "cpp/numeric/random/fisher f distribution/min")  
[fisher_f_distribution::max](fisher_f_distribution/max.html "cpp/numeric/random/fisher f distribution/max")  
Non-member functions  
[operator==operator!=](fisher_f_distribution/operator_cmp.html "cpp/numeric/random/fisher f distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](fisher_f_distribution/operator_ltltgtgt.html "cpp/numeric/random/fisher f distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/fisher_f_distribution/navbar_content&action=edit)
...
Produces random numbers according to the [F-distribution](https://en.wikipedia.org/wiki/F-distribution "enwiki:F-distribution"): 
...
[`std::fisher_f_distribution`](fisher_f_distribution.html#top) satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](fisher_f_distribution.html#Template_parameters)
  * [2 Member types](fisher_f_distribution.html#Member_types)
  * [3 Member functions](fisher_f_distribution.html#Member_functions)
    * [3.1 Generation](fisher_f_distribution.html#Generation)
    * [3.2 Characteristics](fisher_f_distribution.html#Characteristics)
  * [4 Non-member functions](fisher_f_distribution.html#Non-member_functions)
  * [5 Example](fisher_f_distribution.html#Example)
  * [6 External links](fisher_f_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/fisher_f_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/fisher_f_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/fisher_f_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](fisher_f_distribution/fisher_f_distribution.html "cpp/numeric/random/fisher f distribution/fisher f distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](fisher_f_distribution/reset.html "cpp/numeric/random/fisher f distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](fisher_f_distribution/operator\(\).html "cpp/numeric/random/fisher f distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ mn](fisher_f_distribution/params.html "cpp/numeric/random/fisher f distribution/params")(C++11) |  returns the distribution parameters   
...
[ param](fisher_f_distribution/param.html "cpp/numeric/random/fisher f distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](fisher_f_distribution/min.html "cpp/numeric/random/fisher f distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](fisher_f_distribution/max.html "cpp/numeric/random/fisher f distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/fisher_f_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](fisher_f_distribution/operator_cmp.html "cpp/numeric/random/fisher f distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](fisher_f_distribution/operator_ltltgtgt.html "cpp/numeric/random/fisher f distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/fisher_f_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
            [std::cout](../../io/cout.html) << "d₁ = " << d1 << ", d₂ = " << d2 << ":\n";
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/fisher_f_distribution&action=edit&section=6 "Edit section: External links")] External links
