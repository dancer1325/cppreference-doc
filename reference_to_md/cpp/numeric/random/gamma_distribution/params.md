...
Characteristics  
**gamma_distribution::alpha gamma_distribution::beta**  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution/params&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution/params&action=edit&section=2 "Edit section: Return value")] Return value

1) Floating point value identifying the α parameter.

2) Floating point value identifying the β parameter.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution/params&action=edit&section=3 "Edit section: See also")] See also

[ param](param.html "cpp/numeric/random/gamma distribution/param")(C++11) |  gets or sets the distribution parameter object   
