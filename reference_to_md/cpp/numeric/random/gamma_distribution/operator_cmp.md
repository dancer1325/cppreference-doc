...
[`std::gamma_distribution`](../gamma_distribution.html "cpp/numeric/random/gamma distribution")

Member functions  
---  
[gamma_distribution::gamma_distribution](gamma_distribution.html "cpp/numeric/random/gamma distribution/gamma distribution")  
[gamma_distribution::reset](reset.html "cpp/numeric/random/gamma distribution/reset")  
Generation  
[gamma_distribution::operator()](operator\(\).html "cpp/numeric/random/gamma distribution/operator\(\)")  
Characteristics  
[gamma_distribution::alphagamma_distribution::beta](params.html "cpp/numeric/random/gamma distribution/params")  
[gamma_distribution::param](param.html "cpp/numeric/random/gamma distribution/param")  
[gamma_distribution::min](min.html "cpp/numeric/random/gamma distribution/min")  
[gamma_distribution::max](max.html "cpp/numeric/random/gamma distribution/max")  
Non-member functions  
**operator== operator!=**(C++11)(C++11)(until C++20)  
[operator<<operator>>](operator_ltltgtgt.html "cpp/numeric/random/gamma distribution/operator ltltgtgt")(C++11)(C++11)  
...
const gamma_distribution& rhs ); |  (1)  |  (since C++11)  
---|---|---  
friend bool operator!=( const gamma_distribution& lhs,  
const gamma_distribution& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
