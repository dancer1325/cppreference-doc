[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/max&action=edit)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/max&action=edit&section=T-1 "Template:cpp/numeric/random/adaptor/max")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/max&action=edit&section=T-2 "Template:cpp/numeric/random/adaptor/max")] Return value

The maximum potentially generated value. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/max&action=edit&section=T-3 "Template:cpp/numeric/random/adaptor/max")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/max&action=edit&section=T-4 "Template:cpp/numeric/random/adaptor/max")] See also

[ min](min.html "cpp/numeric/random/discard block engine/min")[static] |  gets the smallest possible value in the output range   
