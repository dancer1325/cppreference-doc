[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/constructor&action=edit)
...
[`std::discard_block_engine`](../discard_block_engine.html "cpp/numeric/random/discard block engine")

Member functions  
---  
**discard_block_engine::discard_block_engine**  
[discard_block_engine::seed](seed.html "cpp/numeric/random/discard block engine/seed")  
[discard_block_engine::base](base.html "cpp/numeric/random/discard block engine/base")  
Generation  
[discard_block_engine::operator()](operator\(\).html "cpp/numeric/random/discard block engine/operator\(\)")  
[discard_block_engine::discard](discard.html "cpp/numeric/random/discard block engine/discard")  
Characteristics  
[discard_block_engine::min](min.html "cpp/numeric/random/discard block engine/min")  
[discard_block_engine::max](max.html "cpp/numeric/random/discard block engine/max")  
Non-member functions  
[operator==operator!=](operator_cmp.html "cpp/numeric/random/discard block engine/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](operator_ltltgtgt.html "cpp/numeric/random/discard block engine/operator ltltgtgt")(C++11)(C++11)  
...
explicit discard_block_engine( SeedSeq& seq ); |  (3)  |  (since C++11)  
...
This overload participates in overload resolution only if `Sseq` satisfies the requirements of [SeedSequence](../../../named_req/SeedSequence.html "cpp/named req/SeedSequence").
...
## Contents
  ...
  * [1 Parameters](discard_block_engine.html#Parameters)
  * [2 Exceptions](discard_block_engine.html#Exceptions)
  * [3 Example](discard_block_engine.html#Example)
  * [4 Defect reports](discard_block_engine.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/constructor&action=edit&section=T-1 "Template:cpp/numeric/random/adaptor/constructor")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/constructor&action=edit&section=T-2 "Template:cpp/numeric/random/adaptor/constructor")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/constructor&action=edit&section=T-3 "Template:cpp/numeric/random/adaptor/constructor")] Example

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/constructor&action=edit&section=T-4 "Template:cpp/numeric/random/adaptor/constructor")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2181](https://cplusplus.github.io/LWG/issue2181) | C++11  | overload ([3](discard_block_engine.html#Version_3)) would not throw even if the `seq.generate` call throws  | propagates the exception 
