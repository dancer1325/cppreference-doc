[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/min&action=edit)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/min&action=edit&section=T-1 "Template:cpp/numeric/random/adaptor/min")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/min&action=edit&section=T-2 "Template:cpp/numeric/random/adaptor/min")] Return value

The minimum potentially generated value. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/min&action=edit&section=T-3 "Template:cpp/numeric/random/adaptor/min")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/adaptor/min&action=edit&section=T-4 "Template:cpp/numeric/random/adaptor/min")] See also

[ max](max.html "cpp/numeric/random/discard block engine/max")[static] |  gets the largest possible value in the output range   
