...
Member functions  
---  
[uniform_int_distribution::uniform_int_distribution](uniform_int_distribution/uniform_int_distribution.html "cpp/numeric/random/uniform int distribution/uniform int distribution")  
[uniform_int_distribution::reset](uniform_int_distribution/reset.html "cpp/numeric/random/uniform int distribution/reset")  
Generation  
[uniform_int_distribution::operator()](uniform_int_distribution/operator\(\).html "cpp/numeric/random/uniform int distribution/operator\(\)")  
Characteristics  
[uniform_int_distribution::auniform_int_distribution::b](uniform_int_distribution/params.html "cpp/numeric/random/uniform int distribution/params")  
[uniform_int_distribution::param](uniform_int_distribution/param.html "cpp/numeric/random/uniform int distribution/param")  
[uniform_int_distribution::min](uniform_int_distribution/min.html "cpp/numeric/random/uniform int distribution/min")  
[uniform_int_distribution::max](uniform_int_distribution/max.html "cpp/numeric/random/uniform int distribution/max")  
Non-member functions  
[operator==operator!=](uniform_int_distribution/operator_cmp.html "cpp/numeric/random/uniform int distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](uniform_int_distribution/operator_ltltgtgt.html "cpp/numeric/random/uniform int distribution/operator ltltgtgt")(C++11)(C++11)  
...
`std::uniform_int_distribution` satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](uniform_int_distribution.html#Template_parameters)
  * [2 Member types](uniform_int_distribution.html#Member_types)
  * [3 Member functions](uniform_int_distribution.html#Member_functions)
    * [3.1 Generation](uniform_int_distribution.html#Generation)
    * [3.2 Characteristics](uniform_int_distribution.html#Characteristics)
  * [4 Non-member functions](uniform_int_distribution.html#Non-member_functions)
  * [5 Example](uniform_int_distribution.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/uniform_int_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/uniform_int_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/uniform_int_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](uniform_int_distribution/uniform_int_distribution.html "cpp/numeric/random/uniform int distribution/uniform int distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](uniform_int_distribution/reset.html "cpp/numeric/random/uniform int distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](uniform_int_distribution/operator\(\).html "cpp/numeric/random/uniform int distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ ab](uniform_int_distribution/params.html "cpp/numeric/random/uniform int distribution/params")(C++11) |  returns the distribution parameters   
...
[ param](uniform_int_distribution/param.html "cpp/numeric/random/uniform int distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](uniform_int_distribution/min.html "cpp/numeric/random/uniform int distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](uniform_int_distribution/max.html "cpp/numeric/random/uniform int distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/uniform_int_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](uniform_int_distribution/operator_cmp.html "cpp/numeric/random/uniform int distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](uniform_int_distribution/operator_ltltgtgt.html "cpp/numeric/random/uniform int distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/uniform_int_distribution&action=edit&section=5 "Edit section: Example")] Example

This program simulates throwing 6-sided [dice](https://en.wikipedia.org/wiki/dice "enwiki:dice").
...
Run this code
    ...
    int main()
    {
        [std::random_device](random_device.html) rd;  // a seed source for the random number engine
        [std::mt19937](mersenne_twister_engine.html) gen(rd()); // mersenne_twister_engine seeded with rd()
        std::uniform_int_distribution<> distrib(1, 6);
     
        // Use distrib to transform the random unsigned int
        // generated by gen into an int in [1, 6]
        for (int n = 0; n != 10; ++n)
            [std::cout](../../io/cout.html) << distrib(gen) << ' ';
