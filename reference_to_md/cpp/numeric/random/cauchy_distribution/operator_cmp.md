...
Characteristics  
[cauchy_distribution::acauchy_distribution::b](params.html "cpp/numeric/random/cauchy distribution/params")  
...
const cauchy_distribution& rhs ); |  (1)  |  (since C++11)  
---|---|---  
friend bool operator!=( const cauchy_distribution& lhs,  
const cauchy_distribution& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
