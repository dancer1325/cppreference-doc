...
cauchy_distribution() : cauchy_distribution(0.0) {} |  (1)  |  (since C++11)  
---|---|---  
explicit cauchy_distribution( RealType a, RealType b = 1.0 ); |  (2)  |  (since C++11)  
explicit cauchy_distribution( const param_type& params ); |  (3)  |  (since C++11)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/cauchy_distribution/cauchy_distribution&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/cauchy_distribution/cauchy_distribution&action=edit&section=2 "Edit section: Defect reports")] Defect reports 
