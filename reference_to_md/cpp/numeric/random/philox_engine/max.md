...
static constexpr result_type max(); |  |  (since C++26)  
---|---|---  
| |   
...
[ min](min.html "cpp/numeric/random/philox engine/min")[static] |  gets the smallest possible value in the output range   
