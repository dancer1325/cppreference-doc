...
Member functions  
---  
[philox_engine::philox_engine](philox_engine.html "cpp/numeric/random/philox engine/philox engine")  
...
const philox_engine& e ); |  (1)  |  (since C++26)  
---|---|---  
template< class CharT, class Traits >  
