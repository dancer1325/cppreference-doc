...
void seed( result_type value = default_seed ); |  (1)  |  (since C++26)  
---|---|---  
template< class SeedSeq >   
void seed( SeedSeq& seq ); |  (2) | (since C++26)  
| |   
  
Sets the [state](../philox_engine.html#Generator_properties "cpp/numeric/random/philox engine") of the random-number engine. 

1) Right after the state is set, *this == [std::philox_engine](../philox_engine.html)(value) is true.

2) Right after the state is set, *this == [std::philox_engine](../philox_engine.html)(seq) is true.
...
1) Same as [std::philox_engine](../philox_engine.html)(value).

2) Same as [std::philox_engine](../philox_engine.html)(seq).
