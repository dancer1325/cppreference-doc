...
[philox_engine::seed](seed.html "cpp/numeric/random/philox engine/seed")  
[philox_engine::set_counter](set_counter.html "cpp/numeric/random/philox engine/set counter")  
Generation  
[philox_engine::operator()](operator\(\).html "cpp/numeric/random/philox engine/operator\(\)")  
[philox_engine::discard](discard.html "cpp/numeric/random/philox engine/discard")  
Characteristics  
[philox_engine::min](min.html "cpp/numeric/random/philox engine/min")  
[philox_engine::max](max.html "cpp/numeric/random/philox engine/max")  
...
explicit philox_engine( SeedSeq& seq ); |  (3)  |  (since C++26)  
philox_engine( const philox_engine& other ); |  (4)  |  (since C++26)   
(implicitly declared)  
| |   
...
2) Constructs the engine with a seed value value. The engine's initial [state](../philox_engine.html#Generator_properties "cpp/numeric/random/philox engine") is determined as follows:[[1]](philox_engine.html#cite_note-y-1)
...
3) Constructs the engine with a seed sequence seq. The engine's initial [state](../philox_engine.html#Generator_properties "cpp/numeric/random/philox engine") is determined as follows:[[1]](philox_engine.html#cite_note-y-1)
...
4) The copy constructor. Upon construction, *this == other is true.
  ...
  1. ↑ [1.0](philox_engine.html#cite_ref-y_1-0) [1.1](philox_engine.html#cite_ref-y_1-1) The buffer Y is intentionally not being set. As j is being set to n - 1, the next state transition always generates new random values and stores them in Y.



## Contents

  * [1 Parameters](philox_engine.html#Parameters)
  * [2 Complexity](philox_engine.html#Complexity)
  * [3 Exceptions](philox_engine.html#Exceptions)
  * [4 See also](philox_engine.html#See_also)
