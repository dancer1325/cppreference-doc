...
Member functions  
---  
[linear_congruential_engine::linear_congruential_engine](linear_congruential_engine/linear_congruential_engine.html "cpp/numeric/random/linear congruential engine/linear congruential engine")  
[linear_congruential_engine::seed](linear_congruential_engine/seed.html "cpp/numeric/random/linear congruential engine/seed")  
Generation  
[linear_congruential_engine::operator()](linear_congruential_engine/operator\(\).html "cpp/numeric/random/linear congruential engine/operator\(\)")  
[linear_congruential_engine::discard](linear_congruential_engine/discard.html "cpp/numeric/random/linear congruential engine/discard")  
Characteristics  
[linear_congruential_engine::min](linear_congruential_engine/min.html "cpp/numeric/random/linear congruential engine/min")  
[linear_congruential_engine::max](linear_congruential_engine/max.html "cpp/numeric/random/linear congruential engine/max")  
Non-member functions  
[operator==operator!=](linear_congruential_engine/operator_cmp.html "cpp/numeric/random/linear congruential engine/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](linear_congruential_engine/operator_ltltgtgt.html "cpp/numeric/random/linear congruential engine/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/linear_congruential_engine/navbar_content&action=edit)
...
`linear_congruential_engine` is a random number engine based on [Linear congruential generator](https://en.wikipedia.org/wiki/Linear_congruential_generator "enwiki:Linear congruential generator") (LCG). 

## Contents

  * [1 Template parameters](linear_congruential_engine.html#Template_parameters)
  * [2 Generator properties](linear_congruential_engine.html#Generator_properties)
  * [3 Predefined specializations](linear_congruential_engine.html#Predefined_specializations)
  * [4 Nested types](linear_congruential_engine.html#Nested_types)
  * [5 Data members](linear_congruential_engine.html#Data_members)
  * [6 Member functions](linear_congruential_engine.html#Member_functions)
    * [6.1 Construction and Seeding](linear_congruential_engine.html#Construction_and_Seeding)
    * [6.2 Generation](linear_congruential_engine.html#Generation)
    * [6.3 Characteristics](linear_congruential_engine.html#Characteristics)
  * [7 Non-member functions](linear_congruential_engine.html#Non-member_functions)
  * [8 Example](linear_congruential_engine.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine&action=edit&section=2 "Edit section: Generator properties")] Generator properties

The [size](../random.html#Random_number_engines "cpp/numeric/random") of the states of `linear_congruential_engine` is 1, each of them consists of a single integer. 

The actual modulus \\(\scriptsize m_0\\)m0 is defined as follows: 

  * If m is not zero, \\(\scriptsize m_0\\)m0 is m. 
  * If m is zero, \\(\scriptsize m_0\\)m0 is the value of [std::numeric_limits](../../types/numeric_limits.html)<result_type>::max() plus 1 (which means \\(\scriptsize m_0\\)m0 need not be representable as `result_type`). 



The [transition algorithm](../random.html#Random_number_engines "cpp/numeric/random") of `linear_congruential_engine` is \\(\scriptsize TA(x_i) = (a \cdot x_i + c)\mod m_0\\)TA(xi) = (a·xi+c) mod m0. 

The [generation algorithm](../random.html#Random_number_engines "cpp/numeric/random") of `linear_congruential_engine` is \\(\scriptsize GA(x_i) = (a \cdot x_i + c)\mod m_0\\)GA(xi) = (a·xi+c) mod m0. 

The pseudo-random number generated with the current state is also the successor state. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine&action=edit&section=3 "Edit section: Predefined specializations")] Predefined specializations
...
---  
Type  |  Definition   
`minstd_rand0` (C++11) |  std::linear_congruential_engine<[std::uint_fast32_t](../../types/integer.html),  
` `16807, 0, 2147483647>  
...
`minstd_rand` (C++11) |  std::linear_congruential_engine<[std::uint_fast32_t](../../types/integer.html),  
` `48271, 0, 2147483647>  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine&action=edit&section=4 "Edit section: Nested types")] Nested types

Type  |  Definition   
---|---  
`result_type` |  `UIntType`  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine&action=edit&section=5 "Edit section: Data members")] Data members
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine&action=edit&section=6 "Edit section: Member functions")] Member functions

#####  Construction and Seeding   
  
---  
[ (constructor)](linear_congruential_engine/linear_congruential_engine.html "cpp/numeric/random/linear congruential engine/linear congruential engine") |  constructs the engine   
...
[ seed](linear_congruential_engine/seed.html "cpp/numeric/random/linear congruential engine/seed") |  sets the current state of the engine   
...
[ operator()](linear_congruential_engine/operator\(\).html "cpp/numeric/random/linear congruential engine/operator\(\)") |  advances the engine's state and returns the generated value   
...
[ discard](linear_congruential_engine/discard.html "cpp/numeric/random/linear congruential engine/discard") |  advances the engine's state by a specified amount   
...
[ min](linear_congruential_engine/min.html "cpp/numeric/random/linear congruential engine/min")[static] |  gets the smallest possible value in the output range   
...
[ max](linear_congruential_engine/max.html "cpp/numeric/random/linear congruential engine/max")[static] |  gets the largest possible value in the output range   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine&action=edit&section=7 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](linear_congruential_engine/operator_cmp.html "cpp/numeric/random/linear congruential engine/operator cmp")(C++11)(C++11)(removed in C++20) |  compares the internal states of two pseudo-random number engines   
...
---|---  
[ operator<<operator>>](linear_congruential_engine/operator_ltltgtgt.html "cpp/numeric/random/linear congruential engine/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number engine   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/linear_congruential_engine&action=edit&section=8 "Edit section: Example")] Example
