...
[`std::binomial_distribution`](../binomial_distribution.html "cpp/numeric/random/binomial distribution")

Member functions  
---  
[binomial_distribution::binomial_distribution](binomial_distribution.html "cpp/numeric/random/binomial distribution/binomial distribution")  
[binomial_distribution::reset](reset.html "cpp/numeric/random/binomial distribution/reset")  
Generation  
[binomial_distribution::operator()](operator\(\).html "cpp/numeric/random/binomial distribution/operator\(\)")  
Characteristics  
[binomial_distribution::pbinomial_distribution::t](params.html "cpp/numeric/random/binomial distribution/params")  
[binomial_distribution::param](param.html "cpp/numeric/random/binomial distribution/param")  
[binomial_distribution::min](min.html "cpp/numeric/random/binomial distribution/min")  
[binomial_distribution::max](max.html "cpp/numeric/random/binomial distribution/max")  
Non-member functions  
**operator== operator!=**(C++11)(C++11)(until C++20)  
[operator<<operator>>](operator_ltltgtgt.html "cpp/numeric/random/binomial distribution/operator ltltgtgt")(C++11)(C++11)  
...
const binomial_distribution& rhs ); |  (1)  |  (since C++11)  
---|---|---  
friend bool operator!=( const binomial_distribution& lhs,  
const binomial_distribution& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
