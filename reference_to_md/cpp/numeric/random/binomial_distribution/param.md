[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/param&action=edit)
...
[operator==operator!=](operator_cmp.html "cpp/numeric/random/binomial distribution/operator cmp")(C++11)(C++11)(until C++20)  
...
## Contents
  ...
  * [1 Parameters](param.html#Parameters)
  * [2 Return value](param.html#Return_value)
  * [3 Complexity](param.html#Complexity)
  * [4 Example](param.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/param&action=edit&section=T-1 "Template:cpp/numeric/random/distribution/param")] Parameters

params  |  \-  |  new contents of the associated parameter set   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/param&action=edit&section=T-2 "Template:cpp/numeric/random/distribution/param")] Return value

1) The associated parameter set.

2) (none)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/param&action=edit&section=T-3 "Template:cpp/numeric/random/distribution/param")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/binomial_distribution/param&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        using BinomialDist = [std::binomial_distribution](../binomial_distribution.html)<>;
        BinomialDist bino_dis(1, 0.5);
     
        [std::cout](../../../io/cout.html) << "A sample of Binomial(  1, 0.5): " << bino_dis(gen) << '\n';
     
        // Use another parameter set
        bino_dis.param(BinomialDist::param_type(100,0.9));
        [std::cout](../../../io/cout.html) << "A sample of Binomial(100, 0.9): " << bino_dis(gen) << '\n';
    }
