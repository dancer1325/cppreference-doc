...
Member functions  
---  
[chi_squared_distribution::chi_squared_distribution](chi_squared_distribution/chi_squared_distribution.html "cpp/numeric/random/chi squared distribution/chi squared distribution")  
[chi_squared_distribution::reset](chi_squared_distribution/reset.html "cpp/numeric/random/chi squared distribution/reset")  
Generation  
[chi_squared_distribution::operator()](chi_squared_distribution/operator\(\).html "cpp/numeric/random/chi squared distribution/operator\(\)")  
Characteristics  
[chi_squared_distribution::n](chi_squared_distribution/n.html "cpp/numeric/random/chi squared distribution/n")  
[chi_squared_distribution::param](chi_squared_distribution/param.html "cpp/numeric/random/chi squared distribution/param")  
[chi_squared_distribution::min](chi_squared_distribution/min.html "cpp/numeric/random/chi squared distribution/min")  
[chi_squared_distribution::max](chi_squared_distribution/max.html "cpp/numeric/random/chi squared distribution/max")  
Non-member functions  
[operator==operator!=](chi_squared_distribution/operator_cmp.html "cpp/numeric/random/chi squared distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](chi_squared_distribution/operator_ltltgtgt.html "cpp/numeric/random/chi squared distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/chi_squared_distribution/navbar_content&action=edit)

Defined in header `[<random>](../../header/random.html "cpp/header/random")` |  |   
---|---|---  
template< class RealType = double >  
class chi_squared_distribution; |  |  (since C++11)  
| |   
  
The `chi_squared_distribution` produces random numbers \\(\small x>0\\)x>0 according to the [Chi-squared distribution](https://en.wikipedia.org/wiki/Chi-squared_distribution "enwiki:Chi-squared distribution"): 
...
\\(\small\Gamma\\)Γ is the [Gamma function](https://en.wikipedia.org/wiki/Gamma_function "enwiki:Gamma function") (See also [std::tgamma](../math/tgamma.html "cpp/numeric/math/tgamma")) and \\(\small n\\)n are the [degrees of freedom](https://en.wikipedia.org/wiki/Degrees_of_freedom_\(statistics\) "enwiki:Degrees of freedom \(statistics\)") (default 1). 

[`std::chi_squared_distribution`](chi_squared_distribution.html#top) satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](chi_squared_distribution.html#Template_parameters)
  * [2 Member types](chi_squared_distribution.html#Member_types)
  * [3 Member functions](chi_squared_distribution.html#Member_functions)
    * [3.1 Generation](chi_squared_distribution.html#Generation)
    * [3.2 Characteristics](chi_squared_distribution.html#Characteristics)
  * [4 Non-member functions](chi_squared_distribution.html#Non-member_functions)
  * [5 Example](chi_squared_distribution.html#Example)
  * [6 External links](chi_squared_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/chi_squared_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/chi_squared_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/chi_squared_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](chi_squared_distribution/chi_squared_distribution.html "cpp/numeric/random/chi squared distribution/chi squared distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](chi_squared_distribution/reset.html "cpp/numeric/random/chi squared distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](chi_squared_distribution/operator\(\).html "cpp/numeric/random/chi squared distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ n](chi_squared_distribution/n.html "cpp/numeric/random/chi squared distribution/n")(C++11) |  returns the degrees of freedom (\\(\small n\\)n) distribution parameter   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/chi_squared_distribution/dsc_n&action=edit)  
[ param](chi_squared_distribution/param.html "cpp/numeric/random/chi squared distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](chi_squared_distribution/min.html "cpp/numeric/random/chi squared distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](chi_squared_distribution/max.html "cpp/numeric/random/chi squared distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/chi_squared_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](chi_squared_distribution/operator_cmp.html "cpp/numeric/random/chi squared distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](chi_squared_distribution/operator_ltltgtgt.html "cpp/numeric/random/chi squared distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/chi_squared_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        const auto [min, max] = [std::minmax_element](../../algorithm/minmax_element.html)([std::cbegin](../../iterator/begin.html)(s), [std::cend](../../iterator/end.html)(s));
     
        [std::vector](../../container/vector.html)<[std::div_t](../math/div.html)> qr;
        for (typedef decltype(*[std::cbegin](../../iterator/begin.html)(s)) V; V e : s)
            qr.push_back([std::div](../math/div.html)([std::lerp](../lerp.html)(V(0), 8 * Height,
                                            (e - *min) / (*max - *min)), 8));
     
    ...
     
            if (DrawMinMax && Height > 1)
                Height - 1 == h ? [std::cout](../../io/cout.html) << "┬ " << *max:
                              h ? [std::cout](../../io/cout.html) << "│ "
                                : [std::cout](../../io/cout.html) << "┴ " << *min;
        }
    }
     
    int main()
    {
        [std::random_device](random_device.html) rd{};
        [std::mt19937](mersenne_twister_engine.html) gen{rd()};
     
    ...
     
            ...
            for (int n = 0; n != norm; ++n)
                ++hist[[std::round](../math/round.html)(d(gen))];
     
            [std::vector](../../container/vector.html)<float> bars;
            [std::vector](../../container/vector.html)<int> indices;
    ...
     
            [std::cout](../../io/cout.html) << "dof = " << dof << ":\n";
     
            for (draw_vbars<4, 3>(bars); int n : indices)
                [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(2) << n << "  ";
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/chi_squared_distribution&action=edit&section=6 "Edit section: External links")] External links
...
---|---  
2\.  | [Chi-squared distribution](https://en.wikipedia.org/wiki/Chi-squared_distribution "enwiki:Chi-squared distribution") — From Wikipedia. 
