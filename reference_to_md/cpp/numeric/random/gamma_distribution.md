...
Member functions  
---  
[gamma_distribution::gamma_distribution](gamma_distribution/gamma_distribution.html "cpp/numeric/random/gamma distribution/gamma distribution")  
[gamma_distribution::reset](gamma_distribution/reset.html "cpp/numeric/random/gamma distribution/reset")  
Generation  
[gamma_distribution::operator()](gamma_distribution/operator\(\).html "cpp/numeric/random/gamma distribution/operator\(\)")  
Characteristics  
[gamma_distribution::alphagamma_distribution::beta](gamma_distribution/params.html "cpp/numeric/random/gamma distribution/params")  
[gamma_distribution::param](gamma_distribution/param.html "cpp/numeric/random/gamma distribution/param")  
[gamma_distribution::min](gamma_distribution/min.html "cpp/numeric/random/gamma distribution/min")  
[gamma_distribution::max](gamma_distribution/max.html "cpp/numeric/random/gamma distribution/max")  
Non-member functions  
[operator==operator!=](gamma_distribution/operator_cmp.html "cpp/numeric/random/gamma distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](gamma_distribution/operator_ltltgtgt.html "cpp/numeric/random/gamma distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/gamma_distribution/navbar_content&action=edit)

Defined in header `[<random>](../../header/random.html "cpp/header/random")` |  |   
---|---|---  
template< class RealType = double >  
class gamma_distribution; |  |  (since C++11)  
| |   
...
where α is known as the _shape_ parameter and β is known as the _scale_ parameter. The shape parameter is sometimes denoted by the letter k and the scale parameter is sometimes denoted by the letter θ. 
...
`std::gamma_distribution` satisfies [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](gamma_distribution.html#Template_parameters)
  * [2 Member types](gamma_distribution.html#Member_types)
  * [3 Member functions](gamma_distribution.html#Member_functions)
    * [3.1 Generation](gamma_distribution.html#Generation)
    * [3.2 Characteristics](gamma_distribution.html#Characteristics)
  * [4 Non-member functions](gamma_distribution.html#Non-member_functions)
  * [5 Example](gamma_distribution.html#Example)
  * [6 External links](gamma_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](gamma_distribution/gamma_distribution.html "cpp/numeric/random/gamma distribution/gamma distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](gamma_distribution/reset.html "cpp/numeric/random/gamma distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](gamma_distribution/operator\(\).html "cpp/numeric/random/gamma distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ alphabeta](gamma_distribution/params.html "cpp/numeric/random/gamma distribution/params")(C++11) |  returns the distribution parameters   
...
[ param](gamma_distribution/param.html "cpp/numeric/random/gamma distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](gamma_distribution/min.html "cpp/numeric/random/gamma distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](gamma_distribution/max.html "cpp/numeric/random/gamma distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](gamma_distribution/operator_cmp.html "cpp/numeric/random/gamma distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](gamma_distribution/operator_ltltgtgt.html "cpp/numeric/random/gamma distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution&action=edit&section=6 "Edit section: External links")] External links
