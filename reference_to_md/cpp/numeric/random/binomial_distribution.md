...
Member functions  
---  
[binomial_distribution::binomial_distribution](binomial_distribution/binomial_distribution.html "cpp/numeric/random/binomial distribution/binomial distribution")  
[binomial_distribution::reset](binomial_distribution/reset.html "cpp/numeric/random/binomial distribution/reset")  
Generation  
[binomial_distribution::operator()](binomial_distribution/operator\(\).html "cpp/numeric/random/binomial distribution/operator\(\)")  
Characteristics  
[binomial_distribution::pbinomial_distribution::t](binomial_distribution/params.html "cpp/numeric/random/binomial distribution/params")  
[binomial_distribution::param](binomial_distribution/param.html "cpp/numeric/random/binomial distribution/param")  
[binomial_distribution::min](binomial_distribution/min.html "cpp/numeric/random/binomial distribution/min")  
[binomial_distribution::max](binomial_distribution/max.html "cpp/numeric/random/binomial distribution/max")  
Non-member functions  
[operator==operator!=](binomial_distribution/operator_cmp.html "cpp/numeric/random/binomial distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](binomial_distribution/operator_ltltgtgt.html "cpp/numeric/random/binomial distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/binomial_distribution/navbar_content&action=edit)
...
`std::binomial_distribution` satisfies [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](binomial_distribution.html#Template_parameters)
  * [2 Member types](binomial_distribution.html#Member_types)
  * [3 Member functions](binomial_distribution.html#Member_functions)
    * [3.1 Generation](binomial_distribution.html#Generation)
    * [3.2 Characteristics](binomial_distribution.html#Characteristics)
  * [4 Non-member functions](binomial_distribution.html#Non-member_functions)
  * [5 Example](binomial_distribution.html#Example)
  * [6 External links](binomial_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/binomial_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/binomial_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/binomial_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](binomial_distribution/binomial_distribution.html "cpp/numeric/random/binomial distribution/binomial distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](binomial_distribution/reset.html "cpp/numeric/random/binomial distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](binomial_distribution/operator\(\).html "cpp/numeric/random/binomial distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ pt](binomial_distribution/params.html "cpp/numeric/random/binomial distribution/params")(C++11) |  returns the distribution parameters   
...
[ param](binomial_distribution/param.html "cpp/numeric/random/binomial distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](binomial_distribution/min.html "cpp/numeric/random/binomial distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](binomial_distribution/max.html "cpp/numeric/random/binomial distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/binomial_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](binomial_distribution/operator_cmp.html "cpp/numeric/random/binomial distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](binomial_distribution/operator_ltltgtgt.html "cpp/numeric/random/binomial distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/binomial_distribution&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/binomial_distribution&action=edit&section=6 "Edit section: External links")] External links
