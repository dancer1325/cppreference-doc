...
Member functions  
---  
[lognormal_distribution::lognormal_distribution](lognormal_distribution/lognormal_distribution.html "cpp/numeric/random/lognormal distribution/lognormal distribution")  
[lognormal_distribution::reset](lognormal_distribution/reset.html "cpp/numeric/random/lognormal distribution/reset")  
Generation  
[lognormal_distribution::operator()](lognormal_distribution/operator\(\).html "cpp/numeric/random/lognormal distribution/operator\(\)")  
Characteristics  
[lognormal_distribution::mlognormal_distribution::s](lognormal_distribution/params.html "cpp/numeric/random/lognormal distribution/params")  
[lognormal_distribution::param](lognormal_distribution/param.html "cpp/numeric/random/lognormal distribution/param")  
[lognormal_distribution::min](lognormal_distribution/min.html "cpp/numeric/random/lognormal distribution/min")  
[lognormal_distribution::max](lognormal_distribution/max.html "cpp/numeric/random/lognormal distribution/max")  
Non-member functions  
[operator==operator!=](lognormal_distribution/operator_cmp.html "cpp/numeric/random/lognormal distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](lognormal_distribution/operator_ltltgtgt.html "cpp/numeric/random/lognormal distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/lognormal_distribution/navbar_content&action=edit)

Defined in header `[<random>](../../header/random.html "cpp/header/random")` |  |   
---|---|---  
template< class RealType = double >  
class lognormal_distribution; |  |  (since C++11)  
| |   
  
The lognormal_distribution random number distribution produces random numbers x > 0 according to a [Log-normal distribution](https://en.wikipedia.org/wiki/Log-normal_distribution "enwiki:Log-normal distribution"): 
...
[`std::lognormal_distribution`](lognormal_distribution.html#top) satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](lognormal_distribution.html#Template_parameters)
  * [2 Member types](lognormal_distribution.html#Member_types)
  * [3 Member functions](lognormal_distribution.html#Member_functions)
    * [3.1 Generation](lognormal_distribution.html#Generation)
    * [3.2 Characteristics](lognormal_distribution.html#Characteristics)
  * [4 Non-member functions](lognormal_distribution.html#Non-member_functions)
  * [5 Example](lognormal_distribution.html#Example)
  * [6 External links](lognormal_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/lognormal_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/lognormal_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/lognormal_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](lognormal_distribution/lognormal_distribution.html "cpp/numeric/random/lognormal distribution/lognormal distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](lognormal_distribution/reset.html "cpp/numeric/random/lognormal distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](lognormal_distribution/operator\(\).html "cpp/numeric/random/lognormal distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ ms](lognormal_distribution/params.html "cpp/numeric/random/lognormal distribution/params")(C++11) |  returns the distribution parameters   
...
[ param](lognormal_distribution/param.html "cpp/numeric/random/lognormal distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](lognormal_distribution/min.html "cpp/numeric/random/lognormal distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](lognormal_distribution/max.html "cpp/numeric/random/lognormal distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/lognormal_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](lognormal_distribution/operator_cmp.html "cpp/numeric/random/lognormal distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](lognormal_distribution/operator_ltltgtgt.html "cpp/numeric/random/lognormal distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/lognormal_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        for ([std::cout](../../io/cout.html) << [std::fixed](../../io/manip/fixed.html) << [std::setprecision](../../io/manip/setprecision.html)(1); auto [x, y] : hist)
            [std::cout](../../io/cout.html) << [std::hex](../../io/manip/hex.html) << x << ' ' << [std::string](../../string/basic_string.html)(y / 200, '*') << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/lognormal_distribution&action=edit&section=6 "Edit section: External links")] External links
