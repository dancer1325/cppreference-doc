...
Member functions  
---  
[poisson_distribution::poisson_distribution](poisson_distribution/poisson_distribution.html "cpp/numeric/random/poisson distribution/poisson distribution")  
[poisson_distribution::reset](poisson_distribution/reset.html "cpp/numeric/random/poisson distribution/reset")  
Generation  
[poisson_distribution::operator()](poisson_distribution/operator\(\).html "cpp/numeric/random/poisson distribution/operator\(\)")  
Characteristics  
[poisson_distribution::mean](poisson_distribution/mean.html "cpp/numeric/random/poisson distribution/mean")  
[poisson_distribution::param](poisson_distribution/param.html "cpp/numeric/random/poisson distribution/param")  
[poisson_distribution::min](poisson_distribution/min.html "cpp/numeric/random/poisson distribution/min")  
[poisson_distribution::max](poisson_distribution/max.html "cpp/numeric/random/poisson distribution/max")  
Non-member functions  
[operator==operator!=](poisson_distribution/operator_cmp.html "cpp/numeric/random/poisson distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](poisson_distribution/operator_ltltgtgt.html "cpp/numeric/random/poisson distribution/operator ltltgtgt")(C++11)(C++11)  
...
class poisson_distribution; |  |  (since C++11)  
| |   
...
The value obtained is the probability of exactly i occurrences of a random event if the expected, _mean_ number of its occurrence under the same conditions (on the same time/space interval) is μ. 

`std::poisson_distribution` satisfies [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](poisson_distribution.html#Template_parameters)
  * [2 Member types](poisson_distribution.html#Member_types)
  * [3 Member functions](poisson_distribution.html#Member_functions)
    * [3.1 Generation](poisson_distribution.html#Generation)
    * [3.2 Characteristics](poisson_distribution.html#Characteristics)
  * [4 Non-member functions](poisson_distribution.html#Non-member_functions)
  * [5 Example](poisson_distribution.html#Example)
  * [6 External links](poisson_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/poisson_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/poisson_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/poisson_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](poisson_distribution/poisson_distribution.html "cpp/numeric/random/poisson distribution/poisson distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](poisson_distribution/reset.html "cpp/numeric/random/poisson distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](poisson_distribution/operator\(\).html "cpp/numeric/random/poisson distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ mean](poisson_distribution/mean.html "cpp/numeric/random/poisson distribution/mean")(C++11) |  returns the _mean_ distribution parameter (mean number of occurrences of the event)   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/poisson_distribution/dsc_mean&action=edit)  
[ param](poisson_distribution/param.html "cpp/numeric/random/poisson distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](poisson_distribution/min.html "cpp/numeric/random/poisson distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](poisson_distribution/max.html "cpp/numeric/random/poisson distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/poisson_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](poisson_distribution/operator_cmp.html "cpp/numeric/random/poisson distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](poisson_distribution/operator_ltltgtgt.html "cpp/numeric/random/poisson distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/poisson_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        for (auto [x, y] : hist)
            [std::cout](../../io/cout.html) << [std::hex](../../io/manip/hex.html) << x << ' '
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/poisson_distribution&action=edit&section=6 "Edit section: External links")] External links
