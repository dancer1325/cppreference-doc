...
const mersenne_twister_engine& rhs ); |  (1)  |  (since C++11)  
---|---|---  
friend bool operator!=( const mersenne_twister_engine& lhs,  
const mersenne_twister_engine& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
