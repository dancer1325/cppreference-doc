...
[mersenne_twister_engine::seed](seed.html "cpp/numeric/random/mersenne twister engine/seed")  
Generation  
...
explicit mersenne_twister_engine( SeedSeq& seq ); |  (3)  |  (since C++11)  
mersenne_twister_engine( const mersenne_twister_engine& other ); |  (4)  |  (since C++11)   
(implicitly declared)  
| |   
...
as p, the engine's initial [state](../mersenne_twister_engine.html#Generator_properties "cpp/numeric/random/mersenne twister engine") is determined as follows: 

  1. Sets \\(\scriptsize X_{-n} \\)X-n to value % p. 
  2. For each integer i in `[`i - n`, `-1`]`, sets \\(\scriptsize X_i \\)Xi to \\(\scriptsize [f \cdot (X_{i-1}\ \mathsf{xor}\ (X_{i-1}\ \mathsf{rshift}\ (w-2)))+i \mod n] \mod p \\)[f·(Xi-1 xor (Xi-1 rshift (w-2)))+i mod n] mod p, where \\(\scriptsize \mathsf{xor} \\)xor and \\(\scriptsize \mathsf{rshift} \\)rshift stand for built-in [bitwise XOR](../../../language/operator_arithmetic.html#Bitwise_logic_operators "cpp/language/operator arithmetic") and [bitwise right-shift](../../../language/operator_arithmetic.html#Bitwise_shift_operators "cpp/language/operator arithmetic") respectively.



3) Constructs the engine with a seed sequence seq. Given [std::size_t](../../../types/size_t.html)(w / 32) + 1 as k, the engine's initial [state](../mersenne_twister_engine.html#Generator_properties "cpp/numeric/random/mersenne twister engine") is determined as follows: 
...
## Contents
  ...
  * [1 Parameters](mersenne_twister_engine.html#Parameters)
  * [2 Complexity](mersenne_twister_engine.html#Complexity)
  * [3 Exceptions](mersenne_twister_engine.html#Exceptions)
  * [4 Example](mersenne_twister_engine.html#Example)
  * [5 Defect reports](mersenne_twister_engine.html#Defect_reports)
  * [6 See also](mersenne_twister_engine.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::mt19937](../mersenne_twister_engine.html) gen32; // overload (1)
        [std::mt19937_64](../mersenne_twister_engine.html) gen64; // overload (1)
        gen32.discard(10000 - 1);
        gen64.discard(10000 - 1);
        [assert](../../../error/assert.html)(gen32() == 4123659995);
