...
Member functions  
---  
[mersenne_twister_engine::mersenne_twister_engine](mersenne_twister_engine.html "cpp/numeric/random/mersenne twister engine/mersenne twister engine")  
**mersenne_twister_engine::seed**  
Generation  
[mersenne_twister_engine::operator()](operator\(\).html "cpp/numeric/random/mersenne twister engine/operator\(\)")  
[mersenne_twister_engine::discard](discard.html "cpp/numeric/random/mersenne twister engine/discard")  
Characteristics  
[mersenne_twister_engine::min](min.html "cpp/numeric/random/mersenne twister engine/min")  
[mersenne_twister_engine::max](max.html "cpp/numeric/random/mersenne twister engine/max")  
...
Sets the [state](../mersenne_twister_engine.html#Generator_properties "cpp/numeric/random/mersenne twister engine") of the random-number engine. 

1) Right after the state is set, *this == [std::mersenne_twister_engine](../mersenne_twister_engine.html)(value) is true.

2) Right after the state is set, *this == [std::mersenne_twister_engine](../mersenne_twister_engine.html)(seq) is true.
...
1) Same as [std::mersenne_twister_engine](../mersenne_twister_engine.html)(value).

2) Same as [std::mersenne_twister_engine](../mersenne_twister_engine.html)(seq).
...
[ (constructor)](mersenne_twister_engine.html "cpp/numeric/random/mersenne twister engine/mersenne twister engine") |  constructs the engine   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/mersenne_twister_engine/seed&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::mt19937](../mersenne_twister_engine.html) gen;
     
        // Seed the engine with an unsigned int
        gen.seed(1);
        [std::cout](../../../io/cout.html) << "after seed by 1: " << gen() << '\n';
     
        // Seed the engine with two unsigned ints
        [std::seed_seq](../seed_seq.html) sseq{1, 2};
        gen.seed(sseq);
        [std::cout](../../../io/cout.html) << "after seed by {1,2}: " << gen() << '\n';
    }
