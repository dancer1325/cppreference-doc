...
Member functions  
---  
[extreme_value_distribution::extreme_value_distribution](extreme_value_distribution/extreme_value_distribution.html "cpp/numeric/random/extreme value distribution/extreme value distribution")  
[extreme_value_distribution::reset](extreme_value_distribution/reset.html "cpp/numeric/random/extreme value distribution/reset")  
Generation  
[extreme_value_distribution::operator()](extreme_value_distribution/operator\(\).html "cpp/numeric/random/extreme value distribution/operator\(\)")  
Characteristics  
[extreme_value_distribution::aextreme_value_distribution::b](extreme_value_distribution/params.html "cpp/numeric/random/extreme value distribution/params")  
[extreme_value_distribution::param](extreme_value_distribution/param.html "cpp/numeric/random/extreme value distribution/param")  
[extreme_value_distribution::min](extreme_value_distribution/min.html "cpp/numeric/random/extreme value distribution/min")  
[extreme_value_distribution::max](extreme_value_distribution/max.html "cpp/numeric/random/extreme value distribution/max")  
Non-member functions  
[operator==operator!=](extreme_value_distribution/operator_cmp.html "cpp/numeric/random/extreme value distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](extreme_value_distribution/operator_ltltgtgt.html "cpp/numeric/random/extreme value distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/extreme_value_distribution/navbar_content&action=edit)

Defined in header `[<random>](../../header/random.html "cpp/header/random")` |  |   
---|---|---  
template< class RealType = double >  
class extreme_value_distribution; |  |  (since C++11)  
| |   
  
Produces random numbers according to the [Generalized extreme value distribution](https://en.wikipedia.org/wiki/Generalized_extreme_value_distribution "enwiki:Generalized extreme value distribution") (it is also known as Gumbel Type I, log-Weibull, Fisher-Tippett Type I): 
...
`std::extreme_value_distribution` satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](extreme_value_distribution.html#Template_parameters)
  * [2 Member types](extreme_value_distribution.html#Member_types)
  * [3 Member functions](extreme_value_distribution.html#Member_functions)
    * [3.1 Generation](extreme_value_distribution.html#Generation)
    * [3.2 Characteristics](extreme_value_distribution.html#Characteristics)
  * [4 Non-member functions](extreme_value_distribution.html#Non-member_functions)
  * [5 Example](extreme_value_distribution.html#Example)
  * [6 External links](extreme_value_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/extreme_value_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/extreme_value_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/extreme_value_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](extreme_value_distribution/extreme_value_distribution.html "cpp/numeric/random/extreme value distribution/extreme value distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](extreme_value_distribution/reset.html "cpp/numeric/random/extreme value distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](extreme_value_distribution/operator\(\).html "cpp/numeric/random/extreme value distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ ab](extreme_value_distribution/params.html "cpp/numeric/random/extreme value distribution/params")(C++11) |  returns the distribution parameters   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/dsc_params&action=edit)  
[ param](extreme_value_distribution/param.html "cpp/numeric/random/extreme value distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](extreme_value_distribution/min.html "cpp/numeric/random/extreme value distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](extreme_value_distribution/max.html "cpp/numeric/random/extreme value distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/extreme_value_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](extreme_value_distribution/operator_cmp.html "cpp/numeric/random/extreme value distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](extreme_value_distribution/operator_ltltgtgt.html "cpp/numeric/random/extreme value distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/extreme_value_distribution&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/extreme_value_distribution&action=edit&section=6 "Edit section: External links")] External links
