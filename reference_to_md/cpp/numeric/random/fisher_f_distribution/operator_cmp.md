...
[`std::fisher_f_distribution`](../fisher_f_distribution.html "cpp/numeric/random/fisher f distribution")

Member functions  
---  
[fisher_f_distribution::fisher_f_distribution](fisher_f_distribution.html "cpp/numeric/random/fisher f distribution/fisher f distribution")  
[fisher_f_distribution::reset](reset.html "cpp/numeric/random/fisher f distribution/reset")  
Generation  
[fisher_f_distribution::operator()](operator\(\).html "cpp/numeric/random/fisher f distribution/operator\(\)")  
Characteristics  
[fisher_f_distribution::mfisher_f_distribution::n](params.html "cpp/numeric/random/fisher f distribution/params")  
[fisher_f_distribution::param](param.html "cpp/numeric/random/fisher f distribution/param")  
[fisher_f_distribution::min](min.html "cpp/numeric/random/fisher f distribution/min")  
[fisher_f_distribution::max](max.html "cpp/numeric/random/fisher f distribution/max")  
Non-member functions  
**operator== operator!=**(C++11)(C++11)(until C++20)  
[operator<<operator>>](operator_ltltgtgt.html "cpp/numeric/random/fisher f distribution/operator ltltgtgt")(C++11)(C++11)  
...
const fisher_f_distribution& rhs ); |  (1)  |  (since C++11)  
---|---|---  
friend bool operator!=( const fisher_f_distribution& lhs,  
const fisher_f_distribution& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
