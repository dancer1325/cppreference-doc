...
[`std::piecewise_linear_distribution`](../piecewise_linear_distribution.html "cpp/numeric/random/piecewise linear distribution")

Member functions  
---  
[piecewise_linear_distribution::piecewise_linear_distribution](piecewise_linear_distribution.html "cpp/numeric/random/piecewise linear distribution/piecewise linear distribution")  
[piecewise_linear_distribution::reset](reset.html "cpp/numeric/random/piecewise linear distribution/reset")  
Generation  
[piecewise_linear_distribution::operator()](operator\(\).html "cpp/numeric/random/piecewise linear distribution/operator\(\)")  
Characteristics  
[piecewise_linear_distribution::intervalspiecewise_linear_distribution::densities](params.html "cpp/numeric/random/piecewise linear distribution/params")  
[piecewise_linear_distribution::param](param.html "cpp/numeric/random/piecewise linear distribution/param")  
[piecewise_linear_distribution::min](min.html "cpp/numeric/random/piecewise linear distribution/min")  
[piecewise_linear_distribution::max](max.html "cpp/numeric/random/piecewise linear distribution/max")  
Non-member functions  
**operator== operator!=**(C++11)(C++11)(until C++20)  
[operator<<operator>>](operator_ltltgtgt.html "cpp/numeric/random/piecewise linear distribution/operator ltltgtgt")(C++11)(C++11)  
...
const piecewise_linear_distribution& rhs ); |  (1)  |  (since C++11)  
---|---|---  
friend bool operator!=( const piecewise_linear_distribution& lhs,  
const piecewise_linear_distribution& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
