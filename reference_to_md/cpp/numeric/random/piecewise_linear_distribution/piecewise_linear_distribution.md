...
piecewise_linear_distribution( [std::initializer_list](../../../utility/initializer_list.html)<RealType> ilist,   
UnaryOperation fw ); |  (3)  |  (since C++11)  
template< class UnaryOperation >  
piecewise_linear_distribution( [std::size_t](../../../types/size_t.html) nw,   
...
1) Constructs a distribution object with _n_ = 1, _ρ0_ = 1, _b0_ = 0, and _b1_ = 1.
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_linear_distribution/piecewise_linear_distribution&action=edit&section=1 "Edit section: Parameters")] Parameters
