...
Returns a pseudo-random integral value from the range `[`​0​`, `[RAND_MAX](RAND_MAX.html)`]`. 

[std::srand()](srand.html "cpp/numeric/random/srand") seeds the pseudo-random number generator used by `rand()`. If `rand()` is used before any calls to [std::srand()](srand.html "cpp/numeric/random/srand"), `rand()` behaves as if it was seeded with [std::srand](srand.html)(1). 

Each time `rand()` is seeded with [std::srand()](srand.html "cpp/numeric/random/srand"), it must produce the same sequence of values on successive calls. 
...
## Contents
  ...
  * [1 Return value](rand.html#Return_value)
  * [2 Notes](rand.html#Notes)
  * [3 Example](rand.html#Example)
  * [4 See also](rand.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/rand&action=edit&section=1 "Edit section: Return value")] Return value

Pseudo-random integral value between ​0​ and [RAND_MAX](RAND_MAX.html "cpp/numeric/random/RAND MAX"). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/rand&action=edit&section=2 "Edit section: Notes")] Notes

There are no guarantees as to the quality of the random sequence produced. In the past, some implementations of `rand()` have had serious shortcomings in the randomness, distribution and period of the sequence produced (in one well-known example, the low-order bit simply alternated between 1 and ​0​ between calls). 

`rand()` is not recommended for serious random-number generation needs. It is recommended to use C++11's [random number generation](../random.html "cpp/numeric/random") facilities to replace `rand()`.(since C++11)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/rand&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main() 
    {
        [std::srand](srand.html)([std::time](../../chrono/c/time.html)({})); // use current time as seed for random generator
        const int random_value = std::rand();
        [std::cout](../../io/cout.html) << "Random value on [0, " << [RAND_MAX](RAND_MAX.html) << "]: " << random_value << '\n';
     
        for (const unsigned sides : {2, 4, 6, 8})
        {
            [std::cout](../../io/cout.html) << "Roll " << sides << "-sided die 8 times: ";
            for (int n = 8; n; --n)
                [std::cout](../../io/cout.html) << 1 + bounded_rand(sides) << ' ';
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/rand&action=edit&section=4 "Edit section: See also")] See also

[ uniform_int_distribution](uniform_int_distribution.html "cpp/numeric/random/uniform int distribution")(C++11) |  produces integer values evenly distributed across a range   
...
---|---  
[ srand](srand.html "cpp/numeric/random/srand") |  seeds pseudo-random number generator   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/dsc_srand&action=edit)  
[ RAND_MAX](RAND_MAX.html "cpp/numeric/random/RAND MAX") |  maximum possible value generated by **std::rand**   
(macro constant) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/dsc_RAND_MAX&action=edit)  
[ randint](../../experimental/randint.html "cpp/experimental/randint") |  generates a random integer in the specified range   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_randint&action=edit)  
[C documentation](../../../c/numeric/random/rand.html "c/numeric/random/rand") for rand
