...
lognormal_distribution() : lognormal_distribution(0.0) {} |  (1)  |  (since C++11)  
---|---|---  
explicit lognormal_distribution( RealType m, RealType s = 1.0 ); |  (2)  |  (since C++11)  
explicit lognormal_distribution( const param_type& params ); |  (3)  |  (since C++11)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/lognormal_distribution/lognormal_distribution&action=edit&section=1 "Edit section: Parameters")] Parameters

m  |  \-  |  the _m_ distribution parameter (log-scale)   
---|---|---  
s  |  \-  |  the _s_ distribution parameter (shape)   
params  |  \-  |  the distribution parameter set   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/lognormal_distribution/lognormal_distribution&action=edit&section=2 "Edit section: Defect reports")] Defect reports 
