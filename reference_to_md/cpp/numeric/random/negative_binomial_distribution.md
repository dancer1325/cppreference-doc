...
Member functions  
---  
[negative_binomial_distribution::negative_binomial_distribution](negative_binomial_distribution/negative_binomial_distribution.html "cpp/numeric/random/negative binomial distribution/negative binomial distribution")  
[negative_binomial_distribution::reset](negative_binomial_distribution/reset.html "cpp/numeric/random/negative binomial distribution/reset")  
Generation  
[negative_binomial_distribution::operator()](negative_binomial_distribution/operator\(\).html "cpp/numeric/random/negative binomial distribution/operator\(\)")  
Characteristics  
[negative_binomial_distribution::pnegative_binomial_distribution::k](negative_binomial_distribution/params.html "cpp/numeric/random/negative binomial distribution/params")  
[negative_binomial_distribution::param](negative_binomial_distribution/param.html "cpp/numeric/random/negative binomial distribution/param")  
[negative_binomial_distribution::min](negative_binomial_distribution/min.html "cpp/numeric/random/negative binomial distribution/min")  
[negative_binomial_distribution::max](negative_binomial_distribution/max.html "cpp/numeric/random/negative binomial distribution/max")  
Non-member functions  
[operator==operator!=](negative_binomial_distribution/operator_cmp.html "cpp/numeric/random/negative binomial distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](negative_binomial_distribution/operator_ltltgtgt.html "cpp/numeric/random/negative binomial distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/negative_binomial_distribution/navbar_content&action=edit)

Defined in header `[<random>](../../header/random.html "cpp/header/random")` |  |   
---|---|---  
template< class IntType = int >  
class negative_binomial_distribution; |  |  (since C++11)  
| |   
...
`std::negative_binomial_distribution` satisfies [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](negative_binomial_distribution.html#Template_parameters)
  * [2 Member types](negative_binomial_distribution.html#Member_types)
  * [3 Member functions](negative_binomial_distribution.html#Member_functions)
    * [3.1 Generation](negative_binomial_distribution.html#Generation)
    * [3.2 Characteristics](negative_binomial_distribution.html#Characteristics)
  * [4 Non-member functions](negative_binomial_distribution.html#Non-member_functions)
  * [5 Example](negative_binomial_distribution.html#Example)
  * [6 External links](negative_binomial_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](negative_binomial_distribution/negative_binomial_distribution.html "cpp/numeric/random/negative binomial distribution/negative binomial distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](negative_binomial_distribution/reset.html "cpp/numeric/random/negative binomial distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](negative_binomial_distribution/operator\(\).html "cpp/numeric/random/negative binomial distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ pk](negative_binomial_distribution/params.html "cpp/numeric/random/negative binomial distribution/params")(C++11) |  returns the distribution parameters   
...
[ param](negative_binomial_distribution/param.html "cpp/numeric/random/negative binomial distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](negative_binomial_distribution/min.html "cpp/numeric/random/negative binomial distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](negative_binomial_distribution/max.html "cpp/numeric/random/negative binomial distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](negative_binomial_distribution/operator_cmp.html "cpp/numeric/random/negative binomial distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](negative_binomial_distribution/operator_ltltgtgt.html "cpp/numeric/random/negative binomial distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        for (auto [x, y] : hist)
            [std::cout](../../io/cout.html) << [std::hex](../../io/manip/hex.html) << x << ' ' << [std::string](../../string/basic_string.html)(y / 100, '*') << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution&action=edit&section=6 "Edit section: External links")] External links
