...
Characteristics  
**uniform_int_distribution::a uniform_int_distribution::b**  
...
1) Returns the _a_ distribution parameter. It defines the minimum possibly generated value. The default value is ​0​.

2) Returns the _b_ distribution parameter. It defines the maximum possibly generated value. The default value is [std::numeric_limits](../../../types/numeric_limits.html)<IntType>::max().

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/uniform_int_distribution/params&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/uniform_int_distribution/params&action=edit&section=2 "Edit section: Return value")] Return value

1) The _a_ distribution parameter.

2) The _b_ distribution parameter.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/uniform_int_distribution/params&action=edit&section=3 "Edit section: See also")] See also

[ param](param.html "cpp/numeric/random/uniform int distribution/param")(C++11) |  gets or sets the distribution parameter object   
