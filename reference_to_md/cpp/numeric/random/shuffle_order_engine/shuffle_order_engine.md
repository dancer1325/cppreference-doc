...
[`std::shuffle_order_engine`](../shuffle_order_engine.html "cpp/numeric/random/shuffle order engine")

Member functions  
---  
**shuffle_order_engine::shuffle_order_engine**  
[shuffle_order_engine::seed](seed.html "cpp/numeric/random/shuffle order engine/seed")  
[shuffle_order_engine::base](base.html "cpp/numeric/random/shuffle order engine/base")  
Generation  
[shuffle_order_engine::operator()](operator\(\).html "cpp/numeric/random/shuffle order engine/operator\(\)")  
[shuffle_order_engine::discard](discard.html "cpp/numeric/random/shuffle order engine/discard")  
Characteristics  
[shuffle_order_engine::min](min.html "cpp/numeric/random/shuffle order engine/min")  
[shuffle_order_engine::max](max.html "cpp/numeric/random/shuffle order engine/max")  
Non-member functions  
[operator==operator!=](operator_cmp.html "cpp/numeric/random/shuffle order engine/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](operator_ltltgtgt.html "cpp/numeric/random/shuffle order engine/operator ltltgtgt")(C++11)(C++11)  
...
explicit shuffle_order_engine( SeedSeq& seq ); |  (3)  |  (since C++11)  
...
## Contents
  ...
  * [1 Parameters](shuffle_order_engine.html#Parameters)
  * [2 Exceptions](shuffle_order_engine.html#Exceptions)
  * [3 Example](shuffle_order_engine.html#Example)
  * [4 Defect reports](shuffle_order_engine.html#Defect_reports)
...
---|---|---|---  
[LWG 2181](https://cplusplus.github.io/LWG/issue2181) | C++11  | overload ([3](shuffle_order_engine.html#Version_3)) would not throw even if the `seq.generate` call throws  | propagates the exception 
