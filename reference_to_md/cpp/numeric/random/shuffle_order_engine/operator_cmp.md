...
const shuffle_order_engine& rhs ); |  (1)  |  (since C++11)  
---|---|---  
friend bool operator!=( const shuffle_order_engine& lhs,  
const shuffle_order_engine& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
