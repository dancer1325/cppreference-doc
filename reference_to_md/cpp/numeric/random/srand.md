...
Seeds the pseudo-random number generator used by [std::rand()](rand.html "cpp/numeric/random/rand") with the value `seed`. 

If [std::rand()](rand.html "cpp/numeric/random/rand") is used before any calls to `srand()`, [std::rand()](rand.html "cpp/numeric/random/rand") behaves as if it was seeded with srand(1). 

Each time [std::rand()](rand.html "cpp/numeric/random/rand") is seeded with the same `seed`, it must produce the same sequence of values. 
...
## Contents
  ...
  * [5 See also](srand.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/srand&action=edit&section=1 "Edit section: Parameters")] Parameters

seed  |  \-  |  the seed value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/srand&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/srand&action=edit&section=3 "Edit section: Notes")] Notes
...
Standard practice is to use the result of a call to [std::time](../../chrono/c/time.html)(0) as the seed. However, [std::time](../../chrono/c/time.html "cpp/chrono/c/time") returns a [std::time_t](../../chrono/c/time_t.html) value, and [std::time_t](../../chrono/c/time_t.html) is not guaranteed to be an integral type. In practice, though, every major implementation defines [std::time_t](../../chrono/c/time_t.html) to be an integral type, and this is also what POSIX requires. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/srand&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main() 
    {
        std::srand([std::time](../../chrono/c/time.html)(0)); // use current time as seed for random generator
        [std::cout](../../io/cout.html) << "Random value on [0, " << [RAND_MAX](RAND_MAX.html) << "]: " << [std::rand](rand.html)() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/srand&action=edit&section=5 "Edit section: See also")] See also

[ rand](rand.html "cpp/numeric/random/rand") |  generates a pseudo-random number   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/dsc_rand&action=edit)  
---|---  
[ RAND_MAX](RAND_MAX.html "cpp/numeric/random/RAND MAX") |  maximum possible value generated by [std::rand](rand.html "cpp/numeric/random/rand")   
(macro constant) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/dsc_RAND_MAX&action=edit)  
[ reseed](../../experimental/reseed.html "cpp/experimental/reseed") |  reseeds the per-thread random engine   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_reseed&action=edit)  
[C documentation](../../../c/numeric/random/srand.html "c/numeric/random/srand") for srand
