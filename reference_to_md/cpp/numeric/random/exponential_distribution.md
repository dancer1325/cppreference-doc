...
Member functions  
---  
[exponential_distribution::exponential_distribution](exponential_distribution/exponential_distribution.html "cpp/numeric/random/exponential distribution/exponential distribution")  
[exponential_distribution::reset](exponential_distribution/reset.html "cpp/numeric/random/exponential distribution/reset")  
Generation  
[exponential_distribution::operator()](exponential_distribution/operator\(\).html "cpp/numeric/random/exponential distribution/operator\(\)")  
Characteristics  
[exponential_distribution::lambda](exponential_distribution/lambda.html "cpp/numeric/random/exponential distribution/lambda")  
[exponential_distribution::param](exponential_distribution/param.html "cpp/numeric/random/exponential distribution/param")  
[exponential_distribution::min](exponential_distribution/min.html "cpp/numeric/random/exponential distribution/min")  
[exponential_distribution::max](exponential_distribution/max.html "cpp/numeric/random/exponential distribution/max")  
Non-member functions  
[operator==operator!=](exponential_distribution/operator_cmp.html "cpp/numeric/random/exponential distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](exponential_distribution/operator_ltltgtgt.html "cpp/numeric/random/exponential distribution/operator ltltgtgt")(C++11)(C++11)  
...
class exponential_distribution; |  |  (since C++11)  
| |   
...
This is the continuous counterpart of [std::geometric_distribution](geometric_distribution.html "cpp/numeric/random/geometric distribution"). 

`std::exponential_distribution` satisfies [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](exponential_distribution.html#Template_parameters)
  * [2 Member types](exponential_distribution.html#Member_types)
  * [3 Member functions](exponential_distribution.html#Member_functions)
    * [3.1 Generation](exponential_distribution.html#Generation)
    * [3.2 Characteristics](exponential_distribution.html#Characteristics)
  * [4 Non-member functions](exponential_distribution.html#Non-member_functions)
  * [5 Notes](exponential_distribution.html#Notes)
  * [6 Example](exponential_distribution.html#Example)
  * [7 External links](exponential_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/exponential_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/exponential_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/exponential_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](exponential_distribution/exponential_distribution.html "cpp/numeric/random/exponential distribution/exponential distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](exponential_distribution/reset.html "cpp/numeric/random/exponential distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](exponential_distribution/operator\(\).html "cpp/numeric/random/exponential distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ lambda](exponential_distribution/lambda.html "cpp/numeric/random/exponential distribution/lambda")(C++11) |  returns the _lambda_ distribution parameter (rate of events)   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/exponential_distribution/dsc_lambda&action=edit)  
[ param](exponential_distribution/param.html "cpp/numeric/random/exponential distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](exponential_distribution/min.html "cpp/numeric/random/exponential distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](exponential_distribution/max.html "cpp/numeric/random/exponential distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/exponential_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](exponential_distribution/operator_cmp.html "cpp/numeric/random/exponential distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](exponential_distribution/operator_ltltgtgt.html "cpp/numeric/random/exponential distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/exponential_distribution&action=edit&section=5 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/exponential_distribution&action=edit&section=6 "Edit section: Example")] Example
    ...
     
        for (auto const& [x, y] : hist)
            [std::cout](../../io/cout.html) << [std::fixed](../../io/manip/fixed.html) << [std::setprecision](../../io/manip/setprecision.html)(1)
                      << x / 2.0 << '-' << (x + 1) / 2.0 << ' '
                      << [std::string](../../string/basic_string.html)(y / 200, '*') << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/exponential_distribution&action=edit&section=7 "Edit section: External links")] External links
