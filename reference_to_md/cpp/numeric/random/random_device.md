...
Member functions  
---  
[random_device::random_device](random_device/random_device.html "cpp/numeric/random/random device/random device")  
Generation  
[random_device::operator()](random_device/operator\(\).html "cpp/numeric/random/random device/operator\(\)")  
Characteristics  
[random_device::entropy](random_device/entropy.html "cpp/numeric/random/random device/entropy")  
...
`std::random_device` may be implemented in terms of an implementation-defined pseudo-random number engine if a non-deterministic source (e.g. a hardware device) is not available to the implementation. In this case each [`std::random_device`](random_device.html#top) object may generate the same number sequence. 

## Contents

  * [1 Member types](random_device.html#Member_types)
  * [2 Member functions](random_device.html#Member_functions)
    * [2.1 Construction](random_device.html#Construction)
    * [2.2 Generation](random_device.html#Generation)
    * [2.3 Characteristics](random_device.html#Characteristics)
  * [3 Notes](random_device.html#Notes)
  * [4 Example](random_device.html#Example)
...
Run this code
    ...
    int main()
    {
        ...
        [std::uniform_int_distribution](uniform_int_distribution.html)<int> dist(0, 9);
     
