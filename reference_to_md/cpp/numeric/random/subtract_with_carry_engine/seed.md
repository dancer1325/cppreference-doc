...
Sets the [state](../subtract_with_carry_engine.html#Generator_properties "cpp/numeric/random/subtract with carry engine") of the random-number engine. 

1) Right after the state is set, *this == [std::subtract_with_carry_engine](../subtract_with_carry_engine.html)(value) is true.

2) Right after the state is set, *this == [std::subtract_with_carry_engine](../subtract_with_carry_engine.html)(seq) is true.
...
2) Same as [std::subtract_with_carry_engine](../subtract_with_carry_engine.html)(seq).
