...
---|---|---  
friend bool operator!=( const subtract_with_carry_engine& lhs,  
const subtract_with_carry_engine& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
