...
[subtract_with_carry_engine::seed](seed.html "cpp/numeric/random/subtract with carry engine/seed")  
Generation  
[subtract_with_carry_engine::operator()](operator\(\).html "cpp/numeric/random/subtract with carry engine/operator\(\)")  
[subtract_with_carry_engine::discard](discard.html "cpp/numeric/random/subtract with carry engine/discard")  
Characteristics  
[subtract_with_carry_engine::min](min.html "cpp/numeric/random/subtract with carry engine/min")  
[subtract_with_carry_engine::max](max.html "cpp/numeric/random/subtract with carry engine/max")  
...
explicit subtract_with_carry_engine( SeedSeq& seq ); |  (3)  |  (since C++11)  
subtract_with_carry_engine( const subtract_with_carry_engine& other ); |  (4)  |  (since C++11)   
(implicitly declared)  
| |   
...
2) Constructs the engine with a seed value value. The sequence X of the engine's initial [state](../subtract_with_carry_engine.html#Generator_properties "cpp/numeric/random/subtract with carry engine") is determined as follows: 

  1. Constructs a [std::linear_congruential_engine](../linear_congruential_engine.html)<[std::uint_least32_t](../../../types/integer.html), 40014u, 0u, 2147483563u> object e with argument value == 0u ? default_seed : static_cast<[std::uint_least32_t](../../../types/integer.html)>(value % 2147483563u). 
  2. Let n be [std::size_t](../../../types/size_t.html)(w / 32) + 1. 
...
3) Constructs the engine with a seed sequence seq. Given [std::size_t](../../../types/size_t.html)(w / 32) + 1 as k, the sequence X of the engine's initial [state](../subtract_with_carry_engine.html#Generator_properties "cpp/numeric/random/subtract with carry engine") is determined as follows: 
...
## Contents
  ...
  * [1 Parameters](subtract_with_carry_engine.html#Parameters)
  * [2 Complexity](subtract_with_carry_engine.html#Complexity)
  * [3 Exceptions](subtract_with_carry_engine.html#Exceptions)
  * [4 Example](subtract_with_carry_engine.html#Example)
  * [5 Defect reports](subtract_with_carry_engine.html#Defect_reports)
  * [6 See also](subtract_with_carry_engine.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::ranlux24_base](../subtract_with_carry_engine.html) gen24; // overload (1)
        [std::ranlux48_base](../subtract_with_carry_engine.html) gen48; // overload (1)
        gen24.discard(10000 - 1);
        gen48.discard(10000 - 1);
        [assert](../../../error/assert.html)(gen24() == 7'937'952);
...
---|---|---|---  
[LWG 2181](https://cplusplus.github.io/LWG/issue2181) | C++11  | overload ([3](subtract_with_carry_engine.html#Version_3)) would not throw even if the `seq.generate` call throws  | propagates the exception   
[LWG 3809](https://cplusplus.github.io/LWG/issue3809) | C++11  | e could not be constructed if `result_type` is [std::uint16_t](../../../types/integer.html "cpp/types/integer") | can be constructed in this case   
[LWG 4014](https://cplusplus.github.io/LWG/issue4014) | C++11  | the resolution of [LWG issue 3809](https://cplusplus.github.io/LWG/issue3809) caused the initial seed  
of the intermediate [std::linear_congruential_engine](../linear_congruential_engine.html "cpp/numeric/random/linear congruential engine")  
to have a different type from the engine's `result_type` | truncates and  
converts value  
