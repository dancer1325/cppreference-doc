...
[operator<<operator>>](operator_ltltgtgt.html "cpp/numeric/random/independent bits engine/operator ltltgtgt")(C++11)(C++11)  
...
explicit independent_bits_engine( SeedSeq& seq ); |  (3)  |  (since C++11)  
...
## Contents
  ...
  * [1 Parameters](independent_bits_engine.html#Parameters)
  * [2 Exceptions](independent_bits_engine.html#Exceptions)
  * [3 Example](independent_bits_engine.html#Example)
  * [4 Defect reports](independent_bits_engine.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        auto print = [](auto rem, auto engine, int count)
        {
            ...
            for (int i {}; i != count; ++i)
                [std::cout](../../../io/cout.html) << static_cast<unsigned>(engine()) << ' ';
            [std::cout](../../../io/cout.html) << '\n';
        };
     
        [std::independent_bits_engine](../independent_bits_engine.html)<[std::mt19937](../mersenne_twister_engine.html), /*bits*/ 1, unsigned short>
            e1; // default-constructed
        print("e1", e1, 8);
     
        [std::independent_bits_engine](../independent_bits_engine.html)<[std::mt19937](../mersenne_twister_engine.html), /*bits*/ 1, unsigned int>
            e2(1); // constructed with 1
        print("e2", e2, 8);
     
        [std::random_device](../random_device.html) rd;
        [std::independent_bits_engine](../independent_bits_engine.html)<[std::mt19937](../mersenne_twister_engine.html), /*bits*/ 3, unsigned long>
            e3(rd()); // seeded with rd()
        print("e3", e3, 8);
     
        [std::seed_seq](../seed_seq.html) s {3, 1, 4, 1, 5};
        [std::independent_bits_engine](../independent_bits_engine.html)<[std::mt19937](../mersenne_twister_engine.html), /*bits*/ 3, unsigned long long>
...
---|---|---|---  
[LWG 2181](https://cplusplus.github.io/LWG/issue2181) | C++11  | overload ([3](independent_bits_engine.html#Version_3)) would not throw even if the `seq.generate` call throws  | propagates the exception 
