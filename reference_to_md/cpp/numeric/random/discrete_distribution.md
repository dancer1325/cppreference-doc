...
Member functions  
---  
[discrete_distribution::discrete_distribution](discrete_distribution/discrete_distribution.html "cpp/numeric/random/discrete distribution/discrete distribution")  
[discrete_distribution::reset](discrete_distribution/reset.html "cpp/numeric/random/discrete distribution/reset")  
Generation  
[discrete_distribution::operator()](discrete_distribution/operator\(\).html "cpp/numeric/random/discrete distribution/operator\(\)")  
Characteristics  
[discrete_distribution::probabilities](discrete_distribution/probabilities.html "cpp/numeric/random/discrete distribution/probabilities")  
[discrete_distribution::param](discrete_distribution/param.html "cpp/numeric/random/discrete distribution/param")  
[discrete_distribution::min](discrete_distribution/min.html "cpp/numeric/random/discrete distribution/min")  
[discrete_distribution::max](discrete_distribution/max.html "cpp/numeric/random/discrete distribution/max")  
Non-member functions  
[operator==operator!=](discrete_distribution/operator_cmp.html "cpp/numeric/random/discrete distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](discrete_distribution/operator_ltltgtgt.html "cpp/numeric/random/discrete distribution/operator ltltgtgt")(C++11)(C++11)  
...
class discrete_distribution; |  |  (since C++11)  
| |   
  
`std::discrete_distribution` produces random integers on the interval `[`​0​`, `n`)`, where the probability of each individual integer `i` is defined as wi/S, that is the _weight_ of the `i`th integer divided by the sum of all `n` weights. 

`std::discrete_distribution` satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](discrete_distribution.html#Template_parameters)
  * [2 Member types](discrete_distribution.html#Member_types)
  * [3 Member functions](discrete_distribution.html#Member_functions)
    * [3.1 Generation](discrete_distribution.html#Generation)
    * [3.2 Characteristics](discrete_distribution.html#Characteristics)
  * [4 Non-member functions](discrete_distribution.html#Non-member_functions)
  * [5 Example](discrete_distribution.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/discrete_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/discrete_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/discrete_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](discrete_distribution/discrete_distribution.html "cpp/numeric/random/discrete distribution/discrete distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](discrete_distribution/reset.html "cpp/numeric/random/discrete distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](discrete_distribution/operator\(\).html "cpp/numeric/random/discrete distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ probabilities](discrete_distribution/probabilities.html "cpp/numeric/random/discrete distribution/probabilities") |  obtains the list of probabilities   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/discrete_distribution/dsc_probabilities&action=edit)  
[ param](discrete_distribution/param.html "cpp/numeric/random/discrete distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](discrete_distribution/min.html "cpp/numeric/random/discrete distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](discrete_distribution/max.html "cpp/numeric/random/discrete distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/discrete_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](discrete_distribution/operator_cmp.html "cpp/numeric/random/discrete distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](discrete_distribution/operator_ltltgtgt.html "cpp/numeric/random/discrete distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/discrete_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::map](../../container/map.html)<int, int> map;
     
        for (int n = 0; n < 1e4; ++n)
            ++map[d(gen)];
     
        for (const auto& [num, count] : map)
            [std::cout](../../io/cout.html) << num << " generated " << [std::setw](../../io/manip/setw.html)(4) << count << " times\n";
    }
