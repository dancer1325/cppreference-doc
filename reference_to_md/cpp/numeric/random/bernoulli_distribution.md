...
Member functions  
---  
[bernoulli_distribution::bernoulli_distribution](bernoulli_distribution/bernoulli_distribution.html "cpp/numeric/random/bernoulli distribution/bernoulli distribution")  
[bernoulli_distribution::reset](bernoulli_distribution/reset.html "cpp/numeric/random/bernoulli distribution/reset")  
Generation  
[bernoulli_distribution::operator()](bernoulli_distribution/operator\(\).html "cpp/numeric/random/bernoulli distribution/operator\(\)")  
Characteristics  
[bernoulli_distribution::p](bernoulli_distribution/p.html "cpp/numeric/random/bernoulli distribution/p")  
[bernoulli_distribution::param](bernoulli_distribution/param.html "cpp/numeric/random/bernoulli distribution/param")  
[bernoulli_distribution::min](bernoulli_distribution/min.html "cpp/numeric/random/bernoulli distribution/min")  
[bernoulli_distribution::max](bernoulli_distribution/max.html "cpp/numeric/random/bernoulli distribution/max")  
...
`std::bernoulli_distribution` satisfies [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Member types](bernoulli_distribution.html#Member_types)
  * [2 Member functions](bernoulli_distribution.html#Member_functions)
    * [2.1 Generation](bernoulli_distribution.html#Generation)
    * [2.2 Characteristics](bernoulli_distribution.html#Characteristics)
  * [3 Non-member functions](bernoulli_distribution.html#Non-member_functions)
  * [4 Example](bernoulli_distribution.html#Example)
  * [5 External links](bernoulli_distribution.html#External_links)
...
Run this code
    ...
     
        [std::map](../../container/map.html)<bool, int> hist;
        for (int n = 0; n < 10000; ++n)
            ++hist[d(gen)];
     
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html);
        for (auto const& [key, value] : hist)
            [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(5) << key << ' '
                      << [std::string](../../string/basic_string.html)(value / 500, '*') << '\n';
    }
