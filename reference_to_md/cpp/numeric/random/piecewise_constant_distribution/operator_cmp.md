[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/operator_cmp&action=edit)
...
[`std::piecewise_constant_distribution`](../piecewise_constant_distribution.html "cpp/numeric/random/piecewise constant distribution")

Member functions  
---  
[piecewise_constant_distribution::piecewise_constant_distribution](piecewise_constant_distribution.html "cpp/numeric/random/piecewise constant distribution/piecewise constant distribution")  
[piecewise_constant_distribution::reset](reset.html "cpp/numeric/random/piecewise constant distribution/reset")  
Generation  
[piecewise_constant_distribution::operator()](operator\(\).html "cpp/numeric/random/piecewise constant distribution/operator\(\)")  
Characteristics  
[piecewise_constant_distribution::intervalspiecewise_constant_distribution::densities](params.html "cpp/numeric/random/piecewise constant distribution/params")  
[piecewise_constant_distribution::param](param.html "cpp/numeric/random/piecewise constant distribution/param")  
[piecewise_constant_distribution::min](min.html "cpp/numeric/random/piecewise constant distribution/min")  
[piecewise_constant_distribution::max](max.html "cpp/numeric/random/piecewise constant distribution/max")  
Non-member functions  
**operator== operator!=**(C++11)(C++11)(until C++20)  
[operator<<operator>>](operator_ltltgtgt.html "cpp/numeric/random/piecewise constant distribution/operator ltltgtgt")(C++11)(C++11)  
...
const piecewise_constant_distribution& rhs ); |  (1)  |  (since C++11)  
---|---|---  
friend bool operator!=( const piecewise_constant_distribution& lhs,  
const piecewise_constant_distribution& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/operator_cmp&action=edit&section=T-1 "Template:cpp/numeric/random/distribution/operator cmp")] Parameters

lhs, rhs  |  \-  |  distribution objects to compare   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/operator_cmp&action=edit&section=T-2 "Template:cpp/numeric/random/distribution/operator cmp")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/operator_cmp&action=edit&section=T-3 "Template:cpp/numeric/random/distribution/operator cmp")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/operator_cmp&action=edit&section=T-4 "Template:cpp/numeric/random/distribution/operator cmp")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 3519](https://cplusplus.github.io/LWG/issue3519) | C++11  | the form of equality operators were unspecified  
(could be hidden friends or free function templates)  | specified to be hidden friends 
