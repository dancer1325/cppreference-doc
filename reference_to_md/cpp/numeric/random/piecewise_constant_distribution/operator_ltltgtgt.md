[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/distribution/operator_ltltgtgt&action=edit)
...
const piecewise_constant_distribution& d ); |  (1)  |  (since C++11)  
---|---|---  
template< class CharT, class Traits >  
...
piecewise_constant_distribution& d ); |  (2)  |  (since C++11)  
| |   
...
## Contents
  ...
  * [4 Defect reports](operator_ltltgtgt.html#Defect_reports)
...
---|---|---|---  
[LWG 3519](https://cplusplus.github.io/LWG/issue3519) | C++11  | the form of insertion and extraction operators were unspecified  
(could be hidden friends or out-of-class function templates)  | specified to be hidden friends 
