...
normal_distribution() : normal_distribution(0.0) {} |  (1)  |  (since C++11)  
---|---|---  
explicit normal_distribution( RealType mean, RealType stddev = 1.0 ); |  (2)  |  (since C++11)  
explicit normal_distribution( const param_type& params ); |  (3)  |  (since C++11)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/normal_distribution/normal_distribution&action=edit&section=1 "Edit section: Parameters")] Parameters

mean  |  \-  |  the _μ_ distribution parameter (mean)   
---|---|---  
stddev  |  \-  |  the _σ_ distribution parameter (standard deviation)   
params  |  \-  |  the distribution parameter set   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/normal_distribution/normal_distribution&action=edit&section=2 "Edit section: Defect reports")] Defect reports 
