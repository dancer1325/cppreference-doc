...
Member functions  
---  
[piecewise_linear_distribution::piecewise_linear_distribution](piecewise_linear_distribution/piecewise_linear_distribution.html "cpp/numeric/random/piecewise linear distribution/piecewise linear distribution")  
[piecewise_linear_distribution::reset](piecewise_linear_distribution/reset.html "cpp/numeric/random/piecewise linear distribution/reset")  
Generation  
[piecewise_linear_distribution::operator()](piecewise_linear_distribution/operator\(\).html "cpp/numeric/random/piecewise linear distribution/operator\(\)")  
Characteristics  
[piecewise_linear_distribution::intervalspiecewise_linear_distribution::densities](piecewise_linear_distribution/params.html "cpp/numeric/random/piecewise linear distribution/params")  
[piecewise_linear_distribution::param](piecewise_linear_distribution/param.html "cpp/numeric/random/piecewise linear distribution/param")  
[piecewise_linear_distribution::min](piecewise_linear_distribution/min.html "cpp/numeric/random/piecewise linear distribution/min")  
[piecewise_linear_distribution::max](piecewise_linear_distribution/max.html "cpp/numeric/random/piecewise linear distribution/max")  
Non-member functions  
[operator==operator!=](piecewise_linear_distribution/operator_cmp.html "cpp/numeric/random/piecewise linear distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](piecewise_linear_distribution/operator_ltltgtgt.html "cpp/numeric/random/piecewise linear distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/piecewise_linear_distribution/navbar_content&action=edit)

Defined in header `[<random>](../../header/random.html "cpp/header/random")` |  |   
---|---|---  
template< class RealType = double >  
class piecewise_linear_distribution; |  |  (since C++11)  
| |   
...
The probability density for any \\(\small{ b_i \le x < b_{i+1} }\\)bi≤x<bi+1 is \\(\small{p_i\frac{b_{i+1}-x}{b_{i+1}-b_i} + p_{i+1}\frac{x-b_i}{b_{i+1}-b_i} }\\)pibi+1-x  
---  
bi+1-bi  
\+ pi+1x-bi  
---  
...
[`std::piecewise_linear_distribution`](piecewise_linear_distribution.html#top) satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](piecewise_linear_distribution.html#Template_parameters)
  * [2 Member types](piecewise_linear_distribution.html#Member_types)
  * [3 Member functions](piecewise_linear_distribution.html#Member_functions)
    * [3.1 Generation](piecewise_linear_distribution.html#Generation)
    * [3.2 Characteristics](piecewise_linear_distribution.html#Characteristics)
  * [4 Non-member functions](piecewise_linear_distribution.html#Non-member_functions)
  * [5 Example](piecewise_linear_distribution.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_linear_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_linear_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_linear_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](piecewise_linear_distribution/piecewise_linear_distribution.html "cpp/numeric/random/piecewise linear distribution/piecewise linear distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](piecewise_linear_distribution/reset.html "cpp/numeric/random/piecewise linear distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](piecewise_linear_distribution/operator\(\).html "cpp/numeric/random/piecewise linear distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ intervalsdensities](piecewise_linear_distribution/params.html "cpp/numeric/random/piecewise linear distribution/params")(C++11) |  returns the distribution parameters   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/piecewise_linear_distribution/dsc_params&action=edit)  
[ param](piecewise_linear_distribution/param.html "cpp/numeric/random/piecewise linear distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](piecewise_linear_distribution/min.html "cpp/numeric/random/piecewise linear distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](piecewise_linear_distribution/max.html "cpp/numeric/random/piecewise linear distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_linear_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](piecewise_linear_distribution/operator_cmp.html "cpp/numeric/random/piecewise linear distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](piecewise_linear_distribution/operator_ltltgtgt.html "cpp/numeric/random/piecewise linear distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_linear_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::vector](../../container/vector.html)<double> i{0, 5, 10, 15};
        [std::vector](../../container/vector.html)<double> w{0, 1, 1, 0};
    ...
     
        for (auto [x, y] : hist)
            [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(2) << [std::setfill](../../io/manip/setfill.html)('0') << x
                      << ' ' << [std::string](../../string/basic_string.html)(y / 100, '*') << '\n';
    }
