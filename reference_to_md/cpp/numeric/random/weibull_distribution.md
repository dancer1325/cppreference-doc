...
Member functions  
---  
[weibull_distribution::weibull_distribution](weibull_distribution/weibull_distribution.html "cpp/numeric/random/weibull distribution/weibull distribution")  
[weibull_distribution::reset](weibull_distribution/reset.html "cpp/numeric/random/weibull distribution/reset")  
Generation  
[weibull_distribution::operator()](weibull_distribution/operator\(\).html "cpp/numeric/random/weibull distribution/operator\(\)")  
Characteristics  
[weibull_distribution::aweibull_distribution::b](weibull_distribution/params.html "cpp/numeric/random/weibull distribution/params")  
[weibull_distribution::param](weibull_distribution/param.html "cpp/numeric/random/weibull distribution/param")  
[weibull_distribution::min](weibull_distribution/min.html "cpp/numeric/random/weibull distribution/min")  
[weibull_distribution::max](weibull_distribution/max.html "cpp/numeric/random/weibull distribution/max")  
Non-member functions  
[operator==operator!=](weibull_distribution/operator_cmp.html "cpp/numeric/random/weibull distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](weibull_distribution/operator_ltltgtgt.html "cpp/numeric/random/weibull distribution/operator ltltgtgt")(C++11)(C++11)  
...
class weibull_distribution; |  |  (since C++11)  
| |   
  
The `weibull_distribution` meets the requirements of a [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution") and produces random numbers according to the [Weibull distribution](https://en.wikipedia.org/wiki/Weibull_distribution "enwiki:Weibull distribution"): 
...
a is the [shape parameter](https://en.wikipedia.org/wiki/shape_parameter "enwiki:shape parameter") and b the [scale parameter](https://en.wikipedia.org/wiki/scale_parameter "enwiki:scale parameter"). 

[`std::weibull_distribution`](weibull_distribution.html#top) satisfies [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](weibull_distribution.html#Template_parameters)
  * [2 Member types](weibull_distribution.html#Member_types)
  * [3 Member functions](weibull_distribution.html#Member_functions)
    * [3.1 Generation](weibull_distribution.html#Generation)
    * [3.2 Characteristics](weibull_distribution.html#Characteristics)
  * [4 Non-member functions](weibull_distribution.html#Non-member_functions)
  * [5 Example](weibull_distribution.html#Example)
  * [6 External links](weibull_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/weibull_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/weibull_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/weibull_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](weibull_distribution/weibull_distribution.html "cpp/numeric/random/weibull distribution/weibull distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](weibull_distribution/reset.html "cpp/numeric/random/weibull distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](weibull_distribution/operator\(\).html "cpp/numeric/random/weibull distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ ab](weibull_distribution/params.html "cpp/numeric/random/weibull distribution/params")(C++11) |  returns the distribution parameters   
...
[ param](weibull_distribution/param.html "cpp/numeric/random/weibull distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](weibull_distribution/min.html "cpp/numeric/random/weibull distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](weibull_distribution/max.html "cpp/numeric/random/weibull distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/weibull_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](weibull_distribution/operator_cmp.html "cpp/numeric/random/weibull distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](weibull_distribution/operator_ltltgtgt.html "cpp/numeric/random/weibull distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/weibull_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << [std::fixed](../../io/manip/fixed.html) << [std::setprecision](../../io/manip/setprecision.html)(1) << [std::hex](../../io/manip/hex.html);
        for (auto [x, y] : hist)
            [std::cout](../../io/cout.html) << x << ' ' << [std::string](../../string/basic_string.html)(y / 200, '*') << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/weibull_distribution&action=edit&section=6 "Edit section: External links")] External links

1\.  | [Weisstein, Eric W. "Weibull Distribution."](https://mathworld.wolfram.com/WeibullDistribution.html) From MathWorld — A Wolfram Web Resource.   
---|---  
2\.  | [Weibull distribution](https://en.wikipedia.org/wiki/Weibull_distribution "enwiki:Weibull distribution") — From Wikipedia. 
