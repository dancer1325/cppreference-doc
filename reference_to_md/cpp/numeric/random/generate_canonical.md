...
---|---|---  
template< class RealType, [std::size_t](../../types/size_t.html) Bits, class Generator >  
RealType generate_canonical( Generator& g ); |  |  (since C++11)  
| |   
...
To generate enough entropy, generate_canonical() will call g() exactly \\(\small k\\)k times, where \\(\small k = \max(1, \lceil \frac{b}{\log_2 R} \rceil)\\)k = max(1, ⌈ b / log2 R ⌉) and 
  ...
  * b = [std::min](../../algorithm/min.html)(Bits, [std::size_t](../../types/size_t.html) {[std::numeric_limits](../../types/numeric_limits.html)<RealType>::digits}), 
  * R = g.max() - g.min() + 1. 
...
## Contents
  ...
  * [1 Parameters](generate_canonical.html#Parameters)
  * [2 Return value](generate_canonical.html#Return_value)
  * [3 Exceptions](generate_canonical.html#Exceptions)
  * [4 Notes](generate_canonical.html#Notes)
  * [5 Example](generate_canonical.html#Example)
  * [6 See also](generate_canonical.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        for (int n = 0; n < 10; ++n)
            [std::cout](../../io/cout.html) << std::generate_canonical<double, 10>(gen) << ' ';
