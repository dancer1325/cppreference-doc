...
Member functions  
---  
[normal_distribution::normal_distribution](normal_distribution/normal_distribution.html "cpp/numeric/random/normal distribution/normal distribution")(C++11)  
[normal_distribution::reset](normal_distribution/reset.html "cpp/numeric/random/normal distribution/reset")(C++11)  
Generation  
[normal_distribution::operator()](normal_distribution/operator\(\).html "cpp/numeric/random/normal distribution/operator\(\)")(C++11)  
Characteristics  
[normal_distribution::meannormal_distribution::stddev](normal_distribution/params.html "cpp/numeric/random/normal distribution/params")(C++11)(C++11)  
[normal_distribution::param](normal_distribution/param.html "cpp/numeric/random/normal distribution/param")(C++11)  
[normal_distribution::min](normal_distribution/min.html "cpp/numeric/random/normal distribution/min")(C++11)  
[normal_distribution::max](normal_distribution/max.html "cpp/numeric/random/normal distribution/max")(C++11)  
Non-member functions  
[operator==operator!=](normal_distribution/operator_cmp.html "cpp/numeric/random/normal distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](normal_distribution/operator_ltltgtgt.html "cpp/numeric/random/normal distribution/operator ltltgtgt")(C++11)(C++11)  
...
Generates random numbers according to the [Normal (or Gaussian) random number distribution](https://en.wikipedia.org/wiki/Normal_distribution "enwiki:Normal distribution"). It is defined as: 
...
Here \\(\small\mu\\)μ is the [Mean](https://en.wikipedia.org/wiki/Mean "enwiki:Mean") and \\(\small\sigma\\)σ is the [Standard deviation](https://en.wikipedia.org/wiki/Standard_deviation "enwiki:Standard deviation") (_stddev_). 

[`std::normal_distribution`](normal_distribution.html#top) satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](normal_distribution.html#Template_parameters)
  * [2 Member types](normal_distribution.html#Member_types)
  * [3 Member functions](normal_distribution.html#Member_functions)
    * [3.1 Generation](normal_distribution.html#Generation)
    * [3.2 Characteristics](normal_distribution.html#Characteristics)
  * [4 Non-member functions](normal_distribution.html#Non-member_functions)
  * [5 Example](normal_distribution.html#Example)
  * [6 External links](normal_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/normal_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/normal_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/normal_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](normal_distribution/normal_distribution.html "cpp/numeric/random/normal distribution/normal distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](normal_distribution/reset.html "cpp/numeric/random/normal distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](normal_distribution/operator\(\).html "cpp/numeric/random/normal distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ meanstddev](normal_distribution/params.html "cpp/numeric/random/normal distribution/params")(C++11) |  returns the distribution parameters   
...
[ param](normal_distribution/param.html "cpp/numeric/random/normal distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](normal_distribution/min.html "cpp/numeric/random/normal distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](normal_distribution/max.html "cpp/numeric/random/normal distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/normal_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](normal_distribution/operator_cmp.html "cpp/numeric/random/normal distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](normal_distribution/operator_ltltgtgt.html "cpp/numeric/random/normal distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/normal_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        auto random_int = [&d, &gen]{ return [std::lround](../math/round.html)(d(gen)); };
     
        [std::map](../../container/map.html)<long, unsigned> histogram{};
        for (auto n{10000}; n; --n)
            ++histogram[random_int()];
     
        for (const auto [k, v] : histogram)
            [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(2) << k << ' ' << [std::string](../../string/basic_string.html)(v / 200, '*') << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/normal_distribution&action=edit&section=6 "Edit section: External links")] External links

1\.  | [Weisstein, Eric W. "Normal Distribution."](https://mathworld.wolfram.com/NormalDistribution.html) From MathWorld — A Wolfram Web Resource.   
---|---  
2\.  | [Normal distribution](https://en.wikipedia.org/wiki/Normal_distribution "enwiki:Normal distribution") — From Wikipedia. 
