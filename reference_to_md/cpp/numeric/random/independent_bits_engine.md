...
Member functions  
---  
[independent_bits_engine::independent_bits_engine](independent_bits_engine/independent_bits_engine.html "cpp/numeric/random/independent bits engine/independent bits engine")  
[independent_bits_engine::seed](independent_bits_engine/seed.html "cpp/numeric/random/independent bits engine/seed")  
[independent_bits_engine::base](independent_bits_engine/base.html "cpp/numeric/random/independent bits engine/base")  
Generation  
[independent_bits_engine::operator()](independent_bits_engine/operator\(\).html "cpp/numeric/random/independent bits engine/operator\(\)")  
[independent_bits_engine::discard](independent_bits_engine/discard.html "cpp/numeric/random/independent bits engine/discard")  
Characteristics  
[independent_bits_engine::min](independent_bits_engine/min.html "cpp/numeric/random/independent bits engine/min")  
[independent_bits_engine::max](independent_bits_engine/max.html "cpp/numeric/random/independent bits engine/max")  
...
template<  
class Engine,  
[std::size_t](../../types/size_t.html) W,  
class UIntType  
> class independent_bits_engine; |  |  (since C++11)  
| |   
  
[`independent_bits_engine`](independent_bits_engine.html#top) is a random number engine adaptor that produces random numbers with different number of bits than that of the wrapped engine. 

## Contents

  * [1 Template parameters](independent_bits_engine.html#Template_parameters)
  * [2 Member types](independent_bits_engine.html#Member_types)
  * [3 Member functions](independent_bits_engine.html#Member_functions)
    * [3.1 Generation](independent_bits_engine.html#Generation)
    * [3.2 Characteristics](independent_bits_engine.html#Characteristics)
  * [4 Non-member functions](independent_bits_engine.html#Non-member_functions)
  * [5 Example](independent_bits_engine.html#Example)
