...
Member functions  
---  
[geometric_distribution::geometric_distribution](geometric_distribution/geometric_distribution.html "cpp/numeric/random/geometric distribution/geometric distribution")  
[geometric_distribution::reset](geometric_distribution/reset.html "cpp/numeric/random/geometric distribution/reset")  
Generation  
[geometric_distribution::operator()](geometric_distribution/operator\(\).html "cpp/numeric/random/geometric distribution/operator\(\)")  
Characteristics  
[geometric_distribution::p](geometric_distribution/p.html "cpp/numeric/random/geometric distribution/p")  
[geometric_distribution::param](geometric_distribution/param.html "cpp/numeric/random/geometric distribution/param")  
[geometric_distribution::min](geometric_distribution/min.html "cpp/numeric/random/geometric distribution/min")  
[geometric_distribution::max](geometric_distribution/max.html "cpp/numeric/random/geometric distribution/max")  
Non-member functions  
[operator==operator!=](geometric_distribution/operator_cmp.html "cpp/numeric/random/geometric distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](geometric_distribution/operator_ltltgtgt.html "cpp/numeric/random/geometric distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/geometric_distribution/navbar_content&action=edit)

Defined in header `[<random>](../../header/random.html "cpp/header/random")` |  |   
---|---|---  
template< class IntType = int >  
class geometric_distribution; |  |  (since C++11)  
| |   
...
std::geometric_distribution<>(p) is exactly equivalent to [std::negative_binomial_distribution](negative_binomial_distribution.html)<>(1, p). It is also the discrete counterpart of [std::exponential_distribution](exponential_distribution.html "cpp/numeric/random/exponential distribution"). 

`std::geometric_distribution` satisfies [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](geometric_distribution.html#Template_parameters)
  * [2 Member types](geometric_distribution.html#Member_types)
  * [3 Member functions](geometric_distribution.html#Member_functions)
    * [3.1 Generation](geometric_distribution.html#Generation)
    * [3.2 Characteristics](geometric_distribution.html#Characteristics)
  * [4 Non-member functions](geometric_distribution.html#Non-member_functions)
  * [5 Example](geometric_distribution.html#Example)
  * [6 External links](geometric_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/geometric_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/geometric_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/geometric_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](geometric_distribution/geometric_distribution.html "cpp/numeric/random/geometric distribution/geometric distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](geometric_distribution/reset.html "cpp/numeric/random/geometric distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](geometric_distribution/operator\(\).html "cpp/numeric/random/geometric distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ p](geometric_distribution/p.html "cpp/numeric/random/geometric distribution/p")(C++11) |  returns the _p_ distribution parameter (probability of a trial generating true)   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/geometric_distribution/dsc_p&action=edit)  
[ param](geometric_distribution/param.html "cpp/numeric/random/geometric distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](geometric_distribution/min.html "cpp/numeric/random/geometric distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](geometric_distribution/max.html "cpp/numeric/random/geometric distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/geometric_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](geometric_distribution/operator_cmp.html "cpp/numeric/random/geometric distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](geometric_distribution/operator_ltltgtgt.html "cpp/numeric/random/geometric distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/geometric_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        for (auto [x, y] : hist)
        {
            ...
            [std::cout](../../io/cout.html) << c << ' ' << [std::string](../../string/basic_string.html)(y / 100, '*') << '\n';
        }
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/geometric_distribution&action=edit&section=6 "Edit section: External links")] External links
