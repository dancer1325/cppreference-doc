...
---  
Type  |  Definition   
`ranlux24_base` (C++11) |  std::subtract_with_carry_engine<[std::uint_fast32_t](../../types/integer.html), 24, 10, 24>  
`ranlux48_base` (C++11) |  std::subtract_with_carry_engine<[std::uint_fast64_t](../../types/integer.html), 48, 5, 12>  
