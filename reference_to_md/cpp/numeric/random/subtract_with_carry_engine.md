...
Member functions  
---  
[subtract_with_carry_engine::subtract_with_carry_engine](subtract_with_carry_engine/subtract_with_carry_engine.html "cpp/numeric/random/subtract with carry engine/subtract with carry engine")  
[subtract_with_carry_engine::seed](subtract_with_carry_engine/seed.html "cpp/numeric/random/subtract with carry engine/seed")  
Generation  
[subtract_with_carry_engine::operator()](subtract_with_carry_engine/operator\(\).html "cpp/numeric/random/subtract with carry engine/operator\(\)")  
[subtract_with_carry_engine::discard](subtract_with_carry_engine/discard.html "cpp/numeric/random/subtract with carry engine/discard")  
Characteristics  
[subtract_with_carry_engine::min](subtract_with_carry_engine/min.html "cpp/numeric/random/subtract with carry engine/min")  
[subtract_with_carry_engine::max](subtract_with_carry_engine/max.html "cpp/numeric/random/subtract with carry engine/max")  
Non-member functions  
[operator==operator!=](subtract_with_carry_engine/operator_cmp.html "cpp/numeric/random/subtract with carry engine/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](subtract_with_carry_engine/operator_ltltgtgt.html "cpp/numeric/random/subtract with carry engine/operator ltltgtgt")(C++11)(C++11)  
...
template<  
class UIntType,  
[std::size_t](../../types/size_t.html) w, [std::size_t](../../types/size_t.html) s, [std::size_t](../../types/size_t.html) r  
...
## Contents
  ...
  * [1 Template parameters](subtract_with_carry_engine.html#Template_parameters)
  * [2 Generator properties](subtract_with_carry_engine.html#Generator_properties)
  * [3 Predefined specializations](subtract_with_carry_engine.html#Predefined_specializations)
  * [4 Nested types](subtract_with_carry_engine.html#Nested_types)
  * [5 Data members](subtract_with_carry_engine.html#Data_members)
  * [6 Member functions](subtract_with_carry_engine.html#Member_functions)
    * [6.1 Construction and Seeding](subtract_with_carry_engine.html#Construction_and_Seeding)
    * [6.2 Generation](subtract_with_carry_engine.html#Generation)
    * [6.3 Characteristics](subtract_with_carry_engine.html#Characteristics)
  * [7 Non-member functions](subtract_with_carry_engine.html#Non-member_functions)
  * [8 Example](subtract_with_carry_engine.html#Example)
  * [9 Defect reports](subtract_with_carry_engine.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/subtract_with_carry_engine&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
If w is not in `[`1`, `[std::numeric_limits](../../types/numeric_limits.html)<UIntType>::digits`]`, or s is not in `[`1`, `r`)`, the program is ill-formed. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/subtract_with_carry_engine&action=edit&section=2 "Edit section: Generator properties")] Generator properties

The [size](../random.html#Random_number_engines "cpp/numeric/random") of the states of `subtract_with_carry_engine` is \\(\scriptsize O(r)\\)O(r), each of them consists of two parts: 

  * A sequence X of r integer values, where each value is in `[`​0​`, ``2``w`  
`)`. 
  * An integer c (known as the _carry_ ﻿), whose value is either ​0​ or 1. 



Given that \\(\scriptsize X_j\\)Xj stands for the \\(\scriptsize j\mod r\\)j mod rth value (starting from 0) of X, the [transition algorithm](../random.html#Random_number_engines "cpp/numeric/random") of `subtract_with_carry_engine` (\\(\scriptsize TA(x_i)\\)TA(xi)) is defined as follows: 
...
The [generation algorithm](../random.html#Random_number_engines "cpp/numeric/random") of `subtract_with_carry_engine` is \\(\scriptsize GA(x_i) = y\\)GA(xi) = y, where y is the value produced in step 2 of the transition algorithm. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/subtract_with_carry_engine&action=edit&section=3 "Edit section: Predefined specializations")] Predefined specializations
...
---  
Type  |  Definition   
`ranlux24_base` (C++11) |  std::subtract_with_carry_engine<[std::uint_fast32_t](../../types/integer.html), 24, 10, 24>[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/dsc_ranlux24_base&action=edit)  
`ranlux48_base` (C++11) |  std::subtract_with_carry_engine<[std::uint_fast64_t](../../types/integer.html), 48, 5, 12>[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/dsc_ranlux48_base&action=edit)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/subtract_with_carry_engine&action=edit&section=4 "Edit section: Nested types")] Nested types

Type  |  Definition   
---|---  
`result_type` |  `UIntType`  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/subtract_with_carry_engine&action=edit&section=5 "Edit section: Data members")] Data members

constexpr [std::size_t](../../types/size_t.html "cpp/types/size t") word_size[static] |  w   
(public static member constant)  
---|---  
constexpr [std::size_t](../../types/size_t.html "cpp/types/size t") short_lag[static] |  s   
(public static member constant)  
constexpr [std::size_t](../../types/size_t.html "cpp/types/size t") long_lag[static] |  r   
(public static member constant)  
constexpr [std::uint_least32_t](../../types/integer.html "cpp/types/integer") default_seed[static] |  19780503u   
(public static member constant)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/subtract_with_carry_engine&action=edit&section=6 "Edit section: Member functions")] Member functions

#####  Construction and Seeding   
  
---  
[ (constructor)](subtract_with_carry_engine/subtract_with_carry_engine.html "cpp/numeric/random/subtract with carry engine/subtract with carry engine") |  constructs the engine   
...
[ seed](subtract_with_carry_engine/seed.html "cpp/numeric/random/subtract with carry engine/seed") |  sets the current state of the engine   
...
[ operator()](subtract_with_carry_engine/operator\(\).html "cpp/numeric/random/subtract with carry engine/operator\(\)") |  advances the engine's state and returns the generated value   
...
[ discard](subtract_with_carry_engine/discard.html "cpp/numeric/random/subtract with carry engine/discard") |  advances the engine's state by a specified amount   
...
[ min](subtract_with_carry_engine/min.html "cpp/numeric/random/subtract with carry engine/min")[static] |  gets the smallest possible value in the output range   
...
[ max](subtract_with_carry_engine/max.html "cpp/numeric/random/subtract with carry engine/max")[static] |  gets the largest possible value in the output range   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/subtract_with_carry_engine&action=edit&section=7 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](subtract_with_carry_engine/operator_cmp.html "cpp/numeric/random/subtract with carry engine/operator cmp")(C++11)(C++11)(removed in C++20) |  compares the internal states of two pseudo-random number engines   
...
---|---  
[ operator<<operator>>](subtract_with_carry_engine/operator_ltltgtgt.html "cpp/numeric/random/subtract with carry engine/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number engine   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/subtract_with_carry_engine&action=edit&section=8 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/subtract_with_carry_engine&action=edit&section=9 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 3809](https://cplusplus.github.io/LWG/issue3809) | C++11  | `default_seed` might not be  
representable with `result_type` | changed its type to  
[std::uint_least32_t](../../types/integer.html "cpp/types/integer")
