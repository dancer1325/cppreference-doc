...
Copies the stored seeds to the range beginning with dest. Equivalent to [std::copy](../../../algorithm/copy.html)(`_[v](../seed_seq.html#v "cpp/numeric/random/seed seq")_` ﻿.begin(),` `` _[v](../seed_seq.html#v "cpp/numeric/random/seed seq")_` ﻿.end(), dest);. 

If values of type `result_type` are not [writable](../../../iterator.html#Types_and_writability "cpp/iterator") to dest, the program is ill-formed. 

If `OutputIt` does not satisfy the requirements of [LegacyOutputIterator](../../../named_req/OutputIterator.html "cpp/named req/OutputIterator"), the behavior is undefined. 

## Contents

  * [1 Parameters](param.html#Parameters)
  * [2 Exceptions](param.html#Exceptions)
  * [3 Example](param.html#Example)
  * [4 Defect reports](param.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        ...
        s1.param([std::ostream_iterator](../../../iterator/ostream_iterator.html)<int>([std::cout](../../../io/cout.html), " "));
    }
...
---|---|---|---  
[LWG 2180](https://cplusplus.github.io/LWG/issue2180) | C++11  | `seed_seq::param` is non-throwing  | it may throw exceptions 
