...
Member functions  
---  
[cauchy_distribution::cauchy_distribution](cauchy_distribution/cauchy_distribution.html "cpp/numeric/random/cauchy distribution/cauchy distribution")  
[cauchy_distribution::reset](cauchy_distribution/reset.html "cpp/numeric/random/cauchy distribution/reset")  
Generation  
[cauchy_distribution::operator()](cauchy_distribution/operator\(\).html "cpp/numeric/random/cauchy distribution/operator\(\)")  
Characteristics  
[cauchy_distribution::acauchy_distribution::b](cauchy_distribution/params.html "cpp/numeric/random/cauchy distribution/params")  
[cauchy_distribution::param](cauchy_distribution/param.html "cpp/numeric/random/cauchy distribution/param")  
[cauchy_distribution::min](cauchy_distribution/min.html "cpp/numeric/random/cauchy distribution/min")  
[cauchy_distribution::max](cauchy_distribution/max.html "cpp/numeric/random/cauchy distribution/max")  
Non-member functions  
[operator==operator!=](cauchy_distribution/operator_cmp.html "cpp/numeric/random/cauchy distribution/operator cmp")(C++11)(C++11)(until C++20)  
[operator<<operator>>](cauchy_distribution/operator_ltltgtgt.html "cpp/numeric/random/cauchy distribution/operator ltltgtgt")(C++11)(C++11)  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/random/cauchy_distribution/navbar_content&action=edit)

Defined in header `[<random>](../../header/random.html "cpp/header/random")` |  |   
---|---|---  
template< class RealType = double >  
class cauchy_distribution; |  |  (since C++11)  
| |   
  
Produces random numbers according to a [Cauchy distribution](https://en.wikipedia.org/wiki/Cauchy_distribution "enwiki:Cauchy distribution") (also called Lorentz distribution): 
...
`std::cauchy_distribution` satisfies all requirements of [RandomNumberDistribution](../../named_req/RandomNumberDistribution.html "cpp/named req/RandomNumberDistribution"). 

## Contents

  * [1 Template parameters](cauchy_distribution.html#Template_parameters)
  * [2 Member types](cauchy_distribution.html#Member_types)
  * [3 Member functions](cauchy_distribution.html#Member_functions)
    * [3.1 Generation](cauchy_distribution.html#Generation)
    * [3.2 Characteristics](cauchy_distribution.html#Characteristics)
  * [4 Non-member functions](cauchy_distribution.html#Non-member_functions)
  * [5 Example](cauchy_distribution.html#Example)
  * [6 External links](cauchy_distribution.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/cauchy_distribution&action=edit&section=1 "Edit section: Template parameters")] Template parameters

RealType  |  \-  |  The result type generated by the generator. The effect is undefined if this is not one of float, double, or long double.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/cauchy_distribution&action=edit&section=2 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/cauchy_distribution&action=edit&section=3 "Edit section: Member functions")] Member functions

[ (constructor)](cauchy_distribution/cauchy_distribution.html "cpp/numeric/random/cauchy distribution/cauchy distribution")(C++11) |  constructs new distribution   
...
---|---  
[ reset](cauchy_distribution/reset.html "cpp/numeric/random/cauchy distribution/reset")(C++11) |  resets the internal state of the distribution   
...
[ operator()](cauchy_distribution/operator\(\).html "cpp/numeric/random/cauchy distribution/operator\(\)")(C++11) |  generates the next random number in the distribution   
...
[ ab](cauchy_distribution/params.html "cpp/numeric/random/cauchy distribution/params")(C++11) |  returns the distribution parameters   
...
[ param](cauchy_distribution/param.html "cpp/numeric/random/cauchy distribution/param")(C++11) |  gets or sets the distribution parameter object   
...
[ min](cauchy_distribution/min.html "cpp/numeric/random/cauchy distribution/min")(C++11) |  returns the minimum potentially generated value   
...
[ max](cauchy_distribution/max.html "cpp/numeric/random/cauchy distribution/max")(C++11) |  returns the maximum potentially generated value   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/cauchy_distribution&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions

[ operator==operator!=](cauchy_distribution/operator_cmp.html "cpp/numeric/random/cauchy distribution/operator cmp")(C++11)(C++11)(removed in C++20) |  compares two distribution objects   
...
---|---  
[ operator<<operator>>](cauchy_distribution/operator_ltltgtgt.html "cpp/numeric/random/cauchy distribution/operator ltltgtgt")(C++11) |  performs stream input and output on pseudo-random number distribution   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/cauchy_distribution&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
            [std::cout](../../io/cout.html) << "x₀ = " << x0 << ", 𝛾 = " << 𝛾 << ":\n";
            draw_vbars<4,3>(bars);
            for (int n : indices)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/cauchy_distribution&action=edit&section=6 "Edit section: External links")] External links
