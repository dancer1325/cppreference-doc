...
Characteristics  
**negative_binomial_distribution::p negative_binomial_distribution::k**  
...
double p() const; |  (1)  |  (since C++11)  
---|---|---  
IntType k() const; |  (2)  |  (since C++11)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution/params&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution/params&action=edit&section=2 "Edit section: Return value")] Return value

1) The p distribution parameter.

2) The k distribution parameter.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution/params&action=edit&section=3 "Edit section: See also")] See also

[ param](param.html "cpp/numeric/random/negative binomial distribution/param")(C++11) |  gets or sets the distribution parameter object   
