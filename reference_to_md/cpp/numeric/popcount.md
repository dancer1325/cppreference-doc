...
---|---|---  
template< class T >  
constexpr int popcount( T x ) noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](popcount.html#Parameters)
  * [2 Return value](popcount.html#Return_value)
  * [3 Notes](popcount.html#Notes)
  * [4 Example](popcount.html#Example)
  * [5 See also](popcount.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/popcount&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  value of unsigned integer type   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/popcount&action=edit&section=2 "Edit section: Return value")] Return value

The number of 1 bits in the value of x. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/popcount&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/popcount&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        for (const [std::uint8_t](../types/integer.html) x : {0, 0b00011101, 0b11111111})
            [std::cout](../io/cout.html) << "popcount( " << [std::bitset](../utility/bitset.html)<8>(x) << " ) = "
                      << std::popcount(x) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/popcount&action=edit&section=5 "Edit section: See also")] See also
