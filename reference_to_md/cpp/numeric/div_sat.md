...
---|---|---  
template< class T >  
constexpr T div_sat( T x, T y ) noexcept; |  |  (since C++26)  
| |   
  
Computes the [saturating](https://en.wikipedia.org/wiki/Saturation_arithmetic "enwiki:Saturation arithmetic") division x / y. If `T` is a signed integer type, x is the smallest (most negative) value of `T`, and y == -1, returns the greatest value of `T`; otherwise, returns x / y. 

y must not be ​0​, otherwise the behavior is undefined. The function call is not a [core constant expression](../language/constant_expression.html#Core_constant_expressions "cpp/language/constant expression") if undefined behavior happens. 
...
## Contents
  ...
  * [1 Parameters](div_sat.html#Parameters)
  * [2 Return value](div_sat.html#Return_value)
  * [3 Notes](div_sat.html#Notes)
  * [4 Possible implementation](div_sat.html#Possible_implementation)
  * [5 Example](div_sat.html#Example)
  * [6 See also](div_sat.html#See_also)
  * [7 External links](div_sat.html#External_links)
...
### Possible implementation
    ...
    concept standard_or_extended_integral =
         [std::is_integral_v](../types/is_integral.html)<T> &&
        ![std::is_same_v](../types/is_same.html)<[std::remove_cv_t](../types/remove_cv.html)<T>, bool> &&
        ![std::is_same_v](../types/is_same.html)<[std::remove_cv_t](../types/remove_cv.html)<T>, char> &&
        ![std::is_same_v](../types/is_same.html)<[std::remove_cv_t](../types/remove_cv.html)<T>, char8_t> &&
        ![std::is_same_v](../types/is_same.html)<[std::remove_cv_t](../types/remove_cv.html)<T>, char16_t> &&
        ![std::is_same_v](../types/is_same.html)<[std::remove_cv_t](../types/remove_cv.html)<T>, char32_t> &&
        ![std::is_same_v](../types/is_same.html)<[std::remove_cv_t](../types/remove_cv.html)<T>, wchar_t>;
    } // namespace detail
     
    template<detail::standard_or_extended_integral T>
    constexpr T div_sat( T x, T y ) noexcept
    {
        if constexpr ([std::is_signed_v](../types/is_signed.html)<T>)
            if (x == [std::numeric_limits](../types/numeric_limits.html)<T>::min() && y == -1)
                return [std::numeric_limits](../types/numeric_limits.html)<T>::max();
        return x / y;
    }  
...
Run this code
    ...
    (""
        ...
        && (std::div_sat<int>([INT_MIN](../types/climits.html), -1) == [INT_MAX](../types/climits.html)) // saturated
