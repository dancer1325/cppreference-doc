...
---|---|---  
template< class T >  
constexpr T mul_sat( T x, T y ) noexcept; |  |  (since C++26)  
| |   
  
Computes the [saturating](https://en.wikipedia.org/wiki/Saturation_arithmetic "enwiki:Saturation arithmetic") multiplication x × y. This operation (unlike built-in [arithmetic operations on integers](../language/operator_arithmetic.html#Overflows "cpp/language/operator arithmetic")) behaves as-if it is a mathematical operation with an _infinite_ range. Let `_q_` denote the result of such operation. Returns: 
...
## Contents
  ...
  * [1 Parameters](mul_sat.html#Parameters)
  * [2 Return value](mul_sat.html#Return_value)
  * [3 Notes](mul_sat.html#Notes)
  * [4 Possible implementation](mul_sat.html#Possible_implementation)
  * [5 Example](mul_sat.html#Example)
  * [6 See also](mul_sat.html#See_also)
  * [7 External links](mul_sat.html#External_links)
...
Run this code
    ...
    (""
        ...
        && (std::mul_sat<int>([INT_MAX](../types/climits.html) / 2, 3) == [INT_MAX](../types/climits.html)) // saturated
        && (std::mul_sat<int>(-2, 3) == -6) // not saturated
        && (std::mul_sat<int>([INT_MIN](../types/climits.html) / -2, -3) == [INT_MIN](../types/climits.html)) // saturated
        && (std::mul_sat<unsigned>(2, 3) == 6) // not saturated
        && (std::mul_sat<unsigned>([UINT_MAX](../types/climits.html) / 2, 3) == [UINT_MAX](../types/climits.html)) // saturated
    );
     
    int main() {}
