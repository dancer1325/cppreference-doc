...
---|---|---  
template< class T >  
constexpr T bit_floor( T x ) noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](bit_floor.html#Parameters)
  * [2 Return value](bit_floor.html#Return_value)
  * [3 Notes](bit_floor.html#Notes)
  * [4 Possible implementation](bit_floor.html#Possible_implementation)
  * [5 Example](bit_floor.html#Example)
  * [6 See also](bit_floor.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/bit_floor&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
    {
        if (x != 0)
            return T{1} << ([std::bit_width](bit_width.html)(x) - 1);
        return 0;
    }  
...
Run this code
    ...
    int main()
    {
        ...
        for (unsigned x{}; x != 012; ++x)
            [std::cout](../io/cout.html) << "bit_floor( " << bin(x) << " ) = "
                      << bin(std::bit_floor(x)) << '\n';
    }
