...
---|---|---  
template< class T >  
constexpr int countl_zero( T x ) noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](countl_zero.html#Parameters)
  * [2 Return value](countl_zero.html#Return_value)
  * [3 Notes](countl_zero.html#Notes)
  * [4 Example](countl_zero.html#Example)
  * [5 See also](countl_zero.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_zero&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  value of unsigned integer type   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_zero&action=edit&section=2 "Edit section: Return value")] Return value

The number of consecutive ​0​ bits in the value of x, starting from the most significant bit. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_zero&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_zero&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        for (const [std::uint8_t](../types/integer.html) i : {0, 0b11111111, 0b11110000, 0b00011110})
            [std::cout](../io/cout.html) << "countl_zero( " << [std::bitset](../utility/bitset.html)<8>(i) << " ) = "
                      << std::countl_zero(i) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_zero&action=edit&section=5 "Edit section: See also")] See also
...
[ countr_one](countr_one.html "cpp/numeric/countr one")(C++20) |  counts the number of consecutive 1 bits, starting from the least significant bit   
...
[C documentation](../../c/numeric/bit/stdc_leading_zeros.html "c/numeric/bit/stdc leading zeros") for stdc_leading_zeros
