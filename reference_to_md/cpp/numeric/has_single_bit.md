...
## Contents
  ...
  * [1 Parameters](has_single_bit.html#Parameters)
  * [2 Return value](has_single_bit.html#Return_value)
  * [3 Notes](has_single_bit.html#Notes)
  * [4 Possible implementation](has_single_bit.html#Possible_implementation)
  * [5 Example](has_single_bit.html#Example)
  * [6 See also](has_single_bit.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/has_single_bit&action=edit&section=4 "Edit section: Possible implementation")] Possible implementation
    ...
     
    template<typename T>
    concept strict_unsigned_integral = [std::unsigned_integral](../concepts/unsigned_integral.html)<T> &&
    ...
    constexpr bool has_single_bit(strict_unsigned_integral auto x) noexcept
    {
        return [std::popcount](popcount.html)(x) == 1;
    }  
...
Run this code
    ...
    int main()
    {
        ...
        {
            [std::cout](../io/cout.html) << "u = " << u << " = " << [std::bitset](../utility/bitset.html)<4>(u);
            if (std::has_single_bit(u))
                [std::cout](../io/cout.html) << " = 2^" << [std::log2](math/log2.html)(u) << " (is power of two)";
