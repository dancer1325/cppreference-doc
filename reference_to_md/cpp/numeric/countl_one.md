...
---|---|---  
template< class T >  
constexpr int countl_one( T x ) noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](countl_one.html#Parameters)
  * [2 Return value](countl_one.html#Return_value)
  * [3 Notes](countl_one.html#Notes)
  * [4 Example](countl_one.html#Example)
  * [5 See also](countl_one.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_one&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  value of unsigned integer type   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_one&action=edit&section=2 "Edit section: Return value")] Return value

The number of consecutive 1 bits in the value of x, starting from the most significant bit. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_one&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_one&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        for (const [std::uint8_t](../types/integer.html) i : {0, 0b11111111, 0b01111111, 0b11100011})
            [std::cout](../io/cout.html) << "countl_one( " << [std::bitset](../utility/bitset.html)<8>(i) << " ) = "
                      << std::countl_one(i) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_one&action=edit&section=5 "Edit section: See also")] See also
