...
---|---|---  
template< class T >  
constexpr int countr_one( T x ) noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](countr_one.html#Parameters)
  * [2 Return value](countr_one.html#Return_value)
  * [3 Notes](countr_one.html#Notes)
  * [4 Example](countr_one.html#Example)
  * [5 See also](countr_one.html#See_also)
...
Run this code
    ...
    int main()
    {
        for (const [std::uint8_t](../types/integer.html) i : {0, 0b11111111, 0b11111110, 0b11100011})
            [std::cout](../io/cout.html) << "countr_one( " << [std::bitset](../utility/bitset.html)<8>(i) << " ) = "
                      << std::countr_one(i) << '\n';
    }
