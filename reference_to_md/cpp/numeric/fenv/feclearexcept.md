...
Attempts to clear the floating-point exceptions that are listed in the bitmask argument `excepts`, which is a bitwise OR of the [floating point exception macros](FE_exceptions.html "cpp/numeric/fenv/FE exceptions"). 
...
## Contents
  ...
  * [4 See also](feclearexcept.html#See_also)
...
Run this code
    ...
    int main()
    {
        std::feclearexcept([FE_ALL_EXCEPT](FE_exceptions.html));
        [std::cout](../../io/cout.html) <<  "1.0/0.0 = " << 1.0 / zero << '\n';
        if ([std::fetestexcept](fetestexcept.html)([FE_DIVBYZERO](FE_exceptions.html)))
    ...
     
        ...
        if ([std::fetestexcept](fetestexcept.html)([FE_INEXACT](FE_exceptions.html)))
    ...
     
        ...
        if ([std::fetestexcept](fetestexcept.html)([FE_INVALID](FE_exceptions.html)))
