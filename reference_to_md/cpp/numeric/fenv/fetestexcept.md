...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/fenv/fetestexcept&action=edit&section=1 "Edit section: Parameters")] Parameters

excepts  |  \-  |  bitmask listing the exception flags to test   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/fenv/fetestexcept&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/fenv/fetestexcept&action=edit&section=3 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/fenv/fetestexcept&action=edit&section=4 "Edit section: See also")] See also
