...
---|---|---  
template< class T >  
constexpr int bit_width( T x ) noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](bit_width.html#Parameters)
  * [2 Return value](bit_width.html#Return_value)
  * [3 Notes](bit_width.html#Notes)
  * [4 Example](bit_width.html#Example)
  * [5 Defect reports](bit_width.html#Defect_reports)
  * [6 See also](bit_width.html#See_also)
...
Run this code
    ...
    int main()
    {
        for (unsigned x{}; x != 010; ++x)
            [std::cout](../io/cout.html) << "bit_width( "
                      << [std::bitset](../utility/bitset.html)<4>{x} << " ) = "
                      << std::bit_width(x) << '\n';
    }
