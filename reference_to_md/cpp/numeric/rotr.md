...
---|---|---  
template< class T >  
constexpr T rotr( T x, int s ) noexcept; |  |  (since C++20)  
| |   
...
Formally, let `N` be [std::numeric_limits](../types/numeric_limits.html)<T>::digits and r be s % N. 
  ...
  * if r is negative, returns [std::rotl](rotl.html)(x, -r). 
...
## Contents
  ...
  * [1 Parameters](rotr.html#Parameters)
  * [2 Return value](rotr.html#Return_value)
  * [3 Notes](rotr.html#Notes)
  * [4 Example](rotr.html#Example)
  * [5 See also](rotr.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        for (const int s : {0, 1, 9, -1, 2})
            [std::cout](../io/cout.html) << bin(std::rotr(x, s)) << " <- rotr(x, " << s << ")\n";
    }
