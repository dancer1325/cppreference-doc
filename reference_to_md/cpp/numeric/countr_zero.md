...
---|---|---  
template< class T >  
constexpr int countr_zero( T x ) noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](countr_zero.html#Parameters)
  * [2 Return value](countr_zero.html#Return_value)
  * [3 Notes](countr_zero.html#Notes)
  * [4 Example](countr_zero.html#Example)
  * [5 See also](countr_zero.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countr_zero&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  value of unsigned integer type   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countr_zero&action=edit&section=2 "Edit section: Return value")] Return value

The number of consecutive ​0​ bits in the value of x, starting from the least significant bit. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countr_zero&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countr_zero&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        for (const [std::uint8_t](../types/integer.html) i : {0, 0b11111111, 0b00011100, 0b00011101})
            [std::cout](../io/cout.html) << "countr_zero( " << [std::bitset](../utility/bitset.html)<8>(i) << " ) = "
                      << std::countr_zero(i) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countr_zero&action=edit&section=5 "Edit section: See also")] See also
