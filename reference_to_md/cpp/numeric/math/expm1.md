...
long double expm1 ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
expm1 ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float expm1f( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
long double expm1l( long double num ); |  (3) | (since C++11)   
(constexpr since C++26)  
...
expm1 ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](expm1.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double expm1 ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
  
1-3) Computes the e ([Euler's number](https://en.wikipedia.org/wiki/E_\(mathematical_constant\) "enwiki:E \(mathematical constant\)"), 2.7182818...) raised to the given power num, minus 1.0. This function is more accurate than the expression [std::exp](exp.html)(num) - 1.0 if num is close to zero. The library provides overloads of `std::expm1` for all cv-unqualified floating-point types as the type of the parameter.(since C++23)
...
## Contents
  ...
  * [6 See also](expm1.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/expm1&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/expm1&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/expm1&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/expm1&action=edit&section=4 "Edit section: Notes")] Notes

The functions `std::expm1` and [std::log1p](log1p.html "cpp/numeric/math/log1p") are useful for financial calculations, for example, when calculating small daily interest rates: (1+x)n  
-1 can be expressed as std::expm1(n * [std::log1p](log1p.html)(x)). These functions also simplify writing accurate inverse hyperbolic functions. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/expm1&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "expm1(1) = " << std::expm1(1) << '\n'
                  << "Interest earned in 2 days on $100, compounded daily at 1%\n"
                  << "    on a 30/360 calendar = "
                  << 100 * std::expm1(2 * [std::log1p](log1p.html)(0.01 / 360)) << '\n'
                  << "exp(1e-16)-1 = " << [std::exp](exp.html)(1e-16) - 1
                  << ", but expm1(1e-16) = " << std::expm1(1e-16) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "expm1(-0) = " << std::expm1(-0.0) << '\n'
                  << "expm1(-Inf) = " << std::expm1(-[INFINITY](INFINITY.html)) << '\n';
     
        // error handling
        errno = 0;
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
     
        [std::cout](../../io/cout.html) << "expm1(710) = " << std::expm1(710) << '\n';
     
        ...
        if ([std::fetestexcept](../fenv/fetestexcept.html)([FE_OVERFLOW](../fenv/FE_exceptions.html)))
            [std::cout](../../io/cout.html) << "    FE_OVERFLOW raised\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/expm1&action=edit&section=6 "Edit section: See also")] See also
...
[C documentation](../../../c/numeric/math/expm1.html "c/numeric/math/expm1") for expm1
