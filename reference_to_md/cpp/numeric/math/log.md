...
/*floating-point-type*/  
log ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float logf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
log ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](log.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double log ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
  
1-3) Computes the [natural (base-e) logarithm](https://en.wikipedia.org/wiki/Natural_logarithm "enwiki:Natural logarithm") of num. The library provides overloads of `std::log` for all cv-unqualified floating-point types as the type of the parameter.(since C++23)
...
## Contents
  ...
  * [4 Notes](log.html#Notes)
  * [5 Example](log.html#Example)
  * [6 See also](log.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/log&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/log&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/log&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/log&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/log&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "log(1) = " << std::log(1) << '\n'
                  << "base-5 logarithm of 125 = " << std::log(125) / std::log(5) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "log(1) = " << std::log(1) << '\n'
                  << "log(+Inf) = " << std::log([INFINITY](INFINITY.html)) << '\n';
     
        // error handling
        errno = 0;
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
     
        [std::cout](../../io/cout.html) << "log(0) = " << std::log(0) << '\n';
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/log&action=edit&section=6 "Edit section: See also")] See also
...
[ log(std::valarray)](../valarray/log.html "cpp/numeric/valarray/log") |  applies the function **std::log** to each element of valarray   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/valarray/dsc_log&action=edit)  
[C documentation](../../../c/numeric/math/log.html "c/numeric/math/log") for log
