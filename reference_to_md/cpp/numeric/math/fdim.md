...
long double fdim ( long double x, long double y ); |  | (until C++23)  
...
fdim ( const V0& v_x, const V1& v_y ); |  (S)  |  (since C++26)  
[Additional overloads](fdim.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double fdim ( Integer x, Integer y ); |  (A) | (constexpr since C++23)  
| |   
...
## Contents
  ...
  * [6 See also](fdim.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fdim&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  floating-point or integer values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fdim&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fdim&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fdim&action=edit&section=4 "Edit section: Notes")] Notes

Equivalent to [std::fmax](fmax.html)(x - y, 0), except for the NaN handling requirements. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fdim&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "fdim(4, 1) = " << std::fdim(4, 1) << '\n'
    ...
     
        [std::cout](../../io/cout.html) << "fdim(1e308, -1e308) = " << std::fdim(1e308, -1e308) << '\n';
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fdim&action=edit&section=6 "Edit section: See also")] See also
...
[C documentation](../../../c/numeric/math/fdim.html "c/numeric/math/fdim") for fdim
