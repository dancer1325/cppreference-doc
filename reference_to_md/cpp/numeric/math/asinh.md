...
long double asinh ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
asinh ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float asinhf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
asinh ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](asinh.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double asinh ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
## Contents
  ...
  * [5 Examples](asinh.html#Examples)
  * [6 See also](asinh.html#See_also)
  * [7 External links](asinh.html#External_links)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "asinh(1) = " << std::asinh(1) << '\n'
                  << "asinh(-1) = " << std::asinh(-1) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "asinh(+0) = " << std::asinh(+0.0) << '\n'
