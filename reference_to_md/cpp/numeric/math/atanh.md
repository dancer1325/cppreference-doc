...
long double atanh ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
atanh ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float atanhf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
atanh ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](atanh.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double atanh ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
## Contents
  ...
  * [6 See also](atanh.html#See_also)
  * [7 External links](atanh.html#External_links)
...
If a pole error occurs, [±HUGE_VAL](HUGE_VALL.html "cpp/numeric/math/HUGE VAL"), `±HUGE_VALF`, or `±HUGE_VALL` is returned (with the correct sign). 
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * if |num|>1, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised. 
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "atanh(0) = " << std::atanh(0) << '\n'
    ...
     
        [std::cout](../../io/cout.html) << "atanh(-1) = " << std::atanh(-1) << '\n';
     
