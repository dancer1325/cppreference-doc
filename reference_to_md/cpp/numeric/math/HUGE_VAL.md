...
| **HUGE_VALF HUGE_VALHUGE_VALL**(C++11)(C++11)  
---  
...
The macros HUGE_VALF, HUGE_VAL and HUGE_VALL macros expand to positive floating point constant expressions which compare equal to the values returned by floating-point functions and operators in case of overflow (see [math_errhandling](math_errhandling.html "cpp/numeric/math/math errhandling")). 
