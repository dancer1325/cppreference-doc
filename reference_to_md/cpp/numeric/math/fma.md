...
/* floating-point-type */ z ); |  |  (since C++23)  
float fmaf( float x, float y, float z ); |  (2) | (since C++11)   
(constexpr since C++23)  
long double fmal( long double x, long double y, long double z ); |  (3) | (since C++11)   
(constexpr since C++23)  
...
[Additional overloads](fma.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Arithmetic1, class Arithmetic2, class Arithmetic3 >  
/* common-floating-point-type */  
fma( Arithmetic1 x, Arithmetic2 y, Arithmetic3 z ); |  (A) | (since C++11)   
(constexpr since C++23)  
| |   
...
## Contents
  ...
  * [1 Parameters](fma.html#Parameters)
  * [2 Return value](fma.html#Return_value)
  * [3 Error handling](fma.html#Error_handling)
  * [4 Notes](fma.html#Notes)
  * [5 Example](fma.html#Example)
  * [6 See also](fma.html#See_also)
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If x is zero and y is infinite or if x is infinite and y is zero, and 
    * if z is not a NaN, then NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised, 
    * if z is a NaN, then NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be raised. 
  * If x * y is an exact infinity and z is an infinity with the opposite sign, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised. 
  * If x or y are NaN, NaN is returned. 
  * If z is NaN, and x * y is not 0 * Inf or Inf * 0, then NaN is returned (without [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions")). 
...
POSIX [(`fma`, `fmaf`, `fmal`)](https://pubs.opengroup.org/onlinepubs/9699919799/functions/fma.html) additionally specifies that the situations specified to return [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") are domain errors. 

Due to its infinite intermediate precision, `std::fma` is a common building block of other correctly-rounded mathematical operations, such as [std::sqrt](sqrt.html "cpp/numeric/math/sqrt") or even the division (where not provided by the CPU, e.g. [Itanium](https://en.wikipedia.org/wiki/Itanium "enwiki:Itanium")). 

As with all floating-point expressions, the expression x * y + z may be compiled as a fused multiply-add unless the [` #pragma`](../../preprocessor/impl.html "cpp/preprocessor/impl") STDC FP_CONTRACT is off. 
...
The additional overloads are not required to be provided exactly as (A). They only need to be sufficient to ensure that for their first argument num1, second argument num2 and third argument num3: 
  ...
  * If num1, num2 or num3 has type long double, then std::fma(num1, num2, num3) has the same effect as std::fma(static_cast<long double>(num1),  
static_cast<long double>(num2),  
static_cast<long double>(num3)). 
  * Otherwise, if num1, num2 and/or num3 has type double or an integer type, then std::fma(num1, num2, num3) has the same effect as std::fma(static_cast<double>(num1),  
static_cast<double>(num2),  
static_cast<double>(num3)). 
  * Otherwise, if num1, num2 or num3 has type float, then std::fma(num1, num2, num3) has the same effect as std::fma(static_cast<float>(num1),  
static_cast<float>(num2),  
static_cast<float>(num3)). 

| (until C++23)  
---|---  
If num1, num2 and num3 have arithmetic types, then std::fma(num1, num2, num3) has the same effect as std::fma(static_cast</*common-floating-point-type*/>(num1),  
...
Run this code
    ...
    int main()
    {
        ...
        const double in = 0.1;
        [std::cout](../../io/cout.html) << "0.1 double is " << [std::setprecision](../../io/manip/setprecision.html)(23) << in
                  << " (" << [std::hexfloat](../../io/manip/fixed.html) << in << [std::defaultfloat](../../io/manip/fixed.html) << ")\n"
    ...
     
        ...
        [std::cout](../../io/cout.html) << "0.1 * 10 - 1 = " << expr_result
                  << " : 1 subtracted after intermediate rounding\n"
                  << "fma(0.1, 10, -1) = " << [std::setprecision](../../io/manip/setprecision.html)(6) << fma_result << " ("
                  << [std::hexfloat](../../io/manip/fixed.html) << fma_result << [std::defaultfloat](../../io/manip/fixed.html) << ")\n\n";
     
        // fma is used in double-double arithmetic
        const double high = 0.1 * 10;
        const double low = std::fma(0.1, 10, -high);
        [std::cout](../../io/cout.html) << "in double-double arithmetic, 0.1 * 10 is representable as "
                  << high << " + " << low << "\n\n";
     
        // error handling
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [std::cout](../../io/cout.html) << "fma(+Inf, 10, -Inf) = " << std::fma([INFINITY](INFINITY.html), 10, -[INFINITY](INFINITY.html)) << '\n';
