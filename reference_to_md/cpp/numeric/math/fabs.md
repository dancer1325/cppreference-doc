...
long double abs( long double num ); |  | (until C++23)  
constexpr /* floating-point-type */  
abs( /* floating-point-type */ num ); |  |  (since C++23)  
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
| (2) |   
float fabs ( float num );  
double fabs ( double num );  
long double fabs ( long double num ); |  | (until C++23)  
constexpr /* floating-point-type */  
fabs ( /* floating-point-type */ num ); |  |  (since C++23)  
float fabsf( float num ); |  (3) | (since C++11)   
(constexpr since C++23)  
long double fabsl( long double num ); |  (4) | (since C++11)   
(constexpr since C++23)  
[Additional overloads](fabs.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double fabs ( Integer num ); |  (A) | (since C++11)   
(constexpr since C++23)  
| |   
...
For integral arguments, [the integral overloads of `std::abs`](abs.html "cpp/numeric/math/abs") are likely better matches. If `std::abs` is called with an unsigned integral argument that cannot be converted to int by [integral promotion](../../language/implicit_cast.html#Integral_promotion "cpp/language/implicit conversion"), the program is ill-formed. 

## Contents

  * [1 Parameters](fabs.html#Parameters)
  * [2 Return value](fabs.html#Return_value)
  * [3 Error handling](fabs.html#Error_handling)
  * [4 Notes](fabs.html#Notes)
  * [5 Example](fabs.html#Example)
  * [6 Defect reports](fabs.html#Defect_reports)
  * [7 See also](fabs.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fabs&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fabs&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fabs&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fabs&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fabs&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "abs(+3.0) = " << std::abs(+3.0) << '\n'
                  << "abs(-3.0) = " << std::abs(-3.0) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "abs(-0.0) = " << std::abs(-0.0) << '\n'
                  << "abs(-Inf) = " << std::abs(-[INFINITY](INFINITY.html)) << '\n'
                  << "abs(-NaN) = " << std::abs(-[NAN](NAN.html)) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fabs&action=edit&section=6 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 2192](https://cplusplus.github.io/LWG/issue2192) | C++98  | overloads of `std::abs` were  
inconsistently declared in two headers  | declared these overloads  
in both headers   
[LWG 2735](https://cplusplus.github.io/LWG/issue2735) | C++11  | overloads of `std::abs` for integer types  
returning double was erroneously required  | removed the requirement   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fabs&action=edit&section=7 "Edit section: See also")] See also

[ abs(int)labsllabs](abs.html "cpp/numeric/math/abs")(C++11) |  computes absolute value of an integral value (\\(\small{|x|}\\)|x|)   
...
[C documentation](../../../c/numeric/math/fabs.html "c/numeric/math/fabs") for fabs
