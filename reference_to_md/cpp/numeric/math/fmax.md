...
long double fmax ( long double x, long double y ); |  | (until C++23)  
constexpr /*floating-point-type*/  
fmax ( /*floating-point-type*/ x,  
/*floating-point-type*/ y ); |  |  (since C++23)  
float fmaxf( float x, float y ); |  (2) | (since C++11)   
(constexpr since C++23)  
long double fmaxl( long double x, long double y ); |  (3) | (since C++11)   
(constexpr since C++23)  
...
fmax ( const V0& v_x, const V1& v_y ); |  (S)  |  (since C++26)  
[Additional overloads](fmax.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double fmax ( Integer x, Integer y ); |  (A) | (constexpr since C++23)  
| |   
...
## Contents
  ...
  * [1 Parameters](fmax.html#Parameters)
  * [2 Return value](fmax.html#Return_value)
  * [3 Error handling](fmax.html#Error_handling)
  * [4 Notes](fmax.html#Notes)
  * [5 Example](fmax.html#Example)
  * [6 See also](fmax.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmax&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  floating-point or integer values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmax&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmax&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmax&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmax&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "fmax(2,1)    = " << std::fmax(2, 1) << '\n'
                  << "fmax(-Inf,0) = " << std::fmax(-[INFINITY](INFINITY.html), 0) << '\n'
                  << "fmax(NaN,-1) = " << std::fmax([NAN](NAN.html), -1) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmax&action=edit&section=6 "Edit section: See also")] See also

[ isgreater](isgreater.html "cpp/numeric/math/isgreater")(C++11) |  checks if the first floating-point argument is greater than the second   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/math/dsc_isgreater&action=edit)  
---|---  
[ fminfminffminl](fmin.html "cpp/numeric/math/fmin")(C++11)(C++11)(C++11) |  smaller of two floating point values   
...
[C documentation](../../../c/numeric/math/fmax.html "c/numeric/math/fmax") for fmax
