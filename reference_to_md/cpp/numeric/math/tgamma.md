...
long double tgamma ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
tgamma ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float tgammaf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
long double tgammal( long double num ); |  (3) | (since C++11)   
(constexpr since C++26)  
...
tgamma ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](tgamma.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double tgamma ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
  
1-3) Computes the [gamma function](https://en.wikipedia.org/wiki/Gamma_function "enwiki:Gamma function") of num. The library provides overloads of `std::tgamma` for all cv-unqualified floating-point types as the type of the parameter.(since C++23)
...
## Contents
  ...
  * [6 See also](tgamma.html#See_also)
  * [7 External links](tgamma.html#External_links)
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If the argument is a negative integer, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised. 
...
For IEEE-compatible type double, overflow happens if 0 < num && num < 1 / [DBL_MAX](../../types/climits.html) or if num > 171.7. 
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "tgamma(10) = " << std::tgamma(10)
                  << ", 9! = " << 2 * 3 * 4 * 5 * 6 * 7 * 8 * 9 << '\n'
                  << "tgamma(0.5) = " << std::tgamma(0.5)
                  << ", sqrt(pi) = " << [std::sqrt](sqrt.html)([std::acos](acos.html)(-1)) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "tgamma(1) = " << std::tgamma(1) << '\n'
                  << "tgamma(+Inf) = " << std::tgamma([INFINITY](INFINITY.html)) << '\n';
     
        // error handling
        errno = 0;
