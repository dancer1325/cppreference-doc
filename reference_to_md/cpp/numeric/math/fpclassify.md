...
int fpclassify( long double num ); |  | (since C++11)   
(until C++23)  
constexpr int fpclassify( /* floating-point-type */ num ); |  |  (since C++23)  
[Additional overloads](fpclassify.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
int fpclassify( Integer num ); |  (A)  |  (since C++11)   
...
## Contents
  ...
  * [3 Notes](fpclassify.html#Notes)
  * [4 Example](fpclassify.html#Example)
...
Run this code
    ...
    auto show_classification(double x)
    {
        ...
        {
            case [FP_INFINITE](FP_categories.html):
                return "Inf";
            case [FP_NAN](FP_categories.html):
                return "NaN";
            case [FP_NORMAL](FP_categories.html):
                return "normal";
            case [FP_SUBNORMAL](FP_categories.html):
                return "subnormal";
            case [FP_ZERO](FP_categories.html):
                return "zero";
            default:
                return "unknown";
        }
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "1.0/0.0 is " << show_classification(1 / 0.0) << '\n'
                  << "0.0/0.0 is " << show_classification(0.0 / 0.0) << '\n'
                  << "DBL_MIN/2 is " << show_classification([DBL_MIN](../../types/climits.html) / 2) << '\n'
