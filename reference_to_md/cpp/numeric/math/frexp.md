...
long double frexp ( long double num, int* exp ); |  | (until C++23)  
constexpr /* floating-point-type */  
frexp ( /* floating-point-type */ num, int* exp ); |  |  (since C++23)  
float frexpf( float num, int* exp ); |  (2)  |  (since C++11)   
(constexpr since C++23)  
long double frexpl( long double num, int* exp ); |  (3)  |  (since C++11)   
(constexpr since C++23)  
[Additional overloads](frexp.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double frexp ( Integer num, int* exp ); |  (A)  |  (constexpr since C++23)  
| |   
...
## Contents
  ...
  * [6 See also](frexp.html#See_also)
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If [FLT_RADIX](../../types/climits.html "cpp/types/climits") is 2 (or a power of 2), the returned value is exact, [the current rounding mode](../fenv/FE_round.html "cpp/numeric/fenv/FE round") is ignored. 
...
On a binary system (where [FLT_RADIX](../../types/climits.html "cpp/types/climits") is 2), `std::frexp` may be implemented as 
    ...
    {
        *exp = (value == 0) ? 0 : (int)(1 + [std::logb](logb.html)(value));
        return [std::scalbn](scalbn.html)(value, -(*exp));
    }

The function `std::frexp`, together with its dual, [std::ldexp](ldexp.html "cpp/numeric/math/ldexp"), can be used to manipulate the representation of a floating-point number without direct bit manipulations. 
