...
fmod ( const V0& v_x, const V1& v_y ); |  (S)  |  (since C++26)  
[Additional overloads](fmod.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
...
S) The SIMD overload performs an element-wise `std::fmod` on v_xand v_y.
    ...
    (See [`_math-common-simd-t_`](../simd.html#math-common-simd-t "cpp/numeric/simd") for its definition.)
| (since C++26)  
---|---  
...
## Contents
  ...
  * [6 See also](fmod.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmod&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  floating-point or integer values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmod&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmod&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If x is ±∞ and y is not NaN, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised. 
  * If y is ±0 and x is not NaN, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised. 
  * If y is ±∞ and x is finite, x is returned. 
  * If either argument is NaN, NaN is returned. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmod&action=edit&section=4 "Edit section: Notes")] Notes
...
`std::fmod`, but not [std::remainder](remainder.html "cpp/numeric/math/remainder") is useful for doing silent wrapping of floating-point types to unsigned integer types: (0.0 <= (y = std::fmod([std::rint](rint.html)(x), 65536.0)) ? y : 65536.0 + y) is in the range `[`-0.0`, `65535.0`]`, which corresponds to unsigned short, but [std::remainder](remainder.html)([std::rint](rint.html)(x), 65536.0 is in the range `[`-32767.0`, `+32768.0`]`, which is outside of the range of signed short. 
...
The double version of `std::fmod` behaves as if implemented as follows: 
    ...
    #pragma STDC FENV_ACCESS ON
        double result = [std::remainder](remainder.html)([std::fabs](fabs.html)(x), y = [std::fabs](fabs.html)(y));
        if ([std::signbit](signbit.html)(result))
            result += y;
        return [std::copysign](copysign.html)(result, x);
    }

The expression x - [std::trunc](trunc.html)(x / y) * y may not equal std::fmod(x, y), when the rounding of x / y to initialize the argument of [std::trunc](trunc.html "cpp/numeric/math/trunc") loses too much precision (example: x = 30.508474576271183309, y = 6.1016949152542370172). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmod&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "fmod(+5.1, +3.0) = " << std::fmod(5.1, 3) << '\n'
                  << "fmod(-5.1, +3.0) = " << std::fmod(-5.1, 3) << '\n'
                  << "fmod(+5.1, -3.0) = " << std::fmod(5.1, -3) << '\n'
                  << "fmod(-5.1, -3.0) = " << std::fmod(-5.1, -3) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "fmod(+0.0, 1.0) = " << std::fmod(0, 1) << '\n'
                  << "fmod(-0.0, 1.0) = " << std::fmod(-0.0, 1) << '\n'
                  << "fmod(5.1, Inf) = " << std::fmod(5.1, [INFINITY](INFINITY.html)) << '\n';
     
        // error handling
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [std::cout](../../io/cout.html) << "fmod(+5.1, 0) = " << std::fmod(5.1, 0) << '\n';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/fmod&action=edit&section=6 "Edit section: See also")] See also
...
[C documentation](../../../c/numeric/math/fmod.html "c/numeric/math/fmod") for fmod
