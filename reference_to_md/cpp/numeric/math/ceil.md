...
float ceilf( float num ); |  (2) | (since C++11)   
...
ceil ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](ceil.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double ceil ( Integer num ); |  (A) | (constexpr since C++23)  
| |   
...
## Contents
  ...
  * [6 See also](ceil.html#See_also)
  * [7 External links](ceil.html#External_links)
...
The largest representable floating-point values are exact integers in all standard floating-point formats, so this function never overflows on its own; however the result may overflow any integer type (including [std::intmax_t](../../types/integer.html "cpp/types/integer")), when stored in an integer variable. It is for this reason that the return type is floating-point not integral. 

This function (for double argument) behaves as if (except for the freedom to not raise [FE_INEXACT](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions")) implemented by the following code: 
    ...
    {
        int save_round = [std::fegetround](../fenv/feround.html)();
        [std::fesetround](../fenv/feround.html)([FE_UPWARD](../fenv/FE_round.html));
        double result = [std::rint](rint.html)(x); // or std::nearbyint
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::fixed](../../io/manip/fixed.html)
                  ...
                  << "ceil(-Inf) = " << std::ceil(-[INFINITY](INFINITY.html)) << '\n';
    }
