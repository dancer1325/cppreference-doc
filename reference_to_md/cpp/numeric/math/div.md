...
std::imaxdiv_t div( [std::intmax_t](../../types/integer.html) x, [std::intmax_t](../../types/integer.html) y ); |  (6) | (since C++11)   
(constexpr since C++23)  
std::imaxdiv_t imaxdiv( [std::intmax_t](../../types/integer.html) x, [std::intmax_t](../../types/integer.html) y ); |  (7) | (since C++11)   
(constexpr since C++23)  
| |   
  
Computes both the quotient and the remainder of the division of the numerator x by the denominator y. 

6,7) Overload of `std::div` for [std::intmax_t](../../types/integer.html "cpp/types/integer") is provided in [`<cinttypes>`](../../header/cinttypes.html "cpp/header/cinttypes") if and only if [std::intmax_t](../../types/integer.html "cpp/types/integer") is an [extended integer type](../../language/types.html#Extended_integer_types "cpp/language/types"). | (since C++11)  
---|---  
...
## Contents
  ...
  * [1 Parameters](div.html#Parameters)
  * [2 Return value](div.html#Return_value)
  * [3 std::div_t](div.html#std::div_t)
  * [4 std::ldiv_t](div.html#std::ldiv_t)
  * [5 std::lldiv_t](div.html#std::lldiv_t)
  * [6 std::imaxdiv_t](div.html#std::imaxdiv_t)
    * [6.1 Notes](div.html#Notes)
    * [6.2 Example](div.html#Example)
    * [6.3 See also](div.html#See_also)
    * [6.4 External links](div.html#External_links)
...
##  std::imaxdiv_t
    ...
    struct imaxdiv_t { [std::intmax_t](../../types/integer.html) quot; [std::intmax_t](../../types/integer.html) rem; };

or 
    
    
    struct imaxdiv_t { [std::intmax_t](../../types/integer.html) rem; [std::intmax_t](../../types/integer.html) quot; };
...
Run this code
    ...
    #include <string>
     
    [std::string](../../string/basic_string.html) division_with_remainder_string(int dividend, int divisor)
    {
        auto dv = std::div(dividend, divisor);
        [assert](../../error/assert.html)(dividend == divisor * dv.quot + dv.rem);
        [assert](../../error/assert.html)(dv.quot == dividend / divisor);
        [assert](../../error/assert.html)(dv.rem == dividend % divisor);
     
        auto sign = [](int n){ return n > 0 ? 1 : n < 0 ? -1 : 0; };
        [assert](../../error/assert.html)((dv.rem == 0) or (sign(dv.rem) == sign(dividend)));
     
        return ([std::ostringstream](../../io/basic_ostringstream.html)() << [std::showpos](../../io/manip/showpos.html) << dividend << " = "
                                     << divisor << " * (" << dv.quot << ") "
                                     << [std::showpos](../../io/manip/showpos.html) << dv.rem).str();
    }
     
    [std::string](../../string/basic_string.html) itoa(int n, int radix /*[2..16]*/)
    {
        [std::string](../../string/basic_string.html) buf;
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << division_with_remainder_string(369, 10) << '\n'
                  << division_with_remainder_string(369, -10) << '\n'
                  << division_with_remainder_string(-369, 10) << '\n'
                  << division_with_remainder_string(-369, -10) << "\n\n";
     
        [std::cout](../../io/cout.html) << itoa(12345, 10) << '\n'
                  << itoa(-12345, 10) << '\n'
                  << itoa(42, 2) << '\n'
                  << itoa(65535, 16) << '\n';
    }
