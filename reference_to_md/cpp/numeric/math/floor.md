...
float floorf( float num ); |  (2) | (since C++11)   
(constexpr since C++23)  
long double floorl( long double num ); |  (3) | (since C++11)   
(constexpr since C++23)  
...
floor ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](floor.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
...
## Contents
  ...
  * [6 See also](floor.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::fixed](../../io/manip/fixed.html)
                  ...
                  << "floor(-Inf) = " << std::floor(-[INFINITY](INFINITY.html)) << '\n';
    }
