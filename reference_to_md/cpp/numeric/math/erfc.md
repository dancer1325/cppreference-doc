...
long double erfc ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
erfc ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float erfcf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
erfc ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](erfc.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double erfc ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
  
1-3) Computes the [complementary error function](https://en.wikipedia.org/wiki/Complementary_error_function "enwiki:Complementary error function") of num, that is 1.0 - [std::erf](erf.html)(num), but without loss of precision for large num. The library provides overloads of `std::erfc` for all cv-unqualified floating-point types as the type of the parameter.(since C++23)
...
## Contents
  ...
  * [6 See also](erfc.html#See_also)
  * [7 External links](erfc.html#External_links)
...
∫∞  
num _e_ -t2  
d _t_ or \\({\small 1-\operatorname{erf}(num)}\\)1-erf(num), is returned. 
...
Run this code
    ...
    {
        return std::erfc(-x / [std::sqrt](sqrt.html)(2)) / 2;
    }
     
    int main()
    {
        [std::cout](../../io/cout.html) << "normal cumulative distribution function:\n"
                  << [std::fixed](../../io/manip/fixed.html) << [std::setprecision](../../io/manip/setprecision.html)(2);
        for (double n = 0; n < 1; n += 0.1)
            [std::cout](../../io/cout.html) << "normalCDF(" << n << ") = " << 100 * normalCDF(n) << "%\n";
     
        [std::cout](../../io/cout.html) << "special values:\n"
                  << "erfc(-Inf) = " << std::erfc(-[INFINITY](INFINITY.html)) << '\n'
                  << "erfc(Inf) = " << std::erfc([INFINITY](INFINITY.html)) << '\n';
    }
