...
long double cbrt ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
cbrt ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float cbrtf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
cbrt ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](cbrt.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double cbrt ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
---  
3  
is typically not equal to 1.0 / 3 and [std::pow](pow.html "cpp/numeric/math/pow") cannot raise a negative base to a fractional exponent. Moreover, std::cbrt(num) usually gives more accurate results than [std::pow](pow.html)(num, 1.0 / 3) (see example). 
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html)
            ...
            << "Special values:\n"
            << "cbrt(-0)        = " << std::cbrt(-0.0) << '\n'
            << "cbrt(+inf)      = " << std::cbrt([INFINITY](INFINITY.html)) << '\n'
            << "Accuracy and comparison with `pow`:\n"
            << [std::setprecision](../../io/manip/setprecision.html)([std::numeric_limits](../../types/numeric_limits.html)<double>::max_digits10)
            << "cbrt(343)       = " << std::cbrt(343) << '\n'
            << "pow(343,1.0/3)  = " << [std::pow](pow.html)(343, 1.0 / 3) << '\n'
            << "cbrt(-343)      = " << std::cbrt(-343) << '\n'
            << "pow(-343,1.0/3) = " << [std::pow](pow.html)(-343, 1.0 / 3) << '\n';
    }
