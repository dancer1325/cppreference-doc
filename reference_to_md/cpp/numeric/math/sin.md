...
long double sin ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
sin ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float sinf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
sin ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](sin.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double sin ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
## Contents
  ...
  * [3 Error handling](sin.html#Error_handling)
  * [4 Notes](sin.html#Notes)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sin&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value representing angle in radians   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sin&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sin&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * if the argument is ±∞, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised. 
  * if the argument is NaN, NaN is returned. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sin&action=edit&section=4 "Edit section: Notes")] Notes
...
POSIX also specifies that in case of underflow, num is returned unmodified, and if that is not supported, an implementation-defined value no greater than [DBL_MIN](../../types/climits.html "cpp/types/climits"), [FLT_MIN](../../types/climits.html "cpp/types/climits"), and [LDBL_MIN](../../types/climits.html "cpp/types/climits") is returned. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sin&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
    const double pi = [std::acos](acos.html)(-1); // or std::numbers::pi since C++20
     
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::setprecision](../../io/manip/setprecision.html)(10) << [std::showpos](../../io/manip/showpos.html)
                  << "Typical usage:\n"
    ...
     
        [std::cout](../../io/cout.html) << "std::sin(INFINITY) = " << std::sin([INFINITY](INFINITY.html)) << '\n';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sin&action=edit&section=6 "Edit section: See also")] See also

[ coscosfcosl](cos.html "cpp/numeric/math/cos")(C++11)(C++11) |  computes cosine (\\({\small\cos{x}}\\)cos(x))   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/math/dsc_cos&action=edit)  
---|---  
[ tantanftanl](tan.html "cpp/numeric/math/tan")(C++11)(C++11) |  computes tangent (\\({\small\tan{x}}\\)tan(x))   
...
[ sin(std::valarray)](../valarray/sin.html "cpp/numeric/valarray/sin") |  applies the function **std::sin** to each element of valarray   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/valarray/dsc_sin&action=edit)  
[C documentation](../../../c/numeric/math/sin.html "c/numeric/math/sin") for sin
