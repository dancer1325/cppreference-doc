...
/*floating-point-type*/  
sqrt ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float sqrtf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
sqrt ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](sqrt.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double sqrt ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sqrt&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sqrt&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sqrt&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sqrt&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        // normal use
        [std::cout](../../io/cout.html) << "sqrt(100) = " << std::sqrt(100) << '\n'
                  << "sqrt(2) = " << std::sqrt(2) << '\n'
                  << "golden ratio = " << (1 + std::sqrt(5)) / 2 << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "sqrt(-0) = " << std::sqrt(-0.0) << '\n';
     
        // error handling
        errno = 0;
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
     
        [std::cout](../../io/cout.html) << "sqrt(-1.0) = " << std::sqrt(-1) << '\n';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sqrt&action=edit&section=6 "Edit section: See also")] See also
...
[ sqrt(std::valarray)](../valarray/sqrt.html "cpp/numeric/valarray/sqrt") |  applies the function **std::sqrt** to each element of valarray   
...
[C documentation](../../../c/numeric/math/sqrt.html "c/numeric/math/sqrt") for sqrt
