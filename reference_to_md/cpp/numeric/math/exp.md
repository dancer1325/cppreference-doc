...
/*floating-point-type*/  
exp ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float expf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
exp ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](exp.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double exp ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
  
1-3) Computes e ([Euler's number](https://en.wikipedia.org/wiki/E_\(mathematical_constant\) "enwiki:E \(mathematical constant\)"), 2.7182818...) raised to the given power num. The library provides overloads of `std::exp` for all cv-unqualified floating-point types as the type of the parameter.(since C++23)
...
## Contents
  ...
  * [1 Parameters](exp.html#Parameters)
  * [2 Return value](exp.html#Return_value)
  * [3 Error handling](exp.html#Error_handling)
  * [4 Notes](exp.html#Notes)
  * [5 Example](exp.html#Example)
  * [6 See also](exp.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/exp&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/exp&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the base-e exponential of num (enum  
) is returned. 

If a range error occurs due to overflow, [+HUGE_VAL](HUGE_VALL.html "cpp/numeric/math/HUGE VAL"), `+HUGE_VALF`, or `+HUGE_VALL` is returned. 

If a range error occurs due to underflow, the correct result (after rounding) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/exp&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/exp&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/exp&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::setprecision](../../io/manip/setprecision.html)(16)
                  << "exp(1) = e¹ = " << std::exp(1) << '\n'
                  << "numbers::e  = " << [std::numbers::e](../constants.html) << '\n'
                  << "approx_e    = " << approx_e() << '\n'
                  << "FV of $100, continuously compounded at 3% for 1 year = "
                  << [std::setprecision](../../io/manip/setprecision.html)(6) << 100 * std::exp(0.03) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "exp(-0) = " << std::exp(-0.0) << '\n'
                  << "exp(-Inf) = " << std::exp(-[INFINITY](INFINITY.html)) << '\n';
     
        // error handling 
        errno = 0;
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
     
        [std::cout](../../io/cout.html) << "exp(710) = " << std::exp(710) << '\n';
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/exp&action=edit&section=6 "Edit section: See also")] See also
...
[ exp(std::valarray)](../valarray/exp.html "cpp/numeric/valarray/exp") |  applies the function **std::exp** to each element of valarray   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/valarray/dsc_exp&action=edit)  
[C documentation](../../../c/numeric/math/exp.html "c/numeric/math/exp") for exp
