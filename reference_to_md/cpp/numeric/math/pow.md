...
/* floating-point-type */ exp ) |  |  (since C++23)   
...
(constexpr since C++26)  
long double powl( long double base, long double exp ); |  (4)  |  (since C++11)   
(constexpr since C++26)  
[Additional overloads](pow.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
...
## Contents
  ...
  * [6 See also](pow.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/pow&action=edit&section=1 "Edit section: Parameters")] Parameters

base  |  \-  |  base as a floating-point or integer value   
---|---|---  
exp  |  \-  |  exponent as a floating-point or integer value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/pow&action=edit&section=2 "Edit section: Return value")] Return value
...
If a pole error or a range error due to overflow occurs, [±HUGE_VAL](HUGE_VALL.html "cpp/numeric/math/HUGE VAL"), `±HUGE_VALF`, or `±HUGE_VALL` is returned. 

If a range error occurs due to underflow, the correct result (after rounding) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/pow&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * pow(+0, exp), where exp is a negative odd integer, returns +∞ and raises [FE_DIVBYZERO](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions"). 
  * pow(-0, exp), where exp is a negative odd integer, returns -∞ and raises [FE_DIVBYZERO](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions"). 
  * pow(±0, exp), where exp is negative, finite, and is an even integer or a non-integer, returns +∞ and raises [FE_DIVBYZERO](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions"). 
  * pow(±0, -∞) returns +∞ and may raise [FE_DIVBYZERO](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions"). 
  ...
  * pow(base, exp) returns NaN and raises [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") if base is finite and negative and exp is finite and non-integer. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/pow&action=edit&section=4 "Edit section: Notes")] Notes

C++98 added overloads where exp has type int on top of C [`pow()`](../../../c/numeric/math/pow.html "c/numeric/math/pow"), and the return type of std::pow(float, int) was float. However, the additional overloads introduced in C++11 specify that std::pow(float, int) should return double. [LWG issue 550](https://cplusplus.github.io/LWG/issue550) was raised to target this conflict, and the resolution is to removed the extra int exp overloads. 

Although `std::pow` cannot be used to obtain a root of a negative number, [std::cbrt](cbrt.html "cpp/numeric/math/cbrt") is provided for the common case where exp is 1/3. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/pow&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        // typical usage
        [std::cout](../../io/cout.html) << "pow(2, 10) = " << std::pow(2, 10) << '\n'
                  << "pow(2, 0.5) = " << std::pow(2, 0.5) << '\n'
                  << "pow(-2, -3) = " << std::pow(-2, -3) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "pow(-1, NAN) = " << std::pow(-1, [NAN](NAN.html)) << '\n'
                  << "pow(+1, NAN) = " << std::pow(+1, [NAN](NAN.html)) << '\n'
                  << "pow(INFINITY, 2) = " << std::pow([INFINITY](INFINITY.html), 2) << '\n'
                  << "pow(INFINITY, -1) = " << std::pow([INFINITY](INFINITY.html), -1) << '\n';
     
        // error handling
        errno = 0;
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
     
        [std::cout](../../io/cout.html) << "pow(-1, 1/3) = " << std::pow(-1, 1.0 / 3) << '\n';
        if (errno == [EDOM](../../error/errno_macros.html))
            [std::cout](../../io/cout.html) << "    errno == EDOM " << [std::strerror](../../string/byte/strerror.html)(errno) << '\n';
        if ([std::fetestexcept](../fenv/fetestexcept.html)([FE_INVALID](../fenv/FE_exceptions.html)))
            [std::cout](../../io/cout.html) << "    FE_INVALID raised\n";
     
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
     
        [std::cout](../../io/cout.html) << "pow(-0, -3) = " << std::pow(-0.0, -3) << '\n';
        if ([std::fetestexcept](../fenv/fetestexcept.html)([FE_DIVBYZERO](../fenv/FE_exceptions.html)))
            [std::cout](../../io/cout.html) << "    FE_DIVBYZERO raised\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/pow&action=edit&section=6 "Edit section: See also")] See also
...
[ pow(std::valarray)](../valarray/pow.html "cpp/numeric/valarray/pow") |  applies the function **std::pow** to two valarrays or a valarray and a value   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/valarray/dsc_pow&action=edit)  
[C documentation](../../../c/numeric/math/pow.html "c/numeric/math/pow") for pow
