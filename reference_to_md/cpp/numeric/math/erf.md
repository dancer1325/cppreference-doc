...
long double erf ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
erf ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float erff( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
erf ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](erf.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double erf ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
  
1-3) Computes the [error function](https://en.wikipedia.org/wiki/Error_function "enwiki:Error function") of num. The library provides overloads of `std::erf` for all cv-unqualified floating-point types as the type of the parameter.(since C++23)
...
## Contents
  ...
  * [6 See also](erf.html#See_also)
  * [7 External links](erf.html#External_links)
...
Run this code
    ...
    {
        return (std::erf(x2 / [std::sqrt](sqrt.html)(2)) - std::erf(x1 / [std::sqrt](sqrt.html)(2))) / 2;
    }
     
    int main()
    {
        [std::cout](../../io/cout.html) << "Normal variate probabilities:\n"
        ...
        for (int n = -4; n < 4; ++n)
            [std::cout](../../io/cout.html) << '[' << [std::setw](../../io/manip/setw.html)(2) << n
                      << ':' << [std::setw](../../io/manip/setw.html)(2) << n + 1 << "]: "
                      << [std::setw](../../io/manip/setw.html)(5) << 100 * phi(n, n + 1) << "%\n";
     
        [std::cout](../../io/cout.html) << "Special values:\n"
                  << "erf(-0) = " << std::erf(-0.0) << '\n'
                  << "erf(Inf) = " << std::erf([INFINITY](INFINITY.html)) << '\n';
    }
