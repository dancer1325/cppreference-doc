...
[Additional overloads](isunordered.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Arithmetic1, class Arithmetic2 >  
bool isunordered( Arithmetic1 x, Arithmetic2 y ); |  (A)  |  (since C++11)   
...
## Contents
  ...
  * [3 Notes](isunordered.html#Notes)
  * [4 Example](isunordered.html#Example)
...
Run this code
    ...
    int main()
    {
        ...
        SHOW_UNORDERED([INFINITY](INFINITY.html), [NAN](NAN.html));
        SHOW_UNORDERED([INFINITY](INFINITY.html), [INFINITY](INFINITY.html));
        SHOW_UNORDERED([NAN](NAN.html), [NAN](NAN.html));
    }
