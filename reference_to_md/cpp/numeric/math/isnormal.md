...
bool isnormal( long double num ); |  | (since C++11)   
(until C++23)  
...
isnormal ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](isnormal.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
bool isnormal( Integer num ); |  (A)  |  (since C++11)   
...
## Contents
  ...
  * [3 Notes](isnormal.html#Notes)
  * [4 Example](isnormal.html#Example)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html)
                  << "isnormal(NaN) = " << std::isnormal([NAN](NAN.html)) << '\n'
                  << "isnormal(Inf) = " << std::isnormal([INFINITY](INFINITY.html)) << '\n'
                  << "isnormal(0.0) = " << std::isnormal(0.0) << '\n'
                  << "isnormal(DBL_MIN/2.0) = " << std::isnormal([DBL_MIN](../../types/climits.html) / 2.0) << '\n'
