...
## Contents
  ...
  * [6 See also](remquo.html#See_also)
...
Run this code
    ...
    double cos_pi_x_smart(double x)
    {
        ...
        return quadrant == 0 ?  [std::cos](cos.html)(pi * rem)
                             : -[std::cos](cos.html)(pi * rem);
    }
     
    int main()
    {
    ...
     
        int quo;
        [std::cout](../../io/cout.html) << "remquo(+Inf, 1) = " << std::remquo([INFINITY](INFINITY.html), 1, &quo) << '\n';
