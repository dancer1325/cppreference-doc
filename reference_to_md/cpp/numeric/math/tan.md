...
long double tan ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
tan ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float tanf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
tan ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](tan.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double tan ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
## Contents
  ...
  * [3 Error handling](tan.html#Error_handling)
  * [4 Notes](tan.html#Notes)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tan&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value representing angle in radians   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tan&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tan&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tan&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tan&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    const double pi = [std::acos](acos.html)(-1); // or C++20's std::numbers::pi
     
    int main()
    {
        // typical usage
        [std::cout](../../io/cout.html) << "tan(1*pi/4) = " << std::tan(1*pi/4) << '\n' // 45°
                  << "tan(3*pi/4) = " << std::tan(3*pi/4) << '\n' // 135°
                  << "tan(5*pi/4) = " << std::tan(5*pi/4) << '\n' // -135°
                  << "tan(7*pi/4) = " << std::tan(7*pi/4) << '\n'; // -45°
     
        // special values
        [std::cout](../../io/cout.html) << "tan(+0) = " << std::tan(0.0) << '\n'
                  << "tan(-0) = " << std::tan(-0.0) << '\n';
     
        // error handling
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
     
        [std::cout](../../io/cout.html) << "tan(INFINITY) = " << std::tan([INFINITY](INFINITY.html)) << '\n';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tan&action=edit&section=6 "Edit section: See also")] See also
...
[ tan(std::valarray)](../valarray/tan.html "cpp/numeric/valarray/tan") |  applies the function **std::tan** to each element of valarray   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/numeric/valarray/dsc_tan&action=edit)  
[C documentation](../../../c/numeric/math/tan.html "c/numeric/math/tan") for tan
