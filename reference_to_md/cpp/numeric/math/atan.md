...
float atanf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
atan ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](atan.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double atan ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
## Contents
  ...
  * [3 Error handling](atan.html#Error_handling)
  * [4 Notes](atan.html#Notes)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/atan&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/atan&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/atan&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/atan&action=edit&section=4 "Edit section: Notes")] Notes

[POSIX specifies](https://pubs.opengroup.org/onlinepubs/9699919799/functions/atan.html) that in case of underflow, num is returned unmodified, and if that is not supported, an implementation-defined value no greater than [`DBL_MIN`](../../types/climits.html#Limits_of_floating-point_types "cpp/types/climits"), [FLT_MIN](../../types/climits.html "cpp/types/climits"), and [LDBL_MIN](../../types/climits.html "cpp/types/climits") is returned. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/atan&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "atan(1) = " << std::atan(1) << '\n'
                  << "4*atan(1) = " << 4 * std::atan(1) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "atan(Inf) = " << std::atan([INFINITY](INFINITY.html)) << '\n'
                  << "2*atan(Inf) = " << 2 * std::atan([INFINITY](INFINITY.html)) << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/atan&action=edit&section=6 "Edit section: See also")] See also
...
[ atan(std::valarray)](../valarray/atan.html "cpp/numeric/valarray/atan") |  applies the function **std::atan** to each element of valarray   
...
[C documentation](../../../c/numeric/math/atan.html "c/numeric/math/atan") for atan
