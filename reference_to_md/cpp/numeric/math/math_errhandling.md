...
---  
**math_errhandling MATH_ERRNOMATH_ERREXCEPT**(C++11)` `  
...
The value of `math_errhandling` indicates the type of error handling that is performed by the floating-point operators and [functions](../math.html "cpp/numeric/math"): 

Constant  |  Explanation   
---|---  
`MATH_ERREXCEPT` |  Indicates that floating-point exceptions are used: at least [FE_DIVBYZERO](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions"), [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions"), and [FE_OVERFLOW](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") are defined in [`<cfenv>`](../../header/cfenv.html "cpp/header/cfenv").   
`MATH_ERRNO` |  Indicates that floating-point operations use the variable [errno](../../error/errno.html "cpp/error/errno") to report errors.   
...
---|---|---|---|---  
Domain error  | The argument is outside the range in which the operation is mathematically defined (the description of [each function](../math.html "cpp/numeric/math") lists the required domain errors)  | [EDOM](../../error/errno_macros.html "cpp/error/errno macros") | [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") | [std::acos](acos.html)(2)  
Pole error  | The mathematical result of the function is exactly infinite or undefined  | [ERANGE](../../error/errno_macros.html "cpp/error/errno macros") | [FE_DIVBYZERO](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") | [std::log](log.html)(0.0), 1.0 / 0.0  
Range error due to overflow  | The mathematical result is finite, but becomes infinite after rounding, or becomes the largest representable finite value after rounding down  | [ERANGE](../../error/errno_macros.html "cpp/error/errno macros") | [FE_OVERFLOW](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") | [std::pow](pow.html)([DBL_MAX](../../types/climits.html), 2)  
...
Run this code
    ...
    int main()
    {
        ...
        if ([std::fetestexcept](../fenv/fetestexcept.html)([FE_DIVBYZERO](../fenv/FE_exceptions.html)))
            [std::cout](../../io/cout.html) << "FE_DIVBYZERO (pole error) reported\n";
    }
