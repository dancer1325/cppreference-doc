...
float hypotf( float x, float y ); |  (2) | (since C++11)   
(constexpr since C++26)  
long double hypotl( long double x, long double y ); |  (3) | (since C++11)   
(constexpr since C++26)  
| (4) |   
...
(constexpr since C++26)  
[Additional overloads](hypot.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Arithmetic1, Arithmetic2 >  
/*common-floating-point-type*/  
hypot ( Arithmetic1 x, Arithmetic2 y ); |  (A) | (since C++11)   
(constexpr since C++26)  
template< class Arithmetic1, Arithmetic2, Arithmetic3 >  
/*common-floating-point-type*/  
hypot ( Arithmetic1 x, Arithmetic2 y, Arithmetic3 z ); |  (B)  |  (since C++17)  
| |   
...
The value computed by the two-argument version of this function is the length of the hypotenuse of a right-angled triangle with sides of length x and y, or the distance of the point `(x,y)` from the origin `(0,0)`, or the magnitude of a complex number `x+_i_ y`. 
...
## Contents
  ...
  * [6 See also](hypot.html#See_also)
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * if one of the arguments is ±0, std::hypot(x, y) is equivalent to [std::fabs](fabs.html "cpp/numeric/math/fabs") called with the non-zero argument. 
...
std::hypot(x, y) is equivalent to std::abs([std::complex](../complex.html)<double>(x, y)). 
...
where /*common-floating-point-type*/ is the floating-point type with the greatest [floating-point conversion rank](../../language/usual_arithmetic_conversions.html#Floating-point_conversion_rank "cpp/language/usual arithmetic conversions") and greatest [floating-point conversion subrank](../../language/usual_arithmetic_conversions.html#Floating-point_conversion_subrank "cpp/language/usual arithmetic conversions") among the types of num1, num2 and num3, arguments of integer type are considered to have the same floating-point conversion rank as double. If no such floating-point type with the greatest rank and subrank exists, then [overload resolution](../../language/overload_resolution.html "cpp/language/overload resolution") does not result in a usable candidate from the overloads provided.  | (since C++23)  
...
Run this code
    ...
    {
        // typical usage
        [std::cout](../../io/cout.html) << "(1,1) cartesian is (" << std::hypot(1, 1)
                  << ',' << [std::atan2](atan2.html)(1,1) << ") polar\n";
     
        Point3D a{3.14, 2.71, 9.87}, b{1.14, 5.71, 3.87};
        // C++17 has 3-argument hypot overload:
        [std::cout](../../io/cout.html) << "distance(a,b) = "
                  << std::hypot(a.x - b.x, a.y - b.y, a.z - b.z) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "hypot(NAN,INFINITY) = " << std::hypot([NAN](NAN.html), [INFINITY](INFINITY.html)) << '\n';
     
        // error handling
        errno = 0;
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [std::cout](../../io/cout.html) << "hypot(DBL_MAX,DBL_MAX) = " << std::hypot([DBL_MAX](../../types/climits.html), [DBL_MAX](../../types/climits.html)) << '\n';
     
