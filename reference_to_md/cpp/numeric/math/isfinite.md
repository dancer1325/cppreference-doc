...
bool isfinite( long double num ); |  | (since C++11)   
(until C++23)  
...
isfinite ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](isfinite.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
bool isfinite( Integer num ); |  (A)  |  (since C++11)   
...
## Contents
  ...
  * [3 Notes](isfinite.html#Notes)
  * [4 Examples](isfinite.html#Examples)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/isfinite&action=edit&section=1 "Edit section: Examples")] Examples
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html)
                  << "isfinite(NaN) = " << std::isfinite([NAN](NAN.html)) << '\n'
                  << "isfinite(Inf) = " << std::isfinite([INFINITY](INFINITY.html)) << '\n'
                  << "isfinite(-Inf) = " << std::isfinite(-[INFINITY](INFINITY.html)) << '\n'
                  << "isfinite(HUGE_VAL) = " << std::isfinite([HUGE_VAL](HUGE_VAL.html)) << '\n'
                  << "isfinite(0.0) = " << std::isfinite(0.0) << '\n'
                  << "isfinite(exp(800)) = " << std::isfinite([std::exp](exp.html)(800)) << '\n'
                  << "isfinite(DBL_MIN/2.0) = " << std::isfinite([DBL_MIN](../../types/climits.html) / 2.0) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/isfinite&action=edit&section=2 "Edit section: See also")] See also
...
[C documentation](../../../c/numeric/math/isfinite.html "c/numeric/math/isfinite") for isfinite
