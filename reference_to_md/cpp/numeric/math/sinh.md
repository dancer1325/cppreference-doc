...
long double sinh ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
sinh ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float sinhf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
sinh ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](sinh.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double sinh ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sinh&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sinh&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sinh&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sinh&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sinh&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        const double x = 42;
     
        [std::cout](../../io/cout.html) << "sinh(1) = " << std::sinh(1) << '\n'
                  << "sinh(-1) = " << std::sinh(-1) << '\n'
                  << "log(sinh(" << x << ")+cosh(" << x << ")) = "
                  << [std::log](log.html)(std::sinh(x) + [std::cosh](cosh.html)(x)) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "sinh(+0) = " << std::sinh(0.0) << '\n'
                  << "sinh(-0) = " << std::sinh(-0.0) << '\n';
     
        // error handling
        errno = 0;
    ...
     
        [std::cout](../../io/cout.html) << "sinh(710.5) = " << std::sinh(710.5) << '\n';
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/sinh&action=edit&section=6 "Edit section: See also")] See also
...
[ sinh(std::valarray)](../valarray/sinh.html "cpp/numeric/valarray/sinh") |  applies the function **std::sinh** to each element of valarray   
...
[C documentation](../../../c/numeric/math/sinh.html "c/numeric/math/sinh") for sinh
