...
bool isnan( long double num ); |  | (since C++11)   
(until C++23)  
...
isnan ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](isnan.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
bool isnan( Integer num ); |  (A)  |  (since C++11)   
...
## Contents
  ...
  * [5 See also](isnan.html#See_also)
...
NaN values never compare equal to themselves or to other NaN values. Copying a NaN is not required, by IEEE-754, to preserve its bit representation (sign and [payload](nan.html "cpp/numeric/math/nan")), though most implementation do. 
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html)
                  << "isnan(NaN) = " << std::isnan([NAN](NAN.html)) << '\n'
                  << "isnan(Inf) = " << std::isnan([INFINITY](INFINITY.html)) << '\n'
                  << "isnan(0.0) = " << std::isnan(0.0) << '\n'
                  << "isnan(DBL_MIN/2.0) = " << std::isnan([DBL_MIN](../../types/climits.html) / 2.0) << '\n'
                  << "isnan(0.0 / 0.0)   = " << std::isnan(0.0 / 0.0) << '\n'
                  << "isnan(Inf - Inf)   = " << std::isnan([INFINITY](INFINITY.html) - [INFINITY](INFINITY.html)) << '\n';
    }
