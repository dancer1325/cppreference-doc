...
bool isinf( long double num ); |  | (since C++11)   
(until C++23)  
...
isinf ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](isinf.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
bool isinf( Integer num ); |  (A)  |  (since C++11)   
...
## Contents
  ...
  * [3 Notes](isinf.html#Notes)
  * [4 Example](isinf.html#Example)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/isinf&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        const double max = [std::numeric_limits](../../types/numeric_limits.html)<double>::max();
        const double inf = [std::numeric_limits](../../types/numeric_limits.html)<double>::infinity();
     
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html)
                  << "isinf(NaN) = " << std::isinf([NAN](NAN.html)) << '\n'
                  << "isinf(Inf) = " << std::isinf([INFINITY](INFINITY.html)) << '\n'
                  << "isinf(max) = " << std::isinf(max) << '\n'
                  << "isinf(inf) = " << std::isinf(inf) << '\n'
                  << "isinf(0.0) = " << std::isinf(0.0) << '\n'
                  << "isinf(exp(800)) = " << std::isinf([std::exp](exp.html)(800)) << '\n'
                  << "isinf(DBL_MIN/2.0) = " << std::isinf([DBL_MIN](../../types/climits.html) / 2.0) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/isinf&action=edit&section=2 "Edit section: See also")] See also
...
[C documentation](../../../c/numeric/math/isinf.html "c/numeric/math/isinf") for isinf
