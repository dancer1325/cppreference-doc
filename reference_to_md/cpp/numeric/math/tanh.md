...
long double tanh ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
tanh ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float tanhf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
long double tanhl( long double num ); |  (3) | (since C++11)   
(constexpr since C++26)  
...
tanh ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](tanh.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double tanh ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
## Contents
  ...
  * [3 Error handling](tanh.html#Error_handling)
  * [4 Notes](tanh.html#Notes)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tanh&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tanh&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tanh&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tanh&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tanh&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        [std::random_device](../random/random_device.html) rd;
        [std::mt19937](../random/mersenne_twister_engine.html) gen(rd());
        return [std::uniform_real_distribution](../random/uniform_real_distribution.html)<>(min, max)(gen);
    }
     
    int main()
    {
    ...
     
        [std::cout](../../io/cout.html) << [std::showpos](../../io/manip/showpos.html)
                  ...
                  << std::tanh(x) * [std::sinh](sinh.html)(2 * x) - [std::cosh](cosh.html)(2 * x) << '\n'
                  // special values:
                  << "tanh(+0) = " << std::tanh(+0.0) << '\n'
                  << "tanh(-0) = " << std::tanh(-0.0) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/tanh&action=edit&section=6 "Edit section: See also")] See also
...
[ tanh(std::valarray)](../valarray/tanh.html "cpp/numeric/valarray/tanh") |  applies the function **std::tanh** to each element of valarray   
...
[C documentation](../../../c/numeric/math/tanh.html "c/numeric/math/tanh") for tanh
