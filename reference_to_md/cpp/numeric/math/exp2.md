...
long double exp2 ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
exp2 ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float exp2f( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
exp2 ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](exp2.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double exp2 ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
## Contents
  ...
  * [4 Notes](exp2.html#Notes)
  * [5 Example](exp2.html#Example)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "exp2(4) = " << std::exp2(4) << '\n'
                  << "exp2(0.5) = " << std::exp2(0.5) << '\n'
                  << "exp2(-4) = " << std::exp2(-4) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "exp2(-0) = " << std::exp2(-0.0) << '\n'
                  << "exp2(-Inf) = " << std::exp2(-[INFINITY](INFINITY.html)) << '\n';
     
        // error handling
        errno = 0;
    ...
     
        [std::cout](../../io/cout.html) << "exp2(1024) = " << inf << '\n';
        if (is_range_error)
