...
long double atan2 ( long double y, long double x ); |  | (until C++23)  
/*floating-point-type*/  
...
atan2 ( const V0& v_y, const V1& v_x ); |  (S)  |  (since C++26)  
[Additional overloads](atan2.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double atan2 ( Integer y, Integer x ); |  (A) | (constexpr since C++26)  
| |   
...
[![math-atan2.png](https://upload.cppreference.com/mwiki/images/thumb/9/91/math-atan2.png/285px-math-atan2.png)](https://en.cppreference.com/w/File%253Amath-atan2.png.html)
...
Run this code
    ...
     
        // special values
        [std::cout](../../io/cout.html) << [std::noshowpos](../../io/manip/showpos.html)
                  << "atan2(0, 0) = " << atan2(0, 0) << '\n'
