...
---  
**FP_NORMAL FP_SUBNORMALFP_ZEROFP_INFINITEFP_NAN**(C++11)(C++11)(C++11)(C++11)(C++11)  
...
`FP_SUBNORMAL` |  indicates that the value is _subnormal_  
...
Run this code
    ...
    {
        switch ([std::fpclassify](fpclassify.html)(x))
        {
            case FP_INFINITE:
                return "Inf";
            case FP_NAN:
