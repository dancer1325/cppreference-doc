...
bool signbit( long double num ); |  | (since C++11)   
(until C++23)  
...
signbit ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](signbit.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
bool signbit( Integer num ); |  (A)  |  (since C++11)   
...
## Contents
  ...
  * [5 See also](signbit.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html)
                  ...
                  << "signbit(-0.0) = " << std::signbit(-0.0) << '\n'
                  << "signbit(+nan) = " << std::signbit(+[NAN](NAN.html)) << '\n'
                  << "signbit(-nan) = " << std::signbit(-[NAN](NAN.html)) << '\n'
                  << "signbit(+inf) = " << std::signbit(+[INFINITY](INFINITY.html)) << '\n'
                  << "signbit(-inf) = " << std::signbit(-[INFINITY](INFINITY.html)) << '\n';
    }
