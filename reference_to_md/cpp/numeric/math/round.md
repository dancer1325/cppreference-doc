...
**round lroundllround**(C++11)(C++11)(C++11)  
...
long double round ( long double num ); |  | (since C++11)   
(until C++23)  
constexpr /* floating-point-type */  
round ( /* floating-point-type */ num ); |  |  (since C++23)  
float roundf( float num ); |  (2) | (since C++11)   
(constexpr since C++23)  
long double roundl( long double num ); |  (3) | (since C++11)   
(constexpr since C++23)  
Rounding to long |  |   
| (4) |   
long lround ( float num );  
long lround ( double num );  
long lround ( long double num ); |  | (since C++11)   
(until C++23)  
constexpr long lround( /* floating-point-type */ num ); |  |  (since C++23)  
long lroundf( float num ); |  (5) | (since C++11)   
(constexpr since C++23)  
long lroundl( long double num ); |  (6) | (since C++11)   
(constexpr since C++23)  
Rounding to long long |  |   
| (7) |   
long long llround ( float num );  
long long llround ( double num );  
long long llround ( long double num ); |  | (since C++11)   
(until C++23)  
constexpr long long llround( /* floating-point-type */ num ); |  |  (since C++23)  
long long llroundf( float num ); |  (8) | (since C++11)   
(constexpr since C++23)  
long long llroundl( long double num ); |  (9) | (since C++11)   
(constexpr since C++23)  
[Additional overloads](round.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double round( Integer num ); |  (A) | (since C++11)   
(constexpr since C++23)  
template< class Integer >  
long lround( Integer num ); |  (B) | (since C++11)   
(constexpr since C++23)  
template< class Integer >  
long long llround( Integer num ); |  (C) | (since C++11)   
(constexpr since C++23)  
| |   
...
## Contents
  ...
  * [6 See also](round.html#See_also)
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * The current [rounding mode](../fenv/FE_round.html "cpp/numeric/fenv/FE round") has no effect. 
  ...
  * [FE_INEXACT](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is never raised. 
  * The current [rounding mode](../fenv/FE_round.html "cpp/numeric/fenv/FE round") has no effect. 
...
The largest representable floating-point values are exact integers in all standard floating-point formats, so `std::round` never overflows on its own; however the result may overflow any integer type (including [std::intmax_t](../../types/integer.html "cpp/types/integer")), when stored in an integer variable. 

[POSIX specifies](https://pubs.opengroup.org/onlinepubs/9699919799/functions/lround.html) that all cases where `std::lround` or `std::llround` raise [FE_INEXACT](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") are domain errors. 
...
The double version of `std::round` behaves as if implemented as follows: 
    ...
    {
        const int save_round = [std::fegetround](../fenv/feround.html)();
        [std::fesetround](../fenv/feround.html)([FE_TOWARDZERO](../fenv/FE_round.html));
        const double result = [std::rint](rint.html)([std::copysign](copysign.html)(0.5 + [std::fabs](fabs.html)(x), x));
        [std::fesetround](../fenv/feround.html)(save_round);
        return result;
    }
...
Run this code
    ...
    void test_custom_round()
    {
        for (const double x :
            {
                0.0, 0.3,
                0.5 - [DBL_EPSILON](../../types/climits.html) / 2,
                0.5,
                0.5 + [DBL_EPSILON](../../types/climits.html) / 2,
                0.7, 1.0, 2.3, 2.5, 2.7, 3.0,
                static_cast<double>([INFINITY](INFINITY.html))
            })
            [assert](../../error/assert.html)(round(+x) == custom_round(+x) && round(-x) == custom_round(-x));
    }
     
    int main()
    {
    ...
     
        // round
        [std::cout](../../io/cout.html) << "round(+2.3) = " << std::round(2.3)
                  ...
                  << "  round(-2.7) = " << std::round(-2.7) << '\n';
     
        [std::cout](../../io/cout.html) << "round(-0.0) = " << std::round(-0.0)  << '\n'
                  << "round(-Inf) = " << std::round(-[INFINITY](INFINITY.html)) << '\n';
     
        // lround
        [std::cout](../../io/cout.html) << "lround(+2.3) = " << std::lround(2.3)
                  ...
                  << "  lround(-2.7) = " << std::lround(-2.7) << '\n';
     
        [std::cout](../../io/cout.html) << "lround(-0.0) = " << std::lround(-0.0)  << '\n'
                  << "lround(-Inf) = " << std::lround(-[INFINITY](INFINITY.html)) << '\n';
     
        // error handling
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
     
        [std::cout](../../io/cout.html) << "std::lround(LONG_MAX+1.5) = "
                  << std::lround([LONG_MAX](../../types/climits.html) + 1.5) << '\n';
