...
long double copysign ( long double mag, long double sgn ); |  | (until C++23)  
constexpr /*floating-point-type*/  
copysign ( /*floating-point-type*/ mag,  
/*floating-point-type*/ sgn ); |  |  (since C++23)  
float copysignf( float mag, float sgn ); |  (2) | (since C++11)   
(constexpr since C++23)  
long double copysignl( long double mag, long double sgn ); |  (3) | (since C++11)   
(constexpr since C++23)  
...
copysign ( const V0& v_mag, const V1& v_sgn ); |  (S)  |  (since C++26)  
[Additional overloads](copysign.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double copysign ( Integer mag, Integer sgn ); |  (A) | (constexpr since C++23)  
| |   
...
## Contents
  ...
  * [1 Parameters](copysign.html#Parameters)
  * [2 Return value](copysign.html#Return_value)
  * [3 Error handling](copysign.html#Error_handling)
  * [4 Notes](copysign.html#Notes)
  * [5 Example](copysign.html#Example)
  * [6 See also](copysign.html#See_also)
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * The returned value is exact ([FE_INEXACT](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is never raised) and independent of the current [rounding mode](../fenv/FE_round.html "cpp/numeric/fenv/FE round"). 
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::showpos](../../io/manip/showpos.html)
                  ...
                  << "copysign(1.0,-2.0) = " << std::copysign(1.0, -2.0) << '\n'
                  << "copysign(inf,-2.0) = " << std::copysign([INFINITY](INFINITY.html), -2.0) << '\n'
                  << "copysign(NaN,-2.0) = " << std::copysign([NAN](NAN.html), -2.0) << '\n';
    }
