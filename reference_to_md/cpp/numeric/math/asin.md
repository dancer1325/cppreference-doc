...
long double asin ( long double num ); |  | (until C++23)  
/*floating-point-type*/  
asin ( /*floating-point-type*/ num ); |  |  (since C++23)   
(constexpr since C++26)  
float asinf( float num ); |  (2) | (since C++11)   
(constexpr since C++26)  
...
asin ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](asin.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double asin ( Integer num ); |  (A) | (constexpr since C++26)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "asin(1.0) = " << asin(1) << '\n'
                  << "2*asin(1.0) = " << 2 * asin(1) << '\n'
                  << "asin(-0.5) = " << asin(-0.5) << '\n'
                  << "6*asin(-0.5) =" << 6 * asin(-0.5) << '\n';
     
        // special values
        [std::cout](../../io/cout.html) << "asin(0.0) = " << asin(0) << " asin(-0.0)=" << asin(-0.0) << '\n';
     
        // error handling
        errno = 0;
        [std::feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
     
        [std::cout](../../io/cout.html) << "asin(1.1) = " << asin(1.1) << '\n';
     
