...
float truncf( float num ); |  (2) | (since C++11)   
...
trunc ( const V& v_num ); |  (S)  |  (since C++26)  
[Additional overloads](trunc.html#Notes) (since C++11) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
...
## Contents
  ...
  * [1 Parameters](trunc.html#Parameters)
  * [2 Return value](trunc.html#Return_value)
  * [3 Error handling](trunc.html#Error_handling)
  * [4 Notes](trunc.html#Notes)
  * [5 Example](trunc.html#Example)
  * [6 See also](trunc.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/trunc&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/trunc&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/trunc&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/trunc&action=edit&section=4 "Edit section: Notes")] Notes

[FE_INEXACT](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be (but isn't required to be) raised when truncating a non-integer finite value. 

The largest representable floating-point values are exact integers in all standard floating-point formats, so this function never overflows on its own; however the result may overflow any integer type (including [std::intmax_t](../../types/integer.html "cpp/types/integer")), when stored in an integer variable. 

The [implicit conversion](../../language/implicit_cast.html "cpp/language/implicit conversion") from floating-point to integral types also rounds towards zero, but is limited to the values that can be represented by the target type. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/trunc&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        const auto data = [std::initializer_list](../../utility/initializer_list.html)<double>
        {
            +2.7, -2.9, +0.7, -0.9, +0.0, 0.0, -[INFINITY](INFINITY.html), +[INFINITY](INFINITY.html), -[NAN](NAN.html), +[NAN](NAN.html)
        };
     
        [std::cout](../../io/cout.html) << [std::showpos](../../io/manip/showpos.html);
        for (double const x : data)
            [std::cout](../../io/cout.html) << "trunc(" << x << ") == " << std::trunc(x) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/trunc&action=edit&section=6 "Edit section: See also")] See also
...
[C documentation](../../../c/numeric/math/trunc.html "c/numeric/math/trunc") for trunc
