...
specialization [std::complex](../complex.html)<float> |  |   
| (1) |   
...
specialization [std::complex](../complex.html)<double> |  |   
| (1) |   
...
specialization [std::complex](../complex.html)<long double> |  |   
| (1) |   
...
## Contents
  ...
  * [1 Parameters](imag.html#Parameters)
  * [2 Return value](imag.html#Return_value)
  * [3 Notes](imag.html#Notes)
  * [4 Defect reports](imag.html#Defect_reports)
  * [5 See also](imag.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/imag&action=edit&section=1 "Edit section: Parameters")] Parameters

value  |  \-  |  the value to set the imaginary part to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/imag&action=edit&section=2 "Edit section: Return value")] Return value

1) The imaginary part of *this.

2) (none)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/imag&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/imag&action=edit&section=4 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 387](https://cplusplus.github.io/LWG/issue387) | C++98  | the imaginary part could not be set directly  | can be set directly via a new `imag` overload   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/imag&action=edit&section=5 "Edit section: See also")] See also
