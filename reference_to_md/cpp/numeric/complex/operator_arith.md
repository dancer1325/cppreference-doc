...
| (5) |   
template<class X>  
complex& operator+=( const [std::complex](../complex.html)<X>& other ); |  | (until C++20)  
template<class X>  
constexpr complex& operator+=( const [std::complex](../complex.html)<X>& other ); |  |  (since C++20)  
| (6) |   
template<class X>  
complex& operator-=( const [std::complex](../complex.html)<X>& other ); |  | (until C++20)  
template<class X>  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/operator_arith&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  a complex or scalar value of matching type (float, double, long double)   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/operator_arith&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/operator_arith&action=edit&section=3 "Edit section: See also")] See also
