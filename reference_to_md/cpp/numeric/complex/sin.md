...
## Contents
  ...
  * [4 Example](sin.html#Example)
  * [5 See also](sin.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::complex](../complex.html)<double> z(1.0, 0.0); // behaves like real sine along the real line
        [std::cout](../../io/cout.html) << "sin" << z << " = " << [std::sin](../math/sin.html)(z)
                  << " ( sin(1) = " << [std::sin](../math/sin.html)(1) << ")\n";
     
        [std::complex](../complex.html)<double> z2(0.0, 1.0); // behaves like sinh along the imaginary line
        [std::cout](../../io/cout.html) << "sin" << z2 << " = " << [std::sin](../math/sin.html)(z2)
