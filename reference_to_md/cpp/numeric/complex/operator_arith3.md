...
---|---|---  
template< class T >  
[std::complex](../complex.html)<T> operator+( const [std::complex](../complex.html)<T>& lhs,  
const [std::complex](../complex.html)<T>& rhs ); |  | (until C++20)  
template< class T >  
constexpr [std::complex](../complex.html)<T> operator+( const [std::complex](../complex.html)<T>& lhs,  
const [std::complex](../complex.html)<T>& rhs ); |  |  (since C++20)  
| (2) |   
template< class T >  
[std::complex](../complex.html)<T> operator+( const [std::complex](../complex.html)<T>& lhs,  
const T& rhs ); |  | (until C++20)  
template< class T >  
constexpr [std::complex](../complex.html)<T> operator+( const [std::complex](../complex.html)<T>& lhs,  
const T& rhs ); |  |  (since C++20)  
| (3) |   
template< class T >  
[std::complex](../complex.html)<T> operator+( const T& lhs,  
const [std::complex](../complex.html)<T>& rhs ); |  | (until C++20)  
template< class T >  
constexpr [std::complex](../complex.html)<T> operator+( const T& lhs,  
const [std::complex](../complex.html)<T>& rhs ); |  |  (since C++20)  
| (4) |   
template< class T >  
[std::complex](../complex.html)<T> operator-( const [std::complex](../complex.html)<T>& lhs,  
...
## Contents
  ...
  * [5 See also](operator_arith3.html#See_also)
...
4-6) [std::complex](../complex.html)<T>(lhs) -= rhs

7-9) [std::complex](../complex.html)<T>(lhs) *= rhs
...
Run this code
    ...
    int main()
    {
        [std::complex](../complex.html)<double> c2(2.0, 0.0);
        [std::complex](../complex.html)<double> ci(0.0, 1.0);
     
        [std::cout](../../io/cout.html) << ci << " + " << c2 << " = " << ci + c2 << '\n'
                  << ci << " * " << ci << " = " << ci * ci << '\n'
                  << ci << " + " << c2 << " / " << ci << " = " << ci + c2 / ci << '\n'
                  << 1  << " / " << ci << " = " << 1.0 / ci << '\n';
     
