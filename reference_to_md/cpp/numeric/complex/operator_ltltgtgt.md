...
operator<<( [std::basic_ostream](../../io/basic_ostream.html)<CharT, Traits>& os, const [std::complex](../complex.html)<T>& x ); |  (1)  |   
template< class T, class CharT, class Traits >  
[std::basic_istream](../../io/basic_istream.html)<CharT, Traits>&  
operator>>( [std::basic_istream](../../io/basic_istream.html)<CharT, Traits>& is, [std::complex](../complex.html)<T>& x ); |  (2)  |   
| |   
...
## Contents
  ...
  * [4 Notes](operator_ltltgtgt.html#Notes)
  * [5 Possible implementation](operator_ltltgtgt.html#Possible_implementation)
  * [6 Example](operator_ltltgtgt.html#Example)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::complex](../complex.html)<double> {3.14, 2.71} << '\n';
    }
