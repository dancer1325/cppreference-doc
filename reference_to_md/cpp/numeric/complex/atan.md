...
## Contents
  ...
  * [4 Example](atan.html#Example)
  * [5 See also](atan.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "atan" << z1 << " = " << [std::atan](../math/atan.html)(z1) << '\n';
     
        [std::complex](../complex.html)<double> z2(-0.0, 2.0);
        [std::cout](../../io/cout.html) << "atan" << z2 << " (the other side of the cut) = "
                  << [std::atan](../math/atan.html)(z2) << '\n';
     
        [std::complex](../complex.html)<double> z3(0.0, [INFINITY](../math/INFINITY.html));
        [std::cout](../../io/cout.html) << "2 * atan" << z3 << " = " << 2.0 * [std::atan](../math/atan.html)(z3) << '\n';
    }
