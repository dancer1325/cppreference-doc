...
## Contents
  ...
  * [4 Example](tan.html#Example)
  * [5 See also](tan.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::complex](../complex.html)<double> z(1.0, 0.0); // behaves like real tangent along the real line
        [std::cout](../../io/cout.html) << "tan" << z << " = " << [std::tan](../math/tan.html)(z)
                  << " ( tan(1) = " << [std::tan](../math/tan.html)(1) << ")\n";
     
        [std::complex](../complex.html)<double> z2(0.0, 1.0); // behaves like tanh along the imaginary line
        [std::cout](../../io/cout.html) << "tan" << z2 << " = " << [std::tan](../math/tan.html)(z2)
