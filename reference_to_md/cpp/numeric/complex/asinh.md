...
## Contents
  ...
  * [3 Error handling and special values](asinh.html#Error_handling_and_special_values)
  * [4 Notes](asinh.html#Notes)
  * [5 Example](asinh.html#Example)
  * [6 See also](asinh.html#See_also)
...
If the implementation supports IEEE floating-point arithmetic, 
  ...
  * [std::asinh](../math/asinh.html)([std::conj](conj.html)(z)) == [std::conj](conj.html)([std::asinh](../math/asinh.html)(z))
  * [std::asinh](../math/asinh.html)(-z) == -[std::asinh](../math/asinh.html)(z)
...
Run this code
    ...
    int main()
    {
        ...
        [std::complex](../complex.html)<double> z1(0.0, -2.0);
        [std::cout](../../io/cout.html) << "asinh" << z1 << " = " << [std::asinh](../math/asinh.html)(z1) << '\n';
     
        [std::complex](../complex.html)<double> z2(-0.0, -2);
        [std::cout](../../io/cout.html) << "asinh" << z2 << " (the other side of the cut) = "
                  << [std::asinh](../math/asinh.html)(z2) << '\n';
     
        // for any z, asinh(z) = asin(iz) / i
        [std::complex](../complex.html)<double> z3(1.0, 2.0);
        [std::complex](../complex.html)<double> i(0.0, 1.0);
        [std::cout](../../io/cout.html) << "asinh" << z3 << " = " << [std::asinh](../math/asinh.html)(z3) << '\n'
                  << "asin" << z3 * i << " / i = " << [std::asin](../math/asin.html)(z3 * i) / i << '\n';
    }
