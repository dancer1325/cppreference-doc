...
## Contents
  ...
  * [3 Error handling and special values](acos.html#Error_handling_and_special_values)
...
If the implementation supports IEEE floating-point arithmetic, 
  ...
  * [std::acos](../math/acos.html)([std::conj](conj.html)(z)) == [std::conj](conj.html)([std::acos](../math/acos.html)(z))
  * If z is `(±0,+0)`, the result is `(π/2,-0)`
  * If z is `(±0,NaN)`, the result is `(π/2,NaN)`
  * If z is `(x,+∞)` (for any finite x), the result is `(π/2,-∞)`
  * If z is `(x,NaN)` (for any nonzero finite x), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be raised. 
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "acos" << z1 << " = " << [std::acos](../math/acos.html)(z1) << '\n';
     
        [std::complex](../complex.html)<double> z2(-2.0, -0.0);
        [std::cout](../../io/cout.html) << "acos" << z2 << " (the other side of the cut) = "
                  << [std::acos](../math/acos.html)(z2) << '\n';
     
        // for any z, acos(z) = pi - acos(-z)
        const double pi = [std::acos](../math/acos.html)(-1);
        [std::complex](../complex.html)<double> z3 = pi - [std::acos](../math/acos.html)(z2);
        [std::cout](../../io/cout.html) << "cos(pi - acos" << z2 << ") = " << [std::cos](../math/cos.html)(z3) << '\n';
    }
