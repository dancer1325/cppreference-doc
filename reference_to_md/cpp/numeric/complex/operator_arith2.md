...
---|---|---  
template< class T >  
[std::complex](../complex.html)<T> operator+( const [std::complex](../complex.html)<T>& val ); |  | (until C++20)  
template< class T >  
constexpr [std::complex](../complex.html)<T> operator+( const [std::complex](../complex.html)<T>& val ); |  |  (since C++20)  
| (2) |   
template< class T >  
[std::complex](../complex.html)<T> operator-( const [std::complex](../complex.html)<T>& val ); |  | (until C++20)  
template< class T >  
