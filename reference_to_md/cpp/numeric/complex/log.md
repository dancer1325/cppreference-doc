...
---|---|---  
template< class T >  
[std::complex](../complex.html)<T> log( const [std::complex](../complex.html)<T>& z ); |  |   
| |   
  
Computes complex [natural (base _e_) logarithm](https://en.wikipedia.org/wiki/Natural_logarithm "enwiki:Natural logarithm") of a complex value z with a branch cut along the negative real axis. 

## Contents

  * [1 Parameters](log.html#Parameters)
  * [2 Return value](log.html#Return_value)
  * [3 Error handling and special values](log.html#Error_handling_and_special_values)
  * [4 Notes](log.html#Notes)
  * [5 Example](log.html#Example)
  * [6 Defect reports](log.html#Defect_reports)
  * [7 See also](log.html#See_also)
...
If the implementation supports IEEE floating-point arithmetic, 
  ...
  * [std::log](../math/log.html)([std::conj](conj.html)(z)) == [std::conj](conj.html)([std::log](../math/log.html)(z))
  * If z is `(-0,+0)`, the result is `(-∞,π)` and [FE_DIVBYZERO](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised 
  * If z is `(+0,+0)`, the result is `(-∞,+0)` and [FE_DIVBYZERO](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised 
  * If z is `(x,+∞)` (for any finite x), the result is `(+∞,π/2)`
  * If z is `(x,NaN)` (for any finite x), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be raised 
  * If z is `(-∞,y)` (for any finite positive y), the result is `(+∞,π)`
  * If z is `(+∞,y)` (for any finite positive y), the result is `(+∞,+0)`
  * If z is `(-∞,+∞)`, the result is `(+∞,3π/4)`
  * If z is `(+∞,+∞)`, the result is `(+∞,π/4)`
  * If z is `(±∞,NaN)`, the result is `(+∞,NaN)`
  * If z is `(NaN,y)` (for any finite y), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be raised 
  * If z is `(NaN,+∞)`, the result is `(+∞,NaN)`
...
Run this code
    ...
    int main()
    {
        [std::complex](../complex.html)<double> z {0.0, 1.0}; // r = 1, θ = pi / 2
        [std::cout](../../io/cout.html) << "2 * log" << z << " = " << 2.0 * [std::log](../math/log.html)(z) << '\n';
     
        [std::complex](../complex.html)<double> z2 {sqrt(2.0) / 2, sqrt(2.0) / 2}; // r = 1, θ = pi / 4
        [std::cout](../../io/cout.html) << "4 * log" << z2 << " = " << 4.0 * [std::log](../math/log.html)(z2) << '\n';
     
        [std::complex](../complex.html)<double> z3 {-1.0, 0.0}; // r = 1, θ = pi
        [std::cout](../../io/cout.html) << "log" << z3 << " = " << [std::log](../math/log.html)(z3) << '\n';
        [std::complex](../complex.html)<double> z4 {-1.0, -0.0}; // the other side of the cut
        [std::cout](../../io/cout.html) << "log" << z4 << " (the other side of the cut) = " << [std::log](../math/log.html)(z4) << '\n';
    }
