...
**operator""i operator""ifoperator""il**(C++14)(C++14)(C++14)  
...
constexpr complex<double> operator""i( unsigned long long arg ); |  (1) | (since C++14)  
constexpr complex<float> operator""if( long double arg );  
constexpr complex<float> operator""if( unsigned long long arg ); |  (2) | (since C++14)  
constexpr complex<long double> operator""il( long double arg );  
constexpr complex<long double> operator""il( unsigned long long arg ); |  (3) | (since C++14)  
| |   
  
Forms a [std::complex](../complex.html "cpp/numeric/complex") literal representing an imaginary number. 

1) Forms a literal [std::complex](../complex.html)<double> with the real part zero and imaginary part arg.

2) Forms a literal [std::complex](../complex.html)<float> with the real part zero and imaginary part arg.

3) Forms a literal [std::complex](../complex.html)<long double> with the real part zero and imaginary part arg.

## Contents

  * [1 Parameters](operator""i.html#Parameters)
  * [2 Return value](operator""i.html#Return_value)
  * [3 Notes](operator""i.html#Notes)
  * [4 Possible implementation](operator""i.html#Possible_implementation)
  * [5 Example](operator""i.html#Example)
  * [6 See also](operator""i.html#See_also)
...
Even though if is a [keyword](../../keywords/if.html "cpp/keywords/if") in C++, it is a ud-suffix of the [literal operator](../../language/user_literal.html "cpp/language/user literal") of the form operator ""if and in the literal expressions such as 1if or 1.0if because it is not separated by whitespace and is not a standalone token. 
...
---  
    ...
    constexpr [std::complex](../complex.html)<double> operator""i(unsigned long long d)
    {
        return [std::complex](../complex.html)<double> {0.0, static_cast<double>(d)};
    }
     
    constexpr [std::complex](../complex.html)<double> operator""i(long double d)
    {
        return [std::complex](../complex.html)<double> {0.0, static_cast<double>(d)};
    }  
  
[operator""if](operator""i.html#Version_2)  
      
    
    constexpr [std::complex](../complex.html)<float> operator""if(unsigned long long d)
    {
        return [std::complex](../complex.html)<float> {0.0f, static_cast<float>(d)};
    }
     
    constexpr [std::complex](../complex.html)<float> operator""if(long double d)
    {
        return [std::complex](../complex.html)<float> {0.0f, static_cast<float>(d)};
    }  
  
[operator""il](operator""i.html#Version_3)  
      
    
    constexpr [std::complex](../complex.html)<long double> operator""il(unsigned long long d)
    {
        return [std::complex](../complex.html)<long double> {0.0L, static_cast<long double>(d)};
    }
     
    constexpr [std::complex](../complex.html)<long double> operator""il(long double d)
    {
...
Run this code
    ...
     
        [std::complex](../complex.html)<double> c = 1.0 + 1i;
        [std::cout](../../io/cout.html) << "abs" << c << " = " << std::abs(c) << '\n';
     
        [std::complex](../complex.html)<float> z = 3.0f + 4.0if;
        [std::cout](../../io/cout.html) << "abs" << z << " = " << std::abs(z) << '\n';
    }
