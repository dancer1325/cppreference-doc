...
## Contents
  ...
  * [3 Example](abs.html#Example)
  * [4 See also](abs.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::complex](../complex.html)<double> z(1, 1);
        [std::cout](../../io/cout.html) << z << " cartesian is rho = " << std::abs(z)
                  << " theta = " << [std::arg](arg.html)(z) << " polar\n";
    }
