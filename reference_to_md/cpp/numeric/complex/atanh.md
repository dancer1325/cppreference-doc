...
## Contents
  ...
  * [3 Error handling and special values](atanh.html#Error_handling_and_special_values)
...
If the implementation supports IEEE floating-point arithmetic, 
  ...
  * [std::atanh](../math/atanh.html)([std::conj](conj.html)(z)) == [std::conj](conj.html)([std::atanh](../math/atanh.html)(z))
  * [std::atanh](../math/atanh.html)(-z) == -[std::atanh](../math/atanh.html)(z)
  * If z is `(+0,+0)`, the result is `(+0,+0)`
  * If z is `(+0,NaN)`, the result is `(+0,NaN)`
  * If z is `(+1,+0)`, the result is `(+∞,+0)` and [FE_DIVBYZERO](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised 
  * If z is `(x,+∞)` (for any finite positive x), the result is `(+0,π/2)`
  * If z is `(x,NaN)` (for any finite nonzero x), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be raised 
...
Run this code
    ...
    int main()
    {
        ...
        [std::complex](../complex.html)<double> z1(2.0, 0.0);
        [std::cout](../../io/cout.html) << "atanh" << z1 << " = " << [std::atanh](../math/atanh.html)(z1) << '\n';
     
        [std::complex](../complex.html)<double> z2(2.0, -0.0);
        [std::cout](../../io/cout.html) << "atanh" << z2 << " (the other side of the cut) = "
                  << [std::atanh](../math/atanh.html)(z2) << '\n';
     
        // for any z, atanh(z) = atanh(iz) / i
        [std::complex](../complex.html)<double> z3(1.0, 2.0);
        [std::complex](../complex.html)<double> i(0.0, 1.0);
        [std::cout](../../io/cout.html) << "atanh" << z3 << " = " << [std::atanh](../math/atanh.html)(z3) << '\n'
                  << "atan" << z3 * i << " / i = " << [std::atan](../math/atan.html)(z3 * i) / i << '\n';
    }
