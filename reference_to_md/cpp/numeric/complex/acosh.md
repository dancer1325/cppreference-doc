...
## Contents
  ...
  * [3 Error handling and special values](acosh.html#Error_handling_and_special_values)
...
If the implementation supports IEEE floating-point arithmetic, 
  ...
  * [std::acosh](../math/acosh.html)([std::conj](conj.html)(z)) == [std::conj](conj.html)([std::acosh](../math/acosh.html)(z)). 
  * If z is `(±0,+0)`, the result is `(+0,π/2)`. 
  * If z is `(x,+∞)` (for any finite x), the result is `(+∞,π/2)`. 
  * If z is `(x,NaN)` (for any[[1]](acosh.html#cite_note-1) finite x), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be raised. 
  ...
  * If z is `(NaN,NaN)`, the result is `(NaN,NaN)`. 
  ...
  1. [↑](acosh.html#cite_ref-1) per [C11 DR471](https://open-std.org/JTC1/SC22/WG14/www/docs/n1892.htm#dr_471), this holds for non-zero x only. If z is `(0,NaN)`, the result should be `(NaN,π/2)`.
...
Run this code
    ...
    int main()
    {
        ...
        [std::complex](../complex.html)<double> z1(0.5, 0);
        [std::cout](../../io/cout.html) << "acosh" << z1 << " = " << [std::acosh](../math/acosh.html)(z1) << '\n';
     
        [std::complex](../complex.html)<double> z2(0.5, -0.0);
        [std::cout](../../io/cout.html) << "acosh" << z2 << " (the other side of the cut) = "
                  << [std::acosh](../math/acosh.html)(z2) << '\n';
     
        // in upper half-plane, acosh = i acos 
        [std::complex](../complex.html)<double> z3(1, 1), i(0, 1);
        [std::cout](../../io/cout.html) << "acosh" << z3 << " = " << [std::acosh](../math/acosh.html)(z3) << '\n'
                  << "i*acos" << z3 << " = " << i*[std::acos](../math/acos.html)(z3) << '\n';
    }
