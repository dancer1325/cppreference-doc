...
(until C++23)  
template< class X >  
constexpr explicit(/* see below */) complex( const complex<X>& other ); |  |  (since C++23)  
Standard explicit specialization [std::complex](../complex.html)<float> (until C++23) |  |   
| (1) |   
...
constexpr explicit complex( const complex<long double>& other ); |  |  (since C++11)  
Standard explicit specialization [std::complex](../complex.html)<double> (until C++23) |  |   
| (1) |   
...
constexpr explicit complex( const complex<long double>& other ); |  |  (since C++11)  
Standard explicit specialization [std::complex](../complex.html)<long double> (until C++23) |  |   
| (1) |   
...
Constructs the [std::complex](../complex.html) object. The standard explicit specializations ([std::complex](../complex.html)<float>, [std::complex](../complex.html)<double> and [std::complex](../complex.html)<long double>) have different constructor declarations from the main template.(until C++23)
