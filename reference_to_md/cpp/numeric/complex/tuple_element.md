...
struct tuple_element<I, [std::complex](../complex.html)<T>>; |  |  (since C++26)  
| |   
  
The partial specializations of [`std::tuple_element`](../../utility/tuple_element.html "cpp/utility/tuple element") for [std::complex](../complex.html "cpp/numeric/complex") provide compile-time access to the underlying real and imaginary number type of a `complex`, using tuple-like syntax. They are provided for structured binding support. The program is ill-formed if I >= 2. 

## Contents

  * [1 Member types](tuple_element.html#Member_types)
  * [2 Notes](tuple_element.html#Notes)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/tuple_element&action=edit&section=1 "Edit section: Member types")] Member types

Member type  |  Definition   
---|---  
`type` |  `T`  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/tuple_element&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/tuple_element&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    #include <type_traits>
     
    static_assert([z = [std::complex](../complex.html)<float>()]
    {
        using T = decltype(z);
        return
    #if __cpp_lib_tuple_like >= 202311L
            [std::is_same_v](../../types/is_same.html)<[std::tuple_element_t](../../utility/tuple_element.html)<0, T>, float> &&
            [std::is_same_v](../../types/is_same.html)<[std::tuple_element_t](../../utility/tuple_element.html)<1, T>, float> &&
    #endif
            [std::is_same_v](../../types/is_same.html)<T::value_type, float>;
    }());
     
    int main() {}

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/complex/tuple_element&action=edit&section=4 "Edit section: See also")] See also
...
[ std::tuple_size<std::complex>](tuple_size.html "cpp/numeric/complex/tuple size")(C++26) |  obtains the size of a [std::complex](../complex.html "cpp/numeric/complex")   
