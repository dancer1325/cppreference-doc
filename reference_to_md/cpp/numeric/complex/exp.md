...
---|---|---  
template< class T >   
[std::complex](../complex.html)<T> exp( const [std::complex](../complex.html)<T>& z ); |  |   
| |   
  
Compute base-e exponential of z, that is _e_ (Euler's number, `2.7182818`) raised to the z power. 

## Contents

  * [1 Parameters](exp.html#Parameters)
  * [2 Return value](exp.html#Return_value)
  * [3 Error handling and special values](exp.html#Error_handling_and_special_values)
...
If the implementation supports IEEE floating-point arithmetic, 
  ...
  * [std::exp](../math/exp.html)([std::conj](conj.html)(z)) == [std::conj](conj.html)([std::exp](../math/exp.html)(z))
  * If z is `(±0,+0)`, the result is `(1,+0)`
  * If z is `(x,+∞)` (for any finite x), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised. 
  ...
  * If z is `(+∞,+∞)`, the result is `(±∞,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised (the sign of the real part is unspecified) 
  * If z is `(-∞,NaN)`, the result is `(±0,±0)` (signs are unspecified) 
  * If z is `(+∞,NaN)`, the result is `(±∞,NaN)` (the sign of the real part is unspecified) 
  * If z is `(NaN,+0)`, the result is `(NaN,+0)`
  * If z is `(NaN,y)` (for any nonzero y), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be raised 
...
The following have equivalent results when the real part is 0: 
  ...
  * [std::exp](../math/exp.html)([std::complex](../complex.html)<float>(0, theta))
  * [std::complex](../complex.html)<float>(cosf(theta), sinf(theta))
  * [std::polar](polar.html)(1.f, theta)
...
Run this code
    ...
    int main()
    {
       const double pi = [std::acos](../math/acos.html)(-1.0);
       const [std::complex](../complex.html)<double> i(0.0, 1.0);
     
       [std::cout](../../io/cout.html) << [std::fixed](../../io/manip/fixed.html) << " exp(i * pi) = " << [std::exp](../math/exp.html)(i * pi) << '\n';
    }
