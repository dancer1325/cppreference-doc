...
friend constexpr T& get( [std::complex](../complex.html)<T>& x ); |  (1)  |  (since C++26)  
template< [std::size_t](../../types/size_t.html) I >  
friend constexpr const T& get( const [std::complex](../complex.html)<T>& x ); |  (2)  |  (since C++26)  
template< [std::size_t](../../types/size_t.html) I >  
friend constexpr T&& get( [std::complex](../complex.html)<T>&& x ); |  (3)  |  (since C++26)  
template< [std::size_t](../../types/size_t.html) I >  
friend constexpr const T&& get( const [std::complex](../complex.html)<T>&& x ); |  (4)  |  (since C++26)  
| |   
...
Run this code
    ...
    #include <complex>
     
    static_assert([z = [std::complex](../complex.html)(1.0, 2.0)]
    {
