...
---|---|---  
template< class T >  
[std::complex](../complex.html)<T> asin( const [std::complex](../complex.html)<T>& z ); |  |  (since C++11)  
| |   
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "asin" << z1 << " = " << [std::asin](../math/asin.html)(z1) << '\n';
     
        [std::complex](../complex.html)<double> z2(-2.0, -0.0);
        [std::cout](../../io/cout.html) << "asin" << z2 << " (the other side of the cut) = "
                  << [std::asin](../math/asin.html)(z2) << '\n';
     
        // for any z, asin(z) = acos(−z) − pi / 2
        const double pi = [std::acos](../math/acos.html)(-1);
        [std::complex](../complex.html)<double> z3 = [std::acos](../math/acos.html)(z2) - pi / 2;
        [std::cout](../../io/cout.html) << "sin(acos" << z2 << " - pi / 2) = " << [std::sin](../math/sin.html)(z3) << '\n';
    }
