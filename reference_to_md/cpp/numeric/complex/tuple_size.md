...
---|---|---  
template< class T >  
struct tuple_size<[std::complex](../complex.html)<T>>  
: [std::integral_constant](../../types/integral_constant.html)<[std::size_t](../../types/size_t.html), 2> {}; |  |  (since C++26)  
| |   
  
The partial specialization of [`std::tuple_size`](../../utility/tuple_size.html "cpp/utility/tuple size") for [std::complex](../complex.html "cpp/numeric/complex") provides a compile-time way to obtain the number of components of a `complex`, which is always 2, using tuple-like syntax. It is provided for structured binding support. 
...
## Contents
  ...
  * [1 Inherited from std::integral_constant](tuple_size.html#Inherited_from_std::integral_constant)
    ...
    * [1.4 Notes](tuple_size.html#Notes)
    * [1.5 Example](tuple_size.html#Example)
...
Run this code
    ...
    #include <complex>
     
    static_assert([std::tuple_size_v](../../utility/tuple_size.html)<[std::complex](../complex.html)<float>> == 2);
     
    static_assert([]
    {
    ...
    {
        using namespace std::literals;
        auto z = [std::complex](../complex.html)<double>{};
        auto& [re, im] = z;
        re = 1.0;
        im = 2.0;
        return z == 1.0 + 2.0i;
