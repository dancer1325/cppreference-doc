...
## Contents
  ...
  * [3 Error handling and special values](cosh.html#Error_handling_and_special_values)
  * [4 Notes](cosh.html#Notes)
  * [5 Examples](cosh.html#Examples)
...
If the implementation supports IEEE floating-point arithmetic, 
  ...
  * [std::cosh](../math/cosh.html)([std::conj](conj.html)(z)) == [std::conj](conj.html)([std::cosh](../math/cosh.html)(z))
  * [std::cosh](../math/cosh.html)(z) == [std::cosh](../math/cosh.html)(-z)
  * If z is `(+0,+0)`, the result is `(1,+0)`
  * If z is `(+0,+∞)`, the result is `(NaN,±0)` (the sign of the imaginary part is unspecified) and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised 
  * If z is `(+0,NaN)`, the result is `(NaN,±0)` (the sign of the imaginary part is unspecified) 
  * If z is `(x,+∞)` (for any finite non-zero x), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") is raised 
  * If z is `(x,NaN)` (for any finite non-zero x), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be raised 
  ...
  * If z is `(NaN,+y)` (for any finite non-zero y), the result is `(NaN,NaN)` and [FE_INVALID](../fenv/FE_exceptions.html "cpp/numeric/fenv/FE exceptions") may be raised 
...
Run this code
    ...
    {   
        ...
        [std::complex](../complex.html)<double> z(1.0, 0.0); // behaves like real cosh along the real line
        [std::cout](../../io/cout.html) << "cosh" << z << " = " << [std::cosh](../math/cosh.html)(z)
                  << " (cosh(1) = " << [std::cosh](../math/cosh.html)(1) << ")\n";
     
        [std::complex](../complex.html)<double> z2(0.0, 1.0); // behaves like real cosine along the imaginary line
        [std::cout](../../io/cout.html) << "cosh" << z2 << " = " << [std::cosh](../math/cosh.html)(z2)
                  << " ( cos(1) = " << [std::cos](../math/cos.html)(1) << ")\n";
    }
