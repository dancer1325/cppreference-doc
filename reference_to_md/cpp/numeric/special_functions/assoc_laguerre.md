...
long double assoc_laguerre ( unsigned int n, unsigned int m, long double x ); |  | (since C++17)   
(until C++23)  
...
[Additional overloads](assoc_laguerre.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double assoc_laguerre ( unsigned int n, unsigned int m, Integer x ); |  (A)  |  (since C++17)  
| |   
...
Run this code
    ...
    {
        // spot-checks
        [std::cout](../../io/cout.html) << std::assoc_laguerre(1, 10, 0.5) << '=' << L1(10, 0.5) << '\n'
