...
long double riemann_zeta ( long double num ); |  | (since C++17)   
(until C++23)  
...
[Additional overloads](riemann_zeta.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double riemann_zeta ( Integer num ); |  (A)  |  (since C++17)  
| |   
  
1-3) Computes the [Riemann zeta function](https://en.wikipedia.org/wiki/Riemann_zeta_function "enwiki:Riemann zeta function") of num. The library provides overloads of `std::riemann_zeta` for all cv-unqualified floating-point types as the type of the parameter num.(since C++23)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/riemann_zeta&action=edit&section=1 "Edit section: Parameters")] Parameters

num  |  \-  |  floating-point or value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/riemann_zeta&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/riemann_zeta&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/riemann_zeta&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/riemann_zeta&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr auto π = [std::numbers::pi](../constants.html);
     
        // spot checks for well-known values
        for (const double x : {-1.0, 0.0, 1.0, 0.5, 2.0})
            [std::cout](../../io/cout.html) << [std::format](../../utility/format/format.html)("ζ({})\t= {:+.5f}\n", x, std::riemann_zeta(x));
        [std::cout](../../io/cout.html) << [std::format](../../utility/format/format.html)("π²/6\t= {:+.5f}\n", π * π / 6);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/riemann_zeta&action=edit&section=6 "Edit section: External links")] External links
