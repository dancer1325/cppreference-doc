...
long double hermite ( unsigned int n, long double x ); |  | (since C++17)   
(until C++23)  
...
[Additional overloads](hermite.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double hermite ( unsigned int n, Integer x ); |  (A)  |  (since C++17)  
| |   
  
1-3) Computes the (physicist's) [Hermite polynomials](https://en.wikipedia.org/wiki/Hermite_polynomials "enwiki:Hermite polynomials") of the degree n and argument x. The library provides overloads of `std::hermite` for all cv-unqualified floating-point types as the type of the parameter x.(since C++23)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/hermite&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  the degree of the polynomial   
---|---|---  
x  |  \-  |  the argument, a floating-point or integer value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/hermite&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/hermite&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/hermite&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/hermite&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    double H3(double x)
    {
        return 8 * [std::pow](../math/pow.html)(x, 3) - 12 * x;
    }
     
    double H4(double x)
    {
        return 16 * [std::pow](../math/pow.html)(x, 4) - 48 * x * x + 12;
    }
     
    int main()
    {
        // spot-checks
        [std::cout](../../io/cout.html) << std::hermite(3, 10) << '=' << H3(10) << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/hermite&action=edit&section=6 "Edit section: See also")] See also
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/hermite&action=edit&section=7 "Edit section: External links")] External links
