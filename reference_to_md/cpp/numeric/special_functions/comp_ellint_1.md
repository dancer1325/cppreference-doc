...
long double comp_ellint_1 ( long double k ); |  | (since C++17)   
(until C++23)  
...
[Additional overloads](comp_ellint_1.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double comp_ellint_1 ( Integer k ); |  (A)  |  (since C++17)  
| |   
  
1-3) Computes the [complete elliptic integral of the first kind](https://en.wikipedia.org/wiki/Elliptic_integral#Complete_elliptic_integral_of_the_first_kind "enwiki:Elliptic integral") of k. The library provides overloads of `std::comp_ellint_1` for all cv-unqualified floating-point types as the type of the parameter k.(since C++23)
...
## Contents
  ...
  * [6 See also](comp_ellint_1.html#See_also)
  * [7 External links](comp_ellint_1.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/comp_ellint_1&action=edit&section=1 "Edit section: Parameters")] Parameters

k  |  \-  |  elliptic modulus or eccentricity (a floating-point or integer value)   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/comp_ellint_1&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, value of the complete elliptic integral of the first kind of k, that is [std::ellint_1](ellint_1.html)(k, π/2), is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/comp_ellint_1&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/comp_ellint_1&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/comp_ellint_1&action=edit&section=5 "Edit section: Example")] Example

The [period of a pendulum](https://en.wikipedia.org/wiki/Pendulum_\(mechanics\)#Arbitrary-amplitude_period "enwiki:Pendulum \(mechanics\)") of length l, given acceleration due to gravity g, and initial angle θ equals 4⋅√l/g⋅K(sin(θ/2)), where K is `std::comp_ellint_1`.
...
Run this code
    ...
    int main()
    {
        constexpr double π{[std::numbers::pi](../constants.html)};
     
        [std::cout](../../io/cout.html) << "K(0) ≈ " << std::comp_ellint_1(0) << '\n'
                  << "π/2 ≈ " << π / 2 << '\n'
                  << "K(0.5) ≈ " << std::comp_ellint_1(0.5) << '\n'
                  << "F(0.5, π/2) ≈ " << [std::ellint_1](ellint_1.html)(0.5, π / 2) << '\n'
                  << "The period of a pendulum length 1m at 10° initial angle ≈ "
                  << 4 * [std::sqrt](../math/sqrt.html)(1 / 9.80665) * std::comp_ellint_1([std::sin](../math/sin.html)(π / 18 / 2))
                  << "s,\n" "whereas the linear approximation gives ≈ "
                  << 2 * π * [std::sqrt](../math/sqrt.html)(1 / 9.80665) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/comp_ellint_1&action=edit&section=6 "Edit section: See also")] See also

[ ellint_1ellint_1fellint_1l](ellint_1.html "cpp/numeric/special functions/ellint 1")(C++17)(C++17)(C++17) |  (incomplete) elliptic integral of the first kind   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/comp_ellint_1&action=edit&section=7 "Edit section: External links")] External links
