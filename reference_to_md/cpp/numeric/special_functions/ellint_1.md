...
long double ellint_1 ( long double k, long double phi ); |  | (since C++17)   
(until C++23)  
/* floating-point-type */ ellint_1( /* floating-point-type */ k,  
/* floating-point-type */ phi ); |  |  (since C++23)  
float ellint_1f( float k, float phi ); |  (2)  |  (since C++17)  
long double ellint_1l( long double k, long double phi ); |  (3)  |  (since C++17)  
[Additional overloads](ellint_1.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Arithmetic1, class Arithmetic2 >  
/* common-floating-point-type */  
ellint_1( Arithmetic1 k, Arithmetic2 phi ); |  (A)  |  (since C++17)  
| |   
  
1-3) Computes the [incomplete elliptic integral of the first kind](https://en.wikipedia.org/wiki/Elliptic_integral#Elliptic_integral_of_the_first_kind "enwiki:Elliptic integral") of k and phi. The library provides overloads of `std::ellint_1` for all cv-unqualified floating-point types as the type of the parameters k and phi.(since C++23)

A) Additional overloads are provided for all other combinations of arithmetic types.

## Contents

  * [1 Parameters](ellint_1.html#Parameters)
  * [2 Return value](ellint_1.html#Return_value)
  * [3 Error handling](ellint_1.html#Error_handling)
  * [4 Notes](ellint_1.html#Notes)
  * [5 Example](ellint_1.html#Example)
  * [6 See also](ellint_1.html#See_also)
  * [7 External links](ellint_1.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_1&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_1&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_1&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_1&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_1&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        const double hpi = [std::numbers::pi](../constants.html) / 2.0;
     
        [std::cout](../../io/cout.html) << "F(0,π/2)  = " << std::ellint_1(0, hpi) << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_1&action=edit&section=6 "Edit section: See also")] See also

[ comp_ellint_1comp_ellint_1fcomp_ellint_1l](comp_ellint_1.html "cpp/numeric/special functions/comp ellint 1")(C++17)(C++17)(C++17) |  (complete) elliptic integral of the first kind   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_1&action=edit&section=7 "Edit section: External links")] External links

[Weisstein, Eric W. "Elliptic Integral of the First Kind."](https://mathworld.wolfram.com/EllipticIntegraloftheFirstKind.html) From MathWorld — A Wolfram Web Resource.   
---
