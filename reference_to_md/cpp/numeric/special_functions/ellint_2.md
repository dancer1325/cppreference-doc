...
long double ellint_2 ( long double k, long double phi ); |  | (since C++17)   
(until C++23)  
...
[Additional overloads](ellint_2.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Arithmetic1, class Arithmetic2 >  
/* common-floating-point-type */  
ellint_2( Arithmetic1 k, Arithmetic2 phi ); |  (A)  |  (since C++17)  
| |   
  
1-3) Computes the [incomplete elliptic integral of the second kind](https://en.wikipedia.org/wiki/Elliptic_integral#Incomplete_elliptic_integral_of_the_second_kind "enwiki:Elliptic integral") of k and phi. The library provides overloads of `std::ellint_2` for all cv-unqualified floating-point types as the type of the parameters k and phi.(since C++23)

A) Additional overloads are provided for all other combinations of arithmetic types.

## Contents

  * [1 Parameters](ellint_2.html#Parameters)
  * [2 Return value](ellint_2.html#Return_value)
  * [3 Error handling](ellint_2.html#Error_handling)
  * [4 Notes](ellint_2.html#Notes)
  * [5 Example](ellint_2.html#Example)
  * [6 See also](ellint_2.html#See_also)
  * [7 External links](ellint_2.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_2&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_2&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_2&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_2&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_2&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << "E(0,π/2)  = " << std::ellint_2(0, hpi) << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_2&action=edit&section=6 "Edit section: See also")] See also

[ comp_ellint_2comp_ellint_2fcomp_ellint_2l](comp_ellint_2.html "cpp/numeric/special functions/comp ellint 2")(C++17)(C++17)(C++17) |  (complete) elliptic integral of the second kind   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/ellint_2&action=edit&section=7 "Edit section: External links")] External links
