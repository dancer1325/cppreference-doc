...
**sph_bessel sph_besselfsph_bessell**  
...
long double sph_bessel ( unsigned int n, long double x ); |  | (since C++17)   
(until C++23)  
...
[Additional overloads](sph_bessel.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double sph_bessel ( unsigned int n, Integer x ); |  (A)  |  (since C++17)  
| |   
  
1-3) Computes the [spherical Bessel function of the first kind](https://en.wikipedia.org/wiki/Bessel_function#Spherical_Bessel_functions:_jn.2C_yn "enwiki:Bessel function") of n and x. The library provides overloads of `std::sph_bessel` for all cv-unqualified floating-point types as the type of the parameter x.(since C++23)

A) Additional overloads are provided for all integer types, which are treated as double.

## Contents

  * [1 Parameters](sph_bessel.html#Parameters)
  * [2 Return value](sph_bessel.html#Return_value)
  * [3 Error handling](sph_bessel.html#Error_handling)
  * [4 Notes](sph_bessel.html#Notes)
  * [5 Example](sph_bessel.html#Example)
  * [6 See also](sph_bessel.html#See_also)
  * [7 External links](sph_bessel.html#External_links)
...
Run this code
    ...
    int main()
    {
        // spot check for n == 1
        double x = 1.2345;
        [std::cout](../../io/cout.html) << "j_1(" << x << ") = " << std::sph_bessel(1, x) << '\n';
     
        // exact solution for j_1
        [std::cout](../../io/cout.html) << "sin(x)/x² - cos(x)/x = "
                  << [std::sin](../math/sin.html)(x) / (x * x) - [std::cos](../math/cos.html)(x) / x << '\n';
    }
