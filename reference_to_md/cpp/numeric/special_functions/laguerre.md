...
long double laguerre ( unsigned int n, long double x ); |  | (since C++17)   
(until C++23)  
...
[Additional overloads](laguerre.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Integer >  
double laguerre ( unsigned int n, Integer x ); |  (A)  |  (since C++17)  
| |   
  
1-3) Computes the non-associated [Laguerre polynomials](https://en.wikipedia.org/wiki/Laguerre_polynomials "enwiki:Laguerre polynomials") of the degree n and argument x. The library provides overloads of `std::laguerre` for all cv-unqualified floating-point types as the type of the parameter x.(since C++23)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/laguerre&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  the degree of the polynomial, an unsigned integer value   
---|---|---  
x  |  \-  |  the argument, a floating-point or integer value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/laguerre&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/laguerre&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/laguerre&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/laguerre&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        // spot-checks
        [std::cout](../../io/cout.html) << std::laguerre(1, 0.5) << '=' << L1(0.5) << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/laguerre&action=edit&section=6 "Edit section: See also")] See also

[ assoc_laguerreassoc_laguerrefassoc_laguerrel](assoc_laguerre.html "cpp/numeric/special functions/assoc laguerre")(C++17)(C++17)(C++17) |  associated Laguerre polynomials   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/laguerre&action=edit&section=7 "Edit section: External links")] External links
