...
**cyl_bessel_i cyl_bessel_ifcyl_bessel_il**  
...
long double cyl_bessel_i ( long double nu, long double x ); |  | (since C++17)   
(until C++23)  
...
long double cyl_bessel_il( long double nu, long double x ); |  (3)  |  (since C++17)  
[Additional overloads](cyl_bessel_i.html#Notes) |  |   
Defined in header `[<cmath>](../../header/cmath.html "cpp/header/cmath")` |  |   
template< class Arithmetic1, class Arithmetic2 >  
/* common-floating-point-type */  
cyl_bessel_i( Arithmetic1 nu, Arithmetic2 x ); |  (A)  |  (since C++17)  
| |   
  
1-3) Computes the [regular modified cylindrical Bessel function](https://en.wikipedia.org/wiki/Bessel_function#Modified_Bessel_functions:_I.CE.B1_.2C_K.CE.B1 "enwiki:Bessel function") of nu and x. The library provides overloads of `std::cyl_bessel_i` for all cv-unqualified floating-point types as the type of the parameters nu and x.(since C++23)

A) Additional overloads are provided for all other combinations of arithmetic types.

## Contents

  * [1 Parameters](cyl_bessel_i.html#Parameters)
  * [2 Return value](cyl_bessel_i.html#Return_value)
  * [3 Error handling](cyl_bessel_i.html#Error_handling)
  * [4 Notes](cyl_bessel_i.html#Notes)
  * [5 Example](cyl_bessel_i.html#Example)
  * [6 See also](cyl_bessel_i.html#See_also)
  * [7 External links](cyl_bessel_i.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/cyl_bessel_i&action=edit&section=1 "Edit section: Parameters")] Parameters

nu  |  \-  |  the order of the function   
---|---|---  
x  |  \-  |  the argument of the function   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/cyl_bessel_i&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/cyl_bessel_i&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/cyl_bessel_i&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/cyl_bessel_i&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "I_0(" << x << ") = " << std::cyl_bessel_i(0, x) << '\n';
     
        ...
        {
            sum += [std::pow](../math/pow.html)(x / 2, 2 * k) / [std::pow](../math/pow.html)(fct, 2);
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/cyl_bessel_i&action=edit&section=6 "Edit section: See also")] See also
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/special_functions/cyl_bessel_i&action=edit&section=7 "Edit section: External links")] External links
