...
void erase_if( [std::forward_list](../../container/forward_list.html)<T, Alloc>& c, Pred pred ); |  |  (library fundamentals TS v2)  
| |   
...
Run this code
    ...
    int main()
    {
        [std::forward_list](../../container/forward_list.html)<int> data{3, 3, 4, 5, 5, 6, 6, 7, 2, 1, 0};
