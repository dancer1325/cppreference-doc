...
---|---|---  
template< class T > struct hash<[std::experimental::propagate_const](../propagate_const.html)<T>>; |  |  (library fundamentals TS v2)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [std::experimental::propagate_const](../propagate_const.html)<T> allows users to obtain hashes of objects of type [std::experimental::propagate_const](../propagate_const.html)<T>. 

For a given [std::experimental::propagate_const](../propagate_const.html)<T> p, this specialization ensures that [std::hash](../../utility/hash.html)<[std::experimental::propagate_const](../propagate_const.html)<T>>()(p) == [std::hash](../../utility/hash.html)<T>()(p.t_), where p.t_ is the pointer-like object wrapped by `p`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/propagate_const/hash&action=edit&section=1 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/propagate_const/hash&action=edit&section=2 "Edit section: See also")] See also
