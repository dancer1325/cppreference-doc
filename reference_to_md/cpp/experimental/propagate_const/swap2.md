...
template< class T >  
constexpr void swap( [std::experimental::propagate_const](../propagate_const.html)<T>& lhs,  
[std::experimental::propagate_const](../propagate_const.html)<T>& rhs ) noexcept(/* see below */); |  |  (library fundamentals TS v2)  
---|---|---  
| |   
  
Specializes the swap algorithm for [std::experimental::propagate_const](../propagate_const.html "cpp/experimental/propagate const"). Swaps the pointers of lhs and rhs. Equivalent to lhs.swap(rhs). 

This overload participates in overload resolution only if [std::is_swappable_v](../../types/is_swappable.html)<T> is true.  | (library fundamentals TS v3)  
---|---  
...
## Contents
  ...
  * [4 Complexity](swap2.html#Complexity)
  * [5 See also](swap2.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/propagate_const/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  `propagate_const`s whose contents to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/propagate_const/swap2&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/propagate_const/swap2&action=edit&section=3 "Edit section: Exceptions")] Exceptions

[`noexcept`](../../language/noexcept_spec.html "cpp/language/noexcept spec") specification: 

noexcept(noexcept(lhs.swap(rhs)))

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/propagate_const/swap2&action=edit&section=4 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/propagate_const/swap2&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[ swap](swap.html "cpp/experimental/propagate const/swap") |  swaps the wrapped pointer   
