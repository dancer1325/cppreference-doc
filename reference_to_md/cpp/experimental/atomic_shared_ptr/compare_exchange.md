...
---|---|---  
bool compare_exchange_weak( [std::shared_ptr](../../memory/shared_ptr.html)<T>& expected, [std::shared_ptr](../../memory/shared_ptr.html)<T>&& desired,  
...
bool compare_exchange_strong( [std::shared_ptr](../../memory/shared_ptr.html)<T>& expected, const [std::shared_ptr](../../memory/shared_ptr.html)<T>& desired,  
[std::memory_order](../../atomic/memory_order.html) success, [std::memory_order](../../atomic/memory_order.html) failure ) noexcept; |  (5)  |   
bool compare_exchange_strong( [std::shared_ptr](../../memory/shared_ptr.html)<T>& expected, [std::shared_ptr](../../memory/shared_ptr.html)<T>&& desired,  
