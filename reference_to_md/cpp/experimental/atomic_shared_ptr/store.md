...
void store( shared_ptr<T> desired, [std::memory_order](../../atomic/memory_order.html) order = [std::memory_order_seq_cst](../../atomic/memory_order.html) ) noexcept; |  |   
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_shared_ptr/store&action=edit&section=1 "Edit section: Parameters")] Parameters

desired  |  \-  |  the `shared_ptr` to store into the atomic variable   
---|---|---  
order  |  \-  |  memory order constraints to enforce   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_shared_ptr/store&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_shared_ptr/store&action=edit&section=3 "Edit section: Remarks")] Remarks
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_shared_ptr/store&action=edit&section=4 "Edit section: See also")] See also

[ operator=](operator=.html "cpp/experimental/atomic shared ptr/operator=") |  stores a value into an `atomic_shared_ptr` object   
