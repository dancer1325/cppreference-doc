...
2) Atomic variables are not [CopyAssignable](../../named_req/CopyAssignable.html "cpp/named req/CopyAssignable").
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_shared_ptr/operator%3D&action=edit&section=1 "Edit section: Parameters")] Parameters

desired  |  \-  |  value to assign   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_shared_ptr/operator%3D&action=edit&section=2 "Edit section: Notes")] Notes

Unlike most assignment operators, the assignment operators for `atomic_shared_ptr` returns void. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_shared_ptr/operator%3D&action=edit&section=3 "Edit section: Remarks")] Remarks
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_shared_ptr/operator%3D&action=edit&section=4 "Edit section: See also")] See also

[ (constructor)](atomic_shared_ptr.html "cpp/experimental/atomic shared ptr/atomic shared ptr") |  constructs an `atomic_shared_ptr` object   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/atomic_shared_ptr/dsc_constructor&action=edit)  
---|---  
[ store](store.html "cpp/experimental/atomic shared ptr/store") |  atomically replaces the value of the atomic object with a non-atomic argument   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/atomic_shared_ptr/dsc_store&action=edit)  
