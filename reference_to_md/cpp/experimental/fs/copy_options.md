...
This type represents available options that control the behavior of the [`copy()`](copy.html "cpp/experimental/fs/copy") and [`copy_file()`](copy_file.html "cpp/experimental/fs/copy file") function. 
...
---|---|---  
options controlling [`copy_file()`](copy_file.html "cpp/experimental/fs/copy file") when the file already exists   
...
options controlling the effects of [`copy()`](copy.html "cpp/experimental/fs/copy") on subdirectories   
`none` | ​0​ | Skip subdirectories (default behavior).   
`recursive` | 8 | Recursively copy subdirectories and their content.   
options controlling the effects of [`copy()`](copy.html "cpp/experimental/fs/copy") on symbolic links   
...
options controlling the kind of copying [`copy()`](copy.html "cpp/experimental/fs/copy") does   
