...
1,2) Returns the absolute path of the current working directory, obtained as if by POSIX [getcwd](https://pubs.opengroup.org/onlinepubs/9699919799/functions/getcwd.html). (2) returns path() if error occurs.
...
## Contents
  ...
  * [5 See also](current_path.html#See_also)
