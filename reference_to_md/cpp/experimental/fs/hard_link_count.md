...
---|---|---  
[std::uintmax_t](../../types/integer.html) hard_link_count( const path& p );  
[std::uintmax_t](../../types/integer.html) hard_link_count( const path& p, error_code& ec ); |  (1)  |  (filesystem TS)  
| |   
