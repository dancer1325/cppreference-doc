...
directory_entry& operator=( const directory_entry& ) = default; |  (1)  |  (filesystem TS)  
---|---|---  
directory_entry& operator=( directory_entry&&) = default; |  (2)  |  (filesystem TS)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/directory_entry/operator%3D&action=edit&section=1 "Edit section: Parameters")] Parameters

| This section is incomplete   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/directory_entry/operator%3D&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/directory_entry/operator%3D&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/directory_entry/operator%3D&action=edit&section=4 "Edit section: See also")] See also

[ assign](assign.html "cpp/experimental/fs/directory entry/assign") |  assigns contents   
