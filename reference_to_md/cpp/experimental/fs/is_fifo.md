...
---|---|---  
bool is_fifo( file_status s ); |  (1)  |  (filesystem TS)  
bool is_fifo( const path& p ); |  (2)  |  (filesystem TS)  
bool is_fifo( const path& p, error_code& ec ); |  (3)  |  (filesystem TS)  
| |   
...
## Contents
  ...
  * [4 See also](is_fifo.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_fifo&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_fifo&action=edit&section=2 "Edit section: Return value")] Return value

true if the given path or file status corresponds to a FIFO file. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_fifo&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_fifo&action=edit&section=4 "Edit section: See also")] See also
