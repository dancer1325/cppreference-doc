...
---|---|---  
bool is_empty( const path& p ); |  (1)  |  (filesystem TS)  
bool is_empty( const path& p, error_code& ec ); |  (2)  |  (filesystem TS)  
| |   
...
## Contents
  ...
  * [4 See also](is_empty.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_empty&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  path to examine   
---|---|---  
ec  |  \-  |  error code to modify in case of error   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_empty&action=edit&section=2 "Edit section: Return value")] Return value

true if p refers to an empty file or directory, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_empty&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_empty&action=edit&section=4 "Edit section: See also")] See also
