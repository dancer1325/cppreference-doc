...
void create_hard_link( const path& target, const path& link, error_code& ec ); |  |  (filesystem TS)  
| |   
...
Once created, link and target are two logical names that refer to the same file (they are [`equivalent`](equivalent.html "cpp/experimental/fs/equivalent")). Even if the original name target is deleted, the file continues to exist and is accessible as link. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/create_hard_link&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/create_hard_link&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/create_hard_link&action=edit&section=3 "Edit section: Exceptions")] Exceptions

The overload that does not take an error_code& parameter throws [filesystem_error](filesystem_error.html "cpp/experimental/fs/filesystem error") on underlying OS API errors, constructed with target as the first argument, link as the second argument, and the OS error code as the error code argument. [std::bad_alloc](../../memory/new/bad_alloc.html) may be thrown if memory allocation fails. The overload taking an error_code& parameter sets it to the OS API error code if an OS API call fails, and executes ec.clear() if no errors occur. This overload has 

[`noexcept`](../../language/noexcept_spec.html "cpp/language/noexcept spec") specification: 

noexcept

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/create_hard_link&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/create_hard_link&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/create_hard_link&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[ hard_link_count](hard_link_count.html "cpp/experimental/fs/hard link count") |  returns the number of hard links referring to the specific file   
