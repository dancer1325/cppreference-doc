...
2) Returns a default-constructed [`directory_iterator`](../directory_iterator.html "cpp/experimental/fs/directory iterator"), which serves as the end iterator. The argument is ignored.
