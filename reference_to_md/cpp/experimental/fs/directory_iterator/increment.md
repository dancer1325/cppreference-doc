...
Member functions  
---  
[directory_iterator::directory_iterator](directory_iterator.html "cpp/experimental/fs/directory iterator/directory iterator")  
[directory_iterator::operator*directory_iterator::operator->](operator*.html "cpp/experimental/fs/directory iterator/operator*")  
[directory_iterator::operator=](operator=.html "cpp/experimental/fs/directory iterator/operator=")  
**directory_iterator::increment directory_iterator::operator++**  
...
directory_iterator& increment( error_code& ec ) noexcept; |  |  (filesystem TS)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/directory_iterator/increment&action=edit&section=1 "Edit section: Parameters")] Parameters

ec  |  \-  |  error code to store error status to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/directory_iterator/increment&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/directory_iterator/increment&action=edit&section=3 "Edit section: Exceptions")] Exceptions
