...
## Contents
  ...
  * [4 See also](is_directory.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_directory&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_directory&action=edit&section=2 "Edit section: Return value")] Return value

true if the given path or file status corresponds to a directory, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_directory&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/is_directory&action=edit&section=4 "Edit section: See also")] See also
