...
2) Returns a default-constructed [`recursive_directory_iterator`](../recursive_directory_iterator.html "cpp/experimental/fs/recursive directory iterator"), which serves as the end iterator. The argument is ignored.
