...
The call modifies the pending recursion flag on the iterator in such a way that the next time [`increment`](increment.html "cpp/experimental/fs/recursive directory iterator/increment") is called, the iterator will advance within the current directly even if it is currently referring to a subdirectory that hasn't been visited. 

The status of the pending recursion flag can be queried with [`recursion_pending()`](recursion_pending.html "cpp/experimental/fs/recursive directory iterator/recursion pending"), which is false after this call. It is reset back to true after [`increment`](increment.html "cpp/experimental/fs/recursive directory iterator/increment"), and its initial value is also true. 

The behavior is undefined if *this is the end iterator. 

## Contents

  * [1 Parameters](disable_recursion_pending.html#Parameters)
  * [2 Return value](disable_recursion_pending.html#Return_value)
  * [3 Exceptions](disable_recursion_pending.html#Exceptions)
  * [4 Example](disable_recursion_pending.html#Example)
  * [5 See also](disable_recursion_pending.html#See_also)
