...
Member functions  
---  
[recursive_directory_iterator::recursive_directory_iterator](recursive_directory_iterator.html "cpp/experimental/fs/recursive directory iterator/recursive directory iterator")  
[recursive_directory_iterator::operator*recursive_directory_iterator::operator->](operator*.html "cpp/experimental/fs/recursive directory iterator/operator*")  
[recursive_directory_iterator::options](options.html "cpp/experimental/fs/recursive directory iterator/options")  
**recursive_directory_iterator::depth**  
[recursive_directory_iterator::recursion_pending](recursion_pending.html "cpp/experimental/fs/recursive directory iterator/recursion pending")  
[recursive_directory_iterator::operator=](operator=.html "cpp/experimental/fs/recursive directory iterator/operator=")  
[recursive_directory_iterator::incrementrecursive_directory_iterator::operator++](increment.html "cpp/experimental/fs/recursive directory iterator/increment")  
[recursive_directory_iterator::pop](pop.html "cpp/experimental/fs/recursive directory iterator/pop")  
[recursive_directory_iterator::disable_recursion_pending](disable_recursion_pending.html "cpp/experimental/fs/recursive directory iterator/disable recursion pending")  
...
## Contents
  ...
  * [1 Parameters](depth.html#Parameters)
  * [2 Return value](depth.html#Return_value)
  * [3 Exceptions](depth.html#Exceptions)
  * [4 Example](depth.html#Example)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/recursive_directory_iterator/depth&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/recursive_directory_iterator/depth&action=edit&section=2 "Edit section: Return value")] Return value

Current depth of the directory hierarchy. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/recursive_directory_iterator/depth&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/recursive_directory_iterator/depth&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::ofstream](../../../io/basic_ofstream.html)("sandbox/a/b/file1.txt");
        fs::create_symlink("a", "sandbox/syma");
        for (auto i = fs::recursive_directory_iterator("sandbox");                       
                 i != fs::recursive_directory_iterator(); ++i)
        {
            [std::cout](../../../io/cout.html) << [std::string](../../../string/basic_string.html)(i.depth(), ' ') << *i;
            if (fs::is_symlink(i->symlink_status()))
                [std::cout](../../../io/cout.html) << " -> " << fs::read_symlink(*i);
