...
---|---|---  
[std::uintmax_t](../../types/integer.html) file_size( const path& p );  
[std::uintmax_t](../../types/integer.html) file_size( const path& p, error_code& ec ); |  (1)  |  (filesystem TS)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/file_size&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  path to examine   
---|---|---  
ec  |  \-  |  out-parameter for error reporting in the non-throwing overload   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/file_size&action=edit&section=2 "Edit section: Return value")] Return value

The size of the file, in bytes. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/file_size&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/file_size&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/file_size&action=edit&section=5 "Edit section: See also")] See also

[ resize_file](resize_file.html "cpp/experimental/fs/resize file") |  changes the size of a regular file by truncation or zero-fill   
