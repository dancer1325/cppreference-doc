...
## Contents
  ...
  * [1 Parameters](remove_filename.html#Parameters)
  * [2 Return value](remove_filename.html#Return_value)
  * [3 Exceptions](remove_filename.html#Exceptions)
  * [4 Example](remove_filename.html#Example)
  * [5 See also](remove_filename.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/remove_filename&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/remove_filename&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/remove_filename&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../../io/cout.html) << fs::path("/foo").remove_filename() << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/remove_filename&action=edit&section=4 "Edit section: See also")] See also
