...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  paths whose states to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/swap2&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/swap2&action=edit&section=3 "Edit section: Exceptions")] Exceptions

[`noexcept`](../../../language/noexcept_spec.html "cpp/language/noexcept spec") specification: 

noexcept

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/swap2&action=edit&section=4 "Edit section: See also")] See also

[ swap](swap.html "cpp/experimental/fs/path/swap") |  swaps two paths   
