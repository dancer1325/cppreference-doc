...
Returns the substring from the beginning of [`filename()`](filename.html "cpp/experimental/fs/path/filename") up to and not including the last period (`**.**`) character. 

If the filename is one of the special filesystem components dot or dot-dot, or if it has no periods, the function returns the entire [`filename()`](filename.html "cpp/experimental/fs/path/filename"). 

## Contents

  * [1 Parameters](stem.html#Parameters)
  * [2 Return value](stem.html#Return_value)
  * [3 Exceptions](stem.html#Exceptions)
  * [4 Example](stem.html#Example)
  * [5 See also](stem.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/stem&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/stem&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/stem&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../../io/cout.html) << fs::path("/foo/bar.txt").stem() << '\n'
                  << fs::path("/foo/.bar").stem() << '\n';
     
        for (fs::path p = "foo.bar.baz.tar"; !p.extension().empty(); p = p.stem())
            [std::cout](../../../io/cout.html) << p.extension() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/stem&action=edit&section=4 "Edit section: See also")] See also
