...
## Contents
  ...
  * [1 Parameters](parent_path.html#Parameters)
  * [2 Return value](parent_path.html#Return_value)
  * [3 Exceptions](parent_path.html#Exceptions)
  * [4 Example](parent_path.html#Example)
  * [5 See also](parent_path.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/parent_path&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/parent_path&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/parent_path&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        for (fs::path p : {"/var/tmp/example.txt", "/", "/var/tmp/."})
            [std::cout](../../../io/cout.html) << "The parent path of " << p
                      << " is " << p.parent_path() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/parent_path&action=edit&section=4 "Edit section: See also")] See also
