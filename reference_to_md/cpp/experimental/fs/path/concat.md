...
Member functions  
---  
| [path::path](path.html "cpp/experimental/fs/path/path")  
---  
[path::~path](~path.html "cpp/experimental/fs/path/~path")  
[path::operator=](operator=.html "cpp/experimental/fs/path/operator=")  
[path::assign](assign.html "cpp/experimental/fs/path/assign")  
[path::appendoperator /=](append.html "cpp/experimental/fs/path/append")  
**path::concat operator +=**  
[path::clear](clear.html "cpp/experimental/fs/path/clear")  
[path::make_preferred](make_preferred.html "cpp/experimental/fs/path/make preferred")  
[path::remove_filename](remove_filename.html "cpp/experimental/fs/path/remove filename")  
[path::replace_filename](replace_filename.html "cpp/experimental/fs/path/replace filename")  
[path::replace_extension](replace_extension.html "cpp/experimental/fs/path/replace extension")  
[path::swap](swap.html "cpp/experimental/fs/path/swap")  
[path::compare](compare.html "cpp/experimental/fs/path/compare")  
  
| [path::c_strpath::nativeoperator string_type](native.html "cpp/experimental/fs/path/native")  
---  
[path::stringpath::u8stringpath::u16stringpath::u32stringpath::wstring](string.html "cpp/experimental/fs/path/string")  
[path::generic_stringpath::generic_u8stringpath::generic_u16stringpath::generic_u32stringpath::generic_wstring](generic_string.html "cpp/experimental/fs/path/generic string")  
[path::beginpath::end](begin.html "cpp/experimental/fs/path/begin")  
  
Path decomposition  
| [path::root_name](root_name.html "cpp/experimental/fs/path/root name")  
---  
[path::root_directory](root_directory.html "cpp/experimental/fs/path/root directory")  
[path::root_path](root_path.html "cpp/experimental/fs/path/root path")  
[path::relative_path](relative_path.html "cpp/experimental/fs/path/relative path")  
[path::parent_path](parent_path.html "cpp/experimental/fs/path/parent path")  
[path::filename](filename.html "cpp/experimental/fs/path/filename")  
[path::stem](stem.html "cpp/experimental/fs/path/stem")  
[path::extension](extension.html "cpp/experimental/fs/path/extension")  
[path::empty](empty.html "cpp/experimental/fs/path/empty")  
  
| [path::has_root_pathpath::has_root_namepath::has_root_directorypath::has_relative_pathpath::has_parent_pathpath::has_filenamepath::has_stempath::has_extension](has_path.html "cpp/experimental/fs/path/has path")  
---  
[path::is_absolutepath::is_relative](is_absrel.html "cpp/experimental/fs/path/is absrel")  
  
Non-member functions  
[swap(path)](swap2.html "cpp/experimental/fs/path/swap2")  
[operator==operator!=operator<operator<=operator>operator>=](operator_cmp.html "cpp/experimental/fs/path/operator cmp")  
[operator/](operator_slash.html "cpp/experimental/fs/path/operator slash")  
...
1) Concatenates *this and p in such a way that [native()](native.html "cpp/experimental/fs/path/native") of the result is exactly original [native()](native.html "cpp/experimental/fs/path/native") concatenated with p.native().

2) Same as (1), except the resulting [native()](native.html "cpp/experimental/fs/path/native") is a concatenation of the original [native()](native.html "cpp/experimental/fs/path/native") and the string str.

3) Same as (1), except the resulting [native()](native.html "cpp/experimental/fs/path/native") is a concatenation of the original [native()](native.html "cpp/experimental/fs/path/native") and the null-terminated string whose first character is pointed to by ptr.

4) Same as (1), except the resulting [native()](native.html "cpp/experimental/fs/path/native") is a concatenation of the original [native()](native.html "cpp/experimental/fs/path/native") and the single character x.

5) Same as (1), except the resulting [native()](native.html "cpp/experimental/fs/path/native") is a concatenation of the original [native()](native.html "cpp/experimental/fs/path/native") and the sequence (which may be in portable or native format) represented by source, which may be [std::basic_string](../../../string/basic_string.html), null-terminated multicharacter string, or an input iterator pointing to a null-terminated multicharacter sequence.
...
## Contents
  ...
  * [6 See also](concat.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/concat&action=edit&section=1 "Edit section: Parameters")] Parameters
...
source  |  \-  |  [std::basic_string](../../../string/basic_string.html), null-terminated multicharacter string, or an input iterator pointing to a null-terminated multicharacter sequence, which represents a path name (either in portable or in native format)   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/concat&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/concat&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/concat&action=edit&section=4 "Edit section: Notes")] Notes

Unlike with [append()](append.html "cpp/experimental/fs/path/append") or [operator/=](append.html "cpp/experimental/fs/path/append"), additional directory separators are never introduced. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/concat&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../../io/cout.html) << "\"\" + \"var\" == " << p1 << '\n';
        p1 += "lib"; // does not insert a separator
        [std::cout](../../../io/cout.html) << "\"\" + \"var\" + \"lib\" == " << p1 << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/concat&action=edit&section=6 "Edit section: See also")] See also

[ appendoperator/=](append.html "cpp/experimental/fs/path/append") |  appends elements to the path   
