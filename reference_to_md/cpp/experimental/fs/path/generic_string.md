...
**path::generic_string path::generic_u8stringpath::generic_u16stringpath::generic_u32stringpath::generic_wstring**  
...
---|---|---  
| (2) | (filesystem TS)  
[std::string](../../../string/basic_string.html) generic_string() const; |  |   
[std::wstring](../../../string/basic_string.html) generic_wstring() const; |  |   
[std::string](../../../string/basic_string.html) generic_u8string() const; |  |   
[std::u16string](../../../string/basic_string.html) generic_u16string() const; |  |   
[std::u32string](../../../string/basic_string.html) generic_u32string() const; |  |   
| |   
  
Returns the internal pathname in generic pathname format, converted to specific string type. Conversion, if any, is specified in [todo](https://en.cppreference.com/mwiki/index.php?title=todo&action=edit&redlink=1 "todo \(page does not exist\)"). The `/` character is used as the directory separator. 
...
## Contents
  ...
  * [1 Parameters](generic_string.html#Parameters)
  * [2 Return value](generic_string.html#Return_value)
  * [3 Exceptions](generic_string.html#Exceptions)
  * [4 See also](generic_string.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/generic_string&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/generic_string&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/generic_string&action=edit&section=3 "Edit section: See also")] See also
