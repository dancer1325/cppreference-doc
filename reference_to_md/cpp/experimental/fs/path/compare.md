...
1) Returns a value less than, equal to or greater than 0 if the native representation of the path ([native](native.html "cpp/experimental/fs/path/native")()) is respectively lexicographically less than, equal to or greater than the native representation of p (p.native()). Comparison is performed element-wise, as if by iterating both paths from [begin](begin.html "cpp/experimental/fs/path/begin")() to [end](begin.html "cpp/experimental/fs/path/begin")().
