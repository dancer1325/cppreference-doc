...
2,3) Same as (1), but accepts any [std::basic_string](../../../string/basic_string.html), null-terminated multicharacter string, or an input iterator pointing to a null-terminated multicharacter sequence.

4) Same as (1), but accepts any iterator pair that designates a multicharacter string.

## Contents

  * [1 Parameters](append.html#Parameters)
  * [2 Return value](append.html#Return_value)
  * [3 Exceptions](append.html#Exceptions)
  * [4 Example](append.html#Example)
  * [5 See also](append.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../../io/cout.html) << "\"C:\" / \"Users\" / \"batman\" == " << p1 << '\n';
    }
