...
## Contents
  ...
  * [4 See also](assign.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/assign&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/assign&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/assign&action=edit&section=3 "Edit section: Exceptions")] Exceptions

| This section is incomplete   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/assign&action=edit&section=4 "Edit section: See also")] See also

[ operator=](operator=.html "cpp/experimental/fs/path/operator=") |  assigns another path   
