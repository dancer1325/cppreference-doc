...
## Contents
  ...
  * [1 Parameters](filename.html#Parameters)
  * [2 Return value](filename.html#Return_value)
  * [3 Exceptions](filename.html#Exceptions)
  * [4 Example](filename.html#Example)
  * [5 See also](filename.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/filename&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/filename&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/filename&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../../io/cout.html) << fs::path("/foo/bar.txt").filename() << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/filename&action=edit&section=4 "Edit section: See also")] See also

[ extension](extension.html "cpp/experimental/fs/path/extension") |  returns the file extension path component   
...
[ replace_filename](replace_filename.html "cpp/experimental/fs/path/replace filename") |  replaces the last path component with another path   
