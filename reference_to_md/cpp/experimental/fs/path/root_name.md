...
## Contents
  ...
  * [1 Parameters](root_name.html#Parameters)
  * [2 Return value](root_name.html#Return_value)
  * [3 Exceptions](root_name.html#Exceptions)
  * [4 Example](root_name.html#Example)
  * [5 See also](root_name.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/root_name&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/root_name&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/root_name&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../../io/cout.html) << "Current root name is: " << fs::current_path().root_name() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/root_name&action=edit&section=4 "Edit section: See also")] See also
