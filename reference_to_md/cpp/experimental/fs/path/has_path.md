...
| **path::has_root_path path::has_root_namepath::has_root_directorypath::has_relative_pathpath::has_parent_pathpath::has_filenamepath::has_stempath::has_extension**  
---  
...
1) Checks whether [root_path()](root_path.html "cpp/experimental/fs/path/root path") is empty.

2) Checks whether [root_name()](root_name.html "cpp/experimental/fs/path/root name") is empty.

3) Checks whether [root_directory()](root_directory.html "cpp/experimental/fs/path/root directory") is empty.

4) Checks whether [relative_path()](relative_path.html "cpp/experimental/fs/path/relative path") is empty.

5) Checks whether [parent_path()](parent_path.html "cpp/experimental/fs/path/parent path") is empty.

6) Checks whether [filename()](filename.html "cpp/experimental/fs/path/filename") is empty.

7) Checks whether [stem()](stem.html "cpp/experimental/fs/path/stem") is empty.

8) Checks whether [extension()](extension.html "cpp/experimental/fs/path/extension") is empty.

## Contents

  * [1 Parameters](has_path.html#Parameters)
  * [2 Return value](has_path.html#Return_value)
  * [3 Exceptions](has_path.html#Exceptions)
  * [4 See also](has_path.html#See_also)
...
[ empty](empty.html "cpp/experimental/fs/path/empty") |  checks if the path is empty   
