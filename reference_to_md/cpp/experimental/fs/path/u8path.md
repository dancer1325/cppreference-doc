...
path u8path( const Source& source ); |  (1)  |  (filesystem TS)  
template< class InputIt >  
path u8path( InputIt first, InputIt last ); |  (2)  |  (filesystem TS)  
| |   
  
Constructs a path `p` from a UTF-8 encoded sequence of chars, supplied either as an [std::string](../../../string/basic_string.html "cpp/string/basic string"), or as a null-terminated multibyte string, or as a [first, last) iterator pair. 
  ...
  * Otherwise (for non-UTF-8 narrow character encodings and for non-UTF-16 wchar_t), first converts the UTF-8 character sequence to a temporary UTF-32-encoded string `tmp` of type [std::u32string](../../../string/basic_string.html), and then the new path is constructed as if by path(tmp) (this path is taken on a POSIX system with a non-Unicode multibyte or single-byte encoded filesystem). 



## Contents

  * [1 Parameters](u8path.html#Parameters)
  * [2 Return value](u8path.html#Return_value)
  * [3 Exceptions](u8path.html#Exceptions)
  * [4 Notes](u8path.html#Notes)
  * [5 Example](u8path.html#Example)
  * [6 See also](u8path.html#See_also)
...
---|---|---  
first, last  |  \-  |  pair of [LegacyInputIterators](../../../named_req/InputIterator.html "cpp/named req/InputIterator") that specify a UTF-8 encoded character sequence   
Type requirements   
