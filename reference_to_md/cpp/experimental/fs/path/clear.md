...
Clears the stored pathname. [empty()](empty.html "cpp/experimental/fs/path/empty") is true after the call. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/clear&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/clear&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/clear&action=edit&section=3 "Edit section: Exceptions")] Exceptions
