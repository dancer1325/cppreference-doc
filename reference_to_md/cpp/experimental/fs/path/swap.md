...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  another path to exchange the contents with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/swap&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/swap&action=edit&section=3 "Edit section: Exceptions")] Exceptions

[`noexcept`](../../../language/noexcept_spec.html "cpp/language/noexcept spec") specification: 

noexcept

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/swap&action=edit&section=4 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/swap&action=edit&section=5 "Edit section: See also")] See also
