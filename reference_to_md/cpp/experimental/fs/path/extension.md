...
If the [`filename()`](filename.html "cpp/experimental/fs/path/filename") component of the path contains a period (`**.**`), and is not one of the special filesystem elements dot or dot-dot, then the _extension_ is the substring beginning at the rightmost period (including the period) and until the end of the pathname. 

If the pathname is either `.` or `..`, or if [`filename()`](filename.html "cpp/experimental/fs/path/filename") does not contain the `.` character, then empty path is returned. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/extension&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/extension&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/extension&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/extension&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/path/extension&action=edit&section=5 "Edit section: See also")] See also

[ filename](filename.html "cpp/experimental/fs/path/filename") |  returns the filename path component   
...
---|---  
[ stem](stem.html "cpp/experimental/fs/path/stem") |  returns the stem path component   
...
[ replace_extension](replace_extension.html "cpp/experimental/fs/path/replace extension") |  replaces the extension   
...
[ has_extension](has_path.html "cpp/experimental/fs/path/has path") |  checks if the corresponding path element is not empty   
