...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/file_status/type&action=edit&section=1 "Edit section: Parameters")] Parameters

type  |  \-  |  file type to set to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/file_status/type&action=edit&section=2 "Edit section: Return value")] Return value

1) File type information.

2) (none)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/file_status/type&action=edit&section=3 "Edit section: Exceptions")] Exceptions
