...
This type represents available options that control the behavior of the [`directory_iterator`](directory_iterator.html "cpp/experimental/fs/directory iterator") and [`recursive_directory_iterator`](recursive_directory_iterator.html "cpp/experimental/fs/recursive directory iterator"). 
