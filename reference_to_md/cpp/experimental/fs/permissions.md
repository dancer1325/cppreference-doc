...
void permissions( const path& p, perms prms, error_code& ec ); |  |  (filesystem TS)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/permissions&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/permissions&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/permissions&action=edit&section=3 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/permissions&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/permissions&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
         [std::cout](../../io/cout.html) << ((p & fs::perms::owner_read) != fs::perms::none ? "r" : "-")
    ...
     
        [std::cout](../../io/cout.html) << "After adding o+rwx and g+rwx:  ";
        demo_perms(fs::status("test.txt").permissions());
     
        fs::remove("test.txt");
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/permissions&action=edit&section=6 "Edit section: See also")] See also
