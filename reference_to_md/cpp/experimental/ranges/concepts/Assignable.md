...
Given 
  ...
  * `t`, an lvalue of type [std::remove_reference_t](../../../types/remove_reference.html)<T> that refers to an object `o`, 
...
`Assignable<T, U>` is satisfied only if 
  ...
  * [std::addressof](../../../memory/addressof.html)(t = u) == [std::addressof](../../../memory/addressof.html)(o) (i.e., the assignment expression yields an lvalue referring to the left operand); 
...
There need not be any subsumption relationship between `Assignable<T, U>` and [std::is_lvalue_reference](../../../types/is_lvalue_reference.html)<T>::value. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/ranges/concepts/Assignable&action=edit&section=1 "Edit section: Notes")] Notes
