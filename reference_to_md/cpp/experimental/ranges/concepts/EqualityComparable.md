...
| **EqualityComparable EqualityComparableWith**  
---  
...
---|---|---  
template< class T >  
concept bool EqualityComparable = WeaklyEqualityComparableWith<T, T>; |  (1)  |  (ranges TS)  
...
const [std::remove_reference_t](../../../types/remove_reference.html)<T>&,  
const [std::remove_reference_t](../../../types/remove_reference.html)<U>&>> &&  
WeaklyEqualityComparableWith<T, U>; |  (2)  |  (ranges TS)  
| |   
