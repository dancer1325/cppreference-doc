...
[std::is_convertible](../../../types/is_convertible.html)<From, To>::value &&  
requires(From (&f)()) {  
static_cast<To>(f());  
}; |  |  (ranges TS)  
| |   
...
There need not be any subsumption relationship between ConvertibleTo<From, To> and [std::is_convertible](../../../types/is_convertible.html)<From, To>::value. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/ranges/concepts/ConvertibleTo&action=edit&section=1 "Edit section: See also")] See also
