...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/concurrency&action=edit&section=1 "Edit section: Continuations and other extensions for std::future")] Continuations and other extensions for std::future
...
(class template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_shared_future&action=edit)  
...
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_when_any&action=edit)  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/concurrency&action=edit&section=2 "Edit section: Feature test macros")] Feature test macros
...
## [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/concurrency&action=edit&section=3 "Edit section: Merged into C++20")] Merged into C++20

The following components of the Concurrency TS have been adopted into the C++20 standard. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/concurrency&action=edit&section=4 "Edit section: Latches and barriers")] Latches and barriers

Defined in header `[<experimental/latch>](https://en.cppreference.com/mwiki/index.php?title=cpp/header/experimental/latch&action=edit&redlink=1 "cpp/header/experimental/latch \(page does not exist\)")`  
---  
[ latch](latch.html "cpp/experimental/latch")(concurrency TS) |  single-use thread barrier   
(class) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_latch&action=edit)  
Defined in header `[<experimental/barrier>](https://en.cppreference.com/mwiki/index.php?title=cpp/header/experimental/barrier&action=edit&redlink=1 "cpp/header/experimental/barrier \(page does not exist\)")`  
[ barrier](barrier.html "cpp/experimental/barrier")(concurrency TS) |  reusable thread barrier   
(class) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_barrier&action=edit)  
...
(class) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_flex_barrier&action=edit)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/concurrency&action=edit&section=5 "Edit section: Atomic smart pointers")] Atomic smart pointers
...
(class template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_atomic_shared_ptr&action=edit)  
[ atomic_weak_ptr](atomic_weak_ptr.html "cpp/experimental/atomic weak ptr")(concurrency TS) |  atomic version of std::weak_ptr   
(class template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_atomic_weak_ptr&action=edit)
