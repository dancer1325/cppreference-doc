...
const Searcher& searcher ); |  |  (library fundamentals TS)  
| |   
...
`Searcher` need not be [CopyConstructible](../named_req/CopyConstructible.html "cpp/named req/CopyConstructible"). 
...
## Contents
  ...
  * [4 Example](search.html#Example)
  * [5 See also](search.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::string](../string/basic_string.html) in = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed "
                         "do eiusmod tempor incididunt ut labore et dolore magna aliqua";
        [std::string](../string/basic_string.html) needle = "pisci";
        auto it = std::experimental::search(in.begin(), in.end(),
                      [std::experimental::make_boyer_moore_searcher](boyer_moore_searcher.html)(
