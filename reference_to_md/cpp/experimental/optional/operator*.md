...
The behavior is undefined if *this _does not contain a value_. 
...
Run this code
    ...
    int main()
    {
        [std::experimental::optional](../optional.html)<int> opt1 = 1;
        [std::cout](../../io/cout.html) << *opt1 << '\n';
     
        [std::experimental::optional](../optional.html)<[std::string](../../string/basic_string.html)> opt2 = "abc"s;
        [std::cout](../../io/cout.html) << opt2->size() << '\n';
    }
