...
---|---|---  
template< class T >  
struct hash<[std::experimental::optional](../optional.html)<T>>; |  |  (library fundamentals TS)  
| |   
...
Run this code
    ...
    int main()
    {
        ...
        [std::unordered_set](../../container/unordered_set.html)<[std::experimental::optional](../optional.html)<[std::string](../../string/basic_string.html)>> s = {
            "abc"s, [std::experimental::nullopt](nullopt.html), "def"s
        };
     
        for (const auto& o : s)
            [std::cout](../../io/cout.html) << o.value_or("(null)") << ' ';
