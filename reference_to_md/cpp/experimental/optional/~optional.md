...
If the object contains a value and the type `T` is not trivially destructible (see [std::is_trivially_destructible](../../types/is_destructible.html "cpp/types/is destructible")), destroys the contained value by calling its destructor, as if by val->T::~T(). 

Otherwise, does nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/optional/%7Eoptional&action=edit&section=1 "Edit section: Notes")] Notes
