...
---|---|---  
template< class T >   
constexpr optional<typename [std::decay](../../types/decay.html)<T>::type>   
make_optional( T&& value ); |  |  (library fundamentals TS)  
| |   
  
Creates an optional object from `value`. Effectively calls optional<typename [std::decay](../../types/decay.html)<T>::type>([std::forward](../../utility/forward.html)<T>(value)). 
...
## Contents
  ...
  * [4 See also](make_optional.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/optional/make_optional&action=edit&section=1 "Edit section: Parameters")] Parameters

value  |  \-  |  the value to construct optional object with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/optional/make_optional&action=edit&section=2 "Edit section: Return value")] Return value

An optional object with value as the contained value. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/optional/make_optional&action=edit&section=3 "Edit section: Exceptions")] Exceptions

Throws any exception thrown by the constructor of `T`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/optional/make_optional&action=edit&section=4 "Edit section: See also")] See also

[ (constructor)](optional.html "cpp/experimental/optional/optional") |  constructs the optional object   
