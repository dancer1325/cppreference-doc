...
1) Equivalent to bool(*this) ? **this : static_cast<T>([std::forward](../../utility/forward.html)<U>(default_value)).

2) Equivalent to bool(*this) ? std::move(**this) : static_cast<T>([std::forward](../../utility/forward.html)<U>(default_value)).

## Contents

  * [1 Parameters](value_or.html#Parameters)
  * [2 Return value](value_or.html#Return_value)
  * [3 Exceptions](value_or.html#Exceptions)
  * [4 Example](value_or.html#Example)
...
Run this code
    ...
    #include <iostream>
     
    [std::experimental::optional](../optional.html)<const char*> maybe_getenv(const char* n)
    {
        if (const char* x = [std::getenv](../../utility/program/getenv.html)(n))
            return x;
        else
            return {};
    }
