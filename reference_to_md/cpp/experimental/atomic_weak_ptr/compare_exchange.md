...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/compare_exchange&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/compare_exchange&action=edit&section=2 "Edit section: Return value")] Return value

true if the underlying atomic value was changed, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/compare_exchange&action=edit&section=3 "Edit section: Remarks")] Remarks
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/compare_exchange&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/compare_exchange&action=edit&section=5 "Edit section: See also")] See also
