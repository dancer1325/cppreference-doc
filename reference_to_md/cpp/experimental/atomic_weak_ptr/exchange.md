...
weak_ptr<T> exchange( weak_ptr<T> desired, [std::memory_order](../../atomic/memory_order.html) order = [std::memory_order_seq_cst](../../atomic/memory_order.html) ) noexcept; |  |   
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/exchange&action=edit&section=1 "Edit section: Parameters")] Parameters

desired  |  \-  |  value to assign   
---|---|---  
order  |  \-  |  memory order constraints to enforce   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/exchange&action=edit&section=2 "Edit section: Return value")] Return value

The value of the atomic variable before the call. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/exchange&action=edit&section=3 "Edit section: Remarks")] Remarks
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/exchange&action=edit&section=4 "Edit section: See also")] See also
