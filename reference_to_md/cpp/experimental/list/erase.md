...
![](https://upload.cppreference.com/mwiki/images/3/31/Imbox_notice.png) |  **Merged into ISO C++** The functionality described on this page was merged into the mainline ISO C++ standard as of 11/2018, see [`std::erase`](../../container/list/erase2.html "cpp/container/list/erase2") (since C++20)  
---|---  
...
void erase( [std::list](../../container/list.html)<T, A>& c, const U& value ); |  |  (library fundamentals TS v2)  
| |   
...
## Contents
  ...
  * [4 Notes](erase.html#Notes)
  * [5 See also](erase.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/erase&action=edit&section=T-1 "Template:cpp/experimental/erase")] Parameters

c  |  \-  |  container from which to erase   
---|---|---  
value  |  \-  |  value to be removed   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/erase&action=edit&section=T-2 "Template:cpp/experimental/erase")] Complexity

Linear. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/erase&action=edit&section=T-3 "Template:cpp/experimental/erase")] Example
...
Run this code
    ...
    int main()
    {
        [std::list](../../container/list.html)<int> data{1, 1, 1, 4, 1, 1, 1, 2, 1, 1, 1};
        show(data);
...
Unlike [std::list::remove](../../container/list/remove.html "cpp/container/list/remove"), this function template accepts heterogeneous types and does not force a conversion to the container's value type before invoking the == operator. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/erase&action=edit&section=T-5 "Template:cpp/experimental/erase")] See also
...
---|---  
[ removeremove_if](../../container/list/remove.html "cpp/container/list/remove") |  removes elements satisfying specific criteria   
(public member function of `std::list<T,Allocator>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/container/dsc_remove&action=edit)  
[ erase_if (std::list)](erase_if.html "cpp/experimental/list/erase if")(library fundamentals 2 TS) |  erases all elements satisfying a predicate from a [std::list](../../container/list.html "cpp/container/list")   
(function template) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/dsc_erase_if&action=edit)
