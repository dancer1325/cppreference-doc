...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/null_memory_resource&action=edit&section=1 "Edit section: Return value")] Return value 
...
Returns a pointer `p` to a static storage duration object of a type derived from [std::experimental::pmr::memory_resource](memory_resource.html "cpp/experimental/memory resource"), with the following properties: 
  ...
  * its `allocate()` function always throws [std::bad_alloc](../memory/new/bad_alloc.html "cpp/memory/new/bad alloc"); 
