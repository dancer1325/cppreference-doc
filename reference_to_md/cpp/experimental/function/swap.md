...
The behavior is undefined if *this->get_memory_resource() != *other.get_memory_resource().  | (library fundamentals TS)  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/function/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  function wrapper to exchange the stored callable object with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/function/swap&action=edit&section=2 "Edit section: Return value")] Return value
