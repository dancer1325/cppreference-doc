...
struct uses_allocator<[std::experimental::function](../function.html)<R(ArgTypes...)>, Alloc>   
: [std::true_type](../../types/integral_constant.html) {}; |  |  (library fundamentals TS)   
(removed in library fundamentals TS v3)  
| |   
  
This specialization of [std::uses_allocator](../../memory/uses_allocator.html "cpp/memory/uses allocator") informs other library components that all objects of type std::experimental::function support _uses-allocator construction_. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/function/uses_allocator&action=edit&section=1 "Edit section: See also")] See also
