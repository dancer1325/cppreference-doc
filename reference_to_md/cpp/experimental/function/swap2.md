...
void swap( [std::experimental::function](../function.html)<R(Args...)> &lhs,  
[std::experimental::function](../function.html)<R(Args...)> &rhs ); |  |   
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/function/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  polymorphic function wrappers whose states to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/function/swap2&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/function/swap2&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/function/swap2&action=edit&section=4 "Edit section: See also")] See also

[ swap](swap.html "cpp/experimental/function/swap") |  swaps the contents   
