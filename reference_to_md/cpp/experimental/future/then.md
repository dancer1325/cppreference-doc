...
Let `U` be the return type of the continuation (i.e. [std::result_of_t](../../types/result_of.html)<[std::decay_t](../../types/decay.html)<F>([std::experimental::future](../future.html)<T>)>). If `U` is [std::experimental::future](../future.html)<T2> for some type `T2`, then the return type of `then` is [std::experimental::future](../future.html)<T2>, otherwise it is [std::experimental::future](../future.html)<U>. This is known as _implicit unwrapping_. 
