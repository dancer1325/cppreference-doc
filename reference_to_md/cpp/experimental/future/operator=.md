...
[std::experimental::future](../future.html)<T>& operator=( [std::experimental::future](../future.html)<T>&& other ) noexcept; |  (1)  |   
---|---|---  
[std::experimental::future](../future.html)<T>& operator=( const [std::experimental::future](../future.html)<T>& other ) = delete; |  (2)  |   
| |   
  
Assigns the contents of another future object. 

1) Releases any shared state and move-assigns the contents of other to *this. After the assignment, other.valid() == false and [this->valid()](../../thread/future/valid.html "cpp/thread/future/valid") will yield the same value as other.valid() before the assignment.

2) std::experimental::future is not [CopyAssignable](../../named_req/CopyAssignable.html "cpp/named req/CopyAssignable").

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/future/operator%3D&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  a `std::experimental::future` that will transfer state to *this  
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/future/operator%3D&action=edit&section=2 "Edit section: Return value")] Return value
