...
---|---|---  
template< class... B >  
struct conjunction; |  |  (library fundamentals TS v2)  
| |   
...
The specialization std::experimental::conjunction<B1, ..., BN> has a public and unambiguous base that is 
  ...
  * if sizeof...(B) == 0, [std::true_type](../types/integral_constant.html); otherwise 
...
### Possible implementation
    ...
    struct conjunction<B1, Bn...> 
        : [std::conditional_t](../types/conditional.html)<bool(B1::value), conjunction<Bn...>, B1> {};  
...
Run this code
    ...
    constexpr [std::enable_if_t](../types/enable_if.html)<std::experimental::conjunction_v<[std::is_same](../types/is_same.html)<T, Ts>...>>
    func(T, Ts...)
    {
        [std::cout](../io/cout.html) << "All types are the same.\n";
    }
     
    template<typename T, typename... Ts>
    constexpr [std::enable_if_t](../types/enable_if.html)<!std::experimental::conjunction_v<[std::is_same](../types/is_same.html)<T, Ts>...>>
    func(T, Ts...)
    {
        [std::cout](../io/cout.html) << "Types differ.\n";
    }
     
    int main()
    {
