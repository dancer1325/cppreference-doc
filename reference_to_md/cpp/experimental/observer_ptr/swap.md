...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/observer_ptr/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  another observer_ptr object to swap the watched object with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/observer_ptr/swap&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/observer_ptr/swap&action=edit&section=3 "Edit section: Example")] Example
