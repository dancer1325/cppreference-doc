...
template< class W >  
bool operator==( const observer_ptr<W>& p, [std::nullptr_t](../../types/nullptr_t.html) ) noexcept; |  (3)  |  (library fundamentals TS v2)  
template< class W >  
bool operator==( [std::nullptr_t](../../types/nullptr_t.html), const observer_ptr<W>& p ) noexcept; |  (4)  |  (library fundamentals TS v2)  
template< class W >  
bool operator!=( const observer_ptr<W>& p, [std::nullptr_t](../../types/nullptr_t.html) ) noexcept; |  (5)  |  (library fundamentals TS v2)  
template< class W >  
bool operator!=( [std::nullptr_t](../../types/nullptr_t.html), const observer_ptr<W>& p ) noexcept; |  (6)  |  (library fundamentals TS v2)  
template< class W1, class W2 >  
...
1,2) Equality comparison for two `observer_ptr`s.
...
7) [std::less](../../utility/functional/less.html)<W3>()(p1.get(), p2.get()), where `W3` is the composite pointer type of `W1*` and `W2*`.
