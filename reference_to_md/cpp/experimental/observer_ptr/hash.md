...
---|---|---  
template< class T > struct hash<[std::experimental::observer_ptr](../observer_ptr.html)<T>>; |  |  (library fundamentals TS v2)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [std::experimental::observer_ptr](../observer_ptr.html)<T> allows users to obtain hashes of objects of type [std::experimental::observer_ptr](../observer_ptr.html)<T>. 

For a given [std::experimental::observer_ptr](../observer_ptr.html)<T> p, this specialization ensures that [std::hash](../../utility/hash.html)<[std::experimental::observer_ptr](../observer_ptr.html)<T>>()(p) == [std::hash](../../utility/hash.html)<T*>()(p.get()). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/observer_ptr/hash&action=edit&section=1 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/observer_ptr/hash&action=edit&section=2 "Edit section: See also")] See also
