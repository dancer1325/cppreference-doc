...
Specializes the swap algorithm for [std::experimental::observer_ptr](../observer_ptr.html "cpp/experimental/observer ptr"). Swaps the pointers of lhs and rhs. Calls lhs.swap(rhs). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/observer_ptr/swap2&action=edit&section=1 "Edit section: Parameters")] Parameters

lhs, rhs  |  \-  |  `observer_ptr`s whose contents to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/observer_ptr/swap2&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/observer_ptr/swap2&action=edit&section=3 "Edit section: Complexity")] Complexity

Constant. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/observer_ptr/swap2&action=edit&section=4 "Edit section: See also")] See also
...
---|---  
[ swap](swap.html "cpp/experimental/observer ptr/swap") |  swaps the watched objects   
