...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/synchronized_pool_resource/upstream_resource&action=edit&section=1 "Edit section: See also")] See also 

[ (constructor)](synchronized_pool_resource.html "cpp/experimental/synchronized pool resource/synchronized pool resource") |  constructs a `synchronized_pool_resource`   
