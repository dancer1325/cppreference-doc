...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/synchronized_pool_resource/do_is_equal&action=edit&section=1 "Edit section: Return value")] Return value

this == dynamic_cast<const synchronized_pool_resource*>(&other)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/synchronized_pool_resource/do_is_equal&action=edit&section=2 "Edit section: See also")] See also
