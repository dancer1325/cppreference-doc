...
1) Initializes the exit function with a function or function object, and initializes the counter of uncaught exceptions as if with [std::uncaught_exceptions](../../error/exception/uncaught_exception.html)(). The constructed `scope_fail` is active.
...
This overload participates in overload resolution only if [std::is_same_v](../../types/is_same.html)<[std::remove_cvref_t](../../types/remove_cvref.html)<Fn>, scope_fail> is false and [std::is_constructible_v](../../types/is_constructible.html)<EF, Fn> is true.
...
3) `scope_fail` is not [CopyConstructible](../../named_req/CopyConstructible.html "cpp/named req/CopyConstructible").

## Contents

  * [1 Parameters](scope_fail.html#Parameters)
  * [2 Exceptions](scope_fail.html#Exceptions)
  * [3 Example](scope_fail.html#Example)
  * [4 See also](scope_fail.html#See_also)
