...
T* allocate( [std::size_t](../../types/size_t.html) n ); |  |  (library fundamentals TS)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/polymorphic_allocator/allocate&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  the number of objects to allocate storage for   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/polymorphic_allocator/allocate&action=edit&section=2 "Edit section: Return value")] Return value

A pointer to the allocated storage. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/polymorphic_allocator/allocate&action=edit&section=3 "Edit section: See also")] See also
