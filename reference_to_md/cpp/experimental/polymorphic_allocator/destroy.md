...
template< class U >  
void destroy( U* p ); |  |  (library fundamentals TS)  
---|---|---  
| |   
  
Destroys the object pointed to by p, as if by calling p->~U(). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/polymorphic_allocator/destroy&action=edit&section=1 "Edit section: Parameters")] Parameters

p  |  \-  |  pointer to the object being destroyed   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/polymorphic_allocator/destroy&action=edit&section=2 "Edit section: See also")] See also

[ destroy](../../memory/allocator_traits/destroy.html "cpp/memory/allocator traits/destroy")[static] |  destructs an object stored in the allocated storage   
