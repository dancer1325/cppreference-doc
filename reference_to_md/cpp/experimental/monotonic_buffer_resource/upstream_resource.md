...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/monotonic_buffer_resource/upstream_resource&action=edit&section=1 "Edit section: See also")] See also 

[ (constructor)](monotonic_buffer_resource.html "cpp/experimental/monotonic buffer resource/monotonic buffer resource") |  constructs a `monotonic_buffer_resource`   
