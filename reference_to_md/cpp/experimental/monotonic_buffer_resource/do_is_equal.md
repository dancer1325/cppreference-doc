...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/monotonic_buffer_resource/do_is_equal&action=edit&section=1 "Edit section: Return value")] Return value

this == dynamic_cast<const monotonic_buffer_resource*>(&other)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/monotonic_buffer_resource/do_is_equal&action=edit&section=2 "Edit section: See also")] See also
