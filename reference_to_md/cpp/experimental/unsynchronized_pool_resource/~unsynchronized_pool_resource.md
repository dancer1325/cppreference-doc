...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/unsynchronized_pool_resource/%7Eunsynchronized_pool_resource&action=edit&section=1 "Edit section: See also")] See also 

[ release](release.html "cpp/experimental/unsynchronized pool resource/release") |  release all allocated memory   
