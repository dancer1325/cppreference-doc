...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/unsynchronized_pool_resource/options&action=edit&section=1 "Edit section: See also")] See also 
