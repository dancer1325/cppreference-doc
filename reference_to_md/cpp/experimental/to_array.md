...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/to_array&action=edit&section=1 "Edit section: Parameters")] Parameters

a  |  \-  |  the built-in array to be used to initialize the [std::array](../container/array.html "cpp/container/array")  
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/to_array&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/to_array&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/to_array&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/to_array&action=edit&section=5 "Edit section: See also")] See also
