...
[ (constructor)](scope_exit.html "cpp/experimental/scope exit/scope exit") |  constructs a new `scope_exit`   
...
---|---  
[ (destructor)](~scope_exit.html "cpp/experimental/scope exit/~scope exit") |  calls the exit function when the scope is exited if the `scope_exit` is active, then destroys the `scope_exit`   
