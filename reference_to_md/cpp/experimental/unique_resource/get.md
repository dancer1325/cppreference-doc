...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/unique_resource/get&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/unique_resource/get&action=edit&section=2 "Edit section: Return value")] Return value

The underlying resource handle. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/unique_resource/get&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/unique_resource/get&action=edit&section=4 "Edit section: See also")] See also

[ operator*operator->](operator*.html "cpp/experimental/unique resource/operator*") |  accesses the pointee if the resource handle is a pointer   
...
---|---  
[ get](../../memory/unique_ptr/get.html "cpp/memory/unique ptr/get") |  returns a pointer to the managed object   
(public member function of `std::unique_ptr<T,Deleter>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/memory/unique_ptr/dsc_get&action=edit)
