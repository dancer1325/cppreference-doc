...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/unique_resource/%7Eunique_resource&action=edit&section=1 "Edit section: See also")] See also
...
(public member function of `std::unique_ptr<T,Deleter>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/memory/unique_ptr/dsc_destructor&action=edit)
