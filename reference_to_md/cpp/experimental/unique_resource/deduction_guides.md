...
unique_resource( R, D ) -> unique_resource<R, D>; |  |  (library fundamentals TS v3)  
| |   
  
One [deduction guide](../../language/ctad.html "cpp/language/class template argument deduction") is provided for std::experimental::unique_resource to permit deduction from given resource handle and deleter. 

The arguments (after [array-to-pointer](../../language/implicit_cast.html#Array_to_pointer_conversion "cpp/language/implicit conversion") and [function-to-pointer](../../language/implicit_cast.html#Function_to_pointer "cpp/language/implicit conversion") decay, if any) are copied or moved into the constructed `unique_resource`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/unique_resource/deduction_guides&action=edit&section=1 "Edit section: Example")] Example
