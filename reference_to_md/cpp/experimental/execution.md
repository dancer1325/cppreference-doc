...
| [Execution concepts](execution.html#Execution_concepts "cpp/execution")  
---  
|  | [scheduler](../execution/scheduler.html "cpp/execution/scheduler")  
---  
[receiver](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/receiver&action=edit&redlink=1 "cpp/execution/receiver \(page does not exist\)")  
[receiver_of](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/receiver_of&action=edit&redlink=1 "cpp/execution/receiver of \(page does not exist\)")  
[operation_state](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/operation_state&action=edit&redlink=1 "cpp/execution/operation state \(page does not exist\)")` `  
  
| [sender](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/sender&action=edit&redlink=1 "cpp/execution/sender \(page does not exist\)")  
---  
[sender_in](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/sender_in&action=edit&redlink=1 "cpp/execution/sender in \(page does not exist\)")  
[sender_to](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/sender_to&action=edit&redlink=1 "cpp/execution/sender to \(page does not exist\)")  
  
  
  
[Execution components](execution.html#Execution_components "cpp/execution")  
[Execution contexts](execution.html#Execution_contexts "cpp/execution")  
[run_loop](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/run_loop&action=edit&redlink=1 "cpp/execution/run loop \(page does not exist\)")  
[Execution domains](execution.html#Execution_domains "cpp/execution")  
[default_domain](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/default_domain&action=edit&redlink=1 "cpp/execution/default domain \(page does not exist\)")  
[Forward progress guarantee](execution.html#Forward_progress_guarantee "cpp/execution")  
[forward_progress_guarantee](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/forward_progress_guarantee&action=edit&redlink=1 "cpp/execution/forward progress guarantee \(page does not exist\)")  
[Environments](execution.html#Environments "cpp/execution")  
|  | [empty_env](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/empty_env&action=edit&redlink=1 "cpp/execution/empty env \(page does not exist\)")` `  
---  
  
| [get_env](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/get_env&action=edit&redlink=1 "cpp/execution/get env \(page does not exist\)")` `  
---  
  
| [env_of_t](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/env_of_t&action=edit&redlink=1 "cpp/execution/env of t \(page does not exist\)")  
---  
  
[Queries](execution.html#Queries "cpp/execution")  
[std::stop_token_of_t](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/stop_token_of_t&action=edit&redlink=1 "cpp/execution/stop token of t \(page does not exist\)")  
[std::get_stop_token](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/get_stop_token&action=edit&redlink=1 "cpp/execution/get stop token \(page does not exist\)")  
[std::get_allocator](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/get_allocator&action=edit&redlink=1 "cpp/execution/get allocator \(page does not exist\)")  
[std::forwarding_query](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/forwarding_query&action=edit&redlink=1 "cpp/execution/forwarding query \(page does not exist\)")  
[get_scheduler](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/get_scheduler&action=edit&redlink=1 "cpp/execution/get scheduler \(page does not exist\)")  
[get_domain](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/get_domain&action=edit&redlink=1 "cpp/execution/get domain \(page does not exist\)")  
[get_forward_progress_guarantee](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/get_forward_progress_guarantee&action=edit&redlink=1 "cpp/execution/get forward progress guarantee \(page does not exist\)")  
[get_delegation_scheduler](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/get_delegation_scheduler&action=edit&redlink=1 "cpp/execution/get delegation scheduler \(page does not exist\)")  
[get_completion_scheduler](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/get_completion_scheduler&action=edit&redlink=1 "cpp/execution/get completion scheduler \(page does not exist\)")  
[Completion signatures](execution.html#Completion_signatures "cpp/execution")  
[completion_signatures](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/completion_signatures&action=edit&redlink=1 "cpp/execution/completion signatures \(page does not exist\)")  
[completion_signatures_of_t](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/completion_signatures_of_t&action=edit&redlink=1 "cpp/execution/completion signatures of t \(page does not exist\)")  
[transform_completion_signatures](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/transform_completion_signatures&action=edit&redlink=1 "cpp/execution/transform completion signatures \(page does not exist\)")  
[transform_completion_signatures_of](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/transform_completion_signatures_of&action=edit&redlink=1 "cpp/execution/transform completion signatures of \(page does not exist\)")` `  
|  | [value_types_of_t](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/value_types_of_t&action=edit&redlink=1 "cpp/execution/value types of t \(page does not exist\)")  
---  
[error_types_of_t](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/error_types_of_t&action=edit&redlink=1 "cpp/execution/error types of t \(page does not exist\)")` `  
  
| [tag_of_t](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/tag_of_t&action=edit&redlink=1 "cpp/execution/tag of t \(page does not exist\)")  
---  
[sends_stopped](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/sends_stopped&action=edit&redlink=1 "cpp/execution/sends stopped \(page does not exist\)")` `  
  
[Sender adaptor closures](execution.html#Sender_adaptor_closures "cpp/execution")  
[sender_adaptor_closure](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/sender_adaptor_closure&action=edit&redlink=1 "cpp/execution/sender adaptor closure \(page does not exist\)")  
[Coroutine utility](execution.html#Coroutine_utility "cpp/execution")  
[as_awaitable](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/as_awaitable&action=edit&redlink=1 "cpp/execution/as awaitable \(page does not exist\)")  
[with_awaitable_senders](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/with_awaitable_senders&action=edit&redlink=1 "cpp/execution/with awaitable senders \(page does not exist\)")  
  
| [Core operations](execution.html#Core_operations "cpp/execution")  
---  
[Operation state](execution.html#Operation_state "cpp/execution")  
[connect  
connect_result_t](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/connect&action=edit&redlink=1 "cpp/execution/connect \(page does not exist\)")  
[start](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/start&action=edit&redlink=1 "cpp/execution/start \(page does not exist\)")  
[Completion](execution.html#Completion "cpp/execution")  
[set_value](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/set_value&action=edit&redlink=1 "cpp/execution/set value \(page does not exist\)")  
[set_error](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/set_error&action=edit&redlink=1 "cpp/execution/set error \(page does not exist\)")  
[set_stopped](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/set_stopped&action=edit&redlink=1 "cpp/execution/set stopped \(page does not exist\)")  
[Transformation](execution.html#Transformation "cpp/execution")  
[transform_env](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/transform_env&action=edit&redlink=1 "cpp/execution/transform env \(page does not exist\)")  
[transform_sender](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/transform_sender&action=edit&redlink=1 "cpp/execution/transform sender \(page does not exist\)")  
[apply_sender](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/apply_sender&action=edit&redlink=1 "cpp/execution/apply sender \(page does not exist\)")  
[Sender algorithms](execution.html#Sender_algorithms "cpp/execution")  
[Sender factories](execution.html#Sender_factories "cpp/execution")  
[just](../execution/just.html "cpp/execution/just")  
[just_error](../execution/just_error.html "cpp/execution/just error")  
[just_stopped](../execution/just_stopped.html "cpp/execution/just stopped")  
[read_env](../execution/read_env.html "cpp/execution/read env")  
[schedule  
schedule_result_t](../execution/schedule.html "cpp/execution/schedule")  
[Sender adaptors](execution.html#Sender_adaptors "cpp/execution")  
| [starts_on](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/starts_on&action=edit&redlink=1 "cpp/execution/starts on \(page does not exist\)")  
---  
[continues_on](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/continues_on&action=edit&redlink=1 "cpp/execution/continues on \(page does not exist\)")` `  
[on](../execution/on.html "cpp/execution/on")  
[then](../execution/then.html "cpp/execution/then")  
[upon_error](../execution/upon_error.html "cpp/execution/upon error")  
[upon_stopped](../execution/upon_stopped.html "cpp/execution/upon stopped")  
[let_value](../execution/let_value.html "cpp/execution/let value")  
[let_error](../execution/let_error.html "cpp/execution/let error")  
[let_stopped](../execution/let_stopped.html "cpp/execution/let stopped")  
[schedule_from](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/schedule_from&action=edit&redlink=1 "cpp/execution/schedule from \(page does not exist\)")  
[when_all](../execution/when_all.html "cpp/execution/when all")  
  
| [when_all_with_variant](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/when_all_with_variant&action=edit&redlink=1 "cpp/execution/when all with variant \(page does not exist\)")  
---  
[into_variant](../execution/into_variant.html "cpp/execution/into variant")  
[stopped_as_optional](../execution/stopped_as_optional.html "cpp/execution/stopped as optional")  
[stopped_as_error](../execution/stopped_as_error.html "cpp/execution/stopped as error")  
[bulk](../execution/bulk.html "cpp/execution/bulk")  
[split](https://en.cppreference.com/mwiki/index.php?title=cpp/execution/split&action=edit&redlink=1 "cpp/execution/split \(page does not exist\)")  
...
[Sender consumers](execution.html#Sender_consumers "cpp/execution")  
[this_thread::sync_wait](../thread/this_thread/sync_wait.html "cpp/thread/this thread/sync wait")  
[this_thread::sync_wait_with_variant](https://en.cppreference.com/mwiki/index.php?title=cpp/thread/this_thread/sync_wait_with_variant&action=edit&redlink=1 "cpp/thread/this thread/sync wait with variant \(page does not exist\)")  
...
## Contents
  ...
  * [1 Library-wide definitions](execution.html#Library-wide_definitions)
  * [2 Library utilities](execution.html#Library_utilities)
    * [2.1 Concepts](execution.html#Concepts)
      * [2.1.1 Schedulers](execution.html#Schedulers)
      * [2.1.2 Senders](execution.html#Senders)
      * [2.1.3 Receivers](execution.html#Receivers)
      * [2.1.4 Operation states](execution.html#Operation_states)
    * [2.2 Utility components](execution.html#Utility_components)
      * [2.2.1 Execution contexts](execution.html#Execution_contexts)
      * [2.2.2 Execution domains](execution.html#Execution_domains)
      * [2.2.3 Forward progress guarantee](execution.html#Forward_progress_guarantee)
      * [2.2.4 Environments](execution.html#Environments)
      * [2.2.5 Queries](execution.html#Queries)
      * [2.2.6 Completion signatures](execution.html#Completion_signatures)
      * [2.2.7 Coroutine utility](execution.html#Coroutine_utility)
    * [2.3 Core operations](execution.html#Core_operations)
      * [2.3.1 Operation state](execution.html#Operation_state)
      * [2.3.2 Completion functions](execution.html#Completion_functions)
    * [2.4 Sender algorithms](execution.html#Sender_algorithms)
      * [2.4.1 Sender factories](execution.html#Sender_factories)
      * [2.4.2 Pipeable sender adaptors](execution.html#Pipeable_sender_adaptors)
      * [2.4.3 Sender adaptors](execution.html#Sender_adaptors)
      * [2.4.4 Sender consumers](execution.html#Sender_consumers)
    * [2.5 Example](execution.html#Example)
    * [2.6 See also](execution.html#See_also)
...
Run this code
    ...
     
        [std::jthread](../thread/jthread.html) worker([&]([std::stop_token](../thread/stop_token.html) st)
        {
            [std::stop_callback](../thread/stop_callback.html) cb{st, [&]{ loop.finish(); }};
            loop.run();
        });
     
        ...
        std::execution::sender auto print
            = std::move(hello)
            | std::execution::then([]([std::string](../string/basic_string.html) msg)
            {
                return [std::puts](../io/c/puts.html)(msg.c_str());
            });
     
