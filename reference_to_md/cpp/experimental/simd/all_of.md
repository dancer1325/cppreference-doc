...
bool all_of( const simd_mask<T, Abi>& k ); |  (1)  |  (parallelism TS v2)  
template< class T, class Abi >  
bool any_of( const simd_mask<T, Abi>& k ); |  (2)  |  (parallelism TS v2)  
template< class T, class Abi >  
bool none_of( const simd_mask<T, Abi>& k ); |  (3)  |  (parallelism TS v2)  
template< class T, class Abi >  
bool some_of( const simd_mask<T, Abi>& k ); |  (4)  |  (parallelism TS v2)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/all_of&action=edit&section=1 "Edit section: Parameters")] Parameters

k  |  \-  |  the [`simd_mask`](simd_mask.html "cpp/experimental/simd/simd mask") to apply the reduction to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/all_of&action=edit&section=2 "Edit section: Return value")] Return value

The boolean result of the horizontal reduction. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/all_of&action=edit&section=3 "Edit section: Example")] Example
