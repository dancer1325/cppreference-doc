...
Applies the given comparison element-wise to each corresponding element of the operands. Returns a [`simd_mask`](../simd_mask.html "cpp/experimental/simd/simd mask") such that for all i in the range of `[`​0​`, `[`size()`](size.html "cpp/experimental/simd/simd/size")`)` the ith element equals: 
...
Run this code
    ...
     
        auto assert_equivalence = [](M&& x, [std::initializer_list](../../../utility/initializer_list.html)<int>&& y)
        {
            for (decltype(M::size()) i{}; i != M::size(); ++i)
                [assert](../../../error/assert.html)(x[i] == [std::cbegin](../../../iterator/begin.html)(y)[i]);
        };
     
        V a{2}, b, c{3};
