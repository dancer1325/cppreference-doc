...
The store function copies all elements of a [`simd`](../simd.html "cpp/experimental/simd/simd") such that the i-th element is converted to `U` and subsequently written to mem[i] for all i in the range of `[`​0​`, `[`size()`](size.html "cpp/experimental/simd/simd/size")`)`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/simd/copy_to&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/simd/copy_to&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        alignas(stdx::memory_alignment_v<stdx::native_simd<int>>)
            [std::array](../../../container/array.html)<int, stdx::native_simd<int>::size()> mem = {};
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/simd/copy_to&action=edit&section=3 "Edit section: See also")] See also
