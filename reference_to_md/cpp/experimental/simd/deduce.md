...
struct deduce; |  |  (parallelism TS v2)  
| |   
...
Let `DA` denote deduce<T, N, Abis...>::type when it presents, then 
  ...
  * `DA` is [`simd_abi::scalar`](scalar.html "cpp/experimental/simd/scalar") if N == 1, otherwise it is implementation-defined. 



## Contents

  * [1 Member types](deduce.html#Member_types)
  * [2 Helper types](deduce.html#Helper_types)
  * [3 Notes](deduce.html#Notes)
  * [4 Example](deduce.html#Example)
  * [5 See also](deduce.html#See_also)
