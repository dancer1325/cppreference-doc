...
struct simd_size; |  |  (parallelism TS v2)  
| |   
...
## Contents
  ...
  * [1 Helper variable template](simd_size.html#Helper_variable_template)
  * [2 Inherited from std::integral_constant](simd_size.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](simd_size.html#Member_constants)
    * [2.2 Member functions](simd_size.html#Member_functions)
    * [2.3 Member types](simd_size.html#Member_types)
    * [2.4 Example](simd_size.html#Example)
    * [2.5 See also](simd_size.html#See_also)
...
value[static] |  the width of `simd<T, Abi>`   
