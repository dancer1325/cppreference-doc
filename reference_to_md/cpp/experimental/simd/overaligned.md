...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/overaligned&action=edit&section=1 "Edit section: Template parameters")] Template parameters

N  |  \-  |  the alignment in bytes the memory access may assume   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/overaligned&action=edit&section=2 "Edit section: See also")] See also
