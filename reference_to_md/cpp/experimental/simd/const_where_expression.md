...
[Member functions](const_where_expression.html#Member_functions "cpp/experimental/simd/const where expression")  
---  
| [operator-  
operator+  
operator~](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/const_where_expression/operator_arith&action=edit&redlink=1 "cpp/experimental/simd/const where expression/operator arith \(page does not exist\)")  
---  
...
class const_where_expression; |  |  (parallelism TS v2)  
| |   
