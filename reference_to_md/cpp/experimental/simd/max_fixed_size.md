...
---|---|---  
template< class T >  
constexpr int max_fixed_size = /*implementation-defined*/; |  |  (parallelism TS v2)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/max_fixed_size&action=edit&section=1 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/max_fixed_size&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << stq::simd_abi::max_fixed_size<[std::uint8_t](../../types/integer.html)> << ' ';
        [std::cout](../../io/cout.html) << stq::simd_abi::max_fixed_size<[std::uint64_t](../../types/integer.html)> << ' ';
        [std::cout](../../io/cout.html) << stq::simd_abi::max_fixed_size<float> << ' ';
        [std::cout](../../io/cout.html) << stq::simd_abi::max_fixed_size<long double> << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/simd/max_fixed_size&action=edit&section=3 "Edit section: See also")] See also
