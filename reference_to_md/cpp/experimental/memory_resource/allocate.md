...
[memory_resource::do_deallocate](do_deallocate.html "cpp/experimental/memory resource/do deallocate")  
...
void* allocate( [std::size_t](../../types/size_t.html) bytes, [std::size_t](../../types/size_t.html) alignment = alignof([std::max_align_t](../../types/max_align_t.html)) ); |  |  (library fundamentals TS)  
---|---|---  
| |   
  
Allocates storage with a size of at least bytes bytes. The returned storage is aligned to the specified alignment if such alignment is supported, and to alignof([std::max_align_t](../../types/max_align_t.html)) otherwise. 

Equivalent to return do_allocate(bytes, alignment);. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/memory_resource/allocate&action=edit&section=1 "Edit section: Exceptions")] Exceptions

Throws an exception if storage of the requested size and alignment cannot be obtained. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/memory_resource/allocate&action=edit&section=2 "Edit section: See also")] See also

[ do_allocate](do_allocate.html "cpp/experimental/memory resource/do allocate")[virtual] |  allocates memory   
