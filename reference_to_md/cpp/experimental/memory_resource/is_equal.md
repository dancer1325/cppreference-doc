...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/memory_resource/is_equal&action=edit&section=1 "Edit section: See also")] See also

[ do_is_equal](do_is_equal.html "cpp/experimental/memory resource/do is equal")[virtual] |  compare for equality with another `memory_resource`   
