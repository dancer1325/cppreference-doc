...
---|---|---  
`Traits::compare(data(), v.data(), rlen) < 0` |  `this` is _less_ than `v` |  <0  
`Traits::compare(data(), v.data(), rlen) == 0` |  `size() < v.size()` |  `this` is _less_ than `v` |  <0  
`size() == v.size()` |  `this` is _equal_ to `v` |  ​0​  
`size() > v.size()` |  `this` is _greater_ than `v` |  >0  
`Traits::compare(data(), v.data(), rlen) > 0` |  `this` is _greater_ than `v` |  >0  
...
## Contents
  ...
  * [3 Complexity](compare.html#Complexity)
  * [4 See also](compare.html#See_also)
