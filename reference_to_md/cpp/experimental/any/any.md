...
---  
**any::any**  
[any::operator=](operator=.html "cpp/experimental/any/operator=")  
Modifiers  
...
4) Constructs an object with initial content an object of type [std::decay_t](../../types/decay.html)<ValueType>, [direct-initialized](../../language/direct_initialization.html "cpp/language/direct initialization") from [std::forward](../../utility/forward.html)<ValueType>(value). If [std::is_copy_constructible](../../types/is_copy_constructible.html)<[std::decay_t](../../types/decay.html)<ValueType>>::value is false, the program is ill-formed. This overload participates in overload resolution only if [std::decay_t](../../types/decay.html)<ValueType> is not the same type as any.
...
## Contents
  ...
  * [4 See also](any.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/any/any&action=edit&section=1 "Edit section: Template parameters")] Template parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/any/any&action=edit&section=2 "Edit section: Parameters")] Parameters

other  |  \-  |  another `any` object to copy or move from   
---|---|---  
value  |  \-  |  value to initialize the contained value with   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/any/any&action=edit&section=3 "Edit section: Exceptions")] Exceptions

2,4) Throws any exception thrown by the constructor of the contained type.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/any/any&action=edit&section=4 "Edit section: See also")] See also

[ operator=](operator=.html "cpp/experimental/any/operator=") |  assigns an `any` object   
