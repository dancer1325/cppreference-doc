...
---|---|---  
class bad_any_cast : public [std::bad_cast](../../types/bad_cast.html); |  |  (library fundamentals TS)  
| |   
  
Defines a type of object to be thrown by the value-returning forms of [std::experimental::any_cast](any_cast.html "cpp/experimental/any/any cast") on failure. 

## Contents

  * [1 Member functions](bad_any_cast.html#Member_functions)
  * [2 std::experimental::bad_any_cast::bad_any_cast](bad_any_cast.html#std::experimental::bad_any_cast::bad_any_cast)
    * [2.1 Parameters](bad_any_cast.html#Parameters)
  * [3 std::experimental::bad_any_cast::operator=](bad_any_cast.html#std::experimental::bad_any_cast::operator.3D)
    * [3.1 Parameters](bad_any_cast.html#Parameters_2)
    * [3.2 Return value](bad_any_cast.html#Return_value)
  * [4 std::experimental::bad_any_cast::what](bad_any_cast.html#std::experimental::bad_any_cast::what)
...
2) Copy constructor. If *this and other both have dynamic type `std::experimental::bad_any_cast` then [std::strcmp](../../string/byte/strcmp.html)(what(), other.what()) == 0.
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::experimental::bad_any_cast` then [std::strcmp](../../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment. 
