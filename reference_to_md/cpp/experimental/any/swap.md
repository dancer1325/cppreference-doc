...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/any/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  object to swap with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/any/swap&action=edit&section=2 "Edit section: Return value")] Return value
