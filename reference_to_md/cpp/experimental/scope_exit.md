...
Member functions  
---  
[scope_exit::scope_exit](scope_exit/scope_exit.html "cpp/experimental/scope exit/scope exit")  
[scope_exit::~scope_exit](scope_exit/~scope_exit.html "cpp/experimental/scope exit/~scope exit")  
Modifiers  
[scope_exit::release](scope_exit/release.html "cpp/experimental/scope exit/release")  
[Deduction guides](scope_exit/deduction_guides.html "cpp/experimental/scope exit/deduction guides")  
...
## Contents
  ...
  * [1 Template parameters](scope_exit.html#Template_parameters)
  * [2 Member functions](scope_exit.html#Member_functions)
    * [2.1 Modifiers](scope_exit.html#Modifiers)
  * [3 Deduction guides](scope_exit.html#Deduction_guides)
  * [4 Notes](scope_exit.html#Notes)
  * [5 Example](scope_exit.html#Example)
  * [6 See also](scope_exit.html#See_also)
...
[ (constructor)](scope_exit/scope_exit.html "cpp/experimental/scope exit/scope exit") |  constructs a new `scope_exit`   
...
---|---  
[ (destructor)](scope_exit/~scope_exit.html "cpp/experimental/scope exit/~scope exit") |  calls the exit function when the scope is exited if the `scope_exit` is active, then destroys the `scope_exit`   
...
operator=[deleted] |  `scope_exit` is not assignable   
(public member function)  
  
#####  Modifiers   
  
[ release](scope_exit/release.html "cpp/experimental/scope exit/release") |  makes the `scope_exit` inactive   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/experimental/scope_guard&action=edit&section=T-3 "Template:cpp/experimental/scope guard")] [Deduction guides](scope_exit/deduction_guides.html "cpp/experimental/scope exit/deduction guides")
