...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/flex_barrier/arrive_and_wait&action=edit&section=1 "Edit section: Notes")] Notes 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/flex_barrier/arrive_and_wait&action=edit&section=2 "Edit section: Exceptions")] Exceptions 

Throws nothing. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/flex_barrier/arrive_and_wait&action=edit&section=3 "Edit section: See also")] See also 

[ arrive_and_drop](arrive_and_drop.html "cpp/experimental/flex barrier/arrive and drop") |  arrive at the synchronization point and remove the current thread from the set of participating threads   
