...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/xor&action=edit&section=1 "Edit section: Usage")] Usage

  * [alternative operators](../language/operator_alternative.html "cpp/language/operator alternative"): as an alternative for `^`



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/xor&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/xor&action=edit&section=3 "Edit section: See also")] See also
