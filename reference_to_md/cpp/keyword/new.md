...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/new&action=edit&section=1 "Edit section: Usage")] Usage

  * [`new` expression](../language/new.html "cpp/language/new")
  * [allocation functions](../memory/new/operator_new.html "cpp/memory/new/operator new") as the name of operator-like functions 
