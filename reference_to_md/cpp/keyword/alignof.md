...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/alignof&action=edit&section=1 "Edit section: Usage")] Usage

  * [`alignof` operator](../language/alignof.html "cpp/language/alignof")



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/alignof&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../io/cout.html) << alignof([std::max_align_t](../types/max_align_t.html)) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/alignof&action=edit&section=3 "Edit section: See also")] See also

  * [`alignas`](alignas.html "cpp/keyword/alignas")
