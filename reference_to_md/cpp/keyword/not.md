...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/not&action=edit&section=1 "Edit section: Usage")] Usage

  * [alternative operators](../language/operator_alternative.html "cpp/language/operator alternative"): as an alternative for `!`



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/not&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    void show(bool z, const char* s, int n)
    {
        ...
        if (n <= 1) [std::cout](../io/cout.html) << "│ " <<s<< " │ "<<r<<" │\n";
        if (n == 1) [std::cout](../io/cout.html) << "└───────────┴─────────┘\n";
    }
     
    int main()
    {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/not&action=edit&section=3 "Edit section: See also")] See also
