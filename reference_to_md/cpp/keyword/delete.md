...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/delete&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `delete` expression](../language/delete.html "cpp/language/delete")
  * [ deallocation functions](../memory/new/operator_delete.html "cpp/memory/new/operator delete") as the name of operator-like functions 



  * [deleted functions](../language/function.html#Deleted_functions "cpp/language/function")

| (since C++11)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/delete&action=edit&section=2 "Edit section: See also")] See also

  * [`default`](default.html "cpp/keyword/default") (explicitly-defaulted function definition)
