...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/constexpr&action=edit&section=1 "Edit section: Usage")] Usage
  ...
  * [`constexpr` `if` statement](../language/if.html "cpp/language/if")
  * [_lambda-declarator_](../language/lambda.html "cpp/language/lambda") that explicitly specifies the function call to be a `constexpr` function 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/constexpr&action=edit&section=2 "Edit section: See also")] See also
  ...
  * [`consteval` `if` statement](../language/if.html#Consteval_if "cpp/language/if"): [`consteval`](consteval.html "cpp/keyword/consteval")

| (since C++23)  
---|---  
  
  * [`switch` statement](../language/switch.html "cpp/language/switch"): [`case`](case.html "cpp/keyword/case"), [`default`](default.html "cpp/keyword/default") (as the declaration of the default case label), [`switch`](switch.html "cpp/keyword/switch")
  * [`goto` statement](../language/goto.html "cpp/language/goto"): [`goto`](goto.html "cpp/keyword/goto")
  * [`continue` statement](../language/continue.html "cpp/language/continue"): [`continue`](continue.html "cpp/keyword/continue")
  * [`break` statement](../language/break.html "cpp/language/break"): [`break`](break.html "cpp/keyword/break")
  * [`return` statement](../language/return.html "cpp/language/return"): [`return`](return.html "cpp/keyword/return"), [`co_return`](co_return.html "cpp/keyword/co return")(since C++20)
  * [`do-while` loop](../language/do.html "cpp/language/do") and [`while` loop](../language/while.html "cpp/language/while"): [`do`](do.html "cpp/keyword/do"), [`while`](while.html "cpp/keyword/while")
  * [`for` loop](../language/for.html "cpp/language/for") and [range-based `for` loop](../language/range-for.html "cpp/language/range-for"): [`for`](for.html "cpp/keyword/for")
