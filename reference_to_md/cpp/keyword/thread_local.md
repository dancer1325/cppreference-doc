...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/thread_local&action=edit&section=1 "Edit section: Usage")] Usage

  * [thread local storage duration specifier](../language/storage_duration.html "cpp/language/storage duration")



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/thread_local&action=edit&section=2 "Edit section: See also")] See also

[C documentation](../../c/thread/thread_local.html "c/thread/thread local") for thread_local  
---
