...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/for&action=edit&section=1 "Edit section: Usage")] Usage

  * [`for`](../language/for.html "cpp/language/for") loop: as the declaration of the loop 



  * range-based [`for`](../language/range-for.html "cpp/language/range-for") loop: as the declaration of the loop 

| (since C++11)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/for&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/for&action=edit&section=3 "Edit section: See also")] See also
