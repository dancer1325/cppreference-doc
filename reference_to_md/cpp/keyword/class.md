...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/class&action=edit&section=1 "Edit section: Usage")] Usage

  * [declaration of a class](../language/class.html "cpp/language/class")



  * [declaration of a scoped enumeration type](../language/enum.html "cpp/language/enum")

| (since C++11)  
---|---  
  
  * In a [template declaration](../language/templates.html "cpp/language/templates"), class can be used to introduce [type template parameters](../language/template_parameters.html#Type_template_parameter "cpp/language/template parameters") and [template template parameters](../language/template_parameters.html#Template_template_parameter "cpp/language/template parameters")
  * If a function or a variable exists in scope with the name identical to the name of a class type, class can be prepended to the name for disambiguation, resulting in an [elaborated type specifier](../language/elaborated_type_specifier.html "cpp/language/elaborated type specifier"). 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/class&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/class&action=edit&section=3 "Edit section: See also")] See also

  * [`struct`](struct.html "cpp/keyword/struct"), [`union`](union.html "cpp/keyword/union")
...
---|---  
  ...
  * [`concept`](concept.html "cpp/keyword/concept"), [`requires`](requires.html "cpp/keyword/requires")
