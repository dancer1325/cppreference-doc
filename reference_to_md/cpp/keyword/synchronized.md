...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/synchronized&action=edit&section=1 "Edit section: Usage")] Usage

  * [Synchronized block](../language/transactional_memory.html#Synchronized_blocks "cpp/language/transactional memory"), executed in single total order with all synchronized blocks (TM TS)



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/synchronized&action=edit&section=2 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/synchronized&action=edit&section=3 "Edit section: See also")] See also
