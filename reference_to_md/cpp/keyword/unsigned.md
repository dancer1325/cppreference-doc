...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/unsigned&action=edit&section=1 "Edit section: Usage")] Usage

  * [`unsigned` type modifier](../language/types.html#Modifiers "cpp/language/types")



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/unsigned&action=edit&section=2 "Edit section: See also")] See also
  ...
  * [Fundamental types](../language/types.html "cpp/language/types"): [`void`](void.html "cpp/keyword/void"), [std::nullptr_t](../types/nullptr_t.html "cpp/types/nullptr t")(since C++11). 
    * [Integral types](../language/types.html#Integral_types "cpp/language/types"): [`int`](int.html "cpp/keyword/int"). [Modifiers](../language/types.html#Modifiers "cpp/language/types"): [`signed`](signed.html "cpp/keyword/signed"), **`unsigned`** , [`short`](short.html "cpp/keyword/short"), [`long`](long.html "cpp/keyword/long"). 
