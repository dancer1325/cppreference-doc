...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/requires&action=edit&section=1 "Edit section: Usage")] Usage

  * Specifies a constant expression on template parameters that [evaluate a requirement](../language/requires.html "cpp/language/requires"). 



    

  * Within such a requirement, introduces a [nested requirement](../language/requires.html#Nested_requirements "cpp/language/requires"). 



  * In a template declaration, specifies an [associated constraint](../language/constraints.html "cpp/language/constraints"). 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/requires&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/requires&action=edit&section=3 "Edit section: See also")] See also
