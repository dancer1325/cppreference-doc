...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/co_yield&action=edit&section=1 "Edit section: Usage")] Usage

  * [yields a value from a coroutine](../language/coroutines.html#co_yield "cpp/language/coroutines")



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/co_yield&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/co_yield&action=edit&section=3 "Edit section: See also")] See also

  * [`co_await`](co_await.html "cpp/keyword/co await")
