...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/else&action=edit&section=1 "Edit section: Usage")] Usage

  * [`if` statement](../language/if.html "cpp/language/if"): as the declaration of the alternative branch 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/else&action=edit&section=2 "Edit section: See also")] See also

  * [`if`](../language/if.html "cpp/language/if") statement: [`if`](../keywords/if.html "cpp/keyword/if")
