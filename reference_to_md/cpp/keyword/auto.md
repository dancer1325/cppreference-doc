...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/auto&action=edit&section=1 "Edit section: Usage")] Usage

  * [Automatic storage duration specifier](../language/storage_duration.html "cpp/language/storage duration")

| (until C++11)  
---|---  
  
  * [`auto` placeholder type specifier](../language/auto.html "cpp/language/auto")
  * [Function declaration](../language/function.html "cpp/language/function") with trailing return type 

| (since C++11)  
  
  * [Structured binding declaration](../language/structured_binding.html "cpp/language/structured binding")
...
| (since C++20)  
  ...
  * [Explicit cast to a prvalue copy](../language/explicit_cast.html "cpp/language/explicit cast")

| (since C++23)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/auto&action=edit&section=2 "Edit section: See also")] See also

  * [`decltype`](../keywords/decltype.html "cpp/keyword/decltype") (decltype(auto))

| (since C++14)  
---|---  
  
  * [`register`](register.html "cpp/keyword/register") (Automatic storage duration specifier)
