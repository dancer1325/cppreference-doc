...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/reinterpret_cast&action=edit&section=1 "Edit section: Usage")] Usage

  * [`reinterpret_cast` type conversion expression](../language/reinterpret_cast.html "cpp/language/reinterpret cast"): as the declaration of the expression 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/reinterpret_cast&action=edit&section=2 "Edit section: See also")] See also
