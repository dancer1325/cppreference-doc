...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/case&action=edit&section=1 "Edit section: Usage")] Usage

  * [`switch` statement](../language/switch.html "cpp/language/switch"): as the declaration of the case labels 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/case&action=edit&section=2 "Edit section: See also")] See also
...
| (since C++23)  
  ...
  * [`switch`](../language/switch.html "cpp/language/switch") statement: [`switch`](switch.html "cpp/keyword/switch")
