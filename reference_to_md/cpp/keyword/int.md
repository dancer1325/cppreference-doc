...
**int**  
[long](long.html "cpp/keyword/long")  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/int&action=edit&section=1 "Edit section: Usage")] Usage

  * [`short int` type](../language/types.html#Integral_types "cpp/language/types"): as the declaration of the type when combined with [`short`](short.html "cpp/keyword/short")
  * [`unsigned short int` type](../language/types.html#Integral_types "cpp/language/types"): as the declaration of the type when combined with [`unsigned`](unsigned.html "cpp/keyword/unsigned") and [`short`](short.html "cpp/keyword/short")
  * [`int` type](../language/types.html#Integral_types "cpp/language/types"): as the declaration of the type 
  * [`unsigned int` type](../language/types.html#Integral_types "cpp/language/types"): as the declaration of the type when combined with [`unsigned`](unsigned.html "cpp/keyword/unsigned")
  * [`long int` type](../language/types.html#Integral_types "cpp/language/types"): as the declaration of the type when combined with [`long`](long.html "cpp/keyword/long")
  * [`unsigned long int` type](../language/types.html#Integral_types "cpp/language/types"): as the declaration of the type when combined with [`unsigned`](unsigned.html "cpp/keyword/unsigned") and [`long`](long.html "cpp/keyword/long")



  * [`long long int` type](../language/types.html#Integral_types "cpp/language/types"): as the declaration of the type when combined with two [`long`s](long.html "cpp/keyword/long")
  * [`unsigned long long int` type](../language/types.html#Integral_types "cpp/language/types"): as the declaration of the type when combined with [`unsigned`](unsigned.html "cpp/keyword/unsigned") and two [`long`s](long.html "cpp/keyword/long")

| (since C++11)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/int&action=edit&section=2 "Edit section: See also")] See also
  ...
  * [Fundamental types](../language/types.html "cpp/language/types"): [`void`](void.html "cpp/keyword/void"), [std::nullptr_t](../types/nullptr_t.html "cpp/types/nullptr t")(since C++11). 
    * [Integral types](../language/types.html#Integral_types "cpp/language/types"): **`int`**. [Modifiers](../language/types.html#Modifiers "cpp/language/types"): [`signed`](signed.html "cpp/keyword/signed"), [`unsigned`](unsigned.html "cpp/keyword/unsigned"), [`short`](short.html "cpp/keyword/short"), [`long`](long.html "cpp/keyword/long"). 
