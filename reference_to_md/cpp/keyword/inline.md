...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/inline&action=edit&section=1 "Edit section: Usage")] Usage

  * [`inline` specifier](../language/inline.html "cpp/language/inline") for functions and variables(since C++17)



  * [`inline` `namespace`](../language/namespace.html "cpp/language/namespace") definition 
