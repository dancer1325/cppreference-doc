...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/switch&action=edit&section=1 "Edit section: Usage")] Usage

  * [`switch` statement](../language/switch.html "cpp/language/switch"): as the declaration of the statement 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/switch&action=edit&section=2 "Edit section: See also")] See also
...
| (since C++23)  
  ...
  * [`switch`](../language/switch.html "cpp/language/switch") statement: [`case`](case.html "cpp/keyword/case")
