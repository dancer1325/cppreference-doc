...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/using&action=edit&section=1 "Edit section: Usage")] Usage
  ...
  * [using-enum-declarations](../language/enum.html#Using-enum-declaration "cpp/language/enum") for enumerators 

| (since C++20)  
---|---  
  
  * [type alias and alias template declaration](../language/type_alias.html "cpp/language/type alias")
