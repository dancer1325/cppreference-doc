...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/mutable&action=edit&section=1 "Edit section: Usage")] Usage

  * [`mutable` type specifier](../language/cv.html "cpp/language/cv")



  * [_lambda-declarator_](../language/lambda.html "cpp/language/lambda") that removes `const` qualification from parameters captured by copy 

| (since C++11)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/mutable&action=edit&section=2 "Edit section: See also")] See also
