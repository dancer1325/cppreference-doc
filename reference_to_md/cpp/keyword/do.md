...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/do&action=edit&section=1 "Edit section: Usage")] Usage

  * [`do-while` loop](../language/do.html "cpp/language/do"): as the declaration of the loop 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/do&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/do&action=edit&section=3 "Edit section: See also")] See also
...
---|---  
  ...
  * [`do-while`](../language/do.html "cpp/language/do") loop and [`while` loop](../language/while.html "cpp/language/while"): [`while`](while.html "cpp/keyword/while")
