...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/and_eq&action=edit&section=1 "Edit section: Usage")] Usage

  * [alternative operators](../language/operator_alternative.html "cpp/language/operator alternative"): as an alternative for `&=`



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/and_eq&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::bitset](../utility/bitset.html)<4> mask("1100");
        [std::bitset](../utility/bitset.html)<4> val("0111");
        val and_eq mask;
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/and_eq&action=edit&section=3 "Edit section: See also")] See also
  ...
  * [`xor`](xor.html "cpp/keyword/xor"), [`xor_eq`](xor_eq.html "cpp/keyword/xor eq")
