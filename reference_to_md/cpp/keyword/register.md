...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/register&action=edit&section=1 "Edit section: Usage")] Usage

  * [Automatic storage duration specifier](../language/storage_duration.html "cpp/language/storage duration") (deprecated). 

| (until C++17)  
---|---  
  
  * _The keyword is unused and reserved._

| (since C++17)  
  
###  See also

  * [`auto`](auto.html "cpp/keyword/auto") (Automatic storage duration specifier)
