...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/enum&action=edit&section=1 "Edit section: Usage")] Usage

  * [declaration of an unscoped enumeration type](../language/enum.html#Unscoped_enumerations "cpp/language/enum")



  * [declaration of a scoped enumeration type](../language/enum.html#Scoped_enumerations "cpp/language/enum")

| (since C++11)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/enum&action=edit&section=2 "Edit section: See also")] See also
