...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/try&action=edit&section=1 "Edit section: Usage")] Usage

  * [`try` block](../language/try.html "cpp/language/try")



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/try&action=edit&section=2 "Edit section: See also")] See also

  * [`catch`](catch.html "cpp/keyword/catch"), [`throw`](throw.html "cpp/keyword/throw") (`throw` expressions)
