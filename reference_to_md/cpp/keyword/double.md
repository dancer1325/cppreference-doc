...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/double&action=edit&section=1 "Edit section: Usage")] Usage

  * [`double` type](../language/types.html#Standard_floating-point_types "cpp/language/types"): as the declaration of the type 
  * [`long double` type](../language/types.html#Standard_floating-point_types "cpp/language/types"): as the declaration of the type when combined with [`long`](long.html "cpp/keyword/long")



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/double&action=edit&section=2 "Edit section: See also")] See also
  ...
  * [Fundamental types](../language/types.html "cpp/language/types"): [`void`](void.html "cpp/keyword/void"), [std::nullptr_t](../types/nullptr_t.html "cpp/types/nullptr t")(since C++11). 
    ...
    * [Floating-point types](../language/types.html#Floating-point_types "cpp/language/types"): [`float`](float.html "cpp/keyword/float"), **`double`**. 
