...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/atomic_cancel&action=edit&section=1 "Edit section: Usage")] Usage

  * [Atomic block](../language/transactional_memory.html#Atomic_blocks "cpp/language/transactional memory") that rolls back on exceptions (TM TS)



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/atomic_cancel&action=edit&section=2 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/atomic_cancel&action=edit&section=3 "Edit section: See also")] See also

  * [`atomic_commit`](atomic_commit.html "cpp/keyword/atomic commit") (TM TS)
  * [`atomic_noexcept`](atomic_noexcept.html "cpp/keyword/atomic noexcept") (TM TS)
  * [`synchronized`](synchronized.html "cpp/keyword/synchronized") (TM TS)
  * [`transaction_safe`](transaction_safe.html "cpp/keyword/transaction safe") (TM TS)
  * [`transaction_safe_dynamic`](transaction_safe_dynamic.html "cpp/keyword/transaction safe dynamic") (TM TS)
