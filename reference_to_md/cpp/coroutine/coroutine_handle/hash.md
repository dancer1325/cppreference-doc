...
struct hash<[std::coroutine_handle](../coroutine_handle.html)<Promise>>; |  |  (since C++20)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [std::coroutine_handle](../coroutine_handle.html "cpp/coroutine/coroutine handle") allows users to obtain hashes of objects of type [std::coroutine_handle](../coroutine_handle.html)<P>. 

`operator()` of the specialization is noexcept. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/coroutine_handle/hash&action=edit&section=1 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/coroutine_handle/hash&action=edit&section=2 "Edit section: See also")] See also
