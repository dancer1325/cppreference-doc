...
Let x be some [generator](../../generator.html "cpp/coroutine/generator") object. 

If a [handle](../../generator.html#Data_members "cpp/coroutine/generator") referring to the coroutine whose [promise object](../promise_type.html "cpp/coroutine/generator/promise type") is *this is at the top of *`_[active_](../../generator.html#active "cpp/coroutine/generator")_` of x: 
  ...
  * Otherwise, assigns [std::current_exception()](../../../error/current_exception.html "cpp/error/current exception") to `_[except_](../promise_type.html#except "cpp/coroutine/generator/promise type")_`. 



Otherwise, the behavior is undefined. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/promise_type/unhandled_exception&action=edit&section=1 "Edit section: Exceptions")] Exceptions
