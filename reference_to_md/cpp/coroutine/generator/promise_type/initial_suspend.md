...
[std::suspend_always](../../suspend_always.html) initial_suspend() const noexcept; |  |  (since C++23)  
---|---|---  
| |   
  
Informs that [`std::generator`](../../generator.html "cpp/coroutine/generator") always starts lazily (in suspended state). 

Equivalent to return [std::suspend_always](../../suspend_always.html){};. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/promise_type/initial_suspend&action=edit&section=1 "Edit section: Return value")] Return value

An [awaitable](../../suspend_always.html "cpp/coroutine/suspend always") object. 
