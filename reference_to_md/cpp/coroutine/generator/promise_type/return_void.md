...
No-op. A user provided coroutine that uses the [generator](../../generator.html "cpp/coroutine/generator") cannot issue a value via co_return operator or reaching the end of the coroutine body. 
