...
[std::generator](../../generator.html) get_return_object() noexcept; |  |  (since C++23)  
---|---|---  
| |   
  
Returns a [generator](../../generator.html "cpp/coroutine/generator") object whose member [`_coroutine__`](../../generator.html#Data_members "cpp/coroutine/generator") is obtained via the expression [std::coroutine_handle](../../coroutine_handle.html)<promise_type>::from_promise(*this), and whose member [`_active__`](../../generator.html#Data_members "cpp/coroutine/generator") points to an empty stack. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/promise_type/get_return_object&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/promise_type/get_return_object&action=edit&section=2 "Edit section: Return value")] Return value

The [generator](../../generator.html "cpp/coroutine/generator") object. 
