...
[generator::promise_type::yield_value](yield_value.html "cpp/coroutine/generator/promise type/yield value")  
...
void* [operator new](../../../memory/new/operator_new.html)( [std::size_t](../../../types/size_t.html) size )  
requires [std::same_as](../../../concepts/same_as.html)<Allocator, void> ||  
[std::default_initializable](../../../concepts/default_initializable.html)<Allocator>; |  (1)  |  (since C++23)  
---|---|---  
template< class Alloc, class... Args >  
void* [operator new](../../../memory/new/operator_new.html)( [std::size_t](../../../types/size_t.html) size, [std::allocator_arg_t](../../../memory/allocator_arg_t.html),  
const Alloc& alloc, const Args&... ); |  (2) | (since C++23)  
template< class This, class Alloc, class... Args >  
void* [operator new](../../../memory/new/operator_new.html)( [std::size_t](../../../types/size_t.html) size, const This&, [std::allocator_arg_t](../../../memory/allocator_arg_t.html),  
const Alloc& alloc, const Args&... ); |  (3)  |  (since C++23)  
| |   
  
[Allocates](../../../language/coroutines.html#Dynamic_allocation "cpp/language/coroutines") size bytes of uninitialized storage using default or user-provided allocator. 

Let `A` be 

  * `Allocator`, if it is not void, 
  * `Alloc` for (2,3), or 
  * [std::allocator](../../../memory/allocator.html)<void> otherwise. 



Let `B` be [std::allocator_traits](../../../memory/allocator_traits.html)<A>::template rebind_alloc<U> where `U` is an unspecified type whose size and alignment are both [`__STDCPP_DEFAULT_NEW_ALIGNMENT__`](../../../preprocessor/replace.html#Predefined_macros "cpp/preprocessor/replace"). 
...
Uses b to allocate storage for the smallest array of `U` sufficient to provide storage for a [coroutine state](../../../language/coroutines.html#Execution "cpp/language/coroutines") of size size, and unspecified additional state necessary to ensure that [`operator delete`](operator_delete.html "cpp/coroutine/generator/promise type/operator delete") can later deallocate this memory block with an allocator equal to b. 

The program is ill-formed unless [std::allocator_traits](../../../memory/allocator_traits.html)<B>::pointer is a pointer type and for overloads ([2,3](operator_new.html#Version_2)), [std::same_as](../../../concepts/same_as.html)<Allocator, void> || [std::convertible_to](../../../concepts/convertible_to.html)<const Alloc&, Allocator> is modeled. 
...
## Contents
  ...
  * [4 Defect reports](operator_new.html#Defect_reports)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/promise_type/operator_new&action=edit&section=1 "Edit section: Parameters")] Parameters

size  |  \-  |  the size of the storage to allocate   
---|---|---  
alloc  |  \-  |  a user provided allocator of type `Alloc`  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/promise_type/operator_new&action=edit&section=2 "Edit section: Return value")] Return value

A pointer to the allocated storage. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/promise_type/operator_new&action=edit&section=3 "Edit section: Exceptions")] Exceptions

1-3) May throw.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/promise_type/operator_new&action=edit&section=4 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 3900](https://cplusplus.github.io/LWG/issue3900) | C++23  | overloads ([2,3](operator_new.html#Version_2)) were constrained on conversion of `Alloc` to `Allocator` | mandated 
