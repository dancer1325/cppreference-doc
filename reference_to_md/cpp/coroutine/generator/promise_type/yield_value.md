...
---  
[std::generator](../../generator.html "cpp/coroutine/generator")(C++23)` `  
...
---  
[generator::generator](../generator.html "cpp/coroutine/generator/generator")  
[generator::~generator](../~generator.html "cpp/coroutine/generator/~generator")  
[generator::operator=](../operator=.html "cpp/coroutine/generator/operator=")  
[generator::begin](../begin.html "cpp/coroutine/generator/begin")  
[generator::end](../end.html "cpp/coroutine/generator/end")  
[promise_type](../promise_type.html "cpp/coroutine/generator/promise type")  
[generator::promise_type::get_return_object](get_return_object.html "cpp/coroutine/generator/promise type/get return object")  
[generator::promise_type::initial_suspend](initial_suspend.html "cpp/coroutine/generator/promise type/initial suspend")  
[generator::promise_type::final_suspend](final_suspend.html "cpp/coroutine/generator/promise type/final suspend")  
**generator::promise_type::yield_value**  
[generator::promise_type::return_void](return_void.html "cpp/coroutine/generator/promise type/return void")  
[generator::promise_type::unhandled_exception](unhandled_exception.html "cpp/coroutine/generator/promise type/unhandled exception")  
[generator::promise_type::operator new](operator_new.html "cpp/coroutine/generator/promise type/operator new")  
[generator::promise_type::operator delete](operator_delete.html "cpp/coroutine/generator/promise type/operator delete")  
[_Iterator_](../iterator.html "cpp/coroutine/generator/iterator")  
[generator::_iterator_ ::_iterator_](../iterator.html#constructor "cpp/coroutine/generator/iterator")  
[generator::_iterator_ ::operator=](../iterator.html#assignment "cpp/coroutine/generator/iterator")  
[generator::_iterator_ ::operator*](../iterator.html#dereference "cpp/coroutine/generator/iterator")  
...
---|---|---  
auto yield_value( const [std::remove_reference_t](../../../types/remove_reference.html)<yielded>& lval )  
requires [std::is_rvalue_reference_v](../../../types/is_rvalue_reference.html)<yielded> &&  
[std::constructible_from](../../../concepts/constructible_from.html)<[std::remove_cvref_t](../../../types/remove_cvref.html)<yielded>,  
const [std::remove_reference_t](../../../types/remove_reference.html)<yielded>&>; |  (2)  |  (since C++23)  
template< class R2, class V2, class Alloc2, class Unused >  
requires [std::same_as](../../../concepts/same_as.html)<typename [std::generator](../../generator.html)<T2, V2, Alloc2>::yielded,   
yielded>  
auto yield_value( ranges::elements_of<[std::generator](../../generator.html)<T2, V2, Alloc2>&&,  
Unused> g ) noexcept; |  (3)  |  (since C++23)  
template< class R2, class V2, class Alloc2, class Unused >  
requires [std::same_as](../../../concepts/same_as.html)<typename [std::generator](../../generator.html)<T2, V2, Alloc2>::yielded,   
yielded>  
auto yield_value( ranges::elements_of<[std::generator](../../generator.html)<T2, V2, Alloc2>&,  
Unused> g ) noexcept; |  (4)  |  (since C++23)  
template< [ranges::input_range](../../../ranges/input_range.html) R, class Alloc >  
requires [std::convertible_to](../../../concepts/convertible_to.html)<[ranges::range_reference_t](../../../ranges/range_reference_t.html)<R>, yielded>  
auto yield_value( ranges::elements_of<R, Alloc> r ); |  (5) | (since C++23)  
| |   
  
An implementation of coroutine interface functions used internally to support operator co_yield. 

([`yielded`](../../generator.html#Member_types "cpp/coroutine/generator") is a reference type defined in [std::generator](../../generator.html).)

1) Assigns [std::addressof](../../../memory/addressof.html)(val) to `_[value_](../promise_type.html#value "cpp/coroutine/generator/promise type")_`. Returns {}.

2) Returns an awaitable object x of an unspecified type that stores an object of type [std::remove_cvref_t](../../../types/remove_cvref.html)<`[yielded](../../generator.html#yielded "cpp/coroutine/generator")`>. x is [direct-non-list-initialized](../../../language/direct_initialization.html "cpp/language/direct initialization") with lval, whose member functions are configured so that `_[value_](../promise_type.html#value "cpp/coroutine/generator/promise type")_` points to that stored object. Then suspends the coroutine.

3, 4) Let x be some [generator](../../generator.html "cpp/coroutine/generator") object. 

Returns an awaitable object of an unspecified type into which g.range is moved, 

  * whose member await_ready returns false, 
  * whose member await_suspend pushes g.range.coroutine_ into *x.`_[active_](../../generator.html#active "cpp/coroutine/generator")_` and 
  ...
  * [std::rethrow_exception](../../../error/rethrow_exception.html)(except_) if bool(except_) is true. 
...
5) Equivalent to: 
    ...
    auto nested = []([std::allocator_arg_t](../../../memory/allocator_arg_t.html), Alloc, [ranges::iterator_t](../../../ranges/iterator_t.html)<R> i,
                     [ranges::sentinel_t](../../../ranges/iterator_t.html)<R> s) ->
        [std::generator](../../generator.html)<yielded, void, Alloc>
    {
        for (; i != s; ++i)
    ...
    return yield_value(ranges::elements_of(nested(
        allocator_arg, r.allocator, [ranges::begin](../../../ranges/begin.html)(r.range), [ranges::end](../../../ranges/end.html)(r.range))));

2,3) A handle referring to the coroutine whose promise object is *this must be at the top of *`_[active_](../../generator.html#active "cpp/coroutine/generator")_` of some generator object. Otherwise, the behavior is undefined.

2-5) A [_yield-expression_](../../../language/coroutines.html#co_yield "cpp/language/coroutines") that calls these overload has the type void.

## Contents

  * [1 Parameters](yield_value.html#Parameters)
  * [2 Return value](yield_value.html#Return_value)
  * [3 Exceptions](yield_value.html#Exceptions)
  * [4 Example](yield_value.html#Example)
  * [5 Defect reports](yield_value.html#Defect_reports)
...
---|---|---  
lval  |  \-  |  an lvalue which is a result of the _yield-expression_ evaluation   
...
---|---|---|---  
[LWG 3899](https://cplusplus.github.io/LWG/issue3899) | C++23  | `yield_value` on a range of elements produced by lvalue generator  
used generic `elements_of` overload  | used special `elements_of` overload for such generators   
[LWG 4119](https://cplusplus.github.io/LWG/issue4119) | C++23  | `range_value_t` in `generator`'s template argument as part  
of the return type of nested in ([5](yield_value.html#Version_5)) may be ill-formed  | used void
