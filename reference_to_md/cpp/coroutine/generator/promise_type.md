...
The promise type of [`std::generator`](../generator.html "cpp/coroutine/generator"). 

## Contents

  * [1 Data members](promise_type.html#Data_members)
  * [2 Member functions](promise_type.html#Member_functions)
  * [3 Example](promise_type.html#Example)
  * [4 See also](promise_type.html#See_also)
...
Member  |  Description   
---|---  
[std::add_pointer_t](../../types/add_pointer.html)<std::generator::yielded> `_value__` |  A pointer to the yielded value. Default value is nullptr.  
...
(public member function)  
[ get_return_object](promise_type/get_return_object.html "cpp/coroutine/generator/promise type/get return object") |  issues the [generator](../generator.html "cpp/coroutine/generator") object   
(public member function)  
[ initial_suspend](promise_type/initial_suspend.html "cpp/coroutine/generator/promise type/initial suspend") |  issues an awaiter for initial suspend point   
(public member function)  
[ final_suspend](promise_type/final_suspend.html "cpp/coroutine/generator/promise type/final suspend") |  issues an awaiter for final suspend point   
(public member function)  
[ yield_value](promise_type/yield_value.html "cpp/coroutine/generator/promise type/yield value") |  processes the object obtained from co_yield   
(public member function)  
await_transform[deleted] |  maps the object obtained from co_await to an awaiter   
(public member function)  
[ return_void](promise_type/return_void.html "cpp/coroutine/generator/promise type/return void") |  handles co_return; or the exit out of coroutine's body   
(public member function)  
