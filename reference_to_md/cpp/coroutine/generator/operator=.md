...
std::[`swap`](../../utility/swap.html "cpp/utility/swap")([`_coroutine__`](../generator.html#Data_members "cpp/coroutine/generator")`,`` `other.[`_coroutine__`](../generator.html#Data_members "cpp/coroutine/generator"));  
std::[`swap`](../../utility/swap.html "cpp/utility/swap")([`_active__`](../generator.html#Data_members "cpp/coroutine/generator")`,`` `other.[`_active__`](../generator.html#Data_members "cpp/coroutine/generator"));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/operator%3D&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  another generator to be moved from   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/operator%3D&action=edit&section=2 "Edit section: Return value")] Return value

*this

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/operator%3D&action=edit&section=3 "Edit section: Complexity")] Complexity

| This section is incomplete   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/operator%3D&action=edit&section=4 "Edit section: Notes")] Notes

Iterators previously obtained from other are not invalidated – they become iterators into *this. 

This assignment operator is technically a [copy assignment operator](../../language/as_operator.html "cpp/language/copy assignment"), although `std::generator` is only move assignable. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/generator/operator%3D&action=edit&section=5 "Edit section: Example")] Example
