...
[generator::promise_type::get_return_object](promise_type/get_return_object.html "cpp/coroutine/generator/promise type/get return object")  
[generator::promise_type::initial_suspend](promise_type/initial_suspend.html "cpp/coroutine/generator/promise type/initial suspend")  
[generator::promise_type::final_suspend](promise_type/final_suspend.html "cpp/coroutine/generator/promise type/final suspend")  
[generator::promise_type::yield_value](promise_type/yield_value.html "cpp/coroutine/generator/promise type/yield value")  
[generator::promise_type::return_void](promise_type/return_void.html "cpp/coroutine/generator/promise type/return void")  
[generator::promise_type::unhandled_exception](promise_type/unhandled_exception.html "cpp/coroutine/generator/promise type/unhandled exception")  
[generator::promise_type::operator new](promise_type/operator_new.html "cpp/coroutine/generator/promise type/operator new")  
[generator::promise_type::operator delete](promise_type/operator_delete.html "cpp/coroutine/generator/promise type/operator delete")  
**_Iterator_**  
...
The return type of [`generator::begin`](../generator.html "cpp/coroutine/generator"). Models [`indirectly_readable`](../../iterator/indirectly_readable.html "cpp/iterator/indirectly readable") and [`input_iterator`](../../iterator/input_iterator.html "cpp/iterator/input iterator"). 
...
## Contents
  ...
  * [4 std::generator::_iterator_ ::_iterator_](iterator.html#std::generator::iterator::iterator)
  * [5 std::generator::_iterator_ ::operator=](iterator.html#std::generator::iterator::operator.3D)
  * [6 std::generator::_iterator_ ::operator*](iterator.html#std::generator::iterator::operator.2A)
  * [7 std::generator::_iterator_ ::operator++](iterator.html#std::generator::iterator::operator.2B.2B)
    * [7.1 Non-member functions](iterator.html#Non-member_functions)
  * [8 operator==(std::generator::_iterator_)](iterator.html#operator.3D.3D.28std::generator::iterator.29)
    * [8.1 Example](iterator.html#Example)
...
---|---  
[ operator=](iterator.html#assignment "cpp/coroutine/generator/iterator") |  assigns another iterator   
(public member function)  
[ operator*](iterator.html#dereference "cpp/coroutine/generator/iterator") |  returns an underlying value   
(public member function)  
[ operator++operator++(int)](iterator.html#increment "cpp/coroutine/generator/iterator") |  advances the iterator   
(public member function)  
...
Initializes `_[coroutine_](iterator.html#coroutine)_` with [std::exchange](../../utility/exchange.html)(other.coroutine_, {});. 
...
Equivalent to coroutine_ = [std::exchange](../../utility/exchange.html)(other.coroutine_, {});. 
...
noexcept( [std::is_nothrow_copy_constructible_v](../../types/is_copy_constructible.html)<reference> ); |  |  (since C++23)  
---|---|---  
| |   
  
  1. Let [`_reference_`](../generator.html#Member_types "cpp/coroutine/generator") be the [`std::generator`](../generator.html "cpp/coroutine/generator")'s underlying type. 
  2. Let for some generator object x its `_[coroutine_](iterator.html#coroutine)_` be in the stack *x.active_. 
...
1) Let for some generator object x the `_[coroutine_](iterator.html#coroutine)_` be in the stack *x.active_.
...
friend bool operator==( const /*iterator*/& i, [std::default_sentinel_t](../../iterator/default_sentinel.html) ); |  |  (since C++23)  
---|---|---  
| |   
