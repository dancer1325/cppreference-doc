...
`suspend_always` is an empty class which can be used to indicate that an [await expression](../language/coroutines.html#co_await "cpp/language/coroutines") always suspends and does not produce a value. 

## Contents

  * [1 Member functions](suspend_always.html#Member_functions)
  * [2 std::suspend_always::await_ready](suspend_always.html#std::suspend_always::await_ready)
  * [3 std::suspend_always::await_suspend](suspend_always.html#std::suspend_always::await_suspend)
  * [4 std::suspend_always::await_resume](suspend_always.html#std::suspend_always::await_resume)
    * [4.1 Example](suspend_always.html#Example)
    * [4.2 See also](suspend_always.html#See_also)
