...
---|---|---  
[std::noop_coroutine_handle](coroutine_handle.html) noop_coroutine() noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](noop_coroutine.html#Parameters)
  * [2 Return value](noop_coroutine.html#Return_value)
  * [3 Notes](noop_coroutine.html#Notes)
  * [4 Example](noop_coroutine.html#Example)
  * [5 See also](noop_coroutine.html#See_also)
...
A [std::noop_coroutine_handle](coroutine_handle.html "cpp/coroutine/coroutine handle") referring to a no-op coroutine. 
...
Run this code
    ...
    struct task
    {
        struct promise_type
        {
            ...
            {
                return task([std::coroutine_handle](coroutine_handle.html)<promise_type>::from_promise(*this));
            }
            [std::suspend_always](suspend_always.html) initial_suspend() { return {}; }
            struct final_awaiter
            {
                bool await_ready() noexcept { return false; }
                void await_resume() noexcept {}
                [std::coroutine_handle](coroutine_handle.html)<>
                    await_suspend([std::coroutine_handle](coroutine_handle.html)<promise_type> h) noexcept
                {
    ...
     
            T result;
            [std::coroutine_handle](coroutine_handle.html)<> previous;
        };
     
        task([std::coroutine_handle](coroutine_handle.html)<promise_type> h) : coro(h) {}
        task(task&& t) = delete;
        ~task() { coro.destroy(); }
     
        struct awaiter
        {
            ...
            auto await_suspend([std::coroutine_handle](coroutine_handle.html)<> h)
            {
                coro.promise().previous = h;
                return coro;
            }
            [std::coroutine_handle](coroutine_handle.html)<promise_type> coro;
        };
    ...
    task<int> get_random()
    {
        [std::cout](../io/cout.html) << "in get_random()\n";
        co_return 4;
    }
     
    task<int> test()
...
(class)   
---|---  
[ noop_coroutine_handle](coroutine_handle.html "cpp/coroutine/coroutine handle")(C++20) |  [std::coroutine_handle](coroutine_handle.html)<[std::noop_coroutine_promise](noop_coroutine_promise.html)>, intended to refer to a no-op coroutine   
(typedef) 
