...
`suspend_never` is an empty class which can be used to indicate that an [await expression](../language/coroutines.html#co_await "cpp/language/coroutines") never suspends and does not produce a value. 

## Contents

  * [1 Member functions](suspend_never.html#Member_functions)
  * [2 std::suspend_never::await_ready](suspend_never.html#std::suspend_never::await_ready)
  * [3 std::suspend_never::await_suspend](suspend_never.html#std::suspend_never::await_suspend)
  * [4 std::suspend_never::await_resume](suspend_never.html#std::suspend_never::await_resume)
    * [4.1 Example](suspend_never.html#Example)
    * [4.2 See also](suspend_never.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/suspend_never&action=edit&section=1 "Edit section: Member functions")] Member functions
...
constexpr void await_suspend( [std::coroutine_handle](coroutine_handle.html)<> ) const noexcept {} |  |   
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/suspend_never&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/coroutine/suspend_never&action=edit&section=3 "Edit section: See also")] See also

[ suspend_always](suspend_always.html "cpp/coroutine/suspend always")(C++20) |  indicates that an await-expression should always suspend   
