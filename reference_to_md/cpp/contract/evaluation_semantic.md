...
The enumerators of `std::contracts::evaluation_semantic` correspond to the [evaluation semantics](../language/contracts.html#Evaluating_contract_assertions "cpp/language/contracts") with which a contract assertion may be evaluated, with meanings listed below: 
