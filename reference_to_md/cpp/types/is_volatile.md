...
`std::is_volatile` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 
...
## Contents
  ...
  * [1 Template parameters](is_volatile.html#Template_parameters)
  * [2 Helper variable template](is_volatile.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_volatile.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_volatile.html#Member_constants)
    * [3.2 Member functions](is_volatile.html#Member_functions)
    * [3.3 Member types](is_volatile.html#Member_types)
    * [3.4 Possible implementation](is_volatile.html#Possible_implementation)
    * [3.5 Example](is_volatile.html#Example)
    * [3.6 See also](is_volatile.html#See_also)
...
template< class T >  
constexpr bool is_volatile_v = is_volatile<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
value[static] |  true if `T` is a volatile-qualified type, false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_volatile&action=edit&section=1 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class T> struct is_volatile : [std::false_type](integral_constant.html) {};
    template<class T> struct is_volatile<volatile T> : [std::true_type](integral_constant.html) {};  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_volatile&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    static_assert(std::is_volatile_v<volatile [std::valarray](../numeric/valarray.html)<float>>);
    static_assert(!std::is_volatile_v<[std::valarray](../numeric/valarray.html)<volatile float>>);
     
    int main() {}

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_volatile&action=edit&section=3 "Edit section: See also")] See also
