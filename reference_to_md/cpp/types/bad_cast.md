...
---|---|---  
class bad_cast : public [std::exception](../error/exception.html) |  |   
| |   
  
An exception of this type is thrown when a [`dynamic_cast`](../language/dynamic_cast.html "cpp/language/dynamic cast") to a reference type fails the run-time check (e.g., because the types are not related by inheritance), and also from [std::use_facet](../locale/use_facet.html "cpp/locale/use facet") if the requested facet does not exist in the locale. 

![std-bad cast-inheritance.svg](https://upload.cppreference.com/mwiki/images/0/08/std-bad_cast-inheritance.svg)

Inheritance diagram

## Contents

  * [1 Member functions](bad_cast.html#Member_functions)
  * [2 std::bad_cast::bad_cast](bad_cast.html#std::bad_cast::bad_cast)
    * [2.1 Parameters](bad_cast.html#Parameters)
  * [3 std::bad_cast::operator=](bad_cast.html#std::bad_cast::operator.3D)
    * [3.1 Parameters](bad_cast.html#Parameters_2)
    * [3.2 Return value](bad_cast.html#Return_value)
  * [4 std::bad_cast::what](bad_cast.html#std::bad_cast::what)
    * [4.1 Return value](bad_cast.html#Return_value_2)
    * [4.2 Notes](bad_cast.html#Notes)
  * [5 Inherited from std::exception](bad_cast.html#Inherited_from_std::exception)
    * [5.1 Member functions](bad_cast.html#Member_functions_2)
    * [5.2 Notes](bad_cast.html#Notes_2)
    * [5.3 Example](bad_cast.html#Example)
...
Constructs a new `bad_cast` object with an implementation-defined null-terminated byte string which is accessible through [`what()`](../error/exception/what.html "cpp/error/exception/what"). 

1) Default constructor.

2) Copy constructor. If *this and other both have dynamic type `std::bad_cast` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0.(since C++11)
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::bad_cast` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment.(since C++11)
...
Run this code
    ...
    struct Bar { virtual ~Bar() { [std::cout](../io/cout.html) << "~Bar\n"; } };
    struct Pub : Bar { ~Pub() override { [std::cout](../io/cout.html) << "~Pub\n"; } };
     
    int main()
    {
        Pub pub;
    ...
     
        ...
        {
            [std::cout](../io/cout.html) << "e.what(): " << e.what() << '\n';
        }
    }
