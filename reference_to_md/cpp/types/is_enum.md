...
`std::is_enum` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 

Checks whether `T` is an [enumeration type](../language/enum.html "cpp/language/enum"). Provides the member constant `value` which is equal to true, if `T` is an enumeration type. Otherwise, `value` is equal to false. 

If the program adds specializations for `std::is_enum` or `std::is_enum_v`, the behavior is undefined. 

## Contents

  * [1 Template parameters](is_enum.html#Template_parameters)
  * [2 Helper variable template](is_enum.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_enum.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_enum.html#Member_constants)
    * [3.2 Member functions](is_enum.html#Member_functions)
    * [3.3 Member types](is_enum.html#Member_types)
    * [3.4 Example](is_enum.html#Example)
    * [3.5 See also](is_enum.html#See_also)
...
template< class T >  
constexpr bool is_enum_v = is_enum<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_enum&action=edit&section=1 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_enum&action=edit&section=2 "Edit section: See also")] See also
