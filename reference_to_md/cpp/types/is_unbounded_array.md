...
`std::is_unbounded_array` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 

Checks whether `T` is an [arrays of unknown bound](../language/array.html#Arrays_of_unknown_bound "cpp/language/array"). Provides the member constant value which is equal to true, if `T` is an array type of unknown bound. Otherwise, value is equal to false. 

If the program adds specializations for `std::is_unbounded_array` or `std::is_unbounded_array_v`, the behavior is undefined. 

## Contents

  * [1 Template parameters](is_unbounded_array.html#Template_parameters)
  * [2 Helper variable template](is_unbounded_array.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_unbounded_array.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_unbounded_array.html#Member_constants)
    * [3.2 Member functions](is_unbounded_array.html#Member_functions)
    * [3.3 Member types](is_unbounded_array.html#Member_types)
    * [3.4 Possible implementation](is_unbounded_array.html#Possible_implementation)
    * [3.5 Notes](is_unbounded_array.html#Notes)
    * [3.6 Example](is_unbounded_array.html#Example)
    * [3.7 See also](is_unbounded_array.html#See_also)
...
template< class T >  
constexpr bool is_unbounded_array_v = is_unbounded_array<T>::value; |  |  (since C++20)  
---|---|---  
| |   
...
value[static] |  true if `T` is an array type of unknown bound., false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_unbounded_array&action=edit&section=1 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class T>
    struct is_unbounded_array: [std::false_type](integral_constant.html) {};
     
    template<class T>
    struct is_unbounded_array<T[]> : [std::true_type](integral_constant.html) {};  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_unbounded_array&action=edit&section=2 "Edit section: Notes")] Notes

[Feature-test](../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_bounded_array_traits`](../experimental/feature_test.html#cpp_lib_bounded_array_traits "cpp/feature test") | [`201902L`](../compiler_support/20.html#cpp_lib_bounded_array_traits_201902L "cpp/compiler support/20") | (C++20) | [std::is_bounded_array](is_bounded_array.html "cpp/types/is bounded array"), `std::is_unbounded_array`  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_unbounded_array&action=edit&section=3 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_unbounded_array&action=edit&section=4 "Edit section: See also")] See also
