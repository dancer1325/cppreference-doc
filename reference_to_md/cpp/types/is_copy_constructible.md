...
**is_copy_constructible is_trivially_copy_constructibleis_nothrow_copy_constructible**(C++11)(C++11)(C++11)  
...
---|---|---  
template< class T >  
struct is_copy_constructible; |  (1)  |  (since C++11)  
template< class T >  
struct is_trivially_copy_constructible; |  (2)  |  (since C++11)  
template< class T >  
struct is_nothrow_copy_constructible; |  (3)  |  (since C++11)  
| |   
...
(1) | [std::is_constructible](is_constructible.html)<T, const T&>::value | false  
(2) | [std::is_trivially_constructible](is_constructible.html)<T, const T&>::value  
(3) | [std::is_nothrow_constructible](is_constructible.html)<T, const T&>::value  
...
## Contents
  ...
  * [1 Helper variable templates](is_copy_constructible.html#Helper_variable_templates)
  * [2 Inherited from std::integral_constant](is_copy_constructible.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](is_copy_constructible.html#Member_constants)
    * [2.2 Member functions](is_copy_constructible.html#Member_functions)
    * [2.3 Member types](is_copy_constructible.html#Member_types)
    * [2.4 Possible implementation](is_copy_constructible.html#Possible_implementation)
    * [2.5 Notes](is_copy_constructible.html#Notes)
    * [2.6 Example](is_copy_constructible.html#Example)
    * [2.7 Defect reports](is_copy_constructible.html#Defect_reports)
    * [2.8 See also](is_copy_constructible.html#See_also)
...
value[static] |  true if `T` is copy-constructible, false otherwise   
...
### Possible implementation
    ...
    struct is_copy_constructible :
        [std::is_constructible](is_constructible.html)<T, typename [std::add_lvalue_reference](add_reference.html)<
            typename [std::add_const](add_cv.html)<T>::type>::type> {};
     
    template<class T>
    struct is_trivially_copy_constructible :
        [std::is_trivially_constructible](is_constructible.html)<T, typename [std::add_lvalue_reference](add_reference.html)<
            typename [std::add_const](add_cv.html)<T>::type>::type> {};
     
    template<class T>
    struct is_nothrow_copy_constructible :
        [std::is_nothrow_constructible](is_constructible.html)<T, typename [std::add_lvalue_reference](add_reference.html)<
            typename [std::add_const](add_cv.html)<T>::type>::type> {};  
...
Run this code
    ...
    struct S1
    {
        [std::string](../string/basic_string.html) str; // member has a non-trivial copy constructor
    };
