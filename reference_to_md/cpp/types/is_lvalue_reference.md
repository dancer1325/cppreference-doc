...
`std::is_lvalue_reference` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 
...
## Contents
  ...
  * [1 Template parameters](is_lvalue_reference.html#Template_parameters)
  * [2 Helper variable template](is_lvalue_reference.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_lvalue_reference.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_lvalue_reference.html#Member_constants)
    * [3.2 Member functions](is_lvalue_reference.html#Member_functions)
    * [3.3 Member types](is_lvalue_reference.html#Member_types)
    * [3.4 Possible implementation](is_lvalue_reference.html#Possible_implementation)
    * [3.5 Example](is_lvalue_reference.html#Example)
    * [3.6 See also](is_lvalue_reference.html#See_also)
...
template< class T >  
constexpr bool is_lvalue_reference_v = is_lvalue_reference<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
value[static] |  true if `T` is an lvalue reference type, false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_lvalue_reference&action=edit&section=1 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class T> struct is_lvalue_reference     : [std::false_type](integral_constant.html) {};
    template<class T> struct is_lvalue_reference<T&> : [std::true_type](integral_constant.html) {};  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_lvalue_reference&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_lvalue_reference&action=edit&section=3 "Edit section: See also")] See also
