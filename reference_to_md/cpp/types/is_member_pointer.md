...
`std::is_member_pointer` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 
...
## Contents
  ...
  * [1 Template parameters](is_member_pointer.html#Template_parameters)
  * [2 Helper variable template](is_member_pointer.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_member_pointer.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_member_pointer.html#Member_constants)
    * [3.2 Member functions](is_member_pointer.html#Member_functions)
    * [3.3 Member types](is_member_pointer.html#Member_types)
    * [3.4 Possible implementation](is_member_pointer.html#Possible_implementation)
    * [3.5 Example](is_member_pointer.html#Example)
    * [3.6 See also](is_member_pointer.html#See_also)
...
### Possible implementation
    ...
    template<class T>
    struct is_member_pointer_helper : [std::false_type](integral_constant.html) {};
     
    template<class T, class U>
    struct is_member_pointer_helper<T U::*> : [std::true_type](integral_constant.html) {};
     
    template<class T>
    struct is_member_pointer : is_member_pointer_helper<typename [std::remove_cv](remove_cv.html)<T>::type> {};  
...
Run this code
    ...
     
        ...
        [assert](../error/assert.html)(s.i == s.*pm);
     
