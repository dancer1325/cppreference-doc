...
## Contents
  ...
  * [1 Member types](remove_extent.html#Member_types)
  * [2 Helper types](remove_extent.html#Helper_types)
  * [3 Possible implementation](remove_extent.html#Possible_implementation)
  * [4 Example](remove_extent.html#Example)
  * [5 See also](remove_extent.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/remove_extent&action=edit&section=1 "Edit section: Member types")] Member types

Name  |  Definition   
---|---  
`type` |  the type of the element of `T`  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/remove_extent&action=edit&section=2 "Edit section: Helper types")] Helper types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/remove_extent&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/remove_extent&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
    template<class A>
        [std::enable_if_t](enable_if.html)<[std::rank_v](rank.html)<A> == 1>
    print_1d(const A& a)
    {
        [std::copy](../algorithm/copy.html)(a, a + [std::extent_v](extent.html)<A>,
            [std::ostream_iterator](../iterator/ostream_iterator.html)<std::remove_extent_t<A>>([std::cout](../io/cout.html), " "));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/remove_extent&action=edit&section=5 "Edit section: See also")] See also
