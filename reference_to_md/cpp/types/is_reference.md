...
`std::is_reference` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 
...
## Contents
  ...
  * [1 Template parameters](is_reference.html#Template_parameters)
  * [2 Helper variable template](is_reference.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_reference.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_reference.html#Member_constants)
    * [3.2 Member functions](is_reference.html#Member_functions)
    * [3.3 Member types](is_reference.html#Member_types)
    * [3.4 Possible implementation](is_reference.html#Possible_implementation)
    * [3.5 Example](is_reference.html#Example)
    * [3.6 See also](is_reference.html#See_also)
...
value[static] |  true if `T` is a reference type, false otherwise   
...
### Possible implementation
    ...
    template<class T> struct is_reference<T&> : [std::true_type](integral_constant.html) {};
    template<class T> struct is_reference<T&&> : [std::true_type](integral_constant.html) {};  
