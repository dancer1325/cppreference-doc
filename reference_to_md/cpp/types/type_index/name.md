...
Returns the name of the associated [std::type_info](../type_info.html "cpp/types/type info") object. Equivalent to calling [std::type_info::name()](../type_info/name.html "cpp/types/type info/name") directly. 

## Contents

  * [1 Parameters](name.html#Parameters)
  * [2 Return value](name.html#Return_value)
  * [3 Example](name.html#Example)
  * [4 Defect reports](name.html#Defect_reports)
...
Run this code
    ...
    #include <typeindex>
    int main() {
        [std::cout](../../io/cout.html) << [std::type_index](../type_index.html)(typeid([std::cout](../../io/cout.html))).name();
    }
