...
---|---|---  
template<> struct hash<[std::type_index](../type_index.html)>; |  |  (since C++11)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [std::type_index](../type_index.html "cpp/types/type index") allows users to obtain hashes of objects of type [std::type_index](../type_index.html "cpp/types/type index"). 
