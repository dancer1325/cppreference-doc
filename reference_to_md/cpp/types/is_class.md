...
`std::is_class` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 
...
## Contents
  ...
  * [1 Template parameters](is_class.html#Template_parameters)
  * [2 Helper variable template](is_class.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_class.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_class.html#Member_constants)
    * [3.2 Member functions](is_class.html#Member_functions)
    * [3.3 Member types](is_class.html#Member_types)
    * [3.4 Possible implementation](is_class.html#Possible_implementation)
    * [3.5 Example](is_class.html#Example)
    * [3.6 See also](is_class.html#See_also)
...
template< class T >  
constexpr bool is_class_v = is_class<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
value[static] |  true if `T` is a non-union class type, false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_class&action=edit&section=1 "Edit section: Possible implementation")] Possible implementation
    
    
    namespace detail
    {
        template<class T>
        [std::integral_constant](integral_constant.html)<bool, ![std::is_union](is_union.html)<T>::value> test(int T::*);
     
        template<class>
        [std::false_type](integral_constant.html) test(...);
    }
     
    template<class T>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_class&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_class&action=edit&section=3 "Edit section: See also")] See also
