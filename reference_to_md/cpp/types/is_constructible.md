...
---  
| **is_constructible is_trivially_constructibleis_nothrow_constructible**(C++11)(C++11)(C++11)  
---  
...
struct is_constructible; |  (1)  |  (since C++11)  
template< class T, class... Args >  
struct is_trivially_constructible; |  (2)  |  (since C++11)  
template< class T, class... Args >  
struct is_nothrow_constructible; |  (3)  |  (since C++11)  
| |   
  
1) If `T` is an object or reference type and the variable definition T obj([std::declval](../utility/declval.html)<Args>()...); is well-formed, provides the member constant `value` equal to true. In all other cases, `value` is false.  
For the purposes of this check, the variable definition is never interpreted as a function declaration, and the use of [std::declval](../utility/declval.html "cpp/utility/declval") is not considered an [odr-use](../language/definition.html#ODR-use "cpp/language/definition"). [Access checks](../language/access.html "cpp/language/access") are performed as if from a context unrelated to `T` and any of the types in `Args`. Only the validity of the immediate context of the variable definition is considered.

2) Same as (1), but the variable definition does not call any operation that is not trivial. For the purposes of this check, the call to [std::declval](../utility/declval.html "cpp/utility/declval") is considered trivial.
...
## Contents
  ...
  * [1 Helper variable templates](is_constructible.html#Helper_variable_templates)
  * [2 Inherited from std::integral_constant](is_constructible.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](is_constructible.html#Member_constants)
    * [2.2 Member functions](is_constructible.html#Member_functions)
    * [2.3 Member types](is_constructible.html#Member_types)
    * [2.4 Notes](is_constructible.html#Notes)
    * [2.5 Example](is_constructible.html#Example)
    * [2.6 See also](is_constructible.html#See_also)
...
value[static] |  true if `T` is constructible from `Args...`, false otherwise   
