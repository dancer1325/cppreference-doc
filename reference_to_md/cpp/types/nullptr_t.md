...
`std::nullptr_t` is the type of the null pointer literal nullptr. It is a distinct type that is not itself a pointer type or a pointer to member type. Prvalues of this type are [null pointer constants](../language/pointer.html#Null_pointers "cpp/language/pointer"), and may be [implicitly converted](../language/implicit_cast.html "cpp/language/implicit conversion") to any pointer and pointer to member type. 
...
Run this code
    ...
    void f(int*)
    {
        [std::cout](../io/cout.html) << "Pointer to integer overload\n";
    }
     
    void f(double*)
    {
        [std::cout](../io/cout.html) << "Pointer to double overload\n";
    }
     
    void f(std::nullptr_t)
    {
        [std::cout](../io/cout.html) << "null pointer overload\n";
    }
     
    int main()
    {
