...
The macro **offsetof** expands to an integral constant expression of type [std::size_t](size_t.html "cpp/types/size t"), the value of which is the offset, in bytes, from the beginning of an object of specified type to its specified subobject, including [padding bits](../language/objects.html#Object_representation_and_value_representation "cpp/language/object") if any. 

Given an object o of type `type` and static storage duration, o.member shall be an lvalue constant expression that refers to a subobject of o. Otherwise, the behavior is undefined. Particularly, if `member` is a [static data member](../language/static.html "cpp/language/static"), a [bit-field](../language/bit_field.html "cpp/language/bit field"), or a [member function](../language/member_functions.html "cpp/language/member functions"), the behavior is undefined. 

If `type` is not a [PODType](../named_req/PODType.html "cpp/named req/PODType")(until C++11)[standard-layout](../language/data_members.html#Standard-layout "cpp/language/data members") type(since C++11), the result of `offsetof` is undefined(until C++17)use of the `offsetof` macro is conditionally-supported(since C++17). 

The expression offsetof(type, member) is never [type-dependent](../language/dependent_name.html#Dependent_types "cpp/language/dependent name") and it is value-dependent if and only if `type` is dependent. 

## Contents

  * [1 Exceptions](offsetof.html#Exceptions)
  * [2 Notes](offsetof.html#Notes)
  * [3 Example](offsetof.html#Example)
  * [4 Defect reports](offsetof.html#Defect_reports)
  * [5 See also](offsetof.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/offsetof&action=edit&section=1 "Edit section: Exceptions")] Exceptions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/offsetof&action=edit&section=2 "Edit section: Notes")] Notes

The offset of the first member of a standard-layout type is always zero ([empty-base optimization](../language/ebo.html "cpp/language/ebo") is mandatory).  | (since C++11)  
---|---  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/offsetof&action=edit&section=3 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/offsetof&action=edit&section=4 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[CWG 273](https://cplusplus.github.io/CWG/issues/273.html) | C++98  | `offsetof` may not work if unary `operator&` is overloaded  | required to work correctly even  
if `operator&` is overloaded   
[LWG 306](https://cplusplus.github.io/LWG/issue306) | C++98  | the behavior was not specified when `type` is not a [PODType](../named_req/PODType.html "cpp/named req/PODType") | the result is undefined in this case   
[LWG 449](https://cplusplus.github.io/LWG/issue449) | C++98  | other requirements of `offsetof` were  
removed by the resolution of [LWG issue 306](https://cplusplus.github.io/LWG/issue306) | added them back   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/offsetof&action=edit&section=5 "Edit section: See also")] See also
...
[C documentation](../../c/types/offsetof.html "c/types/offsetof") for offsetof
