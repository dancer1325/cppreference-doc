...
If `T` is a [referenceable type](../meta.html#Definitions "cpp/meta") or (possibly cv-qualified) void, the member typedef `type` provided is typename [std::remove_reference](remove_reference.html)<T>::type*. 
...
## Contents
  ...
  * [1 Nested types](add_pointer.html#Nested_types)
  * [2 Helper types](add_pointer.html#Helper_types)
  * [3 Possible implementation](add_pointer.html#Possible_implementation)
  * [4 Example](add_pointer.html#Example)
  * [5 Defect reports](add_pointer.html#Defect_reports)
  * [6 See also](add_pointer.html#See_also)
...
### Possible implementation
    ...
     
        ...
        auto try_add_pointer(int)
          -> type_identity<typename [std::remove_reference](remove_reference.html)<T>::type*>; // usual case
     
        template<class T>
...
Run this code
    ...
    void ptr_to_member_func_cvref_test(F Class::*)
    {
        ...
        static_assert([std::is_same_v](is_same.html)<F, FF>, "FF should be precisely F");
    }
     
    struct S
    {
    ...
    int main()
    {
        ...
        [std::cout](../io/cout.html) << "*pi = " << *pi << '\n';
     
        static_assert([std::is_pointer_v](is_pointer.html)<IntPtr>, "IntPtr should be a pointer");
        static_assert([std::is_same_v](is_same.html)<IntPtr, int*>, "IntPtr should be a pointer to int");
        static_assert([std::is_same_v](is_same.html)<IntPtr2, IntPtr>, "IntPtr2 should be equal to IntPtr");
     
        typedef [std::remove_pointer](remove_pointer.html)<IntPtr>::type IntAgain;
        IntAgain j = i;
        [std::cout](../io/cout.html) << "j = " << j << '\n';
     
        static_assert(![std::is_pointer_v](is_pointer.html)<IntAgain>, "IntAgain should not be a pointer");
        static_assert([std::is_same_v](is_same.html)<IntAgain, int>, "IntAgain should be equal to int");
     
