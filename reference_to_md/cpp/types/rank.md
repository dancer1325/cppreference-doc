...
## Contents
  ...
  * [1 Helper variable template](rank.html#Helper_variable_template)
  * [2 Inherited from std::integral_constant](rank.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](rank.html#Member_constants)
    * [2.2 Member functions](rank.html#Member_functions)
    * [2.3 Member types](rank.html#Member_types)
    * [2.4 Possible implementation](rank.html#Possible_implementation)
    * [2.5 Example](rank.html#Example)
    * [2.6 See also](rank.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/rank&action=edit&section=1 "Edit section: Helper variable template")] Helper variable template

template< class T >  
constexpr [std::size_t](size_t.html) rank_v = rank<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
value[static] |  the number of dimensions of `T` or zero   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/rank&action=edit&section=2 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class T>
    struct rank : public [std::integral_constant](integral_constant.html)<[std::size_t](size_t.html), 0> {};
     
    template<class T>
    struct rank<T[]> : public [std::integral_constant](integral_constant.html)<[std::size_t](size_t.html), rank<T>::value + 1> {};
     
    template<class T, [std::size_t](size_t.html) N>
    struct rank<T[N]> : public [std::integral_constant](integral_constant.html)<[std::size_t](size_t.html), rank<T>::value + 1> {};  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/rank&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        static_assert(std::rank_v<[std::remove_cvref_t](remove_cvref.html)<decltype(ary[0])>> == 1);
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/rank&action=edit&section=4 "Edit section: See also")] See also
