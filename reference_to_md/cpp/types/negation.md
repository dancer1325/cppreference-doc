...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/negation&action=edit&section=1 "Edit section: Template parameters")] Template parameters

B  |  \-  |  any type such that the expression bool(B::value) is a valid constant expression   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/negation&action=edit&section=2 "Edit section: Helper variable template")] Helper variable template
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/negation&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/negation&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/negation&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/negation&action=edit&section=6 "Edit section: See also")] See also
