...
`std::is_member_function_pointer` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 
...
## Contents
  ...
  * [1 Template parameters](is_member_function_pointer.html#Template_parameters)
  * [2 Helper variable template](is_member_function_pointer.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_member_function_pointer.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_member_function_pointer.html#Member_constants)
    * [3.2 Member functions](is_member_function_pointer.html#Member_functions)
    * [3.3 Member types](is_member_function_pointer.html#Member_types)
    * [3.4 Possible implementation](is_member_function_pointer.html#Possible_implementation)
    * [3.5 Example](is_member_function_pointer.html#Example)
    * [3.6 See also](is_member_function_pointer.html#See_also)
...
value[static] |  true if `T` is a member function pointer type, false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_member_function_pointer&action=edit&section=1 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class T>
    struct is_member_function_pointer_helper : [std::false_type](integral_constant.html) {};
     
    template<class T, class U>
    struct is_member_function_pointer_helper<T U::*> : [std::is_function](is_function.html)<T> {};
     
    template<class T>
    struct is_member_function_pointer 
        : is_member_function_pointer_helper<typename [std::remove_cv](remove_cv.html)<T>::type> {};  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_member_function_pointer&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_member_function_pointer&action=edit&section=3 "Edit section: See also")] See also
