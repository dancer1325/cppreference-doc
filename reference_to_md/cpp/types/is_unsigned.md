...
---|---|---  
template< class T >  
struct is_unsigned; |  |  (since C++11)  
| |   
  
`std::is_unsigned` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 

Checks whether `T` is an unsigned arithmetic type. 

  * If [std::is_arithmetic](is_arithmetic.html)<T>::value is true, provides the member constant `value` equal to T(0) < T(-1). 
...
## Contents
  ...
  * [1 Template parameters](is_unsigned.html#Template_parameters)
  * [2 Helper variable template](is_unsigned.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_unsigned.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_unsigned.html#Member_constants)
    * [3.2 Member functions](is_unsigned.html#Member_functions)
    * [3.3 Member types](is_unsigned.html#Member_types)
    * [3.4 Possible implementation](is_unsigned.html#Possible_implementation)
    * [3.5 Example](is_unsigned.html#Example)
    * [3.6 Defect reports](is_unsigned.html#Defect_reports)
    * [3.7 See also](is_unsigned.html#See_also)
...
template< class T >  
constexpr bool is_unsigned_v = is_unsigned<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
value[static] |  true if `T` is an unsigned integral type, false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_unsigned&action=edit&section=1 "Edit section: Possible implementation")] Possible implementation
    
    
    namespace detail
    {
        template<typename T,bool = [std::is_arithmetic](is_arithmetic.html)<T>::value>
        struct is_unsigned : [std::integral_constant](integral_constant.html)<bool, T(0) < T(-1)> {};
     
        template<typename T>
        struct is_unsigned<T,false> : [std::false_type](integral_constant.html) {};
    } // namespace detail
     
    template<typename T>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_unsigned&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main() 
    {
        ...
        [std::cout](../io/cout.html) << [std::boolalpha](../io/manip/boolalpha.html) << std::is_unsigned<char>::value << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_unsigned&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_unsigned&action=edit&section=4 "Edit section: See also")] See also
...
(public static member constant of `std::numeric_limits<T>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/types/numeric_limits/dsc_is_signed&action=edit)  
