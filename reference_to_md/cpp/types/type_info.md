...
Member functions  
---  
[type_info::~type_info](type_info/~type_info.html "cpp/types/type info/~type info")  
[type_info::operator==type_info::operator!=](type_info/operator_cmp.html "cpp/types/type info/operator cmp")(until C++20)  
[type_info::before](type_info/before.html "cpp/types/type info/before")  
...
The class `type_info` holds implementation-specific information about a type, including the name of the type and means to compare two types for equality or collating order. This is the class returned by the [`typeid`](../language/typeid.html "cpp/language/typeid") operator. 
...
---|---  
[ (destructor)](type_info/~type_info.html "cpp/types/type info/~type info")[virtual] |  the virtual destructor makes `type_info` a polymorphic class   
