...
Performs the type conversions equivalent to the ones performed when passing [function arguments](../language/function.html#Parameter_list "cpp/language/function") by value. Formally: 

  * If `T` is “array of `U`” or reference to it, the member typedef `type` is `U*`. 


  * Otherwise, if `T` is a function type `F` or reference to one, the member typedef `type` is [std::add_pointer](add_pointer.html)<F>::type. 


  * Otherwise, the member typedef `type` is [std::remove_cv](remove_cv.html)<[std::remove_reference](remove_reference.html)<T>::type>::type. 
...
## Contents
  ...
  * [1 Member types](decay.html#Member_types)
  * [2 Helper types](decay.html#Helper_types)
  * [3 Possible implementation](decay.html#Possible_implementation)
  * [4 Example](decay.html#Example)
  * [5 See also](decay.html#See_also)
...
### Possible implementation
    ...
    {
    private:
        typedef typename [std::remove_reference](remove_reference.html)<T>::type U;
    public:
        typedef typename [std::conditional](conditional.html)< 
            [std::is_array](is_array.html)<U>::value,
            typename [std::add_pointer](add_pointer.html)<typename [std::remove_extent](remove_extent.html)<U>::type>::type,
            typename [std::conditional](conditional.html)< 
                [std::is_function](is_function.html)<U>::value,
                typename [std::add_pointer](add_pointer.html)<U>::type,
                typename [std::remove_cv](remove_cv.html)<U>::type
            >::type
        >::type type;
    };  
...
Run this code
    ...
    constexpr bool is_decay_equ = [std::is_same_v](is_same.html)<std::decay_t<T>, U>;
     
    static_assert
    (
