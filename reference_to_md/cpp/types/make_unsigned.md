...
---|---|---  
template< class T >  
struct make_unsigned; |  |  (since C++11)  
| |   
...
If `T` is an enumeration type or char, wchar_t, char8_t(since C++20), char16_t, char32_t; the unsigned integer type with the smallest [rank](../language/implicit_cast.html#Integral_promotion "cpp/language/implicit conversion") having the same `sizeof` as `T` is provided. 
...
## Contents
  ...
  * [1 Member types](make_unsigned.html#Member_types)
  * [2 Helper types](make_unsigned.html#Helper_types)
  * [3 Example](make_unsigned.html#Example)
  * [4 See also](make_unsigned.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/make_unsigned&action=edit&section=1 "Edit section: Member types")] Member types

Name  |  Definition   
---|---  
`type` |  the unsigned integer type corresponding to `T`  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/make_unsigned&action=edit&section=2 "Edit section: Helper types")] Helper types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/make_unsigned&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
        static_assert(
            [std::is_same_v](is_same.html)<uchar_type, unsigned char> and
            [std::is_same_v](is_same.html)<uint_type, unsigned int> and
            [std::is_same_v](is_same.html)<ulong_type, volatile unsigned long>
        );
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/make_unsigned&action=edit&section=4 "Edit section: See also")] See also
