...
---|---|---  
class bad_typeid : public [std::exception](../error/exception.html) |  |   
| |   
  
An exception of this type is thrown when a [`typeid`](../language/typeid.html "cpp/language/typeid") operator is applied to a dereferenced null pointer value of a polymorphic type. 

![std-bad typeid-inheritance.svg](https://upload.cppreference.com/mwiki/images/6/69/std-bad_typeid-inheritance.svg)

Inheritance diagram

## Contents

  * [1 Member functions](bad_typeid.html#Member_functions)
  * [2 std::bad_typeid::bad_typeid](bad_typeid.html#std::bad_typeid::bad_typeid)
    * [2.1 Parameters](bad_typeid.html#Parameters)
  * [3 std::bad_typeid::operator=](bad_typeid.html#std::bad_typeid::operator.3D)
    * [3.1 Parameters](bad_typeid.html#Parameters_2)
    * [3.2 Return value](bad_typeid.html#Return_value)
  * [4 std::bad_typeid::what](bad_typeid.html#std::bad_typeid::what)
    * [4.1 Return value](bad_typeid.html#Return_value_2)
    * [4.2 Notes](bad_typeid.html#Notes)
  * [5 Inherited from std::exception](bad_typeid.html#Inherited_from_std::exception)
    * [5.1 Member functions](bad_typeid.html#Member_functions_2)
    * [5.2 Notes](bad_typeid.html#Notes_2)
    * [5.3 Example](bad_typeid.html#Example)
...
Constructs a new `bad_typeid` object with an implementation-defined null-terminated byte string which is accessible through [`what()`](../error/exception/what.html "cpp/error/exception/what"). 

1) Default constructor.

2) Copy constructor. If *this and other both have dynamic type `std::bad_typeid` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0.(since C++11)
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::bad_typeid` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment.(since C++11)
...
Run this code
    ...
    int main()
    {
        ...
        try
        {
            [std::cout](../io/cout.html) << typeid(*p).name() << '\n';
        }
