...
The macro `NULL` is an implementation-defined [null pointer constant](../language/pointer.html#Null_pointers "cpp/language/pointer"). 

## Contents

  * [1 Possible implementation](NULL.html#Possible_implementation)
  * [2 Notes](NULL.html#Notes)
...
Run this code
    ...
    {
        int* p = NULL;
        int* p2 = static_cast<[std::nullptr_t](nullptr_t.html)>(NULL);
        void(*f)(int) = NULL;
        int S::*mp = NULL;
        void(S::*mfp)(int) = NULL;
        auto nullvar = NULL; // may trigger a warning when compiling with gcc/clang
     
        [std::cout](../io/cout.html) << "The type of nullvar is " << typeid(nullvar).name() << '\n';
     
        if constexpr([std::is_same_v](is_same.html)<decltype(NULL), [std::nullptr_t](nullptr_t.html)>)
            [std::cout](../io/cout.html) << "NULL implemented with type std::nullptr_t\n";
        else
            [std::cout](../io/cout.html) << "NULL implemented using an integral type\n";
     
