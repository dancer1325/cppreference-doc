...
---|---|---  
template< class T >  
struct is_null_pointer; |  |  (since C++11)  
| |   
  
`std::is_null_pointer` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 

Checks whether `T` is the type [std::nullptr_t](nullptr_t.html "cpp/types/nullptr t"). 

Provides the member constant `value` that is equal to true, if `T` is the type [std::nullptr_t](nullptr_t.html "cpp/types/nullptr t"), const [std::nullptr_t](nullptr_t.html), volatile [std::nullptr_t](nullptr_t.html), or const volatile [std::nullptr_t](nullptr_t.html). 
...
## Contents
  ...
  * [1 Template parameters](is_null_pointer.html#Template_parameters)
  * [2 Helper variable template](is_null_pointer.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_null_pointer.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_null_pointer.html#Member_constants)
    * [3.2 Member functions](is_null_pointer.html#Member_functions)
    * [3.3 Member types](is_null_pointer.html#Member_types)
    * [3.4 Possible implementation](is_null_pointer.html#Possible_implementation)
    * [3.5 Notes](is_null_pointer.html#Notes)
    * [3.6 Example](is_null_pointer.html#Example)
    * [3.7 Defect reports](is_null_pointer.html#Defect_reports)
    * [3.8 See also](is_null_pointer.html#See_also)
...
value[static] |  true if `T` is the type [std::nullptr_t](nullptr_t.html "cpp/types/nullptr t") (possibly cv-qualified), false otherwise   
...
### Possible implementation
    ...
    template<class T>
    struct is_null_pointer : [std::is_same](is_same.html)<[std::nullptr_t](nullptr_t.html), [std::remove_cv_t](remove_cv.html)<T>> {};  
...
Run this code
    ...
    static_assert(![std::is_pointer_v](is_pointer.html)<decltype(nullptr)>);
    static_assert([std::is_pointer_v](is_pointer.html)<int*>);
     
    int main()
    {
    }
