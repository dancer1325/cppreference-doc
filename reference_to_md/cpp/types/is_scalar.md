...
`std::is_scalar` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 

If `T` is a [scalar type](../named_req/ScalarType.html "cpp/named req/ScalarType"), provides the member constant `value` equal true. For any other type, `value` is false. 

If the program adds specializations for `std::is_scalar` or `std::is_scalar_v`, the behavior is undefined. 

## Contents

  * [1 Template parameters](is_scalar.html#Template_parameters)
  * [2 Helper variable template](is_scalar.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_scalar.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_scalar.html#Member_constants)
    * [3.2 Member functions](is_scalar.html#Member_functions)
    * [3.3 Member types](is_scalar.html#Member_types)
    * [3.4 Notes](is_scalar.html#Notes)
    * [3.5 Possible implementation](is_scalar.html#Possible_implementation)
    * [3.6 Example](is_scalar.html#Example)
    * [3.7 See also](is_scalar.html#See_also)
...
value[static] |  true if `T` is a scalar type, false otherwise   
...
### Possible implementation
    ...
    template<class T>
    struct is_scalar : [std::integral_constant](integral_constant.html)<bool, [std::is_arithmetic](is_arithmetic.html)<T>::value
                                                 || [std::is_enum](is_enum.html)<T>::value
                                                 || [std::is_pointer](is_pointer.html)<T>::value
                                                 || [std::is_member_pointer](is_member_pointer.html)<T>::value
                                                 || [std::is_null_pointer](is_null_pointer.html)<T>::value>
    {};  
...
Run this code
    ...
    {
        using T = [std::decay_t](decay.html)<decltype(head)>;
     
        [std::cout](../io/cout.html) << typeid(T).name() << " is "
                  << (std::is_scalar_v<T> ? "" : "not ")
                  << "a scalar\n";
     
        if constexpr (sizeof... (Tail))
        {
            are_scalars([std::forward](../utility/forward.html)<decltype(tail)>(tail)...);
        }
    }
     
    int main()
