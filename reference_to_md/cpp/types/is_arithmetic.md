...
`std::is_arithmetic` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 
...
## Contents
  ...
  * [1 Template parameters](is_arithmetic.html#Template_parameters)
  * [2 Helper variable template](is_arithmetic.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_arithmetic.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_arithmetic.html#Member_constants)
    * [3.2 Member functions](is_arithmetic.html#Member_functions)
    * [3.3 Member types](is_arithmetic.html#Member_types)
    * [3.4 Notes](is_arithmetic.html#Notes)
    * [3.5 Possible implementation](is_arithmetic.html#Possible_implementation)
    * [3.6 Example](is_arithmetic.html#Example)
    * [3.7 See also](is_arithmetic.html#See_also)
...
value[static] |  true if `T` is an arithmetic type, false otherwise   
...
### Possible implementation
    ...
    template<class T>
    struct is_arithmetic : [std::integral_constant](integral_constant.html)<bool,
                                                  [std::is_integral](is_integral.html)<T>::value ||
                                                  [std::is_floating_point](is_floating_point.html)<T>::value> {};  
...
Run this code
    ...
    static_assert(
        ...
        std::is_arithmetic_v<[std::size_t](size_t.html)>     == true  and
     
        ...
        std::is_arithmetic_v<[std::byte](byte.html)>       == false and
        std::is_arithmetic_v<[std::atomic_int](../atomic/atomic.html)> == false
    );
     
    int main() {}
