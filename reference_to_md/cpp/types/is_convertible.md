...
---  
**is_convertible is_nothrow_convertible**(C++11)(C++20)  
...
1) If the imaginary function definition To test() { return [std::declval](../utility/declval.html)<From>(); } is well-formed, (that is, either [std::declval](../utility/declval.html)<From>() can be converted to `To` using [implicit conversions](../language/implicit_cast.html "cpp/language/implicit conversion"), or both `From` and `To` are possibly cv-qualified void), provides the member constant value equal to true. Otherwise value is false. For the purposes of this check, the use of [std::declval](../utility/declval.html "cpp/utility/declval") in the return statement is not considered an [ODR-use](../language/definition.html#ODR-use "cpp/language/definition").  If `To` is a reference type and a [temporary object](../language/reference_initialization.html#Lifetime_of_a_temporary "cpp/language/reference initialization") would be created when binding [std::declval](../utility/declval.html)<From>() to `To`, the return statement in the imaginary function is considered well-formed, even though such binding is ill-formed in an actual function.  | (since C++26)  
---|---  
  
[Access checks](../language/access.html "cpp/language/access") are performed as if from a context unrelated to either type. Only the validity of the immediate context of the expression in the return statement (including conversions to the return type) is considered.
...
## Contents
  ...
  * [1 Helper variable template](is_convertible.html#Helper_variable_template)
  * [2 Inherited from std::integral_constant](is_convertible.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](is_convertible.html#Member_constants)
    * [2.2 Member functions](is_convertible.html#Member_functions)
    * [2.3 Member types](is_convertible.html#Member_types)
    * [2.4 Possible implementation](is_convertible.html#Possible_implementation)
    * [2.5 Notes](is_convertible.html#Notes)
    * [2.6 Example](is_convertible.html#Example)
    * [2.7 See also](is_convertible.html#See_also)
...
value[static] |  true if `From` is convertible to `To`, false otherwise   
...
---  
    ...
    namespace detail
    {
        ...
        auto test_returnable(int) -> decltype(
            void(static_cast<T(*)()>(nullptr)), [std::true_type](integral_constant.html){}
        );
        template<class>
        auto test_returnable(...) -> [std::false_type](integral_constant.html);
     
        template<class From, class To>
        auto test_implicitly_convertible(int) -> decltype(
            void([std::declval](../utility/declval.html)<void(&)(To)>()([std::declval](../utility/declval.html)<From>())), [std::true_type](integral_constant.html){}
        );
        template<class, class>
        auto test_implicitly_convertible(...) -> [std::false_type](integral_constant.html);
    } // namespace detail
     
    template<class From, class To>
    struct is_convertible : [std::integral_constant](integral_constant.html)<bool,
        (decltype(detail::test_returnable<To>(0))::value &&
         decltype(detail::test_implicitly_convertible<From, To>(0))::value) ||
        ([std::is_void](is_void.html)<From>::value && [std::is_void](is_void.html)<To>::value)
    > {};  
  
[`is_nothrow_convertible` (2)](is_convertible.html#Version_2)  
      
    
    template<class From, class To>
    struct is_nothrow_convertible : [std::conjunction](conjunction.html)<[std::is_void](is_void.html)<From>, [std::is_void](is_void.html)<To>> {};
     
    template<class From, class To>
        requires
            requires
            {
                ...
                { [std::declval](../utility/declval.html)<void(&)(To) noexcept>()([std::declval](../utility/declval.html)<From>()) } noexcept;
            }
...
Run this code
    ...
     
        static_assert(!std::is_convertible_v<[std::string_view](../string/basic_string_view.html), [std::string](../string/basic_string.html)>);
        static_assert(std::is_convertible_v<[std::string](../string/basic_string.html), [std::string_view](../string/basic_string_view.html)>);
     
        auto stringify = []<typename T>(T x)
        {
            if constexpr (std::is_convertible_v<T, [std::string](../string/basic_string.html)> or
                          std::is_convertible_v<T, [std::string_view](../string/basic_string_view.html)>)
                return x;
            else
                return [std::to_string](../string/basic_string/to_string.html)(x);
        };
     
        using std::operator "" s, std::operator "" sv;
        const char* three = "three";
     
        [std::cout](../io/cout.html) << [std::quoted](../io/manip/quoted.html)(stringify("one"s)) << ' '
                  << [std::quoted](../io/manip/quoted.html)(stringify("two"sv)) << ' '
                  << [std::quoted](../io/manip/quoted.html)(stringify(three)) << ' '
                  << [std::quoted](../io/manip/quoted.html)(stringify(42)) << ' '
                  << [std::quoted](../io/manip/quoted.html)(stringify(42.0)) << '\n';
    }
