...
## Contents
  ...
  * [3 Notes](name.html#Notes)
  * [4 Example](name.html#Example)
  * [5 See also](name.html#See_also)
...
Run this code
    ...
     
        const Base* pb = &b1;
        [std::cout](../../io/cout.html) << typeid(*pb).name() << '\n';
        pb = &d1;
        [std::cout](../../io/cout.html) << typeid(*pb).name() << '\n';
     
        [std::string](../../string/basic_string.html) real_name = boost::core::demangle(typeid(pb).name());
        [std::cout](../../io/cout.html) << typeid(pb).name() << " => " << real_name << '\n';
     
        [std::cout](../../io/cout.html) << "c++filt => " << [std::flush](../../io/manip/flush.html);
        [std::string](../../string/basic_string.html) s = typeid(pb).name();
        [std::system](../../utility/program/system.html)(("c++filt -t " + s).data());
    }
