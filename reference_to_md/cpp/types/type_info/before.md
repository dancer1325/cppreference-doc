...
## Contents
  ...
  * [1 Parameters](before.html#Parameters)
  * [2 Return value](before.html#Return_value)
  * [3 Example](before.html#Example)
  * [4 See also](before.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/type_info/before&action=edit&section=1 "Edit section: Parameters")] Parameters

rhs  |  \-  |  another type information object to compare to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/type_info/before&action=edit&section=2 "Edit section: Return value")] Return value

true if the type of this `type_info` precedes the type of rhs in the implementation's collation order. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/type_info/before&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        if (typeid(int).before(typeid(char)))
            [std::cout](../../io/cout.html) << "int goes before char in this implementation.\n";
        else
            [std::cout](../../io/cout.html) << "char goes before int in this implementation.\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/type_info/before&action=edit&section=4 "Edit section: See also")] See also
