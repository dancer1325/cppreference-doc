...
## Contents
  ...
  * [1 Member types](remove_pointer.html#Member_types)
  * [2 Helper types](remove_pointer.html#Helper_types)
  * [3 Possible implementation](remove_pointer.html#Possible_implementation)
  * [4 Example](remove_pointer.html#Example)
  * [5 See also](remove_pointer.html#See_also)
...
Run this code
    ...
    static_assert
    (
        [std::is_same_v](is_same.html)<int, int> == true &&
        [std::is_same_v](is_same.html)<int, int*> == false &&
        [std::is_same_v](is_same.html)<int, int**> == false &&
        [std::is_same_v](is_same.html)<int, std::remove_pointer_t<int>> == true &&
        [std::is_same_v](is_same.html)<int, std::remove_pointer_t<int*>> == true &&
        [std::is_same_v](is_same.html)<int, std::remove_pointer_t<int**>> == false &&
        [std::is_same_v](is_same.html)<int, std::remove_pointer_t<int* const>> == true &&
        [std::is_same_v](is_same.html)<int, std::remove_pointer_t<int* volatile>> == true &&
        [std::is_same_v](is_same.html)<int, std::remove_pointer_t<int* const volatile>> == true
    );
     
    int main() {}
