...
`std::is_standard_layout` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 

If `T` is a [standard-layout type](../named_req/StandardLayoutType.html "cpp/named req/StandardLayoutType"), provides the member constant `value` equal to true. For any other type, `value` is false. 
...
## Contents
  ...
  * [1 Template parameters](is_standard_layout.html#Template_parameters)
  * [2 Helper variable template](is_standard_layout.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_standard_layout.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_standard_layout.html#Member_constants)
    * [3.2 Member functions](is_standard_layout.html#Member_functions)
    * [3.3 Member types](is_standard_layout.html#Member_types)
    * [3.4 Notes](is_standard_layout.html#Notes)
    * [3.5 Example](is_standard_layout.html#Example)
    * [3.6 Defect reports](is_standard_layout.html#Defect_reports)
    * [3.7 See also](is_standard_layout.html#See_also)
