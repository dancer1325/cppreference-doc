...
`std::is_rvalue_reference` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 
...
## Contents
  ...
  * [1 Template parameters](is_rvalue_reference.html#Template_parameters)
  * [2 Helper variable template](is_rvalue_reference.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_rvalue_reference.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_rvalue_reference.html#Member_constants)
    * [3.2 Member functions](is_rvalue_reference.html#Member_functions)
    * [3.3 Member types](is_rvalue_reference.html#Member_types)
    * [3.4 Possible implementation](is_rvalue_reference.html#Possible_implementation)
    * [3.5 Example](is_rvalue_reference.html#Example)
    * [3.6 See also](is_rvalue_reference.html#See_also)
...
template< class T >  
constexpr bool is_rvalue_reference_v = is_rvalue_reference<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
value[static] |  true if `T` is an rvalue reference type, false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_rvalue_reference&action=edit&section=1 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class T> struct is_rvalue_reference : [std::false_type](integral_constant.html) {};
    template<class T> struct is_rvalue_reference<T&&> : [std::true_type](integral_constant.html) {};  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_rvalue_reference&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    void test(T&& x)
    {
        static_assert([std::is_same_v](is_same.html)<T&&, decltype(x)>);
        [std::cout](../io/cout.html) << "T\t" << std::is_rvalue_reference<T>::value << '\n';
        [std::cout](../io/cout.html) << "T&&\t" << std::is_rvalue_reference<T&&>::value << '\n';
        [std::cout](../io/cout.html) << "decltype(x)\t" << std::is_rvalue_reference<decltype(x)>::value << '\n';
    }
     
    int main()
    {
        [std::cout](../io/cout.html) << [std::boolalpha](../io/manip/boolalpha.html);
        [std::cout](../io/cout.html) << "A\t" << std::is_rvalue_reference<A>::value << '\n';
        [std::cout](../io/cout.html) << "A&\t" << std::is_rvalue_reference<A&>::value << '\n';
        [std::cout](../io/cout.html) << "A&&\t" << std::is_rvalue_reference<A&&>::value << '\n';
        [std::cout](../io/cout.html) << "char\t" << std::is_rvalue_reference<char>::value << '\n';
        [std::cout](../io/cout.html) << "char&\t" << std::is_rvalue_reference<char&>::value << '\n';
        [std::cout](../io/cout.html) << "char&&\t" << std::is_rvalue_reference<char&&>::value << '\n';
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_rvalue_reference&action=edit&section=3 "Edit section: See also")] See also
