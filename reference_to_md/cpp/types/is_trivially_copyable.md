...
---|---|---  
template< class T >  
struct is_trivially_copyable; |  |  (since C++11)  
| |   
  
`std::is_trivially_copyable` is a [UnaryTypeTrait](../named_req/UnaryTypeTrait.html "cpp/named req/UnaryTypeTrait"). 

If `T` is a [trivially copyable](../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable") type, provides the member constant `value` equal to true. For any other type, `value` is false. 
...
## Contents
  ...
  * [1 Template parameters](is_trivially_copyable.html#Template_parameters)
  * [2 Helper variable template](is_trivially_copyable.html#Helper_variable_template)
  * [3 Inherited from std::integral_constant](is_trivially_copyable.html#Inherited_from_std::integral_constant)
    * [3.1 Member constants](is_trivially_copyable.html#Member_constants)
    * [3.2 Member functions](is_trivially_copyable.html#Member_functions)
    * [3.3 Member types](is_trivially_copyable.html#Member_types)
    * [3.4 Notes](is_trivially_copyable.html#Notes)
    * [3.5 Example](is_trivially_copyable.html#Example)
    * [3.6 Defect reports](is_trivially_copyable.html#Defect_reports)
    * [3.7 See also](is_trivially_copyable.html#See_also)
...
template< class T >  
constexpr bool is_trivially_copyable_v = is_trivially_copyable<T>::value; |  |  (since C++17)  
---|---|---  
| |   
...
value[static] |  true if `T` is a trivially copyable type, false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_trivially_copyable&action=edit&section=1 "Edit section: Notes")] Notes

Objects of trivially-copyable types that are not potentially-overlapping subobjects are the only C++ objects that may be safely copied with [std::memcpy](../string/byte/memcpy.html "cpp/string/byte/memcpy") or serialized to/from binary files with [`std::ofstream::write()`](../io/basic_ostream/write.html "cpp/io/basic ostream/write") / [`std::ifstream::read()`](../io/basic_istream/read.html "cpp/io/basic istream/read"). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_trivially_copyable&action=edit&section=2 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_trivially_copyable&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_trivially_copyable&action=edit&section=4 "Edit section: See also")] See also
