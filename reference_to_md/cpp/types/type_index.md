...
Member functions  
---  
[type_index::type_index](type_index/type_index.html "cpp/types/type index/type index")  
[type_index::operator=type_index::operator!=type_index::operator<type_index::operator<=type_index::operator>type_index::operator>=type_index::operator<=>](type_index/operator_cmp.html "cpp/types/type index/operator cmp")(until C++20)(C++20)  
[type_index::hash_code](type_index/hash_code.html "cpp/types/type index/hash code")  
[type_index::name](type_index/name.html "cpp/types/type index/name")  
Helper classes  
...
The `type_index` class is a wrapper class around a [std::type_info](type_info.html "cpp/types/type info") object, that can be used as index in associative and unordered associative containers. The relationship with `type_info` object is maintained through a pointer, therefore `type_index` is [CopyConstructible](../named_req/CopyConstructible.html "cpp/named req/CopyConstructible") and [CopyAssignable](../named_req/CopyAssignable.html "cpp/named req/CopyAssignable"). 

## Contents

  * [1 Member functions](type_index.html#Member_functions)
  * [2 Helper classes](type_index.html#Helper_classes)
  * [3 Example](type_index.html#Example)
  * [4 See also](type_index.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::unordered_map](../container/unordered_map.html)<std::type_index, [std::string](../string/basic_string.html)> type_names;
     
    ...
     
        [std::cout](../io/cout.html) << "i is " << type_names[std::type_index(typeid(i))] << '\n';
        [std::cout](../io/cout.html) << "d is " << type_names[std::type_index(typeid(d))] << '\n';
        [std::cout](../io/cout.html) << "a is " << type_names[std::type_index(typeid(a))] << '\n';
        [std::cout](../io/cout.html) << "*b is " << type_names[std::type_index(typeid(*b))] << '\n';
        [std::cout](../io/cout.html) << "*c is " << type_names[std::type_index(typeid(*c))] << '\n';
    }
