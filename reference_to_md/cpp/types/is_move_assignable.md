...
---  
**is_move_assignable is_trivially_move_assignableis_nothrow_move_assignable**(C++11)(C++11)(C++11)  
...
---|---|---  
template< class T >  
struct is_move_assignable; |  (1)  |  (since C++11)  
template< class T >  
struct is_trivially_move_assignable; |  (2)  |  (since C++11)  
template< class T >  
struct is_nothrow_move_assignable; |  (3)  |  (since C++11)  
| |   
...
(1) | [std::is_assignable](is_assignable.html)<T&, T&&>::value | false  
(2) | [std::is_trivially_assignable](is_assignable.html)<T&, T&&>::value  
(3) | [std::is_nothrow_assignable](is_assignable.html)<T&, T&&>::value  
...
## Contents
  ...
  * [1 Helper variable templates](is_move_assignable.html#Helper_variable_templates)
  * [2 Inherited from std::integral_constant](is_move_assignable.html#Inherited_from_std::integral_constant)
    * [2.1 Member constants](is_move_assignable.html#Member_constants)
    * [2.2 Member functions](is_move_assignable.html#Member_functions)
    * [2.3 Member types](is_move_assignable.html#Member_types)
    * [2.4 Possible implementation](is_move_assignable.html#Possible_implementation)
    * [2.5 Notes](is_move_assignable.html#Notes)
    * [2.6 Example](is_move_assignable.html#Example)
    * [2.7 Defect reports](is_move_assignable.html#Defect_reports)
    * [2.8 See also](is_move_assignable.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_move_assignable&action=edit&section=1 "Edit section: Helper variable templates")] Helper variable templates
...
value[static] |  true if `T` is move-assignable, false otherwise   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_move_assignable&action=edit&section=2 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class T>
    struct is_move_assignable
        : [std::is_assignable](is_assignable.html)<typename [std::add_lvalue_reference](add_reference.html)<T>::type,
                             typename [std::add_rvalue_reference](add_reference.html)<T>::type> {};
     
    template<class T>
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_move_assignable&action=edit&section=3 "Edit section: Notes")] Notes
...
The type does not have to implement a [move assignment operator](../language/move_operator.html "cpp/language/move assignment") in order to satisfy this trait; see [MoveAssignable](../named_req/MoveAssignable.html "cpp/named req/MoveAssignable") for details. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_move_assignable&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../io/cout.html) << [std::boolalpha](../io/manip/boolalpha.html)
                  ...
                  << std::is_nothrow_move_assignable<[std::string](../string/basic_string.html)>::value << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_move_assignable&action=edit&section=5 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_move_assignable&action=edit&section=6 "Edit section: See also")] See also
