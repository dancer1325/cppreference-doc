...
---|---|---  
template< class T >  
struct remove_all_extents; |  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Member types](remove_all_extents.html#Member_types)
  * [2 Helper types](remove_all_extents.html#Helper_types)
  * [3 Possible implementation](remove_all_extents.html#Possible_implementation)
  * [4 Example](remove_all_extents.html#Example)
  * [5 See also](remove_all_extents.html#See_also)
...
Run this code
    ...
    void info(const A&)
    {
        ...
        [std::cout](../io/cout.html) << "underlying type: " << typeid(Type).name() << '\n';
    }
     
    int main()
    {
