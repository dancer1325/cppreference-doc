...
The value of [std::numeric_limits](../numeric_limits.html)<T>::max_exponent10 is the largest positive number n such that \\(\scriptsize 10^n\\)10n  
is a representable finite value of the floating-point type `T`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/max_exponent10&action=edit&section=1 "Edit section: Standard specializations")] Standard specializations

`T` |  value of [std::numeric_limits](../numeric_limits.html)<T>::max_exponent10  
---|---  
/* non-specialized */ |  ​0​  
bool |  ​0​  
char |  ​0​  
...
float |  [FLT_MAX_10_EXP](../climits.html "cpp/types/climits")  
double |  [DBL_MAX_10_EXP](../climits.html "cpp/types/climits")  
long double |  [LDBL_MAX_10_EXP](../climits.html "cpp/types/climits")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/max_exponent10&action=edit&section=2 "Edit section: Example")] Example

Demonstrates the relationships of [max_exponent](max_exponent.html "cpp/types/numeric limits/max exponent"), `max_exponent10`, and [max()](max.html "cpp/types/numeric limits/max") for the type float:
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/max_exponent10&action=edit&section=3 "Edit section: See also")] See also
