...
Run this code
    ...
    static_assert
    (
            [std::numeric_limits](../numeric_limits.html)<bool>::is_integer
        &&  [std::numeric_limits](../numeric_limits.html)<[std::size_t](../size_t.html)>::is_integer
        &&  [std::numeric_limits](../numeric_limits.html)<[std::int32_t](../integer.html)>::is_integer
        &&  [std::numeric_limits](../numeric_limits.html)<[std::int64_t](../integer.html)>::is_integer
        &&  [std::numeric_limits](../numeric_limits.html)<decltype(42)>::is_integer
        && ![std::numeric_limits](../numeric_limits.html)<int*>::is_integer
        && ![std::numeric_limits](../numeric_limits.html)<float>::is_integer
        && ![std::numeric_limits](../numeric_limits.html)<double>::is_integer
        && ![std::numeric_limits](../numeric_limits.html)<long double>::is_integer
        && ![std::numeric_limits](../numeric_limits.html)<decltype([](){})>::is_integer // P0315R4
    );
     
    int main() {}
