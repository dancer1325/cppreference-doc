...
The value of [std::numeric_limits](../numeric_limits.html)<T>::max_exponent is the largest positive number n such that \\(\scriptsize r^{n-1}\\)rn-1  
, where r is [std::numeric_limits](../numeric_limits.html)<T>::radix, is a representable finite value of the floating-point type `T`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/max_exponent&action=edit&section=1 "Edit section: Standard specializations")] Standard specializations

`T` |  value of [std::numeric_limits](../numeric_limits.html)<T>::max_exponent  
---|---  
/* non-specialized */ |  ​0​  
bool |  ​0​  
char |  ​0​  
...
float |  [FLT_MAX_EXP](../climits.html "cpp/types/climits")  
double |  [DBL_MAX_EXP](../climits.html "cpp/types/climits")  
long double |  [LDBL_MAX_EXP](../climits.html "cpp/types/climits")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/max_exponent&action=edit&section=2 "Edit section: Example")] Example

Demonstrates the relationships of `max_exponent`, [max_exponent10](max_exponent10.html "cpp/types/numeric limits/max exponent10"), and [max()](max.html "cpp/types/numeric limits/max") for the type float:
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "max() = " << [std::numeric_limits](../numeric_limits.html)<float>::max() << '\n'
                  << "max_exponent10 = " << [std::numeric_limits](../numeric_limits.html)<float>::max_exponent10 << '\n'
                  << [std::hexfloat](../../io/manip/fixed.html) << '\n'
                  << "max() = " << [std::numeric_limits](../numeric_limits.html)<float>::max() << '\n'
                  << "max_exponent = " << [std::numeric_limits](../numeric_limits.html)<float>::max_exponent << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/max_exponent&action=edit&section=3 "Edit section: See also")] See also

[ min_exponent10](min_exponent10.html "cpp/types/numeric limits/min exponent10")[static] |  the smallest negative power of ten that is a valid normalized floating-point value   
