...
The value of [std::numeric_limits](../numeric_limits.html)<T>::min_exponent is the lowest negative number n such that \\(\scriptsize r^{n-1}\\)rn-1  
, where r is [std::numeric_limits](../numeric_limits.html)<T>::radix, is a valid normalized value of the floating-point type `T`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/min_exponent&action=edit&section=1 "Edit section: Standard specializations")] Standard specializations

`T` |  value of [std::numeric_limits](../numeric_limits.html)<T>::min_exponent  
---|---  
/* non-specialized */ |  ​0​  
bool |  ​0​  
char |  ​0​  
...
float |  [FLT_MIN_EXP](../climits.html "cpp/types/climits")  
double |  [DBL_MIN_EXP](../climits.html "cpp/types/climits")  
long double |  [LDBL_MIN_EXP](../climits.html "cpp/types/climits")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/min_exponent&action=edit&section=2 "Edit section: Example")] Example

Demonstrates the relationships of `min_exponent`, [min_exponent10](min_exponent10.html "cpp/types/numeric limits/min exponent10"), [min()](min.html "cpp/types/numeric limits/min"), and [radix](radix.html "cpp/types/numeric limits/radix") for the type float:
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/min_exponent&action=edit&section=3 "Edit section: See also")] See also
