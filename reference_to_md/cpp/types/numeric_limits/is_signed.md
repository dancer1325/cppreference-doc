...
The value of [std::numeric_limits](../numeric_limits.html)<T>::is_signed is true for all signed arithmetic types `T` and false for the unsigned types. This constant is meaningful for all specializations. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/is_signed&action=edit&section=1 "Edit section: Standard specializations")] Standard specializations

`T` |  value of [std::numeric_limits](../numeric_limits.html)<T>::is_signed  
---|---  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/is_signed&action=edit&section=2 "Edit section: Example")] Example
    ...
    struct test
    {
        test(const char* name, int w = 15)
        {
            [std::cout](../../io/cout.html)
                << [std::left](../../io/manip/left.html) << [std::setw](../../io/manip/setw.html)(w)
                << ([std::numeric_limits](../numeric_limits.html)<T>::is_specialized ? name : "non-specialized")
                << " : "
                << ([std::numeric_limits](../numeric_limits.html)<T>::is_signed ? "" : "un") << "signed\n";
        }
    };
     
    int main()
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/is_signed&action=edit&section=3 "Edit section: See also")] See also
