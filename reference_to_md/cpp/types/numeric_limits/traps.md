...
The value of [std::numeric_limits](../numeric_limits.html)<T>::traps is true for all arithmetic types `T` that have at least one value at the start of the program that, if used as an argument to an arithmetic operation, will generate a [trap](https://en.wikipedia.org/wiki/Trap_\(computing\) "enwiki:Trap \(computing\)"). 

## Contents

  * [1 Standard specializations](traps.html#Standard_specializations)
  * [2 Notes](traps.html#Notes)
  * [3 Example](traps.html#Example)
  * [4 Defect reports](traps.html#Defect_reports)
  * [5 See also](traps.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html)
                  << "bool:     traps = " << [std::numeric_limits](../numeric_limits.html)<bool>::traps << '\n'
                  << "char:     traps = " << [std::numeric_limits](../numeric_limits.html)<char>::traps << '\n'
                  << "char16_t: traps = " << [std::numeric_limits](../numeric_limits.html)<char16_t>::traps << '\n'
                  << "long:     traps = " << [std::numeric_limits](../numeric_limits.html)<long>::traps << '\n'
                  << "float:    traps = " << [std::numeric_limits](../numeric_limits.html)<float>::traps << '\n';
    }
...
---|---|---|---  
[LWG 497](https://cplusplus.github.io/LWG/issue497) | C++98  | it was unclear what is returned if trapping  
