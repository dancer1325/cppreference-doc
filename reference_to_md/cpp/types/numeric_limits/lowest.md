...
Returns the lowest finite value representable by the numeric type `T`, that is, a finite value x such that there is no other finite value y where y < x. This is different from [std::numeric_limits](../numeric_limits.html)<T>::min() for floating-point types. Only meaningful for bounded types. 

## Contents

  * [1 Return value](lowest.html#Return_value)
  * [2 Notes](lowest.html#Notes)
  * [3 Example](lowest.html#Example)
  * [4 See also](lowest.html#See_also)
...
/* non-specialized */ |  T()  
bool |  false  
char |  [CHAR_MIN](../climits.html "cpp/types/climits")  
signed char |  [SCHAR_MIN](../climits.html "cpp/types/climits")  
unsigned char |  ​0​  
wchar_t |  [WCHAR_MIN](../climits.html "cpp/types/climits")  
char8_t (since C++20) |  ​0​  
char16_t |  ​0​  
char32_t |  ​0​  
short |  [SHRT_MIN](../climits.html "cpp/types/climits")  
unsigned short |  ​0​  
int |  [INT_MIN](../climits.html "cpp/types/climits")  
unsigned int |  ​0​  
long |  [LONG_MIN](../climits.html "cpp/types/climits")  
unsigned long |  ​0​  
long long |  [LLONG_MIN](../climits.html "cpp/types/climits")  
unsigned long long |  ​0​  
float |  -[FLT_MAX](../climits.html)  
...
Run this code
    ...
     
    template<typename T>
    void print_twice([std::string_view](../../string/basic_string_view.html) type, T value)
    {
        [std::cout](../../io/cout.html) << '\t' << type << ": "
                  << [std::defaultfloat](../../io/manip/fixed.html) << value << " or "
                  << [std::hexfloat](../../io/manip/fixed.html) << value << '\n';
    }
     
    int main()
    {
        // min()
        [std::cout](../../io/cout.html) << "std::numeric_limits<T>::min():\n";
        print_twice("float", [std::numeric_limits](../numeric_limits.html)<float>::min());
        print_twice("double", [std::numeric_limits](../numeric_limits.html)<double>::min());
        print_twice("long double", [std::numeric_limits](../numeric_limits.html)<long double>::min());
     
        // lowest()
        [std::cout](../../io/cout.html) << "std::numeric_limits<T>::lowest():\n";
        print_twice("float", [std::numeric_limits](../numeric_limits.html)<float>::lowest());
        print_twice("double", [std::numeric_limits](../numeric_limits.html)<double>::lowest());
        print_twice("long double", [std::numeric_limits](../numeric_limits.html)<long double>::lowest());
     
        // max()
        [std::cout](../../io/cout.html) << "std::numeric_limits<T>::max():\n";
        print_twice("float", [std::numeric_limits](../numeric_limits.html)<float>::max());
        print_twice("double", [std::numeric_limits](../numeric_limits.html)<double>::max());
        print_twice("long double", [std::numeric_limits](../numeric_limits.html)<long double>::max());
    }
