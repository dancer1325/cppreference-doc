...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html)
                  << [std::numeric_limits](../numeric_limits.html)<bool>::is_specialized << '\n'
                  << [std::numeric_limits](../numeric_limits.html)<long long>::is_specialized << '\n'
                  << [std::numeric_limits](../numeric_limits.html)<[std::true_type](../integral_constant.html)>::is_specialized << '\n'
                  << [std::numeric_limits](../numeric_limits.html)<E>::is_specialized << '\n';
    }
