...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/max&action=edit&section=1 "Edit section: Return value")] Return value

`T` |  [std::numeric_limits](../numeric_limits.html)<T>::max()  
---|---  
/* non-specialized */ |  T()  
bool |  true  
char |  [CHAR_MAX](../climits.html)  
signed char |  [SCHAR_MAX](../climits.html)  
unsigned char |  [UCHAR_MAX](../climits.html)  
wchar_t |  [WCHAR_MAX](../climits.html)  
char8_t (since C++20) |  [UCHAR_MAX](../climits.html)  
char16_t (since C++11) |  [UINT_LEAST16_MAX](../integer.html)  
char32_t (since C++11) |  [UINT_LEAST32_MAX](../integer.html)  
short |  [SHRT_MAX](../climits.html)  
unsigned short |  [USHRT_MAX](../climits.html)  
int |  [INT_MAX](../climits.html)  
unsigned int |  [UINT_MAX](../climits.html)  
long |  [LONG_MAX](../climits.html)  
unsigned long |  [ULONG_MAX](../climits.html)  
long long (since C++11) |  [LLONG_MAX](../climits.html)  
unsigned long long (since C++11) |  [ULLONG_MAX](../climits.html)  
float |  [FLT_MAX](../climits.html)  
double |  [DBL_MAX](../climits.html)  
long double |  [LDBL_MAX](../climits.html)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/max&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    {
        constexpr T max{[std::numeric_limits](../numeric_limits.html)<T>::max()};
     
        [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(16) << boost::typeindex::type_id<T>() << ": ";
        if constexpr ([std::is_floating_point_v](../is_floating_point.html)<T>)
            [std::cout](../../io/cout.html) << [std::defaultfloat](../../io/manip/fixed.html) << max << " = " << [std::hexfloat](../../io/manip/fixed.html) << max << '\n';
        else
        {
            constexpr auto m{static_cast<unsigned long long>(max)};
            [std::cout](../../io/cout.html) << [std::dec](../../io/manip/hex.html) << m << " = " << [std::hex](../../io/manip/hex.html) << m << '\n';
        }
    }
     
    int main()
    {
        [std::cout](../../io/cout.html) << [std::showbase](../../io/manip/showbase.html);
     
        print_max_value_of<bool>();
        print_max_value_of<short>();
        print_max_value_of<int>();
        print_max_value_of<[std::streamsize](../../io/streamsize.html)>();
        print_max_value_of<[std::size_t](../size_t.html)>();
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/max&action=edit&section=3 "Edit section: See also")] See also
