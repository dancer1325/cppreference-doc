...
Returns the machine epsilon, that is, the difference between 1.0 and the next value representable by the floating-point type `T`. It is only meaningful if [std::numeric_limits](../numeric_limits.html)<T>::is_integer == false. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/epsilon&action=edit&section=1 "Edit section: Return value")] Return value

`T` |  [std::numeric_limits](../numeric_limits.html)<T>::epsilon()  
---|---  
/* non-specialized */ |  T()  
bool |  false  
char |  ​0​  
...
float |  [FLT_EPSILON](../climits.html "cpp/types/climits")  
double |  [DBL_EPSILON](../climits.html "cpp/types/climits")  
long double |  [LDBL_EPSILON](../climits.html "cpp/types/climits")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/epsilon&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
    template <class T>
    [std::enable_if_t](../enable_if.html)<not [std::numeric_limits](../numeric_limits.html)<T>::is_integer, bool>
    equal_within_ulps(T x, T y, [std::size_t](../size_t.html) n)
    {
    ...
     
        ...
        const T m = [std::min](../../algorithm/min.html)([std::fabs](../../numeric/math/fabs.html)(x), [std::fabs](../../numeric/math/fabs.html)(y));
     
        // Subnormal numbers have fixed exponent, which is `min_exponent - 1`.
        const int exp = m < [std::numeric_limits](../numeric_limits.html)<T>::min()
                      ? [std::numeric_limits](../numeric_limits.html)<T>::min_exponent - 1
                      : [std::ilogb](../../numeric/math/ilogb.html)(m);
     
        // We consider `x` and `y` equal if the difference between them is
        // within `n` ULPs.
        return [std::fabs](../../numeric/math/fabs.html)(x - y) <= n * [std::ldexp](../../numeric/math/ldexp.html)([std::numeric_limits](../numeric_limits.html)<T>::epsilon(), exp);
    }
     
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "x = " << x << '\n';
        [std::cout](../../io/cout.html) << "y = " << y << '\n';
        [std::cout](../../io/cout.html) << (x == y ? "x == y" : "x != y") << '\n';
        for ([std::size_t](../size_t.html) n = 0; n <= 10; ++n)
            if (equal_within_ulps(x, y, n))
            {
                [std::cout](../../io/cout.html) << "x equals y within " << n << " ulps" << '\n';
                break;
            }
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/epsilon&action=edit&section=3 "Edit section: See also")] See also
