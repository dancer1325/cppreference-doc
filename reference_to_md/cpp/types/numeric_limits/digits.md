...
The value of [std::numeric_limits](../numeric_limits.html)<T>::digits is the number of digits in base-[radix](radix.html "cpp/types/numeric limits/radix") that can be represented by the type `T` without change. For integer types, this is the number of bits not counting the sign bit and the padding bits (if any). For floating-point types, this is the digits of the mantissa (for [IEC 559/IEEE 754](is_iec559.html "cpp/types/numeric limits/is iec559") implementations, this is the number of digits stored for the mantissa plus one, because the mantissa has an implicit leading 1 and binary point). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/digits&action=edit&section=1 "Edit section: Standard specializations")] Standard specializations

`T` |  value of [std::numeric_limits](../numeric_limits.html)<T>::digits  
(assuming no [padding bits](../../language/objects.html#Object_representation_and_value_representation "cpp/language/object"))   
---|---  
/* non-specialized */ |  ​0​  
bool |  1  
char |  [CHAR_BIT](../climits.html) - [std::numeric_limits](../numeric_limits.html)<char>::is_signed  
signed char |  [CHAR_BIT](../climits.html) - 1  
unsigned char |  [CHAR_BIT](../climits.html "cpp/types/climits")  
wchar_t |  [CHAR_BIT](../climits.html) * sizeof(wchar_t)  
- [std::numeric_limits](../numeric_limits.html)<wchar_t>::is_signed  
char8_t (since C++20) |  [CHAR_BIT](../climits.html "cpp/types/climits")  
char16_t (since C++11) |  [CHAR_BIT](../climits.html) * sizeof(char16_t)  
char32_t (since C++11) |  [CHAR_BIT](../climits.html) * sizeof(char32_t)  
short |  [CHAR_BIT](../climits.html) * sizeof(short) - 1  
unsigned short |  [CHAR_BIT](../climits.html) * sizeof(short)  
int |  [CHAR_BIT](../climits.html) * sizeof(int) - 1  
unsigned int |  [CHAR_BIT](../climits.html) * sizeof(int)  
long |  [CHAR_BIT](../climits.html) * sizeof(long) - 1  
unsigned long |  [CHAR_BIT](../climits.html) * sizeof(long)  
long long (since C++11) |  [CHAR_BIT](../climits.html) * sizeof(long long) - 1  
unsigned long long (since C++11) |  [CHAR_BIT](../climits.html) * sizeof(long long)  
float |  [FLT_MANT_DIG](../climits.html "cpp/types/climits")  
double |  [DBL_MANT_DIG](../climits.html "cpp/types/climits")  
long double |  [LDBL_MANT_DIG](../climits.html "cpp/types/climits")  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/digits&action=edit&section=2 "Edit section: See also")] See also
