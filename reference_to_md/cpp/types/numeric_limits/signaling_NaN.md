...
Returns the special value "signaling [not-a-number](https://en.wikipedia.org/wiki/NaN "enwiki:NaN")", as represented by the floating-point type `T`. Only meaningful if [std::numeric_limits](../numeric_limits.html)<T>::has_signaling_NaN == true. In IEEE 754, the most common binary representation of floating-point numbers, any value with all bits of the exponent set and at least one bit of the fraction set represents a NaN. It is implementation-defined which values of the fraction represent quiet or signaling NaNs, and whether the sign bit is meaningful. 

## Contents

  * [1 Return value](signaling_NaN.html#Return_value)
  * [2 Notes](signaling_NaN.html#Notes)
  * [3 Example](signaling_NaN.html#Example)
  * [4 See also](signaling_NaN.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/signaling_NaN&action=edit&section=1 "Edit section: Return value")] Return value

`T` |  [std::numeric_limits](../numeric_limits.html)<T>::signaling_NaN()  
---|---  
/* non-specialized */ |  T()  
bool |  false  
char |  ​0​  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/signaling_NaN&action=edit&section=2 "Edit section: Notes")] Notes

A NaN never compares equal to itself. Copying a NaN is not required, by IEEE-754, to preserve its bit representation (sign and [payload](../../numeric/math/nan.html "cpp/numeric/math/nan")), though most implementation do. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/signaling_NaN&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    {
        int n = [std::fetestexcept](../../numeric/fenv/fetestexcept.html)([FE_ALL_EXCEPT](../../numeric/fenv/FE_exceptions.html));
     
        if (n & [FE_INVALID](../../numeric/fenv/FE_exceptions.html))
            [std::cout](../../io/cout.html) << "FE_INVALID is raised\n";
        else if (n == 0)
            [std::cout](../../io/cout.html) << "no exceptions are raised\n";
     
        [std::feclearexcept](../../numeric/fenv/feclearexcept.html)([FE_ALL_EXCEPT](../../numeric/fenv/FE_exceptions.html));
    }
     
    int main()
    {
        double snan = [std::numeric_limits](../numeric_limits.html)<double>::signaling_NaN();
        [std::cout](../../io/cout.html) << "After sNaN was obtained, ";
        show_fe_exceptions();
     
        double qnan = snan * 2.0;
        [std::cout](../../io/cout.html) << "After sNaN was multiplied by 2, ";
        show_fe_exceptions();
     
        double qnan2 = qnan * 2.0;
        [std::cout](../../io/cout.html) << "After the quieted NaN was multiplied by 2, ";
        show_fe_exceptions();
     
        [std::cout](../../io/cout.html) << "The result is " << qnan2 << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/types/numeric_limits/signaling_NaN&action=edit&section=4 "Edit section: See also")] See also

[ has_signaling_NaN](has_signaling_NaN.html "cpp/types/numeric limits/has signaling NaN")[static] |  identifies floating-point types that can represent the special value "signaling not-a-number" (NaN)   
...
---|---  
[ quiet_NaN](quiet_NaN.html "cpp/types/numeric limits/quiet NaN")[static] |  returns a quiet NaN value of the given floating-point type   
