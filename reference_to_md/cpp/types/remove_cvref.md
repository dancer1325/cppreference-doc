...
## Contents
  ...
  * [1 Member types](remove_cvref.html#Member_types)
  * [2 Helper types](remove_cvref.html#Helper_types)
  * [3 Possible implementation](remove_cvref.html#Possible_implementation)
  * [4 Notes](remove_cvref.html#Notes)
  * [5 Example](remove_cvref.html#Example)
  * [6 See also](remove_cvref.html#See_also)
...
### Possible implementation
    ...
    struct remove_cvref
    {
        using type = [std::remove_cv_t](remove_cv.html)<[std::remove_reference_t](remove_reference.html)<T>>;
    };  
...
Run this code
    ...
    int main()
    {
        static_assert([std::is_same_v](is_same.html)<std::remove_cvref_t<int>, int>);
        static_assert([std::is_same_v](is_same.html)<std::remove_cvref_t<int&>, int>);
        static_assert([std::is_same_v](is_same.html)<std::remove_cvref_t<int&&>, int>);
        static_assert([std::is_same_v](is_same.html)<std::remove_cvref_t<const int&>, int>);
        static_assert([std::is_same_v](is_same.html)<std::remove_cvref_t<const int[2]>, int[2]>);
        static_assert([std::is_same_v](is_same.html)<std::remove_cvref_t<const int(&)[2]>, int[2]>);
