...
---|---|---  
[std::ios_base](../ios_base.html)& uppercase( [std::ios_base](../ios_base.html)& str ); |  (1)  |   
[std::ios_base](../ios_base.html)& nouppercase( [std::ios_base](../ios_base.html)& str ); |  (2)  |   
| |   
  
Enables the use of uppercase characters in floating-point and hexadecimal integer output. Has no effect on input. 

1) Enables the `uppercase` flag in the stream str as if by calling str.setf([std::ios_base::uppercase](../ios_base/fmtflags.html)).

2) Disables the `uppercase` flag in the stream str as if by calling str.unsetf([std::ios_base::uppercase](../ios_base/fmtflags.html)).

This is an I/O manipulator, it may be called with an expression such as out << std::uppercase for any `out` of type [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream") or with an expression such as in >> std::uppercase for any `in` of type [std::basic_istream](../basic_istream.html "cpp/io/basic istream"). 

## Contents

  * [1 Parameters](uppercase.html#Parameters)
  * [2 Return value](uppercase.html#Return_value)
  * [3 Example](uppercase.html#Example)
  * [4 See also](uppercase.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/uppercase&action=edit&section=1 "Edit section: Parameters")] Parameters

str  |  \-  |  reference to I/O stream   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/uppercase&action=edit&section=2 "Edit section: Return value")] Return value

str (reference to the stream after manipulation). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/uppercase&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../cout.html) << [std::hex](hex.html) << [std::showbase](showbase.html)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/uppercase&action=edit&section=4 "Edit section: See also")] See also
