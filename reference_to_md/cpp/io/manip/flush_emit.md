...
[std::basic_ostream](../basic_ostream.html)<CharT, Traits>& flush_emit( [std::basic_ostream](../basic_ostream.html)<CharT, Traits>& os ); |  |  (since C++20)  
| |   
  
Flushes the output sequence `os` as if by calling os.flush(). Then, if os.rdbuf() actually points to a [std::basic_syncbuf](../basic_syncbuf.html)<CharT, Traits, Allocator> `buf`, calls buf.emit(). 

This is an output-only I/O manipulator, it may be called with an expression such as out << std::flush_emit for any `out` of type [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream"). 
...
## Contents
  ...
  * [1 Parameters](flush_emit.html#Parameters)
  * [2 Return value](flush_emit.html#Return_value)
  * [3 Example](flush_emit.html#Example)
  * [4 See also](flush_emit.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/flush_emit&action=edit&section=1 "Edit section: Parameters")] Parameters

os  |  \-  |  reference to output stream   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/flush_emit&action=edit&section=2 "Edit section: Return value")] Return value

`os` (reference to the stream after manipulation) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/flush_emit&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/flush_emit&action=edit&section=4 "Edit section: See also")] See also
