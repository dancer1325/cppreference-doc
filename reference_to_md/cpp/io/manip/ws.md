...
[std::basic_istream](../basic_istream.html)<CharT, Traits>& ws( [std::basic_istream](../basic_istream.html)<CharT, Traits>& is ); |  |   
| |   
...
Behaves as an [UnformattedInputFunction](../../named_req/UnformattedInputFunction.html "cpp/named req/UnformattedInputFunction"), except that is.gcount() is not modified. After constructing and checking the sentry object, extracts characters from the stream and discards them until any one of the following conditions occurs: 
  ...
  * the next available character c in the input sequence is not whitespace as determined by [std::isspace](../../string/byte/isspace.html)(c, is.getloc()). The non-whitespace character is not extracted. 



This is an input-only I/O manipulator, it may be called with an expression such as in >> std::ws for any in of type [std::basic_istream](../basic_istream.html "cpp/io/basic istream"). 

## Contents

  * [1 Parameters](ws.html#Parameters)
  * [2 Return value](ws.html#Return_value)
  * [3 Notes](ws.html#Notes)
  * [4 Example](ws.html#Example)
  * [5 Defect reports](ws.html#Defect_reports)
  * [6 See also](ws.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/ws&action=edit&section=1 "Edit section: Parameters")] Parameters

is  |  \-  |  reference to input stream   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/ws&action=edit&section=2 "Edit section: Return value")] Return value

is (reference to the stream after extraction of consecutive whitespace). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/ws&action=edit&section=3 "Edit section: Notes")] Notes

If `eofbit` is set on the stream prior to the call, the construction of the sentry object will set `failbit`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/ws&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        for (const char* str : {"     #1 test", "\t #2 test", "#3 test"})
        {
            ...
            [std::getline](../../string/basic_string/getline.html)([std::istringstream](../basic_istringstream.html){str}, line);
            [std::cout](../cout.html) << "getline returns:\t" << [std::quoted](quoted.html)(line) << '\n';
     
            [std::istringstream](../basic_istringstream.html) iss{str};
            [std::getline](../../string/basic_string/getline.html)(iss >> std::ws, line);
            [std::cout](../cout.html) << "ws + getline returns:\t" << [std::quoted](quoted.html)(line) << '\n';
        }
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/ws&action=edit&section=5 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 415](https://cplusplus.github.io/LWG/issue415) | C++98  | calling `std::ws` might not construct the sentry  
object (insonsistent with other input functions)  | required to construct  
the sentry object   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/ws&action=edit&section=6 "Edit section: See also")] See also
