...
/*unspecified*/ put_money( const MoneyT& mon, bool intl = false ); |  |  (since C++11)  
| |   
  
When used in an expression out << put_money(mon, intl), converts the monetary value mon to its character representation as specified by the [std::money_put](../../locale/money_put.html "cpp/locale/money put") facet of the locale currently imbued in out. 

The insertion operation in out << put_money(mon, intl) behaves as a [FormattedOutputFunction](../../named_req/FormattedOutputFunction.html "cpp/named req/FormattedOutputFunction"). 

## Contents

  * [1 Parameters](put_money.html#Parameters)
  * [2 Return value](put_money.html#Return_value)
  * [3 Example](put_money.html#Example)
  * [4 See also](put_money.html#See_also)
...
An object of unspecified type such that 
  ...
  * if out is an object of type [std::basic_ostream](../basic_ostream.html)<CharT, Traits>, the expression out << put_money(mon, intl)
    * has type [std::basic_ostream](../basic_ostream.html)<CharT, Traits>&
    * has value out
    * behaves as a [FormattedOutputFunction](../../named_req/FormattedOutputFunction.html "cpp/named req/FormattedOutputFunction") that calls f(out, mon, intl)
...
where the function f is defined as: 
    ...
    void f([std::basic_ios](../basic_ios.html)<CharT, Traits>& str, const MoneyT& mon, bool intl)
    {
        using Iter = [std::ostreambuf_iterator](../../iterator/ostreambuf_iterator.html)<CharT, Traits>;
        using MoneyPut = [std::money_put](../../locale/money_put.html)<CharT, Iter>;
     
        const MoneyPut& mp = [std::use_facet](../../locale/use_facet.html)<MoneyPut>(str.getloc());
...
Run this code
    ...
     
        [std::cout](../cout.html).imbue([std::locale](../../locale/locale.html)("en_US.UTF-8"));
        [std::cout](../cout.html) << [std::showbase](showbase.html)
                  << "en_US: " << std::put_money(mon)
                  << " or " << std::put_money(mon, true) << '\n';
     
        [std::cout](../cout.html).imbue([std::locale](../../locale/locale.html)("ru_RU.UTF-8"));
        [std::cout](../cout.html) << "ru_RU: " << std::put_money(mon)
                  << " or " << std::put_money(mon, true) << '\n';
     
        [std::cout](../cout.html).imbue([std::locale](../../locale/locale.html)("ja_JP.UTF-8"));
        [std::cout](../cout.html) << "ja_JP: " << std::put_money(mon)
                  << " or " << std::put_money(mon, true) << '\n';
    }
