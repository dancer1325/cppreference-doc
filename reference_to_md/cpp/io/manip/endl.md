...
[std::basic_ostream](../basic_ostream.html)<CharT, Traits>& endl( [std::basic_ostream](../basic_ostream.html)<CharT, Traits>& os ); |  |   
| |   
  
Inserts a newline character into the output sequence os and flushes it as if by calling os.put(os.widen('\n')) followed by os.flush(). 

This is an output-only I/O manipulator, it may be called with an expression such as out << std::endl for any `out` of type [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream"). 

## Contents

  * [1 Notes](endl.html#Notes)
  * [2 Parameters](endl.html#Parameters)
  * [3 Return value](endl.html#Return_value)
  * [4 Example](endl.html#Example)
  * [5 See also](endl.html#See_also)
...
When an incomplete line of output needs to be flushed, the [std::flush](flush.html "cpp/io/manip/flush") manipulator may be used. 
...
Run this code
    ...
    int main()
    {
        [std::cout](../cout.html).sync_with_stdio(false); // on some platforms, stdout flushes on \n
     
        ...
        for (int i = 0; i < 5; ++i)
        {
            ...
            log_progress([std::chrono::high_resolution_clock::now](../../chrono/high_resolution_clock/now.html)() - t1);
        }
    }
