...
---  
**emit_on_flush noemit_on_flush**(C++20)(C++20)  
...
[std::basic_ostream](../basic_ostream.html)<CharT, Traits>& emit_on_flush( [std::basic_ostream](../basic_ostream.html)<CharT, Traits>& os ); |  (1)  |  (since C++20)  
template< class CharT, class Traits >  
[std::basic_ostream](../basic_ostream.html)<CharT, Traits>& noemit_on_flush( [std::basic_ostream](../basic_ostream.html)<CharT, Traits>& os ); |  (2)  |  (since C++20)  
| |   
  
If os.rdbuf() actually points to a [std::basic_syncbuf](../basic_syncbuf.html)<CharT, Traits, Allocator> `buf`, toggles whether it emits (i.e., transmits data to the underlying stream buffer) when flushed: 
...
This is an output-only I/O manipulator, it may be called with an expression such as out << std::emit_on_flush for any `out` of type [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream"). 
...
## Contents
  ...
  * [1 Parameters](emit_on_flush.html#Parameters)
  * [2 Return value](emit_on_flush.html#Return_value)
  * [3 Example](emit_on_flush.html#Example)
  * [4 See also](emit_on_flush.html#See_also)
