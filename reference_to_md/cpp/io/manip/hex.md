...
---|---|---  
[std::ios_base](../ios_base.html)& dec( [std::ios_base](../ios_base.html)& str ); |  (1)  |   
[std::ios_base](../ios_base.html)& hex( [std::ios_base](../ios_base.html)& str ); |  (2)  |   
[std::ios_base](../ios_base.html)& oct( [std::ios_base](../ios_base.html)& str ); |  (3)  |   
| |   
  
Modifies the default numeric base for integer I/O. 

1) Sets the `basefield` of the stream str to `dec` as if by calling str.setf([std::ios_base::dec](../ios_base/fmtflags.html), [std::ios_base::basefield](../ios_base/fmtflags.html)).

2) Sets the `basefield` of the stream str to `hex` as if by calling str.setf([std::ios_base::hex](../ios_base/fmtflags.html), [std::ios_base::basefield](../ios_base/fmtflags.html)).

3) Sets the `basefield` of the stream str to `oct` as if by calling str.setf([std::ios_base::oct](../ios_base/fmtflags.html), [std::ios_base::basefield](../ios_base/fmtflags.html)).

This is an I/O manipulator. It may be called with an expression such as out << std::hex for any `out` of type [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream") or with an expression such as in >> std::hex for any `in` of type [std::basic_istream](../basic_istream.html "cpp/io/basic istream"). 

## Contents

  * [1 Parameters](hex.html#Parameters)
  * [2 Return value](hex.html#Return_value)
  * [3 Example](hex.html#Example)
  * [4 See also](hex.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::cout](../cout.html) << "The number 42 in octal:   " << std::oct << 42 << '\n'
                  << "The number 42 in decimal: " << std::dec << 42 << '\n'
                  << "The number 42 in hex:     " << std::hex << 42 << '\n';
        int n;
        [std::istringstream](../basic_istringstream.html)("2A") >> std::hex >> n;
        [std::cout](../cout.html) << std::dec << "Parsing \"2A\" as hex gives " << n << '\n';
        // the output base is sticky until changed
        [std::cout](../cout.html) << std::hex << "42 as hex gives " << 42
    ...
     
        ...
        [std::cout](../cout.html) << "The number 42 in binary:  " << [std::bitset](../../utility/bitset.html)<8>{42} << '\n';
    }
...
[ setbase](setbase.html "cpp/io/manip/setbase") |  changes the base used for integer I/O   
(function)   
---|---  
