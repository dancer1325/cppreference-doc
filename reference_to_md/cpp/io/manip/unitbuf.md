...
---|---|---  
[std::ios_base](../ios_base.html)& unitbuf( [std::ios_base](../ios_base.html)& str ); |  (1)  |   
[std::ios_base](../ios_base.html)& nounitbuf( [std::ios_base](../ios_base.html)& str ); |  (2)  |   
| |   
  
Enables or disables automatic flushing of the output stream after any output operation. Has no effect on input. 

1) Enables the `unitbuf` flag in the stream str as if by calling str.setf([std::ios_base::unitbuf](../ios_base/fmtflags.html)).

2) Disables the `unitbuf` flag in the stream str as if by calling str.unsetf([std::ios_base::unitbuf](../ios_base/fmtflags.html)).

This is an I/O manipulator, it may be called with an expression such as out << std::unitbuf for any `out` of type [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream") or with an expression such as in >> std::unitbuf for any `in` of type [std::basic_istream](../basic_istream.html "cpp/io/basic istream"). 

## Contents

  * [1 Notes](unitbuf.html#Notes)
  * [2 Parameters](unitbuf.html#Parameters)
  * [3 Return value](unitbuf.html#Return_value)
  * [4 Example](unitbuf.html#Example)
  * [5 See also](unitbuf.html#See_also)
...
Run this code
    ...
    {
        volatile int sink = 0;
        [std::cout](../cout.html) << std::unitbuf; // enable automatic flushing
     
        ...
        for (int j = 0; j < 5; ++j)
        {
            ...
            log_progress([std::chrono::high_resolution_clock::now](../../chrono/high_resolution_clock/now.html)() - start);
        }
        [std::cout](../cout.html) << '\n';
    }
