...
---|---|---  
[std::ios_base](../ios_base.html)& skipws( [std::ios_base](../ios_base.html)& str ); |  (1)  |   
[std::ios_base](../ios_base.html)& noskipws( [std::ios_base](../ios_base.html)& str ); |  (2)  |   
| |   
...
1) Enables the `skipws` flag in the stream str as if by calling str.setf([std::ios_base::skipws](../ios_base/fmtflags.html)).

2) Disables the `skipws` flag in the stream str as if by calling str.unsetf([std::ios_base::skipws](../ios_base/fmtflags.html)).

The whitespace skipping is performed by the constructor of [std::basic_istream::sentry](../basic_istream/sentry.html "cpp/io/basic istream/sentry"), which reads and discards the characters classified as whitespace by the [std::ctype](../../locale/ctype.html "cpp/locale/ctype") facet of the stream's imbued locale. 

This is an I/O manipulator, it may be called with an expression such as out << std::noskipws for any `out` of type [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream") or with an expression such as in >> std::noskipws for any `in` of type [std::basic_istream](../basic_istream.html "cpp/io/basic istream"). 

## Contents

  * [1 Parameters](skipws.html#Parameters)
  * [2 Return value](skipws.html#Return_value)
  * [3 Example](skipws.html#Example)
  * [4 See also](skipws.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/skipws&action=edit&section=1 "Edit section: Parameters")] Parameters

str  |  \-  |  reference to I/O stream   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/skipws&action=edit&section=2 "Edit section: Return value")] Return value

str (reference to the stream after manipulation). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/skipws&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    {
        char c1, c2, c3;
        [std::istringstream](../basic_istringstream.html)("a b c") >> c1 >> c2 >> c3;
        [std::cout](../cout.html) << "Default  behavior:"
                     " c1 = " << c1 << 
                     " c2 = " << c2 << 
                     " c3 = " << c3 << '\n';
        [std::istringstream](../basic_istringstream.html)("a b c") >> std::noskipws >> c1 >> c2 >> c3;
        [std::cout](../cout.html) << "noskipws behavior:" 
                     " c1 = " << c1 <<
                     " c2 = " << c2 <<
                     " c3 = " << c3 << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/skipws&action=edit&section=4 "Edit section: See also")] See also
...
[ ws](ws.html "cpp/io/manip/ws") |  consumes whitespace   
