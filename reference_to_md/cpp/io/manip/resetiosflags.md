...
---|---|---  
/*unspecified*/ resetiosflags( [std::ios_base::fmtflags](../ios_base/fmtflags.html) mask ); |  |   
| |   
...
## Contents
  ...
  * [1 Parameters](resetiosflags.html#Parameters)
  * [2 Return value](resetiosflags.html#Return_value)
  * [3 Example](resetiosflags.html#Example)
  * [4 Defect reports](resetiosflags.html#Defect_reports)
  * [5 See also](resetiosflags.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/resetiosflags&action=edit&section=1 "Edit section: Parameters")] Parameters

mask  |  \-  |  bitmask of the flags to clear   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/resetiosflags&action=edit&section=2 "Edit section: Return value")] Return value

An object of unspecified type such that 

  * if out is an object of type [std::basic_ostream](../basic_ostream.html)<CharT, Traits>, the expression out << resetiosflags(mask)
    * has type [std::basic_ostream](../basic_ostream.html)<CharT, Traits>&
    * has value out
    * behaves as if it called f(out, mask)
  * if in is an object of type [std::basic_istream](../basic_istream.html)<CharT, Traits>, the expression in >> resetiosflags(mask)
...
where the function f is defined as: 
    ...
    void f([std::ios_base](../ios_base.html)& str, [std::ios_base::fmtflags](../ios_base/fmtflags.html) mask)
    {
        // reset specified flags
        str.setf(ios_base::fmtflags(0), mask);
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/resetiosflags&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::istringstream](../basic_istringstream.html) in("10 010 10 010 10 010");
        int n1, n2;
     
        in >> [std::oct](hex.html) >> n1 >> n2;
        [std::cout](../cout.html) << "Parsing \"10 010\" with std::oct gives: " << n1 << ' ' << n2 << '\n';
     
        in >> [std::dec](hex.html) >> n1 >> n2;
        [std::cout](../cout.html) << "Parsing \"10 010\" with std::dec gives: " << n1 << ' ' << n2 << '\n';
     
        in >> std::resetiosflags([std::ios_base::basefield](../ios_base/fmtflags.html)) >> n1 >> n2;
        [std::cout](../cout.html) << "Parsing \"10 010\" with autodetect gives: " << n1 << ' ' << n2 << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/resetiosflags&action=edit&section=4 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 183](https://cplusplus.github.io/LWG/issue183) | C++98  | `resetiosflags` could only be used with  
streams of type [std::ostream](../basic_ostream.html "cpp/io/basic ostream") or [std::istream](../basic_istream.html "cpp/io/basic istream") | usable with any  
character stream   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/resetiosflags&action=edit&section=5 "Edit section: See also")] See also
