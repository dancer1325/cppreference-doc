...
---|---|---  
[std::ios_base](../ios_base.html)& showpoint( [std::ios_base](../ios_base.html)& str ); |  (1)  |   
[std::ios_base](../ios_base.html)& noshowpoint( [std::ios_base](../ios_base.html)& str ); |  (2)  |   
| |   
...
1) Enables the `showpoint` flag in the stream str as if by calling str.setf([std::ios_base::showpoint](../ios_base/fmtflags.html)).

2) Disables the `showpoint` flag in the stream str as if by calling str.unsetf([std::ios_base::showpoint](../ios_base/fmtflags.html)).

This is an I/O manipulator, it may be called with an expression such as out << std::showpoint for any `out` of type [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream") or with an expression such as in >> std::showpoint for any `in` of type [std::basic_istream](../basic_istream.html "cpp/io/basic istream"). 

The character to use as decimal point character is determined by the numpunct facet of the locale imbued in the stream at the time of output, as described in [std::num_put::put](../../locale/num_put/put.html "cpp/locale/num put/put"). 

## Contents

  * [1 Parameters](showpoint.html#Parameters)
  * [2 Return value](showpoint.html#Return_value)
  * [3 Example](showpoint.html#Example)
  * [4 See also](showpoint.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/showpoint&action=edit&section=1 "Edit section: Parameters")] Parameters

str  |  \-  |  reference to I/O stream   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/showpoint&action=edit&section=2 "Edit section: Return value")] Return value

str (reference to the stream after manipulation). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/showpoint&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../cout.html) << "1.0 with showpoint: " << std::showpoint << 1.0 << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/manip/showpoint&action=edit&section=4 "Edit section: See also")] See also
