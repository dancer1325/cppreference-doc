...
## Contents
  ...
  * [1 Parameters](setprecision.html#Parameters)
  * [2 Return value](setprecision.html#Return_value)
  * [3 Example](setprecision.html#Example)
  * [4 Defect reports](setprecision.html#Defect_reports)
  * [5 See also](setprecision.html#See_also)
...
An object of unspecified type such that 
  ...
  * if out is an object of type [std::basic_ostream](../basic_ostream.html)<CharT, Traits>, the expression out << setprecision(n)
    * has type [std::basic_ostream](../basic_ostream.html)<CharT, Traits>&
    * has value out
    * behaves as if it called f(out, n)
  * if in is an object of type [std::basic_istream](../basic_istream.html)<CharT, Traits>, the expression in >> setprecision(n)
...
Run this code
    ...
    int main()
    {
        constexpr long double pi{[std::numbers::pi_v](../../numeric/constants.html)<long double>};
     
        const auto default_precision{[std::cout](../cout.html).precision()};
        constexpr auto max_precision{[std::numeric_limits](../../types/numeric_limits.html)<long double>::digits10 + 1}; 
     
        [std::cout](../cout.html) << "default precision: " << default_precision << '\n'
                  << "maximum precision: " << max_precision << "\n\n"
                     "precision: pi:\n";
     
        for (int p{0}; p <= max_precision; ++p)
            [std::cout](../cout.html) << [std::setw](setw.html)(2) << p << "  " << std::setprecision(p) << pi << '\n';
     
        [std::cout](../cout.html) << std::setprecision(default_precision); // restore defaults
    }
...
---|---|---|---  
[LWG 183](https://cplusplus.github.io/LWG/issue183) | C++98  | `setprecision` could only be used with streams  
