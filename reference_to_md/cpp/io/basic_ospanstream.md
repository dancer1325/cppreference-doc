...
---  
[basic_ospanstream::basic_ospanstream](basic_ospanstream/basic_ospanstream.html "cpp/io/basic ospanstream/basic ospanstream")  
[basic_ospanstream::operator=](basic_ospanstream/operator=.html "cpp/io/basic ospanstream/operator=")  
[basic_ospanstream::swap](basic_ospanstream/swap.html "cpp/io/basic ospanstream/swap")  
[basic_ospanstream::rdbuf](basic_ospanstream/rdbuf.html "cpp/io/basic ospanstream/rdbuf")  
[Underlying buffer operations](basic_ospanstream.html#Underlying_buffer_operations "cpp/io/basic ospanstream")  
[basic_ospanstream::span](basic_ospanstream/span.html "cpp/io/basic ospanstream/span")  
[Non-member functions](basic_ospanstream.html#Non-member_functions "cpp/io/basic ospanstream")  
[swap(std::basic_ospanstream)](basic_ospanstream/swap2.html "cpp/io/basic ospanstream/swap2")  
...
: public basic_ostream<CharT, Traits> |  |  (since C++23)  
| |   
  
The class template `std::basic_ospanstream` implements output operations on streams based on fixed buffers. 

At the low level, the class essentially wraps a raw device implementation of std::basic_spanbuf into a higher-level interface of [std::basic_ostream](basic_ostream.html "cpp/io/basic ostream"). The complete interface to unique std::basic_spanbuf members is provided. 

![std-basic ospanstream-inheritance.svg](https://upload.cppreference.com/mwiki/images/3/30/std-basic_ospanstream-inheritance.svg)
...
## Contents
  ...
  * [1 Member types](basic_ospanstream.html#Member_types)
  * [2 Data members](basic_ospanstream.html#Data_members)
  * [3 Member functions](basic_ospanstream.html#Member_functions)
    * [3.1 Underlying buffer operations](basic_ospanstream.html#Underlying_buffer_operations)
  * [4 Non-member functions](basic_ospanstream.html#Non-member_functions)
  * [5 Inherited from std::basic_ostream](basic_ospanstream.html#Inherited_from_std::basic_ostream)
    * [5.1 Member functions](basic_ospanstream.html#Member_functions_2)
      * [5.1.1 Formatted output](basic_ospanstream.html#Formatted_output)
      * [5.1.2 Unformatted output](basic_ospanstream.html#Unformatted_output)
      * [5.1.3 Positioning](basic_ospanstream.html#Positioning)
      * [5.1.4 Miscellaneous](basic_ospanstream.html#Miscellaneous)
    * [5.2 Member classes](basic_ospanstream.html#Member_classes)
  * [6 Inherited from std::basic_ios](basic_ospanstream.html#Inherited_from_std::basic_ios)
    * [6.1 Member types](basic_ospanstream.html#Member_types_2)
    * [6.2 Member functions](basic_ospanstream.html#Member_functions_3)
      * [6.2.1 State functions](basic_ospanstream.html#State_functions)
      * [6.2.2 Formatting](basic_ospanstream.html#Formatting)
      * [6.2.3 Miscellaneous](basic_ospanstream.html#Miscellaneous_2)
  * [7 Inherited from std::ios_base](basic_ospanstream.html#Inherited_from_std::ios_base)
    * [7.1 Member functions](basic_ospanstream.html#Member_functions_4)
      * [7.1.1 Formatting](basic_ospanstream.html#Formatting_2)
      * [7.1.2 Locales](basic_ospanstream.html#Locales)
      * [7.1.3 Internal extensible array](basic_ospanstream.html#Internal_extensible_array)
      * [7.1.4 Miscellaneous](basic_ospanstream.html#Miscellaneous_3)
      * [7.1.5 Member classes](basic_ospanstream.html#Member_classes_2)
    * [7.2 Member types and constants](basic_ospanstream.html#Member_types_and_constants)
    * [7.3 Notes](basic_ospanstream.html#Notes)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ospanstream&action=edit&section=1 "Edit section: Data members")] Data members
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ospanstream&action=edit&section=2 "Edit section: Member functions")] Member functions
...
---|---  
**(destructor)**[virtual] |  destroys the `basic_ospanstream`   
(virtual public member function)  
[ operator=](basic_ospanstream/operator=.html "cpp/io/basic ospanstream/operator=") |  move-assignments the `basic_ospanstream`   
...
[ swap](basic_ospanstream/swap.html "cpp/io/basic ospanstream/swap") |  swaps two `basic_ospanstream` objects   
...
[ rdbuf](basic_ospanstream/rdbuf.html "cpp/io/basic ospanstream/rdbuf") |  obtains the address of the wrapped raw `span` device object   
...
[ span](basic_ospanstream/span.html "cpp/io/basic ospanstream/span") |  gets or sets the underlying buffer of the wrapped `span` device object   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ospanstream&action=edit&section=3 "Edit section: Non-member functions")] Non-member functions

[ std::swap(std::basic_ospanstream)](basic_ospanstream/swap2.html "cpp/io/basic ospanstream/swap2")(C++23) |  specializes the [std::swap](../utility/swap.html "cpp/algorithm/swap") algorithm   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ospanstream&action=edit&section=4 "Edit section: Notes")] Notes

[Feature-test](../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_spanstream`](../experimental/feature_test.html#cpp_lib_spanstream "cpp/feature test") | [`202106L`](../compiler_support/23.html#cpp_lib_spanstream_202106L "cpp/compiler support/23") | (C++23) | std::spanbuf, std::spanstream
