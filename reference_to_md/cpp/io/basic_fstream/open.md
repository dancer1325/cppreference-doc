...
= [std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html) ); |  (1)  |   
---|---|---  
void open( const std::filesystem::path::value_type* filename,  
[std::ios_base::openmode](../ios_base/openmode.html) mode  
= [std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html) ); |  (2)  |  (since C++17)  
void open( const [std::string](../../string/basic_string.html)& filename,  
[std::ios_base::openmode](../ios_base/openmode.html) mode  
= [std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html) ); |  (3)  |  (since C++11)  
void open( const [std::filesystem::path](../../filesystem/path.html)& filename,  
[std::ios_base::openmode](../ios_base/openmode.html) mode  
= [std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html) ); |  (4)  |  (since C++17)  
| |   
...
1,2) Effectively calls rdbuf()->open(filename, mode) (see [std::basic_filebuf::open](../basic_filebuf/open.html "cpp/io/basic filebuf/open") for the details on the effects of that call). Overload (2) is only provided if `std::filesystem::path::value_type` is not char.(since C++17)
...
Run this code
    ...
    int main()
    {
        [std::string](../../string/basic_string.html) filename = "example.123";
     
    ...
     
        ...
        [std::cout](../cout.html) << "fs.is_open() = " << fs.is_open() << '\n';
        [std::cout](../cout.html) << "fs.good() = " << fs.good() << '\n';
    }
...
[LWG 460](https://cplusplus.github.io/LWG/issue460) | C++98  | the default argument of mode in overload (1)  
...
---|---  
[ close](close.html "cpp/io/basic fstream/close") |  closes the associated file   
(public member function)   
