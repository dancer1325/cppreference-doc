...
private:  
ios_base& operator=( const ios_base& ); |  |  (until C++11)  
---|---|---  
public:  
ios_base& operator=( const ios_base& ) = delete; |  |  (since C++11)  
| |   
...
---|---|---|---  
[LWG 50](https://cplusplus.github.io/LWG/issue50) | C++98  | the copy assignment operator was not specified  | specified as private 
