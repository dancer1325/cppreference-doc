...
---|---|---  
private:  
ios_base( const ios_base& ); |  |  (until C++11)  
public:  
ios_base( const ios_base& ) = delete; |  |  (since C++11)  
protected:  
ios_base(); |  (2)  |   
| |   
...
---|---|---|---  
[LWG 50](https://cplusplus.github.io/LWG/issue50) | C++98  | the copy constructor was not specified  | specified as private   
[LWG 220](https://cplusplus.github.io/LWG/issue220) | C++98  | the behavior of destroying a `std::ios_base`  
object before calling its [`init()`](../basic_ios/init.html "cpp/io/basic ios/init") was not clear  | the behavior is  
undefined in this case   
[LWG 1249](https://cplusplus.github.io/LWG/issue1249) | C++98  | initialization did not need to be completed before first use  | also needs to be completed 
