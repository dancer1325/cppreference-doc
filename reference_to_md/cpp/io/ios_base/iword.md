...
The reference may be invalidated by any operation on this `ios_base` object, including another call to `iword()`, but the stored values are retained, so that reading from iword(index) with the same index later will produce the same value until the next call to [std::basic_ios::copyfmt()](../basic_ios/copyfmt.html "cpp/io/basic ios/copyfmt"). The value can be used for any purpose. The index of the element must be obtained by a previous call to [xalloc()](xalloc.html "cpp/io/ios base/xalloc"), otherwise the behavior is undefined. New elements are initialized to ​0​. 

If the function fails (possibly caused by an allocation failure) and *this is a base class subobject of a `basic_ios<>` object or subobject, calls [std::basic_ios](../basic_ios.html)<>::setstate(badbit) which may throw [std::ios_base::failure](failure.html "cpp/io/ios base/failure"). 

## Contents

  * [1 Notes](iword.html#Notes)
  * [2 Parameters](iword.html#Parameters)
  * [3 Return value](iword.html#Return_value)
  * [4 Exceptions](iword.html#Exceptions)
  * [5 Example](iword.html#Example)
  * [6 Defect reports](iword.html#Defect_reports)
  * [7 See also](iword.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/iword&action=edit&section=1 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/iword&action=edit&section=2 "Edit section: Parameters")] Parameters

index  |  \-  |  index value of the element   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/iword&action=edit&section=3 "Edit section: Return value")] Return value

A reference to the element. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/iword&action=edit&section=4 "Edit section: Exceptions")] Exceptions

May throw [std::ios_base::failure](failure.html "cpp/io/ios base/failure") when setting the badbit. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/iword&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        Foo(const [std::string](../../string/basic_string.html)& s) : data(s) {}
    };
     
    ...
    [std::ostream](../basic_ostream.html)& operator<<([std::ostream](../basic_ostream.html)& os, Foo& f)
    {
        if (os.iword(Foo::foo_xalloc) == 1)
            return os << [std::string](../../string/basic_string.html)(f.data.rbegin(), f.data.rend());
        else
            return os << f.data;
    }
     
    // This I/O manipulator flips the number stored in iword between 0 and 1
    [std::ios_base](../ios_base.html)& rev([std::ios_base](../ios_base.html)& os)
    {
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/iword&action=edit&section=6 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 36](https://cplusplus.github.io/LWG/issue36) | C++98  | the stored value might not be  
retained if the reference is invalidated  | the stored value is retained  
until the next call of `copyfmt()`  
[LWG 41](https://cplusplus.github.io/LWG/issue41) | C++98  | the function set badbit by itself on failure,  
but `ios_base` does not provide such interface  | badbit is set by `basic_ios`  
(if *this is its base class subobject)   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/iword&action=edit&section=7 "Edit section: See also")] See also

[ pword](pword.html "cpp/io/ios base/pword") |  resizes the private storage if necessary and access to the void* element at the given index   
...
---|---  
[ xalloc](xalloc.html "cpp/io/ios base/xalloc")[static] |  returns a program-wide unique integer that is safe to use as index to [`pword()`](pword.html "cpp/io/ios base/pword") and **`iword()`**   
