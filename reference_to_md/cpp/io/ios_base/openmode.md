...
Specifies available file open flags. It is a [BitmaskType](../../named_req/BitmaskType.html "cpp/named req/BitmaskType"), the following constants are defined: 

Constant  |  Explanation   
---|---  
**`app`** |  seek to the end of stream before each write   
**`binary`** |  open in [binary mode](../c/FILE.html#Binary_and_text_modes "cpp/io/c/FILE")  
**`in`** |  open for reading   
...
Run this code
    ...
     
        ...
        [std::fstream](../basic_fstream.html)(fname, std::ios::out | std::ios::trunc) << "Hi";
     
        [std::string](../../string/basic_string.html) s;
        [std::fstream](../basic_fstream.html)(fname, std::ios::in) >> s;
