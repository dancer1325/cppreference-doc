...
The reference may be invalidated by any operation on this `ios_base` object, including another call to `pword()`, but the stored values are retained, so that reading from pword(index) with the same index later will produce the same value until the next call to [std::basic_ios::copyfmt()](../basic_ios/copyfmt.html "cpp/io/basic ios/copyfmt"). The value can be used for any purpose. The index of the element must be obtained by [xalloc()](xalloc.html "cpp/io/ios base/xalloc"), otherwise the behavior is undefined. New elements are initialized to a [null pointer](../../language/pointer.html#Null_pointers "cpp/language/pointer"). 
...
## Contents
  ...
  * [1 Parameters](pword.html#Parameters)
  * [2 Return value](pword.html#Return_value)
  * [3 Exceptions](pword.html#Exceptions)
  * [4 Notes](pword.html#Notes)
  * [5 Example](pword.html#Example)
  * [6 Defect reports](pword.html#Defect_reports)
  * [7 See also](pword.html#See_also)
...
Run this code
    ...
    class mystream : public [std::basic_ostream](../basic_ostream.html)<CharT, Traits>
    {
    public:
        static const int xindex;
     
        mystream([std::basic_ostream](../basic_ostream.html)<CharT, Traits>& ostr) :
            [std::basic_ostream](../basic_ostream.html)<CharT, Traits>(ostr.rdbuf())
        {
    ...
    template<class CharT, class Traits>
    [std::basic_ostream](../basic_ostream.html)<CharT, Traits>& mymanip([std::basic_ostream](../basic_ostream.html)<CharT, Traits>& os)
    {
    ...
    int main()
    {
        [std::cout](../cout.html) << "cout, narrow-character test " << mymanip << '\n';
     
        mystream<char> myout([std::cout](../cout.html));
        myout << "myout, narrow-character test " << mymanip << '\n';
     
        [std::wcout](../cout.html) << "wcout, wide-character test " << mymanip << '\n';
     
        mystream<wchar_t> mywout([std::wcout](../cout.html));
