...
Sets the associated locale of the stream to loc. Before returning, each function, registered by [register_callback()](register_callback.html "cpp/io/ios base/register callback") is called with `imbue_event` as a parameter. 
...
## Contents
  ...
  * [4 Defect reports](imbue.html#Defect_reports)
