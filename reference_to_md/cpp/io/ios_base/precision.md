...
Manages the precision (i.e. how many digits are generated) of floating point output performed by [std::num_put::do_put](../../locale/num_put/put.html "cpp/locale/num put/put"). 

1) Returns the current precision. 

2) Sets the precision to the given one. Returns the previous precision. 

The default precision, as established by [std::basic_ios::init](../basic_ios/init.html "cpp/io/basic ios/init"), is 6. 

## Contents

  * [1 Parameters](precision.html#Parameters)
  * [2 Return value](precision.html#Return_value)
  * [3 Example](precision.html#Example)
  * [4 Defect reports](precision.html#Defect_reports)
  * [5 See also](precision.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../cout.html) << "The  default precision is " << [std::cout](../cout.html).precision() << "\n\n";
        [std::cout](../cout.html) << "With default precision d is " << d << '\n';
        [std::cout](../cout.html).precision(8);
        [std::cout](../cout.html) << "With high    precision d is " << d << '\n';
    }
