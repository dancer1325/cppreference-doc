...
The standard C++ streams are the following: [std::cin](../cin.html "cpp/io/cin"), [std::cout](../cout.html "cpp/io/cout"), [std::cerr](../cerr.html "cpp/io/cerr"), [std::clog](../clog.html "cpp/io/clog"), [std::wcin](../cin.html "cpp/io/cin"), [std::wcout](../cout.html "cpp/io/cout"), [std::wcerr](../cerr.html "cpp/io/cerr") and [std::wclog](../clog.html "cpp/io/clog"). 

The standard C streams are the following: [stdin](../c/std_streams.html "cpp/io/c/std streams"), [stdout](../c/std_streams.html "cpp/io/c/std streams") and [stderr](../c/std_streams.html "cpp/io/c/std streams"). 

For a standard stream str, synchronized with the C stream f, the following pairs of functions have identical effect: 

1) [std::fputc](../c/fputc.html)(f, c) and str.rdbuf()->sputc(c).

2) [std::fgetc](../c/fgetc.html)(f) and str.rdbuf()->sbumpc().

3) [std::ungetc](../c/ungetc.html)(c, f) and str.rdbuf()->sputbackc(c).
...
## Contents
  ...
  * [1 Parameters](sync_with_stdio.html#Parameters)
  * [2 Return value](sync_with_stdio.html#Return_value)
  * [3 Example](sync_with_stdio.html#Example)
  * [4 Defect reports](sync_with_stdio.html#Defect_reports)
  * [5 See also](sync_with_stdio.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/sync_with_stdio&action=edit&section=1 "Edit section: Parameters")] Parameters

sync  |  \-  |  the new synchronization setting   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/sync_with_stdio&action=edit&section=2 "Edit section: Return value")] Return value

Synchronization state before the call to the function. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/sync_with_stdio&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../cout.html) << "a\n";
        [std::printf](../c/fprintf.html)("b\n");
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/sync_with_stdio&action=edit&section=4 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 49](https://cplusplus.github.io/LWG/issue49) | C++98  | it was unspecified (1) which state is actually returned and  
(2) what does 'synchronized' between standard C and C++ streams mean  | both specified   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ios_base/sync_with_stdio&action=edit&section=5 "Edit section: See also")] See also
