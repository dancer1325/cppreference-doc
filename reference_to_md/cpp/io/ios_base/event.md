...
Specifies the event type which is passed to functions registered by [register_callback()](register_callback.html "cpp/io/ios base/register callback") on specific events. The following constants are defined: 

Enumerator  |  Meaning   
---|---  
`erase_event` |  issued on ~ios_base() or [`basic_ios::copyfmt()`](../basic_ios/copyfmt.html "cpp/io/basic ios/copyfmt") (before the copy of members takes place)   
