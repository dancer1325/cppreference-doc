...
---|---|---  
public:  
explicit basic_ios( [std::basic_streambuf](../basic_streambuf.html)<CharT, Traits>* sb ); |  (2)  |   
| (3) |   
private:  
...
1) Default constructor. The internal state is not initialized. [init()](init.html "cpp/io/basic ios/init") must be called before the first use of the object or before destructor, otherwise the behavior is undefined.

2) Initializes the internal state by calling init(sb). The associated stream buffer is set to sb. 

3) The copy constructor is declared private and not defined(until C++11)explicitly defined as deleted(since C++11): I/O streams are not [CopyConstructible](../../named_req/CopyConstructible.html "cpp/named req/CopyConstructible").

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/basic_ios&action=edit&section=1 "Edit section: Parameters")] Parameters

sb  |  \-  |  stream buffer to associate to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/basic_ios&action=edit&section=2 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 1249](https://cplusplus.github.io/LWG/issue1249) | C++98  | internal state did not need to be initialized before first use  | also needs to be initialized 
