...
## Contents
  ...
  * [3 Example](fill.html#Example)
  * [4 See also](fill.html#See_also)
...
Run this code
    ...
    int main ()
    {
        [std::cout](../cout.html) << "With default setting : [" << [std::setw](../manip/setw.html)(10) << 40 << "]\n";
        char prev = [std::cout](../cout.html).fill('x');
        [std::cout](../cout.html) << "Replaced '" << prev << "' with '"
                  << [std::cout](../cout.html).fill() << "': [" << [std::setw](../manip/setw.html)(10) << 40 << "]\n";
    }
