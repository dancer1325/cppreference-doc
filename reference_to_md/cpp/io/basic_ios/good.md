...
See [`ios_base::iostate`](../ios_base/iostate.html "cpp/io/ios base/iostate") for the list of conditions that set the stream status bits. 

## Contents

  * [1 Parameters](good.html#Parameters)
  * [2 Return value](good.html#Return_value)
  * [3 Example](good.html#Example)
  * [4 See also](good.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/good&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/good&action=edit&section=2 "Edit section: Return value")] Return value

true if the stream error flags are all false, false otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/good&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::ofstream](../basic_ofstream.html) ofile{fname};
        ofile << "10 " << "11 " << "12 " << "non-int";
        ofile.close();
     
        [std::ifstream](../basic_ifstream.html) file{fname};
        if (!file.good())  
        {  
            [std::cout](../cout.html) << "#1. Opening file test.txt failed - "
    ...
     
        if (file.bad()) 
        {
            [std::cout](../cout.html) << "#2. I/O error while reading - badbit is true\n";
            return [EXIT_FAILURE](../../utility/program/EXIT_status.html);
        } 
        else if (file.eof())
            [std::cout](../cout.html) << "#3. End of file reached successfully - eofbit is true\n"
                "This is fine even though file.good() is false\n"; 
        else if (file.fail())
            [std::cout](../cout.html) << "#4. Non-integer data encountered - failbit is true\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/good&action=edit&section=4 "Edit section: See also")] See also

The following table shows the value of [`basic_ios`](../basic_ios.html "cpp/io/basic ios") accessors (**`good()`** , [`fail()`](fail.html "cpp/io/basic ios/fail"), etc.) for all possible combinations of [`ios_base::iostate`](../ios_base/iostate.html "cpp/io/ios base/iostate") flags: 

[`ios_base::iostate`](../ios_base/iostate.html "cpp/io/ios base/iostate") flags  |  `basic_ios` accessors   
---|---  
`eofbit` |  `failbit` |  `badbit` |  **`good()`** |  [`fail()`](fail.html "cpp/io/basic ios/fail") |  [`bad()`](bad.html "cpp/io/basic ios/bad") |  [`eof()`](eof.html "cpp/io/basic ios/eof") |  [`operator bool`](operator_bool.html "cpp/io/basic ios/operator bool") |  [`operator!`](operator!.html "cpp/io/basic ios/operator!")  
