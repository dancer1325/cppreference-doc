...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/imbue&action=edit&section=1 "Edit section: Parameters")] Parameters

loc  |  \-  |  the new locale   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/imbue&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/imbue&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::istringstream](../basic_istringstream.html) iss;
        iss.imbue([std::locale](../../locale/locale.html)("en_US.UTF8"));
     
        [std::cout](../cout.html) << "Current locale: " << iss.getloc().name() << '\n';
     
        iss.imbue([std::locale](../../locale/locale.html)());
        [std::cout](../cout.html) << "Global locale : " << iss.getloc().name() << '\n';
    }
