...
Returns true if the associated stream has reached end-of-file. Specifically, returns true if `eofbit` is set in [rdstate()](rdstate.html "cpp/io/basic ios/rdstate"). 

See [`ios_base::iostate`](../ios_base/iostate.html "cpp/io/ios base/iostate") for the list of conditions that set `eofbit`. 

## Contents

  * [1 Parameters](eof.html#Parameters)
  * [2 Return value](eof.html#Return_value)
  * [3 Notes](eof.html#Notes)
  * [4 Example](eof.html#Example)
  * [5 See also](eof.html#See_also)
...
---|---  
`eofbit` |  `failbit` |  `badbit` |  [`good()`](good.html "cpp/io/basic ios/good") |  [`fail()`](fail.html "cpp/io/basic ios/fail") |  [`bad()`](bad.html "cpp/io/basic ios/bad") |  **`eof()`** |  [`operator bool`](operator_bool.html "cpp/io/basic ios/operator bool") |  [`operator!`](operator!.html "cpp/io/basic ios/operator!")  
