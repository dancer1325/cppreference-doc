...
Exchanges the states of *this and other, except for the associated `rdbuf` objects. [rdbuf()](rdbuf.html "cpp/io/basic ios/rdbuf") and other.rdbuf() returns the same values as before the call. 
