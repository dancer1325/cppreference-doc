...
Returns true if an error has occurred on the associated stream. Specifically, returns true if `badbit` or `failbit` is set in [rdstate()](rdstate.html "cpp/io/basic ios/rdstate"). 

See [`ios_base::iostate`](../ios_base/iostate.html "cpp/io/ios base/iostate") for the list of conditions that set `failbit` or `badbit`. 

## Contents

  * [1 Parameters](fail.html#Parameters)
  * [2 Return value](fail.html#Return_value)
  * [3 Example](fail.html#Example)
  * [4 See also](fail.html#See_also)
...
---|---  
`eofbit` |  `failbit` |  `badbit` |  [`good()`](good.html "cpp/io/basic ios/good") |  **`fail()`** |  [`bad()`](bad.html "cpp/io/basic ios/bad") |  [`eof()`](eof.html "cpp/io/basic ios/eof") |  [`operator bool`](operator_bool.html "cpp/io/basic ios/operator bool") |  [`operator!`](operator!.html "cpp/io/basic ios/operator!")  
