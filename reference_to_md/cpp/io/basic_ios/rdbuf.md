...
[std::basic_streambuf](../basic_streambuf.html)<CharT, Traits>* rdbuf() const; |  (1)  |   
---|---|---  
[std::basic_streambuf](../basic_streambuf.html)<CharT, Traits>* rdbuf( [std::basic_streambuf](../basic_streambuf.html)<CharT, Traits>* sb ); |  (2)  |   
| |   
...
2) Sets the associated stream buffer to sb. The error state is cleared by calling [clear()](clear.html "cpp/io/basic ios/clear"). Returns the associated stream buffer before the operation. If there is no associated stream buffer, returns a null pointer.

## Contents

  * [1 Parameters](rdbuf.html#Parameters)
  * [2 Return value](rdbuf.html#Return_value)
  * [3 Exceptions](rdbuf.html#Exceptions)
  * [4 Example](rdbuf.html#Example)
  * [5 See also](rdbuf.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/rdbuf&action=edit&section=1 "Edit section: Parameters")] Parameters

sb  |  \-  |  Stream buffer to associate to.   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/rdbuf&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/rdbuf&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::ostringstream](../basic_ostringstream.html) local;
        auto cout_buff = [std::cout](../cout.html).rdbuf(); // save pointer to std::cout buffer
     
        [std::cout](../cout.html).rdbuf(local.rdbuf()); // substitute internal std::cout buffer with
                                        // buffer of 'local' object
     
        // now std::cout work with 'local' buffer
        // you don't see this message
        [std::cout](../cout.html) << "some message";
     
        // go back to old buffer
        [std::cout](../cout.html).rdbuf(cout_buff);
     
        // you will see this message
        [std::cout](../cout.html) << "back to default buffer\n";
     
        // print 'local' content
        [std::cout](../cout.html) << "local content: " << local.str() << "\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ios/rdbuf&action=edit&section=4 "Edit section: See also")] See also

[ set_rdbuf](set_rdbuf.html "cpp/io/basic ios/set rdbuf") |  replaces the `rdbuf` without clearing its error state   
