...
---|---|---  
void exceptions( [std::ios_base::iostate](../ios_base/iostate.html) except ); |  (2)  |   
| |   
  
Gets and sets the exception mask of the stream. The exception mask determines which error states trigger exceptions of type [failure](../ios_base/failure.html "cpp/io/ios base/failure"). 
...
## Contents
  ...
  * [1 Parameters](exceptions.html#Parameters)
  * [2 Return value](exceptions.html#Return_value)
  * [3 Notes](exceptions.html#Notes)
  * [4 Example](exceptions.html#Example)
...
Run this code
    ...
    int main() 
    {
        ...
        try
        {
            [std::ifstream](../basic_ifstream.html) in("in.txt");
            in.exceptions(std::ifstream::failbit); // may throw
            in >> ivalue; // may throw
        }
        catch (const [std::ios_base::failure](../ios_base/failure.html)& fail)
        {
            // handle exception here
            [std::cout](../cout.html) << fail.what() << '\n';
        }
    }
