...
Makes the `basic_spanbuf` perform I/O on the buffer `[`s`, `s + n`)`. Equivalently calls this->span([std::span](../../container/span.html)<CharT>(s, n)) and then returns this. 
...
[std::ios_base::in](../ios_base/openmode.html) | s | s | s + n  
Set bits in open mode  
...
[std::ios_base::out](../ios_base/openmode.html) && ![std::ios_base::ate](../ios_base/openmode.html) | s | s | s + n  
[std::ios_base::out](../ios_base/openmode.html) && [std::ios_base::ate](../ios_base/openmode.html) | s | s + n | s + n  
