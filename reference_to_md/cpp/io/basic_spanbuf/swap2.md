...
void swap( [std::basic_spanbuf](../basic_spanbuf.html)<CharT, Traits>& lhs,  
[std::basic_spanbuf](../basic_spanbuf.html)<CharT, Traits>& rhs ); |  |  (since C++23)  
| |   
  
Overloads the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for std::basic_spanbuf. Exchanges the state of lhs with that of rhs. Equivalent to lhs.swap(rhs);. 
