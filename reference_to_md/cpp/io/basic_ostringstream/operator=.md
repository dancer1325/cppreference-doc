...
Move assigns the string stream other to *this, effectively move-assigning both the [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream") base class and the associated [std::basic_stringbuf](../basic_stringbuf.html "cpp/io/basic stringbuf"). 
