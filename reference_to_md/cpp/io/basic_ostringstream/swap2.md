...
void swap( [std::basic_ostringstream](../basic_ostringstream.html)<CharT,Traits,Alloc>& lhs,  
[std::basic_ostringstream](../basic_ostringstream.html)<CharT,Traits,Alloc>& rhs ); |  |  (since C++11)  
| |   
  
Overloads the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::basic_ostringstream](../basic_ostringstream.html). Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 
