...
Member functions  
---  
[ostrstream::ostrstream](ostrstream/ostrstream.html "cpp/io/ostrstream/ostrstream")  
[ostrstream::~ostrstream](ostrstream/~ostrstream.html "cpp/io/ostrstream/~ostrstream")  
[ostrstream::rdbuf](ostrstream/rdbuf.html "cpp/io/ostrstream/rdbuf")  
[ostrstream::str](ostrstream/str.html "cpp/io/ostrstream/str")  
[ostrstream::freeze](ostrstream/freeze.html "cpp/io/ostrstream/freeze")  
[ostrstream::pcount](ostrstream/pcount.html "cpp/io/ostrstream/pcount")  
...
---|---|---  
class ostrstream : public [std::ostream](basic_ostream.html) |  |  (deprecated in C++98)   
(removed in C++26)  
| |   
  
The class `ostrstream` implements output operations on array-backed streams. It essentially wraps a raw array I/O device implementation ([std::strstreambuf](strstreambuf.html "cpp/io/strstreambuf")) into the higher-level interface of [std::basic_ostream](basic_ostream.html "cpp/io/basic ostream"). 

The typical implementation of `ostrstream` holds only one non-derived data member: an object of type [std::strstreambuf](strstreambuf.html "cpp/io/strstreambuf"). 

## Contents

  * [1 Notes](ostrstream.html#Notes)
  * [2 Member functions](ostrstream.html#Member_functions)
  * [3 Inherited from std::basic_ostream](ostrstream.html#Inherited_from_std::basic_ostream)
    * [3.1 Member functions](ostrstream.html#Member_functions_2)
      * [3.1.1 Formatted output](ostrstream.html#Formatted_output)
      * [3.1.2 Unformatted output](ostrstream.html#Unformatted_output)
      * [3.1.3 Positioning](ostrstream.html#Positioning)
      * [3.1.4 Miscellaneous](ostrstream.html#Miscellaneous)
    * [3.2 Member classes](ostrstream.html#Member_classes)
  * [4 Inherited from std::basic_ios](ostrstream.html#Inherited_from_std::basic_ios)
    * [4.1 Member types](ostrstream.html#Member_types)
    * [4.2 Member functions](ostrstream.html#Member_functions_3)
      * [4.2.1 State functions](ostrstream.html#State_functions)
      * [4.2.2 Formatting](ostrstream.html#Formatting)
      * [4.2.3 Miscellaneous](ostrstream.html#Miscellaneous_2)
  * [5 Inherited from std::ios_base](ostrstream.html#Inherited_from_std::ios_base)
    * [5.1 Member functions](ostrstream.html#Member_functions_4)
      * [5.1.1 Formatting](ostrstream.html#Formatting_2)
      * [5.1.2 Locales](ostrstream.html#Locales)
      * [5.1.3 Internal extensible array](ostrstream.html#Internal_extensible_array)
      * [5.1.4 Miscellaneous](ostrstream.html#Miscellaneous_3)
      * [5.1.5 Member classes](ostrstream.html#Member_classes_2)
    * [5.2 Member types and constants](ostrstream.html#Member_types_and_constants)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ostrstream&action=edit&section=1 "Edit section: Notes")] Notes

After any call to [str()](ostrstream/str.html "cpp/io/ostrstream/str"), a call to [freeze(false)](ostrstream/freeze.html "cpp/io/ostrstream/freeze") is required to allow the destructor to deallocate the buffer as necessary. 

Before any call to [str()](ostrstream/str.html "cpp/io/ostrstream/str") that uses the result as a C-string, the buffer must be null-terminated, typically with [std::ends](manip/ends.html "cpp/io/manip/ends"). 

`ostrstream` has been deprecated since C++98 and removed since C++26. [std::ostringstream](basic_ostringstream.html "cpp/io/basic ostringstream"), [`std::ospanstream`](basic_ospanstream.html "cpp/io/basic ospanstream")(since C++23), and [`boost::iostreams::array_sink`](https://www.boost.org/doc/libs/release/libs/iostreams/doc/classes/array.html#array_sink) are the recommended replacements. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/ostrstream&action=edit&section=2 "Edit section: Member functions")] Member functions
...
---|---  
[ (destructor)](ostrstream/~ostrstream.html "cpp/io/ostrstream/~ostrstream")[virtual] |  destructs an `ostrstream` object, optionally deallocating the buffer   
...
[ rdbuf](ostrstream/rdbuf.html "cpp/io/ostrstream/rdbuf") |  obtains a pointer to the associated `strstreambuf`   
...
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/strstream/dsc_freeze&action=edit)  
[ pcount](ostrstream/pcount.html "cpp/io/ostrstream/pcount") |  obtains the number of characters written   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/strstream/dsc_pcount&action=edit)  
