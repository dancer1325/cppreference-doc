...
= [std::ios_base::in](../ios_base/openmode.html) ); |  (1)  |   
---|---|---  
void open( const std::filesystem::path::value_type* filename,  
[std::ios_base::openmode](../ios_base/openmode.html) mode  
= [std::ios_base::in](../ios_base/openmode.html) ); |  (2)  |  (since C++17)  
void open( const [std::string](../../string/basic_string.html)& filename,  
[std::ios_base::openmode](../ios_base/openmode.html) mode  
= [std::ios_base::in](../ios_base/openmode.html) ); |  (3)  |  (since C++11)  
void open( const [std::filesystem::path](../../filesystem/path.html)& filename,  
[std::ios_base::openmode](../ios_base/openmode.html) mode  
= [std::ios_base::in](../ios_base/openmode.html) ); |  (4)  |  (since C++17)  
| |   
...
1,2) Effectively calls rdbuf()->open(filename, mode | ios_base::in) (see [std::basic_filebuf::open](../basic_filebuf/open.html "cpp/io/basic filebuf/open") for the details on the effects of that call). Overload (2) is only provided if `std::filesystem::path::value_type` is not char.(since C++17)
