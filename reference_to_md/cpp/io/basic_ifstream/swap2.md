...
Specializes the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::basic_ifstream](../basic_ifstream.html). Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_fstream/swap2&action=edit&section=T-1 "Template:cpp/io/basic fstream/swap2")] Parameters

lhs, rhs  |  \-  |  streams whose state to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_fstream/swap2&action=edit&section=T-2 "Template:cpp/io/basic fstream/swap2")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_fstream/swap2&action=edit&section=T-3 "Template:cpp/io/basic fstream/swap2")] Example
...
Run this code
    ...
    #include <string>
     
    bool create_stream([std::ifstream](../basic_ifstream.html)& fs)
    {
        try
        {
    ...
     
            if ([std::ifstream](../basic_ifstream.html) ts{some_name, some_flags}; ts.is_open())
            {
    ...
    int main()
    {
        if ([std::ifstream](../basic_ifstream.html) fs; create_stream(fs))
        {
            // use fs stream
        }
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_fstream/swap2&action=edit&section=T-4 "Template:cpp/io/basic fstream/swap2")] See also
