...
Member functions  
---  
[basic_stringstream::basic_stringstream](basic_stringstream/basic_stringstream.html "cpp/io/basic stringstream/basic stringstream")  
[basic_stringstream::operator=](basic_stringstream/operator=.html "cpp/io/basic stringstream/operator=")  
[basic_stringstream::swap](basic_stringstream/swap.html "cpp/io/basic stringstream/swap")(C++11)  
[basic_stringstream::rdbuf](basic_stringstream/rdbuf.html "cpp/io/basic stringstream/rdbuf")  
String operations  
[basic_stringstream::str](basic_stringstream/str.html "cpp/io/basic stringstream/str")  
[basic_stringstream::view](basic_stringstream/view.html "cpp/io/basic stringstream/view")(C++20)  
Non-member functions  
[swap(std::basic_stringstream)](basic_stringstream/swap2.html "cpp/io/basic stringstream/swap2")(C++11)  
...
The class template `std::basic_stringstream` implements input and output operations on string based streams. It effectively stores an instance of [std::basic_string](../string/basic_string.html "cpp/string/basic string") and performs the input and output operations on it. 

At the low level, the class essentially wraps a raw string device implementation of [std::basic_stringbuf](basic_stringbuf.html "cpp/io/basic stringbuf") into a higher-level interface of [std::basic_iostream](basic_iostream.html "cpp/io/basic iostream"). The complete interface to unique [std::basic_stringbuf](basic_stringbuf.html "cpp/io/basic stringbuf") members is provided. 

![std-basic stringstream-inheritance.svg](https://upload.cppreference.com/mwiki/images/7/70/std-basic_stringstream-inheritance.svg)
...
## Contents
  ...
  * [1 Member types](basic_stringstream.html#Member_types)
  * [2 Exposition-only members](basic_stringstream.html#Exposition-only_members)
  * [3 Member functions](basic_stringstream.html#Member_functions)
    * [3.1 String operations](basic_stringstream.html#String_operations)
  * [4 Non-member functions](basic_stringstream.html#Non-member_functions)
  * [5 Inherited from std::basic_istream](basic_stringstream.html#Inherited_from_std::basic_istream)
    * [5.1 Member functions](basic_stringstream.html#Member_functions_2)
      * [5.1.1 Formatted input](basic_stringstream.html#Formatted_input)
      * [5.1.2 Unformatted input](basic_stringstream.html#Unformatted_input)
      * [5.1.3 Positioning](basic_stringstream.html#Positioning)
      * [5.1.4 Miscellaneous](basic_stringstream.html#Miscellaneous)
    * [5.2 Member classes](basic_stringstream.html#Member_classes)
  * [6 Inherited from std::basic_ostream](basic_stringstream.html#Inherited_from_std::basic_ostream)
    * [6.1 Member functions](basic_stringstream.html#Member_functions_3)
      * [6.1.1 Formatted output](basic_stringstream.html#Formatted_output)
      * [6.1.2 Unformatted output](basic_stringstream.html#Unformatted_output)
      * [6.1.3 Positioning](basic_stringstream.html#Positioning_2)
      * [6.1.4 Miscellaneous](basic_stringstream.html#Miscellaneous_2)
    * [6.2 Member classes](basic_stringstream.html#Member_classes_2)
  * [7 Inherited from std::basic_ios](basic_stringstream.html#Inherited_from_std::basic_ios)
    * [7.1 Member types](basic_stringstream.html#Member_types_2)
    * [7.2 Member functions](basic_stringstream.html#Member_functions_4)
      * [7.2.1 State functions](basic_stringstream.html#State_functions)
      * [7.2.2 Formatting](basic_stringstream.html#Formatting)
      * [7.2.3 Miscellaneous](basic_stringstream.html#Miscellaneous_3)
  * [8 Inherited from std::ios_base](basic_stringstream.html#Inherited_from_std::ios_base)
    * [8.1 Member functions](basic_stringstream.html#Member_functions_5)
      * [8.1.1 Formatting](basic_stringstream.html#Formatting_2)
      * [8.1.2 Locales](basic_stringstream.html#Locales)
      * [8.1.3 Internal extensible array](basic_stringstream.html#Internal_extensible_array)
      * [8.1.4 Miscellaneous](basic_stringstream.html#Miscellaneous_4)
      * [8.1.5 Member classes](basic_stringstream.html#Member_classes_3)
    * [8.2 Member types and constants](basic_stringstream.html#Member_types_and_constants)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_stringstream&action=edit&section=1 "Edit section: Member types")] Member types
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_stringstream&action=edit&section=2 "Edit section: Exposition-only members")] Exposition-only members
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_stringstream&action=edit&section=3 "Edit section: Member functions")] Member functions
...
---|---  
[ operator=](basic_stringstream/operator=.html "cpp/io/basic stringstream/operator=")(C++11) |  moves the string stream   
...
[ rdbuf](basic_stringstream/rdbuf.html "cpp/io/basic stringstream/rdbuf") |  returns the underlying raw string device object   
...
[ view](basic_stringstream/view.html "cpp/io/basic stringstream/view")(C++20) |  obtains a view over the contents of underlying string device object   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_stringstream&action=edit&section=4 "Edit section: Non-member functions")] Non-member functions
