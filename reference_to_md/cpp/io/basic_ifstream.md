...
Member functions  
---  
[basic_ifstream::basic_ifstream](basic_ifstream/basic_ifstream.html "cpp/io/basic ifstream/basic ifstream")  
[basic_ifstream::operator=](basic_ifstream/operator=.html "cpp/io/basic ifstream/operator=")(C++11)  
[basic_ifstream::swap](basic_ifstream/swap.html "cpp/io/basic ifstream/swap")(C++11)  
[basic_ifstream::rdbuf](basic_ifstream/rdbuf.html "cpp/io/basic ifstream/rdbuf")  
[basic_ifstream::native_handle](basic_ifstream/native_handle.html "cpp/io/basic ifstream/native handle")(C++26)  
File operations  
[basic_ifstream::is_open](basic_ifstream/is_open.html "cpp/io/basic ifstream/is open")  
[basic_ifstream::open](basic_ifstream/open.html "cpp/io/basic ifstream/open")  
[basic_ifstream::close](basic_ifstream/close.html "cpp/io/basic ifstream/close")  
Non-member functions  
[swap(std::basic_ifstream)](basic_ifstream/swap2.html "cpp/io/basic ifstream/swap2")(C++11)  
...
> class basic_ifstream : public [std::basic_istream](basic_istream.html)<CharT, Traits> |  |   
| |   
  
The class template `basic_ifstream` implements high-level input operations on file-based streams. It interfaces a file-based streambuffer ([std::basic_filebuf](basic_filebuf.html "cpp/io/basic filebuf")) with the high-level interface of ([std::basic_istream](basic_istream.html "cpp/io/basic istream")). 

A typical implementation of `std::basic_ifstream` holds only one non-derived data member: an instance of [std::basic_filebuf](basic_filebuf.html)<CharT, Traits>. 

![std-basic ifstream-inheritance.svg](https://upload.cppreference.com/mwiki/images/7/79/std-basic_ifstream-inheritance.svg)
...
## Contents
  ...
  * [1 Member types](basic_ifstream.html#Member_types)
  * [2 Member functions](basic_ifstream.html#Member_functions)
    * [2.1 File operations](basic_ifstream.html#File_operations)
  * [3 Non-member functions](basic_ifstream.html#Non-member_functions)
  * [4 Inherited from std::basic_istream](basic_ifstream.html#Inherited_from_std::basic_istream)
    * [4.1 Member functions](basic_ifstream.html#Member_functions_2)
      * [4.1.1 Formatted input](basic_ifstream.html#Formatted_input)
      * [4.1.2 Unformatted input](basic_ifstream.html#Unformatted_input)
      * [4.1.3 Positioning](basic_ifstream.html#Positioning)
      * [4.1.4 Miscellaneous](basic_ifstream.html#Miscellaneous)
    * [4.2 Member classes](basic_ifstream.html#Member_classes)
  * [5 Inherited from std::basic_ios](basic_ifstream.html#Inherited_from_std::basic_ios)
    * [5.1 Member types](basic_ifstream.html#Member_types_2)
    * [5.2 Member functions](basic_ifstream.html#Member_functions_3)
      * [5.2.1 State functions](basic_ifstream.html#State_functions)
      * [5.2.2 Formatting](basic_ifstream.html#Formatting)
      * [5.2.3 Miscellaneous](basic_ifstream.html#Miscellaneous_2)
  * [6 Inherited from std::ios_base](basic_ifstream.html#Inherited_from_std::ios_base)
    * [6.1 Member functions](basic_ifstream.html#Member_functions_4)
      * [6.1.1 Formatting](basic_ifstream.html#Formatting_2)
      * [6.1.2 Locales](basic_ifstream.html#Locales)
      * [6.1.3 Internal extensible array](basic_ifstream.html#Internal_extensible_array)
      * [6.1.4 Miscellaneous](basic_ifstream.html#Miscellaneous_3)
      * [6.1.5 Member classes](basic_ifstream.html#Member_classes_2)
    * [6.2 Member types and constants](basic_ifstream.html#Member_types_and_constants)
    * [6.3 Notes](basic_ifstream.html#Notes)
    * [6.4 Example](basic_ifstream.html#Example)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ifstream&action=edit&section=1 "Edit section: Member functions")] Member functions

[ (constructor)](basic_ifstream/basic_ifstream.html "cpp/io/basic ifstream/basic ifstream") |  constructs the file stream   
...
---|---  
(destructor)[virtual] (implicitly declared) |  destructs the `basic_ifstream` and the associated buffer, closes the file   
...
[ operator=](basic_ifstream/operator=.html "cpp/io/basic ifstream/operator=")(C++11) |  moves the file stream   
...
[ swap](basic_ifstream/swap.html "cpp/io/basic ifstream/swap")(C++11) |  swaps two file streams   
...
[ rdbuf](basic_ifstream/rdbuf.html "cpp/io/basic ifstream/rdbuf") |  returns the underlying raw file device object   
...
[ native_handle](basic_ifstream/native_handle.html "cpp/io/basic ifstream/native handle")(C++26) |  returns the underlying implementation-defined handle   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_ifstream/dsc_native_handle&action=edit)  
  
#####  File operations   
  
[ is_open](basic_ifstream/is_open.html "cpp/io/basic ifstream/is open") |  checks if the stream has an associated file   
...
[ open](basic_ifstream/open.html "cpp/io/basic ifstream/open") |  opens a file and associates it with the stream   
...
[ close](basic_ifstream/close.html "cpp/io/basic ifstream/close") |  closes the associated file   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ifstream&action=edit&section=2 "Edit section: Non-member functions")] Non-member functions

[ std::swap(std::basic_ifstream)](basic_ifstream/swap2.html "cpp/io/basic ifstream/swap2")(C++11) |  specializes the [std::swap](../utility/swap.html "cpp/algorithm/swap") algorithm   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ifstream&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ifstream&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        double d = 3.14;
        [std::ofstream](basic_ofstream.html)(filename, std::ios::binary)
    ...
     
        ...
        else
        {
            ...
            if (istrm >> n >> s)                               // text input
                [std::cout](cout.html) << "read back from file: " << d << ' ' << n << ' ' << s << '\n';
        }
    }
