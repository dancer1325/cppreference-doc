[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_stringstream/view&action=edit)
...
Obtains a [std::basic_string_view](../../string/basic_string_view.html "cpp/string/basic string view") over the underlying string object. Equivalent to return rdbuf()->view();. 

## Contents

  * [1 Parameters](view.html#Parameters)
  * [2 Return value](view.html#Return_value)
  * [3 Example](view.html#Example)
  * [4 See also](view.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        int n = 0;
        buf1 >> n;
        [std::cout](../cout.html) << "1) buf1 = [" << buf1.view() << "], n = " << n << '\n';
     
        // output stream in append mode
        [std::ostringstream](../basic_ostringstream.html) buf2("test", [std::ios_base::ate](../ios_base/openmode.html));
        buf2 << '1';
        [std::cout](../cout.html) << "2) buf2 = [" << buf2.view() << "]\n";
     
        // input stream
        [std::istringstream](../basic_istringstream.html) inbuf("-42");
        inbuf >> n;
        [std::cout](../cout.html) << "3) inbuf = [" << inbuf.view() << "], n = " << n << '\n';
    }
