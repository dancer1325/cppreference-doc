...
[basic_stringstream::operator=](operator=.html "cpp/io/basic stringstream/operator=")  
[basic_stringstream::swap](swap.html "cpp/io/basic stringstream/swap")(C++11)  
[basic_stringstream::rdbuf](rdbuf.html "cpp/io/basic stringstream/rdbuf")  
String operations  
[basic_stringstream::str](str.html "cpp/io/basic stringstream/str")  
[basic_stringstream::view](view.html "cpp/io/basic stringstream/view")(C++20)  
...
| (1) |   
---|---|---  
explicit basic_stringstream( [std::ios_base::openmode](../ios_base/openmode.html) mode =  
[std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html) ); |  | (until C++11)  
explicit basic_stringstream( [std::ios_base::openmode](../ios_base/openmode.html) mode ); |  |  (since C++11)  
basic_stringstream()  
: basic_stringstream([std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html)) {} |  (2)  |  (since C++11)  
...
basic_stringstream( [std::ios_base::openmode](../ios_base/openmode.html) mode, const Allocator& a ); |  (5)  |  (since C++20)  
template< class SAlloc >  
basic_stringstream( const [std::basic_string](../../string/basic_string.html)<CharT, Traits, SAlloc>& str,  
[std::ios_base::openmode](../ios_base/openmode.html) mode, const Allocator& a ); |  (6)  |  (since C++20)  
template< class SAlloc >  
basic_stringstream( const [std::basic_string](../../string/basic_string.html)<CharT, Traits, SAlloc>& str,  
const Allocator& a )  
: basic_stringstream(str, [std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html), a) {} |  (7)  |  (since C++20)  
template< class SAlloc >  
explicit basic_stringstream  
( const [std::basic_string](../../string/basic_string.html)<CharT, Traits, SAlloc>& str,  
[std::ios_base::openmode](../ios_base/openmode.html) mode =  
[std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html) ); |  (8)  |  (since C++20)  
template< class StringViewLike >  
explicit basic_stringstream  
( const StringViewLike& t,  
[std::ios_base::openmode](../ios_base/openmode.html) mode =  
[std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html) ); |  (9) | (since C++26)  
template< class StringViewLike >  
...
Given 
  ...
  * `base_type` as [std::basic_iostream](../basic_iostream.html)<CharT, Traits>, and 
  * `buf_type` as [std::basic_stringbuf](../basic_stringbuf.html)<CharT, Traits, Allocator>, 



the [std::basic_iostream](../basic_iostream.html "cpp/io/basic iostream") base and the [exposition-only data member](../basic_stringstream.html#Exposition-only_members "cpp/io/basic stringstream") `_sb_` are initialized as follows. 

Over  
load  | [std::basic_iostream](../basic_iostream.html "cpp/io/basic iostream") base  | `_sb_`  
---|---|---  
(1) | base_type([std::addressof](../../memory/addressof.html)(sb))[[1]](basic_stringstream.html#cite_note-1) | buf_type(mode)  
(2) | buf_type([std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html))  
(3) | buf_type(str, mode)  
(4) | buf_type(std::move(str), mode)  
(5) | buf_type(mode, a)  
(6) | buf_type(str, mode, a)  
(7) | buf_type(str, [std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html), a)  
(8) | buf_type(str, mode)  
(9) | [std::addressof](../../memory/addressof.html)(sb) | {t, mode, Allocator()}  
(10) | {t, mode, a}  
(11) | {t, [std::ios_base::in](../ios_base/openmode.html) | [std::ios_base::out](../ios_base/openmode.html), a}  
(12) | move constructed from other's [std::basic_iostream](../basic_iostream.html "cpp/io/basic iostream") base  | move constructed from other.sb  
  
  1. [↑](basic_stringstream.html#cite_ref-1) The [std::basic_iostream](../basic_iostream.html "cpp/io/basic iostream") base was intialized with base_type(&sb) (for overloads (1,3)) until C++11.
...
## Contents
  ...
  * [1 Parameters](basic_stringstream.html#Parameters)
  * [2 Notes](basic_stringstream.html#Notes)
  * [3 Example](basic_stringstream.html#Example)
  * [4 Defect reports](basic_stringstream.html#Defect_reports)
  * [5 See also](basic_stringstream.html#See_also)
