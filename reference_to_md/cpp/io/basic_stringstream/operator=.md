...
Move assigns the string stream other to *this, effectively move-assigning both the [std::basic_iostream](../basic_iostream.html "cpp/io/basic iostream") base class and the associated [std::basic_stringbuf](../basic_stringbuf.html "cpp/io/basic stringbuf"). 
