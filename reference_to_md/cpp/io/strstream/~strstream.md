...
Run this code
    ...
    {
        {
            [std::ostrstream](../ostrstream.html) s; // dynamic buffer 
    ...
     
        {
            [std::ostrstream](../ostrstream.html) s;
            s << 1.23 << [std::ends](../manip/ends.html);
            [std::cout](../cout.html) << s.str() << '\n';
    //      buf.freeze(false);
    ...
     
        {
            [std::istrstream](../istrstream.html) s("1.23"); // constant buffer
            double d;
            s >> d;
            [std::cout](../cout.html) << d << '\n';
