...
---|---|---  
[std::error_code](../../error/error_code.html) make_error_code( [std::io_errc](../io_errc.html) e ) noexcept; |  |  (since C++11)  
| |   
  
Constructs an [std::error_code](../../error/error_code.html "cpp/error/error code") object from a value of type [std::io_errc](../io_errc.html "cpp/io/io errc") as if by return [std::error_code](../../error/error_code.html)(static_cast<int>(e), [std::iostream_category](../iostream_category.html)()). 

This function is called by the constructor of [std::error_code](../../error/error_code.html "cpp/error/error code") with an [std::io_errc](../io_errc.html "cpp/io/io errc") argument. 

## Contents

  * [1 Parameters](make_error_code.html#Parameters)
  * [2 Return value](make_error_code.html#Return_value)
  * [3 Example](make_error_code.html#Example)
  * [4 Defect reports](make_error_code.html#Defect_reports)
  * [5 See also](make_error_code.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::error_code](../../error/error_code.html) ec = [std::make_error_code](../../error/errc/make_error_code.html)([std::io_errc::stream](../io_errc.html));
     
        // This works because of the overloaded method
        //    and the is_error_code_enum specialization.
        ec = [std::io_errc::stream](../io_errc.html);
     
        [std::cout](../cout.html) << "Error code from io_errc::stream has category "
                  << ec.category().name() << '\n';
    }
