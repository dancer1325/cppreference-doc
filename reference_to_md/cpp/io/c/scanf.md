...
int fscanf( [std::FILE](FILE.html)* stream, const char* format, ... ); |  (2)  |   
...
## Contents
  ...
  * [1 Parameters](scanf.html#Parameters)
  * [2 Return value](scanf.html#Return_value)
  * [3 Complexity](scanf.html#Complexity)
  * [4 Notes](scanf.html#Notes)
  * [5 Example](scanf.html#Example)
  * [6 See also](scanf.html#See_also)
...
Run this code
    ...
     
        [std::cout](../cout.html) << "Converted " << ret << " fields:\n"
                     "i = " << i << "\n"
                     "x = " << x << "\n"
                     "str1 = " << str1 << "\n"
                     "j = " << j << "\n"
                     "y = " << y << "\n"
                     "str2 = " << str2 << [std::hex](../manip/hex.html) << "\n"
                     "warr[0] = U+" << (int)warr[0] << "\n"
                     "warr[1] = U+" << (int)warr[1] << '\n';
    }
