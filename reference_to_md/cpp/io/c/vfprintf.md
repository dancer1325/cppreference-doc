...
---  
**vprintf vfprintfvsprintfvsnprintf**(C++11)  
...
int vfprintf( [std::FILE](FILE.html)* stream, const char* format, std::va_list vlist ); |  (2)  |   
int vsprintf( char* buffer, const char* format, std::va_list vlist ); |  (3)  |   
int vsnprintf( char* buffer, [std::size_t](../../types/size_t.html) buf_size, const char* format, std::va_list vlist ); |  (4)  |  (since C++11)  
| |   
...
## Contents
  ...
  * [5 See also](vfprintf.html#See_also)
...
Run this code
    ...
    void debug_log(const char *fmt, ...)
    {
        ...
        char time_buf[100];
        [std::strftime](../../chrono/c/strftime.html)(time_buf, sizeof time_buf, "%D %T", [std::gmtime](../../chrono/c/gmtime.html)(&t));
        std::va_list args1;
        [va_start](../../utility/variadic/va_start.html)(args1, fmt);
        std::va_list args2;
        [va_copy](../../utility/variadic/va_copy.html)(args2, args1);
        [std::vector](../../container/vector.html)<char> buf(1 + std::vsnprintf(nullptr, 0, fmt, args1));
        [va_end](../../utility/variadic/va_end.html)(args1);
        std::vsnprintf(buf.data(), buf.size(), fmt, args2);
        [va_end](../../utility/variadic/va_end.html)(args2);
        [std::printf](fprintf.html)("%s [debug]: %s\n", time_buf, buf.data());
    }
     
    int main()
    {
