...
---  
**vscanf vfscanfvsscanf**(C++11)(C++11)(C++11)  
...
int vfscanf( [std::FILE](FILE.html)* stream, const char* format, std::va_list vlist ); |  (2)  |  (since C++11)  
...
## Contents
  ...
  * [5 See also](vfscanf.html#See_also)
...
The **format** string consists of 
  ...
  * whitespace characters: any single whitespace character in the format string consumes all available consecutive whitespace characters from the input (determined as if by calling std::isspace in a loop). Note that there is no difference between "\n", " ", "\t\t", or other whitespace in the format string. 
...
`d` |  Matches a **decimal integer**. 
  ...
  * The format of the number is the same as expected by [std::strtol](../../string/byte/strtol.html "cpp/string/byte/strtol") with the value 10 for the base argument. 
...
`i` |  Matches an **integer**. 
  ...
  * The format of the number is the same as expected by [std::strtol](../../string/byte/strtol.html "cpp/string/byte/strtol") with the value ​0​ for the base argument (base is determined by the first characters parsed). 

  
`u` |  Matches an unsigned **decimal integer**. 

  * The format of the number is the same as expected by [std::strtoul](../../string/byte/strtoul.html "cpp/string/byte/strtoul") with the value 10 for the base argument. 

  
`o` |  Matches an unsigned **octal integer**. 

  * The format of the number is the same as expected by [std::strtoul](../../string/byte/strtoul.html "cpp/string/byte/strtoul") with the value 8 for the base argument. 

  
`x`  
`X` |  Matches an unsigned **hexadecimal integer**. 

  * The format of the number is the same as expected by [std::strtoul](../../string/byte/strtoul.html "cpp/string/byte/strtoul") with the value 16 for the base argument. 
...
`G` |  Matches a **floating-point number**. 
  ...
  * The format of the number is the same as expected by [std::strtof](../../string/byte/strtof.html "cpp/string/byte/strtof"). 
...
All these functions invoke [va_arg](../../utility/variadic/va_arg.html "cpp/utility/variadic/va arg") at least once, the value of `arg` is indeterminate after the return. These functions to not invoke [va_end](../../utility/variadic/va_end.html "cpp/utility/variadic/va end"), and it must be done by the caller. 
...
Run this code
    ...
    {
        std::va_list ap;
        [va_start](../../utility/variadic/va_start.html)(ap, fmt);
        if (std::vsscanf(buf, fmt, ap) != count)
            throw [std::runtime_error](../../error/runtime_error.html)("parsing error");
        [va_end](../../utility/variadic/va_end.html)(ap);
    }
     
    int main()
    {
        ...
        {
            int n, m;
            [std::cout](../cout.html) << "Parsing '1 2'... ";
            checked_sscanf(2, "1 2", "%d %d", &n, &m);
            [std::cout](../cout.html) << "success\n";
            [std::cout](../cout.html) << "Parsing '1 a'... ";
            checked_sscanf(2, "1 a", "%d %d", &n, &m);
            [std::cout](../cout.html) << "success\n";
        }
        catch (const [std::exception](../../error/exception.html)& e)
        {
            [std::cout](../cout.html) << e.what() << '\n';
        }
    }
...
(function)   
[C documentation](../../../c/io/vfscanf.html "c/io/vfscanf") for vscanf, vfscanf, vsscanf
