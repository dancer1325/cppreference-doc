...
int vfwprintf( [std::FILE](FILE.html)* stream, const wchar_t* format, va_list vlist ); |  (2)  |   
int vswprintf( wchar_t* buffer, [std::size_t](../../types/size_t.html) buf_size, const wchar_t* format, va_list vlist ); |  (3)  |   
| |   
...
## Contents
  ...
  * [5 See also](vfwprintf.html#See_also)
...
vlist  |  \-  |  [variable argument list](../../language/variadic_arguments.html "cpp/language/variadic arguments") containing the data to print.   
...
(function)   
[C documentation](../../../c/io/vfwprintf.html "c/io/vfwprintf") for vwprintf, vfwprintf, vswprintf
