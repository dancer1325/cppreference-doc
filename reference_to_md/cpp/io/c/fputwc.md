...
---|---|---  
[std::wint_t](../../string/wide.html) fputwc( wchar_t ch, [std::FILE](FILE.html)* stream ); |  (1)  |   
[std::wint_t](../../string/wide.html) putwc( wchar_t ch, [std::FILE](FILE.html)* stream ); |  (2)  |   
| |   
...
## Contents
  ...
  * [4 See also](fputwc.html#See_also)
...
Run this code
    ...
     
        ...
        })
        {
            ...
            {
                [std::puts](puts.html)(errno == [EILSEQ](../../error/errno_macros.html)
