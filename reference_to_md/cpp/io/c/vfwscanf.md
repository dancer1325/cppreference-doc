...
---  
**vwscanf vfwscanfvswscanf**(C++11)(C++11)(C++11)  
...
int vfwscanf( [std::FILE](FILE.html)* stream, const wchar_t* format, std::va_list vlist ); |  (2)  |  (since C++11)  
...
1) Reads the data from [stdin](std_streams.html "cpp/io/c/std streams").
...
## Contents
  ...
  * [3 Example](vfwscanf.html#Example)
  * [4 See also](vfwscanf.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/vfwscanf&action=edit&section=1 "Edit section: Parameters")] Parameters
...
The **format** string consists of 
  ...
  * whitespace characters: any single whitespace character in the format string consumes all available consecutive whitespace characters from the input (determined as if by calling [std::iswspace](../../string/wide/iswspace.html "cpp/string/wide/iswspace") in a loop). Note that there is no difference between "\n", " ", "\t\t", or other whitespace in the format string. 
...
`d` |  Matches a **decimal integer**. 
  ...
  * The format of the number is the same as expected by [std::wcstol](../../string/wide/wcstol.html "cpp/string/wide/wcstol") with the value 10 for the base argument. 

| signed char* or unsigned char* | signed short* or unsigned short* | signed int* or unsigned int* | signed long* or unsigned long* | signed long long* or unsigned long long* | [std::intmax_t](../../types/integer.html)* or [std::uintmax_t](../../types/integer.html)* | [std::size_t](../../types/size_t.html)* | [std::ptrdiff_t](../../types/ptrdiff_t.html)* |  N/A  
`i` |  Matches an **integer**. 

  * The format of the number is the same as expected by [std::wcstol](../../string/wide/wcstol.html "cpp/string/wide/wcstol") with the value ​0​ for the base argument (base is determined by the first characters parsed). 

  
`u` |  Matches an unsigned **decimal integer**. 

  * The format of the number is the same as expected by [std::wcstoul](../../string/wide/wcstoul.html "cpp/string/wide/wcstoul") with the value 10 for the base argument. 

  
`o` |  Matches an unsigned **octal integer**. 

  * The format of the number is the same as expected by [std::wcstoul](../../string/wide/wcstoul.html "cpp/string/wide/wcstoul") with the value 8 for the base argument. 

  
`x`  
`X` |  Matches an unsigned **hexadecimal integer**. 

  * The format of the number is the same as expected by [std::wcstoul](../../string/wide/wcstoul.html "cpp/string/wide/wcstoul") with the value 16 for the base argument. 
...
`G` |  Matches a **floating-point number**. 
  ...
  * The format of the number is the same as expected by [std::wcstof](../../string/wide/wcstof.html "cpp/string/wide/wcstof"). 
...
---|---  
[C documentation](../../../c/io/vfwscanf.html "c/io/vfwscanf") for vwscanf, vfwscanf, vswscanf
