...
## Contents
  ...
  * [5 See also](remove.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        if (![std::ofstream](../basic_ofstream.html)("file1.txt").put('a'))
        {
            [std::perror](perror.html)("Error creating file1.txt");
            return [EXIT_FAILURE](../../utility/program/EXIT_status.html);
        }
        [std::cout](../cout.html) << [std::ifstream](../basic_ifstream.html)("file1.txt").rdbuf() << '\n'; // print file
     
        std::remove("file1.txt"); // delete file
     
        if (![std::ifstream](../basic_ifstream.html){"file1.txt"}) // uses operator! of temporary stream object
        {
            [std::perror](perror.html)("Error opening deleted file");
            return [EXIT_FAILURE](../../utility/program/EXIT_status.html);
        }
