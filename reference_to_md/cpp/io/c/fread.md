...
---|---|---  
[std::size_t](../../types/size_t.html) fread( void* buffer, [std::size_t](../../types/size_t.html) size, [std::size_t](../../types/size_t.html) count, [std::FILE](FILE.html)* stream ); |  |   
| |   
...
If the objects are not [TriviallyCopyable](../../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable"), the behavior is undefined. 
...
## Contents
  ...
  * [4 See also](fread.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/fread&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/fread&action=edit&section=2 "Edit section: Return value")] Return value
...
`fread` does not distinguish between end-of-file and error, and callers must use [std::feof](feof.html "cpp/io/c/feof") and [std::ferror](ferror.html "cpp/io/c/ferror") to determine which occurred. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/fread&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    {
        // Prepare file
        [std::ofstream](../basic_ofstream.html)("test.txt") << 1 << ' ' << 2 << '\n';
        [std::FILE](FILE.html)* f = [std::fopen](fopen.html)("test.txt", "r");
     
        [std::vector](../../container/vector.html)<char> buf(4); // char is trivially copyable
        const [std::size_t](../../types/size_t.html) n = std::fread(&buf[0], sizeof buf[0], buf.size(), f);
     
        [std::cout](../cout.html) << "Read " << n << " object" << (n > 1 ? "s" : "") << ": "
                  << [std::hex](../manip/hex.html) << [std::uppercase](../manip/uppercase.html) << [std::setfill](../manip/setfill.html)('0');
        for (char n : buf)
            [std::cout](../cout.html) << "0x" << [std::setw](../manip/setw.html)(2) << static_cast<short>(n) << ' ';
        [std::cout](../cout.html) << '\n';
     
        [std::vector](../../container/vector.html)<[std::string](../../string/basic_string.html)> buf2; // string is not trivially copyable
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/fread&action=edit&section=4 "Edit section: See also")] See also
...
[ fwrite](fwrite.html "cpp/io/c/fwrite") |  writes to a file   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/c/dsc_fwrite&action=edit)  
[C documentation](../../../c/io/fread.html "c/io/fread") for fread
