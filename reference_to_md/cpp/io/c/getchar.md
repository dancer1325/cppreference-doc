...
Reads the next character from [stdin](std_streams.html "cpp/io/c/std streams"). 

Equivalent to [std::getc](fgetc.html)(stdin). 
...
## Contents
  ...
  * [4 See also](getchar.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/getchar&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/getchar&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/getchar&action=edit&section=3 "Edit section: Example")] Example
...
`std::getchar` with error checking. Exit program by entering ESC char. 
    ...
    int main()
    {
        for (int ch; (ch = std::getchar()) != [EOF](../c.html) ;) // read/print "abc" from stdin
        {
            if ([std::isprint](../../string/byte/isprint.html)(ch))
                [std::cout](../cout.html) << static_cast<char>(ch) << '\n';
            if (ch == 27) // 'ESC' (escape) in ASCII
                return [EXIT_SUCCESS](../../utility/program/EXIT_status.html);
        }
     
        // Test reason for reaching EOF.
        if ([std::feof](feof.html)(stdin)) // if failure caused by end-of-file condition
            [std::cout](../cout.html) << "End of file reached\n";
        else if ([std::ferror](ferror.html)(stdin)) // if failure caused by some other error
        {
            [std::perror](perror.html)("getchar()");
            [std::cerr](../cerr.html) << "getchar() failed in file " << [std::quoted](../manip/quoted.html)(__FILE__)
                      << " at line # " << __LINE__ - 14 << '\n';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/getchar&action=edit&section=4 "Edit section: See also")] See also
...
---|---  
[C documentation](../../../c/io/getchar.html "c/io/getchar") for getchar
