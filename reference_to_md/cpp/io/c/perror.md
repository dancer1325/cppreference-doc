...
Prints a textual description of the error code currently stored in the system variable [errno](../../error/errno.html "cpp/error/errno") to [stderr](std_streams.html "cpp/io/c/std streams"). 
...
The description is formed by concatenating the following components: 
  ...
  * implementation-defined error message string describing the error code stored in `errno`, followed by '\n'. The error message string is identical to the result of [std::strerror](../../string/byte/strerror.html)(errno). 
...
## Contents
  ...
  * [4 See also](perror.html#See_also)
...
Run this code
    ...
    int main()
    {
        double not_a_number = [std::log](../../numeric/math/log.html)(-1.0);
        if (errno == [EDOM](../../error/errno_macros.html))
            std::perror("log(-1) failed");
        [std::printf](fprintf.html)("%f\n", not_a_number);
    }
