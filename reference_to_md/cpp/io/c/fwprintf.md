...
int fwprintf( [std::FILE](FILE.html)* stream, const wchar_t* format, ... ); |  (2)  |   
int swprintf( wchar_t* buffer, [std::size_t](../../types/size_t.html) size, const wchar_t* format, ... ); |  (3)  |   
| |   
...
1) Writes the results to [stdout](std_streams.html "cpp/io/c/std streams").
...
## Contents
  ...
  * [5 See also](fwprintf.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/fwprintf&action=edit&section=1 "Edit section: Parameters")] Parameters
...
...  |  \-  |  arguments specifying data to print. If any argument after [default conversions](../../language/variadic_arguments.html#Default_conversions "cpp/language/variadic arguments") is not the type expected by the corresponding conversion specifier, or if there are fewer arguments than required by format, the behavior is undefined. If there are more arguments than required by format, the extraneous arguments are evaluated and ignored   
...
`c` |  Writes a **single character**. 
  ...
  * The argument is first converted to wchar_t as if by calling [std::btowc](../../string/multibyte/btowc.html "cpp/string/multibyte/btowc"). 
  * If the **l** modifier is used, the std::wint_t argument is first converted to wchar_t. 

|  N/A |  N/A | int | std::wint_t |  N/A |  N/A |  N/A |  N/A |  N/A  
`s` |  Writes a **character string**. 

  * The argument must be a pointer to the initial element of a character array containing a multibyte character sequence beginning in the initial shift state, which is converted to wide character array as if by a call to [std::mbrtowc](../../string/multibyte/mbrtowc.html "cpp/string/multibyte/mbrtowc") with zero-initialized conversion state. 
...
`i` |  Converts a **signed integer** into decimal representation _[-]dddd_. 
  ...
  * For the `**z**` modifier, the expected argument type is the signed version of [std::size_t](../../types/size_t.html "cpp/types/size t"). 

| signed char | short | int | long | long long | [std::intmax_t](../../types/integer.html "cpp/types/integer") | ※ | [std::ptrdiff_t](../../types/ptrdiff_t.html "cpp/types/ptrdiff t") |  N/A  
...
| unsigned char | unsigned short | unsigned int | unsigned long | unsigned long long | [std::uintmax_t](../../types/integer.html "cpp/types/integer") | [std::size_t](../../types/size_t.html "cpp/types/size t") | unsigned version of [std::ptrdiff_t](../../types/ptrdiff_t.html "cpp/types/ptrdiff t") |  N/A  
`x`  
...
|  N/A  
`f`  
`F` (C++11) |  Converts **floating-point number** to the decimal notation in the style _[-]ddd.ddd_. 
...
`a`  
`A` (C++11) |  Converts **floating-point number** to the hexadecimal exponent notation. 
...
`G` |  Converts **floating-point number** to decimal or decimal exponent notation depending on the value and the _precision_. 
  ...
  * For the `**G**` conversion style conversion with style `**E**` or `**f**`(until C++11)`**F**`(since C++11) will be performed. 
  * Let `P` equal the precision if nonzero, 6 if the precision is not specified, or 1 if the precision is ​0​. Then, if a conversion with style `E` would have an exponent of `X`: 
    * If _P > X ≥ −4_, the conversion is with style `**f**` or `**F**`(since C++11) and precision _P − 1 − X_. 
...
`n` |  Returns the **number of characters written** so far by this call to the function. 
  ...
  * For the `**z**` modifier, the expected argument type is S*, where `S` is the signed version of [std::size_t](../../types/size_t.html). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/fwprintf&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/fwprintf&action=edit&section=3 "Edit section: Notes")] Notes

While narrow strings provide [std::snprintf](printf.html "cpp/io/c/fprintf"), which makes it possible to determine the required output buffer size, there is no equivalent for wide strings, and in order to determine the buffer size, the program may need to call `std::swprintf`, check the result value, and reallocate a larger buffer, trying again until successful. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/fwprintf&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::wcout](../cout.html).imbue([std::locale](../../locale/locale.html)("en_US.utf8"));
        [std::wcout](../cout.html) << warr << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/fwprintf&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[ vwprintfvfwprintfvswprintf](vfwprintf.html "cpp/io/c/vfwprintf") |  prints formatted wide character output to [stdout](std_streams.html "cpp/io/c/std streams"), a file stream  
...
[C documentation](../../../c/io/fwprintf.html "c/io/fwprintf") for wprintf, fwprintf, swprintf
