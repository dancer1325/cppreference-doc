...
---|---|---  
void rewind( [std::FILE](FILE.html)* stream ); |  |   
| |   
  
Moves the file position indicator to the beginning of the given file stream. 

The function is equivalent to [std::fseek](fseek.html)(stream, 0, [SEEK_SET](../c.html));, except that end-of-file and error indicators are cleared. 

The function drops any effects from previous calls to [ungetc](ungetc.html "cpp/io/c/ungetc"). 
...
## Contents
  ...
  * [4 See also](rewind.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/rewind&action=edit&section=1 "Edit section: Parameters")] Parameters

stream  |  \-  |  file stream to modify   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/rewind&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/rewind&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::FILE](FILE.html)* f = [std::fopen](fopen.html)("file.txt", "w");
        for (char ch = '0'; ch <= '9'; ch++)
            [std::fputc](fputc.html)(ch, f);
        [std::fclose](fclose.html)(f);
     
        [std::array](../../container/array.html)<char, 20> str;
        [std::FILE](FILE.html)* f2 = [std::fopen](fopen.html)("file.txt", "r");
     
        const unsigned size1 = [std::fread](fread.html)(str.data(), 1, str.size(), f2);
        [std::puts](puts.html)(str.data());
        [std::printf](fprintf.html)("size1 = %u\n", size1);
     
        std::rewind(f2);
     
        const unsigned size2 = [std::fread](fread.html)(str.data(), 1, str.size(), f2);
        [std::puts](puts.html)(str.data());
        [std::printf](fprintf.html)("size2 = %u", size2);
     
        [std::fclose](fclose.html)(f2);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/c/rewind&action=edit&section=4 "Edit section: See also")] See also
...
---|---  
[C documentation](../../../c/io/rewind.html "c/io/rewind") for rewind
