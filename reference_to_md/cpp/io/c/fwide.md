...
---|---|---  
int fwide( [std::FILE](FILE.html)* stream, int mode ); |  |   
| |   
...
## Contents
  ...
  * [4 See also](fwide.html#See_also)
...
Run this code
    ...
    {
        n < 0 ? [std::wcout](../cout.html) << "\tnarrow orientation\n" :
        n > 0 ? [std::wcout](../cout.html) << "\twide orientation\n" :
                [std::wcout](../cout.html) << "\tno orientation\n";
    }
     
    void try_read(FILE* fp)
    {
        if (const int c = [std::fgetc](fgetc.html)(fp); c == [EOF](../c.html))
            [std::wcout](../cout.html) << "\tnarrow character read failed\n";
        else
            [std::wcout](../cout.html) << "\tnarrow character read '" << static_cast<char>(c) << "'\n";
     
        if (const wint_t wc = [std::fgetwc](fgetwc.html)(fp); wc == WEOF)
            [std::wcout](../cout.html) << "\twide character read failed\n";
        else
            [std::wcout](../cout.html) << "\twide character read '" << static_cast<wchar_t>(wc) << "'\n";
    }
     
    int main()
    {
    ...
     
        FILE* fp = [std::fopen](fopen.html)("main.cpp", "r");
        if (!fp)
        {
            [std::wcerr](../cerr.html) << "fopen() failed\n";
            return [EXIT_FAILURE](../../utility/program/EXIT_status.html);
        }
     
        [std::wcout](../cout.html) << "1) A newly opened stream has no orientation.\n";
        show_orientation(std::fwide(fp, fwide_orientation::query));
     
        [std::wcout](../cout.html) << "2) Establish byte orientation.\n";
        show_orientation(std::fwide(fp, fwide_orientation::narrow));
        try_read(fp);
     
        [std::wcout](../cout.html) << "3) Only freopen() can reset stream orientation.\n";
        if ([std::freopen](freopen.html)("main.cpp", "r", fp) == [NULL](../../types/NULL.html))
        {
            [std::wcerr](../cerr.html) << "freopen() failed\n";
            return [EXIT_FAILURE](../../utility/program/EXIT_status.html);
        }
     
        [std::wcout](../cout.html) << "4) A reopened stream has no orientation.\n";
        show_orientation(std::fwide(fp, fwide_orientation::query));
     
        [std::wcout](../cout.html) << "5) Establish wide orientation.\n";
