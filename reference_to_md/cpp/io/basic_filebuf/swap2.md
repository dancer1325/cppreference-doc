...
[std::basic_filebuf](../basic_filebuf.html)<CharT,Traits>& rhs ); |  |  (since C++11)  
---|---|---  
| |   
  
Overloads the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for [std::basic_filebuf](../basic_filebuf.html "cpp/io/basic filebuf"). Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 
