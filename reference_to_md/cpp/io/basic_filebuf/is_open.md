...
Returns true if the most recent call to [open()](open.html "cpp/io/basic filebuf/open") succeeded and there has been no call to [close()](close.html "cpp/io/basic filebuf/close") since then. 

## Contents

  * [1 Parameters](is_open.html#Parameters)
  * [2 Return value](is_open.html#Return_value)
  * [3 Notes](is_open.html#Notes)
  * [4 Example](is_open.html#Example)
...
This function is typically called by [std::basic_fstream::is_open()](../basic_fstream/is_open.html "cpp/io/basic fstream/is open"). 
...
Run this code
    ...
    int main()
    {
        [std::ifstream](../basic_ifstream.html) fs("test.txt");
        [std::filebuf](../basic_filebuf.html) fb;
        fb.open("test.txt", [std::ios_base::in](../ios_base/openmode.html));
...
[ open](open.html "cpp/io/basic filebuf/open") |  opens a file and configures it as the associated character sequence   
