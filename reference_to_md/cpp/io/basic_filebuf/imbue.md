...
protected:  
virtual void imbue( const [std::locale](../../locale/locale.html)& loc ) |  |   
---|---|---  
| |   
  
Changes the associated locale so that all characters inserted or extracted after this call (and until another call to `imbue()`) are converted using the [std::codecvt](../../locale/codecvt.html "cpp/locale/codecvt") facet of `loc`. 

If the old locale's encoding is state-dependent and file is not positioned at the beginning, then the new locale must have the same [std::codecvt](../../locale/codecvt.html "cpp/locale/codecvt") facet as the one previously imbued. 

## Contents

  * [1 Parameters](imbue.html#Parameters)
  * [2 Return value](imbue.html#Return_value)
  * [3 Example](imbue.html#Example)
  * [4 See also](imbue.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_filebuf/imbue&action=edit&section=1 "Edit section: Parameters")] Parameters

loc  |  \-  |  the locale to imbue the stream with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_filebuf/imbue&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_filebuf/imbue&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_filebuf/imbue&action=edit&section=4 "Edit section: See also")] See also
