...
Move assigns the file stream other to *this, effectively move-assigning both the [std::basic_ostream](../basic_ostream.html "cpp/io/basic ostream") base class and the associated [std::basic_filebuf](../basic_filebuf.html "cpp/io/basic filebuf"). 
