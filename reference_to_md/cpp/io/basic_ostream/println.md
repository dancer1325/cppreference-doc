...
---|---|---  
template< class... Args >  
void println( [std::ostream](../basic_ostream.html)& os, [std::format_string](../../utility/format/basic_format_string.html)<Args...> fmt, Args&&... args ); |  (1) | (since C++23)  
void println( [std::ostream](../basic_ostream.html)& os ); |  (2) | (since C++26)  
| |   
...
1) Equivalent to: [`std::print`](print.html "cpp/io/basic ostream/print")(os, "{}\n", [std::format](../../utility/format/format.html)(os.getloc(), fmt, args...));

2) Equivalent to: [`std::print`](print.html "cpp/io/basic ostream/print")(os, "\n");
...
## Contents
  ...
  * [5 Defect reports](println.html#Defect_reports)
  * [6 See also](println.html#See_also)
...
Although overload ([2](println.html#Version_2)) is added in C++26, all known implementations make it available in C++23 mode. 
...
---|---|---|---  
[LWG 4088](https://cplusplus.github.io/LWG/issue4088) | C++23  | ([1](println.html#Version_1)) ignored the locale imbued in os in formatting arguments  | such locale is used   
