...
---|---|---  
template< class... Args >  
void print( [std::ostream](../basic_ostream.html)& os, [std::format_string](../../utility/format/basic_format_string.html)<Args...> fmt, Args&&... args ); |  |  (since C++23)  
| |   
  
Formats args according to the format string fmt, and inserts the result into os stream. 

If the [ordinary literal encoding](../../language/charset.html#Code_unit_and_literal_encoding "cpp/language/charset") is UTF-8, equivalent to: 

  * [`std::vprint_unicode`](vprint_unicode.html "cpp/io/basic ostream/vprint unicode")(os, fmt.get(), [std::make_format_args](../../utility/format/make_format_args.html)(args...));. Otherwise, 
  * [`std::vprint_nonunicode`](vprint_nonunicode.html "cpp/io/basic ostream/vprint nonunicode")(os, fmt.get(), [std::make_format_args](../../utility/format/make_format_args.html)(args...));. 



The behavior is undefined if [std::formatter](../../utility/format/formatter.html)<Ti, char> does not meet the [BasicFormatter](../../named_req/BasicFormatter.html "cpp/named req/BasicFormatter") requirements for any `Ti` in `Args` (as required by [std::make_format_args](../../utility/format/make_format_args.html)). 
...
## Contents
  ...
  * [5 See also](print.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ostream/print&action=edit&section=1 "Edit section: Parameters")] Parameters
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ostream/print&action=edit&section=2 "Edit section: Exceptions")] Exceptions
  ...
  * May throw [ios_base::failure](../ios_base/failure.html "cpp/io/ios base/failure") caused by os.setstate(ios_base::badbit) which is called if an insertion into os fails. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ostream/print&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ostream/print&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::array](../../container/array.html)<char, 24> buf;
        [std::format_to](../../utility/format/format_to.html)(buf.begin(), "{:.15f}", [std::numbers::sqrt2](../../numeric/constants.html));
     
        unsigned num{}, sum{};
     
        for (auto n : buf
                    | std::[views::filter](../../ranges/filter_view.html)(isdigit)
                    | std::[views::transform](../../ranges/transform_view.html)([](char x) { return x - '0'; })
                    | std::[views::take_while](../../ranges/take_while_view.html)([&sum](char) { return sum < 42; }))
            sum += n, ++num;
     
        [std::stringstream](../basic_stringstream.html) stream;
     
    #ifdef __cpp_lib_print
        [std::print](../print.html)(stream,
    #else
        stream << [std::format](../../utility/format/format.html)(
    #endif
            "√2 \N{ALMOST EQUAL TO} {0}.\n"
            "The sum of its first {1} digits is {2}.",
            [std::numbers::sqrt2](../../numeric/constants.html), num, sum
        );
     
        [std::puts](../c/puts.html)(stream.str().data());
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ostream/print&action=edit&section=5 "Edit section: See also")] See also

[ println(std::ostream)](println.html "cpp/io/basic ostream/println")(C++23) |  outputs [formatted](../../utility/format.html "cpp/utility/format") representation of the arguments with appended '\n'   
