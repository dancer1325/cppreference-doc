...
If fail()==true, returns pos_type(-1). Otherwise, returns rdbuf()->pubseekoff(0, [std::ios_base::cur](../ios_base/seekdir.html), [std::ios_base::out](../ios_base/openmode.html)). 

## Contents

  * [1 Parameters](tellp.html#Parameters)
  * [2 Return value](tellp.html#Return_value)
  * [3 Example](tellp.html#Example)
  * [4 See also](tellp.html#See_also)
