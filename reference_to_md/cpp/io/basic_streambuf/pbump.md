...
Repositions the _put pointer_ ([pptr()](pptr.html "cpp/io/basic streambuf/pptr")) by count characters, where count may be positive or negative. No checks are done for moving the pointer outside the put area `[`pbase()`, `epptr()`)`. 

If the pointer is advanced and then [overflow()](overflow.html "cpp/io/basic streambuf/overflow") is called to flush the put area to the associated character sequence, the effect is that extra count characters with undefined values are output. 

## Contents

  * [1 Parameters](pbump.html#Parameters)
  * [2 Return value](pbump.html#Return_value)
  * [3 Notes](pbump.html#Notes)
  * [4 Example](pbump.html#Example)
  * [5 See also](pbump.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/pbump&action=edit&section=1 "Edit section: Parameters")] Parameters

count  |  \-  |  number to add to the put pointer   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/pbump&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/pbump&action=edit&section=3 "Edit section: Notes")] Notes

Because this function takes an int, it cannot manipulate buffers larger than [std::numeric_limits](../../types/numeric_limits.html)<int>::max() characters ([LWG issue 255](https://cplusplus.github.io/LWG/issue255)). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/pbump&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    #include <string>
     
    struct showput_streambuf : [std::filebuf](../basic_filebuf.html)
    {
        using std::filebuf::pbump; // expose protected
        [std::string](../../string/basic_string.html) showput() const
        {
            return [std::string](../../string/basic_string.html)(pbase(), pptr());
        }
    };
     
    int main()
    {
        ...
        mybuf.open("test.txt", [std::ios_base::out](../ios_base/openmode.html));
        [std::ostream](../basic_ostream.html) str(&mybuf);
        str << "This is a test" << [std::flush](../manip/flush.html) << "1234";
        [std::cout](../cout.html) << "The put area contains: " << mybuf.showput() << '\n';
        mybuf.pbump(10);
        [std::cout](../cout.html) << "after pbump(10), it contains " << mybuf.showput() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/pbump&action=edit&section=5 "Edit section: See also")] See also

[ gbump](gbump.html "cpp/io/basic streambuf/gbump") |  advances the next pointer in the input sequence   
