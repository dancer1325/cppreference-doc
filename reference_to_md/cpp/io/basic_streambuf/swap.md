...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  stream buffer to exchange contents with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/swap&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/swap&action=edit&section=3 "Edit section: Example")] Example
