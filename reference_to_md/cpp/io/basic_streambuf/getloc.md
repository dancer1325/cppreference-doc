...
The associated locale is the value supplied to [pubimbue()](pubimbue.html "cpp/io/basic streambuf/pubimbue") on the last call, or, if that function has not been called, the value of the global locale ([std::locale](../../locale/locale.html "cpp/locale/locale")) at the time of the construction of the streambuf. 
...
## Contents
  ...
  * [4 See also](getloc.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/getloc&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/getloc&action=edit&section=2 "Edit section: Return value")] Return value

The associated locale. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/getloc&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/getloc&action=edit&section=4 "Edit section: See also")] See also

[ pubimbue](pubimbue.html "cpp/io/basic streambuf/pubimbue") |  changes the associated locale and invokes imbue()   
