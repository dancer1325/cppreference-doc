...
## Contents
  ...
  * [2 Example](~basic_streambuf.html#Example)
  * [3 Defect reports](~basic_streambuf.html#Defect_reports)
  * [4 See also](~basic_streambuf.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/%7Ebasic_streambuf&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/%7Ebasic_streambuf&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::filebuf](../basic_filebuf.html)* fbp = new [std::filebuf](../basic_filebuf.html);
        fbp->open("test.txt", [std::ios_base::out](../ios_base/openmode.html));
        fbp->sputn("Hello\n", 6);
     
        [std::streambuf](../basic_streambuf.html)* sbp = fbp;
        delete sbp; // the file is closed, output flushed and written
     
        [std::ifstream](../basic_ifstream.html) f("test.txt");
        [std::cout](../cout.html) << f.rdbuf(); // proof
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/%7Ebasic_streambuf&action=edit&section=3 "Edit section: Defect reports")] Defect reports

The following behavior-changing defect reports were applied retroactively to previously published C++ standards. 

DR  | Applied to  | Behavior as published  | Correct behavior   
---|---|---|---  
[LWG 54](https://cplusplus.github.io/LWG/issue54) | C++98  | the effect of the destructor was not specified  | specified as no effect   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/%7Ebasic_streambuf&action=edit&section=4 "Edit section: See also")] See also

[ (constructor)](basic_streambuf.html "cpp/io/basic streambuf/basic streambuf") |  constructs a `basic_streambuf` object   
