...
If a putback position is available in the get area (gptr() > eback()), then decrements the next pointer ([gptr()](gptr.html "cpp/io/basic streambuf/gptr")) and returns the character it now points to. 

If a putback position is not available, then calls [pbackfail()](pbackfail.html "cpp/io/basic streambuf/pbackfail") to back up the input sequence if possible. 

The I/O stream function [`basic_istream::unget`](../basic_istream/unget.html "cpp/io/basic istream/unget") is implemented in terms of this function. 

## Contents

  * [1 Parameters](sungetc.html#Parameters)
  * [2 Return value](sungetc.html#Return_value)
  * [3 Example](sungetc.html#Example)
  * [4 See also](sungetc.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::stringstream](../basic_stringstream.html) s("abcdef"); // gptr() points to 'a'
    ...
     
        ...
        if (eof == [EOF](../c.html))
                [std::cout](../cout.html) << "Nothing to unget after 'a'\n";
    }
