...
If a putback position is available in the get area (gptr() > eback()), and the character `c` is equal to the character one position to the left of [gptr()](gptr.html "cpp/io/basic streambuf/gptr") (as determined by Traits::eq(c, gptr()[-1]), then simply decrements the next pointer ([gptr()](gptr.html "cpp/io/basic streambuf/gptr")). 
...
The I/O stream function [`basic_istream::putback`](../basic_istream/putback.html "cpp/io/basic istream/putback") is implemented in terms of this function. 

## Contents

  * [1 Parameters](sputbackc.html#Parameters)
  * [2 Return value](sputbackc.html#Return_value)
  * [3 Example](sputbackc.html#Example)
  * [4 See also](sputbackc.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/sputbackc&action=edit&section=1 "Edit section: Parameters")] Parameters

c  |  \-  |  character to put back   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/sputbackc&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/sputbackc&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::stringstream](../basic_stringstream.html) s("abcdef"); // gptr() points to 'a' in "abcdef"
        [std::cout](../cout.html) << "Before putback, string holds " << s.str() << '\n';
    ...
     
        ...
        if (eof == [EOF](../c.html))
            [std::cout](../cout.html) << "No room to putback after 'z'\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/sputbackc&action=edit&section=4 "Edit section: See also")] See also
