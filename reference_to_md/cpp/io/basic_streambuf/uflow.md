...
Ensures that at least one character is available in the input area by updating the pointers to the input area (if needed). On success returns the value of that character and advances the value of the _get pointer_ by one character. On failure returns traits::eof(). 
...
The base class version of the function calls [underflow()](underflow.html "cpp/io/basic streambuf/underflow") and increments [gptr()](gptr.html "cpp/io/basic streambuf/gptr"). 

## Contents

  * [1 Parameters](uflow.html#Parameters)
  * [2 Return value](uflow.html#Return_value)
  * [3 Note](uflow.html#Note)
  * [4 Example](uflow.html#Example)
  * [5 See also](uflow.html#See_also)
