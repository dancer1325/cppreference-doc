...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/overflow&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  the character to store in the put area   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/overflow&action=edit&section=2 "Edit section: Return value")] Return value

Traits::eof()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/overflow&action=edit&section=3 "Edit section: Implementation requirements")] Implementation requirements
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/overflow&action=edit&section=4 "Edit section: Note")] Note
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/overflow&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/overflow&action=edit&section=6 "Edit section: See also")] See also
...
(virtual protected member function of `std::strstreambuf`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/strstreambuf/dsc_overflow&action=edit)
