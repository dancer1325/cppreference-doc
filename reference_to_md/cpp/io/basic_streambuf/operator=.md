...
basic_streambuf& operator=( const basic_streambuf& other ); |  |  (since C++11)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/operator%3D&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  stream buffer to assign   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/operator%3D&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/operator%3D&action=edit&section=3 "Edit section: Example")] Example
