...
**basic_streambuf::eback basic_streambuf::gptrbasic_streambuf::egptr**  
...
2) Returns the pointer to the current character (_get pointer_) in the get area. 

3) Returns the pointer one past the end of the get area. 

## Contents

  * [1 Parameters](gptr.html#Parameters)
  * [2 Return value](gptr.html#Return_value)
  * [3 Notes](gptr.html#Notes)
  * [4 Example](gptr.html#Example)
  * [5 See also](gptr.html#See_also)
...
2) The pointer to the current character (_get pointer_) in the get area. 
