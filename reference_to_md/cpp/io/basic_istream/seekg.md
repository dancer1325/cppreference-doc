...
---|---|---  
basic_istream& seekg( off_type off, [std::ios_base::seekdir](../ios_base/seekdir.html) dir ); |  (2)  |   
| |   
...
`seekg` behaves as [UnformattedInputFunction](../../named_req/UnformattedInputFunction.html "cpp/named req/UnformattedInputFunction"), except that [gcount()](gcount.html "cpp/io/basic istream/gcount") is not affected. After constructing and checking the sentry object, 

1) if fail() != true, sets the input position indicator to absolute (relative to the beginning of the file) value pos. Specifically, executes rdbuf()->pubseekpos(pos, [std::ios_base::in](../ios_base/openmode.html)) ([`pubseekpos`](../basic_streambuf/pubseekpos.html "cpp/io/basic streambuf/pubseekpos"), in turn, calls seekpos of the specific buffer, such as [`basic_filebuf::seekpos`](../basic_filebuf/seekpos.html "cpp/io/basic filebuf/seekpos"), [`basic_stringbuf::seekpos`](../basic_stringbuf/seekpos.html "cpp/io/basic stringbuf/seekpos"), or [`strstreambuf::seekpos`](../strstreambuf/seekpos.html "cpp/io/strstreambuf/seekpos")). In case of failure, calls setstate([std::ios_base::failbit](../ios_base/iostate.html)).

2) if fail() != true, sets the input position indicator to position off, relative to position, defined by dir. Specifically, executes rdbuf()->pubseekoff(off, dir, [std::ios_base::in](../ios_base/openmode.html)). In case of failure, calls setstate([std::ios_base::failbit](../ios_base/iostate.html)).

## Contents

  * [1 Parameters](seekg.html#Parameters)
  * [2 Return value](seekg.html#Return_value)
  * [3 Exceptions](seekg.html#Exceptions)
  * [4 Notes](seekg.html#Notes)
  * [5 Example](seekg.html#Example)
  * [6 Defect reports](seekg.html#Defect_reports)
  * [7 See also](seekg.html#See_also)
...
seekg(n) is not necessarily equivalent to seekg(n, ios::beg). [std::basic_ifstream](../basic_ifstream.html), for example, requires the absolute position n to come from [tellg()](tellg.html "cpp/io/basic istream/tellg"). 
...
Run this code
    ...
    int main()
    {
        ...
        [std::string](../../string/basic_string.html) word1, word2;
     
        in >> word1;
        in.seekg(0); // rewind
        in >> word2;
...
[LWG 136](https://cplusplus.github.io/LWG/issue136) | C++98  | `seekg` could set the output stream  | only sets the input stream   
[LWG 537](https://cplusplus.github.io/LWG/issue537) | C++98  | the type of off was `off_type&` | corrected to `off_type`  
  
### See also

[ tellg](tellg.html "cpp/io/basic istream/tellg") |  returns the input position indicator   
