...
---|---|---  
basic_istream& getline( char_type* s, [std::streamsize](../streamsize.html) count, char_type delim ); |  (2)  |   
| |   
...
Behaves as [UnformattedInputFunction](../../named_req/UnformattedInputFunction.html "cpp/named req/UnformattedInputFunction"). After constructing and checking the sentry object, extracts characters from *this and stores them in successive locations of the array whose first element is pointed to by s, until any of the following occurs (tested in the order shown): 
  ...
  2. the next available character c is the delimiter, as determined by Traits::eq(c, delim). The delimiter is extracted (unlike [`basic_istream::get()`](get.html "cpp/io/basic istream/get")) and counted towards [gcount()](gcount.html "cpp/io/basic istream/gcount"), but is not stored. 
  3. count is non-positive, or count - 1 characters have been extracted (setstate(failbit) is called in this case). 



If the function extracts no characters, ​`failbit` is set in the local error state before [`setstate()`](../basic_ios/setstate.html "cpp/io/basic ios/setstate") is called. 

In any case, if count > 0, it then stores a null character CharT() into the next successive location of the array and updates [gcount()](gcount.html "cpp/io/basic istream/gcount"). 

## Contents

  * [1 Notes](getline.html#Notes)
  * [2 Parameters](getline.html#Parameters)
  * [3 Return value](getline.html#Return_value)
  * [4 Exceptions](getline.html#Exceptions)
  * [5 Example](getline.html#Example)
  * [6 Defect reports](getline.html#Defect_reports)
  * [7 See also](getline.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::istringstream](../basic_istringstream.html) input("abc|def|gh");
        [std::vector](../../container/vector.html)<[std::array](../../container/array.html)<char, 4>> v;
     
        // note: the following loop terminates when std::ios_base::operator bool()
        // on the stream returned from getline() returns false
        for ([std::array](../../container/array.html)<char, 4> a; input.getline(&a[0], 4, '|');)
            v.push_back(a);
     
        for (auto& a : v)
            [std::cout](../cout.html) << &a[0] << '\n';
    }
...
---|---|---|---  
[LWG 531](https://cplusplus.github.io/LWG/issue531) | C++98  | `std::getline` could not handle the  
