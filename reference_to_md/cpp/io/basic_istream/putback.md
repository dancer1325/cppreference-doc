...
First clears `eofbit`, then behaves as [UnformattedInputFunction](../../named_req/UnformattedInputFunction.html "cpp/named req/UnformattedInputFunction"). After constructing and checking the sentry object, if [`rdbuf()`](../basic_ios/rdbuf.html "cpp/io/basic ios/rdbuf") is not null, calls rdbuf()->sputbackc(ch), which calls rdbuf()->pbackfail(ch) if ch does not equal the most recently extracted character. 

If `rdbuf()` is null or if rdbuf->sputbackc(ch) returns Traits::eof(), calls setstate(badbit). 

In any case, sets the [`gcount()`](gcount.html "cpp/io/basic istream/gcount") counter to zero. 

## Contents

  * [1 Parameters](putback.html#Parameters)
  * [2 Return value](putback.html#Return_value)
  * [3 Exceptions](putback.html#Exceptions)
  * [4 Example](putback.html#Example)
  * [5 Defect reports](putback.html#Defect_reports)
  * [6 See also](putback.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::stringstream](../basic_stringstream.html) s1("Hello, world"); // IO stream
        s1.get();
        if (s1.putback('Y')) // modifies the buffer
            [std::cout](../cout.html) << s1.rdbuf() << '\n';
        else
            [std::cout](../cout.html) << "putback failed\n";
     
        [std::cout](../cout.html) << "--\n";
     
        [std::istringstream](../basic_istringstream.html) s2("Hello, world"); // input-only stream
        s2.get();
        if (s2.putback('Y')) // cannot modify input-only buffer
            [std::cout](../cout.html) << s2.rdbuf() << '\n';
        else
            [std::cout](../cout.html) << "putback failed\n"; 
        s2.clear();
     
