...
Behaves as [UnformattedInputFunction](../../named_req/UnformattedInputFunction.html "cpp/named req/UnformattedInputFunction"). After constructing and checking the sentry object, extracts characters and stores them into successive locations of the character array whose first element is pointed to by s. Characters are extracted and stored until any of the following conditions occurs: 
  ...
  * end of file condition occurs on the input sequence (in which case, setstate(failbit|eofbit) is called). The number of successfully extracted characters can be queried using [`gcount()`](gcount.html "cpp/io/basic istream/gcount"). 



## Contents

  * [1 Parameters](read.html#Parameters)
  * [2 Return value](read.html#Return_value)
  * [3 Exceptions](read.html#Exceptions)
  * [4 Notes](read.html#Notes)
  * [5 Example](read.html#Example)
  * [6 See also](read.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        [std::string](../../string/basic_string.html) bin = {'\x12', '\x12', '\x12', '\x12'};
        [std::istringstream](../basic_istringstream.html) raw(bin);
        [std::uint32_t](../../types/integer.html) n;
        if (raw.read(reinterpret_cast<char*>(&n), sizeof n))
            [std::cout](../cout.html) << [std::hex](../manip/hex.html) << [std::showbase](../manip/showbase.html) << n << '\n';
     
        // prepare file for next snippet
        [std::ofstream](../basic_ofstream.html)("test.txt", std::ios::binary) << "abcd1\nabcd2\nabcd3";
     
        // read entire file into string
        if ([std::ifstream](../basic_ifstream.html) is{"test.txt", std::ios::binary | std::ios::ate})
        {
            auto size = is.tellg();
            [std::string](../../string/basic_string.html) str(size, '\0'); // construct string to stream size
            is.seekg(0);
            if (is.read(&str[0], size))
                [std::cout](../cout.html) << str << '\n';
        }
    }
