...
Calls [`emit()`](emit.html "cpp/io/basic syncbuf/emit") to transmit all pending output (and delayed flush, if any) to the wrapped stream. If an exception is thrown by this call, it is caught and ignored. 

## Contents

  * [1 Parameters](~basic_syncbuf.html#Parameters)
  * [2 Notes](~basic_syncbuf.html#Notes)
  * [3 Example](~basic_syncbuf.html#Example)
  * [4 See also](~basic_syncbuf.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_syncbuf/%7Ebasic_syncbuf&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_syncbuf/%7Ebasic_syncbuf&action=edit&section=2 "Edit section: Notes")] Notes

Normally called by the destructor of the owning std::basic_osyncstream. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_syncbuf/%7Ebasic_syncbuf&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_syncbuf/%7Ebasic_syncbuf&action=edit&section=4 "Edit section: See also")] See also
