...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_syncbuf/swap&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  sync stream buffer to exchange contents with   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_syncbuf/swap&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_syncbuf/swap&action=edit&section=3 "Edit section: Example")] Example
