...
[std::span](../../container/span.html)<const CharT> span() const noexcept; |  (1)  |  (since C++23)  
---|---|---  
void span( [std::span](../../container/span.html)<CharT> s ) noexcept; |  (2)  |  (since C++23)  
template< class SpanLike >  
void span( SpanLike&& r ) noexcept; |  (3)  |  (since C++23)  
| |   
...
[std::span](../../container/span.html)<const CharT> cs{[std::forward](../../utility/forward.html)<SpanLike>(r)};  
[std::span](../../container/span.html)<CharT> s{const_cast<CharT*>(cs.data()), cs.size()};  
. This overload participates in overload resolution only if `SpanLike` models [`borrowed_range`](../../ranges/borrowed_range.html "cpp/ranges/borrowed range"), [std::convertible_to](../../concepts/convertible_to.html)<SpanLike, [std::span](../../container/span.html)<CharT>> is false, and [std::convertible_to](../../concepts/convertible_to.html)<SpanLike, [std::span](../../container/span.html)<const CharT>> is true.
...
---|---|---  
r  |  \-  |  [`borrowed_range`](../../ranges/borrowed_range.html "cpp/ranges/borrowed range") to be use as the new underlying buffer of stream   
