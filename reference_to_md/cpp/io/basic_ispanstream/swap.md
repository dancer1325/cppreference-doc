...
This is done by calling [std::basic_istream](../basic_istream.html)<CharT, Traits>::swap(other) and swapping the wrapped std::basic_spanbuf objects (accessible through *rdbuf()). 
