...
void swap( [std::basic_ispanstream](../basic_ispanstream.html)<CharT, Traits>& lhs,  
[std::basic_ispanstream](../basic_ispanstream.html)<CharT, Traits>& rhs ); |  |  (since C++23)  
| |   
  
Overloads the [std::swap](../../utility/swap.html "cpp/algorithm/swap") algorithm for std::basic_ispanstream. Exchanges the state of lhs with that of rhs. Effectively calls lhs.swap(rhs). 
...
[ swap](swap.html "cpp/io/basic ispanstream/swap") |  swaps two `basic_ispanstream` objects   
