...
---  
[basic_spanstream::basic_spanstream](basic_spanstream/basic_spanstream.html "cpp/io/basic spanstream/basic spanstream")  
[basic_spanstream::operator=](basic_spanstream/operator=.html "cpp/io/basic spanstream/operator=")  
[basic_spanstream::swap](basic_spanstream/swap.html "cpp/io/basic spanstream/swap")  
[basic_spanstream::rdbuf](basic_spanstream/rdbuf.html "cpp/io/basic spanstream/rdbuf")  
[Underlying buffer operations](basic_spanstream.html#Underlying_buffer_operations "cpp/io/basic spanstream")  
[basic_spanstream::span](basic_spanstream/span.html "cpp/io/basic spanstream/span")  
[Non-member functions](basic_spanstream.html#Non-member_functions "cpp/io/basic spanstream")  
[swap(std::basic_spanstream)](basic_spanstream/swap2.html "cpp/io/basic spanstream/swap2")  
  
[[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_spanstream/navbar_content&action=edit)
...
: public basic_iostream<CharT, Traits> |  |  (since C++23)  
| |   
  
The class template `std::basic_spanstream` implements input and output operations on streams based on fixed buffers. 

At the low level, the class essentially wraps a raw device implementation of std::basic_spanbuf into a higher-level interface of [std::basic_iostream](basic_iostream.html "cpp/io/basic iostream"). The complete interface to unique std::basic_spanbuf members is provided. 

![std-basic spanstream-inheritance.svg](https://upload.cppreference.com/mwiki/images/8/84/std-basic_spanstream-inheritance.svg)
...
## Contents
  ...
  * [1 Member types](basic_spanstream.html#Member_types)
  * [2 Data members](basic_spanstream.html#Data_members)
  * [3 Member functions](basic_spanstream.html#Member_functions)
    * [3.1 Underlying buffer operations](basic_spanstream.html#Underlying_buffer_operations)
  * [4 Non-member functions](basic_spanstream.html#Non-member_functions)
  * [5 Inherited from std::basic_istream](basic_spanstream.html#Inherited_from_std::basic_istream)
    * [5.1 Member functions](basic_spanstream.html#Member_functions_2)
      * [5.1.1 Formatted input](basic_spanstream.html#Formatted_input)
      * [5.1.2 Unformatted input](basic_spanstream.html#Unformatted_input)
      * [5.1.3 Positioning](basic_spanstream.html#Positioning)
      * [5.1.4 Miscellaneous](basic_spanstream.html#Miscellaneous)
    * [5.2 Member classes](basic_spanstream.html#Member_classes)
  * [6 Inherited from std::basic_ostream](basic_spanstream.html#Inherited_from_std::basic_ostream)
    * [6.1 Member functions](basic_spanstream.html#Member_functions_3)
      * [6.1.1 Formatted output](basic_spanstream.html#Formatted_output)
      * [6.1.2 Unformatted output](basic_spanstream.html#Unformatted_output)
      * [6.1.3 Positioning](basic_spanstream.html#Positioning_2)
      * [6.1.4 Miscellaneous](basic_spanstream.html#Miscellaneous_2)
    * [6.2 Member classes](basic_spanstream.html#Member_classes_2)
  * [7 Inherited from std::basic_ios](basic_spanstream.html#Inherited_from_std::basic_ios)
    * [7.1 Member types](basic_spanstream.html#Member_types_2)
    * [7.2 Member functions](basic_spanstream.html#Member_functions_4)
      * [7.2.1 State functions](basic_spanstream.html#State_functions)
      * [7.2.2 Formatting](basic_spanstream.html#Formatting)
      * [7.2.3 Miscellaneous](basic_spanstream.html#Miscellaneous_3)
  * [8 Inherited from std::ios_base](basic_spanstream.html#Inherited_from_std::ios_base)
    * [8.1 Member functions](basic_spanstream.html#Member_functions_5)
      * [8.1.1 Formatting](basic_spanstream.html#Formatting_2)
      * [8.1.2 Locales](basic_spanstream.html#Locales)
      * [8.1.3 Internal extensible array](basic_spanstream.html#Internal_extensible_array)
      * [8.1.4 Miscellaneous](basic_spanstream.html#Miscellaneous_4)
      * [8.1.5 Member classes](basic_spanstream.html#Member_classes_3)
    * [8.2 Member types and constants](basic_spanstream.html#Member_types_and_constants)
    * [8.3 Notes](basic_spanstream.html#Notes)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_spanstream&action=edit&section=1 "Edit section: Data members")] Data members

Member name  |  Definition   
---|---  
`_sb_` (private) |  The wrapped std::basic_spanbuf.  
(exposition-only member object*)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_spanstream&action=edit&section=2 "Edit section: Member functions")] Member functions
...
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_spanstream/dsc_constructor&action=edit)  
---|---  
**(destructor)**[virtual] |  destroys the `basic_spanstream`   
(virtual public member function)  
[ operator=](basic_spanstream/operator=.html "cpp/io/basic spanstream/operator=") |  move-assignments the `basic_spanstream`   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_spanstream/dsc_operator%3D&action=edit)  
[ swap](basic_spanstream/swap.html "cpp/io/basic spanstream/swap") |  swaps two `basic_spanstream` objects   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_spanstream/dsc_swap&action=edit)  
[ rdbuf](basic_spanstream/rdbuf.html "cpp/io/basic spanstream/rdbuf") |  obtains the address of the wrapped raw `span` device object   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_spanstream/dsc_rdbuf&action=edit)  
  
#####  Underlying buffer operations   
  
[ span](basic_spanstream/span.html "cpp/io/basic spanstream/span") |  gets or sets the underlying buffer of the wrapped `span` device object   
(public member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/basic_spanstream/dsc_span&action=edit)  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_spanstream&action=edit&section=3 "Edit section: Non-member functions")] Non-member functions

[ std::swap(std::basic_spanstream)](basic_spanstream/swap2.html "cpp/io/basic spanstream/swap2")(C++23) |  specializes the [std::swap](../utility/swap.html "cpp/algorithm/swap") algorithm   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_spanstream&action=edit&section=4 "Edit section: Notes")] Notes

[Feature-test](../utility/feature_test.html "cpp/utility/feature test") macro | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_spanstream`](../experimental/feature_test.html#cpp_lib_spanstream "cpp/feature test") | [`202106L`](../compiler_support/23.html#cpp_lib_spanstream_202106L "cpp/compiler support/23") | (C++23) | std::spanbuf, [`std::spanstream`](basic_spanstream.html#top)
