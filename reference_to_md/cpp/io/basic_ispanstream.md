...
---  
[basic_ispanstream::basic_ispanstream](basic_ispanstream/basic_ispanstream.html "cpp/io/basic ispanstream/basic ispanstream")  
[basic_ispanstream::operator=](basic_ispanstream/operator=.html "cpp/io/basic ispanstream/operator=")  
[basic_ispanstream::swap](basic_ispanstream/swap.html "cpp/io/basic ispanstream/swap")  
[basic_ispanstream::rdbuf](basic_ispanstream/rdbuf.html "cpp/io/basic ispanstream/rdbuf")  
[Underlying buffer operations](basic_ispanstream.html#Underlying_buffer_operations "cpp/io/basic ispanstream")  
[basic_ispanstream::span](basic_ispanstream/span.html "cpp/io/basic ispanstream/span")  
[Non-member functions](basic_ispanstream.html#Non-member_functions "cpp/io/basic ispanstream")  
[swap(std::basic_ipanstream)](basic_ispanstream/swap2.html "cpp/io/basic ispanstream/swap2")  
...
: public basic_istream<CharT, Traits> |  |  (since C++23)  
| |   
  
The class template `std::basic_ispanstream` implements input operations on streams based on fixed buffers. 

At the low level, the class essentially wraps a raw device implementation of std::basic_spanbuf into a higher-level interface of [std::basic_istream](basic_istream.html "cpp/io/basic istream"). The complete interface to unique std::basic_spanbuf members is provided. 

![std-basic ispanstream-inheritance.svg](https://upload.cppreference.com/mwiki/images/e/e9/std-basic_ispanstream-inheritance.svg)
...
## Contents
  ...
  * [1 Member types](basic_ispanstream.html#Member_types)
  * [2 Data members](basic_ispanstream.html#Data_members)
  * [3 Member functions](basic_ispanstream.html#Member_functions)
    * [3.1 Underlying buffer operations](basic_ispanstream.html#Underlying_buffer_operations)
  * [4 Non-member functions](basic_ispanstream.html#Non-member_functions)
  * [5 Inherited from std::basic_istream](basic_ispanstream.html#Inherited_from_std::basic_istream)
    * [5.1 Member functions](basic_ispanstream.html#Member_functions_2)
      * [5.1.1 Formatted input](basic_ispanstream.html#Formatted_input)
      * [5.1.2 Unformatted input](basic_ispanstream.html#Unformatted_input)
      * [5.1.3 Positioning](basic_ispanstream.html#Positioning)
      * [5.1.4 Miscellaneous](basic_ispanstream.html#Miscellaneous)
    * [5.2 Member classes](basic_ispanstream.html#Member_classes)
  * [6 Inherited from std::basic_ios](basic_ispanstream.html#Inherited_from_std::basic_ios)
    * [6.1 Member types](basic_ispanstream.html#Member_types_2)
    * [6.2 Member functions](basic_ispanstream.html#Member_functions_3)
      * [6.2.1 State functions](basic_ispanstream.html#State_functions)
      * [6.2.2 Formatting](basic_ispanstream.html#Formatting)
      * [6.2.3 Miscellaneous](basic_ispanstream.html#Miscellaneous_2)
  * [7 Inherited from std::ios_base](basic_ispanstream.html#Inherited_from_std::ios_base)
    * [7.1 Member functions](basic_ispanstream.html#Member_functions_4)
      * [7.1.1 Formatting](basic_ispanstream.html#Formatting_2)
      * [7.1.2 Locales](basic_ispanstream.html#Locales)
      * [7.1.3 Internal extensible array](basic_ispanstream.html#Internal_extensible_array)
      * [7.1.4 Miscellaneous](basic_ispanstream.html#Miscellaneous_3)
      * [7.1.5 Member classes](basic_ispanstream.html#Member_classes_2)
    * [7.2 Member types and constants](basic_ispanstream.html#Member_types_and_constants)
    * [7.3 Notes](basic_ispanstream.html#Notes)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ispanstream&action=edit&section=1 "Edit section: Data members")] Data members
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ispanstream&action=edit&section=2 "Edit section: Member functions")] Member functions
...
---|---  
**(destructor)**[virtual] |  destroys the `basic_ispanstream`   
(virtual public member function)  
[ operator=](basic_ispanstream/operator=.html "cpp/io/basic ispanstream/operator=") |  move-assignments the `basic_ispanstream`   
...
[ swap](basic_ispanstream/swap.html "cpp/io/basic ispanstream/swap") |  swaps two `basic_ispanstream` objects   
...
[ rdbuf](basic_ispanstream/rdbuf.html "cpp/io/basic ispanstream/rdbuf") |  obtains the address of the wrapped raw `span` device object   
...
[ span](basic_ispanstream/span.html "cpp/io/basic ispanstream/span") |  gets or sets the underlying buffer of the wrapped `span` device object   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ispanstream&action=edit&section=3 "Edit section: Non-member functions")] Non-member functions

[ std::swap(std::basic_ispanstream)](basic_ispanstream/swap2.html "cpp/io/basic ispanstream/swap2")(C++23) |  specializes the [std::swap](../utility/swap.html "cpp/algorithm/swap") algorithm   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ispanstream&action=edit&section=4 "Edit section: Notes")] Notes
