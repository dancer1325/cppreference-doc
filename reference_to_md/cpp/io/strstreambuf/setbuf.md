...
## Contents
  ...
  * [3 Example](setbuf.html#Example)
  * [4 Defect reports](setbuf.html#Defect_reports)
...
Run this code
    ...
    {
        char a[100] = {};
        [std::strstream](../strstream.html) str;
        str.rdbuf()->pubsetbuf(a, sizeof a);
        str << "Test string" << [std::ends](../manip/ends.html);
        [std::cout](../cout.html) << "user-provided buffer holds \"" << a << "\"\n";
    }
...
---|---|---|---  
[LWG 66](https://cplusplus.github.io/LWG/issue66) | C++98  | the effect of `setbuf()` was "performs an operation that is  
