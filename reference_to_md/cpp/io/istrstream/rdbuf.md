[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/io/strstream/rdbuf&action=edit)
...
Run this code
    ...
    int main()
    {
        const [std::istrstream](../istrstream.html) buf("example");
        [std::strstreambuf](../strstreambuf.html)* ptr = buf.rdbuf();
    }
