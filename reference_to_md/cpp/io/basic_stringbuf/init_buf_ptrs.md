...
Initializes the input and output sequences from buf according to mode. buf and mode are [exposition-only data members](../basic_stringbuf.html#Exposition-only_members "cpp/io/basic stringbuf") of *this. 

Immediately after this function returns: 

  * If [std::ios_base::out](../ios_base/openmode.html "cpp/io/ios base/openmode") is set in mode, [`pbase()`](../basic_streambuf/pptr.html "cpp/io/basic streambuf/pptr") points to buf.front() and epptr() >= pbase() + buf.size() is true; 
    * in addition, if [std::ios_base::ate](../ios_base/openmode.html "cpp/io/ios base/openmode") is set in mode, pptr() == pbase() + buf.size() is true, 
    * otherwise pptr() == pbase() is true. 
  * If [std::ios_base::in](../ios_base/openmode.html "cpp/io/ios base/openmode") is set in mode, [`eback()`](../basic_streambuf/gptr.html "cpp/io/basic streambuf/gptr") points to buf.front(), and gptr() == eback() && egptr() == eback() + buf.size() is true. 
...
---|---|---|---  
[LWG 1448](https://cplusplus.github.io/LWG/issue1448) | C++98  | calling `_init_buf_ptrs_()` made  
pptr() == pbase() + buf.data()  
