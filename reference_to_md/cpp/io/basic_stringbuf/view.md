...
Creates and returns a [std::basic_string_view](../../string/basic_string_view.html "cpp/string/basic string view") over the underlying character sequence. 
