...
| (1) |   
---|---|---  
explicit basic_istringstream( [std::ios_base::openmode](../ios_base/openmode.html) mode =  
[std::ios_base::in](../ios_base/openmode.html) ); |  | (until C++11)  
explicit basic_istringstream( [std::ios_base::openmode](../ios_base/openmode.html) mode ); |  |  (since C++11)  
basic_istringstream()  
: basic_istringstream([std::ios_base::in](../ios_base/openmode.html)) {} |  (2)  |  (since C++11)  
...
[std::ios_base::in](../ios_base/openmode.html) ); |  (3)  |   
explicit basic_istringstream  
( [std::basic_string](../../string/basic_string.html)<CharT, Traits, Allocator>&& str,  
[std::ios_base::openmode](../ios_base/openmode.html) mode =  
[std::ios_base::in](../ios_base/openmode.html) ); |  (4)  |  (since C++20)  
basic_istringstream( [std::ios_base::openmode](../ios_base/openmode.html) mode, const Allocator& a ); |  (5)  |  (since C++20)  
template< class SAlloc >  
basic_istringstream( const [std::basic_string](../../string/basic_string.html)<CharT, Traits, SAlloc>& str,  
[std::ios_base::openmode](../ios_base/openmode.html) mode, const Allocator& a ); |  (6)  |  (since C++20)  
template< class SAlloc >  
basic_istringstream( const [std::basic_string](../../string/basic_string.html)<CharT, Traits, SAlloc>& str,  
const Allocator& a )  
: basic_istringstream(str, [std::ios_base::in](../ios_base/openmode.html), a) {} |  (7)  |  (since C++20)  
template< class SAlloc >  
explicit basic_istringstream  
( const [std::basic_string](../../string/basic_string.html)<CharT, Traits, SAlloc>& str,  
[std::ios_base::openmode](../ios_base/openmode.html) mode =  
[std::ios_base::in](../ios_base/openmode.html) ); |  (8)  |  (since C++20)  
template< class StringViewLike >  
explicit basic_istringstream  
( const StringViewLike& t,  
[std::ios_base::openmode](../ios_base/openmode.html) mode =  
[std::ios_base::in](../ios_base/openmode.html) ); |  (9) | (since C++26)  
template< class StringViewLike >  
...
template< class StringViewLike >  
basic_istringstream( const StringViewLike& t, const Allocator& a ); |  (11)  |  (since C++26)  
...
Given 
  ...
  * `base_type` as [std::basic_istream](../basic_istream.html)<CharT, Traits>, and 
  * `buf_type` as [std::basic_stringbuf](../basic_stringbuf.html)<CharT, Traits, Allocator>, 



the [std::basic_istream](../basic_istream.html "cpp/io/basic istream") base and the [exposition-only data member](../basic_istringstream.html#Exposition-only_members "cpp/io/basic istringstream") `_sb_` are initialized as follows. 

Over  
load  | [std::basic_istream](../basic_istream.html "cpp/io/basic istream") base  | `_sb_`  
---|---|---  
(1) | base_type([std::addressof](../../memory/addressof.html)(sb))[[1]](basic_istringstream.html#cite_note-1) | buf_type(mode | [std::ios_base::in](../ios_base/openmode.html))  
(2) | buf_type([std::ios_base::in](../ios_base/openmode.html))  
(3) | buf_type(str, mode | [std::ios_base::in](../ios_base/openmode.html))  
(4) | buf_type(std::move(str), mode | [std::ios_base::in](../ios_base/openmode.html))  
(5) | buf_type(mode | [std::ios_base::in](../ios_base/openmode.html), a)  
(6) | buf_type(str, mode | [std::ios_base::in](../ios_base/openmode.html), a)  
(7) | buf_type(str, [std::ios_base::in](../ios_base/openmode.html), a)  
(8) | buf_type(str, mode | [std::ios_base::in](../ios_base/openmode.html))  
(9) | [std::addressof](../../memory/addressof.html)(sb) | {t, mode | [std::ios_base::in](../ios_base/openmode.html), Allocator()}  
(10) | {t, mode | [std::ios_base::in](../ios_base/openmode.html), a}  
(11) | {t, [std::ios_base::in](../ios_base/openmode.html), a}  
(12) | move constructed from other's [std::basic_istream](../basic_istream.html "cpp/io/basic istream") base  | move constructed from other.sb  
  
  1. [↑](basic_istringstream.html#cite_ref-1) The [std::basic_iostream](../basic_iostream.html "cpp/io/basic iostream") base was intialized with base_type(&sb) (for overloads (1,3)) until C++11.
...
## Contents
  ...
  * [1 Parameters](basic_istringstream.html#Parameters)
  * [2 Notes](basic_istringstream.html#Notes)
  * [3 Example](basic_istringstream.html#Example)
  * [4 Defect reports](basic_istringstream.html#Defect_reports)
  * [5 See also](basic_istringstream.html#See_also)
...
Construction of one-off `basic_istringstream` objects in a tight loop, such as when used for string conversion, may be significantly more costly than calling [str()](str.html "cpp/io/basic istringstream/str") to reuse the same object. 

[Feature-test](../../utility/feature_test.html "cpp/utility/feature test") macro  | Value | Std | Feature   
---|---|---|---  
[`__cpp_lib_sstream_from_string_view`](../../experimental/feature_test.html#cpp_lib_sstream_from_string_view "cpp/feature test") | [`202306L`](../../compiler_support/26.html#cpp_lib_sstream_from_string_view_202306L "cpp/compiler support/26") | (C++26) | Interfacing [std::stringstream](../basic_stringstream.html "cpp/io/basic stringstream")s with [std::string_view](../../string/basic_string_view.html "cpp/string/basic string view"), ([9-11](basic_istringstream.html#Version_9))  
...
[ str](str.html "cpp/io/basic istringstream/str") |  gets or sets the contents of underlying string device object   
