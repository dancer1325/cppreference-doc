...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error&action=edit&section=1 "Edit section: Exception handling")] Exception handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error&action=edit&section=2 "Edit section: Exception categories")] Exception categories
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error&action=edit&section=3 "Edit section: Error numbers")] Error numbers
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error&action=edit&section=4 "Edit section: System error \(since C++11\)")] System error (since C++11)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error&action=edit&section=5 "Edit section: Assertions")] Assertions
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error&action=edit&section=6 "Edit section: Stacktrace \(since C++23\)")] [Stacktrace](utility/basic_stacktrace.html "cpp/utility/basic stacktrace") (since C++23)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error&action=edit&section=7 "Edit section: Debugging support \(since C++26\)")] Debugging support (since C++26)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/error&action=edit&section=8 "Edit section: See also")] See also
