...
requires ([std::indirectly_swappable](../../../iterator/indirectly_swappable.html)<  
[ranges::iterator_t](../../iterator_t.html)</*maybe-const*/<Const, First>>> and ... and  
[std::indirectly_swappable](../../../iterator/indirectly_swappable.html)<[ranges::iterator_t](../../iterator_t.html)</*maybe-const*/<Const, Vs>>>); |  |  (since C++23)  
---|---|---  
| |   
  
Applies [ranges::iter_swap](../../../iterator/ranges/iter_swap.html) to the stored underlying iterators. Formally, for every integer 0 ≤ i ≤ sizeof...(Vs), performs [ranges::iter_swap](../../../iterator/ranges/iter_swap.html)(std::get<i>(x.current_), std::get<i>(y.current_)), where [`_current__`](../iterator.html#Data_members "cpp/ranges/cartesian product view/iterator") is the underlying tuple of iterators. 
