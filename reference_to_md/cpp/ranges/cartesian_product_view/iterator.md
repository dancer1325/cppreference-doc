...
The return type of [`cartesian_product_view::begin`](begin.html "cpp/ranges/cartesian product view/begin"), and of [`cartesian_product_view::end`](end.html "cpp/ranges/cartesian product view/end") when the underlying view `V` is a [`common_range`](../common_range.html "cpp/ranges/common range"). 
...
Member  |  Definition   
---|---  
`_Parent_` (private) |  `_[maybe-const](../../ranges.html#maybe-const "cpp/ranges")_` ﻿<Const, [ranges::cartesian_product_view](../cartesian_product_view.html)>>  
(exposition-only member type*)  
`iterator_category` |  [std::input_iterator_tag](../../iterator/iterator_tags.html)  
`iterator_concept` | 

  * [std::random_access_iterator_tag](../../iterator/iterator_tags.html "cpp/iterator/iterator tags"), if /*cartesian-product-is-random-access*/<Const, First, Vs...> is modeled, 
  * [std::bidirectional_iterator_tag](../../iterator/iterator_tags.html "cpp/iterator/iterator tags"), if /*cartesian-product-is-bidirectional*/<Const, First, Vs...> is modeled, 
  * [std::forward_iterator_tag](../../iterator/iterator_tags.html "cpp/iterator/iterator tags"), if `_[maybe-const](../../ranges.html#maybe-const "cpp/ranges")_` ﻿<Const, First> models [`forward_range`](../forward_range.html "cpp/ranges/forward range"), 
  * [std::input_iterator_tag](../../iterator/iterator_tags.html "cpp/iterator/iterator tags"), otherwise. 

  
`value_type` |  [std::tuple](../../utility/tuple.html)<[ranges::range_value_t](../range_size_t.html)</*maybe-const*/<Const, First>>,  
[ranges::range_value_t](../range_size_t.html)</*maybe-const*/<Const, Vs>>...>;  
`reference` |  [std::tuple](../../utility/tuple.html)<[ranges::range_reference_t](../range_reference_t.html)</*maybe-const*/<Const, First>>,  
...
Member  |  Definition   
---|---  
`_Parent*_` `_parent__` (private) |  A pointer to the parent object [`cartesian_product_view`](cartesian_product_view.html "cpp/ranges/cartesian product view/cartesian product view")  
(exposition-only member object*)  
`_current__` (private) |  A tuple of iterators to the current underlying elements of type [std::tuple](../../utility/tuple.html)<[ranges::iterator_t](../iterator_t.html)</*maybe-const*/<Const, First>>,  
...
---|---  
[ operator*](iterator/operator*.html "cpp/ranges/cartesian product view/iterator/operator*") |  accesses the element   
(public member function)  
...
(function)  
---|---  
[ operator+operator-](iterator/operator_arith2.html "cpp/ranges/cartesian product view/iterator/operator arith2")(C++23) |  performs iterator arithmetic   
(function)  
[ iter_move](iterator/iter_move.html "cpp/ranges/cartesian product view/iterator/iter move")(C++23) |  casts the result of dereferencing the underlying iterator to its associated rvalue reference type   
(function)  
