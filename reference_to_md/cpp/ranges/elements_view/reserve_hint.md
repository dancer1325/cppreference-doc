...
**elements_view::reserve_hint**(C++26)  
...
Equivalent to return ranges::reserve_hint(`_[base_](../elements_view.html#base "cpp/ranges/elements view")_` ﻿);
...
[ size](size.html "cpp/ranges/elements view/size") |  returns the number of elements, provided only if the underlying (adapted) range satisfies [`sized_range`](../sized_range.html "cpp/ranges/sized range")   
