...
The return type of [`elements_view::end`](end.html "cpp/ranges/elements view/end") when the underlying view is not a [`common_range`](../common_range.html "cpp/ranges/common range"). 
