...
Increments or decrements `_[begin_](../subrange.html#begin "cpp/ranges/subrange")_` ﻿: 

  * If `I` models [`bidirectional_iterator`](../../iterator/bidirectional_iterator.html "cpp/iterator/bidirectional iterator") and n < 0 is true, decrements `_[begin_](../subrange.html#begin "cpp/ranges/subrange")_` by -n elements. 



     Equivalent to: [ranges::advance](../../iterator/ranges/advance.html)(`_[begin_](../subrange.html#begin "cpp/ranges/subrange")_` ﻿, n);  
if constexpr (`_[StoreSize](../subrange.html#StoreSize "cpp/ranges/subrange")_` ﻿)  
` `` _[size_](../subrange.html#size "cpp/ranges/subrange")_`` `+=` `` _[to-unsigned-like](../../ranges.html#to-unsigned-like "cpp/ranges")_` ﻿(-n);  
return *this;. 

  * Otherwise, increments `_[begin_](../subrange.html#begin "cpp/ranges/subrange")_` by n elements, or until `_[end_](../subrange.html#end "cpp/ranges/subrange")_` is reached. 



     Equivalent to: auto d = n - [ranges::advance](../../iterator/ranges/advance.html)(`_[begin_](../subrange.html#begin "cpp/ranges/subrange")_` ﻿, n,` `` _[end_](../subrange.html#end "cpp/ranges/subrange")_` ﻿);  
if constexpr (`_[StoreSize](../subrange.html#StoreSize "cpp/ranges/subrange")_` ﻿)  
` `` _[size_](../subrange.html#size "cpp/ranges/subrange")_`` `-=` `` _[to-unsigned-like](../../ranges.html#to-unsigned-like "cpp/ranges")_` ﻿(d);  
return *this;. 

  
According to the preconditions of [ranges::advance](../../iterator/ranges/advance.html "cpp/iterator/ranges/advance"), if n < 0 is true and `_[begin_](../subrange.html#begin "cpp/ranges/subrange")_` cannot be decremented by -n elements, the behavior is undefined. 
...
## Contents
  ...
  * [4 Defect reports](advance.html#Defect_reports)
  * [5 See also](advance.html#See_also)
...
Run this code
    ...
    {
        [std::cout](../../io/cout.html) << name << ".size() == " << sub.size() << "; { ";
        std::[ranges::for_each](../../algorithm/ranges/for_each.html)(sub, [](int x) { [std::cout](../../io/cout.html) << x << ' '; });
    ...
    int main()
    {
        ...
        std::[ranges::subrange](../subrange.html) sub{[std::next](../../iterator/next.html)(arr.begin()), [std::prev](../../iterator/prev.html)(arr.end())};
        print("1) sub", sub);
