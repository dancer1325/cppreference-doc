...
requires (!/*StoreSize*/); |  (2)  |  (since C++20)  
constexpr subrange( /*convertible-to-non-slicing*/<I> auto i, S s,  
/*make-unsigned-like-t*/<[std::iter_difference_t](../../iterator/iter_t.html)<I>> n )  
requires (K == ranges::subrange_kind::sized); |  (3)  |  (since C++20)  
template< /*different-from*/<subrange> R >  
requires [ranges::borrowed_range](../borrowed_range.html)<R> &&  
/*convertible-to-non-slicing*/<[ranges::iterator_t](../iterator_t.html)<R>, I> &&  
[std::convertible_to](../../concepts/convertible_to.html)<[ranges::sentinel_t](../iterator_t.html)<R>, S>  
constexpr subrange( R&& r )  
requires (!/*StoreSize*/ || [ranges::sized_range](../sized_range.html)<R>); |  (4) | (since C++20)  
template< [ranges::borrowed_range](../borrowed_range.html) R>  
requires /*convertible-to-non-slicing*/<[ranges::iterator_t](../iterator_t.html)<R>, I> &&  
[std::convertible_to](../../concepts/convertible_to.html)<[ranges::sentinel_t](../iterator_t.html)<R>, S>  
constexpr subrange( R&& r,  
/*make-unsigned-like-t*/<[std::iter_difference_t](../../iterator/iter_t.html)<I>> n )  
requires (K == ranges::subrange_kind::sized)  
: subrange{[ranges::begin](../begin.html)(r), [ranges::end](../end.html)(r), n} {} |  (5)  |  (since C++20)  
| |   
  
Constructs a `subrange`. 

For the definitions of /*make-unsigned-like-t*/ and /*different-from*/, see `_[make-unsigned-like-t](../../ranges.html#make-unsigned-like-t "cpp/ranges")_` and `_[different-from](../../ranges.html#different-from "cpp/ranges")_` respectively. 

Overload  | [Data members](../subrange.html#Data_members "cpp/ranges/subrange")  
---|---  
`_begin__` | `_end__` | `_size__`  
(only if `_[StoreSize](../subrange.html#StoreSize "cpp/ranges/subrange")_` is true)  
(1) | [value-initialized](../../language/value_initialization.html "cpp/language/value initialization") | [value-initialized](../../language/value_initialization.html "cpp/language/value initialization") | initialized with ​0​  
(2) | initialized with std::move(i) | initialized with s |  N/A  
(3) | initialized with n  
(4) | initialized with std::move([ranges::begin](../begin.html)(r)) | initialized with [ranges::end](../end.html)(r) | initialized with static_cast<decltype(`_[size_](../subrange.html#size "cpp/ranges/subrange")_` ﻿)>  
` `([ranges::size](../size.html)(r))  
(5) | initialized with n  
  
2) If `[`i`, `s`)` is not a [valid range](../../iterator.html#Ranges "cpp/iterator"), the behavior is undefined.

3) If any of the following conditions is satisfied, the behavior is undefined: 

  * `[`i`, `s`)` is not a valid range. 
  * n ==` `` _[to-unsigned-like](../../ranges.html#to-unsigned-like "cpp/ranges")_` ﻿([ranges::distance](../../iterator/ranges/distance.html)(i, s)) is false.
...
---|---|---|---  
[P2393R1](https://wg21.link/P2393R1) | C++20  | for overload ([4](subrange.html#Version_4)), `_[size_](../subrange.html#size "cpp/ranges/subrange")_` might be initialized with [ranges::size](../size.html)(r), but it is  
not always implicitly convertible to the corresponding [_unsigned-integer-like_](../../iterator/is-integer-like.html#Integer-like_type "cpp/iterator/is-integer-like") type  | made the  
conversion explicit 
