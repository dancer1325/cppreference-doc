...
---|---|---  
template< [std::input_or_output_iterator](../../iterator/input_or_output_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S >  
subrange(I, S) -> subrange<I, S>; |  (1)  |  (since C++20)  
template< [std::input_or_output_iterator](../../iterator/input_or_output_iterator.html) I, [std::sentinel_for](../../iterator/sentinel_for.html)<I> S >  
subrange(I, S, /*make-unsigned-like-t*/<[std::iter_difference_t](../../iterator/iter_t.html)<I>>) ->  
subrange<I, S, ranges::subrange_kind::sized>; |  (2)  |  (since C++20)  
template< [ranges::borrowed_range](../borrowed_range.html)<R> >  
subrange(R&&) ->  
subrange<[ranges::iterator_t](../iterator_t.html)<R>, [ranges::sentinel_t](../iterator_t.html)<R>,  
([ranges::sized_range](../sized_range.html)<R> ||  
[std::sized_sentinel_for](../../iterator/sized_sentinel_for.html)<[ranges::sentinel_t](../iterator_t.html)<R>,  
[ranges::iterator_t](../iterator_t.html)<R>>) ?  
ranges::subrange_kind::sized : ranges::subrange_kind::unsized>; |  (3)  |  (since C++20)  
template< [ranges::borrowed_range](../borrowed_range.html)<R> >  
subrange(R&&, /*make-unsigned-like-t*/<[ranges::range_difference_t](../range_size_t.html)<R>>) ->  
subrange<[ranges::iterator_t](../iterator_t.html)<R>, [ranges::sentinel_t](../iterator_t.html)<R>,  
ranges::subrange_kind::sized>; |  (4)  |  (since C++20)  
| |   
  
These [deduction guides](../../language/ctad.html "cpp/language/class template argument deduction") are provided for [std::ranges::subrange](../subrange.html "cpp/ranges/subrange"). 

1) Deduces the template arguments from the type of iterator and sentinel. The `subrange` is sized if [std::sized_sentinel_for](../../iterator/sized_sentinel_for.html)<S, I> is satisfied, as determined by the default template argument.
...
For the definition of /* make-unsigned-like-t */, see `_[make-unsigned-like-t](../../ranges.html#make-unsigned-like-t "cpp/ranges")_` ﻿. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/deduction_guides&action=edit&section=1 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/deduction_guides&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/deduction_guides&action=edit&section=3 "Edit section: Defect reports")] Defect reports
