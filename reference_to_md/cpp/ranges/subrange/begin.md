...
---|---|---  
constexpr I begin() requires (![std::copyable](../../concepts/copyable.html)<I>); |  (2)  |  (since C++20)  
| |   
  
Obtains the iterator to the beginning of the [`subrange`](../subrange.html "cpp/ranges/subrange"). 
