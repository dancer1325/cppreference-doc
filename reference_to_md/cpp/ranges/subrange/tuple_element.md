...
struct tuple_element<0, [ranges::subrange](../subrange.html)<I, S, K>>; |  (1)  |  (since C++20)  
template< class I, class S, [ranges::subrange_kind](../subrange_kind.html) K >  
struct tuple_element<0, const [ranges::subrange](../subrange.html)<I, S, K>>; |  (2)  |  (since C++20)  
template< class I, class S, [ranges::subrange_kind](../subrange_kind.html) K >  
struct tuple_element<1, [ranges::subrange](../subrange.html)<I, S, K>>; |  (3)  |  (since C++20)  
template< class I, class S, [ranges::subrange_kind](../subrange_kind.html) K >  
struct tuple_element<1, const [ranges::subrange](../subrange.html)<I, S, K>>; |  (4)  |  (since C++20)  
| |   
  
The partial specializations of [`std::tuple_element`](../../utility/tuple_element.html "cpp/utility/tuple element") for [std::ranges::subrange](../subrange.html "cpp/ranges/subrange") provide compile-time access to the iterator or sentinel type of a `subrange`, using tuple-like syntax. They are provided for structured binding support. 
...
Run this code
    ...
    int main()
    {
        [std::list](../../container/list.html)<int> list{3, 1, 4, 1, 5, 9, 2, 6};
     
        std::[ranges::subrange](../subrange.html) subrange
        {
            [std::counted_iterator](../../iterator/counted_iterator.html){[std::begin](../../iterator/begin.html)(list), 4},
            [std::default_sentinel](../../iterator/default_sentinel.html)
        };
     
        static_assert(
            [std::is_same_v](../../types/is_same.html)<
                [std::tuple_element_t](../../utility/tuple_element.html)<0, decltype(subrange)>,
                // implementation-defined type:
                [std::counted_iterator](../../iterator/counted_iterator.html)<std::_List_iterator<int>>
                >);
     
        static_assert(
            [std::is_same_v](../../types/is_same.html)<
                [std::tuple_element_t](../../utility/tuple_element.html)<1, decltype(subrange)>,
