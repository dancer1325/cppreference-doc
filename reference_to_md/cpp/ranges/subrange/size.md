...
constexpr /*make-unsigned-like-t*/<[std::iter_difference_t](../../iterator/iter_t.html)<I>> size() const  
requires (K == ranges::subrange_kind::sized); |  |  (since C++20)  
---|---|---  
| |   
  
Obtains the number of elements in the [`subrange`](../subrange.html "cpp/ranges/subrange"): 

  * If `_[StoreSize](../subrange.html#StoreSize "cpp/ranges/subrange")_` is true, returns `_[size_](../subrange.html#size "cpp/ranges/subrange")_`. 
  * Otherwise, returns `_[to-unsigned-like](../../ranges.html#to-unsigned-like "cpp/ranges")_` ﻿(`_[end_](../subrange.html#end "cpp/ranges/subrange")_`` `-` `` _[begin_](../subrange.html#begin "cpp/ranges/subrange")_` ﻿). 



For the definition of /*make-unsigned-like-t*/, see `_[make-unsigned-like-t](../../ranges.html#make-unsigned-like-t "cpp/ranges")_` ﻿. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/size&action=edit&section=1 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/size&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
        auto to_pair = [](auto sub) { return [std::make_pair](../../utility/pair/make_pair.html)(sub[0], sub.size()); };
                                                                     /* ^^^^ */
        auto pairs = v | std::[views::chunk_by](../chunk_by_view.html)([std::equal_to](../../utility/functional/equal_to.html){})
                       | std::[views::transform](../transform_view.html)(to_pair);
     
        for (auto x : pairs bitor std::[views::keys](../keys_view.html))
            [std::cout](../../io/cout.html) << x << ' ';
        [std::cout](../../io/cout.html) << '\n';
        for (auto x : pairs bitor std::[views::values](../values_view.html))
            [std::cout](../../io/cout.html) << x << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/size&action=edit&section=3 "Edit section: See also")] See also

[ empty](empty.html "cpp/ranges/subrange/empty") |  checks whether the `subrange` is empty   
