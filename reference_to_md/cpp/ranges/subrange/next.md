...
constexpr subrange next( [std::iter_difference_t](../../iterator/iter_t.html)<I> n = 1 ) const&  
requires [std::forward_iterator](../../iterator/forward_iterator.html)<I>; |  (1)  |  (since C++20)  
---|---|---  
constexpr subrange next( [std::iter_difference_t](../../iterator/iter_t.html)<I> n = 1 ) &&; |  (2) | (since C++20)  
| |   
  
Returns a [`subrange`](../subrange.html "cpp/ranges/subrange") whose `_[begin_](../subrange.html#begin "cpp/ranges/subrange")_` is incremented (or decremented if n is negative). The actual increment (or decrement) operation is performed by [`advance()`](advance.html "cpp/ranges/subrange/advance"). 
...
## Contents
  ...
  * [1 Parameter](next.html#Parameter)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/next&action=edit&section=1 "Edit section: Parameter")] Parameter

n  |  \-  |  number of maximal increments of the iterator   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/next&action=edit&section=2 "Edit section: Return value")] Return value

As described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/next&action=edit&section=3 "Edit section: Notes")] Notes

The difference between this function and [`advance()`](advance.html "cpp/ranges/subrange/advance") is that the latter performs the increment (or decrement) in place. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/next&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::array](../../container/array.html) arr{1, 2, 3, 4, 5, 6, 7};
        std::[ranges::subrange](../subrange.html) sub{[std::next](../../iterator/next.html)(arr.begin(), 2), [std::prev](../../iterator/prev.html)(arr.end(), 2)};
        [std::println](../../io/println.html)("1) sub: {}", sub);
        [std::println](../../io/println.html)("2) sub: {}", sub.next());
        [std::println](../../io/println.html)("3) sub: {}", sub.next(2));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/subrange/next&action=edit&section=5 "Edit section: See also")] See also
