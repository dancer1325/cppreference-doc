...
Let [`_base__`](../stride_view.html#Data_members "cpp/ranges/stride view") be the underlying view and [`_stride__`](../stride_view.html#Data_members "cpp/ranges/stride view") be the stored stride value. Equivalent to: 
    
    
    return /*to-unsigned-like*/(/*div-ceil*/([ranges::distance](../../iterator/ranges/distance.html)(base_), stride_));
...
Run this code
    ...
     
        [std::forward_list](../../container/forward_list.html) list{v};
