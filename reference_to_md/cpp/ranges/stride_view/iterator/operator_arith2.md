...
[ranges::iterator_t](../../iterator_t.html)<Base>>; |  (5)  |  (since C++23)  
friend constexpr difference_type  
operator-( const /*iterator*/& x, [std::default_sentinel_t](../../../iterator/default_sentinel.html) s )  
requires [std::sized_sentinel_for](../../../iterator/sized_sentinel_for.html)<[ranges::sentinel_t](../../iterator_t.html)<Base>,  
[ranges::iterator_t](../../iterator_t.html)<Base>>; |  (6)  |  (since C++23)  
| |   
...
4) Let `_N_` be x.current_ - y.current_. Returns: 

  * (N + x.missing_ - y.missing_) / x.stride_, if [`_Base_`](../iterator.html#Member_types "cpp/ranges/stride view/iterator") models [`forward_range`](../../forward_range.html "cpp/ranges/forward range"). 
  * -/*div-ceil*/(-N, x.stride_), if `_N < 0_`. 
