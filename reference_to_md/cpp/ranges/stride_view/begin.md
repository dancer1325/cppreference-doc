...
Returns an [iterator](iterator.html "cpp/ranges/stride view/iterator") to the first element of the `stride_view`. 

1) Equivalent to return iterator<false>(this, [ranges::begin](../begin.html)(base_));.
...
Run this code
    ...
    int main()
    {
        ...
        const auto x = v | std::[views::stride](../stride_view.html)(2);
        const auto y = v | std::[views::reverse](../reverse_view.html) | std::[views::stride](../stride_view.html)(2);
        const auto z = v | std::[views::stride](../stride_view.html)(2) | std::[views::reverse](../reverse_view.html);
        [std::println](../../io/println.html)("{} {} {}", *x.begin(), *y.begin(), *z.begin());
    }
