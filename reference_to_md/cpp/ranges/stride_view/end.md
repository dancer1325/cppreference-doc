...
Returns an [iterator](iterator.html "cpp/ranges/stride view/iterator") or a [sentinel](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/stride_view/sentinel&action=edit&redlink=1 "cpp/ranges/stride view/sentinel \(page does not exist\)") representing the end of the [`stride_view`](../stride_view.html "cpp/ranges/stride view"). 

Let [`_base__`](../stride_view.html#Data_members "cpp/ranges/stride view") and [`_stride__`](../stride_view.html#Data_members "cpp/ranges/stride view") be the underlying data members. 
...
Equivalent to: 
    ...
    if constexpr ([ranges::common_range](../common_range.html)<Base> &&
                  [ranges::sized_range](../sized_range.html)<Base> &&
                  [ranges::forward_range](../forward_range.html)<Base>)
    {
        auto missing = (stride_ - [ranges::distance](../../iterator/ranges/distance.html)(base_) % stride_) % stride_;
        return iterator<Const>(this, [ranges::end](../end.html)(base_), missing);
    }
    else if constexpr ([ranges::common_range](../common_range.html)<Base> &&
                       ![ranges::bidirectional_range](../bidirectional_range.html)<Base>)
    {
        return iterator<Const>(this, [ranges::end](../end.html)(base_));
    }
    else
    {
