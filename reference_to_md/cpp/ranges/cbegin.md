...
template< class T >  
requires /* see below */  
constexpr /* see below */ auto cbegin( T&& t ); |  |  (since C++20)  
| |   
...
A call to `ranges::cbegin` is [expression-equivalent](../language/expressions.html#Expression-equivalence "cpp/language/expressions") to [ranges::begin](begin.html)(static_cast<CT&&>(t)).  | (until C++23)  
---|---  
If the argument is an lvalue or [ranges::enable_borrowed_range](borrowed_range.html)<[std::remove_cv_t](../types/remove_cv.html)<T>> is true, then a call to `ranges::cbegin` is [expression-equivalent](../language/expressions.html#Expression-equivalence "cpp/language/expressions") to: 

  * [std::const_iterator](../iterator/const_iterator.html)<decltype(U)>(U) for some expression U equivalent to [ranges::begin](begin.html)(`_[possibly-const-range](../ranges.html#possibly-const-range "cpp/ranges")_`(t). 

In all other cases, a call to `ranges::cbegin` is ill-formed, which can result in [substitution failure](../language/sfinae.html "cpp/language/sfinae") when the call appears in the immediate context of a template instantiation.  | (since C++23)  
...
## Contents
  ...
  * [1 Customization point objects](cbegin.html#Customization_point_objects)
  * [2 Notes](cbegin.html#Notes)
  * [3 Example](cbegin.html#Example)
  * [4 See also](cbegin.html#See_also)
...
[ranges::begin](begin.html)([std::as_const](../utility/as_const.html)(e)).  | (until C++23)  
---|---  
  
  * [ranges::begin](begin.html)(e) if T models [`constant_range`](constant_range.html "cpp/ranges/constant range"). 
  * Otherwise, [ranges::begin](begin.html)([std::as_const](../utility/as_const.html)(e)) if const T models [`constant_range`](constant_range.html "cpp/ranges/constant range"). 
  * Otherwise, [std::basic_const_iterator](../iterator/basic_const_iterator.html)([ranges::begin](begin.html)(e)). 
...
Run this code
    ...
    int main()
    {
        ...
        [assert](../error/assert.html)(3 == *vi);
        ++vi; // OK, constant-iterator object is mutable
        [assert](../error/assert.html)(1 == *vi);
    ...
     
        ...
        [assert](../error/assert.html)(3 == *ai and *(ai + 1) == 1);
