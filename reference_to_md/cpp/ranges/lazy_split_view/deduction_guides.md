...
lazy_split_view( R&&, P&& )  
-> lazy_split_view<[views::all_t](../all_view.html)<R>, [views::all_t](../all_view.html)<P>>; |  (1)  |  (since C++20)  
---|---|---  
template< [ranges::input_range](../input_range.html) R >  
lazy_split_view( R&&, [ranges::range_value_t](../range_size_t.html)<R> )  
-> lazy_split_view<[views::all_t](../all_view.html)<R>,  
[ranges::single_view](../single_view.html)<[ranges::range_value_t](../range_size_t.html)<R>>>; |  (2)  |  (since C++20)  
| |   
  
These [deduction guides](../../language/ctad.html "cpp/language/class template argument deduction") are provided for lazy_split_view to allow deduction from a range and a delimiter. 

1) The delimiter is a range of elements.

2) The delimiter is a single element.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/lazy_split_view/deduction_guides&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        std::[ranges::lazy_split_view](../lazy_split_view.html) w1{"a::b::c"sv, "::"sv};
        // type of w1 is lazy_split_view<string_view, string_view>:
        static_assert([std::is_same_v](../../types/is_same.html)<
            decltype(w1),
            std::[ranges::lazy_split_view](../lazy_split_view.html)<
                [std::basic_string_view](../../string/basic_string_view.html)<char, [std::char_traits](../../string/char_traits.html)<char>>,
                [std::basic_string_view](../../string/basic_string_view.html)<char, [std::char_traits](../../string/char_traits.html)<char>>>>);
     
        std::[ranges::lazy_split_view](../lazy_split_view.html) w2{"x,y,z"sv, ','};
        // type of w2 is lazy_split_view<string_view, single_view<char>>:
        static_assert([std::is_same_v](../../types/is_same.html)<
            decltype(w2),
            std::[ranges::lazy_split_view](../lazy_split_view.html)<
                [std::basic_string_view](../../string/basic_string_view.html)<char, [std::char_traits](../../string/char_traits.html)<char>>,
                std::[ranges::single_view](../single_view.html)<char>>>);
    }
