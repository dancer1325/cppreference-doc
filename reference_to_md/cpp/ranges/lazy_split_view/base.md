...
Returns a copy of the underlying view `_[base_](../lazy_split_view.html#base "cpp/ranges/lazy split view")_`. 

1) Copy constructs the result from the underlying view `_base__`.
...
Run this code
    ...
    #include <string_view>
     
    void print([std::string_view](../../string/basic_string_view.html) rem, auto const& r, [std::string_view](../../string/basic_string_view.html) post = "\n")
    {
        for ([std::cout](../../io/cout.html) << rem; auto const& e : r)
    ...
    int main()
    {
        constexpr [std::string_view](../../string/basic_string_view.html) keywords{ "this,..throw,..true,..try,.." };
        constexpr [std::string_view](../../string/basic_string_view.html) pattern{",.."};
        constexpr std::[ranges::lazy_split_view](../lazy_split_view.html) lazy_split_view{keywords, pattern};
