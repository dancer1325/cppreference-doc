...
requires [ranges::forward_range](../forward_range.html)<V> && [ranges::forward_range](../forward_range.html)<const V>; |  (2)  |  (since C++20)  
| |   
  
Returns an [`_outer_iterator_`](outer_iterator.html "cpp/ranges/lazy split view/outer iterator") to the first element of the [`lazy_split_view`](lazy_split_view.html "cpp/ranges/lazy split view/lazy split view"). 

Let `_[base_](../lazy_split_view.html#base "cpp/ranges/lazy split view")_` be the underlying view and `_[current_](../lazy_split_view.html#current "cpp/ranges/lazy split view")_` be the underlying caching object (may not be present). 
...
1) Equivalent to 
    ...
    constexpr auto begin()
    {
        if constexpr ([ranges::forward_range](../forward_range.html)<V>)
            return /*outer_iterator*/</*simple_view*/<V>>{*this, [ranges::begin](../begin.html)(base_)};
        else
        {
            current_ = [ranges::begin](../begin.html)(base_);
            return /*outer_iterator*/<false>{*this};
        }
    }

2) Equivalent to return /*outer_iterator*/<true>{*this, [ranges::begin](../begin.html)(base_)};.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/lazy_split_view/begin&action=edit&section=1 "Edit section: Return value")] Return value

[`_outer_iterator_`](outer_iterator.html "cpp/ranges/lazy split view/outer iterator") to the first element. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/lazy_split_view/begin&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/lazy_split_view/begin&action=edit&section=3 "Edit section: See also")] See also

[ end](end.html "cpp/ranges/lazy split view/end") |  returns an iterator or a sentinel to the end   
