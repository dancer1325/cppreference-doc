...
class empty_view : public [ranges::view_interface](view_interface.html)<empty_view<T>> |  (1)  |  (since C++20)  
namespace views {  
template<class T>  
...
1) A range factory that produces a [`view`](view.html "cpp/ranges/view") of no elements of a particular type.

2) Variable template for `empty_view`.

## Contents

  * [1 Member functions](empty_view.html#Member_functions)
    * [1.1 Inherited from std::ranges::view_interface](empty_view.html#Inherited_from_std::ranges::view_interface)
  * [2 std::ranges::empty_view::begin](empty_view.html#std::ranges::empty_view::begin)
  * [3 std::ranges::empty_view::end](empty_view.html#std::ranges::empty_view::end)
  * [4 std::ranges::empty_view::data](empty_view.html#std::ranges::empty_view::data)
  * [5 std::ranges::empty_view::size](empty_view.html#std::ranges::empty_view::size)
  * [6 std::ranges::empty_view::empty](empty_view.html#std::ranges::empty_view::empty)
    * [6.1 Helper templates](empty_view.html#Helper_templates)
    * [6.2 Notes](empty_view.html#Notes)
    * [6.3 Example](empty_view.html#Example)
    * [6.4 See also](empty_view.html#See_also)
...
---|---  
end[static] |  returns nullptr   
(public static member function)  
data[static] |  returns nullptr   
(public static member function)  
size[static] |  returns ​0​   
(public static member function)  
empty[static] |  returns true   
(public static member function)  
...
static constexpr [std::size_t](../types/size_t.html) size() noexcept { return 0; } |  |  (since C++20)  
---|---|---  
| |   
...
Run this code
    ...
     
        ...
        static_assert([ranges::empty](empty.html)(e)); // uses operator bool
