...
[Iterator](iterator.html "cpp/ranges/filter view/iterator")  
...
The return type of [`filter_view::end`](../filter_view.html "cpp/ranges/filter view") when the underlying [`view`](../view.html "cpp/ranges/view") `V` does not model [`common_range`](../common_range.html "cpp/ranges/common range"). 

## Contents

  * [1 Data members](sentinel.html#Data_members)
  * [2 Member functions](sentinel.html#Member_functions)
  * [3 std::ranges::filter_view::_sentinel_ ::_sentinel_](sentinel.html#std::ranges::filter_view::sentinel::sentinel)
  * [4 std::ranges::filter_view::_sentinel_ ::base](sentinel.html#std::ranges::filter_view::sentinel::base)
    * [4.1 Non-member functions](sentinel.html#Non-member_functions)
  * [5 operator==(std::ranges::filter_view::_iterator_ , std::ranges::filter_view::_sentinel_)](sentinel.html#operator.3D.3D.28std::ranges::filter_view::iterator.2C_std::ranges::filter_view::sentinel.29)
...
---|---  
[ base](sentinel.html#base "cpp/ranges/filter view/sentinel") |  returns the underlying sentinel   
(public member function)  
...
1) Value-initializes `_end__` via its default member initializer (= [ranges::sentinel_t](../iterator_t.html)<V>()).

2) Initializes `_end__` with [ranges::end](../end.html)(parent.base_). 

##  std::ranges::filter_view::_sentinel_ ::base

constexpr [ranges::sentinel_t](../iterator_t.html)<V> base() const; |  |  (since C++20)  
---|---|---  
| |   
...
Equivalent to return x.current_ == y.end_;, where `_current__` is the underlying iterator wrapped in [`filter_view::_iterator_`](iterator.html "cpp/ranges/filter view/iterator"). 
