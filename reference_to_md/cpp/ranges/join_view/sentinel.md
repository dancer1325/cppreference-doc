...
The return type of [`join_view::end`](end.html "cpp/ranges/join view/end") when either of the underlying ranges (`V` or [ranges::range_reference_t](../range_reference_t.html)<V>) is not a [`common_range`](../common_range.html "cpp/ranges/common range"), or when the parent `join_view` is not a [`forward_range`](../forward_range.html "cpp/ranges/forward range"). 

If `V` is not a [simple view](../../ranges.html#Helper_concepts "cpp/ranges"), `Const` is true for sentinels returned from the const overloads, and false otherwise. If `V` is a simple view, `Const` is true. 
...
Member  |  Definition   
---|---  
`_Parent_` (private) |  `_[maybe-const](../../ranges.html#maybe-const "cpp/ranges")_` ﻿<Const, [ranges::join_view](../join_view.html)<V>>  
