...
**iter_swap(join_with_view::_iterator_)**(C++23)  
...
[ranges::iterator_t](../../iterator_t.html)</*PatternBase*/>>; |  |  (since C++23)  
---|---|---  
| |   
  
Applies [ranges::iter_swap](../../../iterator/ranges/iter_swap.html "cpp/iterator/ranges/iter swap") to the inner iterators as if by [std::visit](../../../utility/variant/visit.html)([ranges::iter_swap](../../../iterator/ranges/iter_swap.html), x.`_[inner_it_](../iterator.html#inner_it "cpp/ranges/join with view/iterator")_` ﻿, y.`_[inner_it_](../iterator.html#inner_it "cpp/ranges/join with view/iterator")_` ﻿);. 
