...
**iter_move(join_with_view::_iterator_)**(C++23)  
...
Returns the result of applying [ranges::iter_move](../../../iterator/ranges/iter_move.html "cpp/iterator/ranges/iter move") to the [inner iterator](../iterator.html "cpp/ranges/join with view/iterator"). 
