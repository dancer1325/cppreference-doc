...
Effectively returns [ranges::find_if_not](../../algorithm/ranges/find.html)(base_, [std::cref](../../utility/functional/ref.html)(pred())), where [`_base__`](../drop_while_view.html#Data_members "cpp/ranges/drop while view") is the underlying view. The behavior is undefined if *this does not store a predicate. 

In order to provide the amortized constant time complexity required by the [`range`](../range.html "cpp/ranges/range") concept, this function caches the result within the `drop_while_view` object for use on subsequent calls. 
...
Run this code
    ...
    int main()
    {
        ...
        auto view = std::[ranges::drop_while_view](../drop_while_view.html){data, [](int x){ return x <= 0; }};
