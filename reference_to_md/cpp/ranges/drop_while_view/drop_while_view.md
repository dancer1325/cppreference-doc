...
1) Default constructor. [Value-initializes](../../language/value_initialization.html "cpp/language/value initialization") the underlying view [`_base__`](../drop_while_view.html#Data_members "cpp/ranges/drop while view") and the predicate [`_pred__`](../drop_while_view.html#Data_members "cpp/ranges/drop while view").
...
Run this code
    ...
    int main()
    {
        ...
        for (auto v = std::[ranges::drop_while_view](../drop_while_view.html){a, [std::not_fn](../../utility/functional/not_fn.html)(positive)}; int x : v)
...
constructs a `drop_while_view` which does not contain an `Pred` | the `drop_while_view` is also  
