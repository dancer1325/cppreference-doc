...
---  
[drop_while_view::drop_while_view](drop_while_view.html "cpp/ranges/drop while view/drop while view")  
**drop_while_view::base**  
[drop_while_view::pred](pred.html "cpp/ranges/drop while view/pred")  
[drop_while_view::begin](begin.html "cpp/ranges/drop while view/begin")  
...
1) Copy constructs the result from the underlying view [`_base__`](../drop_while_view.html#Data_members "cpp/ranges/drop while view").

2) Move constructs the result from the underlying view `_base__`.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/drop_while_view/base&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/drop_while_view/base&action=edit&section=2 "Edit section: Return value")] Return value

A copy of the underlying view. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/drop_while_view/base&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::array](../../container/array.html) data{1, 2, 3, 4, 5};
        print(data.cbegin(), data.cend());
     
        auto func = [](int x) { return x < 3; };
        auto view = std::[ranges::drop_while_view](../drop_while_view.html){data, func};
        print(view.begin(), view.end());
     
        auto base = view.base(); // `base` refers to the `data`
        std::[ranges::reverse](../../algorithm/ranges/reverse.html)(base); //< changes `data` indirectly
        print(data.cbegin(), data.cend());
    }
