...
---|---|---  
template< [ranges::range](range.html) R, class Allocator = [std::allocator](../memory/allocator.html)<[std::byte](../types/byte.html)> >  
struct elements_of; |  |  (since C++23)  
| |   
  
Encapsulates a [`range`](range.html "cpp/ranges/range"). Specializations of `elements_of` act as a tag in overload sets to disambiguate when a range should be treated as a sequence rather than a single value. 

## Contents

  * [1 Template parameters](elements_of.html#Template_parameters)
  * [2 Data members](elements_of.html#Data_members)
  * [3 Deduction guide](elements_of.html#Deduction_guide)
  * [4 Example](elements_of.html#Example)
  * [5 References](elements_of.html#References)
...
allocator |  an allocator of type `Allocator`. It has default member initializer that value initializes itself   
(public member object)  
...
Run this code
    ...
    [std::generator](../coroutine/generator.html)<[std::any](../utility/any.html)> gen(std::[ranges::input_range](input_range.html) auto&& r)
    {
    ...
    int main()
    {
        auto test = [std::string_view](../string/basic_string_view.html){"test"};
     
        for ([std::any](../utility/any.html) a : gen<true>(test))
            [std::cout](../io/cout.html) << '[' << [std::any_cast](../utility/any/any_cast.html)<char>(a) << "] ";
        [std::cout](../io/cout.html) << '\n';
     
        for ([std::any](../utility/any.html) a : gen<false>(test))
            [std::cout](../io/cout.html) << '[' << [std::any_cast](../utility/any/any_cast.html)<[std::string_view](../string/basic_string_view.html)>(a) << "] ";
        [std::cout](../io/cout.html) << '\n';
    }
