...
---|---|---  
template< class D >  
requires [std::is_object_v](../types/is_object.html)<D> && [std::same_as](../concepts/same_as.html)<D, [std::remove_cv_t](../types/remove_cv.html)<D>>  
class range_adaptor_closure {}; |  |  (since C++23)  
| |   
  
`std::ranges::range_adaptor_closure` is a helper class template for defining a [RangeAdaptorClosureObject](../named_req/RangeAdaptorClosureObject.html "cpp/named req/RangeAdaptorClosureObject"). 
...
Let t be the object of type `T`, the implementation ensures that t is a range adaptor closure object if all the requirements are met: 
  ...
  * t is a unary function object that takes one [`range`](range.html "cpp/ranges/range") argument. 
  ...
  * `T` does not satisfy [`range`](range.html "cpp/ranges/range"). 
...
Run this code
    ...
    {
        [std::size_t](../types/size_t.html) start = 0;
        [std::size_t](../types/size_t.html) end = [std::string_view::npos](../string/basic_string_view/npos.html);
     
        constexpr [std::string_view](../string/basic_string_view.html) operator()([std::string_view](../string/basic_string_view.html) sv) const
        {
    ...
    int main()
    {
        constexpr [std::string_view](../string/basic_string_view.html) str = "01234567";
     
    ...
     
        ...
        constexpr auto slice_and_drop = slicer | std::[views::drop](drop_view.html)(2);
        static_assert([std::string_view](../string/basic_string_view.html)(str | slice_and_drop) == "345");
    }
