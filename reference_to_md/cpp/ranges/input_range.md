...
template< class T >  
concept input_range =  
[ranges::range](range.html)<T> && [std::input_iterator](../iterator/input_iterator.html)<[ranges::iterator_t](iterator_t.html)<T>>; |  |  (since C++20)  
| |   
  
The `input_range` concept is a refinement of [`range`](range.html "cpp/ranges/range") for which ranges::begin returns a model of [`input_iterator`](../iterator/input_iterator.html "cpp/iterator/input iterator"). 
