...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/common_view/base&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/common_view/base&action=edit&section=2 "Edit section: Return value")] Return value

A copy of the underlying view. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/common_view/base&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        auto view = std::[views::common](../common_view.html)(str);
     
        [std::string](../../string/basic_string.html) copy_of_str = view.base();
        [std::cout](../../io/cout.html) << "copy of str: [" << copy_of_str << "]\n";
        [std::cout](../../io/cout.html) << "view.base(): [" << view.base() << "]\n";
     
        [std::string](../../string/basic_string.html) move_str = std::move(view.base());
        [std::cout](../../io/cout.html) << "moved str:   [" << move_str << "]\n";
        [std::cout](../../io/cout.html) << "view.base(): [" << view.base() << "]\n"; // unspecified
    }
