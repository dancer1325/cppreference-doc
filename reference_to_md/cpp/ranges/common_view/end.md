...
[common_view::begin](begin.html "cpp/ranges/common view/begin")  
**common_view::end**  
...
1) Returns an iterator representing the end of the `common_view`, that is: 
  ...
  * [ranges::begin](../begin.html)(`_[base_](../common_view.html#base "cpp/ranges/common view")_`) + [ranges::distance](../../iterator/ranges/distance.html)(`_[base_](../common_view.html#base "cpp/ranges/common view")_`), if both [ranges::random_access_range](../random_access_range.html)<V> and [ranges::sized_range](../sized_range.html)<V> are satisfied, 
  * [std::common_iterator](../../iterator/common_iterator.html)<[ranges::iterator_t](../iterator_t.html)<V>, [ranges::sentinel_t](../iterator_t.html)<V>>([ranges::end](../end.html)(`_[base_](../common_view.html#base "cpp/ranges/common view")_`)) otherwise.
...
## Contents
  ...
  * [2 Example](end.html#Example)
  * [3 Defect reports](end.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        constexpr int n{4};
     
        constexpr auto v1 = std::[views::iota](../iota_view.html)(1)
                          | std::[views::take](../take_view.html)(n)
                          | std::[views::common](../common_view.html)
                          ;
        constexpr auto v2 = std::[views::iota](../iota_view.html)(2)
                          | std::[views::take](../take_view.html)(n)
                          ;
        const int product = [std::inner_product](../../algorithm/inner_product.html)(v1.begin(), v1.end(),
                                               v2.begin(),
                                               0);
        [std::cout](../../io/cout.html) << product << '\n';
    }
