...
---  
[common_view::common_view](common_view.html "cpp/ranges/common view/common view")  
[common_view::base](base.html "cpp/ranges/common view/base")  
**common_view::begin**  
[common_view::end](end.html "cpp/ranges/common view/end")  
[common_view::size](size.html "cpp/ranges/common view/size")  
...
1) Returns an iterator to the first element of the `common_view`, that is: 
  ...
  * [ranges::begin](../begin.html)(`_[base_](../common_view.html#base "cpp/ranges/common view")_`), if both [ranges::random_access_range](../random_access_range.html)<V> and [ranges::sized_range](../sized_range.html)<V> are satisfied, 
  * [std::common_iterator](../../iterator/common_iterator.html)<[ranges::iterator_t](../iterator_t.html)<V>, [ranges::sentinel_t](../iterator_t.html)<V>>([ranges::begin](../begin.html)(`_[base_](../common_view.html#base "cpp/ranges/common view")_`)) otherwise.
...
## Contents
  ...
  * [2 Example](begin.html#Example)
  * [3 Defect reports](begin.html#Defect_reports)
  * [4 See also](begin.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/common_view/begin&action=edit&section=1 "Edit section: Return value")] Return value

An iterator to the beginning of the underlying view. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/common_view/begin&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr auto common = std::[views::iota](../iota_view.html)(1)
                              | std::[views::take](../take_view.html)(3)
                              | std::[views::common](../common_view.html)
                              ;
     
        for (int i{}; int e : common)
            [std::cout](../../io/cout.html) << (i++ ? " + " : "") << e;
     
        [std::cout](../../io/cout.html) << " = " << [std::accumulate](../../algorithm/accumulate.html)(common.begin(), common.end(), 0) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/common_view/begin&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/common_view/begin&action=edit&section=4 "Edit section: See also")] See also

[ end](end.html "cpp/ranges/common view/end") |  returns an iterator to the end   
