...
Equivalent to return ranges::reserve_hint(`_[base_](../common_view.html#base "cpp/ranges/common view")_` ﻿);
...
[ size](size.html "cpp/ranges/common view/size") |  returns the number of elements, provided only if the underlying (adapted) range satisfies [`sized_range`](../sized_range.html "cpp/ranges/sized range")   
