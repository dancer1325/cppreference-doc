...
Run this code
    ...
    int main()
    {
        ...
        constexpr auto common1{v1 | std::[views::common](../common_view.html)};
        static_assert(common1.size() == 5);
     
        constexpr auto take3{v1 | std::[views::reverse](../reverse_view.html) | std::[views::take](../take_view.html)(3)};
        constexpr auto common2{take3 | std::[views::common](../common_view.html)};
