...
1) Default constructor. [Value-initializes](../../language/value_initialization.html "cpp/language/value initialization") the underlying view. After construction, [`base()`](base.html "cpp/ranges/common view/base") returns a copy of V().
