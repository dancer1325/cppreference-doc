...
[ranges::range](range.html)<T> &&  
(([ranges::view](view.html)<[std::remove_cvref_t](../types/remove_cvref.html)<T>> &&  
[std::constructible_from](../concepts/constructible_from.html)<[std::remove_cvref_t](../types/remove_cvref.html)<T>, T>) ||  
(![ranges::view](view.html)<[std::remove_cvref_t](../types/remove_cvref.html)<T>> &&  
([std::is_lvalue_reference_v](../types/is_lvalue_reference.html)<T> ||  
([std::movable](../concepts/movable.html)<[std::remove_reference_t](../types/remove_reference.html)<T>> && !/*is-initializer-list*/<T>)))); |  |  (since C++20)  
| |   
  
The `viewable_range` concept is a refinement of [`range`](range.html "cpp/ranges/range") that describes a range that can be converted into a [`view`](view.html "cpp/ranges/view") through [`views::all`](all_view.html "cpp/ranges/all view"). 
...
Run this code
    ...
     
    template <typename T>
    concept valid_viewable_range = [std::same_as](../concepts/same_as.html)<T, valid_result>;
     
    template <typename T>
    concept invalid_viewable_range = [std::same_as](../concepts/same_as.html)<T, invalid_result>;
     
    ...
    int main()
    {
        auto il = {1, 2, 3};
        int arr []{1, 2, 3};
        [std::vector](../container/vector.html) vec{1, 2, 3};
        std::[ranges::ref_view](ref_view.html) r{arr};
        std::[ranges::owning_view](owning_view.html) o{[std::string](../string/basic_string.html)("Hello")};
     
        static_assert(requires {
            ...
            { test_viewable_range(std::[ranges::ref_view](ref_view.html)(o)) } -> valid_viewable_range;
        });
    }
