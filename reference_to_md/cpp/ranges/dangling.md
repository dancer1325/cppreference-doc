...
`dangling` is a placeholder type and an empty class type, used together with the template aliases [`ranges::borrowed_iterator_t`](borrowed_iterator_t.html "cpp/ranges/borrowed iterator t") and [`ranges::borrowed_subrange_t`](borrowed_iterator_t.html "cpp/ranges/borrowed iterator t"). 

When some [constrained algorithms](../algorithm/ranges.html "cpp/algorithm/ranges") that usually return an iterator or a subrange of a [`range`](range.html "cpp/ranges/range") take a particular rvalue `range` argument that does not model [`borrowed_range`](borrowed_range.html "cpp/ranges/borrowed range"), `dangling` will be returned instead to avoid returning potentially dangling results. 

## Contents

  * [1 Member functions](dangling.html#Member_functions)
  * [2 std::ranges::dangling::dangling](dangling.html#std::ranges::dangling::dangling)
    * [2.1 Example](dangling.html#Example)
    * [2.2 See also](dangling.html#See_also)
...
Run this code
    ...
    int main()
    {
        auto get_array_by_value = [] { return [std::array](../container/array.html){0, 1, 0, 1}; };
        auto dangling_iter = std::[ranges::max_element](../algorithm/ranges/max_element.html)(get_array_by_value());
    ...
     
        auto get_persistent_array = []() -> const [std::array](../container/array.html)<int, 4>& {
            static constexpr [std::array](../container/array.html) a{0, 1, 0, 1};
            return a;
        };
        auto valid_iter = std::[ranges::max_element](../algorithm/ranges/max_element.html)(get_persistent_array());
        static_assert(![std::is_same_v](../types/is_same.html)<std::[ranges::dangling](http://en.cppreference.com/w/cpp/ranges-dangling-placeholder/dangling), decltype(valid_iter)>);
        [std::cout](../io/cout.html) << *valid_iter << ' '; // 1
     
     
        auto get_string_view = [] { return [std::string_view](../string/basic_string_view.html){"alpha"}; };
        auto valid_iter2 = std::[ranges::min_element](../algorithm/ranges/min_element.html)(get_string_view());
            // OK: std::basic_string_view models borrowed_range
        static_assert(![std::is_same_v](../types/is_same.html)<std::[ranges::dangling](http://en.cppreference.com/w/cpp/ranges-dangling-placeholder/dangling), decltype(valid_iter2)>);
