...
[ranges::iterator_t](../../iterator_t.html)</*maybe-const*/<Const, Views>>> && ...); |  (1)  |  (since C++23)  
---|---|---  
...
Let `_current__` be the underlying _tuple-like_ object of iterators to elements of adapted views. 
