...
---|---|---  
template<[ranges::random_access_range](../random_access_range.html) R = const D>  
constexpr decltype(auto) operator[]( [ranges::range_difference_t](../range_size_t.html)<R> n ) const; |  (2)  |  (since C++20)  
| |   
...
1) Let `derived` be static_cast<D&>(*this). Equivalent to return [ranges::begin](../begin.html)(derived)[n];.
...
However, following derived types cannot use the default implementations, as they never satisfy [`random_access_range`](../random_access_range.html "cpp/ranges/random access range"): 
