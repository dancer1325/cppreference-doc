...
[ranges::iterator_t](../iterator_t.html)<D>>; |  (1)  |  (since C++20)  
---|---|---  
constexpr auto size() const requires [ranges::forward_range](../forward_range.html)<const D> &&  
[std::sized_sentinel_for](../../iterator/sized_sentinel_for.html)<[ranges::sentinel_t](../iterator_t.html)<const D>,  
[ranges::iterator_t](../iterator_t.html)<const D>>; |  (2)  |  (since C++20)  
| |   
