...
The default implementation of operator bool member function checks whether the view is non-empty. It makes the derived type [contextually convertible to bool](../../language/implicit_cast.html#Contextual_conversions "cpp/language/implicit conversion"). 

1) Let `derived` be static_cast<D&>(*this). The expression in the requires-clause is equal to requires { [ranges::empty](../empty.html)(derived); }, and the function body is equivalent to return ![ranges::empty](../empty.html)(derived);.
...
Run this code
    ...
    int main()
    {
        const [std::array](../../container/array.html) ints {0, 1, 2, 3, 4};
        auto odds = ints | std::[views::filter](../filter_view.html)([](int i) { return 0 != i % 2; });
        auto negs = ints | std::[views::filter](../filter_view.html)([](int i) { return i < 0; });
