...
---|---|---  
constexpr auto cbegin() const requires [ranges::range](../range.html)<const D>; |  (2)  |  (since C++23)  
| |   
...
Equivalent to return [ranges::cbegin](../cbegin.html)(derived);.

2) Same as (1), except that derived is static_cast<const D&>(*this).

## Contents

  * [1 Return value](cbegin.html#Return_value)
