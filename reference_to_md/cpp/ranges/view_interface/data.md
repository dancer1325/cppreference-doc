...
---  
[empty](empty.html "cpp/ranges/view interface/empty")  
...
requires [ranges::range](../range.html)<const D> &&   
[std::contiguous_iterator](../../iterator/contiguous_iterator.html)<[ranges::iterator_t](../iterator_t.html)<const D>>; |  (2)  |  (since C++20)  
| |   
  
The default implementation of `data()` member function obtains the address denoted by the beginning iterator via std::to_address, which is also the lowest address of the contiguous storage (implied by [`contiguous_iterator`](../../iterator/contiguous_iterator.html "cpp/iterator/contiguous iterator")) referenced by the view of the derived type when the view is not empty. 

1) Let `derived` be static_cast<D&>(*this). Equivalent to return [std::to_address](../../memory/to_address.html)([ranges::begin](../begin.html)(derived));.
...
## Contents
  ...
  * [2 Notes](data.html#Notes)
  * [3 Example](data.html#Example)
...
Following derived types may use the default implementation of `data()`: 
  ...
  * [std::ranges::ref_view](../ref_view.html "cpp/ranges/ref view")
...
Following types are derived from [std::ranges::view_interface](../view_interface.html "cpp/ranges/view interface") and do not declare their own `data()` member function, but they cannot use the default implementation, because their iterator types never satisfy [`contiguous_iterator`](../../iterator/contiguous_iterator.html "cpp/iterator/contiguous iterator"): 
...
Run this code
    ...
     
    int main() {
        constexpr [std::string_view](../../string/basic_string_view.html) str { "Hello, C++20!" };
        [std::cout](../../io/cout.html) << (str | std::[views::drop](../drop_view.html)(7)).data() << '\n';
        constexpr static [std::array](../../container/array.html) a { 1,2,3,4,5 };
        constexpr auto v { a | std::[views::take](../take_view.html)(3) };
