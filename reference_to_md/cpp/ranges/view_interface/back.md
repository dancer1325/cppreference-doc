...
requires [ranges::bidirectional_range](../bidirectional_range.html)<const D> && [ranges::common_range](../common_range.html)<const D>; |  (2)  |  (since C++20)  
| |   
...
1) Let `derived` be static_cast<D&>(*this). Equivalent to return *[ranges::prev](../../iterator/ranges/prev.html)([ranges::end](../end.html)(derived));. The behavior is undefined if [`empty()`](empty.html "cpp/ranges/view interface/empty") is true (i.e. the beginning iterator compares equal to the sentinel), even if the iterator obtained in the same way is dereferenceable.
...
However, following derived types cannot use the default implementations, as they never satisfy neither [`bidirectional_range`](../bidirectional_range.html "cpp/ranges/bidirectional range") nor [`common_range`](../common_range.html "cpp/ranges/common range"): 
