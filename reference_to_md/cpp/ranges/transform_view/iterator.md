...
[transform_view::begin](begin.html "cpp/ranges/transform view/begin")  
...
The return type of [`transform_view::begin`](begin.html "cpp/ranges/transform view/begin"), and of [`transform_view::end`](end.html "cpp/ranges/transform view/end") when the underlying view is a [`common_range`](../common_range.html "cpp/ranges/common range"). 
...
---|---  
`_Parent_` (private) |  `_[maybe-const](../../ranges.html#maybe-const "cpp/ranges")_` ﻿<Const, [ranges::transform_view](../transform_view.html)<V, F>>  
(exposition-only member type*)  
`_Base_` (private) |  `_[maybe-const](../../ranges.html#maybe-const "cpp/ranges")_` ﻿<Const, V>  
(exposition-only member type*)  
`iterator_concept` | 

  * [std::random_access_iterator_tag](../../iterator/iterator_tags.html "cpp/iterator/iterator tags"), if `_Base_` models [`random_access_range`](../random_access_range.html "cpp/ranges/random access range"), 
  * [std::bidirectional_iterator_tag](../../iterator/iterator_tags.html "cpp/iterator/iterator tags"), if `_Base_` models [`bidirectional_range`](../bidirectional_range.html "cpp/ranges/bidirectional range"), 
...
[`forward_range`](../forward_range.html "cpp/ranges/forward range")) |  Let `MCF` be `_[maybe-const](../../ranges.html#maybe-const "cpp/ranges")_` ﻿<Const, F>. 

  * [std::input_iterator_tag](../../iterator/iterator_tags.html "cpp/iterator/iterator tags"), if [std::invoke_result_t](../../types/result_of.html)<MCF&, [ranges::range_reference_t](../range_reference_t.html)<Base>> is not a reference. 

Otherwise, let `_C_` be [std::iterator_traits](../../iterator/iterator_traits.html)<[ranges::iterator_t](../iterator_t.html)<Base>>::iterator_category. 

  * [std::random_access_iterator_tag](../../iterator/iterator_tags.html "cpp/iterator/iterator tags"), if `_C_` is [std::contiguous_iterator_tag](../../iterator/iterator_tags.html "cpp/iterator/iterator tags"); 
  * `_C_`, otherwise. 
...
---|---  
`_current__` (private) |  An iterator into (possibly const-qualified) `V`.  
...
---|---  
[ base](iterator/base.html "cpp/ranges/transform view/iterator/base") |  returns the underlying iterator   
(public member function)  
[ operator*](iterator/operator*.html "cpp/ranges/transform view/iterator/operator*") |  accesses the transformed element   
(public member function)  
[ operator[]](iterator/operator_at.html "cpp/ranges/transform view/iterator/operator at") |  accesses an element by index   
(public member function)  
...
(function)  
---|---  
[ operator+operator-](iterator/operator_arith2.html "cpp/ranges/transform view/iterator/operator arith2")(C++20) |  performs iterator arithmetic   
(function)  
...
[LWG 3798](https://cplusplus.github.io/LWG/issue3798) | C++20  | `iterator_category` is input-only if transformation result is rvalue reference  | may have a stronger category 
