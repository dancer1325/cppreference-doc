...
[transform_view::_sentinel_ ::_sentinel_](sentinel.html "cpp/ranges/transform view/sentinel/sentinel")  
[transform_view::_sentinel_ ::base](base.html "cpp/ranges/transform view/sentinel/base")  
**operator==(transform_view::_iterator_ ,transform_view::_sentinel_)**  
[operator-(transform_view::_iterator_ ,transform_view::_sentinel_)](operator-.html "cpp/ranges/transform view/sentinel/operator-")  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/sentinel/operator_cmp&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  [iterator](../iterator.html "cpp/ranges/transform view/iterator") to compare   
---|---|---  
y  |  \-  |  sentinel to compare   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/sentinel/operator_cmp&action=edit&section=2 "Edit section: Return value")] Return value

x.current_ == y.end_, where `_current__` denotes the underlying iterator, `_end__` denotes the underlying sentinel. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/sentinel/operator_cmp&action=edit&section=3 "Edit section: Example")] Example
