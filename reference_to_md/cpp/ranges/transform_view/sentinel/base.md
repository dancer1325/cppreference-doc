...
**transform_view::_sentinel_ ::base**  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/sentinel/base&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/sentinel/base&action=edit&section=2 "Edit section: Return value")] Return value

a copy of the underlying sentinel 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/sentinel/base&action=edit&section=3 "Edit section: Example")] Example
