...
Equivalent to return ranges::reserve_hint(`_[base_](../transform_view.html#base "cpp/ranges/transform view")_` ﻿);
...
[ size](size.html "cpp/ranges/transform view/size") |  returns the number of elements, provided only if the underlying (adapted) range satisfies [`sized_range`](../sized_range.html "cpp/ranges/sized range")   
