...
---|---|---  
constexpr /*iterator*/<false> end() requires [ranges::common_range](../common_range.html)<V>; |  (2)  |  (since C++20)  
constexpr /*sentinel*/<true> end() const  
requires [ranges::range](../range.html)<const V> &&  
[std::regular_invocable](../../concepts/invocable.html)<const F&, [ranges::range_reference_t](../range_reference_t.html)<const V>>; |  (3)  |  (since C++20)  
constexpr /*iterator*/<true> end() const  
requires [ranges::common_range](../common_range.html)<const V> &&  
[std::regular_invocable](../../concepts/invocable.html)<const F&, [ranges::range_reference_t](../range_reference_t.html)<const V>>; |  (4)  |  (since C++20)  
| |   
  
Returns a [sentinel](sentinel.html "cpp/ranges/transform view/sentinel") or an [iterator](iterator.html "cpp/ranges/transform view/iterator") representing the end of the `transform_view`. 

Equivalent to: 

1) return` `[` _sentinel_`](sentinel.html "cpp/ranges/transform view/sentinel") <false>{[ranges::end](../end.html)(`_[base_](../transform_view.html#base "cpp/ranges/transform view")_`);.

2) return` `[` _iterator_`](iterator.html "cpp/ranges/transform view/iterator") <false>{*this, [ranges::end](../end.html)(`_[base_](../transform_view.html#base "cpp/ranges/transform view")_`)};.

3) return` `[` _sentinel_`](sentinel.html "cpp/ranges/transform view/sentinel") <true>{[ranges::end](../end.html)(`_[base_](../transform_view.html#base "cpp/ranges/transform view")_`)};.

4) return` `[` _iterator_`](iterator.html "cpp/ranges/transform view/iterator") <true>{*this, [ranges::end](../end.html)(`_[base_](../transform_view.html#base "cpp/ranges/transform view")_`)};.
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/end&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/end&action=edit&section=2 "Edit section: Return value")] Return value

1,3) sentinel which compares equal to the end iterator

2,4) iterator to the element following the last element

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/end&action=edit&section=3 "Edit section: Notes")] Notes

`end()` returns an iterator if and only if the underlying view is a [`common_range`](../common_range.html "cpp/ranges/common range"): transform_view<V,F> models [`common_range`](../common_range.html "cpp/ranges/common range") whenever `V` does. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/end&action=edit&section=4 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/end&action=edit&section=5 "Edit section: See also")] See also

[ begin](begin.html "cpp/ranges/transform view/begin") |  returns an iterator to the beginning   
