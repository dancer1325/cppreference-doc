...
1) Equivalent to return x.current_ == y.current_;, where `_current__` is the underlying iterator.

2) Equivalent to return x.current_ < y.current_;, where `_current__` is the underlying iterator.
