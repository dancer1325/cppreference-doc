...
**transform_view::_iterator_ ::_iterator_**  
[transform_view::_iterator_ ::base](base.html "cpp/ranges/transform view/iterator/base")  
...
/*iterator*/()  
requires [std::default_initializable](../../../concepts/default_initializable.html)<[ranges::iterator_t](../../iterator_t.html)<Base>> = default; |  (1)  |  (since C++20)  
---|---|---  
constexpr /*iterator*/( Parent& parent, [ranges::iterator_t](../../iterator_t.html)<Base> current ); |  (2)  |  (since C++20)  
constexpr /*iterator*/( /*iterator*/<!Const> i )  
requires Const &&  
[std::convertible_to](../../../concepts/convertible_to.html)<[ranges::iterator_t](../../iterator_t.html)<V>, [ranges::iterator_t](../../iterator_t.html)<Base>>; |  (3)  |  (since C++20)  
| |   
  
Construct an iterator. 

1) Default constructor. [Value-initializes](../../../language/value_initialization.html "cpp/language/value initialization") the underlying iterator, and initializes the pointer to parent `transform_view` with nullptr.

2) Initializes the underlying iterator with std::move(current), and the pointer to parent with [std::addressof](../../../memory/addressof.html)(parent).

3) Conversion from /*iterator*/<false> to /*iterator*/<true>. Move constructs corresponding members.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/iterator/iterator&action=edit&section=1 "Edit section: Parameters")] Parameters

parent  |  \-  |  a (possibly const-qualified) [std::ranges::transform_view](../../transform_view.html "cpp/ranges/transform view")  
---|---|---  
current  |  \-  |  an iterator into (possibly const-qualified) `V`  
i  |  \-  |  an /*iterator*/<false>  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/iterator/iterator&action=edit&section=2 "Edit section: Example")] Example
