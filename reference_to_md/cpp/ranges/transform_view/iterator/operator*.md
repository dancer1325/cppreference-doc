...
Effectively returns [std::invoke](../../../utility/functional/invoke.html)(*parent_->fun_, *current_), where `*parent_->fun_` is the transformation function stored in the parent `transform_view`, and `current_` is the underlying iterator into `V`. 
