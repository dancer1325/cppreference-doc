...
**iter_move(transform_view::_iterator_)**  
...
If *i is an lvalue reference, returns [`std::move`](../../../utility/move.html "cpp/utility/move")(*i); otherwise returns *i. 
...
noexcept(noexcept([std::invoke](../../../utility/functional/invoke.html)(*i.parent_->fun_, *i.current_)))
