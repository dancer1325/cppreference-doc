...
[transform_view::_iterator_ ::_iterator_](iterator.html "cpp/ranges/transform view/iterator/iterator")  
**transform_view::_iterator_ ::base**  
[transform_view::_iterator_ ::operator*](operator*.html "cpp/ranges/transform view/iterator/operator*")  
[transform_view::_iterator_ ::operator[]](operator_at.html "cpp/ranges/transform view/iterator/operator at")  
[transform_view::_iterator_ ::operator++  
transform_view::_iterator_ ::operator++(int)  
transform_view::_iterator_ ::operator--  
transform_view::_iterator_ ::operator--(int)  
transform_view::_iterator_ ::operator+=  
transform_view::_iterator_ ::operator-=](operator_arith.html "cpp/ranges/transform view/iterator/operator arith")  
[operator==(transform_view::_iterator_)  
operator<(transform_view::_iterator_)  
operator>(transform_view::_iterator_)  
operator<=(transform_view::_iterator_)  
operator>=(transform_view::_iterator_)  
operator<=>(transform_view::_iterator_)](operator_cmp.html "cpp/ranges/transform view/iterator/operator cmp")  
[operator+(transform_view::_iterator_)  
operator-(transform_view::_iterator_)](operator_arith2.html "cpp/ranges/transform view/iterator/operator arith2")  
[iter_move(transform_view::_iterator_)](iter_move.html "cpp/ranges/transform view/iterator/iter move")  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/iterator/base&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/iterator/base&action=edit&section=2 "Edit section: Return value")] Return value

1) A reference to the underlying iterator.

2) An iterator move constructed from the underlying iterator.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/iterator/base&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        std::[ranges::transform_view](../../transform_view.html) tv{ v, x2 };
        [std::ostream_iterator](../../../iterator/ostream_iterator.html)<int> ostr{ [std::cout](../../../io/cout.html), " " };
     
        std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(v, ostr), [std::cout](../../../io/cout.html) << '\n';
        std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(tv.base(), ostr), [std::cout](../../../io/cout.html) << '\n';
        std::[ranges::copy](http://en.cppreference.com/w/cpp/ranges-algorithm-placeholder/copy)(tv, ostr), [std::cout](../../../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/iterator/base&action=edit&section=4 "Edit section: Defect reports")] Defect reports
