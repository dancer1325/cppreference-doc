...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/begin&action=edit&section=1 "Edit section: Return value")] Return value

Iterator to the first element. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/begin&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/begin&action=edit&section=3 "Edit section: See also")] See also
