...
1) Copy constructs the result from the underlying view `_[base_](../transform_view.html#base "cpp/ranges/transform view")_`.

2) Move constructs the result from the underlying view `_[base_](../transform_view.html#base "cpp/ranges/transform view")_`.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/base&action=edit&section=1 "Edit section: Return value")] Return value

A copy of the underlying view. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/base&action=edit&section=2 "Edit section: Example")] Example
