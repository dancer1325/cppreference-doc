...
The return type of [`slide_view::end`](end.html "cpp/ranges/slide view/end") when the underlying view is not a [`common_range`](../common_range.html "cpp/ranges/common range"). 
