...
The return type of [`slide_view::begin`](begin.html "cpp/ranges/slide view/begin"), and of [`slide_view::end`](end.html "cpp/ranges/slide view/end") when the underlying view `V` is a [`common_range`](../common_range.html "cpp/ranges/common range"). 
...
---|---  
`_current__` (private) |  [ranges::iterator_t](../iterator_t.html)<Base>, holds an iterator to the first underlying element of the current window in [`slide_view`](../slide_view.html "cpp/ranges/slide view")  
(exposition-only member object*)  
`_last_ele__` (private)   
(conditionally present) |  [ranges::iterator_t](../iterator_t.html)<Base>, holds an iterator to the one-past-end underlying element of the current window in [`slide_view`](../slide_view.html "cpp/ranges/slide view"). Present only if [`_Base_`](iterator.html#Member_types) models /*slide-caches-first*/.  
(exposition-only member object*)  
...
---|---  
[ operator*](iterator/operator*.html "cpp/ranges/slide view/iterator/operator*") |  accesses the element   
(public member function)  
