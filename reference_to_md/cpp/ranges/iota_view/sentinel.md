...
[ranges::iota_view](../iota_view.html)<W, Bound>::`_sentinel_` is the type of the reachable sentinels returned by [`end()`](end.html "cpp/ranges/iota view/end") of [ranges::iota_view](../iota_view.html)<W, Bound>. 

## Contents

  * [1 Data members](sentinel.html#Data_members)
  * [2 Member functions](sentinel.html#Member_functions)
  * [3 std::ranges::iota_view::_sentinel_ ::_sentinel_](sentinel.html#std::ranges::iota_view::sentinel::sentinel)
    * [3.1 Non-member functions](sentinel.html#Non-member_functions)
  * [4 operator==(std::ranges::iota_view::_iterator_ , std::ranges::iota_view::_sentinel_)](sentinel.html#operator.3D.3D.28std::ranges::iota_view::iterator.2C_std::ranges::iota_view::sentinel.29)
  * [5 operator-(std::ranges::iota_view::_iterator_ , std::ranges::iota_view::_sentinel_)](sentinel.html#operator-.28std::ranges::iota_view::iterator.2C_std::ranges::iota_view::sentinel.29)
    * [5.1 Example](sentinel.html#Example)
...
1) Value-initializes `_[bound_](sentinel.html#bound)_` ﻿.
...
Returns x.`_[value_](iterator.html#value "cpp/ranges/iota view/iterator")_`` `== y.`_[bound_](sentinel.html#bound)_`. 
...
friend constexpr [std::iter_difference_t](../../iterator/iter_t.html)<W>  
operator-(const /*iterator*/& x, const /*sentinel*/& y)  
requires [std::sized_sentinel_for](../../iterator/sized_sentinel_for.html)<Bound, W>; |  (1)  |  (since C++20)  
---|---|---  
friend constexpr [std::iter_difference_t](../../iterator/iter_t.html)<W>  
operator-(const /*sentinel*/& x, const /*iterator*/& y)  
requires [std::sized_sentinel_for](../../iterator/sized_sentinel_for.html)<Bound, W>; |  (2)  |  (since C++20)  
| |   
  
1) Returns x.`_[value_](iterator.html#value "cpp/ranges/iota view/iterator")_`` `- y.`_[bound_](sentinel.html#bound)_`.

2) Returns -(y.`_[value_](iterator.html#value "cpp/ranges/iota view/iterator")_`` `- x.`_[bound_](sentinel.html#bound)_` ﻿).
