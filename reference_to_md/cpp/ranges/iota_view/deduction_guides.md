...
This [deduction guide](../../language/ctad.html "cpp/language/class template argument deduction") is provided for [`iota_view`](../iota_view.html "cpp/ranges/iota view") to allow deduction from an initial value and a bounding value. 

For the definitions of /*is-integer-like*/ and /*is-signed-integer-like*/, see [`_is-integer-like_`](../../iterator/is-integer-like.html "cpp/iterator/is-integer-like") ﻿. 

Note that the guide protects itself against bugs arising from sign mismatch, like [views::iota](../iota_view.html)(0, v.size()), where ​0​ is signed and v.size() is unsigned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/iota_view/deduction_guides&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto io = std::[ranges::iota_view](../iota_view.html)(1L, 7L); // deduces W and Bound as “long”
        [assert](../../error/assert.html)(io.front() == 1L and io.back() == 6L);
    }
