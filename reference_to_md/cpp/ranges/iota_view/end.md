...
---|---|---  
constexpr /*iterator*/ end() const requires [std::same_as](../../concepts/same_as.html)<W, Bound>; |  (2)  |  (since C++20)  
| |   
  
1) Obtains a [sentinel](sentinel.html "cpp/ranges/iota view/sentinel") representing the sentinel value: 

  * If `Bound` is [std::unreachable_sentinel_t](../../iterator/unreachable_sentinel_t.html "cpp/iterator/unreachable sentinel t"), returns [std::unreachable_sentinel](../../iterator/unreachable_sentinel_t.html). 
  * Otherwise, returns [`_sentinel_`](sentinel.html "cpp/ranges/iota view/sentinel") ﻿{`_[bound_](../iota_view.html#bound "cpp/ranges/iota view")_` ﻿}.



2) Obtains an [iterator](iterator.html "cpp/ranges/iota view/iterator") to the sentinel value.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/iota_view/end&action=edit&section=1 "Edit section: Return value")] Return value

1) As specified above.

2) [`_iterator_`](iterator.html "cpp/ranges/iota view/iterator") ﻿{`_[bound_](../iota_view.html#bound "cpp/ranges/iota view")_` ﻿}

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/iota_view/end&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto iota{std::[views::iota](../iota_view.html)(2, 6)};
        auto end{iota.end()};
