...
[std::sized_sentinel_for](../../iterator/sized_sentinel_for.html)<Bound, W>; |  |  (since C++20)  
---|---|---  
| |   
  
Returns the size of the view if the view is bounded. 

For the definitions of /*advanceable*/ and /*is-integer-like*/, see `_[advanceable](iterator.html#advanceable "cpp/ranges/iota view/iterator")_` and [`_is-integer-like_`](../../iterator/is-integer-like.html "cpp/iterator/is-integer-like") respectively. 

## Contents

  * [1 Return value](size.html#Return_value)
  * [2 Example](size.html#Example)
  * [3 Defect reports](size.html#Defect_reports)
...
Otherwise, returns  (`_[value_](../iota_view.html#value "cpp/ranges/iota view")_`` `< 0) ?  
` `(  
` `(`_[bound_](../iota_view.html#bound "cpp/ranges/iota view")_`` `< 0) ?  
` `` _[to-unsigned-like](../../ranges.html#to-unsigned-like "cpp/ranges")_` ﻿(-`_[value_](../iota_view.html#value "cpp/ranges/iota view")_` ﻿) -` `` _[to-unsigned-like](../../ranges.html#to-unsigned-like "cpp/ranges")_` ﻿(-`_[bound_](../iota_view.html#bound "cpp/ranges/iota view")_` ﻿) :  
...
Run this code
    ...
    int main()
    {
        ...
        auto i{std::[views::iota](../iota_view.html)(initial_value, bound)};
        [assert](../../error/assert.html)(i.size() == bound - initial_value and i.size() == 4);
     
        auto u{std::[views::iota](../iota_view.html)(8)};
