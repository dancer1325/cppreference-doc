...
## Contents
  ...
  * [2 Example](empty.html#Example)
  * [3 Defect reports](empty.html#Defect_reports)
...
Run this code
    ...
    int main()
    {
        auto a = std::[ranges::iota_view](../iota_view.html)<int, int>();
        [assert](../../error/assert.html)(a.empty());
     
        auto b = std::[ranges::iota_view](../iota_view.html)(4);
        [assert](../../error/assert.html)(!b.empty());
     
        auto c = std::[ranges::iota_view](../iota_view.html)(4, 8);
