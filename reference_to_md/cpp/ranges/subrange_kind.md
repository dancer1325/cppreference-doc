...
Enumerator  |  Meaning   
---|---  
`unsized` |  specifies that the `subrange` does not model [`sized_range`](sized_range.html "cpp/ranges/sized range")  
`sized` |  specifies that the `subrange` does model [`sized_range`](sized_range.html "cpp/ranges/sized range")
