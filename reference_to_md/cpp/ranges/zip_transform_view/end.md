...
[ranges::range_reference_t](../range_reference_t.html)<const Views>...>; |  (2)  |  (since C++23)  
| |   
  
Returns an [iterator](iterator.html "cpp/ranges/zip transform view/iterator") or a [sentinel](sentinel.html "cpp/ranges/zip transform view/sentinel") that compares equal to the end iterator of the [`zip_transform_view`](../zip_transform_view.html "cpp/ranges/zip transform view"). 
