...
Member functions  
**zip_transform_view::_sentinel_ ::_sentinel_**  
Non-member functions  
...
requires Const &&  
[std::convertible_to](../../../concepts/convertible_to.html)</*zentinel*/<false>, /*zentinel*/<Const>>; |  (2)  |  (since C++23)  
constexpr explicit /*sentinel*/( /*zentinel*/<Const> inner ); |  (3)  |  (exposition only*)  
| |   
  
Constructs a sentinel. 

1) Default constructor. [Default-initializes](../../../language/default_initialization.html "cpp/language/default initialization") the underlying sentinel object [`_inner__`](../sentinel.html#Data_members "cpp/ranges/zip transform view/sentinel").

2) Conversion from /*sentinel*/<false> to /*sentinel*/<true>. Move constructs the underlying object `_inner__` with std::move(i.inner_).
