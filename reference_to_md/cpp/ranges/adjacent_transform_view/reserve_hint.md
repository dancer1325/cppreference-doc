...
**adjacent_transform_view::reserve_hint**(C++26)  
...
requires ranges::approximately_sized_range</*InnerView*/> |  (1)  |  (since C++26)  
---|---|---  
constexpr auto reserve_hint() const  
requires ranges::approximately_sized_range<const /*InnerView*/> |  (2)  |  (since C++26)  
| |   
  
Equivalent to return` `` _[inner_](../adjacent_transform_view.html#inner "cpp/ranges/adjacent transform view")_`.reserve_hint();. 
...
[ size](size.html "cpp/ranges/adjacent transform view/size") |  returns the number of elements, provided only if the underlying (adapted) range satisfies [`sized_range`](../sized_range.html "cpp/ranges/sized range")   
