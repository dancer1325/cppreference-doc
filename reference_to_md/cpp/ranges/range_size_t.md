...
---  
| **range_size_t range_difference_trange_value_t**  
---  
...
---|---|---  
template< [ranges::sized_range](sized_range.html) R >  
using range_size_t = decltype([ranges::size](size.html)([std::declval](../utility/declval.html)<R&>())); |  (1)  |  (since C++20)  
template< [ranges::range](range.html) R >  
using range_difference_t = [std::iter_difference_t](../iterator/iter_t.html)<[ranges::iterator_t](iterator_t.html)<R>>; |  (2)  |  (since C++20)  
template< [ranges::range](range.html) R >  
using range_value_t = [std::iter_value_t](../iterator/iter_t.html)<[ranges::iterator_t](iterator_t.html)<R>>; |  (3)  |  (since C++20)  
| |   
  
1) Used to obtain the size type of the [`sized_range`](sized_range.html "cpp/ranges/sized range") type `R`.
