...
operator-( const /* iterator */& i, const /* iterator */& j ) noexcept; |  (4)  |  (since C++23)  
| |   
  
Performs [iterator](../iterator.html "cpp/ranges/enumerate view/iterator") arithmetic or calculates the distance. 

[`_pos__`](../iterator.html#Data_members "cpp/ranges/enumerate view/iterator") is the underlying index, and [`_Base_`](../iterator.html#Member_types "cpp/ranges/enumerate view/iterator") is the (possibly const-qualified) type of underlying view. 
...
## Contents
  ...
  * [5 See also](operator_arith2.html#See_also)
