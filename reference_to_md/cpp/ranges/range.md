...
[ranges::begin](begin.html)(t); // equality-preserving for forward iterators  
[ranges::end](end.html) (t);  
}; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Semantic requirements](range.html#Semantic_requirements)
  * [2 Notes](range.html#Notes)
  * [3 Example](range.html#Example)
  * [4 Defect reports](range.html#Defect_reports)
...
Given an expression E such that decltype((E)) is `T`, `T` models `range` only if 
  ...
  * `[`[ranges::begin](begin.html)(E)`, `[ranges::end](end.html)(E)`)` denotes a [range](../iterator.html#Ranges "cpp/iterator"), and 
  * both [ranges::begin](begin.html)(E) and [ranges::end](end.html)(E) are amortized constant time and do not alter the value of E in a manner observable to [equality-preserving](../concepts.html#Equality_preservation "cpp/concepts") expressions, and 
  * if the type of [ranges::begin](begin.html)(E) models [`forward_iterator`](../iterator/forward_iterator.html "cpp/iterator/forward iterator"), [ranges::begin](begin.html)(E) is [equality-preserving](../concepts.html#Equality_preservation "cpp/concepts") (in other words, forward iterators support multi-pass algorithms). 
...
A typical `range` class only needs to provide two functions: 
  ...
  1. A member function `begin()` whose return type models [`input_or_output_iterator`](../iterator/input_or_output_iterator.html "cpp/iterator/input or output iterator"). 
  2. A member function `end()` whose return type models [`sentinel_for`](../iterator/sentinel_for.html "cpp/iterator/sentinel for")`<It>`, where `It` is the return type of `begin()`. 
...
---|---|---|---  
[LWG 3915](https://cplusplus.github.io/LWG/issue3915) | C++20  | [ranges::begin](begin.html)(t) and [ranges::end](end.html)(t)  
