...
Run this code
    ...
     
        const auto p = [std::distance](../../iterator/distance.html)([ranges::begin](../begin.html)(url), [ranges::find](../../algorithm/ranges/find.html)(url, '/'));
        auto site = [ranges::drop_view](../drop_view.html){url, p + 2}; // drop the prefix "https://"
     
