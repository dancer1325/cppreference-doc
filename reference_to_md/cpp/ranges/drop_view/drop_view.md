...
---|---|---  
constexpr explicit drop_view( V base, [ranges::range_difference_t](../range_size_t.html)<V> count ); |  (2)  |  (since C++20)  
| |   
  
Constructs a `drop_view`. 

1) Default constructor. [Value-initializes](../../language/value_initialization.html "cpp/language/value initialization") the underlying view `_[base_](../drop_view.html#base "cpp/ranges/drop view")_` and initializes the count `_[count_](../drop_view.html#count "cpp/ranges/drop view")_` to ​0​. After construction, [`base()`](base.html "cpp/ranges/drop view/base") returns a copy of V() and [`size()`](size.html "cpp/ranges/drop view/size") equals to the size of the underlying view.
...
Run this code
    ...
    int main()
    {
        constexpr [std::array](../../container/array.html) hi{'H', 'e', 'l', 'l', 'o', ',',
                                ' ', 'C', '+', '+', '2', '0'};
     
        std::[ranges::for_each](../../algorithm/ranges/for_each.html)(hi, [](const char c){ [std::cout](../../io/cout.html) << c; });
        [std::cout](../../io/cout.html) << '\n';
     
        constexpr auto n = [std::distance](../../iterator/distance.html)(hi.cbegin(), std::[ranges::find](../../algorithm/ranges/find.html)(hi, 'C'));
     
        auto cxx = std::[ranges::drop_view](../drop_view.html){hi, n};
     
        std::[ranges::for_each](../../algorithm/ranges/for_each.html)(cxx, [](const char c){ [std::cout](../../io/cout.html) << c; });
        [std::cout](../../io/cout.html) << '\n';
    }
