...
1) Copy constructs the result from the underlying view `_[base_](../drop_view.html#base "cpp/ranges/drop view")_`.
...
Run this code
    ...
    int main()
    {
        ...
        constexpr auto view = a | std::[views::drop](../drop_view.html)(2);
        stq::println("{}", view);
