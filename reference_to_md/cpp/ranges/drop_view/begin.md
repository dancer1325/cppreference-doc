...
[drop_view::size](size.html "cpp/ranges/drop view/size")  
...
[ranges::random_access_range](../random_access_range.html)<const V> &&  
[ranges::sized_range](../sized_range.html)<const V>)); |  (1)  |  (since C++20)  
---|---|---  
constexpr auto begin() const  
requires [ranges::random_access_range](../random_access_range.html)<const V> &&  
[ranges::sized_range](../sized_range.html)<const V>; |  (2)  |  (since C++20)  
| |   
  
Returns an iterator to the first element of the `drop_view`, that is, an iterator to the _N_ _th_ element of the underlying view, or to the end of the underlying view if it has less than _N_ elements. 

If `V` is not a [`random_access_range`](../random_access_range.html "cpp/ranges/random access range") or a [`sized_range`](../sized_range.html "cpp/ranges/sized range"), in order to provide the amortized constant time complexity required by the [`range`](../range.html "cpp/ranges/range") concept, the overload (1) caches the result within the underlying `_[cache_](../drop_view.html#cache "cpp/ranges/drop view")_` object for use on subsequent calls. 
...
Run this code
    ...
    #include <ranges>
     
    void println(std::[ranges::range](../range.html) auto const& range)
    {
    ...
    int main()
    {
        [std::array](../../container/array.html) hi{'H', 'e', 'l', 'l', 'o', ',', ' ', 'C', '+', '+', '2', '0', '!'};
        println(hi);
     
        const auto pos = [std::distance](../../iterator/distance.html)(hi.begin(), std::[ranges::find](../../algorithm/ranges/find.html)(hi, 'C'));
        auto cxx = std::[ranges::drop_view](../drop_view.html){hi, pos};
        [std::cout](../../io/cout.html) << "*drop_view::begin() == '" << *cxx.begin() << "'\n";
