...
[ranges::forward_range](forward_range.html)<T> && [std::bidirectional_iterator](../iterator/bidirectional_iterator.html)<[ranges::iterator_t](iterator_t.html)<T>>; |  |  (since C++20)  
| |   
...
Run this code
    ...
    {
        static_assert(
                std::ranges::bidirectional_range<[std::set](../container/set.html)<int>> and
            not std::ranges::bidirectional_range<[std::unordered_set](../container/unordered_set.html)<int>> and
                std::ranges::bidirectional_range<[std::list](../container/list.html)<int>> and
            not std::ranges::bidirectional_range<[std::forward_list](../container/forward_list.html)<int>>
        );
    }
