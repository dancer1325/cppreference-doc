...
The return type of [`split_view::end`](../split_view.html "cpp/ranges/split view") when the underlying [`view`](../view.html "cpp/ranges/view") type `V` does not models [`common_range`](../common_range.html "cpp/ranges/common range"). 

## Contents

  * [1 Data members](sentinel.html#Data_members)
  * [2 Member functions](sentinel.html#Member_functions)
  * [3 std::ranges::split_view::_sentinel_ ::_sentinel_](sentinel.html#std::ranges::split_view::sentinel::sentinel)
    * [3.1 Non-member functions](sentinel.html#Non-member_functions)
  * [4 operator==(std::ranges::split_view::_iterator_ , std::ranges::split_view::_sentinel_)](sentinel.html#operator.3D.3D.28std::ranges::split_view::iterator.2C_std::ranges::split_view::sentinel.29)
...
---|---|---  
constexpr explicit /*sentinel*/( [ranges::split_view](../split_view.html)& parent ); |  (2)  |  (since C++20)  
| |   
  
1) Value-initializes `_[end_](sentinel.html#end)_` via its default member initializer (= [ranges::sentinel_t](../iterator_t.html)<V>()).
