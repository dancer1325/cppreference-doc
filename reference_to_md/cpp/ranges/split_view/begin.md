...
Returns an [iterator](iterator.html "cpp/ranges/split view/iterator") to the first found subrange. 

In order to provide the amortized constant time complexity required by the [`range`](../range.html "cpp/ranges/range") concept, this function caches the result within the `split_view` (by means of `_[cached_begin_](../split_view.html#cached_begin "cpp/ranges/split view")_` member) for use on subsequent calls. 

Let `_[base_](../split_view.html#base "cpp/ranges/split view")_` be the underlying data member. Equivalent to: 
    
    
    constexpr /*iterator*/ begin()
    {
        if (!cached_begin_.has_value())
            cached_begin_ = this->find_next([ranges::begin](../begin.html)(base_));
        return {*this, [ranges::begin](../begin.html)(base_), cached_begin_.value()};
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/split_view/begin&action=edit&section=1 "Edit section: Return value")] Return value

An [iterator](iterator.html "cpp/ranges/split view/iterator"). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/split_view/begin&action=edit&section=2 "Edit section: Complexity")] Complexity

Amortized \\(\scriptsize \mathcal{O}(1)\\)O(1). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/split_view/begin&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr [std::string_view](../../string/basic_string_view.html) sentence{"Keep..moving..forward.."};
        constexpr [std::string_view](../../string/basic_string_view.html) delim{".."};
        std::[ranges::split_view](../split_view.html) words{sentence, delim};
     
        [std::cout](../../io/cout.html) << "begin(): " << [std::quoted](../../io/manip/quoted.html)([std::string_view](../../string/basic_string_view.html){*words.begin()})
                  << "\nSubstrings: ";
        for (auto word : words)
            [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)([std::string_view](../../string/basic_string_view.html)(word)) << ' ';
     
        std::[ranges::split_view](../split_view.html) letters{sentence, [std::string_view](../../string/basic_string_view.html){""}};
        [std::cout](../../io/cout.html) << "\nbegin(): " << [std::quoted](../../io/manip/quoted.html)([std::string_view](../../string/basic_string_view.html){*letters.begin()})
                  << "\nLetters: ";
        for (auto letter : letters)
            [std::cout](../../io/cout.html) << [std::string_view](../../string/basic_string_view.html)(letter) << ' ';
        [std::cout](../../io/cout.html) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/split_view/begin&action=edit&section=4 "Edit section: See also")] See also

[ end](end.html "cpp/ranges/split view/end") |  returns an iterator or a sentinel to the end   
...
(public member function of `std::ranges::lazy_split_view<V,Pattern>`) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/ranges/adaptor/dsc_begin&action=edit)  
