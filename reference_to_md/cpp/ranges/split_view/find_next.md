...
auto [b, e] = [ranges::search](../../algorithm/ranges/search.html)([ranges::subrange](../subrange.html)(it, [ranges::end](../end.html)(`_[base_](../split_view.html#base "cpp/ranges/split view")_`)),` `` _[pattern_](../split_view.html#pattern "cpp/ranges/split view")_`);  
  
if (b != [ranges::end](../end.html)(`_[base_](../split_view.html#base "cpp/ranges/split view")_`) and [ranges::empty](../empty.html)(`_[pattern_](../split_view.html#pattern "cpp/ranges/split view")_`))  
{  
++b;  
++e;  
}  
