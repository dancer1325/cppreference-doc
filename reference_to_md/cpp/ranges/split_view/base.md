...
Returns a copy of the underlying view `_[base_](../split_view.html#base "cpp/ranges/split view")_`. 
...
Run this code
    ...
    int main()
    {
        constexpr [std::string_view](../../string/basic_string_view.html) keywords{"this throw true try typedef typeid"};
        std::[ranges::split_view](../split_view.html) split_view{keywords, ' '};
        [std::cout](../../io/cout.html) << "base() = " << [std::quoted](../../io/manip/quoted.html)(split_view.base()) << "\n"
                     "substrings: ";
        for (auto split : split_view)
            [std::cout](../../io/cout.html) << [std::quoted](../../io/manip/quoted.html)([std::string_view](../../string/basic_string_view.html){split}) << ' ';
