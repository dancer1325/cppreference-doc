...
Returns an [iterator](iterator.html "cpp/ranges/split view/iterator") or a [sentinel](sentinel.html "cpp/ranges/split view/sentinel") representing the end of the resulting subrange. Equivalent to: 

constexpr auto end()  
{  
if constexpr ([ranges::common_range](../common_range.html)<V>)  
return` `[` _iterator_`](iterator.html "cpp/ranges/split view/iterator"){*this, [ranges::end](../end.html)(`_[base_](../split_view.html#base "cpp/ranges/split view")_`), {}};  
else  
...
Run this code
    ...
    int main()
    {
        constexpr [std::string_view](../../string/basic_string_view.html) keywords{"bitand bitor bool break"};
        std::[ranges::split_view](../split_view.html) kw{keywords, ' '};
