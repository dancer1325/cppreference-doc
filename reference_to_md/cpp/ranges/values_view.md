...
---|---|---  
template< class R >  
using values_view = [ranges::elements_view](elements_view.html)<R, 1>; |  (1)  |  (since C++20)  
namespace views {  
inline constexpr auto values = ranges::elements<1>;  
} |  (2)  |  (since C++20)  
| |   
  
Takes a [`view`](view.html "cpp/ranges/view") of _tuple-like_ values (e.g. [std::tuple](../utility/tuple.html "cpp/utility/tuple") or [std::pair](../utility/pair.html "cpp/utility/pair")), and produces a view with a _value-type_ of the _second_ element of the adapted view's value-type. 

1) An alias for [ranges::elements_view](elements_view.html)<R, 1>.

2) [RangeAdaptorObject](../named_req/RangeAdaptorObject.html "cpp/named req/RangeAdaptorObject") (and also [RangeAdaptorClosureObject](../named_req/RangeAdaptorClosureObject.html "cpp/named req/RangeAdaptorClosureObject")). The expression views::values(e) is [expression-equivalent](../language/expressions.html#Expression-equivalence "cpp/language/expressions") to values_view<[views::all_t](all_view.html)<decltype((e))>>{e} for any suitable subexpression e.

## Contents

  * [1 Notes](values_view.html#Notes)
  * [2 Example](values_view.html#Example)
  * [3 Defect reports](values_view.html#Defect_reports)
  * [4 See also](values_view.html#See_also)
...
values_view can be useful for extracting _values_ from associative containers, e.g. 
    ...
    [std::map](../container/map.html)<int, [std::string](../string/basic_string.html)> map{{1, "alpha"}, {2, "beta"}};
...
Run this code
    ...
    int main()
    {
        const auto list = {[std::pair](../utility/pair.html){1, 11.1}, {2, 22.2}, {3, 33.3}};
        [std::cout](../io/cout.html) << "pair::second values in the list: ";
        for (double value : list | std::views::values)
            [std::cout](../io/cout.html) << value << ' ';
     
        [std::map](../container/map.html)<char, int> map{{'A', 1}, {'B', 2}, {'C', 3}, {'D', 4}, {'E', 5}};
        auto odd = [](int x) { return 0 != (x & 1); };
        [std::cout](../io/cout.html) << "\nodd values in the map: ";
        for (int value : map | std::views::values | std::[views::filter](filter_view.html)(odd))
            [std::cout](../io/cout.html) << value << ' ';
        [std::cout](../io/cout.html) << '\n';
    }
