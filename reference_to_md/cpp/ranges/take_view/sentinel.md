...
The return type of [`take_view::end`](end.html "cpp/ranges/take view/end") when the underlying view is not a [`sized_range`](../sized_range.html "cpp/ranges/sized range"). 
