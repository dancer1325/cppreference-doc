...
1) Copy constructs the result from the underlying view [`_base__`](../take_view.html#Data_members "cpp/ranges/take view").

2) Move constructs the result from the underlying view `_base__`.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/take_view/base&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/take_view/base&action=edit&section=2 "Edit section: Return value")] Return value

A copy of the underlying view. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/take_view/base&action=edit&section=3 "Edit section: Example")] Example
