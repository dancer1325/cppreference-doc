...
| **range_reference_t range_const_reference_trange_rvalue_reference_trange_common_reference_t**(C++23)  
---  
...
using range_reference_t = [std::iter_reference_t](../iterator/iter_t.html)<[ranges::iterator_t](iterator_t.html)<R>>; |  (1)  |  (since C++20)  
template< [ranges::range](range.html) R >  
using range_const_reference_t =  
[std::iter_const_reference_t](../iterator/iter_t.html)<[ranges::iterator_t](iterator_t.html)<R>>; |  (2)  |  (since C++23)  
template< [ranges::range](range.html) R >  
using range_rvalue_reference_t =  
[std::iter_rvalue_reference_t](../iterator/iter_t.html)<[ranges::iterator_t](iterator_t.html)<R>>; |  (3)  |  (since C++20)  
template< [ranges::range](range.html) R >  
using range_common_reference_t =  
[std::iter_common_reference_t](../iterator/iter_t.html)<[ranges::iterator_t](iterator_t.html)<R>>; |  (4)  |  (since C++20)  
| |   
