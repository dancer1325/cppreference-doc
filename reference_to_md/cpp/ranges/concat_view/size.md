...
requires(sized_range<const Views> && ...); |  (2)  |  (since C++26)  
| |   
  
Returns the number of elements. 

Equivalent to  return [std::apply](../../utility/apply.html)  
` `(  
` `[](auto... sizes)  
` `{  
` `using CT = [ranges::common_type_t](../../experimental/ranges/type_traits/common_type.html)<decltype(sizes)...>;  
` `return (`_[make-unsigned-like-t](../../ranges.html#make-unsigned-like-t "cpp/ranges")_` ﻿<CT>(sizes) + ...);  
` `},  
` `` _[tuple-transform](../../ranges.html#tuple-transform "cpp/ranges")_` ﻿([ranges::size](../size.html),` `` _[views_](../concat_view.html#views "cpp/ranges/concat view")_` ﻿)  
` `); . 
...
Run this code
    ...
     
        constexpr auto con{std::[views::concat](../concat_view.html)(a, b, c)};
        static_assert(std::[ranges::sized_range](../sized_range.html)<decltype(con)>);
        static_assert(con.size() == 2 + 3 + 4);
     
        [std::forward_list](../../container/forward_list.html) d = b;
        static_assert(not std::[ranges::sized_range](../sized_range.html)<[std::forward_list](../../container/forward_list.html)<int>>);
        const auto cat{std::[views::concat](../concat_view.html)(b, c, d)};
        static_assert(not std::[ranges::sized_range](../sized_range.html)<decltype(cat)>);
    //  auto x = cat.size(); // error: cat is not sized_range because of d
     
        [std::list](../../container/list.html) e = c;
        const auto dog{std::[views::concat](../concat_view.html)(a, b, e)};
        static_assert(std::[ranges::sized_range](../sized_range.html)<decltype(dog)>);
