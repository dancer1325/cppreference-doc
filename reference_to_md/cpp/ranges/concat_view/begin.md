...
Returns an [iterator](iterator.html "cpp/ranges/concat view/iterator") to the beginning of the [`concat_view`](../concat_view.html "cpp/ranges/concat view"). 

1) Equivalent to  [`_iterator_`](iterator.html "cpp/ranges/concat view/iterator") ﻿<false> it(this, [std::in_place_index](../../utility/in_place.html)<0>,  
` `[ranges::begin](../begin.html)(std::get<0>(`_[views_](../concat_view.html#views "cpp/ranges/concat view")_` ﻿)));  
it.template` `` _[satisfy](iterator/helpers.html#satisfy "cpp/ranges/concat view/iterator/helpers")_` ﻿<0>();  
return it;.

2) Equivalent to  [`_iterator_`](iterator.html "cpp/ranges/concat view/iterator") ﻿<true> it(this, [std::in_place_index](../../utility/in_place.html)<0>,  
` `[ranges::begin](../begin.html)(std::get<0>(`_[views_](../concat_view.html#views "cpp/ranges/concat view")_` ﻿)));  
it.template` `` _[satisfy](iterator/helpers.html#satisfy "cpp/ranges/concat view/iterator/helpers")_` ﻿<0>();  
return it;.
...
Run this code
    ...
    int main()
    {
        ...
        static constexpr auto cat{std::[views::concat](../concat_view.html)(c, a, t)};
