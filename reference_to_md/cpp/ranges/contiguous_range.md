...
[ranges::random_access_range](random_access_range.html)<T> &&  
[std::contiguous_iterator](../iterator/contiguous_iterator.html)<[ranges::iterator_t](iterator_t.html)<T>> &&  
requires(T& t) {  
{ [ranges::data](data.html)(t) } ->  
[std::same_as](../concepts/same_as.html)<[std::add_pointer_t](../types/add_pointer.html)<[ranges::range_reference_t](range_reference_t.html)<T>>>;  
}; |  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        int a[4];
        static_assert(
                CR<[std::vector](../container/vector.html)<int>> and
            not CR<[std::vector](../container/vector.html)<bool>> and
            not CR<[std::deque](../container/deque.html)<int>> and
                CR<[std::valarray](../numeric/valarray.html)<int>> and
                CR<decltype(a)> and
            not CR<[std::list](../container/list.html)<int>> and
            not CR<[std::set](../container/set.html)<int>> and
                CR<[std::array](../container/array.html)<[std::list](../container/list.html)<int>,42>> and
                CR<[std::string_view](../string/basic_string_view.html)> and
                CR<zstring> and
                CR<[std::span](../container/span.html)<const int>> and
            not CR<[std::mdspan](../container/mdspan.html)<int, [std::dims](../container/mdspan/extents.html)<1>>>
        );
    }
