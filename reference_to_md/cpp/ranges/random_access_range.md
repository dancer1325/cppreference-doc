...
[ranges::bidirectional_range](bidirectional_range.html)<T> && [std::random_access_iterator](../iterator/random_access_iterator.html)<[ranges::iterator_t](iterator_t.html)<T>>; |  |  (since C++20)  
| |   
  
The `random_access_range` concept is a refinement of [`range`](range.html "cpp/ranges/range") for which ranges::begin returns a model of [`random_access_iterator`](../iterator/random_access_iterator.html "cpp/iterator/random access iterator"). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/random_access_range&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        int a[4];
        static_assert(
                RAR<[std::vector](../container/vector.html)<int>> and
                RAR<[std::vector](../container/vector.html)<bool>> and
                RAR<[std::deque](../container/deque.html)<int>> and
                RAR<[std::valarray](../numeric/valarray.html)<int>> and
                RAR<decltype(a)> and
            not RAR<[std::list](../container/list.html)<int>> and
            not RAR<[std::set](../container/set.html)<int>> and
                RAR<[std::array](../container/array.html)<[std::list](../container/list.html)<int>,42>>
        );
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/random_access_range&action=edit&section=2 "Edit section: See also")] See also
