...
Returns an iterator to the first element of the view. Effectively calls [ranges::begin](../begin.html) on the underlying view [`_base__`](../take_while_view.html#Data_members "cpp/ranges/take while view"). 
