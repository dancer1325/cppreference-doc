...
Returns a reference to the stored predicate [`_pred__`](../take_while_view.html#Data_members "cpp/ranges/take while view"). 
...
## Contents
  ...
  * [1 Parameters](pred.html#Parameters)
  * [2 Return value](pred.html#Return_value)
  * [3 Example](pred.html#Example)
  * [4 See also](pred.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        constexpr auto v = a | std::[views::take_while](../take_while_view.html)([](int x){ return x < 4; });
