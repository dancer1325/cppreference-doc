...
1) Copy constructs the result from the underlying view [`_base__`](../take_while_view.html#Data_members "cpp/ranges/take while view").
...
Run this code
    ...
    int main()
    {
        ...
        constexpr auto view = a | std::[views::take_while](../take_while_view.html)([](int x){ return x < 4; });
        stq::println("{}", view);
