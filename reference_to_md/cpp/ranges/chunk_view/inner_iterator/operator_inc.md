...
chunk_view::_inner-iterator_ ::operator++(int)**  
...
Increments the [iterator](../inner_iterator.html "cpp/ranges/chunk view/inner iterator"). 
...
1) Equivalent to: 
    ...
    ++*parent_->current_;
    if (*parent_->current_ == [ranges::end](../../end.html)(parent_->base_))
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator_inc&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator_inc&action=edit&section=2 "Edit section: Return value")] Return value

1) *this

2) (none)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator_inc&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator_inc&action=edit&section=4 "Edit section: See also")] See also

[ operator-](operator-.html "cpp/ranges/chunk view/inner iterator/operator-")(C++23) |  calculates the number of chunks remained   
(function)  
---|---
