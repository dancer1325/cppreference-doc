...
[operator==(chunk_view::_inner-iterator_)](operator_cmp.html "cpp/ranges/chunk view/inner iterator/operator cmp")  
[operator-(chunk_view::_inner-iterator_)](operator-.html "cpp/ranges/chunk view/inner iterator/operator-")  
**iter_move(chunk_view::_inner-iterator_)**  
...
friend constexpr auto iter_move( const /*inner-iterator*/& i ) noexcept(/* see below */) |  |  (since C++23)  
---|---|---  
| |   
  
Returns the result of applying [ranges::iter_move](../../../iterator/ranges/iter_move.html "cpp/iterator/ranges/iter move") to the stored inner iterator. 

Let [`_parent__`](../inner_iterator.html#Data_members "cpp/ranges/chunk view/inner iterator") be the underlying pointer to the enclosing `chunk_view`, and *i.parent_->current_ denote the cached underlying iterator of type [ranges::iterator_t](../../iterator_t.html)<V>. 

Equivalent to: return [ranges::iter_move](../../../iterator/ranges/iter_move.html)(*i.parent_->current_);. 

This function is not visible to ordinary [unqualified](../../../language/unqualified_lookup.html "cpp/language/unqualified lookup") or [qualified lookup](../../../language/qualified_lookup.html "cpp/language/qualified lookup"), and can only be found by [argument-dependent lookup](../../../language/adl.html "cpp/language/adl") when `chunk_view::_inner-iterator_` is an associated class of the arguments. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/iter_move&action=edit&section=1 "Edit section: Parameters")] Parameters

i  |  \-  |  iterator   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/iter_move&action=edit&section=2 "Edit section: Return value")] Return value

The result of applying [ranges::iter_move](../../../iterator/ranges/iter_move.html) to the stored iterator of type [ranges::iterator_t](../../iterator_t.html)<V>. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/iter_move&action=edit&section=3 "Edit section: Exceptions")] Exceptions

[`noexcept`](../../../language/noexcept_spec.html "cpp/language/noexcept spec") specification: 

noexcept(noexcept([ranges::iter_move](../../../iterator/ranges/iter_move.html)(*i.parent_->current_)))

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/iter_move&action=edit&section=4 "Edit section: See also")] See also
