...
**chunk_view::_inner-iterator_ ::_inner-iterator_**  
...
/*inner-iterator*/( /*inner-iterator*/&& other ) = default; |  (1)  |  (since C++23)  
---|---|---  
private:  
constexpr explicit /*inner-iterator*/( chunk_view& parent ); |  (2)  |  (exposition only*)  
| |   
  
Construct an iterator. 

1) A move constructor which move-initializes the underlying pointer [`_parent__`](../inner_iterator.html#Data_members "cpp/ranges/chunk view/inner iterator") with other.`_parent__`.

2) A private constructor which is used by [`chunk_view::begin`](../begin.html "cpp/ranges/chunk view/begin"). This constructor is not accessible to users. Initializes [`_parent__`](../inner_iterator.html#Data_members "cpp/ranges/chunk view/inner iterator") with [std::addressof](../../../memory/addressof.html)(parent).

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/inner_iterator&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  an [iterator](../inner_iterator.html "cpp/ranges/chunk view/inner iterator")  
---|---|---  
parent  |  \-  |  the enclosing ranges::chunk_view object   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/inner_iterator&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/inner_iterator&action=edit&section=3 "Edit section: See also")] See also

[ operator=](operator=.html "cpp/ranges/chunk view/inner iterator/operator=")(C++23) |  move assigns another iterator   
