...
constexpr [ranges::range_reference_t](../../range_reference_t.html)<V> operator*() const; |  |  (since C++23)  
---|---|---  
| |   
  
Returns the current element in current chunk in the `chunk_view`. 

Let [`_parent__`](../inner_iterator.html#Data_members "cpp/ranges/chunk view/inner iterator") be the underlying pointer to `chunk_view`. Equivalent to: return **[`_parent__`](../inner_iterator.html#Data_members "cpp/ranges/chunk view/inner iterator") ->[`_current_;_`](../../chunk_view.html#Data_members "cpp/ranges/chunk view"). 
...
[ base](base.html "cpp/ranges/chunk view/inner iterator/base")(C++23) |  returns an iterator to the current element   
