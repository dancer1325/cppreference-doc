...
**chunk_view::_inner-iterator_ ::base**  
[chunk_view::_inner-iterator_ ::operator*](operator*.html "cpp/ranges/chunk view/inner iterator/operator*")  
...
constexpr const [ranges::iterator_t](../../iterator_t.html)<V>& base() const &; |  |  (since C++23)  
---|---|---  
| |   
...
Equivalent to: return *[`_parent__`](../inner_iterator.html#Data_members "cpp/ranges/chunk view/inner iterator") ->[`_current_;_`](../../chunk_view.html#Data_members "cpp/ranges/chunk view"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/base&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/base&action=edit&section=2 "Edit section: Return value")] Return value

An iterator. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/base&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/base&action=edit&section=4 "Edit section: See also")] See also

[ operator*](operator*.html "cpp/ranges/chunk view/inner iterator/operator*")(C++23) |  accesses the element   
