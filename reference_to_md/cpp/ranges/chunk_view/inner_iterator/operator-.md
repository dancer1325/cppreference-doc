...
Calculates the distance (in number of underlying elements) between the [iterator](../inner_iterator.html "cpp/ranges/chunk view/inner iterator") and [sentinel](../../../iterator/default_sentinel.html "cpp/iterator/default sentinel t"). 

Let [`_parent__`](../inner_iterator.html#Data_members "cpp/ranges/chunk view/inner iterator") be the underlying pointer to the enclosing `chunk_view`. 

1) Equivalent to:  
return [ranges::min](../../../algorithm/ranges/min.html)(i.parent_->remainder_,  
[ranges::end](../../end.html)(i.parent_->base_) - *i.parent_->current_);
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator-&action=edit&section=1 "Edit section: Parameters")] Parameters

i  |  \-  |  the [iterator](../inner_iterator.html "cpp/ranges/chunk view/inner iterator")  
---|---|---  
s  |  \-  |  the sentinel   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator-&action=edit&section=2 "Edit section: Return value")] Return value

The distance between given iterator and sentinel. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator-&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator-&action=edit&section=4 "Edit section: See also")] See also

[ operator++](operator_inc.html "cpp/ranges/chunk view/inner iterator/operator inc")(C++23) |  increments the iterator   
