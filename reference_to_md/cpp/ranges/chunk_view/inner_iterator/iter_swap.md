...
**iter_swap(chunk_view::_inner-iterator_)**  
...
noexcept(noexcept([ranges::iter_swap](../../../iterator/ranges/iter_swap.html)(*x.parent_->current_,  
*y.parent_->current_)))  
requires [std::indirectly_swappable](../../../iterator/indirectly_swappable.html)<[ranges::iterator_t](../../iterator_t.html)<V>>; |  |  (since C++23)  
---|---|---  
| |   
  
Applies [ranges::iter_swap](../../../iterator/ranges/iter_swap.html "cpp/iterator/ranges/iter swap") to the underlying cached iterators. 

Let [`_parent__`](../inner_iterator.html#Data_members "cpp/ranges/chunk view/inner iterator") be the underlying pointer to the enclosing `chunk_view`, and *i.parent_->current_ denote the underlying cached iterator of type [ranges::iterator_t](../../iterator_t.html)<V>. 

Equivalent to: [ranges::iter_swap](../../../iterator/ranges/iter_swap.html)(*x.parent_->current_, *y.parent_->current_);. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/iter_swap&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  iterators to the elements to swap   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/iter_swap&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/iter_swap&action=edit&section=3 "Edit section: See also")] See also
