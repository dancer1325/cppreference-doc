...
constexpr explicit chunk_view( V base, [ranges::range_difference_t](../range_size_t.html)<V> n ); |  |  (since C++23)  
---|---|---  
| |   
  
Constructs a `chunk_view`, initializing the underlying data members: 

  * move constructs the `_[base_](../chunk_view.html#base "cpp/ranges/chunk view")_` with std::move(base), 
  * initializes the "chunk size" `_[n_](../chunk_view.html#n "cpp/ranges/chunk view")_` with n. 



In addition, if `V` models exactly the [`input_range`](../input_range.html "cpp/ranges/input range"), the constructor initializes the following exposition-only data members: 

  * initializes the `_[remainder_](../chunk_view.html#remainder "cpp/ranges/chunk view")_` with ​0​, 
  * [default-initializes](../../language/default_initialization.html "cpp/language/default initialization") the `_[current_](../chunk_view.html#current "cpp/ranges/chunk view")_`. 



The behavior is undefined if n is less than or equal to ​0​. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/chunk_view&action=edit&section=1 "Edit section: Parameters")] Parameters

base  |  \-  |  the adapted view   
---|---|---  
n  |  \-  |  the chunk size   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/chunk_view&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto i = std::[views::iota](../iota_view.html)(0, 10);
        auto w = std::[ranges::chunk_view](../chunk_view.html)(i, 4);
     
        std::[ranges::for_each](../../algorithm/ranges/for_each.html)(w, [](auto const v)
        {
            for (auto e : v)
