...
---|---|---  
constexpr [std::default_sentinel_t](../../iterator/default_sentinel.html) end() const noexcept; |  (1)  |  (since C++23)  
`V` models [`forward_range`](../forward_range.html "cpp/ranges/forward range") |  |   
constexpr auto end() requires (!__simple_view<V>); |  (2)  |  (since C++23)  
constexpr auto end() const requires [ranges::forward_range](../forward_range.html)<const V>; |  (3)  |  (since C++23)  
| |   
  
Returns an [iterator](../chunk_view.html#Nested_classes "cpp/ranges/chunk view") or a [std::default_sentinel](../../iterator/default_sentinel.html "cpp/iterator/default sentinel") that compares equal to the end iterator of the [`chunk_view`](../chunk_view.html "cpp/ranges/chunk view"). 

1) Available only if V models [`input_range`](../input_range.html "cpp/ranges/input range"). Equivalent to: return [std::default_sentinel](../../iterator/default_sentinel.html).

2,3) Available if V models [`forward_range`](../forward_range.html "cpp/ranges/forward range"). Let `_[base_](../chunk_view.html#base "cpp/ranges/chunk view")_` denote the underlying adapted view, `_[n_](../chunk_view.html#n "cpp/ranges/chunk view")_` denote the stored chunk size, and [`_iterator_`](iterator.html "cpp/ranges/chunk view/iterator") denote the nested iterator class.

2) Equivalent to 
    
    
    if constexpr ([ranges::common_range](../common_range.html)<V> && [ranges::sized_range](../sized_range.html)<V>)
    {
        auto missing = (n_ - [ranges::distance](../../iterator/ranges/distance.html)(base_) % n_) % n_;
        return iterator<false>(this, [ranges::end](../end.html)(base_), missing);
    }
    else if constexpr ([ranges::common_range](../common_range.html)<V> && ![ranges::bidirectional_range](../bidirectional_range.html)<V>)
        return iterator<false>(this, [ranges::end](../end.html)(base_));
    else
...
3) Equivalent to 
    ...
    if constexpr ([ranges::common_range](../common_range.html)<const V> && [ranges::sized_range](../sized_range.html)<const V>)
    {
        auto missing = (n_ - [ranges::distance](../../iterator/ranges/distance.html)(base_) % n_) % n_;
        return iterator<true>(this, [ranges::end](../end.html)(base_), missing);
    }
    else if constexpr ([ranges::common_range](../common_range.html)<const V> && ![ranges::bidirectional_range](../bidirectional_range.html)<const V>)
        return iterator<true>(this, [ranges::end](../end.html)(base_));
    else
        return [std::default_sentinel](../../iterator/default_sentinel.html);

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/end&action=edit&section=1 "Edit section: Return value")] Return value

An iterator or sentinel representing the end of the [`chunk_view`](../chunk_view.html "cpp/ranges/chunk view"), as described above. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/end&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/end&action=edit&section=3 "Edit section: See also")] See also

[ begin](begin.html "cpp/ranges/chunk view/begin") |  returns an iterator to the beginning   
