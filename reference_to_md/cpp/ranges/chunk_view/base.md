...
1) Copy constructs the result from the underlying view. Equivalent to return` `` _[base_](../chunk_view.html#base "cpp/ranges/chunk view")_` ;.
...
Run this code
    ...
    int main()
    {
        ...
        [std::println](../../io/println.html)("{}", w.base());
    }
