...
constexpr auto begin() const requires [ranges::forward_range](../forward_range.html)<const V>; |  (3)  |  (since C++23)  
| |   
  
Returns an [iterator](iterator.html "cpp/ranges/chunk view/iterator") to the first element of the `chunk_view`. 

1) Available only if V models [`input_range`](../input_range.html "cpp/ranges/input range"). Equivalent to 

`_[current_](../chunk_view.html#current "cpp/ranges/chunk view")_`` `= [ranges::begin](../begin.html)(`_[base_](../chunk_view.html#base "cpp/ranges/chunk view")_`);  
`_[remainder_](../chunk_view.html#remainder "cpp/ranges/chunk view")_`` `=` `` _[n_](../chunk_view.html#n "cpp/ranges/chunk view")_` ;  
return` `[` _outer_iterator_`](outer_iterator.html "cpp/ranges/chunk view/outer iterator")(*this);

2) Available if V models [`forward_range`](../forward_range.html "cpp/ranges/forward range"). Equivalent to return` `[` _iterator_`](iterator.html "cpp/ranges/chunk view/iterator") <false>(this, [ranges::begin](../begin.html)(`_[base_](../chunk_view.html#base "cpp/ranges/chunk view")_`));.
