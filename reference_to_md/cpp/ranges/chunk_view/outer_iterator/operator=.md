...
Assigns another iterator. This [move assignment](../../../language/move_operator.html "cpp/language/move assignment") operator is generated by the compiler. 

Moves the underlying pointer other.[`_parent__`](../outer_iterator.html#Data_members "cpp/ranges/chunk view/outer iterator") to `_parent__`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/outer_iterator/operator%3D&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  an [iterator](../outer_iterator.html "cpp/ranges/chunk view/outer iterator")  
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/outer_iterator/operator%3D&action=edit&section=2 "Edit section: See also")] See also

[ (constructor)](outer_iterator.html "cpp/ranges/chunk view/outer iterator/outer iterator")(C++23) |  constructs an iterator   
