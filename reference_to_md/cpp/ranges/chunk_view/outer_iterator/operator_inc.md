...
chunk_view::_outer-iterator_ ::operator++(int)**  
...
[_outer-iterator_ ::value_type](value_type.html "cpp/ranges/chunk view/outer iterator/value type")  
...
constexpr /*outer-iterator*/& operator++(); |  (1)  |  (since C++23)  
---|---|---  
constexpr void operator++( int ); |  (2)  |  (since C++23)  
| |   
  
Increments the [iterator](../outer_iterator.html "cpp/ranges/chunk view/outer iterator"). 

Let [`_parent__`](../outer_iterator.html#Data_members "cpp/ranges/chunk view/outer iterator") be the underlying pointer to enclosing `chunk_view`. 

1) Equivalent to: 
    
    
    [ranges::advance](../../../iterator/ranges/advance.html)(*parent_->current_, parent_->remainder_, [ranges::end](../../end.html)(parent_->base_));
    parent_->remainder_ = parent_->n_;
    return *this;

Before invocation of this operator the expression *this == [std::default_sentinel](../../../iterator/default_sentinel.html) must be false.

2) Equivalent to ++*this.

## Contents

  * [1 Parameters](operator_inc.html#Parameters)
  * [2 Return value](operator_inc.html#Return_value)
  * [3 Example](operator_inc.html#Example)
  * [4 See also](operator_inc.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/outer_iterator/operator_inc&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/outer_iterator/operator_inc&action=edit&section=2 "Edit section: Return value")] Return value

1) *this

2) (none)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/outer_iterator/operator_inc&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/outer_iterator/operator_inc&action=edit&section=4 "Edit section: See also")] See also

[ operator-](operator-.html "cpp/ranges/chunk view/outer iterator/operator-")(C++23) |  calculates the number of chunks remained   
(function)  
---|---
