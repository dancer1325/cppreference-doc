...
[chunk_view::_outer-iterator_ ::_outer-iterator_](outer_iterator.html "cpp/ranges/chunk view/outer iterator/outer iterator")  
[chunk_view::_outer-iterator_ ::operator=](operator=.html "cpp/ranges/chunk view/outer iterator/operator=")  
[chunk_view::_outer-iterator_ ::operator*](operator*.html "cpp/ranges/chunk view/outer iterator/operator*")  
[chunk_view::_outer-iterator_ ::operator++  
chunk_view::_outer-iterator_ ::operator++(int)](operator_inc.html "cpp/ranges/chunk view/outer iterator/operator inc")  
[operator==(chunk_view::_outer-iterator_)](operator_cmp.html "cpp/ranges/chunk view/outer iterator/operator cmp")  
[operator-(chunk_view::_outer-iterator_)](operator-.html "cpp/ranges/chunk view/outer iterator/operator-")  
**_outer-iterator_ ::value_type**  
[chunk_view::_outer-iterator_ ::value_type::value_type` `](value_type.html#ctor "cpp/ranges/chunk view/outer iterator/value type")  
[chunk_view::_outer-iterator_ ::value_type::begin](value_type.html#begin "cpp/ranges/chunk view/outer iterator/value type")  
[chunk_view::_outer-iterator_ ::value_type::end](value_type.html#end "cpp/ranges/chunk view/outer iterator/value type")  
[chunk_view::_outer-iterator_ ::value_type::size](value_type.html#size "cpp/ranges/chunk view/outer iterator/value type")  
...
A value type of the iterator [`chunk_view::_outer-iterator_`](../outer_iterator.html "cpp/ranges/chunk view/outer iterator"), formed when `V` models [`input_range`](../../input_range.html "cpp/ranges/input range"). 
...
## Contents
  ...
  * [3 std::ranges::chunk_view::_outer-iterator_ ::value_type::value_type](value_type.html#std::ranges::chunk_view::outer-iterator::value_type::value_type)
    * [3.1 Parameters](value_type.html#Parameters)
  * [4 std::ranges::chunk_view::_outer-iterator_ ::value_type::begin](value_type.html#std::ranges::chunk_view::outer-iterator::value_type::begin)
  * [5 std::ranges::chunk_view::_outer-iterator_ ::value_type::end](value_type.html#std::ranges::chunk_view::outer-iterator::value_type::end)
  * [6 std::ranges::chunk_view::_outer-iterator_ ::value_type::size](value_type.html#std::ranges::chunk_view::outer-iterator::value_type::size)
    * [6.1 Example](value_type.html#Example)
    * [6.2 References](value_type.html#References)
    * [6.3 See also](value_type.html#See_also)
...
---|---  
[ begin](value_type.html#begin "cpp/ranges/chunk view/outer iterator/value type")(C++23) |  returns the beginning [`chunk_view::_inner-iterator_`](../inner_iterator.html "cpp/ranges/chunk view/inner iterator")   
(public member function)  
[ end](value_type.html#end "cpp/ranges/chunk view/outer iterator/value type")(C++23) |  returns the default sentinel   
(public member function)  
[ size](value_type.html#size "cpp/ranges/chunk view/outer iterator/value type")(C++23) |  returns the size of the view   
(public member function)  
...
private:  
// exposition only  
constexpr explicit value_type( chunk_view& parent ); |  |  (since C++23)  
---|---|---  
| |   
  
Constructs the `value_type` object so that `_parent__` is initialized with [std::addressof](../../../memory/addressof.html)(parent). 
...
constexpr [std::default_sentinel_t](../../../iterator/default_sentinel.html) end() const noexcept; |  |  (since C++23)  
---|---|---  
| |   
...
requires [std::sized_sentinel_for](../../../iterator/sized_sentinel_for.html)<[ranges::sentinel_t](../../iterator_t.html)<V>, [ranges::iterator_t](../../iterator_t.html)<V>>; |  |  (since C++23)  
---|---|---  
| |   
...
---|---  
[_inner_iterator_](../inner_iterator.html "cpp/ranges/chunk view/inner iterator")(C++23) |  the inner ("element-wise") iterator type when V models [`input_range`](../../input_range.html "cpp/ranges/input range")  
(exposition-only member class of `std::ranges::chunk_view<V>`*)
