...
Compares the [iterator](../outer_iterator.html "cpp/ranges/chunk view/outer iterator") and the [sentinel](../../../iterator/default_sentinel.html "cpp/iterator/default sentinel t"). 

Let [`_parent__`](../outer_iterator.html#Data_members "cpp/ranges/chunk view/outer iterator") be the underlying pointer to enclosing `chunk_view`. Equivalent to: 
    
    
    return *x.parent_->current_ == [ranges::end](../../end.html)(x.parent_->base_) and x.parent_->remainder_ != 0;
