...
**operator-(chunk_view::_outer-iterator_)**  
...
requires ranges::sized_sentinel_for<[ranges::sentinel_t](../../iterator_t.html)<V>,  
[ranges::iterator_t](../../iterator_t.html)<V>>; |  (1)  |  (since C++23)  
---|---|---  
friend constexpr difference_type operator-( const /*outer-iterator*/& i,  
[std::default_sentinel_t](../../../iterator/default_sentinel.html) s )  
requires ranges::sized_sentinel_for<[ranges::sentinel_t](../../iterator_t.html)<V>,  
[ranges::iterator_t](../../iterator_t.html)<V>>; |  (2)  |  (since C++23)  
| |   
  
Calculates the distance (in number of chunks) between the [iterator](../outer_iterator.html "cpp/ranges/chunk view/outer iterator") and [sentinel](../../../iterator/default_sentinel.html "cpp/iterator/default sentinel t"). 
...
1) Equivalent to: 
    ...
    const auto dist = [ranges::end](../../end.html)(i.parent_->base_) - *i.parent_->current_;
