...
Let [`_parent__`](../outer_iterator.html#Data_members "cpp/ranges/chunk view/outer iterator") be the underlying pointer, and [`_value_type_`](../outer_iterator.html#Nested_classes "cpp/ranges/chunk view/outer iterator") be a nested class that is the value type of the [iterator](../outer_iterator.html "cpp/ranges/chunk view/outer iterator"). 
