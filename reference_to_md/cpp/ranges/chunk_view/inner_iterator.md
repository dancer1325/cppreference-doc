...
The return type of [`chunk_view::_outer-iterator_ ::value_type::begin`](outer_iterator/value_type.html#begin "cpp/ranges/chunk view/outer iterator/value type") if `V` models [`input_range`](../input_range.html "cpp/ranges/input range"). 
...
## Contents
  ...
  * [4 Non-member functions](inner_iterator.html#Non-member_functions)
  * [5 Example](inner_iterator.html#Example)
  * [6 References](inner_iterator.html#References)
  * [7 See also](inner_iterator.html#See_also)
...
---|---  
[ operator=](inner_iterator/operator=.html "cpp/ranges/chunk view/inner iterator/operator=")(C++23) |  move assigns another iterator   
(public member function)  
[ base](inner_iterator/base.html "cpp/ranges/chunk view/inner iterator/base")(C++23) |  returns an iterator to the current element   
(public member function)  
[ operator*](inner_iterator/operator*.html "cpp/ranges/chunk view/inner iterator/operator*")(C++23) |  accesses the element   
(public member function)  
...
(function)  
---|---  
[ operator-](inner_iterator/operator-.html "cpp/ranges/chunk view/inner iterator/operator-")(C++23) |  calculates the remained number of elements   
(function)  
[ iter_move](inner_iterator/iter_move.html "cpp/ranges/chunk view/inner iterator/iter move")(C++23) |  casts the result of dereferencing the underlying iterator to its associated rvalue reference type   
(function)  
...
Run this code
    ...
    int main()
    {
        auto letters = [std::istringstream](../../io/basic_istringstream.html){"ABCDEFGHIJK"};
     
        auto chunks = std::[ranges::istream_view](../basic_istream_view.html)<char>(letters)
                    | std::[views::chunk](../chunk_view.html)(4);
     
        for (auto chunk : chunks)
        {
            // chunk is an object of type chunk_view::outer_iterator::value_type
            [std::cout](../../io/cout.html) << '[';
            for (auto inner_iter = chunk.begin(); inner_iter != [std::default_sentinel](../../iterator/default_sentinel.html);
                 ++inner_iter)
                [std::cout](../../io/cout.html) << *inner_iter;
            [std::cout](../../io/cout.html) << "] ";
        }
        [std::cout](../../io/cout.html) << '\n';
    }
