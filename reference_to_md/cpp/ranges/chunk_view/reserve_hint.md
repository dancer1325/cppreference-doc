...
using DT = [ranges::range_difference_t](../range_size_t.html)<decltype((`_[base_](../chunk_view.html#base "cpp/ranges/chunk view")_`))>;  
auto s = static_cast<DT>(ranges::reserve_hint(`_[base_](../chunk_view.html#base "cpp/ranges/chunk view")_`));  
return` `` _to-unsigned-like_`(`_div-ceil_`(s,` `` _[n_](../chunk_view.html#n "cpp/ranges/chunk view")_`));
...
[ size](size.html "cpp/ranges/chunk view/size") |  returns the number of elements, provided only if the underlying (adapted) range satisfies [`sized_range`](../sized_range.html "cpp/ranges/sized range")   
