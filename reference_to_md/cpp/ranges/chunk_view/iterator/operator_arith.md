...
[chunk_view::_iterator_ ::_iterator_](iterator.html "cpp/ranges/chunk view/iterator/iterator")  
[chunk_view::_iterator_ ::base](base.html "cpp/ranges/chunk view/iterator/base")  
[chunk_view::_iterator_ ::operator*](operator*.html "cpp/ranges/chunk view/iterator/operator*")  
[chunk_view::_iterator_ ::operator[]](operator_at.html "cpp/ranges/chunk view/iterator/operator at")  
...
operator<=(chunk_view::_iterator_)  
operator>=(chunk_view::_iterator_)  
operator<=>(chunk_view::_iterator_)](operator_cmp.html "cpp/ranges/chunk view/iterator/operator cmp")  
[operator+(chunk_view::_iterator_)  
operator-(chunk_view::_iterator_)](operator_arith2.html "cpp/ranges/chunk view/iterator/operator arith2")  
...
Advances or decrements the [iterator](iterator.html "cpp/ranges/chunk view/iterator/iterator"). 

Let `_current__`, `_end__`, and `_n__` be the underlying [data members](../iterator.html#Data_members "cpp/ranges/chunk view/iterator") of [`chunk_view::iterator`](../iterator.html "cpp/ranges/chunk view/iterator"). 

1) Equivalent to: 
    
    
    missing_ = [ranges::advance](../../../iterator/ranges/advance.html)(current_, n_, end_);
    return *this;
...
3) Equivalent to: 
    ...
    [ranges::advance](../../../iterator/ranges/advance.html)(current_, missing_ - n_);
    missing_ = 0;
    return *this;
...
5) Equivalent to: 
    ...
    if (x > 0)
    {
        [ranges::advance](../../../iterator/ranges/advance.html)(current_, n_ * (x - 1));
        missing_ = [ranges::advance](../../../iterator/ranges/advance.html)(current_, n_, end_);
    }
    else if (x < 0)
    {
        [ranges::advance](../../../iterator/ranges/advance.html)(current_, n_ * x + missing_);
        missing_ = 0;
    }
    return *this;

If x is positive, then before the invocation the expression [ranges::distance](../../../iterator/ranges/distance.html)(current_, end_) > n_ * (x - 1) must be true (i.e., informally, the requested chunk should be "inside" the underlying sequence). If x is negative, this precondition is always met.
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/iterator/operator_arith&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  a position relative to current location   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/iterator/operator_arith&action=edit&section=2 "Edit section: Return value")] Return value

1,3,5,6) *this

2,4) a copy of *this that was made before the change

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/iterator/operator_arith&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/iterator/operator_arith&action=edit&section=4 "Edit section: See also")] See also

[ operator+operator-](operator_arith2.html "cpp/ranges/chunk view/iterator/operator arith2")(C++23) |  performs iterator arithmetic   
(function)  
---|---
