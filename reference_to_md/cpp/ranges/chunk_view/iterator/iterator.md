...
**chunk_view::_iterator_ ::_iterator_**  
...
1) Default constructor. [Value-initializes](../../../language/value_initialization.html "cpp/language/value initialization") the underlying [data members](../iterator.html#Data_members "cpp/ranges/chunk view/iterator"): 

  * `_current__` with [ranges::iterator_t](../../iterator_t.html)<Base>(), 
  * `_end__` with [ranges::sentinel_t](../../iterator_t.html)<Base>(), 
  * `_n__` with ​0​, 
  * `_missing__` with ​0​.



2) Conversion from /*iterator*/<false> to /*iterator*/<true>. Initializes the underlying [data members](../iterator.html#Data_members "cpp/ranges/chunk view/iterator"): 

  * `_current__` with std::move(i.current_), 
  * `_end__` with std::move(i.end_), 
  * `_n__` with i.n_, 
  * `_missing__` with i.missing_.



3) A private constructor which is used by ranges::chunk_view::begin and ranges::chunk_view::end. This constructor is not accessible to users. Initializes the underlying [data members](../iterator.html#Data_members "cpp/ranges/chunk view/iterator"): 

  * `_current__` with current, 
  * `_end__` with [ranges::end](../../end.html)(parent->base_), 
  * `_n__` with parent->n_, 
  * `_missing__` with missing.
