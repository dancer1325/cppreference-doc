...
chunk_view::_iterator_ ::operator--(int)  
chunk_view::_iterator_ ::operator+=  
chunk_view::_iterator_ ::operator-=](operator_arith.html "cpp/ranges/chunk view/iterator/operator arith")  
...
Let `_current__` and `_end__` be the underlying [data members](../iterator.html#Data_members "cpp/ranges/chunk view/iterator"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/iterator/operator_cmp&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  the [iterators](../iterator.html#Data_members "cpp/ranges/chunk view/iterator") to compare   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/iterator/operator_cmp&action=edit&section=2 "Edit section: Return value")] Return value

The result of comparison. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/iterator/operator_cmp&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/iterator/operator_cmp&action=edit&section=4 "Edit section: See also")] See also  
