...
friend constexpr difference_type operator-( [std::default_sentinel_t](../../../iterator/default_sentinel.html),  
const /*iterator*/& i )  
...
Performs [iterator](../iterator.html "cpp/ranges/chunk view/iterator") arithmetic or calculates the distance. 

Let `_current__`, `_end__`, `_n__`, and `_missing__` be the underlying [data members](../iterator.html#Data_members "cpp/ranges/chunk view/iterator"). 
