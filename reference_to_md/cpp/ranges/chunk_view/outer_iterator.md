...
The return type of [`chunk_view::begin`](begin.html "cpp/ranges/chunk view/begin") if `V` models [`input_range`](../input_range.html "cpp/ranges/input range"). 
...
## Contents
  ...
  * [4 Non-member functions](outer_iterator.html#Non-member_functions)
  * [5 Nested classes](outer_iterator.html#Nested_classes)
  * [6 Example](outer_iterator.html#Example)
  * [7 References](outer_iterator.html#References)
  * [8 See also](outer_iterator.html#See_also)
...
---|---  
[ operator=](outer_iterator/operator=.html "cpp/ranges/chunk view/outer iterator/operator=")(C++23) |  move assigns another iterator   
(public member function)  
[ operator*](outer_iterator/operator*.html "cpp/ranges/chunk view/outer iterator/operator*")(C++23) |  accesses the element   
(public member function)  
...
Run this code
    ...
    int main()
    {
        const [std::string](../../string/basic_string.html) source{"ABCDEFGHIJ"};
     
        auto letters = [std::istringstream](../../io/basic_istringstream.html){source};
        auto chunks = std::[ranges::istream_view](../basic_istream_view.html)<char>(letters)
                    | std::[views::chunk](../chunk_view.html)(4);
     
        for (auto outer_iter = chunks.begin(); outer_iter != [std::default_sentinel](../../iterator/default_sentinel.html);
             ++outer_iter)
        {
    ...
     
        ...
        auto letters2 = [std::istringstream](../../io/basic_istringstream.html){source};
        auto chunks2 = std::[ranges::istream_view](../basic_istream_view.html)<char>(letters2)
                     | std::[views::chunk](../chunk_view.html)(4);
