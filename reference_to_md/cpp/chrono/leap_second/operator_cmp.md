...
[`std::chrono::leap_second`](../leap_second.html "cpp/chrono/leap second")

Member functions  
---  
[leap_second::date](date.html "cpp/chrono/leap second/date")  
Nonmember functions  
**operator== operator<operator<=operator>operator>=operator<=>**  
Helper classes  
[hash<std::chrono::leap_second>](hash.html "cpp/chrono/leap second/hash")(C++26)  
...
---|---|---  
constexpr bool operator==( const [std::chrono::leap_second](../leap_second.html)& x,  
const [std::chrono::leap_second](../leap_second.html)& y ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::strong_ordering](../../utility/compare/strong_ordering.html) operator<=>( const [std::chrono::leap_second](../leap_second.html)& x,  
const [std::chrono::leap_second](../leap_second.html)& y ) noexcept; |  (2)  |  (since C++20)  
template< class Duration >  
constexpr bool operator==( const [std::chrono::leap_second](../leap_second.html)& x,  
const [std::chrono::sys_time](../system_clock.html)<Duration>& y ) noexcept; |  (3)  |  (since C++20)  
template< class Duration >  
constexpr bool operator< ( const [std::chrono::leap_second](../leap_second.html)& x,  
const [std::chrono::sys_time](../system_clock.html)<Duration>& y ) noexcept; |  (4)  |  (since C++20)  
template< class Duration >  
constexpr bool operator< ( const [std::chrono::sys_time](../system_clock.html)<Duration>& x,  
const [std::chrono::leap_second](../leap_second.html)& y ) noexcept; |  (5)  |  (since C++20)  
template< class Duration >  
constexpr bool operator> ( const [std::chrono::leap_second](../leap_second.html)& x,  
const [std::chrono::sys_time](../system_clock.html)<Duration>& y ) noexcept; |  (6)  |  (since C++20)  
template< class Duration >  
constexpr bool operator> ( const [std::chrono::sys_time](../system_clock.html)<Duration>& x,  
const [std::chrono::leap_second](../leap_second.html)& y ) noexcept; |  (7)  |  (since C++20)  
template< class Duration >  
constexpr bool operator<=( const [std::chrono::leap_second](../leap_second.html)& x,  
const [std::chrono::sys_time](../system_clock.html)<Duration>& y ) noexcept; |  (8)  |  (since C++20)  
template< class Duration >  
constexpr bool operator<=( const [std::chrono::sys_time](../system_clock.html)<Duration>& x,  
const [std::chrono::leap_second](../leap_second.html)& y ) noexcept; |  (9)  |  (since C++20)  
template< class Duration >  
constexpr bool operator>=( const [std::chrono::leap_second](../leap_second.html)& x,  
const [std::chrono::sys_time](../system_clock.html)<Duration>& y ) noexcept; |  (10)  |  (since C++20)  
template< class Duration >  
constexpr bool operator>=( const [std::chrono::sys_time](../system_clock.html)<Duration>& x,  
const [std::chrono::leap_second](../leap_second.html)& y ) noexcept; |  (11)  |  (since C++20)  
template< class Duration >  
requires [std::three_way_comparable_with](../../utility/compare/three_way_comparable.html)<  
[std::chrono::sys_seconds](../system_clock.html), [std::chrono::sys_time](../system_clock.html)<Duration>>  
constexpr auto operator<=>( const [std::chrono::leap_second](../leap_second.html)& x,  
const [std::chrono::sys_time](../system_clock.html)<Duration>& y ) noexcept; |  (12)  |  (since C++20)  
| |   
  
Compares the date and time represented by the objects x and y. 

Return type of (12) is deduced from x.date() <=> y, and hence the three-way comparison result type of [std::chrono::seconds](../duration.html "cpp/chrono/duration") and `Duration`. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/leap_second/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value
