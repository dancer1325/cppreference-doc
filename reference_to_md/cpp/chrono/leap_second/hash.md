...
Nonmember functions  
[operator==operator<operator<=operator>operator>=operator<=>](operator_cmp.html "cpp/chrono/leap second/operator cmp")  
Helper classes  
...
---|---|---  
template<> struct hash<[std::chrono::leap_second](../leap_second.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::leap_second`](../leap_second.html "cpp/chrono/leap second") allows users to obtain hashes of objects of type [std::chrono::leap_second](../leap_second.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
