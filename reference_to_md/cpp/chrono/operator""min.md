...
operator""min( unsigned long long mins ); |  (1)  |  (since C++14)  
constexpr chrono::duration</*unspecified*/, ratio<60,1>>  
operator""min( long double mins ); |  (2)  |  (since C++14)  
| |   
  
Forms a [std::chrono::duration](duration.html "cpp/chrono/duration") literal representing minutes. 

1) Integer literal, returns exactly [std::chrono::minutes](duration.html)(mins).

2) Floating-point literal, returns a floating-point duration equivalent to [std::chrono::minutes](duration.html "cpp/chrono/duration").

## Contents

  * [1 Parameters](operator""min.html#Parameters)
  * [2 Return value](operator""min.html#Return_value)
  * [3 Possible implementation](operator""min.html#Possible_implementation)
  * [4 Notes](operator""min.html#Notes)
  * [5 Example](operator""min.html#Example)
  * [6 See also](operator""min.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22min&action=edit&section=1 "Edit section: Parameters")] Parameters

mins  |  \-  |  the number of minutes   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22min&action=edit&section=2 "Edit section: Return value")] Return value

The [std::chrono::duration](duration.html "cpp/chrono/duration") literal. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22min&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    constexpr [std::chrono::minutes](duration.html) operator""min(unsigned long long m)
    {
        return [std::chrono::minutes](duration.html)(m);
    }
    constexpr [std::chrono::duration](duration.html)<long double,
                                    [std::ratio](../numeric/ratio/ratio.html)<60,1>> operator""min(long double m)
    {
        return [std::chrono::duration](duration.html)<long double, ratio<60,1>> (m);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22min&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22min&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        auto lesson = 45min;
        auto halfmin = 0.5min;
        [std::cout](../io/cout.html) << "One lesson is " << lesson.count() << " minutes"
                     " (" << lesson << ")\n"
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22min&action=edit&section=6 "Edit section: See also")] See also
