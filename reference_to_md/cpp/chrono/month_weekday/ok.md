...
Checks if the contained [`month`](../month.html "cpp/chrono/month") and [`weekday_indexed`](../weekday_indexed.html "cpp/chrono/weekday indexed") objects are valid. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday/ok&action=edit&section=1 "Edit section: Return value")] Return value

month().ok() && weekday_indexed().ok()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday/ok&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto mwdi{[std::chrono::March](../month.html)/[std::chrono::Friday](../weekday.html)[1]};
        [assert](../../error/assert.html)(mwdi.ok());
     
        mwdi = {[std::chrono::month](../month.html)(17)/[std::chrono::Friday](../weekday.html)[1]}; 
        [assert](../../error/assert.html)(not mwdi.ok());
     
        mwdi = {[std::chrono::March](../month.html)/[std::chrono::Friday](../weekday.html)[-4]}; 
        [assert](../../error/assert.html)(not mwdi.ok());
    }
