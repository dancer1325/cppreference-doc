...
constexpr month_weekday( const [std::chrono::month](../month.html)& m,  
const [std::chrono::weekday_indexed](../weekday_indexed.html)& wdi ) noexcept; |  |  (since C++20)  
---|---|---  
| |   
  
Constructs a `month_weekday` object that stores the [`month`](../month.html "cpp/chrono/month") m and the [`weekday_indexed`](../weekday_indexed.html "cpp/chrono/weekday indexed") wdi. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday/month_weekday&action=edit&section=1 "Edit section: Notes")] Notes

A more convenient way to construct a `month_weekday` is with operator/, e.g., [std::chrono::April](../month.html)/[std::chrono::Sunday](../weekday.html)[2]. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday/month_weekday&action=edit&section=2 "Edit section: See also")] See also
