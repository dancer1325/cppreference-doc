...
**month_weekday::month month_weekday::weekday_indexed**  
...
---|---|---  
constexpr [std::chrono::weekday_indexed](../weekday_indexed.html) weekday_indexed() const noexcept; |  (2)  |  (since C++20)  
| |   
...
Run this code
    ...
     
        auto mwdi{[std::chrono::March](../month.html)/[std::chrono::Friday](../weekday.html)[1]}; // 1st Friday in a March
        [std::cout](../../io/cout.html) << ([std::chrono::year_month_day](../year_month_day.html){mwdi/2024} == 
                      [std::chrono::year_month_day](../year_month_day.html){[std::chrono::March](../month.html)/1/2024})
                      << ' ';
        ...
        [std::cout](../../io/cout.html) << ([std::chrono::year_month_day](../year_month_day.html){mwdi/2024} == 
                      [std::chrono::year_month_day](../year_month_day.html){[std::chrono::March](../month.html)/29/2024})
                      << '\n';
    }
