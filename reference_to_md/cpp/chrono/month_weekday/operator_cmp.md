...
---|---|---  
constexpr bool operator==( const [std::chrono::month_weekday](../month_weekday.html)& x,  
const [std::chrono::month_weekday](../month_weekday.html)& y ) noexcept; |  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value

x.month() == y.month() && x.weekday_indexed() == y.weekday_indexed()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday/operator_cmp&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr auto mwdi1{[std::chrono::March](../month.html)/[std::chrono::Friday](../weekday.html)[1]};
     
        constexpr auto mwdi2
        {
            [std::chrono::month_weekday](../month_weekday.html)
            {
                [std::chrono::month](../month.html)(3), [std::chrono::weekday](../weekday.html)(5)[1]
            }
        };
     
