...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day_last/ok&action=edit&section=1 "Edit section: Return value")] Return value

year().ok() && month().ok()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day_last/ok&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto ymdl{[std::chrono::last](../last_spec.html)/11/2020};
        [assert](../../error/assert.html)(ymdl.ok());
        ymdl = [std::chrono::year](../year.html)(2020)/[std::chrono::month](../month.html)(13)/[std::chrono::last](../last_spec.html);
        [assert](../../error/assert.html)(not ymdl.ok());
    }
