...
---|---|---  
constexpr bool operator==( const [std::chrono::year_month_day_last](../year_month_day_last.html)& x,  
const [std::chrono::year_month_day_last](../year_month_day_last.html)& y ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::strong_ordering](../../utility/compare/strong_ordering.html)  
operator<=>( const [std::chrono::year_month_day_last](../year_month_day_last.html)& x,  
const [std::chrono::year_month_day_last](../year_month_day_last.html)& y ) noexcept; |  (2)  |  (since C++20)  
| |   
  
Compares the two `year_month_day_last` values x and y. This is a lexicographical comparison: the [`year()`](accessors.html "cpp/chrono/year month day last/accessors") is compared first, then [`month()`](accessors.html "cpp/chrono/year month day last/accessors"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day_last/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value

1) x.year() == y.year() && x.month() == y.month()

2) x.year() <=> y.year() != 0 ? x.year() <=> y.year() : x.month() <=> y.month()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day_last/operator_cmp&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day_last/operator_cmp&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto ymdl1{11/[std::chrono::last](../last_spec.html)/2020};
        auto mdl{[std::chrono::last](../last_spec.html)/[std::chrono::November](../month.html)};
        auto ymdl2{mdl/2020};
        [assert](../../error/assert.html)(ymdl1 == ymdl2);
     
        ymdl1 -= [std::chrono::months](../duration.html){2};
        ymdl2 -= [std::chrono::months](../duration.html){1};
        [assert](../../error/assert.html)(ymdl1 < ymdl2);
    }
