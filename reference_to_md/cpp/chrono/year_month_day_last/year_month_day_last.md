...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "All last days of months of a given year:\n";
     
        constexpr [std::chrono::year](../year.html) year{2021};
     
        for (int i{1}; i <= 12; ++i)
        {
            const [std::chrono::month_day_last](../month_day_last.html) mdl{[std::chrono::month](../month.html)(i) / [std::chrono::last](../last_spec.html)};
            const [std::chrono::year_month_day_last](../year_month_day_last.html) ymdl{year, mdl};
            [std::cout](../../io/cout.html) << ymdl << " day: " << ymdl.day() << '\n';
        }
    }
