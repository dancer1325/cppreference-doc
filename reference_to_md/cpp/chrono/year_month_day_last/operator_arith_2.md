...
Member functions  
---  
[year_month_day_last::year_month_day_last](year_month_day_last.html "cpp/chrono/year month day last/year month day last")  
[year_month_day_last::operator+=year_month_day_last::operator-=](operator_arith.html "cpp/chrono/year month day last/operator arith")  
[year_month_day_last::yearyear_month_day_last::monthyear_month_day_last::dayyear_month_day_last::month_day_last](accessors.html "cpp/chrono/year month day last/accessors")  
[year_month_day_last::operator sys_daysyear_month_day_last::operator local_days](operator_days.html "cpp/chrono/year month day last/operator days")  
[year_month_day_last::ok](ok.html "cpp/chrono/year month day last/ok")  
Nonmember functions  
[operator==operator<=>](operator_cmp.html "cpp/chrono/year month day last/operator cmp")  
**operator+ operator-**  
[operator<<](operator_ltlt.html "cpp/chrono/year month day last/operator ltlt")  
Helper classes  
...
---|---|---  
constexpr [std::chrono::year_month_day_last](../year_month_day_last.html)  
operator+( const [std::chrono::year_month_day_last](../year_month_day_last.html)& ymdl,  
const [std::chrono::months](../duration.html)& dm ) noexcept; |  |  (since C++20)  
constexpr [std::chrono::year_month_day_last](../year_month_day_last.html)  
operator+( const [std::chrono::months](../duration.html)& dm,  
const [std::chrono::year_month_day_last](../year_month_day_last.html)& ymdl ) noexcept; |  |  (since C++20)  
constexpr [std::chrono::year_month_day_last](../year_month_day_last.html)  
operator+( const [std::chrono::year_month_day_last](../year_month_day_last.html)& ymdl,  
...
1,2) Adds dm.count() months to the date represented by ymdl. The result has the same [`year()`](accessors.html "cpp/chrono/year month day last/accessors") and [`month()`](accessors.html "cpp/chrono/year month day last/accessors") as [std::chrono::year_month](../year_month.html)(ymdl.year(), ymdl.month()) + dm.

3,4) Adds dy.count() years to the date represented by ymdl. The result is equivalent to [std::chrono::year_month_day_last](../year_month_day_last.html)(ymdl.year() + dy, ymdl.month_day_last()).
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day_last/operator_arith_2&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto ymdl{11/[std::chrono::last](../last_spec.html)/2020};
        [std::cout](../../io/cout.html) << ymdl << '\n';
     
        ymdl = [std::chrono::years](../duration.html)(10) + ymdl;
        [std::cout](../../io/cout.html) << ymdl << '\n';
        [assert](../../error/assert.html)(ymdl == [std::chrono::day](../day.html)(30)/
                       [std::chrono::November](../month.html)/
                       [std::chrono::year](../year.html)(2030));
     
        ymdl = ymdl - [std::chrono::months](../duration.html)(6);
        [std::cout](../../io/cout.html) << ymdl << '\n';
        [assert](../../error/assert.html)(ymdl == [std::chrono::day](../day.html)(31)/
                       [std::chrono::May](../month.html)/
                       [std::chrono::year](../year.html)(2030));
    }
