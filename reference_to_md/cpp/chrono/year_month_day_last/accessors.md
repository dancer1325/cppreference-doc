...
**year_month_day_last::year year_month_day_last::monthyear_month_day_last::dayyear_month_day_last::month_day_last**  
...
constexpr [std::chrono::month_day_last](../month_day_last.html) month_day_last() const noexcept; |  (4)  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        constexpr auto ymdl{[std::chrono::last](../last_spec.html)/11/2020};
        static_assert
        (
            ymdl.day() == [std::chrono::day](../day.html)(30) &&
            ymdl.month() == [std::chrono::November](../month.html) &&
            ymdl.year() == [std::chrono::year](../year.html)(2020) &&
            ymdl.month_day_last() == [std::chrono::November](../month.html)/[std::chrono::last](../last_spec.html)
        );
    }
