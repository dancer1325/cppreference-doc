...
**hh_mm_ss::is_negative hh_mm_ss::hourshh_mm_ss::minuteshh_mm_ss::secondshh_mm_ss::subseconds**  
...
---|---|---  
constexpr [std::chrono::hours](../duration.html) hours() const noexcept; |  (2)  |   
constexpr [std::chrono::minutes](../duration.html) minutes() const noexcept; |  (3)  |   
constexpr [std::chrono::seconds](../duration.html) seconds() const noexcept; |  (4)  |   
...
2) [std::chrono::duration_cast](../duration/duration_cast.html)<[std::chrono::hours](../duration.html)>(abs(d))

3) [std::chrono::duration_cast](../duration/duration_cast.html)<[std::chrono::minutes](../duration.html)>(abs(d) - hours())

4) [std::chrono::duration_cast](../duration/duration_cast.html)<[std::chrono::seconds](../duration.html)>(abs(d) - hours() - minutes())
