...
[Member functions](../hh_mm_ss.html#Member_functions "cpp/chrono/hh mm ss")  
---  
[hh_mm_ss::hh_mm_ss](hh_mm_ss.html "cpp/chrono/hh mm ss/hh mm ss")  
[hh_mm_ss::is_negativehh_mm_ss::hourshh_mm_ss::minuteshh_mm_ss::secondshh_mm_ss::subseconds](accessors.html "cpp/chrono/hh mm ss/accessors")  
[hh_mm_ss::operator precisionhh_mm_ss::to_duration](duration.html "cpp/chrono/hh mm ss/duration")  
[Non-member functions](../hh_mm_ss.html#Non-member_functions "cpp/chrono/hh mm ss")  
[operator<<](operator_ltlt.html "cpp/chrono/hh mm ss/operator ltlt")  
...
struct formatter<[std::chrono::hh_mm_ss](../hh_mm_ss.html), CharT>; |  |  (since C++20)  
| |   
  
Specialization of [std::formatter](../../utility/format/formatter.html "cpp/utility/format/formatter") that defines formatting rules for a [std::chrono::hh_mm_ss](../hh_mm_ss.html "cpp/chrono/hh mm ss"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/hh_mm_ss/formatter&action=edit&section=1 "Edit section: Format specification")] Format specification
...
Unless otherwise specified, if the chrono-spec is empty, the chrono object is formatted as if by [streaming](operator_ltlt.html "cpp/chrono/hh mm ss/operator ltlt") it to an object `os` of type [std::basic_ostringstream](../../io/basic_ostringstream.html)<CharT> with the formatting locale (one of [std::locale::classic](../../locale/locale/classic.html)(), the passed [std::locale](../../locale/locale.html "cpp/locale/locale") object, and [std::locale::global](../../locale/locale/global.html)()) [imbued](../../io/ios_base/imbue.html "cpp/io/ios base/imbue") and copying os.str() to the output buffer with additional padding and adjustments as per format specifiers. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/hh_mm_ss/formatter&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::chrono::hh_mm_ss](../hh_mm_ss.html) c{16h + 32min + 10s};
     
        [std::cout](../../io/cout.html) << "%R: " << [std::format](../../utility/format/format.html)("{:%R}", c) << '\n'
                  << "%T: " << [std::format](../../utility/format/format.html)("{:%T}", c) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/hh_mm_ss/formatter&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/hh_mm_ss/formatter&action=edit&section=4 "Edit section: See also")] See also
