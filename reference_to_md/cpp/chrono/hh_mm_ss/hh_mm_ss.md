...
2) Constructs a `hh_mm_ss` object corresponding to d: 
  ...
  * hours() returns [std::chrono::duration_cast](../duration/duration_cast.html)<[std::chrono::hours](../duration.html)>(abs(d)). 
  * minutes() returns [std::chrono::duration_cast](../duration/duration_cast.html)<[std::chrono::minutes](../duration.html)>(abs(d) - hours()). 
  * seconds() returns  
[std::chrono::duration_cast](../duration/duration_cast.html)<[std::chrono::seconds](../duration.html)>(abs(d) - hours() - minutes()). 
  * subseconds() returns abs(d) - hours() - minutes() - seconds() if [std::chrono::treat_as_floating_point_v](../treat_as_floating_point.html)<precision::rep> is true; otherwise it returns [std::chrono::duration_cast](../duration/duration_cast.html)<precision>(abs(d) - hours() - minutes() - seconds()).



### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/hh_mm_ss/hh_mm_ss&action=edit&section=1 "Edit section: Parameters")] Parameters

d  |  \-  |  the duration to be broken down   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/hh_mm_ss/hh_mm_ss&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::println](../../io/println.html)("Default constructor: {}", [std::chrono::hh_mm_ss](../hh_mm_ss.html)<[std::chrono::minutes](../duration.html)>{});
     
        [std::chrono::time_point](../time_point.html) now = [std::chrono::system_clock::now](../system_clock/now.html)();
        [std::chrono::hh_mm_ss](../hh_mm_ss.html) time_of_day{now - [std::chrono::floor](../duration/floor.html)<[std::chrono::days](../duration.html)>(now)};
        [std::println](../../io/println.html)("The time of day is: {}", time_of_day);
    }
