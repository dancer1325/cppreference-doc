...
const [std::chrono::file_time](../file_clock.html)<Duration>& tp ); |  |  (since C++20)  
| |   
...
[ std::formatter<std::chrono::file_time>](formatter.html "cpp/chrono/file clock/formatter")(C++20) |  formatting support for `file_time`   
