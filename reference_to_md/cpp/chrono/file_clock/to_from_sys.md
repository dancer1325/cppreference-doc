...
**file_clock::to_sys file_clock::from_sys**(optional*)  
...
static [std::chrono::sys_time](../system_clock.html)</*see below*/>  
to_sys( const [std::chrono::file_time](../file_clock.html)<Duration>& t ); |  (1)  |  (since C++20)   
(optional*)  
---|---|---  
template< class Duration >  
static [std::chrono::file_time](../file_clock.html)</*see below*/>  
from_sys( const [std::chrono::sys_time](../system_clock.html)<Duration>& t ); |  (2)  |  (since C++20)   
(optional*)  
| |   
...
These function templates are optional: an implementation may choose to instead provide [`to_utc()`](to_from_utc.html "cpp/chrono/file clock/to from utc") and [`from_utc()`](to_from_utc.html "cpp/chrono/file clock/to from utc"). 

## Contents

  * [1 Return value](to_from_sys.html#Return_value)
  * [2 Notes](to_from_sys.html#Notes)
  * [3 Example](to_from_sys.html#Example)
  * [4 See also](to_from_sys.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/file_clock/to_from_sys&action=edit&section=1 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/file_clock/to_from_sys&action=edit&section=2 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/file_clock/to_from_sys&action=edit&section=3 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/file_clock/to_from_sys&action=edit&section=4 "Edit section: See also")] See also

[ to_utcfrom_utc](to_from_utc.html "cpp/chrono/file clock/to from utc")[static] (optional) |  converts between `file_time` and `utc_time`   
