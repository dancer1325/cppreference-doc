...
**file_clock::to_utc file_clock::from_utc**(optional*)  
Time point I/O  
...
to_utc( const [std::chrono::file_time](../file_clock.html)<Duration>& t ); |  (1)  |  (since C++20)   
(optional*)  
---|---|---  
template< class Duration >  
static [std::chrono::file_time](../file_clock.html)</* see below */>  
from_utc( const [std::chrono::utc_time](../utc_clock.html)<Duration>& t ); |  (2)  |  (since C++20)   
(optional*)  
| |   
...
These function templates are optional: an implementation may choose to instead provide [`to_sys()`](to_from_sys.html "cpp/chrono/file clock/to from sys") and [`from_sys()`](to_from_sys.html "cpp/chrono/file clock/to from sys"). 

## Contents

  * [1 Return value](to_from_utc.html#Return_value)
  * [2 Notes](to_from_utc.html#Notes)
  * [3 Example](to_from_utc.html#Example)
  * [4 See also](to_from_utc.html#See_also)
