...
const [std::chrono::gps_time](../gps_clock.html)<Duration>& tp ); |  |  (since C++20)  
| |   
...
[ std::formatter<std::chrono::gps_time>](formatter.html "cpp/chrono/gps clock/formatter")(C++20) |  formatting support for `gps_time`   
