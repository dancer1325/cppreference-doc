...
static [std::chrono::gps_time](../gps_clock.html)<[std::common_type_t](../../types/common_type.html)<Duration, [std::chrono::seconds](../duration.html)>>  
from_utc( const [std::chrono::utc_time](../utc_clock.html)<Duration>& ) noexcept; |  |  (since C++20)  
---|---|---  
| |   
...
[ to_utc](to_utc.html "cpp/chrono/gps clock/to utc")[static] |  converts a `gps_time` to `utc_time`   
