...
---|---|---  
constexpr [std::chrono::microseconds](duration.html)  
operator""us( unsigned long long us ); |  (1)  |  (since C++14)  
constexpr [std::chrono::duration](duration.html)</*unspecified*/, [std::micro](../numeric/ratio/ratio.html)>  
operator""us( long double us ); |  (2)  |  (since C++14)  
| |   
  
Forms a [std::chrono::duration](duration.html "cpp/chrono/duration") literal representing microseconds. 

1) Integer literal, returns exactly [std::chrono::microseconds](duration.html)(us).

2) Floating-point literal, returns a floating-point duration equivalent to [std::chrono::microseconds](duration.html "cpp/chrono/duration").

## Contents

  * [1 Parameters](operator""us.html#Parameters)
  * [2 Return value](operator""us.html#Return_value)
  * [3 Possible implementation](operator""us.html#Possible_implementation)
  * [4 Notes](operator""us.html#Notes)
  * [5 Example](operator""us.html#Example)
  * [6 See also](operator""us.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22us&action=edit&section=1 "Edit section: Parameters")] Parameters

us  |  \-  |  the number of microseconds   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22us&action=edit&section=2 "Edit section: Return value")] Return value

The [std::chrono::duration](duration.html "cpp/chrono/duration") literal. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22us&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    constexpr [std::chrono::microseconds](duration.html) operator""us(unsigned long long us)
    {
        return [std::chrono::microseconds](duration.html)(us);
    }
    constexpr [std::chrono::duration](duration.html)<long double, [std::micro](../numeric/ratio/ratio.html)> operator""us(long double us)
    {
        return [std::chrono::duration](duration.html)<long double, [std::micro](../numeric/ratio/ratio.html)>(us);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22us&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22us&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        auto d1 = 250us;
        [std::chrono::microseconds](duration.html) d2 = 1ms;
        [std::cout](../io/cout.html) << d1 << " = " << d1.count() << " microseconds\n"
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22us&action=edit&section=6 "Edit section: See also")] See also
