...
---|---|---  
template<> struct hash<[std::chrono::year](../year.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::year`](../year.html "cpp/chrono/year") allows users to obtain hashes of objects of type [std::chrono::year](../year.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
