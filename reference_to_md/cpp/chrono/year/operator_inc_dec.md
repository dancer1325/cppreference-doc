...
constexpr [std::chrono::year](../year.html)& operator++() noexcept; |  (1)  |  (since C++20)  
---|---|---  
constexpr [std::chrono::year](../year.html) operator++( int ) noexcept; |  (2)  |  (since C++20)  
constexpr [std::chrono::year](../year.html)& operator\--() noexcept; |  (3)  |  (since C++20)  
constexpr [std::chrono::year](../year.html) operator\--( int ) noexcept; |  (4)  |  (since C++20)  
| |   
  
Adds or subtracts 1 from the year value. 

1,2) Performs *this += [std::chrono::years](../duration.html){1};.

3,4) Performs *this -= [std::chrono::years](../duration.html){1};.

## Contents

  * [1 Parameters](operator_inc_dec.html#Parameters)
  * [2 Return value](operator_inc_dec.html#Return_value)
  * [3 Notes](operator_inc_dec.html#Notes)
  * [4 Example](operator_inc_dec.html#Example)
  * [5 See also](operator_inc_dec.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_inc_dec&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_inc_dec&action=edit&section=2 "Edit section: Return value")] Return value

1,3) A reference to this `year` after modification.

2,4) A copy of the `year` made before modification.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_inc_dec&action=edit&section=3 "Edit section: Notes")] Notes

If the result would be outside the range `[`-32767`, `32767`]`, the actual stored value is unspecified. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_inc_dec&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html) << (++y == [std::chrono::year](../year.html)(2021)) << ' ';
        [std::cout](../../io/cout.html) << (--y == [std::chrono::year](../year.html)(2020)) << '\n';
     
        using namespace std::literals::chrono_literals;
        y = 32767y;
        y++; //← unspecified, see ↑ Notes ↑
        [std::cout](../../io/cout.html) << static_cast<int>(y) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_inc_dec&action=edit&section=5 "Edit section: See also")] See also

[ operator+=operator-=](operator_arith.html "cpp/chrono/year/operator arith") |  adds or subtracts a number of years from a `year`   
...
---|---  
[ operator+operator-](operator_arith_2.html "cpp/chrono/year/operator arith 2")(C++20) |  performs arithmetic on `year`s   
