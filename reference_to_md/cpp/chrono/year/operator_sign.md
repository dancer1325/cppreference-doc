...
---|---|---  
constexpr [std::chrono::year](../year.html) operator-() noexcept; |  (2)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_sign&action=edit&section=1 "Edit section: Return value")] Return value

1) *this

2) [std::chrono::year](../year.html)(-int(*this))

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_sign&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr [std::chrono::year](../year.html) y{2020};
        constexpr auto ny = -y;
        [std::cout](../../io/cout.html) << "The year " << (int)y << " negated is " << (int)ny << '\n';
    }
