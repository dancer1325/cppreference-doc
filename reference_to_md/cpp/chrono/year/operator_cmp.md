...
---|---|---  
constexpr bool operator==( const [std::chrono::year](../year.html)& x,  
const [std::chrono::year](../year.html)& y ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::strong_ordering](../../utility/compare/strong_ordering.html) operator<=>( const [std::chrono::year](../year.html)& x,  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value

1) int(x) == int(y)

2) int(x) <=> int(y)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_cmp&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html) << (y1 != y2) << '\n';
     
