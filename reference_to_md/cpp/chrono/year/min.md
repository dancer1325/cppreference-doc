...
static constexpr [std::chrono::year](../year.html) min() noexcept; |  |  (since C++20)  
---|---|---  
| |   
  
Returns the smallest possible `year`, that is, [std::chrono::year](../year.html)(-32767). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/min&action=edit&section=1 "Edit section: Return value")] Return value

[std::chrono::year](../year.html)(-32767)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/min&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::cout](../../io/cout.html) << "The minimum year is: " << (int)std::chrono::year::min() << '\n';
    }
