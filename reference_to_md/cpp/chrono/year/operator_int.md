...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_int&action=edit&section=1 "Edit section: Return value")] Return value

The year value stored in *this. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_int&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "The year is: " << static_cast<int>(y) << '\n';
     
        const year_month_day ymd{floor<days>(system_clock::now())};
        const [std::chrono::year](../year.html) this_year{ymd.year()};
        [std::cout](../../io/cout.html) << "This year is: " << int(this_year) << '\n';
    }
