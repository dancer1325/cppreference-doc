...
Run this code
    ...
    int main() 
    {
        [std::chrono::time_point](../time_point.html)<[std::chrono::system_clock](../system_clock.html)> now =
            [std::chrono::system_clock::now](../system_clock/now.html)();
        [std::vector](../../container/vector.html)<[std::chrono::time_point](../time_point.html)<[std::chrono::system_clock](../system_clock.html)>> times
        {
            now - [std::chrono::hours](../duration.html)(24),
            now - [std::chrono::hours](../duration.html)(48),
            now + [std::chrono::hours](../duration.html)(24)
        };  
     
        [std::chrono::time_point](../time_point.html)<[std::chrono::system_clock](../system_clock.html)> earliest =
            [std::chrono::time_point](../time_point.html)<[std::chrono::system_clock](../system_clock.html)>::max();
     
        [std::cout](../../io/cout.html) << "all times:\n";
        for (const auto& time : times)
        {
            [std::time_t](../c/time_t.html) t = [std::chrono::system_clock::to_time_t](../system_clock/to_time_t.html)(time);
            [std::cout](../../io/cout.html) << [std::ctime](../c/ctime.html)(&t);
     
            if (time < earliest)
                earliest = time;
        }
     
        [std::time_t](../c/time_t.html) t = [std::chrono::system_clock::to_time_t](../system_clock/to_time_t.html)(earliest);
        [std::cout](../../io/cout.html) << "earliest:\n" << [std::ctime](../c/ctime.html)(&t);
    }
