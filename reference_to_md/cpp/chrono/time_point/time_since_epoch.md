...
Returns a [duration](../duration.html "cpp/chrono/duration") representing the amount of time between *this and the `clock`'s epoch. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/time_point/time_since_epoch&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/time_point/time_since_epoch&action=edit&section=2 "Edit section: Return value")] Return value

The amount of time between this `time_point` and the `clock`'s epoch. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/time_point/time_since_epoch&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        const auto p0 = [std::chrono::time_point](../time_point.html)<[std::chrono::system_clock](../system_clock.html)>{};
        const auto p1 = [std::chrono::system_clock::now](../system_clock/now.html)();
        const auto p2 = p1 - [std::chrono::hours](../duration.html)(24);
     
        [std::time_t](../c/time_t.html) epoch_time = [std::chrono::system_clock::to_time_t](../system_clock/to_time_t.html)(p0);
        [std::cout](../../io/cout.html) << "epoch: " << [std::ctime](../c/ctime.html)(&epoch_time);
        [std::time_t](../c/time_t.html) today_time = [std::chrono::system_clock::to_time_t](../system_clock/to_time_t.html)(p1);
        [std::cout](../../io/cout.html) << "today: " << [std::ctime](../c/ctime.html)(&today_time);
     
        [std::cout](../../io/cout.html) << "hours since epoch: "
                  << [std::chrono::duration_cast](../duration/duration_cast.html)<[std::chrono::hours](../duration.html)>(
                         p1.time_since_epoch()).count() 
                  << '\n';
        [std::cout](../../io/cout.html) << "yesterday, hours since epoch: "
                  << [std::chrono::duration_cast](../duration/duration_cast.html)<[std::chrono::hours](../duration.html)>(
