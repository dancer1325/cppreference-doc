...
floor( const [std::chrono::time_point](../time_point.html)<Clock, Duration>& tp ); |  |  (since C++17)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/time_point/floor&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    ...
    constexpr [std::chrono::time_point](../time_point.html)<Clock, To>
        floor(const [std::chrono::time_point](../time_point.html)<Clock, FromDuration>& tp)
    {
        return [std::chrono::time_point](../time_point.html)<Clock, To>{
            [std::chrono::floor](../duration/floor.html)<To>(tp.time_since_epoch())};
    }  
