...
time_point_cast( const [std::chrono::time_point](../time_point.html)<Clock, Duration> &t ); |  | (since C++11)   
(until C++14)  
template< class ToDuration, class Clock, class Duration >  
constexpr [std::chrono::time_point](../time_point.html)<Clock, ToDuration>  
time_point_cast( const [std::chrono::time_point](../time_point.html)<Clock, Duration> &t ); |  |  (since C++14)  
| |   
  
Converts a [std::chrono::time_point](../time_point.html "cpp/chrono/time point") from one duration to another. 

`time_point_cast` participates in overload resolution only if `ToDuration` is a specialization of [std::chrono::duration](../duration.html "cpp/chrono/duration"). 

## Contents

  * [1 Parameters](time_point_cast.html#Parameters)
  * [2 Return value](time_point_cast.html#Return_value)
  * [3 Example](time_point_cast.html#Example)
  * [4 See also](time_point_cast.html#See_also)
...
Run this code
    ...
     
    using Clock = [std::chrono::high_resolution_clock](../high_resolution_clock.html);
    using Ms = [std::chrono::milliseconds](../duration.html);
    using Sec = [std::chrono::seconds](../duration.html);
     
    template<class Duration>
    using TimePoint = [std::chrono::time_point](../time_point.html)<Clock, Duration>;
     
    inline void print_ms(const TimePoint<Ms>& time_point)
    {
        [std::cout](../../io/cout.html) << time_point.time_since_epoch().count() << " ms\n";
    }
     
    int main()
    {
