...
[std::chrono::time_point](../time_point.html)<Clock, Duration2>>; |  |  (since C++11)  
---|---|---  
| |   
  
Exposes the type named `type`, which is the common type of two [std::chrono::time_point](../time_point.html "cpp/chrono/time point")s. 

## Contents

  * [1 Member types](common_type.html#Member_types)
  * [2 Notes](common_type.html#Notes)
