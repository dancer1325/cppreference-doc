...
struct hash<[std::chrono::time_point](../time_point.html)<Clock, Duration>>; |  |  (since C++26)  
| |   
...
Run this code
    ...
     
    struct my_system_clock : [std::chrono::system_clock](../system_clock.html)
    {
        using time_point = [std::chrono::time_point](../time_point.html)<my_system_clock>;
     
        static time_point now() noexcept
        {
            return time_point{[std::chrono::system_clock::now](../system_clock/now.html)().time_since_epoch()};
        }
     
        template<class CharT, class Traits>
        friend auto operator<<([std::basic_ostream](../../io/basic_ostream.html)<CharT, Traits>& os, const time_point& tp)
            -> decltype(os)
        {
    ...
     
    using my_system_clock_tp = [std::chrono::time_point](../time_point.html)<my_system_clock>;
     
    #if __cpp_lib_chrono < 202306L
    // custom specialization of std::hash can be injected in namespace std
    template<>
    struct [std::hash](../../utility/hash.html)<my_system_clock_tp>
    {
        [std::size_t](../../types/size_t.html) operator()(const my_system_clock_tp& d) const noexcept
        {
    ...
     
        [std::unordered_map](../../container/unordered_map.html)<my_system_clock_tp, [std::string](../../string/basic_string.html)> log;
     
        for (int i{}; i != 4; ++i)
        {
            [std::this_thread::sleep_for](../../thread/sleep_for.html)(100ms);
            log[my_system_clock::now()] = "event #" + [std::to_string](../../string/basic_string/to_string.html)(i);
        }
     
        for (auto const& [time, message] : log)
            [std::cout](../../io/cout.html) << '[' << time << "], message: " << message << '\n';
    }
