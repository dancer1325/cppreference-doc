...
---|---|---  
constexpr [std::chrono::milliseconds](duration.html)  
operator""ms( unsigned long long ms ); |  (1)  |  (since C++14)  
constexpr [std::chrono::duration](duration.html)</*unspecified*/, [std::milli](../numeric/ratio/ratio.html)>  
operator""ms( long double ms ); |  (2)  |  (since C++14)  
| |   
  
Forms a [std::chrono::duration](duration.html "cpp/chrono/duration") literal representing milliseconds. 

1) Integer literal, returns exactly [std::chrono::milliseconds](duration.html)(ms).

2) Floating-point literal, returns a floating-point duration equivalent to [std::chrono::milliseconds](duration.html "cpp/chrono/duration").

## Contents

  * [1 Parameters](operator""ms.html#Parameters)
  * [2 Return value](operator""ms.html#Return_value)
  * [3 Possible implementation](operator""ms.html#Possible_implementation)
  * [4 Notes](operator""ms.html#Notes)
  * [5 Example](operator""ms.html#Example)
  * [6 See also](operator""ms.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ms&action=edit&section=1 "Edit section: Parameters")] Parameters

ms  |  \-  |  the number of milliseconds   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ms&action=edit&section=2 "Edit section: Return value")] Return value

The [std::chrono::duration](duration.html "cpp/chrono/duration") literal. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ms&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    constexpr [std::chrono::milliseconds](duration.html) operator""ms(unsigned long long ms)
    {
        return [std::chrono::milliseconds](duration.html)(ms);
    }
    constexpr [std::chrono::duration](duration.html)<long double, [std::milli](../numeric/ratio/ratio.html)> operator""ms(long double ms)
    {
        return [std::chrono::duration](duration.html)<long double, [std::milli](../numeric/ratio/ratio.html)>(ms);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ms&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ms&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        constexpr [std::chrono::milliseconds](duration.html) d2{1s};
        [std::cout](../io/cout.html) << d1 << " = " << d1.count() << " milliseconds\n"
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ms&action=edit&section=6 "Edit section: See also")] See also
