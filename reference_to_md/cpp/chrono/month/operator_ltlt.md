...
operator<<( [std::basic_ostream](../../io/basic_ostream.html)<CharT, Traits>& os, const [std::chrono::month](../month.html)& m ); |  |  (since C++20)  
| |   
  
If !m.ok(), inserts unsigned(m) followed by " is not a valid month" to os. Otherwise, forms a [std::basic_string](../../string/basic_string.html)<CharT> s consisting of the abbreviated month name for the month represented by m, determined using the locale associated with os, and inserts s into os. 

Equivalent to 

return os << (m.ok() ?  
[std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{:L%b}"), m) :  
[std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{} is not a valid month"), unsigned(m)));

where STATICALLY_WIDEN<CharT>("...") is "..." if `CharT` is char, and L"..." if `CharT` is wchar_t. 

## Contents

  * [1 Return value](operator_ltlt.html#Return_value)
  * [2 Notes](operator_ltlt.html#Notes)
  * [3 Defect reports](operator_ltlt.html#Defect_reports)
  * [4 See also](operator_ltlt.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value

os

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month/operator_ltlt&action=edit&section=2 "Edit section: Notes")] Notes

This operator<< is primarily intended for debugging use. For control over formatting, use [std::format](../../utility/format/format.html "cpp/utility/format/format"). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month/operator_ltlt&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month/operator_ltlt&action=edit&section=4 "Edit section: See also")] See also
...
---|---  
[ std::formatter<std::chrono::month>](formatter.html "cpp/chrono/month/formatter")(C++20) |  formatting support for `month`   
