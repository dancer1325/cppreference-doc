...
---|---|---  
constexpr [std::chrono::month](../month.html) operator++( int ) noexcept; |  (2)  |  (since C++20)  
constexpr [std::chrono::month](../month.html)& operator\--() noexcept; |  (3)  |  (since C++20)  
constexpr [std::chrono::month](../month.html) operator\--( int ) noexcept; |  (4)  |  (since C++20)  
| |   
  
Adds or subtracts 1 from the month value, reducing the result modulo 12 to an integer in the range `[`1`, `12`]`. 

1,2) Performs *this += [std::chrono::months](../duration.html){1};.

3,4) Performs *this -= [std::chrono::months](../duration.html){1};.
...
Run this code
    ...
     
        ++m;
        [assert](../../error/assert.html)(m == [std::chrono::month](../month.html)(7));
     
        --m;
        [assert](../../error/assert.html)(m == [std::chrono::month](../month.html)(6));
     
        m = [std::chrono::December](../month.html);
        m++; // rounds up to January
        [assert](../../error/assert.html)(m.ok());
        [std::cout](../../io/cout.html) << unsigned(m) << '\n';
     
        m = [std::chrono::January](../month.html);
