...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month/operator_unsigned&action=edit&section=1 "Edit section: Return value")] Return value

The month value stored in *this. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month/operator_unsigned&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr [std::chrono::month](../month.html) m{6};
        constexpr unsigned p = static_cast<unsigned>(m);
        constexpr unsigned q = static_cast<unsigned>([std::chrono::September](../month.html));
        [std::cout](../../io/cout.html) << "The month is: " << p << '\n'
                  << "September is: " << q << '\n'; 
    }
