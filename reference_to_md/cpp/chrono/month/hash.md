...
---|---|---  
template<> struct hash<[std::chrono::month](../month.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::month`](../month.html "cpp/chrono/month") allows users to obtain hashes of objects of type [std::chrono::month](../month.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
