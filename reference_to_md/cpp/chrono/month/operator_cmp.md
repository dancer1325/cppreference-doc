...
---|---|---  
constexpr bool operator==( const [std::chrono::month](../month.html)& x,  
const [std::chrono::month](../month.html)& y ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::strong_ordering](../../utility/compare/strong_ordering.html) operator<=>( const [std::chrono::month](../month.html)& x,  
const [std::chrono::month](../month.html)& y ) noexcept; |  (2)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value

1) unsigned(x) == unsigned(y)

2) unsigned(x) <=> unsigned(y)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month/operator_cmp&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr [std::chrono::month](../month.html) m1{6}, m2{8};
     
        static_assert
        (
            m1 < m2 && m1 == m1 && m1 <= m2 &&
