...
---|---|---  
constexpr [std::chrono::month](../month.html) operator+( const [std::chrono::month](../month.html)& m,  
const [std::chrono::months](../duration.html)& ms ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::chrono::month](../month.html) operator+( const [std::chrono::months](../duration.html)& ms,  
const [std::chrono::month](../month.html)& m ) noexcept; |  (2)  |  (since C++20)  
constexpr [std::chrono::month](../month.html) operator-( const [std::chrono::month](../month.html)& m,   
const [std::chrono::months](../duration.html)& ms ) noexcept; |  (3)  |  (since C++20)  
constexpr [std::chrono::months](../duration.html) operator-( const [std::chrono::month](../month.html)& m1,   
const [std::chrono::month](../month.html)& m2 ) noexcept; |  (4)  |  (since C++20)  
| |   
...
Run this code
    ...
     
        m = m + [std::chrono::months](../duration.html)(2);
        [assert](../../error/assert.html)(m == [std::chrono::month](../month.html)(8));
     
        m = m - [std::chrono::months](../duration.html)(3);
        [assert](../../error/assert.html)(m == [std::chrono::month](../month.html)(5));
     
        constexpr [std::chrono::months](../duration.html) ms = [std::chrono::month](../month.html)(8) - [std::chrono::month](../month.html)(6);
