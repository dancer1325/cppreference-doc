...
const [std::chrono::duration](../duration.html)<Rep2, Period2>& rhs ); |  (1)  |  (since C++11)  
---|---|---  
template< class Rep1, class Period1, class Rep2, class Period2 >  
constexpr bool operator!=( const [std::chrono::duration](../duration.html)<Rep1, Period1>& lhs,  
const [std::chrono::duration](../duration.html)<Rep2, Period2>& rhs ); |  (2)  |  (since C++11)   
(until C++20)  
template< class Rep1, class Period1, class Rep2, class Period2 >  
constexpr bool operator<( const [std::chrono::duration](../duration.html)<Rep1, Period1>& lhs,  
const [std::chrono::duration](../duration.html)<Rep2, Period2>& rhs ); |  (3)  |  (since C++11)  
template< class Rep1, class Period1, class Rep2, class Period2 >  
constexpr bool operator<=( const [std::chrono::duration](../duration.html)<Rep1, Period1>& lhs,  
const [std::chrono::duration](../duration.html)<Rep2, Period2>& rhs ); |  (4)  |  (since C++11)  
template< class Rep1, class Period1, class Rep2, class Period2 >  
constexpr bool operator>( const [std::chrono::duration](../duration.html)<Rep1, Period1>& lhs,  
const [std::chrono::duration](../duration.html)<Rep2, Period2>& rhs ); |  (5)  |  (since C++11)  
template< class Rep1, class Period1, class Rep2, class Period2 >  
constexpr bool operator>=( const [std::chrono::duration](../duration.html)<Rep1, Period1>& lhs,  
const [std::chrono::duration](../duration.html)<Rep2, Period2>& rhs ); |  (6)  |  (since C++11)  
template< class Rep1, class Period1, class Rep2, class Period2 >  
requires [std::three_way_comparable](../../utility/compare/three_way_comparable.html)<[std::common_type_t](../../types/common_type.html)<Rep1, Rep2>>  
constexpr auto operator<=>( const [std::chrono::duration](../duration.html)<Rep1, Period1>& lhs,  
const [std::chrono::duration](../duration.html)<Rep2, Period2>& rhs ); |  (7)  |  (since C++20)  
| |   
  
Compares two durations. Let `CT` be [std::common_type](../../types/common_type.html)<[std::chrono::duration](../duration.html)<Rep1, Period1>, [std::chrono::duration](../duration.html)<Rep2, Period2>>::type: 
...
Run this code
    ...
    int main()
    {
        constexpr auto t1 = [std::chrono::seconds](../duration.html)(2);
        constexpr auto t2 = [std::chrono::milliseconds](../duration.html)(2000);
     
        if constexpr (t1 == t2)
            [std::cout](../../io/cout.html) << t1 << " == " << t2 << '\n';
        else
            [std::cout](../../io/cout.html) << t1 << " != " << t2 << '\n';
     
        constexpr auto t3 = [std::chrono::seconds](../duration.html)(61);
        constexpr auto t4 = [std::chrono::minutes](../duration.html)(1);
     
        if constexpr (t3 > t4)
            [std::cout](../../io/cout.html) << t3 << " > " << t4 << '\n';
        else
            [std::cout](../../io/cout.html) << t3 << " <= " << t4 << '\n';
     
