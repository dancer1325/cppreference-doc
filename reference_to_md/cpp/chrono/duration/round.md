...
constexpr ToDuration round( const [std::chrono::duration](../duration.html)<Rep, Period>& d ); |  |  (since C++17)  
| |   
...
The function does not participate in the overload resolution unless `ToDuration` is a specialization of [std::chrono::duration](../duration.html "cpp/chrono/duration") and [std::chrono::treat_as_floating_point_v](../treat_as_floating_point.html)<typename ToDuration::rep> is false. 

## Contents

  * [1 Parameters](round.html#Parameters)
  * [2 Return value](round.html#Return_value)
  * [3 Possible implementation](round.html#Possible_implementation)
  * [4 Example](round.html#Example)
  * [5 See also](round.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/round&action=edit&section=1 "Edit section: Parameters")] Parameters

d  |  \-  |  duration to convert   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/round&action=edit&section=2 "Edit section: Return value")] Return value

d rounded to the nearest duration of type `ToDuration`, rounding to even in halfway cases. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/round&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    ...
    namespace detail
    {
        ...
        template<class Rep, class Period> inline constexpr bool is_duration_v<
            [std::chrono::duration](../duration.html)<Rep, Period>> = true;
    }
     
    template<class To, class Rep, class Period,
             class = [std::enable_if_t](../../types/enable_if.html)<detail::is_duration_v<To> &&
                    ![std::chrono::treat_as_floating_point_v](../treat_as_floating_point.html)<typename To::rep>>>
    constexpr To round(const [std::chrono::duration](../duration.html)<Rep, Period>& d)
    {
        To t0 = [std::chrono::floor](floor.html)<To>(d);
        To t1 = t0 + To{1};
        auto diff0 = d - t0;
        auto diff1 = t1 - d;
        if (diff0 == diff1)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/round&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << "Duration\tFloor\tRound\tCeil\n";
        for (using Sec = [std::chrono::seconds](../duration.html);
            auto const d : {+4999ms, +5000ms, +5001ms, +5499ms, +5500ms, +5999ms,
                            -4999ms, -5000ms, -5001ms, -5499ms, -5500ms, -5999ms})
            [std::cout](../../io/cout.html) << [std::showpos](../../io/manip/showpos.html) << d << "\t\t"
                      << [std::chrono::floor](floor.html)<Sec>(d) << '\t'
                      << std::chrono::round<Sec>(d) << '\t'
                      << [std::chrono::ceil](ceil.html) <Sec>(d) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/round&action=edit&section=5 "Edit section: See also")] See also
