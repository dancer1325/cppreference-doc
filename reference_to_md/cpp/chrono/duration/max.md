...
If the representation `rep` of the duration requires some other implementation to return a maximum-length duration, [std::chrono::duration_values](../duration_values.html "cpp/chrono/duration values") can be specialized to return the desired value. 
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html)
            << [std::scientific](../../io/manip/fixed.html) << [std::setprecision](../../io/manip/setprecision.html)(2)
            ...
            << ", sizeof(chrono::years) = "
            << sizeof([std::chrono::years](../duration.html)) << " bytes.\n" "chrono::years "
            ...
            << sizeof([std::chrono::seconds](../duration.html)) << " bytes.\n" "chrono::seconds "
