...
| **formatter <std::chrono::duration>**(C++20)  
---  
...
struct formatter<[std::chrono::duration](../duration.html)<Rep, Period>, CharT>; |  |   
| |   
  
Specialization of [std::formatter](../../utility/format/formatter.html "cpp/utility/format/formatter") that defines formatting rules for a [std::chrono::duration](../duration.html "cpp/chrono/duration"). The `duration` is interpreted as the time of day since midnight. 
...
Unless otherwise specified, if the chrono-spec is empty, the chrono object is formatted as if by [streaming](operator_ltlt.html "cpp/chrono/duration/operator ltlt") it to an object `os` of type [std::basic_ostringstream](../../io/basic_ostringstream.html)<CharT> with the formatting locale (one of [std::locale::classic](../../locale/locale/classic.html)(), the passed [std::locale](../../locale/locale.html "cpp/locale/locale") object, and [std::locale::global](../../locale/locale/global.html)()) [imbued](../../io/ios_base/imbue.html "cpp/io/ios base/imbue") and copying os.str() to the output buffer with additional padding and adjustments as per format specifiers. 
...
Duration count   
`%Q` |  Writes the count of ticks of the duration, i.e. the value obtained via [`count()`](count.html "cpp/chrono/duration/count").   
`%q` |  Writes the unit suffix of the duration, as specified in [`operator<<()`](operator_ltlt.html "cpp/chrono/duration/operator ltlt").   
