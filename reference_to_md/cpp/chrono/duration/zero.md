...
If the representation `rep` of the duration requires some other implementation to return a zero-length duration, [std::chrono::duration_values](../duration_values.html "cpp/chrono/duration values") can be specialized to return the desired value. 

## Contents

  * [1 Parameters](zero.html#Parameters)
  * [2 Return value](zero.html#Return_value)
  * [3 Example](zero.html#Example)
  * [4 See also](zero.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/zero&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/zero&action=edit&section=2 "Edit section: Return value")] Return value

Returns duration([std::chrono::duration_values](../duration_values.html)<rep>::zero()). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/zero&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    using dura = [std::chrono::duration](../duration.html)<X, Y>;
     
    static_assert
    (
        (std::chrono::hours::zero() == std::chrono::nanoseconds::zero()) &&
        (dura<short, [std::nano](../../numeric/ratio/ratio.html)>::zero() == dura<int, [std::deci](../../numeric/ratio/ratio.html)>::zero()) &&
        (dura<short, [std::deca](../../numeric/ratio/ratio.html)>::zero() == dura<long, [std::exa](../../numeric/ratio/ratio.html)>::zero()) &&
        (dura<long, [std::atto](../../numeric/ratio/ratio.html)>::zero().count() == dura<float, [std::exa](../../numeric/ratio/ratio.html)>::zero().count())
    );
     
    int main() {}

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/zero&action=edit&section=4 "Edit section: See also")] See also
...
---|---  
[ max](max.html "cpp/chrono/duration/max")[static] |  returns the special duration value max   
