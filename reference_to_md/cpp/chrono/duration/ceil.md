...
constexpr ToDuration ceil( const [std::chrono::duration](../duration.html)<Rep, Period>& d ); |  |  (since C++17)  
| |   
  
Returns the smallest duration `t` representable in `ToDuration` that is greater or equal to d. 

The function does not participate in the overload resolution unless `ToDuration` is a specialization of [std::chrono::duration](../duration.html "cpp/chrono/duration"). 

## Contents

  * [1 Parameters](ceil.html#Parameters)
  * [2 Return value](ceil.html#Return_value)
  * [3 Possible implementation](ceil.html#Possible_implementation)
  * [4 Example](ceil.html#Example)
  * [5 See also](ceil.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/ceil&action=edit&section=1 "Edit section: Parameters")] Parameters

d  |  \-  |  duration to convert   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/ceil&action=edit&section=2 "Edit section: Return value")] Return value

d rounded up to a duration of type `ToDuration`. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/ceil&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    ...
    constexpr To ceil(const [std::chrono::duration](../duration.html)<Rep, Period>& d)
    {
        To t = [std::chrono::duration_cast](duration_cast.html)<To>(d);
        if (t < d)
            return t + To{1};
        return t;
    }  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/ceil&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        using Min = [std::chrono::minutes](../duration.html);
     
        [std::cout](../../io/cout.html)
            << [std::showpos](../../io/manip/showpos.html)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/ceil&action=edit&section=5 "Edit section: See also")] See also
