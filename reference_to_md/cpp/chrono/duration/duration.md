...
This overload participates in overload resolution only if all following conditions are satisfied: 
  ...
  * [std::chrono::treat_as_floating_point](../treat_as_floating_point.html)<Rep>::value is true. 
  * [std::chrono::treat_as_floating_point](../treat_as_floating_point.html)<Rep2>::value is false.



4) Constructs a duration by converting d to an appropriate period and tick count, as if by [std::chrono::duration_cast](duration_cast.html)<duration>(d).count().

This overload participates in overload resolution only if no overflow is induced in the conversion, and any of the following conditions is satisfied:[[2]](duration.html#cite_note-2)
  ...
  * [std::ratio_divide](../../numeric/ratio/ratio_divide.html)<Period2, Period>::den is 1. 
  * [std::chrono::treat_as_floating_point](../treat_as_floating_point.html)<Rep2>::value is false.



  1. [↑](duration.html#cite_ref-1) That is, a duration with an integer tick count cannot be constructed from a floating-point value, but a duration with a floating-point tick count can be constructed from an integer value.
  2. [↑](duration.html#cite_ref-2) That is, either the duration uses floating-point ticks, or `Period2` is exactly divisible by `Period`.



## Contents

  * [1 Parameters](duration.html#Parameters)
  * [2 Example](duration.html#Example)
  * [3 Defect reports](duration.html#Defect_reports)
  * [4 See also](duration.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::chrono::hours](../duration.html) h(1); // one hour
        [std::chrono::milliseconds](../duration.html) ms{3}; // 3 milliseconds
        [std::chrono::duration](../duration.html)<int, [std::kilo](../../numeric/ratio/ratio.html)> ks(3); // 3000 seconds
     
    ...
     
        ...
        [std::chrono::duration](../duration.html)<double, [std::ratio](../../numeric/ratio/ratio.html)<1, 30>> hz30(3.5);
     
        // 3000 microseconds constructed from 3 milliseconds
        [std::chrono::microseconds](../duration.html) us = ms;
...
---|---|---|---  
[LWG 2094](https://cplusplus.github.io/LWG/issue2094) | C++11  | for overload (4), [std::ratio_divide](../../numeric/ratio/ratio_divide.html)<Period2, period>::num  
might overflow when evaluating  
[std::ratio_divide](../../numeric/ratio/ratio_divide.html)<Period2, period>::den | overload (4) does not  
