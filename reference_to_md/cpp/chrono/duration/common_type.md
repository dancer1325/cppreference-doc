...
struct common_type<[std::chrono::duration](../duration.html)<Rep1, Period1>,  
[std::chrono::duration](../duration.html)<Rep2, Period2>>; |  |  (since C++11)  
| |   
  
Exposes the type named `type`, which is the common type of two [std::chrono::duration](../duration.html "cpp/chrono/duration")s, whose period is the greatest common divisor of `Period1` and `Period2`. 

## Contents

  * [1 Member types](common_type.html#Member_types)
  * [2 Note](common_type.html#Note)
  * [3 Example](common_type.html#Example)
  * [4 See also](common_type.html#See_also)
...
Run this code
    ...
    constexpr auto durationDiff(const T& t, const S& s)
        -> typename [std::common_type](../../types/common_type.html)<T,S>::type
    {
        typedef typename [std::common_type](../../types/common_type.html)<T,S>::type Common;
    ...
     
        [std::cout](../../io/cout.html) << ms << " - " << us << " = " << diff << '\n';
    }
