...
| (1) |   
---|---|---  
duration& operator+=( const duration& d ); |  |  (since C++11)   
(constexpr since C++17)  
| (2) |   
duration& operator-=( const duration& d ); |  |  (since C++11)   
(constexpr since C++17)  
| (3) |   
duration& operator*=( const rep& rhs ); |  |  (since C++11)   
(constexpr since C++17)  
| (4) |   
duration& operator/=( const rep& rhs ); |  |  (since C++11)   
(constexpr since C++17)  
...
(constexpr since C++17)  
| (6) |   
duration& operator%=( const duration& rhs ); |  |  (since C++11)   
(constexpr since C++17)  
| |   
...
## Contents
  ...
  * [1 Parameters](operator_arith3.html#Parameters)
  * [2 Return value](operator_arith3.html#Return_value)
  * [3 Example](operator_arith3.html#Example)
  * [4 See also](operator_arith3.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/operator_arith3&action=edit&section=1 "Edit section: Parameters")] Parameters

d  |  \-  |  duration on the right-hand side of the operator   
---|---|---  
rhs  |  \-  |  number of ticks on the right-hand side of the operator   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/operator_arith3&action=edit&section=2 "Edit section: Return value")] Return value

A reference to this duration after modification. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/operator_arith3&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::chrono::minutes](../duration.html) m(11);
        m *= 2;
        m += [std::chrono::hours](../duration.html)(10); // hours implicitly convert to minutes
        [std::cout](../../io/cout.html) << m.count() << " minutes equals "
                  << [std::chrono::duration_cast](duration_cast.html)<[std::chrono::hours](../duration.html)>(m).count() 
                  << " hours and ";
        m %= [std::chrono::hours](../duration.html)(1);
        [std::cout](../../io/cout.html) << m.count() << " minutes\n";
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/operator_arith3&action=edit&section=4 "Edit section: See also")] See also

[ operator++operator++(int)operator--operator--(int)](operator_arith2.html "cpp/chrono/duration/operator arith2") |  increments or decrements the tick count   
