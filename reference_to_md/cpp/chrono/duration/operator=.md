...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/operator%3D&action=edit&section=1 "Edit section: Parameters")] Parameters

other  |  \-  |  `duration` to copy from   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/operator%3D&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::chrono::hours](../duration.html) z_hours{};
        [std::chrono::seconds](../duration.html) z_seconds{};
     
    ...
     
        [std::cout](../../io/cout.html) << "hours: " << z_hours.count() << '\n';
        [std::cout](../../io/cout.html) << "seconds: " << z_seconds.count() << '\n';
     
        z_seconds -= 42s;
     
    ...
     
        z_hours = [std::chrono::duration_cast](duration_cast.html)<[std::chrono::hours](../duration.html)>(z_seconds); // ok
        z_hours = [std::chrono::duration_cast](duration_cast.html)<decltype(z_hours)>(z_seconds);  // ditto
     
        [std::cout](../../io/cout.html) << "hours: " << z_hours.count() << '\n';
        [std::cout](../../io/cout.html) << "seconds: " << z_seconds.count() << '\n';
     
        [std::chrono::duration](../duration.html)<double, [std::ratio](../../numeric/ratio/ratio.html)<3600>> z2_hours{};
     
        z2_hours = z_seconds; // ok, no truncation, implicit cast
     
        [std::cout](../../io/cout.html) << "hours: " << z2_hours.count() << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/operator%3D&action=edit&section=3 "Edit section: See also")] See also

[ (constructor)](duration.html "cpp/chrono/duration/duration") |  constructs new duration   
