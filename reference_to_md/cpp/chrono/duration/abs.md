...
constexpr [std::chrono::duration](../duration.html)<Rep, Period> abs( [std::chrono::duration](../duration.html)<Rep, Period> d ); |  |  (since C++17)  
| |   
  
Returns the absolute value of the duration d. Specifically, if d >= d.zero(), return d, otherwise return -d. 

The function does not participate in the overload resolution unless [std::numeric_limits](../../types/numeric_limits.html)<Rep>::is_signed is true. 

## Contents

  * [1 Parameters](abs.html#Parameters)
  * [2 Return value](abs.html#Return_value)
  * [3 Possible implementation](abs.html#Possible_implementation)
  * [4 Example](abs.html#Example)
  * [5 See also](abs.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/abs&action=edit&section=1 "Edit section: Parameters")] Parameters

d  |  \-  |  duration   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/abs&action=edit&section=2 "Edit section: Return value")] Return value

Absolute value of d. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/abs&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    template<class Rep, class Period,
        class = [std::enable_if_t](../../types/enable_if.html)<[std::numeric_limits](../../types/numeric_limits.html)<Rep>::is_signed>>
    constexpr [std::chrono::duration](../duration.html)<Rep, Period> abs([std::chrono::duration](../duration.html)<Rep, Period> d)
    {
        return d >= d.zero() ? +d : -d;
    }  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/abs&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << "abs(+3min) = " << abs(3min).count() << '\n'
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration/abs&action=edit&section=5 "Edit section: See also")] See also

[ operator+operator-](operator_arith.html "cpp/chrono/duration/operator arith") |  implements unary + and unary -   
