...
---|---|---  
constexpr [std::chrono::nanoseconds](duration.html)  
operator""ns( unsigned long long nsec ); |  (1)  |  (since C++14)  
constexpr [std::chrono::duration](duration.html)</*unspecified*/, [std::nano](../numeric/ratio/ratio.html)>  
operator""ns( long double nsec ); |  (2)  |  (since C++14)  
| |   
  
Forms a [std::chrono::duration](duration.html "cpp/chrono/duration") literal representing nanoseconds. 

1) Integer literal, returns exactly [std::chrono::nanoseconds](duration.html)(nsec).

2) Floating-point literal, returns a floating-point duration equivalent to [std::chrono::nanoseconds](duration.html "cpp/chrono/duration").

## Contents

  * [1 Parameters](operator""ns.html#Parameters)
  * [2 Return value](operator""ns.html#Return_value)
  * [3 Possible implementation](operator""ns.html#Possible_implementation)
  * [4 Notes](operator""ns.html#Notes)
  * [5 Example](operator""ns.html#Example)
  * [6 See also](operator""ns.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ns&action=edit&section=1 "Edit section: Parameters")] Parameters

nsec  |  \-  |  the number of nanoseconds   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ns&action=edit&section=2 "Edit section: Return value")] Return value

The [std::chrono::duration](duration.html "cpp/chrono/duration") literal. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ns&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    constexpr [std::chrono::nanoseconds](duration.html) operator""ns(unsigned long long ns)
    {
        return [std::chrono::nanoseconds](duration.html)(ns);
    }
    constexpr [std::chrono::duration](duration.html)<long double, [std::nano](../numeric/ratio/ratio.html)> operator""ns(long double ns)
    {
        return [std::chrono::duration](duration.html)<long double, [std::nano](../numeric/ratio/ratio.html)>(ns);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ns&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ns&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        auto d1{250ns};
        [std::chrono::nanoseconds](duration.html) d2{1us};
        [std::cout](../io/cout.html) << d1 << " = " << d1.count() << " nanoseconds\n"
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22ns&action=edit&section=6 "Edit section: See also")] See also
