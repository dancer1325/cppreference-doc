...
const [std::chrono::month_day_last](../month_day_last.html)& mdl ); |  |  (since C++20)  
| |   
  
Outputs a textual representation of mdl into os, as if by 

os << [std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{:L}/last"), mdl.month());

where STATICALLY_WIDEN<CharT>("{:L}/last") is "{:L}/last" if `CharT` is char, and L"{:L}/last" if `CharT` is wchar_t. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day_last/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value

os

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day_last/operator_ltlt&action=edit&section=2 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day_last/operator_ltlt&action=edit&section=3 "Edit section: See also")] See also
