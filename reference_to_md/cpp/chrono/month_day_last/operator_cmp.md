...
---|---|---  
constexpr bool operator==( const [std::chrono::month_day_last](../month_day_last.html)& x,  
const [std::chrono::month_day_last](../month_day_last.html)& y ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::strong_ordering](../../utility/compare/strong_ordering.html) operator<=>( const [std::chrono::month_day_last](../month_day_last.html)& x,  
const [std::chrono::month_day_last](../month_day_last.html)& y ) noexcept; |  (2)  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        constexpr auto mdl1{[std::chrono::February](../month.html)/[std::chrono::last](../last_spec.html)};
        constexpr [std::chrono::month_day_last](../month_day_last.html) mdl2{[std::chrono::month](../month.html)(2)};
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html) << (mdl1 == mdl2) << '\n';
     
