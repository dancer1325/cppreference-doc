...
**hash <std::chrono::month_day_last>**(C++26)  
  


Defined in header `[<chrono>](../../header/chrono.html "cpp/header/chrono")` |  |   
---|---|---  
template<> struct hash<[std::chrono::month_day_last](../month_day_last.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::month_day_last`](../month_day_last.html "cpp/chrono/month day last") allows users to obtain hashes of objects of type [std::chrono::month_day_last](../month_day_last.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
