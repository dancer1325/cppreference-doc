...
constexpr [std::chrono::month](../month.html) month() const noexcept; |  |  (since C++20)  
---|---|---  
| |   
  
Retrieves a copy of the std::chrono::month object stored in *this. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day_last/month&action=edit&section=1 "Edit section: Return value")] Return value

A copy of the std::chrono::month object stored in *this. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day_last/month&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html) << (year_month_day{ymdl} == year_month_day{February/29/2020}) << ' ';
     
        mdl = (mdl.month() + months(1)) / last; // Last day of the next month, in 2020
        ymdl = year(2020) / mdl;
        [std::cout](../../io/cout.html) << (year_month_day{ymdl} == year_month_day{March/31/2020}) << '\n';
    }
