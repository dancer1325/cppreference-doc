...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day_last/ok&action=edit&section=1 "Edit section: Return value")] Return value

month().ok()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day_last/ok&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto mdl{[std::chrono::February](../month.html)/[std::chrono::last](../last_spec.html)};
        [assert](../../error/assert.html)(mdl.ok());
        mdl = {[std::chrono::month](../month.html)(42)/[std::chrono::last](../last_spec.html)};
        [assert](../../error/assert.html)(!mdl.ok());
    }
