...
const [std::chrono::tai_time](../tai_clock.html)<Duration>& tp ); |  |  (since C++20)  
| |   
...
[ std::formatter<std::chrono::tai_time>](formatter.html "cpp/chrono/tai clock/formatter")(C++20) |  formatting support for `tai_time`   
