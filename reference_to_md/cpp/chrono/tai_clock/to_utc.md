...
to_utc( const [std::chrono::tai_time](../tai_clock.html)<Duration>& t ) noexcept; |  |  (since C++20)  
---|---|---  
| |   
  
Converts the `tai_time` t to a `utc_time` representing the same point in time. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/tai_clock/to_utc&action=edit&section=1 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/tai_clock/to_utc&action=edit&section=2 "Edit section: See also")] See also

[ from_utc](from_utc.html "cpp/chrono/tai clock/from utc")[static] |  converts `utc_time` to `tai_time`   
