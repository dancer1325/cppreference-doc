...
Member functions  
---  
[day::day](day/day.html "cpp/chrono/day/day")  
[day::operator++day::operator--](day/operator_inc_dec.html "cpp/chrono/day/operator inc dec")  
[day::operator+=day::operator-=](day/operator_arith.html "cpp/chrono/day/operator arith")  
[day::operator unsigned](day/operator_unsigned.html "cpp/chrono/day/operator unsigned")  
[day::ok](day/ok.html "cpp/chrono/day/ok")  
Nonmember functions  
[operator==operator<=>](day/operator_cmp.html "cpp/chrono/day/operator cmp")  
[operator+operator-](day/operator_arith_2.html "cpp/chrono/day/operator arith 2")  
[operator<<](day/operator_ltlt.html "cpp/chrono/day/operator ltlt")  
[from_stream](day/from_stream.html "cpp/chrono/day/from stream")  
**operator""d**  
Helper classes  
...
---|---|---  
constexpr [std::chrono::day](day.html) operator ""d( unsigned long long d ) noexcept; |  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Parameters](operator""d.html#Parameters)
  * [2 Return value](operator""d.html#Return_value)
  * [3 Possible implementation](operator""d.html#Possible_implementation)
  * [4 Notes](operator""d.html#Notes)
  * [5 Example](operator""d.html#Example)
  * [6 See also](operator""d.html#See_also)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22d&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    ...
    {
        return [std::chrono::day](day.html)(d);
    }  
...
Run this code
    ...
    int main()
    {
        using namespace std::literals::chrono_literals;
     
        [std::cout](../io/cout.html) << static_cast<unsigned>(42d) << '\t' << 42d << '\n'
