...
The class `year` represents a year in the [proleptic Gregorian calendar](https://en.wikipedia.org/wiki/proleptic_Gregorian_calendar "enwiki:proleptic Gregorian calendar"). Its range is `[`-32767`, `32767`]`. 

`year` is a [TriviallyCopyable](../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable") [StandardLayoutType](../named_req/StandardLayoutType.html "cpp/named req/StandardLayoutType"). 

## Contents

  * [1 Member functions](year.html#Member_functions)
  * [2 Non-member functions](year.html#Non-member_functions)
  * [3 Helper classes](year.html#Helper_classes)
  * [4 Literals](year.html#Literals)
