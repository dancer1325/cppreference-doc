...
## Contents
  ...
  * [1 Parameters](from_time_t.html#Parameters)
  * [2 Return value](from_time_t.html#Return_value)
  * [3 Example](from_time_t.html#Example)
  * [4 See also](from_time_t.html#See_also)
...
Run this code
    ...
     
        const [std::time_t](../c/time_t.html) t = [std::time](../c/time.html)(nullptr); // usually has "1 second" precision
     
        const auto from = std::chrono::system_clock::from_time_t(t);
     
        [std::this_thread::sleep_for](../../thread/sleep_for.html)(500ms);
     
        const auto diff = [std::chrono::system_clock::now](now.html)() - from;
     
        [std::cout](../../io/cout.html) << diff << " ("
                  << [std::chrono::round](../duration/round.html)<[std::chrono::milliseconds](../duration.html)>(diff)
                  << ")\n";
    }
