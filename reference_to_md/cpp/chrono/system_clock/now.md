...
static [std::chrono::time_point](../time_point.html)<[std::chrono::system_clock](../system_clock.html)> now() noexcept; |  |  (since C++11)  
---|---|---  
| |   
...
Run this code
    ...
    int main()
    {
        ...
        const [std::time_t](../c/time_t.html) t_c = [std::chrono::system_clock::to_time_t](to_time_t.html)(now);
        [std::cout](../../io/cout.html) << "The system clock is currently at " << [std::ctime](../c/ctime.html)(&t_c);
    }
