...
Member functions  
---  
[tai_clock::now](tai_clock/now.html "cpp/chrono/tai clock/now")  
[tai_clock::to_utc](tai_clock/to_utc.html "cpp/chrono/tai clock/to utc")  
[tai_clock::from_utc](tai_clock/from_utc.html "cpp/chrono/tai clock/from utc")  
Time point I/O  
[operator<<](tai_clock/operator_ltlt.html "cpp/chrono/tai clock/operator ltlt")  
...
The clock `std::chrono::tai_clock` is a [Clock](../named_req/Clock.html "cpp/named req/Clock") that represents [International Atomic Time](https://en.wikipedia.org/wiki/International_Atomic_Time "enwiki:International Atomic Time") (TAI). It measures time since 00:00:00, 1 January 1958, and is offset 10 seconds ahead of UTC at that date (i.e., its epoch, 1958-01-01 00:00:00 TAI, is 1957-12-31 23:59:50 UTC). 
...
`tai_clock` meets the [Clock](../named_req/Clock.html "cpp/named req/Clock") requirements. It does not meet the [TrivialClock](../named_req/TrivialClock.html "cpp/named req/TrivialClock") requirements unless the implementation can guarantee that [`now()`](tai_clock/now.html "cpp/chrono/tai clock/now") does not throw an exception. 

## Contents

  * [1 Time point family](tai_clock.html#Time_point_family)
  * [2 Member types](tai_clock.html#Member_types)
  * [3 Member constants](tai_clock.html#Member_constants)
  * [4 Member functions](tai_clock.html#Member_functions)
...
using tai_time = [std::chrono::time_point](time_point.html)<std::chrono::tai_clock, Duration>; |  |  (since C++20)  
