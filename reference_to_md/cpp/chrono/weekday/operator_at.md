...
---|---|---  
constexpr [std::chrono::weekday_last](../weekday_last.html)  
operator[]( [std::chrono::last_spec](../last_spec.html) ) const noexcept; |  (2)  |  (since C++20)  
| |   
...
Run this code
    ...
     
        [std::cout](../../io/cout.html) << second_tuesday_in_October_2019 << '\n'
