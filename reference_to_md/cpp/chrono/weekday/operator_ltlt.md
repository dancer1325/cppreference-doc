...
operator<<( [std::basic_ostream](../../io/basic_ostream.html)<CharT, Traits>& os, const [std::chrono::weekday](../weekday.html)& wd ); |  |  (since C++20)  
| |   
  
If !wd.ok(), inserts wd.c_encoding() followed by " is not a valid weekday" into os. Otherwise, forms a [std::basic_string](../../string/basic_string.html)<CharT> s consisting of the abbreviated weekday name for the weekday represented by wd, determined using the locale associated with os, and inserts s into os. 

Equivalent to 

return os << (wd.ok() ?  
[std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{:L%a}"), wd) :  
[std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{} is not a valid weekday"),  
wd.c_encoding()));
...
## Contents
  ...
  * [2 Example](operator_ltlt.html#Example)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value

os

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday/operator_ltlt&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday/operator_ltlt&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday/operator_ltlt&action=edit&section=4 "Edit section: See also")] See also
...
---|---  
[ std::formatter<std::chrono::weekday>](formatter.html "cpp/chrono/weekday/formatter")(C++20) |  formatting support for `weekday`   
