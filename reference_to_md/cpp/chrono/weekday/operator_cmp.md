...
---|---|---  
constexpr bool operator==( const [std::chrono::weekday](../weekday.html)& x,  
const [std::chrono::weekday](../weekday.html)& y ) noexcept; |  |  (since C++20)  
| |   
...
Run this code
    ...
     
        constexpr [std::chrono::weekday](../weekday.html) wd1{2};
        constexpr [std::chrono::weekday](../weekday.html) wd2{[std::chrono::Friday](../weekday.html)};
        static_assert(wd1 != wd2);
     
        // 13 January 1313 is a Friday
        constexpr [std::chrono::weekday](../weekday.html) wd3{1313y/1/13d};
