...
---|---|---  
constexpr [std::chrono::weekday](../weekday.html) operator++( int ) noexcept; |  (2)  |  (since C++20)  
constexpr [std::chrono::weekday](../weekday.html)& operator\--() noexcept; |  (3)  |  (since C++20)  
constexpr [std::chrono::weekday](../weekday.html) operator\--( int ) noexcept; |  (4)  |  (since C++20)  
| |   
...
Run this code
    ...
     
        [std::chrono::weekday](../weekday.html) wd{0}; // Sunday is 0 or 7
     
        --wd;
        [std::cout](../../io/cout.html) << (wd == [std::chrono::Saturday](../weekday.html)) << ' ';
     
        ++wd;
        [std::cout](../../io/cout.html) << (wd == [std::chrono::Sunday](../weekday.html)) << '\n';
     
        wd = [std::chrono::weekday](../weekday.html){13};
        [assert](../../error/assert.html)(!wd.ok());
        wd++;
        [assert](../../error/assert.html)(wd.ok());
    }
