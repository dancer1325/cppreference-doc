...
---|---|---  
template<> struct hash<[std::chrono::weekday](../weekday.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::weekday`](../weekday.html "cpp/chrono/weekday") allows users to obtain hashes of objects of type [std::chrono::weekday](../weekday.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
