...
**operator <<**  
Helper classes  
[formatter<std::chrono::local_info>](formatter.html "cpp/chrono/local info/formatter")  
...
const [std::chrono::local_info](../local_info.html)& r ); |  |  (since C++20)  
| |   
  
Inserts a textual representation of r into os. The exact format is unspecified. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/local_info/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value
