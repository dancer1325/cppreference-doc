...
Member functions  
---  
[year_month_day::year_month_day](year_month_day/year_month_day.html "cpp/chrono/year month day/year month day")  
[year_month_day::operator+=year_month_day::operator-=](year_month_day/operator_arith.html "cpp/chrono/year month day/operator arith")  
[year_month_day::yearyear_month_day::monthyear_month_day::day](year_month_day/accessors.html "cpp/chrono/year month day/accessors")  
[year_month_day::operator sys_daysyear_month_day::operator local_days](year_month_day/operator_days.html "cpp/chrono/year month day/operator days")  
[year_month_day::ok](year_month_day/ok.html "cpp/chrono/year month day/ok")  
Nonmember functions  
[operator==operator<=>](year_month_day/operator_cmp.html "cpp/chrono/year month day/operator cmp")  
[operator+operator-](year_month_day/operator_arith_2.html "cpp/chrono/year month day/operator arith 2")  
[operator<<](year_month_day/operator_ltlt.html "cpp/chrono/year month day/operator ltlt")  
[from_stream](year_month_day/from_stream.html "cpp/chrono/year month day/from stream")  
Helper classes  
...
`year_month_day` is a [TriviallyCopyable](../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable") [StandardLayoutType](../named_req/StandardLayoutType.html "cpp/named req/StandardLayoutType"). 

## Contents

  * [1 Member functions](year_month_day.html#Member_functions)
  * [2 Nonmember functions](year_month_day.html#Nonmember_functions)
  * [3 Helper classes](year_month_day.html#Helper_classes)
  * [4 Example](year_month_day.html#Example)
...
Run this code
    ...
    int main()
    {
        const [std::chrono::time_point](time_point.html) now{[std::chrono::system_clock::now](system_clock/now.html)()};
     
        const std::chrono::year_month_day ymd{[std::chrono::floor](duration/floor.html)<[std::chrono::days](duration.html)>(now)};
     
        [std::cout](../io/cout.html) << "Current Year: " << static_cast<int>(ymd.year()) << ", "
