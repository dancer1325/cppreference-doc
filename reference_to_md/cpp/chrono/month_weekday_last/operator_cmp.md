...
---|---|---  
constexpr bool operator==( const [std::chrono::month_weekday_last](../month_weekday_last.html)& x,   
const [std::chrono::month_weekday_last](../month_weekday_last.html)& y ) noexcept; |  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday_last/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value

x.month() == y.month() && x.weekday_last() == y.weekday_last()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday_last/operator_cmp&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr [std::chrono::month_weekday_last](../month_weekday_last.html) mwdl1
        {
            [std::chrono::March](../month.html)/[std::chrono::Friday](../weekday.html)[[std::chrono::last](../last_spec.html)]
        };
     
        constexpr [std::chrono::month_weekday_last](../month_weekday_last.html) mwdl2
        {
            [std::chrono::March](../month.html), [std::chrono::Friday](../weekday.html)[[std::chrono::last](../last_spec.html)]
        };
     
