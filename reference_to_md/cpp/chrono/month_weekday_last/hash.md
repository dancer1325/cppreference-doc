...
---|---|---  
template<> struct hash<[std::chrono::month_weekday_last](../month_weekday_last.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::month_weekday_last`](../month_weekday_last.html "cpp/chrono/month weekday last") allows users to obtain hashes of objects of type [std::chrono::month_weekday_last](../month_weekday_last.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
