...
**month_weekday_last::month month_weekday_last::weekday_last**  
...
---|---|---  
constexpr [std::chrono::weekday_last](../weekday_last.html) weekday_last() const noexcept; |  (2)  |  (since C++20)  
| |   
  
Retrieves a copy of the [`month`](../month.html "cpp/chrono/month") and [`weekday_last`](../weekday_last.html "cpp/chrono/weekday last") objects stored in *this. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday_last/accessors&action=edit&section=1 "Edit section: Return value")] Return value

1) A copy of the std::chrono::month object stored in *this.

2) A copy of the std::chrono::weekday_last object stored in *this.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_weekday_last/accessors&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html) << (year_month_day{ywdl} == 
