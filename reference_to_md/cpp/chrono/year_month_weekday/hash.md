...
---|---|---  
template<> struct hash<[std::chrono::year_month_weekday](../year_month_weekday.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::year_month_weekday`](../year_month_weekday.html "cpp/chrono/year month weekday") allows users to obtain hashes of objects of type [std::chrono::year_month_weekday](../year_month_weekday.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
