...
---|---|---  
constexpr year_month_weekday( const [std::chrono::year](../year.html)& y,  
const [std::chrono::month](../month.html)& m,  
const [std::chrono::weekday_indexed](../weekday_indexed.html)& wdi ) noexcept; |  (2)  |  (since C++20)  
constexpr year_month_weekday( const [std::chrono::sys_days](../system_clock.html)& dp ) noexcept; |  (3)  |  (since C++20)  
constexpr explicit year_month_weekday( const [std::chrono::local_days](../local_t.html)& dp ) noexcept; |  (4)  |  (since C++20)  
| |   
