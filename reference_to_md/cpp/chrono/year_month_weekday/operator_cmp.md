...
---|---|---  
constexpr bool operator==( const [std::chrono::year_month_weekday](../year_month_weekday.html)& x,  
const [std::chrono::year_month_weekday](../year_month_weekday.html)& y ) noexcept; |  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value

x.year() == y.year() && x.month() == y.month() && x.weekday_indexed() == y.weekday_indexed()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday/operator_cmp&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html) << (ymwdi1 == ymwdi2) << '\n';
    }
