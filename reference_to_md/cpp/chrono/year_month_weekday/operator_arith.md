...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday/operator_arith&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto ymwi{1/[std::chrono::Wednesday](../weekday.html)[2]/2021};
        [std::cout](../../io/cout.html) << ymwi << '\n';
     
        ymwi += [std::chrono::years](../duration.html)(5);
        [std::cout](../../io/cout.html) << ymwi << '\n';
        [assert](../../error/assert.html)(static_cast<[std::chrono::year_month_day](../year_month_day.html)>(ymwi) ==
                           [std::chrono::year](../year.html)(2026)/1/14);
     
        ymwi -= [std::chrono::months](../duration.html)(1);
        [std::cout](../../io/cout.html) << ymwi << '\n';
        [assert](../../error/assert.html)(static_cast<[std::chrono::year_month_day](../year_month_day.html)>(ymwi) == 
                           [std::chrono::day](../day.html)(10)/12/2025);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday/operator_arith&action=edit&section=2 "Edit section: See also")] See also

[ operator+operator-](operator_arith_2.html "cpp/chrono/year month weekday/operator arith 2")(C++20) |  adds or subtracts a `year_month_weekday` and some number of years or months   
