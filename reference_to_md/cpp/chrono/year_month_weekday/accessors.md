...
**year_month_weekday::year year_month_weekday::monthyear_month_weekday::weekdayyear_month_weekday::indexyear_month_weekday::weekday_indexed**  
...
constexpr [std::chrono::weekday_indexed](../weekday_indexed.html) weekday_indexed() const noexcept; |  (5)  |  (since C++20)  
| |   
  
Retrieves the field values stored in this `year_month_weekday` object. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday/accessors&action=edit&section=1 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday/accessors&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr auto ym{[std::chrono::year](../year.html)(2021)/[std::chrono::January](../month.html)};
        constexpr auto wdi{[std::chrono::Wednesday](../weekday.html)[1]};
        auto ymwdi{ym/wdi};
        const auto index{ymwdi.index() + 1};
        auto weekday{ymwdi.weekday() + [std::chrono::days](../duration.html)(1)};
        ymwdi = {ymwdi.year()/ymwdi.month()/weekday[index]};
        // Second Thursday in January, 2021
        [assert](../../error/assert.html)([std::chrono::year_month_day](../year_month_day.html){ymwdi} == [std::chrono::January](../month.html)/14/2021);
    }
