...
Member functions  
---  
[year_month_weekday::year_month_weekday](year_month_weekday.html "cpp/chrono/year month weekday/year month weekday")  
[year_month_weekday::operator+=year_month_weekday::operator-=](operator_arith.html "cpp/chrono/year month weekday/operator arith")  
[year_month_weekday::yearyear_month_weekday::monthyear_month_weekday::weekdayyear_month_weekday::indexyear_month_weekday::weekday_indexed](accessors.html "cpp/chrono/year month weekday/accessors")  
[year_month_weekday::operator sys_daysyear_month_weekday::operator local_days](operator_days.html "cpp/chrono/year month weekday/operator days")  
[year_month_weekday::ok](ok.html "cpp/chrono/year month weekday/ok")  
Nonmember functions  
[operator==](operator_cmp.html "cpp/chrono/year month weekday/operator cmp")  
**operator+ operator-**  
[operator<<](operator_ltlt.html "cpp/chrono/year month weekday/operator ltlt")  
Helper classes  
...
constexpr [std::chrono::year_month_weekday](../year_month_weekday.html)   
operator+( const [std::chrono::year_month_weekday](../year_month_weekday.html)& ymwd,  
const [std::chrono::months](../duration.html)& dm ) noexcept; |  (1)  |  (since C++20)  
---|---|---  
constexpr [std::chrono::year_month_weekday](../year_month_weekday.html)   
operator+( const [std::chrono::months](../duration.html)& dm,  
const [std::chrono::year_month_weekday](../year_month_weekday.html)& ymwd ) noexcept; |  (2)  |  (since C++20)  
constexpr [std::chrono::year_month_weekday](../year_month_weekday.html)   
operator+( const [std::chrono::year_month_weekday](../year_month_weekday.html)& ymwd,  
const [std::chrono::years](../duration.html)& dy ) noexcept; |  (3)  |  (since C++20)  
constexpr [std::chrono::year_month_weekday](../year_month_weekday.html)   
operator+( const [std::chrono::years](../duration.html)& dy,  
const [std::chrono::year_month_weekday](../year_month_weekday.html)& ymwd ) noexcept; |  (4)  |  (since C++20)  
constexpr [std::chrono::year_month_weekday](../year_month_weekday.html)  
operator-( const [std::chrono::year_month_weekday](../year_month_weekday.html)& ymwd,  
const [std::chrono::months](../duration.html)& dm ) noexcept; |  (5)  |  (since C++20)  
constexpr [std::chrono::year_month_weekday](../year_month_weekday.html)   
operator-( const [std::chrono::year_month_weekday](../year_month_weekday.html)& ymwd,  
const [std::chrono::years](../duration.html)& dy ) noexcept; |  (6)  |  (since C++20)  
| |   
  
1,2) Adds dm.count() months to the date represented by ymwd. The result has the same [`year()`](accessors.html "cpp/chrono/year month weekday/accessors") and [`month()`](accessors.html "cpp/chrono/year month weekday/accessors") as [std::chrono::year_month](../year_month.html)(ymwd.year(), ymwd.month()) + dm and the same [`weekday()`](accessors.html "cpp/chrono/year month weekday/accessors") and [`index()`](accessors.html "cpp/chrono/year month weekday/accessors") as ymwd.

3,4) Adds dy.count() years to the date represented by ymwd. The result is equivalent to [std::chrono::year_month_weekday](../year_month_weekday.html)(ymwd.year() + dy, ymwd.month(), ymwd.weekday_indexed()).
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday/operator_arith_2&action=edit&section=1 "Edit section: Notes")] Notes

Even if ymwd.ok() is true, the resulting `year_month_weekday` may not represent a valid date if ymwd.index() is 5. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday/operator_arith_2&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        auto ymwdi{1/[std::chrono::Wednesday](../weekday.html)[1]/2021};
        [std::cout](../../io/cout.html) << ymwdi << '\n';
     
        ymwdi = [std::chrono::years](../duration.html)(5) + ymwdi;
        // First Wednesday in January, 2026
        [std::cout](../../io/cout.html) << ymwdi << '\n';
        [assert](../../error/assert.html)(static_cast<[std::chrono::year_month_day](../year_month_day.html)>(ymwdi) ==
               [std::chrono::January](../month.html)/7/2026);
     
        ymwdi = ymwdi - [std::chrono::months](../duration.html)(6);
        // First Wednesday in July, 2025
        [std::cout](../../io/cout.html) << ymwdi << '\n';
        [assert](../../error/assert.html)(static_cast<[std::chrono::year_month_day](../year_month_day.html)>(ymwdi) ==
               [std::chrono::July](../month.html)/2/2025);
    }
