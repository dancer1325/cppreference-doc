...
---|---|---  
template<> struct hash<[std::chrono::weekday_indexed](../weekday_indexed.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::weekday_indexed`](../weekday_indexed.html "cpp/chrono/weekday indexed") allows users to obtain hashes of objects of type [std::chrono::weekday_indexed](../weekday_indexed.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
