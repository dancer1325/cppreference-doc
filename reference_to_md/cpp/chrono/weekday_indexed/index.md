...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_indexed/index&action=edit&section=1 "Edit section: Return value")] Return value

The index stored in *this. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_indexed/index&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::chrono::weekday_indexed](../weekday_indexed.html) wdi {[std::chrono::Tuesday](../weekday.html)[2]}; // 2nd Tuesday of a month
        [std::cout](../../io/cout.html) << ([std::chrono::year_month_day](../year_month_day.html){wdi/10/2019} == 
                      [std::chrono::year_month_day](../year_month_day.html){[std::chrono::October](../month.html)/8/2019}) << ' ';
     
        wdi = {wdi.weekday()[wdi.index() + 2]}; // 2nd Tuesday => 4th Tuesday
        [std::cout](../../io/cout.html) << ([std::chrono::year_month_day](../year_month_day.html){wdi/10/2019} == 
                      [std::chrono::year_month_day](../year_month_day.html){[std::chrono::October](../month.html)/22/2019}) << '\n';
    }
