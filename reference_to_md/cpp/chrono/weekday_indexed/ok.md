...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_indexed/ok&action=edit&section=1 "Edit section: Return value")] Return value

true if weekday().ok() == true and index() is in the range `[`1`, `5`]`. Otherwise false. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_indexed/ok&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::chrono::weekday_indexed](../weekday_indexed.html) wdi{[std::chrono::Tuesday](../weekday.html)[2]};
        [std::cout](../../io/cout.html) << (wdi.ok()) << ' ';
        wdi = {[std::chrono::weekday](../weekday.html)(42)[2]}; 
        [std::cout](../../io/cout.html) << (wdi.ok()) << ' ';
        wdi = {[std::chrono::Tuesday](../weekday.html)[-4]}; 
        [std::cout](../../io/cout.html) << (wdi.ok()) << '\n';
    }
