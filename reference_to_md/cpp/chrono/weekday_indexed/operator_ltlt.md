...
const [std::chrono::weekday_indexed](../weekday_indexed.html)& wdi ); |  |  (since C++20)  
| |   
...
os << [std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{:L}[{} is not a valid index]"),  
wdi.weekday(), wdi.index());

where STATICALLY_WIDEN<CharT>("...") is "..." if `CharT` is char, and L"..." if `CharT` is wchar_t. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_indexed/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value

os

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_indexed/operator_ltlt&action=edit&section=2 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_indexed/operator_ltlt&action=edit&section=3 "Edit section: See also")] See also
