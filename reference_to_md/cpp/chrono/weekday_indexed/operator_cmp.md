...
---|---|---  
constexpr bool operator==( const [std::chrono::weekday_indexed](../weekday_indexed.html)& x,  
const [std::chrono::weekday_indexed](../weekday_indexed.html)& y ) noexcept; |  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        constexpr [std::chrono::weekday_indexed](../weekday_indexed.html) wdi1{[std::chrono::Wednesday](../weekday.html)[2]};
        constexpr [std::chrono::weekday_indexed](../weekday_indexed.html) wdi2{[std::chrono::weekday](../weekday.html)(3), 2};
