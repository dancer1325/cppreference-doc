...
---|---|---  
constexpr weekday_indexed( const [std::chrono::weekday](../weekday.html)& wd, unsigned index ) noexcept; |  (2)  |  (since C++20)  
| |   
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html) << year_month_day{ wdi / October / 2019y } << '\n';
    }
