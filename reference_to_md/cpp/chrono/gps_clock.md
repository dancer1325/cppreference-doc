...
Member functions  
---  
[gps_clock::now](gps_clock/now.html "cpp/chrono/gps clock/now")  
[gps_clock::to_utc](gps_clock/to_utc.html "cpp/chrono/gps clock/to utc")  
[gps_clock::from_utc](gps_clock/from_utc.html "cpp/chrono/gps clock/from utc")  
Time point I/O  
[operator<<](gps_clock/operator_ltlt.html "cpp/chrono/gps clock/operator ltlt")  
[formatter<std::chrono::gps_time>](gps_clock/formatter.html "cpp/chrono/gps clock/formatter")  
[from_stream](gps_clock/from_stream.html "cpp/chrono/gps clock/from stream")  
...
The clock `std::chrono::gps_clock` is a [Clock](../named_req/Clock.html "cpp/named req/Clock") that represents Global Positioning System (GPS) time. It measures time since 00:00:00, 6 January 1980 UTC. 

Leap seconds are not inserted into GPS. Thus, every time a leap second is inserted into UTC, UTC falls another second behind GPS. As of December 2017, UTC is 18 seconds behind GPS, reflecting the 18 leap seconds inserted between 1980 and 2017. Thus, 2018-01-01 00:00:00 UTC is equivalent to 2018-01-01 00:00:18 GPS. GPS is a constant 19 seconds behind [TAI](tai_clock.html "cpp/chrono/tai clock"). 

`gps_clock` meets the [Clock](../named_req/Clock.html "cpp/named req/Clock") requirements. It does not meet the [TrivialClock](../named_req/TrivialClock.html "cpp/named req/TrivialClock") requirements unless the implementation can guarantee that [`now()`](gps_clock/now.html "cpp/chrono/gps clock/now") does not throw an exception. 

## Contents

  * [1 Time point family](gps_clock.html#Time_point_family)
  * [2 Member types](gps_clock.html#Member_types)
  * [3 Member constants](gps_clock.html#Member_constants)
  * [4 Member functions](gps_clock.html#Member_functions)
...
using gps_time = [std::chrono::time_point](time_point.html)<std::chrono::gps_clock, Duration>; |  |  (since C++20)  
using gps_seconds = gps_time<[std::chrono::seconds](duration.html)>; |  |  (since C++20)  
| |   
[ operator<<(std::chrono::gps_time)](gps_clock/operator_ltlt.html "cpp/chrono/gps clock/operator ltlt")(C++20) |  performs stream output on a `gps_time`   
...
[ std::formatter<std::chrono::gps_time>](gps_clock/formatter.html "cpp/chrono/gps clock/formatter")(C++20) |  formatting support for `gps_time`   
...
`time_point` |  [std::chrono::time_point](time_point.html)<std::chrono::gps_clock>  
...
constexpr bool is_steady[static] |  true if the time between ticks is always constant, i.e. calls to [`now()`](gps_clock/now.html "cpp/chrono/gps clock/now") return values that increase monotonically even in case of some external clock adjustment, otherwise false   
(public static member constant)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/gps_clock&action=edit&section=1 "Edit section: Member functions")] Member functions

[ now](gps_clock/now.html "cpp/chrono/gps clock/now")[static] |  returns a [std::chrono::time_point](time_point.html "cpp/chrono/time point") representing the current point in time   
(public static member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/chrono/gps_clock/dsc_now&action=edit)  
---|---  
[ to_utc](gps_clock/to_utc.html "cpp/chrono/gps clock/to utc")[static] |  converts a `gps_time` to `utc_time`   
(public static member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/chrono/gps_clock/dsc_to_utc&action=edit)  
[ from_utc](gps_clock/from_utc.html "cpp/chrono/gps clock/from utc")[static] |  converts a `utc_time` to `gps_time`   
