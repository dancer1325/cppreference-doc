...
---  
[operator<<](sys_info/operator_ltlt.html "cpp/chrono/sys info/operator ltlt")  
Helper classes  
...
## Contents
  ...
  * [1 Member objects](sys_info.html#Member_objects)
  * [2 Nonmember functions](sys_info.html#Nonmember_functions)
  * [3 Helper classes](sys_info.html#Helper_classes)
  * [4 Example](sys_info.html#Example)
...
`offset` |  [std::chrono::seconds](duration.html "cpp/chrono/duration")  
`save` |  [std::chrono::minutes](duration.html "cpp/chrono/duration")  
`abbrev` |  [std::string](../string/basic_string.html "cpp/string/basic string")  
...
The `offset` and `abbrev` data member indicate the UTC offset and time zone abbreviation, respectively, in effect for the associated time zone and [std::chrono::time_point](time_point.html "cpp/chrono/time point"). Note that time zone abbreviations are not unique. 
