...
![std-chrono-ambiguous local time-inheritance.svg](https://upload.cppreference.com/mwiki/images/7/74/std-chrono-ambiguous_local_time-inheritance.svg)

Inheritance diagram

## Contents

  * [1 Member functions](ambiguous_local_time.html#Member_functions)
  * [2 std::chrono::ambiguous_local_time::ambiguous_local_time](ambiguous_local_time.html#std::chrono::ambiguous_local_time::ambiguous_local_time)
    * [2.1 Parameters](ambiguous_local_time.html#Parameters)
    * [2.2 Exceptions](ambiguous_local_time.html#Exceptions)
    * [2.3 Notes](ambiguous_local_time.html#Notes)
  * [3 std::chrono::ambiguous_locale_time::operator=](ambiguous_local_time.html#std::chrono::ambiguous_locale_time::operator.3D)
    * [3.1 Parameters](ambiguous_local_time.html#Parameters_2)
    * [3.2 Return value](ambiguous_local_time.html#Return_value)
  * [4 std::chrono::ambiguous_locale_time::what](ambiguous_local_time.html#std::chrono::ambiguous_locale_time::what)
    * [4.1 Return value](ambiguous_local_time.html#Return_value_2)
    * [4.2 Notes](ambiguous_local_time.html#Notes_2)
  * [5 Inherited from std::runtime_error](ambiguous_local_time.html#Inherited_from_std::runtime_error)
  * [6 Inherited from std::exception](ambiguous_local_time.html#Inherited_from_std::exception)
    * [6.1 Member functions](ambiguous_local_time.html#Member_functions_2)
    * [6.2 See also](ambiguous_local_time.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/ambiguous_local_time&action=edit&section=1 "Edit section: Member functions")] Member functions
...
ambiguous_local_time( const [std::chrono::local_time](local_t.html)<Duration>& tp,  
const [std::chrono::local_info](local_info.html)& i ); |  (1)  |  (since C++20)  
---|---|---  
...
1) The explanatory string returned by what() is equivalent to that produced by os.str() after the following code:
    ...
    [std::ostringstream](../io/basic_ostringstream.html) os;
...
2) Copy constructor. If *this and `other` both have dynamic type `std::chrono::ambiguous_local_time` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0.
...
May throw [std::bad_alloc](../memory/new/bad_alloc.html "cpp/memory/new/bad alloc")

###  Notes

Because copying a standard library class derived from [std::exception](../error/exception.html "cpp/error/exception") is not permitted to throw exceptions, this message is typically stored internally as a separately-allocated reference-counted string. 
...
Assigns the contents with those of other. If *this and other both have dynamic type `std::chrono::ambiguous_locale_time` then [std::strcmp](../string/byte/strcmp.html)(what(), other.what()) == 0 after assignment. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/ambiguous_local_time&action=edit&section=5 "Edit section: See also")] See also

[ nonexistent_local_time](nonexistent_local_time.html "cpp/chrono/nonexistent local time")(C++20) |  exception thrown to report that a local time is nonexistent   
