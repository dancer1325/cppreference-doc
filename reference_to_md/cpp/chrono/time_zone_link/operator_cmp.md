...
Member functions  
---  
[time_zone_link::nametime_zone_link::target](accessors.html "cpp/chrono/time zone link/accessors")  
Nonmember functions  
**operator== operator<=>**  
...
---|---|---  
bool operator==( const [std::chrono::time_zone_link](../time_zone_link.html)& x,  
const [std::chrono::time_zone_link](../time_zone_link.html)& y ) noexcept; |  (1)  |  (since C++20)  
[std::strong_ordering](../../utility/compare/strong_ordering.html) operator<=>( const [std::chrono::time_zone_link](../time_zone_link.html)& x,  
const [std::chrono::time_zone_link](../time_zone_link.html)& y ) noexcept; |  (2)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/time_zone_link/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value
