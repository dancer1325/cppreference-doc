...
/* unspecified */ parse( const CharT* fmt, Parsable& tp ); |  (1)  |  (since C++20)  
template< class CharT, class Traits, class Alloc, class Parsable >  
/* unspecified */ parse( const [std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>& fmt,  
Parsable& tp ); |  (2)  |  (since C++20)  
template< class CharT, class Traits, class Alloc, class Parsable >  
/* unspecified */ parse( const CharT* fmt, Parsable& tp,  
[std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>& abbrev ); |  (3)  |  (since C++20)  
template< class CharT, class Traits, class Alloc, class Parsable >  
/* unspecified */ parse( const [std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>& fmt,  
Parsable& tp,  
[std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>& abbrev ); |  (4)  |  (since C++20)  
template< class CharT, class Parsable >  
/* unspecified */ parse( const CharT* fmt, Parsable& tp,  
[std::chrono::minutes](duration.html)& offset ); |  (5)  |  (since C++20)  
template< class CharT, class Traits, class Alloc, class Parsable >  
/* unspecified */ parse( const [std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>& fmt,  
Parsable& tp, [std::chrono::minutes](duration.html)& offset ); |  (6)  |  (since C++20)  
template< class CharT, class Traits, class Alloc, class Parsable >  
/* unspecified */ parse( const CharT* fmt, Parsable& tp,  
[std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>& abbrev,  
[std::chrono::minutes](duration.html)& offset ); |  (7)  |  (since C++20)  
template< class CharT, class Traits, class Alloc, class Parsable >  
/* unspecified */ parse( const [std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>& fmt,  
Parsable& tp,  
[std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>& abbrev,  
[std::chrono::minutes](duration.html)& offset ); |  (8)  |  (since C++20)  
| |   
  
Returns an object `manip` of unspecified type such that, given a [std::basic_istream](../io/basic_istream.html)<CharT, Traits> object `is`, the expression is >> manip calls `from_stream` (unqualified, to enable [argument-dependent lookup](../language/adl.html "cpp/language/adl")) as follows: 

1) from_stream(is, fmt, tp)

2) from_stream(is, fmt.c_str(), tp)

3) from_stream(is, fmt, tp, [std::addressof](../memory/addressof.html)(abbrev))

4) from_stream(is, fmt.c_str(), tp, [std::addressof](../memory/addressof.html)(abbrev))

5) from_stream(is, fmt, tp,  
static_cast<[std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>*>(nullptr), &offset)

6) from_stream(is, fmt.c_str(), tp,  
static_cast<[std::basic_string](../string/basic_string.html)<CharT, Traits, Alloc>*>(nullptr), &offset)

7) from_stream(is, fmt, tp, [std::addressof](../memory/addressof.html)(abbrev), &offset)

8) from_stream(is, fmt.c_str(), tp, [std::addressof](../memory/addressof.html)(abbrev), &offset).

The expression is >> manip is an lvalue of type [std::basic_istream](../io/basic_istream.html)<CharT, Traits> with the value `is`. 
...
## Contents
  ...
  * [1 Parameters](parse.html#Parameters)
  * [2 Format string](parse.html#Format_string)
  * [3 Example](parse.html#Example)
  * [4 Defect reports](parse.html#Defect_reports)
  * [5 See also](parse.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        {
            [std::istringstream](../io/basic_istringstream.html) is{str};
        ...
        parse("01:02:03", "%H:%M:%S", [std::chrono::hours](duration.html){});
        parse("01:02:03", "%H:%M:%S", [std::chrono::minutes](duration.html){});
        parse("01:02:03", "%H:%M:%S", [std::chrono::seconds](duration.html){});
    }
