...
Member functions  
---  
[weekday_indexed::weekday_indexed](weekday_indexed/weekday_indexed.html "cpp/chrono/weekday indexed/weekday indexed")  
[weekday_indexed::weekday](weekday_indexed/weekday.html "cpp/chrono/weekday indexed/weekday")  
[weekday_indexed::index](weekday_indexed/index.html "cpp/chrono/weekday indexed/index")  
[weekday_indexed::ok](weekday_indexed/ok.html "cpp/chrono/weekday indexed/ok")  
Nonmember functions  
[operator==](weekday_indexed/operator_cmp.html "cpp/chrono/weekday indexed/operator cmp")  
[operator<<](weekday_indexed/operator_ltlt.html "cpp/chrono/weekday indexed/operator ltlt")  
Helper classes  
...
The class `weekday_indexed` combines a [`weekday`](weekday.html "cpp/chrono/weekday"), representing a day of the week in the [proleptic Gregorian calendar](https://en.wikipedia.org/wiki/proleptic_Gregorian_calendar "enwiki:proleptic Gregorian calendar"), with a small index `_n_` in the range `[`1`, `5`]`. It represents the first, second, third, fourth, or fifth weekday of some month. 

`weekday_indexed` is a [TriviallyCopyable](../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable") [StandardLayoutType](../named_req/StandardLayoutType.html "cpp/named req/StandardLayoutType"). 

## Contents

  * [1 Member functions](weekday_indexed.html#Member_functions)
  * [2 Nonmember functions](weekday_indexed.html#Nonmember_functions)
  * [3 Helper classes](weekday_indexed.html#Helper_classes)
  * [4 Example](weekday_indexed.html#Example)
