...
**get_tzdb get_tzdb_listreload_tzdbremote_version**(C++20)(C++20)(C++20)(C++20)  
...
[std::chrono::tzdb_list](tzdb_list.html)& get_tzdb_list(); |  (1)  |  (since C++20)  
---|---|---  
const [std::chrono::tzdb](tzdb.html)& get_tzdb(); |  (2)  |  (since C++20)  
[std::string](../string/basic_string.html) remote_version(); |  (3)  |  (since C++20)  
const [std::chrono::tzdb](tzdb.html)& reload_tzdb(); |  (4)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/tzdb_functions&action=edit&section=1 "Edit section: Exceptions")] Exceptions 

1) [std::runtime_error](../error/runtime_error.html "cpp/error/runtime error") if for any reason a reference to a `tzdb_list` containing one or more valid `tzdb` cannot be returned.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/tzdb_functions&action=edit&section=2 "Edit section: Return value")] Return value 
