...
constexpr [std::chrono::day](../day.html)& operator+=( const [std::chrono::days](../duration.html)& d ) noexcept; |  (1)  |  (since C++20)  
---|---|---  
constexpr [std::chrono::day](../day.html)& operator-=( const [std::chrono::days](../duration.html)& d ) noexcept; |  (2)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_arith&action=edit&section=1 "Edit section: Return value")] Return value

A reference to this `day` after modification. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_arith&action=edit&section=2 "Edit section: Notes")] Notes

If the result would be outside the range `[`​0​`, `255`]`, the actual stored value is unspecified. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_arith&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
        d += [std::chrono::days](../duration.html)(2);
        [assert](../../error/assert.html)(d == [std::chrono::day](../day.html)(17));
     
        d -= [std::chrono::days](../duration.html){3};
        [assert](../../error/assert.html)(d == [std::chrono::day](../day.html)(14));
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_arith&action=edit&section=4 "Edit section: See also")] See also
