...
[from_stream](from_stream.html "cpp/chrono/day/from stream")  
...
constexpr [std::chrono::day](../day.html)& operator++() noexcept; |  (1)  |  (since C++20)  
---|---|---  
constexpr [std::chrono::day](../day.html) operator++( int ) noexcept; |  (2)  |  (since C++20)  
constexpr [std::chrono::day](../day.html)& operator\--() noexcept; |  (3)  |  (since C++20)  
constexpr [std::chrono::day](../day.html) operator\--( int ) noexcept; |  (4)  |  (since C++20)  
| |   
  
Adds or subtracts 1 from the day value. 

1,2) Performs *this += [std::chrono::days](../duration.html){1};.

3,4) Performs *this -= [std::chrono::days](../duration.html){1};.
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_inc_dec&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_inc_dec&action=edit&section=2 "Edit section: Return value")] Return value

1,3) A reference to this `day` after modification.

2,4) A copy of the `day` made before modification.

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_inc_dec&action=edit&section=3 "Edit section: Notes")] Notes

If the result would be outside the range `[`​0​`, `255`]`, the actual stored value is unspecified. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_inc_dec&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        [std::chrono::day](../day.html) d{15};
     
        ++d;
        [assert](../../error/assert.html)(d == [std::chrono::day](../day.html)(16));
     
        --d;
        [assert](../../error/assert.html)(d == [std::chrono::day](../day.html)(15));
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_inc_dec&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[ operator+operator-](operator_arith_2.html "cpp/chrono/day/operator arith 2")(C++20) |  adds or subtracts a number of days and a `day`, or find the difference between two `day`s   
