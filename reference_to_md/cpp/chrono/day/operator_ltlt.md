...
operator<<( [std::basic_ostream](../../io/basic_ostream.html)<CharT, Traits>& os, const [std::chrono::day](../day.html)& d ); |  |  (since C++20)  
| |   
  
Forms a [std::basic_string](../../string/basic_string.html)<CharT> `s` consisting of the day value stored in d formatted as a decimal number, with a leading zero if the result would otherwise be a single decimal digit. Then, if !d.ok(), append " is not a valid day" to the formatted string. Inserts that string into os. 

Equivalent to 

return os << (d.ok() ?  
[std::format](../../utility/format/format.html)(STATICALLY_WIDEN<CharT>("{:%d}"), d) :  
[std::format](../../utility/format/format.html)(STATICALLY_WIDEN<CharT>("{:%d} is not a valid day"), d));

where STATICALLY_WIDEN<CharT>("...") is "..." if `CharT` is char, and L"..." if `CharT` is wchar_t. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value

os

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_ltlt&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr [std::chrono::day](../day.html) d1{31}, d2{7}, d3{42}, d4{};
        [std::cout](../../io/cout.html) << d1 << '\n'
                  << d2 << '\n'
                  << d3 << '\n'
                  << d4 << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/day/operator_ltlt&action=edit&section=3 "Edit section: See also")] See also
...
---|---  
[ std::formatter<std::chrono::day>](formatter.html "cpp/chrono/day/formatter")(C++20) |  formatting support for `day`   
