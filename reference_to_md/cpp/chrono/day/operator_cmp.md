...
---|---|---  
constexpr bool operator==( const [std::chrono::day](../day.html)& x,  
const [std::chrono::day](../day.html)& y ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::strong_ordering](../../utility/compare/strong_ordering.html) operator<=>( const [std::chrono::day](../day.html)& x,  
const [std::chrono::day](../day.html)& y ) noexcept; |  (2)  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        constexpr [std::chrono::day](../day.html) x{13}, y{31};
        static_assert(x != y);
     
        if constexpr (constexpr auto res = x <=> y; res < 0)
            [std::cout](../../io/cout.html) << "x is less than y\n";
        else if constexpr (res > 0)
            [std::cout](../../io/cout.html) << "x is greater than y\n";
        else
            [std::cout](../../io/cout.html) << "x and y are equal\n";
     
