...
---|---|---  
template<> struct hash<[std::chrono::day](../day.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::day`](../day.html "cpp/chrono/day") allows users to obtain hashes of objects of type [std::chrono::day](../day.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
