...
---|---|---  
constexpr [std::chrono::day](../day.html) operator+( const [std::chrono::day](../day.html)& d,  
const [std::chrono::days](../duration.html)& ds ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::chrono::day](../day.html) operator+( const [std::chrono::days](../duration.html)& ds,  
const [std::chrono::day](../day.html)& d ) noexcept; |  (2)  |  (since C++20)  
constexpr [std::chrono::day](../day.html) operator-( const [std::chrono::day](../day.html)& d,  
const [std::chrono::days](../duration.html)& ds ) noexcept; |  (3)  |  (since C++20)  
constexpr [std::chrono::days](../duration.html) operator-( const [std::chrono::day](../day.html)& x,  
const [std::chrono::day](../day.html)& y ) noexcept; |  (4)  |  (since C++20)  
| |   
...
3) [std::chrono::day](../day.html)(unsigned(d) - ds.count())
...
Run this code
    ...
     
        d = d + [std::chrono::days](../duration.html)(2);
        [assert](../../error/assert.html)(d == [std::chrono::day](../day.html)(17));
     
        d = d - [std::chrono::days](../duration.html)(3);
        [assert](../../error/assert.html)(d == [std::chrono::day](../day.html)(14));
     
        constexpr [std::chrono::days](../duration.html) ds = [std::chrono::day](../day.html)(16) - [std::chrono::day](../day.html)(14);
