...
struct zoned_traits { }; |  (1)  |  (since C++20)  
template <>  
struct zoned_traits<const [std::chrono::time_zone](time_zone.html)*>; |  (2)  |  (since C++20)  
| |   
...
The primary template is empty. A specialization is provided for const [std::chrono::time_zone](time_zone.html)*, the default time zone pointer type. 

## Contents

  * [1 Member functions](zoned_traits.html#Member_functions)
  * [2 std::chrono::zoned_traits<const std::chrono::time_zone*>::default_zone](zoned_traits.html#std::chrono::zoned_traits.3Cconst_std::chrono::time_zone.2A.3E::default_zone)
    * [2.1 Return value](zoned_traits.html#Return_value)
  * [3 std::chrono::zoned_traits<const std::chrono::time_zone*>::locate_zone](zoned_traits.html#std::chrono::zoned_traits.3Cconst_std::chrono::time_zone.2A.3E::locate_zone)
    * [3.1 Return value](zoned_traits.html#Return_value_2)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/zoned_traits&action=edit&section=1 "Edit section: Member functions")] Member functions 

##  std::chrono::zoned_traits<const std::chrono::time_zone*>::default_zone 

static const [std::chrono::time_zone](time_zone.html)* default_zone(); |  |   
---|---|---  
| |   
...
[std::chrono::locate_zone](locate_zone.html)("UTC"). 

##  std::chrono::zoned_traits<const std::chrono::time_zone*>::locate_zone

static const [std::chrono::time_zone](time_zone.html)* locate_zone([std::string_view](../string/basic_string_view.html) name); |  |   
---|---|---  
| |   
...
[std::chrono::locate_zone](locate_zone.html)(name). 
