...
const [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)& ymwdl ); |  |  (since C++20)  
| |   
  
Outputs a textual representation of ymwdl into os, as if by 

os << [std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{}/{:L}/{:L}"),  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value

os

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/operator_ltlt&action=edit&section=2 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/operator_ltlt&action=edit&section=3 "Edit section: See also")] See also
