...
**year_month_weekday_last::year year_month_weekday_last::monthyear_month_weekday_last::weekdayyear_month_weekday_last::weekday_last**  
...
---|---|---  
constexpr [std::chrono::month](../month.html) month() const noexcept; |  (2)  |  (since C++20)  
constexpr [std::chrono::weekday](../weekday.html) weekday() const noexcept; |  (3)  |  (since C++20)  
constexpr [std::chrono::weekday_last](../weekday_last.html) weekday_last() const noexcept; |  (4)  |  (since C++20)  
| |   
  
Retrieves the field values stored in this `year_month_weekday_last` object. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/accessors&action=edit&section=1 "Edit section: Return value")] Return value
...
4) [std::chrono::weekday_last](../weekday_last.html)(weekday())

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/accessors&action=edit&section=2 "Edit section: Example")] Example
