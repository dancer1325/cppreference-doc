...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/operator_arith&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [std::cout](../../io/cout.html) << year_month_day{ymwdl} << '\n';
        ymwdl += months(2);
        [std::cout](../../io/cout.html) << year_month_day{ymwdl} << '\n';
        ymwdl -= years(1); 
        [std::cout](../../io/cout.html) << year_month_day{ymwdl} << '\n';
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/operator_arith&action=edit&section=2 "Edit section: See also")] See also

[ operator+operator-](operator_arith_2.html "cpp/chrono/year month weekday last/operator arith 2")(C++20) |  adds or subtracts a `year_month_weekday_last` and some number of years or months   
