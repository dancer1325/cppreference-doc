...
[`std::chrono::year_month_weekday_last`](../year_month_weekday_last.html "cpp/chrono/year month weekday last")

Member functions  
---  
[year_month_weekday_last::year_month_weekday_last](year_month_weekday_last.html "cpp/chrono/year month weekday last/year month weekday last")  
[year_month_weekday_last::operator+=year_month_weekday_last::operator-=](operator_arith.html "cpp/chrono/year month weekday last/operator arith")  
[year_month_weekday_last::yearyear_month_weekday_last::monthyear_month_weekday_last::weekdayyear_month_weekday_last::weekday_last](accessors.html "cpp/chrono/year month weekday last/accessors")  
[year_month_weekday_last::operator sys_daysyear_month_weekday_last::operator local_days](operator_days.html "cpp/chrono/year month weekday last/operator days")  
[year_month_weekday_last::ok](ok.html "cpp/chrono/year month weekday last/ok")  
Nonmember functions  
[operator==](operator_cmp.html "cpp/chrono/year month weekday last/operator cmp")  
**operator+ operator-**  
[operator<<](operator_ltlt.html "cpp/chrono/year month weekday last/operator ltlt")  
Helper classes  
[formatter<std::chrono::year_month_weekday_last>](formatter.html "cpp/chrono/year month weekday last/formatter")  
[hash<std::chrono::year_month_weekday_last>](hash.html "cpp/chrono/year month weekday last/hash")(C++26)  
...
constexpr [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)   
operator+( const [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)& ymwdl,  
const [std::chrono::months](../duration.html)& dm ) noexcept; |  |  (since C++20)  
---|---|---  
constexpr [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)   
operator+( const [std::chrono::months](../duration.html)& dm,   
const [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)& ymwdl ) noexcept; |  |  (since C++20)  
constexpr [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)  
operator+( const [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)& ymwdl,   
const [std::chrono::years](../duration.html)& dy ) noexcept; |  |  (since C++20)  
constexpr [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)  
...
1,2) Adds dm.count() months to the date represented by ymwdl. The result has the same [`year()`](accessors.html "cpp/chrono/year month weekday last/accessors") and [`month()`](accessors.html "cpp/chrono/year month weekday last/accessors") as [std::chrono::year_month](../year_month.html)(ymwdl.year(), ymwdl.month()) + dm and the same [`weekday()`](accessors.html "cpp/chrono/year month weekday last/accessors") as ymwdl.

3,4) Adds dy.count() years to the date represented by ymwdl. The result is equivalent to [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)(ymwdl.year() + dy, ymwdl.month(), ymwd.weekday_last()).
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/operator_arith_2&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        auto ymwdl2 = ymwdl1;
        ymwdl2 = [std::chrono::months](../duration.html)(12) + ymwdl2;
        ymwdl2 = ymwdl2 - [std::chrono::years](../duration.html)(1);
        [assert](../../error/assert.html)(ymwdl1 == ymwdl2);
    }
