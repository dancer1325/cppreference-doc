...
---|---|---  
constexpr bool operator==( const [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)& x,   
const [std::chrono::year_month_weekday_last](../year_month_weekday_last.html)& y ) noexcept; |  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value

x.year() == y.year() && x.month() == y.month() && x.weekday() == y.weekday()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/operator_cmp&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        ymwdl2 += months(12);
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html) << (ymwdl1 == ymwdl2) << '\n';
    }
