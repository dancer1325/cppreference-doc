...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/ok&action=edit&section=1 "Edit section: Return value")] Return value

year().ok() && month().ok() && weekday().ok()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_weekday_last/ok&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        [assert](../../error/assert.html)(ymwdl.ok());
