...
---|---|---  
[std::tm](tm.html)* localtime( const [std::time_t](time_t.html)* time ); |  |   
| |   
  
Converts given time since epoch as [std::time_t](time_t.html "cpp/chrono/c/time t") value into calendar time, expressed in local time. 
...
## Contents
  ...
  * [5 See also](localtime.html#See_also)
...
POSIX requires that this function sets [errno](../../error/errno.html "cpp/error/errno") to [EOVERFLOW](../../error/errno_macros.html "cpp/error/errno macros") if it fails because the argument is too large. 
...
Run this code
    ...
     
        [std::tm](tm.html) tm{}; // Zero initialize
    ...
     
        [std::cout](../../io/cout.html) << "UTC:   " << [std::put_time](../../io/manip/put_time.html)([std::gmtime](gmtime.html)(&t), "%c %Z") << '\n';
        [std::cout](../../io/cout.html) << "local: " << [std::put_time](../../io/manip/put_time.html)(std::localtime(&t), "%c %Z") << '\n';
    }
