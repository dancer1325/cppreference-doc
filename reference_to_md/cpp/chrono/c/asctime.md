...
---|---|---  
char* asctime( const [std::tm](tm.html)* time_ptr ); |  |   
| |   
  
Converts given calendar time [std::tm](tm.html "cpp/chrono/c/tm") to a textual representation of the following fixed 25-character form: Www Mmm dd hh:mm:ss yyyy\n. 
...
## Contents
  ...
  * [5 See also](asctime.html#See_also)
...
Run this code
    ...
    int main()
    {
        const [std::time_t](time_t.html) now = [std::time](time.html)(nullptr);
     
        for (const char* localeName : {"C", "en_US.utf8", "de_DE.utf8", "ja_JP.utf8"})
        {
            [std::cout](../../io/cout.html) << "locale " << localeName << ":\n" << [std::left](../../io/manip/left.html);
            [std::locale::global](../../locale/locale/global.html)([std::locale](../../locale/locale.html)(localeName));
     
            [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(40) << "    asctime" << std::asctime([std::localtime](localtime.html)(&now));
     
            // strftime output for comparison:
            char buf[64];
            if (strftime(buf, sizeof buf, "%c\n", [std::localtime](localtime.html)(&now)))
                [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(40) << "    strftime %c" << buf;
     
            if (strftime(buf, sizeof buf, "%a %b %e %H:%M:%S %Y\n", [std::localtime](localtime.html)(&now)))
                [std::cout](../../io/cout.html) << [std::setw](../../io/manip/setw.html)(40) << "    strftime %a %b %e %H:%M:%S %Y" << buf;
     
