...
[strftime](strftime.html "cpp/chrono/c/strftime")  
**wcsftime**  
...
---|---|---  
[std::size_t](../../types/size_t.html) wcsftime( wchar_t* str, [std::size_t](../../types/size_t.html) count, const wchar_t* format, const [std::tm](tm.html)* time ); |  |   
| |   
  
Converts the date and time information from a given calendar time time to a null-terminated wide character string str according to [format string](wcsftime.html#Format_string) format. Up to count wide characters are written. 
...
## Contents
  ...
  * [5 See also](wcsftime.html#See_also)
...
Run this code
    ...
    int main()
    {
        ...
        wchar_t wstr[100];
        if (std::wcsftime(wstr, 100, L"%A %c", [std::localtime](localtime.html)(&t)))
            [std::wcout](../../io/cout.html) << wstr << '\n';
    }
