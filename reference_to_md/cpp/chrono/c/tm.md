...
## Contents
  ...
  * [2 Notes](tm.html#Notes)
  * [3 Example](tm.html#Example)
...
(public member object)  
  ...
  1. [↑](tm.html#cite_ref-leapsecond_1-0) Range allows for a positive leap second. Two leap seconds in the same minute are not allowed (the range `[`​0​`, `61`]` was a defect introduced in C89 and corrected in C99).
...
Run this code
    ...
    int main()
    {
        ...
        tm.tm_mday = 1;
        [std::mktime](mktime.html)(&tm);
     
        [std::cout](../../io/cout.html) << [std::asctime](asctime.html)(&tm); // note implicit trailing '\n'
    }
