...
## Contents
  ...
  * [1 Data members](timespec.html#Data_members)
  * [2 Notes](timespec.html#Notes)
  * [3 Example](timespec.html#Example)
  * [4 See also](timespec.html#See_also)
...
Member  |  Description   
---|---  
[std::time_t](time_t.html "cpp/chrono/c/time t") `tv_sec` |  whole seconds, the value is >= ​0​   
(public member object)  
long `tv_nsec` |  nanoseconds, the value is in range `[`​0​`, `999999999`]`   
(public member object)  
...
Run this code
    ...
    {
        std::timespec ts;
        [std::timespec_get](timespec_get.html)(&ts, [TIME_UTC](timespec_get.html));
        char buff[0x80];
        [std::strftime](strftime.html)(buff, sizeof buff, "%D %T", [std::gmtime](gmtime.html)(&ts.tv_sec));
     
    ...
     
        [std::cout](../../io/cout.html) << "Current time: " << buff << " (UTC)\n"
