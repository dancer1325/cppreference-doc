...
---|---|---  
double difftime( [std::time_t](time_t.html) time_end, [std::time_t](time_t.html) time_beg ); |  |   
| |   
  
Computes difference between two calendar times as [std::time_t](time_t.html "cpp/chrono/c/time t") objects (time_end - time_beg) in seconds. If time_end refers to time point before time_beg then the result is negative. 
...
## Contents
  ...
  * [5 See also](difftime.html#See_also)
...
Run this code
    ...
    int main()
    {
        [std::time_t](time_t.html) start = [std::time](time.html)(nullptr);
    ...
     
        ...
        for (int p = 0; p < 10000; ++p)
            for (int q = 0; q < 100000; ++q)
                d = d + p * d * q + d;
     
        [std::cout](../../io/cout.html) << "Wall time passed: "
                  << std::difftime([std::time](time.html)(nullptr), start) << " s.\n";
    }
