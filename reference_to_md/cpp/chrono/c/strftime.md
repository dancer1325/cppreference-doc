...
---  
Time manipulation  
[difftime](difftime.html "cpp/chrono/c/difftime")  
[time](time.html "cpp/chrono/c/time")  
[clock](clock.html "cpp/chrono/c/clock")  
[timespec_get](timespec_get.html "cpp/chrono/c/timespec get")(C++17)  
Format conversions  
[asctime](asctime.html "cpp/chrono/c/asctime")  
[ctime](ctime.html "cpp/chrono/c/ctime")  
**strftime**  
[wcsftime](wcsftime.html "cpp/chrono/c/wcsftime")  
[gmtime](gmtime.html "cpp/chrono/c/gmtime")  
[localtime](localtime.html "cpp/chrono/c/localtime")  
[mktime](mktime.html "cpp/chrono/c/mktime")  
Constants  
[CLOCKS_PER_SEC](CLOCKS_PER_SEC.html "cpp/chrono/c/CLOCKS PER SEC")  
Types  
[tm](tm.html "cpp/chrono/c/tm")  
[time_t](time_t.html "cpp/chrono/c/time t")  
...
---|---|---  
[std::size_t](../../types/size_t.html) strftime( char* str, [std::size_t](../../types/size_t.html) count, const char* format, const [std::tm](tm.html)* tp ); |  |   
| |   
...
## Contents
  ...
  * [5 See also](strftime.html#See_also)
...
Run this code
    ...
    void utcExample()
    {
        ...
        [std::time_t](time_t.html) time = [std::time](time.html)({});
        char timeString[[std::size](../../iterator/size.html)("yyyy-mm-ddThh:mm:ssZ")];
        std::strftime([std::data](../../iterator/data.html)(timeString), [std::size](../../iterator/size.html)(timeString),
                      "%FT%TZ", [std::gmtime](gmtime.html)(&time));
        [std::cout](../../io/cout.html) << timeString << '\n';
    }
     
    int main()
    {
        [std::time_t](time_t.html) t = [std::time](time.html)(nullptr);
        char mbstr[100];
     
        if (std::strftime(mbstr, sizeof(mbstr), "%A %c", [std::localtime](localtime.html)(&t)))
            [std::cout](../../io/cout.html) << mbstr << '\n';
     
