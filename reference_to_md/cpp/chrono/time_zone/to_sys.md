...
**time_zone::to_sys**  
[time_zone::to_local](to_local.html "cpp/chrono/time zone/to local")  
Nonmember functions  
...
-> [std::chrono::sys_time](../system_clock.html)<[std::common_type_t](../../types/common_type.html)<Duration, [std::chrono::seconds](../duration.html)>>; |  (1)  |  (since C++20)  
---|---|---  
template< class Duration >  
auto to_sys( const [std::chrono::local_time](../local_t.html)<Duration>& tp, [std::chrono::choose](../choose.html) z ) const  
-> [std::chrono::sys_time](../system_clock.html)<[std::common_type_t](../../types/common_type.html)<Duration, [std::chrono::seconds](../duration.html)>>; |  (2)  |  (since C++20)  
| |   
...
## Contents
  ...
  * [1 Return value](to_sys.html#Return_value)
  * [2 Exceptions](to_sys.html#Exceptions)
  * [3 Notes](to_sys.html#Notes)
  * [4 Example](to_sys.html#Example)
...
1) Throws: 
  ...
  * [std::chrono::ambiguous_local_time](../ambiguous_local_time.html) if the conversion is ambiguous, 
  * [std::chrono::nonexistent_local_time](../nonexistent_local_time.html) if tp represents a nonexistent time.
