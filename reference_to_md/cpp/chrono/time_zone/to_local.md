...
Member functions  
---  
[time_zone::name](name.html "cpp/chrono/time zone/name")  
[time_zone::get_info](get_info.html "cpp/chrono/time zone/get info")  
[time_zone::to_sys](to_sys.html "cpp/chrono/time zone/to sys")  
**time_zone::to_local**  
Nonmember functions  
...
-> [std::chrono::local_time](../local_t.html)<[std::common_type_t](../../types/common_type.html)<Duration, [std::chrono::seconds](../duration.html)>>; |  |  (since C++20)  
---|---|---  
| |   
  
Converts the `sys_time` tp to the corresponding `local_time` in this [time zone](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones "enwiki:List of tz database time zones"). 

## Contents

  * [1 Parameters](to_local.html#Parameters)
  * [2 Return value](to_local.html#Return_value)
  * [3 Notes](to_local.html#Notes)
  * [4 Example](to_local.html#Example)
...
Run this code
    ...
    int main()
    {
        ...
        const auto time_pt_utc{[std::chrono::system_clock::now](../system_clock/now.html)()};
        [std::cout](../../io/cout.html) << "Current time UTC is:\t\t " << time_pt_utc << '\n';
     
        try
        {
            [std::cout](../../io/cout.html) << "Current time local is:\t\t "
                      << [std::chrono::current_zone](../current_zone.html)()-> // may throw
                          to_local(time_pt_utc) << '\n'
                      << "Current time " << some_zone_name << " is:\t "
                      << [std::chrono::locate_zone](../locate_zone.html)(some_zone_name)-> // may throw
                          to_local(time_pt_utc) << '\n';
        }
