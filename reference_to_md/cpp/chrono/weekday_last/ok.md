...
Run this code
    ...
     
        auto wdl{[std::chrono::Tuesday](../weekday.html)[[std::chrono::last](../last_spec.html)]};
        [std::cout](../../io/cout.html) << (wdl.ok()) << ' ';
     
        wdl = {[std::chrono::weekday](../weekday.html)(42)[[std::chrono::last](../last_spec.html)]};
        [std::cout](../../io/cout.html) << (wdl.ok()) << '\n';
    }
