...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_last/weekday&action=edit&section=1 "Edit section: Return value")] Return value

A copy of the std::chrono::weekday object stored in *this. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_last/weekday&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
        ...
        [std::cout](../../io/cout.html) << (year_month_day{wdl/10/2019} ==
