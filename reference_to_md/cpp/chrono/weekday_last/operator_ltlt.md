...
operator<<( [std::basic_ostream](../../io/basic_ostream.html)<CharT, Traits>& os, const [std::chrono::weekday_last](../weekday_last.html)& wdl ); |  |  (since C++20)  
| |   
  
Outputs a textual representation of wdl into the stream os, as if by 

os << [std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{:L}[last]"), wdl.weekday());
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_last/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value

os

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_last/operator_ltlt&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_last/operator_ltlt&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_last/operator_ltlt&action=edit&section=4 "Edit section: See also")] See also
