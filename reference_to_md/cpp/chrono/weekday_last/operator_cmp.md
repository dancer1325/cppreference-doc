...
---|---|---  
constexpr bool operator==( const [std::chrono::weekday_last](../weekday_last.html)& x,  
const [std::chrono::weekday_last](../weekday_last.html)& y ) noexcept; |  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_last/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value

x.weekday() == y.weekday()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_last/operator_cmp&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr auto wdl1{[std::chrono::Tuesday](../weekday.html)[[std::chrono::last](../last_spec.html)]};
        constexpr [std::chrono::weekday_last](../weekday_last.html) wdl2{[std::chrono::weekday](../weekday.html)(2)};
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html)
                  << (wdl1 == wdl2) << ' '
                  << (wdl1 == [std::chrono::Wednesday](../weekday.html)[[std::chrono::last](../last_spec.html)]) << '\n';
    }
