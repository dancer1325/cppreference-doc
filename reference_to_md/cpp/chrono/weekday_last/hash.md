...
**hash <std::chrono::weekday_last>**(C++26)  
...
---|---|---  
template<> struct hash<[std::chrono::weekday_last](../weekday_last.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::weekday_last`](../weekday_last.html "cpp/chrono/weekday last") allows users to obtain hashes of objects of type [std::chrono::weekday_last](../weekday_last.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
