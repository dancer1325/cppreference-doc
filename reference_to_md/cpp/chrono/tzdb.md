...
---|---  
`version` |  A [std::string](../string/basic_string.html "cpp/string/basic string") that contains the version of the database   
`zones` |  A sorted [std::vector](../container/vector.html)<[std::chrono::time_zone](time_zone.html)> containing description of time zones   
