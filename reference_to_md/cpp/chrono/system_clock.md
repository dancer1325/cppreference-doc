...
Member functions  
---  
[system_clock::now](system_clock/now.html "cpp/chrono/system clock/now")  
[system_clock::to_time_t](system_clock/to_time_t.html "cpp/chrono/system clock/to time t")  
[system_clock::from_time_t](system_clock/from_time_t.html "cpp/chrono/system clock/from time t")  
Time point I/O  
[operator<<](system_clock/operator_ltlt.html "cpp/chrono/system clock/operator ltlt")  
...
`std::chrono::system_clock` meets the requirements of [TrivialClock](../named_req/TrivialClock.html "cpp/named req/TrivialClock"). 
...
## Contents
  ...
  * [1 Time point family](system_clock.html#Time_point_family)
  * [2 Member types](system_clock.html#Member_types)
  * [3 Member constants](system_clock.html#Member_constants)
  * [4 Member functions](system_clock.html#Member_functions)
  * [5 Notes](system_clock.html#Notes)
  * [6 See also](system_clock.html#See_also)
...
using sys_time = [std::chrono::time_point](time_point.html)<std::chrono::system_clock, Duration>; |  |  (since C++20)  
using sys_seconds = sys_time<[std::chrono::seconds](duration.html)>; |  |  (since C++20)  
