...
---|---|---  
template< class Rep >   
struct treat_as_floating_point : [std::is_floating_point](../types/is_floating_point.html)<Rep> {}; |  |  (since C++11)  
| |   
...
## Contents
  ...
  * [1 Helper variable template](treat_as_floating_point.html#Helper_variable_template)
  * [2 Specializations](treat_as_floating_point.html#Specializations)
  * [3 Example](treat_as_floating_point.html#Example)
  * [4 See also](treat_as_floating_point.html#See_also)
...
Run this code
    ...
    {
        [std::chrono::milliseconds](duration.html) simulated_work(2);
        [std::this_thread::sleep_for](../thread/sleep_for.html)(simulated_work);
    }
     
    int main() 
    {
        auto start = [std::chrono::high_resolution_clock::now](high_resolution_clock/now.html)();
     
        [std::cout](../io/cout.html) << "Running some timed piece of code...\n";
        timed_piece_of_code();
     
        auto stop = [std::chrono::high_resolution_clock::now](high_resolution_clock/now.html)();
     
        // A floating point milliseconds type
        using FpMilliseconds = 
            [std::chrono::duration](duration.html)<float, std::chrono::milliseconds::period>;
     
    ...
     
        ...
        auto i_ms = [std::chrono::duration_cast](duration/duration_cast.html)<[std::chrono::milliseconds](duration.html)>(stop - start);
     
        // Note that implicit conversion is allowed here
        auto f_ms = FpMilliseconds(stop - start);
     
        [std::cout](../io/cout.html) << "Timing stats:\n";
     
        [std::cout](../io/cout.html) << "  Time in milliseconds, using default rep: "
                  << i_ms.count() << '\n';
     
        [std::cout](../io/cout.html) << "  Time in milliseconds, using floating point rep: "
                  << f_ms.count() << '\n';
    }
