...
---|---|---  
constexpr year_month_day( const [std::chrono::year](../year.html)& y,  
const [std::chrono::month](../month.html)& m,  
const [std::chrono::day](../day.html)& d ) noexcept; |  (2)  |  (since C++20)  
constexpr year_month_day( const [std::chrono::year_month_day_last](../year_month_day_last.html)& ymdl ) noexcept; |  (3)  |  (since C++20)  
constexpr year_month_day( const [std::chrono::sys_days](../system_clock.html)& dp ) noexcept; |  (4)  |  (since C++20)  
constexpr explicit year_month_day( const [std::chrono::local_days](../local_t.html)& dp ) noexcept; |  (5)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day/year_month_day&action=edit&section=1 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day/year_month_day&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
     
        constexpr auto ymd2 = [std::chrono::year_month_day](../year_month_day.html)(
            2020y, [std::chrono::January](../month.html), 31d // overload (2)
        );
        [std::cout](../../io/cout.html) << "ymd2: " << ymd2 << '\n';
     
        constexpr auto ymd3 = [std::chrono::year_month_day](../year_month_day.html)(
            [std::chrono::April](../month.html) / [std::chrono::Monday](../weekday.html)[last] / 2023y // overload (3)
        );
        [std::cout](../../io/cout.html) << "ymd3: " << ymd3 << '\n';
     
        const auto now = [std::chrono::system_clock::now](../system_clock/now.html)();
        const auto ymd4 = [std::chrono::year_month_day](../year_month_day.html)(
            [std::chrono::floor](../duration/floor.html)<[std::chrono::days](../duration.html)>(now) // overload (4)
        );
        [std::cout](../../io/cout.html) << "ymd4: " << ymd4 << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day/year_month_day&action=edit&section=3 "Edit section: See also")] See also
