...
struct formatter<[std::chrono::year_month_day](../year_month_day.html), CharT>; |  |  (since C++20)  
| |   
  
Specialization of [std::formatter](../../utility/format/formatter.html "cpp/utility/format/formatter") that defines formatting rules for a std::chrono::year_month_day. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day/formatter&action=edit&section=1 "Edit section: Format specification")] Format specification
...
Unless otherwise specified, if the chrono-spec is empty, the chrono object is formatted as if by [streaming](operator_ltlt.html "cpp/chrono/year month day/operator ltlt") it to an object `os` of type [std::basic_ostringstream](../../io/basic_ostringstream.html)<CharT> with the formatting locale (one of [std::locale::classic](../../locale/locale/classic.html)(), the passed [std::locale](../../locale/locale.html "cpp/locale/locale") object, and [std::locale::global](../../locale/locale/global.html)()) [imbued](../../io/ios_base/imbue.html "cpp/io/ios base/imbue") and copying os.str() to the output buffer with additional padding and adjustments as per format specifiers. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day/formatter&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day/formatter&action=edit&section=3 "Edit section: See also")] See also
