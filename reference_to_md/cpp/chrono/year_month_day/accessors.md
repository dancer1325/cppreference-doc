...
**year_month_day::year year_month_day::monthyear_month_day::day**  
...
constexpr [std::chrono::day](../day.html) day() const noexcept; |  (3)  |  (since C++20)  
| |   
  
Retrieves the year, month and day values stored in this `year_month_day` object. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day/accessors&action=edit&section=1 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month_day/accessors&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr [std::chrono::year_month_day](../year_month_day.html) ymd{[std::chrono::July](../month.html)/1/2021};
     
        static_assert(ymd.year() == [std::chrono::year](../year.html)(2021));
        static_assert(ymd.month() == [std::chrono::month](../month.html)(7));
        static_assert(ymd.day() == [std::chrono::day](../day.html)(1));
    }
