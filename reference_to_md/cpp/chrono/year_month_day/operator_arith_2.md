...
---|---|---  
constexpr [std::chrono::year_month_day](../year_month_day.html) operator+( const [std::chrono::year_month_day](../year_month_day.html)& ymd,  
const [std::chrono::months](../duration.html)& dm  
) noexcept; |  |  (since C++20)  
constexpr [std::chrono::year_month_day](../year_month_day.html) operator+( const [std::chrono::months](../duration.html)& dm,  
const [std::chrono::year_month_day](../year_month_day.html)& ymd  
) noexcept; |  |  (since C++20)  
constexpr [std::chrono::year_month_day](../year_month_day.html) operator+( const [std::chrono::year_month_day](../year_month_day.html)& ymd,  
const [std::chrono::years](../duration.html)& dy  
) noexcept; |  |  (since C++20)  
constexpr [std::chrono::year_month_day](../year_month_day.html) operator+( const [std::chrono::years](../duration.html)& dy,  
const [std::chrono::year_month_day](../year_month_day.html)& ymd  
) noexcept; |  |  (since C++20)  
constexpr [std::chrono::year_month_day](../year_month_day.html) operator-( const [std::chrono::year_month_day](../year_month_day.html)& ymd,  
const [std::chrono::months](../duration.html)& dm  
...
1,2) Adds dm.count() months to the date represented by ymd. The result has the same day() as ymd and the same year() and month() as [std::chrono::year_month](../year_month.html)(ymd.year(), ymd.month()) + dm.

3,4) Adds dy.count() years to the date represented by ymd. The result is equivalent to [std::chrono::year_month_day](../year_month_day.html)(ymd.year() + dy, ymd.month(), ymd.day().
...
Run this code
    ...
     
        auto ymd{[std::chrono::day](../day.html)(1)/[std::chrono::July](../month.html)/2021};
     
        ymd = ymd + [std::chrono::months](../duration.html)(4);
        [std::cout](../../io/cout.html) << (ymd.month() == [std::chrono::November](../month.html)) << ' '
                  << (ymd.year() == [std::chrono::year](../year.html)(2021)) << ' ';
     
        ymd = ymd - [std::chrono::years](../duration.html)(10);
        [std::cout](../../io/cout.html) << (ymd.month() == [std::chrono::month](../month.html)(11)) << ' '
                  << (ymd.year() == [std::chrono::year](../year.html)(2011)) << '\n';
    }
