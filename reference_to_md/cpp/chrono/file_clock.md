...
Member functions  
---  
[file_clock::now](file_clock/now.html "cpp/chrono/file clock/now")  
  
  
[file_clock::to_sysfile_clock::from_sys](file_clock/to_from_sys.html "cpp/chrono/file clock/to from sys")(optional*)  
  
  
[file_clock::to_utcfile_clock::from_utc](file_clock/to_from_utc.html "cpp/chrono/file clock/to from utc")(optional*)  
Time point I/O  
[operator<<](file_clock/operator_ltlt.html "cpp/chrono/file clock/operator ltlt")  
[formatter<std::chrono::file_time>](file_clock/formatter.html "cpp/chrono/file clock/formatter")  
[from_stream](file_clock/from_stream.html "cpp/chrono/file clock/from stream")  
...
`std::chrono::file_clock` is an alias for the clock used for [std::filesystem::file_time_type](../filesystem/file_time_type.html "cpp/filesystem/file time type"). Its epoch is unspecified. 

`file_clock` meets the [TrivialClock](../named_req/TrivialClock.html "cpp/named req/TrivialClock") requirements. 

## Contents

  * [1 Time point family](file_clock.html#Time_point_family)
  * [2 Member types](file_clock.html#Member_types)
  * [3 Member constants](file_clock.html#Member_constants)
  * [4 Member functions](file_clock.html#Member_functions)
...
using file_time = [std::chrono::time_point](time_point.html)<std::chrono::file_clock, Duration>; |  |  (since C++20)  
| |   
[ operator<<(std::chrono::file_time)](file_clock/operator_ltlt.html "cpp/chrono/file clock/operator ltlt")(C++20) |  performs stream output on a `file_time`   
...
[ std::formatter<std::chrono::file_time>](file_clock/formatter.html "cpp/chrono/file clock/formatter")(C++20) |  formatting support for `file_time`   
...
`time_point` |  [std::chrono::time_point](time_point.html)<std::chrono::file_clock>  
...
constexpr bool is_steady[static] |  true if the time between ticks is always constant, i.e. calls to [`now()`](file_clock/now.html "cpp/chrono/file clock/now") return values that increase monotonically even in case of some external clock adjustment, otherwise false   
(public static member constant)  
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/file_clock&action=edit&section=1 "Edit section: Member functions")] Member functions
...
[ now](file_clock/now.html "cpp/chrono/file clock/now")[static] |  returns a [std::chrono::time_point](time_point.html "cpp/chrono/time point") representing the current point in time   
(public static member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/chrono/file_clock/dsc_now&action=edit)  
---|---  
[ to_utcfrom_utc](file_clock/to_from_utc.html "cpp/chrono/file clock/to from utc")[static] (optional) |  converts between `file_time` and `utc_time`   
(public static member function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/chrono/file_clock/dsc_to_from_utc&action=edit)  
[ to_sysfrom_sys](file_clock/to_from_sys.html "cpp/chrono/file clock/to from sys")[static] (optional) |  converts between `file_time` and `sys_time`   
