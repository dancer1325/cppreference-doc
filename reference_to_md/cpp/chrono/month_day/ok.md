...
Run this code
    ...
     
        constexpr auto md1{[std::chrono::July](../month.html)/15};
        [std::cout](../../io/cout.html) << (md1.ok()) << ' ';
        constexpr [std::chrono::month_day](../month_day.html) md2{[std::chrono::month](../month.html)(14), [std::chrono::day](../day.html)(42)};
        [std::cout](../../io/cout.html) << (md2.ok()) << ' ';
        constexpr auto md3{[std::chrono::February](../month.html)/29};
        [std::cout](../../io/cout.html) << (md3.ok()) << '\n';
    }
