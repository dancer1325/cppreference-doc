...
operator<<( [std::basic_ostream](../../io/basic_ostream.html)<CharT, Traits>& os, const [std::chrono::month_day](../month_day.html)& md ); |  |  (since C++20)  
| |   
  
Outputs a textual representation of md into the stream os, as if by 

os << [std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{:L}/{}"), md.month(), md.day())
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value

os

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/operator_ltlt&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/operator_ltlt&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/operator_ltlt&action=edit&section=4 "Edit section: See also")] See also
...
---|---  
[ std::formatter<std::chrono::month_day>](formatter.html "cpp/chrono/month day/formatter")(C++20) |  formatting support for `month_day`   
