...
[from_stream](from_stream.html "cpp/chrono/month day/from stream")  
Helper classes  
**formatter <std::chrono::month_day>**  
...
struct formatter<[std::chrono::month_day](../month_day.html), CharT>; |  |  (since C++20)  
| |   
  
Specialization of [std::formatter](../../utility/format/formatter.html "cpp/utility/format/formatter") that defines formatting rules for std::chrono::month_day. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/formatter&action=edit&section=1 "Edit section: Format specification")] Format specification
...
Unless otherwise specified, if the chrono-spec is empty, the chrono object is formatted as if by [streaming](operator_ltlt.html "cpp/chrono/month day/operator ltlt") it to an object `os` of type [std::basic_ostringstream](../../io/basic_ostringstream.html)<CharT> with the formatting locale (one of [std::locale::classic](../../locale/locale/classic.html)(), the passed [std::locale](../../locale/locale.html "cpp/locale/locale") object, and [std::locale::global](../../locale/locale/global.html)()) [imbued](../../io/ios_base/imbue.html "cpp/io/ios base/imbue") and copying os.str() to the output buffer with additional padding and adjustments as per format specifiers. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/formatter&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        ...
        constexpr [std::chrono::month_day](../month_day.html) md{[std::chrono::February](../month.html) / 29d};
     
        [std::cout](../../io/cout.html) << "%B: " << [std::format](../../utility/format/format.html)("{:%B}", md) << '\n'
                  << "%d: " << [std::format](../../utility/format/format.html)("{:%d}", md) << '\n';
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/formatter&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/formatter&action=edit&section=4 "Edit section: See also")] See also
