...
---|---|---  
template<> struct hash<[std::chrono::month_day](../month_day.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::month_day`](../month_day.html "cpp/chrono/month day") allows users to obtain hashes of objects of type [std::chrono::month_day](../month_day.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
