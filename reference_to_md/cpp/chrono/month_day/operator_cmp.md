...
---|---|---  
constexpr bool operator==( const [std::chrono::month_day](../month_day.html)& x,  
const [std::chrono::month_day](../month_day.html)& y ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::strong_ordering](../../utility/compare/strong_ordering.html) operator<=>( const [std::chrono::month_day](../month_day.html)& x,  
const [std::chrono::month_day](../month_day.html)& y ) noexcept; |  (2)  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value

1) x.month() == y.month() && x.day() == y.day()

2) x.month() <=> y.month() != 0 ? x.month() <=> y.month() : x.day() <=> y.day()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/operator_cmp&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr auto md1{[std::chrono::August](../month.html)/15};
        constexpr auto md2{[std::chrono::month](../month.html)(8)/[std::chrono::day](../day.html)(15)};
        [std::cout](../../io/cout.html) << [std::boolalpha](../../io/manip/boolalpha.html) << (md1 == md2) << '\n';
     
