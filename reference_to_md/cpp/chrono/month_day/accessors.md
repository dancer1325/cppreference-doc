...
---|---|---  
constexpr [std::chrono::day](../day.html) day() const noexcept; |  (1)  |  (since C++20)  
| |   
...
Run this code
    ...
    int main()
    {
        constexpr auto md{[std::chrono::July](../month.html)/15};  
        static_assert(md.month() == [std::chrono::month](../month.html)(7));
        static_assert(md.day() == [std::chrono::day](../day.html)(15));
    }
