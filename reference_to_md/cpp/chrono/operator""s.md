...
---|---|---  
constexpr [std::chrono::seconds](duration.html)  
operator""s( unsigned long long secs ); |  (1)  |  (since C++14)  
constexpr [std::chrono::duration](duration.html)</*unspecified*/>  
operator""s( long double secs ); |  (2)  |  (since C++14)  
| |   
  
Forms a [std::chrono::duration](duration.html "cpp/chrono/duration") literal representing seconds. 

1) Integer literal, returns exactly [std::chrono::seconds](duration.html)(secs).

2) Floating-point literal, returns a floating-point duration equivalent to [std::chrono::seconds](duration.html "cpp/chrono/duration").

## Contents

  * [1 Parameters](operator""s.html#Parameters)
  * [2 Return value](operator""s.html#Return_value)
  * [3 Possible implementation](operator""s.html#Possible_implementation)
  * [4 Notes](operator""s.html#Notes)
  * [5 Example](operator""s.html#Example)
  * [6 See also](operator""s.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22s&action=edit&section=1 "Edit section: Parameters")] Parameters

secs  |  \-  |  the number of seconds   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22s&action=edit&section=2 "Edit section: Return value")] Return value

The [std::chrono::duration](duration.html "cpp/chrono/duration") literal. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22s&action=edit&section=3 "Edit section: Possible implementation")] Possible implementation
    
    
    constexpr [std::chrono::seconds](duration.html) operator""s(unsigned long long s)
    {
        return [std::chrono::seconds](duration.html)(s);
    }
    constexpr [std::chrono::duration](duration.html)<long double> operator""s(long double s)
    {
        return [std::chrono::duration](duration.html)<long double>(s);
    }  
  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22s&action=edit&section=4 "Edit section: Notes")] Notes
...
[std::string](../string/basic_string.html "cpp/string/basic string") also defines operator""s, to represent literal objects of type `std::string`, but it is a string literal: 10s is ten seconds, but "10"s is a two-character string. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22s&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        [std::chrono::seconds](duration.html) halfmin = 30s;
        [std::cout](../io/cout.html) << "Half a minute is " << halfmin.count() << " seconds"
            " (" << halfmin << ").\n"
            "A minute and a second is " << (1min + 1s).count() << " seconds.\n";
     
        [std::chrono::duration](duration.html) moment = 0.1s;
        [std::cout](../io/cout.html) << "A moment is " << moment.count() << " seconds"
            " (" << moment << ").\n"
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/operator%22%22s&action=edit&section=6 "Edit section: See also")] See also
