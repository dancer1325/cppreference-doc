[[edit template]](https://en.cppreference.com/mwiki/index.php?title=Template:cpp/chrono/clock_time_ltlt&action=edit)
...
const [std::chrono::utc_time](../utc_clock.html)<Duration>& tp ); |  |  (since C++20)  
| |   
