...
[std::chrono::leap_second_info](leap_second_info.html)  
get_leap_second_info( const [std::chrono::utc_time](../utc_clock.html)<Duration>& ut ); |  |  (since C++20)  
| |   
  
Obtains a [std::chrono::leap_second_info](leap_second_info.html "cpp/chrono/utc clock/leap second info") whose `is_leap_second` and `elapsed` indicate whether ut is during a positive leap second insertion and the sum of leap seconds between 1 January 1970 and ut, respectively. 

## Contents

  * [1 Parameters](get_leap_second_info.html#Parameters)
  * [2 Return value](get_leap_second_info.html#Return_value)
  * [3 Exceptions](get_leap_second_info.html#Exceptions)
  * [4 See also](get_leap_second_info.html#See_also)
