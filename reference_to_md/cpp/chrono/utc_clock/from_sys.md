...
from_sys( const [std::chrono::sys_time](../system_clock.html)<Duration>& t ); |  |  (since C++20)  
---|---|---  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/utc_clock/from_sys&action=edit&section=1 "Edit section: Return value")] Return value

A `utc_time` representing the same point in time as t. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/utc_clock/from_sys&action=edit&section=2 "Edit section: See also")] See also

[ to_sys](to_sys.html "cpp/chrono/utc clock/to sys")[static] |  converts `utc_time` to `sys_time`   
