...
---|---|---  
constexpr [std::chrono::hours](duration.html)  
operator""h( unsigned long long hrs ); |  (1)  |  (since C++14)  
constexpr [std::chrono::duration](duration.html)</*unspecified*/, [std::ratio](../numeric/ratio/ratio.html)<3600,1>>  
operator""h( long double hrs ); |  (2)  |  (since C++14)  
| |   
  
Forms a [std::chrono::duration](duration.html "cpp/chrono/duration") literal representing hours. 

1) Integer literal, returns exactly [std::chrono::hours](duration.html)(hrs).

2) Floating-point literal, returns a floating-point duration equivalent to [std::chrono::hours](duration.html "cpp/chrono/duration").

## Contents

  * [1 Parameters](operator""h.html#Parameters)
  * [2 Return value](operator""h.html#Return_value)
  * [3 Possible implementation](operator""h.html#Possible_implementation)
  * [4 Notes](operator""h.html#Notes)
  * [5 Example](operator""h.html#Example)
  * [6 See also](operator""h.html#See_also)
...
### Possible implementation
    ...
    {
        return [std::chrono::hours](duration.html)(h);
    }
     
    constexpr [std::chrono::duration](duration.html)<long double, ratio<3600,1>> operator""h(long double h)
    {
        return [std::chrono::duration](duration.html)<long double, [std::ratio](../numeric/ratio/ratio.html)<3600,1>>(h);
    }  
...
Run this code
    ...
    int main()
    {
        ...
        auto day = 24h;
        auto halfhour = 0.5h;
        [std::cout](../io/cout.html) << "one day is " << day.count() << " hours (" << day << ")\n"
