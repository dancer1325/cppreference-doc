...
Run this code
    ...
     
        constexpr auto ym{[std::chrono::year](../year.html)(2021)/[std::chrono::July](../month.html)};  
        [std::cout](../../io/cout.html) << (ym.year() == [std::chrono::year](../year.html)(2021)) << ' ';
        [std::cout](../../io/cout.html) << (ym.month() == [std::chrono::month](../month.html)(7)) << '\n';
    }
