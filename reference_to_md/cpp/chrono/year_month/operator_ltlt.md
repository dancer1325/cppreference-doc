...
operator<<( [std::basic_ostream](../../io/basic_ostream.html)<CharT, Traits>& os, const [std::chrono::year_month](../year_month.html)& ym ); |  |  (since C++20)  
| |   
  
Outputs a textual representation of ym into the stream os, as if by 

os << [std::format](../../utility/format/format.html)(os.getloc(), STATICALLY_WIDEN<CharT>("{}/{:L}"), ym.year(), ym.month())
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month/operator_ltlt&action=edit&section=1 "Edit section: Return value")] Return value

os

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month/operator_ltlt&action=edit&section=2 "Edit section: Example")] Example

| This section is incomplete  
Reason: no example   
---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month/operator_ltlt&action=edit&section=3 "Edit section: Defect reports")] Defect reports
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month/operator_ltlt&action=edit&section=4 "Edit section: See also")] See also
...
---|---  
[ std::formatter<std::chrono::year_month>](formatter.html "cpp/chrono/year month/formatter")(C++20) |  formatting support for `year_month`   
