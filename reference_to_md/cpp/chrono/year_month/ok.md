...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month/ok&action=edit&section=1 "Edit section: Return value")] Return value

year().ok() && month().ok()

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year_month/ok&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        constexpr [std::chrono::year_month](../year_month.html) ym1{3030y, [std::chrono::July](../month.html)};
        static_assert(ym1.ok());
     
        constexpr [std::chrono::year_month](../year_month.html) ym2{[std::chrono::year](../year.html)(2020)/16};
