...
---|---|---  
constexpr bool operator==( const [std::chrono::year_month](../year_month.html)& x,  
const [std::chrono::year_month](../year_month.html)& y ) noexcept; |  (1)  |  (since C++20)  
constexpr [std::strong_ordering](../../utility/compare/strong_ordering.html) operator<=>( const [std::chrono::year_month](../year_month.html)& x,  
const [std::chrono::year_month](../year_month.html)& y ) noexcept; |  (2)  |  (since C++20)  
| |   
