...
---|---|---  
template<> struct hash<[std::chrono::year_month](../year_month.html)>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::year_month`](../year_month.html "cpp/chrono/year month") allows users to obtain hashes of objects of type [std::chrono::year_month](../year_month.html). This specialization is [enabled](../../utility/hash.html "cpp/utility/hash"). 
