...
zoned_time() -> zoned_time<[std::chrono::seconds](../duration.html)>; |  (1)  |  (since C++20)  
---|---|---  
template< class Duration >  
zoned_time( [std::chrono::sys_time](../system_clock.html)<Duration> )  
-> zoned_time<[std::common_type_t](../../types/common_type.html)<Duration, [std::chrono::seconds](../duration.html)>>; |  (2)  |  (since C++20)  
template< class TimeZonePtrOrName >  
zoned_time( TimeZonePtrOrName&& ) -> zoned_time<[std::chrono::seconds](../duration.html), /* see below */>; |  (3)  |  (since C++20)  
template< class TimeZonePtrOrName, class Duration >  
zoned_time( TimeZonePtrOrName&&, [std::chrono::sys_time](../system_clock.html)<Duration> )  
-> zoned_time<[std::common_type_t](../../types/common_type.html)<Duration, [std::chrono::seconds](../duration.html)>, /* see below */>; |  (4)  |  (since C++20)  
template< class TimeZonePtrOrName, class Duration >  
zoned_time( TimeZonePtrOrName&&, [std::chrono::local_time](../local_t.html)<Duration>,  
[std::chrono::choose](../choose.html) = std::chrono::choose::earliest )  
-> zoned_time<[std::common_type_t](../../types/common_type.html)<Duration, [std::chrono::seconds](../duration.html)>, /* see below */>; |  (5)  |  (since C++20)  
template< class TimeZonePtrOrName, class Duration, class TimeZonePtr2 >  
zoned_time( TimeZonePtrOrName&&, [std::chrono::zoned_time](../zoned_time.html)<Duration, TimeZonePtr2>,  
[std::chrono::choose](../choose.html) = std::chrono::choose::earliest )  
-> zoned_time<[std::common_type_t](../../types/common_type.html)<Duration, [std::chrono::seconds](../duration.html)>, /* see below */>; |  (6)  |  (since C++20)  
| |   
  
These deduction guides normalize `Duration` to a minimum resolution of [std::chrono::seconds](../duration.html "cpp/chrono/duration"), and provide correct handling for time zone names specified using types convertible to [std::string_view](../../string/basic_string_view.html). 

3-6) If [std::is_convertible_v](../../types/is_convertible.html)<TimeZonePtrOrName, [std::string_view](../../string/basic_string_view.html)> is true, the deduced second template argument is const [std::chrono::time_zone](../time_zone.html)*. Otherwise it is [std::remove_cvref_t](../../types/remove_cvref.html)<TimeZonePtrOrName>.
