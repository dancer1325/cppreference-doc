...
---|---|---  
zoned_time& operator=( const [std::chrono::sys_time](../system_clock.html)<Duration>& other ); |  (2)  |  (since C++20)  
zoned_time& operator=( const [std::chrono::local_time](../local_t.html)<Duration>& other ); |  (3)  |  (since C++20)  
| |   
