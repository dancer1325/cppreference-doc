...
bool operator==( const [std::chrono::zoned_time](../zoned_time.html)<Duration1, TimeZonePtr>& x,  
const [std::chrono::zoned_time](../zoned_time.html)<Duration2, TimeZonePtr>& y ); |  |  (since C++20)  
| |   
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/zoned_time/operator_cmp&action=edit&section=1 "Edit section: Return value")] Return value
