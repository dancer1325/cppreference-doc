...
struct hash<[std::chrono::zoned_time](../zoned_time.html)<Duration, TimeZonePtr>>; |  |  (since C++26)  
| |   
  
The template specialization of [std::hash](../../utility/hash.html "cpp/utility/hash") for [`std::chrono::zoned_time`](../zoned_time.html "cpp/chrono/zoned time") allows users to obtain hashes of objects of type [std::chrono::zoned_time](../zoned_time.html)<Duration, TimeZonePtr>. This specialization is [enabled](../../utility/hash.html "cpp/utility/hash") if and only if both [std::hash](../../utility/hash.html)<Duration> and [std::hash](../../utility/hash.html)<TimeZonePtr> are enabled. 
