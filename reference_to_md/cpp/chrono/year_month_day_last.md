...
Member functions  
---  
[year_month_day_last::year_month_day_last](year_month_day_last/year_month_day_last.html "cpp/chrono/year month day last/year month day last")  
[year_month_day_last::operator+=year_month_day_last::operator-=](year_month_day_last/operator_arith.html "cpp/chrono/year month day last/operator arith")  
[year_month_day_last::yearyear_month_day_last::monthyear_month_day_last::dayyear_month_day_last::month_day_last](year_month_day_last/accessors.html "cpp/chrono/year month day last/accessors")  
[year_month_day_last::operator sys_daysyear_month_day_last::operator local_days](year_month_day_last/operator_days.html "cpp/chrono/year month day last/operator days")  
[year_month_day_last::ok](year_month_day_last/ok.html "cpp/chrono/year month day last/ok")  
Nonmember functions  
[operator==operator<=>](year_month_day_last/operator_cmp.html "cpp/chrono/year month day last/operator cmp")  
[operator+operator-](year_month_day_last/operator_arith_2.html "cpp/chrono/year month day last/operator arith 2")  
[operator<<](year_month_day_last/operator_ltlt.html "cpp/chrono/year month day last/operator ltlt")  
Helper classes  
...
`year_month_day_last` is a [TriviallyCopyable](../named_req/TriviallyCopyable.html "cpp/named req/TriviallyCopyable") [StandardLayoutType](../named_req/StandardLayoutType.html "cpp/named req/StandardLayoutType"). 

## Contents

  * [1 Member functions](year_month_day_last.html#Member_functions)
  * [2 Nonmember functions](year_month_day_last.html#Nonmember_functions)
  * [3 Helper classes](year_month_day_last.html#Helper_classes)
  * [4 Example](year_month_day_last.html#Example)
  * [5 See also](year_month_day_last.html#See_also)
...
Run this code
    ...
    int main()
    {
        const auto ymd = [std::chrono::year_month_day](year_month_day.html)
        {
            [std::chrono::floor](duration/floor.html)<[std::chrono::days](duration.html)>([std::chrono::system_clock::now](system_clock/now.html)())
        };
     
        const std::chrono::year_month_day_last ymdl
        {
            ymd.year(), ymd.month() / [std::chrono::last](last_spec.html)
        };
     
        [std::cout](../io/cout.html) << "The last day of present month (" << ymdl << ") is: "
                  << [std::chrono::year_month_day](year_month_day.html){ymdl}.day() << '\n';
     
