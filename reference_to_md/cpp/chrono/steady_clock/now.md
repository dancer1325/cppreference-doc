...
[`std::chrono::steady_clock`](../steady_clock.html "cpp/chrono/steady clock")
...
static [std::chrono::time_point](../time_point.html)<[std::chrono::steady_clock](../steady_clock.html)> now() noexcept; |  |  (since C++11)  
---|---|---  
| |   
