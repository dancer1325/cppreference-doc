...
---|---|---  
[thrd_t](../thread.html) thrd_current( void ); |  |  (since C11)  
| |   
...
## Contents
  ...
  * [1 Parameters](thrd_current.html#Parameters)
  * [2 Return value](thrd_current.html#Return_value)
  * [3 References](thrd_current.html#References)
  * [4 See also](thrd_current.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/thrd_current&action=edit&section=1 "Edit section: Parameters")] Parameters

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/thrd_current&action=edit&section=2 "Edit section: Return value")] Return value

The identifier of the calling thread. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/thrd_current&action=edit&section=3 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/thrd_current&action=edit&section=4 "Edit section: See also")] See also

[C++ documentation](../../cpp/thread/get_id.html "cpp/thread/get id") for get_id  
---
