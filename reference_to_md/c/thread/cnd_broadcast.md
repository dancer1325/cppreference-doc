...
---|---|---  
int cnd_broadcast( [cnd_t](../thread.html) *cond ); |  |  (since C11)  
| |   
...
## Contents
  ...
  * [1 Parameters](cnd_broadcast.html#Parameters)
  * [2 Return value](cnd_broadcast.html#Return_value)
  * [3 References](cnd_broadcast.html#References)
  * [4 See also](cnd_broadcast.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_broadcast&action=edit&section=1 "Edit section: Parameters")] Parameters

cond  |  \-  |  pointer to a condition variable   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_broadcast&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_broadcast&action=edit&section=3 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_broadcast&action=edit&section=4 "Edit section: See also")] See also

[ cnd_signal](cnd_signal.html "c/thread/cnd signal")(C11) |  unblocks one thread blocked on a condition variable   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/thread/dsc_cnd_signal&action=edit)  
---|---  
[C++ documentation](../../cpp/thread/condition_variable/notify_all.html "cpp/thread/condition variable/notify all") for condition_variable::notify_all  
[C++ documentation](../../cpp/thread/condition_variable_any/notify_all.html "cpp/thread/condition variable any/notify all") for condition_variable_any::notify_all
