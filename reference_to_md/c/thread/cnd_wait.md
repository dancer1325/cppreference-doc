...
---|---|---  
int cnd_wait( [cnd_t](../thread.html)* cond, [mtx_t](../thread.html)* mutex ); |  |  (since C11)  
| |   
  
Atomically unlocks the mutex pointed to by `mutex` and blocks on the condition variable pointed to by `cond` until the thread is signalled by [cnd_signal](cnd_signal.html "c/thread/cnd signal") or [cnd_broadcast](cnd_broadcast.html "c/thread/cnd broadcast"), or until a spurious wake-up occurs. The mutex is locked again before the function returns. 

The behavior is undefined if the mutex is not already locked by the calling thread. 

## Contents

  * [1 Parameters](cnd_wait.html#Parameters)
  * [2 Return value](cnd_wait.html#Return_value)
  * [3 References](cnd_wait.html#References)
  * [4 See also](cnd_wait.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_wait&action=edit&section=1 "Edit section: Parameters")] Parameters

cond  |  \-  |  pointer to the condition variable to block on   
---|---|---  
mutex  |  \-  |  pointer to the mutex to unlock for the duration of the block   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_wait&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_wait&action=edit&section=3 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_wait&action=edit&section=4 "Edit section: See also")] See also

[ cnd_timedwait](cnd_timedwait.html "c/thread/cnd timedwait")(C11) |  blocks on a condition variable, with a timeout   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/thread/dsc_cnd_timedwait&action=edit)  
---|---  
[C++ documentation](../../cpp/thread/condition_variable/wait.html "cpp/thread/condition variable/wait") for condition_variable::wait  
[C++ documentation](../../cpp/thread/condition_variable_any/wait.html "cpp/thread/condition variable any/wait") for condition_variable_any::wait
