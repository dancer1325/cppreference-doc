...
---|---|---  
int cnd_init( [cnd_t](../thread.html)* cond ); |  |  (since C11)  
| |   
...
## Contents
  ...
  * [1 Parameters](cnd_init.html#Parameters)
  * [2 Return value](cnd_init.html#Return_value)
  * [3 References](cnd_init.html#References)
  * [4 See also](cnd_init.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_init&action=edit&section=1 "Edit section: Parameters")] Parameters

cond  |  \-  |  pointer to a variable to store identifier of the condition variable to   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_init&action=edit&section=2 "Edit section: Return value")] Return value

[thrd_success](thrd_errors.html "c/thread/thrd errors") if the condition variable was successfully created. Otherwise returns [thrd_nomem](thrd_errors.html "c/thread/thrd errors") if there was insufficient amount of memory or `thrd_error` if another error occurred. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_init&action=edit&section=3 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_init&action=edit&section=4 "Edit section: See also")] See also

[C++ documentation](../../cpp/thread/condition_variable/condition_variable.html "cpp/thread/condition variable/condition variable") for condition_variable  
---  
[C++ documentation](../../cpp/thread/condition_variable_any/condition_variable_any.html "cpp/thread/condition variable any/condition variable any") for condition_variable_any
