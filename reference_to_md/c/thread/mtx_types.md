...
**mtx_plain mtx_recursivemtx_timed**  
...
When passed to [mtx_init](mtx_init.html "c/thread/mtx init"), identifies the type of a mutex to create. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/mtx_types&action=edit&section=1 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/mtx_types&action=edit&section=2 "Edit section: See also")] See also

[ mtx_init](mtx_init.html "c/thread/mtx init")(C11) |  creates a mutex   
