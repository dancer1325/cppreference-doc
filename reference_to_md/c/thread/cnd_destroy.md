...
---|---|---  
void cnd_destroy( [cnd_t](../thread.html)* cond ); |  |  (since C11)  
| |   
...
## Contents
  ...
  * [1 Parameters](cnd_destroy.html#Parameters)
  * [2 Return value](cnd_destroy.html#Return_value)
  * [3 References](cnd_destroy.html#References)
  * [4 See also](cnd_destroy.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_destroy&action=edit&section=1 "Edit section: Parameters")] Parameters

cond  |  \-  |  pointer to the condition variable to destroy   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_destroy&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_destroy&action=edit&section=3 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_destroy&action=edit&section=4 "Edit section: See also")] See also
