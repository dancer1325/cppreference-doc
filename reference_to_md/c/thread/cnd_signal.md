...
---|---|---  
int cnd_signal( [cnd_t](../thread.html) *cond ); |  |  (since C11)  
| |   
...
## Contents
  ...
  * [1 Parameters](cnd_signal.html#Parameters)
  * [2 Return value](cnd_signal.html#Return_value)
  * [3 References](cnd_signal.html#References)
  * [4 See also](cnd_signal.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_signal&action=edit&section=1 "Edit section: Parameters")] Parameters

cond  |  \-  |  pointer to a condition variable   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_signal&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_signal&action=edit&section=3 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/thread/cnd_signal&action=edit&section=4 "Edit section: See also")] See also

[ cnd_broadcast](cnd_broadcast.html "c/thread/cnd broadcast")(C11) |  unblocks all threads blocked on a condition variable   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/thread/dsc_cnd_broadcast&action=edit)  
---|---  
[C++ documentation](../../cpp/thread/condition_variable/notify_one.html "cpp/thread/condition variable/notify one") for condition_variable::notify_one  
[C++ documentation](../../cpp/thread/condition_variable_any/notify_one.html "cpp/thread/condition variable any/notify one") for condition_variable_any::notify_one
