...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/double&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `double` type](../language/types.html "c/language/types"): as the declaration of the type 
  * [ `long double` type](../language/types.html "c/language/types"): as the declaration of the type when combined with [`long`](long.html "c/keyword/long")
