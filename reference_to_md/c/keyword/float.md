...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/float&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `float` type](../language/types.html "c/language/types"): as the declaration of the type 
