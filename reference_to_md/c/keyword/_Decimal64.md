...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/_Decimal64&action=edit&section=1 "Edit section: Usage")] Usage

  * [`_Decimal64` type](../language/types.html "c/language/types"): as the declaration of the type (since C23)
