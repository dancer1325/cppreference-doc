...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/auto&action=edit&section=1 "Edit section: Usage")] Usage

  * [ automatic duration storage-class specifier](../language/storage_class_specifiers.html "c/language/storage duration") with no linkage. 
