...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/_Bool&action=edit&section=1 "Edit section: Usage")] Usage

  * [boolean type](../language/arithmetic_types.html#Boolean_type "c/language/arithmetic types"): as the declaration of the type (since C99)
