...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/else&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `if` statement](../language/if.html "c/language/if"): as the declaration of the alternative branch 
