...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/thread_local&action=edit&section=1 "Edit section: Usage")] Usage

  * [thread storage-class specifier](../language/storage_class_specifiers.html "c/language/storage duration") (since C23)
