...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/do&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `do-while` loop](../language/do.html "c/language/do"): as the declaration of the loop 
