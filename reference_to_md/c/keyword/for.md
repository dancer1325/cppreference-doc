...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/for&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `for` loop](../language/for.html "c/language/for"): as the declaration of the loop 
