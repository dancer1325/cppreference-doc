...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/while&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `while` loop](../language/while.html "c/language/while"): as the declaration of the loop 
  * [ `do-while` loop](../language/do.html "c/language/do"): as the declaration of the terminating condition of the loop 
