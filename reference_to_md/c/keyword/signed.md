...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/signed&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `signed` type modifier](../language/types.html "c/language/types")
