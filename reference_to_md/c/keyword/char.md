...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/char&action=edit&section=1 "Edit section: Usage")] Usage

  * _type specifier_ for the [ character types](../language/arithmetic_types.html#Character_types "c/language/arithmetic types") (`char`, `signed char`, and `unsigned char`). 
