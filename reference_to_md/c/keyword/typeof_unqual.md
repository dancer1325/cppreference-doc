...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/typeof_unqual&action=edit&section=1 "Edit section: Usage")] Usage

  * [`typeof` operator](../language/typeof_unqual.html "c/language/typeof") that removes qualifiers (since C23)
