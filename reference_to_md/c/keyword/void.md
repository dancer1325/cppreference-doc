...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/void&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `void` type](../language/types.html "c/language/types"): as the declaration of the incomplete type 
  * [ `void`](../language/function_declaration.html "c/language/function declaration"): in a function with no parameter or no return value 
