...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/switch&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `switch` statement](../language/switch.html "c/language/switch"): as the declaration of the statement 
