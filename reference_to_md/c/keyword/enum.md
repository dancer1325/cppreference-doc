...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/enum&action=edit&section=1 "Edit section: Usage")] Usage

  * [ declaration of an enumeration type](../language/enum.html "c/language/enum")
