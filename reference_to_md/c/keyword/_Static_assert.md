...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/_Static_assert&action=edit&section=1 "Edit section: Usage")] Usage

  * [static assert declaration](../language/static_assert.html "c/language/ Static assert") (since C11)(deprecated in C23)
