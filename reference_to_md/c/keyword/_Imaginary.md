...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/_Imaginary&action=edit&section=1 "Edit section: Usage")] Usage

  * [imaginary floating type](../language/arithmetic_types.html#Imaginary_floating_types "c/language/arithmetic types") specifier (since C99)
