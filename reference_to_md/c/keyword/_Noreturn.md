...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/_Noreturn&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `_Noreturn` function specifier](../language/noreturn.html "c/language/ Noreturn") (deprecated in C23)
  * [ `_Noreturn` attribute-token](../language/attributes/noreturn.html "c/language/attributes/noreturn") (since C23)(deprecated in C23)



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/_Noreturn&action=edit&section=2 "Edit section: Notes")] Notes

Since C23, `_Noreturn` is also [attribute token](../language/attributes/noreturn.html "c/language/attributes/noreturn"). Its usage is deprecated and `noreturn` should be used instead. 
