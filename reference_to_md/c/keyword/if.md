...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/if&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `if` statement](../language/if.html "c/language/if"): as the declaration of the `if` statement 
