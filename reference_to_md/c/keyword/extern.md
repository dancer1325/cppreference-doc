...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/extern&action=edit&section=1 "Edit section: Usage")] Usage

  * [ static duration storage-class specifier](../language/storage_class_specifiers.html "c/language/storage duration") with either internal or more usually external linkage. 
