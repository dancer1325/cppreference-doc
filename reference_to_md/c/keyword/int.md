...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/keyword/int&action=edit&section=1 "Edit section: Usage")] Usage

  * [ `int` type](../language/types.html "c/language/types"): as the declaration of the type 
