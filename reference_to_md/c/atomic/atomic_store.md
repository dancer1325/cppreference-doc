...
void atomic_store_explicit( volatile A* obj, C desired, [memory_order](memory_order.html) order ); |  (2)  |  (since C11)  
| |   
...
The first version orders memory accesses according to [memory_order_seq_cst](memory_order.html "c/atomic/memory order"), the second version orders memory accesses according to `order`. `order` must be one of [memory_order_relaxed](memory_order.html "c/atomic/memory order"), [memory_order_release](memory_order.html "c/atomic/memory order") or [memory_order_seq_cst](memory_order.html "c/atomic/memory order"). Otherwise the behavior is undefined. 
...
## Contents
  ...
  * [3 References](atomic_store.html#References)
  * [4 See also](atomic_store.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/atomic/atomic_store&action=edit&section=1 "Edit section: Parameters")] Parameters

obj  |  \-  |  pointer to the atomic object to modify   
---|---|---  
order  |  \-  |  the memory synchronization ordering for this operation   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/atomic/atomic_store&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/atomic/atomic_store&action=edit&section=3 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/atomic/atomic_store&action=edit&section=4 "Edit section: See also")] See also

[ atomic_loadatomic_load_explicit](atomic_load.html "c/atomic/atomic load")(C11) |  reads a value from an atomic object   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/atomic/dsc_atomic_load&action=edit)  
---|---  
[C++ documentation](../../cpp/atomic/atomic_store.html "cpp/atomic/atomic store") for atomic_store, atomic_store_explicit
