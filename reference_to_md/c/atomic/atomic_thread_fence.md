...
---|---|---  
void atomic_thread_fence( [memory_order](memory_order.html) order ); |  |  (since C11)  
| |   
  
Establishes memory synchronization ordering of non-atomic and relaxed atomic accesses, as instructed by `order`, without an associated atomic operation. For example, all non-atomic and relaxed atomic stores that happen before a [memory_order_release](memory_order.html "c/atomic/memory order") fence in thread A will be synchronized with non-atomic and relaxed atomic loads from the same locations made in thread B after an [memory_order_acquire](memory_order.html "c/atomic/memory order") fence. 

## Contents

  * [1 Parameters](atomic_thread_fence.html#Parameters)
  * [2 Return value](atomic_thread_fence.html#Return_value)
  * [3 References](atomic_thread_fence.html#References)
  * [4 See also](atomic_thread_fence.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/atomic/atomic_thread_fence&action=edit&section=1 "Edit section: Parameters")] Parameters

order  |  \-  |  the memory ordering executed by this fence   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/atomic/atomic_thread_fence&action=edit&section=2 "Edit section: Return value")] Return value

(none) 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/atomic/atomic_thread_fence&action=edit&section=3 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/atomic/atomic_thread_fence&action=edit&section=4 "Edit section: See also")] See also

[ atomic_signal_fence](atomic_signal_fence.html "c/atomic/atomic signal fence")(C11) |  fence between a thread and a signal handler executed in the same thread   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/atomic/dsc_atomic_signal_fence&action=edit)  
---|---  
[C++ documentation](../../cpp/atomic/atomic_thread_fence.html "cpp/atomic/atomic thread fence") for atomic_thread_fence
