...
This header provides a convenience macro [`noreturn`](../language/noreturn.html "c/language/noreturn"), that specifies that the function does not return to its point of invocation. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/header/stdnoreturn&action=edit&section=1 "Edit section: Synopsis")] Synopsis
