...
1-3) Computes the floating-point remainder of the division operation x/y as the [remainder()](remainder.html "c/numeric/math/remainder") function does. Additionally, the sign and at least the three of the last bits of x/y will be stored in quo, sufficient to determine the octant of the result within a period.
...
## Contents
  ...
  * [1 Parameters](remquo.html#Parameters)
  * [2 Return value](remquo.html#Return_value)
  * [3 Error handling](remquo.html#Error_handling)
  * [4 Notes](remquo.html#Notes)
  * [5 Example](remquo.html#Example)
  * [6 References](remquo.html#References)
  * [7 See also](remquo.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remquo&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  floating-point values   
---|---|---  
quo  |  \-  |  pointer to an integer value to store the sign and some bits of x/y  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remquo&action=edit&section=2 "Edit section: Return value")] Return value

If successful, returns the floating-point remainder of the division x/y as defined in [remainder](remainder.html "c/numeric/math/remainder"), and stores, in *quo, the sign and at least three of the least significant bits of x/y (formally, stores a value whose sign is the sign of x/y and whose magnitude is congruent modulo 2n  
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remquo&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remquo&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remquo&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    double cos_pi_x_smart(double x)
    {
        ...
        return extremum ? -[cos](cos.html)(pi * rem) : [cos](cos.html)(pi * rem);
    }
     
    int main(void)
    {
        [printf](../../io/fprintf.html)("cos(pi * 0.25) = %f\n", cos_pi_x_naive(0.25));
        [printf](../../io/fprintf.html)("cos(pi * 1.25) = %f\n", cos_pi_x_naive(1.25));
        [printf](../../io/fprintf.html)("cos(pi * 1000000000000.25) = %f\n", cos_pi_x_naive(1000000000000.25));
        [printf](../../io/fprintf.html)("cos(pi * 1000000000001.25) = %f\n", cos_pi_x_naive(1000000000001.25));
    ...
     
        ...
        int quo;
        [printf](../../io/fprintf.html)("remquo(+Inf, 1) = %.1f\n", remquo(INFINITY, 1, &quo));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remquo&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remquo&action=edit&section=7 "Edit section: See also")] See also
...
---|---  
[ fmodfmodffmodl](fmod.html "c/numeric/math/fmod")(C99)(C99) |  computes remainder of the floating-point division operation   
...
[C++ documentation](../../../cpp/numeric/math/remquo.html "cpp/numeric/math/remquo") for remquo
