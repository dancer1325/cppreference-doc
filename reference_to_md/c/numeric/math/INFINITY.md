...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/INFINITY&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    {
        double f = INFINITY;
        [uint64_t](../../types/integer.html) fn; [memcpy](../../string/byte/memcpy.html)(&fn, &f, sizeof f);
        [printf](../../io/fprintf.html)("INFINITY:   %f %" [PRIx64](../../types/integer.html) "\n", f, fn);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/INFINITY&action=edit&section=2 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/INFINITY&action=edit&section=3 "Edit section: See also")] See also
...
---|---  
[ HUGE_VALFHUGE_VALHUGE_VALL](HUGE_VALL.html "c/numeric/math/HUGE VAL")(C99)(C99) |  indicates value too big to be representable (infinity) by float, double and long double respectively   
(macro constant) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_HUGE_VAL&action=edit)  
[C++ documentation](../../../cpp/numeric/math/INFINITY.html "cpp/numeric/math/INFINITY") for INFINITY
