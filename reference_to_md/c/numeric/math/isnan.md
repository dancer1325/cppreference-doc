...
## Contents
  ...
  * [1 Parameters](isnan.html#Parameters)
  * [2 Return value](isnan.html#Return_value)
  * [3 Notes](isnan.html#Notes)
  * [4 Example](isnan.html#Example)
  * [5 References](isnan.html#References)
  * [6 See also](isnan.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnan&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnan&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if arg is a NaN, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnan&action=edit&section=3 "Edit section: Notes")] Notes

There are many different NaN values with different sign bits and payloads, see [nan](nan.html "c/numeric/math/nan"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnan&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("isnan(NAN)         = %d\n", isnan(NAN));
        [printf](../../io/fprintf.html)("isnan(INFINITY)    = %d\n", isnan(INFINITY));
        [printf](../../io/fprintf.html)("isnan(0.0)         = %d\n", isnan(0.0));
        [printf](../../io/fprintf.html)("isnan(DBL_MIN/2.0) = %d\n", isnan([DBL_MIN](../../types/limits.html) / 2.0));
        [printf](../../io/fprintf.html)("isnan(0.0 / 0.0)   = %d\n", isnan(0.0 / 0.0));
        [printf](../../io/fprintf.html)("isnan(Inf - Inf)   = %d\n", isnan(INFINITY - INFINITY));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnan&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnan&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[ fpclassify](fpclassify.html "c/numeric/math/fpclassify")(C99) |  classifies the given floating-point value   
...
[ isunordered](isunordered.html "c/numeric/math/isunordered")(C99) |  checks if two floating-point values are unordered   
(function macro) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_isunordered&action=edit)  
[C++ documentation](../../../cpp/numeric/math/isnan.html "cpp/numeric/math/isnan") for isnan
