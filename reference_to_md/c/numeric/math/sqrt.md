...
4) Type-generic macro: If arg has type long double, `sqrtl` is called. Otherwise, if arg has integer type or the type double, `sqrt` is called. Otherwise, `sqrtf` is called. If arg is complex or imaginary, then the macro invokes the corresponding complex function ([csqrtf](../complex/csqrt.html), [csqrt](../complex/csqrt.html), [csqrtl](../complex/csqrt.html)).

## Contents

  * [1 Parameters](sqrt.html#Parameters)
  * [2 Return value](sqrt.html#Return_value)
  * [3 Error handling](sqrt.html#Error_handling)
  * [4 Notes](sqrt.html#Notes)
  * [5 Example](sqrt.html#Example)
  * [6 References](sqrt.html#References)
  * [7 See also](sqrt.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sqrt&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sqrt&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sqrt&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If the argument is less than -0, [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised and NaN is returned. 
  * If the argument is +∞ or ±0, it is returned, unmodified. 
  * If the argument is NaN, NaN is returned. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sqrt&action=edit&section=4 "Edit section: Notes")] Notes

`sqrt` is required by the IEEE standard to be correctly rounded from the infinitely precise result. In particular, the exact result is produced if it can be represented in the floating-point type. The only other operations which require this are the [arithmetic operators](../../language/operator_arithmetic.html "c/language/operator arithmetic") and the function [fma](fma.html "c/numeric/math/fma"). Other functions, including [pow](pow.html "c/numeric/math/pow"), are not so constrained. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sqrt&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        // normal use
        [printf](../../io/fprintf.html)("sqrt(100) = %f\n", sqrt(100));
        [printf](../../io/fprintf.html)("sqrt(2) = %f\n", sqrt(2));
        [printf](../../io/fprintf.html)("golden ratio = %f\n", (1 + sqrt(5)) / 2);
     
        // special values
        [printf](../../io/fprintf.html)("sqrt(-0) = %f\n", sqrt(-0.0));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("sqrt(-1.0) = %f\n", sqrt(-1));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sqrt&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sqrt&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/sqrt.html "cpp/numeric/math/sqrt") for sqrt
