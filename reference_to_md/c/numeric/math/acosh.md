...
## Contents
  ...
  * [5 Example](acosh.html#Example)
  * [6 References](acosh.html#References)
  * [7 See also](acosh.html#See_also)
  * [8 External links](acosh.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acosh&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value representing the area of a hyperbolic sector   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acosh&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acosh&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If the argument is less than 1, [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised an NaN is returned. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acosh&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acosh&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("acosh(1) = %f\nacosh(10) = %f\n", acosh(1), acosh(10));
        [printf](../../io/fprintf.html)("acosh(DBL_MAX) = %f\nacosh(Inf) = %f\n", acosh([DBL_MAX](../../types/limits.html)), acosh(INFINITY));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("acosh(0.5) = %f\n", acosh(0.5));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acosh&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acosh&action=edit&section=7 "Edit section: See also")] See also
...
---|---  
[ atanhatanhfatanhl](atanh.html "c/numeric/math/atanh")(C99)(C99)(C99) |  computes inverse hyperbolic tangent (\\({\small\operatorname{artanh}{x} }\\)artanh(x))   
...
[C++ documentation](../../../cpp/numeric/math/acosh.html "cpp/numeric/math/acosh") for acosh  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acosh&action=edit&section=8 "Edit section: External links")] External links
