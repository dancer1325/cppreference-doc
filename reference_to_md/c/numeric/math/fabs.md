...
1-6) Computes the absolute value of a floating-point value arg.  The functions with decimal floating-point parameters are declared if and only if the implementation predefines `__STDC_IEC_60559_DFP__` (i.e. the implementation supports decimal floating-point numbers).  | (since C23)  
---|---  
  
7) Type-generic macro: If the argument has type _Decimal128, _Decimal64, _Decimal32,(since C23)long double, double, or float, `fabsd128`, `fabsd64`, `fabsd32`,(since C23)`fabsl`, `fabs`, or `fabsf` is called, respectively. Otherwise, if the argument has integer type, `fabs` is called. Otherwise, if the argument is complex, then the macro invokes the corresponding complex function ([cabsf](../complex/cabs.html "c/numeric/complex/cabs"), [cabs](../complex/cabs.html "c/numeric/complex/cabs"), [cabsl](../complex/cabs.html "c/numeric/complex/cabs")). Otherwise, the behavior is undefined.
...
## Contents
  ...
  * [4 Example](fabs.html#Example)
  * [5 References](fabs.html#References)
  * [6 See also](fabs.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fabs&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
arith  |  \-  |  floating-point or integer value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fabs&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fabs&action=edit&section=3 "Edit section: Error handling")] Error handling

This function is not subject to any of the error conditions specified in [`math_errhandling`](math_errhandling.html "c/numeric/math/math errhandling"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fabs&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("fabs(+3) = %f\n", fabs(+3.0));
        [printf](../../io/fprintf.html)("fabs(-3) = %f\n", fabs(-3.0));
        // special values
        [printf](../../io/fprintf.html)("fabs(-0) = %f\n", fabs(-0.0));
        [printf](../../io/fprintf.html)("fabs(-Inf) = %f\n", fabs(-INFINITY));
     
        [printf](../../io/fprintf.html)("Area under sin(x) in [-PI, PI] = %f\n", integrate([sin](sin.html), -PI, PI, 5101));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fabs&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fabs&action=edit&section=6 "Edit section: See also")] See also

[ abslabsllabs](abs.html "c/numeric/math/abs")(C99) |  computes absolute value of an integral value (\\(\small{|x|}\\)|x|)   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_abs&action=edit)  
---|---  
[ copysigncopysignfcopysignl](copysign.html "c/numeric/math/copysign")(C99)(C99)(C99) |  produces a value with the magnitude of a given value and the sign of another given value   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_copysign&action=edit)  
[ signbit](signbit.html "c/numeric/math/signbit")(C99) |  checks if the given number is negative   
...
[C++ documentation](../../../cpp/numeric/math/fabs.html "cpp/numeric/math/fabs") for fabs
