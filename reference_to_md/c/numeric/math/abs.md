...
[intmax_t](../../types/integer.html) imaxabs( [intmax_t](../../types/integer.html) n ); |  |  (since C99)  
| |   
...
## Contents
  ...
  * [5 References](abs.html#References)
  * [6 See also](abs.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/abs&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  integer value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/abs&action=edit&section=2 "Edit section: Return value")] Return value

The absolute value of n (i.e. `|n|`), if it is representable. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/abs&action=edit&section=3 "Edit section: Notes")] Notes

In 2's complement systems, the absolute value of the most-negative value is out of range, e.g. for 32-bit 2's complement type int, [INT_MIN](../../types/limits.html "c/types/limits") is -2147483648, but the would-be result 2147483648 is greater than [INT_MAX](../../types/limits.html "c/types/limits"), which is 2147483647. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/abs&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("abs(+3) = %d\n", abs(+3));
        [printf](../../io/fprintf.html)("abs(-3) = %d\n", abs(-3));
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/abs&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/abs&action=edit&section=6 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/abs.html "cpp/numeric/math/abs") for abs
