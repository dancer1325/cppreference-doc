...
The value computed by this function is the length of the hypotenuse of a right-angled triangle with sides of length x and y, or the distance of the point (x, y) from the origin (0, 0), or the magnitude of a complex number `x+_i_ y`. 

## Contents

  * [1 Parameters](hypot.html#Parameters)
  * [2 Return value](hypot.html#Return_value)
  * [3 Error handling](hypot.html#Error_handling)
  * [4 Notes](hypot.html#Notes)
  * [5 Example](hypot.html#Example)
  * [6 References](hypot.html#References)
  * [7 See also](hypot.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/hypot&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  floating-point value   
---|---|---  
y  |  \-  |  floating-point value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/hypot&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/hypot&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * if one of the arguments is ±0, `hypot` is equivalent to [fabs](fabs.html) called with the non-zero argument 
  * if one of the arguments is ±∞, `hypot` returns +∞ even if the other argument is NaN 
  * otherwise, if any of the arguments is NaN, NaN is returned. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/hypot&action=edit&section=4 "Edit section: Notes")] Notes

Implementations usually guarantee precision of less than 1 ulp ([units in the last place](https://en.wikipedia.org/wiki/Unit_in_the_last_place "enwiki:Unit in the last place")): [GNU](https://sourceware.org/git/?p=glibc.git;a=blob_plain;f=sysdeps/ieee754/dbl-64/e_hypot.c), [BSD](https://www.freebsd.org/cgi/cvsweb.cgi/src/lib/msun/src/e_hypot.c). 

hypot(x, y) is equivalent to [cabs](../complex/cabs.html)(x + I*y). 
...
hypot(INFINITY, NAN) returns +∞, but [sqrt](sqrt.html)(INFINITY * INFINITY + NAN * NAN) returns NaN. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/hypot&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        // typical usage
        [printf](../../io/fprintf.html)("(1,1) cartesian is (%f,%f) polar\n", hypot(1,1), [atan2](atan2.html)(1, 1));
     
        // special values
        [printf](../../io/fprintf.html)("hypot(NAN,INFINITY) = %f\n", hypot(NAN, INFINITY));
     
        // error handling
        errno = 0;
        [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("hypot(DBL_MAX,DBL_MAX) = %f\n", hypot([DBL_MAX](../../types/limits.html), [DBL_MAX](../../types/limits.html)));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/hypot&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/hypot&action=edit&section=7 "Edit section: See also")] See also

[ powpowfpowl](pow.html "c/numeric/math/pow")(C99)(C99) |  computes a number raised to the given power (\\(\small{x^y}\\)xy)   
...
[C++ documentation](../../../cpp/numeric/math/hypot.html "cpp/numeric/math/hypot") for hypot
