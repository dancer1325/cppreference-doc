...
---|---|---  
float scalbnf( float arg, int [exp](exp.html) ); |  (1)  |  (since C99)  
double scalbn( double arg, int [exp](exp.html) ); |  (2)  |  (since C99)  
long double scalbnl( long double arg, int [exp](exp.html) ); |  (3)  |  (since C99)  
Defined in header `[`<tgmath.h>`](../../header/tgmath.html "c/header/tgmath")` |  |   
#define scalbn( arg, exp ) |  (4)  |  (since C99)  
Defined in header `[`<math.h>`](../../header/math.html "c/header/math")` |  |   
float scalblnf( float arg, long [exp](exp.html) ); |  (5)  |  (since C99)  
double scalbln( double arg, long [exp](exp.html) ); |  (6)  |  (since C99)  
long double scalblnl( long double arg, long [exp](exp.html) ); |  (7)  |  (since C99)  
Defined in header `[`<tgmath.h>`](../../header/tgmath.html "c/header/tgmath")` |  |   
#define scalbln( arg, exp ) |  (8)  |  (since C99)  
| |   
  
1-3,5-7) Multiplies a floating-point value arg by [FLT_RADIX](../../types/limits.html "c/types/limits") raised to power [exp](exp.html).
...
## Contents
  ...
  * [1 Parameters](scalbn.html#Parameters)
  * [2 Return value](scalbn.html#Return_value)
  * [3 Error handling](scalbn.html#Error_handling)
  * [4 Notes](scalbn.html#Notes)
  * [5 Example](scalbn.html#Example)
  * [6 References](scalbn.html#References)
  * [7 See also](scalbn.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/scalbn&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
exp  |  \-  |  integer value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/scalbn&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, arg multiplied by [FLT_RADIX](../../types/limits.html "c/types/limits") to the power of [exp](exp.html) (arg×FLT_RADIXexp  
) is returned. 

If a range error due to overflow occurs, ±[HUGE_VAL](HUGE_VAL.html), `±HUGE_VALF`, or `±HUGE_VALL` is returned. 

If a range error due to underflow occurs, the correct result (after rounding) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/scalbn&action=edit&section=3 "Edit section: Error handling")] Error handling

Errors are reported as specified in [`math_errhandling`](math_errhandling.html "c/numeric/math/math errhandling"). 

If the implementation supports IEEE floating-point arithmetic (IEC 60559), 

  * Unless a range error occurs, [FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is never raised (the result is exact). 
  * Unless a range error occurs, the [current rounding mode](../fenv/FE_round.html "c/numeric/fenv/FE round") is ignored. 
  * If arg is ±0, it is returned, unmodified. 
  * If arg is ±∞, it is returned, unmodified. 
  * If [exp](exp.html) is 0, then `arg` is returned, unmodified. 
  * If arg is NaN, NaN is returned. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/scalbn&action=edit&section=4 "Edit section: Notes")] Notes

On binary systems (where [FLT_RADIX](../../types/limits.html "c/types/limits") is `2`), `scalbn` is equivalent to [ldexp](ldexp.html "c/numeric/math/ldexp"). 
...
The `scalbln` function is provided because the factor required to scale from the smallest positive floating-point value to the largest finite one may be greater than 32767, the standard-guaranteed [INT_MAX](../../types/limits.html "c/types/limits"). In particular, for the 80-bit long double, the factor is 32828. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/scalbn&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("scalbn(7, -4) = %f\n", scalbn(7, -4));
        [printf](../../io/fprintf.html)("scalbn(1, -1074) = %g (minimum positive subnormal double)\n",
                scalbn(1, -1074));
        [printf](../../io/fprintf.html)("scalbn(nextafter(1,0), 1024) = %g (largest finite double)\n",
                scalbn([nextafter](nexttoward.html)(1,0), 1024));
     
        // special values
        [printf](../../io/fprintf.html)("scalbn(-0, 10) = %f\n", scalbn(-0.0, 10));
        [printf](../../io/fprintf.html)("scalbn(-Inf, -1) = %f\n", scalbn(-INFINITY, -1));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("scalbn(1, 1024) = %f\n", scalbn(1, 1024));
        if (errno == [ERANGE](../../error/errno_macros.html))
            [perror](../../io/perror.html)("    errno == ERANGE");
        if ([fetestexcept](../fenv/fetestexcept.html)([FE_OVERFLOW](../fenv/FE_exceptions.html)))
            [puts](../../io/puts.html)("    FE_OVERFLOW raised");
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/scalbn&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/scalbn&action=edit&section=7 "Edit section: See also")] See also

[ frexpfrexpffrexpl](frexp.html "c/numeric/math/frexp")(C99)(C99) |  breaks a number into significand and a power of 2   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_frexp&action=edit)  
---|---  
[ ldexpldexpfldexpl](ldexp.html "c/numeric/math/ldexp")(C99)(C99) |  multiplies a number by 2 raised to a power   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_ldexp&action=edit)  
[C++ documentation](../../../cpp/numeric/math/scalbn.html "cpp/numeric/math/scalbn") for scalbn
