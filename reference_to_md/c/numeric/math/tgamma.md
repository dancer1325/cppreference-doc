...
## Contents
  ...
  * [1 Parameters](tgamma.html#Parameters)
  * [2 Return value](tgamma.html#Return_value)
  * [3 Error handling](tgamma.html#Error_handling)
  * [4 Notes](tgamma.html#Notes)
  * [5 Example](tgamma.html#Example)
  * [6 References](tgamma.html#References)
  * [7 See also](tgamma.html#See_also)
  * [8 External links](tgamma.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tgamma&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tgamma&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tgamma&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559): 
  ...
  * If the argument is ±0, ±∞ is returned and [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised. 
  * If the argument is a negative integer, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tgamma&action=edit&section=4 "Edit section: Notes")] Notes
...
For IEEE-compatible type double, overflow happens if 0 < x < 1/[DBL_MAX](../../types/limits.html) or if x > 171.7. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tgamma&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("tgamma(10) = %f, 9!=%f\n", tgamma(10), 2 * 3 * 4 * 5 * 6 * 7 * 8 * 9.0);
        [printf](../../io/fprintf.html)("tgamma(0.5) = %f, sqrt(pi) = %f\n", tgamma(0.5), [sqrt](sqrt.html)([acos](acos.html)(-1)));
     
        // special values
        [printf](../../io/fprintf.html)("tgamma(+Inf) = %f\n", tgamma(INFINITY));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("tgamma(-1) = %f\n", tgamma(-1));
        if (errno == [ERANGE](../../error/errno_macros.html))
            [perror](../../io/perror.html)("    errno == ERANGE");
        else
            if (errno == [EDOM](../../error/errno_macros.html))   [perror](../../io/perror.html)("    errno == EDOM");
        if ([fetestexcept](../fenv/fetestexcept.html)([FE_DIVBYZERO](../fenv/FE_exceptions.html)))
            [puts](../../io/puts.html)("    FE_DIVBYZERO raised");
        else if ([fetestexcept](../fenv/fetestexcept.html)([FE_INVALID](../fenv/FE_exceptions.html)))
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tgamma&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tgamma&action=edit&section=7 "Edit section: See also")] See also

[ lgammalgammaflgammal](lgamma.html "c/numeric/math/lgamma")(C99)(C99)(C99) |  computes natural (base-_e_) logarithm of the gamma function   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_lgamma&action=edit)  
---|---  
[C++ documentation](../../../cpp/numeric/math/tgamma.html "cpp/numeric/math/tgamma") for tgamma  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tgamma&action=edit&section=8 "Edit section: External links")] External links
