...
## Contents
  ...
  * [1 Parameters](isunordered.html#Parameters)
  * [2 Return value](isunordered.html#Return_value)
  * [3 Example](isunordered.html#Example)
  * [4 References](isunordered.html#References)
  * [5 See also](isunordered.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isunordered&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  floating point value   
---|---|---  
y  |  \-  |  floating point value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isunordered&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if either x or y is NaN, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isunordered&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("isunordered(NAN,1.0) = %d\n", isunordered(NAN, 1.0));
        [printf](../../io/fprintf.html)("isunordered(1.0,NAN) = %d\n", isunordered(1.0, NAN));
        [printf](../../io/fprintf.html)("isunordered(NAN,NAN) = %d\n", isunordered(NAN, NAN));
        [printf](../../io/fprintf.html)("isunordered(1.0,0.0) = %d\n", isunordered(1.0, 0.0));
     
        return 0;
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isunordered&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isunordered&action=edit&section=5 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/isunordered.html "cpp/numeric/math/isunordered") for isunordered
