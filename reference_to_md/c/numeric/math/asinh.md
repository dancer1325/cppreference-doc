...
4) Type-generic macro: If the argument has type long double, `asinhl` is called. Otherwise, if the argument has integer type or the type double, `asinh` is called. Otherwise, `asinhf` is called. If the argument is complex, then the macro invokes the corresponding complex function ([casinhf](../complex/casinh.html "c/numeric/complex/casinh"), [casinh](../complex/casinh.html "c/numeric/complex/casinh"), [casinhl](../complex/casinh.html "c/numeric/complex/casinh")).

## Contents

  * [1 Parameters](asinh.html#Parameters)
  * [2 Return value](asinh.html#Return_value)
  * [3 Error handling](asinh.html#Error_handling)
  * [4 Notes](asinh.html#Notes)
  * [5 Example](asinh.html#Example)
  * [6 References](asinh.html#References)
  * [7 See also](asinh.html#See_also)
  * [8 External links](asinh.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asinh&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value representing the area of a hyperbolic sector   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asinh&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asinh&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asinh&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asinh&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("asinh(1) = %f\nasinh(-1) = %f\n", asinh(1), asinh(-1));
        // special values
        [printf](../../io/fprintf.html)("asinh(+0) = %f\nasinh(-0) = %f\n", asinh(0.0), asinh(-0.0));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asinh&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asinh&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/asinh.html "cpp/numeric/math/asinh") for asinh  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asinh&action=edit&section=8 "Edit section: External links")] External links
