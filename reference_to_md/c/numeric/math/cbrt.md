...
## Contents
  ...
  * [1 Parameters](cbrt.html#Parameters)
  * [2 Return value](cbrt.html#Return_value)
  * [3 Error handling](cbrt.html#Error_handling)
  * [4 Notes](cbrt.html#Notes)
  * [5 Example](cbrt.html#Example)
  * [6 References](cbrt.html#References)
  * [7 See also](cbrt.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cbrt&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cbrt&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the cube root of `arg` (\\(\small{\sqrt[3]{arg} }\\)3√arg), is returned. 

If a range error occurs due to underflow, the correct result (after rounding) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cbrt&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cbrt&action=edit&section=4 "Edit section: Notes")] Notes

cbrt(arg) is not equivalent to [pow](pow.html)(arg, 1.0/3) because the rational number \\(\small{\frac1{3} }\\)1  
---  
3  
is typically not equal to 1.0/3 and std::pow cannot raise a negative base to a fractional exponent. Moreover, cbrt(arg) usually gives more accurate results than [pow](pow.html)(arg, 1.0/3) (see example). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cbrt&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("Normal use:\n"
               "cbrt(729)      = %f\n", cbrt(729));
        [printf](../../io/fprintf.html)("cbrt(-0.125)   = %f\n", cbrt(-0.125));
        [printf](../../io/fprintf.html)("Special values:\n"
               "cbrt(-0)       = %f\n", cbrt(-0.0));
        [printf](../../io/fprintf.html)("cbrt(+inf)     = %f\n", cbrt(INFINITY));
        [printf](../../io/fprintf.html)("Accuracy:\n"
               "cbrt(343)      = %.*f\n", DBL_DECIMAL_DIG, cbrt(343));
        [printf](../../io/fprintf.html)("pow(343,1.0/3) = %.*f\n", DBL_DECIMAL_DIG, [pow](pow.html)(343, 1.0/3));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cbrt&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cbrt&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/cbrt.html "cpp/numeric/math/cbrt") for cbrt
