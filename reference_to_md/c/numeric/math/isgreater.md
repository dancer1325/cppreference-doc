...
## Contents
  ...
  * [1 Parameters](isgreater.html#Parameters)
  * [2 Return value](isgreater.html#Return_value)
  * [3 Notes](isgreater.html#Notes)
  * [4 Example](isgreater.html#Example)
  * [5 References](isgreater.html#References)
  * [6 See also](isgreater.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreater&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  floating-point value   
---|---|---  
y  |  \-  |  floating-point value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreater&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if x > y, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreater&action=edit&section=3 "Edit section: Notes")] Notes

The built-in operator> for floating-point numbers may set [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") if one or both of the arguments is NaN. This function is a "quiet" version of operator>. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreater&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("isgreater(2.0,1.0)      = %d\n", isgreater(2.0, 1.0));
        [printf](../../io/fprintf.html)("isgreater(1.0,2.0)      = %d\n", isgreater(1.0, 2.0));
        [printf](../../io/fprintf.html)("isgreater(INFINITY,1.0) = %d\n", isgreater(INFINITY, 1.0));
        [printf](../../io/fprintf.html)("isgreater(1.0,NAN)      = %d\n", isgreater(1.0, NAN));
     
        return 0;
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreater&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreater&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/numeric/math/isgreater.html "cpp/numeric/math/isgreater") for isgreater
