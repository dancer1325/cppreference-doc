...
## Contents
  ...
  * [1 Parameters](sinpi.html#Parameters)
  * [2 Return value](sinpi.html#Return_value)
  * [3 Error handling](sinpi.html#Error_handling)
  * [4 Example](sinpi.html#Example)
  * [5 References](sinpi.html#References)
  * [6 See also](sinpi.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinpi&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value whose product with `π` represents an angle in radians   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinpi&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the sine of `π·arg` (sin(π×arg)) in the range [-1, +1], is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinpi&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinpi&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    {
        return [sin](sin.html)(arg * (double)3.1415926535897932384626433);
    }
    #endif
     
    int main(void)
    ...
     
        // typical usage
        [printf](../../io/fprintf.html)("sinpi(1) = %f, sin(pi) = %f\n", sinpi(1), [sin](sin.html)(pi));
        [printf](../../io/fprintf.html)("sinpi(0.5) = %f, sin(pi/2) = %f\n", sinpi(0.5), [sin](sin.html)(pi / 2));
        [printf](../../io/fprintf.html)("sinpi(-0.75) = %f, sin(-3*pi/4) = %f\n", sinpi(-0.75), [sin](sin.html)(-3 * pi / 4));
     
        // special values
        [printf](../../io/fprintf.html)("sinpi(+0) = %f\n", sinpi(0.0));
        [printf](../../io/fprintf.html)("sinpi(-0) = %f\n", sinpi(-0.0));
     
        // error handling
        [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("sinpi(INFINITY) = %f\n", sinpi(INFINITY));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinpi&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinpi&action=edit&section=6 "Edit section: See also")] See also
