...
The types float_t and double_t are floating types at least as wide as float and double, respectively, and such that double_t is at least as wide as float_t. The value of [FLT_EVAL_METHOD](../../types/limits/FLT_EVAL_METHOD.html "c/types/limits/FLT EVAL METHOD") determines the types of float_t and double_t. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/float_t&action=edit&section=1 "Edit section: Example")] Example
...
Run this code
    ...
    int main()
    {
        SHOW([FLT_EVAL_METHOD](../../types/limits/FLT_EVAL_METHOD.html));
        SHOW(sizeof(float));
        SHOW(sizeof(float_t));
        SHOW(sizeof(double));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/float_t&action=edit&section=2 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/float_t&action=edit&section=3 "Edit section: See also")] See also
