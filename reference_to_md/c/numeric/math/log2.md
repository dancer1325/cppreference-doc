...
## Contents
  ...
  * [1 Parameters](log2.html#Parameters)
  * [2 Return value](log2.html#Return_value)
  * [3 Error handling](log2.html#Error_handling)
  * [4 Notes](log2.html#Notes)
  * [5 Example](log2.html#Example)
  * [6 References](log2.html#References)
  * [7 See also](log2.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log2&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log2&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the base-_2_ logarithm of `arg` (log2(arg) or lb(arg)) is returned. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log2&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If the argument is negative, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised. 
  * If the argument is +∞, +∞ is returned 
  * If the argument is NaN, NaN is returned 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log2&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log2&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("log2(65536) = %f\n", log2(65536));
        [printf](../../io/fprintf.html)("log2(0.125) = %f\n", log2(0.125));
        [printf](../../io/fprintf.html)("log2(0x020f) = %f (highest set bit is in position 9)\n", log2(0x020f));
        [printf](../../io/fprintf.html)("base-5 logarithm of 125 = %f\n", log2(125)/log2(5));
        // special values
        [printf](../../io/fprintf.html)("log2(1) = %f\n", log2(1));
        [printf](../../io/fprintf.html)("log2(+Inf) = %f\n", log2(INFINITY));
        //error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("log2(0) = %f\n", log2(0));
        if(errno == [ERANGE](../../error/errno_macros.html)) [perror](../../io/perror.html)("    errno == ERANGE");
        if([fetestexcept](../fenv/fetestexcept.html)([FE_DIVBYZERO](../fenv/FE_exceptions.html))) [puts](../../io/puts.html)("    FE_DIVBYZERO raised");
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log2&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log2&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/log2.html "cpp/numeric/math/log2") for log2
