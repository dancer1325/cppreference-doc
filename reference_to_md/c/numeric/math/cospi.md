...
## Contents
  ...
  * [1 Parameters](cospi.html#Parameters)
  * [2 Return value](cospi.html#Return_value)
  * [3 Error handling](cospi.html#Error_handling)
  * [4 Example](cospi.html#Example)
  * [5 References](cospi.html#References)
  * [6 See also](cospi.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cospi&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value whose product with `π` represents an angle in radians   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cospi&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the cosine of `π·arg` (cos(π×arg)) in the range [-1, +1], is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cospi&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cospi&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    {
        return [cos](cos.html)(arg * (double)3.1415926535897932384626433);
    }
    #endif
     
    int main(void)
    ...
     
        // typical usage
        [printf](../../io/fprintf.html)("cospi(1) = %f, cos(pi) = %f\n", cospi(1), [cos](cos.html)(pi));
        [printf](../../io/fprintf.html)("cospi(0.5) = %f, cos(pi/2) = %f\n", cospi(0.5), [cos](cos.html)(pi / 2));
        [printf](../../io/fprintf.html)("cospi(-0.75) = %f, cos(-3*pi/4) = %f\n", cospi(-0.75), [cos](cos.html)(-3 * pi / 4));
     
        // special values
        [printf](../../io/fprintf.html)("cospi(+0) = %f\n", cospi(0.0));
        [printf](../../io/fprintf.html)("cospi(-0) = %f\n", cospi(-0.0));
     
        // error handling
        [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("cospi(INFINITY) = %f\n", cospi(INFINITY));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cospi&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cospi&action=edit&section=6 "Edit section: See also")] See also
