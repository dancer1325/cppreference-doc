...
## Contents
  ...
  * [1 Parameters](fmin.html#Parameters)
  * [2 Return value](fmin.html#Return_value)
  * [3 Error handling](fmin.html#Error_handling)
  * [4 Notes](fmin.html#Notes)
  * [5 Example](fmin.html#Example)
  * [6 References](fmin.html#References)
  * [7 See also](fmin.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmin&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  floating-point values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmin&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmin&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmin&action=edit&section=4 "Edit section: Notes")] Notes

This function is not required to be sensitive to the sign of zero, although some implementations additionally enforce that if one argument is +0 and the other is -0, then -0 is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmin&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("fmin(2,1)    = %f\n", fmin(2, 1));
        [printf](../../io/fprintf.html)("fmin(-Inf,0) = %f\n", fmin(-INFINITY, 0));
        [printf](../../io/fprintf.html)("fmin(NaN,-1) = %f\n", fmin(NAN, -1));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmin&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmin&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/fmin.html "cpp/numeric/math/fmin") for fmin
