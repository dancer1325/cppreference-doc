...
1-3) Computes the natural (base e) logarithm of 1 + arg. This function is more precise than the expression [log](log.html)(1 + arg) if arg is close to zero.
...
## Contents
  ...
  * [1 Parameters](log1p.html#Parameters)
  * [2 Return value](log1p.html#Return_value)
  * [3 Error handling](log1p.html#Error_handling)
  * [4 Notes](log1p.html#Notes)
  * [5 Example](log1p.html#Example)
  * [6 References](log1p.html#References)
  * [7 See also](log1p.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log1p&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log1p&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur ln(1 + arg) is returned. 

If a domain error occurs, an implementation-defined value is returned (NaN where supported). 

If a pole error occurs, -[HUGE_VAL](HUGE_VAL.html), `-HUGE_VALF`, or `-HUGE_VALL` is returned. 

If a range error occurs due to underflow, the correct result (after rounding) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log1p&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If the argument is -1, -∞ is returned and [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised. 
  * If the argument is less than -1, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised. 
  * If the argument is +∞, +∞ is returned. 
  * If the argument is NaN, NaN is returned. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log1p&action=edit&section=4 "Edit section: Notes")] Notes

The functions [expm1](expm1.html "c/numeric/math/expm1") and `log1p` are useful for financial calculations, for example, when calculating small daily interest rates: (1+x)n  
-1 can be expressed as [expm1](expm1.html)(n * log1p(x)). These functions also simplify writing accurate inverse hyperbolic functions. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log1p&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("log1p(0) = %f\n", log1p(0));
        [printf](../../io/fprintf.html)("Interest earned in 2 days on $100, compounded daily at 1%%\n"
               " on a 30/360 calendar = %f\n",
               100*[expm1](expm1.html)(2*log1p(0.01/360)));
        [printf](../../io/fprintf.html)("log(1+1e-16) = %g, but log1p(1e-16) = %g\n",
               [log](log.html)(1+1e-16), log1p(1e-16));
     
        // special values
        [printf](../../io/fprintf.html)("log1p(-0) = %f\n", log1p(-0.0));
        [printf](../../io/fprintf.html)("log1p(+Inf) = %f\n", log1p(INFINITY));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("log1p(-1) = %f\n", log1p(-1));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log1p&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log1p&action=edit&section=7 "Edit section: See also")] See also

[ loglogflogl](log.html "c/numeric/math/log")(C99)(C99) |  computes natural (base-_e_) logarithm (\\({\small \ln{x} }\\)ln(x))   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_log&action=edit)  
---|---  
[ log10log10flog10l](log10.html "c/numeric/math/log10")(C99)(C99) |  computes common (base-_10_) logarithm (\\({\small \log_{10}{x} }\\)log10(x))   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_log10&action=edit)  
[ log2log2flog2l](log2.html "c/numeric/math/log2")(C99)(C99)(C99) |  computes base-2 logarithm (\\({\small \log_{2}{x} }\\)log2(x))   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_log2&action=edit)  
[ expm1expm1fexpm1l](expm1.html "c/numeric/math/expm1")(C99)(C99)(C99) |  computes _e_ raised to the given power, minus one (\\({\small e^x-1}\\)ex-1)   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_expm1&action=edit)  
[C++ documentation](../../../cpp/numeric/math/log1p.html "cpp/numeric/math/log1p") for log1p
