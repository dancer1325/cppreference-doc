...
Formally, the unbiased exponent is the signed integral part of logr|arg| (returned by this function as a floating-point value), for non-zero arg, where `r` is [FLT_RADIX](../../types/limits.html "c/types/limits"). If arg is subnormal, it is treated as though it was normalized. 

## Contents

  * [1 Parameters](logb.html#Parameters)
  * [2 Return value](logb.html#Return_value)
  * [3 Error handling](logb.html#Error_handling)
  * [4 Notes](logb.html#Notes)
  * [5 Example](logb.html#Example)
  * [6 References](logb.html#References)
  * [7 See also](logb.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/logb&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/logb&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the unbiased exponent of arg is returned as a signed floating-point value. 

If a domain error occurs, an implementation-defined value is returned. 

If a pole error occurs, [-HUGE_VAL](HUGE_VALL.html "c/numeric/math/HUGE VAL"), `-HUGE_VALF`, or `-HUGE_VALL` is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/logb&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If arg is ±0, -∞ is returned and [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised. 
  * If arg is ±∞, +∞ is returned. 
  * If arg is NaN, NaN is returned. 
  * In all other cases, the result is exact ([FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is never raised) and [the current rounding mode](../fenv/FE_round.html "c/numeric/fenv/FE round") is ignored. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/logb&action=edit&section=4 "Edit section: Notes")] Notes

[POSIX requires](https://pubs.opengroup.org/onlinepubs/9699919799/functions/logb.html) that a pole error occurs if arg is ±0. 

The value of the exponent returned by `logb` is always 1 less than the exponent returned by [frexp](frexp.html "c/numeric/math/frexp") because of the different normalization requirements: for the exponent `e` returned by `logb`, |arg*r-e  
| is between 1 and `r` (typically between 1 and 2), but for the exponent `e` returned by [frexp](frexp.html "c/numeric/math/frexp"), |arg*2-e  
| is between 0.5 and 1. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/logb&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/logb&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/logb&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/logb.html "cpp/numeric/math/logb") for logb
