...
## Contents
  ...
  * [6 References](fmax.html#References)
  * [7 See also](fmax.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmax&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  floating-point values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmax&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmax&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmax&action=edit&section=4 "Edit section: Notes")] Notes

This function is not required to be sensitive to the sign of zero, although some implementations additionally enforce that if one argument is +0 and the other is -0, then +0 is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmax&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("fmax(2,1)    = %f\n", fmax(2,1));
        [printf](../../io/fprintf.html)("fmax(-Inf,0) = %f\n", fmax(-INFINITY,0));
        [printf](../../io/fprintf.html)("fmax(NaN,-1) = %f\n", fmax(NAN,-1));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmax&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fmax&action=edit&section=7 "Edit section: See also")] See also
...
---|---  
[ fminfminffminl](fmin.html "c/numeric/math/fmin")(C99)(C99)(C99) |  determines smaller of two floating-point values   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_fmin&action=edit)  
[C++ documentation](../../../cpp/numeric/math/fmax.html "cpp/numeric/math/fmax") for fmax
