...
## Contents
  ...
  * [1 Parameters](isless.html#Parameters)
  * [2 Return value](isless.html#Return_value)
  * [3 Notes](isless.html#Notes)
  * [4 Example](isless.html#Example)
  * [5 References](isless.html#References)
  * [6 See also](isless.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isless&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  floating-point value   
---|---|---  
y  |  \-  |  floating-point value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isless&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if x < y, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isless&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isless&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("isless(2.0,1.0)      = %d\n", isless(2.0, 1.0));
        [printf](../../io/fprintf.html)("isless(1.0,2.0)      = %d\n", isless(1.0, 2.0));
        [printf](../../io/fprintf.html)("isless(INFINITY,1.0) = %d\n", isless(INFINITY, 1.0));
        [printf](../../io/fprintf.html)("isless(1.0,NAN)      = %d\n", isless(1.0, NAN));
     
        return 0;
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isless&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isless&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/numeric/math/isless.html "cpp/numeric/math/isless") for isless
