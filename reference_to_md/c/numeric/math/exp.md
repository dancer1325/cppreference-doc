...
4) Type-generic macro: If arg has type long double, `expl` is called. Otherwise, if arg has integer type or the type double, `exp` is called. Otherwise, `expf` is called. If arg is complex or imaginary, then the macro invokes the corresponding complex function ([cexpf](../complex/cexp.html), [cexp](../complex/cexp.html), [cexpl](../complex/cexp.html)).
...
## Contents
  ...
  * [6 References](exp.html#References)
  * [7 See also](exp.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the base-_e_ exponential of arg (earg  
) is returned. 

If a range error occurs due to overflow, [+HUGE_VAL](HUGE_VALL.html "c/numeric/math/HUGE VAL"), `+HUGE_VALF`, or `+HUGE_VALL` is returned. 

If a range error occurs due to underflow, the correct result (after rounding) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp&action=edit&section=4 "Edit section: Notes")] Notes

For IEEE-compatible type double, overflow is guaranteed if 709.8 < arg, and underflow is guaranteed if arg < -708.4. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("exp(1) = %f\n", exp(1));
        [printf](../../io/fprintf.html)("FV of $100, continuously compounded at 3%% for 1 year = %f\n",
                100*exp(0.03));
        // special values
        [printf](../../io/fprintf.html)("exp(-0) = %f\n", exp(-0.0));
        [printf](../../io/fprintf.html)("exp(-Inf) = %f\n", exp(-INFINITY));
        //error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("exp(710) = %f\n", exp(710));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/exp.html "cpp/numeric/math/exp") for exp
