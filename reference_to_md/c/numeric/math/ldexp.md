...
---|---|---  
float ldexpf( float arg, int [exp](exp.html) ); |  (1)  |  (since C99)  
double ldexp( double arg, int [exp](exp.html) ); |  (2)  |   
long double ldexpl( long double arg, int [exp](exp.html) ); |  (3)  |  (since C99)  
Defined in header `[`<tgmath.h>`](../../header/tgmath.html "c/header/tgmath")` |  |   
#define ldexp( arg, exp ) |  (4)  |  (since C99)  
| |   
  
1-3) Multiplies a floating-point value arg by the number 2 raised to the [exp](exp.html) power.
...
## Contents
  ...
  * [1 Parameters](ldexp.html#Parameters)
  * [2 Return value](ldexp.html#Return_value)
  * [3 Error handling](ldexp.html#Error_handling)
  * [4 Notes](ldexp.html#Notes)
  * [5 Example](ldexp.html#Example)
  * [6 References](ldexp.html#References)
  * [7 See also](ldexp.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ldexp&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
exp  |  \-  |  integer value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ldexp&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, arg multiplied by 2 to the power of [exp](exp.html) (arg×2exp  
) is returned. 

If a range error due to overflow occurs, [±HUGE_VAL](HUGE_VALL.html "c/numeric/math/HUGE VAL"), `±HUGE_VALF`, or `±HUGE_VALL` is returned. 

If a range error due to underflow occurs, the correct result (after rounding) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ldexp&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ldexp&action=edit&section=4 "Edit section: Notes")] Notes

On binary systems (where [FLT_RADIX](../../types/limits.html "c/types/limits") is 2), `ldexp` is equivalent to [scalbn](scalbn.html "c/numeric/math/scalbn"). 

The function `ldexp` ("load exponent"), together with its dual, [frexp](frexp.html "c/numeric/math/frexp"), can be used to manipulate the representation of a floating-point number without direct bit manipulations. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ldexp&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("ldexp(7, -4) = %f\n", ldexp(7, -4));
        [printf](../../io/fprintf.html)("ldexp(1, -1074) = %g (minimum positive subnormal double)\n",
                ldexp(1, -1074));
        [printf](../../io/fprintf.html)("ldexp(nextafter(1,0), 1024) = %g (largest finite double)\n",
                ldexp([nextafter](nexttoward.html)(1,0), 1024));
     
        // special values
        [printf](../../io/fprintf.html)("ldexp(-0, 10) = %f\n", ldexp(-0.0, 10));
        [printf](../../io/fprintf.html)("ldexp(-Inf, -1) = %f\n", ldexp(-INFINITY, -1));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("ldexp(1, 1024) = %f\n", ldexp(1, 1024));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ldexp&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ldexp&action=edit&section=7 "Edit section: See also")] See also
...
---|---  
[ scalbnscalbnfscalbnlscalblnscalblnfscalblnl](scalbn.html "c/numeric/math/scalbn")(C99)(C99)(C99)(C99)(C99)(C99) |  computes efficiently a number times [FLT_RADIX](../../types/limits.html "c/types/limits") raised to a power   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_scalbn&action=edit)  
[C++ documentation](../../../cpp/numeric/math/ldexp.html "cpp/numeric/math/ldexp") for ldexp
