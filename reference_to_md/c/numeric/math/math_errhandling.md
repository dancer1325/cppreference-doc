...
Error handling  
| **MATH_ERRNO MATH_ERRNOEXCEPT**(C99)(C99)` `  
---  
...
The value of `math_errhandling` indicates the type of error handling that is performed by the floating-point operators and [functions](../math.html "c/numeric/math"): 

Constant  |  Explanation   
---|---  
`MATH_ERREXCEPT` |  indicates that floating-point exceptions are used: at least [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions"), [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions"), and [FE_OVERFLOW](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") are defined in `<fenv.h>`.   
`MATH_ERRNO` |  indicates that floating-point operations use the variable [errno](../../error/errno.html "c/error/errno") to report errors.   
...
---|---|---|---|---  
Domain error  | the argument is outside the range in which the operation is mathematically defined (the description of [each function](../math.html "c/numeric/math") lists the required domain errors)  | [EDOM](../../error/errno_macros.html "c/error/errno macros") | [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") | [acos](acos.html)(2)  
Pole error  | the mathematical result of the function is exactly infinite or undefined  | [ERANGE](../../error/errno_macros.html "c/error/errno macros") | [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") | [log](log.html)(0.0), 1.0/0.0  
Range error due to overflow  | the mathematical result is finite, but becomes infinite after rounding, or becomes the largest representable finite value after rounding down  | [ERANGE](../../error/errno_macros.html "c/error/errno macros") | [FE_OVERFLOW](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") | [pow](pow.html)([DBL_MAX](../../types/limits.html),2)  
Range error due to underflow  | the result is non-zero, but becomes zero after rounding, or becomes subnormal with a loss of precision  | [ERANGE](../../error/errno_macros.html "c/error/errno macros") or unchanged (implementation-defined)  | [FE_UNDERFLOW](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") or nothing (implementation-defined)  | DBL_TRUE_MIN/2  
Inexact result  | the result has to be rounded to fit in the destination type  | unchanged  | [FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") or nothing (unspecified)  | [sqrt](sqrt.html)(2), 1.0/10.0  
  
## Contents

  * [1 Notes](math_errhandling.html#Notes)
  * [2 Example](math_errhandling.html#Example)
  * [3 References](math_errhandling.html#References)
  * [4 See also](math_errhandling.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/math_errhandling&action=edit&section=1 "Edit section: Notes")] Notes

Whether [FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised by the mathematical library functions is unspecified in general, but may be explicitly specified in the description of the function (e.g. [rint](rint.html "c/numeric/math/rint") vs [nearbyint](nearbyint.html "c/numeric/math/nearbyint")). 

Before C99, floating-point exceptions were not specified, [EDOM](../../error/errno_macros.html) was required for any domain error, [ERANGE](../../error/errno_macros.html) was required for overflows and implementation-defined for underflows. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/math_errhandling&action=edit&section=2 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("MATH_ERRNO is %s\n", math_errhandling & MATH_ERRNO ? "set" : "not set");
        ...
        errno = 0;
        [printf](../../io/fprintf.html)("log(0) = %f\n", [log](log.html)(0));
        if(errno == [ERANGE](../../error/errno_macros.html))
            [perror](../../io/perror.html)("errno == ERANGE");
        if([fetestexcept](../fenv/fetestexcept.html)([FE_DIVBYZERO](../fenv/FE_exceptions.html)))
            [puts](../../io/puts.html)("FE_DIVBYZERO (pole error) reported");
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/math_errhandling&action=edit&section=3 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/math_errhandling&action=edit&section=4 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/math_errhandling.html "cpp/numeric/math/math errhandling") for math_errhandling
