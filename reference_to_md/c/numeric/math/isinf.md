...
## Contents
  ...
  * [1 Parameters](isinf.html#Parameters)
  * [2 Return value](isinf.html#Return_value)
  * [3 Example](isinf.html#Example)
  * [4 References](isinf.html#References)
  * [5 See also](isinf.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isinf&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isinf&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if `arg` has an infinite value, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isinf&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("isinf(NAN)         = %d\n", isinf(NAN));
        [printf](../../io/fprintf.html)("isinf(INFINITY)    = %d\n", isinf(INFINITY));
        [printf](../../io/fprintf.html)("isinf(0.0)         = %d\n", isinf(0.0));
        [printf](../../io/fprintf.html)("isinf(DBL_MIN/2.0) = %d\n", isinf([DBL_MIN](../../types/limits.html)/2.0));
        [printf](../../io/fprintf.html)("isinf(1.0)         = %d\n", isinf(1.0));
        [printf](../../io/fprintf.html)("isinf(exp(800))    = %d\n", isinf([exp](exp.html)(800)));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isinf&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isinf&action=edit&section=5 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/isinf.html "cpp/numeric/math/isinf") for isinf
