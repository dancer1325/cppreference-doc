...
4) Type-generic macro: If any argument has type long double, `powl` is called. Otherwise, if any argument has integer type or has type double, `pow` is called. Otherwise, `powf` is called. If at least one argument is complex or imaginary, then the macro invokes the corresponding complex function ([cpowf](../complex/cpow.html), [cpow](../complex/cpow.html), [cpowl](../complex/cpow.html)).

## Contents

  * [1 Parameters](pow.html#Parameters)
  * [2 Return value](pow.html#Return_value)
  * [3 Error handling](pow.html#Error_handling)
  * [4 Notes](pow.html#Notes)
  * [5 Example](pow.html#Example)
  * [6 References](pow.html#References)
  * [7 See also](pow.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/pow&action=edit&section=1 "Edit section: Parameters")] Parameters

base  |  \-  |  base as floating-point value   
---|---|---  
exponent  |  \-  |  exponent as floating-point value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/pow&action=edit&section=2 "Edit section: Return value")] Return value
...
If a pole error or a range error due to overflow occurs, ±[HUGE_VAL](HUGE_VAL.html), `±HUGE_VALF`, or `±HUGE_VALL` is returned. 

If a range error occurs due to underflow, the correct result (after rounding) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/pow&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * pow(+0, exponent), where exponent is a negative odd integer, returns `+∞` and raises [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions")
  * pow(-0, exponent), where exponent is a negative odd integer, returns `-∞` and raises [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions")
  * pow(±0, exponent), where exponent is negative, finite, and is an even integer or a non-integer, returns +∞ and raises [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions")
  * pow(±0, -∞) returns +∞ and may raise [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions")(until C23)
  ...
  * pow(base, exponent) returns `NaN` and raises [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") if base is finite and negative and exponent is finite and non-integer. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/pow&action=edit&section=4 "Edit section: Notes")] Notes

Although `pow` cannot be used to obtain a root of a negative number, [cbrt](cbrt.html "c/numeric/math/cbrt") is provided for the common case where `exponent` is 1 / 3. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/pow&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        // typical usage
        [printf](../../io/fprintf.html)("pow(2, 10) = %f\n", pow(2, 10));
        [printf](../../io/fprintf.html)("pow(2, 0.5) = %f\n", pow(2, 0.5));
        [printf](../../io/fprintf.html)("pow(-2, -3) = %f\n", pow(-2, -3));
     
        // special values
        [printf](../../io/fprintf.html)("pow(-1, NAN) = %f\n", pow(-1, NAN));
        [printf](../../io/fprintf.html)("pow(+1, NAN) = %f\n", pow(+1, NAN));
        [printf](../../io/fprintf.html)("pow(INFINITY, 2) = %f\n", pow(INFINITY, 2));
        [printf](../../io/fprintf.html)("pow(INFINITY, -1) = %f\n", pow(INFINITY, -1));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("pow(-1, 1/3) = %f\n", pow(-1, 1.0 / 3));
        if (errno == [EDOM](../../error/errno_macros.html))
            [perror](../../io/perror.html)("    errno == EDOM");
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/pow&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/pow&action=edit&section=7 "Edit section: See also")] See also

[ sqrtsqrtfsqrtl](sqrt.html "c/numeric/math/sqrt")(C99)(C99) |  computes square root (\\(\small{\sqrt{x} }\\)√x)   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_sqrt&action=edit)  
---|---  
[ cbrtcbrtfcbrtl](cbrt.html "c/numeric/math/cbrt")(C99)(C99)(C99) |  computes cube root (\\(\small{\sqrt[3]{x} }\\)3√x)   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_cbrt&action=edit)  
[ hypothypotfhypotl](hypot.html "c/numeric/math/hypot")(C99)(C99)(C99) |  computes square root of the sum of the squares of two given numbers (\\(\scriptsize{\sqrt{x^2+y^2} }\\)√x2  
+y2  
)   
...
[C++ documentation](../../../cpp/numeric/math/pow.html "cpp/numeric/math/pow") for pow
