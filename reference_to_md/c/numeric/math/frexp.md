...
---|---|---  
float frexpf( float arg, int* [exp](exp.html) ); |  (1)  |  (since C99)  
double frexp( double arg, int* [exp](exp.html) ); |  (2)  |   
long double frexpl( long double arg, int* [exp](exp.html) ); |  (3)  |  (since C99)  
...
## Contents
  ...
  * [1 Parameters](frexp.html#Parameters)
  * [2 Return value](frexp.html#Return_value)
  * [3 Error handling](frexp.html#Error_handling)
  * [4 Notes](frexp.html#Notes)
  * [5 Example](frexp.html#Example)
  * [6 References](frexp.html#References)
  * [7 See also](frexp.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/frexp&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
exp  |  \-  |  pointer to integer value to store the exponent to   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/frexp&action=edit&section=2 "Edit section: Return value")] Return value

If `arg` is zero, returns zero and stores zero in `*exp`. 

Otherwise (if `arg` is not zero), if no errors occur, returns the value `x` in the range `(-1;-0.5], [0.5; 1)` and stores an integer value in *[exp](exp.html) such that x×2(*exp)  
=arg. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/frexp&action=edit&section=3 "Edit section: Error handling")] Error handling

This function is not subject to any errors specified in [`math_errhandling`](math_errhandling.html "c/numeric/math/math errhandling"). 

If the implementation supports IEEE floating-point arithmetic (IEC 60559), 

  * If `arg` is ±0, it is returned, unmodified, and `0` is stored in *[exp](exp.html). 
  * If `arg` is ±∞, it is returned, and an unspecified value is stored in *[exp](exp.html). 
  * If `arg` is NaN, NaN is returned, and an unspecified value is stored in *[exp](exp.html). 
  * No floating-point exceptions are raised. 
  * If [FLT_RADIX](../../types/limits.html "c/types/limits") is 2 (or a power of 2), the returned value is exact, [the current rounding mode](../fenv/FE_round.html "c/numeric/fenv/FE round") is ignored. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/frexp&action=edit&section=4 "Edit section: Notes")] Notes

On a binary system (where [FLT_RADIX](../../types/limits.html "c/types/limits") is 2), `frexp` may be implemented as 
    
    
    {
        *[exp](exp.html) = (value == 0) ? 0 : (int)(1 + [logb](logb.html)(value));
        return [scalbn](scalbn.html)(value, -(*[exp](exp.html)));
    }

The function `frexp`, together with its dual, [ldexp](ldexp.html "c/numeric/math/ldexp"), can be used to manipulate the representation of a floating-point number without direct bit manipulations. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/frexp&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        double f = 123.45;
        [printf](../../io/fprintf.html)("Given the number %.2f or %a in hex,\n", f, f);
     
        double f3;
        double f2 = [modf](modf.html)(f, &f3);
        [printf](../../io/fprintf.html)("modf() makes %.0f + %.2f\n", f3, f2);
     
        int i;
        f2 = frexp(f, &i);
        [printf](../../io/fprintf.html)("frexp() makes %f * 2^%d\n", f2, i);
     
        i = [ilogb](ilogb.html)(f);
        [printf](../../io/fprintf.html)("logb()/ilogb() make %f * %d^%d\n", f/[scalbn](scalbn.html)(1.0, i), [FLT_RADIX](../../types/limits.html), i);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/frexp&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/frexp&action=edit&section=7 "Edit section: See also")] See also
...
---|---  
[ logblogbflogbl](logb.html "c/numeric/math/logb")(C99)(C99)(C99) |  extracts exponent of the given number   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_logb&action=edit)  
[ ilogbilogbfilogbl](ilogb.html "c/numeric/math/ilogb")(C99)(C99)(C99) |  extracts exponent of the given number   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_ilogb&action=edit)  
[ modfmodffmodfl](modf.html "c/numeric/math/modf")(C99)(C99) |  breaks a number into integer and fractional parts   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_modf&action=edit)  
[C++ documentation](../../../cpp/numeric/math/frexp.html "cpp/numeric/math/frexp") for frexp
