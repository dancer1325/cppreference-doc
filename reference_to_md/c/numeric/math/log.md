...
long double logl( long double arg ); |  (3)  |  (since C99)  
Defined in header `[`<tgmath.h>`](../../header/tgmath.html "c/header/tgmath")` |  |   
#define log( arg ) |  (4)  |  (since C99)  
| |   
  
1-3) Computes the natural (base _e_) logarithm of arg.

4) Type-generic macro: If arg has type long double, `logl` is called. Otherwise, if arg has integer type or the type double, `log` is called. Otherwise, `logf` is called. If arg is complex or imaginary, then the macro invokes the corresponding complex function ([clogf](../complex/clog.html), [clog](../complex/clog.html), [clogl](../complex/clog.html)).

## Contents

  * [1 Parameters](log.html#Parameters)
  * [2 Return value](log.html#Return_value)
  * [3 Error handling](log.html#Error_handling)
  * [4 Example](log.html#Example)
  * [5 References](log.html#References)
  * [6 See also](log.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the natural (base-_e_) logarithm of arg (ln(arg) or loge(arg)) is returned. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("log(1) = %f\n", log(1));
        [printf](../../io/fprintf.html)("base-5 logarithm of 125 = %f\n", log(125) / log(5));
     
        // special values
        [printf](../../io/fprintf.html)("log(1) = %f\n", log(1));
        [printf](../../io/fprintf.html)("log(+Inf) = %f\n", log(INFINITY));
     
        // error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log&action=edit&section=6 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/log.html "cpp/numeric/math/log") for log
