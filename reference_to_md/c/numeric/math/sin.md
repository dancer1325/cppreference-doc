...
## Contents
  ...
  * [6 References](sin.html#References)
  * [7 See also](sin.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sin&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value representing an angle in radians   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sin&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sin&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sin&action=edit&section=4 "Edit section: Notes")] Notes
...
POSIX also specifies that in case of underflow, arg is returned unmodified, and if that is not supported, an implementation-defined value no greater than [DBL_MIN](../../types/limits.html "c/types/limits"), [FLT_MIN](../../types/limits.html "c/types/limits"), and [LDBL_MIN](../../types/limits.html "c/types/limits") is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sin&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
     
        // typical usage
        [printf](../../io/fprintf.html)("sin(pi/6) = %f\n", sin(pi / 6));
        [printf](../../io/fprintf.html)("sin(pi/2) = %f\n", sin(pi / 2));
        [printf](../../io/fprintf.html)("sin(-3*pi/4) = %f\n", sin(-3 * pi / 4));
     
        // special values
        [printf](../../io/fprintf.html)("sin(+0) = %f\n", sin(0.0));
        [printf](../../io/fprintf.html)("sin(-0) = %f\n", sin(-0.0));
     
        // error handling
        [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("sin(INFINITY) = %f\n", sin(INFINITY));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sin&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sin&action=edit&section=7 "Edit section: See also")] See also

[ coscosfcosl](cos.html "c/numeric/math/cos")(C99)(C99) |  computes cosine (\\({\small\cos{x} }\\)cos(x))   
...
[C++ documentation](../../../cpp/numeric/math/sin.html "cpp/numeric/math/sin") for sin
