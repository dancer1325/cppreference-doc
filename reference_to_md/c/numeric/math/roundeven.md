...
long double roundevenl( long double arg ); |  (3)  |  (since C23)  
...
## Contents
  ...
  * [1 Parameters](roundeven.html#Parameters)
  * [2 Return value](roundeven.html#Return_value)
  * [3 Error handling](roundeven.html#Error_handling)
  * [4 Example](roundeven.html#Example)
  * [5 References](roundeven.html#References)
  * [6 See also](roundeven.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/roundeven&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/roundeven&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the nearest integer value to arg, rounding halfway cases to nearest even integer, is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/roundeven&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/roundeven&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("roundeven(+2.4) = %+.1f\n", roundeven(2.4));
        [printf](../../io/fprintf.html)("roundeven(-2.4) = %+.1f\n", roundeven(-2.4));
        [printf](../../io/fprintf.html)("roundeven(+2.5) = %+.1f\n", roundeven(2.5));
        [printf](../../io/fprintf.html)("roundeven(-2.5) = %+.1f\n", roundeven(-2.5));
        [printf](../../io/fprintf.html)("roundeven(+2.6) = %+.1f\n", roundeven(2.6));
        [printf](../../io/fprintf.html)("roundeven(-2.6) = %+.1f\n", roundeven(-2.6));
        [printf](../../io/fprintf.html)("roundeven(+3.5) = %+.1f\n", roundeven(3.5));
        [printf](../../io/fprintf.html)("roundeven(-3.5) = %+.1f\n", roundeven(-3.5));
        [printf](../../io/fprintf.html)("roundeven(-0.0) = %+.1f\n", roundeven(-0.0));
        [printf](../../io/fprintf.html)("roundeven(-Inf) = %+f\n",   roundeven(-INFINITY));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/roundeven&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/roundeven&action=edit&section=6 "Edit section: See also")] See also
