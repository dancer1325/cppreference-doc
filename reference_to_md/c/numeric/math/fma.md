...
| **FP_FAST_FMAL FP_FAST_FMAD _N_**(C99)(C23)  
---  
...
## Contents
  ...
  * [6 References](fma.html#References)
  * [7 See also](fma.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fma&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y, z  |  \-  |  floating-point values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fma&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fma&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If x is zero and y is infinite or if x is infinite and y is zero, and 
    * if z is not a NaN, then NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised, 
    * if z is a NaN, then NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") may be raised. 
  * If x * y is an exact infinity and z is an infinity with the opposite sign, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised. 
  * If x or y are NaN, NaN is returned. 
  * If z is NaN, and x * y is not 0 * Inf or Inf * 0, then NaN is returned (without [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions")). 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fma&action=edit&section=4 "Edit section: Notes")] Notes
...
Due to its infinite intermediate precision, `fma` is a common building block of other correctly-rounded mathematical operations, such as [sqrt](sqrt.html "c/numeric/math/sqrt") or even the division (where not provided by the CPU, e.g. [Itanium](https://en.wikipedia.org/wiki/Itanium "enwiki:Itanium")). 

As with all floating-point expressions, the expression (x * y) + z may be compiled as a fused mutiply-add unless the [` #pragma`](../../preprocessor/impl.html "c/preprocessor/impl") STDC FP_CONTRACT is off. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fma&action=edit&section=5 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fma&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fma&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/fma.html "cpp/numeric/math/fma") for fma
