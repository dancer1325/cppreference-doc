...
4) Type-generic macro: If the argument has type long double, `sinhl` is called. Otherwise, if the argument has integer type or the type double, `sinh` is called. Otherwise, `sinhf` is called. If the argument is complex, then the macro invokes the corresponding complex function ([csinhf](../complex/csinh.html), [csinh](../complex/csinh.html), [csinhl](../complex/csinh.html)).

## Contents

  * [1 Parameters](sinh.html#Parameters)
  * [2 Return value](sinh.html#Return_value)
  * [3 Error handling](sinh.html#Error_handling)
  * [4 Notes](sinh.html#Notes)
  * [5 Example](sinh.html#Example)
  * [6 References](sinh.html#References)
  * [7 See also](sinh.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinh&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value representing a hyperbolic angle   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinh&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinh&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinh&action=edit&section=4 "Edit section: Notes")] Notes

[POSIX specifies](https://pubs.opengroup.org/onlinepubs/9699919799/functions/sinh.html) that in case of underflow, arg is returned unmodified, and if that is not supported, an implementation-defined value no greater than [DBL_MIN](../../types/limits.html "c/types/limits"), [FLT_MIN](../../types/limits.html "c/types/limits"), and [LDBL_MIN](../../types/limits.html "c/types/limits") is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinh&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("sinh(1) = %f\nsinh(-1)=%f\n", sinh(1), sinh(-1));
        [printf](../../io/fprintf.html)("log(sinh(1) + cosh(1))=%f\n", [log](log.html)(sinh(1) + [cosh](cosh.html)(1)));
     
        // special values
        [printf](../../io/fprintf.html)("sinh(+0) = %f\nsinh(-0)=%f\n", sinh(0.0), sinh(-0.0));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("sinh(710.5) = %f\n", sinh(710.5));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinh&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinh&action=edit&section=7 "Edit section: See also")] See also

[ coshcoshfcoshl](cosh.html "c/numeric/math/cosh")(C99)(C99) |  computes hyperbolic cosine (\\({\small\cosh{x} }\\)cosh(x))   
...
[C++ documentation](../../../cpp/numeric/math/sinh.html "cpp/numeric/math/sinh") for sinh
