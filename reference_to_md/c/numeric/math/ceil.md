...
## Contents
  ...
  * [3 Error handling](ceil.html#Error_handling)
  * [4 Notes](ceil.html#Notes)
  * [5 Example](ceil.html#Example)
  * [6 References](ceil.html#References)
  * [7 See also](ceil.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ceil&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ceil&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ceil&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ceil&action=edit&section=4 "Edit section: Notes")] Notes

[FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") may be (but isn't required to be) raised when rounding a non-integer finite value. 

The largest representable floating-point values are exact integers in all standard floating-point formats, so this function never overflows on its own; however the result may overflow any integer type (including [intmax_t](../../types/integer.html "c/types/integer")), when stored in an integer variable. 

This function (for double argument) behaves as if (except for the freedom to not raise [FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions")) implemented by 
    ...
    {
        double result;
        int save_round = [fegetround](../fenv/feround.html)();
        [fesetround](../fenv/feround.html)([FE_UPWARD](../fenv/FE_round.html));
        result = [rint](rint.html)(x); // or nearbyint
        [fesetround](../fenv/feround.html)(save_round);
        return result;
    }

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ceil&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("ceil(+2.4) = %+.1f\n", ceil(2.4));
        [printf](../../io/fprintf.html)("ceil(-2.4) = %+.1f\n", ceil(-2.4));
        [printf](../../io/fprintf.html)("ceil(-0.0) = %+.1f\n", ceil(-0.0));
        [printf](../../io/fprintf.html)("ceil(-Inf) = %+f\n",   ceil(-INFINITY));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ceil&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/ceil&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/ceil.html "cpp/numeric/math/ceil") for ceil
