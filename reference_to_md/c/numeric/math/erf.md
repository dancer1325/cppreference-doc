...
## Contents
  ...
  * [1 Parameters](erf.html#Parameters)
  * [2 Return value](erf.html#Return_value)
  * [3 Error handling](erf.html#Error_handling)
  * [4 Notes](erf.html#Notes)
  * [5 Example](erf.html#Example)
  * [6 References](erf.html#References)
  * [7 See also](erf.html#See_also)
  * [8 External links](erf.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/erf&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/erf&action=edit&section=2 "Edit section: Return value")] Return value
...
∫arg  
0 _e_ -t2  
d _t_ , is returned. If a range error occurs due to underflow, the correct result (after rounding), that is \\(\frac{2\cdot arg}{\sqrt{\pi} }\\)2*arg  
---  
√π  
, is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/erf&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/erf&action=edit&section=4 "Edit section: Notes")] Notes

Underflow is guaranteed if |arg| < [DBL_MIN](../../types/limits.html)*([sqrt](sqrt.html)(π)/2). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/erf&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    {
        return (erf(x2 / [sqrt](sqrt.html)(2)) - erf(x1 / [sqrt](sqrt.html)(2))) / 2;
    }
     
    int main(void)
    {
        [puts](../../io/puts.html)("normal variate probabilities:");
        for (int n = -4; n < 4; ++n)
            [printf](../../io/fprintf.html)("[%2d:%2d]: %5.2f%%\n", n, n + 1, 100 * phi(n, n + 1));
     
        [puts](../../io/puts.html)("special values:");
        [printf](../../io/fprintf.html)("erf(-0) = %f\n", erf(-0.0));
        [printf](../../io/fprintf.html)("erf(Inf) = %f\n", erf(INFINITY));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/erf&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/erf&action=edit&section=7 "Edit section: See also")] See also

[ erfcerfcferfcl](erfc.html "c/numeric/math/erfc")(C99)(C99)(C99) |  computes complementary error function   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_erfc&action=edit)  
---|---  
[C++ documentation](../../../cpp/numeric/math/erf.html "cpp/numeric/math/erf") for erf  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/erf&action=edit&section=8 "Edit section: External links")] External links
