...
7) Type-generic macro: If the argument has type long double, (3) (`atanl`) is called. Otherwise, if the argument has integer type or the type double, (2) (`atan`) is called. Otherwise, (1) (`atanf`) is called. If the argument is complex, then the macro invokes the corresponding complex function ([catanf](../complex/catan.html "c/numeric/complex/catan"), [catan](../complex/catan.html "c/numeric/complex/catan"), [catanl](../complex/catan.html "c/numeric/complex/catan")).
...
## Contents
  ...
  * [6 References](atan.html#References)
  * [7 See also](atan.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atan&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atan&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atan&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atan&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atan&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("atan(1) = %f, 4*atan(1)=%f\n", atan(1), 4 * atan(1));
        // special values
        [printf](../../io/fprintf.html)("atan(Inf) = %f, 2*atan(Inf) = %f\n", atan(INFINITY), 2 * atan(INFINITY));
        [printf](../../io/fprintf.html)("atan(-0.0) = %+f, atan(+0.0) = %+f\n", atan(-0.0), atan(0));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atan&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atan&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/atan.html "cpp/numeric/math/atan") for atan
