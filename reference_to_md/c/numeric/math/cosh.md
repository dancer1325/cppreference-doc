...
4) Type-generic macro: If the argument has type long double, `coshl` is called. Otherwise, if the argument has integer type or the type double, `cosh` is called. Otherwise, `coshf` is called. If the argument is complex, then the macro invokes the corresponding complex function ([ccoshf](../complex/ccosh.html), [ccosh](../complex/ccosh.html), [ccoshl](../complex/ccosh.html)).

## Contents

  * [1 Parameters](cosh.html#Parameters)
  * [2 Return value](cosh.html#Return_value)
  * [3 Error handling](cosh.html#Error_handling)
  * [4 Notes](cosh.html#Notes)
  * [5 Example](cosh.html#Example)
  * [6 References](cosh.html#References)
  * [7 See also](cosh.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cosh&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value representing a hyperbolic angle   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cosh&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cosh&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cosh&action=edit&section=4 "Edit section: Notes")] Notes

For the IEEE-compatible type double, if |arg| > 710.5, then `cosh(arg)` overflows. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cosh&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("cosh(1) = %f\ncosh(-1)= %f\n", cosh(1), cosh(-1));
        [printf](../../io/fprintf.html)("log(sinh(1) + cosh(1))=%f\n", [log](log.html)([sinh](sinh.html)(1) + cosh(1)));
        // special values
        [printf](../../io/fprintf.html)("cosh(+0) = %f\ncosh(-0) = %f\n", cosh(0.0), cosh(-0.0));
        // error handling
        errno = 0;
        [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("cosh(710.5) = %f\n", cosh(710.5));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cosh&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cosh&action=edit&section=7 "Edit section: See also")] See also

[ sinhsinhfsinhl](sinh.html "c/numeric/math/sinh")(C99)(C99) |  computes hyperbolic sine (\\({\small\sinh{x} }\\)sinh(x))   
...
[C++ documentation](../../../cpp/numeric/math/cosh.html "cpp/numeric/math/cosh") for cosh
