...
## Contents
  ...
  * [1 Parameters](signbit.html#Parameters)
  * [2 Return value](signbit.html#Return_value)
  * [3 Notes](signbit.html#Notes)
  * [4 Example](signbit.html#Example)
  * [5 References](signbit.html#References)
  * [6 See also](signbit.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/signbit&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/signbit&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if arg is negative, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/signbit&action=edit&section=3 "Edit section: Notes")] Notes

This macro detects the sign bit of zeroes, infinities, and NaNs. Along with [copysign](copysign.html "c/numeric/math/copysign"), this macro is one of the only two portable ways to examine the sign of a NaN. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/signbit&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("signbit(+0.0) = %d\n", signbit(+0.0));
        [printf](../../io/fprintf.html)("signbit(-0.0) = %d\n", signbit(-0.0));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/signbit&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/signbit&action=edit&section=6 "Edit section: See also")] See also

[ fabsfabsffabsl](fabs.html "c/numeric/math/fabs")(C99)(C99) |  computes absolute value of a floating-point value (\\(\small{|x|}\\)|x|)   
...
[C++ documentation](../../../cpp/numeric/math/signbit.html "cpp/numeric/math/signbit") for signbit
