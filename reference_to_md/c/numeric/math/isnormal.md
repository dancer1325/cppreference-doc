...
## Contents
  ...
  * [1 Parameters](isnormal.html#Parameters)
  * [2 Return value](isnormal.html#Return_value)
  * [3 Example](isnormal.html#Example)
  * [4 References](isnormal.html#References)
  * [5 See also](isnormal.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnormal&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnormal&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if arg is normal, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnormal&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("isnormal(NAN)         = %d\n", isnormal(NAN));
        [printf](../../io/fprintf.html)("isnormal(INFINITY)    = %d\n", isnormal(INFINITY));
        [printf](../../io/fprintf.html)("isnormal(0.0)         = %d\n", isnormal(0.0));
        [printf](../../io/fprintf.html)("isnormal(DBL_MIN/2.0) = %d\n", isnormal([DBL_MIN](../../types/limits.html) / 2.0));
        [printf](../../io/fprintf.html)("isnormal(1.0)         = %d\n", isnormal(1.0));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnormal&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isnormal&action=edit&section=5 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/isnormal.html "cpp/numeric/math/isnormal") for isnormal
