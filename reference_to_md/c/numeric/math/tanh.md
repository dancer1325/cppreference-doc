...
4) Type-generic macro: If the argument has type long double, `tanhl` is called. Otherwise, if the argument has integer type or the type double, `tanh` is called. Otherwise, `tanhf` is called. If the argument is complex, then the macro invokes the corresponding complex function ([ctanhf](../complex/ctanh.html), [ctanh](../complex/ctanh.html), [ctanhl](../complex/ctanh.html)).
...
## Contents
  ...
  * [6 References](tanh.html#References)
  * [7 See also](tanh.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tanh&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value representing a hyperbolic angle   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tanh&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tanh&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tanh&action=edit&section=4 "Edit section: Notes")] Notes

[POSIX specifies](https://pubs.opengroup.org/onlinepubs/9699919799/functions/tanh.html) that in case of underflow, arg is returned unmodified, and if that is not supported, an implementation-defined value no greater than [DBL_MIN](../../types/limits.html "c/types/limits"), [FLT_MIN](../../types/limits.html "c/types/limits"), and [LDBL_MIN](../../types/limits.html "c/types/limits") is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tanh&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("tanh(1) = %f\ntanh(-1) = %f\n", tanh(1), tanh(-1));
        [printf](../../io/fprintf.html)("tanh(0.1)*sinh(0.2)-cosh(0.2) = %f\n", tanh(0.1) * [sinh](sinh.html)(0.2) - [cosh](cosh.html)(0.2));
        // special values
        [printf](../../io/fprintf.html)("tanh(+0) = %f\ntanh(-0) = %f\n", tanh(0.0), tanh(-0.0));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tanh&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/tanh&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/tanh.html "cpp/numeric/math/tanh") for tanh
