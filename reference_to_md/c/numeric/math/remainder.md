...
In contrast to [fmod()](fmod.html "c/numeric/math/fmod"), the returned value is not guaranteed to have the same sign as x. 
...
## Contents
  ...
  * [6 References](remainder.html#References)
  * [7 See also](remainder.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remainder&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  floating-point values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remainder&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remainder&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * [FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is never raised, the result is always exact. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remainder&action=edit&section=4 "Edit section: Notes")] Notes
...
[fmod](fmod.html "c/numeric/math/fmod"), but not `remainder` is useful for doing silent wrapping of floating-point types to unsigned integer types: (0.0 <= (y = [fmod](fmod.html)([rint](rint.html)(x), 65536.0)) ? y : 65536.0 + y) is in the range `[`-0.0`, `65535.0`]`, which corresponds to unsigned short, but remainder([rint](rint.html)(x), 65536.0) is in the range `[`-32767.0`, `+32768.0`]`, which is outside of the range of signed short. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remainder&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("remainder(+5.1, +3.0) = %.1f\n", remainder(5.1, 3));
        [printf](../../io/fprintf.html)("remainder(-5.1, +3.0) = %.1f\n", remainder(-5.1, 3));
        [printf](../../io/fprintf.html)("remainder(+5.1, -3.0) = %.1f\n", remainder(5.1, -3));
        [printf](../../io/fprintf.html)("remainder(-5.1, -3.0) = %.1f\n", remainder(-5.1, -3));
     
        // special values
        [printf](../../io/fprintf.html)("remainder(-0.0, 1.0) = %.1f\n", remainder(-0.0, 1));
        [printf](../../io/fprintf.html)("remainder(+5.1, Inf) = %.1f\n", remainder(5.1, INFINITY));
     
        // error handling
        [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("remainder(+5.1, 0) = %.1f\n", remainder(5.1, 0));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remainder&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/remainder&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/remainder.html "cpp/numeric/math/remainder") for remainder
