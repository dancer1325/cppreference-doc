...
1-3) Computes the _e_ (Euler's number, `2.7182818`) raised to the given power `arg`, minus 1.0. This function is more accurate than the expression [exp](exp.html)(arg)-1.0 if `arg` is close to zero.
...
## Contents
  ...
  * [1 Parameters](expm1.html#Parameters)
  * [2 Return value](expm1.html#Return_value)
  * [3 Error handling](expm1.html#Error_handling)
  * [4 Notes](expm1.html#Notes)
  * [5 Example](expm1.html#Example)
  * [6 References](expm1.html#References)
  * [7 See also](expm1.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/expm1&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/expm1&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/expm1&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/expm1&action=edit&section=4 "Edit section: Notes")] Notes

The functions `expm1` and [log1p](log1p.html "c/numeric/math/log1p") are useful for financial calculations, for example, when calculating small daily interest rates: (1+x)n  
-1 can be expressed as expm1(n * [log1p](log1p.html)(x)). These functions also simplify writing accurate inverse hyperbolic functions. 

For IEEE-compatible type double, overflow is guaranteed if 709.8 < arg. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/expm1&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("expm1(1) = %f\n", expm1(1));
        [printf](../../io/fprintf.html)("Interest earned in 2 days on $100, compounded daily at 1%%\n"
               " on a 30/360 calendar = %f\n",
               100*expm1(2*[log1p](log1p.html)(0.01/360)));
        [printf](../../io/fprintf.html)("exp(1e-16)-1 = %g, but expm1(1e-16) = %g\n",
               [exp](exp.html)(1e-16)-1, expm1(1e-16));
        // special values
        [printf](../../io/fprintf.html)("expm1(-0) = %f\n", expm1(-0.0));
        [printf](../../io/fprintf.html)("expm1(-Inf) = %f\n", expm1(-INFINITY));
        //error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("expm1(710) = %f\n", expm1(710));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/expm1&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/expm1&action=edit&section=7 "Edit section: See also")] See also

[ expexpfexpl](exp.html "c/numeric/math/exp")(C99)(C99) |  computes _e_ raised to the given power (\\({\small e^x}\\)ex)   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_exp&action=edit)  
---|---  
[ exp2exp2fexp2l](exp2.html "c/numeric/math/exp2")(C99)(C99)(C99) |  computes _2_ raised to the given power (\\({\small 2^x}\\)2x)   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_exp2&action=edit)  
[ log1plog1pflog1pl](log1p.html "c/numeric/math/log1p")(C99)(C99)(C99) |  computes natural (base-_e_) logarithm of 1 plus the given number (\\({\small \ln{(1+x)} }\\)ln(1+x))   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_log1p&action=edit)  
[C++ documentation](../../../cpp/numeric/math/expm1.html "cpp/numeric/math/expm1") for expm1
