...
4) Type-generic macro: If the argument has type long double, `atanhl` is called. Otherwise, if the argument has integer type or the type double, `atanh` is called. Otherwise, `atanhf` is called. If the argument is complex, then the macro invokes the corresponding complex function ([catanhf](../complex/catanh.html "c/numeric/complex/catanh"), [catanh](../complex/catanh.html "c/numeric/complex/catanh"), [catanhl](../complex/catanh.html "c/numeric/complex/catanh")).

## Contents

  * [1 Parameters](atanh.html#Parameters)
  * [2 Return value](atanh.html#Return_value)
  * [3 Error handling](atanh.html#Error_handling)
  * [4 Notes](atanh.html#Notes)
  * [5 Example](atanh.html#Example)
  * [6 References](atanh.html#References)
  * [7 See also](atanh.html#See_also)
  * [8 External links](atanh.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atanh&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating_point value representing the area of a hyperbolic sector   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atanh&action=edit&section=2 "Edit section: Return value")] Return value
...
If a pole error occurs, ±[HUGE_VAL](HUGE_VAL.html), `±HUGE_VALF`, or `±HUGE_VALL` is returned (with the correct sign). 

If a range error occurs due to underflow, the correct result (after rounding) is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atanh&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If |arg|>1, NaN is returned and [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised. 
  * If the argument is NaN, NaN is returned. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atanh&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atanh&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("atanh(0) = %f\natanh(-0) = %f\n", atanh(0), atanh(-0.0));
        [printf](../../io/fprintf.html)("atanh(0.9) = %f\n", atanh(0.9));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("atanh(-1) = %f\n", atanh(-1));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atanh&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atanh&action=edit&section=7 "Edit section: See also")] See also

[ asinhasinhfasinhl](asinh.html "c/numeric/math/asinh")(C99)(C99)(C99) |  computes inverse hyperbolic sine (\\({\small\operatorname{arsinh}{x} }\\)arsinh(x))   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_asinh&action=edit)  
---|---  
[ acoshacoshfacoshl](acosh.html "c/numeric/math/acosh")(C99)(C99)(C99) |  computes inverse hyperbolic cosine (\\({\small\operatorname{arcosh}{x} }\\)arcosh(x))   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_acosh&action=edit)  
[ tanhtanhftanhl](tanh.html "c/numeric/math/tanh")(C99)(C99) |  computes hyperbolic tangent (\\({\small\tanh{x} }\\)tanh(x))   
...
[C++ documentation](../../../cpp/numeric/math/atanh.html "cpp/numeric/math/atanh") for atanh  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atanh&action=edit&section=8 "Edit section: External links")] External links
