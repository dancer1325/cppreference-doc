...
[FLT_EVAL_METHOD](../../types/limits/FLT_EVAL_METHOD.html "c/types/limits/FLT EVAL METHOD") is ignored: even if the argument is evaluated with more range and precision than its type, it is first converted to its semantic type, and the classification is based on that. 

## Contents

  * [1 Parameters](isfinite.html#Parameters)
  * [2 Return value](isfinite.html#Return_value)
  * [3 Example](isfinite.html#Example)
  * [4 References](isfinite.html#References)
  * [5 See also](isfinite.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isfinite&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isfinite&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if arg has finite value, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isfinite&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("isfinite(NAN)         = %d\n", isfinite(NAN));
        [printf](../../io/fprintf.html)("isfinite(INFINITY)    = %d\n", isfinite(INFINITY));
        [printf](../../io/fprintf.html)("isfinite(0.0)         = %d\n", isfinite(0.0));
        [printf](../../io/fprintf.html)("isfinite(DBL_MIN/2.0) = %d\n", isfinite([DBL_MIN](../../types/limits.html) / 2.0));
        [printf](../../io/fprintf.html)("isfinite(1.0)         = %d\n", isfinite(1.0));
        [printf](../../io/fprintf.html)("isfinite(exp(800))    = %d\n", isfinite([exp](exp.html)(800)));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isfinite&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isfinite&action=edit&section=5 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/isfinite.html "cpp/numeric/math/isfinite") for isfinite
