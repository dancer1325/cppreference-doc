...
## Contents
  ...
  * [1 Parameters](islessequal.html#Parameters)
  * [2 Return value](islessequal.html#Return_value)
  * [3 Notes](islessequal.html#Notes)
  * [4 Example](islessequal.html#Example)
  * [5 References](islessequal.html#References)
  * [6 See also](islessequal.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/islessequal&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  floating-point value   
---|---|---  
y  |  \-  |  floating-point value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/islessequal&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if x <= y, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/islessequal&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/islessequal&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("islessequal(2.0,1.0)      = %d\n", islessequal(2.0, 1.0));
        [printf](../../io/fprintf.html)("islessequal(1.0,2.0)      = %d\n", islessequal(1.0, 2.0));
        [printf](../../io/fprintf.html)("islessequal(1.0,1.0)      = %d\n", islessequal(1.0, 1.0));
        [printf](../../io/fprintf.html)("islessequal(INFINITY,1.0) = %d\n", islessequal(INFINITY, 1.0));
        [printf](../../io/fprintf.html)("islessequal(1.0,NAN)      = %d\n", islessequal(1.0, NAN));
     
        return 0;
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/islessequal&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/islessequal&action=edit&section=6 "Edit section: See also")] See also

[ isgreaterequal](isgreaterequal.html "c/numeric/math/isgreaterequal")(C99) |  checks if the first floating-point argument is greater or equal than the second   
...
---|---  
[C++ documentation](../../../cpp/numeric/math/islessequal.html "cpp/numeric/math/islessequal") for islessequal
