...
## Contents
  ...
  * [1 Parameters](exp2.html#Parameters)
  * [2 Return value](exp2.html#Return_value)
  * [3 Error handling](exp2.html#Error_handling)
  * [4 Example](exp2.html#Example)
  * [5 References](exp2.html#References)
  * [6 See also](exp2.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp2&action=edit&section=1 "Edit section: Parameters")] Parameters

n  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp2&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the base-_2_ exponential of `n` (2n  
) is returned. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp2&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp2&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("exp2(5) = %f\n", exp2(5));
        [printf](../../io/fprintf.html)("exp2(0.5) = %f\n", exp2(0.5));
        [printf](../../io/fprintf.html)("exp2(-4) = %f\n", exp2(-4));
        // special values
        [printf](../../io/fprintf.html)("exp2(-0.9) = %f\n", exp2(-0.9));
        [printf](../../io/fprintf.html)("exp2(-Inf) = %f\n", exp2(-INFINITY));
        //error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("exp2(1024) = %f\n", exp2(1024));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp2&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp2&action=edit&section=6 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/exp2.html "cpp/numeric/math/exp2") for exp2
