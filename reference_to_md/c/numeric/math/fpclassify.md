...
[FLT_EVAL_METHOD](../../types/limits/FLT_EVAL_METHOD.html "c/types/limits/FLT EVAL METHOD") is ignored: even if the argument is evaluated with more range and precision than its type, it is first converted to its semantic type, and the classification is based on that: a normal long double value might become subnormal when converted to double and zero when converted to float. 

## Contents

  * [1 Parameters](fpclassify.html#Parameters)
  * [2 Return value](fpclassify.html#Return_value)
  * [3 Example](fpclassify.html#Example)
  * [4 References](fpclassify.html#References)
  * [5 See also](fpclassify.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fpclassify&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fpclassify&action=edit&section=2 "Edit section: Return value")] Return value

One of [FP_INFINITE](FP_categories.html "c/numeric/math/FP categories"), [FP_NAN](FP_categories.html "c/numeric/math/FP categories"), [FP_NORMAL](FP_categories.html "c/numeric/math/FP categories"), [FP_SUBNORMAL](FP_categories.html "c/numeric/math/FP categories"), [FP_ZERO](FP_categories.html "c/numeric/math/FP categories") or implementation-defined type, specifying the category of arg. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fpclassify&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    const char* show_classification(double x)
    {
        switch(fpclassify(x))
        {
            case [FP_INFINITE](FP_categories.html):  return "Inf";
            case [FP_NAN](FP_categories.html):       return "NaN";
            case [FP_NORMAL](FP_categories.html):    return "normal";
            case [FP_SUBNORMAL](FP_categories.html): return "subnormal";
            case [FP_ZERO](FP_categories.html):      return "zero";
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("1.0/0.0 is %s\n", show_classification(1 / 0.0));
        [printf](../../io/fprintf.html)("0.0/0.0 is %s\n", show_classification(0.0 / 0.0));
        [printf](../../io/fprintf.html)("DBL_MIN/2 is %s\n", show_classification([DBL_MIN](../../types/limits.html) / 2));
        [printf](../../io/fprintf.html)("-0.0 is %s\n", show_classification(-0.0));
        [printf](../../io/fprintf.html)("1.0 is %s\n", show_classification(1.0));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fpclassify&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fpclassify&action=edit&section=5 "Edit section: See also")] See also

[ isfinite](isfinite.html "c/numeric/math/isfinite")(C99) |  checks if the given number has finite value   
(function macro) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_isfinite&action=edit)  
---|---  
[ isinf](isinf.html "c/numeric/math/isinf")(C99) |  checks if the given number is infinite   
...
[ isnormal](isnormal.html "c/numeric/math/isnormal")(C99) |  checks if the given number is normal   
(function macro) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_isnormal&action=edit)  
[C++ documentation](../../../cpp/numeric/math/fpclassify.html "cpp/numeric/math/fpclassify") for fpclassify
