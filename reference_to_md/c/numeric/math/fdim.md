...
## Contents
  ...
  * [1 Parameters](fdim.html#Parameters)
  * [2 Return value](fdim.html#Return_value)
  * [3 Error handling](fdim.html#Error_handling)
  * [4 Notes](fdim.html#Notes)
  * [5 Example](fdim.html#Example)
  * [6 References](fdim.html#References)
  * [7 See also](fdim.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fdim&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fdim&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fdim&action=edit&section=3 "Edit section: Error handling")] Error handling

Errors are reported as specified in [Template:rllpt](https://en.cppreference.com/mwiki/index.php?title=Template:rllpt&action=edit&redlink=1 "Template:rllpt \(page does not exist\)"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fdim&action=edit&section=4 "Edit section: Notes")] Notes

Equivalent to [fmax](fmax.html)(x-y, 0) except for the NaN handling requirements. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fdim&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("fdim(4, 1) = %f, fdim(1, 4)=%f\n", fdim(4,1), fdim(1,4));
        [printf](../../io/fprintf.html)("fdim(4,-1) = %f, fdim(1,-4)=%f\n", fdim(4,-1), fdim(1,-4));
        //error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("fdim(1e308, -1e308) = %f\n", fdim(1e308, -1e308));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fdim&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/fdim&action=edit&section=7 "Edit section: See also")] See also
...
---|---  
[ fmaxfmaxffmaxl](fmax.html "c/numeric/math/fmax")(C99)(C99)(C99) |  determines larger of two floating-point values   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_fmax&action=edit)  
[C++ documentation](../../../cpp/numeric/math/fdim.html "cpp/numeric/math/fdim") for fdim
