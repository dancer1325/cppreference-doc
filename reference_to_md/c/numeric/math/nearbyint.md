...
1-3) Rounds the floating-point argument arg to an integer value in floating-point format, using the [current rounding mode](../fenv/FE_round.html "c/numeric/fenv/FE round").
...
## Contents
  ...
  * [1 Parameters](nearbyint.html#Parameters)
  * [2 Return value](nearbyint.html#Return_value)
  * [3 Error handling](nearbyint.html#Error_handling)
  * [4 Notes](nearbyint.html#Notes)
  * [5 Example](nearbyint.html#Example)
  * [6 References](nearbyint.html#References)
  * [7 See also](nearbyint.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nearbyint&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nearbyint&action=edit&section=2 "Edit section: Return value")] Return value

The nearest integer value to arg, according to the [current rounding mode](../fenv/FE_round.html "c/numeric/fenv/FE round"), is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nearbyint&action=edit&section=3 "Edit section: Error handling")] Error handling

This function is not subject to any of the errors specified in [`math_errhandling`](math_errhandling.html "c/numeric/math/math errhandling"). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nearbyint&action=edit&section=4 "Edit section: Notes")] Notes

The only difference between `nearbyint` and [rint](rint.html "c/numeric/math/rint") is that `nearbyint` never raises [FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions"). 

The largest representable floating-point values are exact integers in all standard floating-point formats, so `nearbyint` never overflows on its own; however the result may overflow any integer type (including [intmax_t](../../types/integer.html "c/types/integer")), when stored in an integer variable. 

If the current rounding mode is [FE_TONEAREST](../fenv/FE_round.html "c/numeric/fenv/FE round"), this function rounds to even in halfway cases (like [rint](rint.html "c/numeric/math/rint"), but unlike [round](round.html "c/numeric/math/round")). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nearbyint&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    // #pragma STDC FENV_ACCESS ON
        ...
        [printf](../../io/fprintf.html)("rounding to nearest:\nnearbyint(+2.3) = %+.1f  ", nearbyint(2.3));
        [printf](../../io/fprintf.html)("nearbyint(+2.5) = %+.1f  ", nearbyint(2.5));
        [printf](../../io/fprintf.html)("nearbyint(+3.5) = %+.1f\n", nearbyint(3.5));
        [printf](../../io/fprintf.html)("nearbyint(-2.3) = %+.1f  ", nearbyint(-2.3));
        [printf](../../io/fprintf.html)("nearbyint(-2.5) = %+.1f  ", nearbyint(-2.5));
        [printf](../../io/fprintf.html)("nearbyint(-3.5) = %+.1f\n", nearbyint(-3.5));
     
        ...
        [printf](../../io/fprintf.html)("nearbyint(-3.5) = %+.1f\n", nearbyint(-3.5));
     
        [printf](../../io/fprintf.html)("nearbyint(-0.0) = %+.1f\n", nearbyint(-0.0));
        [printf](../../io/fprintf.html)("nearbyint(-Inf) = %+.1f\n", nearbyint(-INFINITY));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nearbyint&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nearbyint&action=edit&section=7 "Edit section: See also")] See also

[ rintrintfrintllrintlrintflrintlllrintllrintfllrintl](rint.html "c/numeric/math/rint")(C99)(C99)(C99)(C99)(C99)(C99)(C99)(C99)(C99) |  rounds to an integer using current rounding mode with   
exception if the result differs   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_rint&action=edit)  
---|---  
[ roundroundfroundllroundlroundflroundlllroundllroundfllroundl](round.html "c/numeric/math/round")(C99)(C99)(C99)(C99)(C99)(C99)(C99)(C99)(C99) |  rounds to nearest integer, rounding away from zero in halfway cases   
...
[C++ documentation](../../../cpp/numeric/math/nearbyint.html "cpp/numeric/math/nearbyint") for nearbyint
