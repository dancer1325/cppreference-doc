...
7) Type-generic macro: If the argument has type long double, (3) (`asinl`) is called. Otherwise, if the argument has integer type or the type double, (2) (`asin`) is called. Otherwise, (1) (`asinf`) is called. If the argument is complex, then the macro invokes the corresponding complex function ([casinf](../complex/casin.html "c/numeric/complex/casin"), [casin](../complex/casin.html "c/numeric/complex/casin"), [casinl](../complex/casin.html "c/numeric/complex/casin")).
...
## Contents
  ...
  * [3 Error handling](asin.html#Error_handling)
  * [4 Example](asin.html#Example)
  * [5 References](asin.html#References)
  * [6 See also](asin.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asin&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asin&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asin&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asin&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("asin( 1.0) = %+f, 2*asin( 1.0)=%+f\n", asin(1), 2 * asin(1));
        [printf](../../io/fprintf.html)("asin(-0.5) = %+f, 6*asin(-0.5)=%+f\n", asin(-0.5), 6 * asin(-0.5));
     
        // special values
        [printf](../../io/fprintf.html)("asin(0.0) = %1f, asin(-0.0)=%f\n", asin(+0.0), asin(-0.0));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("asin(1.1) = %f\n", asin(1.1));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asin&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asin&action=edit&section=6 "Edit section: See also")] See also
...
[ atan2atan2fatan2l](atan2.html "c/numeric/math/atan2")(C99)(C99) |  computes arc tangent, using signs to determine quadrants   
...
[C++ documentation](../../../cpp/numeric/math/asin.html "cpp/numeric/math/asin") for asin
