...
## Contents
  ...
  * [6 References](trunc.html#References)
  * [7 See also](trunc.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/trunc&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/trunc&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/trunc&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/trunc&action=edit&section=4 "Edit section: Notes")] Notes

[FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") may be (but isn't required to be) raised when truncating a non-integer finite value. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/trunc&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("trunc(+2.7) = %+.1f\n", trunc(+2.7));
        [printf](../../io/fprintf.html)("trunc(-2.7) = %+.1f\n", trunc(-2.7));
        [printf](../../io/fprintf.html)("trunc(-0.0) = %+.1f\n", trunc(-0.0));
        [printf](../../io/fprintf.html)("trunc(-Inf) = %+f\n",   trunc(-INFINITY));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/trunc&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/trunc&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/trunc.html "cpp/numeric/math/trunc") for trunc
