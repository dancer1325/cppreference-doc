...
## Contents
  ...
  * [1 Parameters](isgreaterequal.html#Parameters)
  * [2 Return value](isgreaterequal.html#Return_value)
  * [3 Notes](isgreaterequal.html#Notes)
  * [4 Example](isgreaterequal.html#Example)
  * [5 References](isgreaterequal.html#References)
  * [6 See also](isgreaterequal.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreaterequal&action=edit&section=1 "Edit section: Parameters")] Parameters

x  |  \-  |  floating-point value   
---|---|---  
y  |  \-  |  floating-point value   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreaterequal&action=edit&section=2 "Edit section: Return value")] Return value

Nonzero integral value if x >= y, ​0​ otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreaterequal&action=edit&section=3 "Edit section: Notes")] Notes

The built-in operator>= for floating-point numbers may raise [FE_INVALID](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") if one or both of the arguments is NaN. This function is a "quiet" version of operator>=. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreaterequal&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("isgreaterequal(2.0,1.0)      = %d\n", isgreaterequal(2.0, 1.0));
        [printf](../../io/fprintf.html)("isgreaterequal(1.0,2.0)      = %d\n", isgreaterequal(1.0, 2.0));
        [printf](../../io/fprintf.html)("isgreaterequal(1.0,1.0)      = %d\n", isgreaterequal(1.0, 1.0));
        [printf](../../io/fprintf.html)("isgreaterequal(INFINITY,1.0) = %d\n", isgreaterequal(INFINITY, 1.0));
        [printf](../../io/fprintf.html)("isgreaterequal(1.0,NAN)      = %d\n", isgreaterequal(1.0, NAN));
     
        return 0;
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreaterequal&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/isgreaterequal&action=edit&section=6 "Edit section: See also")] See also

[ islessequal](islessequal.html "c/numeric/math/islessequal")(C99) |  checks if the first floating-point argument is less or equal than the second   
(function macro) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_islessequal&action=edit)  
---|---  
[C++ documentation](../../../cpp/numeric/math/isgreaterequal.html "cpp/numeric/math/isgreaterequal") for isgreaterequal
