...
If `islower` returns true, it is guaranteed that [iscntrl](iscntrl.html "c/string/byte/iscntrl"), [isdigit](isdigit.html "c/string/byte/isdigit"), [ispunct](ispunct.html "c/string/byte/ispunct"), and [isspace](isspace.html "c/string/byte/isspace") return false for the same character in the same C locale. 
...
## Contents
  ...
  * [3 Example](islower.html#Example)
  * [4 References](islower.html#References)
  * [5 See also](islower.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/islower&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character to classify   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/islower&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the character is a lowercase letter, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/islower&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        ...
        [printf](../../io/fprintf.html)("In the default C locale, \\xe5 is %slowercase\n",
               islower(c) ? "" : "not " );
        [setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "en_GB.iso88591");
        [printf](../../io/fprintf.html)("In ISO-8859-1 locale, \\xe5 is %slowercase\n",
               islower(c) ? "" : "not " );
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/islower&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/islower&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/byte/islower.html "cpp/string/byte/islower") for islower  
...
[`iswupper`](../wide/iswupper.html "c/string/wide/iswupper") |  **`islower`**  
