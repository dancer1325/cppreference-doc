...
In locales other than "C", an alphabetic character is a character for which [isupper()](isupper.html "c/string/byte/isupper") or [islower()](islower.html "c/string/byte/islower") returns true or any other character considered alphabetic by the locale. In any case, [iscntrl()](iscntrl.html "c/string/byte/iscntrl"), [isdigit()](isdigit.html "c/string/byte/isdigit"), [ispunct()](ispunct.html "c/string/byte/ispunct") and [isspace()](isspace.html "c/string/byte/isspace") will return false for this character. 
...
## Contents
  ...
  * [3 Example](isalpha.html#Example)
  * [4 References](isalpha.html#References)
  * [5 See also](isalpha.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isalpha&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character to classify   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isalpha&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the character is an alphabetic character, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isalpha&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
        [printf](../../io/fprintf.html)("isalpha('\\xdf') in default C locale returned %d\n", !!isalpha(c));
     
        [setlocale](../../locale/setlocale.html)([LC_CTYPE](../../locale/LC_categories.html), "de_DE.iso88591");
        [printf](../../io/fprintf.html)("isalpha('\\xdf') in ISO-8859-1 locale returned %d\n", !!isalpha(c));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isalpha&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isalpha&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/byte/isalpha.html "cpp/string/byte/isalpha") for isalpha  
...
[`iswalnum`](../wide/iswalnum.html "c/string/wide/iswalnum") |  **`isalpha`**   
