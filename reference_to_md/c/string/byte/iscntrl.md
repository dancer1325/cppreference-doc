...
## Contents
  ...
  * [3 Example](iscntrl.html#Example)
  * [4 References](iscntrl.html#References)
  * [5 See also](iscntrl.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/iscntrl&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character to classify   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/iscntrl&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the character is a control character, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/iscntrl&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        ...
        [printf](../../io/fprintf.html)("In the default C locale, \\x94 is %sa control character\n",
               iscntrl(c) ? "" : "not " );
        [setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "en_GB.iso88591");
        [printf](../../io/fprintf.html)("In ISO-8859-1 locale, \\x94 is %sa control character\n",
               iscntrl(c) ? "" : "not " );
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/iscntrl&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/iscntrl&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/byte/iscntrl.html "cpp/string/byte/iscntrl") for iscntrl  
