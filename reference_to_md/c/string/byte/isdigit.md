...
## Contents
  ...
  * [5 References](isdigit.html#References)
  * [6 See also](isdigit.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isdigit&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character to classify   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isdigit&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the character is a numeric character, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isdigit&action=edit&section=3 "Edit section: Notes")] Notes

`isdigit` and [isxdigit](isxdigit.html "c/string/byte/isxdigit") are the only standard narrow character classification functions that are not affected by the currently installed C locale, although some implementations (e.g. Microsoft in [1252 codepage](https://en.wikipedia.org/wiki/Windows-1252 "enwiki:Windows-1252")) may classify additional single-byte characters as digits. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isdigit&action=edit&section=4 "Edit section: Example")] Example
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isdigit&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isdigit&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/byte/isdigit.html "cpp/string/byte/isdigit") for isdigit  
...
[`iswlower`](../wide/iswlower.html "c/string/wide/iswlower") |  **`isdigit`**  
