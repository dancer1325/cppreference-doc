...
If `isupper` returns true, it is guaranteed that [iscntrl](iscntrl.html "c/string/byte/iscntrl"), [isdigit](isdigit.html "c/string/byte/isdigit"), [ispunct](ispunct.html "c/string/byte/ispunct"), and [isspace](isspace.html "c/string/byte/isspace") return false for the same character in the same C locale. 
...
## Contents
  ...
  * [3 Example](isupper.html#Example)
  * [4 References](isupper.html#References)
  * [5 See also](isupper.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isupper&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character to classify   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isupper&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the character is an uppercase letter, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isupper&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        ...
        [printf](../../io/fprintf.html)("In the default C locale, \\xc6 is %suppercase\n",
               isupper(c) ? "" : "not " );
        [setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "en_GB.iso88591");
        [printf](../../io/fprintf.html)("In ISO-8859-1 locale, \\xc6 is %suppercase\n",
               isupper(c) ? "" : "not " );
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isupper&action=edit&section=4 "Edit section: References")] References
  ...
  * 7.4.1.11 The isupper function (p: TBD) 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isupper&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/byte/isupper.html "cpp/string/byte/isupper") for isupper  
...
[`iswalpha`](../wide/iswalpha.html "c/string/wide/iswalpha") |  **`isupper`**  
