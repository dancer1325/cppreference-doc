...
The behavior is undefined if the value of ch is not representable as unsigned char and is not equal to [EOF](../../io.html "c/io"). 

## Contents

  * [1 Parameters](isspace.html#Parameters)
  * [2 Return value](isspace.html#Return_value)
  * [3 Example](isspace.html#Example)
  * [4 References](isspace.html#References)
  * [5 See also](isspace.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isspace&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  character to classify   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isspace&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the character is a whitespace character, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isspace&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        for (int ndx = 0; ndx <= [UCHAR_MAX](../../types/limits.html); ++ndx)
            if (isspace(ndx))
                [printf](../../io/fprintf.html)("0x%02x ", ndx);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isspace&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/byte/isspace&action=edit&section=5 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/byte/isspace.html "cpp/string/byte/isspace") for isspace  
...
[`iswprint`](../wide/iswprint.html "c/string/wide/iswprint") |  **`isspace`**  
