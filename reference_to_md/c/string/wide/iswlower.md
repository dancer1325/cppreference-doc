...
---|---|---  
int iswlower( wint_t ch ); |  |  (since C95)  
| |   
...
## Contents
  ...
  * [5 References](iswlower.html#References)
  * [6 See also](iswlower.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswlower&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  wide character   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswlower&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the wide character is an lowercase letter, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswlower&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswlower&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        ...
        [printf](../../io/fprintf.html)("In the default locale, iswlower(%#x) = %d\n", c, !!iswlower(c));
        [setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "en_US.utf8");
        [printf](../../io/fprintf.html)("In Unicode locale, iswlower(%#x) = %d\n", c, !!iswlower(c));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswlower&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswlower&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/wide/iswlower.html "cpp/string/wide/iswlower") for iswlower  
...
**`iswlower`** |  [`isdigit`](../byte/isdigit.html "c/string/byte/isdigit")  
