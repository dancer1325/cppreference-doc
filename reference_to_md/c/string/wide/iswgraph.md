...
---|---|---  
int iswgraph( wint_t ch ); |  |  (since C95)  
| |   
...
## Contents
  ...
  * [5 References](iswgraph.html#References)
  * [6 See also](iswgraph.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswgraph&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  wide character   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswgraph&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the wide character has a graphical representation character, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswgraph&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswgraph&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        ...
        [printf](../../io/fprintf.html)("in the default locale, iswgraph(%#x) = %d\n", c, !!iswgraph(c));
        [setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "en_US.utf8");
        [printf](../../io/fprintf.html)("in Unicode locale, iswgraph(%#x) = %d\n", c, !!iswgraph(c));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswgraph&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswgraph&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/wide/iswgraph.html "cpp/string/wide/iswgraph") for iswgraph  
...
**`iswgraph`** |  [`ispunct`](../byte/ispunct.html "c/string/byte/ispunct")   
