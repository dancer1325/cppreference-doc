...
---|---|---  
wchar_t *wcsrchr( const wchar_t *str, wchar_t ch ); |  (1)  |  (since C95)  
...
## Contents
  ...
  * [4 References](wcsrchr.html#References)
  * [5 See also](wcsrchr.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/wcsrchr&action=edit&section=1 "Edit section: Parameters")] Parameters

str  |  \-  |  pointer to the null-terminated wide string to be analyzed   
---|---|---  
ch  |  \-  |  wide character to search for   
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/wcsrchr&action=edit&section=2 "Edit section: Return value")] Return value

Pointer to the found character in str, or a null pointer if no such character is found. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/wcsrchr&action=edit&section=3 "Edit section: Example")] Example
...
Run this code
    ...
     
        cat ? [printf](../../io/fprintf.html)("The character 猫 found at position %td\n", cat - arr)
            : [puts](../../io/puts.html)("The character 猫 not found");
     
        dog ? [printf](../../io/fprintf.html)("The character 犬 found at position %td\n", dog - arr)
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/wcsrchr&action=edit&section=4 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/wcsrchr&action=edit&section=5 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/string/wide/wcsrchr.html "cpp/string/wide/wcsrchr") for wcsrchr
