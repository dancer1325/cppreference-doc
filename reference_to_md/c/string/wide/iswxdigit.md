...
## Contents
  ...
  * [5 References](iswxdigit.html#References)
  * [6 See also](iswxdigit.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswxdigit&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  wide character   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswxdigit&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the wide character is a hexadecimal numeric character, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswxdigit&action=edit&section=3 "Edit section: Notes")] Notes

[iswdigit](iswdigit.html "c/string/wide/iswdigit") and `iswxdigit` are the only standard wide character classification functions that are not affected by the currently installed C locale. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswxdigit&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    void test(wchar_t a3, wchar_t u3, wchar_t j3)
    {
        ...
        [printf](../../io/fprintf.html)("iswxdigit: %d    %d    %d\n",
               !!iswxdigit(a3),
               !!iswxdigit(u3),
               !!iswxdigit(j3));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswxdigit&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswxdigit&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/wide/iswxdigit.html "cpp/string/wide/iswxdigit") for iswxdigit  
