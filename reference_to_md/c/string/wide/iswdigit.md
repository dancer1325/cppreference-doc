...
## Contents
  ...
  * [5 References](iswdigit.html#References)
  * [6 See also](iswdigit.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswdigit&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  wide character   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswdigit&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the wide character is a numeric character, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswdigit&action=edit&section=3 "Edit section: Notes")] Notes

`iswdigit` and [iswxdigit](iswxdigit.html "c/string/wide/iswxdigit") are the only standard wide character classification functions that are not affected by the currently installed C locale. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswdigit&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    {
        [printf](../../io/fprintf.html)("\t '%lc'  '%lc' '%lc'\n", a3, u3, j3);
        [printf](../../io/fprintf.html)("iswdigit: %d    %d    %d\n",
               !!iswdigit(a3),
               !!iswdigit(u3),
               !!iswdigit(j3));
        [printf](../../io/fprintf.html)("jdigit:   %d    %d    %d\n",
               !![iswctype](iswctype.html)(a3, [wctype](wctype.html)("jdigit")),
               !![iswctype](iswctype.html)(u3, [wctype](wctype.html)("jdigit")),
               !![iswctype](iswctype.html)(j3, [wctype](wctype.html)("jdigit")));
    }
     
    int main(void)
    {
    ...
     
        ...
        [puts](../../io/puts.html)("In American locale:");
        test(a3, u3, j3);
     
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswdigit&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswdigit&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/wide/iswdigit.html "cpp/string/wide/iswdigit") for iswdigit  
...
**`iswdigit`** |  [`isxdigit`](../byte/isxdigit.html "c/string/byte/isxdigit")  
