...
---|---|---  
wint_t towlower( wint_t wc ); |  |  (since C95)  
| |   
...
## Contents
  ...
  * [5 References](towlower.html#References)
  * [6 See also](towlower.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/towlower&action=edit&section=1 "Edit section: Parameters")] Parameters

wc  |  \-  |  wide character to be converted   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/towlower&action=edit&section=2 "Edit section: Return value")] Return value

Lowercase version of wc or unmodified wc if no lowercase version is listed in the current C locale. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/towlower&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/towlower&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        ...
        [printf](../../io/fprintf.html)("in the default locale, towlower(%#x) = %#x\n", wc, towlower(wc));
        [setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "en_US.utf8");
        [printf](../../io/fprintf.html)("in Unicode locale, towlower(%#x) = %#x\n", wc, towlower(wc));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/towlower&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/towlower&action=edit&section=6 "Edit section: See also")] See also

[ towupper](towupper.html "c/string/wide/towupper")(C95) |  converts a wide character to uppercase   
...
[C++ documentation](../../../cpp/string/wide/towlower.html "cpp/string/wide/towlower") for towlower
